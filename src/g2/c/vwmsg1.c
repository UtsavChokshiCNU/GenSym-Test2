...
Object Chain_of_available_ws_representation_types = UNBOUND;

Object Ws_representation_type_count = UNBOUND;
    ...
    Object ws_representation_type;
{
    ...
    svref_new_value = Chain_of_available_ws_representation_types;
    SVREF(ws_representation_type,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_ws_representation_types = ws_representation_type;
    return VALUES_1(Nil);
}
...
Object make_permanent_ws_representation_type_structure_internal()
{
    ...
    Object ws_representation_type_count_new_value;
    ...
    ws_representation_type_count_new_value = 
	    FIXNUM_ADD1(Ws_representation_type_count);
    Ws_representation_type_count = ws_representation_type_count_new_value;
...
void view_msg1_INIT()
{
    ...
    Object Qchart_property_getter, Qchart_property_spec, Qchart, Qgraph;
    ...
    Object Qws_representation_type_count;
    Object Qchain_of_available_ws_representation_types, string_constant_1;
    ...
    string_constant = STATIC_STRING("43Dy8m83omy1n83omy8n8k1l8n0000000kpk0k0");
    ...
    Qws_representation_type_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_1 = STATIC_STRING("1q83omy8s83-vxy09k9l");
