    ...
    Object class_definition;
{
	...
	return gensym_cons_1(temp,gensym_cons_1(temp_1,
...
Object Chain_of_available_bounding_box_states = UNBOUND;

Object Bounding_box_state_count = UNBOUND;
    ...
    Object bounding_box_state;
{
    ...
    svref_new_value = Chain_of_available_bounding_box_states;
    SVREF(bounding_box_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_bounding_box_states = bounding_box_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_bounding_box_state_structure_internal()
{
    ...
    Object bounding_box_state_count_new_value;
    Object defstruct_g2_bounding_box_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(237,6);
    def_structure_bounding_box_state_variable = Nil;
    bounding_box_state_count_new_value = FIXNUM_ADD1(Bounding_box_state_count);
    Bounding_box_state_count = bounding_box_state_count_new_value;
...
{
    Object def_structure_bounding_box_state_variable, svref_new_value;

    x_note_fn_call(237,7);
    def_structure_bounding_box_state_variable = 
	    Chain_of_available_bounding_box_states;
    ...
    SVREF(def_structure_bounding_box_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_bounding_box_state_variable);
}
    ...
    Object bounding_box_state;
{
    ...
    x_note_fn_call(237,9);
    if (ISVREF(bounding_box_state,(SI_Long)12L))
	reclaim_gensym_list_1(ISVREF(bounding_box_state,(SI_Long)11L));
    gensymed_symbol = 
	    ISVREF(ISVREF(ISVREF(The_type_description_of_bounding_box_state,
    ...
    Object class_definition;
{
	...
	if (variable_spec_list);
	    ...
	    variable_spec_list = gensym_cons_1(Qvariables,Nil);
	...
	svref_new_value = gensym_cons_1(Qvariables,Nil);
	SVREF(icon_editor,FIX((SI_Long)7L)) = svref_new_value;
...
Object Current_icon_editor_event = UNBOUND;

Object Current_icon_editor = UNBOUND;

Object Current_icon_editor_workspace = UNBOUND;

Object Current_workspace_on_image_plane_qm = UNBOUND;
    ...
    Object icon_editor, image_plane, block_near_cursor;
{
	...
	establish_next_workstation_context_continuation(Nil,
		...
		gensym_list_2(icon_editor,bounding_box),
    ...
    Object icon_editor, mouse_pointer, image_plane;
{
    ...
    Object class_qualifier_qm, x, y, xa, ya, icon_editor_engine, layer;
    Object sublist, drawing_element, old_text_place, old_text;
    Object current_wide_string_list, wide_string_bv16, current_wide_string;
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object temp_1, initial_string, old_stipple_place, old_stipple;
	...
	if (point_in_view_pad_p(x_in_workspace,y_in_workspace,
		...
		if (temp) {
		    establish_next_workstation_context_continuation(Nil,
			    ...
			    gensym_list_2(get_lookup_slot_value_given_default(block_near_cursor_qm,
			...
			if (temp ? TRUEP(type_of_slot_if_editable(4,
				...
				PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
				  ...
				  POP_SPECIAL();
				POP_SPECIAL();
				initial_string = gensym_cons_1(temp_1,Nil);
				if (T)
    ...
    Object workstation_event, mouse_pointer;
{
    ...
    x_note_fn_call(237,16);
    current_icon_editor_event = workstation_event;
    PUSH_SPECIAL(Current_icon_editor_event,current_icon_editor_event,9);
      current_icon_editor = Specific_structure_for_current_workstation_context;
      PUSH_SPECIAL(Current_icon_editor,current_icon_editor,8);
	current_icon_editor_workspace = ISVREF(Current_icon_editor,
		(SI_Long)4L);
	PUSH_SPECIAL(Current_icon_editor_workspace,current_icon_editor_workspace,
		7);
	  current_image_plane_qm = ISVREF(Current_icon_editor_event,
		  (SI_Long)7L);
	  PUSH_SPECIAL(Current_image_plane_qm,current_image_plane_qm,6);
	    current_workspace_on_image_plane_qm = Current_image_plane_qm ? 
		    ISVREF(Current_image_plane_qm,(SI_Long)5L) : Nil;
	    PUSH_SPECIAL(Current_workspace_on_image_plane_qm,current_workspace_on_image_plane_qm,
		    5);
...
void icons5_INIT()
{
    ...
    Object Qbounding_box_state_count, Qchain_of_available_bounding_box_states;
    ...
    string_constant_1 = 
	    STATIC_STRING("43Dy8m83fVy1o83fVy83-Sy8n8k1l83-Sy0000001m1n8y83-2xy1u83qqy83qsy83qwy83r+y83qry83qxy83r-y83qty83qvy83quy1m8x83-Sykxk0k0");
    ...
    Qbounding_box_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_2 = STATIC_STRING("1q83fVy8s83-L-y09k9l");
    ...
    string_constant_4 = 
	    STATIC_STRING("1s1n836Xy8k9k1n834xy8k9k1n83-Igy8349y9l1n83-Igy8k9k1n32Gy8k9m1n32Ry8k9m1n831-y8k9m1n83XKy8k9k");
    clear_optimized_constants();
