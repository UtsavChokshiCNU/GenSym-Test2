...
Object Chain_of_available_xml_structures = UNBOUND;

Object Xml_structure_count = UNBOUND;
    ...
    Object xml_structure;
{
    ...
    svref_new_value = Chain_of_available_xml_structures;
    SVREF(xml_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_xml_structures = xml_structure;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_xml_structure_variable, xml_structure_count_new_value;
    ...
    xml_structure_count_new_value = FIXNUM_ADD1(Xml_structure_count);
    Xml_structure_count = xml_structure_count_new_value;
...
Object Current_xml_structures = UNBOUND;

static Object Qcurrent_xml_structures;  /* current-xml-structures */
...
Object Chain_of_available_xml_nodes = UNBOUND;

Object Xml_node_count = UNBOUND;
    ...
    Object xml_node;
{
    ...
    svref_new_value = Chain_of_available_xml_nodes;
    SVREF(xml_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_xml_nodes = xml_node;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_xml_node_variable, xml_node_count_new_value;
    Object defstruct_g2_xml_node_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(191,11);
    def_structure_xml_node_variable = Nil;
    xml_node_count_new_value = FIXNUM_ADD1(Xml_node_count);
    Xml_node_count = xml_node_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_xml_node_variable;
...
Object Chain_of_available_xml_node_lists = UNBOUND;

Object Xml_node_list_count = UNBOUND;
    ...
    Object xml_node_list;
{
    ...
    svref_new_value = Chain_of_available_xml_node_lists;
    SVREF(xml_node_list,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_xml_node_lists = xml_node_list;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_xml_node_list_variable, xml_node_list_count_new_value;
    ...
    xml_node_list_count_new_value = FIXNUM_ADD1(Xml_node_list_count);
    Xml_node_list_count = xml_node_list_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_xml_namespaces = UNBOUND;

Object Xml_namespace_count = UNBOUND;
    ...
    Object xml_namespace;
{
    ...
    svref_new_value = Chain_of_available_xml_namespaces;
    SVREF(xml_namespace,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_xml_namespaces = xml_namespace;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_xml_namespace_variable, xml_namespace_count_new_value;
    ...
    xml_namespace_count_new_value = FIXNUM_ADD1(Xml_namespace_count);
    Xml_namespace_count = xml_namespace_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_xml_namespace_lists = UNBOUND;

Object Xml_namespace_list_count = UNBOUND;
    ...
    Object xml_namespace_list;
{
    ...
    svref_new_value = Chain_of_available_xml_namespace_lists;
    SVREF(xml_namespace_list,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_xml_namespace_lists = xml_namespace_list;
    return VALUES_1(Nil);
}
...
Object make_permanent_xml_namespace_list_structure_internal()
{
    ...
    Object xml_namespace_list_count_new_value;
    ...
    xml_namespace_list_count_new_value = FIXNUM_ADD1(Xml_namespace_list_count);
    Xml_namespace_list_count = xml_namespace_list_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object names_string;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(convert_xml_name_to_symbol_and_reclaim(name),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    Object frame, element;
{
    ...
    x_note_fn_call(191,137);
    allow_name_box_creation_without_workspace = T;
    PUSH_SPECIAL(Allow_name_box_creation_without_workspace,allow_name_box_creation_without_workspace,
	    0);
...
void dom_INIT()
{
    ...
    Object Qxml_namespace_list_count, Qchain_of_available_xml_namespace_lists;
    Object string_constant_16, Qtype_description_of_type;
    ...
    Object Qxml_namespace_structure_memory_usage, Qxml_namespace_count;
    Object Qchain_of_available_xml_namespaces, string_constant_14;
    Object string_constant_13, Qprint_xml_node_list, Qprint_xml_node;
    Object Qxml_node_list, Qoutstanding_xml_node_list_count;
    Object Qxml_node_list_structure_memory_usage, Qxml_node_list_count;
    Object Qchain_of_available_xml_node_lists, string_constant_12;
    Object string_constant_11, Qxml_node, Qoutstanding_xml_node_count;
    Object Qxml_node_structure_memory_usage, Qxml_node_count;
    Object Qchain_of_available_xml_nodes, string_constant_10;
    Object string_constant_9, Qnamed_dynamic_extent_description;
    Object Qxml_structures_extent, Qdom, Qxml_structure;
    Object Qoutstanding_xml_structure_count;
    Object Qxml_structure_structure_memory_usage, Qxml_structure_count;
    Object Qchain_of_available_xml_structures, string_constant_8;
    Object string_constant_7;

    x_note_fn_call(191,145);
    SET_PACKAGE("AB");
    ...
    string_constant_8 = STATIC_STRING("1q832ry8s83-w1y09k9l");
    ...
    string_constant_9 = 
	    STATIC_STRING("43Dy8m83opy1o83opy832ry8n8k1l832ry0000001n1m8x832ry1m83My83-BQy1m83=0y9kkmk0k0");
    ...
    string_constant_10 = STATIC_STRING("1q83opy8s83-w=y09k9l");
    clear_optimized_constants();
    ...
    string_constant_11 = 
	    STATIC_STRING("43Dy8m83oqy1o83oqy832ry8n8k1l832ry0000001n1m8x832ry1m83My83-BRy1m83=0y9kkmk0k0");
    ...
    string_constant_12 = STATIC_STRING("1q83oqy8s83-w0y09k9l");
    clear_optimized_constants();
    ...
    string_constant_13 = 
	    STATIC_STRING("43Dy8m83ony1o83ony832ry8n8k1l832ry0000001m1m8x832ry1m83My83-BOykmk0k0");
    ...
    string_constant_14 = STATIC_STRING("1q83ony8s83-w-y09k9l");
    clear_optimized_constants();
    ...
    Qprint_xml_namespace_list = STATIC_SYMBOL("PRINT-XML-NAMESPACE-LIST",
	    AB_package);
    string_constant_15 = 
	    STATIC_STRING("43Dy8m83ooy1o83ooy832ry8n8k1l832ry0000001n1m8x832ry1m83My83-BPy1m83=0y9kkmk0k0");
    ...
    Qxml_namespace_list_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_16 = STATIC_STRING("1q83ooy8s83-w*y09k9l");
    clear_optimized_constants();
