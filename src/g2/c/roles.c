    ...
    Object continuation;
{
    ...
    Object next_continuation, expiration_qm;
    ...
    if (expiration_qm) {
	gensymed_symbol_1 = value_qm;
	temp = FIXNUMP(gensymed_symbol_1);
	if (temp);
	else
	    temp = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_1) != 
		    (SI_Long)0L ? 
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_1)) == 
		    (SI_Long)1L : TRUEP(Qnil);
	if (temp);
	else
	    temp = INLINE_LONG_VECTOR_P(gensymed_symbol_1) != (SI_Long)0L ?
		     IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_1)) == 
		    (SI_Long)1L : TRUEP(Qnil);
	if (temp);
	else
	    temp = gensymed_symbol_1 ? SYMBOLP(gensymed_symbol_1) : 
		    TRUEP(Qnil);
	if (temp);
	else
	    temp = INLINE_UNSIGNED_BYTE_16_VECTOR_P(gensymed_symbol_1) != 
		    (SI_Long)0L;
	if (temp);
		...
		gensymed_symbol_3 = SXHASH_SYMBOL_1(gensymed_symbol_1) & 
    ...
    Object evaluation_iteration_state;
{
    ...
    Object gensymed_symbol_2, cdr_new_value;
	...
	inline_note_reclaim_cons(reference_cons,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(reference_cons) = cdr_new_value;
	Available_gensym_conses = reference_cons;
	inline_note_reclaim_cons(evaluation_iteration_state,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(evaluation_iteration_state) = cdr_new_value;
	Available_gensym_conses = evaluation_iteration_state;
    }
    else {
    ...
    Object block;
{
	...
	if (slot_description_qm && parent_description_qm) {
	    ...
	    temp_1 = TRUEP(Nil);
	if (temp_1)
	    return gensym_list_3(Qthe,gensym_list_3(Qclass_qualified_name,
	    ...
	    return gensym_list_3(Qthe,ISVREF(slot_description_qm,
...
Object Note_things_encountered_during_role_service_qm = UNBOUND;

Object Things_that_affect_this_formula = UNBOUND;
    ...
    Object value_to_check, quantifier, role, domain;
{
    ...
    Object value_qm, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    Object sub_class_bit_vector, role_value_qm, continuation_qm, expiration_qm;
	...
	if (predicate_function_qm) {
	  ...
	  next_loop_2:
		...
		if (continuation_qm) {
		    gensymed_symbol_1 = M_CAR(continuation_qm);
		    gensymed_symbol = Nil;
		    gensymed_symbol_4 = continuation_qm;
		    inline_funcall_2(gensymed_symbol_1,gensymed_symbol,
			    gensymed_symbol_4);
		}
		return VALUES_1(T);
	    }
		...
		gensymed_symbol = T;
		gensymed_symbol_4 = continuation_qm;
		result = inline_funcall_2(gensymed_symbol_1,
			gensymed_symbol,gensymed_symbol_4);
		MVS_3(result,role_value_qm,continuation_qm,expiration_qm);
	    }
	    goto next_loop_2;
	  end_loop_2:
    ...
    Object role, domain;
{
  ...
  next_loop:
	...
	if (CONSP(last_cons_so_far)) {
	    cdr_new_value = gensym_cons_1(value,Nil);
	    M_CDR(last_cons_so_far) = cdr_new_value;
	    last_cons_so_far = CDR(last_cons_so_far);
	}
	else {
	    values_so_far = gensym_cons_1(value,Nil);
    ...
    Object designation;
{
	...
	if (value_qm)
	    return gensym_cons_1(value_qm,Nil);
	else
	    return VALUES_1(Nil);
    }
	...
	if (EQ(CAR(designation),Qthe)) {
	    ...
	    if (value_qm)
		result_list = gensym_cons_1(value_qm,result_list);
	}
	else {
	    temp = role_of_designation(designation);
	  ...
	  next_loop_1:
	    if ( !TRUEP(expiration_qm))
		goto end_loop_1;
	    result_list = gensym_cons_1(role_value_qm,result_list);
	    if ( !TRUEP(continuation_qm))
		goto end_loop_1;
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(domain_values);
...
Object collect_instances_of_class_for_role_service(class_1)
    Object class_1;
{
    Object instance_list, gensymed_symbol, gensymed_symbol_1;
  ...
  end_4:;
	...
	next_loop_8:
	  ...
	  if ( !temp_2) {
	      ...
	      gensymed_symbol = ISVREF(object_to_try,(SI_Long)14L);
		...
		instance_list = gensym_cons_1(connection_frame_1,
			instance_list);
		goto next_loop_10;
	      end_loop_12:;
	      POP_SPECIAL();
	...
	if (temp_2) {
		...
		end_loop_21:
		  ...
		  instance_list = gensym_cons_1(instance,instance_list);
	      goto next_loop_21;
	    end_loop_22:;
	    POP_SPECIAL();
	}
...
Object serve_first_item_or_evaluation_value_of_role varargs_1(int, n)
{
    ...
    Object gensymed_symbol_3, temp_1, temp_2, new_cons, global_properties;
	...
	PUSH_SPECIAL(There_exists_p,there_exists_p,0);
	  if (function) {
	      if (domain_2_qm) {
	...
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = role;
	gensymed_symbol_4 = SXHASH_SYMBOL_1(role) & IFIX(Most_positive_fixnum);
	gensymed_symbol_5 = (SI_Long)0L;
      next_loop_1:
	if ( !TRUEP(gensymed_symbol))
	    goto end_loop_1;
	gensymed_symbol_5 = IFIX(ISVREF(gensymed_symbol,(SI_Long)0L));
	if (gensymed_symbol_4 < gensymed_symbol_5)
	    gensymed_symbol = ISVREF(gensymed_symbol,(SI_Long)1L);
	else if (gensymed_symbol_4 > gensymed_symbol_5)
	    gensymed_symbol = ISVREF(gensymed_symbol,(SI_Long)2L);
	else {
	    gensymed_symbol = ISVREF(gensymed_symbol,(SI_Long)3L);
	    gensymed_symbol_2 = Nil;
	...
	if (kb_properties) {
	    gensymed_symbol = CDR(kb_properties);
	    gensymed_symbol_1 = Class_description_gkbprop;
	    gensymed_symbol_4 = SXHASH_SYMBOL_1(Class_description_gkbprop) 
		    & IFIX(Most_positive_fixnum);
	    gensymed_symbol_5 = (SI_Long)0L;
	  next_loop_5:
	    if ( !TRUEP(gensymed_symbol))
    ...
    Object item_or_value, type;
{
    ...
    Object gensym_cons, temp_1, amf_available_array_cons_qm, amf_array;
    Object svref_new_value, amf_result, incff_1_arg, new_float, result_1;
	...
	if ((IFIX(Current_computation_flags) & (SI_Long)8L) != (SI_Long)0L) {
		...
		PUSH_SPECIAL(Variables_that_did_not_have_values,variables_that_did_not_have_values,
			0);
		  coerced_value_qm = 
		...
		pruned_interest_list = 
			delete_gensym_element_1(Qvalue_request_pending,
		...
		if (gensymed_symbol &&  !((SI_Long)0L == 
		    ...
		    gensym_cons = gensymed_symbol;
		  next_loop_1:
		    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		    if (EQ(gensym_cons,gensymed_symbol_4))
			goto end_1;
		...
		Available_gensym_conses = gensymed_symbol;
	    }
    ...
    Object role, domain, domain_2_qm;
{
    ...
    Object expiration_qm, gensymed_symbol, gensymed_symbol_1;
    ...
    Object item_or_structure, attribute, class_specific_attribute_class_qm;
{
    ...
    Object gensymed_symbol_5, car_1, managed_value, evaluator_info, getter_qm;
    Object virtual_attribute_qm, extracted_value, reclaim_p, gensymed_symbol_6;
    Object value, category_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;
    Object result;
	...
	if ( !TRUEP(structure_slot_value_qm))
		...
		temp = EQ(structure_slot_value_qm,Evaluation_true_value) 
			...
			Evaluation_false_value) ? structure_slot_value_qm :
			 gensym_cons_1(M_CAR(structure_slot_value_qm),
			Qtruth_value);
		...
		if (temp_1) {
			...
			if (temp_1) {
				...
				if (FIXNUM_EQ(managed_value,Truth))
				    ...
				    temp = gensym_cons_1(managed_value,
					    Qtruth_value);
			    }
			    else
...
{
    Object gensymed_symbol, gensymed_symbol_1, new_cons, gensymed_symbol_2;
    Object slot_value_qm, temp_1, car_1, cdr_1, managed_value, x2;
    char temp;
	...
	if (temp) {
		...
		if (temp) {
			...
			if (FIXNUM_EQ(managed_value,Truth))
			    ...
			    temp_1 = gensym_cons_1(managed_value,Qtruth_value);
		    }
		    else
...
{
    Object evaluation_value, ab_loop_list_, list_qm, cdr_new_value;
    Object constant_to_serve, rest_qm, gensym_cons;
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(continuation);
	return VALUES_1(Qnil);
    }
    else {
	list_qm = M_CDR(continuation);
	if ( !TRUEP(list_qm)) {
	    inline_note_reclaim_cons(continuation,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(continuation) = cdr_new_value;
	    Available_gensym_conses = continuation;
	    return VALUES_3(Nil,Nil,Nil);
	}
	else {
		...
		if (continuation &&  !((SI_Long)0L == 
			inline_debugging_consing())) {
		    gensym_cons = continuation;
		  next_loop_1:
		    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		    if (EQ(gensym_cons,list_qm))
			goto end_1;
		    else if ( !TRUEP(gensym_cons))
			goto end_1;
		    else
		...
		cdr_new_value = Available_gensym_conses;
		M_CDR(list_qm) = cdr_new_value;
		Available_gensym_conses = continuation;
		return VALUES_3(constant_to_serve,Nil,Qnever);
	    }
	    else {
		M_CDR(continuation) = rest_qm;
		inline_note_reclaim_cons(list_qm,Qab_gensym);
		cdr_new_value = Available_gensym_conses;
		M_CDR(list_qm) = cdr_new_value;
		Available_gensym_conses = list_qm;
...
Object serve_next_unreprocessed_frame(continue_qm,continuation)
    Object continue_qm, continuation;
{
    Object last_1, next_qm, cdr_new_value, frame_reference_cons;
    Object frame_reference_number, instance_cons, rest_of_instances, instance;
    Object gensymed_symbol, xa, ya, gensym_cons;
    char temp;
	...
	if (rest_of_instances) {
	    ...
	    inline_note_reclaim_cons(instance_cons,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(instance_cons) = cdr_new_value;
	    Available_gensym_conses = instance_cons;
	    gensymed_symbol = ISVREF(instance,(SI_Long)3L);
	    temp = SIMPLE_VECTOR_P(instance) ? EQ(ISVREF(instance,
	    ...
	    if ( !temp ? TRUEP(serve_item_p(instance)) : TRUEP(Nil))
		...
		gensym_cons = continuation;
	      next_loop_2:
		inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		if (EQ(gensym_cons,instance_cons))
		    goto end_1;
		else if ( !TRUEP(gensym_cons))
		    goto end_1;
		else
...
Object serve_all_unreprocessed_frames(frame_list)
    Object frame_list;
{
    Object instance_to_serve, temp, new_cons, gensymed_symbol, continuation;
	...
	inline_note_reclaim_cons(frame_list,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(frame_list) = temp;
	Available_gensym_conses = frame_list;
    ...
    Object continue_qm, continuation;
{
    ...
    Object frame_serial_number, value_cons, rest_of_values, cdr_new_value, x2;
    Object gensymed_symbol, xa, ya, gensym_cons, last_1, next_qm;
    char temp;
	...
	if (rest_of_values) {
	    ...
	    inline_note_reclaim_cons(value_cons,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(value_cons) = cdr_new_value;
	    Available_gensym_conses = value_cons;
	    if ( !(SIMPLE_VECTOR_P(item_or_value) && 
...
{
    Object value_to_serve, x2, car_new_value, new_cons, gensymed_symbol;
    Object continuation;
    char temp;
	...
	value_to_serve = M_CAR(item_or_value_list);
	car_new_value = copy_frame_serial_number(Current_frame_serial_number);
	M_CAR(item_or_value_list) = car_new_value;
	new_cons = Available_gensym_conses;
	if (new_cons) {
	    Available_gensym_conses = M_CDR(new_cons);
	    gensymed_symbol = new_cons;
	...
	if ( !TRUEP(gensymed_symbol))
	    gensymed_symbol = replenish_gensym_cons_pool();
	car_new_value = SYMBOL_FUNCTION(Qserve_next_item_or_value);
    ...
    Object eval_cons_list_of_frames;
{
    ...
    temp = copy_frame_serial_number(Current_frame_serial_number);
    return gensym_cons_1(temp,gensym_cons_1(FIX((SI_Long)1L),
    ...
    Object cache_list;
{
    ...
    Object gensymed_symbol, xa, ya, temp_1, temp_2, new_cons;
    Object gensymed_symbol_1, temp_3;
    char temp;
    ...
    Object continue_qm, continuation;
{
	...
	if (temp) {
		...
		if (IFIX(M_SECOND(cache_list) = temp_1) == (SI_Long)0L) {
			...
			temp_1 = Available_gensym_conses;
			M_CDR(last_1) = temp_1;
			Available_gensym_conses = cache_list;
		    }
		}
		if (continuation &&  !((SI_Long)0L == 
			inline_debugging_consing())) {
		  ...
		  next_loop_2:
		    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		    if (EQ(gensym_cons,current_position_cons))
			goto end_1;
		    else if ( !TRUEP(gensym_cons))
			goto end_1;
		    else
		...
		temp_1 = Available_gensym_conses;
		M_CDR(current_position_cons) = temp_1;
		Available_gensym_conses = continuation;
...
Object Role_caching_enabled_qm = UNBOUND;
    ...
    Object entity, role_name, role_argument, eval_cons_list_of_frames;
{
    ...
    specific_cache_entry = gensym_cons_1(role_argument,cache_list);
    domain_cache_qm = get_lookup_slot_value_given_default(entity,
	    Qrole_cache,Nil);
    role_cache_qm = assq_function(role_name,domain_cache_qm);
    if (role_cache_qm) {
	cdr_new_value = gensym_cons_1(specific_cache_entry,CDR(role_cache_qm));
	M_CDR(role_cache_qm) = cdr_new_value;
    }
    else
	set_non_savable_lookup_slot_value(entity,Qrole_cache,
		gensym_cons_1(gensym_list_2(role_name,
		specific_cache_entry),domain_cache_qm));
...
Object Get_focal_entity_for_simulation_formula_qm = UNBOUND;

Object Focal_entity_for_simulation_formula = UNBOUND;
    ...
    Object role_cache_entries, gensymed_symbol;
{
  ...
  next_loop_1:
    ...
    reclaim_gensym_tree_1(CAR(specific_cache));
    inline_note_reclaim_cons(specific_cache,Qab_gensym);
    temp = Available_gensym_conses;
    M_CDR(specific_cache) = temp;
    Available_gensym_conses = specific_cache;
    goto next_loop_1;
  end_loop_1:;
	...
	temp = Available_gensym_conses;
	M_CDR(last_1) = temp;
	Available_gensym_conses = list_of_specific_caches;
    }
    inline_note_reclaim_cons(role_cache_entry,Qab_gensym);
    temp = Available_gensym_conses;
    M_CDR(role_cache_entry) = temp;
    Available_gensym_conses = role_cache_entry;
    goto next_loop;
  end_loop:;
	...
	temp = Available_gensym_conses;
	M_CDR(last_1) = temp;
	Available_gensym_conses = role_cache_entries;
    }
    return VALUES_1(Nil);
}
    ...
    Object entity;
{
    ...
    Object cache_list, temp_1, last_1, next_qm;

    x_note_fn_call(150,45);
  ...
  next_loop:
	...
	role_entries_to_remove = gensym_cons_1(role_cache_entry,
  ...
  end_loop_2:;
    ...
    inline_note_reclaim_cons(entry,Qab_gensym);
    temp_1 = Available_gensym_conses;
    M_CDR(entry) = temp_1;
    Available_gensym_conses = entry;
    goto next_loop_1;
  end_loop_1:;
	...
	temp_1 = Available_gensym_conses;
	M_CDR(last_1) = temp_1;
	Available_gensym_conses = role_entries_to_remove;
    }
    return VALUES_1(Qnil);
}

Object Connections_to_be_excluded_qm = UNBOUND;

Object Entities_to_be_excluded_qm = UNBOUND;

Object Entities_or_triples_found_in_search = UNBOUND;
    ...
    Object connection;
{
    ...
    x_note_fn_call(150,47);
    things_that_affect_this_formula = Nil;
    PUSH_SPECIAL(Things_that_affect_this_formula,things_that_affect_this_formula,
	    4);
      note_things_encountered_during_role_service_qm = T;
      PUSH_SPECIAL(Note_things_encountered_during_role_service_qm,note_things_encountered_during_role_service_qm,
	      3);
	...
	if (gensymed_symbol && ISVREF(gensymed_symbol,(SI_Long)16L)) {
	    ...
	    PUSH_SPECIAL(Entities_or_triples_found_in_search,entities_or_triples_found_in_search,
		    2);
	      PUSH_SPECIAL(Entities_to_be_excluded_qm,entities_to_be_excluded_qm,
		      1);
		PUSH_SPECIAL(Connections_to_be_excluded_qm,connections_to_be_excluded_qm,
			0);
		  search_for_directly_connected_entities_for_connection(block,
			  Qobject,connection,Nil,Nil,Nil,Nil,T);
		  reclaim_gensym_list_1(Entities_or_triples_found_in_search);
	...
	goto next_loop_1;
      end_loop_1:;
	reclaim_gensym_list_1(Things_that_affect_this_formula);
	result = VALUES_1(Qnil);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
    ...
    Object role, domain;
{
	...
	temp_1 = M_CDR(name_or_names) ? 
		gensym_cons_1(SYMBOL_FUNCTION(Qserve_next_name_of_entity),
		copy_list_using_gensym_conses_1(M_CDR(name_or_names))) : Nil;
...
Object serve_next_name_of_entity(continue_qm,continuation)
    Object continue_qm, continuation;
{
    Object instance_cons, cdr_new_value, temp, gensym_cons;

    x_note_fn_call(150,51);
    if ( !TRUEP(continue_qm))
	return reclaim_gensym_list_1(continuation);
    else {
	...
	if ( !TRUEP(instance_cons)) {
	    ...
	    temp = CAR(instance_cons);
	    cdr_new_value = M_CDR(instance_cons);
	    M_CDR(continuation) = cdr_new_value;
	    inline_note_reclaim_cons(instance_cons,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(instance_cons) = cdr_new_value;
	    Available_gensym_conses = instance_cons;
	    return VALUES_3(temp,continuation,Qnever);
	}
    }
}
    ...
    Object variable_or_parameter;
{
    ...
    Object gensym_cons, cdr_new_value;
    Declare_stack_pointer;
    Declare_catch(1);
    Declare_special(1);
    Object result;

    x_note_fn_call(150,55);
    SAVE_STACK();
    value = Nil;
    expiration_qm = Nil;
    type = Nil;
	...
	if (gensymed_symbol &&  !((SI_Long)0L == inline_debugging_consing())) {
	  ...
	  next_loop_1:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	    if (EQ(gensym_cons,gensymed_symbol_1))
		goto end_1;
	    else if ( !TRUEP(gensym_cons))
		goto end_1;
	    else
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(gensymed_symbol_1) = cdr_new_value;
	Available_gensym_conses = gensymed_symbol;
    }
    CONTINUE_UNWINDING(0);
    ...
    Object frame, attribute_name, class_qualifier_qm;
{
	...
	PUSH_SPECIAL(Evaluation_value_writing_target_length_qm,evaluation_value_writing_target_length_qm,
		1);
	  ...
	  PUSH_SPECIAL(Current_ddd_dot_dddd_format_qm,current_ddd_dot_dddd_format_qm,
		  0);
	    text_string = 
...
Object Connections_in_connection_paths = UNBOUND;

Object Current_connection_path = UNBOUND;

/* CLEAR-ENTITIES-TO-BE-EXCLUDED */
Object clear_entities_to_be_excluded(entities)
    Object entities;
{
    x_note_fn_call(150,81);
    clear_blocks_found_in_search(entities);
    return reclaim_gensym_list_1(entities);
}
...
Object clear_connections_to_be_excluded(connections)
    Object connections;
{
    x_note_fn_call(150,82);
    clear_connections_found_in_search(connections);
    return reclaim_gensym_list_1(connections);
}
	  ...
	  PUSH_SPECIAL(Entities_to_be_excluded_qm,entities_to_be_excluded_qm,
	    ...
	    PUSH_SPECIAL(Connections_to_be_excluded_qm,connections_to_be_excluded_qm,
		  ...
		  if (Nil) {
		      ...
		      Entities_to_be_excluded_qm = gensym_cons_1(entity,
			      Entities_to_be_excluded_qm);
		      svref_new_value = IFIX(ISVREF(Nil,(SI_Long)7L)) | 
			      (SI_Long)512L;
		      ISVREF(Nil,(SI_Long)7L) = FIX(svref_new_value);
		      Connections_to_be_excluded_qm = gensym_cons_1(Nil,
...
Object Do_not_stop_search_once_found_qm = UNBOUND;
    ...
    Object do_not_stop_search_at_connections_qm;
{
    ...
    end_1:
	  ...
	  PUSH_SPECIAL(Do_not_stop_search_once_found_qm,do_not_stop_search_once_found_qm,
		  0);
	    search_for_directly_connected_entities_for_connection(entity,
		    class_1,connection,directionality_qm,
		    also_get_port_and_direction_info_qm,Nil,
    ...
    Object do_not_stop_search_at_connections_qm;
{
    ...
    x_note_fn_call(150,90);
    if (EQ(do_not_stop_search_at_connections_qm,Qsave_path)) {
	temp = 
		get_or_make_connection_frame_and_activate_if_appropriate(connection);
	Current_connection_path = gensym_cons_1(temp,Current_connection_path);
...
Object search_for_directly_connected_entities_for_connection_1(entity,
    ...
    Object do_not_stop_search_at_connections_qm;
{
    Object gensymed_symbol, gensymed_symbol_1, new_cons, gensymed_symbol_2, x;
    Object x2, entity_at_other_end, class_of_entity_at_other_end;
    Object connection_frame_or_class, connection_class, directionality, symbol;
    Object property_name, temp_1, temp_2, global_properties, kb_properties;
    Object kb_specific_value, resulting_value, sub_class_bit_vector;
    Object connection_frame_1, transparent_class, ab_loop_list_, ab_loop_it_;
    Object name_or_names, cp_list, cp_list_tail, names_sic, name, names_sic_1;
    Object frame, cp, superior_connection_and_end, superior_connection;
    Object superior_connection_frame, connection_end, required_direction_qm;
    Object direction_to_try;
    SI_Long gensymed_symbol_3, gensymed_symbol_4, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5, svref_new_value;
    char temp;

    x_note_fn_call(150,91);
	...
	if (temp) {
		...
		if (temp) {
		    ...
		    gensymed_symbol_3 = SXHASH_SYMBOL_1(symbol) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_4 = (SI_Long)0L;
		  next_loop:
		    if ( !TRUEP(gensymed_symbol))
			goto end_loop;
		    gensymed_symbol_4 = IFIX(ISVREF(gensymed_symbol,
			    (SI_Long)0L));
		    if (gensymed_symbol_3 < gensymed_symbol_4)
			gensymed_symbol = ISVREF(gensymed_symbol,(SI_Long)1L);
		    else if (gensymed_symbol_3 > gensymed_symbol_4)
		  ...
		  end_4:;
			...
			gensymed_symbol_3 = SXHASH_SYMBOL_1(property_name) 
				& IFIX(Most_positive_fixnum);
			gensymed_symbol_4 = (SI_Long)0L;
		      next_loop_4:
			if ( !TRUEP(gensymed_symbol))
			...
			gensymed_symbol = CDR(Symbol_properties_table);
			gensymed_symbol_1 = class_1;
			gensymed_symbol_3 = SXHASH_SYMBOL_1(class_1) & 
				IFIX(Most_positive_fixnum);
			gensymed_symbol_4 = (SI_Long)0L;
		      next_loop_8:
			if ( !TRUEP(gensymed_symbol))
			...
			if ( !((SI_Long)0L != (IFIX(ISVREF(entity,
				(SI_Long)5L)) & (SI_Long)1048576L))) {
			    svref_new_value = IFIX(ISVREF(entity,
				    (SI_Long)5L)) | (SI_Long)1048576L;
			    ISVREF(entity,(SI_Long)5L) = FIX(svref_new_value);
			    Entities_to_be_excluded_qm = 
				    gensym_cons_1(entity,
				    Entities_to_be_excluded_qm);
			    svref_new_value = IFIX(ISVREF(connection,
				    (SI_Long)7L)) | (SI_Long)512L;
			    ISVREF(connection,(SI_Long)7L) = 
				    FIX(svref_new_value);
			    Connections_to_be_excluded_qm = 
				    gensym_cons_1(connection,
				    Connections_to_be_excluded_qm);
			    temp_2 = directionality_qm;
			    if (temp_2);
			    else
			...
			if (temp) {
			    Entities_or_triples_found_in_search = 
				    gensym_cons_1(also_get_port_and_direction_info_qm 
				    ? gensym_list_3(connection_frame_1,Nil,
				...
				if (temp) {
				    ...
				    ISVREF(entity_at_other_end,
					    ...
					    FIX(svref_new_value);
				    Entities_to_be_excluded_qm = 
					    gensym_cons_1(entity_at_other_end,
					    Entities_to_be_excluded_qm);
				    svref_new_value = 
			...
			gensymed_symbol = CDR(Symbol_properties_table);
			gensymed_symbol_1 = class_of_entity_at_other_end;
			gensymed_symbol_3 = 
    ...
    Object entity_found, connection, also_get_port_and_direction_info_qm;
{
	...
	if (Current_connection_path)
	    Connections_in_connection_paths = 
		    gensym_cons_1(copy_list_using_gensym_conses_1(Current_connection_path),
		    Connections_in_connection_paths);
	if (also_get_port_and_direction_info_qm)
	    add_port_and_direction_info_triple(entity_found,connection,
		    also_get_port_and_direction_info_qm);
	else {
	    svref_new_value = IFIX(ISVREF(entity_found,(SI_Long)5L)) | 
		    (SI_Long)1048576L;
	    ISVREF(entity_found,(SI_Long)5L) = FIX(svref_new_value);
	    Entities_to_be_excluded_qm = gensym_cons_1(entity_found,
		    Entities_to_be_excluded_qm);
	    Entities_or_triples_found_in_search = 
		    gensym_cons_1(entity_found,
		    Entities_or_triples_found_in_search);
	}
	if (There_exists_p) {
...
{
    Object connection_post, ab_loop_list_, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp, temp_1, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
	...
	if ( !((SI_Long)0L != (IFIX(ISVREF(connection_post,(SI_Long)5L)) & 
	  ...
	  end_4:;
	    ...
	    if (temp_2) {
		svref_new_value = IFIX(ISVREF(connection_post,
			(SI_Long)5L)) | (SI_Long)1048576L;
		ISVREF(connection_post,(SI_Long)5L) = FIX(svref_new_value);
		Entities_to_be_excluded_qm = gensym_cons_1(connection_post,
			Entities_to_be_excluded_qm);
		if (Nil) {
		    svref_new_value = IFIX(ISVREF(connection_post,
			    (SI_Long)5L)) | (SI_Long)1048576L;
    ...
    Object entity, connection, port_and_direction_info_qm;
{
    ...
    direction_of_connection_for_entity =  !((SI_Long)0L != 
	    ...
	    : Nil;
    triple_to_add = gensym_list_3(entity,port_names,
	    direction_of_connection_for_entity);
    if (EQ(port_and_direction_info_qm,Qboth)) {
	Entities_or_triples_found_in_search = gensym_cons_1(triple_to_add,
		Entities_or_triples_found_in_search);
	...
	if (EQ(entity,CAR(triple))) {
		...
		if (EQUAL(port_names,temp)) {
		    reclaim_gensym_tree_1(triple_to_add);
		    return VALUES_0();
		}
	    }
...
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    Object connection_item, temp;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;

    x_note_fn_call(150,96);
  ...
  end_2:;
    if (connection_item) {
	temp = get_direction_of_connection(2,connection,block);
	temp = copy_list_using_gensym_conses_1(EQ(temp,Qinput) ? 
    ...
    Object role, domain;
{
	...
	if (temp)
		...
		return add_to_cache_and_serve(gensymed_symbol,
			gensymed_symbol_1,
			copy_tree_using_gensym_conses_1(gensymed_symbol_2),
			gensymed_symbol_4);
	    else
    ...
    Object object, quantifier, role, domain_designation;
{
    ...
    Object name_or_names, last_1, next_qm, cdr_new_value, class_qm;
    Object gensymed_symbol_5, gensymed_symbol_8, temp_1, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value;
    SI_Long gensymed_symbol_6, gensymed_symbol_7;
    char temp;
    Object result;

    x_note_fn_call(150,100);
	...
	gensymed_symbol_4 = gensym_cons_1(role_argument,
		gensym_cons_1(quantifier_1,designation));
    }
    else
	gensymed_symbol_4 = Nil;
	...
	if (SYMBOLP(domain_designation)) {
	  ...
	  next_loop_1:
	    ...
	    if ((CONSP(name_or_names) ? 
		    ...
		    role,entity)))
		entities_to_serve = gensym_cons_1(entity,entities_to_serve);
	    goto next_loop_1;
	  end_loop_1:;
		...
		cdr_new_value = Available_gensym_conses;
		M_CDR(last_1) = cdr_new_value;
		Available_gensym_conses = connected_entities;
	    }
		...
		gensymed_symbol_5 = class_qm;
		gensymed_symbol_6 = SXHASH_SYMBOL_1(class_qm) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_7 = (SI_Long)0L;
	      next_loop_3:
		if ( !TRUEP(gensymed_symbol_3))
		    goto end_loop_3;
		gensymed_symbol_7 = IFIX(ISVREF(gensymed_symbol_3,
			(SI_Long)0L));
		if (gensymed_symbol_6 < gensymed_symbol_7)
		    gensymed_symbol_3 = ISVREF(gensymed_symbol_3,(SI_Long)1L);
		else if (gensymed_symbol_6 > gensymed_symbol_7)
		    gensymed_symbol_3 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
		else {
		    gensymed_symbol_3 = ISVREF(gensymed_symbol_3,(SI_Long)3L);
		    gensymed_symbol_8 = Nil;
		  next_loop_4:
		    if ( !TRUEP(gensymed_symbol_3))
			goto end_loop_4;
		    gensymed_symbol_8 = M_CAR(M_CAR(gensymed_symbol_3));
		    if (EQ(gensymed_symbol_5,gensymed_symbol_8)) {
		...
		if ( !TRUEP(gensymed_symbol_3)) {
			...
			gensymed_symbol_5 = Nil;
		    if ( !TRUEP(gensymed_symbol_5))
			gensymed_symbol_5 = replenish_gensym_cons_pool();
		    M_CAR(gensymed_symbol_5) = Qsymbol_properties_hash_table;
		    M_CDR(gensymed_symbol_5) = Nil;
		    inline_note_allocate_cons(gensymed_symbol_5,Qab_gensym);
		    gensymed_symbol_3 = 
			    set_balanced_binary_tree_entry(temp_1,Qeq,Nil,
			    T,gensymed_symbol_3,temp_2,gensymed_symbol_5);
		}
		...
		if (kb_properties) {
		    ...
		    gensymed_symbol_5 = Class_description_gkbprop;
		    gensymed_symbol_6 = 
			    SXHASH_SYMBOL_1(Class_description_gkbprop) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_7 = (SI_Long)0L;
		...
		if (unique_value_of_role_p(object,role,entity))
		    entities_to_serve = gensym_cons_1(entity,
			    entities_to_serve);
		goto next_loop_11;
	      end_loop_11:;
		if (connected_entities) {
	...
	if (gensymed_symbol_2)
	    result = add_to_cache_and_serve(gensymed_symbol,
		    gensymed_symbol_1,
		    copy_tree_using_gensym_conses_1(gensymed_symbol_4),
		    gensymed_symbol_3);
	else
    ...
    if (gensymed_symbol_4) {
	reclaim_gensym_cons_1(CDR(gensymed_symbol_4));
	reclaim_gensym_cons_1(gensymed_symbol_4);
    }
    ...
    Object object, quantifier, role, domain_designation;
{
    ...
    Object entity, entity_entry, last_1, next_qm, cdr_new_value;
    char temp;
    Object result;

    x_note_fn_call(150,103);
    gensymed_symbol = object;
    gensymed_symbol_1 = quantifier;
    gensymed_symbol_2 = role;
    gensymed_symbol_3 = domain_designation;
	...
	if (classes_qm) {
	  ...
	  end_loop_2:
	    ...
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(last_1) = cdr_new_value;
	    Available_gensym_conses = classes_qm;
	}
	reclaim_gensym_tree_1(connected_entities);
	gensymed_symbol_3 = entities_to_serve;
	if (gensymed_symbol_2)
	    result = add_to_cache_and_serve(gensymed_symbol,
		    gensymed_symbol_1,
    ...
    Object object, quantifier, role, domain_designation;
{
    ...
    Object ab_loopvar__2, connected_entities, entities_to_serve, entity;
    Object entity_entry, last_1, next_qm, cdr_new_value;
    char temp;
    Object result;

    x_note_fn_call(150,106);
    gensymed_symbol = object;
    gensymed_symbol_1 = quantifier;
    gensymed_symbol_2 = role;
    gensymed_symbol_3 = domain_designation;
...
{
    Object frame_or_frames, frame, ab_loop_list_, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, class_qm, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp, temp_1, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;

    x_note_fn_call(150,110);
    if (SYMBOLP(domain_designation)) {
	frame_or_frames = 
		lookup_kb_specific_property_value(domain_designation,
		Frame_or_frames_with_this_name_kbprop);
	if (LISTP(frame_or_frames)) {
	  ...
	  next_loop:
		...
		ab_loopvar__2 = gensym_cons_1(ISVREF(ISVREF(frame,
	  ...
	  end_loop:
	    ...
	    return gensym_cons_1(ISVREF(ISVREF(frame_or_frames,
		    (SI_Long)1L),(SI_Long)1L),Nil);
	else
	    return VALUES_1(Nil);
    }
	...
	if (class_qm) {
	    ...
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_qm) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_1:
	    if ( !TRUEP(gensymed_symbol))
	  ...
	  end_4:;
	    ...
	    temp_2 = TRUEP(Nil);
	if (temp_2)
	    return gensym_cons_1(class_qm,Nil);
	else
	    return VALUES_1(Nil);
    }
}
    ...
    Object object, quantifier, role, domain_designation;
{
    ...
    Object classes_qm, class_1, ab_loop_list_, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, connected_entities, entities_to_serve, entity;
    Object sub_class_bit_vector, last_1, next_qm, cdr_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5, gensymed_symbol_6, gensymed_symbol_7;
    char temp;
    Object result;

    x_note_fn_call(150,120);
    gensymed_symbol = object;
    gensymed_symbol_1 = quantifier;
    gensymed_symbol_2 = role;
    gensymed_symbol_3 = domain_designation;
    ...
    Object block, connection_class;
{
    ...
    end_1:
	  ...
	  ab_loopvar__2 = gensym_cons_1(connection_frame_qm,Nil);
	  if (ab_loopvar__1)
	      M_CDR(ab_loopvar__1) = ab_loopvar__2;
	  else
	      ab_loopvar_ = ab_loopvar__2;
    ...
    Object kb_frame, class_description;
{
  ...
  next_loop:
	...
	temp = TRUEP(Nil);
    if (temp) {
	ab_loopvar__2 = gensym_cons_1(attribute_value_qm,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
Object Attribute_items = UNBOUND;
    ...
    Object item, quantifier, role, domain_designation;
{
    ...
    Object current_attribute_cons, attribute, next_attribute_cons;
    Object cdr_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;

    x_note_fn_call(150,132);
    frames_to_serve = Nil;
	...
	temp = TRUEP(Nil);
    temp_1 = temp ? copy_list_using_gensym_conses_1(ISVREF(item,
	    (SI_Long)18L)) : Nil;
  ...
  next_loop:
	...
	inline_note_reclaim_cons(current_attribute_cons,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(current_attribute_cons) = cdr_new_value;
	Available_gensym_conses = current_attribute_cons;
    }
    ...
    Object role, domain;
{
	...
	if (temp) {
	    ab_loopvar__2 = gensym_cons_1(FIXNUMP(value) || value && 
	...
	value_qm = frame_or_evaluation_value_user_attribute_value(domain,
		slot_name,Nil);
	reclaim_gensym_cons_1(slot_name_and_value);
    ...
    Object role, domain;
{
    ...
    Object ab_loopvar__1, ab_loopvar__2, val_to_serve, rest_qm, temp, x2, x;
    Object class_or_frame, ab_loopvar__3, ab_loopvar__4;
    Object tail_of_slot_descriptions, temp_1;
    SI_Long next_index, length_1;
    char temp_2;

    x_note_fn_call(150,137);
	...
	if ( !TRUEP(gensymed_symbol))
		...
		inline_note_reclaim_cons(gensymed_symbol,Qab_gensym);
		temp = Available_gensym_conses;
	...
	if (gensymed_symbol && ISVREF(gensymed_symbol,(SI_Long)16L)) {
	  ...
	  next_loop_2:
	    ...
	    ab_loopvar__4 = gensym_cons_1(x,Nil);
	    if (ab_loopvar__3)
    ...
    Object role, domain;
{
    ...
    Object name_to_slot_description_alist, entry_cons, alist_entry;
    SI_Long next_index, length_1;

    x_note_fn_call(150,139);
    if (CONSP(domain) && EQ(M_CDR(domain),Qab_structure)) {
	structure = domain;
	gensymed_symbol = structure;
	held_vector = Nil;
	...
	reclaim_gensym_cons_1(alist_entry);
    ...
    Object role, item, attribute_name;
{
    ...
    Object coerced_value_qm, gensym_list, gensym_list_tail, gensym_cons;
    Object cdr_new_value;

    x_note_fn_call(150,142);
    attribute = attribute_name;
    if (unauthorized_system_slot_p(attribute))
	return VALUES_3(Nil,Nil,Nil);
    else {
	class_qm = CONSP(role) ? SECOND(role) : Nil;
	class_type_spec = gensym_list_2(Qab_class,class_qm);
	...
	gensym_list = class_type_spec;
	gensym_list_tail = M_CDR(class_type_spec);
    ...
    Object role, domain;
{
    ...
    x_note_fn_call(150,147);
    gensymed_symbol = ISVREF(domain,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    ws = gensymed_symbol;
    ...
    Object workspace, quantifier, role, domain_designation;
{
	...
	if (EQ(ab_next_queue_element_,ab_queue_form_))
	    goto end_loop;
	frame = ISVREF(ab_next_queue_element_,(SI_Long)2L);
	ab_next_queue_element_ = ISVREF(ab_next_queue_element_,(SI_Long)0L);
	if (ISVREF(ISVREF(frame,(SI_Long)1L),(SI_Long)16L) && 
		serve_item_p(frame) && 
		designation_could_denote_item_p(domain_designation,frame)) {
	    ab_loopvar__1 = gensym_cons_1(frame,Nil);
	    if (ab_loopvar_)
    ...
    Object item, quantifier, role, domain_designation;
{
	...
	if (temp);
	    ...
	    gensymed_symbol = ISVREF(kb_workspace_qm,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    ab_queue_form_ = gensymed_symbol;
	    ab_next_queue_element_ = Nil;
...
Object serve_first_superior_class(role,domain)
    Object role, domain;
{
    Object class_name, temp, system_class_p_qm, superior_classes_qm;
    ...
    Object ab_loopvar__2, val_to_serve, rest_qm, temp_3;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;

    x_note_fn_call(150,158);
    class_name = domain;
  ...
  next_loop_8:
    ...
    class_1 = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp_2 =  !TRUEP(system_class_p_qm);
    if (temp_2);
    else {
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = class_1;
    ...
    if (temp_2) {
	ab_loopvar__2 = gensym_cons_1(class_1,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
  ...
  end_17:;
	...
	rest_qm = M_CDR(gensymed_symbol);
	if (rest_qm) {
	    temp_3 = SYMBOL_FUNCTION(Qserve_next_evaluation_value);
	    M_CAR(gensymed_symbol) = temp_3;
	    return VALUES_3(val_to_serve,gensymed_symbol,Qnever);
	}
	else {
	    inline_note_reclaim_cons(gensymed_symbol,Qab_gensym);
	    temp_3 = Available_gensym_conses;
	    M_CDR(gensymed_symbol) = temp_3;
	    Available_gensym_conses = gensymed_symbol;
	    return VALUES_3(val_to_serve,Nil,Qnever);
	}
    }
    ...
    Object role, domain;
{
    ...
    Object val_to_serve, rest_qm, temp;

    x_note_fn_call(150,160);
    class_name = domain;
    inferior_classes_qm = 
	    lookup_global_or_kb_specific_property_value(class_name,
    ...
    Object role, domain;
{
	...
	if (temp)
		...
		if (sub_class_vector_index < 
		    ...
		    temp = TRUEP(Nil);
		if (temp) {
		    ab_loopvar__2 = gensym_cons_1(instance,Nil);
		    if (ab_loopvar__1)
			M_CDR(ab_loopvar__1) = ab_loopvar__2;
		    else
			ab_loopvar_ = ab_loopvar__2;
		...
		goto next_loop;
	      end_loop:
		reclaim_gensym_list_1(named_instances);
		temp_1 = ab_loopvar_;
		goto end_1;
		temp_1 = Qnil;
	      end_1:;
...
Object serve_first_related(role,domain)
    Object role, domain;
{
    Object class_1, class_description, given_name, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, unfiltered_related_items;
    Object scope_conses, ab_node_stack_, ab_current_node_, ab_skip_list_form_;
    Object ab_binary_tree_form_, temp, ab_skip_list_p_, ab_next_node_;
    Object ab_tail_node_, ab_current_alist_, ab_entry_cons_, item, result_1;
    Object ab_loopvar_, ab_loopvar__1, ab_less_than_branch_qm_;
    Object sub_class_bit_vector;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_1;
	...
	if (gensymed_symbol) {
	    gensymed_symbol = CDR(gensymed_symbol);
	    gensymed_symbol_1 = given_name;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(given_name) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
    ...
    Object item, quantifier, role, domain_designation;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, subject_unfiltered_list;
    Object temp_1, scope_conses, ab_node_stack_, ab_current_node_;
    ...
    Object ab_less_than_branch_qm_, item_2, result_1, ab_loopvar_;
    Object ab_loopvar__1, relation_instances, relation_instance;
    Object forward_instances, ab_node_stack__1, ab_current_node__1;
    Object ab_skip_list_p__1, ab_next_node__1, ab_tail_node__1;
    Object ab_current_alist__1, ab_entry_cons__1, possible_unique_item;
    Object item_list, ab_loopvar__2, ab_node_stack__2, ab_current_node__2;
    Object ab_skip_list_p__2, ab_next_node__2, ab_tail_node__2;
    Object ab_current_alist__2, ab_entry_cons__2, the_only_item;
    Object sub_class_bit_vector;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp;
	...
	if (gensymed_symbol) {
	    gensymed_symbol = CDR(gensymed_symbol);
	    gensymed_symbol_1 = other_name;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(other_name) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
	...
	subject_unfiltered_list = Nil;
    temp =  !TRUEP(subject_unfiltered_list);
    if (temp);
    else {
	...
	if (temp) {
	    ...
	    temp = EQ(ISVREF(ISVREF(M_CAR(gensymed_symbol),(SI_Long)0L),
		    (SI_Long)0L),M_CDR(gensymed_symbol));
	}
	else
	    temp =  !TRUEP(M_CDR(subject_unfiltered_list));
	if (temp);
	else {
	    scope_conses = Scope_conses;
	    ab_node_stack_ = Nil;
	...
	next_loop_4:
	  ...
	  if (serve_item_p(item_2) && 
	      ...
	      ab_loopvar__1 = gensym_cons_1(item_2,Nil);
	      if (ab_loopvar_)
		  M_CDR(ab_loopvar_) = ab_loopvar__1;
	      else
		  result_1 = ab_loopvar__1;
	...
	ab_entry_cons_ = Nil;
	item_2 = Nil;
	PUSH_SPECIAL(Scope_conses,scope_conses,2);
	  result_1 = Nil;
	  ab_loopvar_ = Nil;
	  ab_loopvar__1 = Nil;
	  if (ab_skip_list_p_) {
		...
		next_loop_8:
		  ...
		  if (gensymed_symbol_2 < gensymed_symbol_3)
		    ...
		    next_loop_9:
		      ...
		      gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
		      if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
			  relation_instance = M_CDR(M_CAR(gensymed_symbol));
			  goto end_5;
		      }
		      gensymed_symbol = M_CDR(gensymed_symbol);
		      goto next_loop_9;
		    end_loop_9:
		      relation_instance = Qnil;
		    end_5:;
		      goto end_6;
		  }
		  goto next_loop_8;
		  ...
		  if (relation_instance) {
			  ...
			  PUSH_SPECIAL(Scope_conses,scope_conses,1);
				...
				next_loop_10:
				  if (ab_current_alist__2) {
					  ...
					  ab_next_node__2 = 
						  ISVREF(ISVREF(ab_current_node__2,
						  (SI_Long)0L),(SI_Long)0L);
			  ...
			  next_loop_12:
				...
				if (ab_next_node__1) {
				    ...
				    ab_next_node__1 = 
					    ISVREF(ISVREF(ab_current_node__1,
					    (SI_Long)0L),(SI_Long)0L);
				    if (EQ(ab_next_node__1,ab_tail_node__1))
					ab_next_node__1 = Nil;
				    ab_entry_cons__1 = 
			    ...
			    if (temp ? 
				    ...
				    : TRUEP(Nil)) {
				ab_loopvar__2 = 
					gensym_cons_1(possible_unique_item,
					Nil);
				if (ab_loopvar__1)
				    M_CDR(ab_loopvar__1) = ab_loopvar__2;
				else
    ...
    Object value_to_check, quantifier, role, domain;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, related_items;
    Object sub_class_bit_vector, scope_conses, ab_node_stack_;
    Object ab_current_node_, ab_skip_list_form_, ab_binary_tree_form_, temp_1;
    Object ab_skip_list_p_, ab_next_node_, ab_tail_node_, ab_current_alist_;
    Object ab_entry_cons_, item, ab_less_than_branch_qm_;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp;
    Declare_special(1);

    x_note_fn_call(150,173);
    ...
    if (gensymed_symbol) {
	gensymed_symbol = CDR(gensymed_symbol);
	gensymed_symbol_1 = relation_name;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(relation_name) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
	...
	if (EQ(quantifier,Qthe)) {
		...
		end_3:;
		POP_SPECIAL();
		temp = EQ(temp_1,value_to_check);
	    }
	    else
		temp = TRUEP(Nil);
	    temp_1 = temp ? only_one_related_item_p(related_items) : Nil;
	}
	else
	    temp_1 = Nil;
	if (temp_1)
	    ...
	    gensymed_symbol = CDR(related_items);
	    gensymed_symbol_1 = value_to_check;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(value_to_check) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_4:
	    if ( !TRUEP(gensymed_symbol))
    ...
    Object role, g2_list_or_sequence_qm;
{
	...
	if (desired_list_type_qm) {
		...
		class_type_spec = gensym_list_2(Qab_class,Nil);
	...
	if (EQ(element_position,Qfirst_of_list) || EQ(element_position,
	  ...
	  end_1:;
	    ...
	    result_1 = Qnil;
	reclaim_gensym_list_1(class_type_spec);
	if (result_1) {
    ...
    Object item, quantifier, role, domain_designation;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	g2_list = ISVREF(g2_list_element_structure,(SI_Long)3L);
	...
	if (element_qm && EQ(item,element_qm) &&  
	    ...
	    ab_loopvar__1 = gensym_cons_1(g2_list,Nil);
	    if (ab_loopvar_)
		M_CDR(ab_loopvar_) = ab_loopvar__1;
	    else
		result_1 = ab_loopvar__1;
    ...
    Object item_or_value, index_value, top_of_stack, signal_errors_qm;
{
	...
	if ( !temp_1) {
		...
		if ( !(FIXNUMP(index_value) && IFIX(index_value) >= 
		    ...
		    managed_float_array = ISVREF(item_or_value,(SI_Long)23L);
		    amf_available_array_cons_qm = 
...
Object serve_first_element_iterator(role,domain)
    Object role, domain;
{
    Object desired_element_type, element_type, sub_class_bit_vector;
    ...
    Object kb_specific_value, resulting_value, g2_list_structure_qm;
    Object structure_head, next_element, skip_element_test_qm;
    Object item_or_value_to_serve, x2, continuation, svref_new_value;
	...
	if (temp) {
		...
		if (SYMBOLP(desired_element_type)) {
		    gensymed_symbol_3 = CDR(Symbol_properties_table);
		    gensymed_symbol_4 = desired_element_type;
		    gensymed_symbol = 
		...
		structure_head = ISVREF(g2_list_structure_qm,(SI_Long)0L);
		next_element = ISVREF(structure_head,(SI_Long)0L);
		skip_element_test_qm = 
			g2_list_or_array_type_ok_p(desired_element_type,
			element_type,Nil);
		if (EQ(next_element,g2_list_structure_qm)) {
		    ...
		    continuation = 
			    gensym_cons_1(SYMBOL_FUNCTION(Qserve_remaining_list_elements),
			    gensym_cons_1(structure_head,
			    skip_element_test_qm ? Nil : 
			    desired_element_type));
		    svref_new_value = gensym_cons_1(continuation,
			    ISVREF(domain,(SI_Long)23L));
		    ISVREF(domain,(SI_Long)23L) = svref_new_value;
		...
		if ( 
			...
			continuation = 
				gensym_cons_1(SYMBOL_FUNCTION(Qserve_remaining_g2_array_elements),
				gensym_cons_1(domain,
				gensym_cons_1(FIX((SI_Long)0L),
				skip_element_test_qm ? Nil : 
				desired_element_type)));
    ...
    Object sequence, desired_element_type;
{
    ...
    Object gensym_list, gensym_list_tail, gensym_cons, cdr_new_value, temp_1;
    SI_Long next_index, length_1;

    x_note_fn_call(150,199);
    temp = copy_frame_serial_number(Current_frame_serial_number);
    class_spec = gensym_list_2(Qab_class,desired_element_type);
    type_spec = 
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(FIXNUMP(elt_1) || elt_1 && 
    ...
    goto next_loop;
  end_loop:
    gensym_list = class_spec;
    gensym_list_tail = M_CDR(class_spec);
    if (gensym_list &&  !((SI_Long)0L == inline_debugging_consing())) {
	gensym_cons = gensym_list;
      next_loop_1:
	inline_note_reclaim_cons(gensym_cons,Qab_gensym);
  ...
  end_2:;
    return serve_next_evaluation_sequence_value(T,
	    gensym_cons_1(SYMBOL_FUNCTION(Qserve_next_evaluation_sequence_value),
	    gensym_cons_1(temp,temp_1)));
}
    ...
    Object role, item;
{
	...
	if (temp ?  !TRUEP(memq_function(g2_list,
	    ...
	    list_of_g2_lists_to_return = gensym_cons_1(g2_list,
    ...
    Object item, quantifier, role, domain_designation;
{
	...
	if ( !temp)
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    comparison_list = ISVREF(element,(SI_Long)3L);
	...
	if (class_qm && is_list) {
	  ...
	  next_loop_1:
		...
		goto end_loop_1;
	    element = ISVREF(ab_loopvar__1,(SI_Long)2L);
    ...
    Object continue_qm, continuation;
{
    ...
    Object g2_list_frame_p_qm, temp, gensym_cons, g2_list_frame;
	...
	if ( !TRUEP(element_structure_or_list_cons))
	    ...
	    frame_qm = ISVREF(element_structure_or_list_cons,(SI_Long)3L);
	if (frame_qm) {
	...
	if (g2_list_frame_p_qm) {
	    temp = delete_gensym_element_1(continuation,ISVREF(frame_qm,
		    (SI_Long)23L));
	    ISVREF(frame_qm,(SI_Long)23L) = temp;
	}
	if (CONSP(element_structure_or_list_cons))
	    reclaim_gensym_list_1(element_structure_or_list_cons);
	if (continuation &&  !((SI_Long)0L == inline_debugging_consing())) {
	    gensym_cons = continuation;
	  next_loop:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	...
	temp = Available_gensym_conses;
	M_CDR(second_cons) = temp;
	Available_gensym_conses = continuation;
	return VALUES_3(Nil,Nil,Nil);
    }
    else if (element_structure_or_list_cons) {
	g2_list_frame = ISVREF(element_structure_or_list_cons,(SI_Long)3L);
	...
	item_or_value_to_serve = ISVREF(element_structure_or_list_cons,
		(SI_Long)2L);
	next_element_structure = ISVREF(element_structure_or_list_cons,
		(SI_Long)0L);
	...
	if (temp_1) {
	    ...
	    serve_item_or_value_p_qm = Nil;
	if (EQ(next_element_structure,list_structure))
	    goto end_loop_1;
	...
	item_or_value_to_serve = ISVREF(next_element_structure,(SI_Long)2L);
	next_element_structure = ISVREF(next_element_structure,(SI_Long)0L);
	goto next_loop_1;
      end_loop_1:
	temp = delete_gensym_element_1(continuation,ISVREF(g2_list_frame,
		(SI_Long)23L));
    ...
    Object continue_qm, continuation;
{
    ...
    Object gensym_list, gensym_list_tail, gensym_cons, cdr_new_value;
    ...
    possible_item_element_p_qm = 
	    g2_list_or_array_element_type_may_contain_item_p(element_type);
    if ( !TRUEP(continue_qm)) {
	gensym_list = continuation;
	gensym_list_tail = CDDR(continuation);
	if (gensym_list &&  !((SI_Long)0L == inline_debugging_consing())) {
	    gensym_cons = gensym_list;
	  next_loop:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	...
	PUSH_SPECIAL(Current_index,current_index,0);
	  following_index = Nil;
    ...
    Object role, attribute_value;
{
    ...
    Object class_description_qm, temp_1, gensymed_symbol_2, gensymed_symbol_4;
    Object parent_and_class_tree_qm, scope_conses, ab_node_stack_;
    Object ab_current_node_, ab_next_node_qm_, ab_current_alist_;
    Object ab_entry_cons_, hashed_item, defining_classes, slot_description_qm;
    Object defining_class_of_attribute_qm, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, ab_less_than_branch_qm_, sub_class_bit_vector;
    Object item_or_item_list, item, ab_loop_list_;
    SI_Long gensymed_symbol_1, temp, gensymed_symbol_3;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5;
    char temp_2;
    Declare_special(1);

    x_note_fn_call(150,207);
    gensymed_symbol = role;
    gensymed_symbol = CDR(gensymed_symbol);
	...
	gensymed_symbol_2 = indexed_attribute_value_qm;
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
	    goto end_loop;
	...
	if (gensymed_symbol_1 < gensymed_symbol_3)
	  ...
	  next_loop_1:
		...
		goto end_loop_1;
	    gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
	    if (evaluation_value_equal_p(gensymed_symbol_2,
			gensymed_symbol_4)) {
		parent_and_class_tree_qm = M_CDR(M_CAR(gensymed_symbol));
		goto end_1;
	    }
	    gensymed_symbol = M_CDR(gensymed_symbol);
	    goto next_loop_1;
	  end_loop_1:
	    parent_and_class_tree_qm = Qnil;
	  end_1:;
	    goto end_2;
	}
	goto next_loop;
	...
	if (parent_and_class_tree_qm) {
	    ...
	    ab_node_stack_ = Nil;
	    ab_current_node_ = Nil;
	    ab_next_node_qm_ = parent_and_class_tree_qm;
	    ab_current_alist_ = Nil;
	    ab_entry_cons_ = Nil;
	    hashed_item = Nil;
	    ...
	    next_loop_2:
		  ...
		  ab_loopvar__2 = gensym_cons_1(hashed_item,Nil);
		  if (ab_loopvar__1)
		      M_CDR(ab_loopvar__1) = ab_loopvar__2;
		  else
		      ab_loopvar_ = ab_loopvar__2;
	...
	if ( !TRUEP(item_or_item_list))
		...
		temp_2 = TRUEP(Nil);
	    temp_1 = temp_2 ? gensym_cons_1(item_or_item_list,Nil) : Nil;
	}
	else {
	    item = Nil;
...
{
    x_note_fn_call(150,214);
    return decache_roles_for_all_items();
}

Object Unique_value_roles = UNBOUND;
    ...
    Object top_of_stack, role_constant, no_item_allowed_p, item_qm;
{
    ...
    Object scope_conses, ab_node_stack_, ab_current_node_, ab_skip_list_form_;
    Object ab_binary_tree_form_, temp, ab_skip_list_p_, ab_next_node_;
    Object ab_tail_node_, ab_current_alist_, ab_entry_cons_, item_2;
    Object ab_less_than_branch_qm_, sub_class_bit_vector, top_of_stack_1;
    Object text_string, snapshots, snapshots_of_related_blocks;
    Object note_blocks_in_tformat, current_wide_string_list, wide_string_bv16;
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    ...
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5, bv16_length, aref_arg_2;
    SI_Long aref_new_value, length_1;
    char filter_of_items_not_needed_qm, temp_1;
    Declare_special(8);

    x_note_fn_call(150,221);
	...
	if (unfiltered_related_items) {
	    ...
	    next_loop_2:
		  ...
		  temp_1 = filter_of_items_not_needed_qm;
		  if (temp_1);
		  else {
	...
	if (unfiltered_related_items) {
	    ...
	    ab_entry_cons_ = Nil;
	    item_2 = Nil;
	    PUSH_SPECIAL(Scope_conses,scope_conses,7);
	      if (ab_skip_list_p_) {
		  ab_next_node_ = 
			  ISVREF(ISVREF(M_CAR(M_CDR(ab_skip_list_form_)),
			  (SI_Long)0L),(SI_Long)0L);
    ...
    Object top_of_stack, role_constant, no_item_allowed_p, array, index_1;
{
    ...
    Object temp, svref_new_value, amf_result, incff_1_arg, new_float;
    double aref_new_value;

    x_note_fn_call(150,228);
    length_1 = ISVREF(array,(SI_Long)20L);
    float_value_qm = Nil;
    if (IFIX(index_1) < (SI_Long)0L || FIXNUM_GE(index_1,length_1)) {
	raw_stack_error_named_error(top_of_stack,
    ...
    Object top_of_stack, role_constant, no_item_allowed_p, array, index_1;
{
	...
	if (IFIX(index_1) < (SI_Long)0L || FIXNUM_GE(index_1,length_1)) {
		...
		if (EQ(ISVREF(array,(SI_Long)21L),Qtruth_value)) {
			...
			value_qm = gensym_cons_1(value_qm,Qtruth_value);
		}
		else
...
void roles_INIT()
{
    ...
    Object list_constant_2, Qnext_procedure_method, list_constant_5;
    Object list_constant_38, Qclass_qualified_method, Qab_method;
    Object Qclass_qualified_name_frame_or_place_reference, list_constant_37;
    Object list_constant_31, Qelement_frame_or_place_reference;
    Object list_constant_36, list_constant_35, list_constant_34;
    Object list_constant_33, list_constant_18, list_constant_22, Qab_or;
    Object list_constant_30, Qattribute_frame_or_place_reference;
    Object list_constant_32, list_constant_6, list_constant_4;
    Object Qplace_reference, Qindexed_attribute, list_constant_29;
    Object Qmember_iterator, Qelement_iterator, list_constant_28;
    Object list_constant_27, list_constant_26, list_constant_19;
    Object list_constant_25, list_constant_24, list_constant_23, Qg2_array;
    Object Qitem_or_value, Qrole_and_designation_print_nth_element;
    Object list_constant_21, list_constant_20, Qg2_list;
    ...
    Object Qsuperior_class, Qthis_window, Qupon, list_constant_17;
    Object list_constant_16, Qworkspace, Qattribute_value, list_constant_15;
    Object list_constant_14, list_constant_11;
    Object Qrole_and_designation_print_attribute_value, Qattribute_names;
    Object list_constant_13, Quser_attribute_names, Qattribute_of_class;
    Object list_constant_12, Qsuperior_item, Qroles, Qattribute_items;
    Object Qsubworkspace, Qat_either_end, Qat_output_end, Qat_input_end;
    Object Qat_an_output, Qat_an_input, Qat_port, Qcurrent_connection_path;
    Object Qconnections_in_connection_paths, list_constant_10, Qloose_end;
    Object list_constant_9, Qconnection_post, Qinvisible_entity;
    ...
    Object Qicon_color, Qnearest, Qnamed_by_debugging_name, list_constant_8;
    Object list_constant_7, list_constant_3, Qslot_value_reclaimer;
    Object Qreclaim_role_cache_value, Qrole_caching_enabled_qm;
    Object Qthere_exists_p, G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qthings_that_affect_this_formula;
    Object Qnote_things_encountered_during_role_service_qm;

    x_note_fn_call(150,232);
    SET_PACKAGE("AB");
    ...
    list_constant_3 = STATIC_LIST((SI_Long)7L,Qconnected_to,Qat_an_input,
	    Qat_an_output,Qat_port,Qat_input_end,Qat_output_end,
	    Qat_either_end);
    if (List_of_connection_roles == UNBOUND)
	List_of_connection_roles = list_constant_3;
    ...
    mutate_global_property(Qname,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qnamed_by,list_constant_6,
	    Qrequired_domain_types_of_role);
    ...
    list_constant_7 = STATIC_LIST((SI_Long)3L,Qab_or,Qsymbol,Qtext);
    list_constant_8 = STATIC_CONS(list_constant_7,Qnil);
    mutate_global_property(Qnamed_by_debugging_name,list_constant_8,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qnearest,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qicon_color,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qitem_color,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qitem_x_position,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qitem_y_position,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qicon_heading,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qitem_width,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qitem_height,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qsystem_attribute,Qitem_or_datum,
	    Qdefined_type_of_role);
    mutate_global_property(Qsystem_attribute,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qsystem_attribute_as_text,Qtext,
	    Qdefined_type_of_role);
    mutate_global_property(Qsystem_attribute_as_text,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qtext_of_attribute,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_9 = STATIC_LIST((SI_Long)3L,Qdefault_junction,
	    Qinvisible_entity,Qconnection_post);
    Transparent_classes_for_schematic_search = list_constant_9;
    Qloose_end = STATIC_SYMBOL("LOOSE-END",AB_package);
    list_constant_10 = STATIC_CONS(Qloose_end,Qnil);
    Classes_to_ignore_for_schematic_search = list_constant_10;
    ...
    mutate_global_property(Qconnected_to,serve_first_connected_to_1,
	    Qrole_server);
    mutate_global_property(Qconnected_to,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qat_port,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qat_an_input,serve_first_at_an_input_1,
	    Qrole_server);
    mutate_global_property(Qat_an_input,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qat_an_output,serve_first_at_an_output_1,
	    Qrole_server);
    mutate_global_property(Qat_an_output,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qat_input_end,serve_first_at_input_end_1,
	    Qrole_server);
    mutate_global_property(Qat_input_end,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qat_output_end,serve_first_at_output_end_1,
	    Qrole_server);
    mutate_global_property(Qat_output_end,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qat_either_end,serve_first_at_either_end_1,
	    Qrole_server);
    mutate_global_property(Qat_either_end,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qsubworkspace,serve_first_subworkspace_1,
	    Qrole_server);
    mutate_global_property(Qsubworkspace,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qsuperior_item,serve_first_superior_item_1,
	    Qrole_server);
    mutate_global_property(Qsuperior_item,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_12 = STATIC_LIST_STAR((SI_Long)3L,Qab_or,
	    list_constant_11,list_constant_5);
    list_constant_13 = STATIC_CONS(list_constant_12,Qnil);
    mutate_global_property(Qattribute_of_class,list_constant_13,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Quser_attribute_names,Qsymbol,
	    Qdefined_type_of_role);
    mutate_global_property(Quser_attribute_names,list_constant_13,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qattribute_names,list_constant_13,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qattribute_value,serve_first_attribute_value_1,
	    Qrole_server);
    list_constant_14 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_4,
	    list_constant_11);
    list_constant_15 = STATIC_CONS(list_constant_14,list_constant_6);
    mutate_global_property(Qattribute_value,list_constant_15,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qclass_qualified_name,Qitem_or_datum,
	    Qdefined_type_of_role);
    mutate_global_property(Qclass_qualified_name,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qworkspace,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    list_constant_16 = STATIC_LIST((SI_Long)2L,Qab_class,Qkb_workspace);
    list_constant_17 = STATIC_CONS(list_constant_16,Qnil);
    mutate_global_property(Qupon,list_constant_17,
	    Qrequired_domain_types_of_role);
    ...
    mutate_global_property(Qsuperior_class,list_constant_6,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qinferior_class,list_constant_6,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qclass_instances_named_by,list_constant_6,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qrelated,list_constant_5,
	    Qrequired_domain_types_of_role);
    ...
    list_constant_18 = STATIC_LIST((SI_Long)2L,Qab_class,Qg2_list);
    list_constant_19 = STATIC_CONS(Qsequence,Qnil);
    list_constant_20 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_18,
	    list_constant_19);
    list_constant_21 = STATIC_CONS(list_constant_20,Qnil);
    mutate_global_property(Qfirst_of_list,list_constant_21,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qsecond_of_list,serve_first_second_of_list_1,
	    Qrole_server);
    mutate_global_property(Qsecond_of_list,list_constant_21,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qnext_to_last_of_list,list_constant_21,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qlast_of_list,serve_first_last_of_list_1,
	    Qrole_server);
    mutate_global_property(Qlast_of_list,list_constant_21,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_22 = STATIC_LIST((SI_Long)2L,Qab_class,Qg2_array);
    list_constant_23 = STATIC_CONS(Qtext,Qnil);
    list_constant_24 = STATIC_LIST_STAR((SI_Long)5L,Qab_or,
	    list_constant_22,list_constant_18,list_constant_19,
	    list_constant_23);
    list_constant_25 = STATIC_LIST((SI_Long)2L,list_constant_24,Qinteger);
    mutate_global_property(Qnth_element,list_constant_25,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_26 = STATIC_CONS(list_constant_19,Qnil);
    list_constant_27 = STATIC_LIST_STAR((SI_Long)4L,Qab_or,
	    list_constant_18,list_constant_22,list_constant_26);
    list_constant_28 = STATIC_CONS(list_constant_27,Qnil);
    mutate_global_property(Qelement_iterator,list_constant_28,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qmember_iterator,serve_first_member_iterator_1,
	    Qrole_server);
    mutate_global_property(Qmember_iterator,list_constant_18,
	    Qdefined_type_of_role);
    mutate_global_property(Qmember_iterator,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_29 = STATIC_CONS(Qdatum,Qnil);
    mutate_global_property(Qindexed_attribute,list_constant_29,
	    Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_30 = STATIC_CONS(Qplace_reference,Qnil);
    list_constant_31 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_4,
	    list_constant_30);
    mutate_global_property(Qattribute_frame_or_place_reference,
	    list_constant_31,Qdefined_type_of_role);
    list_constant_32 = STATIC_CONS(list_constant_31,list_constant_6);
    mutate_global_property(Qattribute_frame_or_place_reference,
	    list_constant_32,Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qelement_frame_or_place_reference,
	    list_constant_31,Qdefined_type_of_role);
    list_constant_33 = STATIC_CONS(list_constant_30,Qnil);
    list_constant_34 = STATIC_LIST_STAR((SI_Long)4L,Qab_or,
	    list_constant_22,list_constant_18,list_constant_33);
    list_constant_35 = STATIC_CONS(Qinteger,Qnil);
    list_constant_36 = STATIC_CONS(list_constant_34,list_constant_35);
    mutate_global_property(Qelement_frame_or_place_reference,
	    list_constant_36,Qrequired_domain_types_of_role);
    if ( 
    ...
    mutate_global_property(Qclass_qualified_name_frame_or_place_reference,
	    list_constant_31,Qdefined_type_of_role);
    list_constant_37 = STATIC_CONS(list_constant_31,Qnil);
    mutate_global_property(Qclass_qualified_name_frame_or_place_reference,
	    list_constant_37,Qrequired_domain_types_of_role);
    if ( 
    ...
    list_constant_38 = STATIC_LIST((SI_Long)2L,Qab_class,Qab_method);
    mutate_global_property(Qclass_qualified_method,list_constant_38,
	    Qdefined_type_of_role);
    ...
    mutate_global_property(Qnext_procedure_method,list_constant_38,
	    Qdefined_type_of_role);
    mutate_global_property(Qnext_procedure_method,list_constant_5,
	    Qrequired_domain_types_of_role);
    if ( 
