...
Object Chain_of_available_item_access_caches = UNBOUND;

Object Item_access_cache_count = UNBOUND;
    ...
    Object item_access_cache;
{
    ...
    svref_new_value = Chain_of_available_item_access_caches;
    SVREF(item_access_cache,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_item_access_caches = item_access_cache;
    return VALUES_1(Nil);
}
...
Object make_permanent_item_access_cache_structure_internal()
{
    ...
    Object item_access_cache_count_new_value;
    ...
    item_access_cache_count_new_value = FIXNUM_ADD1(Item_access_cache_count);
    Item_access_cache_count = item_access_cache_count_new_value;
...
Object Denotation_size_vector = UNBOUND;

Object Current_conclude_innermost_attribute_description = UNBOUND;

Object The_denotation_conversion_buffer = UNBOUND;
    ...
    Object root, denotation, index_1;
{
    ...
    x_note_fn_call(192,44);
    event_name = ISVREF(denotation,(SI_Long)2L + IFIX(index_1));
    return VALUES_2(Nil,T);
}

Object Comp_trace_level = UNBOUND;
    ...
    Object icp_socket_qm, frame, denotation, callback, user_data_value;
{
	...
	if (temp_1);
	    ...
	    temp_1 = Local_pseudo_socket;
	svref_new_value = gensym_list_4(Qsocket,temp_1,Qsession_id,
...
Object denotation_gt_denotation_sequence varargs_1(int, n)
{
  ...
  next_loop:
    ...
    sequence_elements = gensym_cons_1(temp,sequence_elements);
...
Object Current_conclude_frame_list = UNBOUND;

Object Current_conclude_innermost_frame = UNBOUND;

Object Current_conclude_innermost_item_index = UNBOUND;

Object Current_subscribe_innermost_class = UNBOUND;

Object Current_subscribe_innermost_item_index = UNBOUND;
    ...
    Object frame_or_class_description, denotation;
{
    ...
    x_note_fn_call(192,51);
    SAVE_STACK();
    current_subscribe_innermost_class = Nil;
    PUSH_SPECIAL(Current_subscribe_innermost_class,current_subscribe_innermost_class,
	    1);
      current_subscribe_innermost_item_index = Nil;
      PUSH_SPECIAL(Current_subscribe_innermost_item_index,current_subscribe_innermost_item_index,
	      0);
    ...
    Object item, denotation_sequences;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(g2_get_from_item(item,
    ...
    Object allow_batched_update_ev;
{
	...
	reclaim_gensym_cons_1(allow_batched_update_ev);
    denotation_or_error = 
	    denotation_sequence_gt_denotation(denotation_sequence);
    reclaim_evaluation_value(denotation_sequence);
    if (SIMPLE_VECTOR_P(denotation_or_error) && 
    ...
    Object allow_batched_update;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(g2_subscribe_to_item(item,temp,callback,
    ...
    Object item, attr_spec, callback, user_data;
{
	...
	if ( !SYMBOLP(attr_name) || EQ(attr_name,Qstar)) {
	    ...
	    ab_loopvar__2 = 
		    gensym_cons_1(allocate_evaluation_sequence(gensym_cons_1(gensym_cons_1(gensymed_symbol,
	...
	if (problem_p) {
	  ...
	  next_loop_1:
	    ...
	    goto next_loop_1;
	  end_loop_1:;
	    reclaim_gensym_list_1(new_sequence_contents);
	    if ( !(FIXNUMP(user_data) || SYMBOLP(user_data) || 
		    SIMPLE_VECTOR_P(user_data)))
		reclaim_if_evaluation_value_1(user_data);
	    top_of_stack = Cached_top_of_stack;
    ...
    Object item;
{
  ...
  next_loop:
	...
	temp = TRUEP(Nil);
    if (temp) {
	ab_loopvar__2 = gensym_cons_1(ISVREF(representation,(SI_Long)12L),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object item, denotation;
{
	...
	if (IFIX(end_index) == (SI_Long)0L) {
	  ...
	  next_loop:
		...
		result_list = gensym_cons_1(name,result_list);
		temp = get_attribute_description_evaluation_value(item,
			M_CDR(name_description));
		result_list = gensym_cons_1(temp,result_list);
	    }
	    goto next_loop;
	  end_loop:
    ...
    Object item, denotation, new_value, mutate_p;
{
    ...
    Object representation_and_frame, frame, cdr_new_value;
    Declare_special(3);

    x_note_fn_call(192,88);
    current_conclude_innermost_frame = Nil;
    PUSH_SPECIAL(Current_conclude_innermost_frame,current_conclude_innermost_frame,
	    2);
      current_conclude_frame_list = Qnil;
      PUSH_SPECIAL(Current_conclude_frame_list,current_conclude_frame_list,1);
	current_conclude_innermost_item_index = Nil;
	PUSH_SPECIAL(Current_conclude_innermost_item_index,current_conclude_innermost_item_index,
		0);
	  cache = make_item_access_cache();
	    ...
	    end_loop_2:;
		  ...
		  if (SIMPLE_VECTOR_P(access_error_qm) && 
		    ...
		    next_loop_3:
		      ...
		      M_CDR(representation_and_frame) = cdr_new_value;
		      Available_gensym_conses = representation_and_frame;
		      goto next_loop_3;
		    end_loop_3:;
    ...
    Object item, virtual_attribute, denotation, index_1, new_value;
{
    ...
    Object amf_result, incff_1_arg, new_float, temp_1, value_to_conclude_qm;
    Object block, name, setter_qm, getter_qm, evaluation_value;
    Object replaced_partial_evaluation_value_or_error;
    double aref_new_value;

    x_note_fn_call(192,100);
    end_index = denotation_end_index(denotation);
	...
	if (SIMPLE_VECTOR_P(value_to_conclude_qm) && 
		...
		Qg2_defstruct_structure_name_access_error_g2_struct)) {
	    temp_1 = ISVREF(virtual_attribute,(SI_Long)1L);
	    temp_1 = make_access_error_1(Qtype_mismatch,
		    gensym_list_4(Qattribute,temp_1,Qvalue,
	    ...
	    temp_1 = setter_qm ? inline_funcall_2(setter_qm,block,
	...
	if (aggregate_evaluation_value_p(evaluation_value)) {
	    ...
	    if (SIMPLE_VECTOR_P(replaced_partial_evaluation_value_or_error) 
		    ...
		    (SI_Long)0L),
		    Qg2_defstruct_structure_name_access_error_g2_struct))
		temp_1 = replaced_partial_evaluation_value_or_error;
	    else {
    ...
    Object item, slot_description, denotation, index_1, new_value;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, temp_1, value_to_conclude_qm;
    Object type_specification, type_details, evaluation_value;
    Object replaced_partial_evaluation_value_or_error, new_whole_value;
    char temp_2;
    double aref_new_value;
    Object result;

    x_note_fn_call(192,103);
    end_index = denotation_end_index(denotation);
    if (FIXNUM_EQ(end_index,index_1)) {
	...
	if (SIMPLE_VECTOR_P(value_to_conclude_qm) && 
	    ...
	    M_CAR(gensymed_symbol_1) = temp;
	    temp_1 = make_access_error_1(Qtype_mismatch,gensymed_symbol);
	}
	    ...
	    change_slot_description_value_function(item,slot_description,
		    gensym_list_2(M_CAR(value_to_conclude_qm),
		    Qtruth_value),Nil,Nil);
	    if ( !(EQ(value_to_conclude_qm,Evaluation_true_value) || 
		    EQ(value_to_conclude_qm,Evaluation_false_value)))
		reclaim_gensym_cons_1(value_to_conclude_qm);
	    temp_1 = Nil;
	}
	else
	    temp_1 = change_slot_description_value_function(item,
	...
	if (SYMBOLP(type_specification)) {
	    ...
	    temp_1 = M_CAR(type_specification);
	    if (EQ(temp_1,Qab_or)) {
		if (EQ(M_CAR(type_details),Qitem_or_datum)) {
		    temp_1 = CADR(type_details);
		    temp_2 = EQUAL(temp_1,list_constant_5);
		}
		else
		    temp_2 = TRUEP(Nil);
		if ( !temp_2)
	    ...
	    else if (EQ(temp_1,Qab_structure) || EQ(temp_1,Qsequence));
	    else
		error((SI_Long)2L,
			"unknown type-specification for user attribute conclude ~s",
			type_specification);
...
Object Scratch_attribute_denotation = UNBOUND;
...
Object Scratch_virtual_attribute_denotation = UNBOUND;
...
Object Scratch_variable_value_denotation = UNBOUND;
...
Object Scratch_item_color_pattern_change_denotation = UNBOUND;
...
Object Scratch_custom_event_denotation = UNBOUND;
...
Object Scratch_item_event_denotation = UNBOUND;
...
Object Scratch_add_item_to_workspace = UNBOUND;
...
Object Scratch_remove_item_from_workspace = UNBOUND;
...
void conclude_INIT()
{
    ...
    Object Qitem_access_cache_count, Qchain_of_available_item_access_caches;
    ...
    string_constant_17 = 
	    STATIC_STRING("43Dy8m83jRy1n83jRy8n8k1l8n0000001l1n8y83-4jy0kpk0k0");
    ...
    Qitem_access_cache_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_18 = STATIC_STRING("1q83jRy8s83-aKy09k9l");
