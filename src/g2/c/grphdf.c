...
{
    Object value, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    Object gensymed_symbol;
    double aref_new_value;

    x_note_fn_call(176,1);
	...
	if (FIXNUM_EQ(gensymed_symbol,Truth))
	    ...
	    return gensym_cons_1(gensymed_symbol,Qtruth_value);
    }
    else
    ...
    Object evaluation_value, frame, slot_description, gensymed_symbol;
{
    ...
    Object amf_result, incff_1_arg, new_float, interval_width;
    Object interval_origin_qm;
    SI_int64 aref_new_value;
    double aref_new_value_1;
    Declare_special(5);
    Object result;

    x_note_fn_call(176,45);
    if ( !TRUEP(gensymed_symbol)) {
	value_at_type_failure = Nil;
	type_at_type_failure = Nil;
	reason_for_type_failure = Nil;
    ...
    Object slot_value, frame, slot_description;
{
    ...
    Object new_float, gensymed_symbol_2, svref_new_value;
    SI_Long gensymed_symbol_1, svref_arg_2;
    char temp_2;
    double aref_new_value;
    XDeclare_area(1);
	...
	if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		...
		if (FIXNUM_EQ(gensymed_symbol_2,Truth))
		    ...
		    item_or_value = gensym_cons_1(gensymed_symbol_2,
			    Qtruth_value);
	    }
	    else
    ...
    Object evaluation_value, frame, slot_description, gensymed_symbol;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp_2, svref_new_value;
    Object amf_result, incff_1_arg, new_float, current_wide_string_list;
	...
	if (FIXNUMP(value))
		...
		temp_2 = FIXNUM_ADD1(Created_simple_float_array_pool_arrays);
		Created_simple_float_array_pool_arrays = temp_2;
		incff_1_arg = 
			bytes_per_double_float_simple_array(FIX((SI_Long)1L));
		temp_2 = FIXNUM_ADD(Simple_float_array_pool_memory_usage,
			incff_1_arg);
		Simple_float_array_pool_memory_usage = temp_2;
		amf_result = generate_float_vector(FIX((SI_Long)1L));
	    }
    ...
    Object slot_value, frame, slot_description;
{
    ...
    Object incff_1_arg, new_float, gensymed_symbol_2, x2, svref_new_value;
    SI_Long gensymed_symbol_1, svref_arg_2;
    char temp_3;
    double aref_new_value;

    x_note_fn_call(176,50);
    temp = CAR(slot_value);
    if (EQ(temp,Qnone))
	temp = Nil;
    ...
    Object slot_value, frame, slot_description;
{
    ...
    Object incff_1_arg, new_float, gensymed_symbol_3, x2, svref_new_value;
    Object temp_3;
    SI_Long gensymed_symbol_2, svref_arg_2;
    char temp_2;
    double aref_new_value;

    x_note_fn_call(176,76);
    if (slot_value) {
	...
	if (FIXNUM_LE(ISVREF(gensymed_symbol_1,(SI_Long)1L),
		...
		if (FIXNUM_EQ(gensymed_symbol_3,Truth))
		    ...
		    item_or_value = gensym_cons_1(gensymed_symbol_3,
			    Qtruth_value);
	    }
	    else
		item_or_value = error((SI_Long)2L,
...
Object compile_plot_update_interval_spec_for_slot varargs_1(int, n)
{
	...
	if (EQ(display_interval_parse_result,Bad_phrase))
		...
		return gensym_list_3(Qinterval_with_granularity,
...
Object Chain_of_available_display_panes = UNBOUND;

Object Display_pane_count = UNBOUND;
    ...
    Object display_pane;
{
    ...
    reclaim_gensym_list_1(ISVREF(display_pane,(SI_Long)11L));
    SVREF(display_pane,FIX((SI_Long)11L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_display_panes;
    SVREF(display_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_display_panes = display_pane;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_display_pane_variable, display_pane_count_new_value;
    Object defstruct_g2_display_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,103);
    def_structure_display_pane_variable = Nil;
    display_pane_count_new_value = FIXNUM_ADD1(Display_pane_count);
    Display_pane_count = display_pane_count_new_value;
...
Object Chain_of_available_axis_panes = UNBOUND;

Object Axis_pane_count = UNBOUND;
    ...
    Object axis_pane;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_axis_panes;
    SVREF(axis_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_axis_panes = axis_pane;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_axis_pane_variable, axis_pane_count_new_value;
    Object defstruct_g2_axis_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,110);
    def_structure_axis_pane_variable = Nil;
    axis_pane_count_new_value = FIXNUM_ADD1(Axis_pane_count);
    Axis_pane_count = axis_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_axis_pane_variable;

    x_note_fn_call(176,111);
    def_structure_axis_pane_variable = Chain_of_available_axis_panes;
...
Object Chain_of_available_trend_chart_panes = UNBOUND;

Object Trend_chart_pane_count = UNBOUND;
    ...
    Object trend_chart_pane;
{
    ...
    x_note_fn_call(176,114);
    inline_note_reclaim_cons(trend_chart_pane,Nil);
    old_structure_being_reclaimed = Structure_being_reclaimed;
    Structure_being_reclaimed = trend_chart_pane;
    reclaim_gensym_list_1(ISVREF(trend_chart_pane,(SI_Long)11L));
    SVREF(trend_chart_pane,FIX((SI_Long)11L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_trend_chart_panes;
    SVREF(trend_chart_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_trend_chart_panes = trend_chart_pane;
    return VALUES_1(Nil);
}
...
Object make_permanent_trend_chart_pane_structure_internal()
{
    ...
    Object trend_chart_pane_count_new_value;
    Object defstruct_g2_trend_chart_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,116);
    def_structure_trend_chart_pane_variable = Nil;
    trend_chart_pane_count_new_value = FIXNUM_ADD1(Trend_chart_pane_count);
    Trend_chart_pane_count = trend_chart_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_legend_panes = UNBOUND;

Object Legend_pane_count = UNBOUND;
    ...
    Object legend_pane;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_legend_panes;
    SVREF(legend_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_legend_panes = legend_pane;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_legend_pane_variable, legend_pane_count_new_value;
    Object defstruct_g2_legend_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,122);
    def_structure_legend_pane_variable = Nil;
    legend_pane_count_new_value = FIXNUM_ADD1(Legend_pane_count);
    Legend_pane_count = legend_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_relative_time_panes = UNBOUND;

Object Relative_time_pane_count = UNBOUND;
    ...
    Object relative_time_pane;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_relative_time_panes;
    SVREF(relative_time_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_relative_time_panes = relative_time_pane;
    return VALUES_1(Nil);
}
...
Object make_permanent_relative_time_pane_structure_internal()
{
    ...
    Object relative_time_pane_count_new_value;
    Object defstruct_g2_relative_time_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,128);
    def_structure_relative_time_pane_variable = Nil;
    relative_time_pane_count_new_value = FIXNUM_ADD1(Relative_time_pane_count);
    Relative_time_pane_count = relative_time_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_grid_panes = UNBOUND;

Object Grid_pane_count = UNBOUND;
    ...
    Object grid_pane;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_grid_panes;
    SVREF(grid_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_grid_panes = grid_pane;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_grid_pane_variable, grid_pane_count_new_value;
    Object defstruct_g2_grid_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(176,134);
    def_structure_grid_pane_variable = Nil;
    grid_pane_count_new_value = FIXNUM_ADD1(Grid_pane_count);
    Grid_pane_count = grid_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_grid_pane_variable;

    x_note_fn_call(176,135);
    def_structure_grid_pane_variable = Chain_of_available_grid_panes;
...
Object Current_display_pane_left = UNBOUND;

Object Current_display_pane_top = UNBOUND;

Object Current_display_pane_right = UNBOUND;

Object Current_display_pane_bottom = UNBOUND;

Object Current_display_pane_height = UNBOUND;

Object Current_display_pane_width = UNBOUND;
    ...
    Object display, display_pane;
{
    ...
    x_note_fn_call(176,136);
    display_pane_list = Qnil;
    pane = display_pane;
  next_loop:
    if ( !TRUEP(pane))
	goto end_loop;
    display_pane_list = gensym_cons_1(pane,display_pane_list);
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(display_pane_list);
    ...
    Object frame, new_value, gensymed_symbol;
{
    ...
    Object ab_loop_list_, ab_loop_it_, temp_1, gensym_pop_store, cons_1;
    Object next_cons;
    SI_Long svref_new_value;
    char temp;
    Declare_special(1);

    x_note_fn_call(176,149);
	...
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(frame,
    ...
    Object trend_chart, slot_component_group_or_name, note_type, add_p;
{
	...
	current_computation_component_particulars = 
		gensym_list_4(Qslot_component,slot_name,Nil,indicator);
    ...
    Object expand_inherited_slots_p, multiple_p;
{
    ...
    x_note_fn_call(176,165);
    indicator = CAR(slot_component_group);
    slot_component_name_for_names = ISVREF(compound_type_descriptor,
	    (SI_Long)4L);
    reversed_plist = multiple_p ? gensym_list_2(indicator,
	...
	if (add_attribute_to_struct_p) {
		...
		if (slot_component_value)
		    evaluation_value = CONSP(slot_component_value) ? 
			    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(slot_component_value)) 
	    ...
	    if (add_attribute_to_struct_p) {
		reversed_plist = gensym_cons_1(best_slot_component_name,
			reversed_plist);
		reversed_plist = gensym_cons_1(evaluation_value,
			reversed_plist);
	    }
	}
    }
...
void graph_def_INIT()
{
    ...
    Object Qgrid_pane_structure_memory_usage, Qutilities2, Qgrid_pane_count;
    Object Qchain_of_available_grid_panes, string_constant_129;
    ...
    Object Qrelative_time_pane_structure_memory_usage;
    Object Qrelative_time_pane_count, Qchain_of_available_relative_time_panes;
    Object string_constant_127, string_constant_126, Qlegend_pane;
    Object Qoutstanding_legend_pane_count, Qlegend_pane_structure_memory_usage;
    Object Qlegend_pane_count, Qchain_of_available_legend_panes;
    Object string_constant_125, string_constant_124, Qtrend_chart_pane;
    Object Qoutstanding_trend_chart_pane_count;
    Object Qtrend_chart_pane_structure_memory_usage, Qtrend_chart_pane_count;
    Object Qchain_of_available_trend_chart_panes, string_constant_123;
    Object string_constant_122, Qaxis_pane, Qoutstanding_axis_pane_count;
    Object Qaxis_pane_structure_memory_usage, Qaxis_pane_count;
    Object Qchain_of_available_axis_panes, string_constant_121;
    Object string_constant_120, Qdisplay_pane, Qoutstanding_display_pane_count;
    Object Qdisplay_pane_structure_memory_usage, Qdisplay_pane_count;
    Object Qchain_of_available_display_panes, string_constant_119;
    ...
    string_constant_56 = 
	    STATIC_STRING("1s1m83-Cry83Sy1m83iEy83Sy1m83-J4y1n1m9k9l1m9k83-w3y1m9k83-YSy1m83-A-y83Sy1m83-91y83=xy1m832Yy83*vy1n83-TQy1o1m9k83=Gy83-Hy1m9k83");
    string_constant_57 = 
	    STATIC_STRING("*Xy83*ny2lmo1n83-TQy1m1m9k83=Gy83-Hy2lm83Py");
    ...
    mutate_global_property(Qextant_color_or_metacolor,
	    ...
	    Qslot_value_writer);
    string_constant_58 = 
	    STATIC_STRING("1n1n83p1y1m9k83gy1o8382y6B83bSy83gy1n83p1y1m9k83hy1o8382y6A83bSy83hy1n83p1y1m9k83Zy1m83Zy6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Q2d_shading_target_spec = STATIC_SYMBOL("2D-SHADING-TARGET-SPEC",
	    AB_package);
    string_constant_59 = 
	    STATIC_STRING("1n1o8382yl83bSy83gy1o8382yk83bSy83hy1m83Zyk");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_shading_target_spec,
	    n_2d_shading_target_spec_evaluation_getter_1);
    string_constant_60 = 
	    STATIC_STRING("1p1n83p=y1n1m9k83-*Qy1m9k83-Ty832Cy1o83J2y6A83-*Tyn1n83p=y1m1m9k831Sy1m9k83*ly1o837Ry6D83-Chy83gWy1n83p=y1m9k83aqy1o837Ry6C83-Ch");
    string_constant_61 = 
	    STATIC_STRING("y83aqy1n83p=y1m9k83ley1o837Ry6B83-Chy83ley1n83p=y1m9k83ly1o837Ry6A83-Chy83ly");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_62 = 
	    STATIC_STRING("1p1o83J2yk83-*Tyn1o837Ryn83-Chy83gWy1o837Rym83-Chy83aqy1o837Ryl83-Chy83ley1o837Ryk83-Chy83ly");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_plot_marker_shape,
	    n_2d_plot_marker_shape_evaluation_getter_1);
    string_constant_63 = 
	    STATIC_STRING("1n1n83-Iay1n1m9k83HCy1m9k831Dy1m9k834ry1o83-Bdy6B9l83HCy1n83-Iay1n1m9k83GOy1m9k831Dy1m9k834ry1o83-Bdy6A9l83GOy1n83-Iay1m9k83Zy1m");
    ...
    string_constant_65 = 
	    STATIC_STRING("1n1o83-Bdyl9k83HCy1o83-Bdyk9k83GOy1m83Zyk");
    clear_optimized_constants();
    push_optimized_constant(Qposition);
    ...
    mutate_global_property(Q2d_location_spec,
	    ...
	    Qslot_value_writer);
    string_constant_66 = 
	    STATIC_STRING("1m1n83p2y1n1m9k83-6Uy1m9k833Wy1m9k83*ny1o83Uqy6A83bSy839gy1n83p2y83*vy1o83GPy6A83*nyl");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Q2d_tickmark_label_color = STATIC_SYMBOL("2D-TICKMARK-LABEL-COLOR",
	    AB_package);
    string_constant_67 = STATIC_STRING("1m1o83Uqyk83bSy839gy1o83GPyk83*nyl");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_tickmark_label_color,
	    n_2d_tickmark_label_color_evaluation_getter_1);
    string_constant_68 = 
	    STATIC_STRING("1m1n83p4y83-oy1o83-oy6A9kl1n83p4y1n1m9l83n2y1m9l830*y1m9l836xy1m83phy6A");
    clear_optimized_constants();
    ...
    string_constant_69 = STATIC_STRING("1m1o83-oyk9kl1m83phyk");
    clear_optimized_constants();
    push_optimized_constant(Qlength);
    ...
    set_slot_value_to_evaluation_value_function(Q2d_time_span_spec,
	    n_2d_time_span_spec_evaluation_getter_1);
    string_constant_70 = 
	    STATIC_STRING("1m1n83p5y83-oy1o83-oy6A9kl1n83p5y1o1m9l83Euy1m9l83*5y1m9l831Dy1m9l834ry1m83uby6A");
    clear_optimized_constants();
    push_optimized_constant(Qlength);
    push_optimized_constant(Qquote);
    ...
    Q2d_total_time_span_spec = STATIC_SYMBOL("2D-TOTAL-TIME-SPAN-SPEC",
	    AB_package);
    string_constant_71 = STATIC_STRING("1m1o83-oyk9kl1m83ubyk");
    clear_optimized_constants();
    push_optimized_constant(Qlength);
    ...
    set_slot_value_to_evaluation_value_function(Q2d_total_time_span_spec,
	    n_2d_total_time_span_spec_evaluation_getter_1);
    string_constant_72 = 
	    STATIC_STRING("1n1n83p+y1n83-oy1m9k835+y1m9k836Gy1o83-Dhy6A83-oyl1n83p+y1m1m9k9l1m9k83-CDy1m83-1ty6A1n83p+y1m1m9k831Sy1m9k831Ay1m83BTy6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_73 = STATIC_STRING("1n1o83-Dhyk83-oyl1m83-1tyk1m83BTyk");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_end_time_spec,
	    n_2d_end_time_spec_evaluation_getter_1);
    string_constant_74 = 
	    STATIC_STRING("1m1n83-Iby83-oy1o83-oy6A9kl1n83-Iby1m9l83Zy1m83Zy6A");
    clear_optimized_constants();
    push_optimized_constant(Qlength);
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Q2d_scrolling_alignment_spec,
	    ...
	    Qslot_value_writer);
    string_constant_76 = 
	    STATIC_STRING("1n1n83p3y1m1m9k9l83-oy1o83-oy6A9mm1n83p3y1m9k83Ary1m83A5y6A1n83p3y1m9k83Zy1m83Zy6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    set_slot_value_to_evaluation_value_function(Q2d_time_axis_tickmark_frequency_spec,
	    n_2d_time_axis_tickmark_frequency_spec_evaluation_getter_1);
    string_constant_78 = 
	    STATIC_STRING("1l1n83p*y1n1m9k9l83Sy1m9k839iy1o83-A*y6A83-Hym");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qevery);
    ...
    Q2d_plot_marker_frequency = STATIC_SYMBOL("2D-PLOT-MARKER-FREQUENCY",
	    AB_package);
    string_constant_79 = STATIC_STRING("1l1o83-A*yk83-Hym");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_plot_marker_frequency,
	    n_2d_plot_marker_frequency_evaluation_getter_1);
    string_constant_80 = 
	    STATIC_STRING("1o1n83p7y1p1m9k9l83-Hy1m9k83HBy1m9k83=Gy83-Hy1q83-oy6B83*4ym83-8Gyp1n83p7y1m1m9k9l83-Hy1q83-oy6A83*4ym83-8Gy01n83p7y1m83Sy1m9k9m");
    string_constant_81 = 
	    STATIC_STRING("1o83wuy6A9nl1n83p7y1m9k83Ary1m83Ary6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qevery);
    ...
    string_constant_82 = 
	    STATIC_STRING("1o1q83-oyl83*4ym83-8Gyp1q83-oyk83*4ym83-8Gy01o83wuyk9kl1m83Aryk");
    clear_optimized_constants();
    push_optimized_constant(Qcount);
    ...
    set_slot_value_to_evaluation_value_function(Q2d_value_axis_tickmark_frequency_spec,
	    n_2d_value_axis_tickmark_frequency_spec_evaluation_getter_1);
    string_constant_83 = 
	    STATIC_STRING("1m1n83p6y1o1m9k832+y83-Hy1m9k83=3y83-Hy1q83-Dby6A83-2hym83-Fwyo1n83p6y1m9k83Zy1m83Zy6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Q2d_value_axis_bounds_spec = STATIC_SYMBOL("2D-VALUE-AXIS-BOUNDS-SPEC",
	    AB_package);
    string_constant_84 = STATIC_STRING("1m1q83-Dbyk83-2hym83-Fwyo1m83Zyk");
    ...
    set_slot_value_to_evaluation_value_function(Q2d_value_axis_bounds_spec,
	    n_2d_value_axis_bounds_spec_evaluation_getter_1);
    string_constant_85 = 
	    STATIC_STRING("1m1n83-FJy83*vy1o83GPy6A83*nyl1n83-FJy1n1m9k83-6Uy1m9k833Wy1m9k83sPy1m83Uqy6A");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_86 = STATIC_STRING("1m1o83GPyk83*nyl1m83Uqyk");
    ...
    mutate_global_property(Qvalue_axis_position,list_constant_99,
	    Qenumeration_grammar_category_members);
    string_constant_87 = 
	    STATIC_STRING("1m1n83-GQy1m9k83*hy83*hy1n83-GQy1m9k83-cy83-cy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qtrend_chart_legend_position,list_constant_100,
	    Qenumeration_grammar_category_members);
    string_constant_88 = 
	    STATIC_STRING("1m1n83-FKy1m9k83HCy83HCy1n83-FKy1m9k83GOy83GOy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Q2d_line_style,list_constant_101,
	    Qenumeration_grammar_category_members);
    string_constant_89 = 
	    STATIC_STRING("1n1n83p-y1m9k83-boy83-=oy1n83p-y1n1m9k83-CDy1m9k83-ty1m9k83-XVy83-m7y1n83p-y1q1m9k83-CDy1m9k83-ty1m9k83-XVy1m9k83vy1m9k83AUy1m9k");
    string_constant_90 = STATIC_STRING("83-lsy83-CEy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qtime_axis_label_alignment,list_constant_102,
	    Qenumeration_grammar_category_members);
    string_constant_91 = 
	    STATIC_STRING("1n1n83-F0y1m9k83-dy83-dy1n83-F0y1m9k83-cy83-cy1n83-F0y1m9k83*hy83*hy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qtime_axis_label_format_spec,list_constant_103,
	    Qenumeration_grammar_category_members);
    string_constant_92 = 
	    STATIC_STRING("13Fy1n83-F1y1o1m9k83-*Iy1m9k83*5y1m9k83=ay1m9k83-oy83-XHy1n83-F1y1m9k83-eKy83-eKy1n83-F1y1m9k83-eJy83-eJy1n83-F1y1m9k83-QGy83-QG");
    string_constant_93 = 
	    STATIC_STRING("y1n83-F1y1m9k83-Q0y83-Q0y1n83-F1y1m9k83-w4y83-w4y1n83-F1y1m9k83-dvy83-dvy1n83-F1y1m9k83-eDy83-eDy1n83-F1y1m9k83-duy83-eHy1n83-F1");
    string_constant_94 = 
	    STATIC_STRING("y1m9k83-eIy83-eIy1n83-F1y1o1m9k83-Pwy1m9k83*5y1m9k83=ay1m9k83-oy83-Pxy1n83-F1y1o1m9k83-6vy1m9k83*5y1m9k83=ay1m9k83-oy83-eCy1n83-");
    string_constant_95 = 
	    STATIC_STRING("F1y1m9k83-6vy83-6vy1n83-F1y1m9k83-X9y83-X9y1n83-F1y1o1m9k83-*Gy1m9k83*5y1m9k83=ay1m9k83-oy83-XDy1n83-F1y1m9k83-*Gy83-*Gy1n83-F1y");
    string_constant_96 = 
	    STATIC_STRING("1m9k83-X4y83-X4y1n83-F1y1o1m9k83-*Ey1m9k83*5y1m9k83=ay1m9k83-oy83-X8y1n83-F1y1m9k83-*Ey83-*Ey");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Q2d_range_mode,list_constant_104,
	    Qenumeration_grammar_category_members);
    string_constant_97 = 
	    STATIC_STRING("1n1n83p0y1p1m9k83-KIy1m9k830Py1m9k830*y1m9k83-hUy1m9k9l83-XNy1n83p0y1o1m9k83-KIy1m9k830Py1m9k831Dy1m9k834ry83Ary1n83p0y1m9k83wOy");
    string_constant_98 = STATIC_STRING("83wOy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qgrid_line_ratio,
	    ...
	    Qslot_value_writer);
    string_constant_99 = 
	    STATIC_STRING("1o1m83-FLy83lhy1n83-FLy1m9k83Ary83-Ncy1m83-93y83=Qy1n83-93y1u83=Qy1m9k83vy1m9k83=Fy1m9k83Dmy1m9k83-oy1m9k837my1m9k831Dy1m9k839iy");
    string_constant_100 = STATIC_STRING("1m9k9l831Ny1n83-Zjylu");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_101 = STATIC_STRING("83-GPy");
    string_constant_102 = 
	    STATIC_STRING("1n1n83b8y831Ty83-GOy1m8p83-ky1m83Way8k");
    ...
    string_constant_103 = STATIC_STRING("83-97y");
    string_constant_104 = 
	    STATIC_STRING("1n1n83b8y831Ty83-96y1m8p83-ky1m83Way8k");
    ...
    string_constant_105 = STATIC_STRING("83t2y");
    string_constant_106 = 
	    STATIC_STRING("1n1n83b8y831Ty83t1y1m8p83-ky1m83Way8k");
    ...
    string_constant_107 = STATIC_STRING("83-92y");
    string_constant_108 = 
	    STATIC_STRING("1n1n83b8y831Ty833Wy1m8p83-ky1m83Way8k");
    ...
    string_constant_119 = STATIC_STRING("1q831Vy8s83-RQy09k9l");
    clear_optimized_constants();
    ...
    string_constant_120 = 
	    STATIC_STRING("43Dy8m83fLy1o83fLy831Vy8n8k1l831Vy0000001l1m8x831Vyk3Nyk0k0");
    ...
    string_constant_121 = STATIC_STRING("1q83fLy8s83-KOy09k9l");
    clear_optimized_constants();
    ...
    string_constant_122 = 
	    STATIC_STRING("43Dy8m83o2y1o83o2y831Vy8n8k1l831Vy0000001l1m8x831Vykxk0k0");
    ...
    Qtrend_chart_pane_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_123 = STATIC_STRING("1q83o2y8s83-sPy09k9l");
    clear_optimized_constants();
    ...
    string_constant_124 = 
	    STATIC_STRING("43Dy8m83kYy1o83kYy831Vy8n8k1l831Vy0000001l1m8x831Vykyk0k0");
    ...
    string_constant_125 = STATIC_STRING("1q83kYy8s83-bay09k9l");
    clear_optimized_constants();
    ...
    string_constant_126 = 
	    STATIC_STRING("43Dy8m83mJy1o83mJy831Vy8n8k1l831Vy0000001l1m8x831Vykyk0k0");
    ...
    Qrelative_time_pane_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_127 = STATIC_STRING("1q83mJy8s83-kky09k9l");
    clear_optimized_constants();
    ...
    string_constant_128 = 
	    STATIC_STRING("43Dy8m83iFy1o83iFy831Vy8n8k1l831Vy0000001l1m8x831Vyk3Lyk0k0");
    ...
    string_constant_129 = STATIC_STRING("1q83iFy8s83-Wdy09k9l");
    clear_optimized_constants();
    ...
    string_constant_130 = STATIC_STRING("1l1m83-TXy83Sy");
