...
Object Stack_expiration = UNBOUND;

Object Multiplier_for_turning_off_data_collection = UNBOUND;

Object Message_completion_interval = UNBOUND;

Object Inference_engine_parameters = UNBOUND;
    ...
    Object inference_engine_parameters, value;
{
    ...
    PUSH_SPECIAL(Inference_engine_parameters,inference_engine_parameters,0);
      result = VALUES_1(Nil);
    POP_SPECIAL();
    return result;
}
...
Object Recursive_depth = UNBOUND;
...
Object Current_environment = UNBOUND;

Object Cached_top_of_stack = UNBOUND;

Object Cached_stack_program_counter = UNBOUND;

Object Cached_fixnum_start_time = UNBOUND;

Object Cached_byte_code_body = UNBOUND;

Object Cached_fixnum_time_limit_qm = UNBOUND;

Object The_type_description_of_rule_instance = UNBOUND;

Object Chain_of_available_rule_instances = UNBOUND;

Object Rule_instance_count = UNBOUND;
    ...
    Object rule_instance;
{
    ...
    svref_new_value = Nil;
    SVREF(rule_instance,FIX((SI_Long)7L)) = svref_new_value;
    ...
    svref_new_value = Chain_of_available_rule_instances;
    SVREF(rule_instance,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_rule_instances = rule_instance;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_rule_instance_variable, temp;
    Object defstruct_g2_rule_instance_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(143,13);
    def_structure_rule_instance_variable = Nil;
    temp = FIXNUM_ADD1(Rule_instance_count);
    Rule_instance_count = temp;
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_rule_instances;
...
Object Current_ri_completion_notification_collection_qm = UNBOUND;
...
{
    Object temp, value, gensymed_symbol, possible_type_name, gensymed_symbol_1;
	...
	if (temp);
		...
		if (SYMBOLP(possible_type_name)) {
		    ...
		    gensymed_symbol_2 = 
			    SXHASH_SYMBOL_1(possible_type_name) & 
		...
		temp_1 = TRUEP(Nil);
	    temp = (temp_1 ? CONSP(evaluation_value) : TRUEP(Nil)) ? 
...
Object analyze_byte_code_body_for_free_reference_consistency(parent_1,
	    byte_code_body)
    Object parent_1, byte_code_body;
{
    Object free_reference_vector_qm, type, reference;
    SI_Long index_1, ab_loop_bind_;

    x_note_fn_call(143,63);
    if (byte_code_body && SIMPLE_VECTOR_P(byte_code_body) && 
	    EQ(ISVREF(byte_code_body,(SI_Long)0L),
	...
	if (free_reference_vector_qm) {
	  ...
	  next_loop:
	    ...
	    analyze_single_free_reference_for_consistency(parent_1,type,
		    reference);
...
Object Allow_internal_procedure_environment_printing_qm = UNBOUND;
    ...
    Object error_symbol;
{
	...
	if (SYMBOLP(error_symbol)) {
	    ...
	    gensymed_symbol_1 = error_symbol;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(error_symbol) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
...
Object add_source_info_to_error_trace(error_object)
    Object error_object;
{
    Object temp, temp_1, temp_2, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object error_trace_new_value;
    ...
    gensym_push_modify_macro_arg = gensym_list_4(temp,temp_1,temp_2,
	    get_lookup_slot_value(error_object,Qerror_source_column));
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = get_lookup_slot_value_given_default(error_object,Qerror_trace,Nil);
    error_trace_new_value = gensym_cons_1(car_1,cdr_1);
...
Object g2_profiled_call_information()
{
    ...
    Object ab_current_node_, ab_current_alist_, ab_entry_cons_, x;
...
static Object Qcontinuation_task_for_current_backup;  /* continuation-task-for-current-backup */
...
Object g2_system_profile()
{
    ...
    Object ab_entry_cons_, x, scheduling_time, data_service_time, kb_io_time;
    Object overhead_time, workstation_time, display_time, icp_time;
    Object system_time, name, duration, ab_less_than_branch_qm_;
    Object amf_available_array_cons_qm, amf_array, temp_3, svref_new_value;
    Object amf_result, incff_1_arg, new_float;
...
Object Registered_activities_symbol_array = UNBOUND;
    ...
    Object item;
{
    ...
    Object x, ab_less_than_branch_qm_, gensymed_symbol, gensymed_symbol_1;
...
Object g2_system_profiled_items()
{
    ...
    Object ab_current_node_, ab_current_alist_, ab_entry_cons_, x, name;
    Object ab_less_than_branch_qm_, gensymed_symbol, gensymed_symbol_1, temp_1;
    Object old_entry;
...
Object g2_disable_system_profiling()
{
    ...
    Object amf_array, temp_1, svref_new_value, amf_result, incff_1_arg;
    Object new_float, current_time;
    char temp;
    double aref_new_value;

    x_note_fn_call(143,104);
    code = M_CAR(M_CDR(Sparse_known_pathnames_list));
    temp = FIXNUMP(code) ? (IFIX(code) & (SI_Long)512L) != (SI_Long)0L : 
	    TRUEP(Qnil);
    if (temp);
...
{
    Object temp_1, gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_4;
    Object profiling_structure_qm, old_entry, frame_serial_number_setf_arg;
    Object old, new_1, svref_new_value;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;
    char temp_2;
    Object result;

    x_note_fn_call(143,108);
    ...
    gensymed_symbol_2 = thing_to_profile;
    gensymed_symbol_3 = (SI_Long)0L;
  next_loop:
    if ( !TRUEP(gensymed_symbol_1))
	goto end_loop;
	...
	if (EQ(gensymed_symbol_2,gensymed_symbol_4)) {
	    profiling_structure_qm = M_CDR(M_CAR(gensymed_symbol_1));
	    goto end_1;
	}
	gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	goto next_loop_1;
      end_loop_1:
	profiling_structure_qm = Qnil;
      end_1:;
	goto end_2;
    }
    goto next_loop;
  ...
  end_2:;
	...
	temp_2 =  !(FIXNUMP(gensymed_symbol_1) ? 
	...
	temp = gensymed_symbol % (SI_Long)43L;
	result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		temp_1,SVREF(hash_table,FIX(temp)),FIX(gensymed_symbol));
	old_entry = NTH_VALUE((SI_Long)1L, result);
	reclaim_basic_profiling_structure(old_entry);
	...
	gensymed_symbol = SYMBOLP(thing_to_profile) ? 
		...
		IFIX(frame_hash_function(thing_to_profile));
	temp = gensymed_symbol % (SI_Long)43L;
	set_balanced_binary_tree_entry(SVREF(hash_table,FIX(temp)),Qeq,
		Fp_mutate_call_hash_tree_for_hash_tree_entry,T,
...
Object note_possibly_profiled_item_deletion(item)
    Object item;
{
    Object call_hash, temp_1, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4, old_entry;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;
    char temp_2;
    Object result;

    x_note_fn_call(143,110);
  ...
  end_2:;
	...
	temp = gensymed_symbol % (SI_Long)43L;
	result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		item,SVREF(call_hash,FIX(temp)),FIX(gensymed_symbol));
	old_entry = NTH_VALUE((SI_Long)1L, result);
	reclaim_basic_profiling_structure(old_entry);
    }
    return VALUES_1(Nil);
    ...
    Object item;
{
    ...
    Object svref_new_value, amf_result, incff_1_arg, new_float, current_time;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    double aref_new_value;

    x_note_fn_call(143,111);
    ...
    Object pathname_string, module_name, g2_window_qm, options;
{
    ...
    PUSH_SPECIAL(G2_window_for_save_via_system_procedure_qm,g2_window_for_save_via_system_procedure_qm,
	    1);
      PUSH_SPECIAL(Attempting_save_via_system_procedure_qm,attempting_save_via_system_procedure_qm,
	      0);
	car_arg = ISVREF(file_command,(SI_Long)16L);
	car_new_value = gensym_list_3(gensym_list_2(Qsave_module,
...
Object G2_save_module_flag = UNBOUND;

/* SET-G2-SAVE-MODULE-FLAG */
Object set_g2_save_module_flag()
{
    x_note_fn_call(143,113);
    ...
    Object module_name, include_required_modules_qm;
{
    ...
    options = gensym_cons_1(gensymed_symbol,Qab_structure);
    ...
    Object g2_window_qm;
{
	...
	reclaim_gensym_cons_1(file_progress_display_qm);
    Return_from_save_to_caller_for_continuation_qm = T;
    Kb_save_termination_reason_qm = Nil;
    Suppress_notification_for_kb_save_qm =  !TRUEP(display_qm) ? T : Nil;
    update_terminate_kb_save_stream_error_message(Nil);
    ...
    PUSH_SPECIAL(G2_window_for_save_via_system_procedure_qm,g2_window_for_save_via_system_procedure_qm,
      ...
      PUSH_SPECIAL(Attempting_save_via_system_procedure_qm,attempting_save_via_system_procedure_qm,
	      0);
	car_arg = ISVREF(file_command,(SI_Long)16L);
	car_new_value = gensym_list_2(type_of_file,pathname_string);
	M_CAR(car_arg) = car_new_value;
	Kb_save_termination_reason_qm = Qfailed;
	execute_file_command(file_command);
	delete_frame(file_command);
    ...
    Object file_progress_display_qm;
{
	...
	if (temp);
	    ...
	    PUSH_SPECIAL(Current_saving_context,current_saving_context,5);
	      enable_saving_compiled_kbs_p = ISVREF(Current_saving_context,
		      (SI_Long)10L);
	      PUSH_SPECIAL(Enable_saving_compiled_kbs_p,enable_saving_compiled_kbs_p,
		      4);
		...
		PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
		  ...
		  PUSH_SPECIAL(Write_xml_object_items_collected,write_xml_object_items_collected,
		    ...
		    PUSH_SPECIAL(Total_items_in_file,total_items_in_file,1);
		      ...
		      ab_loop_list_ = ISVREF(Current_saving_context,
			      (SI_Long)1L);
		      PUSH_SPECIAL(Current_kb_save,current_kb_save,0);
		      next_loop:
			if ( !TRUEP(ab_loop_list_))
			    goto end_loop;
    ...
    Object also_delete_associated_workspaces_qm_boolean_as_evaluation_value;
{
    ...
    if (deleting_associated_workspaces_qm && Current_computation_instance 
	    ...
	    procedure_of_invocation_qm) {
	gensymed_symbol = ISVREF(procedure_of_invocation_qm,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)5L) : Nil;
	...
	reclaim_gensym_cons_1(also_delete_associated_workspaces_qm_boolean_as_evaluation_value);
    return VALUES_0();
}
...
Object g2_modules_with_unsaved_changes()
{
    ...
    x_note_fn_call(143,127);
    value_1 = Nil;
    list_1 = modules_with_unsaved_changes();
    temp = copy_list_using_gensym_conses_1(list_1);
    ...
    Object pathname_string_as_evaluation_value, options_as_evaluation_value;
{
    ...
    update_before_loading_qm = CONSP(evaluation_value) && 
	    ...
	    Truth) ? T : Nil) : Nil;
    PUSH_SPECIAL(Reformat_as_appropriate_qm,reformat_as_appropriate_qm,0);
	...
	temp = gensym_cons_1(value_1,Qtruth_value);
    return VALUES_1(temp);
}
    ...
    Object reformat_as_appropriate_qm_truth_value_as_evaluation_value;
{
    ...
    if ( !(EQ(auto_merge_case_qm_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(auto_merge_case_qm_truth_value_as_evaluation_value);
    if ( !(EQ(reformat_as_appropriate_qm_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(reformat_as_appropriate_qm_truth_value_as_evaluation_value);
    if (FIXNUM_EQ(value_1,Truth))
	temp = Evaluation_true_value;
    else if (FIXNUM_EQ(value_1,Falsity))
	temp = Evaluation_false_value;
    ...
    Object pathname_string_as_evaluation_value, options_as_evaluation_value;
{
    ...
    PUSH_SPECIAL(Do_not_allow_user_interactions_during_kb_load_qm,do_not_allow_user_interactions_during_kb_load_qm,
	    5);
      PUSH_SPECIAL(Do_not_show_conflicts_during_kb_load_qm,do_not_show_conflicts_during_kb_load_qm,
	      4);
	PUSH_SPECIAL(Do_not_notify_user_during_kb_load_qm,do_not_notify_user_during_kb_load_qm,
		3);
	  PUSH_SPECIAL(Do_not_restore_image_planes_qm,do_not_restore_image_planes_qm,
		  2);
	    PUSH_SPECIAL(Do_not_update_file_progress_display_qm,do_not_update_file_progress_display_qm,
		    1);
    ...
    Object install_system_tables_qm_truth_value_as_evaluation_value;
{
    ...
    if ( !(EQ(clear_kb_qm_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(clear_kb_qm_truth_value_as_evaluation_value);
    if ( !(EQ(install_system_tables_qm_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(install_system_tables_qm_truth_value_as_evaluation_value);
    if (FIXNUM_EQ(value_1,Truth))
	temp = Evaluation_true_value;
    else if (FIXNUM_EQ(value_1,Falsity))
	temp = Evaluation_false_value;
    ...
    Object catch_up_qm_truth_value_as_evaluation_value;
{
    ...
    if ( !(EQ(catch_up_qm_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(catch_up_qm_truth_value_as_evaluation_value);
    if (FIXNUM_EQ(value_1,Truth))
	temp = Evaluation_true_value;
    else if (FIXNUM_EQ(value_1,Falsity))
	temp = Evaluation_false_value;
...
{
    Object truename_qm, client_qm, old_structure_being_reclaimed, temp;
    Object def_structure_schedule_task_variable, new_task, gensymed_symbol;
    Object gensymed_symbol_1, def_structure_queue_element_variable;
    Object kb_serial_number, temp_1;

    x_note_fn_call(143,136);
	...
	if (clear_kb_qm) {
	    ...
	    ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)2L);
	    SVREF(new_task,FIX((SI_Long)11L)) = truename_qm;
	    ...
	    M_CAR(gensymed_symbol_1) = temp;
	    SVREF(new_task,FIX((SI_Long)12L)) = gensymed_symbol;
    ...
    Object item, connection, integer_list;
{
    ...
    x_note_fn_call(143,139);
    connection_structure = ISVREF(connection,(SI_Long)21L);
    dont_include_offset_for_end_position_qm = T;
    PUSH_SPECIAL(Dont_include_offset_for_end_position_qm,dont_include_offset_for_end_position_qm,
	    0);
      connection_deltas = 
    ...
    Object connection, connection_deltas, integer_list, starting_at_output_qm;
{
	...
	if (starting_at_output_qm) {
	  ...
	  next_loop_1:
		...
		if (LISTP(integer_list))
		    integer_list = gensym_cons_1(value_to_insert,integer_list);
		else
	...
	if (reclaim_deltas_on_exit_qm)
	    reclaim_gensym_list_1(connection_deltas);
    }
    return VALUES_1(integer_list);
}
    ...
    Object connected_items_item_list;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, message_1, connected_items_qm;
    Object connected_item_at_port, ab_loop_list_, sub_class_bit_vector;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;

    x_note_fn_call(143,143);
	...
	if (connected_items_qm)
	    reclaim_gensym_list_1(connected_items_qm);
    }
    return VALUES_1(Nil);
}
    ...
    Object connected_items_item_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(temp_list);
    return VALUES_1(Qnil);
}
    ...
    Object class_name, array_frame, specific_attributes_flag;
{
    ...
    Object ab_loop_iter_flag_, temp_3, temp_4, gensym_pop_store, cons_1;
    Object next_cons;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, index_1, svref_arg_2;
    char temp_2, all_attributes_p;
    Object result;

    x_note_fn_call(143,146);
  ...
  next_loop_9:
	...
	temp_2 = TRUEP(Nil);
    attribute_name = temp_2 ? ISVREF(ab_loopvar__2,(SI_Long)1L) : 
  ...
  end_12:;
	...
	attr_info_list = gensym_cons_1(attribute_name,attr_info_list);
	attr_info_list = gensym_cons_1(ISVREF(slot_description,
	...
	MVS_3(result,attribute_type_generic,attribute_type_specific,
		empty_allowed_p);
	attr_info_list = gensym_cons_1(attribute_type_generic,attr_info_list);
	attr_info_list = gensym_cons_1(attribute_type_specific,attr_info_list);
	attr_info_list = gensym_cons_1(empty_allowed_p,attr_info_list);
	if ( !TRUEP(slot_init_form))
		...
		if (EQ(slot_units,Qnumber)) {
			...
			temp_1 = gensym_cons_1(slot_value,Qtruth_value);
		    result = VALUES_2(Qvalue,temp_1);
		}
		...
		gensymed_symbol_1 = slot_init_form;
		temp_2 = FIXNUMP(gensymed_symbol_1);
		if (temp_2);
		else
		    temp_2 = 
		...
		if (temp_2);
		    ...
		    temp_2 = INLINE_LONG_VECTOR_P(gensymed_symbol_1) != 
			    (SI_Long)0L ? 
			    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_1)) 
			    == (SI_Long)1L : TRUEP(Qnil);
		if (temp_2);
		...
		if (temp_2);
		    ...
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    temp_2 = EQ(gensymed_symbol_1,Qtruth_value);
		    if (temp_2);
		    else
			temp_2 = EQ(gensymed_symbol_1,Qiteration_state);
		    if (temp_2);
			...
			if (gensymed_symbol_2 < gensymed_symbol_3)
			  ...
			  next_loop_19:
			    ...
			    gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
			    if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
				temp_2 = TRUEP(M_CDR(M_CAR(gensymed_symbol)));
				goto end_17;
			    }
			    gensymed_symbol = M_CDR(gensymed_symbol);
			    goto next_loop_19;
		...
		if (temp_2) {
		    ...
		    reclaim_gensym_list_1(attr_info_list);
		    top_of_stack = Cached_top_of_stack;
	...
	attr_info_list = gensym_cons_1(initial_type,attr_info_list);
	attr_info_list = gensym_cons_1(initial_value_or_class,attr_info_list);
	attr_info_list = gensym_cons_1(ISVREF(slot_description,
  ...
  next_loop_20:
	...
	temp_4 = ISVREF(managed_array,(index_1 >>  -  - (SI_Long)10L) + 
		(SI_Long)2L);
	svref_arg_2 = index_1 & (SI_Long)1023L;
	ISVREF(temp_4,svref_arg_2) = temp_3;
    }
    if (FIXNUM_LE(ISVREF(managed_array,(SI_Long)1L),
	    Maximum_in_place_array_size)) {
	svref_arg_2 = index_1 + IFIX(Managed_array_index_offset);
	...
	ISVREF(managed_array,svref_arg_2) = gensym_pop_store;
    }
    else {
	temp_4 = ISVREF(managed_array,(index_1 >>  -  - (SI_Long)10L) + 
		(SI_Long)2L);
	...
	if (cons_1) {
	    ...
	    next_cons = Nil;
	attr_info_list = next_cons;
	ISVREF(temp_4,svref_arg_2) = gensym_pop_store;
    }
    ab_loop_iter_flag_ = Nil;
    goto next_loop_20;
  end_loop_20:;
    return reclaim_gensym_list_1(attr_info_list);
}
    ...
    Object class_name, pretty_slot_name, symbol_list;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, top_of_stack, message_1, defining_class;
    Object class_specific_attributes_of_defining_class, enumerations;
    Object attribute_description, ab_loop_list_, attribute_name;
    Object allowed_symbol;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;

    x_note_fn_call(143,147);
    if (SYMBOLP(class_name)) {
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = class_name;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(class_name) & 
    ...
    Object suppress_trailing_zeros_p_truth_value_as_evaluation_value;
{
    ...
    if ( !(EQ(always_format_as_exponent_p_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(always_format_as_exponent_p_truth_value_as_evaluation_value);
    if ( !(EQ(suppress_trailing_zeros_p_truth_value_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(suppress_trailing_zeros_p_truth_value_as_evaluation_value);
...
Object Tracked_items_call_depth = UNBOUND;

Object Available_tracked_items_call_vector_table_hash_vector_43_vectors = UNBOUND;

Object Count_of_tracked_items_call_vector_table_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_tracked_items_call_vector_table_hash_vector_43_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(143,154);
    count_of_tracked_items_call_vector_table_hash_vector_43_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_tracked_items_call_vector_table_hash_vector_43_vectors);
...
Object make_tracked_items_call_vector_table_hash_vector()
{
    ...
    x_note_fn_call(143,155);
    if (Available_tracked_items_call_vector_table_hash_vector_43_vectors) {
	temp = 
		M_CAR(Available_tracked_items_call_vector_table_hash_vector_43_vectors);
	temp_1 = 
		M_CDR(Available_tracked_items_call_vector_table_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_tracked_items_call_vector_table_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = 
...
/* MUTATE-TRACKED-ITEMS-CALL-VECTOR-TABLE-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_tracked_items_call_vector_table_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(143,157);
    reclaim_if_evaluation_value_function(M_CDR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_tracked_items_call_vector_table_tree_for_hash_tree_entry = UNBOUND;

/* CLEAR-TRACKED-ITEMS-CALL-VECTOR-TABLE-TREE */
Object clear_tracked_items_call_vector_table_tree(tracked_items_call_vector_table_tree_for_hash_binary_tree)
    Object tracked_items_call_vector_table_tree_for_hash_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, old_entry;
    Object result;

    x_note_fn_call(143,158);
    element_qm = Nil;
  next_loop:
    element_qm = 
	    CDR(tracked_items_call_vector_table_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    ...
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
	    gensymed_symbol,
	    tracked_items_call_vector_table_tree_for_hash_binary_tree,
	    frame_hash_function(gensymed_symbol));
    old_entry = NTH_VALUE((SI_Long)1L, result);
    reclaim_if_evaluation_value_function(old_entry);
    goto next_loop;
  end_loop:;
    return VALUES_1(tracked_items_call_vector_table_tree_for_hash_binary_tree);
}
    ...
    Object tracked_items_call_vector_table_hash_table;
{
  ...
  next_loop_1:
    element_qm = 
	    M_CDR(tracked_items_call_vector_table_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(tracked_items_call_vector_table_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(tracked_items_call_vector_table_tree_for_hash_binary_tree) = 
	    cdr_new_value;
    ...
    Object item;
{
	...
	if (Current_computation_frame && Current_computation_instance && 
	    ...
	    temp_2 = 
		    Fp_mutate_tracked_items_call_vector_table_tree_for_hash_tree_entry;
	    set_balanced_binary_tree_entry(temp,Qeq,temp_2,T,item,
		    FIX(gensymed_symbol),
    ...
    Object item;
{
    ...
    x_note_fn_call(143,164);
    if (Tracked_items_call_vector_table) {
	gensymed_symbol = IFIX(frame_hash_function(item));
	temp = Tracked_items_call_vector_table;
	temp_1 = gensymed_symbol % (SI_Long)43L;
	result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		item,SVREF(temp,FIX(temp_1)),FIX(gensymed_symbol));
	old_entry = NTH_VALUE((SI_Long)1L, result);
	reclaim_if_evaluation_value_function(old_entry);
    }
    return VALUES_1(Nil);
...
{
    Object item, value_1, temp, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4, thing;
    SI_Long gensymed_symbol, temp_1, gensymed_symbol_3;

    x_note_fn_call(143,165);
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol_1));
	    if (EQ(gensymed_symbol_2,gensymed_symbol_4)) {
		thing = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_1;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_1;
...
Object Tracking_items_grammar_installed_p = UNBOUND;

static Object string_constant_29;  /* "1l1n83m1y1p1m9k83*Xy1m9k9l1m9k83-s0y1m9k83Ry1m9k9m1m83-YXy83fCy" */
    ...
    Object text_timestamp;
{
    ...
    Object message_1, amf_available_array_cons_qm, amf_array, temp_1;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    double the_value_as_float, temp_2, aref_new_value_1;
    Declare_special(5);
    Object result;

    x_note_fn_call(143,175);
    ...
    PUSH_SPECIAL(Time_of_frame_edit_base_time,time_of_frame_edit_base_time,1);
      text_time_stamp_seconds = float_constant;
      PUSH_SPECIAL(Text_time_stamp_seconds,text_time_stamp_seconds,0);
	...
	new_float = amf_result;
	temp_2 = DOUBLE_FLOAT_TO_DOUBLE(Text_time_stamp_seconds);
	aref_new_value_1 = 60.0 * the_value_as_float + temp_2;
	DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value_1);
	result = VALUES_1(new_float);
      POP_SPECIAL();
    POP_SPECIAL();
    ...
    Object user_name;
{
    ...
    x_note_fn_call(143,181);
    modes_qm = authorized_modes_for_user(user_name);
    if (modes_qm)
	return allocate_evaluation_sequence(copy_list_using_gensym_conses_1(modes_qm));
    else
...
void sets_INIT()
{
    ...
    Object Qmutate_tracked_items_call_vector_table_tree_for_hash_tree_entry;
    ...
    Object string_constant_63, Qutilities2;
    Object Qcount_of_tracked_items_call_vector_table_hash_vector_43_vectors;
    Object Qavailable_tracked_items_call_vector_table_hash_vector_43_vectors;
    Object Qg2_run_trace, Qg2_float_to_text;
    ...
    Object list_constant_39, Qsets, Qsave_kb_state_for_system_procedure_save;
    Object Qterminate_kb_save_stream_error_message_qm;
    Object Qsuppress_notification_for_kb_save_qm;
    Object Qkb_save_termination_reason_qm;
    Object Qreturn_from_save_to_caller_for_continuation_qm;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qg2_clear_profiling;
    Object Qg2_toggle_system_profiling, Qg2_disable_system_profiling;
    Object Qg2_enable_system_profiling, Qg2_system_profiled_items;
    Object Qg2_procedure_activity_calls, Qg2_user_name_for_frame;
    Object Qg2_allow_profiling_regardless_of_license;
    ...
    Object Qprofiling_structure, Qcurrent_profile_structure_qm;
    ...
    Object Qrule_instance_structure_memory_usage, Qrule_instance_count;
    Object Qchain_of_available_rule_instances, string_constant_50;
    Object Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_49, Qunique_structure_type_of_ab_name_qm;
    Object Qab_name_of_unique_structure_type, Qcached_fixnum_time_limit_qm;
    Object Qcached_byte_code_body, Qcached_stack_frame_base;
    Object Qcached_fixnum_start_time, Qcached_stack_program_counter;
    Object Qcached_top_of_stack, Qutilities0, Qcurrent_environment;
    ...
    Object Qinterval, Qrecursive_depth, Qretry_interval_after_timeout;
    ...
    Object Qset_of_all_computation_styles, Ksystem_frame;
    Object Qinference_engine_parameters, string_constant_48;
    ...
    Object Qsystem_table, Qmessage_completion_interval;
    Object Qmultiplier_for_turning_off_data_collection, Qstack_expiration;

    x_note_fn_call(143,191);
    SET_PACKAGE("AB");
    ...
    string_constant_44 = 
	    STATIC_STRING("1q4z8r83Yky83Yky8395y8395y03ky001n1l8o1l8l1m8p83Sy000004z8r83c9y83c9y8395y8395y03Qy001n1l8o1l8l1m8p8376y000004z8r83cAy83cAy8395y");
    string_constant_45 = 
	    STATIC_STRING("8395y03Qy001n1l8o1l8l1m8p8376y000004z8r83ZAy83ZAy8395y8395y03uy001n1l8o1l8l1m8p83D6y000004z8r83csy83csy8395y8395y038Sy001n1l8o1l");
    string_constant_46 = 
	    STATIC_STRING("8l1m8p83-hy000004z8r83LDy83LDy8395y8395y038Sz001m1l8o1l8l00000");
    string_constant_47 = 
	    STATIC_STRING("1s8q1n8395y1l83-sy83ey1p83Yky3ky8o8l1m8p83Sy1p83c9y3Qy8o8l1m8p8376y1p83cAy3Qy8o8l1m8p8376y1p83ZAy3uy8o8l1m8p83D6y1p83csy38Sy8o8l");
    string_constant_48 = STATIC_STRING("1m8p83-hy1o83LDy38Sz8o8l");
    ...
    string_constant_49 = 
	    STATIC_STRING("43Dy8m83mdy1o83mdy830Ey8n8k1l830Ey0000001m1m8x830Ey1m8y83-5gyk3Pyk0k0");
    ...
    string_constant_50 = STATIC_STRING("1q83mdy8s83-m1y09k9l");
    clear_optimized_constants();
    ...
    string_constant_52 = 
	    STATIC_STRING("1p4z8r83Kgy83Kgy9k9k00001n1n8p83-ey83Gy1l8l1l8z000004z8r83Kky83Kky9k9k00001o1m8p83Ycy1l8l1l8z1l83Fy000004z8r83Kly83Kly9k9k083JGy");
    string_constant_53 = 
	    STATIC_STRING("001o1m8p83Sy1l8l1l8z1l83Fy000004z8r83Kjy83Kjy9k9k083JFy001o1m8p83Sy1l8l1l8z1l83Fy000004z8r83Kmy83Kmy9k9k00001n1m8p01l8l1l83Hy000");
    string_constant_54 = STATIC_STRING("00");
    string_constant_55 = 
	    STATIC_STRING("1r8q1p9k1l83-Oy1m8v9k8t83Ly1p83Kgy01n8p83-ey83Gy8l8z1q83Kky01m8p83Ycy8l8z83Fy1q83Kly83JGy1m8p83Sy8l8z83Fy1q83Kjy83JFy1m8p83Sy8l8");
    string_constant_56 = STATIC_STRING("z83Fy1p83Kmy01m8p08l83Hy");
    clear_optimized_constants();
    ...
    string_constant_59 = STATIC_STRING("1m8q1p83uuy1l9k8t83Iy83Ly");
    ...
    string_constant_61 = STATIC_STRING("1m8q1p83xjy1l835Gy8t83Iy83Ly");
    temp = regenerate_optimized_constant(string_constant_57);
    temp_1 = regenerate_optimized_constant(string_constant_58);
    ...
    string_constant_62 = STATIC_STRING("1m8q1p83xWy1l835Gy8t83Iy83Ly");
    temp = regenerate_optimized_constant(string_constant_57);
    temp_1 = regenerate_optimized_constant(string_constant_58);
    ...
    Qtracked_items_call_vector_table_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_63 = STATIC_STRING("1q83-s1y83*By83-P8y09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qout_tracked_items_call_vector_table_hash_vector_43_vectors,
	    ...
	    NIL,FALSE,0,0));
    Qmutate_tracked_items_call_vector_table_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-TRACKED-ITEMS-CALL-VECTOR-TABLE-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_tracked_items_call_vector_table_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_tracked_items_call_vector_table_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_tracked_items_call_vector_table_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_tracked_items_call_vector_table_tree_for_hash_tree_entry);
    ...
    string_constant_29 = 
	    STATIC_STRING("1l1n83m1y1p1m9k83*Xy1m9k9l1m9k83-s0y1m9k83Ry1m9k9m1m83-YXy83fCy");
