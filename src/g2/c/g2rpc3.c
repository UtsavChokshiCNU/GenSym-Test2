    ...
    Object time_at_start_qm;
{
    ...
    Object resulting_value, sub_class_bit_vector, new_history_object_qm, x2;
    Object remote_time_at_start_qm, svref_arg_1;
    ...
    Object new_history_object, datapoint_count, datapoint_age, granularity;
{
    ...
    change_slot_value_for_object_passing(new_history_object,
	    ...
	    gensym_list_4(Qhistory,datapoint_count,datapoint_age,granularity));
    return VALUES_1(Nil);
}
    ...
    Object float_vector_for_values_p;
{
    ...
    Object temp_1, temp_2, amf_available_array_cons_qm, amf_array;
    ...
    PUSH_SPECIAL(Previous_timestamp_qm,previous_timestamp_qm,0);
    ...
    Object history_node, history_enclosure_qm, history, history_spec;
{
    ...
    svref_new_value = copy_list_using_gensym_conses_1(history_spec);
	...
	temp_2 = contents_qm ? (FIXNUMP(contents_qm) || contents_qm && 
		SYMBOLP(contents_qm) ? contents_qm : 
		copy_evaluation_value_1(contents_qm)) : Nil;
	svref_new_value = gensym_list_4(temp,temp_1,temp_2,
		  ...
		  next_loop:
			...
			if (corresponding_index_qm)
			    cached_interning_details = 
				    gensym_cons_1(gensym_cons_1(FIX(cached_index),
    ...
    Object remaining_uncached_count, bandwidth_needed, bandwidth_available;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_history_array_deleted,temp);
    }
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_history_array_index_lost,temp);
    }
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_history_array_entries_lost,temp);
    }
		  ...
		  next_loop:
			...
			if (corresponding_index_qm)
			    uncached_interning_details = 
				    gensym_cons_1(gensym_cons_1(ring_index,
				    corresponding_index_qm),
				    uncached_interning_details);
		    }
		    else {
    ...
    Object base_time, lowest_ever, highest_ever;
{
    ...
    svref_new_value = gensym_cons_1(gensym_list_3(datapoint_count_qm,
	    datapoint_age,Nil),Nil);
    SVREF(new_history,FIX((SI_Long)3L)) = svref_new_value;
    svref_new_value = gensym_cons_1(new_buffer,Nil);
    ...
    Object timestamps_use_float_array_p, values_use_float_array_p;
{
    ...
    Object next_interning_index_qm, gensym_pop_store, cons_1, next_cons;
    Object history, timestamp_vector, value_vector, identical_timestamp_count;
    Object ring_index, previous_timestamp_qm, first_uncached_index;
    Object managed_timestamp;
	...
	if (cached_timestamps_use_float_array_p || 
		...
		if (cached_timestamps_use_float_array_p && 
		  ...
		  end_loop:
			...
			reclaim_gensym_tree_1(cached_interning_details_qm);
		}
	...
	if (timestamps_use_float_array_p || values_use_float_array_p) {
		...
		if (timestamps_use_float_array_p && values_use_float_array_p) {
		    ...
		    end_loop_6:
			  ...
			  reclaim_gensym_tree_1(uncached_interning_details_qm);
		    POP_SPECIAL();
		}
    ...
    Object timestamps_use_float_array_p;
{
    ...
    Object corresponding_index_qm, temp_2, gensym_pop_store, cons_1, next_cons;
    Object history, timestamp_vector, value_vector, identical_timestamp_count;
    Object ring_index, previous_timestamp_qm, first_uncached_index;
    Object managed_timestamp;
    SI_Long ab_loop_repeat_, cache_index;
    ...
    Object number_of_elements;
{
    ...
    Object new_float, index_1, ring_buffer, ring_index, ab_loop_iter_flag_;
    Object value_1, timestamp_1;
    SI_Long temp_2, ab_loop_repeat_, starting_newest_ring_index;
		...
		if (ISVREF(Current_receiving_resumable_object,(SI_Long)10L)) {
		  ...
		  next_loop_3:
		    ...
		    temp = ISVREF(timestamp_vector,(IFIX(ring_index) >>  - 
			     - (SI_Long)10L) + (SI_Long)2L);
		    temp_2 = IFIX(ring_index) & (SI_Long)1023L;
		    DFLOAT_ISASET_1(temp,temp_2,timestamp);
		    temp = ISVREF(value_vector,(IFIX(ring_index) >>  -  - 
			    (SI_Long)10L) + (SI_Long)2L);
		    temp_2 = IFIX(ring_index) & (SI_Long)1023L;
		    DFLOAT_ISASET_1(temp,temp_2,value);
		    ab_loop_iter_flag_ = Nil;
		    goto next_loop_3;
		  end_loop_3:
		...
		if (ISVREF(Current_receiving_resumable_object,(SI_Long)10L)) {
		  ...
		  next_loop_7:
			...
			temp = ISVREF(timestamp_vector,(IFIX(ring_index) 
				>>  -  - (SI_Long)10L) + (SI_Long)2L);
			temp_2 = IFIX(ring_index) & (SI_Long)1023L;
			ISVREF(temp,temp_2) = timestamp_1;
		    }
		    temp = ISVREF(value_vector,(IFIX(ring_index) >>  -  - 
			    (SI_Long)10L) + (SI_Long)2L);
		    temp_2 = IFIX(ring_index) & (SI_Long)1023L;
    ...
    Object number_of_elements, resumable_node, interning_details_qm;
{
    ...
    Object ab_loop_iter_flag_, gensym_pop_store, cons_1, next_cons, temp;
	...
	if (next_interning_index_qm && IFIX(next_interning_index_qm) == 
	    ...
	    corresponding_index_qm = Nil;
	write_icp_attribute_value(ISVREF(list_element,(SI_Long)2L),
		corresponding_index_qm);
	ab_loop_iter_flag_ = Nil;
	list_index = list_index + (SI_Long)1L;
	goto next_loop;
      end_loop:
	temp = ISVREF(list_element,(SI_Long)0L);
    ...
    Object interning_details_qm;
{
	...
	if ( !TRUEP(ab_loop_iter_flag_))
	    list_element = ISVREF(list_element,(SI_Long)0L);
	element_value = ISVREF(list_element,(SI_Long)2L);
    ...
    Object resumable_node, resumable_object;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_value_list_subobject_deleted,temp_1);
    }
    list_element_qm = ISVREF(resumable_node,(SI_Long)20L);
    if (list_element_qm) {
	if ( !EQ(ISVREF(list_element_qm,(SI_Long)2L),
		    G2_list_structure_marker)) {
	    temp_1 = ISVREF(list_element_qm,(SI_Long)3L);
		...
		PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
		  ...
		  POP_SPECIAL();
		POP_SPECIAL();
		return gensym_list_2(Qg2_value_list_element_removed,temp_1);
	    }
	    else
		return VALUES_1(Nil);
	}
...
Object Minimnal_bandwidth_for_resumable_sequence_range = UNBOUND;
    ...
    Object resumable_node, resumable_object, icp_port;
{
    ...
    Object gensymed_symbol, incff_1_arg, decff_1_arg, svref_new_value, temp_1;
    Object result;

    x_note_fn_call(169,25);
	...
	if (elements_remain_p && IFIX(number_of_elements) <= (SI_Long)0L) {
	    reclaim_gensym_tree_1(interning_details);
		...
		if (ISVREF(icp_socket,(SI_Long)31L)) {
		    if ( !TRUEP(ISVREF(icp_socket,(SI_Long)32L))) {
			temp = last(ISVREF(icp_socket,(SI_Long)31L),_);
			SVREF(icp_socket,FIX((SI_Long)32L)) = temp;
		    }
		    temp = ISVREF(icp_socket,(SI_Long)32L);
		    M_CDR(temp) = gensymed_symbol;
		}
		else
		    SVREF(icp_socket,FIX((SI_Long)31L)) = gensymed_symbol;
		SVREF(icp_socket,FIX((SI_Long)32L)) = gensymed_symbol;
		possible_throw_value = 
    ...
    Object object, attribute_name;
{
    ...
    Object sub_class_bit_vector, raw_value_qm, gensymed_symbol_4;
    Object gensymed_symbol_5, car_1, cdr_1, inner_value, constant_type;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(169,26);
	...
	if (memq_function(base_name,list_constant)) {
	    ...
	    raw_value_qm = temp_1 ? get_slot_value_if_any_function(object,
		    ...
		    base_name,class_qualifier_qm);
	    gensymed_symbol_4 = raw_value_qm;
		...
		if (temp_1) {
			...
			if (FIXNUM_EQ(inner_value,Truth))
			    ...
			    temp = gensym_cons_1(inner_value,Qtruth_value);
		    }
		    else
  ...
  end_1:;
	...
	if (EQ(continuation_tag,Qstart)) {
	    ...
	    receive_start_or_call_remote_procedure(temp,temp_2,
		    gensym_cons_1(temp_3,gensym_cons_1(Nil,
	    ...
	    receive_remote_procedure_values(remote_procedure_identifier,
		    gensym_cons_1(temp,gensym_cons_1(Nil,
		    converted_rpc_arglist)));
	}
...
Object suspend_object_passing_transmission varargs_1(int, n)
{
    ...
    Object reschedule_p, schedule_task_qm, old_structure_being_reclaimed, temp;
    ...
    Object gensymed_symbol_1, suspended_resumable_node;
    char g2_p;
    double aref_new_value;
    Declare_varargs_nonrelocating;

    x_note_fn_call(169,31);
	...
	temp = Nil;
	SVREF(resumable_object,FIX((SI_Long)19L)) = temp;
    }
    if (reschedule_p) {
	...
	SVREF(resumable_object,FIX((SI_Long)19L)) = task;
    }
    ...
    Object resumable_node, resumable_object;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_value_array_deleted,temp_1);
    }
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_list_2(Qg2_value_array_length_diminished,temp_1);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object resumable_node, resumable_object, icp_port;
{
    ...
    Object network_is_limiting_factor_p, temp, gensymed_symbol, incff_1_arg;
    Object decff_1_arg, svref_new_value, temp_1;
    Object result;

    x_note_fn_call(169,33);
    ...
    Object resumable_node, resumable_object, icp_port;
{
	...
	if ( !(IFIX(number_of_cached_elements) > (SI_Long)0L || 
	    ...
	    reclaim_gensym_tree_1(cached_interning_details);
	    reclaim_gensym_tree_1(uncached_interning_details);
	    if (network_is_limiting_factor_p) {
		temp = Minimnal_bandwidth_for_resumable_sequence_range;
		SVREF(resumable_object,FIX((SI_Long)17L)) = temp;
		gensymed_symbol = resumable_object;
...
{
    Object icp_socket, icp_port, current_object, temp, possible_throw_value;
    Object bandwidth_needed, gensymed_symbol, allocated_bandwidth, parent_qm;
    Object svref_old_value, temp_1, next_node_qm, ascension_target_qm;

    x_note_fn_call(169,36);
  ...
  transmit_sequence_contents_if_any:
	...
	if (ISVREF(resumable_node,(SI_Long)5L)) {
	    ...
	    temp = ISVREF(current_object,(SI_Long)23L);
	    SVREF(resumable_node,FIX((SI_Long)20L)) = temp;
	    possible_throw_value = 
	...
	if (ISVREF(resumable_node,(SI_Long)5L)) {
	    current_object = ISVREF(resumable_node,(SI_Long)4L);
	    temp = get_history_ring_buffer_if_any(current_object,Nil);
	    SVREF(resumable_node,FIX((SI_Long)20L)) = temp;
	    possible_throw_value = 
  ...
  transmit_node_itself:
	...
	if (IFIX(FIXNUM_MINUS(ISVREF(icp_socket,(SI_Long)30L),
		...
		temp = REST(svref_old_value);
		SVREF(parent_qm,FIX((SI_Long)14L)) = temp;
	    }
  ...
  get_next_node_1:
    if (SIMPLE_VECTOR_P(resumable_node) && EQ(ISVREF(resumable_node,
	    ...
	    Qg2_defstruct_structure_name_resumable_value_list_node_g2_struct)) 
		{
	temp_1 = ISVREF(resumable_node,(SI_Long)14L);
	temp_1 = CAR(temp_1);
	if (SIMPLE_VECTOR_P(resumable_node) && EQ(ISVREF(resumable_node,
		(SI_Long)0L),
		Qg2_defstruct_structure_name_resumable_object_vector_node_g2_struct)) 
		    {
	    temp = FIXNUM_ADD1(ISVREF(resumable_node,(SI_Long)21L));
    ...
    Object resumable_object;
{
    ...
    if (temp) {
	Rpc_throw_tag = Kabort_transmitting_resumable_object;
	return gensym_list_2(Qrpc_object_argument_deleted,
  ...
  next_loop:
	...
	if (temp) {
	    new_attribute_name = gensym_list_3(Qattribute,
		    ...
		    base_slot_name);
	    new_attribute_name_cons = gensym_cons_1(new_attribute_name,Nil);
	...
	if (CONSP(slot_name_with_qualifier_if_necessary))
	    reclaim_gensym_list_1(slot_name_with_qualifier_if_necessary);
    }
    goto next_loop;
  end_loop:;
	...
	system_attribute_names = gensym_cons_1(attribute_spec_qm,
    ...
    Object included_system_attributes;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(slot_descriptions_of_item);
    system_attribute_names = Nil;
    attribute_spec_qm = 
    ...
    Object included_system_attributes;
{
	...
	if (temp) {
		...
		if (temp) {
			...
			if ( !TRUEP(ISVREF(object,(SI_Long)20L))) {
			    if (Noting_changes_to_kb_p)
				note_change_to_block_1(object,Qlist_structure);
			    svref_new_value = create_empty_g2_list_structure();
			    SVREF(object,FIX((SI_Long)20L)) = svref_new_value;
			}
			temp_1 = ISVREF(ISVREF(object,(SI_Long)20L),
				(SI_Long)0L);
			toplevel_node = 
			...
			if (temp) {
			    ...
			    if ( !TRUEP(ISVREF(object,(SI_Long)20L))) {
				if (Noting_changes_to_kb_p)
				    note_change_to_block_1(object,
					    Qlist_structure);
				svref_new_value = 
					create_empty_g2_list_structure();
				SVREF(object,FIX((SI_Long)20L)) = 
					svref_new_value;
			    }
			    temp_1 = ISVREF(ISVREF(object,(SI_Long)20L),
				    (SI_Long)0L);
    ...
    next_loop:
	  ...
	  if (IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)5L) {
		  ...
		  if (IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)8L)
		      resumable_object_as_handle = gensym_cons_1(kind,
			      constant_value);
		  else {
	  ...
	  if (IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)5L) {
		  ...
		  if (temp_1) {
		      ...
		      temp_2 = ISVREF(icp_socket,(SI_Long)22L);
		      if (IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)8L)
			  resumable_object = gensym_list_4(Qcopy,
	  ...
	  if ((IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)10L ? TRUEP(T) : 
	      ...
	      register_all_items_in_value(argument_or_result,
		      interface_frame_qm);
	      car_new_value = gensym_cons_1(Qhandle,argument_or_result);
	      ...
	      temp_2 = ISVREF(icp_socket,(SI_Long)22L);
	      if (IFIX(FIXNUM_MIN(temp,temp_2)) >= (SI_Long)8L) {
		  car_new_value = as_reference_p ? 
			  gensym_cons_1(Qreference,argument_or_result) : 
			  gensym_list_4(Qcopy,argument_or_result,info,Nil);
		  M_CAR(argument_or_result_cons) = car_new_value;
	      }
	  }
      }
    ...
    Object remote_procedure_declaration, icp_interface;
{
    ...
    Object gensym_push_modify_macro_arg, car_1, cdr_1, temp, temp_1, arg;
    Object ab_loop_list_;

    x_note_fn_call(169,50);
    remote_procedure_identifier = 
    ...
    gensym_push_modify_macro_arg = remote_procedure_call;
	...
	if (SIMPLE_VECTOR_P(arg) && EQ(ISVREF(arg,(SI_Long)0L),
	    ...
	    gensym_push_modify_macro_arg = arg;
	    car_1 = gensym_push_modify_macro_arg;
    ...
    Object returned_values, return_descriptions, remote_procedure_declaration;
{
    ...
    Object temp_to_reclaim, resumable_objects_reclaimed_p, type1, type2;
    Object constant_value, handled_object_qm;
    SI_Long gensymed_symbol, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(169,51);
  ...
  next_loop:
	...
	gensymed_symbol_2 = evaluation_value_or_frame_qm;
	temp_1 = FIXNUMP(gensymed_symbol_2);
	if (temp_1);
	else
	    temp_1 = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_2) != 
		    (SI_Long)0L ? 
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_2)) == 
		    (SI_Long)1L : TRUEP(Qnil);
	if (temp_1);
	else
	    temp_1 = INLINE_LONG_VECTOR_P(gensymed_symbol_2) != 
		    (SI_Long)0L ? 
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_2)) == 
		    (SI_Long)1L : TRUEP(Qnil);
	if (temp_1);
	else
	    temp_1 = gensymed_symbol_2 ? SYMBOLP(gensymed_symbol_2) : 
		    TRUEP(Qnil);
	if (temp_1);
	else
	    temp_1 = INLINE_UNSIGNED_BYTE_16_VECTOR_P(gensymed_symbol_2) 
		    != (SI_Long)0L;
	if (temp_1);
	else if (CONSP(gensymed_symbol_2)) {
	    gensymed_symbol_2 = M_CDR(gensymed_symbol_2);
	    temp_1 = EQ(gensymed_symbol_2,Qtruth_value);
	    if (temp_1);
	    else
		temp_1 = EQ(gensymed_symbol_2,Qiteration_state);
	    if (temp_1);
	    else if (SYMBOLP(gensymed_symbol_2)) {
		gensymed_symbol_1 = CDR(Defined_evaluation_value_types);
		gensymed_symbol = SXHASH_SYMBOL_1(gensymed_symbol_2) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop_1:
		if ( !TRUEP(gensymed_symbol_1))
	...
	if ( !temp_1) {
	  ...
	  next_loop_3:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    gensymed_symbol_2 = temp_to_reclaim;
	    temp_1 = FIXNUMP(gensymed_symbol_2);
	    if (temp_1);
	    else
		temp_1 = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_2) 
...
static Object string_constant_33;  /* "1y1n83-8my1m1m9k83*5y1m9k83-k5y1m83-1iy83-k5y1m83-7Ny83-fTy1n83-fTy1t1m9k83-9y1m9k83jWy1m9k83-Ty1m9k83-Gy83jSy1m9k83-*5y1m9k83Gr" */

static Object string_constant_34;  /* "y83-bvy1m9k83-Ay1n83-Gyps1n83-fTy1x1m9k83-9y1m9k83jWy1m9k83-Ty1m9k83-Gy83jSy1m9k83-*5y1m9k830*y1m9k83Gry1m9k83*Xy1m9k9l1m9k83-qy" */

static Object string_constant_35;  /* "836Iy1m9k83-Ay1n83-Gyp1m9mw1m83-bvy83-MSy1o83-bvy1n83-MSy1m9k83vy83-bvy1nmln9n1m83-MSy836Iy1n83-MSy1p83djy1m9k83-*6y1m9k83-7Ky1m" */

static Object string_constant_36;  /* "9k83=hy83djy1mlo1n833*y1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy833*y1m83-fUyp1n830By1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy830By1m83-fU" */

static Object string_constant_37;  /* "yp1n83F2y1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy83F2y1m83-fUyp1n83lNy1n1m9k83DAy1m9k83-Py839ay1n83DAyn1m1l8328y01n83lNy1n1m9k83E=y1" */

static Object string_constant_38;  /* "m9k83-Py83-ky1n83E=yn1m1l8328y01n83lNy1n1m9k83BCy1m9k83-Py83-2y1n83BCyn1m1l8328y0" */
...
Object enable_references_for_item_passing()
{
    ...
    Object kb_properties, kb_specific_value, resulting_value, temp_2, entry;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    Declare_special(1);
    XDeclare_area(1);

    x_note_fn_call(169,55);
    ...
    Object identifying_attributes, interface_1;
{
    ...
    x_note_fn_call(169,65);
    current_network_interface = interface_1;
    PUSH_SPECIAL(Current_network_interface,current_network_interface,0);
    ...
    Object miscellaneous_parameters;
{
    ...
    x_note_fn_call(169,70);
    PUSH_SPECIAL(Miscellaneous_parameters,miscellaneous_parameters,1);
      scope_conses = Scope_conses;
      ab_loopvar_ = Nil;
      ab_loopvar__1 = Nil;
      x = Nil;
...
{
    x_note_fn_call(169,75);
    return write_name_denotation(slot_value);
}

Object Cached_name_for_local_home = UNBOUND;
...
Object name_for_local_home()
{
    ...
    Object ab_loop_desetq_, str, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, interface_1, attribute, value;
    char temp;
    Declare_special(2);
    Object result;

    x_note_fn_call(169,80);
	...
	if (Cached_name_for_local_home) {
		...
		PUSH_SPECIAL(Local_host_name,local_host_name,1);
...
void g2_rpc3_INIT()
{
    ...
    Object Qname_for_local_home, AB_package, list_constant_6, Qslot_putter;
    Object Qput_local_item_home, Qslot_value_writer;
    Object Qwrite_local_item_home_from_slot;
    ...
    string_constant_53 = 
	    STATIC_STRING("13ey1n83-Bry1n1m9k83-9y83-kqy1m9k83-Ay1lm1n83-Bry1n1m9k83-9y83-JWy1m9k83-Ay1lm1o83-JWy1n1m9k830*y1m9k83-Bey83-kqy1mn1m83-JVy8k9l");
    string_constant_54 = 
	    STATIC_STRING("1n83-kqy1n1m9k83-Gy83-Gy83-gPy2m83*gy1m83-Gymn1n83-kqy1m1m9k8377y83-gPy2m83*gy83=Kym1n83-kqy1m1m9k83*ly83-gPy2m83*gy83=oym1n83-k");
    string_constant_55 = 
	    STATIC_STRING("qy1m1m9k8s83-gPy2m83*gy1l8sm1n83-kqy1m1m9k830Sy83-gPy2m83*gy1l830Sym1n83mMy1m1m9k83-Gy83-Gy1m83*gy1m83-Gym1n83mMy1n1m9k83-Gy83-G");
    string_constant_56 = 
	    STATIC_STRING("y83-8my2m83*gy1m83-Gymn1n83mMy1n1m9k83-Gy83-Gy83-hSy2m83*gy1m83-Gymn1n83mMy1o1m9k83-9y1m9k83-Gy83-Gy1m9k83-Ay1m83*gy1m83-Gyn1n83");
    string_constant_57 = 
	    STATIC_STRING("mMy1n1m9k83-9y1m9k8377y1m9k83-Ay1m83*gy83=Ky1n83mMy1n1m9k83-9y1m9k83*ly1m9k83-Ay1m83*gy83=oy1n83mMy1n1m9k83-9y1m9k8s1m9k83-Ay1m8");
    string_constant_58 = 
	    STATIC_STRING("3*gy1l8s1n83mMy1n1m9k83-9y1m9k830Sy1m9k83-Ay1m83*gy1l830Sy1n83mMy1p1m9k83-9y1m9k83-Gy83-Gy83-gPy1m9k83-Ay2m83*gy1m83-Gyno1n83mMy");
    string_constant_59 = 
	    STATIC_STRING("1o1m9k83-9y1m9k8377y83-gPy1m9k83-Ay2m83*gy83=Kyn1n83mMy1o1m9k83-9y1m9k83*ly83-gPy1m9k83-Ay2m83*gy83=oyn1n83mMy1o1m9k83-9y1m9k8s8");
    string_constant_60 = 
	    STATIC_STRING("3-gPy1m9k83-Ay2m83*gy1l8sn1n83mMy1o1m9k83-9y1m9k830Sy83-gPy1m9k83-Ay2m83*gy1l830Syn1m83-gPy83-gOy1m83-gPy83-gQy1o83-gPy1m83-hSy8");
    string_constant_61 = 
	    STATIC_STRING("3-gQy1mlm9l1o83-gPy1m83-gQy83-hSy1mlm9l1m83-gOy83-8my1m83-gOy83-hSy1n83-8my1m1m9k83*5y1m9k83-X-y1m83-1iy83-X-y1n83-hSy1m1m9k83=F");
    string_constant_62 = 
	    STATIC_STRING("y1m9k83-X-y1m83-1iy83-L9y1o83-gQy1n83-Yjy1m9k83-ty83-Yiy1mln9l1m83-gQy83-Yjy1m83-Yjy83-Ydy1m83-Yjy83-T-y1o83-Ydy1r1m9k83-=Ny1m9k");
    string_constant_63 = 
	    STATIC_STRING("839Zy1m9k9m1m9k83oNy1m9k83Gry1m9k83-Py83oOy1m83-Ycyr9n1n83-Ydy1q1m9k83-=Ny1m9k839Zy1m9k9m1m9k83oNy1m9k83-qy83djy1m83-Ycy1lq1o83-");
    string_constant_64 = 
	    STATIC_STRING("T-y1q1m9k83-T=y1m9k9m1m9k83oNy1m9k83Gry1m9k83-Py83oOy1m83-T+yq9n1n83-T-y1p1m9k83-T=y1m9k9m1m9k83oNy1m9k83-qy83djy1m83-T+y1lp1m83");
    string_constant_65 = 
	    STATIC_STRING("-gQy83-Yiy1n83-Yiy1o1m9k83-=Ny1m9k830*y1m9k8l1m9k83Gry1m83-Yay8k1o83-Yiy1r1m9k83-=Ny1m9k830*y1m9k8l1m9k83Gry1m9k83vsy1m9k83-Py83");
    string_constant_66 = 
	    STATIC_STRING("-YTy1o83-Ybyr83-Yay8k9n1o83-Yiy1q1m9k83-=Ny1m9k9m1m9k8l1m9k83Gry1m9k83-Py83-YTy1m83-Yhyq9n1n83-Yiy1p1m9k83-=Ny1m9k9m1m9k8l1m9k83");
    string_constant_67 = 
	    STATIC_STRING("-qy83j-y1m83-Yhy1lp1n83j-y1n1m9k836xy1m9k83-Ty1m9k830Cy836xy1m83j-y83FJy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_33 = 
	    STATIC_STRING("1y1n83-8my1m1m9k83*5y1m9k83-k5y1m83-1iy83-k5y1m83-7Ny83-fTy1n83-fTy1t1m9k83-9y1m9k83jWy1m9k83-Ty1m9k83-Gy83jSy1m9k83-*5y1m9k83Gr");
    string_constant_34 = 
	    STATIC_STRING("y83-bvy1m9k83-Ay1n83-Gyps1n83-fTy1x1m9k83-9y1m9k83jWy1m9k83-Ty1m9k83-Gy83jSy1m9k83-*5y1m9k830*y1m9k83Gry1m9k83*Xy1m9k9l1m9k83-qy");
    string_constant_35 = 
	    STATIC_STRING("836Iy1m9k83-Ay1n83-Gyp1m9mw1m83-bvy83-MSy1o83-bvy1n83-MSy1m9k83vy83-bvy1nmln9n1m83-MSy836Iy1n83-MSy1p83djy1m9k83-*6y1m9k83-7Ky1m");
    string_constant_36 = 
	    STATIC_STRING("9k83=hy83djy1mlo1n833*y1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy833*y1m83-fUyp1n830By1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy830By1m83-fU");
    string_constant_37 = 
	    STATIC_STRING("yp1n83F2y1p1m9k9l1m9k83-7Ky1m9k83D0y1m9k83=Iy83F2y1m83-fUyp1n83lNy1n1m9k83DAy1m9k83-Py839ay1n83DAyn1m1l8328y01n83lNy1n1m9k83E=y1");
    string_constant_38 = 
	    STATIC_STRING("m9k83-Py83-ky1n83E=yn1m1l8328y01n83lNy1n1m9k83BCy1m9k83-Py83-2y1n83BCyn1m1l8328y0");
    ...
    string_constant_68 = 
	    STATIC_STRING("1n1m83D1y836Iy1n83DTy1r1m9k83-2fy1m9k837by1m9k83ULy1m9k9l1m9k832+y1m9k83kDy1m9k83-V6y1l9m1m83DTy83-qy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
