...
Object Dummy_evaluators_list = UNBOUND;
...
Object Funcalled_instructions = UNBOUND;

Object Funcalled_instruction_functions = UNBOUND;
...
Object Free_global_stacks = UNBOUND;

Object Stack_eval_locals_bindings = UNBOUND;

Object Float_contagion_stack_operators = UNBOUND;
...
Object Stack_instructions = UNBOUND;
...
Object Current_code_body_entry = UNBOUND;
...
Object resolve_procedure_byte_code_addresses varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Current_code_body_entry,current_code_body_entry,0);
...
Object Show_stack_bytes_qm = UNBOUND;
...
/* COMPUTATION-INSTANCE-ANOTHER-BYTE-CODE-BODY */
Object computation_instance_another_byte_code_body(computation_instance)
    Object computation_instance;
{
    Object temp;
    ...
    if (SIMPLE_VECTOR_P(computation_instance) && 
	    EQ(ISVREF(computation_instance,(SI_Long)0L),
	    Qg2_defstruct_structure_name_procedure_invocation_g2_struct))
	temp = ISVREF(computation_instance,(SI_Long)23L);
    else if (SIMPLE_VECTOR_P(computation_instance) && 
	    EQ(ISVREF(computation_instance,(SI_Long)0L),
	    Qg2_defstruct_structure_name_rule_instance_g2_struct))
	temp = ISVREF(computation_instance,(SI_Long)8L);
    else
	temp = computation_instance;
    return get_byte_code_body_if_any(temp,Nil);
}
    ...
    Object depth, computation_frame, computation_instance, stack_frame_base;
{
  ...
  next_loop:
	...
	temp = TRUEP(Nil);
    if (temp) {
	ab_loopvar__2 = gensym_cons_1(current_frame,Nil);
	if (ab_loopvar__1)
    ...
    Object computation_instance;
{
    ...
    Object local_var_vector, stack_program_counter, instance, bcb, b;
    Object svref_new_value;
	...
	if (Inside_breakpoint_p)
		...
		bcb = ISVREF(instance,(SI_Long)1L);
		if ( !TRUEP(ISVREF(bcb,(SI_Long)2L))) {
		    b = computation_instance_another_byte_code_body(instance);
		    if (b) {
			bcb = b;
			SVREF(instance,FIX((SI_Long)1L)) = bcb;
			svref_new_value = ISVREF(bcb,(SI_Long)3L);
			SVREF(instance,FIX((SI_Long)4L)) = svref_new_value;
		    }
		}
		byte_code_body = bcb;
    ...
    Object find_cycle;
{
    ...
    Object ab_current_alist_, ab_entry_cons_, invocation;
    Object ab_less_than_branch_qm_, gensym_pop_store, cons_1, next_cons;
    Object temp_1, temp_2, invocation_entry, waited_for_invocation;
    Object ab_loop_list_, waiting_invocation, ab_loop_list__1;
    Object gensym_push_modify_macro_arg, car_1, cdr_1, waiter, entry;
	...
	end_loop:
	  ...
	  next_loop_2:
	    ...
	    invocations_to_process = gensym_cons_1(invocation,
  ...
  next_loop_6:
	...
	if (ISVREF(invocation,(SI_Long)19L))
	    ...
	    temp_2 = ISVREF(invocation,(SI_Long)13L) ? FIX((SI_Long)1L) : 
		    FIX((SI_Long)0L);
	else
	    temp_2 = length(ISVREF(invocation,(SI_Long)13L));
	invocation_entry = gensym_list_3(invocation,temp_2,Nil);
	eq_puthash(invocations_hash_table,invocation,invocation_entry);
	invocation_entries = gensym_cons_1(invocation_entry,
		invocation_entries);
	...
	if ( !TRUEP(eq_gethash(invocations_hash_table,
		waited_for_invocation,Nil)))
	    invocations_to_process = gensym_cons_1(waited_for_invocation,
		    invocations_to_process);
	goto next_loop_7;
      end_loop_7:;
    }
  ...
  end_loop_9:;
	...
	awaiting_serialization = gensym_cons_1(invocation_entry,
  ...
  next_loop_10:
    ...
    invocation_entry = gensym_pop_store;
    number_of_unserialized_invocations = 
  ...
  next_loop_11:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp_1 = FIXNUM_SUB1(SECOND(waiter));
    if (IFIX(M_SECOND(waiter) = temp_1) == (SI_Long)0L)
	awaiting_serialization = gensym_cons_1(waiter,awaiting_serialization);
    goto next_loop_11;
  end_loop_11:;
    goto next_loop_10;
  end_loop_10:
    temp_2 = IFIX(number_of_unserialized_invocations) == (SI_Long)0L ? Nil 
	    : find_cycle ? 
  ...
  next_loop_12:
    ...
    goto next_loop_12;
  end_loop_12:;
    reclaim_gensym_list_1(invocation_entries);
    ...
    Object entry;
{
	...
	temp = gensym_cons_1(CAR(entry),Nil);
	...
	if (EQ(waiting_for_this,entry)) {
		...
		if (EQ(end_of_path,CAR(entry)))
		    ...
		    temp = gensym_cons_1(CAR(entry),path_or_cycle);
    ...
    Object invocation_cycle;
{
  ...
  end_loop_1:
    ...
    reclaim_gensym_list_1(invocation_cycle);
    return VALUES_1(Nil);
}
...
Object Automatic_deadlock_detection_task = UNBOUND;

Object Automatic_deadlock_detection_frequency = UNBOUND;
    ...
    Object new_frequency, force_qm;
{
    ...
    Object frequency_as_float, future_task_schedule_modify_arg_4;
	...
	if (Automatic_deadlock_detection_task) {
	    if (EQ(Automatic_deadlock_detection_task,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Automatic_deadlock_detection_task,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Automatic_deadlock_detection_task);
	    inline_note_reclaim_cons(Automatic_deadlock_detection_task,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Automatic_deadlock_detection_task;
	    reclaim_schedule_task_args(ISVREF(Automatic_deadlock_detection_task,
		    (SI_Long)9L));
	    temp = Automatic_deadlock_detection_task;
	...
	temp = Nil;
	Automatic_deadlock_detection_task = temp;
	if (new_frequency) {
		...
		future_task_schedule_modify_arg_3 = temp_1 + temp_2;
		future_task_schedule_modify_arg_4 = frequency_as_float;
		future_task_schedule_modify_arg_8 = 
			SYMBOL_FUNCTION(Qdetect_and_break_deadlocks);
		if (Automatic_deadlock_detection_task) {
		    if (EQ(Automatic_deadlock_detection_task,
			    Current_schedule_task))
			Current_schedule_task = Nil;
		    if (ISVREF(Automatic_deadlock_detection_task,(SI_Long)6L))
			cancel_and_reclaim_scheduled_queue_element_1(Automatic_deadlock_detection_task);
		    inline_note_reclaim_cons(Automatic_deadlock_detection_task,
			    Nil);
		    old_structure_being_reclaimed = Structure_being_reclaimed;
		...
		Automatic_deadlock_detection_task = task;
	    }
...
void stack_utils_INIT()
{
    ...
    Object Qautomatic_deadlock_detection_frequency;
    Object Qautomatic_deadlock_detection_task, Qg2_detect_and_break_deadlocks;
    ...
    Object Qinference_engine_parameters, Qtruth_threshold, Qbyte_instruction;
    Object Qinstruction_count, Qinitial_program_counter;
    Object Qstack_program_counter, Qinitial_stack_frame_base;
    Object Qstack_frame_base, Qinitial_top_of_stack, Qtop_of_stack;
    Object Qglobal_stack, Qlocal_stack, list_constant_3, Qinstruction_vector;
    Object Qbyte_code_body, Qbyte_code_body_byte_vector;
    Object Qmaximum_stack_frame_size, Qfree_global_stacks, Qmake_global_stack;
    Object list_constant_2, Qutilities0, Kfuncall, Qglobal_stack_size;
    Object Qfuncall_eval_type_8_arg, Qfuncall_eval_type_7_arg;
    Object Qfuncall_eval_type_6_arg, Qfuncall_eval_type_5_arg;
    Object Qfuncall_eval_type_4_arg, Qfuncall_eval_type_3_arg;
    Object Qfuncall_eval_type_2_arg, Qfuncall_eval_type_1_arg;
    Object Qfuncall_eval_type_0_arg, Qmaximum_number_of_funcalled_instructions;
    Object Qsimulator, Qinference;
    ...
    string_constant = 
	    ...
	    STATIC_STRING("source code of the item named in the error message."));
