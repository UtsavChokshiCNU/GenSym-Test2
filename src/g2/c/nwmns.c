...
Object Chain_of_available_partial_commands = UNBOUND;

Object Partial_command_count = UNBOUND;
    ...
    Object partial_command;
{
    ...
    svref_new_value = Chain_of_available_partial_commands;
    SVREF(partial_command,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_partial_commands = partial_command;
    return VALUES_1(Nil);
}
...
Object make_permanent_partial_command_structure_internal()
{
    ...
    Object partial_command_count_new_value;
    ...
    partial_command_count_new_value = FIXNUM_ADD1(Partial_command_count);
    Partial_command_count = partial_command_count_new_value;
    ...
    Object partial_command;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(arguments);
    return reclaim_partial_command_1_1(partial_command);
}
    ...
    Object partial_command;
{
    ...
    arguments = copy_list_using_gensym_conses_1(ISVREF(partial_command,
	    (SI_Long)2L));
    sublist = arguments;
    argument = Nil;
  next_loop:
    ...
    Object command_or_command_name;
{
	...
	number_of_arguments = Qnil;
      end_1:;
	arguments = make_gensym_list_1(number_of_arguments);
	place = arguments;
      next_loop_1:
	if ( !TRUEP(place))
	    goto end_loop_1;
    ...
    Object presentation_type;
{
	...
	if (CONSP(temp))
	    reclaim_gensym_list_1(CAR(presentation_type));
	return reclaim_gensym_list_1(presentation_type);
    }
    else
	return VALUES_1(Nil);
}
...
Object Ui_command_context = UNBOUND;
    ...
    Object partial_command;
{
	...
	argument = M_CAR(ab_loop_list_);
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(command_argument_value(argument),Nil);
	if (ab_loopvar__1)
	...
	reclaim_gensym_list_1(command_arguments);
...
Object Presentation_mode = UNBOUND;
    ...
    Object partial_command, argument_type, mouse_pointer, mode;
{
    ...
    PUSH_SPECIAL(Presentation_mode,presentation_mode,0);
      if (ptype_qm) {
    ...
    Object menu_description;
{
    ...
    Object command_structure_qm, gensym_modify_macro_using_test_arg_1, car_1;
	...
	if (ATOM(symbol_or_list)) {
	    command_structure_qm = 
		    ...
		    Qui_command_named);
	    gensym_modify_macro_using_test_arg_1 = command_structure_qm ? 
...
Object menu_item_string varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
	  ...
	  if (temp_1)
		  ...
		  (SI_Long)0L),
		  Qg2_defstruct_structure_name_ui_command_g2_struct)) {
	      string_1 = translated_string_for_symbol(3,ISVREF(menu_item,
		      (SI_Long)2L),capitalize_qm,strip_hyphens_qm);
	      result = compute_modified_menu_item_string(ISVREF(menu_item,
		      (SI_Long)1L),string_1);
	  }
	  else if (CONSP(menu_item)) {
	      temp = CAR(menu_item);
		  ...
		  if (ISVREF(menu_description,(SI_Long)10L)) {
			  ...
			  temp = submenu_name;
		      result = menu_item_string(5,menu_description,temp,
		      ...
		      result = menu_item_string(5,submenu_desc,temp,
			      capitalize_qm,strip_hyphens_qm,parameters);
		  }
		  else
		      result = tformat_text_string(2,string_constant_2,
			      submenu_name);
	      }
	      else if (EQ(temp,Qchoice) || EQ(temp,Qcommand) || EQ(temp,
		      Qdialog) || EQ(temp,Quser_menu_choice))
		  result = menu_item_string(5,menu_description,
			  SECOND(menu_item),capitalize_qm,strip_hyphens_qm,
			  parameters);
	      else
		  result = VALUES_1(Nil);
	  }
...
Object transform_menu_item varargs_1(int, n)
{
	...
	if ( !TRUEP(partial_command_qm))
	    ...
	    new_menu_item = copy_list_using_gensym_conses_1(menu_item);
	    M_THIRD(new_menu_item) = partial_command_qm;
	    if (recyclable_lists_qm)
		reclaim_gensym_list_1(menu_item);
    ...
    Object choices, restrictions, permitted_qm;
{
  ...
  next_loop:
    ...
    if (allowed_p) {
	ab_loopvar__2 = gensym_cons_1(choice,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
{
    Object x2, gensym_push_modify_macro_arg, car_1, cdr_1;
	...
	temp = TRUEP(Nil);
    if (temp) {
	gensym_push_modify_macro_arg = make_snapshot_of_block(menu_item);
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = get_lookup_slot_value_given_default(menu_1,
		Qnew_menu_other_things_to_reclaim,Nil);
	new_menu_other_things_to_reclaim_new_value = gensym_cons_1(car_1,
		cdr_1);
	return set_non_savable_lookup_slot_value(menu_1,
	    ...
	    (SI_Long)0L),
	    Qg2_defstruct_structure_name_partial_command_g2_struct)) {
	gensym_push_modify_macro_arg = menu_item;
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = get_lookup_slot_value_given_default(menu_1,
		Qnew_menu_other_things_to_reclaim,Nil);
	new_menu_other_things_to_reclaim_new_value = gensym_cons_1(car_1,
	...
	if (menu_item_is_command_p(menu_item)) {
	    ...
	    temp = TRUEP(Nil);
	if (temp) {
	    gensym_push_modify_macro_arg = menu_item_command(menu_item);
	    car_1 = gensym_push_modify_macro_arg;
	    cdr_1 = get_lookup_slot_value_given_default(menu_1,
		    Qnew_menu_other_things_to_reclaim,Nil);
	    new_menu_other_things_to_reclaim_new_value = 
...
Object make_menu_from_description varargs_1(int, n)
{
	...
	ab_loop_it_ = item_submenu_function_qm ? 
		inline_funcall_5(item_submenu_function_qm,menu_description,
		menu_item,arg_1,arg_2,arg_3) : 
	...
	if (title_qm) {
	    temp = gensym_cons_1(menu_item_string(5,menu_description,
		    title_qm,capitalize_qm,strip_hyphens_qm,parameters),Nil);
	    title_cells = gensym_cons_1(make_table_spanning_row(2,
	...
	format_1 = (item_submenu_function_qm ? 
		...
		TRUEP(menu_item_submenu_p(menu_description,menu_item))) ? 
		cascade_format : default_format;
	ab_loopvar__2 = make_table_rows_for_menu_item(5,menu_description,
		menu_item,format_1,number_of_columns,parameters);
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
	...
	goto next_loop_3;
      end_loop_3:;
	set_non_savable_lookup_slot_value(menu_1,Qmenu_description_of_menu,
		menu_description);
	...
	set_non_savable_lookup_slot_value(menu_1,Qmenu_no_choice_function,
		ISVREF(menu_description,(SI_Long)6L));
	ISVREF(menu_1,(SI_Long)22L) = Nil;
	set_non_savable_lookup_slot_value(menu_1,Qmenu_choice_transformer,
		ISVREF(menu_description,(SI_Long)9L));
    ...
    Object menu_1, adjustment;
{
    ...
    Object new_format_name, new_format, x, x2, temp_1, gensymed_symbol;
    char temp;
  ...
  next_loop_1:
    ...
    else if (EQ(format_name,Qleft_aligned_cascade_menu_item_format_new_small))
	new_format_name = 
    ...
    else if (EQ(format_name,Qleft_arrow_left_aligned_cascade_menu_item_format))
	...
	new_format_name = Qleft_arrow_left_aligned_menu_item_format_new_large;
    else if (EQ(format_name,Qleft_aligned_menu_item_format_new_small))
	new_format_name = Qleft_arrow_left_aligned_menu_item_format_new_small;
    else if (EQ(format_name,
    ...
    if (new_format_name) {
	temp_1 = get_instance_with_name_if_any(Qformat_frame,new_format_name);
	if (temp_1);
	else
...
Object make_table_rows_for_menu_item varargs_1(int, n)
{
	...
	if (text_cell_qm ||  !TRUEP(item)) {
	    ab_loopvar__2 = gensym_cons_1(text_cell_qm,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
	...
	text_cell_qm = menu_item_make_text_cell(menu_description,menu_item,
		format_1,parameters);
	if (text_cell_qm)
	    return gensym_cons_1(make_table_spanning_row(2,text_cell_qm,
    ...
    Object menu_description, menu_item, format_1, parameters;
{
	...
	string_qm = menu_item_string(5,menu_description,menu_item,
		capitalize_qm,strip_hyphens_qm,parameters);
	if (string_qm) {
	    text_cell = make_text_cell(2,gensym_cons_1(string_qm,Nil),
		    format_1);
...
{
    Object menu_1;
    Object thing, temp, gensym_push_modify_macro_arg, car_1, cdr_1;
    Declare_varargs_nonrelocating;
    ...
    if (is_block_p(thing)) {
	gensym_push_modify_macro_arg = menu_1;
	car_1 = gensym_push_modify_macro_arg;
...
Object create_submenu varargs_1(int, n)
{
	...
	if (submenu_choice_list)
	    reclaim_gensym_list_1(submenu_choice_list);
	if (menu_qm) {
    ...
    Object x_for_right_adjusting_qm, walking_submenu_p;
{
    ...
    Object title_text_qm, ab_loop_it_, gensym_pop_store, cons_1, next_cons;
    ...
    Object mouse_pointer;
{
  ...
  end_1:;
	...
	if (text_box_spot_qm) {
		...
		temp_1 = TRUEP(Nil);
	    if (temp_1) {
		gensymed_symbol = ISVREF(frame_represented_qm,(SI_Long)14L);
		gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
			(SI_Long)5L) : Nil;
    ...
    Object cell;
{
	...
	gensymed_symbol_3 = ISVREF(cell,(SI_Long)14L);
...
Object Compute_menu_items_list = UNBOUND;

/* COLLECT-MENU-ITEM */
Object collect_menu_item(menu_description,menu_item,mouse_pointer)
    Object menu_description, menu_item, mouse_pointer;
{
    x_note_fn_call(119,220);
    Compute_menu_items_list = gensym_cons_1(menu_item,Compute_menu_items_list);
    return VALUES_1(Nil);
}
    ...
    Object menu_description, mouse_pointer, parameters;
{
    ...
    x_note_fn_call(119,221);
    compute_menu_items_list = Nil;
    PUSH_SPECIAL(Compute_menu_items_list,compute_menu_items_list,0);
...
Object Cached_restrictions_alist = UNBOUND;
    ...
    Object menu_description;
{
	...
	if (include_clause_qm) {
	    ...
	    ab_loopvar__2 = gensym_cons_1(copy_menu_item(choice),Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
...
Object Name_for_find_menu_item = UNBOUND;
    ...
    Object menu_name, menu_description, mouse_pointer, parameters;
{
    ...
    x_note_fn_call(119,224);
    name_for_find_menu_item = menu_name;
    PUSH_SPECIAL(Name_for_find_menu_item,name_for_find_menu_item,0);
    ...
    Object menu_items;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(menu_items);
}
...
Object Chain_of_available_hot_spot_states = UNBOUND;

Object Hot_spot_state_count = UNBOUND;
    ...
    Object hot_spot_state;
{
    ...
    svref_new_value = Chain_of_available_hot_spot_states;
    SVREF(hot_spot_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_hot_spot_states = hot_spot_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_hot_spot_state_structure_internal()
{
    ...
    Object hot_spot_state_count_new_value;
    Object defstruct_g2_hot_spot_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(119,234);
    def_structure_hot_spot_state_variable = Nil;
    hot_spot_state_count_new_value = FIXNUM_ADD1(Hot_spot_state_count);
    Hot_spot_state_count = hot_spot_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_hot_spot_state_variable, svref_new_value;

    x_note_fn_call(119,235);
    def_structure_hot_spot_state_variable = Chain_of_available_hot_spot_states;
    ...
    SVREF(def_structure_hot_spot_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    ...
    svref_new_value = copy_of_current_frame_serial_number_function();
    SVREF(def_structure_hot_spot_state_variable,FIX((SI_Long)14L)) = 
	    svref_new_value;
    SVREF(def_structure_hot_spot_state_variable,FIX((SI_Long)15L)) = T;
    svref_new_value = 
	    ISVREF(image_plane_with_selection_focus_of_workstation_context,
	    (SI_Long)5L);
    SVREF(def_structure_hot_spot_state_variable,FIX((SI_Long)16L)) = 
	    svref_new_value;
    svref_new_value = ISVREF(ISVREF(Current_workstation,(SI_Long)11L),
	    (SI_Long)7L);
    SVREF(def_structure_hot_spot_state_variable,FIX((SI_Long)17L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_hot_spot_state_variable);
}
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
			    ...
			    hot_spot_state = 
				    workstation_context_specifics_blackboard_function(mouse_pointer);
			    if (hot_spot_state) {
				SVREF(hot_spot_state,FIX((SI_Long)12L)) = T;
				if ( !TRUEP(ISVREF(hot_spot_state,
					(SI_Long)13L)))
				    result = push_back_mouse_motion_event();
				else
				    result = VALUES_1(Nil);
			    }
			    else
...
{
    Object svref_arg_1, schedule_task_qm, old_structure_being_reclaimed, temp;
    Object mouse_pointer, hot_spot_state, future_task_schedule_modify_arg_8;
    ...
    x_note_fn_call(119,241);
    svref_arg_1 = Current_workstation;
    schedule_task_qm = ISVREF(svref_arg_1,(SI_Long)36L);
    if (schedule_task_qm) {
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qscrolling_heartbeat);
	...
	result = VALUES_1(SVREF(svref_arg_1,FIX((SI_Long)36L)) = task);
    }
    ...
    Object method, inside_qm;
{
    ...
    Object gensym_window, image_plane, temp, schedule_task_qm;
    Object old_structure_being_reclaimed, svref_new_value, ui_command;
    Object gensymed_symbol, temp_1;

    x_note_fn_call(119,242);
    mouse_pointer = ISVREF(Current_workstation,(SI_Long)13L);
    hot_spot_state = 
	    workstation_context_specifics_blackboard_function(mouse_pointer);
    spot = spot_blackboard_function(mouse_pointer);
	...
	if (EQ(method,Kunwind)) {
	    ...
	    schedule_task_qm = ISVREF(temp,(SI_Long)36L);
	    if (schedule_task_qm) {
		if (EQ(schedule_task_qm,Current_schedule_task))
		    Current_schedule_task = Nil;
		if (ISVREF(schedule_task_qm,(SI_Long)6L))
	    ...
	    svref_new_value = Nil;
	    return VALUES_1(SVREF(temp,FIX((SI_Long)36L)) = svref_new_value);
	}
    ...
    Object identified_drawing_activity, kind_of_continuation;
{
	...
	if (ISVREF(hot_spot_state,(SI_Long)12L)) {
	    current_workstation_1 = 
		    ISVREF(ISVREF(identified_drawing_activity,(SI_Long)6L),
		    (SI_Long)2L);
	    PUSH_SPECIAL(Current_workstation,current_workstation_1,11);
    ...
    return remove_identified_drawing_activity(identified_drawing_activity,
	    kind_of_continuation);
}
...
Object Chain_of_available_elevator_states = UNBOUND;

Object Elevator_state_count = UNBOUND;
    ...
    Object elevator_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_elevator_states;
    SVREF(elevator_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_elevator_states = elevator_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_elevator_state_structure_internal()
{
    ...
    Object elevator_state_count_new_value;
    Object defstruct_g2_elevator_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(119,251);
    def_structure_elevator_state_variable = Nil;
    elevator_state_count_new_value = FIXNUM_ADD1(Elevator_state_count);
    Elevator_state_count = elevator_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_elevator_state_variable, svref_new_value;

    x_note_fn_call(119,252);
    def_structure_elevator_state_variable = Chain_of_available_elevator_states;
    ...
    svref_new_value = copy_of_current_frame_serial_number_function();
    SVREF(def_structure_elevator_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    ...
    Object gensym_window, menu_1, top_level_menu_handle_qm;
{
    ...
    next_loop:
	  ...
	  if (top_handle);
	      ...
	      top_handle = FIX(i);
	  entry = gensym_list_2(menu_snap,top_handle);
    ...
    Object gensym_window, handle, info;
{
    ...
    PUSH_SPECIAL(Native_menu_table,native_menu_table,0);
      ...
      if (entry_qm)
	  nconc2(entry_qm,gensym_cons_1(info,Nil));
...
Object extract_menu_item_list_from_menu varargs_1(int, n)
{
    ...
    Object max_depth, column_items, items, ab_loopvar_, ab_loopvar__1, row;
    Object ab_loop_list_, cell_qm, string_qm, item_qm, ab_loop_it_;
    Object ab_loopvar__2, ab_loopvar__3, piece, ab_loop_list__1, fmt, plist;
    Object fg, bg, submenu_qm, choice, submenu_handle, temp;
    SI_Long column, ab_loop_bind_;
    Declare_varargs_nonrelocating;

    x_note_fn_call(119,273);
    INIT_ARGS_nonrelocating();
  ...
  next_loop_1:
	...
	if (menu_item_format_is_cascade_p(fmt)) {
		...
		if ( !TRUEP(submenu_qm))
		    ...
		    submenu_handle = allocate_menu_handle(gensym_window,
			    submenu_qm,top_level_menu_handle);
		    ensure_that_menu_item_will_be_reclaimed(menu_1,submenu_qm);
		    temp = gensym_list_3(Qsubmenu,string_qm,submenu_handle);
		    item_qm = nconc2(temp,
			    extract_menu_item_list_from_menu(4,
			    gensym_window,top_level_menu_handle,submenu_qm,
			    FIXNUM_SUB1(max_depth)));
		}
	    }
	}
	else if (fg || bg)
...
{
    Object index_1, row, ab_loop_list_, cell_qm;
    SI_Long column, ab_loop_bind_;

    x_note_fn_call(119,277);
...
void new_menus_INIT()
{
    ...
    Object Qelevator_state_count, Qchain_of_available_elevator_states;
    ...
    Object Qhot_spot_state_structure_memory_usage, Qhot_spot_state_count;
    Object Qchain_of_available_hot_spot_states, string_constant_17;
    ...
    Object Qui_command_context, Qpartial_command;
    Object Qoutstanding_partial_command_count;
    Object Qpartial_command_structure_memory_usage, Qpartial_command_count;
    Object Qchain_of_available_partial_commands, string_constant_6;
    ...
    string_constant_5 = 
	    STATIC_STRING("43Dy8m83lWy1n83lWy8n8k1l8n0000001m1n8y83-54y01m83My83-Amyknk0k0");
    ...
    string_constant_6 = STATIC_STRING("1q83lWy8s83-hQy09k9l");
    ...
    string_constant_8 = 
	    STATIC_STRING("1o4z8r83VHy83VHy835qy835qy00001m1l83Ey1l8l000004z8r83VGy83VGy835qy835qy00001m1l83Ey1l8l000004z8r83WUy83WUy835qy835qy00001m1l83Ey");
    string_constant_9 = 
	    STATIC_STRING("1l8l000004z8r83VJy83VJy835qy835qy00001m1l83Ey1l8l00000");
    string_constant_10 = 
	    STATIC_STRING("1q8q1n835qy1l9k8t1o83VHy083Ey8l1o83VGy083Ey8l1o83WUy083Ey8l1o83VJy083Ey8l");
    ...
    string_constant_13 = 
	    STATIC_STRING("1n4z8r8325y8325y83XZy83XZy09k001m1l8o1l8l000004z8r83Xay83Xay83XZy83XZy00001m1l83Ey1l8l000004z8r83Xby83Xby83XZy83XZy00001m1l83Ey1");
    string_constant_14 = STATIC_STRING("l8l00000");
    string_constant_15 = 
	    STATIC_STRING("1p8q1n83XZy1l835qy8t1o8325y9k8o8l1o83Xay083Ey8l1o83Xby083Ey8l");
    temp = regenerate_optimized_constant(string_constant_7);
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83iby1p83iby830Vy83-Sy8n8k1l830Vy0000001m1n8y83-4Gy1t831Cy831Ky831Oy83-6my83-=Yy83-2*y83-FAy83-C3y83qny1m8x830Vyk3Eyk0k0");
    ...
    string_constant_17 = STATIC_STRING("1q83iby8s83-XYy09k9l");
    clear_optimized_constants();
    ...
    string_constant_19 = 
	    STATIC_STRING("43Dy8m83h4y1p83h4y830Vy83-Sy8n8k1l830Vy0000001m1n8y83-3Zy1n831Cy831Ky831Oy1m8x830Vykzk0k0");
    ...
    string_constant_20 = STATIC_STRING("1q83h4y8s83-SMy09k9l");
    clear_optimized_constants();
