...
Object Chain_of_available_code_body_continuations = UNBOUND;

Object Code_body_continuation_count = UNBOUND;
    ...
    Object code_body_continuation;
{
    ...
    x_note_fn_call(243,2);
    inline_note_reclaim_cons(code_body_continuation,Nil);
    svref_new_value = Chain_of_available_code_body_continuations;
    SVREF(code_body_continuation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_code_body_continuations = code_body_continuation;
    return VALUES_1(Nil);
}
...
Object make_permanent_code_body_continuation_structure_internal()
{
    ...
    Object code_body_continuation_count_new_value;
    Object defstruct_g2_code_body_continuation_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(243,4);
    def_structure_code_body_continuation_variable = Nil;
    code_body_continuation_count_new_value = 
	    FIXNUM_ADD1(Code_body_continuation_count);
    Code_body_continuation_count = code_body_continuation_count_new_value;
...
Object Chain_of_available_blocking_sockets = UNBOUND;

Object Blocking_socket_count = UNBOUND;
    ...
    Object blocking_socket;
{
    ...
    schedule_task_qm = ISVREF(blocking_socket,(SI_Long)9L);
    if (schedule_task_qm) {
    ...
    svref_new_value = Nil;
    SVREF(blocking_socket,FIX((SI_Long)9L)) = svref_new_value;
    ...
    reclaim_blocking_socket_partial_data(ISVREF(blocking_socket,(SI_Long)12L));
    ...
    svref_new_value = Chain_of_available_blocking_sockets;
    SVREF(blocking_socket,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_blocking_sockets = blocking_socket;
    return VALUES_1(Nil);
}
...
Object make_permanent_blocking_socket_structure_internal()
{
    ...
    Object blocking_socket_count_new_value;
    Object defstruct_g2_blocking_socket_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(243,14);
    def_structure_blocking_socket_variable = Nil;
    blocking_socket_count_new_value = FIXNUM_ADD1(Blocking_socket_count);
    Blocking_socket_count = blocking_socket_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_icmp_sockets = UNBOUND;

Object Icmp_socket_count = UNBOUND;
    ...
    Object icmp_socket;
{
    ...
    schedule_task_qm = ISVREF(icmp_socket,(SI_Long)9L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value = Nil;
    SVREF(icmp_socket,FIX((SI_Long)9L)) = svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_icmp_sockets;
    SVREF(icmp_socket,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_icmp_sockets = icmp_socket;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_icmp_socket_variable, icmp_socket_count_new_value;
    Object defstruct_g2_icmp_socket_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(243,51);
    def_structure_icmp_socket_variable = Nil;
    icmp_socket_count_new_value = FIXNUM_ADD1(Icmp_socket_count);
    Icmp_socket_count = icmp_socket_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Ping_seq_id_array = UNBOUND;
    ...
    Object icmp_socket, error_code, block_p;
{
  ...
  next_loop_3:
	...
	goto end_loop_3;
    c = FIX(UBYTE_8_ISAREF_1(buffer,i));
    ab_loopvar__2 = gensym_cons_1(c,Nil);
    if (ab_loopvar__1)
  ...
  end_1:;
    ...
    struct_1 = gensym_cons_1(gensymed_symbol,Qab_structure);
    ...
    Object g2_socket_as_evaluation_value, ret_var_as_evaluation_value;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, value;
    Object gensymed_symbol, invocation, x2;
    char temp;

    x_note_fn_call(243,58);
    g2_socket = IDENTITY(g2_socket_as_evaluation_value);
    ret_var = ret_var_as_evaluation_value;
...
/* G2-MQTT-LOG-TOPIC-DATA */
Object g2_mqtt_log_topic_data(item,log_p)
    Object item, log_p;
{
    SI_Long r;

    x_note_fn_call(243,59);
    r = g2ext_mqtt_log_topic_data((SI_Long)0L,EQ(log_p,Truth) ? 
...
/* G2-MQTT-LOG-PACKET-DATA */
Object g2_mqtt_log_packet_data(item,log_p)
    Object item, log_p;
{
    SI_Long r;

    x_note_fn_call(243,60);
    r = g2ext_mqtt_log_packet_data((SI_Long)0L,EQ(log_p,Truth) ? 
	    (SI_Long)1L : (SI_Long)0L);
    if (r == (SI_Long)0L)
	return VALUES_1(Evaluation_false_value);
    else
...
void socket2_INIT()
{
    ...
    Object Qg2_mqtt_log_packet_data;
    Object Qfunction_keeps_procedure_environment_valid_qm, AB_package;
    Object Qg2_mqtt_log_topic_data, Qread_ping_stream, Qicmp_socket;
    ...
    Object Qicmp_socket_count, Qchain_of_available_icmp_sockets;
    ...
    Object Qblocking_socket_structure_memory_usage, Qblocking_socket_count;
    Object Qchain_of_available_blocking_sockets, string_constant_32;
    ...
    Object Qcode_body_continuation_structure_memory_usage;
    Object Qcode_body_continuation_count;
    Object Qchain_of_available_code_body_continuations, string_constant_13;
    Object string_constant_12;

    x_note_fn_call(243,61);
    SET_PACKAGE("AB");
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83g1y1n83g1y8n8k1l8n0000001l1n8y83-3Fy1o83sDy83sEy83sFy83sCykpk0k0");
    ...
    Qcode_body_continuation_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83g1y8s83-Mpy09k9l");
    ...
    Qcreate_icon_description = STATIC_SYMBOL("CREATE-ICON-DESCRIPTION",
	    AB_package);
    string_constant_15 = 
	    STATIC_STRING("1p4z8r8u8u83NSy83NSy01p8w9k3ky3ky13Jy1q83-1y2l83*Ny83Ty2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l83*Uy83Ty1l83-iy1l83-jy83-Ly1n83jy1");
    string_constant_16 = 
    ...
    string_constant_21 = 
	    STATIC_STRING("TITY class definition000004z8r83NTy83NTy83NSy83NSy00001p1l8l1l8o1l83Fy1m8p83-qy1l83Hy000004z8r83NVy83NVy83NSy83NSy0835ry001p1l8l");
    string_constant_22 = 
	    STATIC_STRING("1l8o1l83Fy1m8p83-qy1l83Hy000004z8r83NUy83NUy83NSy83NSy00001p1l8l1l8o1l83Fy1m8p83-qy1l83Hy000004z8r83Sby83Sby83NSy83NSy00001n1l83");
    string_constant_23 = STATIC_STRING("Fy1l8l1l83Hy00000");
    string_constant_24 = 
	    STATIC_STRING("1r8q1o83NSy1m83Ry83-+y83Iy83Ly1m8u1p8w9k3ky3ky13Jy1q83-1y2l83*Ny83Ty2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l83*Uy83Ty1l83-iy1l83-j");
    string_constant_25 = 
    ...
    string_constant_29 = 
	    STATIC_STRING("1p83Jy1m3Ty3Sy1m3Ty3Vy1m3Xy3Vy1m3Xy3Sy1p83Jy1mvx1mv3Gy1m3Fy3Gy1m3Fyx1p83Jy1mxz1mx3Ey1m3Dy3Ey1m3Dyz1q83NTy08o83Fy1m8p83-qy83Hy1q8");
    string_constant_30 = 
	    STATIC_STRING("3NVy835ry8o83Fy1m8p83-qy83Hy1q83NUy08o83Fy1m8p83-qy83Hy1p83Sby083Fy8l83Hy");
    ...
    string_constant_32 = STATIC_STRING("1q83B-y8s83-Ksy09k9l");
    clear_optimized_constants();
    ...
    string_constant_33 = 
	    STATIC_STRING("43Dy8m83iey1q83iey83B-y837Vy832ky8n8k1l83B-y0000001l1m8x83B-yk3Cyk0k0");
    ...
    string_constant_34 = STATIC_STRING("1q83iey8s83-Xgy09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qread_ping_stream,STATIC_FUNCTION(read_ping_stream,
	    NIL,FALSE,2,2));
    Qg2_mqtt_log_topic_data = STATIC_SYMBOL("G2-MQTT-LOG-TOPIC-DATA",
	    AB_package);
    gensymed_symbol = Nil;
    mutate_global_property(Qg2_mqtt_log_topic_data,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    SET_SYMBOL_FUNCTION(Qg2_mqtt_log_topic_data,
	    STATIC_FUNCTION(g2_mqtt_log_topic_data,NIL,FALSE,2,2));
    Qg2_mqtt_log_packet_data = STATIC_SYMBOL("G2-MQTT-LOG-PACKET-DATA",
	    AB_package);
    gensymed_symbol = Nil;
    mutate_global_property(Qg2_mqtt_log_packet_data,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    SET_SYMBOL_FUNCTION(Qg2_mqtt_log_packet_data,
	    STATIC_FUNCTION(g2_mqtt_log_packet_data,NIL,FALSE,2,2));
}
