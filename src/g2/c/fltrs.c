    ...
    Object list_1;
{
    ...
    return reclaim_gensym_tree_1(list_1);
}
    ...
    Object car_1, cdr_1;
{
    ...
    return gensym_cons_1(car_1,cdr_1);
}
    ...
    Object thing;
{
    ...
    if (CONSP(thing))
	return copy_tree_using_gensym_conses_1(thing);
    else
...
Object Table_menu_choices = UNBOUND;

Object Global_keyboard_command_choices = UNBOUND;

Object Main_menu_choices = UNBOUND;

Object Workspace_menu_choices = UNBOUND;
...
Object make_declaration_clause_for_item_configuration varargs_1(int, n)
{
	...
	temp = Qitem;
    return gensym_list_4(Qdeclaration,gensym_cons_1(temp,Nil),property_1,
	    value ? T : Nil);
}
    ...
    Object keysym;
{
    ...
    PUSH_SPECIAL(Write_symbols_parsably_qm,write_symbols_parsably_qm,5);
...
Object Non_menu_choices = UNBOUND;
    ...
    Object key_code;
{
	...
	PUSH_SPECIAL(Write_symbols_parsably_qm,write_symbols_parsably_qm,5);
	  ...
	  PUSH_SPECIAL(Write_strings_parsably_qm,write_strings_parsably_qm,0);
...
static Object Qkb_restrictions;    /* kb-restrictions */

static Object Qkb_configuration;   /* kb-configuration */
    ...
    Object kb_configuration;
{
    ...
    x_note_fn_call(181,48);
    PUSH_SPECIAL(Kb_configuration,kb_configuration,0);
...
Object ensure_user_interface_section(item)
    Object item;
{
    Object temp, clause, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object object_configuration_new_value;

    x_note_fn_call(181,65);
    temp = assq_function(Quser_interface,get_lookup_slot_value(item,
	    Qobject_configuration));
    if (temp)
	return VALUES_1(temp);
    else {
	clause = gensym_cons_1(Quser_interface,Nil);
	gensym_push_modify_macro_arg = clause;
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = get_lookup_slot_value(item,Qobject_configuration);
	object_configuration_new_value = gensym_cons_1(car_1,cdr_1);
	if (Noting_changes_to_kb_p)
    ...
    Object item;
{
    ...
    x_note_fn_call(181,66);
    temp = assq_function(Qproprietary,get_lookup_slot_value(item,
	    Qobject_configuration));
    if (temp)
	return VALUES_1(temp);
    else {
	clause = gensym_cons_1(Qproprietary,Nil);
	gensym_push_modify_macro_arg = clause;
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = get_lookup_slot_value(item,Qobject_configuration);
	object_configuration_new_value = gensym_cons_1(car_1,cdr_1);
    ...
    Object item, when_or_unless, mode;
{
	...
	if (temp)
	    ...
	    clause = gensym_list_2(when_or_unless,gensym_cons_1(mode,Nil));
	    gensym_push_modify_macro_arg = clause;
	    car_1 = gensym_push_modify_macro_arg;
    ...
    Object item, when_or_unless, mode, pattern;
{
    ...
    Object ab_loop_list__2, star_qm, temp_1, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, temp_2, user_mode_section;
    char temp;

    x_note_fn_call(181,68);
    if (EQ(mode,Qproprietary)) {
	...
	if (temp_1)
	    ...
	    clause = copy_list_using_gensym_conses_1(pattern);
	    gensym_push_modify_macro_arg = clause;
	    car_1 = gensym_push_modify_macro_arg;
    ...
    Object item, mode, clause;
{
	...
	if (memq_function(FIRST(major_clause),list_constant_4)) {
	  ...
	  end_2:;
	    if (temp) {
		temp_1 = delete_gensym_element_1(clause,CDDR(mode_clause));
		M_CDDR(mode_clause) = temp_1;
		if ( !TRUEP(CDDR(mode_clause))) {
		    temp_1 = delete_gensym_element_1(mode_clause,
			    CDR(major_clause));
		    M_CDR(major_clause) = temp_1;
		    reclaim_gensym_tree_1(mode_clause);
		    if ( !TRUEP(CDR(major_clause))) {
			temp_2 = major_clause;
			temp_1 = delete_gensym_element_1(temp_2,
    ...
    Object top_as_evaluation_value;
{
	...
	if (EQ(rectangle,Qstar)) {
	    fourth_new_value = gensym_list_4(left,right,bottom,top);
    ...
    Object user_mode_as_evaluation_value;
{
	...
	temp_4 = gensym_cons_1(value_5,Qtruth_value);
    ...
    Object user_mode_as_evaluation_value;
{
	...
	reclaim_gensym_tree_1(clause_qm);
    }
    new_value = get_lookup_slot_value(item,Qobject_configuration);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(item,Qobject_configuration);
    ...
    Object dy_as_evaluation_value;
{
    ...
    Object temp, old_value, new_value, clause, grid, fourth_new_value;

    x_note_fn_call(181,74);
    item = IDENTITY(item_as_evaluation_value);
    when_or_unless = when_or_unless_as_evaluation_value;
    user_mode = user_mode_as_evaluation_value;
	...
	grid = FOURTH(clause);
	if (EQ(grid,Qstar)) {
	    fourth_new_value = gensym_cons_1(dx,dy);
	    M_FOURTH(clause) = fourth_new_value;
	}
	else if (CONSP(grid)) {
	    M_CAR(grid) = dx;
    ...
    Object user_mode_as_evaluation_value;
{
	...
	temp_2 = gensym_cons_1(value_3,Qtruth_value);
    ...
    Object block, new_configuration, initializing_qm;
{
    ...
    Object slot_description, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object cdr_new_value, stack_of_slot_value_changes, gensymed_symbol_2;
    Object gensymed_symbol_3, frame_and_slot_or_atom, ab_loop_list_;
    Object ab_loop_it_, gensym_pop_store, cons_1, next_cons;
    SI_Long svref_new_value;
    char temp_1;
    Declare_special(1);

    x_note_fn_call(181,77);
	...
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(block,
	...
	cdr_new_value = Stack_of_slot_value_changes;
    ...
    Object definition, new_configuration, initializing_qm;
{
	...
	if ( !TRUEP(gensymed_symbol))
	    gensymed_symbol = replenish_gensym_cons_pool();
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(definition,
		    slot_description),gensym_cons_1(Nil,Nil));
	else {
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
	...
	PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	  ...
	  if (temp_1);
	    ...
	    next_loop:
	      ...
	      ab_loop_it_ = temp_1 ? (EQ(definition,
		      M_CAR(frame_and_slot_or_atom)) ? T : Nil) : Nil;
	      if (ab_loop_it_) {
		  temp_1 = TRUEP(ab_loop_it_);
		  goto end_1;
    ...
    Object type_of_configuration, block, old_configuration, new_configuration;
{
    ...
    Object deferred_list_cons_qm, gensym_cons, cdr_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index;
	...
	if (EQ(type_of_configuration,Qitem_configuration) && EQ(block,
	    ...
	    gensymed_symbol = Nil;
	    PUSH_SPECIAL(Compiled_items_deferred_for_analysis,compiled_items_deferred_for_analysis,
		    2);
	      PUSH_SPECIAL(Defer_consistency_analysis_qm,defer_consistency_analysis_qm,
		      1);
		scope_conses = Scope_conses;
		ab_loopvar_ = Nil;
		ab_loopvar__1 = Nil;
		...
		if (Compiled_items_deferred_for_analysis) {
		  ...
		  end_loop_4:
		    ...
		    cdr_new_value = Available_gensym_conses;
		    M_CDR(deferred_list_cons_qm) = cdr_new_value;
    ...
    Object workspace, frame_style, initializing_qm;
{
    ...
    Object new_cons, gensymed_symbol, gensymed_symbol_1, cdr_new_value;
    Object stack_of_slot_value_changes, gensymed_symbol_2, gensymed_symbol_3;
    Object frame_and_slot_or_atom, ab_loop_list_, ab_loop_it_, temp_1;
    Object gensym_pop_store, cons_1, next_cons;
    SI_Long svref_new_value;
    char temp;
    Declare_special(1);

    x_note_fn_call(181,84);
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(workspace,
		slot_description),gensym_cons_1(Nil,Nil));
    else {
	new_cons = Available_gensym_conses;
	if (new_cons) {
    ...
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    stack_of_slot_value_changes = gensymed_symbol;
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  gensymed_symbol_2,gensymed_symbol_3);
	  svref_new_value = IFIX(ISVREF(workspace,(SI_Long)5L)) | 
		  (SI_Long)16777216L;
	...
	end_1:;
	  ...
	  temp = TRUEP(Nil);
      if (temp ?  !TRUEP(Suppress_use_of_stack_of_slot_value_changes_p) : 
	      TRUEP(Nil))
	  do_deferred_updates_to_representations_in_tables();
    POP_SPECIAL();
    ...
    Object object_configuration, user_restrictions;
{
  ...
  end_1:;
	...
	proprietary_clauses = nconc2(proprietary_clauses,
		copy_tree_using_gensym_conses_1(body));
    if (new_modes) {
	temp = user_interface_clauses;
	user_interface_clauses = nconc2(temp,
		gensym_cons_1(nconc2(gensym_list_2(when_or_unless,
		new_modes),copy_tree_using_gensym_conses_1(body)),Nil));
    }
    goto next_loop;
  end_loop:;
    ui = user_interface_clauses ? gensym_cons_1(Quser_interface,
	    user_interface_clauses) : Qnil;
    prop = proprietary_clauses ? gensym_cons_1(Qproprietary,
  ...
  next_loop_2:
    ...
    if (memq_function(FIRST(clause),list_constant_4)) {
	if (ui) {
	    new_object_configuration = gensym_cons_1(ui,
	...
	if (prop) {
	    new_object_configuration = gensym_cons_1(prop,
		    new_object_configuration);
	    prop = Nil;
	}
    }
	...
	new_object_configuration = 
		gensym_cons_1(copy_tree_using_gensym_conses_1(clause),
		new_object_configuration);
    goto next_loop_2;
  end_loop_2:;
	...
	new_object_configuration = nconc2(new_object_configuration,
		gensym_cons_1(ui,Nil));
    if (prop)
	new_object_configuration = nconc2(new_object_configuration,
		gensym_cons_1(prop,Nil));
    ...
    Object block, user_restrictions;
{
    ...
    if ( !EQ(old_object_configuration,get_slot_init_form(2,
	    ...
	    Qobject_configuration)))
	reclaim_gensym_list_1(old_object_configuration);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(block,Qobject_configuration);
...
Object Superior_frame_for_restrictions_frame_qm = UNBOUND;

Object Superior_frame_for_restrictions_superior_qm = UNBOUND;
...
Object G2_identification_for_write_locks = UNBOUND;
...
static Object Qsaving_parameters;  /* saving-parameters */
...
Object reason_permanent_items_module_is_not_editable varargs_1(int, n)
{
    ...
    Object reason_module_is_not_editable, old_structure_being_reclaimed;
    Object temp_1, def_structure_schedule_task_variable, new_task, temp_2;
    Object def_structure_queue_element_variable, gensymed_symbol_1;
    char temp;
    Declare_varargs_nonrelocating;

    x_note_fn_call(181,99);
    INIT_ARGS_nonrelocating();
    item = REQUIRED_ARG_nonrelocating();
	...
	if (module_qm) {
		...
		if (reason_module_is_not_editable && allow_warning_p && 
			...
			if (Nil) {
			    ...
			    Chain_of_available_schedule_tasks = Nil;
			}
			...
			ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)3L);
			SVREF(new_task,FIX((SI_Long)11L)) = item;
			temp_1 = copy_frame_serial_number(ISVREF(item,
				(SI_Long)3L));
			SVREF(new_task,FIX((SI_Long)12L)) = temp_1;
			temp_2 = current_workstation_if_usable_for_dialog(Nil);
			if (temp_2);
			else
			    temp_2 = get_current_ui_client_interface();
			temp_1 = gensym_list_3(module_qm,
				reason_module_is_not_editable,temp_2);
			SVREF(new_task,FIX((SI_Long)13L)) = temp_1;
			gensymed_symbol = ISVREF(Immediate_task_queue,
				(SI_Long)1L);
			...
			inline_note_allocate_cons(def_structure_queue_element_variable,
				Nil);
			temp_1 = Immediate_task_queue;
			SVREF(def_structure_queue_element_variable,
				FIX((SI_Long)0L)) = temp_1;
			SVREF(def_structure_queue_element_variable,
				FIX((SI_Long)1L)) = gensymed_symbol;
			SVREF(def_structure_queue_element_variable,
				FIX((SI_Long)2L)) = new_task;
			gensymed_symbol_1 = 
				def_structure_queue_element_variable;
			SVREF(gensymed_symbol,FIX((SI_Long)0L)) = 
				gensymed_symbol_1;
			temp_1 = Immediate_task_queue;
			SVREF(temp_1,FIX((SI_Long)1L)) = gensymed_symbol_1;
			SVREF(new_task,FIX((SI_Long)6L)) = gensymed_symbol_1;
...
Object See_also_for_warn_about_editing_item = UNBOUND;
    ...
    Object item, frame_serial_number, arg_list;
{
	...
	if (temp_1) {
		...
		gensymed_symbol_1 = gensymed_symbol;
		car_new_value = gensym_list_3(Qtext,tformat_text_string(4,
			string_constant_105,item,reason,
			See_also_for_warn_about_editing_item),
			Qedit_item_warning);
		M_CAR(gensymed_symbol_1) = car_new_value;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		car_new_value = gensym_list_3(Qitem,item,Quneditable_item);
		M_CAR(gensymed_symbol_1) = car_new_value;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		car_new_value = gensym_list_3(Qbutton,
			copy_text_string(array_constant_3),Qok);
		M_CAR(gensymed_symbol_1) = car_new_value;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		car_new_value = gensym_list_3(Qtext,
			copy_text_string(array_constant_4),Qallow_edits_to);
		M_CAR(gensymed_symbol_1) = car_new_value;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		car_new_value = gensym_list_4(Qcheck_box,
		...
		M_CAR(gensymed_symbol_1) = car_new_value;
		temp = 
			gensym_list_3(Qt2_continuation_for_warn_about_editing_item,
		...
		PUSH_SPECIAL(Type_of_current_workstation_context,type_of_current_workstation_context,
		  ...
		  PUSH_SPECIAL(Specific_structure_for_current_workstation_context,specific_structure_for_current_workstation_context,
		    ...
		    PUSH_SPECIAL(Current_workstation_detail_pane,current_workstation_detail_pane,
			    3);
		      current_g2_user_mode_qm = ISVREF(Current_workstation,
			      (SI_Long)19L);
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				  0);
			    result = warn_about_editing_item_for_workstation_1(item,
				    module_qm,reason);
			  POP_SPECIAL();
			POP_SPECIAL();
		      POP_SPECIAL();
...
Object Currently_active_event_handlers_via_object_configuration = UNBOUND;
    ...
    Object clause, arg_1, arg_2;
{
	...
	temp = gensym_cons_1(key_code,gensym_cons_1(gensym_cons_1(temp,
		gensym_cons_1(filter_copy(action_qm),Nil)),Nil));
    ...
    Object frame_qm;
{
    ...
    x_note_fn_call(181,122);
    currently_active_event_handlers_via_object_configuration = Nil;
    PUSH_SPECIAL(Currently_active_event_handlers_via_object_configuration,currently_active_event_handlers_via_object_configuration,
	    0);
    ...
    Object clause, alist, arg2;
{
	...
	if ( !TRUEP(interpretation_plus_state)) {
	    interpretation_plus_state = gensym_cons_1(Nil,Nil);
	    a = gensym_cons_1(key_code_qm,interpretation_plus_state);
	    alist = gensym_cons_1(a,alist);
	}
...
{
    x_note_fn_call(181,125);
    return VALUES_1(Nil);
}

static Object Qcurrent_g2_user_mode_qm;  /* current-g2-user-mode? */
    ...
    Object keymap, frame_qm;
{
    ...
    reclaim_gensym_tree_1(key_bindings);
    return VALUES_1(temp);
}
...
Object compute_snap_grid_for_block varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Superior_frame_for_restrictions_superior_qm,superior_frame_for_restrictions_superior_qm,
		1);
	  PUSH_SPECIAL(Superior_frame_for_restrictions_frame_qm,superior_frame_for_restrictions_frame_qm,
		  0);
    ...
    Object old_set, additions, complement_set_1, complement_set_2;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = gensym_cons_1(element,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
    ...
    Object set_1, removals;
{
  ...
  next_loop:
    ...
    element = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    set_1 = delete_gensym_element_1(element,set_1);
    goto next_loop;
  end_loop:
    temp = set_1;
    goto end_1;
...
Object Permitted_restriction_set = UNBOUND;

Object Prohibited_restriction_set = UNBOUND;

Object Absolutely_prohibited_restriction_set = UNBOUND;

Object Absolutely_selected_choice_qm = UNBOUND;

Object Conditional_selected_choice_qm = UNBOUND;

Object Conditional_termination_state_qm = UNBOUND;

/* RECLAIM-PERMITTED-RESTRICTION-SET */
Object reclaim_permitted_restriction_set()
{
    x_note_fn_call(181,148);
    reclaim_gensym_list_1(Permitted_restriction_set);
...
{
    x_note_fn_call(181,149);
    reclaim_gensym_list_1(Prohibited_restriction_set);
...
{
    x_note_fn_call(181,150);
    reclaim_gensym_list_1(Absolutely_prohibited_restriction_set);
...
Object Choice_conflict = UNBOUND;
    ...
    Object item;
{
    ...
    x_note_fn_call(181,157);
    permitted_restriction_set = Nil;
    PUSH_SPECIAL(Permitted_restriction_set,permitted_restriction_set,5);
      prohibited_restriction_set = Nil;
      PUSH_SPECIAL(Prohibited_restriction_set,prohibited_restriction_set,4);
	absolutely_prohibited_restriction_set = Nil;
	PUSH_SPECIAL(Absolutely_prohibited_restriction_set,absolutely_prohibited_restriction_set,
		3);
	  absolutely_selected_choice_qm = Nil;
	  PUSH_SPECIAL(Absolutely_selected_choice_qm,absolutely_selected_choice_qm,
		  2);
	    conditional_selected_choice_qm = Nil;
	    PUSH_SPECIAL(Conditional_selected_choice_qm,conditional_selected_choice_qm,
		    1);
	      conditional_termination_state_qm = Nil;
	      PUSH_SPECIAL(Conditional_termination_state_qm,conditional_termination_state_qm,
		      0);
...
Object Exact_class_names_for_menu_restrictions = UNBOUND;
...
Object compute_restrictions_of_type varargs_1(int, n)
{
	...
	if (frame_qm)
	    ...
	    PUSH_SPECIAL(Exact_class_names_for_menu_restrictions,exact_class_names_for_menu_restrictions,
		    6);
	      permitted_restriction_set = Nil;
	      PUSH_SPECIAL(Permitted_restriction_set,permitted_restriction_set,
		      5);
		prohibited_restriction_set = Nil;
		PUSH_SPECIAL(Prohibited_restriction_set,prohibited_restriction_set,
			4);
		  absolutely_prohibited_restriction_set = Nil;
		  PUSH_SPECIAL(Absolutely_prohibited_restriction_set,absolutely_prohibited_restriction_set,
			  3);
...
Object compute_all_restrictions varargs_1(int, n)
{
    ...
    result_1 = Nil;
    PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,0);
      type = Nil;
    ...
    next_loop:
	  ...
	  result_1 = gensym_cons_1(gensym_cons_1(type,
		  gensym_cons_1(permitted_qm,restrictions)),result_1);
      goto next_loop;
    end_loop:;
...
Object Slot_description_for_restrictions = UNBOUND;

Object Slot_alias_for_restrictions = UNBOUND;
    ...
    Object user_mode;
{
    ...
    x_note_fn_call(181,165);
    current_g2_user_mode_qm = user_mode;
    PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,8);
	  ...
	  if (temp)
		  ...
		  if (temp) {
		      ...
		      PUSH_SPECIAL(Slot_description_for_restrictions,slot_description_for_restrictions,
			      7);
			PUSH_SPECIAL(Slot_alias_for_restrictions,slot_alias_for_restrictions,
				6);
    ...
    Object item, slot_name_or_alias_qm, defining_class;
{
    ...
    x_note_fn_call(181,170);
    permitted_restriction_set = Nil;
    PUSH_SPECIAL(Permitted_restriction_set,permitted_restriction_set,7);
      prohibited_restriction_set = Nil;
      PUSH_SPECIAL(Prohibited_restriction_set,prohibited_restriction_set,6);
	absolutely_prohibited_restriction_set = Nil;
	PUSH_SPECIAL(Absolutely_prohibited_restriction_set,absolutely_prohibited_restriction_set,
		5);
	  absolutely_selected_choice_qm = Nil;
...
{
    Object restrictions, permitted_qm, temp, last_1, next_qm, cdr_new_value;
    Object result;

    x_note_fn_call(181,173);
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = restrictions;
    }
    return VALUES_1(temp);
}
    ...
    Object item;
{
    ...
    PUSH_SPECIAL(Write_symbols_in_lower_case_qm,write_symbols_in_lower_case_qm,
      ...
      header = gensym_cons_1(tformat_text_string(2,string_constant_111,
	      item),Nil);
	  ...
	  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	    ...
	    POP_SPECIAL();
	  POP_SPECIAL();
	  temp_1 = gensym_cons_1(temp_1,Nil);
	  if (choice_restrictions)
	      reclaim_gensym_list_1(choice_restrictions);
      ...
      PUSH_SPECIAL(Non_menu_choices,non_menu_choices,6);
	...
	if (choice_restrictions) {
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    table_menu_choices = gensym_cons_1(temp_1,Nil);
	}
	else
	    table_menu_choices = Nil;
	PUSH_SPECIAL(Table_menu_choices,table_menu_choices,5);
	  text_strings = Nil;
	  class_1 = ISVREF(ISVREF(item,(SI_Long)1L),(SI_Long)1L);
	  class_description = ISVREF(item,(SI_Long)1L);
	  ...
	  if (type_of_slot &&  
		  ...
		  if (include_slot_in_attribute_table_p(item,
			  ...
			  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
			    ...
			    current_wide_string = wide_string_bv16;
			    PUSH_SPECIAL(Current_wide_string,current_wide_string,
				    3);
			      fill_pointer_for_current_wide_string = 
				      FIX((SI_Long)0L);
			      PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		      ...
		      text_string_qm = class_qualifier_qm ? 
			      ...
			      aliased_slot_name);
		  if (text_string_qm)
		      text_strings = gensym_cons_1(text_string_qm,
			      text_strings);
	      }
	  }
	  goto next_loop;
	...
	next_loop_1:
	  ...
	  if (class_is_visible_to_user_p(traversing_class_hierarchy_qm ? 
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	      list_1 = gensym_cons_1(temp_1,list_1);
	  }
	  if (traversing_class_hierarchy_qm) {
	...
	next_loop_2:
	  ...
	  if (text_string_p(CAR(l))) {
	      temp_2 = gensym_cons_1(make_text_cell(2,gensym_cons_1(CAR(l),
		      Nil),format_1),Nil);
	      M_CAR(l) = temp_2;
	  }
	  ab_loop_iter_flag_ = Nil;
...
Object Current_filters_search_result = UNBOUND;

Object Contains_proprietary_p_1 = UNBOUND;
    ...
    Object block;
{
    ...
    x_note_fn_call(181,177);
    current_filters_search_result = Nil;
    PUSH_SPECIAL(Current_filters_search_result,current_filters_search_result,
	    0);
...
Object Contains_either_really_transient_or_proprietary_p_1 = UNBOUND;
    ...
    Object user_restrictions_in_slot_of_kb_restrictions;
{
	...
	if (EQ(termination_state_qm,Qinclude)) {
	    reclaim_gensym_list_1(prohibited_set);
	    reclaim_gensym_list_1(absolutely_prohibited_set);
	    return VALUES_2(permitted_set,T);
	}
	else {
	    reclaim_gensym_list_1(permitted_set);
	    reclaim_gensym_list_1(absolutely_prohibited_set);
...
Object setup_current_simulated_product_authorization()
{
    ...
    return reclaim_gensym_list_1(atomic_products_authorized_1);
}
    ...
    Object visible_products_authorized;
{
  ...
  next_loop:
    ...
    atomic_product_p = CAR(temp);
    if (atomic_product_p) {
	gensym_modify_macro_using_test_arg_1 = visible_product;
	...
	temp_1 = TRUEP(Qnil);
      end_1:;
	result_1 = temp_1 ? cdr_1 : gensym_cons_1(car_1,cdr_1);
    }
    else {
	known_product = Nil;
	...
	if (known_atomic_product_p) {
		...
		gensym_modify_macro_using_test_arg_1 = known_product;
		car_1 = gensym_modify_macro_using_test_arg_1;
		cdr_1 = result_1;
		key_result = car_1;
		x_element = Nil;
  ...
  end_loop:
	...
	if ( !TRUEP(memq_function(disabled_product,
	    ...
	    result_1 = delete_gensym_element_1(disabled_product,result_1);
	goto next_loop_4;
      end_loop_4:;
    }
    return VALUES_1(result_1);
	  ...
	  if (offline_is_forced_qm || offline_is_simulated_qm) {
	    ...
	    next_loop:
	      ...
	      if (offline_is_forced_qm &&  !TRUEP(memq_function(p,
		      ...
		      simulated_optional_modules)))
		  result_1 = gensym_cons_1(p,result_1);
	      goto next_loop;
	    end_loop:
	...
	end_loop_1:;
	  ...
	  if (visible_atomic_products_not_being_simulated)
	      tformat(2,string_constant_139,
		      visible_atomic_products_not_being_simulated);
	  reclaim_gensym_list_1(visible_atomic_products_forced_to_not_simulate);
	  reclaim_gensym_list_1(visible_atomic_products_suppressed_by_offline);
	  reclaim_gensym_list_1(visible_atomic_products_not_being_simulated);
	  reclaim_gensym_list_1(visible_atomic_products_being_simulated);
	  temp = 
		  reclaim_gensym_list_1(visible_non_atomic_products_being_simulated);
	POP_SPECIAL();
    }
    else
	temp = Nil;
...
Object set_inherit_stdio_handles(new_value)
    Object new_value;
{
    x_note_fn_call(181,199);
    return VALUES_1(FIX(g2ext_set_inherit_stdio_handles(IFIX(new_value))));
}

Object Foremost_attribute_for_multiplexed_chaining_qm = UNBOUND;
    ...
    Object internal_menu_choices, frame, slot_description;
{
  ...
  next_loop:
	...
	temp = Nil;
    ab_loopvar__1 = gensym_cons_1(temp,Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	gensymed_symbol = ab_loopvar__1;
    ...
    Object internal_menu_choices, frame, slot_description;
{
  ...
  next_loop:
    ...
    source_menu_choice_element = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(source_menu_choice_element,Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	gensymed_symbol = ab_loopvar__1;
...
static Object Qtable_menu_choices;  /* table-menu-choices */
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(source_attribute_element,Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
    ...
    Object configure_user_interface_info, frame, slot_description;
{
    ...
    set_evaluation_structure_slot(gensymed_symbol,Qmodes,
	    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(SECOND(configure_user_interface_info))));
    GENSYM_RETURN_ONE(gensymed_symbol);
    return VALUES_1(Nil);
}
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = gensym_cons_1(gensymed_symbol_1,Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	gensymed_symbol = ab_loopvar__1;
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop_1:
    ...
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    ab_loopvar__2 = gensym_cons_1(source_access_type_element,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(feature_name,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ab_loopvar__1 = ab_loopvar__2;
    ab_loopvar__2 = gensym_cons_1(feature_value ? Evaluation_true_value : 
    ...
    Object global_keyboard_command_restriction_info, frame, slot_description;
{
  ...
  next_loop_1:
    ...
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    ab_loopvar__2 = gensym_cons_1(command_choice_element,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	gensymed_symbol_2 = ab_loopvar__2;
    ...
    Object g2_login;
{
    ...
    Object new_float, temp_1, scope_conses, ab_loopvar_, ab_loopvar__1, item;
    Object sub_class_bit_vector;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp_2;
    ...
    temp_1 = Kb_configuration;
    set_lookup_slot_value_1(temp_1,Quser_mode_aliases,gensym_cons_1(alias,
...
void filters_INIT()
{
    ...
    Object AB_package, Qsimulated_products_qm, Qnamed, list_constant_173;
    Object list_constant_308, Qtype_specification_simple_expansion;
    Object list_constant_307, Qpsueudo_authorized_optional_modules;
    Object list_constant_148, Qglobal_keyboard_command_restrictions;
    Object list_constant_306, list_constant_231, list_constant_305;
    Object list_constant_294, list_constant_304, Qab_structure;
    Object list_constant_303, list_constant_239, list_constant_282;
    Object list_constant_302, list_constant_301, list_constant_300;
    Object list_constant_299, list_constant_150, list_constant_298;
    Object list_constant_297, list_constant_100, Qmain_menu_restrictions;
    Object list_constant_296, list_constant_295, list_constant_293;
    Object list_constant_242, list_constant_292, list_constant_291;
    Object list_constant_290, list_constant_289, list_constant_288;
    Object list_constant_287, list_constant_286, list_constant_285;
    Object list_constant_169, list_constant_284, list_constant_102;
    Object list_constant_283, list_constant_281, list_constant_280;
    Object list_constant_279, list_constant_278, list_constant_277;
    Object list_constant_276, list_constant_275, list_constant_146;
    Object list_constant_274, list_constant_273, list_constant_272;
    Object list_constant_271, list_constant_270, list_constant_269;
    Object list_constant_268, list_constant_159, list_constant_267;
    Object list_constant_266, list_constant_265, list_constant_264;
    Object list_constant_254, list_constant_263, list_constant_262;
    Object list_constant_261, list_constant_260, list_constant_259;
    Object list_constant_258, list_constant_257, list_constant_256;
    Object list_constant_255, list_constant_232, Qexternal_simulation;
    ...
    Object list_constant_250, list_constant_249, list_constant_248;
    Object list_constant_247, Qtelewindows_and_gsi;
    Object Qg2_and_telewindows_and_gsi, list_constant_246, list_constant_245;
    Object list_constant_244, list_constant_243, list_constant_241;
    Object list_constant_240, list_constant_238, list_constant_237;
    Object list_constant_236, list_constant_235, list_constant_234;
    Object list_constant_233, Qunreserved_symbol, list_constant_230;
    ...
    Object list_constant_217, list_constant_210, list_constant_216;
    Object list_constant_215, list_constant_214, list_constant_213;
    Object list_constant_212, list_constant_211, list_constant_209;
    Object list_constant_208, list_constant_207, list_constant_201;
    Object list_constant_206, list_constant_205, list_constant_204;
    Object list_constant_203, list_constant_202, list_constant_191;
    Object list_constant_200, list_constant_199, list_constant_189;
    Object list_constant_198, list_constant_197, list_constant_196;
    Object list_constant_195, list_constant_194, list_constant_181;
    ...
    Object list_constant_182, list_constant_110, Qmodifier_key;
    Object list_constant_180, list_constant_179, list_constant_178;
    Object list_constant_177, list_constant_176, list_constant_175;
    Object list_constant_174, list_constant_172, list_constant_97;
    Object list_constant_171, list_constant_170, list_constant_168;
    Object list_constant_167, list_constant_166, list_constant_165;
    Object list_constant_164, list_constant_163, list_constant_162;
    Object list_constant_161, list_constant_160, list_constant_155;
    Object list_constant_158, list_constant_157, list_constant_153;
    Object list_constant_156, list_constant_106, list_constant_154;
    Object list_constant_152, list_constant_151, list_constant_149;
    Object list_constant_147, list_constant_145, list_constant_99;
    Object Qmenu_and_attribute_visibility_configurations_restriction_type;
    Object list_constant_105, Qmarshall_exceptional_float_arguments;
    Object list_constant_94, Qfunction_keeps_procedure_environment_valid_qm;
    Object Qset_inherit_stdio_handles, Qg2_describe_g2_license, Qlicense_level;
    Object Qframe_note_writer_1, string_constant_263, string_constant_262;
    Object string_constant_261, string_constant_260, Qgfi, Qicp, Qslot_putter;
    Object Qput_simulated_optional_modules, string_constant_259;
    ...
    Object Qblock_visible_to_inspect, list_constant_141, list_constant_140;
    Object Qmake_permanent, list_constant_139, list_constant_136;
    Object Qmake_transient, list_constant_138, Qchange_set_of_inferiors;
    Object list_constant_137, Qclone_block, Qchange_superior;
    Object list_constant_135, list_constant_134, list_constant_133;
    Object list_constant_132, list_constant_131, Qedit;
    Object Qcontains_either_really_transient_or_proprietary_p_1;
    Object Qcontains_proprietary_p_1, list_constant_130, Qchoice_conflict;
    Object list_constant_129, list_constant_128;
    Object Qg2_set_all_items_in_module_explicitly_editable;
    Object Qg2_set_item_and_all_its_subblocks_explicitly_editable;
    Object Qg2_set_item_explicitly_editable, list_constant_127;
    Object list_constant_126, list_constant_125, string_constant_258;
    Object string_constant_257, string_constant_256, Qg2_item_is_editable;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qmodule_is_explictly_editable_p;
    Object Qdo_not_carry_global_property_value_into_kbs_qm, list_constant_124;
    Object list_constant_123, list_constant_122, list_constant_121;
    Object list_constant_120, list_constant_119, list_constant_118;
    Object list_constant_117, Qattribute_initializations, Qdefault_settings;
    Object Qclass_specific_attributes, Qattributes_specific_to_class;
    Object Qdirect_superior_classes, Qsuperior_class, list_constant_116;
    ...
    Object Qg2_set_movement_grid, list_constant_115, Qg2_clear_movement_limits;
    ...
    Object Qsubstitute_class_and_kb_flags, list_constant_114, Qfilters;
    Object Kfuncall, Ksystem_frame, string_constant_255, list_constant_113;
    Object string_constant_254, string_constant_244, string_constant_253;
    Object string_constant_252, string_constant_251, list_constant_112;
    ...
    Object Qnon_menu_choice, Qnon_menu_choices, Qitem_menu_choice;
    Object Qitem_menu_choices, Qworkspace_menu_choice, Qworkspace_menu_choices;
    Object string_constant_243, Qsystem_or_user_defined_attribute_name;
    Object Qattribute_names_or, string_constant_242;
    Object Qconvert_class_qualified_list_to_keyword_symbol;
    Object Quser_attribute_name, Quser_attribute_names, string_constant_241;
    Object string_constant_240, Qattribute_names, Qrestrictable_class;
    Object Qrestrictable_classes, Qprohibit_nothing, string_constant_239;
    Object string_constant_238, string_constant_237, Qselect_area;
    Object list_constant_111, Qselect_object, Qallow_selection_of_text;
    ...
    Object string_constant_221, Quser_restriction_clause;
    Object Quser_restriction_clause_list, string_constant_220;
    Object Quser_mode_restriction, string_constant_219, Qcomment_option;
    Object Qcomment_options, string_constant_218;
    Object Qproprietary_restriction_clause;
    Object Qproprietary_restriction_clause_list, string_constant_217;
    Object Qfix_object_configuration_clause, string_constant_216;
    Object string_constant_215, Qremove_separator_symbol_from_phrase;
    Object string_constant_214, Qmodifier_key_list, string_constant_213;
    Object string_constant_212, Qparse_user_interface_key_chord;
    ...
    Object Qparse_user_interface_gesture, string_constant_205;
    Object Qgrid_spec_must_be_positive, string_constant_204;
    Object Qfix_item_filter_phrase, string_constant_203, string_constant_202;
    Object string_constant_201, Quser_restrictable_class;
    Object Quser_restrictable_classes, string_constant_200;
    ...
    Object string_constant_187, Qstring_to_insert_for_keyboard_symbol;
    Object Qstring_to_display_for_keyboard_symbol, list_constant_109, Qcol, Q9;
    Object Q8, Q7, Q6, Q5, Q4, Q3, Q2, Q1, Q0, Qescape, Qlinefeed, Qtab;
    Object Qbackspace, Qf12, Qf11, Qf10, Qf9, Qf8, Qf7, Qf6, Qf5, Qf4, Qf3;
    Object Qf2, Qf1, list_constant_108, Qct, Qcbt, Qobt, Qz, Qy, Qx, Qw, Qv;
    Object Qu, Qs, Qr, Qq, Qp, Qo, Qn, Qm, Ql, Qk, Qj, Qi, Qh, Qg, Qf, Qe, Qd;
    Object Qc, Qb, Qa, Qqm, list_constant_107, Qredo, Qinsert, Qhelp, Qenter;
    ...
    Object Quser_annotation_clause_list, string_constant_186;
    Object Quser_mode_annotation, Quser_mode_annotations, string_constant_185;
    ...
    Object string_constant_175, Qnetwork_accessing_product;
    ...
    Object Qcommon_network_access_type_list, string_constant_174;
    ...
    Object string_constant_167, string_constant_166, Qnetwork_access_option;
    Object Qnetwork_access_options, string_constant_165, string_constant_164;
    Object string_constant_163, Quser_declaration_element, Quser_declarations;
    Object Qmassage_user_declaration_clause, string_constant_162;
    Object string_constant_161, string_constant_160, string_constant_159;
    Object Qfix_network_configuration_clause, string_constant_158;
    Object string_constant_157, Qobject_configuration_clause;
    Object list_constant_104, list_constant_103, Qdo_not_single_step;
    ...
    Object Qclose_and_continue, list_constant_101, Qload_attribute_file;
    ...
    Object Qwrite_g2_stats, Qmain_menu_choices, Qfour_times_the_scale;
    Object Qone_quarter_the_scale, Qtwenty_percent_wider;
    Object Qtwenty_percent_narrower, Qtwenty_percent_bigger;
    Object Qtwenty_percent_smaller, Qmaximum_scale_to_fit, Qscale_to_fit;
    Object Qcenter_origin, Qshift_down_one_percent, Qshift_right_one_percent;
    ...
    Object Qglobal_keyboard_command_choices, list_constant_98, Qshow_text;
    Object Qshow_value, Qtransfer_original, Qdelete_original, Qgo_to_original;
    Object Qchange_size, Qhide_attribute_display, Qdelete_name_of_attribute;
    ...
    Object Qadd_subtable, Qshow_summary_of_text, list_constant_96;
    ...
    Object string_constant_156, string_constant_155;
    ...
    Object string_constant_154, string_constant_153;
    Object Qsimplify_associative_operation, string_constant_152;
    Object string_constant_151, string_constant_150;
    Object Qglobal_keyboard_command_mode_restriction;
    Object Qmain_menu_mode_restriction, Qg2_user_mode_for_login_qm;
    Object list_constant_95, Qno_item, Qg2_user_mode_for_login;
    ...
    Object Qg2_user_mode, string_constant_149, string_constant_148;
    Object string_constant_147, string_constant_146;

    x_note_fn_call(181,277);
    SET_PACKAGE("AB");
    ...
    list_constant_94 = STATIC_LIST((SI_Long)2L,Qunsigned_byte,
	    FIX((SI_Long)16L));
    array_constant = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)40L));
    ...
    list_constant_95 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_82,
	    Qsymbol);
    ...
    string_constant_150 = 
	    STATIC_STRING("1l1o83-cUy1p83Fuy1m9k83*Xy839Sy1m9k83-Py83-cWy2mlnp9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_151 = STATIC_STRING("1m1m83Fuy1m9k837ey1m83Fuy1m9k83ALy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_152 = 
	    STATIC_STRING("1n1n839Sy1m836uy1m9k83-eNy1ll1n839Sy1o836uy1m9k83=Uy836uy1m9k83-eNy1mln1o839Sy1o836uy1m9k83vy83-7+y1m9k83-eNy2lln9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_153 = 
	    STATIC_STRING("1m1o83-7+y1n836uy1m9k83vy83-7+y1nmln1l9l1n83-7+y1o836uy1m9k83vy1m9k83=Uy836uy1nmlo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_154 = 
	    STATIC_STRING("1l1o83-W4y1p83Fuy1m9k83*Xy839Sy1m9k83-Py83-W6y2mlnp9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_mode_restriction);
    ...
    string_constant_155 = 
	    STATIC_STRING("1l1o83-cVy1p1m9k83-cSy1m9k9l1m9k83s3y83mQy83-cTy2m839Oyop1m9mm");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_156 = 
	    STATIC_STRING("1l1o83-W5y1p1m9k83-W1y1m9k83-b2y1m9k83-NBy83mQy83-W3y2m83-W2yop1m9lm");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_tailing_associative_list);
    ...
    list_constant_96 = STATIC_LIST((SI_Long)26L,Qmark_not_to_strip_text,
	    Qremove_do_not_strip_text_mark_star,
	    ...
	    Qhide_name);
    list_constant_97 = STATIC_LIST_STAR((SI_Long)32L,Qlift_to_top,
	    ...
	    list_constant_96);
    Item_menu_choices = list_constant_97;
    ...
    list_constant_98 = STATIC_LIST((SI_Long)18L,Qshow_summary_of_text,
    ...
    list_constant_99 = STATIC_LIST_STAR((SI_Long)32L,Qsubtable,
	    ...
	    Qview_change_log,Qshow_value,Qshow_text,list_constant_98);
    if (Table_menu_choices == UNBOUND)
	Table_menu_choices = list_constant_99;
    ...
    list_constant_100 = STATIC_LIST((SI_Long)27L,Qpause,Qrefresh,Qhelp,
	...
	Global_keyboard_command_choices = list_constant_100;
    ...
    list_constant_101 = STATIC_LIST((SI_Long)18L,Qwrite_g2_stats,Qclear_kb,
    ...
    list_constant_102 = STATIC_LIST_STAR((SI_Long)32L,Qstart,Qpause,
	...
	Main_menu_choices = list_constant_102;
    ...
    list_constant_103 = STATIC_LIST((SI_Long)21L,Qclose_and_continue,
	    ...
	    Qremove_do_not_strip_text_mark_star,
	    Qremove_do_not_strip_text_mark);
    list_constant_104 = STATIC_LIST_STAR((SI_Long)32L,Qnew_object,
	    ...
	    Qsingle_step,Qdo_not_single_step,list_constant_103);
    if (Workspace_menu_choices == UNBOUND)
	Workspace_menu_choices = list_constant_104;
    ...
    list_constant_105 = STATIC_LIST((SI_Long)5L,Qinclude,
    ...
    list_constant_106 = STATIC_LIST((SI_Long)3L,Qworkspace_menu,Qitem_menu,
	    Qnon_menu);
    Menu_configuration_operation_types = list_constant_106;
    ...
    string_constant_157 = 
	    STATIC_STRING("1p1m83-gLy83sqy1m83-gLy83spy1m83-gLy83-Bty1m83-gLy83-G4y1m83-gLy83-G3y");
    ...
    string_constant_158 = 
	    STATIC_STRING("1l1o83sqy1q1m9k83-Nly1m9k9l1m9k83oNy1m9k83D0y837jy83-u4y2l83Fjyq9m");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_159 = 
	    STATIC_STRING("1l1o83spy1q1m9k9l1m9k837by1m9k83-7Ky1m9k83Aby837jy83-fQy2l83-fOyq9m");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_160 = 
	    STATIC_STRING("1l1o83-G3y1n1m9k83-NCy837jy83-NEy2l83-NCyn9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_object_configuration_clause);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_160));
    string_constant_161 = 
	    STATIC_STRING("1l1m837jy1n1m9k83*5y1m9k83-U4y1m9k83-Py");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_162 = 
	    STATIC_STRING("1m1o83-G4y1o1m9k83gcy1m9k83-jMy837jy83-u*y2m83ury0o9l1o83-G4y1q1m9k83gcy1m9k83-jMy1m9k83-Ty8399y837jy83-u*y2m83uryoq9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_163 = 
	    STATIC_STRING("1m1n83-u-y83wwy1ml8k1n83-u-y1m1m9k9l83wwy1mm0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnot);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_163));
    string_constant_164 = 
	    STATIC_STRING("1u1m83wwy1m9k83-p4y1m83wwy1m9k83-Yty1m83wwy1m9k83-p5y1m83wwy1m9k83pUy1m83wwy1m9k83wCy1m83wwy1m9k83-cgy1m83wwy1m9k83-E4y1m83wwy1m");
    string_constant_165 = 
	    STATIC_STRING("9k83-gsy1m83wwy1m9k83-ZDy1m83wwy1m9k83-Zny");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_166 = 
	    STATIC_STRING("1v1n83-fPy1o83-7My1m9k83Aby1m9k83*uy83-fSy1mol1n83-fPy1m83-7My83sRy1o83=by0lm1n83-fPy1m83-0=y83sBy1o83=by0lm1n83-fPy1m83-7My83xg");
    string_constant_167 = 
	    STATIC_STRING("y1o830Jy0lm1n83-fPy1o83-7My83sRy1m9k83=3y8399y1o83=byolm1n83-fPy1o83-7My83xgy1m9k83=3y8399y1o830Jyolm1n83-fPy1o83-7My83sRy1m9k83");
    string_constant_168 = 
	    STATIC_STRING("*uy83-7Ly1oo0lm1n83-fPy1o83-7My83xgy1m9k83*uy1m9k830Jy1o830Jy0lm1n83-fPy1o83-0=y83sBy1m9k83*uy83s9y1oo0lm1n83-fPy1q83-7My83sRy1m");
    string_constant_169 = 
	    STATIC_STRING("9k83=3y8399y1m9k83*uy83-7Ly1oqolm1n83-fPy1q83-7My83xgy1m9k83=3y8399y1m9k83*uy1m9k830Jy1o830Jyolm");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_170 = 
	    STATIC_STRING("1n1n83-7My1m9k837gy83j*y1n83-7My1m9k83-9Xy836ny1n83-7My1m1m9k83-9Xy1m9k83pOy83vty");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_170));
    string_constant_171 = 
	    STATIC_STRING("1m1n83-0=y1m9k837gy83j*y1n83-0=y1m9k83-9Xy836ny");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Qfix_item_filter_phrase = STATIC_SYMBOL("FIX-ITEM-FILTER-PHRASE",
	    AB_package);
    string_constant_172 = STATIC_STRING("1l1o83sRy1m83-NKy1m9k83Abyl9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_173 = STATIC_STRING("1l1o83xgy1m83-V1y1m9k83Abyl9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_item_filter_phrase);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_173));
    string_constant_174 = STATIC_STRING("1l1o83sBy1m83sAy1m9k83Aby1ll9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_item_filter_phrase);
    ...
    string_constant_175 = 
	    STATIC_STRING("1m1m83-NJy1m9k83-=Zy1m83-NJy1m9k83-T0y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_175));
    string_constant_176 = STATIC_STRING("1m1m83-V0y1m9k9l1m83-V0y1m9k9m");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_177 = STATIC_STRING("1l1m83sAy1m9k836iy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_177));
    string_constant_178 = 
	    STATIC_STRING("1o1m83-7Ly1m9k830Jy1m83-7Ly1m9k831Jy1n83-7Ly1n1m9k830Jy1m9k83-ty1m9k831Jy83xRy1n83-7Ly1n1m9k831Jy1m9k83-ty1m9k830Jy83xRy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_178));
    string_constant_179 = 
	    STATIC_STRING("1z1m83s9y1m9k830Jy1m83s9y1m9k83-EYy1m83s9y1m9k831Jy1n83s9y1n1m9k830Jy1m9k83-ty1m9k831Jy83xRy1n83s9y1p1m9k830Jy1m9k83-ty1m9k831Jy");
    string_constant_180 = 
	    STATIC_STRING("1m9k83-ty1m9k83-EYy83-Uty1n83s9y1n1m9k830Jy1m9k83-ty1m9k83-EYy83-Usy1n83s9y1p1m9k830Jy1m9k83-ty1m9k83-EYy1m9k83-ty1m9k831Jy83-Ut");
    string_constant_181 = 
	    STATIC_STRING("y1n83s9y1n1m9k831Jy1m9k83-ty1m9k830Jy83xRy1n83s9y1p1m9k831Jy1m9k83-ty1m9k830Jy1m9k83-ty1m9k83-EYy83-Uty1n83s9y1n1m9k831Jy1m9k83-");
    string_constant_182 = 
	    STATIC_STRING("ty1m9k83-EYy83-qjy1n83s9y1p1m9k831Jy1m9k83-ty1m9k83-EYy1m9k83-ty1m9k831Jy83-Uty1n83s9y1n1m9k83-EYy1m9k83-ty1m9k830Jy83-Usy1n83s9");
    string_constant_183 = 
	    STATIC_STRING("y1p1m9k83-EYy1m9k83-ty1m9k830Jy1m9k83-ty1m9k831Jy83-Uty1n83s9y1n1m9k83-EYy1m9k83-ty1m9k831Jy83-qjy1n83s9y1p1m9k83-EYy1m9k83-ty1m");
    string_constant_184 = STATIC_STRING("9k831Jy1m9k83-ty1m9k830Jy83-Uty");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_185 = 
	    STATIC_STRING("1n1m83-fRy1m9k830Jy1m83-fRy1m9k831Jy1m83-fRy1m9k83-EYy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_185));
    ...
    string_constant_186 = 
	    STATIC_STRING("1l1o83-u3y1p83Fuy1m9k83*Xy839Sy1m9k83-Py83-u+y2mlnp9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_mode_restriction);
    ...
    array_constant_1 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    list_constant_107 = STATIC_LIST((SI_Long)16L,Qfind,Qhome,Qbegin,Qend,
    ...
    list_constant_108 = STATIC_LIST_STAR((SI_Long)32L,Q_,Qbq,Qob,Qab_or_1,
	    ...
	    Qredo,Qmenu,list_constant_107);
    list_constant_109 = STATIC_LIST_STAR((SI_Long)32L,Qnum_gt,Qqm,Qa,Qb,Qc,
	    Qd,Qe,Qf,Qg,Qh,Qi,Qj,Qk,Ql,Qm,Qn,Qo,Qp,Qq,Qr,Qs,Qt,Qu,Qv,Qw,Qx,
	    Qy,Qz,Qobt,Qcbt,Qct,list_constant_108);
    list_constant_110 = STATIC_LIST_STAR((SI_Long)32L,Qf1,Qf2,Qf3,Qf4,Qf5,
	    Qf6,Qf7,Qf8,Qf9,Qf10,Qf11,Qf12,Qbackspace,Qtab,Qlinefeed,
	    Qreturn,Qescape,Q0,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Qcol,Qsc,Qnum_lt,
	    Qnum_eq,list_constant_109);
    ...
    SET_SYMBOL_FUNCTION(Qstring_to_insert_for_keyboard_symbol,
	    ...
	    1,1));
    def_semi_open_category_1(5,Qkeyboard_symbol,list_constant_110,Qsymbol,
	    SYMBOL_FUNCTION(Qstring_to_display_for_keyboard_symbol),
	    SYMBOL_FUNCTION(Qstring_to_insert_for_keyboard_symbol));
    string_constant_187 = 
	    STATIC_STRING("1n1m83-txy83oRy1m83-txy83g*y1m83-txy83gLy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_187));
    string_constant_188 = 
	    STATIC_STRING("1m1n83gLy1w1m9k83-OMy1m9k83-f+y8399y1m9k83FHy1m9k8319y1m9k9l1m9k83Ry1m9k83-JUy1m9k830Py1m9k9l1m9k83R*y83--jy1ol83-f+ynw1n83gLy1r");
    string_constant_189 = 
	    STATIC_STRING("1m9k83-OMy1m9k83-f+y8399y1m9k83=3y1m9k9l1m9k83Yjy83Yjy1ol83Yjynr");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_188,
	    string_constant_189)));
    string_constant_190 = 
	    STATIC_STRING("1o1m83-73y1m9k83BGy1m83-73y1m9k83-Riy1m83-73y1m9k839ky1m83-73y1m9k83-kly");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_191 = 
	    STATIC_STRING("1x1o83g*y1n83-73y83-G7y83-=Ky1nlmn9k1o83g*y1p83-73y83-G7y1m9l830Py83-H*y83-=My1olmpo9k1o83g*y1p83-73y83-G7y1m9l830Py8399y83-=Ly1");
    string_constant_192 = 
	    STATIC_STRING("olmpo9k1o83g*y1w1m9l839ky83-G7y1m9l830Py8399y1m9l83-pHy834Ry1m9l83*5y1m9l9m1m9l83E-y1m9l83-s2y1m9l83lMy8399y1o839kym1n9nqwo9k1o8");
    string_constant_193 = 
	    STATIC_STRING("3g*y1x1m9l839ky83-G7y1m9l830Py8399y1m9l83-pHy834Ry1m9l83*5y1m9l9m1m9l83E-y1m9l83-s2y1m9l83-OYy1m9l83lMy8399y1o839kym1o9nqx83-edy");
    string_constant_194 = 
	    STATIC_STRING("o9k1o83g*y1n1m9l83-t+y83-G5y83-=Ky1n83-t+ymn9k1o83g*y1p1m9l83-t+y83-G5y1m9l830Py83-H*y83-=My1o83-t+ympo9k1o83g*y1p1m9l83-t+y83-G");
    string_constant_195 = 
	    STATIC_STRING("5y1m9l830Py8399y83-=Ly1o83-t+ympo9k1o83g*y1n1m9l83-lwy83-76y83-=Ky1n83-lwymn9k1o83g*y1p1m9l83-lwy83-76y1m9l83lMy83-H*y83-=My1o83");
    string_constant_196 = 
	    STATIC_STRING("-lwympo9k1o83g*y1p1m9l83-lwy83-76y1m9l83lMy8399y83-=Ly1o83-lwympo9k1o83g*y1p1m9l83-Xcy83-74y1m9l83lMy83-H*y83-=My1o83-Xcympo9k1o");
    string_constant_197 = 
	    STATIC_STRING("83g*y1p1m9l83-Xcy83-74y1m9l83lMy8399y83-=Ly1o83-Xcympo9k");
    clear_optimized_constants();
    ...
    string_constant_198 = 
	    STATIC_STRING("1n1n83-=Ky1m1m9k83Cpy83-2kym1n83-=Ky1m1m9k83Cpy83--5ym1n83-=Ky1m1m9k838By1m9k9l9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnothing);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_198));
    string_constant_199 = 
	    STATIC_STRING("1m1n83-=My1m1m9k83Cpy83ogym1n83-=My1m1m9k838By1m9k9l9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnothing);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_199));
    string_constant_200 = 
	    STATIC_STRING("1m1n83-=Ly1m1m9k83Cpy83jUym1n83-=Ly1m1m9k838By1m9k9l9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnothing);
    ...
    string_constant_201 = 
	    STATIC_STRING("1n1m83-u7y83-Gy1m83-u7y1m9k835ny1m83-u7y1m9k83*ry");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_201));
    string_constant_202 = 
	    STATIC_STRING("1m1o8399y1m1m9k83=by83-u8ym9l1o8399y1m1m9k837Zy1m9k83Rym9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_item_filter_phrase);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_202));
    string_constant_203 = 
	    STATIC_STRING("1l1n83-H*y1m1m9k83=by1m9k83*ry1l83*ry");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_204 = 
	    STATIC_STRING("1l1o83--jy1p1m9k83-9y83-Vy1m9k83vy83-Vy1m9k83-Ay2lmo9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    array_constant_2 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)48L));
    ...
    string_constant_205 = 
	    STATIC_STRING("1l1n83Yjy1t1m9k83-9y83Sy1m9k83vy83Sy1m9k83vy83Sy1m9k83vy83Sy1m9k83-Ay1omoqs");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_206 = 
	    STATIC_STRING("1n1m83-G5y83-b4y1o83-G5y1n83Dry1m9k9l83-b4y1mln9m1m83-G5y83-Uy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_207 = 
	    STATIC_STRING("1m1n83wsy1o1m9k9l1m9k83E-y1m9k83-v8y1m9k83hWy83-ejy1n83wsy1o1m9k9l1m9k83E-y1m9k83-v8y1m9k83fNy83-eiy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_207));
    string_constant_208 = 
	    STATIC_STRING("1m1m83-76y83wsy1o83-76y1n83Dry1m9k9l83wsy1mln9m");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qplus);
    push_optimized_constant(Qparse_user_interface_key_chord);
    ...
    string_constant_209 = 
	    STATIC_STRING("1m1n83-74y1m1m9k9l1m9k83E-y1l83-efy1o83-74y1o83Dry1m9k9m1m9k9l1m9k83E-y1ml83-efy9n");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    push_optimized_constant(Qplus);
    ...
    string_constant_210 = 
	    STATIC_STRING("1o1n83-G6y1n1m9k83=by1m9k83E-y1m9k833hy1l83-Jmy1n83-G6y1o1m9k9l1m9k83*hy1m9k83E-y1m9k833hy1l83-bRy1n83-G6y1o1m9k9l1m9k83-diy1m9k");
    string_constant_211 = 
	    STATIC_STRING("83E-y1m9k833hy1l83-djy1n83-G6y1o1m9k9l1m9k83-cy1m9k83E-y1m9k833hy1l83-loy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_210,
	    string_constant_211)));
    string_constant_212 = 
	    STATIC_STRING("1m1m83-G7y83-G6y1o83-G7y1n83Dry1m9k9l83-G6y1mln9m");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qplus);
    push_optimized_constant(Qparse_user_interface_key_chord);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_212));
    string_constant_213 = 
	    STATIC_STRING("1n1m83-eQy1m9k83Ioy1m83-eQy1m9k83-nAy1m83-eQy1m9k83-Jey");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_214 = STATIC_STRING("1l1o83Dry83-eRyl9k");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qremove_separator_symbol_from_phrase,
	    ...
	    1,1));
    string_constant_215 = 
	    STATIC_STRING("1m1n83-gSy1n1m9k83-Ty8399y1m9k83*Iym1n83-gSy1m9k83*Iy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_215));
    string_constant_216 = 
	    STATIC_STRING("1l1n83lJy1p1m9k83-9y83Sy1m9k83vy83Sy1m9k83-Ay1mmo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_216));
    string_constant_217 = 
	    STATIC_STRING("1l1o83-Bty1p1m9k83-lEy1m9k839qy1m9k83jWy837jy83-jQy2l839qyp9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_object_configuration_clause);
    ...
    string_constant_218 = 
	    STATIC_STRING("1n1m83-jPy83oRy1m83-jPy83g*y1m83-jPy83gLy");
    ...
    add_grammar_rules_for_list(5,Qcomment_options,Qcomment_option,Qcm,Qnil,
	    Qnil);
    string_constant_219 = STATIC_STRING("1l1n83-NDy1n83-2y1m9k83-Py83-xy1mln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    add_grammar_rules_for_list(5,Quser_restrictions,Quser_mode_restriction,
	    Qsc,Qnil,Qnone);
    string_constant_220 = 
	    STATIC_STRING("1l1o83-u5y1p83Fuy1m9k83*Xy839Sy1m9k83-Py83-u9y2mlnp9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qfix_mode_restriction);
    ...
    string_constant_221 = 
	    STATIC_STRING("1r1m83oRy83-H1y1m83oRy83-01y1m83oRy83-7Yy1m83oRy83-H5y1m83oRy83-03y1m83oRy83-DJy1m83oRy83-EPy");
    ...
    Qdont_include_workspace = STATIC_SYMBOL("DONT-INCLUDE-WORKSPACE",
	    AB_package);
    string_constant_222 = 
	    STATIC_STRING("13Sy1p83-H1y1q1m9k9l1m9k83s3y1m9k83=Iy1m9k83*ry83mQy83-vhy2n834uy1l83*rypq9m1m9nn1n83-H1y1q1m9k9l1m9k83s3y1m9k83=Iy1m9k83*ry83-Y");
    string_constant_223 = 
	    STATIC_STRING("gy1m9k9o1n834uy1l83*ryp1q83-01y1p1m9k9l1m9k83s3y83-UBy83mQy83-aMy2n834uynop9m1m9nn1m9pl1o83-01y1p1m9k9l1m9k83s3y83-UBy83-Ygy1m9k");
    string_constant_224 = 
	    STATIC_STRING("9o1n834uyno1m9pl1o83-UBy1m1m9k83=Iy83-lGym9q1q83-7Yy1q1m9k83-fwy1m9k83s3y1m9k83=Iy83-lGy83mQy83-g+y2n83-fwyopq9m1m9nn1m9pl1o83-7");
    string_constant_225 = 
	    STATIC_STRING("Yy1q1m9k83-fwy1m9k83s3y1m9k83=Iy83-lGy83-Ygy1m9k9o1n83-fwyop1m9pl1o83-H5y1p1m9k83-miy1m9k83=by1m9k83*ry1m9k83Cpy83ogy1n83-miy1l8");
    string_constant_226 = 
	    STATIC_STRING("3*ryp9m1o83-H5y1q1m9k83-miy1m9k83=by1m9k83*ry1m9k83pOy1m9k83Cpy83ogy1n83-mjy1l83*ryq9m1n83-H5y1p1m9k83-miy1m9k83=by1m9k83*ry1m9k");
    string_constant_227 = 
	    STATIC_STRING("838By1m9k9o1n83-miy1l83*ry9o1n83-H5y1q1m9k83-miy1m9k83=by1m9k83*ry1m9k83pOy1m9k838By1m9k9o1n83-mjy1l83*ry9o1p83-03y1p1m9k83-miy1");
    string_constant_228 = 
	    STATIC_STRING("m9k83=by83-lGy1m9k83Cpy83jUy1n83-miynp9m1m9pl1p83-03y1q1m9k83-miy1m9k83=by83-lGy1m9k83pOy1m9k83Cpy83jUy1n83-mjynq9m1m9pl1o83-03y");
    string_constant_229 = 
	    STATIC_STRING("1p1m9k83-miy1m9k83=by83-lGy1m9k838By1m9k9o1n83-miyn9o1m9pl1o83-03y1q1m9k83-miy1m9k83=by83-lGy1m9k83pOy1m9k838By1m9k9o1n83-mjyn9o");
    string_constant_230 = 
	    STATIC_STRING("1m9pl1q83-DJy1q1m9k83Gry1m9k83-Ggy1m9k83=Iy83-lGy83mQy83fIy1o83Fryoqp9m1m9pl1m9pm1o83-DJy1q1m9k83Gry1m9k83-Ggy1m9k83=Iy83-lGy83-");
    string_constant_231 = 
	    STATIC_STRING("Ygy1m9k9o1o83Fryo0p1m9pl1r83-EPy1v1m9k83*Jy1m9k9l1m9k83s3y1m9k83=Iy1m9k9r83-K8y1m9k83-Ty1m9k83=by83-lGy83mQy83-qNy2o83*Jytquv9m1");
    string_constant_232 = 
	    STATIC_STRING("m9no1m9pl1m9pm1p83-EPy1v1m9k83*Jy1m9k9l1m9k83s3y1m9k83=Iy1m9k9r83-K8y1m9k83-Ty1m9k83=by83-lGy83-Ygy1m9k9o1o83*Jytqu1m9pl1m9pm1q8");
    string_constant_233 = 
	    STATIC_STRING("3-EPy1s1m9k83*Jy1m9k9l1m9k83s3y1m9k83=Iy1m9k83=by83-lGy83mQy83-qNy2o83*Jyq0rs9m1m9no1m9pl1o83-EPy1s1m9k83*Jy1m9k9l1m9k83s3y1m9k8");
    string_constant_234 = 
	    STATIC_STRING("3=Iy1m9k83=by83-lGy83-Ygy1m9k9o1o83*Jyq0r1m9pl1n83mQy1m83-lHy1m9k83-Pyl1m83-lHy1m9k83*Yy1n83-lHy1m1m9k83*Yy1m9k83-JLy83j*y1m83-l");
    string_constant_235 = 
	    STATIC_STRING("Hy1m9k83Bvy1n83-lHy1m1m9k83Bvy1m9k83-JLy836ny1n83-lHy1m1m9k83Bvy1m9k83pOy83vty1n83-Ygy1m1m9k83*Yy1m9k83-Pyl1n83-Ygy1m1m9k83Bvy1m");
    string_constant_236 = 
	    STATIC_STRING("9k83-Pyl1m83-lFy83-Gy1m83-lFy1m9k835ny1m83jUy834oy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qmenu);
    ...
    list_constant_111 = STATIC_LIST((SI_Long)16L,Qmove_object,
	...
	Non_menu_choices = list_constant_111;
    string_constant_237 = 
	    STATIC_STRING("13Cy1m83-fxy1m9k83-eoy1m83-fxy1m9k83-epy1m83-fxy1m9k83-emy1m83-fxy1m9k83W6y1m83-fxy1m9k83-ewy1m83-fxy1m9k9l1m83-fxy1m9k83-mEy1m8");
    string_constant_238 = 
	    STATIC_STRING("3-fxy1m9k83-Mgy1m83-fxy1m9k83-Uny1m83-fxy1m9k83-gty1m83-fxy1m9k83-dRy1m83-fxy1m9k83-RZy1m83-fxy1m9k83-Jby1m83-fxy1m9k83-Jcy1m83-");
    string_constant_239 = STATIC_STRING("fxy1m9k9m1m83-fxy1m9k83-mey");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qshow_workspace);
    push_optimized_constant(Qselect_area);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_3(string_constant_237,
    ...
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_240));
    string_constant_241 = 
	    STATIC_STRING("1n1m83nfy83FJy1m83nfy83*my1n83nfy1n83-Gy1m9k83=my83*my1n830=yln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_242 = 
	    STATIC_STRING("1m1m83djy83*my1o83djy1n83-Gy1m9k83=my83*my1n830=yln9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qconvert_class_qualified_list_to_keyword_symbol);
    ...
    string_constant_243 = STATIC_STRING("1l1m83FJy83-6y");
    ...
    list_constant_112 = STATIC_CONS(Qsystem_table,Qnil);
    check_if_superior_classes_are_defined(Qkb_restrictions,list_constant_112);
    string_constant_244 = STATIC_STRING("1l1l83ey");
    string_constant_245 = 
	    STATIC_STRING("1s4z8r830jy830jy839Dy839Dy01l1m83Fjy1p83ALy1l833ey1o834uy1l83Ry836ny830Fy1o83Fry1l839Dy1n83Uiy83TVy83SBy83Bvy1o83Fry1l83Ry1l835X");
    string_constant_246 = 
    ...
    string_constant_248 = 
	    STATIC_STRING("z8r83Uiy83Uiy839Dy839Dy00001m1l8l1m8p83Uhy000004z8r83Qgy83Qgy839Dy839Dy00001m1l8l1m8p83Qfy000004z8r83SBy83SBy839Dy839Dy00001m1l8");
    string_constant_249 = 
	    STATIC_STRING("l1m8p83CBy000004z8r83Z2y83Z2y839Dy839Dy00001l1l8l000004z8r83Gwy83Gwy839Dy839Dy00001o1l8l1l83Fy1l83Hy1m8p83YQy000004z8r83aBy83aBy");
    string_constant_250 = 
	    STATIC_STRING("839Dy839Dy08k001n1l8l1l83Hy1m8p83F0y000004z8r83Fly83Fly839Dy839Dy00001m1l8l1l83Cy00000");
    string_constant_251 = 
	    STATIC_STRING("1u8q1n839Dy1l83-sy83ey1m830jy1l1m83Fjy1p83ALy1l833ey1o834uy1l83Ry836ny830Fy1o83Fry1l839Dy1n83Uiy83TVy83SBy83Bvy1o83Fry1l83Ry1l83");
    string_constant_252 = 
	    STATIC_STRING("5Xy836ny1o83Uiy08l1m8p83Uhy1o83Qgy08l1m8p83Qfy1o83SBy08l1m8p83CBy1n83Z2y08l1q83Gwy08l83Fy83Hy1m8p83YQy1p83aBy8k8l83Hy1m8p83F0y1o");
    string_constant_253 = STATIC_STRING("83Fly08l83Cy");
    temp = regenerate_optimized_constant(string_constant_244);
    temp_1 = regenerate_optimized_constant(list(6,string_constant_245,
	    string_constant_246,string_constant_247,string_constant_248,
	    string_constant_249,string_constant_250));
    add_class_to_environment(9,Qkb_restrictions,list_constant_112,Nil,temp,
	    Nil,temp_1,list_constant_112,
	    regenerate_optimized_constant(LIST_3(string_constant_251,
	    string_constant_252,string_constant_253)),Nil);
    Qkb_configuration = STATIC_SYMBOL("KB-CONFIGURATION",AB_package);
    list_constant_113 = STATIC_CONS(Qkb_restrictions,Qnil);
    check_if_superior_classes_are_defined(Qkb_configuration,list_constant_113);
    string_constant_254 = STATIC_STRING("0");
    string_constant_255 = STATIC_STRING("1m8q1n83-1Zy1l839Dy83ey");
    temp = regenerate_optimized_constant(string_constant_244);
    temp_1 = regenerate_optimized_constant(string_constant_254);
    add_class_to_environment(9,Qkb_configuration,list_constant_113,Nil,
	    temp,Nil,temp_1,list_constant_113,
	    regenerate_optimized_constant(string_constant_255),Nil);
    ...
    list_constant_114 = STATIC_LIST((SI_Long)3L,Kfuncall,Qsymbol_value,
	    Qkb_configuration);
    record_system_variable(Qkb_restrictions,Qfilters,list_constant_114,
	    Qnil,Qnil,Qnil,Qt);
    Qglobal_keyboard_command_user_restrictions = 
    ...
    mutate_global_property(Qg2_set_movement_grid,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    list_constant_115 = STATIC_LIST((SI_Long)2L,Qitem,Qstar);
    ...
    list_constant_117 = STATIC_LIST((SI_Long)2L,Quser_restrictions,
	    Qitem_configuration);
    list_constant_118 = STATIC_LIST((SI_Long)2L,Qclass_restrictions,
	    Qinstance_configuration);
    Qdescribe_restrictions = STATIC_SYMBOL("DESCRIBE-RESTRICTIONS",AB_package);
    list_constant_119 = STATIC_LIST((SI_Long)2L,Qdescribe_restrictions,
	    Qdescribe_configuration);
    list_constant_116 = STATIC_CONS(Qkb_configuration,Qnil);
    list_constant_120 = STATIC_CONS(Qkb_restrictions,list_constant_116);
    Qsuperior_class = STATIC_SYMBOL("SUPERIOR-CLASS",AB_package);
    Qdirect_superior_classes = STATIC_SYMBOL("DIRECT-SUPERIOR-CLASSES",
	    AB_package);
    list_constant_121 = STATIC_LIST((SI_Long)2L,Qsuperior_class,
    ...
    Qclass_specific_attributes = STATIC_SYMBOL("CLASS-SPECIFIC-ATTRIBUTES",
	    AB_package);
    list_constant_122 = STATIC_LIST((SI_Long)2L,
    ...
    Qattribute_initializations = STATIC_SYMBOL("ATTRIBUTE-INITIALIZATIONS",
	    AB_package);
    list_constant_123 = STATIC_LIST((SI_Long)2L,Qdefault_settings,
	    Qattribute_initializations);
    list_constant_124 = STATIC_LIST((SI_Long)7L,list_constant_117,
	    list_constant_118,list_constant_119,list_constant_120,
	    list_constant_121,list_constant_122,list_constant_123);
    Things_to_rename_in_restrictions = list_constant_124;
	...
	See_also_for_warn_about_editing_item = string_constant_256;
    ...
    array_constant_3 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_4 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_5 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_6 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_7 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    list_constant_125 = STATIC_LIST((SI_Long)2L,string_constant_117,Qitem);
    string_constant_257 = STATIC_STRING("this item\'s workspace");
    list_constant_126 = STATIC_LIST((SI_Long)2L,string_constant_257,
	    Qworkspace);
    string_constant_258 = STATIC_STRING("this item\'s module");
    list_constant_127 = STATIC_LIST((SI_Long)2L,string_constant_258,Qmodule);
    list_constant_7 = STATIC_LIST((SI_Long)3L,list_constant_125,
    ...
    list_constant_128 = STATIC_CONS(Qstar,Qnil);
    list_constant_9 = STATIC_LIST_STAR((SI_Long)4L,Qconstrain,Qmoving,
	    Qstar,list_constant_128);
    list_constant_129 = STATIC_CONS(Qstar,list_constant_128);
    ...
    list_constant_130 = STATIC_CONS(Qworkspace,Qnil);
    list_constant_16 = STATIC_CONS(Qitem,list_constant_130);
    ...
    Qrestricted_by_these_input_operations_on_slot = 
	    ...
	    AB_package);
    list_constant_131 = STATIC_LIST((SI_Long)2L,
	    Qrestricted_by_these_input_operations_on_slot,Qedit);
    list_constant_132 = STATIC_CONS(list_constant_131,Qnil);
    mutate_global_property(Qedit_attribute,list_constant_132,
	    Qinfo_for_restrictable_frame_system_operation);
    ...
    list_constant_133 = STATIC_CONS(Qrestricted_if_slot_not_visible,Qnil);
    list_constant_134 = STATIC_CONS(list_constant_133,Qnil);
    mutate_global_property(Qview_attribute,list_constant_134,
	    Qinfo_for_restrictable_frame_system_operation);
    ...
    list_constant_135 = STATIC_CONS(Qrestricted_if_it_contains_proprietary,
	    Qnil);
    list_constant_136 = STATIC_CONS(list_constant_135,Qnil);
    mutate_global_property(Qchange_superior,list_constant_136,
	    Qinfo_for_restrictable_frame_system_operation);
    Qclone_block = STATIC_SYMBOL("CLONE-BLOCK",AB_package);
    mutate_global_property(Qclone_block,list_constant_136,
	    Qinfo_for_restrictable_frame_system_operation);
    ...
    list_constant_137 = STATIC_CONS(Qrestricted_if_it_is_proprietary,Qnil);
    list_constant_138 = STATIC_CONS(list_constant_137,Qnil);
    mutate_global_property(Qchange_set_of_inferiors,list_constant_138,
	    Qinfo_for_restrictable_frame_system_operation);
    Qmake_transient = STATIC_SYMBOL("MAKE-TRANSIENT",AB_package);
    mutate_global_property(Qmake_transient,list_constant_136,
	    Qinfo_for_restrictable_frame_system_operation);
    ...
    mutate_global_property(Qmake_permanent,list_constant_140,
	    Qinfo_for_restrictable_frame_system_operation);
    ...
    mutate_global_property(Qsimulated_products_qm,T,
	    Quse_slot_value_compiler_for_default_overrides_p);
    string_constant_259 = 
	    STATIC_STRING("1m1n83F0y1n1m9k830Iy1m9k9l1m9k83-o8y8k1m83F0y839py");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnot);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_259));
    ...
    string_constant_260 = STATIC_STRING("embedded");
    string_constant_261 = STATIC_STRING("runtime");
    string_constant_262 = STATIC_STRING("restricted-use");
    string_constant_263 = STATIC_STRING("development");
    list_constant_25 = STATIC_LIST((SI_Long)8L,FIX((SI_Long)0L),
	    string_constant_260,FIX((SI_Long)1L),string_constant_261,
	    FIX((SI_Long)2L),string_constant_262,FIX((SI_Long)3L),
	    string_constant_263);
    string_constant_129 = 
    ...
    mutate_global_property(Qmarshall_exceptional_float_arguments,
	    gensymed_symbol,Qfunction_keeps_procedure_environment_valid_qm);
    array_constant_8 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_9 = STATIC_ARRAY(list_constant_94,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    list_constant_27 = STATIC_CONS(Qmember,list_constant_105);
    ...
    set_property_value_function(get_symbol_properties_function(Qtable_menu_choice),
	    Qtype_specification_simple_expansion,Qnil);
    list_constant_29 = STATIC_CONS(Qmember,list_constant_99);
    ...
    list_constant_31 = STATIC_LIST((SI_Long)3L,Qsequence,list_constant_28,
	    FIX((SI_Long)0L));
    ...
    set_property_value_function(get_symbol_properties_function(Qmenu_choices),
	    Qtype_specification_simple_expansion,list_constant_83);
    list_constant_145 = STATIC_CONS(FIX((SI_Long)0L),Qnil);
    ...
    list_constant_146 = STATIC_CONS(Qab_structure,Qnil);
    set_property_value_function(get_symbol_properties_function(Qtable_menu_configurations),
	    Qtype_specification_simple_expansion,list_constant_146);
    Qoperation_type = STATIC_SYMBOL("OPERATION-TYPE",AB_package);
    Qtable_menu = STATIC_SYMBOL("TABLE-MENU",AB_package);
    list_constant_147 = STATIC_LIST((SI_Long)2L,Qmember,Qtable_menu);
    list_constant_149 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_147);
    Qrestriction_type = STATIC_SYMBOL("RESTRICTION-TYPE",AB_package);
    list_constant_150 = STATIC_LIST((SI_Long)2L,Qrestriction_type,
	    list_constant_26);
    list_constant_151 = STATIC_LIST((SI_Long)2L,Qmenu_choices,
	    list_constant_30);
    Qapplicable_attributes = STATIC_SYMBOL("APPLICABLE-ATTRIBUTES",AB_package);
    list_constant_152 = STATIC_LIST((SI_Long)2L,Qapplicable_attributes,
	    list_constant_33);
    Qapplicable_items = STATIC_SYMBOL("APPLICABLE-ITEMS",AB_package);
    list_constant_148 = STATIC_LIST((SI_Long)3L,Qsequence,Qsymbol,
	    FIX((SI_Long)1L));
    list_constant_153 = STATIC_LIST((SI_Long)2L,Qapplicable_items,
	    list_constant_148);
    list_constant_154 = STATIC_LIST((SI_Long)5L,list_constant_149,
	    list_constant_150,list_constant_151,list_constant_152,
	    list_constant_153);
    list_constant_155 = STATIC_LIST((SI_Long)5L,Qand,Qoperation_type,
    ...
    set_property_value_function(get_symbol_properties_function(Qmenu_configurations),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_156 = STATIC_CONS(Qmember,list_constant_106);
    list_constant_157 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_156);
    list_constant_158 = STATIC_LIST((SI_Long)2L,Qmenu_choices,
	    list_constant_32);
    list_constant_159 = STATIC_CONS(list_constant_153,Qnil);
    list_constant_160 = STATIC_LIST_STAR((SI_Long)4L,list_constant_157,
	    list_constant_150,list_constant_158,list_constant_159);
    list_constant_161 = STATIC_CONS(list_constant_155,Qnil);
    list_constant_37 = STATIC_LIST_STAR((SI_Long)3L,Qab_structure,
	    list_constant_160,list_constant_161);
    ...
    set_property_value_function(get_symbol_properties_function(Qattribute_visibility_configurations),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_162 = STATIC_LIST((SI_Long)2L,Qmember,Qattribute_visibility);
    list_constant_164 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_162);
    Qattributes = STATIC_SYMBOL("ATTRIBUTES",AB_package);
    list_constant_163 = STATIC_CONS(list_constant_33,Qnil);
    list_constant_165 = STATIC_CONS(Qattributes,list_constant_163);
    list_constant_167 = STATIC_LIST_STAR((SI_Long)4L,list_constant_164,
	    list_constant_150,list_constant_165,list_constant_159);
    list_constant_166 = STATIC_LIST((SI_Long)2L,Qapplicable_items,
	    Qrestriction_type);
    list_constant_168 = STATIC_LIST_STAR((SI_Long)4L,Qand,Qoperation_type,
	    Qattributes,list_constant_166);
    ...
    list_constant_169 = STATIC_CONS(Qsymbol,Qnil);
    list_constant_170 = STATIC_LIST_STAR((SI_Long)3L,Qab_or,Qnil,
	    list_constant_169);
    list_constant_171 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_170,
	    list_constant_146);
    set_property_value_function(get_symbol_properties_function(Quser_interface_consequent_action),
	    Qtype_specification_simple_expansion,list_constant_171);
    list_constant_172 = STATIC_CONS(Qmember,list_constant_97);
    list_constant_179 = STATIC_LIST_STAR((SI_Long)3L,Qab_or,
	    list_constant_172,list_constant_169);
    Qmouse_tracking_procedure_name = 
	    STATIC_SYMBOL("MOUSE-TRACKING-PROCEDURE-NAME",AB_package);
    list_constant_174 = STATIC_CONS(Qmouse_tracking_procedure_name,
	    list_constant_169);
    Qmouse_tracking_applicable_items = 
	    STATIC_SYMBOL("MOUSE-TRACKING-APPLICABLE-ITEMS",AB_package);
    list_constant_173 = STATIC_CONS(list_constant_148,Qnil);
    list_constant_175 = STATIC_CONS(Qmouse_tracking_applicable_items,
	    list_constant_173);
    Qmouse_motion_tracking_qm = STATIC_SYMBOL("MOUSE-MOTION-TRACKING\?",
	    AB_package);
    list_constant_176 = STATIC_LIST((SI_Long)2L,Qmouse_motion_tracking_qm,
	    Qtruth_value);
    list_constant_177 = STATIC_LIST((SI_Long)3L,list_constant_174,
	    list_constant_175,list_constant_176);
    list_constant_178 = STATIC_LIST((SI_Long)3L,Qand,
	    Qmouse_tracking_procedure_name,Qmouse_tracking_applicable_items);
    list_constant_180 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_177,list_constant_178);
    list_constant_41 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_179,
	    list_constant_180);
    ...
    set_property_value_function(get_symbol_properties_function(Qkeyboard_symbol),
	    Qtype_specification_simple_expansion,Qnil);
    list_constant_45 = STATIC_CONS(Qmember,list_constant_110);
    ...
    list_constant_181 = STATIC_LIST((SI_Long)2L,Qmodifiers,Qinteger);
    list_constant_182 = STATIC_LIST((SI_Long)2L,Qkeyboard_symbol,
	    list_constant_44);
    list_constant_184 = STATIC_LIST((SI_Long)2L,list_constant_181,
	    list_constant_182);
    list_constant_183 = STATIC_CONS(Qkeyboard_symbol,Qnil);
    list_constant_185 = STATIC_LIST_STAR((SI_Long)3L,Qand,Qmodifiers,
	    list_constant_183);
    ...
    set_property_value_function(get_symbol_properties_function(Qconfigure_keystroke),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_186 = STATIC_LIST((SI_Long)3L,Qmember,Qtyping,Qhovering);
    list_constant_187 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_186);
    Qkey_code = STATIC_SYMBOL("KEY-CODE",AB_package);
    list_constant_188 = STATIC_LIST((SI_Long)2L,Qkey_code,list_constant_48);
    Qconsequent_action = STATIC_SYMBOL("CONSEQUENT-ACTION",AB_package);
    list_constant_189 = STATIC_LIST((SI_Long)2L,Qconsequent_action,
	    list_constant_40);
    list_constant_190 = STATIC_LIST_STAR((SI_Long)4L,list_constant_187,
	    list_constant_188,list_constant_189,list_constant_159);
    list_constant_191 = STATIC_LIST((SI_Long)4L,Qand,Qoperation_type,
	    Qkey_code,Qconsequent_action);
    list_constant_51 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_190,list_constant_191);
    ...
    set_property_value_function(get_symbol_properties_function(Qconfigure_mouse_click),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_192 = STATIC_CONS(Qclicking,Qnil);
    list_constant_193 = STATIC_LIST_STAR((SI_Long)4L,Qmember,Qpressing,
	    Qreleasing,list_constant_192);
    list_constant_199 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_193);
    list_constant_194 = STATIC_LIST((SI_Long)2L,Qmouse_button,
	    list_constant_46);
    list_constant_196 = STATIC_LIST((SI_Long)2L,list_constant_181,
	    list_constant_194);
    list_constant_195 = STATIC_CONS(Qmouse_button,Qnil);
    list_constant_197 = STATIC_CONS(Qand,list_constant_195);
    list_constant_198 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_196,list_constant_197);
    list_constant_200 = STATIC_LIST((SI_Long)2L,Qkey_code,list_constant_198);
    list_constant_201 = STATIC_CONS(list_constant_189,list_constant_159);
    list_constant_202 = STATIC_LIST_STAR((SI_Long)3L,list_constant_199,
	    list_constant_200,list_constant_201);
    list_constant_203 = STATIC_CONS(list_constant_191,Qnil);
    ...
    set_property_value_function(get_symbol_properties_function(Qconfigure_selection),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_204 = STATIC_LIST((SI_Long)2L,Qselecting,
	    Qselecting_absolutely);
    list_constant_205 = STATIC_CONS(Qmember,list_constant_204);
    list_constant_206 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_205);
    list_constant_208 = STATIC_CONS(list_constant_206,list_constant_201);
    list_constant_207 = STATIC_CONS(Qconsequent_action,Qnil);
    list_constant_209 = STATIC_LIST_STAR((SI_Long)3L,Qand,Qoperation_type,
	    list_constant_207);
    ...
    list_constant_210 = STATIC_CONS(Qinteger,Qnil);
    list_constant_211 = STATIC_CONS(Qleft_edge,list_constant_210);
    Qright_edge = STATIC_SYMBOL("RIGHT-EDGE",AB_package);
    list_constant_212 = STATIC_CONS(Qright_edge,list_constant_210);
    Qtop_edge = STATIC_SYMBOL("TOP-EDGE",AB_package);
    list_constant_213 = STATIC_CONS(Qtop_edge,list_constant_210);
    Qbottom_edge = STATIC_SYMBOL("BOTTOM-EDGE",AB_package);
    list_constant_214 = STATIC_CONS(Qbottom_edge,list_constant_210);
    list_constant_215 = STATIC_LIST((SI_Long)4L,list_constant_211,
	    list_constant_212,list_constant_213,list_constant_214);
    list_constant_216 = STATIC_LIST((SI_Long)5L,Qand,Qleft_edge,
    ...
    list_constant_217 = STATIC_CONS(Qx_grid_length,list_constant_210);
    Qy_grid_length = STATIC_SYMBOL("Y-GRID-LENGTH",AB_package);
    list_constant_218 = STATIC_CONS(Qy_grid_length,list_constant_210);
    list_constant_219 = STATIC_LIST((SI_Long)2L,list_constant_217,
	    list_constant_218);
    list_constant_220 = STATIC_LIST((SI_Long)3L,Qand,Qx_grid_length,
	    Qy_grid_length);
    list_constant_60 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_219,list_constant_220);
    ...
    set_property_value_function(get_symbol_properties_function(Qconstrain_movement_of_items),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_221 = STATIC_LIST((SI_Long)2L,Qmember,Qmoving);
    list_constant_225 = STATIC_LIST((SI_Long)2L,Qoperation_type,
	    list_constant_221);
    Qtype_of_region = STATIC_SYMBOL("TYPE-OF-REGION",AB_package);
    list_constant_222 = STATIC_CONS(Qgrid,Qnil);
    list_constant_223 = STATIC_LIST_STAR((SI_Long)3L,Qmember,Qrectangle,
	    list_constant_222);
    list_constant_226 = STATIC_LIST((SI_Long)2L,Qtype_of_region,
	    list_constant_223);
    Qconstrained_region = STATIC_SYMBOL("CONSTRAINED-REGION",AB_package);
    list_constant_224 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_57,
	    list_constant_59);
    list_constant_227 = STATIC_LIST((SI_Long)2L,Qconstrained_region,
	    list_constant_224);
    list_constant_228 = STATIC_LIST_STAR((SI_Long)4L,list_constant_225,
	    list_constant_226,list_constant_227,list_constant_159);
    list_constant_229 = STATIC_LIST((SI_Long)5L,Qand,Qoperation_type,
	    Qtype_of_region,Qconstrained_region,Qapplicable_items);
    list_constant_62 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_228,list_constant_229);
    ...
    Qrestrict_proprietary_items_and_configure_user_interface_statement = 
	    ...
	    AB_package);
    list_constant_230 = STATIC_LIST((SI_Long)8L,Qab_or,Qnil,Qnil,Qnil,Qnil,
	    Qnil,Qnil,Qnil);
    set_property_value_function(get_symbol_properties_function(Qrestrict_proprietary_items_and_configure_user_interface_statement),
	    Qtype_specification_simple_expansion,list_constant_230);
    ...
    set_property_value_function(get_symbol_properties_function(Qconfigure_user_interface_statements),
	    Qtype_specification_simple_expansion,list_constant_83);
    list_constant_231 = STATIC_CONS(FIX((SI_Long)1L),Qnil);
    list_constant_66 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_63,list_constant_231);
    ...
    list_constant_232 = STATIC_CONS(Qtruth_value,Qnil);
    list_constant_235 = STATIC_CONS(Qnegative,list_constant_232);
    Qmodes = STATIC_SYMBOL("MODES",AB_package);
    Qunreserved_symbol = STATIC_SYMBOL("UNRESERVED-SYMBOL",AB_package);
    list_constant_233 = STATIC_LIST((SI_Long)2L,Qnamed,Qunreserved_symbol);
    list_constant_234 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_233,list_constant_231);
    list_constant_236 = STATIC_LIST((SI_Long)2L,Qmodes,list_constant_234);
    list_constant_237 = STATIC_LIST((SI_Long)2L,list_constant_235,
	    list_constant_236);
    list_constant_238 = STATIC_LIST((SI_Long)2L,Qand,Qmodes);
    list_constant_68 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_237,list_constant_238);
    ...
    set_property_value_function(get_symbol_properties_function(Qconfigure_user_interface),
	    Qtype_specification_simple_expansion,list_constant_83);
    list_constant_239 = STATIC_LIST((SI_Long)2L,Qapplicable_user_modes,
	    list_constant_67);
    Qstatements = STATIC_SYMBOL("STATEMENTS",AB_package);
    list_constant_240 = STATIC_LIST((SI_Long)2L,Qstatements,list_constant_65);
    list_constant_241 = STATIC_LIST((SI_Long)2L,list_constant_239,
	    list_constant_240);
    list_constant_242 = STATIC_LIST((SI_Long)3L,Qand,
	    Qapplicable_user_modes,Qstatements);
    list_constant_243 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_241,list_constant_242);
    list_constant_70 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_243,list_constant_231);
    ...
    list_constant_244 = STATIC_LIST((SI_Long)4L,Qmember,Qallow,Qprohibit,
	    Qprohibit_absolutely);
    list_constant_248 = STATIC_LIST((SI_Long)2L,Qrestriction_type,
	    list_constant_244);
    Qaccess_types = STATIC_SYMBOL("ACCESS-TYPES",AB_package);
    list_constant_245 = STATIC_LIST((SI_Long)6L,Qmember,Qexecute,Qconnect,
	    Qinform,Qread,Qwrite);
    list_constant_246 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_245,list_constant_231);
    list_constant_249 = STATIC_LIST((SI_Long)2L,Qaccess_types,
	    list_constant_246);
    Qaccess_agent = STATIC_SYMBOL("ACCESS-AGENT",AB_package);
    Qtelewindows_and_gsi = STATIC_SYMBOL("TELEWINDOWS-AND-GSI",AB_package);
    list_constant_247 = STATIC_LIST((SI_Long)8L,Qmember,Qany,Qg2,Qgsi,
	    Qg2_and_gsi,Qg2_and_telewindows,Qg2_and_telewindows_and_gsi,
	    Qtelewindows_and_gsi);
    list_constant_250 = STATIC_LIST((SI_Long)2L,Qaccess_agent,
	    list_constant_247);
    list_constant_251 = STATIC_LIST_STAR((SI_Long)4L,list_constant_248,
	    list_constant_249,list_constant_250,list_constant_159);
    list_constant_252 = STATIC_LIST((SI_Long)4L,Qand,Qrestriction_type,
	    Qaccess_types,Qaccess_agent);
    list_constant_253 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_251,list_constant_252);
    list_constant_73 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_253,list_constant_231);
    ...
    list_constant_254 = STATIC_LIST((SI_Long)9L,
	    Qindependent_for_all_compilations,
	    ...
	    Qsubworkspace_connection_posts);
    SET_SYMBOL_VALUE(Qdeclared_properties_attributes,list_constant_254);
    ...
    list_constant_255 = STATIC_CONS(Qindependent_for_all_compilations,
	    list_constant_232);
    list_constant_256 = STATIC_CONS(Qstable_for_dependent_compilations,
	    list_constant_232);
    list_constant_257 = STATIC_CONS(Qstable_hierarchy,list_constant_232);
    list_constant_258 = STATIC_CONS(Qmanual_connections,list_constant_232);
    list_constant_259 = STATIC_CONS(Qoptimizable,list_constant_232);
    list_constant_260 = STATIC_CONS(Qinlineable,list_constant_232);
    list_constant_261 = STATIC_CONS(Qactivatable_subworkspace,
	    list_constant_232);
    list_constant_262 = STATIC_CONS(Qexternal_simulation,list_constant_232);
    list_constant_263 = STATIC_CONS(Qsubworkspace_connection_posts,
	    list_constant_232);
    list_constant_264 = STATIC_LIST((SI_Long)9L,list_constant_255,
	    list_constant_256,list_constant_257,list_constant_258,
	    list_constant_259,list_constant_260,list_constant_261,
	    list_constant_262,list_constant_263);
    list_constant_265 = STATIC_CONS(Qab_or,list_constant_254);
    list_constant_266 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_264,list_constant_265);
    list_constant_267 = STATIC_LIST((SI_Long)2L,Qdeclared_properties,
	    list_constant_266);
    list_constant_268 = STATIC_CONS(list_constant_267,list_constant_159);
    list_constant_269 = STATIC_LIST((SI_Long)2L,Qand,Qdeclared_properties);
    list_constant_75 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_268,list_constant_269);
    ...
    list_constant_270 = STATIC_CONS(Qtag_name,list_constant_169);
    Qassociated_text = STATIC_SYMBOL("ASSOCIATED-TEXT",AB_package);
    list_constant_271 = STATIC_LIST((SI_Long)2L,Qassociated_text,Qtext);
    list_constant_272 = STATIC_LIST((SI_Long)2L,list_constant_270,
	    list_constant_271);
    list_constant_273 = STATIC_LIST((SI_Long)2L,Qand,Qtag_name);
    list_constant_274 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_272,list_constant_273);
    list_constant_77 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_274,list_constant_231);
    ...
    set_property_value_function(get_symbol_properties_function(Qobject_configuration_spec),
	    Qtype_specification_simple_expansion,list_constant_146);
    list_constant_275 = STATIC_CONS(Qcomment,Qnil);
    list_constant_276 = STATIC_LIST_STAR((SI_Long)6L,Qmember,
	    Qconfigure_user_interface,Qrestrict_proprietary_items,
	    Qset_up_network_access,Qdeclare_properties,list_constant_275);
    list_constant_278 = STATIC_LIST((SI_Long)2L,Qtype,list_constant_276);
    Qclauses = STATIC_SYMBOL("CLAUSES",AB_package);
    list_constant_277 = STATIC_LIST((SI_Long)6L,Qab_or,list_constant_69,
	    list_constant_71,list_constant_72,list_constant_74,
	    list_constant_76);
    list_constant_279 = STATIC_LIST((SI_Long)2L,Qclauses,list_constant_277);
    list_constant_280 = STATIC_LIST((SI_Long)2L,list_constant_278,
	    list_constant_279);
    list_constant_281 = STATIC_LIST((SI_Long)3L,Qand,Qtype,Qclauses);
    list_constant_79 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_280,list_constant_281);
    ...
    set_slot_value_to_evaluation_value_function(Qobject_configuration_spec,
	    object_configuration_spec_evaluation_getter_1);
    list_constant_282 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_82,
	    list_constant_83);
    set_property_value_function(get_symbol_properties_function(Qobject_configuration),
	    Qtype_specification_simple_expansion,list_constant_282);
    list_constant_283 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_78,list_constant_231);
    ...
    set_property_value_function(get_symbol_properties_function(Qmain_menu_restrictions_statements),
	    Qtype_specification_simple_expansion,list_constant_83);
    list_constant_284 = STATIC_CONS(Qmember,list_constant_102);
    list_constant_285 = STATIC_LIST_STAR((SI_Long)3L,Qab_or,
	    list_constant_284,list_constant_169);
    list_constant_286 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_285,list_constant_231);
    list_constant_287 = STATIC_LIST((SI_Long)2L,Qmenu_choices,
	    list_constant_286);
    list_constant_289 = STATIC_LIST((SI_Long)2L,list_constant_150,
	    list_constant_287);
    list_constant_288 = STATIC_CONS(Qmenu_choices,Qnil);
    list_constant_290 = STATIC_LIST_STAR((SI_Long)3L,Qand,
	    Qrestriction_type,list_constant_288);
    list_constant_291 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_289,list_constant_290);
    list_constant_85 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_291,list_constant_231);
    ...
    set_property_value_function(get_symbol_properties_function(Qmain_menu_restrictions),
	    Qtype_specification_simple_expansion,list_constant_282);
    list_constant_292 = STATIC_LIST((SI_Long)2L,Qstatements,list_constant_84);
    list_constant_293 = STATIC_LIST((SI_Long)2L,list_constant_239,
	    list_constant_292);
    list_constant_294 = STATIC_CONS(list_constant_242,Qnil);
    list_constant_295 = STATIC_LIST_STAR((SI_Long)3L,Qab_structure,
	    list_constant_293,list_constant_294);
    list_constant_296 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_295,list_constant_231);
    ...
    list_constant_297 = STATIC_CONS(Qmember,list_constant_100);
    list_constant_298 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_297,list_constant_231);
    list_constant_299 = STATIC_LIST((SI_Long)2L,Qcommand_choices,
	    list_constant_298);
    list_constant_300 = STATIC_LIST((SI_Long)2L,list_constant_150,
	    list_constant_299);
    list_constant_301 = STATIC_LIST((SI_Long)3L,Qand,Qrestriction_type,
	    Qcommand_choices);
    list_constant_302 = STATIC_LIST((SI_Long)3L,Qab_structure,
	    list_constant_300,list_constant_301);
    list_constant_89 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_302,list_constant_231);
    ...
    set_property_value_function(get_symbol_properties_function(Qglobal_keyboard_command_restrictions),
	    Qtype_specification_simple_expansion,list_constant_282);
    list_constant_303 = STATIC_LIST((SI_Long)2L,Qstatements,list_constant_88);
    list_constant_304 = STATIC_LIST((SI_Long)2L,list_constant_239,
	    list_constant_303);
    list_constant_305 = STATIC_LIST_STAR((SI_Long)3L,Qab_structure,
	    list_constant_304,list_constant_294);
    list_constant_306 = STATIC_LIST_STAR((SI_Long)3L,Qsequence,
	    list_constant_305,list_constant_231);
    ...
    set_slot_value_to_evaluation_value_function(Qpsueudo_authorized_optional_modules,
	    psueudo_authorized_optional_modules_evaluation_getter_1);
    list_constant_307 = STATIC_CONS(list_constant_83,Qnil);
    list_constant_308 = STATIC_LIST_STAR((SI_Long)4L,Qab_or,
	    list_constant_82,Qsymbol,list_constant_307);
    set_property_value_function(get_symbol_properties_function(Qsimulated_products_qm),
	    Qtype_specification_simple_expansion,list_constant_308);
    list_constant_93 = STATIC_LIST_STAR((SI_Long)4L,Qab_or,
	    list_constant_82,Qsymbol,list_constant_173);
