...
Object Current_plot = UNBOUND;

Object Low_and_high_values_specified_for_vertical_axis_qm = UNBOUND;

Object Scale_y_data_points_qm = UNBOUND;

Object Current_graph_grid = UNBOUND;

Object Current_data_buffer_for_plot = UNBOUND;

Object Current_plot_number = UNBOUND;

Object Low_value_for_horizontal_axis = UNBOUND;

Object Many_more_data_points_than_pixels_qm = UNBOUND;

Object History_time_to_evaluate_display_expression_with = UNBOUND;

Object Ring_buffer_for_history_time = UNBOUND;

Object Current_cascaded_ring_buffer = UNBOUND;

Object Most_recent_extremum_maximum_for_pixel_p = UNBOUND;

Object Index_for_stop_time = UNBOUND;

Object Most_recent_extremum_maximum_p = UNBOUND;

Object X_data_min_set_qm = UNBOUND;

Object X_value_on_graph = UNBOUND;

Object Interval_between_plot_markers = UNBOUND;

Object Plot_marker_qm = UNBOUND;

Object Minimum_and_maximum_y_value_set_qm = UNBOUND;

Object Fixnum_minimum_y_value = UNBOUND;

Object Fixnum_maximum_y_value = UNBOUND;

Object Plot_min_and_max_qm = UNBOUND;

Object History_time_per_pixel = UNBOUND;

Object Last_history_time_for_data_point_on_pixel = UNBOUND;

Object Minimum_y_value_for_pixel = UNBOUND;

Object Maximum_y_value_for_pixel = UNBOUND;

Object Minimum_y_value = UNBOUND;

Object Maximum_y_value = UNBOUND;

Object Plot_min_qm = UNBOUND;

Object Plot_max_qm = UNBOUND;

Object Vertical_axis_range = UNBOUND;

Object Low_value_for_vertical_axis = UNBOUND;

Object Handy_float_1 = UNBOUND;
...
Object Default_duration_for_data_point = UNBOUND;
...
Object Redraw_as_well_as_reformat_p = UNBOUND;
    ...
    Object graph_grid;
{
    ...
    reclaim_gensym_list_1(ISVREF(graph_grid,(SI_Long)53L));
    ...
    Object graph_rendering, graph_grid_or_chart;
{
    ...
    Object gensymed_symbol_4, gensymed_symbol_5, temp_1, graph;
	...
	if (temp) {
	  ...
	  next_loop:
		...
		inline_note_reclaim_cons(gensymed_symbol_5,Qab_gensym);
		temp_1 = Available_gensym_conses;
		M_CDR(gensymed_symbol_5) = temp_1;
		Available_gensym_conses = gensymed_symbol_5;
		goto end_1;
	    }
	  ...
	  end_1:;
		...
		gensymed_symbol = ISVREF(graph_grid_or_chart,(SI_Long)14L);
    ...
    Object graph_grid;
{
    ...
    reclaim_gensym_list_1(ISVREF(graph_grid,(SI_Long)42L));
    ...
    Object line_drawing_description_for_graph_grid_qm, graph_grid;
{
    ...
    reclaim_gensym_tree_1(line_drawing_description_for_graph_grid_qm);
    ...
    Object plot, old_value;
{
	...
	PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
		0);
	  change_slot_value(3,plot,Qplot_color,gensym_list_2(ISVREF(plot,
		  (SI_Long)4L),old_value));
	POP_SPECIAL();
    }
    return VALUES_1(Nil);
}
...
Object Chain_of_available_plot_data_ring_buffers = UNBOUND;

Object Plot_data_ring_buffer_count = UNBOUND;
    ...
    Object plot_data_ring_buffer;
{
    ...
    svref_new_value = Chain_of_available_plot_data_ring_buffers;
    SVREF(plot_data_ring_buffer,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_plot_data_ring_buffers = plot_data_ring_buffer;
    return VALUES_1(Nil);
}
...
Object make_permanent_plot_data_ring_buffer_structure_internal()
{
    ...
    Object plot_data_ring_buffer_count_new_value;
    ...
    plot_data_ring_buffer_count_new_value = 
	    FIXNUM_ADD1(Plot_data_ring_buffer_count);
    Plot_data_ring_buffer_count = plot_data_ring_buffer_count_new_value;
    ...
    Object indices;
{
    ...
    return reclaim_gensym_list_1(indices);
}
...
Object Minimum_distance_for_data_points = UNBOUND;

Object Graph_background_color_value = UNBOUND;

Object Horizontal_grid_line_width = UNBOUND;

Object Vertical_grid_line_width = UNBOUND;

Object Vertical_grid_line_color_qm = UNBOUND;

Object Horizontal_grid_line_color_qm = UNBOUND;

Object Graph_grid_for_data = UNBOUND;

Object Grid_width = UNBOUND;

Object Grid_height = UNBOUND;

Object Default_graph_line_color_value = UNBOUND;

Object Joes_graph_hax_p = UNBOUND;

Object Joes_graph_hax_trace_p = UNBOUND;

Object Current_graph_grid_in_minimal_update = UNBOUND;
    ...
    Object graph_grid;
{
    ...
    Object gensymed_symbol_1, temp_1, new_cons, gensymed_symbol_2;
    char temp;
    Declare_special(1);
	...
	PUSH_SPECIAL(Redraw_as_well_as_reformat_p,redraw_as_well_as_reformat_p,
		0);
...
Object Bogus_preflight_from_printing_to_graphs = UNBOUND;
    ...
    Object workspace;
{
    ...
    PUSH_SPECIAL(Bogus_preflight_from_printing_to_graphs,bogus_preflight_from_printing_to_graphs_1,
	    0);
    ...
    Object graph_grid, repaint_raster_qm;
{
    ...
    PUSH_SPECIAL(Default_graph_line_color_value,default_graph_line_color_value,
	    9);
      temp = get_lookup_slot_value(graph,Qbackground_colors);
      ...
      PUSH_SPECIAL(Graph_background_color_value,graph_background_color_value,
	      8);
	temp = get_lookup_slot_value(graph,Qbackground_colors);
	...
	PUSH_SPECIAL(Horizontal_grid_line_width,horizontal_grid_line_width,7);
	  vertical_grid_line_width = ISVREF(graph_format,(SI_Long)29L);
	  PUSH_SPECIAL(Vertical_grid_line_width,vertical_grid_line_width,6);
	    gensymed_symbol = ISVREF(graph_grid,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    ...
	    PUSH_SPECIAL(Graph_grid_for_data,graph_grid_for_data,5);
	      ...
	      horizontal_grid_line_color_qm = ISVREF(graph_format,
		      (SI_Long)28L);
	      PUSH_SPECIAL(Horizontal_grid_line_color_qm,horizontal_grid_line_color_qm,
		      4);
		vertical_grid_line_color_qm = ISVREF(graph_format,
			(SI_Long)30L);
		PUSH_SPECIAL(Vertical_grid_line_color_qm,vertical_grid_line_color_qm,
			3);
		  grid_width = ISVREF(graph_grid,(SI_Long)34L);
		  PUSH_SPECIAL(Grid_width,grid_width,2);
		    grid_height = ISVREF(graph_grid,(SI_Long)35L);
		    PUSH_SPECIAL(Grid_height,grid_height,1);
		      current_graph_rendering = Nil;
		      PUSH_SPECIAL(Current_graph_rendering,current_graph_rendering,
			      0);
			...
			if (update_graph_description_qm && 
				...
				graph_grid) : TRUEP(T))) {
			    reclaim_gensym_tree_1(ISVREF(graph_grid,
				    (SI_Long)56L));
			    svref_new_value = 
				    gensym_cons_1(gensym_cons_1(Qgraph,
				    Nil),Nil);
    ...
    Object graph_grid, axis_label_text_box;
{
    ...
    PUSH_SPECIAL(Current_text_box_format,current_text_box_format,2);
      current_text_cell_plist = ISVREF(axis_label_text_box,(SI_Long)18L);
      PUSH_SPECIAL(Current_text_cell_plist,current_text_cell_plist,1);
	gensymed_symbol = ISVREF(graph_grid,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)5L) : Nil;
	graph = gensymed_symbol;
    ...
    Object graph_grid, graph_format;
{
	...
	gensymed_symbol = ISVREF(supertable,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)5L) : Nil;
	if (gensymed_symbol) {
	    gensymed_symbol = ISVREF(supertable,(SI_Long)14L);
    ...
    Object graph_grid;
{
    ...
    Object gensymed_symbol_1, new_cons, gensymed_symbol_2;
    ...
    Object graph_grid, graph, graph_rendering, grid_background_color_value;
{
    ...
    Object gensymed_symbol_1, new_cons, gensymed_symbol_2, extra_grid_lines_qm;
    ...
    Object low_value_for_vertical_axis;
{
    ...
    PUSH_SPECIAL(Low_value_for_vertical_axis,low_value_for_vertical_axis,1);
      PUSH_SPECIAL(Vertical_axis_range,vertical_axis_range,0);
...
Object Horizontal_grid_line_spacing = UNBOUND;
    ...
    Object graph_grid, graph, clipped_left_edge_qm, clipped_right_edge_qm;
{
	...
	PUSH_SPECIAL(Horizontal_grid_line_spacing,horizontal_grid_line_spacing,
		0);
    ...
    Object graph_grid, extra_grid_lines_qm, left_edge, right_edge;
{
	...
	PUSH_SPECIAL(Low_value_for_vertical_axis,low_value_for_vertical_axis,
		1);
	  PUSH_SPECIAL(Vertical_axis_range,vertical_axis_range,0);
	    if (CONSP(extra_grid_lines_qm) &&  
		    !(INLINE_DOUBLE_FLOAT_VECTOR_P(extra_grid_lines_qm) != 
...
Object Vertical_grid_line_spacing = UNBOUND;
    ...
    Object graph_grid;
{
	...
	PUSH_SPECIAL(Vertical_grid_line_spacing,vertical_grid_line_spacing,0);
    ...
    Object graph_grid, graph_format;
{
	...
	PUSH_SPECIAL(Minimum_distance_for_data_points,minimum_distance_for_data_points,
		0);
	  plot = Nil;
	  ab_loop_list_ = ISVREF(graph_grid,(SI_Long)33L);
...
Object Minimum_x_value_for_new_data = UNBOUND;

Object Minimum_y_value_for_new_data = UNBOUND;

Object Maximum_x_value_for_new_data = UNBOUND;

Object Maximum_y_value_for_new_data = UNBOUND;

Object New_dateline_qm = UNBOUND;

/* STORE-NEW-DATA-EXTREMA */
Object store_new_data_extrema(x,y)
    Object x, y;
{
    x_note_fn_call(173,86);
...
Object Current_minimal_grid_draw_has_seen_one_image_plane_p = UNBOUND;
    ...
    Object graph_grid;
{
    ...
    Object new_data_qm, new_dateline_in_workspace_units_p, svref_new_value;
    ...
    Object data_buffer_for_plot, ab_loop_iter_flag_, temp, temp_1, temp_2;
    Object temp_3, temp_4, temp_5, gensymed_symbol_3, new_cons;
    Object gensymed_symbol_4, redraw_as_well_as_reformat_p;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, left_edge_of_grid;
    ...
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    graph = gensymed_symbol;
    PUSH_SPECIAL(Current_graph_rendering,current_graph_rendering,14);
      if (Current_graph_rendering) {
	  graph_grid_for_data = graph_grid;
	  PUSH_SPECIAL(Graph_grid_for_data,graph_grid_for_data,13);
	    graph_format = ISVREF(graph,(SI_Long)22L);
	    default_graph_line_color_value = 
		    compute_graph_line_color_value(graph_grid,graph_format);
	    PUSH_SPECIAL(Default_graph_line_color_value,default_graph_line_color_value,
	      ...
	      top_edge_of_grid = gensymed_symbol_1 + gensymed_symbol_2;
	      horizontal_grid_line_width = ISVREF(graph_format,(SI_Long)27L);
	      PUSH_SPECIAL(Horizontal_grid_line_width,horizontal_grid_line_width,
		      11);
		vertical_grid_line_width = ISVREF(graph_format,(SI_Long)27L);
		PUSH_SPECIAL(Vertical_grid_line_width,vertical_grid_line_width,
			10);
		  horizontal_grid_line_color_qm = ISVREF(graph_format,
			  (SI_Long)28L);
		  PUSH_SPECIAL(Horizontal_grid_line_color_qm,horizontal_grid_line_color_qm,
		    ...
		    PUSH_SPECIAL(Vertical_grid_line_color_qm,vertical_grid_line_color_qm,
		      ...
		      PUSH_SPECIAL(Minimum_x_value_for_new_data,minimum_x_value_for_new_data,
			      7);
			minimum_y_value_for_new_data = Nil;
			PUSH_SPECIAL(Minimum_y_value_for_new_data,minimum_y_value_for_new_data,
				6);
			  maximum_x_value_for_new_data = Nil;
			  PUSH_SPECIAL(Maximum_x_value_for_new_data,maximum_x_value_for_new_data,
				  5);
			    maximum_y_value_for_new_data = Nil;
			    PUSH_SPECIAL(Maximum_y_value_for_new_data,maximum_y_value_for_new_data,
				    4);
			      new_dateline_qm = Nil;
			      PUSH_SPECIAL(New_dateline_qm,new_dateline_qm,3);
				...
				PUSH_SPECIAL(Minimum_distance_for_data_points,minimum_distance_for_data_points,
					2);
				  grid_width = ISVREF(graph_grid,(SI_Long)34L);
				  PUSH_SPECIAL(Grid_width,grid_width,1);
				    grid_height = ISVREF(graph_grid,
					    (SI_Long)35L);
				    PUSH_SPECIAL(Grid_height,grid_height,0);
				      grid_border_width = 
					...
					end_loop:
					  ...
					  gensymed_symbol_2 = 
						  IFIX(grid_border_width);
					  draw_current_graph_rendering(temp,
						  temp_1,temp_2,
    ...
    Object extrema_rectangles_qm, min_x, min_y, max_x, max_y;
{
  ...
  next_loop:
	...
	rectangles_to_combine = gensym_cons_1(previous_rest_of_rectangles,
  ...
  end_loop:
	...
	if (rectangle_pointer) {
	    ...
	    reclaim_gensym_list_1(rectangle_to_reclaim_head);
	}
	else {
	    ...
	    reclaim_gensym_list_1(extrema_rectangles_head);
	}
	goto next_loop_1;
      end_loop_1:;
	reclaim_gensym_list_1(rectangles_to_combine);
	return gensym_cons_1(combined_min_x,gensym_cons_1(combined_min_y,
		gensym_cons_1(combined_max_x,gensym_cons_1(combined_max_y,
		extrema_rectangles_qm))));
    }
    else
	return gensym_cons_1(min_x,gensym_cons_1(min_y,gensym_cons_1(max_x,
		gensym_cons_1(max_y,extrema_rectangles_qm))));
    return VALUES_1(Qnil);
}
...
{
    Object plot_marker_class, gensymed_symbol, gensymed_symbol_1;
    ...
    x_note_fn_call(173,95);
    PUSH_SPECIAL(Plot_marker_qm,plot_marker_qm,0);
      if (CONSP(Plot_marker_qm)) {
	  plot_marker_class = CDR(Plot_marker_qm);
	  gensymed_symbol = CDR(Symbol_properties_table);
	  gensymed_symbol_1 = plot_marker_class;
	  gensymed_symbol_2 = SXHASH_SYMBOL_1(plot_marker_class) & 
...
{
    x_note_fn_call(173,98);
    return add_form_to_graph_line_drawing_description(gensym_list_3(Qsolid_rectangle,
	    gensym_list_2(left_edge_of_rectangle_in_raster,
	    top_edge_of_rectangle_in_raster),
	    gensym_list_2(right_edge_of_rectangle_in_raster,
	    bottom_edge_of_rectangle_in_raster)));
}
...
Object add_graph_clear_rectangle(left_edge_of_rectangle_in_raster,
    ...
    Object bottom_edge_of_rectangle_in_raster;
{
    x_note_fn_call(173,99);
    return add_form_to_graph_line_drawing_description(gensym_list_3(Qclear_solid_rectangle,
	    gensym_list_2(left_edge_of_rectangle_in_raster,
	    top_edge_of_rectangle_in_raster),
	    gensym_list_2(right_edge_of_rectangle_in_raster,
	    bottom_edge_of_rectangle_in_raster)));
...
{
    x_note_fn_call(173,100);
    return add_form_to_graph_line_drawing_description(gensym_list_2(Qgraph_dateline,
	    gensym_list_2(dateline_in_raster,erase_dateline_in_raster)));
}
...
{
    x_note_fn_call(173,101);
    return add_form_to_graph_line_drawing_description(gensym_list_2(Qdata_extrema,
	    extrema_rectangles));
}
    ...
    Object start_new_line_qm, x1, y1_1, x2, y2;
{
	...
	temp_1 = gensym_cons_1(gensym_list_2(x2,y2),Nil);
	M_CDR(temp) = temp_1;
	temp = Graph_grid_for_data;
	...
	temp_1 = gensym_cons_1(gensym_list_3(Qlines,gensym_list_2(x1,y1_1),
		gensym_list_2(x2,y2)),Nil);
	M_CDR(temp) = temp_1;
	temp = Graph_grid_for_data;
...
{
    x_note_fn_call(173,103);
    return add_form_to_graph_line_drawing_description(gensym_cons_1(Qclear_graph,
	    Nil));
}
...
Object add_graph_color_to_use(color)
    Object color;
{
    x_note_fn_call(173,104);
    return add_form_to_graph_line_drawing_description(gensym_list_2(Qgraph_color_to_use,
	    color));
}
...
Object add_graph_shading(shading_qm)
    Object shading_qm;
{
    x_note_fn_call(173,105);
    return add_form_to_graph_line_drawing_description(gensym_list_2(Qgraph_shading_qm,
	    shading_qm));
}
...
{
    x_note_fn_call(173,106);
    return add_form_to_graph_line_drawing_description(gensym_list_2(Qgraph_line_width_to_use,
	    line_width_qm));
}
...
{
    x_note_fn_call(173,107);
    return add_form_to_graph_line_drawing_description(gensym_list_4(Qgraph_marker,
    ...
    Object form;
{
    ...
    x_note_fn_call(173,108);
    temp = ISVREF(Graph_grid_for_data,(SI_Long)57L);
    temp_1 = gensym_cons_1(form,Nil);
    M_CDR(temp) = temp_1;
    temp = Graph_grid_for_data;
    temp_2 = ISVREF(Graph_grid_for_data,(SI_Long)57L);
    temp_1 = CDR(temp_2);
		  ...
		  PUSH_SPECIAL(Current_scratchpad_raster_tiled_p,current_scratchpad_raster_tiled_p,
			...
			PUSH_SPECIAL(Current_scratchpad_raster_depth,current_scratchpad_raster_depth,
			  ...
			  PUSH_SPECIAL(On_monochrome_raster_list_p,on_monochrome_raster_list_p,
				...
				PUSH_SPECIAL(Current_scratchpad_raster,current_scratchpad_raster,
					0);
				  result = paint_graph_from_graph_rendering(Current_graph_rendering,
					  Nil,T);
				POP_SPECIAL();
			      POP_SPECIAL();
			    POP_SPECIAL();
...
void graphs1_INIT()
{
    ...
    Object Qgraphs1, Qnew_dateline_qm, Qmaximum_y_value_for_new_data;
    Object Qmaximum_x_value_for_new_data, Qminimum_y_value_for_new_data;
    Object Qminimum_x_value_for_new_data, Qvertical_grid_line_spacing;
    Object Qhorizontal_grid_line_spacing, G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qdraw, Qdraw_for_graph_grid, Qdraw_for_graph, Qslot_value_reclaimer;
    ...
    Object Qplot_data_ring_buffer_count;
    Object Qchain_of_available_plot_data_ring_buffers, string_constant_94;
    ...
    Object Qreclaim_vertical_axis_range_value, Qvertical_axis_range;
    ...
    Object Qlow_value_for_vertical_axis;
    ...
    Object Qdefault_duration_for_data_point, Qinitialize_to_managed_float_box;
    Object list_constant, Qgraphs2, Qhandy_float_1, Qplot_max_qm, Qplot_min_qm;
    Object Qmaximum_y_value, Qminimum_y_value, Qmaximum_y_value_for_pixel;
    Object Qminimum_y_value_for_pixel, Qdata_point_value;
    Object Qlast_history_time_for_data_point_on_pixel, Qhistory_time_per_pixel;
    Object Kfuncall;

    x_note_fn_call(173,126);
    SET_PACKAGE("AB");
    ...
    Qtable_format_for_graphs = STATIC_SYMBOL("TABLE-FORMAT-FOR-GRAPHS",
	    AB_package);
    string_constant = STATIC_STRING("1v83*oy8308yl830Ayl8309yl8307yl83=Dyk");
    ...
    string_constant_2 = 
	    STATIC_STRING("13Ry4z8r83Qry83Qry833Ny833Ny083fy001n1l8o1l8l1l83Cy000004z8r83Qky83Qky833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83Vdy83Vdy833Ny833N");
    string_constant_3 = 
	    STATIC_STRING("y03-Cy001n1l8o1l8l1l83Cy000004z8r83Vey83Vey833Ny833Ny03Gy001n1l8o1l8l1l83Cy000004z8r83Qsy83Qsy833Ny833Ny00001n1l8o1l8l1l83Cy0000");
    string_constant_4 = 
	    STATIC_STRING("04z8r83Qpy83Qpy833Ny833Ny0l001n1l8o1l8l1l83Cy000004z8r83Qoy83Qoy833Ny833Ny083fy001n1l8o1l8l1l83Cy000004z8r83R-y83R-y833Ny833Ny0l");
    string_constant_5 = 
	    STATIC_STRING("001n1l8o1l8l1l83Cy000004z8r83R+y83R+y833Ny833Ny083fy001n1l8o1l8l1l83Cy000004z8r83Vfy83Vfy833Ny833Ny030ey001n1l8o1l8l1l83Cy000004");
    string_constant_6 = 
	    STATIC_STRING("z8r83Vcy83Vcy833Ny833Ny03=4y001n1l8o1l8l1l83Cy000004z8r83Wky83Wky833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83X=y83X=y833Ny833Ny0000");
    string_constant_7 = 
	    STATIC_STRING("1n1l8o1l8l1l83Cy000004z8r83Rby83Rby833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83e2y83e2y833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83Viy");
    string_constant_8 = 
	    STATIC_STRING("83Viy833Ny833Ny09k001n1l8o1l8l1l83Cy000004z8r83Vky83Vky833Ny833Ny0o001n1l8o1l8l1l83Cy000004z8r83Vjy83Vjy833Ny833Ny09l001n1l8o1l8");
    string_constant_9 = 
	    STATIC_STRING("l1l83Cy000004z8r83Vmy83Vmy833Ny833Ny0n001n1l8o1l8l1l83Cy000004z8r83J5y83J5y833Ny833Ny0u001n1l8o1l8l1l83Cy000004z8r83Vby83Vby833N");
    string_constant_10 = 
	    STATIC_STRING("y833Ny0u001n1l8o1l8l1l83Cy000004z8r83dgy83dgy833Ny833Ny08k001n1l8o1l8l1l83Cy000004z8r83TSy83TSy833Ny833Ny00001n1l8o1l8l1l83Cy000");
    string_constant_11 = 
	    STATIC_STRING("004z8r83TTy83TTy833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83TRy83TRy833Ny833Ny00001n1l8o1l8l1l83Cy000004z8r83TUy83TUy833Ny833Ny0000");
    string_constant_12 = 
	    STATIC_STRING("1n1l8o1l8l1l83Cy000004z8r83LAy83LAy833Ny833Ny0k001n1l8o1l8l1l83Cy000004z8r83L8y83L8y833Ny833Ny09m001n1l8o1l8l1l83Cy000004z8r83LB");
    string_constant_13 = 
	    STATIC_STRING("y83LBy833Ny833Ny09n001n1l8o1l8l1l83Cy000004z8r83L9y83L9y833Ny833Ny09o001n1l8o1l8l1l83Cy000004z8r83Ymy83Ymy833Ny833Ny08k001n1l8o1");
    string_constant_14 = STATIC_STRING("l8l1l83Cy00000");
    float_constant_4 = STATIC_FLOAT(0.001);
    float_constant_5 = STATIC_FLOAT(0.4);
    string_constant_15 = 
	    STATIC_STRING("13Ty8q1m833Ny1l831Fy1p83Qry83fy8o8l83Cy1p83Qky08o8l83Cy1p83Vdy3-Cy8o8l83Cy1p83Vey3Gy8o8l83Cy1p83Qsy08o8l83Cy1p83Qpyl8o8l83Cy1p83");
    string_constant_16 = 
	    STATIC_STRING("Qoy83fy8o8l83Cy1p83R-yl8o8l83Cy1p83R+y83fy8o8l83Cy1p83Vfy30ey8o8l83Cy1p83Vcy3=4y8o8l83Cy1p83Wky08o8l83Cy1p83X=y08o8l83Cy1p83Rby0");
    string_constant_17 = 
	    STATIC_STRING("8o8l83Cy1p83e2y08o8l83Cy1p83Viy9k8o8l83Cy1p83Vkyo8o8l83Cy1p83Vjy9l8o8l83Cy1p83Vmyn8o8l83Cy1p83J5yu8o8l83Cy1p83Vbyu8o8l83Cy1p83dg");
    string_constant_18 = 
	    STATIC_STRING("y8k8o8l83Cy1p83TSy08o8l83Cy1p83TTy08o8l83Cy1p83TRy08o8l83Cy1p83TUy08o8l83Cy1p83LAyk8o8l83Cy1p83L8y9m8o8l83Cy1p83LBy9m8o8l83Cy1p8");
    string_constant_19 = STATIC_STRING("3L9y9m8o8l83Cy1p83Ymy8k8o8l83Cy");
    ...
    string_constant_21 = 
	    STATIC_STRING("1n4z8r83Xry83Xry834Oy834Oy083fy001m1l8o1l8l000004z8r83Xsy83Xsy834Oy834Oy00001m1l8o1l8l000004z8r83dhy83dhy834Oy834Oy00001m1l8o1l8");
    string_constant_22 = STATIC_STRING("l00000");
    string_constant_23 = 
	    STATIC_STRING("1p8q1m834Oy1l831Fy1o83Xry83fy8o8l1o83Xsy08o8l1o83dhy08o8l");
    temp = regenerate_optimized_constant(string_constant_1);
    ...
    string_constant_43 = 
	    STATIC_STRING("1l83-5y000004z8r835cy835cy833My833My00001o1n8p83-ey83Gy1l83-4y1l83Ey1l8l000004z8r830wy830wy833My833My00001o1l83-4y1l83Ey1l83Cy1l");
    string_constant_44 = 
    ...
    string_constant_45 = 
	    STATIC_STRING("830Hy830Hy833My833My0m001p1m8p83=Qy1l83-4y1l83Ey1l8l1l8z000004z8r830Gy830Gy833My833My0m001p1m8p83-Zy1l83-4y1l83Ey1l8l1l8z000004z");
    string_constant_46 = 
    ...
    string_constant_47 = 
	    STATIC_STRING("833My833My00001n1l83-4y1l83Ey1l8l000004z8r83Qty83Qty833My833My00001m1l83Ey1l8l00000");
    string_constant_48 = 
    ...
    string_constant_59 = 
	    STATIC_STRING("3C=y01m8p838Jy8o8l8z1q83Awy2l83*2y83*2y1m8p838xy83Ey8l8z1r83=gy01n8p83DSy83Gy83-4y83Ey8l83-5y1q835cy01n8p83-ey83Gy83-4y83Ey8l1q8");
    string_constant_60 = 
	    STATIC_STRING("30wy083-4y83Ey83Cy8l1p830cy083-4y83Ey8l1r8300yp1m8p83=Qy83-4y83Ey8l8z1r830Hym1m8p83=Qy83-4y83Ey8l8z1r830Gym1m8p83-Zy83-4y83Ey8l8");
    string_constant_61 = 
	    STATIC_STRING("z1r83=Py01m8p83Ky83-4y83Ey8l8z1p830xy083-4y83Ey8l1p830sy083-4y83Ey8l1o83Qty083Ey8l");
    ...
    string_constant_63 = 
	    STATIC_STRING("13hy4z8r83Jey83Jey83Qny83Qny00001m1l8o1l8l000004z8r83Jay83Jay83Qny83Qny00001m1l8o1l8l000004z8r83Jgy83Jgy83Qny83Qny00001m1l8o1l8l");
    string_constant_64 = 
	    STATIC_STRING("000004z8r83Jcy83Jcy83Qny83Qny00001m1l8o1l8l000004z8r83Sly83Sly83Qny83Qny00001m1l8o1l8l000004z8r83Ucy83Ucy83Qny83Qny00001m1l8o1l8");
    string_constant_65 = 
	    STATIC_STRING("l000004z8r83RRy83RRy83Qny83Qny00001m1l8o1l8l000004z8r83Wjy83Wjy83Qny83Qny00001m1l8o1l8l000004z8r83Ray83Ray83Qny83Qny00001m1l8o1l");
    string_constant_66 = 
	    STATIC_STRING("8l000004z8r83aky83aky83Qny83Qny00001m1l8o1l8l000004z8r83Sny83Sny83Qny83Qny00001m1l8o1l8l000004z8r83Uey83Uey83Qny83Qny00001m1l8o1");
    string_constant_67 = 
	    STATIC_STRING("l8l000004z8r83RUy83RUy83Qny83Qny00001m1l8o1l8l000004z8r83X*y83X*y83Qny83Qny00001m1l8o1l8l000004z8r83e1y83e1y83Qny83Qny00001m1l8o");
    string_constant_68 = 
	    STATIC_STRING("1l8l000004z8r83aiy83aiy83Qny83Qny00001m1l8o1l8l000004z8r83Tdy83Tdy83Qny83Qny00001m1l8o1l8l000004z8r83U7y83U7y83Qny83Qny00001n1l8");
    string_constant_69 = 
	    STATIC_STRING("o1l8l1l83Cy000004z8r83R1y83R1y83Qny83Qny00001m1l8o1l8l000004z8r83R0y83R0y83Qny83Qny00001m1l8o1l8l000004z8r83RZy83RZy83Qny83Qny00");
    string_constant_70 = 
	    STATIC_STRING("001m1l8o1l8l000004z8r83e0y83e0y83Qny83Qny00001m1l8o1l8l000004z8r83Qqy83Qqy83Qny83Qny00001m1l8o1l8l000004z8r83Qwy83Qwy83Qny83Qny0");
    string_constant_71 = 
	    STATIC_STRING("0001m1l8o1l8l000004z8r83Qxy83Qxy83Qny83Qny00001m1l8o1l8l000004z8r83Qly83Qly83Qny83Qny00001m1l8o1l8l000004z8r83Quy83Quy83Qny83Qny");
    string_constant_72 = 
	    STATIC_STRING("00001m1l8o1l8l000004z8r83Zwy83Zwy83Qny83Qny00001m1l8o1l8l000004z8r83Uay83Uay83Qny83Qny00001m1l8o1l8l000004z8r83Uby83Uby83Qny83Qn");
    string_constant_73 = 
	    STATIC_STRING("y00001m1l8o1l8l000004z8r83RQy83RQy83Qny83Qny00001m1l8o1l8l000004z8r83Udy83Udy83Qny83Qny00001m1l8o1l8l000004z8r83RTy83RTy83Qny83Q");
    string_constant_74 = 
	    STATIC_STRING("ny00001m1l8o1l8l000004z8r83J8y83J8y83Qny83Qny0k001m1l8o1l8l000004z8r83XBy83XBy83Qny83Qny0k001m1l8o1l8l000004z8r83WVy83WVy83Qny83");
    string_constant_75 = 
	    STATIC_STRING("Qny00001m1l8o1l8l000004z8r83Qmy83Qmy83Qny83Qny00001m1l8o1l8l000004z8r83J1y83J1y83Qny83Qny00001m1l8o1l8l000004z8r83Smy83Smy83Qny8");
    string_constant_76 = 
	    STATIC_STRING("3Qny00001m1l8o1l8l000004z8r83RYy83RYy83Qny83Qny00001m1l8o1l8l000004z8r83U*y83U*y83Qny83Qny00001m1l8o1l8l000004z8r83bQy83bQy83Qny");
    string_constant_77 = 
	    STATIC_STRING("83Qny00001m1l8o1l8l000004z8r83bRy83bRy83Qny83Qny00001m1l8o1l8l000004z8r83R=y83R=y83Qny83Qny00001m1l8o1l8l000004z8r83RXy83RXy83Qn");
    string_constant_78 = 
	    STATIC_STRING("y83Qny00001m1l8o1l8l000004z8r83KBy83KBy83Qny83Qny00001m1l8o1l8l000004z8r83XCy83XCy83Qny83Qny0k001m1l8o1l8l00000");
    string_constant_79 = 
	    STATIC_STRING("13jy8q1n83Qny1l9k8t1o83Jey08o8l1o83Jay08o8l1o83Jgy08o8l1o83Jcy08o8l1o83Sly08o8l1o83Ucy08o8l1o83RRy08o8l1o83Wjy08o8l1o83Ray08o8l1");
    string_constant_80 = 
	    STATIC_STRING("o83aky08o8l1o83Sny08o8l1o83Uey08o8l1o83RUy08o8l1o83X*y08o8l1o83e1y08o8l1o83aiy08o8l1o83Tdy08o8l1p83U7y08o8l83Cy1o83R1y08o8l1o83R");
    string_constant_81 = 
	    STATIC_STRING("0y08o8l1o83RZy08o8l1o83e0y08o8l1o83Qqy08o8l1o83Qwy08o8l1o83Qxy08o8l1o83Qly08o8l1o83Quy08o8l1o83Zwy08o8l1o83Uay08o8l1o83Uby08o8l1");
    string_constant_82 = 
	    STATIC_STRING("o83RQy08o8l1o83Udy08o8l1o83RTy08o8l1o83J8yk8o8l1o83XByk8o8l1o83WVy08o8l1o83Qmy08o8l1o83J1y08o8l1o83Smy08o8l1o83RYy08o8l1o83U*y08");
    string_constant_83 = 
	    STATIC_STRING("o8l1o83bQy08o8l1o83bRy08o8l1o83R=y08o8l1o83RXy08o8l1o83KBy08o8l1o83XCyk8o8l");
    ...
    string_constant_84 = 
	    STATIC_STRING("1t4z8r834Oy834Oy833Wy833Wy00001n1l8o1l8l1l83Cy000004z8r83K2y83K2y833Wy833Wy00001n1l8o1l8l1l83Cy000004z8r839gy839gy833Wy833Wy0000");
    string_constant_85 = 
	    STATIC_STRING("1n1l8o1l8l1l83Cy000004z8r83J3y83J3y833Wy833Wy00001m1l8o1l8l000004z8r83ejy83ejy833Wy833Wy00001m1l8o1l8l000004z8r83eiy83eiy833Wy83");
    string_constant_86 = 
	    STATIC_STRING("3Wy00001m1l8o1l8l000004z8r83W5y83W5y833Wy833Wy00001m1l8o1l8l000004z8r83XIy83XIy833Wy833Wy00001m1l8o1l8l000004z8r83WRy83WRy833Wy8");
    string_constant_87 = STATIC_STRING("33Wy00001m1l8o1l8l00000");
    string_constant_88 = 
	    STATIC_STRING("1v8q1n833Wy1l83=fy8t1p834Oy08o8l83Cy1p83K2y08o8l83Cy1p839gy08o8l83Cy1o83J3y08o8l1o83ejy08o8l1o83eiy08o8l1o83W5y08o8l1o83XIy08o8l");
    string_constant_89 = STATIC_STRING("1o83WRy08o8l");
    temp = regenerate_optimized_constant(string_constant_62);
    ...
    string_constant_90 = 
	    STATIC_STRING("1n4z8r83xy83xy83Qiy83Qiy083Qjy001n1l8l1l83Ey1m83Dy53CyExport, writable000004z8r83Tcy83Tcy83Qiy83Qiy00001m1l83Ey1l8l000004z8r83Rc");
    string_constant_91 = 
	    STATIC_STRING("y83Rcy83Qiy83Qiy00001m1l83Ey1l8l00000");
    string_constant_92 = 
	    STATIC_STRING("1p8q1m83Qiy1l83-ly1m83xy83Qjy1o83Tcy083Ey8l1o83Rcy083Ey8l");
    temp = regenerate_optimized_constant(string_constant_1);
    ...
    string_constant_93 = 
	    STATIC_STRING("43Dy8m83lcy1o83lcy834Yy8n8k1l834Yy0000001m1m8x834Yy1m8y83-59ykxk0k0");
    ...
    Qplot_data_ring_buffer_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_94 = STATIC_STRING("1q83lcy8s83-hry09k9l");
    clear_optimized_constants();
    ...
    Qgraph_horizontal_axis_heading_text_cell_format = 
	    ...
	    AB_package);
    string_constant_96 = 
	    STATIC_STRING("1v83-Qy83kyk83wy83-dy83aym83cym83iy30ey");
