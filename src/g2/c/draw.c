...
Object funcall_for_workstation_of_image_plane varargs_1(int, n)
{
    ...
    current_workstation_1 = ISVREF(ISVREF(ISVREF(image_plane,(SI_Long)2L),
		  ...
		  PUSH_SPECIAL(Specific_structure_for_current_workstation_context,specific_structure_for_current_workstation_context,
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				...
				result = FUNCALL_1(function,arg1);
			    else if (EQ(arg3,No_arg))
				result = FUNCALL_2(function,arg1,arg2);
			    else
				result = FUNCALL_3(function,arg1,arg2,arg3);
			  POP_SPECIAL();
			POP_SPECIAL();
		      POP_SPECIAL();
		    POP_SPECIAL();
...
Object Extreme_left_edge_so_far = UNBOUND;

Object Extreme_top_edge_so_far = UNBOUND;

Object Extreme_right_edge_so_far = UNBOUND;

Object Extreme_bottom_edge_so_far = UNBOUND;

Object Do_not_update_selection_highlights = UNBOUND;
    ...
    Object block, do_only_loose_ends_p;
{
	...
	temp = subblocks ?  !EQ(ISVREF(subblocks,(SI_Long)0L),subblocks) : 
		TRUEP(Qnil);
	if (temp);
	else {
	    gensymed_symbol = ISVREF(subblock,(SI_Long)14L);
	...
	PUSH_SPECIAL(Extreme_right_edge_so_far,extreme_right_edge_so_far,1);
	  ...
	  PUSH_SPECIAL(Extreme_bottom_edge_so_far,extreme_bottom_edge_so_far,
		...
		gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
			(SI_Long)4L) : Nil;
		subblocks = gensymed_symbol;
		temp = subblocks ?  !EQ(ISVREF(subblocks,(SI_Long)0L),
			subblocks) : TRUEP(Qnil);
		if (temp);
		else {
		    gensymed_symbol = ISVREF(block,(SI_Long)14L);
    ...
    Object list_1;
{
  ...
  next_loop:
	...
	if (output_connections) {
	    ...
	    reclaim_gensym_list_1(output_connections);
	    goto end_1;
	}
    }
    else {
    ...
    Object constant_queue, cursor;
{
    ...
    queue_element = cursor ? ISVREF(cursor,(SI_Long)0L) : head;
    block = Nil;
  next_loop:
    if (EQ(queue_element,constant_queue))
	goto end_loop;
    block = ISVREF(queue_element,(SI_Long)2L);
    if (loose_end_p_function(block)) {
	output_connections = output_connections_of_block(block);
	if (output_connections) {
	    temp = 
    ...
    Object block, superblock;
{
    ...
    Object gensymed_symbol_2, slot_group_qm, subblocks, block_1;
    Object sub_class_bit_vector, def_structure_queue_element_variable;
    ...
    if (slot_group_qm)
	SVREF(slot_group_qm,FIX((SI_Long)5L)) = gensymed_symbol_2;
	...
	SVREF(temp,FIX((SI_Long)5L)) = gensymed_symbol_2;
    }
    temp_1 = (SI_Long)0L != (IFIX(ISVREF(block,(SI_Long)4L)) & (SI_Long)1024L);
    if (temp_1);
    else {
	gensymed_symbol_1 = ISVREF(superblock,(SI_Long)14L);
	gensymed_symbol_1 = gensymed_symbol_1 ? ISVREF(gensymed_symbol_1,
		(SI_Long)4L) : Nil;
	subblocks = gensymed_symbol_1;
	temp_1 =  !TRUEP(subblocks);
	if (temp_1);
	else
	    temp_1 = EQ(ISVREF(subblocks,(SI_Long)0L),subblocks);
    }
    if (temp_1);
    else {
	...
	if (temp_1) {
		...
		next_item = 
			find_next_non_loose_end_in_queue(gensymed_symbol_1,
			Nil);
	    }
	}
	gensymed_symbol_1 = ISVREF(superblock,(SI_Long)14L);
	...
	if ( !TRUEP(gensymed_symbol_1)) {
	    ...
	    gensymed_symbol = make_empty_constant_queue();
	    if (slot_group_qm)
		SVREF(slot_group_qm,FIX((SI_Long)4L)) = gensymed_symbol;
	    else if ( !EQ(gensymed_symbol,Qnil)) {
		if (Noting_changes_to_kb_p)
		    note_change_to_block_1(gensymed_symbol_1,
			    Qslot_group_for_block_qm);
		temp = make_icon_slot_group_1();
		SVREF(gensymed_symbol_1,FIX((SI_Long)14L)) = temp;
		temp = ISVREF(gensymed_symbol_1,(SI_Long)14L);
		SVREF(temp,FIX((SI_Long)4L)) = gensymed_symbol;
	    }
	}
	gensymed_symbol_2 = ISVREF(superblock,(SI_Long)14L);
	gensymed_symbol_2 = gensymed_symbol_2 ? ISVREF(gensymed_symbol_2,
		(SI_Long)4L) : Nil;
	gensymed_symbol_1 = ISVREF(gensymed_symbol_2,(SI_Long)0L);
	...
	gensymed_symbol = def_structure_queue_element_variable;
	SVREF(gensymed_symbol_2,FIX((SI_Long)0L)) = gensymed_symbol;
	SVREF(gensymed_symbol_1,FIX((SI_Long)1L)) = gensymed_symbol;
	if (G2_has_v5_mode_windows_p && workspace_qm) {
	    sub_class_bit_vector = ISVREF(ISVREF(workspace_qm,(SI_Long)1L),
		    (SI_Long)19L);
	    superior_class_bit_number = 
	...
	gensymed_symbol_1 = gensymed_symbol_1 ? ISVREF(gensymed_symbol_1,
		(SI_Long)4L) : Nil;
	constant_queue = gensymed_symbol_1;
	head = ISVREF(constant_queue,(SI_Long)0L);
	queue_element = head;
	...
	subblock =  !EQ(next_queue_element,constant_queue) ? 
		ISVREF(next_queue_element,(SI_Long)2L) : Nil;
	if (EQ(next_queue_element,constant_queue)) {
	    if (EQ(queue_element,constant_queue)) {
		gensymed_symbol_1 = ISVREF(constant_queue,(SI_Long)0L);
		def_structure_queue_element_variable = 
			Chain_of_available_queue_elements;
		if (def_structure_queue_element_variable)
		    Chain_of_available_queue_elements = 
		...
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)0L)) = gensymed_symbol_1;
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)1L)) = constant_queue;
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)2L)) = block;
		gensymed_symbol = def_structure_queue_element_variable;
		SVREF(constant_queue,FIX((SI_Long)0L)) = gensymed_symbol;
		SVREF(gensymed_symbol_1,FIX((SI_Long)1L)) = gensymed_symbol;
	    }
	    else {
		gensymed_symbol_1 = ISVREF(queue_element,(SI_Long)0L);
		def_structure_queue_element_variable = 
			Chain_of_available_queue_elements;
		if (def_structure_queue_element_variable)
		    Chain_of_available_queue_elements = 
		...
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)0L)) = gensymed_symbol_1;
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)1L)) = queue_element;
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)2L)) = block;
		gensymed_symbol = def_structure_queue_element_variable;
		SVREF(queue_element,FIX((SI_Long)0L)) = gensymed_symbol;
		if (EQ(gensymed_symbol_1,constant_queue))
		    SVREF(constant_queue,FIX((SI_Long)1L)) = gensymed_symbol;
		else
		    SVREF(gensymed_symbol_1,FIX((SI_Long)1L)) = 
			    gensymed_symbol;
	    }
	    if (G2_has_v5_mode_windows_p && workspace_qm) {
	...
	if (temp_1);
	    ...
	    gensymed_symbol_1 = gensymed_symbol_1 ? 
		    ISVREF(gensymed_symbol_1,(SI_Long)4L) : Nil;
	    subblocks = gensymed_symbol_1;
	    temp_1 = subblocks ?  !EQ(ISVREF(subblocks,(SI_Long)0L),
		    subblocks) : TRUEP(Qnil);
	}
	if (temp_1);
	else {
	    gensymed_symbol_1 = ISVREF(block,(SI_Long)14L);
	    gensymed_symbol_1 = gensymed_symbol_1 ? 
		    ISVREF(gensymed_symbol_1,(SI_Long)6L) : Nil;
	    temp_1 = TRUEP(gensymed_symbol_1);
	}
	if (temp_1)
    ...
    Object block1, block2, superblock;
{
    ...
    gensymed_symbol = ISVREF(superblock,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
  ...
  next_loop:
    if (EQ(queue_element,constant_queue))
	goto end_loop;
    if (EQ(block2,ISVREF(queue_element,(SI_Long)2L))) {
	if (EQ(queue_element,constant_queue)) {
	    ...
	    gensymed_symbol = ISVREF(queue_element,(SI_Long)1L);
	    def_structure_queue_element_variable = 
		    Chain_of_available_queue_elements;
	    if (def_structure_queue_element_variable)
		Chain_of_available_queue_elements = 
	    ...
	    SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = 
		    block1;
	    gensymed_symbol_1 = def_structure_queue_element_variable;
	    SVREF(queue_element,FIX((SI_Long)1L)) = gensymed_symbol_1;
	    if (EQ(gensymed_symbol,constant_queue))
		SVREF(constant_queue,FIX((SI_Long)0L)) = gensymed_symbol_1;
	    else
		SVREF(gensymed_symbol,FIX((SI_Long)0L)) = gensymed_symbol_1;
	}
	goto end_loop;
    ...
    Object block, superblock, position_or_next_item;
{
	...
	gensymed_symbol_2 = gensymed_symbol_2 ? ISVREF(gensymed_symbol_2,
		(SI_Long)4L) : Nil;
	gensymed_symbol = ISVREF(gensymed_symbol_2,(SI_Long)0L);
	def_structure_queue_element_variable = 
		Chain_of_available_queue_elements;
	if (def_structure_queue_element_variable)
	    Chain_of_available_queue_elements = 
	...
	SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = block;
	gensymed_symbol_1 = def_structure_queue_element_variable;
	SVREF(gensymed_symbol_2,FIX((SI_Long)0L)) = gensymed_symbol_1;
	...
	gensymed_symbol_2 = gensymed_symbol_2 ? ISVREF(gensymed_symbol_2,
		(SI_Long)4L) : Nil;
	gensymed_symbol = ISVREF(gensymed_symbol_2,(SI_Long)1L);
	def_structure_queue_element_variable = 
		Chain_of_available_queue_elements;
	if (def_structure_queue_element_variable)
	    Chain_of_available_queue_elements = 
	...
	gensymed_symbol_1 = def_structure_queue_element_variable;
	SVREF(gensymed_symbol,FIX((SI_Long)0L)) = gensymed_symbol_1;
	SVREF(gensymed_symbol_2,FIX((SI_Long)1L)) = gensymed_symbol_1;
	return VALUES_1(gensymed_symbol_1);
    }
    else {
    ...
    Object workspace, block;
{
	...
	temp = delete_gensym_element_1(block,ISVREF(workspace,(SI_Long)24L));
	ISVREF(workspace,(SI_Long)24L) = temp;
	temp = FIXNUM_SUB1(Count_of_pending_workspace_drawing);
	Count_of_pending_workspace_drawing = temp;
	reclaim_block_change(ISVREF(block,(SI_Long)11L));
	ISVREF(block,(SI_Long)11L) = Nil;
    }
  ...
  next_loop:
	...
	if (list_1) {
	  ...
	  next_loop_1:
		...
		svref_new_value = FIXNUM_SUB1(ISVREF(window,(SI_Long)29L));
		SVREF(window,FIX((SI_Long)29L)) = svref_new_value;
		reclaim_gensym_cons_1(this_1);
	    }
	    else {
    ...
    svref_new_value = delete_gensym_element_1(block_or_connection,
...
Object Purpose_of_frame_projecting = UNBOUND;

Object Control_stack_of_frame_projecting = UNBOUND;

Object Orientation_of_frame = UNBOUND;

Object Current_slice_size_qm = UNBOUND;

Object Left_edge_of_frame = UNBOUND;

Object Top_edge_of_frame = UNBOUND;

Object Right_edge_of_frame = UNBOUND;

Object Bottom_edge_of_frame = UNBOUND;

Object Remaining_space_for_variable_size_pieces_of_frame = UNBOUND;

Object Remaining_number_of_size_pieces_of_frame = UNBOUND;

Object Partition_details_of_current_branch_of_frame = UNBOUND;

Object Mouse_pointer_of_frame = UNBOUND;

Object Block_of_frame = UNBOUND;

Object Frame_transform_of_frame = UNBOUND;

Object New_position_of_horizontal_elevator_of_frame = UNBOUND;

Object New_position_of_vertical_elevator_of_frame = UNBOUND;

Object The_type_description_of_workspace_background_spot = UNBOUND;

Object Chain_of_available_workspace_background_spots = UNBOUND;

Object Workspace_background_spot_count = UNBOUND;
    ...
    Object workspace_background_spot;
{
    ...
    svref_new_value = Chain_of_available_workspace_background_spots;
    SVREF(workspace_background_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_workspace_background_spots = workspace_background_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_workspace_background_spot_structure_internal()
{
    ...
    Object workspace_background_spot_count_new_value;
    ...
    workspace_background_spot_count_new_value = 
	    FIXNUM_ADD1(Workspace_background_spot_count);
...
Object Chain_of_available_title_bar_spots = UNBOUND;

Object Title_bar_spot_count = UNBOUND;
    ...
    Object title_bar_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_title_bar_spots;
    SVREF(title_bar_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_title_bar_spots = title_bar_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_title_bar_spot_structure_internal()
{
    ...
    Object title_bar_spot_count_new_value;
    ...
    title_bar_spot_count_new_value = FIXNUM_ADD1(Title_bar_spot_count);
    Title_bar_spot_count = title_bar_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Currently_working_on_drawing_workspace = UNBOUND;

Object Workstation_with_image_plane_being_refreshed = UNBOUND;
	...
	if (Currently_working_on_drawing_workspace) {
	  ...
	  end_1:;
		...
		gensym_push_modify_macro_arg = 
			gensym_list_3(SYMBOL_FUNCTION(Qdeferred_draw_block),
    ...
    Object block, reference_frame_serial_number;
{
	...
	PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,6);
	  PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,5);
	    PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,4);
	      PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,3);
		...
		PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
		  ...
		  PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			...
			next_loop:
			  ...
			  gensymed_symbol = ISVREF(enclosing_block,
				  (SI_Long)14L);
			  gensymed_symbol = gensymed_symbol ? 
    ...
    Object block, recurse_to_subblocks_qm;
{
	...
	if ( !TRUEP(frame_transforms_of_block)) {
	    ...
	    PUSH_SPECIAL(Frame_transform_of_frame,frame_transform_of_frame,5);
	      block_of_frame = block;
	      PUSH_SPECIAL(Block_of_frame,block_of_frame,4);
		...
		left_edge_of_frame = FIX(gensymed_symbol_1 - 
			gensymed_symbol_2);
		PUSH_SPECIAL(Left_edge_of_frame,left_edge_of_frame,3);
		  gensymed_symbol = ISVREF(block,(SI_Long)14L);
		  gensymed_symbol = gensymed_symbol ? 
		  ...
		  top_edge_of_frame = FIX(gensymed_symbol_1 - 
			  gensymed_symbol_2);
		  PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,2);
		    gensymed_symbol = ISVREF(block,(SI_Long)14L);
		    gensymed_symbol = gensymed_symbol ? 
		    ...
		    right_edge_of_frame = FIX(gensymed_symbol_1 + 
			    gensymed_symbol_2);
		    PUSH_SPECIAL(Right_edge_of_frame,right_edge_of_frame,1);
		      gensymed_symbol = ISVREF(block,(SI_Long)14L);
		      gensymed_symbol = gensymed_symbol ? 
		...
		PUSH_SPECIAL(Current_frame_transform_qm,current_frame_transform_qm,
		  ...
		  if ((SI_Long)0L != (IFIX(ISVREF(block,(SI_Long)5L)) & 
		    ...
		    next_loop:
		      ...
		      gensymed_symbol_1 = ISVREF(enclosing_block,(SI_Long)14L);
		      gensymed_symbol_1 = gensymed_symbol_1 ? 
...
Object Operation_of_graphic_element = UNBOUND;

Object Left_edge_in_window_of_graphic_element = UNBOUND;

Object Top_edge_in_window_of_graphic_element = UNBOUND;

Object Right_edge_in_window_of_graphic_element = UNBOUND;

Object Bottom_edge_in_window_of_graphic_element = UNBOUND;

Object Foreground_color_value_of_graphic_element = UNBOUND;

Object Foreground_color_difference_of_graphic_element = UNBOUND;

Object X_scale_of_graphic_element = UNBOUND;

Object Y_scale_of_graphic_element = UNBOUND;

Object Image_data_of_graphic_element = UNBOUND;

Object X_in_window_of_graphic_element = UNBOUND;

Object Y_in_window_of_graphic_element = UNBOUND;

Object Rotation_of_graphic_element = UNBOUND;

Object Quality_of_graphic_element = UNBOUND;

Object Background_color_value_of_graphic_element = UNBOUND;

Object Graph_or_icon_rendering_of_graphic_element = UNBOUND;

Object Foreground_color_difference_or_differences_of_graphic_element = UNBOUND;

Object Color_values_of_graph_rasters_of_graphic_element = UNBOUND;

Object Left_edge_of_line_of_text_in_window_of_graphic_element = UNBOUND;

Object Baseline_in_window_for_line_of_text_of_graphic_element = UNBOUND;

Object Text_line_for_line_of_text_of_graphic_element = UNBOUND;

Object Word_spacing_for_line_of_text_of_graphic_element = UNBOUND;

Object Font_map_for_line_of_text_of_graphic_element = UNBOUND;

Object Color_difference_for_line_of_text_of_graphic_element = UNBOUND;

Object Entity_width_in_ws = UNBOUND;

Object Entity_height_in_ws = UNBOUND;

Object Poly_vertices = UNBOUND;

Object Poly_line_width = UNBOUND;

Object Poly_line_pattern = UNBOUND;

Object Poly_line_style = UNBOUND;

Object Polygon_fill_color_difference = UNBOUND;

Object Polygon_fill_pattern = UNBOUND;
...
Object Effectively_infinite_region = UNBOUND;

static Object Qcurrent_image_plane;  /* current-image-plane */
...
Object draw_graphic_element varargs_1(int, n)
{
	...
	if (FIXNUM_LT(top_edge_within_draw_area,
	    ...
	    fill_out_current_graphic_element(graphic_element_operation,
		    ...
		    bottom_edge_of_graphic_element_in_window,arg1,arg2,
		    arg3,arg4,arg5,arg6,arg7,arg8);
	    project_graphic_element(left_edge_within_draw_area,
		    top_edge_within_draw_area,right_edge_within_draw_area,
		    bottom_edge_within_draw_area);
	    return VALUES_1(Nil);
	}
	else
...
Object Drawing_state_for_project_paper = UNBOUND;
    ...
    Object region, state_qm;
{
	...
	PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	  ...
	  PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		  15);
	    PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,14);
	      PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,13);
						  ...
						  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
							...
							if (temp_1)
							    ...
							    drawing_state_for_project_paper 
								    = state_qm;
							    PUSH_SPECIAL(Drawing_state_for_project_paper,drawing_state_for_project_paper,
								    0);
							      if ( 
...
Object work_on_xor_drawing(region)
    Object region;
{
    Object current_drawing_transfer_mode, activity, gensym_pop_store;
    Object svref_arg_1, cons_1, next_cons, cdr_new_value, region_strip, top;
    ...
    end_loop_1:;
	  ...
	  temp = Extra_time_for_drawing;
	  if (temp);
	  else
	      temp = FIX((SI_Long)0L);
	  gensymed_symbol_1 = IFIX(temp);
	  maximum_time_slice_size = FIX(gensymed_symbol + gensymed_symbol_1);
	  PUSH_SPECIAL(Maximum_time_slice_size,maximum_time_slice_size,0);
    ...
    Object region, using_geometry_p;
{
    ...
    Object bottom, block_or_connection, connection_p, gensym_pop_store;
    Object svref_arg_1, cons_1, next_cons, temp, x2, gensymed_symbol, scale;
    Object value, region_strip, top_1, bottom_1, region_strip_1;
    Object remaining_region_strips, ab_loop_list_, region_strip_2, a, b;
    Object left_1, right_1, ab_loop_list__1, ab_loop_desetq_;
    Object left_edge_of_draw_area, top_edge_of_draw_area;
    Object right_edge_of_draw_area, bottom_edge_of_draw_area;
    ...
    workstation_with_image_plane_being_refreshed = 
	    ...
	    (SI_Long)2L),(SI_Long)2L);
    PUSH_SPECIAL(Workstation_with_image_plane_being_refreshed,workstation_with_image_plane_being_refreshed,
	    6);
      PUSH_SPECIAL(Currently_working_on_drawing_workspace,currently_working_on_drawing_workspace,
	      5);
	...
	block_or_connection = gensym_pop_store;
	...
	if (temp_1);
		...
		temp_1 = b2 >= IFIX(bottom) && IFIX(bottom) >= t2 || 
			...
			IFIX(right) && IFIX(right) >= l2 || IFIX(right) >= 
			r2 && r2 >= IFIX(left) : TRUEP(Qnil);
	    }
	}
	if (temp_1) {
	    region_strip = Nil;
			...
			PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,
			  ...
			  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
			    ...
			    Top_edge_of_draw_area = FIXNUM_MAX(top_1,
				    Top_edge_of_draw_area);
			    Right_edge_of_draw_area = FIXNUM_MIN(right_1,
				    Right_edge_of_draw_area);
			    Bottom_edge_of_draw_area = FIXNUM_MIN(bottom_1,
				    Bottom_edge_of_draw_area);
			    if (FIXNUM_LT(Left_edge_of_draw_area,
				    Right_edge_of_draw_area) && 
				    FIXNUM_LT(Top_edge_of_draw_area,
				...
				if (using_geometry_p || connection_p)
					...
					if ( !((SI_Long)0L != 
						...
						if (subblocks &&  
							...
							ab_next_queue_element_ 
								= 
								ISVREF(ab_queue_form_,
								(SI_Long)0L);
						  next_loop_4:
						    if (EQ(ab_next_queue_element_,
							    ab_queue_form_))
							goto end_loop_4;
						    subblock = 
	...
	if (temp_1);
		...
		temp_1 = info ? (EQ(Current_drawing_priority,
			...
			(SI_Long)4L),(SI_Long)4L)) : FIXNUM_GE(ISVREF(info,
			(SI_Long)14L),Drawing_max_outstanding_icp_bytes)) :
			 TRUEP(Qnil);
	    }
	}
	else
	...
	if ( !TRUEP(ISVREF(Current_image_plane,(SI_Long)30L)) && 
	    ...
	    draw_selection_handles_for_current_image_plane(left,top,right,
		    bottom);
      POP_SPECIAL();
    POP_SPECIAL();
    if (ISVREF(Current_image_plane,(SI_Long)31L) &&  
	    !TRUEP(ISVREF(Current_image_plane,(SI_Long)30L)))
	return work_on_xor_drawing(region);
    else
	return VALUES_1(Nil);
}
    ...
    Object workspace, image_plane, block, region;
{
	...
	if ( !opaque_qm) {
	    ...
	    PUSH_SPECIAL(Priority_of_next_task,priority_of_next_task,1);
	      PUSH_SPECIAL(Maximum_time_slice_size,maximum_time_slice_size,0);
    ...
    Object bottom_edge_of_frame_in_workspace, interior_projection_qm;
{
    ...
    control_stack_of_frame_projecting = gensym_cons_1(frame_description,Nil);
    ...
    PUSH_SPECIAL(Bottom_edge_of_frame,bottom_edge_of_frame,7);
      PUSH_SPECIAL(Right_edge_of_frame,right_edge_of_frame,6);
	PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,5);
	  PUSH_SPECIAL(Left_edge_of_frame,left_edge_of_frame,4);
	    PUSH_SPECIAL(Control_stack_of_frame_projecting,control_stack_of_frame_projecting,
		    3);
	      PUSH_SPECIAL(Orientation_of_frame,orientation_of_frame,2);
		PUSH_SPECIAL(Purpose_of_frame_projecting,purpose_of_frame_projecting,
			1);
		  ...
		  if (interior_projection_qm)
		      result = FUNCALL_0(interior_projection_qm);
		  else
		      result = VALUES_1(Nil);
		POP_SPECIAL();
	      POP_SPECIAL();
    ...
    Object partition_details_of_current_branch_of_frame;
{
    ...
    Object ab_loop_list_, decff_1_arg, temp, gensym_pop_store, cons_1;
    Object next_cons, partition_details_of_current_branch_of_frame_old_value;
    Object temp_1, chunk_size_spec, chunk_size, var_chunk_size;
    Object first_old_value, first_new_value, instruction, layout_specification;
    Object partition_details, slice_size, current_slice_size_qm;
    Object branch_frame_description, bottom_edge_of_frame;
    Object orientation_of_frame, top_edge_of_frame, left_edge_of_frame;
    Object right_edge_of_frame;
    Declare_special(6);
    Object result;

    x_note_fn_call(90,84);
    PUSH_SPECIAL(Partition_details_of_current_branch_of_frame,partition_details_of_current_branch_of_frame,
	    5);
      ...
      PUSH_SPECIAL(Remaining_number_of_size_pieces_of_frame,remaining_number_of_size_pieces_of_frame,
	      4);
	PUSH_SPECIAL(Remaining_space_for_variable_size_pieces_of_frame,remaining_space_for_variable_size_pieces_of_frame,
		3);
	  chunk_size_qm = Nil;
	...
	next_loop_1:
	  ...
	  temp_1 = FIRST(first_old_value);
	  first_new_value = REST(first_old_value);
	  M_FIRST(temp) = first_new_value;
	  instruction = temp_1;
	  if (EQ(FIRST(instruction),Qframe_section) || frame_interesting_p()) {
	      temp_1 = FIRST(instruction);
	      if (EQ(temp_1,Qframe_section)) {
		  ...
		  PUSH_SPECIAL(Current_slice_size_qm,current_slice_size_qm,2);
		    branch_frame_description = CDDR(instruction);
		    temp_1 = FIRST(layout_specification);
		    if (EQ(temp_1,Qtop)) {
			bottom_edge_of_frame = 
				FIXNUM_ADD(Top_edge_of_frame,
				Current_slice_size_qm);
			orientation_of_frame = Qhorizontal;
			PUSH_SPECIAL(Orientation_of_frame,orientation_of_frame,
				1);
			  PUSH_SPECIAL(Bottom_edge_of_frame,bottom_edge_of_frame,
				  0);
			    if (frame_interesting_p()) {
				Control_stack_of_frame_projecting = 
					gensym_cons_1(branch_frame_description,
					Control_stack_of_frame_projecting);
			...
			PUSH_SPECIAL(Orientation_of_frame,orientation_of_frame,
				1);
			  PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,0);
			    if (frame_interesting_p()) {
				Control_stack_of_frame_projecting = 
					gensym_cons_1(branch_frame_description,
					Control_stack_of_frame_projecting);
    ...
    Object partition_details;
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_frame,bottom_edge_of_frame,3);
      PUSH_SPECIAL(Right_edge_of_frame,right_edge_of_frame,2);
	PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,1);
	  PUSH_SPECIAL(Left_edge_of_frame,left_edge_of_frame,0);
...
Object Current_create_frame_description_reference_1 = UNBOUND;
    ...
    Object frame_description;
{
    ...
    PUSH_SPECIAL(Current_create_frame_description_reference_1,current_create_frame_description_reference_1,
	    0);
    ...
    Object new_position_of_vertical_elevator;
{
    ...
    new_position_of_vertical_elevator_of_frame = 
	    new_position_of_vertical_elevator;
    PUSH_SPECIAL(New_position_of_vertical_elevator_of_frame,new_position_of_vertical_elevator_of_frame,
	    6);
      PUSH_SPECIAL(New_position_of_horizontal_elevator_of_frame,new_position_of_horizontal_elevator_of_frame,
	      5);
	PUSH_SPECIAL(Block_of_frame,block_of_frame,4);
	  frame_transforms_of_block_qm = 
		  get_lookup_slot_value_given_default(block,
	  ...
	  if ( !TRUEP(frame_transforms_of_block_qm)) {
	      ...
	      result = update_elevator_positions_of_block_1(Qhorizontal);
	  }
	  else {
	      ...
	      gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		      (SI_Long)0L) : FIX((SI_Long)0L);
	      gensymed_symbol_1 = IFIX(gensymed_symbol);
	      gensymed_symbol_2 = IFIX(ISVREF(frame_description_reference,
		      (SI_Long)4L));
	      left_edge_of_frame = FIX(gensymed_symbol_1 - gensymed_symbol_2);
	      PUSH_SPECIAL(Left_edge_of_frame,left_edge_of_frame,3);
		gensymed_symbol = ISVREF(block,(SI_Long)14L);
		gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
			(SI_Long)1L) : FIX((SI_Long)0L);
		gensymed_symbol_1 = IFIX(gensymed_symbol);
		gensymed_symbol_2 = 
			IFIX(ISVREF(frame_description_reference,(SI_Long)5L));
		top_edge_of_frame = FIX(gensymed_symbol_1 - gensymed_symbol_2);
		PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,2);
		  gensymed_symbol = ISVREF(block,(SI_Long)14L);
		  gensymed_symbol = gensymed_symbol ? 
			  ISVREF(gensymed_symbol,(SI_Long)2L) : 
		  ...
		  PUSH_SPECIAL(Right_edge_of_frame,right_edge_of_frame,1);
		    ...
		    bottom_edge_of_frame = FIX(gensymed_symbol_1 + 
			    gensymed_symbol_2);
		    PUSH_SPECIAL(Bottom_edge_of_frame,bottom_edge_of_frame,0);
		      result = project_frame(Qmove_elevator,
			      ISVREF(frame_description_reference,
			      (SI_Long)2L),Left_edge_of_frame,
			      Top_edge_of_frame,Right_edge_of_frame,
    ...
    Object mouse_pointer, frame_description, block, left, top, right, bottom;
{
    ...
    PUSH_SPECIAL(Mouse_pointer_of_frame,mouse_pointer_of_frame,3);
      PUSH_SPECIAL(Block_of_frame,block_of_frame,2);
	original_head_of_stack_of_spots = ISVREF(Mouse_pointer_of_frame,
		(SI_Long)5L);
	maximum_time_slice_size = Most_positive_fixnum;
	priority_of_next_task = Most_positive_fixnum;
	PUSH_SPECIAL(Priority_of_next_task,priority_of_next_task,1);
	  PUSH_SPECIAL(Maximum_time_slice_size,maximum_time_slice_size,0);
	    project_frame(Qmouse_tracking,frame_description,left,top,right,
		    bottom,Nil);
	  POP_SPECIAL();
	POP_SPECIAL();
	if ( !EQ(original_head_of_stack_of_spots,
	    ...
	    result = VALUES_1(SVREF(svref_arg_1,FIX((SI_Long)3L)) = Nil);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object left, top, right, bottom;
{
    ...
    PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,8);
      PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,7);
	if (FIXNUM_LT(Left_edge_of_draw_area,Right_edge_of_draw_area)) {
	    top_edge_of_draw_area = FIXNUM_MAX(top,Top_edge_of_draw_area);
	    bottom_edge_of_draw_area = FIXNUM_MIN(bottom,
		    Bottom_edge_of_draw_area);
	    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,6);
	      PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,5);
...
Object Chain_of_available_frame_component_spots = UNBOUND;

Object Frame_component_spot_count = UNBOUND;
    ...
    Object frame_component_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_frame_component_spots;
    SVREF(frame_component_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_frame_component_spots = frame_component_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_frame_component_spot_structure_internal()
{
    ...
    Object frame_component_spot_count_new_value;
    ...
    frame_component_spot_count_new_value = 
	    FIXNUM_ADD1(Frame_component_spot_count);
    Frame_component_spot_count = frame_component_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_frame_component_spot_variable, svref_new_value;
    ...
    svref_new_value = Left_edge_of_frame;
    SVREF(def_structure_frame_component_spot_variable,FIX((SI_Long)6L)) = 
	    svref_new_value;
    svref_new_value = Top_edge_of_frame;
    SVREF(def_structure_frame_component_spot_variable,FIX((SI_Long)7L)) = 
	    svref_new_value;
    svref_new_value = Right_edge_of_frame;
    SVREF(def_structure_frame_component_spot_variable,FIX((SI_Long)8L)) = 
	    svref_new_value;
    svref_new_value = Bottom_edge_of_frame;
    SVREF(def_structure_frame_component_spot_variable,FIX((SI_Long)9L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_frame_component_spot_variable);
}
...
Object Chain_of_available_elevator_shaft_spots = UNBOUND;

Object Elevator_shaft_spot_count = UNBOUND;
    ...
    Object elevator_shaft_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_elevator_shaft_spots;
    SVREF(elevator_shaft_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_elevator_shaft_spots = elevator_shaft_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_elevator_shaft_spot_structure_internal()
{
    ...
    Object elevator_shaft_spot_count_new_value;
    ...
    elevator_shaft_spot_count_new_value = 
	    FIXNUM_ADD1(Elevator_shaft_spot_count);
    Elevator_shaft_spot_count = elevator_shaft_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_elevator_shaft_spot_variable, svref_new_value;
    ...
    svref_new_value = Left_edge_of_frame;
    SVREF(def_structure_elevator_shaft_spot_variable,FIX((SI_Long)6L)) = 
	    svref_new_value;
    svref_new_value = Top_edge_of_frame;
    SVREF(def_structure_elevator_shaft_spot_variable,FIX((SI_Long)7L)) = 
	    svref_new_value;
    svref_new_value = Right_edge_of_frame;
    SVREF(def_structure_elevator_shaft_spot_variable,FIX((SI_Long)8L)) = 
	    svref_new_value;
    svref_new_value = Bottom_edge_of_frame;
    SVREF(def_structure_elevator_shaft_spot_variable,FIX((SI_Long)9L)) = 
	    svref_new_value;
...
Object Chain_of_available_stepper_of_scroll_bar_spots = UNBOUND;

Object Stepper_of_scroll_bar_spot_count = UNBOUND;
    ...
    Object stepper_of_scroll_bar_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_stepper_of_scroll_bar_spots;
    SVREF(stepper_of_scroll_bar_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_stepper_of_scroll_bar_spots = 
...
Object make_permanent_stepper_of_scroll_bar_spot_structure_internal()
{
    ...
    Object stepper_of_scroll_bar_spot_count_new_value;
    ...
    stepper_of_scroll_bar_spot_count_new_value = 
	    FIXNUM_ADD1(Stepper_of_scroll_bar_spot_count);
...
{
    Object def_structure_stepper_of_scroll_bar_spot_variable, svref_new_value;
    ...
    svref_new_value = Left_edge_of_frame;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)6L)) = svref_new_value;
    svref_new_value = Top_edge_of_frame;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)7L)) = svref_new_value;
    svref_new_value = Right_edge_of_frame;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)8L)) = svref_new_value;
    svref_new_value = Bottom_edge_of_frame;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)9L)) = svref_new_value;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)10L)) = Nil;
    SVREF(def_structure_stepper_of_scroll_bar_spot_variable,
	    FIX((SI_Long)11L)) = Nil;
...
Object Chain_of_available_elevator_of_scroll_bar_spots = UNBOUND;

Object Elevator_of_scroll_bar_spot_count = UNBOUND;
    ...
    Object elevator_of_scroll_bar_spot;
{
    ...
    x_note_fn_call(90,125);
    inline_note_reclaim_cons(elevator_of_scroll_bar_spot,Nil);
    old_structure_being_reclaimed = Structure_being_reclaimed;
    Structure_being_reclaimed = elevator_of_scroll_bar_spot;
    reclaim_structure_if_any(ISVREF(elevator_of_scroll_bar_spot,(SI_Long)2L));
    SVREF(elevator_of_scroll_bar_spot,FIX((SI_Long)2L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_elevator_of_scroll_bar_spots;
    SVREF(elevator_of_scroll_bar_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_elevator_of_scroll_bar_spots = 
	    elevator_of_scroll_bar_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_elevator_of_scroll_bar_spot_structure_internal()
{
    ...
    Object elevator_of_scroll_bar_spot_count_new_value;
    Object defstruct_g2_elevator_of_scroll_bar_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(90,127);
    def_structure_elevator_of_scroll_bar_spot_variable = Nil;
    elevator_of_scroll_bar_spot_count_new_value = 
	    FIXNUM_ADD1(Elevator_of_scroll_bar_spot_count);
...
{
    Object def_structure_elevator_of_scroll_bar_spot_variable, svref_new_value;

    x_note_fn_call(90,128);
    def_structure_elevator_of_scroll_bar_spot_variable = 
	    Chain_of_available_elevator_of_scroll_bar_spots;
    ...
    Object workspace, spec;
{
    ...
    Object element, ab_loop_list_, temp, aref_arg_2_1;
    Object gensym_list_of_wide_strings, string_1, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, new_cons, gensymed_symbol, short_string, temp_1;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    Declare_special(5);

    x_note_fn_call(90,137);
    wide_string_bv16 = 
...
Object Known_gensym_acronyms = UNBOUND;
...
Object Lower_match_rank_for_player_eyes_p = UNBOUND;
    ...
    Object font_size;
{
	...
	if (title_text_qm) {
	    ...
	    PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
	      ...
	      PUSH_SPECIAL(Lower_match_rank_for_player_eyes_p,lower_match_rank_for_player_eyes_p,
		      1);
		PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
			0);
...
Object Chain_of_available_resize_box_spots = UNBOUND;

Object Resize_box_spot_count = UNBOUND;
    ...
    Object resize_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resize_box_spots;
    SVREF(resize_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resize_box_spots = resize_box_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_resize_box_spot_structure_internal()
{
    ...
    Object resize_box_spot_count_new_value;
    Object defstruct_g2_resize_box_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(90,150);
    def_structure_resize_box_spot_variable = Nil;
    resize_box_spot_count_new_value = FIXNUM_ADD1(Resize_box_spot_count);
    Resize_box_spot_count = resize_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_close_box_spots = UNBOUND;

Object Close_box_spot_count = UNBOUND;
    ...
    Object close_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_close_box_spots;
    SVREF(close_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_close_box_spots = close_box_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_close_box_spot_structure_internal()
{
    ...
    Object close_box_spot_count_new_value;
    Object defstruct_g2_close_box_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(90,157);
    def_structure_close_box_spot_variable = Nil;
    close_box_spot_count_new_value = FIXNUM_ADD1(Close_box_spot_count);
    Close_box_spot_count = close_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Close_box_rubber_stamp_widget = UNBOUND;
    ...
    Object slot_value, frame, slot_description;
{
	...
	ab_loopvar__1 = gensym_cons_1(gensym_cons_1(gensymed_symbol_1,
		Qab_structure),Nil);
	if (ab_loopvar_)
    ...
    Object frame_style, default_frame_style;
{
	...
	if (temp)
	    ...
	    frame_style_reference = 
		    create_frame_description_reference(copy_tree_using_gensym_conses_1(temp_1));
...
Object clean_frame_description_references()
{
  ...
  next_loop_1:
	...
	temp_2 = TRUEP(Qnil);
      end_2:;
	if (temp_2) {
	    gensymed_symbol = ISVREF(ISVREF(image_plane,(SI_Long)5L),
		    (SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    ab_queue_form_ = gensymed_symbol;
    ...
    Object block, known_or_future_workspace_qm;
{
	...
	if ( !TRUEP(block_is_enclosed_by_superior_p(block))) {
	    ...
	    PUSH_SPECIAL(Purpose_of_extreme_edges,purpose_of_extreme_edges,0);
	      result = determine_extreme_edges_of_block(block);
	    POP_SPECIAL();
...
Object enlarge_workspace_if_necessary varargs_1(int, n)
{
    ...
    new_right_qm = Nil;
    new_bottom_qm = Nil;
    PUSH_SPECIAL(Workspace_for_current_draw_document_qm,workspace_for_current_draw_document_qm,
	    1);
    ...
    Object workspace;
{
	...
	PUSH_SPECIAL(Extreme_bottom_edge_so_far,extreme_bottom_edge_so_far,3);
	  PUSH_SPECIAL(Extreme_right_edge_so_far,extreme_right_edge_so_far,2);
	    PUSH_SPECIAL(Extreme_top_edge_so_far,extreme_top_edge_so_far,1);
    ...
    Object workspace;
{
    ...
    PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	    1);
      PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,0);
...
Object Chain_of_available_uninteresting_block_spots = UNBOUND;

Object Uninteresting_block_spot_count = UNBOUND;
    ...
    Object uninteresting_block_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_uninteresting_block_spots;
    SVREF(uninteresting_block_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_uninteresting_block_spots = uninteresting_block_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_uninteresting_block_spot_structure_internal()
{
    ...
    Object uninteresting_block_spot_count_new_value;
    Object defstruct_g2_uninteresting_block_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(90,205);
    def_structure_uninteresting_block_spot_variable = Nil;
    uninteresting_block_spot_count_new_value = 
	    FIXNUM_ADD1(Uninteresting_block_spot_count);
    Uninteresting_block_spot_count = uninteresting_block_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_simple_item_spots = UNBOUND;

Object Simple_item_spot_count = UNBOUND;
    ...
    Object simple_item_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_simple_item_spots;
    SVREF(simple_item_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_simple_item_spots = simple_item_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_simple_item_spot_structure_internal()
{
    ...
    Object simple_item_spot_count_new_value;
    Object defstruct_g2_simple_item_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(90,212);
    def_structure_simple_item_spot_variable = Nil;
    simple_item_spot_count_new_value = FIXNUM_ADD1(Simple_item_spot_count);
    Simple_item_spot_count = simple_item_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object aggregate_subblock, mouse_pointer;
{
    ...
    x_note_fn_call(90,215);
    gensymed_symbol = ISVREF(aggregate_subblock,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    superior_block = gensymed_symbol;
    super_super_block_qm = Nil;
  next_loop:
    gensymed_symbol = ISVREF(superior_block,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    ...
    Object block;
{
	...
	if (EQ(block,first_subblock(superblock_qm)))
	    ...
	    gensymed_symbol = ISVREF(superblock_qm,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    constant_queue = gensymed_symbol;
	    head = ISVREF(constant_queue,(SI_Long)0L);
	  ...
	  next_loop:
	    if (EQ(queue_element,constant_queue))
		goto end_loop;
	    if (EQ(block,ISVREF(queue_element,(SI_Long)2L))) {
    ...
    Object block_1, block_2, in_back_p;
{
    ...
    Object element, block, gensymed_symbol_1, svref_new_value;
    Object def_structure_queue_element_variable, sub_class_bit_vector;
    Object item_below, position_or_next_lower_item;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, gensymed_symbol_4;
    char temp;

    x_note_fn_call(90,220);
    gensymed_symbol = ISVREF(block_1,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    superblock_1 = gensymed_symbol;
    gensymed_symbol = ISVREF(block_2,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
    superblock_2 = gensymed_symbol;
    if (superblock_1 && superblock_2 && EQ(superblock_1,superblock_2)) {
	gensymed_symbol = ISVREF(superblock_1,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)4L) : Nil;
	constant_queue = gensymed_symbol;
	queue_element_1 = Nil;
	...
	if (EQ(element,constant_queue))
	    goto end_loop;
	block = ISVREF(element,(SI_Long)2L);
	if (EQ(block,block_1)) {
	...
	if (queue_element_1 && queue_element_2)
	    goto end_loop;
	element = ISVREF(element,(SI_Long)0L);
	goto next_loop;
      end_loop:;
	if (changed_something_qm) {
	    if (in_back_p) {
		gensymed_symbol = ISVREF(queue_element_2,(SI_Long)0L);
		gensymed_symbol_1 = ISVREF(queue_element_2,(SI_Long)1L);
		SVREF(gensymed_symbol_1,FIX((SI_Long)0L)) = gensymed_symbol;
		SVREF(gensymed_symbol,FIX((SI_Long)1L)) = gensymed_symbol_1;
		inline_note_reclaim_cons(queue_element_2,Nil);
		svref_new_value = Chain_of_available_queue_elements;
		SVREF(queue_element_2,FIX((SI_Long)0L)) = svref_new_value;
		Chain_of_available_queue_elements = queue_element_2;
		if (EQ(queue_element_1,constant_queue)) {
		    gensymed_symbol = ISVREF(constant_queue,(SI_Long)1L);
		    def_structure_queue_element_variable = 
			    Chain_of_available_queue_elements;
		    if (def_structure_queue_element_variable)
		    ...
		    inline_note_allocate_cons(def_structure_queue_element_variable,
			    Nil);
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)0L)) = constant_queue;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)1L)) = gensymed_symbol;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)2L)) = block_2;
		    gensymed_symbol_1 = def_structure_queue_element_variable;
		    ...
		    gensymed_symbol = ISVREF(queue_element_1,(SI_Long)1L);
		    def_structure_queue_element_variable = 
			    Chain_of_available_queue_elements;
		    if (def_structure_queue_element_variable)
			Chain_of_available_queue_elements = 
		    ...
		    inline_note_allocate_cons(def_structure_queue_element_variable,
			    Nil);
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)0L)) = queue_element_1;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)1L)) = gensymed_symbol;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)2L)) = block_2;
		    gensymed_symbol_1 = def_structure_queue_element_variable;
		    SVREF(queue_element_1,FIX((SI_Long)1L)) = 
			    gensymed_symbol_1;
		    if (EQ(gensymed_symbol,constant_queue))
			SVREF(constant_queue,FIX((SI_Long)0L)) = 
				gensymed_symbol_1;
		    else
			SVREF(gensymed_symbol,FIX((SI_Long)0L)) = 
				gensymed_symbol_1;
		...
		gensymed_symbol = ISVREF(queue_element_1,(SI_Long)0L);
		gensymed_symbol_1 = ISVREF(queue_element_1,(SI_Long)1L);
		SVREF(gensymed_symbol_1,FIX((SI_Long)0L)) = gensymed_symbol;
		SVREF(gensymed_symbol,FIX((SI_Long)1L)) = gensymed_symbol_1;
		inline_note_reclaim_cons(queue_element_1,Nil);
		svref_new_value = Chain_of_available_queue_elements;
		SVREF(queue_element_1,FIX((SI_Long)0L)) = svref_new_value;
		Chain_of_available_queue_elements = queue_element_1;
		if (EQ(queue_element_2,constant_queue)) {
		    gensymed_symbol = ISVREF(constant_queue,(SI_Long)1L);
		    def_structure_queue_element_variable = 
			    Chain_of_available_queue_elements;
		    if (def_structure_queue_element_variable)
		    ...
		    gensymed_symbol = ISVREF(queue_element_2,(SI_Long)1L);
		    def_structure_queue_element_variable = 
			    Chain_of_available_queue_elements;
		    if (def_structure_queue_element_variable)
			Chain_of_available_queue_elements = 
		    ...
		    inline_note_allocate_cons(def_structure_queue_element_variable,
			    Nil);
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)0L)) = queue_element_2;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)1L)) = gensymed_symbol;
		    SVREF(def_structure_queue_element_variable,
			    FIX((SI_Long)2L)) = block_1;
		    gensymed_symbol_1 = def_structure_queue_element_variable;
		    SVREF(queue_element_2,FIX((SI_Long)1L)) = 
			    gensymed_symbol_1;
		    if (EQ(gensymed_symbol,constant_queue))
			SVREF(constant_queue,FIX((SI_Long)0L)) = 
				gensymed_symbol_1;
...
void draw_INIT()
{
    ...
    Object Qsimple_item_spot_count, Qchain_of_available_simple_item_spots;
    Object string_constant_39;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_38, Qunique_structure_type_of_ab_name_qm;
    ...
    Object Quninteresting_block_spot_count;
    Object Qchain_of_available_uninteresting_block_spots, string_constant_37;
    Object string_constant_36, Qreconsider_formatting_for_block;
    Object list_constant_79, Qformatting_dimension, list_constant_78;
    Object list_constant_46, list_constant_77, list_constant_64;
    Object list_constant_76, list_constant_75, list_constant_72;
    Object list_constant_74, list_constant_73, list_constant_71;
    Object list_constant_57, list_constant_70, list_constant_69;
    Object list_constant_61, list_constant_68, list_constant_67;
    Object list_constant_66, list_constant_65, Qdark_gray, list_constant_63;
    Object list_constant_59, list_constant_62, list_constant_60;
    Object list_constant_58, list_constant_37, list_constant_56;
    Object list_constant_55, list_constant_47, list_constant_54;
    Object list_constant_53, list_constant_52, list_constant_51;
    Object list_constant_41, list_constant_50, Qlarge, list_constant_49;
    Object list_constant_48, list_constant_45, list_constant_44;
    Object list_constant_43, list_constant_42, list_constant_40;
    ...
    Object Qcompile_frame_description_for_slot, string_constant_35;
    Object string_constant_34, string_constant_33, string_constant_32;
    Object string_constant_31, string_constant_30, list_constant_29, Qnamed;
    ...
    Object Qclose_box_spot_structure_memory_usage, Qclose_box_spot_count;
    Object Qchain_of_available_close_box_spots, string_constant_29;
    Object string_constant_28, Qresize_box_spot;
    Object Qoutstanding_resize_box_spot_count;
    Object Qresize_box_spot_structure_memory_usage, Qresize_box_spot_count;
    Object Qchain_of_available_resize_box_spots, string_constant_27;
    Object string_constant_26, list_constant_28, Qelevator_of_scroll_bar_spot;
    Object Qoutstanding_elevator_of_scroll_bar_spot_count;
    Object Qelevator_of_scroll_bar_spot_structure_memory_usage;
    Object Qelevator_of_scroll_bar_spot_count;
    Object Qchain_of_available_elevator_of_scroll_bar_spots;
    Object string_constant_25, string_constant_24, Qstepper_of_scroll_bar_spot;
    Object Qoutstanding_stepper_of_scroll_bar_spot_count;
    Object Qstepper_of_scroll_bar_spot_structure_memory_usage;
    Object Qstepper_of_scroll_bar_spot_count;
    Object Qchain_of_available_stepper_of_scroll_bar_spots, string_constant_23;
    Object string_constant_22, Qelevator_shaft_spot;
    Object Qoutstanding_elevator_shaft_spot_count;
    Object Qelevator_shaft_spot_structure_memory_usage;
    Object Qelevator_shaft_spot_count;
    Object Qchain_of_available_elevator_shaft_spots, string_constant_21;
    Object string_constant_20, Qframe_component_spot;
    Object Qoutstanding_frame_component_spot_count;
    Object Qframe_component_spot_structure_memory_usage;
    Object Qframe_component_spot_count;
    Object Qchain_of_available_frame_component_spots, string_constant_19;
    Object string_constant_18, list_constant_27, list_constant_26;
    ...
    Object Qdraw, Qeffectively_infinite_region, Qpolygon_fill_pattern;
    Object Qpolygon_fill_color_difference, Qpoly_line_style;
    Object Qpoly_line_pattern, Qpoly_line_width, Qpoly_vertices;
    Object Qentity_height_in_ws, Qentity_width_in_ws, Qimage_top_offset_in_ws;
    Object Qimage_left_offset_in_ws;
    Object Qcolor_difference_for_line_of_text_of_graphic_element;
    Object Qfont_map_for_line_of_text_of_graphic_element;
    Object Qword_spacing_for_line_of_text_of_graphic_element;
    Object Qtext_line_for_line_of_text_of_graphic_element;
    Object Qbaseline_in_window_for_line_of_text_of_graphic_element;
    Object Qleft_edge_of_line_of_text_in_window_of_graphic_element;
    Object Qcolor_values_of_graph_rasters_of_graphic_element;
    Object Qforeground_color_difference_or_differences_of_graphic_element;
    Object Qgraph_or_icon_rendering_of_graphic_element;
    Object Qbackground_color_value_of_graphic_element;
    Object Qquality_of_graphic_element, Qrotation_of_graphic_element;
    Object Qy_in_window_of_graphic_element, Qx_in_window_of_graphic_element;
    Object Qimage_data_of_graphic_element, Qy_scale_of_graphic_element;
    Object Qx_scale_of_graphic_element;
    Object Qforeground_color_difference_of_graphic_element;
    Object Qforeground_color_value_of_graphic_element;
    Object Qbottom_edge_in_window_of_graphic_element;
    Object Qright_edge_in_window_of_graphic_element;
    Object Qtop_edge_in_window_of_graphic_element;
    Object Qleft_edge_in_window_of_graphic_element;
    Object Qoperation_of_graphic_element, Qnamed_dynamic_extent_description;
    Object Qgraphic_element_projection, Qscroll_block;
    Object Qscroll_block_for_workspace, Qscroll_block_for_block;
    Object list_constant_17, Qdirection_of_step, Qamount_of_step, Qimage_plane;
    Object Qcurrently_working_on_drawing_workspace;
    Object Qworking_on_drawing_workspace, list_constant_16, Qfor_image_plane;
    Object Qtitle_bar_spot, Qoutstanding_title_bar_spot_count;
    Object Qtitle_bar_spot_structure_memory_usage, Qtitle_bar_spot_count;
    Object Qchain_of_available_title_bar_spots, string_constant_17;
    Object string_constant_16, Qworkspace_background_spot;
    Object Qoutstanding_workspace_background_spot_count;
    Object Qworkspace_background_spot_structure_memory_usage;
    Object Qworkspace_background_spot_count;
    Object Qchain_of_available_workspace_background_spots, string_constant_15;
    Object string_constant_14, Qframe_projecting, list_constant_15;
    Object Qwith_extreme_edges;

    x_note_fn_call(90,221);
    SET_PACKAGE("AB");
    ...
    Qworkspace_background_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q831By8s83-vey09k9l");
    ...
    string_constant_17 = STATIC_STRING("1q83AFy8s83-rmy09k9l");
    clear_optimized_constants();
    ...
    Qframe_component_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q834=y8s83-Ucy09k9l");
    clear_optimized_constants();
    ...
    string_constant_20 = 
	    STATIC_STRING("43Dy8m83h3y1q83h3y834=y831By83Qy8n8k1l834=y0000001l1m8x834=ykvk0k0");
    ...
    Qelevator_shaft_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_21 = STATIC_STRING("1q83h3y8s83-SLy09k9l");
    clear_optimized_constants();
    ...
    Qstepper_of_scroll_bar_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_23 = STATIC_STRING("1q83FCy8s83-pTy09k9l");
    clear_optimized_constants();
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8m83KSy1q83KSy834=y831By83Qy8n8k1l834=y0000001l1m8x834=ykvk0k0");
    ...
    Qelevator_of_scroll_bar_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_25 = STATIC_STRING("1q83KSy8s83-SKy09k9l");
    clear_optimized_constants();
    ...
    string_constant_26 = 
	    STATIC_STRING("43Dy8m83mOy1p83mOy831By83Qy8n8k1l831By0000001l1m8x831Bykuk0k0");
    ...
    string_constant_27 = STATIC_STRING("1q83mOy8s83-l7y09k9l");
    clear_optimized_constants();
    ...
    string_constant_29 = STATIC_STRING("1q836gy8s83-Mly09k9l");
    clear_optimized_constants();
    ...
    string_constant_36 = 
	    STATIC_STRING("43Dy8m83oGy1o83oGy83Qy8n8k1l83Qy0000001l1m8x83Qykqk0k0");
    ...
    Quninteresting_block_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_37 = STATIC_STRING("1q83oGy8s83-tGy09k9l");
    clear_optimized_constants();
    ...
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_37));
    ...
    Qsimple_item_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_39 = STATIC_STRING("1q83F=y8s83-o4y09k9l");
    clear_optimized_constants();
