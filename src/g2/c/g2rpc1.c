    ...
    Object remote_procedure_description;
{
	...
	temp = 
		allocate_evaluation_structure(gensym_cons_1(Qis_class_instance,
		gensym_cons_1(temp,gensym_cons_1(Qtype_name,
		gensym_cons_1(temp_1,Nil)))));
    }
    else {
	...
	if (general_description_qm) {
	  ...
	  next_loop:
	    ...
	    ab_loopvar__1 = gensym_cons_1(attr,Nil);
	    if (ab_loopvar_)
	  ...
	  end_4:;
	    temp = 
		    allocate_evaluation_structure(gensym_cons_1(Qis_class_instance,
		    gensym_cons_1(temp_2,gensym_cons_1(Qtype_name,
		    gensym_cons_1(class_name,gensym_cons_1(Qkind,
		    gensym_cons_1(kind,
		    gensym_cons_1(Qinclude_all_system_attributes,
		    gensym_cons_1(temp_1,
		    gensym_cons_1(Qinclude_all_system_attributes_except,
		    gensym_cons_1(temp_3,
		    gensym_cons_1(Qincluded_system_attributes,
		    gensym_cons_1(temp_4,
		    gensym_cons_1(Qincluded_user_attributes,
		    gensym_cons_1(temp_5,
		    gensym_cons_1(Qexcluded_user_attributes,
		    gensym_cons_1(temp,Nil)))))))))))))))));
	}
	else
	    temp = Nil;
    }
    ...
    Object slot_value_qm, frame, slot_description;
{
	...
	ab_loopvar__2 = 
		gensym_cons_1(convert_remote_procedure_description_to_structure(description),
		Nil);
	if (ab_loopvar__1)
    ...
    Object descriptions;
{
  ...
  next_loop:
	...
	if (badly_formated_properties_qm) {
		...
		svref_new_value = gensym_cons_1(Kgeneral_description,
			gensym_cons_1(Ktype,gensym_cons_1(type,
  ...
  next_loop_2:
	...
	temp = CADDR(tail) ? gensym_cons_1(Kkind,gensym_cons_1(Qhandle,
		CDDDR(tail))) : CDDDR(tail);
	M_CDR(tail) = temp;
    }
    tail = CDDR(tail);
    goto next_loop_2;
    ...
    PUSH_SPECIAL(Kb_flags,kb_flags,1);
	  ...
	  next_loop_2:
		...
		if (excess_info_qm) {
		    ...
		    reclaim_gensym_cons_1(excess_info_qm);
		}
	    }
	    goto next_loop_2;
	  end_loop_2:;
...
Object Chain_of_available_scheduled_remote_procedure_starts = UNBOUND;

Object Scheduled_remote_procedure_start_count = UNBOUND;
    ...
    Object scheduled_remote_procedure_start;
{
    ...
    schedule_task_qm = ISVREF(scheduled_remote_procedure_start,(SI_Long)5L);
    if (schedule_task_qm) {
    ...
    svref_new_value = Nil;
    SVREF(scheduled_remote_procedure_start,FIX((SI_Long)5L)) = svref_new_value;
    SVREF(scheduled_remote_procedure_start,FIX((SI_Long)5L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_scheduled_remote_procedure_starts;
    SVREF(scheduled_remote_procedure_start,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_scheduled_remote_procedure_starts = 
	    scheduled_remote_procedure_start;
    return VALUES_1(Nil);
}
...
Object make_permanent_scheduled_remote_procedure_start_structure_internal()
{
    ...
    Object scheduled_remote_procedure_start_count_new_value;
    ...
    scheduled_remote_procedure_start_count_new_value = 
	    FIXNUM_ADD1(Scheduled_remote_procedure_start_count);
...
Object deactivate_for_remote_procedure_declaration(remote_procedure_declaration)
    Object remote_procedure_declaration;
{
    Object queue, scheduled_start, gensymed_symbol, temp, gensymed_symbol_1;
    Object gensymed_symbol_2, svref_new_value, frame, sub_vector_qm;
	...
	scheduled_start = Nil;
      next_loop:
	gensymed_symbol = ISVREF(queue,(SI_Long)0L);
	if (EQ(gensymed_symbol,queue)) {
	    temp = Nil;
	    scheduled_start = temp;
	}
	else {
	    gensymed_symbol_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
	    gensymed_symbol_2 = ISVREF(gensymed_symbol,(SI_Long)0L);
	    SVREF(queue,FIX((SI_Long)0L)) = gensymed_symbol_2;
	    SVREF(gensymed_symbol_2,FIX((SI_Long)1L)) = queue;
    ...
    Object wait_interval_qm, priority_qm, new_top_of_stack;
{
    ...
    Object message_1, temp_1, execution_priority, scheduled_start;
    ...
    Object def_structure_schedule_task_variable, task, gensymed_symbol_5;
    Object gensymed_symbol_6, def_structure_queue_element_variable;
	...
	future_task_schedule_modify_arg_2 = execution_priority;
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qexecute_scheduled_remote_procedure_start);
	future_task_schedule_modify_arg_11 = scheduled_start;
	future_task_schedule_modify_arg_12 = execution_priority;
	schedule_task_qm = ISVREF(scheduled_start,(SI_Long)5L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	SVREF(scheduled_start,FIX((SI_Long)5L)) = task;
	reclaim_evaluation_quantity(wait_interval_qm);
	gensymed_symbol_5 = ISVREF(remote_procedure_declaration,(SI_Long)23L);
	gensymed_symbol_6 = ISVREF(gensymed_symbol_5,(SI_Long)1L);
	...
	SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = 
		scheduled_start;
	gensymed_symbol_7 = def_structure_queue_element_variable;
	SVREF(gensymed_symbol_6,FIX((SI_Long)0L)) = gensymed_symbol_7;
	SVREF(gensymed_symbol_5,FIX((SI_Long)1L)) = gensymed_symbol_7;
	SVREF(scheduled_start,FIX((SI_Long)6L)) = gensymed_symbol_7;
    }
    return VALUES_1(Nil);
}
    ...
    Object scheduled_start, execution_priority;
{
    ...
    Object icp_interface, argument_list, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_2, svref_new_value, xa, ya, sub_class_bit_vector;
    ...
    gensymed_symbol = ISVREF(scheduled_start,(SI_Long)6L);
    gensymed_symbol_1 = ISVREF(gensymed_symbol,(SI_Long)0L);
    gensymed_symbol_2 = ISVREF(gensymed_symbol,(SI_Long)1L);
    ...
    Object icp_version, uses_item_references, interface_list;
{
    ...
    PUSH_SPECIAL(Inhibit_corresponding_icp_object_making,inhibit_corresponding_icp_object_making,
	    12);
    ...
    Object execution_priority, do_not_reclaim_or_modify_argument_list;
{
	...
	argument_list = copy_list_using_gensym_conses_1(argument_list);
    ...
    Object type, kind, argument;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, argument_type, constant_value;
    ...
    Object rpd_vector, key;
{
  ...
  next_loop:
	...
	description = Nil;
    ab_loopvar__2 = gensym_cons_1(getf(description,key,_),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ...
    Object declaration;
{
    ...
    reclaim_gensym_list_1(return_included_spec);
    reclaim_gensym_list_1(return_excluded_spec);
    reclaim_gensym_list_1(return_included_system_attribute_spec);
    reclaim_gensym_list_1(return_include_all_system_attribute_spec);
    reclaim_gensym_list_1(return_include_all_system_attribute_except_spec);
    reclaim_gensym_list_1(return_kind_spec);
    return VALUES_1(temp);
}
...
Object System_defined_rpcs = UNBOUND;

Object System_defined_rpc_prop = UNBOUND;

Object The_type_description_of_system_rpc_instance = UNBOUND;

Object Chain_of_available_system_rpc_instances = UNBOUND;

Object System_rpc_instance_count = UNBOUND;
    ...
    Object system_rpc_instance;
{
    ...
    svref_new_value = Chain_of_available_system_rpc_instances;
    SVREF(system_rpc_instance,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_system_rpc_instances = system_rpc_instance;
    return VALUES_1(Nil);
}
...
Object make_permanent_system_rpc_instance_structure_internal()
{
    ...
    Object system_rpc_instance_count_new_value;
    ...
    system_rpc_instance_count_new_value = 
	    FIXNUM_ADD1(System_rpc_instance_count);
    System_rpc_instance_count = system_rpc_instance_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object remote_procedure_identifier_qm;
{
  ...
  next_loop:
    ...
    argument_list = gensym_cons_1(lisp_arg,argument_list);
	...
	reclaim_gensym_list_1(rpc_arg_list);
  ...
  end_loop:
    ...
    reclaim_gensym_list_1(apply_args);
    ...
    Object system_rpc_instance, rpc_value_list;
{
  ...
  end_loop:
	...
	send_or_enqueue_icp_write_task(output_port,FIX((SI_Long)6L),
		...
		gensym_list_2(tag,rpc_value_list),
		SYMBOL_FUNCTION(Qreclaim_after_rpc_return_values),
		gensym_cons_1(rpc_value_list,Nil));
    else {
    ...
    Object rpc_instance, arg1;
{
    ...
    Object amf_result, incff_1_arg, new_float, result_list, managed_float;
    double res;
    XDeclare_area(1);
    XDeclare_frontier(1);
    ...
    Object name;
{
    ...
    debugging_reset = T;
    PUSH_SPECIAL(Debugging_reset,debugging_reset,1);
...
Object Prefer_kb_procedures_to_system_defined_p = UNBOUND;
    ...
    Object icp_socket, name, argument_list, remote_procedure_identifier_qm;
{
    ...
    Object sub_class_bit_vector, temp_2, format_string, arg1, arg2;
    ...
    Object remote_procedure_identifier_qm;
{
    ...
    initial_rpc_frame_serial_number = gensym_pop_store;
    gensym_pop_store = Nil;
    cons_1 = argument_list;
    if (cons_1) {
	gensym_pop_store = M_CAR(cons_1);
	...
	next_cons = Nil;
    argument_list = next_cons;
    rpc_argument_list_error = gensym_pop_store;
    PUSH_SPECIAL(Rpc_argument_list_error,rpc_argument_list_error,0);
	  ...
	  SVREF(task,FIX((SI_Long)11L)) = procedure_qm_1;
	  SVREF(task,FIX((SI_Long)12L)) = argument_list;
	  SVREF(task,FIX((SI_Long)13L)) = icp_socket;
	  SVREF(task,FIX((SI_Long)14L)) = remote_procedure_identifier_qm;
    ...
    Object remote_procedure_identifier_qm, error_1;
{
	...
	if (error_1) {
	    temp = error_1;
	    error_arguments = gensym_cons_1(gensym_list_4(Qcopy,temp,
		    make_remote_procedure_item_info(Nil,Nil,Nil,T,Nil,Nil),
		    Nil),Nil);
	}
	else {
	    temp = gensym_cons_1(Qvalue,error_name);
	    error_arguments = gensym_list_2(temp,gensym_cons_1(Qvalue,
		    copy_text_string(error_message)));
	}
	args = gensym_list_4(error_name,error_level,error_message,
		error_arguments);
	temp = remote_procedure_identifier_qm ? 
		nconc2(gensym_list_2(remote_procedure_index_qm,Nil),args) :
		 args;
	return send_or_enqueue_icp_write_task(output_port,FIX((SI_Long)6L),
		...
		gensym_list_2(error_message,error_arguments));
    }
    else {
    ...
    Object returning_code_body_invocation;
{
    ...
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object message_1, gensymed_symbol_2, gensymed_symbol_4, temp_1, temp_2;
    Object temp_3, temp_4, temp_5, temp_6, transform_error_message_qm;
	...
	svref_new_value = 
		delete_gensym_element_1(returning_code_body_invocation,
	...
	PUSH_SPECIAL(Cached_top_of_stack,cached_top_of_stack,7);
	  index_1 = IFIX(FIXNUM_ADD1(FIXNUM_MINUS(top_of_stack,
		  values_on_stack)));
	  value_or_object = Nil;
	  description_index = (SI_Long)0L;
	...
	next_loop_1:
	  ...
	  if (invalidity_message_qm) {
		...
		next_loop_2:
		  ...
		  goto next_loop_2;
		end_loop_2:;
		  reclaim_gensym_list_1(argument_strings_for_trace);
	      }
		...
		POP_SPECIAL();
		  ...
		  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
			...
			PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
			  ...
			  PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
				  0);
			    gensymed_symbol_2 = value_or_object;
				...
				temp = 
					INLINE_LONG_VECTOR_P(gensymed_symbol_2) 
					!= (SI_Long)0L ? 
					IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_2)) 
					== (SI_Long)1L : TRUEP(Qnil);
			    if (temp);
				...
				temp = EQ(gensymed_symbol_2,Qtruth_value);
				if (temp);
				else
				    temp = EQ(gensymed_symbol_2,
					    Qiteration_state);
				if (temp);
	  ...
	  ab_loopvar__1 = gensym_cons_1(value_or_object,Nil);
	  if (ab_loopvar_)
	      M_CDR(ab_loopvar_) = ab_loopvar__1;
	  else
	  ...
	  goto next_loop_1;
	end_loop_1:
	  temp_2 = ISVREF(remote_procedure_call,(SI_Long)23L);
	  temp_3 = results;
	  temp_4 = 
		  get_icp_interface_for_remote_procedure_call(remote_procedure_call,
		  T);
	  temp_5 = get_rpc_priority_from_computation_context();
	  temp_1 = ISVREF(ISVREF(ISVREF(remote_procedure_identifier,
		  (SI_Long)8L),(SI_Long)1L),(SI_Long)1L);
	  temp_6 = CDR(temp_1);
	  temp_1 = ISVREF(ISVREF(ISVREF(remote_procedure_identifier,
		  (SI_Long)8L),(SI_Long)1L),(SI_Long)1L);
	  transform_error_message_qm = 
		  transform_rpc_argument_or_result_list(9,temp_2,temp_3,
		  return_descriptions,icp_socket,temp_4,temp_5,Nil,temp_6,
		  CAR(temp_1));
	  if (transform_error_message_qm) {
	      reclaim_rpc_argument_list(results,Nil);
	      if (exit_message_qm) {
    ...
    Object remote_procedure_identifier, returned_values;
{
    ...
    returned_values = next_cons;
    rpc_argument_list_error = gensym_pop_store;
    PUSH_SPECIAL(Rpc_argument_list_error,rpc_argument_list_error,1);
	...
	temp = delete_gensym_element_1(remote_procedure_call,ISVREF(caller,
		(SI_Long)13L));
    ...
    Object remote_procedure_declaration, calling_environment;
{
    ...
    SI_Long aref_arg_2, aref_new_value, length_1, gensymed_symbol_3;
    ...
    Object remote_procedure_call, reason_string_qm, error_1;
{
	...
	svref_new_value = delete_gensym_element_1(called_code_body,
		ISVREF(remote_procedure_call,(SI_Long)13L));
	SVREF(remote_procedure_call,FIX((SI_Long)13L)) = svref_new_value;
    }
    ...
    Object remote_procedure_call;
{
	...
	svref_new_value = 
		delete_gensym_element_1(base_code_body_invocation,
		ISVREF(remote_procedure_call,(SI_Long)13L));
	SVREF(remote_procedure_call,FIX((SI_Long)13L)) = svref_new_value;
    ...
    Object remote_procedure_identifier;
{
	...
	if (caller) {
	    svref_new_value = 
		    delete_gensym_element_1(remote_procedure_call,
    ...
    Object remote_procedure_call;
{
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
	  ...
	  temp = delete_gensym_element_1(remote_procedure_call,
...
void g2_rpc1_INIT()
{
    ...
    Object Qsystem_rpc_instance_count;
    Object Qchain_of_available_system_rpc_instances, string_constant_64;
    ...
    Object Qscheduled_remote_procedure_start_count;
    Object Qchain_of_available_scheduled_remote_procedure_starts;
    ...
    string_constant_55 = 
	    STATIC_STRING("k000004z8r83ry83ry837Ly837Ly00001p1l8o1l8l1n8p837Ly83Gy1l83-5y1l83-3y000004z8r83WDy83WDy837Ly837Ly00001n1l8o1l8l1m8p8369y000004z");
    string_constant_56 = 
	    STATIC_STRING("8r83Yxy83Yxy837Ly837Ly00001n1l8o1l8l1l83Hy000004z8r83dmy83dmy837Ly837Ly00001n1l8o1l8l1l83Cy000004z8r83Zly83Zly837Ly837Ly00001n1l");
    string_constant_57 = 
	    STATIC_STRING("8o1l8l1l83Hy000004z8r83Yuy83Yuy837Ly837Ly00001p1m8p83Yvy1l8o1l8l1l83Cy1l83Ny000004z8r83Z+y83Z+y837Ly837Ly00001p1m8p83Yvy1l8o1l8l");
    string_constant_58 = STATIC_STRING("1l83Cy1l83Ny00000");
    string_constant_59 = 
	    STATIC_STRING("1w8q1o837Ly1l83*sy1m8v837Ly8t1n83--y01m8p83-*y1n83-0y01m8p83-0y1p83-Fy08l1m8p083Cy1q83ry08o8l1n8p837Ly83Gy83-5y1p83WDy08o8l1m8p8");
    string_constant_60 = 
	    STATIC_STRING("369y1p83Yxy08o8l83Hy1p83dmy08o8l83Cy1p83Zly08o8l83Hy1r83Yuy01m8p83Yvy8o8l83Cy83Ny1r83Z+y01m8p83Yvy8o8l83Cy83Ny");
    ...
    string_constant_61 = 
	    STATIC_STRING("43Dy8m83mky1n83mky8n8k1l8n0000001l1n8y83-5ky1o83-Bqy83-Boy83-Bpy83-Bnykrk0k0");
    ...
    Qscheduled_remote_procedure_start_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_62 = STATIC_STRING("1q83mky8s83-mRy09k9l");
    ...
    string_constant_63 = 
	    STATIC_STRING("43Dy8m83nhy1n83nhy8n8k1l8n0000001l1n8y83-64y1n83-EGy83-EEy83-EFykok0k0");
    ...
    Qsystem_rpc_instance_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_64 = STATIC_STRING("1q83nhy8s83-qGy09k9l");
    clear_optimized_constants();
