...
Object Default_language = UNBOUND;
...
Object Language_parameters = UNBOUND;
    ...
    Object language_parameters, value;
{
    ...
    x_note_fn_call(111,5);
    PUSH_SPECIAL(Language_parameters,language_parameters,0);
    ...
    Object frame, language_qm, delete_case_qm;
{
	...
	if (delete_case_qm) {
		...
		temp = delete_gensym_element_1(frame,translation_contributors);
	    ...
	    mutate_kb_specific_property_value(language_qm,
		    gensym_cons_1(frame,translation_contributors),
		    Translation_contributors_kbprop);
...
Object Current_localization_purpose_qm = UNBOUND;

Object Current_localization_domains_qm = UNBOUND;
    ...
    Object additional_domain;
{
    ...
    x_note_fn_call(111,11);
    if ( !TRUEP(Current_localization_domains_qm)) {
	Current_localization_domains_qm = gensym_cons_1(additional_domain,Nil);
	...
	if ( !TRUEP(CDR(Current_localization_domains_qm))) {
	    ...
	    cdr_new_value = gensym_cons_1(additional_domain,Nil);
    ...
    Object list_1, item;
{
    ...
    x_note_fn_call(111,12);
    tail_of_list = list_1;
  next_loop:
    if ( !TRUEP(tail_of_list))
	goto end_loop;
    if ( !TRUEP(CDR(tail_of_list))) {
	cdr_new_value = gensym_cons_1(item,Nil);
...
Object remove_last_item_in_current_localization_domains()
{
    ...
    x_note_fn_call(111,13);
    if (Current_localization_domains_qm) {
	if ( !TRUEP(CDR(Current_localization_domains_qm))) {
	    reclaim_gensym_cons_1(Current_localization_domains_qm);
	  ...
	  next_loop:
		...
		reclaim_gensym_cons_1(cons_cell);
...
Object Known_localizations = UNBOUND;
    ...
    Object value, frame, initializing_qm;
{
    ...
    x_note_fn_call(111,32);
    if (initializing_qm) {
	language = CAR(value);
	term_translation_pairs_1 = CDR(value);
	cdr_new_value = gensym_cons_1(gensym_cons_1(Qmenu_item,Qmenu),
		CDR(value));
...
{
    x_note_fn_call(111,37);
    return reclaim_gensym_list_1(translations_for_symbol);
}
    ...
    Object symbol, frame;
{
	...
	return mutate_kb_specific_property_value(symbol,
		gensym_cons_1(frame,Nil),Translations_for_symbol_kbprop);
	...
	return mutate_kb_specific_property_value(symbol,
		gensym_cons_1(frame,entry),Translations_for_symbol_kbprop);
    }
}
    ...
    Object symbol, frame;
{
	...
	if ( !TRUEP(entry))
	    ...
	    temp = delete_gensym_element_1(frame,entry);
    ...
    Object symbol, language;
{
	...
	if ( !TRUEP(purpose) &&  !TRUEP(domains))
	    ...
	    return find_translation_for_symbol_in_contextually_appropriate_frame(symbol,
...
{
    Object possible_governing_domain, ab_loop_list_, gensymed_symbol;
  ...
  next_loop:
	...
	if (SYMBOLP(domain)) {
	    ...
	    gensymed_symbol_1 = domain;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(domain) & 
    ...
    Object parse_result;
{
    ...
    Object default_qm, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    Object temp, temp_1, new_cons, global_properties, kb_properties;
    Object kb_specific_value, resulting_value, legal_domains_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;

    x_note_fn_call(111,51);
	...
	if (SYMBOLP(domain_qm)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = domain_qm;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(domain_qm) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
...
Object check_for_other_language_translations varargs_1(int, n)
{
    ...
    temp = CAR(temp);
    domain = CDR(temp);
    domains = gensym_cons_1(domain,Nil);
    frame = Nil;
  ...
  end_1:;
    ...
    return reclaim_gensym_list_1(frames);
}
...
{
    x_note_fn_call(111,63);
    return gensym_cons_1(other_translation_symbol,
	    gensym_cons_1(other_translation_count,
	    gensym_cons_1(other_translation_language,
	    gensym_cons_1(other_translation_purpose,
	    gensym_cons_1(other_translation_domain,Nil)))));
}
...
void language_INIT()
{
    ...
    Object Qtext, Qab_or, string_constant_40, Qmenu_item_translation_pair;
    Object Qmenu_item_translation_pairs, string_constant_39;
    Object string_constant_38, string_constant_37, string_constant_36;
    Object string_constant_35;
    ...
    Object string_constant_31, Qreclaim_translations_for_symbol;
    ...
    Object Qcleanup_for_language_translation, string_constant_30;
    Object string_constant_29, string_constant_28, list_constant_21;
    Object string_constant_27, string_constant_26, string_constant_25;
    Object string_constant_24, string_constant_23, Qstatement, Qsimple_message;
    ...
    Object Qnamed_dynamic_extent_description, Qlocalization_context;
    ...
    Object Qlanguage_parameters, Qabsent_slot_putter;
    ...
    Object list_constant_11, Qdefault_language, Kfuncall;

    x_note_fn_call(111,71);
    SET_PACKAGE("AB");
    ...
    string_constant_20 = 
	    STATIC_STRING("1m4z8r83Ixy83Ixy83Tfy83Tfy00001n1l8o1l8l1m8p83BRy000004z8r83=ly83=ly83Tfy83Tfy00001n1m8p830Uy1l83Ey1l8l00000");
    string_constant_21 = 
	    STATIC_STRING("1o8q1n83Tfy1l83-sy83ey1p83Ixy08o8l1m8p83BRy1p83=ly01m8p830Uy83Ey8l");
    ...
    mutate_global_property(Qcurrent_language,
	    ...
	    Qslot_value_writer);
    string_constant_22 = 
	    STATIC_STRING("1q1m83BRy83Tey1m83BRy1m9k83vdy1m83Tey1m9k8378y1m83Tey1m9k83kIy1m83Tey1m9k83-CBy1m83Tey83-6y");
    ...
    check_if_superior_classes_are_defined(Qlanguage_translation,
	    list_constant_21);
    string_constant_23 = STATIC_STRING("1m1m8v835dy1l8t");
    string_constant_24 = 
    ...
    string_constant_28 = 
	    STATIC_STRING("1p8q1o835dy1l83*sy1m8v835dy8t1o83--y01m8p83-*y1m83Dy53=5yWill allow 0 or more author entries. each author entry may have ~\n     ");
    string_constant_29 = 
    ...
    temp_1 = regenerate_optimized_constant(LIST_4(string_constant_24,
    ...
    add_class_to_environment(9,Qlanguage_translation,list_constant_21,Nil,
	    ...
	    regenerate_optimized_constant(LIST_3(string_constant_28,
	    string_constant_29,string_constant_30)),Nil);
    ...
    string_constant_31 = 
	    STATIC_STRING("1l1n835dy1q1m9k83*Xy83Tey1m9k83vy83-2Vy1m9k83-Py9l1nmoq");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_32 = 
	    STATIC_STRING("1l1n835dy1o1m9k83*Xy83Tey1m9k83-Py83-dNy2lmo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_32));
    string_constant_33 = 
	    STATIC_STRING("1o1n83-2Vy1q1m9k83*5y83=Zy83-cDy1m9k83-Ty83=Zy83-Gy2lnq1n83-2Vy1n1m9k83*5y83=Zy83-cDy1ln1n83-2Vy1q1m9k83*5y83=Zy83-cDy1m9k83*Xy1");
    string_constant_34 = 
	    STATIC_STRING("m9k9l83-f4y2lnq1n83-2Vy1q1m9k83*5y83=Zy83-cDy1m9k83*Xy1m9k9l83-SGy2lnq");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_33,
	    string_constant_34)));
    ...
    string_constant_35 = STATIC_STRING("1l1n83-qqy1n83-2Uy1m9k9l83nby2lln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_36 = 
	    STATIC_STRING("1p1m83-2Uy83kly1m83-2Uy83q1y1m83-2Uy83B2y1m83-2Uy83a7y1m83-2Uy83-o0y");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_36));
    string_constant_37 = 
	    STATIC_STRING("1p1m83kly83jUy1m83kly83-2ky1m83kly83ogy1m83jUy83-2y1m83-2ky83-2y");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_37));
    string_constant_38 = STATIC_STRING("1m1m83q1y83*my1m83q1y83FJy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_38));
    string_constant_39 = STATIC_STRING("1m1m83nby83-2y1m83nby83-Uy");
    ...
    string_constant_40 = STATIC_STRING("1l1n83-dMy1n83kly1m9k9l83nby2lln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnum_eq);
