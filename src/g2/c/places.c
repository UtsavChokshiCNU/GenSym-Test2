...
Object Current_include_denotation_for_block_flag = UNBOUND;
...
Object denote_component_of_block varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Current_include_denotation_for_block_flag,current_include_denotation_for_block_flag,
	    1);
...
Object Chain_of_available_place_reference_internalss = UNBOUND;

Object Place_reference_internals_count = UNBOUND;
    ...
    Object place_reference_internals;
{
    ...
    reclaim_frame_serial_number(ISVREF(place_reference_internals,(SI_Long)2L));
    SVREF(place_reference_internals,FIX((SI_Long)2L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_place_reference_internalss;
    SVREF(place_reference_internals,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_place_reference_internalss = place_reference_internals;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_place_reference_internals_variable;
    Object place_reference_internals_count_new_value, the_array;
    ...
    place_reference_internals_count_new_value = 
	    FIXNUM_ADD1(Place_reference_internals_count);
    ...
    Object particulars, block_or_symbol;
{
    ...
    temp = gensym_cons_1(make_place_reference_internals_1(particulars,
	    block_or_symbol,
...
Object reclaim_evaluation_place_reference(place_reference)
    Object place_reference;
{
    Object place_reference_internals, old_structure_being_reclaimed, thing;
    Object temp;
    ...
    SVREF(place_reference_internals,FIX((SI_Long)2L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    temp = Chain_of_available_place_reference_internalss;
    SVREF(place_reference_internals,FIX((SI_Long)0L)) = temp;
    Chain_of_available_place_reference_internalss = place_reference_internals;
    if (place_reference) {
	inline_note_reclaim_cons(place_reference,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(place_reference) = temp;
	Available_gensym_conses = place_reference;
    }
    return VALUES_1(Nil);
}
    ...
    Object place_reference;
{
    ...
    temp = 
	    gensym_cons_1(copy_place_reference_internals(M_CAR(place_reference)),
	    Qplace_reference);
    return VALUES_1(temp);
}
...
void places_INIT()
{
    ...
    Object Qplace_reference_internals_count;
    Object Qchain_of_available_place_reference_internalss, string_constant_19;
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83lby1m83lby8k1l8k0000001m1m83*gy9k1n8y83-58y1n83-9=y83-9-y83-9*yknk0k0");
    ...
    Qplace_reference_internals_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83lby8s83-hny09k9l");
    clear_optimized_constants();
