...
Object Chain_of_available_gsi_icp_interfaces = UNBOUND;

Object Gsi_icp_interface_count = UNBOUND;
    ...
    Object gsi_icp_interface;
{
    ...
    svref_new_value = Chain_of_available_gsi_icp_interfaces;
    SVREF(gsi_icp_interface,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gsi_icp_interfaces = gsi_icp_interface;
    return VALUES_1(Nil);
}
...
Object make_permanent_gsi_icp_interface_structure_internal()
{
    ...
    Object gsi_icp_interface_count_new_value;
    ...
    gsi_icp_interface_count_new_value = FIXNUM_ADD1(Gsi_icp_interface_count);
    Gsi_icp_interface_count = gsi_icp_interface_count_new_value;
...
Object enable_control_of_disable_interleaving_of_large_messages()
{
    ...
    Object slot_description, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp_1, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value, svref_new_value;
	...
	end_8:;
      ...
      slot_description = 
	      ...
	      gensymed_symbol,Nil);
      svref_new_value = ldelete(4,Qdo_not_save,ldelete(4,
    ...
    Object interface_frame, attributes_within_text;
{
	...
	temp = SYMBOLP(symbol_or_comma_headed_list) ? 
		gensym_cons_1(symbol_or_comma_headed_list,Nil) : 
...
Object compile_attributes_which_identify_a_network_item_reference_for_slot varargs_1(int, n)
{
	...
	return gensym_cons_1(parse_result,Nil);
    else if (CONSP(parse_result) && EQ(M_CAR(parse_result),
	    Qclass_qualified_name))
	return gensym_cons_1(gensym_list_3(FIRST(parse_result),
	...
	if (SYMBOLP(attribute_name_or_translation))
	    ...
	    temp = gensym_list_3(FIRST(attribute_name_or_translation),
	...
	return gensym_cons_1(compile_network_class_attribute_translation(parse_result),
		Nil);
}
    ...
    Object translation;
{
	...
	return gensym_cons_1(translation,Nil);
    else if (CONSP(translation) && EQ(M_CAR(translation),
	    Qclass_qualified_name)) {
	attr_name = translation;
	return gensym_cons_1(gensym_list_3(FIRST(attr_name),
	...
	if (CONSP(thing) && EQ(M_CAR(thing),Qclass_qualified_name)) {
	    ...
	    temp = gensym_list_3(FIRST(attr_name),SECOND(attr_name),
		    THIRD(attr_name));
	}
	else
	    temp = FIRST(translation);
	return gensym_cons_1(temp,SECOND(translation));
    }
}
    ...
    Object translation;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(compile_network_attribute_translation(translation),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	...
	temp_1 = 
		gensym_cons_1(compile_network_attribute_translation(translations),
		Nil);
    temp_1 = gensym_cons_1(temp,temp_1);
...
Object compile_options_for_item_reference_for_slot varargs_1(int, n)
{
	...
	return copy_tree_using_gensym_conses_1(CDR(parse_result));
    else
	return gensym_cons_1(copy_tree_using_gensym_conses_1(parse_result),
		Nil);
}
...
Object No_grouping_tag_for_grouping_specification = UNBOUND;
...
Object List_of_gsi_values_to_process_head = UNBOUND;

Object List_of_gsi_values_to_process_tail = UNBOUND;

Object Task_to_process_gsi_values = UNBOUND;

Object Task_to_process_gsi_interfaces = UNBOUND;

Object Task_scheduled_to_process_gsi_values_qm = UNBOUND;
...
Object Max_gsi_sensors_in_a_group = UNBOUND;

Object The_type_description_of_sensor_group = UNBOUND;

Object Chain_of_available_sensor_groups = UNBOUND;

Object Sensor_group_count = UNBOUND;
    ...
    Object sensor_group;
{
    ...
    svref_new_value = Chain_of_available_sensor_groups;
    SVREF(sensor_group,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_sensor_groups = sensor_group;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_sensor_group_variable, sensor_group_count_new_value;
    ...
    sensor_group_count_new_value = FIXNUM_ADD1(Sensor_group_count);
    Sensor_group_count = sensor_group_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_sensor_groups_headers = UNBOUND;

Object Sensor_groups_header_count = UNBOUND;
    ...
    Object sensor_groups_header;
{
    ...
    svref_new_value = Chain_of_available_sensor_groups_headers;
    SVREF(sensor_groups_header,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_sensor_groups_headers = sensor_groups_header;
    return VALUES_1(Nil);
}
...
Object make_permanent_sensor_groups_header_structure_internal()
{
    ...
    Object sensor_groups_header_count_new_value;
    ...
    sensor_groups_header_count_new_value = 
	    FIXNUM_ADD1(Sensor_groups_header_count);
    Sensor_groups_header_count = sensor_groups_header_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object List_of_all_gsi_interfaces = UNBOUND;

Object Gsi_interfaces_to_process_head = UNBOUND;

Object Gsi_interfaces_to_process_tail = UNBOUND;
    ...
    Object sensor;
{
	...
	PUSH_SPECIAL(Deregister_and_register_item_p,deregister_and_register_item_p,
		0);
...
Object maybe_declare_all_gsi_sensors()
{
	...
	ab_loopvar__1 = Nil;
	sensor = Nil;
	PUSH_SPECIAL(Scope_conses,scope_conses,12);
    ...
    Object gsi_sensor, error_code;
{
    ...
    Object svref_new_value, def_structure_schedule_task_variable, task, ctask;
    Object p, v, q, def_structure_queue_element_variable, gensymed_symbol_4;
    Object temp_1;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
	...
	if ( !TRUEP(expiration_time) || EQ(expiration_time,Qnever) || 
		...
		if (FIXNUM_EQ(value,Truth))
		    ...
		    sensor_status_value = gensym_cons_1(value,Qtruth_value);
	    }
	    else
		sensor_status_value = 
	...
	if (simplep)
	    ...
	    queue_entry = gensym_list_4(sensor_status,error_code,Qnever,Nil);
	    gensymed_symbol = queue_entry;
	    gensymed_symbol = gensym_cons_1(gensymed_symbol,Nil);
	    if (List_of_gsi_values_to_process_head) {
		if ( !TRUEP(List_of_gsi_values_to_process_tail))
		    List_of_gsi_values_to_process_tail = 
			    last(List_of_gsi_values_to_process_head,_);
		temp = List_of_gsi_values_to_process_tail;
		M_CDR(temp) = gensymed_symbol;
	    }
	    else
		List_of_gsi_values_to_process_head = gensymed_symbol;
	    List_of_gsi_values_to_process_tail = gensymed_symbol;
		...
		current_task_schedule_modify_arg_2 = 
			ISVREF(Data_server_parameters,(SI_Long)22L);
		current_task_schedule_modify_arg_8 = 
			SYMBOL_FUNCTION(Qprocess_gsi_sensor_values);
		if (Task_to_process_gsi_values) {
		    if (EQ(Task_to_process_gsi_values,Current_schedule_task))
			Current_schedule_task = Nil;
		    if (ISVREF(Task_to_process_gsi_values,(SI_Long)6L))
			cancel_and_reclaim_scheduled_queue_element_1(Task_to_process_gsi_values);
		    inline_note_reclaim_cons(Task_to_process_gsi_values,Nil);
		    old_structure_being_reclaimed = Structure_being_reclaimed;
		    Structure_being_reclaimed = Task_to_process_gsi_values;
		    reclaim_schedule_task_args(ISVREF(Task_to_process_gsi_values,
			    (SI_Long)9L));
		    temp = Task_to_process_gsi_values;
		...
		SVREF(def_structure_queue_element_variable,
			FIX((SI_Long)2L)) = task;
		gensymed_symbol_4 = def_structure_queue_element_variable;
		SVREF(gensymed_symbol,FIX((SI_Long)0L)) = gensymed_symbol_4;
		SVREF(q,FIX((SI_Long)1L)) = gensymed_symbol_4;
		SVREF(task,FIX((SI_Long)6L)) = gensymed_symbol_4;
		if (ctask && FIXNUM_LT(p,Priority_of_next_task))
		    Priority_of_next_task = p;
		Task_to_process_gsi_values = task;
	    }
	}
    }
    ...
    Object value_vector_qm;
{
    ...
    Object g2_sensor_p, no_error_p, queue_entry, temp_1;
    Object current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8, old_structure_being_reclaimed;
    Object svref_new_value_1, def_structure_schedule_task_variable, task;
    Object ctask, p, v, q, def_structure_queue_element_variable;
    SI_Long superior_class_bit_number, sub_class_vector_index;
	...
	if (value_qm || value_vector_qm) {
	    queue_entry = gensym_list_4(gsi_sensor,value_qm,
		    collection_time_qm,value_vector_qm);
	    gensymed_symbol = queue_entry;
	    gensymed_symbol = gensym_cons_1(gensymed_symbol,Nil);
	    if (List_of_gsi_values_to_process_head) {
		if ( !TRUEP(List_of_gsi_values_to_process_tail))
		    List_of_gsi_values_to_process_tail = 
			    last(List_of_gsi_values_to_process_head,_);
		temp_1 = List_of_gsi_values_to_process_tail;
		...
		if (Task_to_process_gsi_values) {
		    ...
		    reclaim_schedule_task_args(ISVREF(Task_to_process_gsi_values,
			    (SI_Long)9L));
		    temp_1 = Task_to_process_gsi_values;
		    SVREF(temp_1,FIX((SI_Long)9L)) = Nil;
		    Structure_being_reclaimed = old_structure_being_reclaimed;
		    temp_1 = Task_to_process_gsi_values;
		    svref_new_value_1 = Chain_of_available_schedule_tasks;
		    SVREF(temp_1,FIX((SI_Long)0L)) = svref_new_value_1;
		    Chain_of_available_schedule_tasks = 
			    Task_to_process_gsi_values;
		}
		def_structure_schedule_task_variable = 
    ...
    Object ok_to_put_values_qm;
{
    ...
    Object value_vector_qm, current_computation_frame, gensymed_symbol;
    Object gensymed_symbol_1, temp, x2, sub_class_bit_vector, vector_element;
    Object ab_loop_list_, slot_name, new_slot_value_qm;
    Object new_slot_collection_time_qm, current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8, old_structure_being_reclaimed;
    Object temp_2, svref_new_value, def_structure_schedule_task_variable, task;
    Object ctask, p, v, q, def_structure_queue_element_variable;
	...
	if ( !TRUEP(CAR(List_of_gsi_values_to_process_head)))
	    goto end_loop;
	gensymed_symbol = List_of_gsi_values_to_process_head;
	gensymed_symbol_1 = Nil;
	if (gensymed_symbol) {
	    temp = CAR(gensymed_symbol);
	    gensymed_symbol_1 = CDR(gensymed_symbol);
	    List_of_gsi_values_to_process_head = gensymed_symbol_1;
	    if ( !TRUEP(gensymed_symbol_1))
		List_of_gsi_values_to_process_tail = Nil;
	    reclaim_gensym_cons_1(gensymed_symbol);
	    g2_sensor_value_list = temp;
	}
	else
	    g2_sensor_value_list = Nil;
	...
	reclaim_gensym_list_1(g2_sensor_value_list);
	...
	if (CAR(List_of_gsi_values_to_process_head)) {
		...
		reclaim_schedule_task_args(ISVREF(Task_to_process_gsi_values,
			(SI_Long)9L));
		temp_2 = Task_to_process_gsi_values;
		SVREF(temp_2,FIX((SI_Long)9L)) = Nil;
		Structure_being_reclaimed = old_structure_being_reclaimed;
		temp_2 = Task_to_process_gsi_values;
		svref_new_value = Chain_of_available_schedule_tasks;
		SVREF(temp_2,FIX((SI_Long)0L)) = svref_new_value;
		Chain_of_available_schedule_tasks = Task_to_process_gsi_values;
	    }
	    def_structure_schedule_task_variable = 
		    Chain_of_available_schedule_tasks;
	    if (def_structure_schedule_task_variable) {
    ...
    Object frame, slot_name, value, collection_time_qm;
{
    ...
    Object problem_string_qm, gensymed_symbol_4, gensymed_symbol_5, type;
    Object temp_1, index_1, unqualified_name, class_qualifier;
    Object attribute_description_qm, current_value, error_string_qm;
    Object current_size;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3, length_1;
    char temp;
    XDeclare_area(1);
    XDeclare_frontier(1);
	...
	if ( !temp)
	    ...
	    temp = FIXNUMP(gensymed_symbol_4);
	    if (temp);
	    else
		temp = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_4) != 
			(SI_Long)0L ? 
			IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_4)) 
			== (SI_Long)1L : TRUEP(Qnil);
	    if (temp);
	    else
		temp = INLINE_LONG_VECTOR_P(gensymed_symbol_4) != 
			(SI_Long)0L ? 
			IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_4)) 
			== (SI_Long)1L : TRUEP(Qnil);
	    if (temp);
	    else
		temp = gensymed_symbol_4 ? SYMBOLP(gensymed_symbol_4) : 
			TRUEP(Qnil);
	    if (temp);
	    else
		temp = INLINE_UNSIGNED_BYTE_16_VECTOR_P(gensymed_symbol_4) 
			!= (SI_Long)0L;
	    if (temp);
	    else if (CONSP(gensymed_symbol_4)) {
		gensymed_symbol_4 = M_CDR(gensymed_symbol_4);
		temp = EQ(gensymed_symbol_4,Qtruth_value);
		if (temp);
		else
		    temp = EQ(gensymed_symbol_4,Qiteration_state);
		if (temp);
		...
		if (EQ(type,Qvalue))
		    ...
		    temp_1 = type;
		if ( !TRUEP(type_specification_type_p(value,temp_1)))
		    problem_string_qm = tformat_text_string(3,
...
Object Icp_sockets_now_initializing_gsi = UNBOUND;
    ...
    Object icp_socket, process_initialization_string, interface_struct;
{
    ...
    PUSH_SPECIAL(Current_icp_port,current_icp_port,23);
      current_icp_socket = ISVREF(Current_icp_port,(SI_Long)2L);
      PUSH_SPECIAL(Current_icp_socket,current_icp_socket,22);
	...
	PUSH_SPECIAL(Disable_resumability,disable_resumability,21);
	  ...
	  PUSH_SPECIAL(Number_of_icp_bytes_for_message_series,number_of_icp_bytes_for_message_series,
		...
		PUSH_SPECIAL(Icp_byte_position_of_start_of_message_series_qm,icp_byte_position_of_start_of_message_series_qm,
		  ...
		  PUSH_SPECIAL(Number_of_icp_bytes_to_fill_buffer,number_of_icp_bytes_to_fill_buffer,
			  16);
		    current_icp_buffer = Nil;
		    PUSH_SPECIAL(Current_icp_buffer,current_icp_buffer,15);
		      current_write_icp_byte_position = Nil;
		      PUSH_SPECIAL(Current_write_icp_byte_position,current_write_icp_byte_position,
			      14);
			number_of_icp_bytes_in_message_group = 
...
Object Maintaining_gsi_interface_status_changed_p = UNBOUND;

Object Gsi_interface_status_changed_p = UNBOUND;
...
Object Gsi_connection_checkup_interval_in_ms = UNBOUND;
    ...
    Object gsi_interface_frame;
{
	...
	if (interface_name_or_names_qm) {
		...
		end_loop:
		  ...
		  ab_loopvar__4 = gensym_cons_1(sensor,Nil);
		  if (ab_loopvar__3)
	...
	goto next_loop_2;
      end_loop_2:;
	return reclaim_gensym_list_1(begin_collecting_data_list);
    }
    else
	return VALUES_1(Nil);
}
...
static Object Qgsi_application_name;  /* gsi-application-name */
    ...
    Object icp_socket, already_initialized_p;
{
    ...
    List_of_all_gsi_interfaces = gensym_cons_1(gsi_interface_frame,
...
Object remove_pending_requests_from_gsi_interface(gsi_interface_frame)
    Object gsi_interface_frame;
{
    Object sensor_groups_header_qm, sensor_group_qm, gensymed_symbol;
    Object gensymed_symbol_1, temp, sensor_cons_qm, group_parameters_qm;
  ...
  next_loop:
	...
	gensymed_symbol = ISVREF(sensor_groups_header_qm,(SI_Long)1L);
	gensymed_symbol_1 = Nil;
	if (gensymed_symbol) {
	    temp = CAR(gensymed_symbol);
	    gensymed_symbol_1 = CDR(gensymed_symbol);
	    SVREF(sensor_groups_header_qm,FIX((SI_Long)1L)) = 
		    gensymed_symbol_1;
	    if ( !TRUEP(gensymed_symbol_1))
		SVREF(sensor_groups_header_qm,FIX((SI_Long)2L)) = Nil;
	    reclaim_gensym_cons_1(gensymed_symbol);
	    sensor_group_qm = temp;
	}
	else
	    sensor_group_qm = Nil;
    }
    ...
    sensor_cons_qm = Nil;
  next_loop_1:
    gensymed_symbol = ISVREF(sensor_group_qm,(SI_Long)4L);
    gensymed_symbol_1 = Nil;
    if (gensymed_symbol) {
	temp = CAR(gensymed_symbol);
	gensymed_symbol_1 = CDR(gensymed_symbol);
	SVREF(sensor_group_qm,FIX((SI_Long)4L)) = gensymed_symbol_1;
	if ( !TRUEP(gensymed_symbol_1))
	    SVREF(sensor_group_qm,FIX((SI_Long)5L)) = Nil;
	reclaim_gensym_cons_1(gensymed_symbol);
	sensor_cons_qm = temp;
    }
    else
	...
	goto end_loop_1;
    reclaim_gensym_cons_1(sensor_cons_qm);
    goto next_loop_1;
  end_loop_1:;
  ...
  end_loop_2:
	...
	reclaim_gensym_list_1(group_parameters_qm);
    ...
    Object icp_socket, clean_qm;
{
	...
	if (reason_for_shutdown_qm) {
	    ...
	    PUSH_SPECIAL(Warning_message_level,warning_message_level,7);
	      if ((SI_Long)3L <= IFIX(Warning_message_level) &&  
		      !TRUEP(Debugging_reset)) {
		  if ( !TRUEP(Defer_notifications_qm))
		      break_out_of_debug_messages();
...
Object stop_processing_on_gsi_interface(gsi_interface_frame)
    Object gsi_interface_frame;
{
    Object next_one_qm, good_ones, ab_loopvar_, ab_loopvar__1, gensymed_symbol;
    Object gensymed_symbol_1, temp, good_one, ab_loop_list_, cdr_arg;
    ...
    ab_loopvar__1 = Nil;
  next_loop:
    gensymed_symbol = Gsi_interfaces_to_process_head;
    gensymed_symbol_1 = Nil;
    if (gensymed_symbol) {
	temp = CAR(gensymed_symbol);
	gensymed_symbol_1 = CDR(gensymed_symbol);
	Gsi_interfaces_to_process_head = gensymed_symbol_1;
	if ( !TRUEP(gensymed_symbol_1))
	    Gsi_interfaces_to_process_tail = Nil;
	reclaim_gensym_cons_1(gensymed_symbol);
	next_one_qm = temp;
    }
    else
	...
	ab_loopvar__1 = gensym_cons_1(next_one_qm,Nil);
	if (ab_loopvar_)
  ...
  next_loop_1:
    ...
    gensymed_symbol = gensym_cons_1(gensymed_symbol,Nil);
    if (Gsi_interfaces_to_process_head) {
	if ( !TRUEP(Gsi_interfaces_to_process_tail))
	    Gsi_interfaces_to_process_tail = 
		    last(Gsi_interfaces_to_process_head,_);
	cdr_arg = Gsi_interfaces_to_process_tail;
	M_CDR(cdr_arg) = gensymed_symbol;
    }
    else
	Gsi_interfaces_to_process_head = gensymed_symbol;
    Gsi_interfaces_to_process_tail = gensymed_symbol;
    goto next_loop_1;
  end_loop_1:;
    reclaim_gensym_list_1(good_ones);
    List_of_all_gsi_interfaces = 
	    delete_gensym_element_1(gsi_interface_frame,
	    List_of_all_gsi_interfaces);
    ...
    Object icp_socket, clean_qm;
{
	...
	if (get_slot_value_if_any_function(gsi_interface_frame_qm,
	    ...
	    Remote_gsi_interface_list = 
		    delete_gensym_element_1(gsi_interface_frame_qm,
		    Remote_gsi_interface_list);
    ...
    Object gsi_interface;
{
	...
	PUSH_SPECIAL(Gsi_interface_status_changed_p,gsi_interface_status_changed_p,
		2);
	  PUSH_SPECIAL(Maintaining_gsi_interface_status_changed_p,maintaining_gsi_interface_status_changed_p,
		  1);
	    frame = gsi_interface;
	    sub_vector_qm = ISVREF(ISVREF(ISVREF(frame,(SI_Long)1L),
    ...
    Object gsi_interface;
{
	...
	Remote_gsi_interface_list = delete_gensym_element_1(gsi_interface,
		Remote_gsi_interface_list);
	...
	if (interface_icp_socket_qm &&  
	    ...
	    PUSH_SPECIAL(Icp_socket_transacting_message_group,icp_socket_transacting_message_group,
		    0);
    ...
    Object interface_object, icp_connection_forms, initializing_p;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	new_icp_connection_forms = gensym_cons_1(temp_2,
    ...
    Object gsi_interface, old_attributes, new_attributes;
{
    ...
    x_note_fn_call(219,132);
    designation = gensym_list_3(Qthe,Nil,list_constant_14);
    attribute = Nil;
...
Object deactivate_dataservice_for_gsi_data_service(gsi_data_service)
    Object gsi_data_service;
{
    Object sensor_status, schedule_task_qm, old_structure_being_reclaimed;
    Object svref_new_value_1, x2;
    SI_Long svref_new_value;
    char temp;

    x_note_fn_call(219,137);
    sensor_status = get_slot_value_if_any_function(gsi_data_service,
	    Qgsi_variable_status,Nil);
    ...
    schedule_task_qm = ISVREF(gsi_data_service,(SI_Long)40L);
    if (schedule_task_qm) {
	...
	Structure_being_reclaimed = old_structure_being_reclaimed;
	svref_new_value_1 = Chain_of_available_schedule_tasks;
	SVREF(schedule_task_qm,FIX((SI_Long)0L)) = svref_new_value_1;
	Chain_of_available_schedule_tasks = schedule_task_qm;
    }
    svref_new_value_1 = Nil;
    ISVREF(gsi_data_service,(SI_Long)40L) = svref_new_value_1;
    schedule_task_qm = ISVREF(gsi_data_service,(SI_Long)30L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value_1 = Nil;
    ISVREF(gsi_data_service,(SI_Long)30L) = svref_new_value_1;
    if (SIMPLE_VECTOR_P(sensor_status) && 
...
Object gsi_process_gsi_interfaces()
{
    ...
    Object new_float, second_1, minute, hour, day, month, year;
...
{
    Object new_list, interface_1, ab_loop_list_, interface_qm, gensymed_symbol;
    Object gensymed_symbol_1, temp, old_structure_being_reclaimed, temp_1;
    Object svref_new_value;

    x_note_fn_call(219,151);
    new_list = Qnil;
    interface_1 = Nil;
    ab_loop_list_ = List_of_all_gsi_interfaces;
  next_loop:
    ...
    if ((SI_Long)0L != (IFIX(ISVREF(interface_1,(SI_Long)4L)) & 
	    (SI_Long)16777216L))
	new_list = gensym_cons_1(interface_1,new_list);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(List_of_all_gsi_interfaces);
  ...
  end_loop_1:;
	...
	temp_1 = Task_to_process_gsi_values;
	svref_new_value = Chain_of_available_schedule_tasks;
	SVREF(temp_1,FIX((SI_Long)0L)) = svref_new_value;
	Chain_of_available_schedule_tasks = Task_to_process_gsi_values;
    }
    temp_1 = Nil;
    Task_to_process_gsi_values = temp_1;
    if (Task_to_process_gsi_interfaces) {
	if (EQ(Task_to_process_gsi_interfaces,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(Task_to_process_gsi_interfaces,(SI_Long)6L))
	    cancel_and_reclaim_scheduled_queue_element_1(Task_to_process_gsi_interfaces);
	inline_note_reclaim_cons(Task_to_process_gsi_interfaces,Nil);
	old_structure_being_reclaimed = Structure_being_reclaimed;
	Structure_being_reclaimed = Task_to_process_gsi_interfaces;
	reclaim_schedule_task_args(ISVREF(Task_to_process_gsi_interfaces,
		(SI_Long)9L));
	temp_1 = Task_to_process_gsi_interfaces;
	SVREF(temp_1,FIX((SI_Long)9L)) = Nil;
	Structure_being_reclaimed = old_structure_being_reclaimed;
	temp_1 = Task_to_process_gsi_interfaces;
	svref_new_value = Chain_of_available_schedule_tasks;
	SVREF(temp_1,FIX((SI_Long)0L)) = svref_new_value;
	Chain_of_available_schedule_tasks = Task_to_process_gsi_interfaces;
    }
    temp_1 = Nil;
    Task_to_process_gsi_interfaces = temp_1;
    return VALUES_1(Task_to_process_gsi_interfaces);
}
    ...
    Object sensor, value_to_set_qm, collection_interval;
{
    ...
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object schedule_task_qm, old_structure_being_reclaimed, temp_3;
    ...
    Object future_task_schedule_modify_arg_13;
    Object def_structure_schedule_task_variable, task, sensor_groups_header;
    Object existing_sensor_groups, gsi_sensor_group, ab_loop_list_;
    Object sensor_put_in_existing_group_qm, current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8, svref_new_value_1, ctask, p, v;
    Object q, def_structure_queue_element_variable, gensymed_symbol_6;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    SI_Long bv16_length, temp_2, aref_new_value, length_1;
    char temp, svref_new_value, g2_p;
    double future_task_schedule_modify_arg_3, aref_new_value_1;
	...
	if ( !TRUEP(gsi_interface_qm)) {
		...
		temp_3 = Nil;
		ISVREF(sensor,(SI_Long)40L) = temp_3;
		if (evaluation_quantity_gt(collection_interval,
		    ...
		    future_task_schedule_modify_arg_8 = 
			    SYMBOL_FUNCTION(Qenqueue_gsi_request_for_sensor);
		    future_task_schedule_modify_arg_11 = sensor;
		    future_task_schedule_modify_arg_12 = value_to_set_qm;
		    future_task_schedule_modify_arg_13 = collection_interval;
		    schedule_task_qm = ISVREF(sensor,(SI_Long)40L);
		    if (schedule_task_qm) {
			if (EQ(schedule_task_qm,Current_schedule_task))
			    Current_schedule_task = Nil;
		...
		if (evaluation_quantity_gt(collection_interval,
		    ...
		    future_task_schedule_modify_arg_3 = gensymed_symbol_4 
			    + gensymed_symbol_5;
		    future_task_schedule_modify_arg_4 = 
			    FIXNUMP(collection_interval) ? 
			    (double)IFIX(collection_interval) : 
			    DFLOAT_ISAREF_1(collection_interval,(SI_Long)0L);
		    future_task_schedule_modify_arg_8 = 
			    SYMBOL_FUNCTION(Qenqueue_gsi_request_for_sensor);
		    ...
		    SVREF(task,FIX((SI_Long)11L)) = 
			    future_task_schedule_modify_arg_11;
		    SVREF(task,FIX((SI_Long)12L)) = No_value_to_set;
		    SVREF(task,FIX((SI_Long)13L)) = Collect_one_now;
		    future_task_schedule_2(task);
		    ISVREF(sensor,(SI_Long)40L) = task;
		}
		if (value_to_set_qm ||  !((SI_Long)0L != 
		  ...
		  end_loop:
			...
			if ( !TRUEP(ISVREF(sensor_groups_header,
				...
				if ( !TRUEP(Gsi_interfaces_to_process_tail))
				    Gsi_interfaces_to_process_tail = 
					    last(Gsi_interfaces_to_process_head,
					    _);
				temp_3 = Gsi_interfaces_to_process_tail;
				M_CDR(temp_3) = gensymed_symbol;
			    }
			    else
				...
				current_task_schedule_modify_arg_2 = 
					ISVREF(Data_server_parameters,
					(SI_Long)22L);
				current_task_schedule_modify_arg_8 = 
					SYMBOL_FUNCTION(Qprocess_requests_for_gsi_interfaces);
				if (Task_to_process_gsi_interfaces) {
				    if (EQ(Task_to_process_gsi_interfaces,
					    Current_schedule_task))
					Current_schedule_task = Nil;
				    if (ISVREF(Task_to_process_gsi_interfaces,
					    (SI_Long)6L))
					cancel_and_reclaim_scheduled_queue_element_1(Task_to_process_gsi_interfaces);
				    inline_note_reclaim_cons(Task_to_process_gsi_interfaces,
					    Nil);
				    old_structure_being_reclaimed = 
					    Structure_being_reclaimed;
				    Structure_being_reclaimed = 
				    ...
				    reclaim_schedule_task_args(ISVREF(Task_to_process_gsi_interfaces,
					    (SI_Long)9L));
				    temp_3 = Task_to_process_gsi_interfaces;
				...
				SVREF(gensymed_symbol,FIX((SI_Long)0L)) = 
					gensymed_symbol_6;
				SVREF(q,FIX((SI_Long)1L)) = gensymed_symbol_6;
				SVREF(task,FIX((SI_Long)6L)) = 
					gensymed_symbol_6;
				if (ctask && FIXNUM_LT(p,
					Priority_of_next_task))
				    Priority_of_next_task = p;
				Task_to_process_gsi_interfaces = task;
			    }
			}
    ...
    Object interval_for_collection, sensor_group;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, gsi_sensor;
    Object temp_2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(219,158);
	...
	if (parameter_values_match_qm) {
	    ...
	    temp_2 = FIXNUM_ADD1(ISVREF(sensor_group,(SI_Long)6L));
	    SVREF(sensor_group,FIX((SI_Long)6L)) = temp_2;
	    gensymed_symbol_1 = gensym_cons_1(gsi_sensor,value_to_set_qm);
	    gensymed_symbol_1 = gensym_cons_1(gensymed_symbol_1,Nil);
	    if (ISVREF(sensor_group,(SI_Long)4L)) {
		if ( !TRUEP(ISVREF(sensor_group,(SI_Long)5L))) {
		    temp_2 = last(ISVREF(sensor_group,(SI_Long)4L),_);
		    SVREF(sensor_group,FIX((SI_Long)5L)) = temp_2;
		}
		temp_2 = ISVREF(sensor_group,(SI_Long)5L);
		M_CDR(temp_2) = gensymed_symbol_1;
	    }
	    else
		SVREF(sensor_group,FIX((SI_Long)4L)) = gensymed_symbol_1;
	    SVREF(sensor_group,FIX((SI_Long)5L)) = gensymed_symbol_1;
    ...
    Object value_to_set_qm, interval_for_collection;
{
    ...
    Object sensor_group_parameters, sensor_group, gsi_sensor, temp;
    Object gensymed_symbol_1;

    x_note_fn_call(219,159);
  ...
  end_1:;
    ...
    gensymed_symbol = gensym_cons_1(gsi_sensor,value_to_set_qm);
    gensymed_symbol = gensym_cons_1(gensymed_symbol,Nil);
    if (ISVREF(sensor_group,(SI_Long)4L)) {
	if ( !TRUEP(ISVREF(sensor_group,(SI_Long)5L))) {
	    temp = last(ISVREF(sensor_group,(SI_Long)4L),_);
	    SVREF(sensor_group,FIX((SI_Long)5L)) = temp;
	}
	temp = ISVREF(sensor_group,(SI_Long)5L);
	M_CDR(temp) = gensymed_symbol;
    }
    else
	SVREF(sensor_group,FIX((SI_Long)4L)) = gensymed_symbol;
    SVREF(sensor_group,FIX((SI_Long)5L)) = gensymed_symbol;
    gensymed_symbol = sensor_group;
    gensymed_symbol_1 = gensym_cons_1(gensymed_symbol,Nil);
    if (ISVREF(sensor_groups_header,(SI_Long)1L)) {
	if ( !TRUEP(ISVREF(sensor_groups_header,(SI_Long)2L))) {
	    temp = last(ISVREF(sensor_groups_header,(SI_Long)1L),_);
	    SVREF(sensor_groups_header,FIX((SI_Long)2L)) = temp;
	}
	temp = ISVREF(sensor_groups_header,(SI_Long)2L);
	M_CDR(temp) = gensymed_symbol_1;
    }
    else
	SVREF(sensor_groups_header,FIX((SI_Long)1L)) = gensymed_symbol_1;
    SVREF(sensor_groups_header,FIX((SI_Long)2L)) = gensymed_symbol_1;
    return VALUES_1(gensymed_symbol);
}
    ...
    Object sensor, gsi_interface;
{
    ...
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object temp_1, schedule_task_qm, old_structure_being_reclaimed;
    Object svref_new_value;
	...
	if (get_slot_value_if_any_function(gsi_interface,
		...
		svref_new_value = Nil;
		ISVREF(sensor,(SI_Long)40L) = svref_new_value;
	    }
	}
...
Object process_requests_for_gsi_interfaces()
{
    ...
    Object icp_socket_open_qm, gensymed_symbol, gensymed_symbol_1, temp;
    Object sensor_groups_header, gsi_request_to_send, cdr_arg;
    SI_Long count_1;

    x_note_fn_call(219,165);
  ...
  next_loop:
	...
	if (interface_icp_socket_qm && icp_socket_open_qm) {
		...
		gsi_request_to_send = Nil;
	      next_loop_1:
		gensymed_symbol = ISVREF(sensor_groups_header,(SI_Long)1L);
		gensymed_symbol_1 = Nil;
		if (gensymed_symbol) {
		    temp = CAR(gensymed_symbol);
		    gensymed_symbol_1 = CDR(gensymed_symbol);
		    SVREF(sensor_groups_header,FIX((SI_Long)1L)) = 
			    gensymed_symbol_1;
		    if ( !TRUEP(gensymed_symbol_1))
			SVREF(sensor_groups_header,FIX((SI_Long)2L)) = Nil;
		    reclaim_gensym_cons_1(gensymed_symbol);
		    gsi_request_to_send = temp;
		}
		else
		    gsi_request_to_send = Nil;
...
{
    Object gensymed_symbol, old_star_current_computation_frame_star;
    Object name_or_names_qm, parameter_value_qm, gensymed_symbol_1;
    Object gensymed_symbol_4, sub_class_bit_vector;
    Object old_star_current_computation_frame_star_1;
	...
	if ( !TRUEP(parameter_value_qm))
	    ...
	    gensymed_symbol_1 = parameter_value_qm;
		...
		if (temp) {
			...
			if (FIXNUM_EQ(value,Truth))
			    ...
			    gensymed_symbol = gensym_cons_1(value,
				    Qtruth_value);
		    }
		    else
			gensymed_symbol = 
    ...
    Object gsi_request_to_send, gsi_interface;
{
    ...
    Object gensymed_symbol_3, gensymed_symbol_4, parameters_list, parameter;
    Object ab_loop_list_;
    double gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_5;
    double gensymed_symbol_6, gensymed_symbol_7, aref_new_value;
    Declare_special(13);

    x_note_fn_call(219,167);
    ...
    PUSH_SPECIAL(Use_new_message_group_for_send_icp_enlarge_index_space_p,use_new_message_group_for_send_icp_enlarge_index_space_p,
	    12);
				...
				PUSH_SPECIAL(Writing_icp_message_group,writing_icp_message_group,
				  ...
				  if (icp_connection_open_p(Current_icp_socket) 
				    ...
				    next_loop:
					  ...
					  temp = CAR(gensymed_symbol_3);
					  gensymed_symbol_4 = 
						  CDR(gensymed_symbol_3);
					  ...
					  if ( !TRUEP(gensymed_symbol_4))
					      SVREF(gsi_request_to_send,
						      FIX((SI_Long)5L)) = Nil;
					  reclaim_gensym_cons_1(gensymed_symbol_3);
					  sensor_list_element_cons = temp;
				      }
				      else
					  sensor_list_element_cons = Nil;
				      ...
				      if (value_to_set_qm)
					  reclaim_evaluation_value(value_to_set_qm);
				      reclaim_gensym_cons_1(sensor_list_element_cons);
				      goto next_loop;
				    end_loop:
				      parameters_list = 
					      ISVREF(gsi_request_to_send,
				    ...
				    end_loop_1:
				      SVREF(gsi_request_to_send,
					      FIX((SI_Long)1L)) = Nil;
				      reclaim_gensym_list_1(parameters_list);
    ...
    Object gsi_interface_qm, year, month, day, hour, minute, second_1, status;
{
    ...
    Object gsi_interface_socket, svref_new_value, schedule_task_qm;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		gsi_interface_socket = 
			get_slot_value_if_any_function(gsi_interface_frame,
			Qgsi_interface_icp_socket,Nil);
		svref_new_value = Gsi_connection_established;
		SVREF(gsi_interface_socket,FIX((SI_Long)28L)) = 
			svref_new_value;
		schedule_task_qm = ISVREF(gsi_interface_socket,(SI_Long)16L);
		if (schedule_task_qm) {
		    if (EQ(schedule_task_qm,Current_schedule_task))
			Current_schedule_task = Nil;
		    if (ISVREF(schedule_task_qm,(SI_Long)6L))
		...
		svref_new_value = Nil;
		SVREF(gsi_interface_socket,FIX((SI_Long)16L)) = 
			svref_new_value;
...
void g2_gsi_INIT()
{
    ...
    Object Qg2_gsi, Qicp_sockets_now_initializing_gsi;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qgsi_interfaces_to_process_tail, Qgsi_interfaces_to_process_head;
    Object Qlist_of_all_gsi_interfaces, Qsensor_groups_header;
    ...
    Object Qsensor_groups_header_count;
    Object Qchain_of_available_sensor_groups_headers, string_constant_142;
    ...
    Object Qsensor_group_structure_memory_usage, Qsensor_group_count;
    Object Qchain_of_available_sensor_groups, string_constant_140;
    Object string_constant_139, Qmax_gsi_sensors_in_a_group;
    Object Qtask_scheduled_to_process_gsi_values_qm;
    Object Qtask_to_process_gsi_interfaces, Qtask_to_process_gsi_values;
    Object Qlist_of_gsi_values_to_process_tail;
    Object Qlist_of_gsi_values_to_process_head;
    Object Qnote_name_change_for_gsi_data_service, string_constant_138;
    Object Qslot_value_writer, Qwrite_gsi_interface_name_from_slot;
    Object list_constant_78, list_constant_77, list_constant_76;
    Object list_constant_75, list_constant_74, Qput_data_server_for_messages;
    ...
    Object Qgsi_icp_interface_structure_memory_usage, Qgsi_icp_interface_count;
    Object Qchain_of_available_gsi_icp_interfaces, string_constant_73;
    Object string_constant_72, Qoptional_modules, Qab, Qstring_or_symbol_equal;

    x_note_fn_call(219,169);
    SET_PACKAGE("AB");
    ...
    string_constant_72 = 
	    STATIC_STRING("43Dy8m83iMy1n83iMy8n8k1l8n0000001l1n8y83-4By1o83--xy83-*+y83--vy83--wykuk0k0");
    ...
    Qgsi_icp_interface_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_73 = STATIC_STRING("1q83iMy8s83-Wmy09k9l");
    ...
    string_constant_84 = 
	    STATIC_STRING("13Cy4z8r83R4y83R4y83=8y83=8y01n02l835jyk+s3-gy3-hy3-gy3-Xykko3A++y001n1l8l1n8p83Cay83Gy1l83Cy000004z8r83C*y83C*y83=8y83=8y00001o");
    string_constant_85 = 
    ...
    string_constant_86 = 
	    STATIC_STRING("8p839=y1l83Cy000004z8r83Ejy83Ejy83=8y83=8y0+skkkkkkk3A++y001o1l8l1l8z1m8p839oy1l83Cy000004z8r83R2y83R2y83=8y83=8y083Py001o1l8l1l");
    string_constant_87 = 
	    STATIC_STRING("8z1m8p83CZy1l83Cy000004z8r83R7y83R7y83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r83RFy83RFy83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r");
    string_constant_88 = 
	    STATIC_STRING("83RCy83RCy83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r83RAy83RAy83=8y83=8y0k001o1l8l1m8p83RBy1l83Hy1l83Fy000004z8r83R8y83R8y83=8y83");
    string_constant_89 = 
	    STATIC_STRING("=8y00001o1l8l1m8p83Ky1l83Hy1l83Fy000004z8r83R6y83R6y83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r83D7y83D7y83=8y83=8y00001o1l8l1l8z1");
    string_constant_90 = 
	    STATIC_STRING("m8p833by1l83Cy000004z8r83c6y83c6y83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r83S6y83S6y83=8y83=8y00001n1l8l1l83Ny1l83Hy000004z8r83R");
    string_constant_91 = 
	    STATIC_STRING("9y83R9y83=8y83=8y00001o1l83Ey1l8l1l83Ny1l83Hy00000");
    string_constant_92 = 
	    STATIC_STRING("13Ey8q1p83=8y1l8328y1m8v83-Oy1o830by8301y8304y8305y8t1p83R4y1n02l835jyk5onone1l8l1n8p83Cay83Gy1l83Cy1q83C*y01l8l8z1m8p83Ky1l83Cy");
    string_constant_93 = 
	    STATIC_STRING("1q83ENy01l8l8z1m8p83Ky1l83Cy1q83CYy83E0y1l8l8z1m8p839=y1l83Cy1q83Ejy5k1l8l8z1m8p839oy1l83Cy1q83R2y83Py1l8l8z1m8p83CZy1l83Cy1p83R");
    string_constant_94 = 
	    STATIC_STRING("7y01l8l1l83Ny1l83Hy1p83RFy01l8l1l83Ny1l83Hy1p83RCy01l8l1l83Ny1l83Hy1q83RAyk1l8l1m8p83RBy1l83Hy1l83Fy1q83R8y01l8l1m8p83Ky1l83Hy1l");
    string_constant_95 = 
	    STATIC_STRING("83Fy1p83R6y01l8l1l83Ny1l83Hy1q83D7y01l8l8z1m8p833by1l83Cy1p83c6y01l8l1l83Ny1l83Hy1p83S6y08l1l83Ny1l83Hy1q83R9y01l83Ey1l8l1l83Ny1");
    ...
    string_constant_98 = 
	    STATIC_STRING("1o4z8r8u8u839sy839sy01p8w9k3-My3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1m3");
    string_constant_99 = 
    ...
    string_constant_101 = 
	    STATIC_STRING("1n1m3-Cy3ky1mn3hy1m3-9y3hy9l1p83Jy1mkk1mk3ky1m3-Cy3ky1m3-Cyk1o83Gy+3Cy3-Ey3-1y3-9y3-By3-Gy3-1ykkkkkkkkq3A++y1mu3Hy83-Wy1o83Gy+s3");
    string_constant_102 = 
	    STATIC_STRING("fy3-5y3-Gy3-1y3-9ykp3A++y1m3Ey3Vy83-Wy1o83Oy1m3-6yp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3-6y3fy1m3-6yp001o1l8l1l8o1l8z1m83Dy53YySee comm");
    string_constant_103 = 
	    STATIC_STRING("ent on ENTITY class definition000004z8r83Svy83Svy839sy839sy00001n1l8l1m8p83=Ky1l83Ny000004z8r83Swy83Swy839sy839sy00001n1l8l1m8p8");
    string_constant_104 = 
	    STATIC_STRING("3=oy1l83Ny000004z8r83Ssy83Ssy839sy839sy00001n1l8l1m8p83=oy1l83Ny00000");
    string_constant_105 = 
	    STATIC_STRING("1q8q1o839sy1m83-+y83Ry1m8v839sy8t1m8u1p8w9k3-My3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83");
    string_constant_106 = 
    ...
    string_constant_108 = 
	    STATIC_STRING("1m3-9yn1m3-Cy3ky1n1m3-Cy3ky1mn3hy1m3-9y3hy9l1p83Jy1mkk1mk3ky1m3-Cy3ky1m3-Cyk1o83Gy5qREMOTE1mu3Hy83-Wy1o83Gy5p-ITEM1m3Ey3Vy83-Wy1");
    string_constant_109 = 
	    STATIC_STRING("o83Oy1m3-6yp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3-6y3fy1m3-6yp1p83Svy01l8l1m8p83=Ky1l83Ny1p83Swy01l8l1m8p83=oy1l83Ny1p83Ssy01l8l1m8p83=");
    ...
    string_constant_112 = 
	    STATIC_STRING("1p1m832uy1m9k83Zy1m832uy83-buy1m83-buy83-7Ny1o83-buy1n83-7Ny1m9k83vy83-buy1nmln9l1m83-7Ny836Iy");
    clear_optimized_constants();
    ...
    string_constant_113 = 
	    STATIC_STRING("13Hy1m839ay1m9k83Zy1m839ay83-guy1o839ay1n83-guy1m9k83-ay839ay1nmln9l1m83-guy83-XWy1m83-guy83-f1y1m83-guy83-MTy1m83-guy83-k9y1m83");
    string_constant_114 = 
	    STATIC_STRING("-guy83-k7y1n83-XWy1o1m9k83-n2y1m9k83jWy1m9k83*uy1m9k83-jRy1m83-Oay8k1n83-XWy1n1m9k83=Ty1m9k9m1m9k83t9y1m83-Oay01n83-f1y1n1m9k83=");
    string_constant_115 = 
	    STATIC_STRING("hy1m9k83-Yly1m9k9m1m9n8k1n83-f1y1p1m9k83=hy1m9k83-Yly1m9k9m1m9k83ALy1m9k83ULy1m9n83-tdy1n83-f1y1n1m9k83=Ty1m9k83=hy1m9k83t9y1m9n");
    string_constant_116 = 
	    STATIC_STRING("01n83-MTy1r1m9k83AMy1m9k83-Gy83jSy1m9k83=Iy1m9k83-fry1m9k83ULy1m9k83jWy1n83-fvyn01n83-MTy1u1m9k83AMy1m9k83-iPy9o1m9k83=Iy1m9k9p1");
    string_constant_117 = 
	    STATIC_STRING("m9k83-Gy1m9k83-Ty1m9k83-fry1m9k83ULy1m9k83jWy1n83-fvy0n1n83-MTy1z1m9k83AMy1m9k83-iPy9o1m9k83=Iy1m9k9p1m9k83-Gy1m9k83-Ty1m9k83-fr");
    string_constant_118 = 
	    STATIC_STRING("y1m9k83ULy1m9k83jWy1m9k83vy1m9k83=Fy1m9k83Py1m9k83-Gy83jSy1n83-fvyzn1n83-MTy1n1m9k83=Ty1m9k83-Gy1m9k83t9y1n83-fvy001n83-k9y1q1m9");
    string_constant_119 = 
	    STATIC_STRING("k83-2fy1m9k837by1m9k83-kCy1m9k83Fmy1m9k83-Y8y1m9k83Gry1m83-k8y8k1n83-k9y1p1m9k830Iy1m9k9q1m9k83-2fy1m9k837by1m9k83-kCy1m83-k8y01");
    string_constant_120 = 
	    STATIC_STRING("n83-k7y1p1m9k83Iqy1m9k83-kCy1m9k83Fmy1m9k83-PKy1m9k83Gry1m83-k6y8k1n83-k7y1o1m9k830Iy1m9k9q1m9k83Iqy1m9k83-kCy1m83-k6y0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qsimplify_associative_operation);
    ...
    string_constant_121 = 
	    STATIC_STRING("1r1o839=y1o1m9k83-Wfy1m9k83-l4y1m9k83*uy83-c2y1m83vyo9l1n839=y1m1m9k83=Ty1m9k83-Why83E0y1m83-KFy1m9k83Zy1m83-KFy83-c2y1m83-c2y83");
    string_constant_122 = 
	    STATIC_STRING("-Wty1o83-c2y1n83-Wty1m9k83vy83-c2y1nmln9l1m83-Wty83djy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qsimplify_associative_operation);
    ...
    string_constant_123 = 
	    STATIC_STRING("1o1m83AEy833by1n83AEy1m9k83-Fry83-Fry1m833by83-oy1n833by1m1m9k83AMy1m9k83Py83Py");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qtimeout_interval_or_default_or_none,
	    ...
	    Qslot_value_writer);
    string_constant_124 = 
	    STATIC_STRING("1t1m83-*Oy83-6y1m83-7Oy83-6y1m83-EXy83Sy1m83wMy83-Uy1m83iay83-Uy1m839oy83-Uy1m83Cay1m9k83Zy1n83Cay1p1m9k83bcy1m9k83Rdy83iay1m9k8");
    string_constant_125 = 
	    STATIC_STRING("3Y+y83-EXy1o83bcynp01n83Cay1r1m9k83bcy1m9k83Rdy83iay1m9k83Y+y83-EXy1m9k83-CXy83Ky1o83bcynpr");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_128 = 
	    STATIC_STRING("8r83=8y83=8y839-y839-y00001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83REy83REy839-y839-y00001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83R3y83R3y83");
    string_constant_129 = 
	    STATIC_STRING("9-y839-y0k001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83RDy83RDy839-y839-y00001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83RGy83RGy839-y839-y0k001o");
    string_constant_130 = STATIC_STRING("1l83Ey1l8l1l83Fy1m8p83RHy00000");
    string_constant_131 = 
    ...
    string_constant_132 = 
	    STATIC_STRING("83Ey1l8l1l83Ny1l83Hy1q83REy01l83Ey1l8l1l83Ny1l83Hy1q83R3yk1l83Ey1l8l1l83Ny1l83Hy1q83RDy01l83Ey1l8l1l83Ny1l83Hy1q83RGyk1l83Ey1l8l");
    string_constant_133 = STATIC_STRING("83Fy1m8p83RHy");
    ...
    string_constant_139 = 
	    STATIC_STRING("43Dy8m83mpy1n83mpy8n8k1l8n0000001l1n8y83-5oy1n83-Ccy83-Cdy83-Cbykrk0k0");
    ...
    string_constant_140 = STATIC_STRING("1q83mpy8s83-msy09k9l");
    clear_optimized_constants();
    ...
    string_constant_141 = 
	    STATIC_STRING("43Dy8m83mqy1n83mqy8n8k1l8n0000001l1m8y83-5pyknk0k0");
    ...
    Qsensor_groups_header_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_142 = STATIC_STRING("1q83mqy8s83-mty09k9l");
    clear_optimized_constants();
