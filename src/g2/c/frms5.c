    ...
    Object representation_frame, frame;
{
	...
	svref_new_value = gensym_cons_1(representation_frame,ISVREF(frame,
		(SI_Long)9L));
    ...
    Object representation_frame, frame;
{
    ...
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(frame,Qframe_representations);
    svref_new_value = delete_gensym_element_1(representation_frame,
    ...
    Object frame_representations, frame;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(frame_representations);
    return VALUES_1(Nil);
}

Object Namelike_slot_p_prop = UNBOUND;

Object Stack_of_slot_value_changes = UNBOUND;

Object Just_update_representations_of_slot_value = UNBOUND;

Object Suppress_updating_of_slot_value_representations_qm = UNBOUND;
    ...
    Object frame, new_frame_status, do_not_update_representations_qm;
{
	...
	if ( ! !TRUEP(new_frame_status)) {
	    if (Noting_changes_to_kb_p)
		note_change_to_block_1(frame,Qframe_status_and_notes);
	    svref_new_value = gensym_cons_1(new_frame_status,Nil);
...
Object Current_computation_component_particulars = UNBOUND;
    ...
    Object do_not_update_representations_qm;
{
	...
	if (temp);
	    ...
	    temp = gensym_cons_1(Nil,Nil);
	temp_1 = nconc2(temp,gensym_cons_1(type_of_note,
		gensym_cons_1(particulars,Nil)));
...
Object delete_frame_note_if_any_1(type_of_note,frame)
    Object type_of_note, frame;
{
    Object frame_status_and_notes, l, plist_tail, cdr_new_value, temp;

    x_note_fn_call(88,24);
    frame_status_and_notes = ISVREF(frame,(SI_Long)8L);
	...
	if (EQ(M_CAR(plist_tail),type_of_note)) {
		...
		if (Noting_changes_to_kb_p)
		    note_change_to_block_1(frame,Qframe_status_and_notes);
		SVREF(frame,FIX((SI_Long)8L)) = Nil;
		inline_note_reclaim_cons(frame_status_and_notes,Qab_gensym);
		cdr_new_value = Available_gensym_conses;
		M_CDR(frame_status_and_notes) = cdr_new_value;
		Available_gensym_conses = frame_status_and_notes;
	    }
	    update_representations_of_frame_notes(frame);
	    temp = type_of_note;
	    goto end_1;
    ...
    Object item, type_of_note, frame;
{
	...
	return add_frame_note_1(type_of_note,frame,
		nconc2(existing_particulars,gensym_cons_1(item,Nil)),Nil,Nil);
    else
	return VALUES_1(Nil);
}

Object Current_computation_frame = UNBOUND;
...
Object component_particulars_with_frame_notes()
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(component_particulars,Nil);
    if (ab_loopvar__1)
...
Object Frame_note_index_skip = UNBOUND;

Object Frame_note_index = UNBOUND;

Object Frame_note_index_has_been_written_qm = UNBOUND;

Object Frame_note_count = UNBOUND;

/* INITIAL-ITEM-NOTES */
Object initial_item_notes(class_1)
    Object class_1;
{
    x_note_fn_call(88,35);
    return VALUES_1(Nil);
}
    ...
    Object frame;
{
    ...
    x_note_fn_call(88,36);
    notes = Nil;
    frame_status_and_notes = ISVREF(frame,(SI_Long)8L);
    if (CDR(frame_status_and_notes)) {
	frame_note_index_skip = FIX((SI_Long)0L);
	PUSH_SPECIAL(Frame_note_index_skip,frame_note_index_skip,8);
	  frame_note_count = FIX(IFIX(length(CDR(frame_status_and_notes))) 
		  >>  -  - (SI_Long)1L);
	  PUSH_SPECIAL(Frame_note_count,frame_note_count,7);
	    index_1 = (SI_Long)1L;
	    frame_note_index = Nil;
	    PUSH_SPECIAL(Frame_note_index,frame_note_index,6);
	      frame_note_index_has_been_written_qm = Nil;
	      PUSH_SPECIAL(Frame_note_index_has_been_written_qm,frame_note_index_has_been_written_qm,
		      5);
		...
		PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
		  ...
		  POP_SPECIAL();
		POP_SPECIAL();
		notes = gensym_cons_1(note,notes);
		note = Nil;
		if (note)
...
Object Abbreviate_frame_notes_p = UNBOUND;
    ...
    Object frame, abbreviate_frame_notes_p;
{
    ...
    x_note_fn_call(88,38);
    PUSH_SPECIAL(Abbreviate_frame_notes_p,abbreviate_frame_notes_p,9);
      frame_status_and_notes = ISVREF(frame,(SI_Long)8L);
      if (CDR(frame_status_and_notes)) {
	  frame_note_index_skip = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Frame_note_index_skip,frame_note_index_skip,8);
    ...
    Object frame_notes_for_component_particulars, frame;
{
  ...
  next_loop:
    ...
    if (frame_notes) {
	frame_note_index_skip = FIX((SI_Long)0L);
	PUSH_SPECIAL(Frame_note_index_skip,frame_note_index_skip,2);
	  ...
	  index_1 = (SI_Long)1L;
	  frame_note_index = Nil;
	  PUSH_SPECIAL(Frame_note_index,frame_note_index,1);
	    frame_note_index_has_been_written_qm = Nil;
	    PUSH_SPECIAL(Frame_note_index_has_been_written_qm,frame_note_index_has_been_written_qm,
		    0);
	      ab_loop_iter_flag_ = T;
    ...
    Object component_particulars, frame;
{
	...
	new_component_particulars_entry_qm = 
		gensym_list_2(copy_for_slot_value(component_particulars),Nil);
	temp = nconc2(particulars_of_frame_notes_for_component_particulars,
		gensym_cons_1(new_component_particulars_entry_qm,Nil));
    ...
    Object particular, type_of_note, frame, component_particulars;
{
	...
	return add_frame_note_to_component_particulars(type_of_note,frame,
		...
		gensym_cons_1(particular,Nil)),Nil,Nil);
    else
	return VALUES_1(Nil);
}
...
Object Suppress_use_of_stack_of_slot_value_changes_p = UNBOUND;
...
{
    Object l, plist_tail, cdr_new_value, slot_description, new_cons;
...
{
    Object temp, slot_description, new_cons, gensymed_symbol;
    Object gensymed_symbol_1, cdr_new_value, stack_of_slot_value_changes;
    Object frame_note_type, ab_loop_list_, frame_and_slot_or_atom, ab_loop_it_;
    Object gensym_pop_store, cons_1, next_cons;
    char temp_1;
    Declare_special(1);

    x_note_fn_call(88,51);
    temp = ISVREF(frame,(SI_Long)8L);
    if (CDR(temp)) {
	slot_description = 
		get_slot_description_of_class_description_function(Qframe_status_and_notes,
    ...
    Object simple_string, length_of_simple_string;
{
	...
	if (temp);
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    return gensym_list_2(symbol_or_string,
		    non_empty_directory_of_names);
	else
	    return gensym_cons_1(symbol_or_string,
		    non_empty_directory_of_names);
    }
    else {
	character_1 = UBYTE_16_ISAREF_1(simple_string,IFIX(m));
	...
	if (temp) {
		...
		return gensym_list_2(non_empty_directory_of_names,
			symbol_or_string);
	}
	else {
	    l_trailer_qm = Nil;
	  ...
	  next_loop:
		...
		if (NUM_EQ(temp_2,temp_1)) {
		    ...
		    temp_4 = gensym_cons_1(symbol_or_string,l);
		    M_CDR(l_trailer_qm) = temp_4;
		}
		else
		    return gensym_cons_1(symbol_or_string,l);
	    ...
	    goto next_loop;
	  end_loop:
	    temp_4 = gensym_cons_1(symbol_or_string,Nil);
	    M_CDR(l_trailer_qm) = temp_4;
	    return VALUES_1(non_empty_directory_of_names);
	    return VALUES_1(Qnil);
	}
    ...
    Object symbol_or_string, simple_string, length_of_simple_string;
{
	...
	if (EQ(FIRST(non_empty_directory_of_names),symbol_or_string)) {
		...
		reclaim_gensym_cons_1(non_empty_directory_of_names);
		return VALUES_1(temp);
	    }
	    else {
		temp = SECOND(non_empty_directory_of_names);
		reclaim_gensym_list_1(non_empty_directory_of_names);
		return VALUES_1(temp);
	    }
	}
	else
...
Object Flattened_menu_reverse = UNBOUND;

Object Flattened_menu_maximum_remaining_elements = UNBOUND;
    ...
    Object directory_of_names;
{
	...
	if (temp);
		...
		Flattened_menu_reverse = gensym_cons_1(directory_of_names,
    ...
    Object return_partial_list_p;
{
    ...
    PUSH_SPECIAL(Flattened_menu_maximum_remaining_elements,flattened_menu_maximum_remaining_elements,
	    1);
      flattened_menu_reverse = Nil;
      PUSH_SPECIAL(Flattened_menu_reverse,flattened_menu_reverse,0);
	...
	if (few_enough_choices_p || return_partial_list_p)
	    ...
	    reclaim_gensym_list_1(Flattened_menu_reverse);
    ...
    Object namable_frame, new_name, initializing_qm;
{
	...
	new_value = ATOM(names) ? new_name : gensym_cons_1(new_name,
		copy_list_using_gensym_conses_1(CDR(names)));
	if (initializing_qm)
    ...
    Object namable_frame, new_name, initializing_qm;
{
	...
	if (temp)
	    ...
	    new_value = ATOM(names) ? gensym_list_2(names,new_name) : 
		    gensym_cons_1(CAR(names),gensym_cons_1(new_name,
		    CDDR(names)));
	    if (initializing_qm)
		return put_name_or_names_for_frame(namable_frame,new_value,
			initializing_qm);
    ...
    Object slot_component_indicator_qm;
{
    ...
    Object stack_of_slot_value_changes, pretty_slot_name, defining_class;
    Object do_not_reclaim_old_value_override_qm, old_value;
    Object do_not_reclaim_old_value_qm, slot_component_putter_qm, value;
    Object dont_reclaim_qm, temp, slot_putter_qm, list_1, vector_slot_index_qm;
    Object user_vector_slot_index_qm, slot_name, lookup_structure_qm;
    Object slot_index_qm, slot_features, sub_class_bit_vector;
	...
	gensymed_symbol_1 = nconc2(gensym_list_2(frame,slot_description),
		gensym_cons_1(slot_component_name_qm,
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  if (slot_component_name_qm || slot_component_indicator_qm) {
		  ...
		  temp = set_slot_component_value(frame,pretty_slot_name,
			  defining_class,slot_component_name_qm,
	...
	next_loop_2:
	  ...
	  ab_loop_it_ = temp_1 ? (EQ(frame,M_CAR(frame_and_slot_or_atom)) ?
		   T : Nil) : Nil;
	  if (ab_loop_it_) {
	      temp_1 = TRUEP(ab_loop_it_);
	      goto end_2;
...
Object Pseudo_class_slot_description = UNBOUND;
...
Object set_slot_value_and_update_representations varargs_1(int, n)
{
    Object frame, slot_name, new_value;
    Object defining_class_qm, slot_component_name_qm;
    Object slot_component_indicator_qm, slot_description, new_cons;
    Object gensymed_symbol, gensymed_symbol_1, cdr_new_value;
    Object stack_of_slot_value_changes, temp, frame_and_slot_or_atom;
    ...
    stack_of_slot_value_changes = gensymed_symbol;
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
      temp = set_slot_value_function(frame,slot_name,new_value,
	      defining_class_qm);
      temp_1 = TRUEP(Suppress_updating_of_slot_value_representations_qm);
      if (temp_1);
      else if (M_CDR(Stack_of_slot_value_changes)) {
...
Object Items_deleted_since_load_or_save = UNBOUND;

Object Items_deleted_since_load_or_save_tail = UNBOUND;
    ...
    Object item, frame_qm;
{
	...
	cdr_new_value = gensym_cons_1(frame_serial_number,Nil);
	...
	Items_deleted_since_load_or_save_tail = 
		gensym_cons_1(frame_serial_number,Nil);
...
Object reclaim_items_deleted_since_load_or_save()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(Items_deleted_since_load_or_save);
...
Object note_deletion_of_block_1(block)
    Object block;
{
    x_note_fn_call(88,89);
    note_deletion_of_block_2(block);
    return VALUES_1(Nil);
}

Object Blocks_with_relation_instances_from_kb_read = UNBOUND;
    ...
    Object frame;
{
    ...
    Object function_qm, gensymed_symbol_4, gensymed_symbol_5;
    ...
    if (ISVREF(ISVREF(frame,(SI_Long)1L),(SI_Long)16L) && ISVREF(frame,
	    (SI_Long)12L)) {
	if (Releasing_kb_qm) {
	    reclaim_relation_instances(ISVREF(frame,(SI_Long)12L));
	    if (Noting_changes_to_kb_p)
		note_change_to_block_1(frame,Qrelation_instances);
	    SVREF(frame,FIX((SI_Long)12L)) = Nil;
	}
	else {
...
Object Dynamic_menus_modification_tick = UNBOUND;
    ...
    Object compiled_parse_result, evaluation_value, evaluator_info;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_cons_1(compiled_parse_result,
...
void frames5_INIT()
{
    ...
    Object Qslot_value_compiler, Qcompile_uuid_for_slot, list_constant_12;
    ...
    Object Qnote_name_change_for_kb_workspace, Qframes5;
    Object Qdynamic_menus_modification_tick, Qmodule_assignment, Qinitialize;
    Object Qinitialize_for_kb_workspace, Qput_module_this_is_part_of_qm;
    Object Qwrite_module_name_qm_from_slot, Qmodule_name_qm, Qnamed;
    Object Qtype_specification_simple_expansion, list_constant_10, Qab_or;
    Object Qcompile_module_name_qm_for_slot, Qbackground_color;
    Object Qworkspace_background_color_qm, Qforeground_color;
    Object Qworkspace_foreground_color_qm, list_constant_15;
    Object string_constant_50, Qinitial_width, Qkb_workspace_initial_width;
    Object Qinitial_height, Qkb_workspace_initial_height, string_constant_49;
    ...
    Object list_constant_14, string_constant_36, string_constant_35;
    ...
    Object Qworkspace, Qitems_deleted_since_load_or_save_tail;
    Object Qitems_deleted_since_load_or_save;
    Object Qreclaim_name_or_names_for_frame_value, Qnote_name_change_for_block;
    Object Qgeneric_method_lambda_list, list_constant_13, Qinitializing_p;
    Object Qold_names, Qput_name_or_names_for_frame;
    Object Qframe_or_frames_with_this_name;
    ...
    Object Qreclaim_grammar_tree_function, string_constant_19;
    Object Qwrite_frame_status_and_notes_from_slot, Qget_item_notes;
    Object Qinitial_item_notes, list_constant_4, list_constant_11;
    Object list_constant_2, list_constant_9, Qno_item;
    Object Qvirtual_attributes_local_to_class, Qinferior_frame_note_types;
    Object Qcurrent_computation_frame, list_constant_8, list_constant_7;
    Object list_constant_6, list_constant_5;
    ...
    Object Qinitial_item_status, list_constant_3, Kwithin_putter;
    Object Kevent_updates, Qreclaim_frame_status_and_notes_value;
    Object Qjust_update_representations_of_slot_value;
    Object Qreclaim_slot_value_tree_function, Qstack_of_slot_value_changes;
    Object Qnamelike_slot_p, Qreclaim_frame_representations_value;

    x_note_fn_call(88,128);
    SET_PACKAGE("AB");
    ...
    list_constant_2 = STATIC_LIST((SI_Long)2L,Qab_class,Qblock);
    list_constant_3 = STATIC_LIST((SI_Long)4L,Qmember,Qok,Qincomplete,Qbad);
    Kevent_updates = STATIC_SYMBOL("EVENT-UPDATES",Pkeyword);
    Kwithin_putter = STATIC_SYMBOL("WITHIN-PUTTER",Pkeyword);
    list_constant_4 = STATIC_LIST((SI_Long)2L,Kevent_updates,Kwithin_putter);
    ...
    SET_SYMBOL_FUNCTION(Qget_item_status,STATIC_FUNCTION(get_item_status,
	    NIL,FALSE,1,1));
    add_virtual_attribute(Qitem_status,list_constant_2,list_constant_3,
	    list_constant_4,SYMBOL_FUNCTION(Qinitial_item_status),
    ...
    SET_SYMBOL_FUNCTION(Qget_item_active,STATIC_FUNCTION(get_item_active,
	    NIL,FALSE,1,1));
    add_virtual_attribute(Qitem_active,list_constant_2,Qtruth_value,
	    list_constant_4,SYMBOL_FUNCTION(Qinitial_item_active),
    ...
    add_virtual_attribute(Qcontaining_module,list_constant_2,Qsymbol,Qnil,
    ...
    list_constant_6 = STATIC_LIST_STAR((SI_Long)4L,
    ...
    list_constant_7 = STATIC_LIST_STAR((SI_Long)4L,
	    Qaction_for_user_menu_choice_qm,Qnil,
	    Qembedded_rule_in_user_menu_choice_qm,list_constant_5);
    list_constant_8 = STATIC_LIST((SI_Long)2L,list_constant_6,list_constant_7);
    List_of_embedding_slots = list_constant_8;
    Qembedded_rule_has_frame_notes = 
    ...
    list_constant_9 = STATIC_LIST((SI_Long)2L,Qsequence,Qtext);
    Qno_item = STATIC_SYMBOL("NO-ITEM",AB_package);
    list_constant_10 = STATIC_CONS(Qno_item,Qnil);
    list_constant_11 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_9,
	    list_constant_10);
    ...
    SET_SYMBOL_FUNCTION(Qget_item_notes,STATIC_FUNCTION(get_item_notes,NIL,
	    FALSE,1,1));
    add_virtual_attribute(Qitem_notes,list_constant_2,list_constant_11,
	    list_constant_4,SYMBOL_FUNCTION(Qinitial_item_notes),
    ...
    mutate_global_property(Qframe_notes_for_component_particulars,
	    write_frame_notes_for_component_particulars_note_1,
	    Qframe_note_writer_1);
    string_constant_19 = STATIC_STRING("nil");
    if (Directory_nil == UNBOUND)
	Directory_nil = make_symbol(string_constant_19);
    ...
    list_constant_13 = STATIC_LIST((SI_Long)3L,Qblock,Qold_names,
	    Qinitializing_p);
    Qgeneric_method_lambda_list = 
	    STATIC_SYMBOL("GENERIC-METHOD-LAMBDA-LIST",AB_package);
    mutate_global_property(Qnote_name_change,list_constant_13,
	    Qgeneric_method_lambda_list);
    ...
    list_constant_14 = STATIC_LIST((SI_Long)2L,Qitem,Qworkspace);
    check_if_superior_classes_are_defined(Qkb_workspace,list_constant_14);
    string_constant_20 = STATIC_STRING("1m1m8v83=uy1l8t");
    string_constant_21 = 
	    STATIC_STRING("1x4z8r83K4y83K4y83=uy83=uy00001o1l8o1l8l1l83Cy1m83Dy53hyBogus name. Part of tamper mechanism. Internal.000004z8r83SFy83SFy83=uy8");
    string_constant_22 = 
    ...
    string_constant_23 = 
	    STATIC_STRING("hange alias to just module \?000004z8r83DMy83DMy83=uy83=uy036uy001r1l83Ey1l8l1l83Cy1m8p83-Vy1l8z1l83Ny1m83Dy53-8yexport as initia");
    string_constant_24 = 
	    STATIC_STRING("l-workspace-width, (type positive-integer), writable = false000004z8r83DLy83DLy83=uy83=uy033my001r1l83Ey1l8l1l83Cy1l8z1m8p83-Vy1");
    string_constant_25 = 
    ...
    string_constant_35 = 
	    STATIC_STRING("my3-ry3-ey3-Xy3fy3-gy3-Ty3-fy3-Xy3by3xy000004z8r834ky834ky83=uy83=uy00001n1l8l1l8z1m8p833cy000004z8r83K3y83K3y83=uy83=uy00001o1l");
    string_constant_36 = 
	    STATIC_STRING("8o1l8l1l83Cy1m83Dy53hyBogus name. Part of tamper mechanism. Internal.000004z8r83Toy83Toy83=uy83=uy00001m1l83Ey1l8l00000");
    string_constant_37 = 
	    STATIC_STRING("1z8q1o83=uy1m83Ry83*ry1m8v83=uy8t1q83K4y08o8l83Cy1m83Dy53hyBogus name. Part of tamper mechanism. Internal.1o83SFy08o8l1r83Dxy083");
    string_constant_38 = 
	    STATIC_STRING("Ey8l8z1m8p8313y1m83Dy53-1yCurrently aliased to module-assignment. Change alias to just module \?1t83DMy36uy83Ey8l83Cy1m8p83-Vy8z8");
    string_constant_39 = 
	    STATIC_STRING("3Ny1m83Dy53-8yexport as initial-workspace-width, (type positive-integer), writable = false1t83DLy33my83Ey8l83Cy8z1m8p83-Vy83Ny1m");
    string_constant_40 = 
    ...
    string_constant_49 = 
	    STATIC_STRING("08l8z1m8p833cy1q83K3y08o8l83Cy1m83Dy53hyBogus name. Part of tamper mechanism. Internal.1o83Toy083Ey8l");
    temp_1 = regenerate_optimized_constant(string_constant_20);
    temp_2 = regenerate_optimized_constant(list(16,string_constant_21,
    ...
    add_class_to_environment(9,Qkb_workspace,list_constant_14,Nil,temp_1,
	    Nil,temp_2,list_constant_14,
	    regenerate_optimized_constant(list(13,string_constant_37,
	    ...
	    string_constant_47,string_constant_48,string_constant_49)),Nil);
    ...
    alias_slot_name(3,Qkb_workspace_initial_width,Qinitial_width,
	    Qkb_workspace);
    string_constant_50 = 
	    STATIC_STRING("1n1m83Duy83-6y1m8313y83Duy1m8313y1m9k83dZy");
    ...
    list_constant_15 = STATIC_CONS(Qunspecified,Qnil);
    reserve_words(list_constant_15);
