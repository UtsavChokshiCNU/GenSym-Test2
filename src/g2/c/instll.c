    ...
    Object rule, value, initializing_qm;
{
    ...
    Object gensymed_symbol_2, cdr_new_value, temp, new_cons;
...
Object Simulation_parameters = UNBOUND;
...
static Object Qsimulation_parameters;  /* simulation-parameters */
    ...
    Object simulation_parameters;
{
    ...
    PUSH_SPECIAL(Simulation_parameters,simulation_parameters,0);
    ...
    Object generic_formula, box_translation_and_text, initializing_qm;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_2, temp_1, result_1;
    ...
    Object retaining_old_frame_or_initializing_qm;
{
    ...
    Object gensymed_symbol_4, gensymed_symbol_5, temp_1, new_cons, temp_2;
    Object slot_features, parent_pretty_slot_name, class_description;
...
Object Chain_of_available_edit_caches = UNBOUND;

Object Edit_cache_count = UNBOUND;
    ...
    Object edit_cache;
{
    ...
    svref_new_value = Chain_of_available_edit_caches;
    SVREF(edit_cache,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_edit_caches = edit_cache;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_edit_cache_variable, edit_cache_count_new_value;
    Object defstruct_g2_edit_cache_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(180,21);
    def_structure_edit_cache_variable = Nil;
    edit_cache_count_new_value = FIXNUM_ADD1(Edit_cache_count);
    Edit_cache_count = edit_cache_count_new_value;
...
{
    Object def_structure_edit_cache_variable;
    ...
    Object edit_cache;
{
    ...
    reclaim_gensym_list_1(ISVREF(edit_cache,(SI_Long)2L));
    reclaim_gensym_list_1(ISVREF(edit_cache,(SI_Long)3L));
    return reclaim_edit_cache_internal_1(edit_cache);
}
...
Object validate_executing_statements_and_procedures()
{
    ...
    validate_all_procedure_invocations();
...
{
    Object schedule_task_qm, old_structure_being_reclaimed, temp, result_1;
    ...
    Object ab_loop_it_, temp_2, gensym_pop_store, cons_1, next_cons;
    SI_Long svref_new_value;
    char temp_1;
    Declare_special(1);
    ...
    Object display_frame, new_expressions, initializing_qm;
{
    ...
    Object slot_description, new_cons, gensymed_symbol_3, gensymed_symbol_4;
    Object stack_of_slot_value_changes, gensymed_symbol_5, gensymed_symbol_6;
    Object temp_2, graph_grid_qm, display_expressions_1;
    Object graph_expression_without_info, plot_color_qm, plot_pattern_qm;
    Object plot_min_and_max_qm, graph_expression, ab_loop_list_, ab_loopvar_;
    Object ab_loopvar__1, ab_loopvar__2, redraw_as_well_as_reformat_p;
    Object frame_and_slot_or_atom, ab_loop_it_, gensym_pop_store, cons_1;
    Object next_cons, cell_array_qm, priority_of_current_task;
	...
	if (initializing_qm) {
	    ...
	    if (Nil)
		gensymed_symbol_4 = nconc2(gensym_list_2(display_frame,
			slot_description),gensym_cons_1(Nil,Nil));
	    else {
		new_cons = Available_gensym_conses;
		if (new_cons) {
	    ...
	    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		  ...
		  if (display_expressions_1) {
			  ...
			  PUSH_SPECIAL(Plot_min_and_max_qm,plot_min_and_max_qm,
				  0);
			  ...
			  next_loop:
			    ...
			    MVS_4(result,graph_expression_without_info,
				    ...
				    Plot_min_and_max_qm);
			    ab_loopvar__2 = 
				    gensym_cons_1(make_plot(graph_expression_without_info,
				    plot_color_qm,plot_pattern_qm,
    ...
    Object graph_expression_with_info;
{
	...
	if (EQ(CAR(graph_expression_with_info),Qcm)) {
	    temp = 
		    copy_tree_using_gensym_conses_1(SECOND(graph_expression_with_info));
	    temp_1 = THIRD(graph_expression_with_info);
	    temp_2 = 
		    copy_tree_using_gensym_conses_1(FOURTH(graph_expression_with_info));
	    min_and_max_qm = FIFTH(graph_expression_with_info);
	    temp_3 = min_and_max_qm ? 
		    gensym_cons_1(copy_for_slot_value(CAR(min_and_max_qm)),
		    copy_for_slot_value(CDR(min_and_max_qm))) : Nil;
	    return VALUES_4(temp,temp_1,temp_2,temp_3);
	}
	else {
	    temp_3 = 
		    copy_tree_using_gensym_conses_1(graph_expression_with_info);
    ...
    Object graph, new_value, initializing_qm;
{
    ...
    PUSH_SPECIAL(Changing_graph_margins_qm,changing_graph_margins_qm,0);
      if (Noting_changes_to_kb_p)
...
{
    Object temp, wait_1, update, future_task_schedule_modify_arg_2;
	...
	future_task_schedule_modify_arg_2 = get_lookup_slot_value(display,
		Qdisplay_update_priority);
	...
	future_task_schedule_modify_arg_3 = gensymed_symbol + 
		gensymed_symbol_1;
	future_task_schedule_modify_arg_4 = FIXNUMP(update) ? 
		(double)IFIX(update) : DFLOAT_ISAREF_1(update,(SI_Long)0L);
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qscheduled_display_update);
	future_task_schedule_modify_arg_11 = display;
	schedule_task_qm = ISVREF(display,(SI_Long)20L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	DFLOAT_ISASET_1(temp_2,(SI_Long)0L,future_task_schedule_modify_arg_3);
	temp_2 = ISVREF(task,(SI_Long)1L);
	DFLOAT_ISASET_1(temp_2,(SI_Long)1L,future_task_schedule_modify_arg_4);
	...
	return VALUES_1(ISVREF(display,(SI_Long)20L) = task);
    }
    else
	return VALUES_1(Nil);
}
...
Object Post_analyzer_warning_notes_for_generic_simulation_formulas_qm = UNBOUND;
    ...
    Object initializing_qm;
{
    ...
    Object gensymed_symbol_2, gensymed_symbol_3, temp_2, old_translation_qm;
    Object new_translation, new_role_name, old_role_name, new_class_or_item;
    Object old_class_or_item, new_left_side, old_left_side;
    Object frame_and_slot_or_atom, ab_loop_list_, ab_loop_it_;
    Object gensym_pop_store, cons_1, next_cons;
    SI_Long svref_new_value;
    char temp_1;
    ...
    PUSH_SPECIAL(Post_analyzer_warning_notes_for_generic_simulation_formulas_qm,post_analyzer_warning_notes_for_generic_simulation_formulas_qm,
	    1);
      result_1 = Nil;
      current_flag_state_qm = Nil;
      slot_description = 
      ...
      if (Nil)
	  gensymed_symbol_1 = 
		  nconc2(gensym_list_2(generic_simulation_formula,
		  slot_description),gensym_cons_1(Nil,Nil));
      else {
	  new_cons = Available_gensym_conses;
	  if (new_cons) {
	...
	if ( !TRUEP(current_flag_state_qm)) {
	    ...
	    inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		    gensymed_symbol_2,gensymed_symbol_3);
	    svref_new_value = IFIX(ISVREF(generic_simulation_formula,
		    (SI_Long)5L)) | (SI_Long)16777216L;
    ...
    Object generic_simulation_formula, new_byte_code_body, initializing_qm;
{
	...
	next_loop:
	  ...
	  ab_loop_it_ = temp ? (EQ(generic_simulation_formula,
		  M_CAR(frame_and_slot_or_atom)) ? T : Nil) : Nil;
	  if (ab_loop_it_) {
	      temp = TRUEP(ab_loop_it_);
	      goto end_1;
...
Object body_of_put_for_simulation_frame(variable,simulation_details,
    ...
    Object variable, simulation_details, initializing_qm;
{
    Object old_value_qm, symbol, property_name, gensymed_symbol;
    ...
    Object simulation_info_qm, svref_new_value;
	...
	svref_new_value = simulation_details ? T : Nil;
	SVREF(simulation_info_qm,FIX((SI_Long)15L)) = svref_new_value;
    }
    ...
    Object simulation_subtable, new_byte_code_body, initializing_qm;
{
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(simulation_subtable,
		slot_description),gensym_cons_1(Nil,Nil));
    else {
	new_cons = Available_gensym_conses;
	if (new_cons) {
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  gensymed_symbol_2,gensymed_symbol_3);
	  svref_new_value = IFIX(ISVREF(simulation_subtable,(SI_Long)5L)) 
		  | (SI_Long)16777216L;
	  ISVREF(simulation_subtable,(SI_Long)5L) = FIX(svref_new_value);
      }
      if (Noting_changes_to_kb_p)
	  note_change_to_block_1(simulation_subtable,
	...
	next_loop:
	  ...
	  ab_loop_it_ = temp ? (EQ(simulation_subtable,
		  M_CAR(frame_and_slot_or_atom)) ? T : Nil) : Nil;
	  if (ab_loop_it_) {
	      temp = TRUEP(ab_loop_it_);
	      goto end_1;
...
Object Inhibit_model_install_qm = UNBOUND;
    ...
    Object connection, value, initializing_qm;
{
	...
	if (output_end_object_qm) {
	    gensymed_symbol = ISVREF(output_end_object_qm,(SI_Long)14L);
...
Object Post_kb_loading_consistency_analysis = UNBOUND;
...
Object List_of_types_to_be_analyzed = UNBOUND;
...
Object Post_analyzer_warning_note_qm = UNBOUND;
    ...
    Object stability_info_list, gensymed_symbol;
{
  ...
  next_loop:
	...
	class_stability_items = gensym_cons_1(info_item,class_stability_items);
    else
	method_stability_items = gensym_cons_1(info_item,
...
Object analyze_compiled_items_after_loading_1()
{
    ...
    PUSH_SPECIAL(Post_kb_loading_consistency_analysis,post_kb_loading_consistency_analysis,
	    2);
      PUSH_SPECIAL(Post_analyzer_warning_notes_for_generic_simulation_formulas_qm,post_analyzer_warning_notes_for_generic_simulation_formulas_qm,
	      1);
	scope_conses = Scope_conses;
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		    0);
	      object_configuration_qm = get_lookup_slot_value(block,
    ...
    Object delete_as_item_referring_to_name_qm;
{
    ...
    Object class_type_qm, attribute_initial_type, gensymed_symbol_3;
    Object gensymed_symbol_4, gensymed_symbol_5, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, cons_holding_validity_interval_override_qm;
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    delete_all_consistency_analysis_frame_notes(1,class_definition);
	    ...
	    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
	      ...
	      class_description_qm = 
		      ...
		      Class_description_gkbprop);
	      default_overrides = ISVREF(class_definition,(SI_Long)27L);
		  ...
		  temp = TRUEP(Nil);
	      if (temp)
		  connections_qm = ISVREF(class_definition,(SI_Long)30L);
	      else {
		  temp_1 = member(4,Qstubs_for_class,default_overrides,
			  Ktest,Qcar_eq);
		  stubs_for_class_override_qm = CAR(temp_1);
		  connections_qm = stubs_for_class_override_qm ? 
			  M_CAR(M_CDR(stubs_for_class_override_qm)) : Qnil;
	      }
	      icon_description_qm = 
		...
		end_loop:;
	      ...
	      any_qm = Nil;
	      temp_1 = get_variable_specification_if_any(icon_description_qm);
	    ...
	    next_loop_1:
	      ...
	      ab_loop_list_ = M_CDR(ab_loop_list_);
	      if (CONSP(drawing_element) && EQ(FIRST(drawing_element),
			  Qimage)) {
	    ...
	    end_loop_1:
		  ...
		  check_undefined_instances_of_class(image_name_qm,
			  Qimage_definition);
	      if (image_name_qm && (Post_kb_loading_consistency_analysis 
		      ||  !TRUEP(Add_as_item_referring_to_name_qm) &&  
		      !TRUEP(Delete_as_item_referring_to_name_qm)) &&  
		      !((SI_Long)0L != (IFIX(ISVREF(class_definition,
	    ...
	    next_loop_2:
		  ...
		  if (class_type_qm) {
			  ...
			  gensymed_symbol_4 = class_type_qm;
			  gensymed_symbol = SXHASH_SYMBOL_1(class_type_qm) 
				  & IFIX(Most_positive_fixnum);
			  gensymed_symbol_1 = (SI_Long)0L;
			next_loop_3:
			  if ( !TRUEP(gensymed_symbol_3))
			...
			end_4:;
			  ...
			  if (SYMBOLP(attribute_initial_type)) {
			      gensymed_symbol_3 = CDR(Symbol_properties_table);
			      gensymed_symbol_4 = attribute_initial_type;
			      gensymed_symbol = 
			    ...
			    end_10:;
			      if ( !TRUEP(gensymed_symbol_3)) {
				  gensymed_symbol_3 = attribute_initial_type;
				  temp_2 = Symbol_properties_table;
				  temp_1 = 
					  FIX(SXHASH_SYMBOL_1(gensymed_symbol_3) 
					  & IFIX(Most_positive_fixnum));
	      ...
	      goto next_loop_2;
	    end_loop_2:;
	      cons_holding_validity_interval_override_qm = member(4,
		      Qvalidity_interval,default_overrides,Ktest,Qcar_eq);
	      cons_holding_data_server_map_override_qm = member(4,
		      Qdata_server_map,default_overrides,Ktest,Qcar_eq);
	      if (cons_holding_validity_interval_override_qm || 
		      cons_holding_data_server_map_override_qm) {
		  if (cons_holding_validity_interval_override_qm) {
		      temp_1 = CAR(cons_holding_validity_interval_override_qm);
		      real_or_implied_validity_interval_value = SECOND(temp_1);
		  }
		  else if (class_description_qm) {
		      gensymed_symbol_3 = CDR(Symbol_properties_table);
		      gensymed_symbol_4 = class_name_qm;
		      gensymed_symbol = SXHASH_SYMBOL_1(class_name_qm) & 
			      IFIX(Most_positive_fixnum);
		      gensymed_symbol_1 = (SI_Long)0L;
		    next_loop_19:
		      if ( !TRUEP(gensymed_symbol_3))
			...
			end_24:;
		      ...
		      real_or_implied_validity_interval_value = 
			      slot_description_qm ? 
			      ISVREF(slot_description_qm,(SI_Long)6L) : Qnil;
		  }
		  else {
		      gensymed_symbol_3 = CDR(Symbol_properties_table);
		      gensymed_symbol_4 = Qg2_variable;
		      gensymed_symbol = SXHASH_SYMBOL_1(Qg2_variable) & 
			      IFIX(Most_positive_fixnum);
		      gensymed_symbol_1 = (SI_Long)0L;
		    next_loop_27:
		      if ( !TRUEP(gensymed_symbol_3))
		  ...
		  if (cons_holding_data_server_map_override_qm) {
		      temp_1 = CAR(cons_holding_data_server_map_override_qm);
		      real_or_implied_data_server_map_value = SECOND(temp_1);
		  }
		  else if (class_description_qm) {
		      gensymed_symbol_3 = CDR(Symbol_properties_table);
		      gensymed_symbol_4 = class_name_qm;
		  ...
		  if (EQ(real_or_implied_validity_interval_value,Qsupplied)) {
		      if ( !EQ(real_or_implied_data_server_map_value,
			      Qcomputation))
			  add_frame_note(2,
	    ...
	    next_loop_51:
		  ...
		  if (SYMBOLP(class_to_instantiate_qm)) {
		      gensymed_symbol_3 = CDR(Symbol_properties_table);
		      gensymed_symbol_4 = class_to_instantiate_qm;
		      gensymed_symbol = 
			...
			end_56:;
		      ...
		      temp = TRUEP(Nil);
		  if (temp ? TRUEP(class_description_qm) : TRUEP(Nil)) {
			...
			end_64:;
			  ...
			  if (class_in_attribute_conforms_to_type_p(4,
				  slot_description_qm,class_name_qm,T,
	    ...
	    end_loop_51:;
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(class_definition);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	PUSH_SPECIAL(Drawing_parameters,drawing_parameters,1);
	  if (Defer_consistency_analysis_qm &&  
	      ...
	      image_name_qm = CONSP(image_palette) ? SECOND(image_palette) 
		      : Qnil;
		...
		if (image_name_qm)
	      ...
	      if (system_table_installed_p(Drawing_parameters) && 
		      ...
		      !TRUEP(Add_as_item_referring_to_name_qm) &&  
		      !TRUEP(Delete_as_item_referring_to_name_qm)) &&  
		      !((SI_Long)0L != (IFIX(ISVREF(Drawing_parameters,
		      (SI_Long)5L)) & (SI_Long)512L))) {
		  ...
		  if ( !TRUEP(Loading_kb_p))
		      result = propagate_image_palette_to_all_gensym_windows(image_palette);
		  else
		      result = VALUES_1(Nil);
	      }
	      else
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    delete_all_consistency_analysis_frame_notes(1,kb_workspace);
	    compiled_item_being_analyzed = kb_workspace;
	    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		    0);
	      object_configuration_qm = get_lookup_slot_value(kb_workspace,
		      Qobject_configuration);
	      if (object_configuration_qm)
		  map_over_external_names_in_object_configuration(SYMBOL_FUNCTION(Qcheck_undefined_instances_of_class),
			  object_configuration_qm);
	      image_name = Nil;
	      ab_loop_list_ = workspace_background_images(kb_workspace);
	      ab_loop_desetq_ = Nil;
	    next_loop:
	      if ( !TRUEP(ab_loop_list_))
		  goto end_loop;
	      ...
	      ab_loop_list_ = M_CDR(ab_loop_list_);
	      check_undefined_instances_of_class(image_name,Qimage_definition);
	      goto next_loop;
	    end_loop:;
		...
		result = refresh_background_images(kb_workspace);
	    }
	    else
		result = VALUES_1(Nil);
	}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
		...
		temp = Nil;
	    result = analyze_formula_for_consistency(generic_formula,
		    temp_1,temp,Nil,Nil);
	}
      POP_SPECIAL();
    POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
	      ...
	      delete_all_consistency_analysis_frame_notes(2,variable,T);
	    POP_SPECIAL();
	    ...
	    cell_array_qm = get_lookup_slot_value_given_default(variable,
		    Qcell_array,Nil);
	    PUSH_SPECIAL(Compiled_item_being_analyzed_started_out_incomplete_qm,compiled_item_being_analyzed_started_out_incomplete_qm,
		    1);
	      PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		      0);
		if (cell_array_qm) {
		...
		if (EQ(ISVREF(variable,(SI_Long)27L),Qsupplied)) {
		    if ( !EQ(ISVREF(variable,(SI_Long)31L),Qcomputation))
			add_frame_note(2,
				Qincompatible_validity_interval_and_data_server,
				variable);
		}
	      POP_SPECIAL();
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(variable);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    temp_2 = CAR(temp);
	    temp = ISVREF(generic_simulation_formula,(SI_Long)16L);
	    result = analyze_formula_for_consistency(generic_simulation_formula,
	...
	PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
	  ...
	  PUSH_SPECIAL(Compiled_item_being_analyzed_started_out_incomplete_qm,compiled_item_being_analyzed_started_out_incomplete_qm,
	    ...
	    alist = formula_class_case_qm ? 
		    gensym_cons_1(gensym_cons_1(formula_class_or_item,
		...
		current_computation_component_particulars = 
			gensym_list_2(Qcell_array_element,
		...
		analyze_byte_code_body_for_free_reference_consistency(formula,
			byte_code_body_qm);
	    }
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    delete_all_consistency_analysis_frame_notes(1,function_definition);
	    compiled_item_being_analyzed = function_definition;
	    compiled_item_being_analyzed_started_out_incomplete_qm = 
		    frame_incomplete_p(function_definition);
	    byte_code_body_qm = ISVREF(function_definition,(SI_Long)20L);
	    PUSH_SPECIAL(Compiled_item_being_analyzed_started_out_incomplete_qm,compiled_item_being_analyzed_started_out_incomplete_qm,
		    1);
	      PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		      0);
		if (byte_code_body_qm) {
		    if ( !TRUEP(Delete_as_item_referring_to_name_qm) && 
			    frame_incomplete_p(function_definition))
			update_frame_status(function_definition,Nil,Nil);
		    analyze_byte_code_body_for_free_reference_consistency(function_definition,
			    byte_code_body_qm);
		}
	      POP_SPECIAL();
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(function_definition);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_display_for_consistency(readout_table);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_display_for_consistency(dial);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_display_for_consistency(meter);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
	...
	if (Defer_consistency_analysis_qm &&  
		...
		PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		  ...
		  if (CONSP(display_expressions) && 
		      ...
		      current_computation_component_particulars = 
			      gensym_cons_1(Qgraph_expression,
			      FIX((SI_Long)1L));
		      PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
			      1);
			graph_expression = Nil;
			...
			cdr_arg = Current_computation_component_particulars;
			M_CDR(cdr_arg) = FIX(expression_index);
			result = parse_graph_expression_with_info(graph_expression);
			MVS_4(result,graph_expression_without_info,temp,
				plot_pattern_qm,plot_min_and_max_qm);
			PUSH_SPECIAL(Plot_min_and_max_qm,plot_min_and_max_qm,
				0);
			  analyze_compiled_form(graph_expression_without_info,
				  Nil,Nil);
			  reclaim_gensym_tree_1(graph_expression_without_info);
			  if (CONSP(plot_pattern_qm))
			      reclaim_gensym_tree_1(plot_pattern_qm);
	    ...
	    result = post_analyzer_warning_note_if_necessary(graph);
	}
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
		...
		next_loop:
		  ...
		  ab_loop_list_ = M_CDR(ab_loop_list_);
		  designation_1 = get_simple_part_feature(a_data_series,
			  Qdata_series_info_1);
		  designation_2 = get_simple_part_feature(a_data_series,
			  Qdata_series_info_2);
		  if ( !TRUEP(ab_loop_iter_flag_))
		  ...
		  if ( !TRUEP(get_simple_part_feature(a_data_series,
			  Qdata_series_failed_to_compile))) {
		      if (designation_1)
			  analyze_compiled_form(designation_1,Nil,Nil);
		      if (designation_2)
			  analyze_compiled_form(designation_2,Nil,Nil);
		  }
		  ab_loop_iter_flag_ = Nil;
		  goto next_loop;
		end_loop:
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(chart);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_for_consistency_block_with_only_cell_array(new_table);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_for_consistency_block_with_only_cell_array(inter_g2_data_request_holder);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_for_consistency_block_with_only_cell_array(kb_search_state);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    result = analyze_for_consistency_block_with_only_cell_array(user_menu_choice);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(procedure);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object procedure;
{
    ...
    compiled_item_being_analyzed = procedure;
    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,1);
      compiled_item_being_analyzed_started_out_incomplete_qm = 
	...
	if (first_byte_code_body_qm) {
	    ...
	    analyze_byte_code_body_for_free_reference_consistency(procedure,
		    first_byte_code_body_qm);
	    if ( !TRUEP(Delete_as_item_referring_to_name_qm)) {
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    status_of_embedded_rule_parent_qm = parent_of_embedded_rule_qm 
		    ? button_frame_status(parent_of_embedded_rule_qm) : Nil;
		...
		if (byte_code_body_qm) {
			...
			else if ( !TRUEP(status_of_embedded_rule_parent_qm))
			    update_frame_status(rule,Nil,Nil);
		    }
		    analyze_byte_code_body_for_free_reference_consistency(rule,
			    byte_code_body_qm);
		}
	      POP_SPECIAL();
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(rule);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    delete_all_consistency_analysis_frame_notes(1,simulation_subtable);
	    ...
	    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
	      ...
	      PUSH_SPECIAL(Compiled_item_being_analyzed_started_out_incomplete_qm,compiled_item_being_analyzed_started_out_incomplete_qm,
		      1);
		byte_code_body_qm = ISVREF(simulation_subtable,(SI_Long)23L);
		initial_value_byte_code_body_qm = 
		...
		if (byte_code_body_qm) {
		    ...
		    analyze_byte_code_body_for_free_reference_consistency(simulation_subtable,
			    byte_code_body_qm);
		}
		if (initial_value_byte_code_body_qm) {
	      ...
	      POP_SPECIAL();
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(simulation_subtable);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
	    ...
	    delete_all_consistency_analysis_frame_notes(1,non_action_button);
	    ...
	    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		  ...
		  if (G2_has_v5_mode_windows_p) {
		      sub_class_bit_vector = 
			      ISVREF(ISVREF(non_action_button,(SI_Long)1L),
			      (SI_Long)19L);
		      superior_class_bit_number = 
	    ...
	    POP_SPECIAL();
	    result = post_analyzer_warning_note_if_necessary(non_action_button);
	}
	else
	    result = VALUES_1(Nil);
      POP_SPECIAL();
    ...
    Object delete_as_item_referring_to_name_qm;
{
	...
	if (Defer_consistency_analysis_qm &&  
		...
		element_type_spec = EQ(element_type,Qitem_or_datum) ? 
			element_type : gensym_list_2(Qab_class,element_type);
		PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
			0);
		  delete_all_consistency_analysis_frame_notes(1,g2_array);
		...
		end_loop:;
		  ...
		  result = post_analyzer_warning_note_if_necessary(g2_array);
		POP_SPECIAL();
	    }
	    else
		result = VALUES_1(Nil);
    ...
    Object delete_as_item_referring_to_name_qm;
{
    ...
    PUSH_SPECIAL(Delete_as_item_referring_to_name_qm,delete_as_item_referring_to_name_qm,
      ...
      PUSH_SPECIAL(Add_as_item_referring_to_name_qm,add_as_item_referring_to_name_qm,
	      2);
	PUSH_SPECIAL(Language_parameters,language_parameters,1);
	  if (Defer_consistency_analysis_qm &&  
		  !TRUEP(Add_as_item_referring_to_name_qm) &&  
		  !TRUEP(Delete_as_item_referring_to_name_qm))
		...
		if (text_conversion_style_qm)
		    result = check_undefined_instances_of_class(text_conversion_style_qm,
    ...
    Object form, alist, constraints;
{
  ...
  next_loop:
    ...
    binding_form_constraint_info = analyze_compiled_form(binding_form,
	    alist,Nil);
    alist = gensym_cons_1(gensym_cons_1(local_name,
  ...
  next_loop_1:
	...
	goto end_loop_1;
    temp = CDR(alist);
    reclaim_gensym_cons_1(CAR(alist));
    reclaim_gensym_cons_1(alist);
    alist = temp;
    i = i + (SI_Long)1L;
    goto next_loop_1;
  end_loop_1:
...
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_2;
    Object cdr_new_value, temp, new_cons;
    ...
    Object name, index_1;
{
	...
	if (instance_qm) {
		...
		reclaim_gensym_cons_1(old_constant_value_qm);
	    ...
	    svref_new_value = gensym_cons_1(name,Cached_name_cons_marker);
    ...
    Object class_specific_attribute_class_qm, constant_index;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, class_description_qm, slot_description_qm;
    Object attribute_index_qm, old_constant_value_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
	...
	if (constant_vector_qm && FIXNUM_LT(constant_index,
		...
		if (old_constant_value_qm && LISTP(old_constant_value_qm))
		    reclaim_gensym_list_1(old_constant_value_qm);
    ...
    Object user_class, analyze_inherited_attributes_also_qm;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, scope_conses, ab_loopvar_, subclass;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
    Declare_special(1);
    Object result;
	...
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = user_class;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(user_class) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
    ...
    Object user_class, analyze_inherited_attributes_also_qm;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, class_description_qm, slot_descriptions_qm;
    Object slot_description, ab_loop_list_, slot_name;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
    ...
    Object class_1, attribute, compiled_item_being_analyzed;
{
    ...
    PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,0);
    ...
    Object stable_procedure_call_qm, procedure_to_analyze_qm;
{
    ...
    Object method_list_qm, first_arg_type_qm, gensymed_symbol_3;
    Object gensymed_symbol_4, gensymed_symbol_5, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, method, ab_loop_list_, arg_count, method_found_qm;
    Object var_count_1, description_vector, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, description, frame_key, arg_type, restp;
    Object formal_arg_types_tail, formal_arg_type, formal_arg_kinds_tail, kind;
    Object as_handle_p, ab_loop_iter_flag_, required_type;
    Object formal_return_types_tail, formal_return_type;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, index_1, ab_loop_bind_;
    SI_Long arg_number, return_number;
    char temp_1;
    ...
    Object return_types;
{
	...
	if ( !TRUEP(method_qm) ||  !EQ(ISVREF(method_qm,(SI_Long)31L),
		...
		return note_invalid_stable_hierarchy(Compiled_item_being_analyzed,
			gensym_list_3(method_name,first_arg_class,
			length(arg_types)));
	    else
		return VALUES_1(Nil);
	}
    ...
    Object frame_note, pair_key, pair_value, copy_pair_key_and_value_qm;
{
    ...
    Object trigger_update_of_representations_qm, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, rest_new_value;
	...
	add_to_frame_note_particulars_list_if_necessary(gensym_list_2(copy_pair_key_and_value_qm 
	...
	nconc2(existing_particulars_alist,
		gensym_cons_1(gensym_list_2(copy_pair_key_and_value_qm ? 
		copy_for_slot_value(pair_key) : pair_key,
		copy_pair_key_and_value_qm ? 
    ...
    Object frame_note, key, associated_slot_value, listed_slot_value;
{
    ...
    if ( !TRUEP(existing_particulars_alist)) {
	add_to_frame_note_particulars_list_if_necessary(gensym_list_3(copy_for_slot_value(key),
	...
	nconc2(existing_particulars_alist,
		gensym_cons_1(gensym_list_3(copy_for_slot_value(key),
		copy_for_slot_value(associated_slot_value),
	...
	cdr_new_value = 
		gensym_cons_1(copy_for_slot_value(listed_slot_value),Nil);
...
void install_INIT()
{
    ...
    Object Qnew_table, Qanalyze_for_consistency_for_new_table, Qchart;
    ...
    Object Qitem_depends_on_unstable_heirarchy, string_constant_92;
    Object string_constant_91, string_constant_90, list_constant_12;
    ...
    Object list_constant_11, Qcompiler_warnings;
    Object Qnamed_dynamic_extent_description;
    Object Qanalyze_for_consistency_in_progress, Qinstall;
    Object Qgeneric_method_lambda_list, list_constant_10;
    Object Qdelete_as_item_referring_to_name_qm;
    Object Qadd_as_item_referring_to_name_qm;
    ...
    Object Qinhibit_model_install_qm;
    ...
    Object Qget_focal_entity_for_simulation_formula_qm;
    Object Qfocal_entity_for_simulation_formula;
    ...
    Object Qpost_analyzer_warning_notes_for_generic_simulation_formulas_qm;
    ...
    Object Qedit_cache_structure_memory_usage, Qutilities2, Qedit_cache_count;
    Object Qchain_of_available_edit_caches, string_constant_88;
    ...
    Object Qgeneric_simulation_formulas_used_p;
    ...
    string_constant_81 = 
	    STATIC_STRING("1t4z8r83Bfy83Bfy83aGy83aGy09k001n1l8l1m8p832iy1l8o000004z8r83D*y83D*y83aGy83aGy0833uy001n1l8l1m8p833Py1l8o000004z8r83aMy83aMy83a");
    string_constant_82 = 
	    STATIC_STRING("Gy83aGy00001n1l8l1m8p83Ky1l8o000004z8r83Zey83Zey83aGy83aGy00001m1l8l1l8o000004z8r83L6y83L6y83aGy83aGy00001n1l8l1n8p834vy83Gy1l8o");
    string_constant_83 = 
	    STATIC_STRING("000004z8r83F3y83F3y83aGy83aGy00001n1l8l1m8p8306y1l8o000004z8r83Zty83Zty83aGy83aGy00001n1l8l1m8p83Ky1l8o000004z8r83duy83duy83aGy8");
    string_constant_84 = 
	    STATIC_STRING("3aGy00001m1l8l1l8o000004z8r83e+y83e+y83aGy83aGy00001m1l8l1l8o00000");
    float_constant = STATIC_FLOAT(0.5);
    string_constant_85 = 
	    STATIC_STRING("1v8q1n83aGy1l83-sy83ey1p83Bfy9k8l1m8p832iy8o1p83D*y833uy8l1m8p833Py8o1p83aMy08l1m8p83Ky8o1o83Zey08l8o1p83L6y08l1n8p834vy83Gy8o1p");
    string_constant_86 = 
	    STATIC_STRING("83F3y08l1m8p8306y8o1p83Zty08l1m8p83Ky8o1o83duy08l8o1o83e+y08l8o");
    ...
    string_constant_87 = 
	    STATIC_STRING("43Dy8m83h*y1n83h*y8n8k1l8n0000001l1m83My83-ADykok0k0");
    ...
    string_constant_88 = STATIC_STRING("1q83h*y8s83-S5y09k9l");
    clear_optimized_constants();
  ...
  end_loop_1:;
    ...
    string_constant_92 = STATIC_STRING("Please see the release notes.");
