...
Object Generated_var_spots_for_base_code_body_return = UNBOUND;

Object Returned_values_description = UNBOUND;

Object Return_statement_processed_qm = UNBOUND;

Object Call_statement_processed_qm = UNBOUND;

Object Expression_bound_local_names = UNBOUND;
...
Object Procedure_branch_short_cuts = UNBOUND;
...
Object Base_code_body_return_tag = UNBOUND;
...
Object Current_return_values_position = UNBOUND;
...
static Object Qreturned_values_description;  /* returned-values-description */
    ...
    Object procedure, procedure_definition;
{
    ...
    Object slot_description, new_cons, gensymed_symbol_4;
    Object stack_of_slot_value_changes, gensymed_symbol_5, gensymed_symbol_6;
    Object slot_description_1, current_edit_state, compiler_errors;
    Object compiler_warnings, new_goto_tag_counter, goto_tags_in_compilation;
    ...
    Object suppress_updates_to_name_boxes, temp_2, first_argument_type_qm;
    Object first_argument_class_qm, old_method_name_qm, old_method_class_qm;
    Object temp_3, outermost_stack_frame_var_binding_qm;
    ...
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3, temp_1;
    ...
    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,31);
	...
	PUSH_SPECIAL(Missing_local_names_already_reported,missing_local_names_already_reported,
		29);
	  duplicate_local_names_already_reported = Nil;
	  PUSH_SPECIAL(Duplicate_local_names_already_reported,duplicate_local_names_already_reported,
		  28);
	    base_environment = Nil;
	    returned_values_description = Nil;
	    PUSH_SPECIAL(Returned_values_description,returned_values_description,
		    27);
	      return_statement_processed_qm = Nil;
	      PUSH_SPECIAL(Return_statement_processed_qm,return_statement_processed_qm,
		      26);
		call_statement_processed_qm = Nil;
		PUSH_SPECIAL(Call_statement_processed_qm,call_statement_processed_qm,
			25);
		  ...
		  if (Nil)
		      gensymed_symbol_4 = nconc2(gensym_list_2(procedure,
		  ...
		  PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
			...
			temp_1 = IFIX(ISVREF(procedure,(SI_Long)5L)) | 
				(SI_Long)16777216L;
			ISVREF(procedure,(SI_Long)5L) = FIX(temp_1);
		    }
		    slot_description_1 = 
			    get_slot_description_of_class_description_function(Qframe_status_and_notes,
			    ISVREF(procedure,(SI_Long)1L),Nil);
		    ...
		    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		      ...
		      PUSH_SPECIAL(Current_edit_state,current_edit_state,22);
			temp = Current_edit_state;
			SVREF(temp,FIX((SI_Long)90L)) = gensymed_symbol_4;
			compiler_errors = Nil;
			compiler_warnings = Nil;
			PUSH_SPECIAL(Compiler_warnings,compiler_warnings,21);
			  PUSH_SPECIAL(Compiler_errors,compiler_errors,20);
				...
				PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,
					19);
				  PUSH_SPECIAL(Goto_tags_in_compilation,goto_tags_in_compilation,
					  18);
				    PUSH_SPECIAL(New_goto_tag_counter,new_goto_tag_counter,
					    17);
				      if (PUSH_UNWIND_PROTECT(2)) {
					  lexically_visible_code_bodies = Nil;
					  code_body_entries_in_compilation 
						  = Nil;
					  PUSH_SPECIAL(Code_body_entries_in_compilation,code_body_entries_in_compilation,
						  16);
					    PUSH_SPECIAL(Lexically_visible_code_bodies,lexically_visible_code_bodies,
						    15);
					      if (PUSH_UNWIND_PROTECT(1)) {
						  stack_nodes_to_reclaim = Nil;
						  PUSH_SPECIAL(Stack_nodes_to_reclaim,stack_nodes_to_reclaim,
							  14);
							...
							collecting_free_references 
								= T;
							PUSH_SPECIAL(Collecting_free_references,collecting_free_references,
								13);
							  PUSH_SPECIAL(Compiler_free_references,compiler_free_references,
								  12);
							    if ( 
								...
								if (EQ(name,
								    ...
								    suppress_updates_to_name_boxes 
									    = 
									    T;
								    PUSH_SPECIAL(Suppress_updates_to_name_boxes,suppress_updates_to_name_boxes,
									    0);
								      change_slot_value(3,
									      procedure,
									      Qname_or_names_for_frame,
								...
								if (argument_list_description) 
								    ...
								    first_argument_type_qm 
									    = 
									    getfq_function_no_default(CDR(temp_2),
									    Ktype);
								}
								else
								    first_argument_type_qm 
							    ...
							    gensymed_symbol_4 
								    = 
								    make_compiler_code_body_entry_1(temp_2,
								    gensymed_symbol_4 
								    ? 
								    position(2,
								    gensymed_symbol_4,
							    ...
							    PUSH_SPECIAL(Lexically_visible_code_bodies,lexically_visible_code_bodies,
							      ...
							      stack_frame_vars_ok_in_procedure_qm 
								      = Nil;
							      PUSH_SPECIAL(Stack_frame_vars_ok_in_procedure_qm,stack_frame_vars_ok_in_procedure_qm,
								      10);
								PUSH_SPECIAL(Next_stack_frame_var_location,next_stack_frame_var_location,
									9);
								  PUSH_SPECIAL(Outermost_stack_frame_var_binding_qm,outermost_stack_frame_var_binding_qm,
									  8);
								    ...
								    PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,
								      ...
								      PUSH_SPECIAL(Base_code_body_return_tag,base_code_body_return_tag,
									      6);
									PUSH_SPECIAL(Generated_var_spots_for_base_code_body_return,generated_var_spots_for_base_code_body_return,
										5);
								...
								ab_loopvar__2 
									= 
									gensym_cons_1(make_frame(Qcode_body),
									Nil);
								if (ab_loopvar__1)
								    M_CDR(ab_loopvar__1) 
									    = 
								...
								ab_loop_list_ 
									= 
									code_body_frames;
								PUSH_SPECIAL(Code_body,code_body,
									1);
								  code_body_entry 
									  = 
									  Nil;
								...
								next_loop_4:
								  ...
								  current_return_values_position 
									  ...
									  ISVREF(code_body_entry,
									  (SI_Long)2L));
								  PUSH_SPECIAL(Current_return_values_position,current_return_values_position,
									  0);
								    SVREF(code_body_entry,
									    FIX((SI_Long)9L)) 
									    = 
								...
								if (code_body_frames) 
								    ...
								    end_loop_7:;
								    POP_SPECIAL();
								    reclaim_gensym_list_1(code_body_frames);
								    code_body_frames 
									    = 
									    Nil;
								}
			...
			if (temp_6);
			    ...
			    temp_2 = M_CDR(frame_and_slot_or_atom);
			    temp_6 = CONSP(temp_2) ? EQ(slot_description,
				    SECOND(frame_and_slot_or_atom)) && 
    ...
    Object args, return_types, local_vars;
{
    ...
    returned_values_description = Nil;
    variable_initializations = Nil;
    PUSH_SPECIAL(Returned_values_description,returned_values_description,0);
      arg_name = Nil;
      type = Nil;
      ab_loop_list_ = args;
...
Object New_descriptions = UNBOUND;
...
Object convert_description_list_to_managed_array varargs_1(int, n)
{
	...
	if (temp_2) {
		...
		svref_new_value = gensym_cons_1(Kgeneral_description,
			gensym_cons_1(keyword,EQ(CAR(description),Ktype) ? 
			copy_for_slot_value(CDR(description)) : 
    ...
    Object item_being_inlined;
{
    ...
    PUSH_SPECIAL(Code_body,code_body,3);
      argument_list_description = Nil;
      base_environment = Nil;
      returned_values_description = Nil;
      variable_initializations = Nil;
      ...
      PUSH_SPECIAL(Returned_values_description,returned_values_description,2);
	...
	end_loop_2:;
	  ...
	  PUSH_SPECIAL(Base_code_body_return_tag,base_code_body_return_tag,0);
	    record_goto_tags(body_statement);
	    compile_procedure_statement(body_statement);
	    emit_already_consed_instruction(phrase_list_2(Qtag_statement,
		    Base_code_body_return_tag));
...
Object compile_procedure_expression varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Expression_bound_local_names,expression_bound_local_names,0);
    ...
    Object procedure_instructions;
{
	...
	PUSH_SPECIAL(Procedure_branch_short_cuts,procedure_branch_short_cuts,
		0);
    ...
    Object procedure_instructions, code_body_entry;
{
    ...
    Object gensymed_symbol_1, svref_arg_1, svref_new_value, temp, new_cons;
    Object gensymed_symbol_3, temp_2, restart_cons, restart_point_or_end;
  ...
  next_loop_2:
	...
	if ( !TRUEP(memq_function(gensymed_symbol_1,gensymed_symbol))) {
	    ...
	    M_CAR(gensymed_symbol_3) = gensymed_symbol_1;
	    M_CDR(gensymed_symbol_3) = gensymed_symbol;
	    inline_note_allocate_cons(gensymed_symbol_3,Qab_gensym);
	    referenced_tags = ISVREF(svref_arg_1,gensymed_symbol_2) = 
		    gensymed_symbol_3;
	}
    }
    else
...
Object write_call_statement(statement)
    Object statement;
{
    Object new_statement, gensym_list, gensym_list_tail, gensym_cons;
...
Object Tightest_end_of_loop_tag = UNBOUND;
    ...
    Object statement;
{
    ...
    PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,1);
    ...
    end_loop:;
      ...
      PUSH_SPECIAL(Tightest_end_of_loop_tag,tightest_end_of_loop_tag,0);
	emit_already_consed_instruction(phrase_list_2(Qtag_statement,
		start_of_loop_tag));
	sub_statement = Nil;
	ab_loop_list_ = CDR(statement);
    ...
    Object statement;
{
    ...
    lexically_visible_goto_tags = Lexically_visible_goto_tags;
    PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,6);
      iteration_statement = Nil;
      ab_loop_list_ = statements;
    next_loop:
      if ( !TRUEP(ab_loop_list_))
    ...
    end_loop:;
      ...
      local_var_type = Nil;
      PUSH_SPECIAL(Tightest_end_of_loop_tag,tightest_end_of_loop_tag,5);
	result = variable_spot_and_description_for_local_name(local_name);
    ...
    Object statement;
{
    ...
    no_error_tag = Nil;
    lexically_visible_goto_tags = Lexically_visible_goto_tags;
    PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,5);
