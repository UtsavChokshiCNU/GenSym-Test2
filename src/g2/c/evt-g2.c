    ...
    Object rpc_instance, item, pretty_slot_name, class_if_specific;
{
	...
	return_from_system_defined_rpc(rpc_instance,
		gensym_cons_1(text_or_error,Nil));
    return VALUES_1(Nil);
}
...
Object Chain_of_available_pseudo_attributes = UNBOUND;

Object Pseudo_attribute_count = UNBOUND;
    ...
    Object pseudo_attribute;
{
    ...
    svref_new_value = Chain_of_available_pseudo_attributes;
    SVREF(pseudo_attribute,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_pseudo_attributes = pseudo_attribute;
    return VALUES_1(Nil);
}
...
Object make_permanent_pseudo_attribute_structure_internal()
{
    ...
    Object pseudo_attribute_count_new_value;
    ...
    pseudo_attribute_count_new_value = FIXNUM_ADD1(Pseudo_attribute_count);
    Pseudo_attribute_count = pseudo_attribute_count_new_value;
...
Object Static_attributes = UNBOUND;

Object Class_info_attributes = UNBOUND;
    ...
    Object class_name;
{
	...
	return gensym_cons_1(M_CAR(evaluation_value),Qtruth_value);
}
    ...
    Object class_name;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(Reference_class_info_p ? 
...
Object icon_description_pseudo_attribute_getter(class_name)
    Object class_name;
{
    Object category_evaluator_interface, evaluation_value_function;
    ...
    Object line_drawing_description, gensymed_symbol_5;
    ...
    Object class_name;
{
    ...
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, slot_description_qm, slot_init_form_qm;
    Object cross_section_pattern, gensymed_symbol_5;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    ...
    Object class_name;
{
  ...
  next_loop:
    ...
    if (valid_attribute) {
	ab_loopvar__2 = gensym_cons_1(valid_attribute,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object class_description, include_inherited_attributes_p, stop_classes;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(attr_name,
		attribute_structure),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(virtual_attributes);
  ...
  next_loop_1:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(aliased_slot_name,
		slot_description),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
  ...
  end_2:;
	...
	if (include_inherited_attributes_p ?  
	    ...
	    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(non_local_attr,
		    attribute_structure),Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
...
Object get_instance_attribute_descriptions_of_class varargs_1(int, n)
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__1 = 
		gensym_cons_1(generate_description_of_attribute(class_name,
		name,slot,
		lookup_global_or_kb_specific_property_value(class_name,
    ...
    Object class_name;
{
  ...
  next_loop:
    ...
    result_1 = gensym_cons_1(attribute_value,result_1);
    result_1 = gensym_cons_1(attribute_name,result_1);
    goto next_loop;
  end_loop:
    ...
    Object class_name, include_inherited_attributes_p, structure_p;
{
	...
	PUSH_SPECIAL(Class_info_attributes,class_info_attributes,0);
	  Class_info_attributes = gensym_cons_1(Qclass_attributes,
		  Class_info_attributes);
	  Class_info_attributes = gensym_cons_1(class_attributes,
		  Class_info_attributes);
	  Class_info_attributes = gensym_cons_1(Qinstance_attributes,
		  Class_info_attributes);
	  Class_info_attributes = gensym_cons_1(instance_attributes,
		  Class_info_attributes);
	  Class_info_attributes = 
    ...
    Object rpc_instance, class_name, include_inherited_attributes_p;
{
    ...
    PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  return_from_system_defined_rpc(rpc_instance,
		  gensym_cons_1(info_or_error,Nil));
    POP_SPECIAL();
    return VALUES_1(Nil);
}
    ...
    Object class_name;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(class_in_hierarchy,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object class_name;
{
	...
	temp = definition ? 
		allocate_evaluation_sequence(gensym_list_3(class_inheritance_path,
    ...
    Object rpc_instance, classname, attribute;
{
	...
	return_from_system_defined_rpc(rpc_instance,
		gensym_cons_1(evaluation_value_or_error,Nil));
    return VALUES_1(Nil);
}
    ...
    Object rpc_instance, classname, attributes;
{
  ...
  next_loop:
	...
	goto next_loop_1;
      end_loop_1:;
	reclaim_gensym_list_1(attribute_values);
	evaluation_value_or_error = attribute_value_or_error;
	goto end_1;
    }
    else {
	attribute_values = gensym_cons_1(attribute_value_or_error,
		attribute_values);
	attribute_values = gensym_cons_1(attribute_name,attribute_values);
    }
    goto next_loop;
  end_loop:
    evaluation_value_or_error = 
    ...
    Object rpc_instance, class_names;
{
    ...
    return_from_system_defined_rpc(rpc_instance,
	    gensym_cons_1(g2_get_multiple_class_attribute_values(class_names),
	    Nil));
    return VALUES_1(Nil);
}
    ...
    Object class_names;
{
  ...
  next_loop_3:
    ...
    class_attribute_values_list = gensym_cons_1(temp_1,
	    class_attribute_values_list);
    class_attribute_values_list = gensym_cons_1(class_to_collect,
	    class_attribute_values_list);
    goto next_loop_3;
  end_loop_3:;
    ...
    Object class_name;
{
  ...
  next_loop:
	...
	class_attribute_values = gensym_cons_1(temp,class_attribute_values);
	class_attribute_values = gensym_cons_1(pseudo_attribute_name,
    ...
    Object format_description;
{
  ...
  next_loop:
	...
	name_value_plist = gensym_cons_1(name,name_value_plist);
	name_value_plist = gensym_cons_1(exported_value_qm,name_value_plist);
    }
    goto next_loop;
  end_loop:
    reclaim_eval_alist(name_and_description_alist);
    ...
    Object class_name;
{
	...
	PUSH_SPECIAL(Indent_sequences_and_structures_p,indent_sequences_and_structures_p,
		0);
    ...
    Object rpc_instance;
{
	...
	end_loop:
	  ...
	  temp =  !TRUEP(name_qm);
      if ( !temp)
	  ws_info_list = gensym_cons_1(name_qm,ws_info_list);
      goto next_loop;
    end_loop_1:
      ws_info = allocate_evaluation_sequence(ws_info_list);
      return_from_system_defined_rpc(rpc_instance,gensym_cons_1(ws_info,Nil));
    POP_SPECIAL();
    return VALUES_1(Nil);
}
...
{
    x_note_fn_call(250,58);
    set_v5_mode_state(evaluation_truth_value_true_p(state_1));
    return_from_system_defined_rpc(rpc_instance,
	    gensym_cons_1(G2_has_v5_mode_windows_p ? Evaluation_true_value 
	    : Evaluation_false_value,Nil));
    return VALUES_1(Nil);
}

Object Ws_representation_slots_to_update = UNBOUND;
    ...
    Object rpc_instance, session, workspace, attributes;
{
	...
	if (attributes) {
	  ...
	  next_loop:
	    ...
	    next_index = next_index + (SI_Long)1L;
	    attr = validated_elt;
	    ab_loopvar__2 = gensym_cons_1(attr,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
	...
	result_1 = 
		gensym_cons_1(create_ws_representation_updated_state(workspace,
		attr_list),Nil);
	if (interim_attr_list)
	    reclaim_gensym_list_1(interim_attr_list);
	if (attributes)
    ...
    Object rpc_instance, session, subscription_handle;
{
	...
	return_from_system_defined_rpc(rpc_instance,
		gensym_cons_1(Evaluation_false_value,Nil));
    else {
	...
	if (disassociate_workspace_from_ui_session(session,frame)) {
	    ...
	    return_from_system_defined_rpc(rpc_instance,
		    gensym_cons_1(Evaluation_true_value,Nil));
	}
	else
    ...
    Object transient_change_p_ev;
{
	...
	reclaim_gensym_cons_1(enlarge_workspace_if_necessary_p_ev);
	...
	reclaim_gensym_cons_1(transient_change_p_ev);
    ...
    return_from_system_defined_rpc(rpc_instance,gensym_cons_1(item ? 
...
{
    x_note_fn_call(250,66);
    set_package_preparation_mode(evaluation_truth_value_is_true_p(new_state));
    return_from_system_defined_rpc(rpc_instance,
	    gensym_cons_1(Package_preparation_mode ? Evaluation_true_value 
	    : Evaluation_false_value,Nil));
    return VALUES_1(Nil);
}
...
Object g2_set_simulate_proprietary_mode_system_rpc_internal(rpc_instance,
    ...
    Object rpc_instance, new_state;
{
    x_note_fn_call(250,68);
    set_simulate_proprietary_mode(evaluation_truth_value_is_true_p(new_state));
    return_from_system_defined_rpc(rpc_instance,
	    gensym_cons_1(Simulate_proprietary_qm ? Evaluation_true_value :
	     Evaluation_false_value,Nil));
    return VALUES_1(Nil);
}
    ...
    Object items, paths, interval, return_rpc_name, id;
{
  ...
  next_loop:
		  ...
		  if (EQ(version_for_current,T) || 
			  ...
			  PUSH_SPECIAL(Current_lookup_data,current_lookup_data,
			    ...
			    send_ws_representations_item_moved_aux(item,
				    path,FIX((SI_Long)0L),FIX((SI_Long)0L),
				    interval,return_rpc_name,id);
	...
	if (temp_1 ? TRUEP(representation_address_valid_p(rep)) : TRUEP(Nil)) {
	  ...
	  next_loop_6:
		...
		sessions = gensym_cons_1(session,sessions);
	    goto next_loop_6;
	  end_loop_6:;
	}
	goto next_loop_5;
  ...
  end_loop:
    ...
    return allocate_evaluation_sequence(sessions);
    return VALUES_1(Qnil);
}
    ...
    Object item, without_permanence_checks_p, without_leaving_stubs_p;
{
	...
	reclaim_gensym_cons_1(without_permanence_checks_p);
	...
	reclaim_gensym_cons_1(without_leaving_stubs_p);
    ...
    Object message_1;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = gensym_cons_1(block,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	    lst = ab_loopvar__1;
    ...
    Object item;
{
  ...
  next_loop:
	...
	goto end_loop;
    containment_list = gensym_cons_1(superior_frame_1,containment_list);
    ...
    Object item, user_mode;
{
	...
	end_1:;
	  ...
	  exported_user_menu_choices = 
		  gensym_cons_1(current_user_menu_choice,
		  exported_user_menu_choices);
      goto next_loop_1;
    end_loop_1:;
      goto next_loop;
    ...
    Object gensymed_symbol, item, session;
{
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,1);
	    ...
	    PUSH_SPECIAL(Current_ui_client_session,current_ui_client_session,
		    0);
	      result = g2_get_current_user_menu_choices_internal(item,
		      user_mode);
	    POP_SPECIAL();
    ...
    Object class_name;
{
	...
	ab_loopvar__2 = gensym_cons_1(sci,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    scis = ab_loopvar__2;
    ...
    Object class_name;
{
    ...
    x_note_fn_call(250,115);
    if (lookup_global_or_kb_specific_property_value(class_name,
	    Class_description_gkbprop))
	return allocate_evaluation_sequence(copy_list_using_gensym_conses_1(lookup_global_or_kb_specific_property_value(class_name,
    ...
    Object rpc_instance, item;
{
    ...
    return_from_system_defined_rpc(rpc_instance,gensym_cons_1(ok_qm ? 
	    Evaluation_true_value : Evaluation_false_value,Nil));
    return VALUES_1(Nil);
}
    ...
    Object rpc_instance, item;
{
    ...
    x_note_fn_call(250,119);
    disabled_qm = (SI_Long)0L != (IFIX(ISVREF(item,(SI_Long)4L)) & 
	    (SI_Long)8192L);
    return_from_system_defined_rpc(rpc_instance,gensym_cons_1(disabled_qm ?
	     Evaluation_true_value : Evaluation_false_value,Nil));
    return VALUES_1(Nil);
}
    ...
    Object item;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    lists = gensym_cons_1(ISVREF(element,(SI_Long)3L),lists);
    goto next_loop;
  end_loop:
    ...
    Object class_name;
{
  ...
  next_loop_1:
    ...
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    methods = gensym_cons_1(method,methods);
    goto next_loop_1;
  end_loop_1:;
    goto next_loop;
  end_loop:
    ...
    Object method_name;
{
  ...
  next_loop:
	...
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	methods_found = gensym_cons_1(specific_method,methods_found);
	goto next_loop_1;
      end_loop_1:;
    }
    goto next_loop;
    ...
    Object rpc_instance, desired_state;
{
	...
	if (Inside_breakpoint_p)
	    return_from_breakpoint(1,gensym_cons_1(Qg2_set_g2_state,
		    rpc_instance));
    ...
    Object rpc_instance;
{
	...
	new_state = Qreset;
    return_from_system_defined_rpc(rpc_instance,gensym_cons_1(new_state,Nil));
    return VALUES_1(Nil);
}
    ...
    Object loose_end, connection, vertex_list_arg, connection_mode;
{
	...
	if ( !(horizontal_p ? FIXNUM_EQ(prev_y,y) : FIXNUM_EQ(prev_x,x))) {
	    ...
	    reclaim_gensym_list_1(deltas);
	    top_of_stack = Cached_top_of_stack;
	    message_1 = tformat_stack_error_text_string(1,string_constant_11);
	    raw_stack_error_named_error(top_of_stack,message_1);
	}
	deltas = gensym_cons_1(horizontal_p ? FIXNUM_MINUS(x,prev_x) : 
	...
	if ( !TRUEP(ab_loop_iter_flag_))
	    horizontal_p =  !TRUEP(horizontal_p) ? T : Nil;
	deltas = gensym_cons_1(initial_horizontal_p ? FIXNUM_MINUS(x,
		prev_x) : FIXNUM_MINUS(y,prev_y),deltas);
	deltas = gensym_cons_1( !TRUEP(initial_horizontal_p) ? 
    ...
    Object gensymed_symbol, connection;
{
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    result = allocate_evaluation_sequence(gensym_list_2(input,output));
	    MVS_2(result,gensymed_symbol_1,gensymed_symbol_2);
	    return_list = gensym_cons_1(gensymed_symbol_1,Nil);
	    result = return_from_system_defined_rpc(gensymed_symbol,
		    return_list);
    ...
    Object rpc_instance, type;
{
    ...
    return_from_system_defined_rpc(rpc_instance,gensym_cons_1(value,Nil));
    return VALUES_1(Nil);
}
    ...
    Object tree;
{
    ...
    Object gensymed_symbol, element, ab_loop_list_, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, list_of_sequences;
    double aref_new_value;

    x_note_fn_call(250,147);
    if ( !LISTP(tree)) {
	if (FIXNUMP(tree))
	    temp = tree;
	else if ( !TRUEP(tree))
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(make_nested_evaluation_value_based_on_type(element),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    Object trend_chart, trend_chart_data;
{
  ...
  next_loop_1:
	...
	subscription_handle = ISVREF(representation,(SI_Long)12L);
	socket_1 = getf(address,Qsocket,_);
	argument_list = gensym_list_4(subscription_handle,trend_chart,
    ...
    Object trend_chart, is_activation;
{
  ...
  next_loop_1:
	...
	if ( !TRUEP(body_evaluated_p)) {
	    ...
	    notification_body = gensym_cons_1(gensymed_symbol,Qab_structure);
	    body_evaluated_p = T;
	}
	address = ISVREF(representation,(SI_Long)8L);
	subscription_handle = ISVREF(representation,(SI_Long)12L);
    ...
    Object trend_chart, delta;
{
    ...
    Object amf_array, amf_result, incff_1_arg, new_float, gensymed_symbol_4;
    Object svref_new_value, address, subscription_handle, socket_1;
  ...
  next_loop_1:
	...
	if ( !TRUEP(body_evaluated_p)) {
		...
		if (FIXNUMP(delta))
			...
			item_or_value = gensym_cons_1(gensymed_symbol_4,
				Qtruth_value);
		}
		else
    ...
    Object item, new_variables;
{
	...
	next_loop_1:
	  ...
	  if ( !temp ? 
	      ...
	      address = ISVREF(representation,(SI_Long)8L);
	      socket_1 = getf(address,Qsocket,_);
	      representation_version = remote_icp_protocol_version(socket_1);
	      subscription_handle = ISVREF(representation,(SI_Long)12L);
	      current_list = Notification_data_version_map;
	      version_or_data = Nil;
	    next_loop_2:
	      ...
	      evaluatedp = 
		      javalink_versioned_call_data_evaluated_p(version_or_data);
	      if (EQ(version_for_current,T) || 
		      FIXNUM_GE(representation_version,version_for_current)) {
		  if ( !TRUEP(evaluatedp)) {
		      current_lookup_data = 
			      make_javalink_versioned_data(version_or_data);
		      PUSH_SPECIAL(Current_lookup_data,current_lookup_data,0);
			send_versioned_ws_notification_internal(Qitem_icon_variables_change,
				item,FIXNUMP(new_variables) || 
				new_variables && SYMBOLP(new_variables) || 
	...
	end_loop_1:
	  ...
	  reclaim_frame_serial_number(current_frame_serial_number_on_entry);
	  javalink_versioning_reclaim_evaluated_version_bodies(Notification_data_version_map);
	  result = VALUES_1(any_body_evaluated_p);
	  goto end_3;
	  result = VALUES_1(Qnil);
	end_3:;
      }
    ...
    Object id_qm;
{
	...
	bounds = gensym_cons_1(gensymed_symbol,Qab_structure);
    }
    if (path_qm) {
	    ...
	    next_loop_2:
		  ...
		  if ( !TRUEP(evaluatedp)) {
		      current_lookup_data = 
			      make_javalink_versioned_data(version_or_data);
		      PUSH_SPECIAL(Current_lookup_data,current_lookup_data,0);
			send_ws_representations_item_moved_aux(item,Nil,
				FIX((SI_Long)0L),FIX((SI_Long)0L),Nil,Nil,Nil);
			version_or_data = Current_lookup_data;
		      POP_SPECIAL();
		      M_CAR(current_list) = version_or_data;
		  }
    ...
    Object connection;
{
    ...
    PUSH_SPECIAL(Notification_data_version_map,notification_data_version_map,
	  ...
	  if (temp) {
	      ...
	      (SI_Long)0L),Qg2_defstruct_structure_name_connection_g2_struct))
	  ...
	  if ( !temp ? 
	    ...
	    next_loop_2:
		  ...
		  if ( !TRUEP(evaluatedp)) {
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size))
			    SVREF(gensymed_symbol_3,FIX((SI_Long)3L)) = Qleft;
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
			    ...
			    temp_2 = temp ? 
				    get_reference_to_item(item_or_value) : 
				    item_or_value;
			    SVREF(gensymed_symbol_3,FIX((SI_Long)4L)) = temp_2;
			}
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			    item_or_value = new_left;
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size))
			    SVREF(gensymed_symbol_3,FIX((SI_Long)5L)) = Qtop;
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
			    ...
			    temp_2 = temp ? 
				    get_reference_to_item(item_or_value) : 
				    item_or_value;
			    SVREF(gensymed_symbol_3,FIX((SI_Long)6L)) = temp_2;
			}
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			    item_or_value = FIXNUM_NEGATE(new_top);
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size))
			    SVREF(gensymed_symbol_3,FIX((SI_Long)7L)) = Qright;
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
			    ...
			    temp_2 = temp ? 
				    get_reference_to_item(item_or_value) : 
				    item_or_value;
			    SVREF(gensymed_symbol_3,FIX((SI_Long)8L)) = temp_2;
			}
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			    item_or_value = new_right;
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size))
			    SVREF(gensymed_symbol_3,FIX((SI_Long)9L)) = 
				    Qbottom;
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
			    ...
			    temp_2 = temp ? 
				    get_reference_to_item(item_or_value) : 
				    item_or_value;
			    SVREF(gensymed_symbol_3,FIX((SI_Long)10L)) = 
				    temp_2;
			}
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			...
			send_versioned_ws_notification_internal(Qitem_resize,
				item,gensym_cons_1(gensymed_symbol_3,
				Qab_structure));
			version_or_data = Current_lookup_data;
		      POP_SPECIAL();
		      M_CAR(current_list) = version_or_data;
		...
		next_loop_2:
		  ...
		  if (EQ(version_for_current,T) || 
			  ...
			  PUSH_SPECIAL(Current_lookup_data,current_lookup_data,
			    ...
			    if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				    (SI_Long)1L),Maximum_in_place_array_size))
				SVREF(gensymed_symbol_3,FIX((SI_Long)3L)) 
					= Qnew_rotation;
			    else {
				temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
				SVREF(temp_2,FIX((SI_Long)1L)) = Qnew_rotation;
			    }
			    if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				    (SI_Long)1L),
					Maximum_in_place_array_size)) {
				...
				temp_2 = temp ? 
					get_reference_to_item(item_or_value) 
					: item_or_value;
				SVREF(gensymed_symbol_3,FIX((SI_Long)4L)) 
					= temp_2;
			    }
			    else {
				temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
		  ...
		  if ( !TRUEP(evaluatedp)) {
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				...
				if (FIXNUM_LE(ISVREF(gensymed_symbol_4,
				    ...
				    svref_arg_2 = gensymed_symbol + 
					    IFIX(Managed_array_index_offset);
				    ISVREF(gensymed_symbol_4,svref_arg_2) 
					    = FIX((SI_Long)1L);
				}
				else {
				    temp_2 = ISVREF(gensymed_symbol_4,
					    (gensymed_symbol >>  -  - 
					    (SI_Long)10L) + (SI_Long)2L);
				    svref_arg_2 = gensymed_symbol & 
					    (SI_Long)1023L;
				...
				item_or_value = 
					gensym_cons_1(gensymed_symbol_4,
					Qab_structure);
			    }
			    else
				item_or_value = 
				...
				if (FIXNUM_LE(ISVREF(gensymed_symbol_4,
				    ...
				    temp_3 = ISVREF(gensymed_symbol_4,
					    (gensymed_symbol >>  -  - 
					    (SI_Long)10L) + (SI_Long)2L);
				    svref_arg_2 = gensymed_symbol & 
					    (SI_Long)1023L;
    ...
    Object thing, parent_of_thing_qm, position_or_next_lower_thing;
{
    ...
    PUSH_SPECIAL(Notification_data_version_map,notification_data_version_map,
	    1);
      if (should_be_wksp_thing && v5_tw_item_like_p(should_be_wksp_thing)) {
	  any_body_evaluated_p = Nil;
		  ...
		  if ( !TRUEP(evaluatedp)) {
			...
			if (FIXNUMP(version_or_data) && 
			    ...
			    send_ws_representations_item_insert_or_change_layer_aux(thing,
				    useable_position_or_next_lower_thing,Nil);
			else {
			    send_ws_representations_item_remove_as_subblock_aux(thing);
			    send_ws_representations_item_insert_or_change_layer_aux(thing,
				    useable_position_or_next_lower_thing,T);
			}
			version_or_data = Current_lookup_data;
		      POP_SPECIAL();
		      M_CAR(current_list) = version_or_data;
    ...
    Object thing, parent_of_thing_qm, position_or_next_lower_thing;
{
	...
	position_or_next_lower_thing = 
		...
		subblocks_1));
	reclaim_gensym_list_1(subblocks_1);
    }
    ...
    Object thing, position_or_next_lower_thing;
{
    ...
    temp_2 = send_versioned_ws_notification_internal(Qitem_layer_change,
	    thing,gensym_cons_1(gensymed_symbol,Qab_structure));
	  ...
	  if ( !temp ? 
	    ...
	    next_loop_2:
		  ...
		  if ( !TRUEP(evaluatedp)) {
			...
			new_value = getter_qm ? inline_funcall_1(getter_qm,
				item) : No_component_value;
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
			    ...
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			    SVREF(temp_2,FIX((SI_Long)1L)) = Qattribute_name;
			}
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size)) {
			...
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size))
			    SVREF(gensymed_symbol_3,FIX((SI_Long)5L)) = 
				    Qnew_value;
			else {
			    temp_2 = ISVREF(gensymed_symbol_3,(SI_Long)2L);
			    SVREF(temp_2,FIX((SI_Long)3L)) = Qnew_value;
			}
			if (FIXNUM_LE(ISVREF(gensymed_symbol_3,
				(SI_Long)1L),Maximum_in_place_array_size)) {
			...
			update_info = gensym_cons_1(gensymed_symbol_3,
				Qab_structure);
...
Object Highest_parsing_context_handle = UNBOUND;

Object Current_parsing_contexts = UNBOUND;
...
Object Testing_parsing_context_locally_p = UNBOUND;
    ...
    Object current_parsing_context_qm, index_1, rpc_instance;
{
    ...
    x_note_fn_call(250,176);
    PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,1);
	  ...
	  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		  Maximum_in_place_array_size)) {
	      item_or_value = 
		      allocate_evaluation_sequence(copy_list_using_gensym_conses_1(completion_choices));
	      if (SIMPLE_VECTOR_P(item_or_value) && 
		      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
		      (SI_Long)2L &&  !EQ(ISVREF(item_or_value,
		      (SI_Long)1L),Qavailable_frame_vector)) {
	  ...
	  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		  Maximum_in_place_array_size)) {
	      item_or_value = 
		      allocate_evaluation_sequence(copy_list_using_gensym_conses_1(category_choices));
	      if (SIMPLE_VECTOR_P(item_or_value) && 
		      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
		      (SI_Long)2L &&  !EQ(ISVREF(item_or_value,
		      (SI_Long)1L),Qavailable_frame_vector)) {
...
{
    x_note_fn_call(250,177);
    maybe_return_from_system_defined_rpc(rpc_instance,
	    gensym_cons_1(g2_simple_create_parsing_context(item,
	    attribute_name),Nil));
    return VALUES_1(Nil);
}
    ...
    Object the_text_as_evaluation_value;
{
    ...
    PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
...
Object g2_delete_parsing_context_system_rpc_internal(rpc_instance,
    ...
    Object rpc_instance, parsing_context_handle;
{
    x_note_fn_call(250,186);
    if (rpc_interface_class_ok_qm(rpc_instance,Qg2_delete_parsing_context,
	    Qui_client_interface))
	return_from_system_defined_rpc(rpc_instance,
		gensym_cons_1(g2_delete_parsing_context(parsing_context_handle),
		Nil));
    return VALUES_1(Nil);
}
    ...
    Object editing_for_runtime_change_p;
{
	...
	PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
	  if (Current_parsing_context_qm) {
	      ...
	      return_from_system_defined_rpc(rpc_instance,
		      gensym_cons_1(structure_to_return,Nil));
	  }
	  else {
	      top_of_stack = Cached_top_of_stack;
	      message_1 = tformat_stack_error_text_string(2,
    ...
    Object editing_for_runtime_change_p_as_evaluation_value;
{
    ...
    PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
	  ...
	  value_1 = gensym_cons_1(gensymed_symbol,Qab_structure);
      }
      else {
	  top_of_stack = Cached_top_of_stack;
	  message_1 = tformat_stack_error_text_string(2,string_constant_23,
    ...
    if ( !(EQ(editing_for_runtime_change_p_as_evaluation_value,
	    ...
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(editing_for_runtime_change_p_as_evaluation_value);
    ...
    Object copy_of_gripe;
{
    ...
    PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
      ...
      result = maybe_return_from_system_defined_rpc(rpc_instance,
	      gensym_cons_1(package_return_values_from_parsing_rpc(ok,
    ...
    Object completion_choices, token_complete_p, token_data, copy_of_gripe;
{
    ...
    if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
	    Maximum_in_place_array_size)) {
	item_or_value = 
		allocate_evaluation_sequence(copy_list_using_gensym_conses_1(token_data));
	if (SIMPLE_VECTOR_P(item_or_value) && 
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
		(SI_Long)2L &&  !EQ(ISVREF(item_or_value,(SI_Long)1L),
		Qavailable_frame_vector)) {
    ...
    Object rpc_instance, parsing_context_handle, new_position, the_text;
{
	...
	PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
	  if (Current_parsing_context_qm) {
	      ...
	      maybe_return_from_system_defined_rpc(rpc_instance,
		      gensym_cons_1(g2_adjust_cursor_position(parsing_context_handle,
...
{
    x_note_fn_call(250,204);
    if (rpc_interface_class_ok_qm(rpc_instance,
	    Qg2_parsing_context_insert_characters,Qui_client_interface))
	return_from_system_defined_rpc(rpc_instance,
		gensym_cons_1(g2_parsing_context_insert_characters(parsing_context_handle,
	...
	PUSH_SPECIAL(Current_parsing_context_qm,current_parsing_context_qm,0);
	  if (Current_parsing_context_qm) {
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size)) {
		      item_or_value = 
			      allocate_evaluation_sequence(copy_list_using_gensym_conses_1(list_1));
		      if (SIMPLE_VECTOR_P(item_or_value) && 
			      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
			      > (SI_Long)2L &&  !EQ(ISVREF(item_or_value,
			      (SI_Long)1L),Qavailable_frame_vector)) {
    ...
    Object category_qm, category_function_qm, slot_features, frame, value;
{
	...
	if ( !TRUEP(value))
	    ...
	    temp = 
		    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(value));
	else if (SYMBOLP(value))
	    temp = value;
	else
	    temp = Qt;
    ...
    Object slot_component_indicator_qm;
{
    ...
    Object new_float, gensymed_symbol_4, svref_new_value, address;
    Object subscription_handle, socket_1, argument_list;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    SI_Long svref_arg_2;
	...
	if ( !temp ? TRUEP(representation_address_valid_p(representation)) 
		...
		notification_body = gensym_cons_1(gensymed_symbol,
			Qab_structure);
		body_evaluated_p = T;
	    }
	    address = ISVREF(representation,(SI_Long)8L);
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    if ( !(EQ(enlarge_workspace_if_necessary_1,
		    ...
		    Evaluation_false_value)))
		reclaim_gensym_cons_1(enlarge_workspace_if_necessary_1);
	    gensymed_symbol_1 = Nil;
	    return_list = Nil;
	    result = return_from_system_defined_rpc(gensymed_symbol,
		    return_list);
    ...
    Object item;
{
    ...
    next_loop:
	  ...
	  description = Nil;
      if (description)
	  descriptions = gensym_cons_1(description,descriptions);
      goto next_loop;
    end_loop:
      reclaim_gensym_list_1(display_description);
      descriptions = gensym_cons_1(main_header,descriptions);
...
/* GET-ITEM-NAME-OF-NODE */
Object get_item_name_of_node(node)
    Object node;
{
    Object item_or_name, temp, item_or_value, item, x2, item_name;
    char temp_1;

    x_note_fn_call(250,220);
    item_or_name = estructure_slot(node,Qitem_or_name,Nil);
    if (INLINE_UNSIGNED_BYTE_16_VECTOR_P(item_or_name) != (SI_Long)0L)
	temp = item_or_name;
    else {
	item_or_value = item_or_name;
	item = CONSP(item_or_value) && EQ(M_CDR(item_or_value),
	...
	if (SIMPLE_VECTOR_P(item) && IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item)) 
	    ...
	    temp_1 = TRUEP(Nil);
	item_name = temp_1 ? get_lookup_slot_value_given_default(item,
		Qname_or_names_for_frame,Nil) : Nil;
	temp = SYMBOLP(item_name) ? symbol_namew(item_name) : array_constant_4;
    }
    return VALUES_1(temp);
}

/* ITEM-OR-NAME-LESSP */
Object item_or_name_lessp(node1,node2)
    Object node1, node2;
{
    Object temp;

    x_note_fn_call(250,221);
    temp = get_item_name_of_node(node1);
    temp = string_lesspw(temp,get_item_name_of_node(node2));
    return VALUES_1(temp);
}
    ...
    Object default_junction, excluded_node;
{
    ...
    x_note_fn_call(250,223);
    siblings = Qnil;
    scope_conses = Scope_conses;
    ab_node_stack_ = Nil;
    ab_current_node_ = Nil;
    gensymed_symbol = ISVREF(default_junction,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)6L) : Nil;
    ab_skip_list_form_ = gensymed_symbol;
    ab_skip_list_p_ = Nil;
    ...
    end_1:
	  ...
	  if (temp_1) {
	      ...
	      siblings = gensym_cons_1(gensym_cons_1(gensymed_symbol,
...
static Object Qitem_or_name_lessp;  /* item-or-name-lessp */
    ...
    Object item_node;
{
	...
	if (temp)
	    ...
	    child_nodes = gensym_cons_1(gensym_cons_1(gensymed_symbol_3,
		    Qab_structure),Nil);
	}
	node = Nil;
	...
	temp_2 = child_nodes ? set_evaluation_structure_slot(item_node,
		Qchildren,
		allocate_evaluation_sequence(sort_list(child_nodes,
		SYMBOL_FUNCTION(Qitem_or_name_lessp),Nil))) : Nil;
    }
    else
	temp_2 = Nil;
    return VALUES_1(temp_2);
...
Object get_tree_structure_for_inspect_command varargs_1(int, n)
{
	...
	root_node = gensym_cons_1(gensymed_symbol,Qab_structure);
    }
    else
	root_node = Nil;
    if (root_node) {
...
Object export_graph_node varargs_1(int, n)
{
	...
	child_nodes_qm = gensym_cons_1(temp_2,child_nodes_qm);
	goto next_loop;
      end_loop:
	if (child_nodes_qm)
	    set_evaluation_structure_slot(root_node,Qchildren,
	...
	set_evaluation_structure_slot(root_node,Qchildren,
		allocate_evaluation_sequence(gensym_cons_1(export_graph_node(3,
    ...
    Object module_to_start_with_qm;
{
    ...
    x_note_fn_call(250,243);
    gensymed_symbol = get_or_make_dummy_workstation();
    current_workstation_1 = gensymed_symbol;
    PUSH_SPECIAL(Current_workstation,current_workstation_1,10);
      current_workstation_window = ISVREF(Current_workstation,(SI_Long)1L);
      PUSH_SPECIAL(Current_workstation_window,current_workstation_window,9);
	type_of_current_workstation_window = Nil;
	PUSH_SPECIAL(Type_of_current_workstation_window,type_of_current_workstation_window,
		8);
	  current_workstation_native_window_qm = Nil;
		  ...
		  PUSH_SPECIAL(Current_workstation_detail_pane,current_workstation_detail_pane,
			...
			if (system_table_for_top_module_qm && 
			    ...
			    graph = 
				    ...
				    temp_1,temp_2,temp_3,temp_4,Nil,temp,
				    Nil,FIX((SI_Long)0L),FIX((SI_Long)0L));
			    gensymed_symbol = allocate_managed_array(1,
				    FIX((SI_Long)2L + (SI_Long)1L));
			    gensymed_symbol_1 = (SI_Long)0L;
				...
				temp_5 = ISVREF(gensymed_symbol,(SI_Long)2L);
				SVREF(temp_5,FIX((SI_Long)1L)) = Qitem_or_name;
			    }
			    if (FIXNUM_LE(ISVREF(gensymed_symbol,
				    (SI_Long)1L),
					Maximum_in_place_array_size)) {
			    ...
			    set_evaluation_structure_slot(temp,Qchildren,
				    allocate_evaluation_sequence(gensym_cons_1(export_graph_node(1,
			...
			next_loop:
			  ...
			  if ( !EQ(module_information_instance,
				  ...
				  instance_qm = 
					  ...
					  Module_information_instance_for_module_qm_kbprop);
				  temp_6 =  !(instance_qm && 
					  ISVREF(instance_qm,(SI_Long)25L));
			      }
			  }
			  else
			      temp_6 = TRUEP(Nil);
			  if (temp_6) {
			      ...
			      if (FIXNUM_LE(ISVREF(gensymed_symbol,
				      (SI_Long)1L),
				      Maximum_in_place_array_size)) {
				  item_or_value = module_information_instance;
				  if (SIMPLE_VECTOR_P(item_or_value) && 
					  IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
					  > (SI_Long)2L &&  
					  !EQ(ISVREF(item_or_value,
			      ...
			      unrequired_modules_qm = 
				      gensym_cons_1(gensym_cons_1(gensymed_symbol,
				      Qab_structure),unrequired_modules_qm);
			  }
			  goto next_loop;
			end_loop_1:
			...
			if (unrequired_modules_node_qm) {
			    ...
			    root_node = gensym_cons_1(gensymed_symbol,
				    Qab_structure);
			    set_evaluation_structure_slot(root_node,
				    Qchildren,
				    allocate_evaluation_sequence(gensym_list_2(required_modules_node,
				    unrequired_modules_node_qm)));
			    result = VALUES_1(root_node);
			}
			else
			    result = VALUES_1(required_modules_node);
		      POP_SPECIAL();
		    POP_SPECIAL();
		  POP_SPECIAL();
		POP_SPECIAL();
...
void events_g2_INIT()
{
    ...
    Object Qpseudo_attribute_count, Qchain_of_available_pseudo_attributes;
    ...
    string_constant_42 = 
	    STATIC_STRING("43Dy8m83lty1n83lty8n8k1l8n0000001l1n8y83-5Ey1l83-9bykpk0k0");
    ...
    Qpseudo_attribute_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_43 = STATIC_STRING("1q83lty8s83-jSy09k9l");
    ...
    Qitem_or_name_lessp = STATIC_SYMBOL("ITEM-OR-NAME-LESSP",AB_package);
    SET_SYMBOL_FUNCTION(Qitem_or_name_lessp,
	    STATIC_FUNCTION(item_or_name_lessp,NIL,FALSE,2,2));
