...
Object write_attribute_description varargs_1(int, n)
{
	...
	if (slot_description) {
		...
		gensymed_symbol_1 = name_of_defined_class;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(name_of_defined_class) 
    ...
    Object override, frame;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, initial_type;
    Object write_strings_parsably_qm, slot_value_writer_qm;
    Object write_symbols_in_lower_case_qm, class_1, car_1, cdr_1, data_type_qm;
    Object array_class;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    ...
    Object value, frame, slot_description;
{
	...
	authors_sequence = allocate_evaluation_sequence(other_authors_qm ? 
		gensym_cons_1(first_author_qm,
		copy_list_using_gensym_conses_1(other_authors_qm)) : 
		gensym_cons_1(first_author_qm,Nil));
	result_1 = allocate_evaluation_structure(gensym_list_2(Qauthors,
		authors_sequence));
	if (last_edit_timestamp_qm) {
	    if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		set_evaluation_structure_slot(result_1,Qtimestamp,
			gensym_cons_1(gensymed_symbol,Qab_structure));
	    }
	    POP_LOCAL_ALLOCATION(0,0);
	}
	temp = result_1;
	...
	temp = allocate_evaluation_structure(gensym_list_2(Qauthors,
    ...
    Object element;
{
    ...
    Object gensymed_symbol, held_vector, name, attribute_value, plist;
    Object ab_loopvar_, ab_loopvar__1, sub_element, list_of_elements, elt_1;
    ...
    Object initial_value;
{
	...
	if (temp_1) {
		...
		if (FIXNUM_EQ(managed_value,Truth))
		    ...
		    return gensym_cons_1(managed_value,Qtruth_value);
	    }
		...
		return gensym_cons_1(initial_value,Qtruth_value);
	}
    ...
    Object initial_value, initial_type;
{
	...
	substitute_value = gensym_list_2(initial_value,Qtruth_value);
	answer = make_initial_value_for_user(substitute_value);
	reclaim_gensym_list_1(substitute_value);
	temp = answer;
    }
    else
    ...
    Object slot_value, frame, slot_description;
{
	...
	if (source_attribute_range) {
	  ...
	  next_loop_1:
	    ...
	    ab_loop_list__1 = M_CDR(ab_loop_list__1);
	    ab_loopvar__2 = gensym_cons_1(range_elt,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
    ...
    Object slot_value, frame_qm, slot_description;
{
    ...
    Object copied_attribute, ab_loop_list__1, attribute_name, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, car_new_value;
    Object copied_superior_attribute_descriptions_qm, attribute_info;
    Object source_attribute_name, source_attribute_type_specification;
    Object source_attribute_initial_value, source_attribute_initial_type;
    Object source_attribute_range, value, range_elt;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
	...
	if (class_description_qm &&  !TRUEP(ISVREF(class_description_qm,
	  ...
	  next_loop_2:
		...
		M_CAR(copied_attribute) = car_new_value;
	    }
	    else
		pretty_slot_names_encountered_qm = 
	...
	if (source_attribute_range) {
	  ...
	  next_loop_12:
		...
		gensymed_symbol_4 = ab_loopvar__2;
	    ab_loopvar__1 = ab_loopvar__2;
	    goto next_loop_12;
	  end_loop_12:
	    temp_1 = allocate_evaluation_sequence(gensymed_symbol_4);
	    goto end_11;
	    temp_1 = Qnil;
	  end_11:;
	    set_evaluation_structure_slot(gensymed_symbol_1,
    ...
    Object slot_value, frame, slot_description;
{
	...
	if (maximum_number || maximum_age || minimum_interval) {
	    temp = maximum_number ? 
		    gensym_list_2(Qmaximum_number_of_data_points,
		    maximum_number) : Nil;
	    temp = allocate_evaluation_structure(nconc2(temp,
		    nconc2(maximum_age ? 
		    gensym_list_2(Qmaximum_age_of_data_points,maximum_age) 
		    : Nil,minimum_interval ? 
		    gensym_list_2(Qminimum_interval_between_data_points,
    ...
    Object slot_value, frame, slot_description;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__1 = gensym_cons_1(class_name,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	    gensymed_symbol = ab_loopvar__1;
...
void grammar6b_INIT()
{
    ...
    string_constant_94 = 
	    STATIC_STRING("1o1m838My1m9k83Zy1m838My83-U0y1m83-U0y83-Gy1o83-U0y1n83-Gy1m9k83vy83-U0y1n83-tyln9l");
    ...
    string_constant_95 = 
	    STATIC_STRING("1o1m838Ny1m9k83Zy1m838Ny83-U2y1m83-U2y839Wy1o83-U2y1n839Wy1m9k83vy83-U2y1n83-tyln9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qsimplify_associative_operation);
    ...
    mutate_global_property(Qfocal_objects,
	    ...
	    Qslot_value_writer);
    string_constant_96 = 
	    STATIC_STRING("1o1m837sy1m9k83Zy1m837sy83-Lay1m83-Lay83mcy1o83-Lay1n83mcy1m9k83vy83-Lay1n83-tyln9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qsimplify_associative_operation);
    ...
    string_constant_97 = 
	    STATIC_STRING("1o1n83-oZy1m1m9k83-RKy1m9k83nTy83gqy1n83-oZy1m1m9k83gNy1m9k83nTy83gOy1m83-oZy1m9k83v0y1m83-oZy1m9k83dy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_98 = 
	    STATIC_STRING("1s1m83-*y1m9k83Zy1m83-*y83-Tsy1n83-*y1n83-Tsy1m9k83vy83-KHy1mln1m83-Tsy83q4y1n83-Tsy1o83q4y1m9k83-9y83x*y1m9k83-Ay2lln1o83x*y1m8");
    string_constant_99 = 
	    STATIC_STRING("355y83o+y1mlm9l1o83udy8355yl9m1m83q4y83-2y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant