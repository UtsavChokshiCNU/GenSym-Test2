    ...
    Object integer_or_text_string;
{
    ...
    temp = gensym_cons_1(Qlost_spaces,integer_or_text_string);
...
Object make_empty_text()
{
    ...
    return gensym_list_2(temp,obtain_simple_text_string(FIX((SI_Long)0L)));
}
    ...
    Object text;
{
    ...
    temp = gensym_cons_1(gensym_cons_1(Qintercepted,Nil),text);
    return VALUES_1(temp);
}
...
Object Chain_of_available_text_spots = UNBOUND;

Object Text_spot_count = UNBOUND;
    ...
    Object text_spot;
{
    ...
    svref_new_value = Chain_of_available_text_spots;
    SVREF(text_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_text_spots = text_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_text_spot_variable, text_spot_count_new_value;
    Object defstruct_g2_text_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(110,16);
    def_structure_text_spot_variable = Nil;
    text_spot_count_new_value = FIXNUM_ADD1(Text_spot_count);
    Text_spot_count = text_spot_count_new_value;
...
{
    Object def_structure_text_spot_variable;
...
Object Chain_of_available_table_spots = UNBOUND;

Object Table_spot_count = UNBOUND;
    ...
    Object table_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_table_spots;
    SVREF(table_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_table_spots = table_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_table_spot_variable, table_spot_count_new_value;
    Object defstruct_g2_table_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(110,22);
    def_structure_table_spot_variable = Nil;
    table_spot_count_new_value = FIXNUM_ADD1(Table_spot_count);
    Table_spot_count = table_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_table_spot_variable;
    ...
    Object class_1, called_from_alter_inheritance_qm;
{
    ...
    Object resulting_value, default_text_box_colors, class_description;
    Object class_inheritance_path, specified_border_color_qm;
    Object specified_text_color_qm, specified_background_color_qm, superior;
    Object ab_loop_list_, class_description_qm, sub_class_bit_vector;
  ...
  end_4:;
	...
	temp = gensym_list_2(Qborder_color,specified_border_color_qm);
    else {
	superior = Nil;
	...
	if (temp_2) {
	  ...
	  end_20:;
		...
		temp = gensym_list_2(Qborder_color,
	...
	temp_3 = gensym_list_2(Qline_color,specified_text_color_qm);
    else {
	superior = Nil;
	ab_loop_list_ = CDR(class_inheritance_path);
      next_loop_25:
	...
	if (temp_2) {
	  ...
	  end_37:;
		...
		temp_3 = gensym_list_2(Qline_color,
	...
	temp_1 = gensym_list_2(Qbackground_color,
		specified_background_color_qm);
    else {
	superior = Nil;
	ab_loop_list_ = CDR(class_inheritance_path);
      next_loop_42:
	...
	if (class_description_qm &&  !TRUEP(ISVREF(class_description_qm,
	  ...
	  end_44:;
		...
		M_CDR(gensymed_symbol_1) = Nil;
		inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
		gensymed_symbol = set_balanced_binary_tree_entry(temp_4,
			Qeq,Nil,T,gensymed_symbol,temp_1,gensymed_symbol_1);
	    }
	    global_properties = gensymed_symbol;
	    gensymed_symbol = CDR(global_properties);
	...
	if (called_from_alter_inheritance_qm) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = Qtext_box;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(Qtext_box) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_59:
	    if ( !TRUEP(gensymed_symbol))
	  ...
	  end_63:;
	    ...
	    new_slot_description = make_slot_description(8,
		    ...
		    ISVREF(plist_slot_description_from_text_box_class,
		    (SI_Long)9L));
	    reclaim_gensym_list_1(plist_init_form_qm);
		...
		goto next_loop_69;
	      end_loop_70:;
	      POP_SPECIAL();
	      result = reclaim_gensym_list_1(plist_init_form_qm);
	    POP_SPECIAL();
	    return result;
	}
    }
...
Object Chain_of_available_text_box_spots = UNBOUND;

Object Text_box_spot_count = UNBOUND;
    ...
    Object text_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_text_box_spots;
    SVREF(text_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_text_box_spots = text_box_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_text_box_spot_variable, text_box_spot_count_new_value;
    ...
    text_box_spot_count_new_value = FIXNUM_ADD1(Text_box_spot_count);
    Text_box_spot_count = text_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Post_draw_methods_for_text_box_formats = UNBOUND;
...
Object compute_width_of_longest_line varargs_1(int, n)
{
  ...
  next_loop:
	...
	if (line_width_qm)
	    ...
	    temp_1 = gensym_cons_1(text_element,CDR(l));
	    M_CDR(l) = temp_1;
	    temp_1 = gensym_cons_1(Qline_width,line_width);
	    M_CAR(l) = temp_1;
	}
	if (indentation_qm)
	    indentation_qm = Nil;
	else if (put_in_indentations_and_widths_qm) {
	    temp_1 = gensym_cons_1(CAR(l),CDR(l));
	    M_CDR(l) = temp_1;
	    M_CAR(l) = indentation;
	}
    }
...
Object change_color_of_text_box varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,3);
	...
	if (temp ? Scheduled_text_highlighting ||  
		...
		superblock_qm = Nil;
	      next_loop:
		gensymed_symbol_3 = ISVREF(this_block,(SI_Long)14L);
    ...
    Object new_border_color_qm;
{
	...
	if (force_hairline_border_qm);
		...
		gensymed_symbol_3 = ISVREF(superblock_qm,(SI_Long)14L);
		gensymed_symbol_3 = gensymed_symbol_3 ? 
			ISVREF(gensymed_symbol_3,(SI_Long)5L) : Nil;
		superblock_qm = gensymed_symbol_3;
		goto next_loop;
    ...
    Object unmagnified_distance_of_text_segment_from_top, text_box;
{
    ...
    x_note_fn_call(110,79);
    current_text_box_format = ISVREF(text_box,(SI_Long)17L);
    PUSH_SPECIAL(Current_text_box_format,current_text_box_format,3);
      current_text_cell_plist = ISVREF(text_box,(SI_Long)18L);
      PUSH_SPECIAL(Current_text_cell_plist,current_text_cell_plist,2);
	if (get_lookup_slot_value_given_default(text_box,
		Qframe_transforms_of_block,Nil)) {
	    temp = Current_image_plane;
	    temp = assq_function(temp,
	  ...
	  PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
		...
		if ( !temp_2) {
		  ...
		  next_loop:
		    ...
		    gensymed_symbol_1 = ISVREF(superblock_qm,(SI_Long)14L);
		    gensymed_symbol_1 = gensymed_symbol_1 ? 
			    ISVREF(gensymed_symbol_1,(SI_Long)5L) : Nil;
		    superblock_qm = gensymed_symbol_1;
		    goto next_loop;
...
Object Suppress_scrolling_into_view_global_flag_qm = UNBOUND;
...
Object Chain_of_available_label_box_spots = UNBOUND;

Object Label_box_spot_count = UNBOUND;
    ...
    Object label_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_label_box_spots;
    SVREF(label_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_label_box_spots = label_box_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_label_box_spot_structure_internal()
{
    ...
    Object label_box_spot_count_new_value;
    Object defstruct_g2_label_box_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(110,90);
    def_structure_label_box_spot_variable = Nil;
    label_box_spot_count_new_value = FIXNUM_ADD1(Label_box_spot_count);
    Label_box_spot_count = label_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Allow_activation_of_name_boxes_p = UNBOUND;
...
Object Chain_of_available_name_box_spots = UNBOUND;

Object Name_box_spot_count = UNBOUND;
    ...
    Object name_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_name_box_spots;
    SVREF(name_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_name_box_spots = name_box_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_name_box_spot_variable, name_box_spot_count_new_value;
    Object defstruct_g2_name_box_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(110,99);
    def_structure_name_box_spot_variable = Nil;
    name_box_spot_count_new_value = FIXNUM_ADD1(Name_box_spot_count);
    Name_box_spot_count = name_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
static Object Qg2gl_variable;      /* g2gl-variable */
...
Object Allow_name_box_creation = UNBOUND;

Object Allow_name_box_creation_without_workspace = UNBOUND;
  ...
  end_1:;
	...
	if (name_box_qm) {
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    new_text = gensym_cons_1(temp_1,Nil);
		...
		svref_new_value = gensym_cons_1(No_value,new_text);
	...
	if (Currently_working_on_drawing_workspace) {
	  ...
	  end_1:;
		...
		gensym_push_modify_macro_arg = 
			gensym_list_3(SYMBOL_FUNCTION(Qdraw_blinker_in_xor),
...
Object make_free_text_box varargs_1(int, n)
{
	...
	next_index = temp;
	temp = make_lost_spaces_text_element(FIX((SI_Long)0L));
	ab_loopvar__2 = gensym_list_2(temp,text_string_substring(text_line,
		index_1,next_index));
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
...
Object make_free_text_box_with_text varargs_1(int, n)
{
    ...
    svref_new_value = gensym_cons_1(No_value,text);
...
Object Star_line_index_of_change_qm = UNBOUND;

Object Star_character_index_of_change_qm = UNBOUND;

Object Star_line_index_past_deletion_qm = UNBOUND;

Object Star_character_index_past_deletion_qm = UNBOUND;

Object Star_string_to_insert_qm = UNBOUND;

Object Star_text_string_to_insert_is_simple_qm = UNBOUND;

Object Star_character_index_in_string_to_insert_qm = UNBOUND;

Object Star_line_buffer = UNBOUND;

Object Star_line_index = UNBOUND;

Object Star_character_index = UNBOUND;

Object Star_text_line = UNBOUND;

Object Star_text_line_is_simple_qm = UNBOUND;

Object Star_line_length = UNBOUND;

Object Star_lost_space_at_end_of_line = UNBOUND;

Object Star_this_text_tail_qm = UNBOUND;

Object Star_next_text_tail_qm = UNBOUND;

Object Star_current_indentation = UNBOUND;

Object Star_explicit_paragraph_or_newline_qm = UNBOUND;

Object Star_line_buffer_fill_pointer = UNBOUND;

Object Star_line_buffer_limit = UNBOUND;
...
Object reformat_text varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Star_line_index_of_change_qm,star_line_index_of_change_qm,19);
      star_character_index_of_change_qm = character_index_of_change_qm;
      PUSH_SPECIAL(Star_character_index_of_change_qm,star_character_index_of_change_qm,
	      18);
	star_line_index_past_deletion_qm = line_index_past_deletion_qm;
	PUSH_SPECIAL(Star_line_index_past_deletion_qm,star_line_index_past_deletion_qm,
		17);
	  star_character_index_past_deletion_qm = 
		  character_index_past_deletion_qm;
	  PUSH_SPECIAL(Star_character_index_past_deletion_qm,star_character_index_past_deletion_qm,
		  16);
	    star_string_to_insert_qm = string_to_insert_qm;
	    PUSH_SPECIAL(Star_string_to_insert_qm,star_string_to_insert_qm,15);
	      star_text_string_to_insert_is_simple_qm = Nil;
	      PUSH_SPECIAL(Star_text_string_to_insert_is_simple_qm,star_text_string_to_insert_is_simple_qm,
		      14);
		star_character_index_in_string_to_insert_qm = 
			Star_string_to_insert_qm ? FIX((SI_Long)0L) : Nil;
		PUSH_SPECIAL(Star_character_index_in_string_to_insert_qm,star_character_index_in_string_to_insert_qm,
			13);
		  star_line_buffer = make_text_line_buffer();
		  PUSH_SPECIAL(Star_line_buffer,star_line_buffer,12);
		    star_line_buffer_fill_pointer = FIX((SI_Long)0L);
		    PUSH_SPECIAL(Star_line_buffer_fill_pointer,star_line_buffer_fill_pointer,
			    11);
		      star_line_buffer_limit = get_text_line_buffer_limit();
		      PUSH_SPECIAL(Star_line_buffer_limit,star_line_buffer_limit,
			      10);
			star_line_index = Nil;
			PUSH_SPECIAL(Star_line_index,star_line_index,9);
			  star_character_index = FIX((SI_Long)0L);
			  PUSH_SPECIAL(Star_character_index,star_character_index,
				  8);
			    star_this_text_tail_qm = Nil;
			    PUSH_SPECIAL(Star_this_text_tail_qm,star_this_text_tail_qm,
				    7);
			      star_text_line = Nil;
			      PUSH_SPECIAL(Star_text_line,star_text_line,6);
				star_text_line_is_simple_qm = Nil;
				PUSH_SPECIAL(Star_text_line_is_simple_qm,star_text_line_is_simple_qm,
					5);
				  star_line_length = Nil;
				  PUSH_SPECIAL(Star_line_length,star_line_length,
					  4);
				    star_lost_space_at_end_of_line = Nil;
				    PUSH_SPECIAL(Star_lost_space_at_end_of_line,star_lost_space_at_end_of_line,
					    3);
				      star_next_text_tail_qm = Nil;
				      PUSH_SPECIAL(Star_next_text_tail_qm,star_next_text_tail_qm,
					      2);
					star_current_indentation = 
						FIX((SI_Long)0L);
					PUSH_SPECIAL(Star_current_indentation,star_current_indentation,
						1);
					  star_explicit_paragraph_or_newline_qm 
						  = Nil;
					  PUSH_SPECIAL(Star_explicit_paragraph_or_newline_qm,star_explicit_paragraph_or_newline_qm,
						  0);
    ...
    Object allow_override_below_limit_p;
{
  ...
  end_loop:;
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	context_stack = gensym_cons_1(symbol,context_stack);
	goto next_loop_1;
      end_loop_1:;
    }
  ...
  next_loop_2:
	...
	if (ok_to_break_qm) {
		...
		reclaim_gensym_tree_1(context_stack_at_last_natural_break_qm);
	    if (context_stack)
		context_stack_at_last_natural_break_qm = 
			copy_tree_using_gensym_conses_1(context_stack);
	}
    }
	...
	if (put_in_indentations_and_widths_qm)
	    reversed_new_text_segment = 
		    gensym_cons_1(gensym_cons_1(Qline_width,line_width),
		    reversed_new_text_segment);
	reversed_new_text_segment = gensym_cons_1(new_text_line,
		reversed_new_text_segment);
  ...
  end_loop_5:
    ...
    if (context_stack)
	reclaim_gensym_tree_1(context_stack);
    if (context_stack_at_last_natural_break_qm)
	reclaim_gensym_tree_1(context_stack_at_last_natural_break_qm);
...
Object convert_text_string_to_text(text_string)
    Object text_string;
{
    x_note_fn_call(110,132);
    return gensym_list_2(make_lost_spaces_text_element(FIX((SI_Long)0L)),
	    text_string);
}
    ...
    Object text_string_list;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(make_lost_spaces_text_element(FIX((SI_Long)0L)),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ab_loopvar__1 = ab_loopvar__2;
    ab_loopvar__2 = gensym_cons_1(text_string,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ...
    Object text_string, text_box;
{
    ...
    x_note_fn_call(110,148);
    temp = ISVREF(text_box,(SI_Long)16L);
    text = CDR(temp);
    current_custom_reclamation_stamp_qm = string_constant_5;
    PUSH_SPECIAL(Current_custom_reclamation_stamp_qm,current_custom_reclamation_stamp_qm,
	    0);
	  ...
	  translation = temp;
	  new_box_translation_and_text = gensym_cons_1(translation,
    ...
    Object entity;
{
	...
	if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
	    ...
	    item_or_value = gensym_cons_1(gensymed_symbol_2,Qab_structure);
	    if (SIMPLE_VECTOR_P(item_or_value) && 
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
    ...
    Object entity, evaluation_value;
{
	...
	PUSH_SPECIAL(Allow_name_box_creation,allow_name_box_creation,0);
    ...
    Object bottom_edge_of_cell_in_window;
{
    ...
    PUSH_SPECIAL(Current_text_box_format,current_text_box_format,1);
      current_text_cell_plist = Qnil;
      PUSH_SPECIAL(Current_text_cell_plist,current_text_cell_plist,0);
...
void boxes_INIT()
{
    ...
    Object Qname_box_spot_count, Qchain_of_available_name_box_spots;
    ...
    Object Qallow_activation_of_name_boxes_p, string_constant_82;
    Object list_constant_35, string_constant_81, string_constant_80;
    Object list_constant_34, Qexported_system_item;
    Object Qgenerate_spot_for_label_box, Qlabel_box_spot;
    Object Qoutstanding_label_box_spot_count;
    Object Qlabel_box_spot_structure_memory_usage, Qlabel_box_spot_count;
    Object Qchain_of_available_label_box_spots, string_constant_78;
    ...
    Object Qtext_box_spot_structure_memory_usage, Qtext_box_spot_count;
    Object Qchain_of_available_text_box_spots, string_constant_51;
    ...
    Object Qtable_spot_count, Qchain_of_available_table_spots;
    ...
    Object Qtext_spot_count, Qchain_of_available_text_spots, string_constant_9;
    Object string_constant_8, Qreclaim_text;

    x_note_fn_call(110,171);
    SET_PACKAGE("AB");
    ...
    string_constant_9 = STATIC_STRING("1q83*Cy8s83-r=y09k9l");
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83*xy1p83*xy83*Cy83Qy8n8k1l83*Cy0000001l1m8x83*Cyk3Jyk0k0");
    ...
    string_constant_11 = STATIC_STRING("1q83*xy8s83-qVy09k9l");
    clear_optimized_constants();
    ...
    string_constant_24 = 
	    STATIC_STRING("1u4z8r83ry83ry83-ly83-ly00001o1n8p83*sy83Gy1l8o1l8l1l83-3y000004z8r83-My83-My83-ly83-ly00001n1l8o1l8l1l83Cy000004z8r83xy83xy83-l");
    string_constant_25 = 
    ...
    string_constant_29 = 
	    STATIC_STRING("l83Ny1m83Dy5rNew api000004z8r83bly83bly83-ly83-ly00001p1m8p830iy1l83Ey1l8l1l83Ny1m83Dy5rNew api000004z8r83V4y83V4y83-ly83-ly0000");
    string_constant_30 = 
	    STATIC_STRING("1o1l83Ey1l8l1l83Ny1m83Dy5rNew api000004z8r8326y8326y83-ly83-ly0k001p1m8p83Sy1l83Ey1l8l1l83Ny1m83Dy5rNew api000004z8r83Uty83Uty83");
    string_constant_31 = 
    ...
    string_constant_43 = 
	    STATIC_STRING("ay3-my3fy3-hy3-Yy3fy3-my3-Xy3-qy3-my3fy3-Uy3-hy3-qy3uy3hy3-ny3-ey3wy1q83ry01n8p83*sy83Gy8o8l83-3y1p83-My08o8l83Cy1p83xy083Ey8l1m");
    string_constant_44 = 
    ...
    string_constant_47 = 
	    STATIC_STRING("1m83Dy5rNew api1r83bly01m8p830iy83Ey8l83Ny1m83Dy5rNew api1q83V4y083Ey8l83Ny1m83Dy5rNew api1r8326yk1m8p83Sy83Ey8l83Ny1m83Dy5rNew ");
    string_constant_48 = 
	    STATIC_STRING("api1r83Uty3Bxxxy1m8p83Sy83Ey8l83Ny1m83Dy5rNew api");
    ...
    string_constant_49 = 
	    STATIC_STRING("1p1o83A9y1m9k83Zy09l1m83A9y83-qwy1n83-qwy83-qvy1ll1n83-qwy1n83-qvy1m9k83-ay83-qwy2lln1n83-qvy1n83-Ecy1m9k83*Iy83*vy2lln");
    clear_optimized_constants();
    ...
    string_constant_51 = STATIC_STRING("1q832my8s83-quy09k9l");
    clear_optimized_constants();
    ...
    string_constant_53 = 
	    STATIC_STRING("13Py4z8r83ny83ny83-My83-My01l83-ry001n1m8p831wy1l8o1l8l000004z8r83-Ny83-Ny83-My83-My00001n1m8p83*ny1l8o1l8l000004z8r83*Ky83*Ky83");
    string_constant_54 = 
	    STATIC_STRING("-My83-My00001n1m8p83*ny1l8o1l8l000004z8r837Wy837Wy83-My83-My00001n1m8p83Ugy1l8o1l8l000004z8r837Xy837Xy83-My83-My00001n1m8p83Ugy1");
    string_constant_55 = 
    ...
    string_constant_63 = 
	    STATIC_STRING("3*4y1l8o1l8l000004z8r83**y83**y83-My83-My0m001n1m8p83*4y1l8o1l8l000004z8r83*ky83*ky83-My83-My00001n1m8p83*ny1l8o1l8l000004z8r832");
    string_constant_64 = 
	    STATIC_STRING("cy832cy83-My83-My0k001n1m8p83*4y1l8o1l8l000004z8r83Vhy83Vhy83-My83-My0k001n1m8p83*4y1l8o1l8l00000");
    string_constant_65 = 
	    STATIC_STRING("13Ry8q1m83-My1l831Fy1p83ny1l83-ry1m8p831wy8o8l1p83-Ny01m8p83*ny8o8l1p83*Ky01m8p83*ny8o8l1p837Wy01m8p83Ugy8o8l1p837Xy01m8p83Ugy8o");
    string_constant_66 = 
    ...
    string_constant_69 = 
	    STATIC_STRING("1ym1m8p83*4y8o8l1p83*0ym1m8p83*4y8o8l1p83**ym1m8p83*4y8o8l1p83*ky01m8p83*ny8o8l1p832cyk1m8p83*4y8o8l1p83Vhyk1m8p83*4y8o8l");
    ...
    string_constant_74 = 
	    STATIC_STRING("1m4z8r83xy83xy83TZy83TZy083Tay001n1l8l1l83Ey1m83Dy53CyExport, writable000004z8r835ky835ky83TZy83TZy01n1l83*qy1l9k1l8331y001l1l8l");
    string_constant_75 = STATIC_STRING("00000");
    string_constant_76 = 
	    STATIC_STRING("1o8q1m83TZy1l83A1y1m83xy83Tay1m835ky1n1l83*qy1l9k1l8331y");
    temp = regenerate_optimized_constant(string_constant_52);
    clear_optimized_constants();
    ...
    string_constant_77 = 
	    STATIC_STRING("43Dy8m83kLy1q83kLy832my83*Cy83Qy8n8k1l832my0000001l1m8x832myk3Cyk0k0");
    ...
    string_constant_78 = STATIC_STRING("1q83kLy8s83-bHy09k9l");
    clear_optimized_constants();
    ...
    string_constant_80 = 
	    STATIC_STRING("1m4z8r83xy83xy835ny835ny083W9y001n1l8l1l83Ey1m83Dy53CyExport, writable000004z8r835ky835ky835ny835ny01n1l83*qy1m9k+3Cy3-ay3-by3-W");
    string_constant_81 = 
	    STATIC_STRING("y3-Xy3Sy3-gy3-Ty3-fy3-Xykkkkkt3A++y1l8331y001m1l8l1l83-4y00000");
    string_constant_82 = 
	    STATIC_STRING("1o8q1n835ny1m838Iy83A1y83Iy1m83xy83W9y1n835ky1n1l83*qy1m9k5thide name1l8331y83-4y");
    ...
    string_constant_83 = 
	    STATIC_STRING("43Dy8m83l0y1q83l0y832my83*Cy83Qy8n8k1l832my0000001l1m8x832myk3Cyk0k0");
    ...
    string_constant_84 = STATIC_STRING("1q83l0y8s83-f0y09k9l");
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qworkspace_name_box,
	    list_constant_36);
    string_constant_85 = 
	    STATIC_STRING("1l4z8r83xy83xy83ecy83ecy083edy001n1l8l1l83Ey1m83Dy53CyExport, writable00000");
    string_constant_86 = STATIC_STRING("1n8q1n83ecy1l835ny83Iy1m83xy83edy");
    temp = regenerate_optimized_constant(string_constant_79);
    ...
    Qcreate_icon_description = STATIC_SYMBOL("CREATE-ICON-DESCRIPTION",
	    AB_package);
    string_constant_92 = 
	    STATIC_STRING("1l4z8r8u8u83KIy83KIy01p8w9kws1l1q83qy1q1mkq1mpk1muq1msq1mpm1mmq1n1mpk1muq1msq1n1mpm1mkq1mpk1n1mpk1msq1mpm1n1mpm1mmq1mkq001o1l8l1");
    string_constant_93 = 
	    STATIC_STRING("l8o1l8z1m83Dy53YySee comment on ENTITY class definition00000");
    string_constant_94 = 
	    STATIC_STRING("1n8q1m83KIy1l8350y1m8u1p8w9kws1l1q83qy1q1mkq1mpk1muq1msq1mpm1mmq1n1mpk1muq1msq1n1mpm1mkq1mpk1n1mpk1msq1mpm1n1mpm1mmq1mkq");
    temp = regenerate_optimized_constant(string_constant_52);
    clear_optimized_constants();
    ...
    string_constant_95 = 
	    STATIC_STRING("1l4z8r8u8u83aVy83aVy01p8w9kso1l1q83qy1q1mko1mok1mso1mro1mol1mlo1n1mok1mso1mro1n1mol1mko1mok1n1mok1mro1mol1n1mol1mlo1mko001o1l8l1");
    string_constant_96 = 
	    STATIC_STRING("1n8q1m83aVy1l8350y1m8u1p8w9kso1l1q83qy1q1mko1mok1mso1mro1mol1mlo1n1mok1mso1mro1n1mol1mko1mok1n1mok1mro1mol1n1mol1mlo1mko");
    temp = regenerate_optimized_constant(string_constant_52);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    ...
    string_constant_99 = STATIC_STRING("1p1m8v83*sy1l8t1l83-8y1l83Iy1l83Ly");
    string_constant_100 = 
	    STATIC_STRING("1m4z8r83xy83xy83*sy83*sy0830qy001n1l8l1m83Dy73*0y3-Xy3-qy3-iy3-hy3-ky3-my3Sy3-Ty3-ly3Sy3-Wy3-Xy3-Yy3-Ty3-ny3-ey3-my3fy3-my3-Xy3-");
    string_constant_101 = 
    ...
    string_constant_104 = 
	    STATIC_STRING("3-Yy3-hy3-ky3-fy3-Ty3-my3-ly3gy1l83Ey000004z8r83Zhy83Zhy83*sy83*sy00001n1l8l1l8o1m83Dy5sInternal00000");
    string_constant_105 = 
	    STATIC_STRING("1o8q1r83*sy1m83Ry83A=y1m8v83*sy8t83-8y83Iy83Ly1n83xy830qy1m83Dy73*0y3-Xy3-qy3-iy3-hy3-ky3-my3Sy3-Ty3-ly3Sy3-Wy3-Xy3-Yy3-Ty3-ny3-");
    string_constant_106 = 
    ...
    string_constant_109 = 
	    STATIC_STRING("y3-ly3Sy3-hy3-Yy3Sy3-Yy3-hy3-ky3-fy3-Ty3-my3-ly3gy1p83Zhy08l8o1m83Dy5sInternal");
    ...
    string_constant_116 = 
	    STATIC_STRING("l, ~\n<li>line-color: color-symbol, <br>000004z8r83ry83ry8341y8341y00001o1l8l1n8p83-ey83Gy1l8o1l83-3y000004z8r83xy83xy8341y8341y0");
    string_constant_117 = 
	    STATIC_STRING("83MRy001n1l8l1l83Ey1m83Dy53CyExport, writable00000");
    string_constant_118 = 
	    STATIC_STRING("1p8q1n8341y1m83Ry83-ly1m8v8341y1n83=ky08z1n83ry01n8p83-ey83Gy1m83xy83MRy");
    ...
    string_constant_125 = 
	    STATIC_STRING("l, ~\n<li>line-color: color-symbol, <br>000004z8r83ry83ry837py837py00001o1l8l1n8p83-ey83Gy1l8o1l83-3y000004z8r83xy83xy837py837py0");
    string_constant_126 = 
	    STATIC_STRING("8351y001n1l8l1l83Ey1m83Dy53CyExport, writable00000");
    string_constant_127 = 
	    STATIC_STRING("1p8q1n837py1m83Ry83-ly1m8v837py1n83=ky08z1n83ry01n8p83-ey83Gy1m83xy8351y");
    ...
    string_constant_141 = 
	    STATIC_STRING("1t4z8r83biy83biy832Wy832Wy0k001l1l8l000004z8r83bky83bky832Wy832Wy0k001l1l8l000004z8r83bjy83bjy832Wy832Wy0k001l1l8l000004z8r83bhy");
    string_constant_142 = 
	    STATIC_STRING("83bhy832Wy832Wy0k001l1l8l000004z8r83ky83ky832Wy832Wy0k001n1l8l1m8p83*4y1l8o000004z8r83-=y83-=y832Wy832Wy0k001n1l8l1m8p83*4y1l8o0");
    string_constant_143 = 
	    STATIC_STRING("00004z8r83-Ny83-Ny832Wy832Wy00001n1l8l1m8p83*ny1l8o000004z8r83*ky83*ky832Wy832Wy00001n1l8l1m8p83*ny1l8o000004z8r83*Ky83*Ky832Wy8");
    string_constant_144 = STATIC_STRING("32Wy00001n1l8l1m8p83*ny1l8o00000");
    string_constant_145 = 
	    STATIC_STRING("1v8q1m832Wy1l83-My1m83biyk1m83bkyk1m83bjyk1m83bhyk1m83kyk1m83-=yk1m83-Ny01m83*ky01m83*Ky0");
    temp = regenerate_optimized_constant(string_constant_52);
    ...
    string_constant_148 = 
	    STATIC_STRING("1z832Wy83wy83-dy83*=yl83*1yl83*0ys83**ys83iy3ky83*ay3ky");
    ...
    Qnon_default_button_format = STATIC_SYMBOL("NON-DEFAULT-BUTTON-FORMAT",
	    AB_package);
    string_constant_149 = 
	    STATIC_STRING("1z832Wy83wy83-dy83*=yl83*1yl83*0yl83**yl83iy3ky83*ay3ky");
    ...
    string_constant_150 = 
	    STATIC_STRING("1m4z8r83ry83ry83Jny83Jny00001o1l8l1n8p083Gy1l8o1l83-3y000004z8r83xy83xy83Jny83Jny083Joy001n1l8l1l83Ey1m83Dy53CyExport, writable0");
    string_constant_151 = STATIC_STRING("0000");
    string_constant_152 = 
	    STATIC_STRING("1o8q1m83Jny1l83-ly1n83ry01n8p083Gy1m83xy83Joy");
    temp = regenerate_optimized_constant(string_constant_52);
    ...
    string_constant_153 = 
	    STATIC_STRING("1l4z8r83ry83ry83Jly83Jly00001o1l8l1n8p083Gy1l8o1l83-3y00000");
    string_constant_154 = STATIC_STRING("1n8q1m83Jly1l83-ly1n83ry01n8p083Gy");
    temp = regenerate_optimized_constant(string_constant_52);
