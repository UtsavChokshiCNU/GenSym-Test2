...
Object Cell_index_currently_being_registered = UNBOUND;
...
Object Set_of_all_permanent_computation_style = UNBOUND;
    ...
    Object block, g2_cell_array, index_1, cell;
{
	...
	temp = TRUEP(Nil);
    if (temp)
	return schedule_expression_cell_execution(block,index_1,T);
    else {
	sub_class_bit_vector = ISVREF(gensymed_symbol,(SI_Long)19L);
	superior_class_bit_number = 
	...
	if (sub_class_vector_index < 
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    return compute_new_designation_cell_value(g2_cell_array,
		    index_1,cell);
	else {
	    sub_class_bit_vector = ISVREF(gensymed_symbol,(SI_Long)19L);
	    superior_class_bit_number = 
		...
		temp = TRUEP(Nil);
	    if (temp)
		return compute_new_query_cell_value(g2_cell_array,index_1,
			cell);
	    else
		return VALUES_1(Qnil);
	}
    ...
    Object g2_cell_array_qm;
{
	...
	cell = FIXNUM_LE(ISVREF(managed_array,(SI_Long)1L),
		...
		ISVREF(ISVREF(managed_array,(index_1 >>  -  - 
		(SI_Long)10L) + (SI_Long)2L),index_1 & (SI_Long)1023L);
	if (SIMPLE_VECTOR_P(cell) && IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(cell)) 
...
Object rebuild_backpointers_of_cells_of_g2_cell_array(g2_cell_array,
    ...
    Object g2_cell_array, parent_frame;
{
    Object managed_array, cell, sub_class_bit_vector;
    SI_Long index_1, ab_loop_bind_, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol, gensymed_symbol_1;
    SI_Long gensymed_symbol_2;
    char temp;

    x_note_fn_call(156,54);
    managed_array = ISVREF(g2_cell_array,(SI_Long)3L);
    if (managed_array) {
	index_1 = (SI_Long)0L;
	ab_loop_bind_ = IFIX(ISVREF(managed_array,(SI_Long)1L));
	...
	if (cell) {
	    ...
	    temp = TRUEP(Nil);
	if (temp) {
	    ISVREF(cell,(SI_Long)4L) = g2_cell_array;
	    ISVREF(cell,(SI_Long)5L) = FIX(index_1);
...
{
    Object last_1, next_qm, cdr_new_value, trailer, value_cons_qm, value;
    Object gensym_cons;

    x_note_fn_call(156,62);
    if (frames_qm) {
	if (query_cell_cached_value) {
	  ...
	  end_loop:
	    ...
	    Available_gensym_conses = query_cell_cached_value;
	}
    }
    else {
	...
	if (query_cell_cached_value &&  !((SI_Long)0L == 
	    ...
	    gensym_cons = query_cell_cached_value;
	  next_loop_2:
...
Object Chain_of_available_query_cell_streams = UNBOUND;

Object Query_cell_stream_count = UNBOUND;
    ...
    Object query_cell_stream;
{
    ...
    svref_new_value = Chain_of_available_query_cell_streams;
    SVREF(query_cell_stream,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_query_cell_streams = query_cell_stream;
    return VALUES_1(Nil);
}
...
Object make_permanent_query_cell_stream_structure_internal()
{
    ...
    Object query_cell_stream_count_new_value;
    Object defstruct_g2_query_cell_stream_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(156,67);
    def_structure_query_cell_stream_variable = Nil;
    query_cell_stream_count_new_value = FIXNUM_ADD1(Query_cell_stream_count);
    Query_cell_stream_count = query_cell_stream_count_new_value;
...
{
    Object def_structure_query_cell_stream_variable, temp, new_stream;

    x_note_fn_call(156,69);
    def_structure_query_cell_stream_variable = 
	    Chain_of_available_query_cell_streams;
    if (def_structure_query_cell_stream_variable) {
	Chain_of_available_query_cell_streams = 
...
{
    Object gensymed_symbol, gensymed_symbol_1, old_structure_being_reclaimed;
    Object svref_new_value;

    x_note_fn_call(156,70);
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_query_cell_streams;
    SVREF(query_cell_cached_value_stream,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_query_cell_streams = query_cell_cached_value_stream;
    return VALUES_1(Nil);
}
    ...
    Object g2_cell_array, index_1, query_cell;
{
	...
	next_loop_2:
	  ...
	  goto next_loop_2;
	end_loop_2:;
	  reclaim_gensym_list_1(new_values);
	  new_values = Nil;
      }
	...
	end_loop_3:;
      ...
      new_cache_qm = new_values ? gensym_cons_1(FIX((SI_Long)1L),
	      new_values) : Nil;
...
{
    Object computation_style, schedule_task_qm, old_structure_being_reclaimed;
    Object temp, scan_interval_qm, initial_wait_interval, parent_frame, temp_1;
    ...
    char temp_2, future_task_schedule_modify_arg_6;
    char future_task_schedule_modify_arg_13, svref_new_value;
    double arg, arg_1, gensymed_symbol, gensymed_symbol_1;
    double future_task_schedule_modify_arg_3;
    double future_task_schedule_modify_arg_4;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(156,90);
    computation_style = ISVREF(expression_cell,(SI_Long)3L);
    schedule_task_qm = ISVREF(expression_cell,(SI_Long)9L);
    if (schedule_task_qm) {
    ...
    temp = Nil;
    ISVREF(expression_cell,(SI_Long)9L) = temp;
	...
	if (temp_2 ?  !TRUEP(ISVREF(computation_style,(SI_Long)21L)) || 
		...
		future_task_schedule_modify_arg_2 = 
			ISVREF(computation_style,(SI_Long)18L);
		gensymed_symbol = DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L);
		gensymed_symbol_1 = FIXNUMP(initial_wait_interval) ? 
		...
		future_task_schedule_modify_arg_8 = 
			SYMBOL_FUNCTION(Qattempt_expression_cell_execution);
		future_task_schedule_modify_arg_11 = expression_cell;
		future_task_schedule_modify_arg_13 = (SI_Long)0L != 
			(IFIX(ISVREF(parent_frame,(SI_Long)4L)) & 
			(SI_Long)33554432L);
		schedule_task_qm = ISVREF(expression_cell,(SI_Long)9L);
		if (schedule_task_qm) {
		...
		SVREF(task,FIX((SI_Long)13L)) = 
			future_task_schedule_modify_arg_13 ? T : Nil;
		future_task_schedule_2(task);
		ISVREF(expression_cell,(SI_Long)9L) = task;
	    }
	    POP_LOCAL_ALLOCATION(0,0);
	}
    }
...
{
    Object schedule_task_qm, computation_style;
    ...
    Object gensymed_symbol_1;
    char temp, current_task_schedule_modify_arg_5;
    char current_task_schedule_modify_arg_13, g2_p;
    double aref_new_value;

    x_note_fn_call(156,95);
	...
	if (override_update_when_shown_qm ||  
	    ...
	    current_task_schedule_modify_arg_2 = ISVREF(computation_style,
		    (SI_Long)18L);
	    ...
	    current_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qattempt_expression_cell_execution);
	    current_task_schedule_modify_arg_11 = expression_cell;
	    current_task_schedule_modify_arg_13 = (SI_Long)0L != 
		    (IFIX(ISVREF(containing_block,(SI_Long)4L)) & 
		    (SI_Long)33554432L);
	    schedule_task_qm = ISVREF(expression_cell,(SI_Long)7L);
	    if (schedule_task_qm) {
	    ...
	    SVREF(task,FIX((SI_Long)12L)) = Nil;
	    SVREF(task,FIX((SI_Long)13L)) = 
		    current_task_schedule_modify_arg_13 ? T : Nil;
	    ...
	    ISVREF(expression_cell,(SI_Long)7L) = task;
	}
    }
    return VALUES_1(Nil);
}
    ...
    Object containing_block, index_1;
{
    ...
    Object gensym_cons, schedule_task_qm, old_structure_being_reclaimed;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;

    x_note_fn_call(156,97);
    g2_cell_array = get_lookup_slot_value_given_default(containing_block,
	    Qcell_array,Nil);
    managed_array = g2_cell_array ? ISVREF(g2_cell_array,(SI_Long)3L) : Nil;
    expression_cell = managed_array && FIXNUM_LT(index_1,
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	temp_1 = delete_gensym_element_1(gensymed_symbol_3,
	...
	if (gensymed_symbol_4) {
	  ...
	  end_loop_1:
	    if (gensymed_symbol_4 &&  !((SI_Long)0L == 
		    inline_debugging_consing())) {
		gensym_cons = gensymed_symbol_4;
	      next_loop_2:
		inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		if (EQ(gensym_cons,gensymed_symbol_5))
		    goto end_1;
		else if ( !TRUEP(gensym_cons))
		    goto end_1;
		else
	    ...
	    Available_gensym_conses = gensymed_symbol_4;
	}
	schedule_task_qm = ISVREF(expression_cell,(SI_Long)7L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
	...
	temp_1 = Nil;
	ISVREF(expression_cell,(SI_Long)7L) = temp_1;
    ...
    Object expression_cell, argument_list, allow_inactive_objects_qm;
{
    ...
    Object saved_breakpoint_level, schedule_task_qm;
    Object old_structure_being_reclaimed, svref_new_value, gensymed_symbol_5;
    Object temp, new_vector, environment_vector, argument, ab_loop_list_;
    ...
    PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
      ...
      PUSH_SPECIAL(Current_computation_style,current_computation_style,11);
	...
	current_computation_flags = FIX(gensymed_symbol + 
		...
		+ gensymed_symbol_4);
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,10);
	  current_computation_activity = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Current_computation_activity,current_computation_activity,
		  9);
	    current_computation_component_particulars = 
		...
		PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
		  ...
		  PUSH_SPECIAL(Current_environment,current_environment,5);
		    evaluating_simulator_procedure_qm = Nil;
		    PUSH_SPECIAL(Evaluating_simulator_procedure_qm,evaluating_simulator_procedure_qm,
			    4);
		      explanation_variables = Nil;
		      PUSH_SPECIAL(Explanation_variables,explanation_variables,
			      3);
			saved_warning_level = Nil;
			PUSH_SPECIAL(Saved_warning_level,saved_warning_level,
				2);
			  saved_tracing_level = Nil;
			  PUSH_SPECIAL(Saved_tracing_level,saved_tracing_level,
				  1);
			    saved_breakpoint_level = Nil;
			    PUSH_SPECIAL(Saved_breakpoint_level,saved_breakpoint_level,
				    0);
			      schedule_task_qm = ISVREF(expression_cell,
				      (SI_Long)7L);
			      if (schedule_task_qm) {
				  ...
				  reclaim_schedule_task_args(ISVREF(schedule_task_qm,
					  (SI_Long)9L));
				  SVREF(schedule_task_qm,FIX((SI_Long)9L)) 
					  = Nil;
				  Structure_being_reclaimed = 
					  old_structure_being_reclaimed;
				  svref_new_value = 
			      ...
			      svref_new_value = Nil;
			      ISVREF(expression_cell,(SI_Long)7L) = 
				      svref_new_value;
				  ...
				  temp = var_count(ISVREF(byte_code_body,
					  (SI_Long)4L));
				  new_vector = 
					  allocate_managed_simple_vector(buffer_size_for_partial_buffer(temp,
				...
				end_loop_1:;
				  ...
				  temp = ISVREF(byte_code_body,(SI_Long)3L);
				  stack_eval(byte_code_body,temp,
					  environment_vector,
				...
				end_loop_2:;
			      ...
			      reclaim_gensym_list_1(Current_computation_component_particulars);
			      temp = clear_computation_context_variables();
			    POP_SPECIAL();
			  POP_SPECIAL();
			POP_SPECIAL();
		      POP_SPECIAL();
    ...
    Object expression_cell;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp = delete_gensym_element_1(gensymed_symbol,
  ...
  end_loop:
    ...
    temp = Nil;
    ISVREF(expression_cell,(SI_Long)7L) = temp;
    schedule_task_qm = ISVREF(expression_cell,(SI_Long)9L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
    ...
    Object cache_obsolete_value_qm;
{
	...
	new_cache_qm = CONSP(old_cache_qm) && EQ(M_CDR(old_cache_qm),
		Qobsolete_datum) ? old_cache_qm : 
		gensym_cons_1(old_cache_qm,Qobsolete_datum);
    }
    ...
    Object expression_cell;
{
    ...
    x_note_fn_call(156,105);
    byte_code_body_qm = ISVREF(expression_cell,(SI_Long)10L);
    if (byte_code_body_qm)
	analyze_byte_code_body_for_free_reference_consistency(ISVREF(ISVREF(expression_cell,
		(SI_Long)4L),(SI_Long)2L),byte_code_body_qm);
    return VALUES_1(Nil);
}
    ...
    Object block;
{
    ...
    Object gensymed_symbol_5, last_1, next_qm, cdr_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, gensymed_symbol_4;
    SI_Long managed_array_length, cell_index;
    char temp;

    x_note_fn_call(156,107);
  ...
  next_loop_2:
	...
	if (gensymed_symbol_1) {
	    ...
	    temp = TRUEP(Nil);
	if (temp) {
	    if ( !TRUEP(memq_function(FIX(cell_index),cell_indexes_in_use))) {
	...
	inline_funcall_2(gensymed_symbol,gensymed_symbol_1,gensymed_symbol_5);
  ...
  end_loop_2:;
	...
	if (cell_indexes_in_use) {
	  ...
	  end_loop_3:
	    ...
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(last_1) = cdr_new_value;
	    Available_gensym_conses = cell_indexes_in_use;
	    return VALUES_1(Nil);
	}
	else
	    return VALUES_1(Nil);
...
void cells_INIT()
{
    ...
    Object Qquery_cell_stream_count, Qchain_of_available_query_cell_streams;
    ...
    Object Qmake_computation_style_function, list_constant_4, Qcells;
    Object Qthe_only_dynamic_computation_style, Kfuncall, list_constant_3;
    Object Qset_of_all_permanent_computation_style;
    ...
    Object string_constant_3, Kno_initial_value, Qcurrent_computation_style;
    Object Qcell_index_currently_being_registered;

    x_note_fn_call(156,108);
    SET_PACKAGE("AB");
    ...
    string_constant_3 = 
	    STATIC_STRING("13Dy4z8r83Xmy83Xmy836hy836hy00001n1l8o1l83Cy1l8l000004z8r83IWy83IWy836hy836hy00001n1l8o1l83Hy1l8l000004z8r83IXy83IXy836hy836hy0l");
    string_constant_4 = 
    ...
    string_constant_8 = 
	    STATIC_STRING("1l8l000004z8r83IZy83IZy836hy836hy00001n1l8o1l83Cy1l8l000004z8r83W0y83W0y836hy836hy00001n1l8l1l8o1l83Hy000004z8r83W=y83W=y836hy83");
    string_constant_9 = 
	    STATIC_STRING("6hy00001n1l8l1l8o1l83Hy000004z8r83IVy83IVy836hy836hy00001n1l8o1l83Cy1l8l00000");
    string_constant_10 = 
	    STATIC_STRING("13Fy8q1n836hy1l9k8t1p83Xmy08o83Cy8l1p83IWy08o83Hy8l1p83IXyl8o83Cy8l1p83IYy08o83Cy8l1p83IQym8o83Cy8l1p83Icy8k8o83Cy8l1p83Iay08o83");
    string_constant_11 = 
    ...
    string_constant_12 = 
	    STATIC_STRING("0y08o83Hy1o83W=y08o83Hy1p83IVy08o83Cy8l");
    ...
    string_constant_13 = 
	    STATIC_STRING("1m4z8r83Mcy83Mcy83May83May00001o1l8o1l8l1l83Hy1l83Uy000004z8r83Mby83Mby83May83May00001n1l8o1l8l1l83Cy00000");
    string_constant_14 = 
	    STATIC_STRING("1o8q1n83May1l83=fy8t1q83Mcy08o8l83Hy83Uy1p83Mby08o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_2);
    ...
    string_constant_17 = 
	    STATIC_STRING("1o4z8r83NNy83NNy83NKy83NKy00001n1l8o1l8l1l83Cy000004z8r83NOy83NOy83NKy83NKy00001n1l8o1l8l1l83Cy000004z8r83NLy83NLy83NKy83NKy0000");
    string_constant_18 = 
	    STATIC_STRING("1m1l8o1l8l000004z8r83NMy83NMy83NKy83NKy00001m1l8o1l8l00000");
    string_constant_19 = 
	    STATIC_STRING("1q8q1n83NKy1l835Fy8t1p83NNy08o8l83Cy1p83NOy08o8l83Cy1o83NLy08o8l1o83NMy08o8l");
    temp = regenerate_optimized_constant(string_constant_2);
    ...
    check_if_superior_classes_are_defined(Qg2_designation_cell,
	    list_constant_6);
    string_constant_20 = 
	    STATIC_STRING("1o4z8r83Mhy83Mhy83Mfy83Mfy00001n1l8o1l8l1l83Cy000004z8r83Mjy83Mjy83Mfy83Mfy00001n1l8o1l8l1l83Cy000004z8r83Mgy83Mgy83Mfy83Mfy0000");
    string_constant_21 = 
	    STATIC_STRING("1m1l8o1l8l000004z8r83Miy83Miy83Mfy83Mfy00001m1l8o1l8l00000");
    string_constant_22 = 
	    STATIC_STRING("1q8q1n83Mfy1l835Fy8t1p83Mhy08o8l83Cy1p83Mjy08o8l83Cy1o83Mgy08o8l1o83Miy08o8l");
    temp = regenerate_optimized_constant(string_constant_2);
    ...
    string_constant_23 = 
	    STATIC_STRING("1v4z8r83Muy83Muy83Mly83Mly00001n1l8o1l8l1l83Cy000004z8r83Mpy83Mpy83Mly83Mly00001o1l8o1l8l1l83Cy1l83Uy000004z8r83Mry83Mry83Mly83M");
    string_constant_24 = 
	    STATIC_STRING("ly00001o1l8o1l8l1l83Hy1l83Uy000004z8r83Msy83Msy83Mly83Mly00001m1l8o1l8l000004z8r83Mny83Mny83Mly83Mly00001n1l8o1l8l1l83Uy000004z8");
    string_constant_25 = 
	    STATIC_STRING("r83Mvy83Mvy83Mly83Mly00001n1l8o1l8l1l83Uy000004z8r83bry83bry83Mly83Mly00001n1l8o1l8l1l83Uy000004z8r83Mqy83Mqy83Mly83Mly00001n1l8");
    string_constant_26 = 
	    STATIC_STRING("o1l8l1l83Uy000004z8r83Mmy83Mmy83Mly83Mly00001n1l8o1l8l1l83Cy000004z8r83Moy83Moy83Mly83Mly00001n1l8o1l8l1l83Cy000004z8r83Mty83Mty");
    string_constant_27 = STATIC_STRING("83Mly83Mly00001n1l8o1l8l1l83Uy00000");
    string_constant_28 = 
	    STATIC_STRING("1x8q1n83Mly1l835Fy8t1p83Muy08o8l83Cy1q83Mpy08o8l83Cy83Uy1q83Mry08o8l83Hy83Uy1o83Msy08o8l1p83Mny08o8l83Uy1p83Mvy08o8l83Uy1p83bry0");
    string_constant_29 = 
	    STATIC_STRING("8o8l83Uy1p83Mqy08o8l83Uy1p83Mmy08o8l83Cy1p83Moy08o8l83Cy1p83Mty08o8l83Uy");
    temp = regenerate_optimized_constant(string_constant_2);
    ...
    string_constant_30 = 
	    STATIC_STRING("43Dy8m83m*y1n83m*y8n8k1l8n0000001m1n8y83-5Gy1n83-9ly83-9ny83-9my1m83My83-Arykok0k0");
    ...
    Qquery_cell_stream_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_31 = STATIC_STRING("1q83m*y8s83-jky09k9l");
    clear_optimized_constants();
