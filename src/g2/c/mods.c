    ...
    Object list_to_sort, list_in_default_order;
{
  ...
  next_loop:
	...
	result_1 = gensym_cons_1(element,result_1);
    goto next_loop;
  end_loop:
    element = Nil;
  ...
  next_loop_1:
	...
	elements_to_put_on_end = gensym_cons_1(element,elements_to_put_on_end);
    goto next_loop_1;
  end_loop_1:;
    reclaim_gensym_list_1(list_to_sort);
...
Object compute_system_table_choices varargs_1(int, n)
{
	...
	temp = g2_window_for_this_workstation_qm ? 
		gensym_cons_1(Qthis_window,Nil) : Nil;
    }
    else
	temp = Nil;
    module_name = Nil;
  ...
  next_loop_1:
	...
	ab_loopvar__4 = gensym_cons_1(system_variable_name,Nil);
	if (ab_loopvar__3)
    ...
    Object class_1;
{
  ...
  next_loop:
	...
	goto end_loop;
    ab_loopvar__2 = gensym_cons_1(class_name,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
...
Object Modules_and_system_tables_a_list = UNBOUND;
    ...
    Object module_information_instance;
{
    ...
    end_1:;
      result_1 = gensym_cons_1(module_information_instance,Nil);
      class_1 = Nil;
    ...
    next_loop_1:
	  ...
	  nconc2(result_1,gensym_cons_1(system_table_instance,Nil));
      goto next_loop_1;
    end_loop_1:
      temp = result_1;
      goto end_2;
    ...
    Object module_information_frame_serial_number;
{
    ...
    return reclaim_gensym_list_1(module_information_frame_serial_number);
}
    ...
    Object module_information;
{
    ...
    PUSH_SPECIAL(Module_information,module_information,0);
    ...
    Object slot_value, frame, slot_description;
{
	...
	module_name = M_CAR(ab_loop_list_);
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__1 = gensym_cons_1(module_name,Nil);
	if (ab_loopvar_)
...
Object Modules_that_have_already_been_loaded = UNBOUND;

Object Currently_loading_modules_qm = UNBOUND;
    ...
    Object system_tables;
{
    ...
    Object ab_loop_list__1, gensym_push_modify_macro_arg, car_1, cdr_1;
  ...
  end_1:;
	...
	gensym_push_modify_macro_arg = system_table;
	...
	result_1 = gensym_cons_1(gensym_cons_1(system_table,Nil),result_1);
    goto next_loop;
  end_loop:
    temp = result_1;
    if (temp)
...
Object System_tables_read_for_this_module = UNBOUND;

Object Name_of_module_being_read_qm = UNBOUND;

Object Main_kb_being_read_qm = UNBOUND;
...
Object set_up_modules_and_system_tables_a_list_after_reading()
{
	...
	end_loop_1:;
      ...
      result = reclaim_gensym_list_1(all_system_table_suites_read_in);
    POP_SPECIAL();
    return result;
}
...
Object merge_in_system_table_suite_read_in varargs_1(int, n)
{
	...
	if (installing_qm) {
	    ...
	    PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,0);
    ...
    Object suite;
{
    ...
    copied_suite_list = copy_list_using_gensym_conses_1(suite);
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(copied_suite_list);
    return VALUES_1(suite);
    return VALUES_1(Qnil);
}
    ...
    Object suite;
{
	...
	end_1:;
	  ...
	  suite = gensym_cons_1(new_system_table,suite);
      }
      goto next_loop;
    end_loop:;
    POP_SPECIAL();
    ...
    Object suite;
{
    ...
    Modules_and_system_tables_a_list = gensym_cons_1(suite,
	    Modules_and_system_tables_a_list);
    return VALUES_1(Modules_and_system_tables_a_list);
}
...
Object delete_system_table_suite varargs_1(int, n)
{
    ...
    Modules_and_system_tables_a_list = 
	    delete_gensym_element_1(system_table_suite,
	    Modules_and_system_tables_a_list);
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:;
    reclaim_gensym_list_1(system_table_suite);
    ...
    Object module_information_instance;
{
    ...
    next_loop_1:
      ...
      ab_loopvar__1 = gensym_cons_1(new_system_table,Nil);
      if (ab_loopvar_)
	  M_CDR(ab_loopvar_) = ab_loopvar__1;
      else
    ...
    end_2:;
      Modules_and_system_tables_a_list = 
	      gensym_cons_1(new_system_table_suite,
	      Modules_and_system_tables_a_list);
      update_module_related_frame_notes_for_all_workspaces(0);
    POP_SPECIAL();
    decache_dynamic_menus(1,Qab_modules);
...
Object update_module_related_frame_notes_for_all_workspaces varargs_1(int, n)
{
    ...
    Object new_cons, gensymed_symbol, gensymed_symbol_1, temp;
    ...
    Object temp_2, gensym_pop_store, cons_1, next_cons, temp_3;
    char temp_1;
    Declare_varargs_nonrelocating;
    Declare_special(4);
    Object result;
	...
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(Module_information,
	...
	PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	  ...
	  PUSH_SPECIAL(Suppress_updating_of_slot_value_representations_qm,suppress_updating_of_slot_value_representations_qm,
		...
		end_loop_2:
	      ...
	      if (Nil)
		  gensymed_symbol_1 = 
			  nconc2(gensym_list_2(module_information_instance,
			  slot_description_1),gensym_cons_1(Nil,Nil));
	      else {
		  new_cons = Available_gensym_conses;
		  if (new_cons) {
		      Available_gensym_conses = M_CDR(new_cons);
...
Object All_module_frame_notes_for_workspaces = UNBOUND;
    ...
    Object kb_workspace;
{
    ...
    Object cdr_new_value, stack_of_slot_value_changes, module_qm, temp;
    Object module_information_instance_qm, frame_and_slot_or_atom;
	...
	if ( !TRUEP(gensymed_symbol))
	    gensymed_symbol = replenish_gensym_cons_pool();
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(kb_workspace,
		    slot_description),gensym_cons_1(Nil,Nil));
	else {
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
	...
	PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	  ...
	  if (temp_1);
	    ...
	    next_loop:
	      ...
	      ab_loop_it_ = temp_1 ? (EQ(kb_workspace,
		      M_CAR(frame_and_slot_or_atom)) ? T : Nil) : Nil;
	      if (ab_loop_it_) {
		  temp_1 = TRUEP(ab_loop_it_);
		  goto end_1;
...
Object Obsolete_frame_note_types_from_modularity_development = UNBOUND;
...
Object Current_modularity_problems = UNBOUND;

Object Inspect_command_for_modularity_problems_qm = UNBOUND;

Object Current_modularity_problems_fatal_qm = UNBOUND;
...
Object report_on_modularity_checking()
{
  ...
  next_loop:
	...
	if (Inspect_command_for_modularity_problems_qm) {
	    ...
	    inspect_messages = gensym_cons_1(temp,inspect_messages);
	}
	else {
    ...
    Object classes;
{
    ...
    x_note_fn_call(94,100);
    if (Inspect_command_for_modularity_problems_qm) {
	items = gensym_cons_1(tformat_text_string(1,string_constant_60),Nil);
	class_1 = Nil;
	...
	items = gensym_cons_1(class_definition,items);
	goto next_loop;
      end_loop:
	temp = nreverse(items);
	multiple_add_to_results_for_inspect_command(temp,
    ...
    Object classes;
{
    ...
    x_note_fn_call(94,101);
    if (Inspect_command_for_modularity_problems_qm) {
	items = gensym_cons_1(tformat_text_string(1,string_constant_63),Nil);
	class_1 = Nil;
	ab_loop_list_ = classes;
	class_definition = Nil;
      next_loop:
    ...
    Object a_list_of_classes;
{
    ...
    x_note_fn_call(94,102);
    if (Inspect_command_for_modularity_problems_qm) {
	items = gensym_cons_1(tformat_text_string(1,string_constant_66),Nil);
	class_1 = Nil;
	instances = Nil;
	...
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	items = gensym_cons_1(instance,items);
	goto next_loop_1;
      end_loop_1:;
	goto next_loop;
      end_loop:
...
Object All_cycles_found_so_far_in_module_hierarchy = UNBOUND;
    ...
    Object module_information_instance;
{
    ...
    x_note_fn_call(94,105);
    if (module_information_instance) {
	all_cycles_found_so_far_in_module_hierarchy = Qnil;
	result_1 = Nil;
	PUSH_SPECIAL(All_cycles_found_so_far_in_module_hierarchy,all_cycles_found_so_far_in_module_hierarchy,
		0);
	  ...
	  result_1 =  ! 
		  !TRUEP(All_cycles_found_so_far_in_module_hierarchy) ? T :
		   Nil;
	  reclaim_gensym_tree_1(All_cycles_found_so_far_in_module_hierarchy);
	  temp = result_1;
	POP_SPECIAL();
    }
    else
    ...
    Object node, history_path;
{
  ...
  next_loop:
	...
	if (cycle_qm) {
	    temp = nconc2(copy_list_using_gensym_conses_1(cycle_qm),
		    gensym_cons_1(node,Nil));
	    ...
	    temporary_list_history_path_and_node = 
		    nconc2(copy_list_using_gensym_conses_1(history_path),
		    gensym_cons_1(node,Nil));
	    find_all_cycles_in_module_hierarchy_1(node_2_qm,
		    temporary_list_history_path_and_node);
	    reclaim_gensym_list_1(temporary_list_history_path_and_node);
	}
    }
    goto next_loop;
  end_loop:;
...
{
    Object temp, gensym_modify_macro_using_test_arg_1, car_1, cdr_1;
    Object key_result, x_element, ab_loop_list_, ab_loop_it_;
    Object workspaces_belonging_to_this_module_new_value;
    char temp_1;

    x_note_fn_call(94,112);
    if (delete_case_qm) {
	temp = delete_gensym_element_1(kb_workspace,
		lookup_kb_specific_property_value(module,
		Workspaces_belonging_to_this_module_kbprop));
	...
	gensym_modify_macro_using_test_arg_1 = kb_workspace;
    ...
    Object key_1, key_2;
{
    ...
    x_note_fn_call(94,120);
    temp = EQ(M_CAR(key_1),M_CAR(key_2)) ? (EQ(M_CDR(key_1),M_CDR(key_2)) ?
	     T : Nil) : Qnil;
    return VALUES_1(temp);
}

Object Available_module_required_by_relationships_hash_vector_43_vectors = UNBOUND;

Object Count_of_module_required_by_relationships_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_module_required_by_relationships_hash_vector_43_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(94,123);
    count_of_module_required_by_relationships_hash_vector_43_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_module_required_by_relationships_hash_vector_43_vectors);
...
Object make_module_required_by_relationships_hash_vector()
{
    ...
    x_note_fn_call(94,124);
    if (Available_module_required_by_relationships_hash_vector_43_vectors) {
	temp = 
		M_CAR(Available_module_required_by_relationships_hash_vector_43_vectors);
	temp_1 = 
		M_CDR(Available_module_required_by_relationships_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_module_required_by_relationships_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = 
...
/* MUTATE-MODULE-REQUIRED-BY-RELATIONSHIPS-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_module_required_by_relationships_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(94,126);
    reclaim_gensym_cons_1(M_CAR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_module_required_by_relationships_tree_for_hash_tree_entry = UNBOUND;

static Object Qmodule_relationship_key_equal;  /* module-relationship-key-equal */

/* CLEAR-MODULE-REQUIRED-BY-RELATIONSHIPS-TREE */
Object clear_module_required_by_relationships_tree(module_required_by_relationships_tree_for_hash_binary_tree)
    Object module_required_by_relationships_tree_for_hash_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, old_key;

    x_note_fn_call(94,127);
    element_qm = Nil;
  next_loop:
    element_qm = 
	    CDR(module_required_by_relationships_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    temp = ISVREF(element_qm,(SI_Long)3L);
    gensymed_symbol = CAAR(temp);
    temp = 
	    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qmodule_relationship_key_equal),
	    gensymed_symbol,
	    module_required_by_relationships_tree_for_hash_binary_tree,
	    sxhashw(gensymed_symbol));
    old_key = temp;
    reclaim_gensym_cons_1(old_key);
    goto next_loop;
  end_loop:;
    return VALUES_1(module_required_by_relationships_tree_for_hash_binary_tree);
}
...
{
    Object module_required_by_relationships_tree_for_hash_binary_tree;
    Object element_qm, gensymed_symbol, temp, old_key, cdr_new_value;
    SI_Long index_1;

    x_note_fn_call(94,131);
    index_1 = (SI_Long)0L;
  next_loop:
    if (index_1 >= (SI_Long)43L)
	goto end_loop;
  ...
  next_loop_1:
    element_qm = 
	    M_CDR(module_required_by_relationships_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(module_required_by_relationships_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(module_required_by_relationships_tree_for_hash_binary_tree) = 
	    cdr_new_value;
...
Object Module_required_by_relationships = UNBOUND;
    ...
    Object list_of_pathnames;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(gensym_namestring(1,pathname_1),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
...
Object get_initial_value_for_g2_module_search_path()
{
    ...
    reclaim_gensym_list_1(token_list);
    return VALUES_1(list_of_pathnames);
}

Object G2_module_search_path = UNBOUND;

Object G2_module_file_name_map = UNBOUND;
    ...
    Object module, kb_uses_crlf_p;
{
    ...
    x_note_fn_call(94,152);
    PUSH_SPECIAL(Kb_uses_crlf_p,kb_uses_crlf_p,0);
...
Object Server_parameters = UNBOUND;
...
Object get_initial_window_style()
{
    ...
    x_note_fn_call(94,153);
    temp = getf(Command_line_arguments,Qdefault_window_style,_);
    return VALUES_1(temp);
}

Object Current_style_if_other_than_default = UNBOUND;
...
Object Source_code_control_support_enabled_p = UNBOUND;

Object Restrict_edits_to_modules_having_read_only_files_p = UNBOUND;
    ...
    Object server_parameters, new_path_list, initializing_qm;
{
	...
	next_loop:
	  ...
	  goto next_loop;
	end_loop:;
	  reclaim_gensym_list_1(G2_module_search_path);
	...
	next_loop_1:
	  ...
	  goto next_loop_1;
	end_loop_1:
	  reclaim_gensym_list_1(new_path_list);
      }
      if (Noting_changes_to_kb_p)
	  note_change_to_block_1(Server_parameters,Qmodule_search_path);
      temp = Server_parameters;
...
void modules_INIT()
{
    ...
    Object list_constant_32, Qcurrent_style_if_other_than_default;
    Object Qget_initial_window_style, Kfuncall, Qab_standard;
    Object string_constant_108, string_constant_107, Qg2_window_style;
    Object string_constant_106, string_constant_105, string_constant_104;
    Object string_constant_103, list_constant_15, string_constant_102;
    Object string_constant_101, string_constant_85, Qmodule_uses_crlf_p;
    ...
    Object Qg2_module_file_name_map, list_constant_31, Qg2_module_search_path;
    Object Qget_initial_value_for_g2_module_search_path;
    Object Qmutate_module_required_by_relationships_tree_for_hash_tree_entry;
    ...
    Object string_constant_100, Qutilities2;
    Object Qcount_of_module_required_by_relationships_hash_vector_43_vectors;
    Object Qavailable_module_required_by_relationships_hash_vector_43_vectors;
    ...
    Object Qclasses_whose_superiors_are_not_defined_in_required_modules;
    Object Qprint_classes_not_defined_in_any_module;
    Object Qclasses_not_defined_in_any_module, string_constant_99;
    Object string_constant_98, string_constant_97, string_constant_96;
    Object string_constant_95, Qnamed_dynamic_extent_description;
    Object Qmodularity_checking, Qmodules_that_exist_are_unknown;
    ...
    Object list_constant_26, Qcurrently_loading_modules_qm;
    Object Qreclaim_gensym_list_function;
    Object Qmodules_that_have_already_been_loaded, Qslot_value_reclaimer;
    Object Qreclaim_directly_required_kb_modules_value;
    ...
    Object Qmodules_and_system_tables_a_list, Qgeneric_method_lambda_list;
    Object list_constant_14, Qversion_control_parameters, Qsaving_parameters;
    Object Qdrawing_parameters, Qitem_reference_parameters, Qmenu_parameters;
    Object Qeditor_parameters, Qfonts, Qlanguage_parameters, Qcolor_parameters;
    Object Qlog_file_parameters, Qlogbook_parameters;
    Object Qmessage_board_parameters, Qprinter_setup, Qkb_configuration;
    Object Qsimulation_parameters, Qg2gl_parameters, Qdata_server_parameters;
    Object Qinference_engine_parameters, Qtiming_parameters;
    Object Qdebugging_parameters, string_constant_86, list_constant_13;
    ...
    string_constant_81 = 
	    STATIC_STRING("time)000004z8r83bwy83bwy83A6y83A6y00001p1l83Ny1l8l1l8o1l83Cy1m83Dy53TyExport, boolean, writable = false000004z8r83W-y83W-y83A6y8");
    string_constant_82 = 
	    STATIC_STRING("3A6y00001p1l83Ny1l8l1l8o1l83Cy1m83Dy53SyExport, symbol, writable = false00000");
    string_constant_83 = 
	    STATIC_STRING("1r8q1m83A6y1l83-+y1n83-Fy083Ny1n83--y01m8p83-*y1n83-0y01m8p83-0y1r83bwy083Ny8l8o83Cy1m83Dy53TyExport, boolean, writable = false1");
    string_constant_84 = 
	    STATIC_STRING("r83W-y083Ny8l8o83Cy1m83Dy53SyExport, symbol, writable = false");
    ...
    check_if_superior_classes_are_defined(Qmodule_information,
	    list_constant_15);
    string_constant_87 = 
	    STATIC_STRING("1p4z8r83TGy83TGy83Vwy83Vwy00001n1m8p83Dty1l8o1l8l000004z8r83cHy83cHy83Vwy83Vwy00001n1m8p83Dvy1l8o1l8l000004z8r83Jwy83Jwy83Vwy83V");
    string_constant_88 = 
	    STATIC_STRING("wy00001n1m8p835ey1l8o1l8l000004z8r83HWy83HWy83Vwy83Vwy00001n1l83Hy1l8o1l8l000004z8r83Dsy83Dsy83Vwy83Vwy00001m1m8p83Dsy1l8l00000");
    string_constant_89 = 
	    STATIC_STRING("1r8q1n83Vwy1l83-sy83ey1p83TGy01m8p83Dty8o8l1p83cHy01m8p83Dvy8o8l1p83Jwy01m8p835ey8o8l1p83HWy083Hy8o8l1o83Dsy01m8p83Dsy8l");
    temp = regenerate_optimized_constant(string_constant_85);
    ...
    mutate_global_property(Qdeinstall_system_table,temp_2,
	    Qclasses_which_define);
    string_constant_90 = STATIC_STRING("1m1m83-Tey1m9k83Zy1m83-Tey838Ky");
    ...
    set_slot_value_to_evaluation_value_function(Qmodule_file_name_qm,
	    module_file_name_qm_evaluation_getter_1);
    string_constant_92 = 
	    STATIC_STRING("1q1m83Dsy83-eWy1n83Dsy1m9k83Zy01n83-eWy1n83-2y1m9k83*Iy83-eXy1mln1n83-eWy1p83-2y1m9k83*Iy83-eXy1m9k83-ay83-eWy2mlnp1m83-eXy83Kny");
    string_constant_93 = STATIC_STRING("1m83-eXy83-2y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qcircularity_in_module_hierarchy,
	    string_constant_95,Qformat_string_for_kb_modularity_problem);
    string_constant_96 = 
    ...
    Qmodule_required_by_relationships_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_100 = STATIC_STRING("1q83-eZy83*By83-P+y09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qout_module_required_by_relationships_hash_vector_43_vectors,
	    ...
	    NIL,FALSE,0,0));
    Qmutate_module_required_by_relationships_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-MODULE-REQUIRED-BY-RELATIONSHIPS-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_module_required_by_relationships_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_module_required_by_relationships_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_module_required_by_relationships_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_module_required_by_relationships_tree_for_hash_tree_entry);
    ...
    string_constant_101 = 
	    STATIC_STRING("1o4z8r83Dwy83Dwy83Zvy83Zvy00001m1l8l1m8p83Dwy000004z8r83ady83ady83Zvy83Zvy00001m1l8l1m8p0000004z8r83Z6y83Z6y83Zvy83Zvy00001m1l8l");
    string_constant_102 = 
	    STATIC_STRING("1m8p0000004z8r83J=y83J=y83Zvy83Zvy00001m1l8l1m8p830Ky00000");
    string_constant_103 = 
	    STATIC_STRING("1q8q1n83Zvy1l83-sy83ey1n83Dwy01m8p83Dwy1n83ady01m8p01n83Z6y01m8p01n83J=y01m8p830Ky");
    temp = regenerate_optimized_constant(string_constant_85);
    temp_1 = regenerate_optimized_constant(LIST_2(string_constant_101,
	    string_constant_102));
    add_class_to_environment(9,Qserver_parameters,list_constant_15,Nil,
	    temp,Nil,temp_1,list_constant_15,
	    regenerate_optimized_constant(string_constant_103),Nil);
    ...
    record_system_variable(Qserver_parameters,Qab_modules,Ksystem_frame,
	    Qnil,Qnil,Qnil,Qt);
    string_constant_104 = STATIC_STRING("1m1m83Dwy1m9k83Zy1m83Dwy83-7*y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_104));
    string_constant_105 = 
	    STATIC_STRING("1m1n83-7*y83-8ny1ll1n83-7*y1n83-8ny1m9k83vy83-7*y2lln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_105));
    string_constant_106 = STATIC_STRING("1l1m83-8ny83-Uy");
    ...
    string_constant_107 = 
	    STATIC_STRING("1n1m838Zy1m9k837Ry1m838Zy1m9k83-pBy1m838Zy1m9k83-Uqy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_107));
    string_constant_108 = STATIC_STRING("1m1m830Ky1m9k83Py1m830Ky838Zy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
