...
Object Connections_to_delete_after_reading_kb = UNBOUND;
...
Object Blocks_to_delete_after_unsquirreling = UNBOUND;
...
Object Blocks_with_bad_connections = UNBOUND;

Object Switched_once_only_post_loads_are_after_conflict_resolution = UNBOUND;

Object List_of_module_pre_conflict_resolution_post_loading_functions = UNBOUND;

Object List_of_once_only_pre_conflict_resolution_post_loading_functions = UNBOUND;

Object List_of_once_only_switched_post_loading_functions = UNBOUND;

Object List_of_once_only_post_conflict_resolution_post_loading_functions = UNBOUND;

Object List_of_switched_and_module_post_loading_functions = UNBOUND;
...
Object Frame_serial_number_map = UNBOUND;
...
Object Ignore_kb_flags_in_kbs_qm = UNBOUND;

Object Saved_detail_pane_description = UNBOUND;

Object Reference_serial_number_for_saved_detail_pane_description = UNBOUND;
...
Object Refresh_all_windows_after_merging_qm = UNBOUND;

Object Reformat_as_appropriate_qm = UNBOUND;

Object Frames_with_substitute_classes = UNBOUND;

Object Kb_object_index_space = UNBOUND;

Object Next_character_for_kb_qm = UNBOUND;

Object Read_kb_buffer = UNBOUND;

Object Read_kb_buffer_index = UNBOUND;

Object Read_kb_buffer_length = UNBOUND;

Object Read_kb_stream = UNBOUND;

Object Basis_kb_frame_serial_number = UNBOUND;

Object Kb_format_identifier_read_qm = UNBOUND;
...
Object Newline_characters = UNBOUND;
...
{
    Object new_cons, gensymed_symbol, temp, l, l_tail, character_1, temp_1;
    ...
    Object number_of_characters_init, decrypt_qm;
{
    ...
    Object current_extended_utf_g_low_half_character_qm;
    ...
    SI_Long gensymed_symbol_3, row, unicode_full_row;
    char temp_2;
    Declare_special(6);
...
Object Original_kb_state_plist_written_qm = UNBOUND;

Object Backup_case_qm = UNBOUND;

Object Type_of_file_being_read = UNBOUND;

Object Previous_timestamp_qm = UNBOUND;

Object Slot_description_for_slot_value_being_read_qm = UNBOUND;

Object Frames_for_rendezvous_in_aggregate_values_qm = UNBOUND;
    ...
    Object not_top_level_qm;
{
    ...
    PUSH_SPECIAL(Gensym_file_error_occurred_p,gensym_file_error_occurred_p,2);
      PUSH_SPECIAL(Inside_handling_gensym_file_errors_scope_p,inside_handling_gensym_file_errors_scope_p,
	      1);
	if (PUSH_CATCH(Qgensym_file_error_catch_tag,1)) {
	    ...
	    PUSH_SPECIAL(Read_kb_stream,read_kb_stream,0);
	      if (PUSH_UNWIND_PROTECT(0)) {
		  pathname_used_p = 
	...
	if (Gensym_file_error_occurred_p) {
		...
		goto next_loop;
	      end_loop:
		reclaim_gensym_list_1(result_from_body);
	    }
	    report_string = temp;
    ...
    Object xml_object_qm;
{
    ...
    SAVE_STACK();
    PUSH_SPECIAL(Read_kb_stream,read_kb_stream,13);
      ...
      PUSH_SPECIAL(Base_reference,base_reference,12);
	PUSH_SPECIAL(Read_kb_buffer_index,read_kb_buffer_index,11);
	  PUSH_SPECIAL(Read_kb_buffer_length,read_kb_buffer_length,10);
	    PUSH_SPECIAL(Next_character_for_kb_qm,next_character_for_kb_qm,9);
	      PUSH_SPECIAL(Previous_timestamp_qm,previous_timestamp_qm,8);
		PUSH_SPECIAL(Plist_has_been_checked_p,plist_has_been_checked_p,
			7);
		  PUSH_SPECIAL(Kb_uses_crlf_p,kb_uses_crlf_p,6);
		    PUSH_SPECIAL(New_saved_kb_format_p,new_saved_kb_format_p,
			    5);
		      PUSH_SPECIAL(Name_text_string_for_kb_being_read,name_text_string_for_kb_being_read,
			      4);
			PUSH_SPECIAL(Kb_object_index_space,kb_object_index_space,
				3);
			  PUSH_SPECIAL(Namestring_for_kb_being_read,namestring_for_kb_being_read,
				  2);
			    if (PUSH_UNWIND_PROTECT(0)) {
				...
				if (EQ(operation,Qplist)) {
				    ...
				    PUSH_SPECIAL(Reformat_as_appropriate_qm,reformat_as_appropriate_qm,
					    1);
				      PUSH_SPECIAL(Name_of_kb_being_read,name_of_kb_being_read,
					      0);
...
static Object Qkb_flags;           /* kb-flags */
...
Object read_initial_plist_for_kb varargs_1(int, n)
{
	...
	if (kb_file_comment_string_qm)
	    plist = nconc2(gensym_list_2(Qkb_file_comment_string,
...
Object New_compiled_byte_code_body_list = UNBOUND;

Object New_byte_code_body_list = UNBOUND;
    ...
    Object function;
{
    ...
    New_compiled_byte_code_body_list = gensym_cons_1(function,
    ...
    Object byte_code_body;
{
    ...
    New_byte_code_body_list = gensym_cons_1(byte_code_body,
	    New_byte_code_body_list);
    return VALUES_1(New_byte_code_body_list);
}

Object Recompile_on_next_load = UNBOUND;
    ...
    Object auto_merge_case_qm, default_kb_directory_qm;
{
    ...
    SAVE_STACK();
    PUSH_SPECIAL(Reformat_as_appropriate_qm,reformat_as_appropriate_qm,11);
	...
	PUSH_SPECIAL(Kb_load_case_qm,kb_load_case_qm,9);
	  Noting_changes_to_kb_p = Nil;
	  inside_handling_gensym_file_errors_scope_p = T;
	  gensym_file_error_occurred_p = Nil;
	  PUSH_SPECIAL(Gensym_file_error_occurred_p,gensym_file_error_occurred_p,
		  8);
	    PUSH_SPECIAL(Inside_handling_gensym_file_errors_scope_p,inside_handling_gensym_file_errors_scope_p,
		    7);
		  ...
		  PUSH_SPECIAL(Loading_compiled_kb_p,loading_compiled_kb_p,6);
		    PUSH_SPECIAL(New_byte_code_body_list,new_byte_code_body_list,
			    5);
		      PUSH_SPECIAL(New_compiled_byte_code_body_list,new_compiled_byte_code_body_list,
			      4);
			if (PUSH_UNWIND_PROTECT(2)) {
			    ...
			    namestring_1 = Qunbound_in_protected_let;
			    read_kb_stream = Qunbound_in_protected_let;
			    PUSH_SPECIAL(Read_kb_stream,read_kb_stream,3);
			...
			if (New_byte_code_body_list) {
			    if ( !EQ(New_byte_code_body_list,
				    Qunbound_in_protected_let))
				reclaim_gensym_list_1(New_byte_code_body_list);
			}
			if (New_compiled_byte_code_body_list) {
			    if ( !EQ(New_compiled_byte_code_body_list,
				    Qunbound_in_protected_let))
				reclaim_gensym_list_1(New_compiled_byte_code_body_list);
			}
			if (namestring_for_file) {
...
Object Class_name_read_while_reading_current_ghost_definition = UNBOUND;

Object Dont_load_if_definitions_have_changed_p = UNBOUND;

Object Forward_referenced_format_frames = UNBOUND;

Object Preexisting_frames = UNBOUND;

Object Plist_from_end_element_qm = UNBOUND;
...
Object Collecting_warnings_p = UNBOUND;

Object Collected_items_with_warnings_alist = UNBOUND;
...
Object Definitions_read_in_this_module = UNBOUND;
...
static Object Qoriginal_kb_state_plist_written_qm;  /* original-kb-state-plist-written? */
    ...
    Object auto_merge_case_qm, default_kb_directory_qm, xml_object_qm;
{
    ...
    Object workstation, gensym_pop_store, cons_1, next_cons, block;
    ...
    SAVE_STACK();
    PUSH_SPECIAL(Reformat_as_appropriate_qm,reformat_as_appropriate_qm,47);
      PUSH_SPECIAL(Main_kb_being_read_qm,main_kb_being_read_qm,46);
	PUSH_SPECIAL(Read_kb_stream,read_kb_stream,45);
	  reading_kb_p = T;
	  PUSH_SPECIAL(Reading_kb_p,reading_kb_p,44);
	    reading_succeeded_qm = Nil;
	    definitions_read_in_this_module = Nil;
	    PUSH_SPECIAL(Definitions_read_in_this_module,definitions_read_in_this_module,
		    43);
	      discrepancy_with_system_time1_p = gensym_list_2(Nil,Nil);
	      discrepancy_with_system_time2_p = gensym_cons_1(Nil,
		      CDR(discrepancy_with_system_time1_p));
	      separate_imminent_actions_p = Nil;
	      PUSH_SPECIAL(Separate_imminent_actions_p,separate_imminent_actions_p,
		      42);
		defer_notifications_qm = Nil;
		PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,41);
		  forward_referenced_format_frames = Nil;
		  PUSH_SPECIAL(Forward_referenced_format_frames,forward_referenced_format_frames,
			  40);
		    record_class_name_conflicts_qm = EQ(auto_merge_case_qm,
			    Qdefault) ? 
			    Automatically_resolve_conflicts_by_default : 
			    auto_merge_case_qm;
		    PUSH_SPECIAL(Record_class_name_conflicts_qm,record_class_name_conflicts_qm,
			    39);
			...
			PUSH_SPECIAL(Name_of_module_being_read_qm,name_of_module_being_read_qm,
				37);
			  ...
			  kb_file_progress = 
				  ...
				  Current_kb_file_progress_for_modules_qm :
				   Nil;
			  PUSH_SPECIAL(Kb_file_progress,kb_file_progress,36);
			    class_name_conflicts = Nil;
			    PUSH_SPECIAL(Class_name_conflicts,class_name_conflicts,
				    35);
			      blocks_to_delete_after_reading_kb = Nil;
			      PUSH_SPECIAL(Blocks_to_delete_after_reading_kb,blocks_to_delete_after_reading_kb,
				      34);
				connections_to_delete_after_reading_kb = Nil;
				PUSH_SPECIAL(Connections_to_delete_after_reading_kb,connections_to_delete_after_reading_kb,
					33);
				  blocks_with_bad_connections = Nil;
				  PUSH_SPECIAL(Blocks_with_bad_connections,blocks_with_bad_connections,
					  32);
				    refresh_all_windows_after_merging_qm = Nil;
				    PUSH_SPECIAL(Refresh_all_windows_after_merging_qm,refresh_all_windows_after_merging_qm,
					    31);
				      new_saved_kb_format_p = Nil;
				      PUSH_SPECIAL(New_saved_kb_format_p,new_saved_kb_format_p,
					      30);
					kb_uses_crlf_p = Nil;
					PUSH_SPECIAL(Kb_uses_crlf_p,kb_uses_crlf_p,
						29);
					  plist_has_been_checked_p = Nil;
					  PUSH_SPECIAL(Plist_has_been_checked_p,plist_has_been_checked_p,
						  28);
					    original_kb_state_plist_written_qm 
						    = Nil;
					    PUSH_SPECIAL(Original_kb_state_plist_written_qm,original_kb_state_plist_written_qm,
						    27);
					      previous_timestamp_qm = Nil;
					      PUSH_SPECIAL(Previous_timestamp_qm,previous_timestamp_qm,
						      26);
						file_length_qm =  
							!TRUEP(xml_object_qm) 
							? 
						...
						local_system_version_from_last_kb_read 
							= Nil;
						frame_serial_number_map = Nil;
						PUSH_SPECIAL(Frame_serial_number_map,frame_serial_number_map,
							25);
						  ...
						  PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
						    ...
						    PUSH_SPECIAL(Current_frame_serial_number_before_reading,current_frame_serial_number_before_reading,
							    23);
							  ...
							  PUSH_SPECIAL(Loading_kb_p,loading_kb_p,
							    ...
							    PUSH_SPECIAL(Suppress_updating_of_slot_value_representations_qm,suppress_updating_of_slot_value_representations_qm,
							      ...
							      system_version_from_kb_being_read 
								      = Nil;
							      PUSH_SPECIAL(System_version_from_kb_being_read,system_version_from_kb_being_read,
								      20);
								system_quality_from_last_kb_read 
									= Nil;
								PUSH_SPECIAL(System_quality_from_last_kb_read,system_quality_from_last_kb_read,
									19);
								  system_revision_from_last_kb_read 
									  = 
									  Nil;
								  PUSH_SPECIAL(System_revision_from_last_kb_read,system_revision_from_last_kb_read,
									  18);
								    kb_flags 
									    = 
									    Kb_flags;
								    PUSH_SPECIAL(Kb_flags,kb_flags,
									    17);
								      deferred_class_definitions_alist 
									      = 
									      Nil;
								      PUSH_SPECIAL(Deferred_class_definitions_alist,deferred_class_definitions_alist,
									      16);
									frames_with_substitute_classes 
										= 
										Nil;
									PUSH_SPECIAL(Frames_with_substitute_classes,frames_with_substitute_classes,
										15);
									  number_of_kb_lines_so_far 
										  = 
										  FIX((SI_Long)0L);
									  PUSH_SPECIAL(Number_of_kb_lines_so_far,number_of_kb_lines_so_far,
										  14);
									    number_of_kb_characters_so_far_qm 
										    = 
										    Nil;
									    PUSH_SPECIAL(Number_of_kb_characters_so_far_qm,number_of_kb_characters_so_far_qm,
									      ...
									      next_character_for_kb_qm 
										      = 
										      Nil;
									      PUSH_SPECIAL(Next_character_for_kb_qm,next_character_for_kb_qm,
										      12);
										read_kb_buffer_length 
											= 
											FIX((SI_Long)0L);
										PUSH_SPECIAL(Read_kb_buffer_length,read_kb_buffer_length,
										  ...
										  read_kb_buffer_index 
											  = 
											  FIX((SI_Long)0L);
										  PUSH_SPECIAL(Read_kb_buffer_index,read_kb_buffer_index,
											  10);
										    plist_from_end_element_qm 
											    = 
											    Nil;
										    PUSH_SPECIAL(Plist_from_end_element_qm,plist_from_end_element_qm,
											    9);
										      preexisting_frames 
											      = 
											      Nil;
										      PUSH_SPECIAL(Preexisting_frames,preexisting_frames,
											      8);
											base_reference 
												= 
												Nil;
											PUSH_SPECIAL(Base_reference,base_reference,
												7);
											  type_of_file_being_read 
												  = 
												  Nil;
											  PUSH_SPECIAL(Type_of_file_being_read,type_of_file_being_read,
												  6);
											    backup_case_qm 
												    = 
												    Nil;
											    PUSH_SPECIAL(Backup_case_qm,backup_case_qm,
												    5);
											      system_tables_read_for_this_module 
												      = 
												      Nil;
											      PUSH_SPECIAL(System_tables_read_for_this_module,system_tables_read_for_this_module,
												      4);
													...
													if ( 
													  ...
													  end_loop_3:
													    ...
													    collected_items_with_warnings_alist 
														    = 
														    Nil;
													    PUSH_SPECIAL(Collected_items_with_warnings_alist,collected_items_with_warnings_alist,
														    3);
													      PUSH_SPECIAL(Collecting_warnings_p,collecting_warnings_p,
														      2);
														  ...
														  end_1:;
															...
															if (PUSH_LOCAL_ALLOCATION(Local_area,
																...
																if (PUSH_UNWIND_PROTECT(1)) 
																    ...
																    gensymed_symbol 
																	    = 
																	    make_gensym_list_1(FIX((SI_Long)9L));
																    gensymed_symbol_1 
																	    = 
																	    gensymed_symbol;
																    temp_2 
																...
																timestamp_qm_1 
																	= 
																	gensym_cons_1(timestamp_field_qm,
																	timestamp_qm_1);
																goto next_loop_9;
															      end_loop_9:;
																timestamp_field_qm 
																...
																if ( 
																	!TRUEP(timestamp_field_qm)) 
																	    {
																    if (timestamp_qm_1)
																	reclaim_gensym_list_1(timestamp_qm_1);
																    decrypted_timestamp_qm 
																	    = 
																	    Nil;
																    goto end_4;
																...
																if ( 
																	...
																	gensymed_symbol 
																		= 
																		make_gensym_list_1(FIX((SI_Long)7L));
																	gensymed_symbol_1 
																		= 
																		gensymed_symbol;
																	temp_2 
																...
																if ( 
																	...
																	Qunbound_in_protected_let))
																    reclaim_gensym_list_1(decrypted_timestamp_qm);
															    }
															    CONTINUE_UNWINDING(2);
															}
															POP_LOCAL_ALLOCATION(0,0);
														...
														if (encrypted_timestamp) 
														    ...
														    if ( 
															    ...
															    Qunbound_in_protected_let))
															reclaim_gensym_list_1(encrypted_timestamp);
														}
												...
												if (System_tables_read_for_this_module) 
													    {
												    reclaim_gensym_list_1(System_tables_read_for_this_module);
												    System_tables_read_for_this_module 
													    = 
													    Nil;
												}
							...
							goto next_loop_25;
							  ...
							  kb_flags_from_last_kb_read 
								  = 
								  local_kb_flags_from_last_kb_read;
							  PUSH_SPECIAL(Kb_flags_from_last_kb_read,kb_flags_from_last_kb_read,
								  3);
							    system_version_from_last_kb_read 
								    = 
								    local_system_version_from_last_kb_read;
							    PUSH_SPECIAL(System_version_from_last_kb_read,system_version_from_last_kb_read,
								    2);
							      if ( 
								      !(xml_object_qm 
								      || 
						    ...
						    reclaim_gensym_list_1(discrepancy_with_system_time1_p);
...
static Object Qgensym_time;        /* gensym-time */
...
Object Blocks_with_subblocks_from_kb_read = UNBOUND;
...
Object Classes_needing_data_interface_initialization = UNBOUND;
...
Object initialize_instances_with_default_data_interface_values()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(Classes_needing_data_interface_initialization);
    ...
    Object character_1, top_level_element_qm;
{
    ...
    Object substitute_class_and_kb_flags_qm, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, sub_class_bit_vector, class_description;
    Object class_inheritance_path, frame_is_block_qm;
    Object definition_being_read_in_is_a_ghost_qm, kb_object_index_for_frame;
    Object frame_qm, frame, index_space, index_1, object, temp_3;
    Object frame_being_read_qm, slot_description_for_slot_value_being_read_qm;
    ...
    SI_Long sub_class_vector_index, gensymed_symbol_5, temp_4;
    char temp_1;
    Declare_special(3);
    ...
    PUSH_SPECIAL(Frame_being_read_qm,frame_being_read_qm,2);
      slot_description_for_slot_value_being_read_qm = Nil;
      PUSH_SPECIAL(Slot_description_for_slot_value_being_read_qm,slot_description_for_slot_value_being_read_qm,
	      1);
	...
	if (EQ(slot_name,Qname_of_defined_class))
	    ...
	    PUSH_SPECIAL(Kb_flags,kb_flags,0);
		...
		System_tables_read_for_this_module = gensym_cons_1(frame,
			System_tables_read_for_this_module);
	    }
	    else
		put_name_or_names_for_frame(frame,slot_value,T);
	...
	if (name_of_defined_class_qm || superior_of_defined_class_qm || 
	    ...
	    adjusted_direct_superiors = superior_of_defined_class_qm ? 
		    ...
		    gensym_cons_1(superior_of_defined_class_qm,Nil) : 
	...
	if (capabilities_of_class_qm && name_of_defined_class_qm) {
		...
		reclaim_gensym_tree_1(capabilities_of_class_qm);
	}
...
{
    Object first_element, gensym_push_modify_macro_arg, car_1, cdr_1, temp;
	...
	line_drawing_description = gensym_cons_1(gensym_cons_1(Qpolychrome,
		Nil),line_drawing_description);
    if ( !TRUEP(get_variable_specification_if_any(line_drawing_description))) {
	gensym_push_modify_macro_arg = gensym_cons_1(Qvariables,Nil);
	car_1 = gensym_push_modify_macro_arg;
	...
	gensym_push_modify_macro_arg = gensym_cons_1(Qbackground_layer,Nil);
	car_1 = gensym_push_modify_macro_arg;
  ...
  end_loop:;
	...
	gensym_push_modify_macro_arg = gensym_cons_1(Qicon_color,
		line_color_of_icon_qm);
	car_1 = gensym_push_modify_macro_arg;
	...
	temp = gensym_cons_1(gensym_cons_1(Qforeground,Qforeground),
		CDR(polychrome_header));
	M_CDR(polychrome_header) = temp;
    }
  next_loop_3:
	...
	goto end_loop_3;
    temp = delete_gensym_element_1(Qnil,CDR(polychrome_header));
    M_CDR(polychrome_header) = temp;
    goto next_loop_3;
  end_loop_3:;
    ...
    Object block, left_edge_of_block;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_2, slot_group_qm;
  ...
  next_loop:
	...
	SVREF(temp_2,FIX((SI_Long)5L)) = gensymed_symbol_2;
    }
    ab_loopvar__1 = gensym_cons_1(subblock,Nil);
    if (ab_loopvar_)
  ...
  end_loop:
    ...
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(gensymed_symbol_1,Qslot_group_for_block_qm);
    gensymed_symbol = upgrade_subblocks(subblocks);
    if (slot_group_qm)
	...
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(gensymed_symbol_1,Qslot_group_for_block_qm);
	temp_2 = make_icon_slot_group_1();
	SVREF(gensymed_symbol_1,FIX((SI_Long)14L)) = temp_2;
	temp_2 = ISVREF(gensymed_symbol_1,(SI_Long)14L);
	SVREF(temp_2,FIX((SI_Long)4L)) = gensymed_symbol;
    }
    return VALUES_1(Qnil);
}
    ...
    Object change_the_text_of_attributes_qm, change_the_text_of_overrides_qm;
{
    ...
    Object slot_description_qm, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp, temp_1, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value, definition_class;
    Object superior_class, superior_definition;
    Object list_holding_superior_information_qm, superior_information, temp_2;
	...
	if ( !EQ(THIRD(override),Quser_defined)) {
	    ab_loopvar__2 = gensym_cons_1(override,Nil);
	    if (ab_loopvar__1)
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	if (EQ(THIRD(override),Quser_defined)) {
	    ab_loopvar__2 = gensym_cons_1(copy_for_slot_value(override),Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
	...
	if (direct_superiors_are_defined_qm) {
	  ...
	  end_11:;
		...
		superior_class = Qnil;
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = superior_class;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(superior_class) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_12:
	    if ( !TRUEP(gensymed_symbol))
	...
	if (superior_slot_description_qm &&  
		...
		if ( !TRUEP(memq_function(temp_1,
			...
			temp_2 = gensym_cons_1(attribute_name,
				SECOND(superior_information));
			M_SECOND(superior_information) = temp_2;
		    }
		    else
			new_superior_indexed_attributes_qm = 
				gensym_cons_1(gensym_list_2(superior_class,
				gensym_cons_1(attribute_name,Nil)),
				new_superior_indexed_attributes_qm);
		}
		...
		temp = 
			gensym_cons_1(gensym_list_3(FIRST(attribute_description),
			gensym_cons_1(attribute_initial_value,Nil),
			Quser_defined),Nil);
	    else if (attribute_initial_value || attribute_initial_type_qm)
		temp = 
			gensym_cons_1(gensym_list_3(FIRST(attribute_description),
			attribute_initial_type_qm ? 
			gensym_list_2(attribute_initial_value,
			attribute_initial_type_qm) : 
	    ...
	    temp_2 = gensym_cons_1(gensym_list_3(Qab_or,Qitem_or_datum,
		    gensym_cons_1(Qno_item,Nil)),CDR(attribute_description));
	    M_CDR(attribute_description) = temp_2;
	    class_specific_attributes_list = 
		    nconc2(class_specific_attributes_list,
		    gensym_cons_1(attribute_description,Nil));
	}
	goto next_loop_2;
      end_loop_2:;
    }
	...
	if ( !TRUEP(memq_function(attribute_name,
		indexed_attributes_becoming_overrides_qm))) {
	    ab_loopvar__2 = gensym_cons_1(attribute_name,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
	...
	reclaim_gensym_list_1(indexed_attributes_becoming_overrides_qm);
    }
    superior_class = Nil;
  ...
  next_loop_21:
    ...
    goto next_loop_21;
  end_loop_21:;
    reclaim_gensym_tree_1(new_superior_indexed_attributes_qm);
	...
	return reclaim_gensym_list_1(attribute_descriptions_qm);
    else
	return VALUES_1(Nil);
}
    ...
    Object called_from_change_the_text_qm;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(symbol,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_2:;
	...
	if (direct_superiors_of_defined_class_qm &&  
		...
		list_constant_9))
	    direct_superiors_of_defined_class_qm = gensym_cons_1(Qobject,Nil);
	else {
	    superior = Nil;
  ...
  end_loop_3:;
	...
	data_service_and_interface_capabilities_qm = 
		...
		gensym_cons_1(chosen_data_interface_capability_qm,Nil));
	...
	if ( !TRUEP(CDR(data_service_and_interface_capabilities_qm)) && 
	    ...
	    if (called_from_change_the_text_qm) {
		reclaim_gensym_list_1(direct_superiors_of_defined_class_qm);
		direct_superiors_of_defined_class_qm = Nil;
	    }
	...
	if (more_than_one_interface_capability_qm) {
		...
		Classes_needing_data_interface_initialization = 
			gensym_cons_1(gensym_list_2(class_name,
			chosen_data_interface_capability_qm),
			Classes_needing_data_interface_initialization);
	}
	reclaim_gensym_list_1(data_service_and_interface_capabilities_qm);
    }
	...
	configuration_list = nconc2(temp_1,
		gensym_cons_1(make_declaration_clause_for_item_configuration(2,
		symbol,T),Nil));
	goto next_loop_6;
      end_loop_6:
	if (called_from_change_the_text_qm)
	...
	reclaim_gensym_list_1(instance_configuration_capabilities_qm);
    }
    return reclaim_gensym_list_1(capability_flat_list);
}
...
Object Connection_classes_warned_about_for_this_kb = UNBOUND;
    ...
    Object top_level_element_qm;
{
	...
	if ( !(FIXNUM_LE(FIX((SI_Long)-128L),temp_1) && FIXNUM_LE(temp_1,
		...
		break;
	      case 126:
		temp_1 = gensym_list_2(Qframe_denotation,
			read_element_for_kb(Nil));
		break;
	      case 124:
...
Object Create_frames_and_connections_reading_past_qm = UNBOUND;
...
Object read_aggregate_evaluation_value_for_kb()
{
  ...
  next_loop:
	...
	if (FIXNUM_LE(ISVREF(managed_array,(SI_Long)1L),
	    ...
	    temp_1 = gensym_list_2(Qframe_denotation,element);
	    ...
	    svref_new_value = gensym_list_2(Qframe_denotation,element);
    ...
    goto next_loop;
  end_loop:
    aggregate_evaluation_value = gensym_cons_1(managed_array,aggregate_type);
...
Object read_ghost_definitions()
{
    ...
    PUSH_SPECIAL(Reading_ghost_definitions_p,reading_ghost_definitions_p,0);
    ...
    Object definition_infos;
{
    ...
    Object cons_1, next_cons, next, ancestor;
    ...
    Object install_qm;
{
	...
	PUSH_SPECIAL(Class_name_read_while_reading_current_ghost_definition,class_name_read_while_reading_current_ghost_definition,
		0);
	  definition_qm = Nil;
	next_loop:
	  ...
	  information_on_ghost_definitions = 
		  gensym_cons_1(gensym_list_3(Class_name_read_while_reading_current_ghost_definition,
	  ...
	  goto next_loop;
	end_loop:
	  reclaim_gensym_tree_1(information_on_ghost_definitions);
	  result = VALUES_1(Qnil);
	POP_SPECIAL();
	return result;
    }
    ...
    Object information_on_ghost_definitions_qm;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_tree_1(information_on_ghost_definitions_qm);
    return VALUES_1(Qnil);
}
    ...
    Object class_name, new_definition, information_on_ghost_definitions_qm;
{
	...
	if (old_class_definition_is_frame_p_qm) {
	    ...
	    adjusted_direct_superiors_qm = direct_superiors_qm ? 
		    ...
		    gensym_cons_1(direct_superiors_qm,Nil) : 
...
{
    Object superior, ab_loop_list_, ab_loop_it_, gensymed_symbol;
	...
	if (CONSP(attribute_initial_value) && 
		EQ(CAR(attribute_initial_value),Kfuncall))
	    temp_1 = 
		    gensym_list_3(CAR(copied_definition1_configuration_attribute_description),
		    gensym_cons_1(attribute_initial_value,Nil),Quser_defined);
	else if (attribute_initial_value || attribute_initial_type_qm)
	    temp_1 = 
		    gensym_list_3(CAR(copied_definition1_configuration_attribute_description),
		    attribute_initial_type_qm ? 
	...
	if (EQUAL(definition2_configuration_default_override,
		...
		new_definition1_default_overrides = 
			gensym_cons_1(proposed_definition1_configuration_default_override,
			Nil);
	    else {
		...
		if ( !TRUEP(definition2_list))
		    ab_loopvar__2 =  !TRUEP(new_override_added_qm) && 
			    ...
			    gensym_list_2(override,
			    proposed_definition1_configuration_default_override) 
			    : gensym_cons_1(override,Nil);
		else {
			...
			ab_loopvar__2 = 
				gensym_list_2(proposed_definition1_configuration_default_override,
				override);
		    }
		    else {
	    ...
	    svref_new_value = 
		    delete_gensym_element_1(definition1_configuration_attribute_description,
		    definition1_attributes);
	    SVREF(definition1,FIX((SI_Long)22L)) = svref_new_value;
    ...
    Object block, slot_group_data;
{
	...
	reclaim_gensym_list_1(slot_group_data);
    }
    return VALUES_1(Nil);
}
...
Object fix_subworkspace_names()
{
    ...
    PUSH_SPECIAL(Kb_flags,kb_flags,6);
	  ...
	  ab_loopvar__1 = Nil;
	  kb_workspace = Nil;
	  PUSH_SPECIAL(Scope_conses,scope_conses,5);
	    superior_item = Nil;
    ...
    Object definition;
{
	...
	if ( !(EQ(THIRD(override),Quser_defined) || THIRD(override))) {
		...
		cdr_new_value = nconc2(temp,
			gensym_cons_1(most_refined_foundation_class_of_direct_superiors(2,
...
Object make_all_rule_boxes_have_text_box_format()
{
    ...
    kb_flags = Kb_flags_from_last_kb_read;
    PUSH_SPECIAL(Kb_flags,kb_flags,1);
...
Object fix_unimplemented_definitions()
{
    ...
    Object class_name, gensymed_symbol_1, gensymed_symbol_4, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
	...
	end_loop:
      ...
      if ( !((SI_Long)0L != (IFIX(ISVREF(definition,(SI_Long)5L)) & 
	      (SI_Long)262144L))) {
	  gensymed_symbol = ISVREF(definition,(SI_Long)14L);
	  gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		  (SI_Long)5L) : Nil;
	  temp =  !TRUEP(gensymed_symbol);
      }
...
Object Ui_client_interface_in_which_to_launch_recompilation_qm = UNBOUND;
...
Object Compiling_incomplete_items_after_analyze_p = UNBOUND;

Object Collecting_procedures_to_warn_about_p = UNBOUND;

Object Procedures_to_warn_about_p = UNBOUND;

Object Add_as_item_referring_to_name_qm = UNBOUND;
...
Object analyze_compiled_items_after_loading()
{
    ...
    PUSH_SPECIAL(Collected_items_with_warnings_alist,collected_items_with_warnings_alist,
	    7);
      PUSH_SPECIAL(Collecting_warnings_p,collecting_warnings_p,6);
	if (Some_module_is_clear_text_p) {
		...
		PUSH_SPECIAL(Items_made_incomplete_were_recorded_qm,items_made_incomplete_were_recorded_qm,
		  ...
		  PUSH_SPECIAL(Procedures_to_warn_about_p,procedures_to_warn_about_p,
			  2);
		    collecting_procedures_to_warn_about_p = T;
		    PUSH_SPECIAL(Collecting_procedures_to_warn_about_p,collecting_procedures_to_warn_about_p,
			    1);
		      compiling_incomplete_items_after_analyze_p = T;
		      PUSH_SPECIAL(Compiling_incomplete_items_after_analyze_p,compiling_incomplete_items_after_analyze_p,
			      0);
...
Object Rendezvous_successful_blocks_qm = UNBOUND;

Object Additional_related_blocks = UNBOUND;
...
Object rendezvous_frame_denotations_in_relation_instances()
{
    ...
    Object other_instances, corresponding_relation_qm, gensymed_symbol_1;
    Object gensymed_symbol_4, the_block, blocks, type_of_relation;
    Object copied_relation_instances, copied_relation_instance;
    Object copied_object_frames, inverse_instance;
	...
	if ( !TRUEP(relation_instances) || CONSP(relation_instances) &&  
	  ...
	  end_3:;
		...
		if (item_frame) {
		    ...
		    reclaim_gensym_cons_1(temp_1);
		    leading_pointer = item_references;
		}
		goto next_loop_5;
	      end_loop_5:
		M_CDDR(relation_instance) = item_references;
		reclaim_gensym_list_1(item_references_with_possible_duplicates);
		...
		if ( !EQ(relation_name_reference,relation_name) &&  
			...
			relations_with_changed_slots_qm = 
				gensym_cons_1(relation_frame_qm,
				relations_with_changed_slots_qm);
		}
		...
		if (following_pointer) {
		    ...
		    reclaim_gensym_cons_1(current_pointer);
		    current_pointer = CDR(following_pointer);
		}
		else {
		...
		reclaim_gensym_list_1(relation_instance);
	    }
	    goto next_loop_1;
	  end_loop_1:;
	    if ( !TRUEP(relation_instances_empty_p(ISVREF(block,
		    (SI_Long)12L))))
		Rendezvous_successful_blocks_qm = gensym_cons_1(block,
    ...
    next_loop_7:
	  ...
	  next_loop_9:
	    ...
	    other_instances = object_frame ? ISVREF(object_frame,
		    (SI_Long)12L) : Nil;
	    if (other_instances) {
		gensymed_symbol = CDR(other_instances);
		gensymed_symbol_1 = other_relation_name_reference;
		gensymed_symbol_2 = 
		...
		if (gensymed_symbol_2 < gensymed_symbol_3)
		  ...
		  next_loop_12:
		    ...
		    goto next_loop_12;
		  end_loop_12:
		    corresponding_relation_qm = Qnil;
		  end_5:;
		    goto end_6;
		}
		goto next_loop_11;
		...
		if (corresponding_relation_qm) {
		    ...
		    gensymed_symbol_1 = the_block;
		    gensymed_symbol_2 = SXHASH_SYMBOL_1(the_block) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_3 = (SI_Long)0L;
		  next_loop_13:
		    if ( !TRUEP(gensymed_symbol))
		...
		if ((temp ? TRUEP(ISVREF(relation,(SI_Long)25L)) : 
			...
			if (EQ(relation_name_reference,relation_name) && 
			    ...
			    if (other_instances) {
				gensymed_symbol_1 = ISVREF(relation,
					(SI_Long)23L);
  ...
  next_loop_21:
    ...
    next_loop_22:
	  ...
	  if ((EQ(type_of_relation,Qone_to_one) || EQ(type_of_relation,
	      ...
	      if ( !TRUEP(memq_function(relation,
		      relations_with_changed_slots_qm)))
		  relations_with_changed_slots_qm = gensym_cons_1(relation,
			  relations_with_changed_slots_qm);
	  }
      }
      goto next_loop_22;
	  ...
	  next_loop_26:
		...
		if ( !temp) {
			...
			Additional_related_blocks = 
				gensym_cons_1(object_frame,
				Additional_related_blocks);
		    gensymed_symbol = CDR(relation_instances);
		    gensymed_symbol_1 = relation_name_reference;
		    gensymed_symbol_2 = 
		  ...
		  next_loop_33:
			...
			gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
			if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
			    block_relevant_relation_instance = 
				    M_CDR(M_CAR(gensymed_symbol));
			    goto end_20;
			}
			gensymed_symbol = M_CDR(gensymed_symbol);
			goto next_loop_34;
		      end_loop_34:
			block_relevant_relation_instance = Qnil;
		      end_20:;
			goto end_21;
		    }
		    goto next_loop_33;
		  ...
		  end_21:;
			...
			set_balanced_binary_tree_entry(relevant_object_frames,
			...
			if (temp);
				...
				temp = 
					EQ(ISVREF(ISVREF(M_CAR(gensymed_symbol),
					(SI_Long)0L),(SI_Long)0L),
					M_CDR(gensymed_symbol));
			    }
			    else
				...
				next_loop_35:
				  if (ab_current_alist_) {
					  ...
					  ab_current_node_ = ab_next_node_;
					  ab_next_node_ = 
						  ISVREF(ISVREF(ab_current_node_,
						  (SI_Long)0L),(SI_Long)0L);
					  if (EQ(ab_next_node_,ab_tail_node_))
					      ab_next_node_ = Nil;
					  ab_entry_cons_ = 
  ...
  end_loop_24:;
    ...
    reclaim_gensym_list_1(relations_with_changed_slots_qm);
    temp_1 = copy_frame_serial_number(Current_frame_serial_number);
    Rendezvous_successful_blocks_qm = gensym_cons_1(temp_1,
	    Rendezvous_successful_blocks_qm);
    temp_1 = copy_frame_serial_number(Current_frame_serial_number);
    Additional_related_blocks = gensym_cons_1(temp_1,
	    Additional_related_blocks);
    ...
    Object blocks;
{
  ...
  end_loop:;
    reclaim_frame_serial_number(fsn);
    return reclaim_gensym_list_1(blocks);
}
  ...
  next_loop:
	...
	next_loop_1:
	  ...
	  if (memq_function(relation,relations)) {
	      ...
	      set_balanced_binary_tree_entry(temp,Qeq,Nil,T,
		      gensymed_symbol,FIX(SXHASH_SYMBOL_1(gensymed_symbol) 
		      & IFIX(Most_positive_fixnum)),Nil);
	      deleted_names = gensym_cons_1(relation_name,deleted_names);
	...
	end_loop_2:
	  if (deleted_names) {
	    ...
	    next_loop_3:
	      ...
	      delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),temp,
		      temp_2,FIX(SXHASH_SYMBOL_1(name) & 
		      IFIX(Most_positive_fixnum)));
	      goto next_loop_3;
	    end_loop_3:;
	      reclaim_gensym_list_1(deleted_names);
	  }
	POP_SPECIAL();
    }
    goto next_loop;
...
Object ensure_connections_have_frames_if_necessary()
{
    ...
    kb_flags = Kb_flags_from_last_kb_read;
    PUSH_SPECIAL(Kb_flags,kb_flags,2);
    ...
    Object variables_alist_qm;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	variables_plist = gensym_cons_1(variable_name,variables_plist);
	variables_plist = gensym_cons_1(variable_value,variables_plist);
	goto next_loop;
      end_loop:
	reclaim_gensym_tree_1(variables_alist_qm);
    ...
    Object message_definition;
{
  ...
  next_loop:
    ...
    value = CDR(temp);
    if (value) {
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(sym,value),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
static Object Qeditor_parameters;  /* editor-parameters */
...
static Object Qlogbook_parameters;  /* logbook-parameters */

static Object Qprefer_native_logbook;  /* prefer-native-logbook */

static Object Qmessage_board_parameters;  /* message-board-parameters */
...
void kb_load2_INIT()
{
    ...
    Object Qui_client_interface_in_which_to_launch_recompilation_qm;
    Object Qworkstation_in_which_to_launch_recompilation_qm;
    Object Qlaunch_recompile_for_compilations_removed_in_this_kb_qm;
    ...
    Object Qconnection_classes_warned_about_for_this_kb;
    ...
    Object Qclasses_needing_data_interface_initialization;
    ...
    Object Qblocks_with_subblocks_from_kb_read;
    Object Qblocks_with_connections_from_kb_read;
    Object Qblocks_with_relation_instances_from_kb_read;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qearliest_version_to_allow_kb_loading, list_constant_20;
    Object Qframes_for_rendezvous_in_aggregate_values_qm;
    ...
    Object Qbasis_kb_frame_serial_number, Qread_kb_stream;
    Object Qwarmboot_current_time, Qwarmboot_simulated_time, list_constant_18;
    Object Qread_kb_buffer, Qsaving_kb_p, Qloading_kb_p, Qreading_kb_p;
    Object Qreclaim_frame_serial_number;
    Object Qreference_serial_number_for_saved_detail_pane_description;
    Object Qreclaim_slot_value, Qsaved_detail_pane_description;
    Object Qlist_of_switched_and_module_post_loading_functions;
    Object Qlist_of_once_only_pre_conflict_resolution_post_loading_functions;
    Object Qlist_of_module_pre_conflict_resolution_post_loading_functions;
    Object Qlist_of_once_only_switched_post_loading_functions;
    Object Qlist_of_once_only_post_conflict_resolution_post_loading_functions;

    x_note_fn_call(133,165);
    SET_PACKAGE("AB");
