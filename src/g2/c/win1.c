...
Object Defer_notifications_qm = UNBOUND;

Object G2_has_v5_mode_windows_p = UNBOUND;
...
Object Trace_image_planes_p = UNBOUND;
...
Object Default_maximum_icon_bitmaps = UNBOUND;

Object Default_maximum_icon_bitmap_memory = UNBOUND;
...
Object Chain_of_available_gensym_windows = UNBOUND;

Object Gensym_window_count = UNBOUND;
    ...
    Object gensym_window;
{
    ...
    reclaim_gensym_tree_with_text_strings(ISVREF(gensym_window,(SI_Long)19L));
    ...
    reclaim_gensym_list_1(ISVREF(gensym_window,(SI_Long)27L));
    SVREF(gensym_window,FIX((SI_Long)27L)) = Nil;
    reclaim_gensym_list_1(ISVREF(gensym_window,(SI_Long)28L));
    ...
    reclaim_gensym_tree_with_text_strings(ISVREF(gensym_window,(SI_Long)64L));
    ...
    svref_new_value = Chain_of_available_gensym_windows;
    SVREF(gensym_window,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gensym_windows = gensym_window;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_gensym_window_variable, gensym_window_count_new_value;
    Object defstruct_g2_gensym_window_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(56,13);
    def_structure_gensym_window_variable = Nil;
    gensym_window_count_new_value = FIXNUM_ADD1(Gensym_window_count);
    Gensym_window_count = gensym_window_count_new_value;
...
{
    Object def_structure_gensym_window_variable, svref_new_value;

    x_note_fn_call(56,14);
    def_structure_gensym_window_variable = Chain_of_available_gensym_windows;
    ...
    svref_new_value = allocate_small_2d_array(FIX((SI_Long)14L));
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)25L)) = 
	    svref_new_value;
    svref_new_value = allocate_small_2d_array(FIX((SI_Long)14L));
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)26L)) = 
	    svref_new_value;
    ...
    svref_new_value = Default_image_palette;
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)31L)) = 
	    svref_new_value;
    ...
    svref_new_value = make_queue();
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)47L)) = 
	    svref_new_value;
    svref_new_value = make_queue();
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)48L)) = 
	    svref_new_value;
    svref_new_value = make_queue();
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)49L)) = 
	    svref_new_value;
    svref_new_value = allocate_managed_array(1,FIX((SI_Long)1024L));
    SVREF(def_structure_gensym_window_variable,FIX((SI_Long)50L)) = 
	    svref_new_value;
...
Object Native_menu_table = UNBOUND;
    ...
    Object native_menu_table;
{
    ...
    x_note_fn_call(56,21);
    PUSH_SPECIAL(Native_menu_table,native_menu_table,0);
...
Object printing_window_p(gensym_window)
    Object gensym_window;
{
    x_note_fn_call(56,36);
    return VALUES_1(EQ(ISVREF(gensym_window,(SI_Long)1L),Qprinter) ? T : Nil);
}

Object X_debugging_on = UNBOUND;

/* DEBUG-X11 */
Object debug_x11()
{
    x_note_fn_call(56,37);
...
Object Current_window = UNBOUND;

Object Drawing_on_window = UNBOUND;

Object Left_edge_of_draw_area = UNBOUND;

Object Top_edge_of_draw_area = UNBOUND;

Object Right_edge_of_draw_area = UNBOUND;

Object Bottom_edge_of_draw_area = UNBOUND;

Object Current_image_x_scale = UNBOUND;

Object Current_image_y_scale = UNBOUND;

Object Current_x_origin_of_drawing = UNBOUND;

Object Current_y_origin_of_drawing = UNBOUND;

Object Type_of_current_window = UNBOUND;

Object Current_native_window_qm = UNBOUND;

Object Current_color_map = UNBOUND;

Object Current_drawing_transfer_mode = UNBOUND;

Object Current_background_color_value = UNBOUND;

Object Current_foreground_color_value = UNBOUND;

Object Current_pane = UNBOUND;

Object Current_drawing_priority = UNBOUND;

Object Current_draw_paper_p = UNBOUND;

Object Current_draw_document_p = UNBOUND;

Object Workspace_for_current_draw_document_qm = UNBOUND;

Object Currently_jump_out_of_drawing_image_plane_when_empty_rectangle_p = UNBOUND;
    ...
    Object gensym_window;
{
    ...
    PUSH_SPECIAL(Delete_corresponding_object_qm,delete_corresponding_object_qm,
	    1);
      PUSH_SPECIAL(Current_window,current_window_1,0);
...
{
    x_note_fn_call(56,50);
    if (EQ(axis,Qx))
	return l_round(FIXNUM_TIMES(dialog_units,get_system_metric(3,
...
{
    x_note_fn_call(56,68);
    return force_graphics_on_window(FIX((SI_Long)1L));
}

Object The_type_description_of_identified_drawing_activity = UNBOUND;

Object Chain_of_available_identified_drawing_activitys = UNBOUND;

Object Identified_drawing_activity_count = UNBOUND;
    ...
    Object identified_drawing_activity;
{
    ...
    x_note_fn_call(56,71);
    inline_note_reclaim_cons(identified_drawing_activity,Nil);
    svref_new_value = Chain_of_available_identified_drawing_activitys;
    SVREF(identified_drawing_activity,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_identified_drawing_activitys = 
...
Object make_permanent_identified_drawing_activity_structure_internal()
{
    ...
    Object identified_drawing_activity_count_new_value;
    Object defstruct_g2_identified_drawing_activity_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(56,73);
    def_structure_identified_drawing_activity_variable = Nil;
    identified_drawing_activity_count_new_value = 
	    FIXNUM_ADD1(Identified_drawing_activity_count);
...
Object Flush_graphics_immediately_qm = UNBOUND;
    ...
    Object right_edge_of_draw_area, bottom_edge_of_draw_area;
{
    ...
    x_note_fn_call(56,87);
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,4);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,3);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,2);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,1);
	    PUSH_SPECIAL(Current_window,current_window_1,0);
...
static Object Qdrawing_on_window;  /* drawing-on-window */
...
Object All_colors = UNBOUND;

Object Menu_colors = UNBOUND;

Object Menu_colors_sorted_alphabetically = UNBOUND;

Object Menu_colors_sorted_by_hue = UNBOUND;

Object The_type_description_of_color_map = UNBOUND;

Object Chain_of_available_color_maps = UNBOUND;

Object Color_map_count = UNBOUND;
    ...
    Object color_map;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_color_maps;
    SVREF(color_map,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_color_maps = color_map;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_color_map_variable, color_map_count_new_value;
    Object defstruct_g2_color_map_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(56,103);
    def_structure_color_map_variable = Nil;
    color_map_count_new_value = FIXNUM_ADD1(Color_map_count);
    Color_map_count = color_map_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_color_map_variable;

    x_note_fn_call(56,104);
    def_structure_color_map_variable = Chain_of_available_color_maps;
...
Object Initialize_gensym_window_after_connection_done = UNBOUND;
...
Object Current_scratchpad_raster_type = UNBOUND;

Object Current_scratchpad_raster = UNBOUND;

Object Current_scratchpad_raster_width = UNBOUND;

Object Current_scratchpad_raster_height = UNBOUND;

Object Current_scratchpad_raster_depth = UNBOUND;

Object Current_scratchpad_raster_tiled_p = UNBOUND;

Object Current_x_offset_for_stored_raster_qm = UNBOUND;

Object Current_y_offset_for_stored_raster_qm = UNBOUND;

Object Current_x_max_for_stored_raster_qm = UNBOUND;

Object Current_y_max_for_stored_raster_qm = UNBOUND;
    ...
    Object callback_function_to_gc_if_allocation_failure;
{
    ...
    x_note_fn_call(56,129);
    do_not_error_in_x11_create_pixmap_on_failed_allocation = T;
    PUSH_SPECIAL(Do_not_error_in_x11_create_pixmap_on_failed_allocation,do_not_error_in_x11_create_pixmap_on_failed_allocation,
	    0);
...
Object On_monochrome_raster_list_p = UNBOUND;

Object Paint_only_target_monochrome_raster_p = UNBOUND;
			  ...
			  PUSH_SPECIAL(Current_y_offset_for_stored_raster_qm,current_y_offset_for_stored_raster_qm,
				...
				PUSH_SPECIAL(Current_scratchpad_raster,current_scratchpad_raster,
				  ...
				  transfer_region_to_smaller_raster(FIX((SI_Long)0L),
					  ...
					  x_offset,y_offset,FIX((SI_Long)1L));
				  new_stored_raster = 
...
Object Current_scratchpad_raster_list = UNBOUND;

Object Current_scratchpad_color_value_list = UNBOUND;

Object The_type_description_of_tiled_raster = UNBOUND;

Object Chain_of_available_tiled_rasters = UNBOUND;

Object Tiled_raster_count = UNBOUND;
    ...
    Object tiled_raster;
{
    ...
    x_note_fn_call(56,135);
    inline_note_reclaim_cons(tiled_raster,Nil);
    svref_new_value = Chain_of_available_tiled_rasters;
    SVREF(tiled_raster,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_tiled_rasters = tiled_raster;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_tiled_raster_variable, tiled_raster_count_new_value;
    Object defstruct_g2_tiled_raster_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(56,137);
    def_structure_tiled_raster_variable = Nil;
    tiled_raster_count_new_value = FIXNUM_ADD1(Tiled_raster_count);
    Tiled_raster_count = tiled_raster_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_pixmaps = UNBOUND;

Object Pixmap_count = UNBOUND;
    ...
    Object pixmap;
{
    ...
    x_note_fn_call(56,142);
    inline_note_reclaim_cons(pixmap,Nil);
    svref_new_value = Chain_of_available_pixmaps;
    SVREF(pixmap,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_pixmaps = pixmap;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_pixmap_variable, pixmap_count_new_value;
    Object defstruct_g2_pixmap_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(56,144);
    def_structure_pixmap_variable = Nil;
    pixmap_count_new_value = FIXNUM_ADD1(Pixmap_count);
    Pixmap_count = pixmap_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_pixmap_variable;

    x_note_fn_call(56,145);
    def_structure_pixmap_variable = Chain_of_available_pixmaps;
    if (def_structure_pixmap_variable) {
	Chain_of_available_pixmaps = ISVREF(def_structure_pixmap_variable,
		(SI_Long)0L);
    ...
    Object gensym_window;
{
    ...
    Object stored_raster_qm, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value;
    SI_Long ab_loop_repeat_, index_1, ab_loop_bind_;

    x_note_fn_call(56,148);
    count_1 = FIX((SI_Long)0L);
  ...
  next_loop_2:
    ...
    stored_raster_qm = gensym_pop_store;
...
Object hard_reclaim_all_irregular_size_reclaimed_stored_rasters(gensym_window)
    Object gensym_window;
{
    Object count_1, pool_vector, raster_info_qm, gensym_pop_store, cons_1;
    Object next_cons, cdr_new_value, temp;

    x_note_fn_call(56,149);
    count_1 = FIX((SI_Long)0L);
  ...
  next_loop:
    ...
    raster_info_qm = gensym_pop_store;
    if ( !TRUEP(raster_info_qm))
	goto end_loop;
    count_1 = FIXNUM_ADD1(count_1);
    g2ext_reclaim_pixmap(IFIX(THIRD(raster_info_qm)));
    reclaim_gensym_list_1(raster_info_qm);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(pool_vector);
    SVREF(gensym_window,FIX((SI_Long)27L)) = Nil;
    temp = count_1;
    count_1 = FIX((SI_Long)0L);
  ...
  end_loop_1:
    reclaim_gensym_list_1(pool_vector);
    SVREF(gensym_window,FIX((SI_Long)28L)) = Nil;
    return VALUES_1(FIXNUM_ADD(temp,count_1));
}
    ...
    Object gensym_window, minimum_width, minimum_height, bits_per_pixel;
{
	...
	if (FIXNUM_EQ(FIRST(raster_info),minimum_width) && 
	    ...
	    reclaim_gensym_list_1(raster_info);
	    goto end_loop;
	}
	...
	if (the_stored_raster_qm) {
	    ...
	    reclaim_gensym_cons_1(rest_of_pool);
	}
    }
    if (the_stored_raster_qm)
    ...
    Object make_exact_size_p;
{
    ...
    Object current_regular_raster_height_index, temp;
    Object do_not_error_in_x11_create_pixmap_on_failed_allocation, pool;
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value;
    Object stored_raster_qm;
    SI_Long svref_arg_2;
    Declare_special(1);
    Object result;

    x_note_fn_call(56,153);
	...
	temp = FIX((SI_Long)0L);
	temp = NUM_LT(minimum_width,temp) ? T : Nil;
	if (temp);
	else {
	    temp = FIX((SI_Long)0L);
	    temp = NUM_LT(minimum_height,temp) ? T : Nil;
	}
	do_not_error_in_x11_create_pixmap_on_failed_allocation = temp;
	PUSH_SPECIAL(Do_not_error_in_x11_create_pixmap_on_failed_allocation,do_not_error_in_x11_create_pixmap_on_failed_allocation,
		0);
	  result = find_irregular_size_stored_raster(gensym_window,
		  minimum_width,minimum_height,bits_per_pixel);
	POP_SPECIAL();
	return result;
    }
	...
	if (stored_raster_qm)
	    ...
	    temp = create_stored_raster(gensym_window,
    ...
    Object gensym_window, minimum_width, minimum_height, bits_per_pixel;
{
  ...
  next_loop:
    ...
    bigger_stored_raster_qm = gensym_pop_store;
    ...
    Object minimum_height, bits_per_pixel;
{
	...
	raster_info = gensym_list_4(minimum_width,minimum_height,
		stored_raster_to_be_reclaimed,bits_per_pixel);
	if (IFIX(bits_per_pixel) <= (SI_Long)1L) {
	    temp = gensym_cons_1(raster_info,ISVREF(gensym_window,
		    (SI_Long)27L));
	    SVREF(gensym_window,FIX((SI_Long)27L)) = temp;
	}
	else {
    ...
    Object minimum_height, bits_per_pixel, made_exact_size_p;
{
	...
	raster_pools = IFIX(bits_per_pixel) <= (SI_Long)1L ? 
		ISVREF(gensym_window,(SI_Long)25L) : ISVREF(gensym_window,
		(SI_Long)26L);
	result_1 = gensym_cons_1(stored_raster_to_be_reclaimed,
		ISVREF(raster_pools,
...
{
    Object row_array, row, svref_arg_1;

    x_note_fn_call(56,161);
	...
	SVREF(row_array,FIX((SI_Long)2L)) = row;
    else {
	svref_arg_1 = ISVREF(row_array,(SI_Long)2L);
	SVREF(svref_arg_1,FIX((SI_Long)0L)) = row;
    }
    if (FIXNUM_LE(ISVREF(row,(SI_Long)1L),Maximum_in_place_array_size))
	SVREF(row,FIX((SI_Long)2L)) = Nil;
    else {
	svref_arg_1 = ISVREF(row,(SI_Long)2L);
	SVREF(svref_arg_1,FIX((SI_Long)0L)) = Nil;
    }
    ...
    Object tiled_raster;
{
  ...
  next_loop:
    ...
    row = FIXNUM_LE(ISVREF(tile_arrays,(SI_Long)1L),
	    ...
	    IFIX(Managed_array_index_offset)) : ISVREF(ISVREF(tile_arrays,
...
Object Region_and_tile_x_offset = UNBOUND;

Object Region_and_tile_y_offset = UNBOUND;
...
Object update_window varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,33);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,32);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,31);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,30);
	    ...
	    PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	      ...
	      PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		      28);
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,27);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,26);
						...
						PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,
						  ...
						  PUSH_SPECIAL(Drawing_on_window,drawing_on_window,
							...
							if (temp_1) {
							    ...
							    Qprinter)) {
							if (EQ(arg1,No_arg))
							    result = FUNCALL_0(SYMBOL_FUNCTION(function));
							else if (EQ(arg2,
								No_arg)) {
							    temp = 
								    SYMBOL_FUNCTION(function);
							    result = FUNCALL_1(temp,
								    arg1);
							}
							else if (EQ(arg3,
								No_arg)) {
...
void windows1_INIT()
{
    ...
    Object Qwindows1, Qregion_and_tile_y_offset, AB_package;
    Object Qregion_and_tile_x_offset, Qpixmap, Qreclaim_structure;
    Object Qoutstanding_pixmap_count, Qpixmap_structure_memory_usage;
    Object Qutilities2, Qpixmap_count, Qchain_of_available_pixmaps;
    ...
    Object Qtiled_raster_structure_memory_usage, Qtiled_raster_count;
    Object Qchain_of_available_tiled_rasters, string_constant_17;
    Object string_constant_16;
    Object Qhandler_for_printing_initialize_scratchpad_raster;
    Object Qnamed_dynamic_extent_description, Qscratchpad_raster;
    Object Qinitialize_gensym_window_after_connection_done;
    ...
    Object Qcolor_map_structure_memory_usage, Qcolor_map_count;
    Object Qchain_of_available_color_maps, string_constant_15;
    Object string_constant_14, list_constant_11, Qmenu_colors_sorted_by_hue;
    Object Qcompute_standard_gensym_colors, Kfuncall, list_constant_10;
    Object Qmenu_colors_sorted_alphabetically, list_constant_9, Qmenu_colors;
    Object list_constant_8, Qall_colors, list_constant_7;
    Object Qhandler_for_printing_ping_drawing, Qidentified_drawing_activity;
    Object Qoutstanding_identified_drawing_activity_count;
    Object Qidentified_drawing_activity_structure_memory_usage;
    Object Qidentified_drawing_activity_count;
    Object Qchain_of_available_identified_drawing_activitys;
    Object string_constant_13, string_constant_12;
    Object Qhandler_for_printing_force_graphics_on_window;
    Object Qreclaim_icp_port_entry_for_gensym_window, list_constant_6;
    ...
    Object Qcoordinate, Qon_window_with_drawing, list_constant_5;
    Object Qexcluded_dynamic_superiors, list_constant_4;
    Object Qon_window_without_drawing, Qworkspace_for_current_draw_document_qm;
    Object Qcurrent_draw_document_p, Qcurrent_draw_paper_p;
    Object Kdraw_as_late_as_possible, Qcurrent_drawing_priority;
    Object Qcurrent_drawing_transfer_mode;
    Object Qcurrent_gensym_window_serial_number;
    Object Qoutstanding_gensym_window_count;
    Object Qgensym_window_structure_memory_usage, Qgensym_window_count;
    Object Qchain_of_available_gensym_windows, string_constant_11;
    Object string_constant_10, Qstandard_colors;
    Object Qdefault_maximum_icon_bitmap_memory, Qdefault_maximum_icon_bitmaps;
    Object list_constant_3, list_constant_2, Qinitialize_v5_mode;
    Object list_constant_1, Qg2_has_v5_mode_windows_p;

    x_note_fn_call(56,171);
    SET_PACKAGE("AB");
    ...
    list_constant_1 = STATIC_LIST((SI_Long)2L,Kfuncall,Qinitialize_v5_mode);
    ...
    list_constant_3 = STATIC_LIST((SI_Long)14L,FIX((SI_Long)4L),
	    ...
	    FIX((SI_Long)400L));
    List_of_regular_raster_sizes = list_constant_3;
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83i0y1n83i0y8n8k1l8n0000001m1m83My83-ANy1n8y83-42y1l83-7Hyk3-2yk0k0");
    ...
    string_constant_11 = STATIC_STRING("1q83i0y8s83-Vsy09k9l");
    ...
    Qon_window_with_drawing = STATIC_SYMBOL("ON-WINDOW-WITH-DRAWING",
	    AB_package);
    list_constant_4 = STATIC_CONS(Qon_window_without_drawing,Qnil);
    Qexcluded_dynamic_superiors = 
	    STATIC_SYMBOL("EXCLUDED-DYNAMIC-SUPERIORS",AB_package);
    list_constant_5 = STATIC_CONS(Qon_window_with_drawing,Qnil);
    named_dynamic_extent_description = 
	    make_named_dynamic_extent_description(Qon_window_with_drawing,
	    Qwindows1,Nil,list_constant_4,Qnil,Qnil,Nil);
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83isy1o83isy83EJy8n8k1l83EJy0000001n1m8x83EJy1m83My83-Ady1n8y83-4Wy1q83--0y83-=Ey83Xdy83WHy83Iny83ppyktk0k0");
    ...
    Qidentified_drawing_activity_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83isy8s83-Y7y09k9l");
    clear_optimized_constants();
    ...
    list_constant_7 = STATIC_LIST((SI_Long)2L,Qtransparent,Qforeground);
    All_metacolors = list_constant_7;
    ...
    list_constant_8 = STATIC_LIST((SI_Long)3L,Kfuncall,
	    Qcompute_standard_gensym_colors,Qnil);
    record_system_variable(Qall_colors,Qwindows1,list_constant_8,Qnil,Qnil,
	    Qnil,Qnil);
    Qmenu_colors = STATIC_SYMBOL("MENU-COLORS",AB_package);
    SET_SYMBOL_VALUE_LOCATION(Qmenu_colors,Menu_colors);
    list_constant_9 = STATIC_LIST((SI_Long)3L,Kfuncall,
	    Qcompute_standard_gensym_colors,Qt);
    record_system_variable(Qmenu_colors,Qwindows1,list_constant_9,Qnil,
	    Qnil,Qnil,Qnil);
    ...
    list_constant_10 = STATIC_LIST((SI_Long)4L,Kfuncall,
    ...
    list_constant_11 = STATIC_LIST((SI_Long)4L,Kfuncall,
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83g4y1n83g4y8n8k1l8n0000001l1n8y83-3Gy1p83sKy83sNy83sOy83sLy83sMyksk0k0");
    ...
    string_constant_15 = STATIC_STRING("1q83g4y8s83-N5y09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83nvy1n83nvy8n8k1l8n0000001l1m83My83-BEykqk0k0");
    ...
    string_constant_17 = STATIC_STRING("1q83nvy8s83-rNy09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83lay1n83lay8n8k1l8n0000001m1n8y83-57y1o83-9+y83-8wy83-8vy83-8xy1m83My83-Anykpk0k0");
    ...
    string_constant_19 = STATIC_STRING("1q83lay8s83-hmy09k9l");
    clear_optimized_constants();
