...
Object Chain_of_available_backward_chaining_displays = UNBOUND;

Object Backward_chaining_display_count = UNBOUND;
    ...
    Object backward_chaining_display;
{
    ...
    svref_new_value = Chain_of_available_backward_chaining_displays;
    SVREF(backward_chaining_display,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_backward_chaining_displays = backward_chaining_display;
    return VALUES_1(Nil);
}
...
Object make_permanent_backward_chaining_display_structure_internal()
{
    ...
    Object backward_chaining_display_count_new_value;
    ...
    backward_chaining_display_count_new_value = 
	    FIXNUM_ADD1(Backward_chaining_display_count);
    ...
    Object variable;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(display,Nil);
	if (ab_loopvar__1)
    ...
    Object variable;
{
	...
	goto next_loop;
      end_loop:;
	return reclaim_gensym_list_1(displays_to_delete);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object variable;
{
	...
	reclaim_gensym_list_1(forward_chaining);
    }
	...
	reclaim_gensym_list_1(backward_chaining);
    }
    ...
    Object variable;
{
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(forward_chaining_rules_to_show);
    ...
    Object variable;
{
	...
	if (specific_formula_qm)
	    frames_to_show = gensym_cons_1(make_attributes_table(6,
		    variable,Nil,Nil,Nil,Nil,list_constant),Nil);
	else if (generic_formulas)
	    frames_to_show = gensym_cons_1(make_short_representation(3,
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    ab_loopvar__2 = gensym_cons_1(make_short_representation(3,
	...
	reclaim_gensym_tree_1(backward_chaining_link_and_objects);
...
void explain_INIT()
{
    ...
    Object Qbackward_chaining_display_count;
    Object Qchain_of_available_backward_chaining_displays, string_constant_2;
    ...
    Object Qbackward_chaining_displays;
    ...
    string_constant_1 = 
	    STATIC_STRING("43Dy8m83fOy1o83fOy836my8n8k1l836my0000001m1m8x836my1n8y83-5Jy1l83qNyknk0k0");
    ...
    Qbackward_chaining_display_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_2 = STATIC_STRING("1q83fOy8s83-KYy09k9l");
