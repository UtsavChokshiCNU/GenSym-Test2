...
Object Unix_time_offset_was_computed_qm = UNBOUND;

Object Unix_time_offset_for_encoding = UNBOUND;
...
Object compute_unix_time_offset()
{
	...
	temp_1 = temp_1 + 86400.0 * (double)IFIX(encode_unix_date(day,
		month,year));
    ...
    Object second_1, minute, hour, day, month, year;
{
	...
	if (arg == arg_1 &&  !inline_nanp_for_comparison(arg) &&  
		!inline_nanp_for_comparison(arg_1)) {
	    temp_1 = encode_unix_time_after_failure(second_1,minute,hour,
		    day,month,year);
...
Object Year_at_compilation_time = UNBOUND;
...
Object Copyright_boilerplate_lines_of_text_1 = UNBOUND;
...
Object Copyright_boilerplate_lines_of_text_2 = UNBOUND;
...
void times_INIT()
{
    Object list_constant_10, Qtimes, Qcopyright_boilerplate_lines_of_text_2;
    Object Kfuncall, AB_package, list_constant_5, list_constant_9;
    Object list_constant_8, list_constant_7, list_constant_6;
    Object Qcopyright_boilerplate_lines_of_text_1, Qseconds, Qminutes, Qhours;
    Object Qdays, Qweeks, Qminute, Qhour, Qday, Qweek, Qseconds_per_day;
    Object list_constant_4, Qdays_before_this_month, float_constant;
    Object Qseconds_from_1900_to_1970;
	...
	Year_at_compilation_time = FIX((SI_Long)2017L);
