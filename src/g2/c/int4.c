    ...
    Object item;
{
	...
	PUSH_SPECIAL(Deregister_but_do_not_remove_from_table_p,deregister_but_do_not_remove_from_table_p,
		0);
    ...
    Object icp_socket;
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, temp_2, index_list_tail, next_index_list, index_1;
    ...
    temp = Nil;
    SVREF(icp_socket,FIX((SI_Long)47L)) = temp;
