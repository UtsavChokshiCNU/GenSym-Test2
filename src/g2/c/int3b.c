...
Object Icp_port_for_reclaim = UNBOUND;

Object Deregister_and_register_item_p = UNBOUND;

Object Deregister_but_do_not_remove_from_table_p = UNBOUND;
    ...
    Object icp_object_qm, index_1, original_index_space_name, icp_port, localp;
{
	...
	PUSH_SPECIAL(Icp_port_for_reclaim,icp_port_for_reclaim,0);
...
Object handle_icp_deregister_icp_objects()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
		...
		handle_icp_deregister_icp_objects__body(name_of_corresponding_icp_object_index_space,
	      ...
	      POP_SPECIAL();
	      result_of_read = 
		      reclaim_gensym_list_1(corresponding_icp_object_index_list);
	      if (tracep)
		  emit_icp_read_trace(Nil,byte_count_before,
			  instantaneous_icp_reader_byte_count(),
...
Object Gsi_application_name = UNBOUND;

Object Tcp_listener_port_number = UNBOUND;

Object Name_for_local_home = UNBOUND;

Object Icp_version_info_alist = UNBOUND;

Object Icp_protocol_version = UNBOUND;
...
static Object Qg2_time_at_start;   /* g2-time-at-start */

static Object Qg2_time_at_start_as_text_string;  /* g2-time-at-start-as-text-string */
    ...
    Object icp_socket;
{
	...
	if (text_string_qm) {
	    ...
	    gensym_push_modify_macro_arg = gensym_cons_1(Qg2_time_at_start,
		    managed_float);
...
static Object Qlocal_host_name;    /* local-host-name */
...
static Object Qtcp_listener_port_number;  /* tcp-listener-port-number */
...
static Object Qname_for_local_home;  /* name-for-local-home */
...
Object Cached_local_icp_version_info = UNBOUND;
...
Object compute_local_icp_version_info()
{
  ...
  next_loop:
	...
	if (STRINGP(value)) {
	    ...
	    temp_2 = value;
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(temp,temp_2),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
static Object Qicp_protocol_version;  /* icp-protocol-version */
    ...
    Object icp_socket;
{
    ...
    svref_new_value = gensym_cons_1(gensym_cons_1(Qicp_protocol_version,
	    FIX(icp_version)),ISVREF(icp_socket,(SI_Long)19L));
    SVREF(icp_socket,FIX((SI_Long)19L)) = svref_new_value;
    return VALUES_1(FIX(icp_version));
}

Object Initial_icp_version_info_enabled_p = UNBOUND;

Object Write_initial_icp_version_info_p = UNBOUND;
    ...
    Object icp_socket, connect_p;
{
    ...
    PUSH_SPECIAL(Gsi_application_name,gsi_application_name,15);
      disable_resumability =  ! !TRUEP(ISVREF(icp_socket,(SI_Long)53L)) ? 
	      T : Nil;
      PUSH_SPECIAL(Disable_resumability,disable_resumability,14);
	name_for_local_home_1 = name_for_local_home();
	PUSH_SPECIAL(Name_for_local_home,name_for_local_home_1,13);
	  ...
	  if (Initial_icp_version_info_enabled_p && (info_initial_p || 
		...
		PUSH_SPECIAL(Current_icp_socket,current_icp_socket,11);
		  temp = IFIX(ISVREF(Current_icp_socket,(SI_Long)22L)) >= 
		  ...
		  PUSH_SPECIAL(Disable_resumability,disable_resumability,10);
				...
				PUSH_SPECIAL(Current_write_icp_byte_position,current_write_icp_byte_position,
				  ...
				  PUSH_SPECIAL(Number_of_icp_bytes_in_message_group,number_of_icp_bytes_in_message_group,
				    ...
				    PUSH_SPECIAL(Writing_icp_message_group,writing_icp_message_group,
					  ...
					  PUSH_SPECIAL(Write_initial_icp_version_info_p,write_initial_icp_version_info_p,
						  0);
    ...
    Object icp_socket, handler_name;
{
	...
	if ( !TRUEP(ISVREF(icp_socket,(SI_Long)19L))) {
	    svref_new_value = 
		    gensym_cons_1(gensym_cons_1(Qno_icp_version_info,Nil),Nil);
	    SVREF(icp_socket,FIX((SI_Long)19L)) = svref_new_value;
	}
    }
    return VALUES_1(Nil);
    ...
    Object icp_socket, value, symbol;
{
    ...
    if ( !TRUEP(ISVREF(icp_socket,(SI_Long)19L))) {
	temp = gensym_cons_1(gensym_cons_1(Qno_icp_version_info,Nil),Nil);
	...
	temp_1 = ISVREF(icp_socket,(SI_Long)19L);
	cdr_new_value = gensym_cons_1(gensym_cons_1(symbol,value),CDR(temp_1));
...
static Object Qdisable_resumability;  /* disable-resumability */
    ...
    Object total_number_of_bytes_init;
{
	...
	if ((SI_Long)0L == first_byte)
	  ...
	  next_loop:
	    ...
	    if (info) {
		ab_loopvar__2 = gensym_cons_1(info,Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
		    ab_loopvar_ = ab_loopvar__2;
    ...
    Object type_code, byte_count, alist;
{
	...
	temp = gensym_cons_1(symbol,read_icp_fixnum());
    else if (EQ(type,Qgensym_string))
	temp = gensym_cons_1(symbol,read_icp_gensym_string());
    else if (EQ(type,Qwide_string))
	temp = gensym_cons_1(symbol,read_icp_wide_string());
    else if (EQ(type,Qsymbol))
	temp = gensym_cons_1(symbol,intern_gensym_string(1,
    ...
    Object version_info;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(version_info);
    return VALUES_1(Nil);
}
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
		  ...
		  if (ISVREF(Current_icp_socket,(SI_Long)19L)) {
		      ...
		      svref_arg_1 = Current_icp_socket;
		      result_of_read = 
			      gensym_cons_1(gensym_cons_1(Qno_icp_version_info,
			      Nil),Nil);
...
Object read_icp_float()
{
    ...
    Object expon, sign, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float, temp_4;
    Object result_of_read, resumable_icp_state_1, icp_suspend_1, top, value;
    double temp_1, temp_2, temp_3, aref_new_value;
    Declare_special(1);
    Object result;

    x_note_fn_call(53,78);
    if (Disable_resumability) {
	if (Icp_read_trace_cutoff_level_qm) {
	    tracep = EQ(Icp_read_trace_cutoff_level_qm,T) ? T : Nil;
	    if (tracep);
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
		  ...
		  temp_1 = DOUBLE_FLOAT_TO_DOUBLE(expon);
		  temp_2 = DOUBLE_FLOAT_TO_DOUBLE(signif);
		  temp_3 = 
			  DOUBLE_FLOAT_TO_DOUBLE(Most_positive_fixnum32_plus_one_as_float);
		  temp_4 = expt(FIX((SI_Long)10L),
			  DOUBLE_TO_DOUBLE_FLOAT(temp_1 + temp_2 / temp_3));
		  temp_3 = DOUBLE_FLOAT_TO_DOUBLE(temp_4);
		  ...
		  temp_4 = expt(FIX((SI_Long)10L),
			  DOUBLE_TO_DOUBLE_FLOAT(temp_1 + temp_2 / temp_3));
		  aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_4);
	      }
...
Object read_icp_managed_double_float()
{
    ...
    Object amf_result, incff_1_arg, new_float, b0, b1, b2, b3, result_of_read;
    ...
    Object s_expression;
{
	...
	reclaim_gensym_list_1(s_expression);
	return VALUES_1(Qnil);
    }
...
Object read_icp_s_expression_for_remote_eval()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    next_loop:
		  ...
		  goto end_loop;
	      ab_loopvar__2 = gensym_cons_1(read_icp_sexp_element(),Nil);
	      if (ab_loopvar__1)
		  M_CDR(ab_loopvar__1) = ab_loopvar__2;
	      else
		  ab_loopvar_ = ab_loopvar__2;
...
static Object Qdead_connection;    /* dead-connection */

/* DO-I-AM-ALIVE-PROCESSING */
Object do_i_am_alive_processing(icp_socket)
    Object icp_socket;
{
    Object i_am_alive_info, temp, temp_1;
    SI_Long gensymed_symbol, gensymed_symbol_1;
    char temp_2;

    x_note_fn_call(53,100);
    i_am_alive_info = ISVREF(icp_socket,(SI_Long)24L);
    if (i_am_alive_info && ISVREF(i_am_alive_info,(SI_Long)1L)) {
	...
	temp_1 = dead_connection_timeout_from_system_table();
	temp_2 = FIXNUM_GT(temp,FIXNUM_TIMES(temp_1,
		Fixnum_time_units_per_second));
    }
    else
	temp_2 = TRUEP(Nil);
    if (temp_2) {
	if (disconnect_dead_connections_qm_from_system_table())
	    shutdown_icp_socket_connection(2,icp_socket,Qdead_connection);
...
Object Sending_i_am_alive_qm = UNBOUND;

Object I_am_alive_send_time_interval_in_seconds = UNBOUND;

Object I_am_alive_send_time_interval_in_seconds_as_float = UNBOUND;

Object I_am_alive_send_time_interval = UNBOUND;
    ...
    Object icp_socket, i_am_alive_info;
{
    ...
    temp = Nil;
    SVREF(icp_socket,FIX((SI_Long)51L)) = temp;
	...
	PUSH_SPECIAL(Sending_i_am_alive_qm,sending_i_am_alive_qm,12);
	  current_icp_port = ISVREF(icp_socket,(SI_Long)4L);
    ...
    do_i_am_alive_processing(icp_socket);
    ...
    Object icp_socket, i_am_alive_info;
{
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qsend_i_am_alive_message);
    ...
    Object message_group_id;
{
    ...
    Object incff_1_arg, decff_1_arg, gensym_cons;

    x_note_fn_call(53,106);
	...
	if (message_group_ids_and_byte_counts_qm) {
	  ...
	  next_loop:
		...
		if (message_group_ids_and_byte_counts_qm &&  !((SI_Long)0L 
		    ...
		    gensym_cons = message_group_ids_and_byte_counts_qm;
		  next_loop_2:
		    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		    if (EQ(gensym_cons,trailing_entry_cons))
			goto end_1;
		...
		temp = Available_gensym_conses;
		M_CDR(trailing_entry_cons) = temp;
		Available_gensym_conses = message_group_ids_and_byte_counts_qm;
		goto end_loop;
	    }
...
Object Local_host_name = UNBOUND;
...
Object warn_disallowed_icp_listener_connections varargs_1(int, n)
{
  ...
  next_loop_1:
	...
	Refused_icp_listener_connections = gensym_cons_1(icp_socket,
...
void int3b_INIT()
{
    Object AB_package, list_constant_48, Qint3b, Qget_unix_host_name, Kfuncall;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, float_constant_1;
    Object Qhandling_solitary_i_am_alive_qm, Qsending_i_am_alive_qm;
    Object list_constant_47, Qcached_local_icp_version_info, list_constant_46;
    ...
    Object list_constant_12, list_constant_11, list_constant_4;
    Object Qmessage_board_enabled, Qoperator_logbook_enabled;
    Object Qsupoorts_get_and_set_scroll_position_in_grid_view;
    Object Qsupports_update_color_in_label, Qsupports_update_color_in_list_box;
    Object Qsupports_color_settings_in_toggle_button;
    Object Qsupports_border_settings_in_label;
    Object Qsupports_background_color_in_custom_dialogs;
    Object Qsupports_update_color_in_push_button, Qsupports_font_in_grid_view;
    Object Qsupports_dialog_component_with_font, list_constant_10;
    Object Qg2_machine_type, Qg2_operating_system;
    Object Qsupports_transparent_color_index, list_constant_8, list_constant_9;
    ...
    Object Qicp_value_reclaimer, Qreclaim_icp_list, Qicp_port_for_reclaim;

    x_note_fn_call(53,129);
    SET_PACKAGE("AB");
    ...
    Qsupports_update_color_in_push_button = 
    ...
    list_constant_42 = STATIC_LIST_STAR((SI_Long)3L,FIX((SI_Long)37L),
	    Qoperator_logbook_enabled,list_constant_4);
    ...
    list_constant_11 = STATIC_LIST_STAR((SI_Long)3L,FIX((SI_Long)38L),
	    Qmessage_board_enabled,list_constant_4);
    ...
    list_constant_44 = STATIC_LIST_STAR((SI_Long)32L,list_constant_12,
	    ...
	    list_constant_43);
    Icp_version_info_alist = list_constant_44;
    ...
    Icp_acknowledge_version_info_alist = list_constant_46;
    ...
    Qdead_connection = STATIC_SYMBOL("DEAD-CONNECTION",AB_package);
    ...
    list_constant_48 = STATIC_LIST((SI_Long)2L,Kfuncall,Qget_unix_host_name);
    record_system_variable(Qlocal_host_name,Qint3b,list_constant_48,Qnil,
	    Qnil,Qnil,Qnil);
