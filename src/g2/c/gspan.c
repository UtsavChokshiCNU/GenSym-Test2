...
Object Proceed_with_edit = UNBOUND;
    ...
    Object external_simulation_definition, output_vector, initializing_qm;
{
	...
	if ( !TRUEP(initializing_qm)) {
	    ...
	    reclaim_gensym_list_1(designations_to_remove);
	    return reclaim_gensym_list_1(designations_to_add);
	}
	else
	    return VALUES_1(Nil);
    }
    ...
    Object external_simulation_definition;
{
  ...
  end_1:;
	...
	inline_funcall_1(method_function_qm,frame);
    proceed_with_edit = T;
    PUSH_SPECIAL(Proceed_with_edit,proceed_with_edit,0);
...
Object install_externally_simulated_entity varargs_1(int, n)
{
  ...
  next_loop:
	...
	if (external_simulation_definition_being_edited_qm) {
	    ...
	    reclaim_gensym_list_1(designations);
	}
	return VALUES_0();
    }
    goto next_loop;
    ...
    Object incremental_qm;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_2, cdr_new_value, temp, new_cons;
    Object scope_conses, ab_loopvar_, ab_loopvar__1, entity, super_class;
    Object class_description, external_simulation_definition_qm;
    Object super_class_designations;
    char temp_1;
    Declare_special(1);
    Object result;

    x_note_fn_call(220,12);
    designation = Nil;
    ab_loop_list_ = designations;
    attribute = Nil;
  next_loop:
  ...
  end_loop:;
	...
	if (temp_1) {
	    temp = ISVREF(external_simulation_definition_qm,(SI_Long)23L);
	    super_class_designations = get_attribute_designations(CAR(temp));
	    scope_conses = Scope_conses;
	    ab_loopvar_ = Nil;
	    ab_loopvar__1 = Nil;
	    entity = Nil;
	    ...
	    end_loop_8:;
	    POP_SPECIAL();
	    reclaim_gensym_list_1(super_class_designations);
	    goto end_2;
	}
	goto next_loop_6;
      end_loop_6:
    ...
    Object second_designation_or_designations;
{
	...
	if (more_than_one_designation_in_vector_p(second_designation_or_designations)) 
	    ...
	    if ( !TRUEP(member_equal(designation,
		    second_designation_or_designations)))
		missing_designations = gensym_cons_1(designation,
	...
	if (more_than_one_designation_in_vector_p(second_designation_or_designations)) 
	    ...
	    if ( !TRUEP(member_equal(first_designation_or_designations,
		    second_designation_or_designations)))
		missing_designations = 
			gensym_cons_1(first_designation_or_designations,
			missing_designations);
	}
	else if (at_least_one_designation_in_vector_p(second_designation_or_designations)) 
		    {
...
{
    x_note_fn_call(220,16);
    if (more_than_one_designation_in_vector_p(designation_or_designations))
	return copy_list_using_gensym_conses_1(CDR(designation_or_designations));
    else if (at_least_one_designation_in_vector_p(designation_or_designations))
	return gensym_cons_1(designation_or_designations,Nil);
    else
	return VALUES_1(Qnil);
}
    ...
    Object variable;
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(external_simulation_definitions_for_variable_qm);
	return VALUES_1(Qnil);
    }
    else
    ...
    Object variable, attribute, entity, external_simulation_definitions_so_far;
{
	...
	if (memq_function(external_simulation_definition_for_entity,
	    ...
	    external_simulation_definitions_so_far = 
		    gensym_cons_1(external_simulation_definition_for_entity,
		    external_simulation_definitions_so_far);
    }
    ...
    Object variable, designation, entity, external_simulation_definition;
{
    ...
    x_note_fn_call(220,21);
    alist = 
	    gensym_cons_1(gensym_cons_1(ISVREF(external_simulation_definition,
...
Object Output_vector_for_object = UNBOUND;

Object The_type_description_of_external_simulation_object = UNBOUND;

Object Chain_of_available_external_simulation_objects = UNBOUND;

Object External_simulation_object_count = UNBOUND;
    ...
    Object external_simulation_object;
{
    ...
    x_note_fn_call(220,25);
    inline_note_reclaim_cons(external_simulation_object,Nil);
    svref_new_value = Chain_of_available_external_simulation_objects;
    SVREF(external_simulation_object,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_external_simulation_objects = 
	    external_simulation_object;
    return VALUES_1(Nil);
}
...
Object make_permanent_external_simulation_object_structure_internal()
{
    ...
    Object external_simulation_object_count_new_value;
    Object defstruct_g2_external_simulation_object_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(220,27);
    def_structure_external_simulation_object_variable = Nil;
    external_simulation_object_count_new_value = 
	    FIXNUM_ADD1(External_simulation_object_count);
...
Object handle_icp_end_simulation_output_vector_for_object__body()
{
    ...
    PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,3);
      PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
	      2);
	if (Current_model_runtime_info_qm) {
		...
		PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
		  ...
		  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
		    ...
		    reclaim_gensym_tree_1(alist);
		    reclaim_gensym_list_1(designations);
		    reclaim_gensym_list_1(Output_vector_for_object);
...
Object read_icp_returned_external_simulation_object()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	      ...
	      PUSH_SPECIAL(Current_icp_port,current_icp_port,1);
    ...
    Object external_simulation_definition, entity;
{
	...
	PUSH_SPECIAL(Current_simulation_runtime_structure,current_simulation_runtime_structure,
		1);
	  temp = ISVREF(external_simulation_definition,(SI_Long)24L);
	  designations = get_attribute_designations(CAR(temp));
	  initializing_simulator_qm = T;
	  PUSH_SPECIAL(Initializing_simulator_qm,initializing_simulator_qm,0);
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    ab_loopvar__2 = 
		    gensym_cons_1(sim_eval_variable_for_designation(designation,
		    alist),Nil);
	    if (ab_loopvar__1)
	  ...
	  end_1:;
	    ...
	    reclaim_gensym_tree_1(alist);
	    reclaim_gensym_list_1(designations);
	    reclaim_gensym_list_1(initialization_values);
	    result = VALUES_1(temp);
	  POP_SPECIAL();
	POP_SPECIAL();
      POP_SPECIAL();
    ...
    Object externally_simulated_entity;
{
    ...
    x_note_fn_call(220,85);
    scope_conses = Scope_conses;
    ab_node_stack_ = Nil;
    ab_current_node_ = Nil;
    gensymed_symbol = ISVREF(externally_simulated_entity,(SI_Long)14L);
    ...
    Object connection, externally_simulated_entity, output_connection_qm;
{
  ...
  end_loop:;
    ...
    reclaim_gensym_tree_1(opposite_end_info_triples);
    return reclaim_gensym_tree_1(connection_paths);
}
    ...
    Object connection, entity;
{
    ...
    x_note_fn_call(220,87);
    entities = Nil;
    connections = Nil;
    current_connection_path = Nil;
    PUSH_SPECIAL(Current_connection_path,current_connection_path,4);
      connections_in_connection_paths = Nil;
      PUSH_SPECIAL(Connections_in_connection_paths,connections_in_connection_paths,
	      3);
    ...
    Object connection_path;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = external_simulation_object_for_connection_qm ? 
	    gensym_cons_1(external_simulation_object_for_connection_qm,
	    Nil) : Nil;
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
  ...
  end_1:;
	...
	send_icp_connection_info(input_end_object,output_end_object,
		...
		FIX((SI_Long)-1L));
    return reclaim_gensym_list_1(externally_simulated_connections_in_connection_path);
}

/* HANDLE-UPDATES-TO-EXTERNALLY-SIMULATED-ENTITIES */
Object handle_updates_to_externally_simulated_entities()
{
    x_note_fn_call(220,90);
    return VALUES_1(Nil);
}
    ...
    Object external_simulation_definition, object;
{
	...
	end_1:;
	  if (external_simulator_input_values_ok_qm(input_values,object,
	      ...
	      temp = Nil;
	  reclaim_gensym_tree_1(alist);
	  reclaim_gensym_list_1(input_value_designations);
	  reclaim_gensym_list_1(input_values);
	  reclaim_gensym_list_1(message_keywords);
	  result = VALUES_1(temp);
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    ...
    Object tagname;
{
	...
	if (Current_model_runtime_info_qm) {
		...
		temp_1 = 
			gensym_cons_1(convert_speedup_tagname_to_designation(tagname),
			Nil);
		M_CDR(temp) = temp_1;
		temp = Current_model_runtime_info_qm;
...
Object define_speedup_end_tagnames()
{
    ...
    x_note_fn_call(220,107);
    result = get_model_runtime_info_given_icp_socket(Current_icp_socket);
    MVS_2(result,current_model_runtime_info_lexical_qm,
	    current_model_definition_lexical_qm);
    current_model_runtime_info_qm = current_model_runtime_info_lexical_qm;
    current_model_definition_qm = current_model_definition_lexical_qm;
    PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,13);
      PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
	      12);
	if (Current_model_runtime_info_qm) {
	    temp = Current_model_runtime_info_qm;
		  ...
		  next_loop:
			...
			if ((simulation_info_qm ? 
				...
				temp = 
					...
					(SI_Long)38L);
				temp_3 = 
					gensym_cons_1(new_variable_simulation_runtime_structure,
					Nil);
				M_CDR(temp) = temp_3;
				temp = Current_model_runtime_info_qm;
				temp_1 = 
...
Object send_speedup_input()
{
    ...
    x_note_fn_call(220,115);
    if (current_vector_to_external_simulator()) {
	current_icp_port = ISVREF(ISVREF(Current_model_runtime_info_qm,
		(SI_Long)14L),(SI_Long)4L);
	PUSH_SPECIAL(Current_icp_port,current_icp_port,15);
	  current_icp_socket = ISVREF(Current_icp_port,(SI_Long)2L);
	  PUSH_SPECIAL(Current_icp_socket,current_icp_socket,14);
	    temp = IFIX(ISVREF(Current_icp_socket,(SI_Long)22L)) >= 
		    (SI_Long)17L ? ISVREF(Current_icp_socket,(SI_Long)53L) 
		    : Nil;
	    if (temp);
		...
		temp = EQ(ISVREF(Current_icp_socket,(SI_Long)25L),
			Qtelewindows) ? T : Nil;
	    disable_resumability = temp;
	    PUSH_SPECIAL(Disable_resumability,disable_resumability,13);
	      number_of_icp_bytes_for_message_series = FIX((SI_Long)0L);
	      PUSH_SPECIAL(Number_of_icp_bytes_for_message_series,number_of_icp_bytes_for_message_series,
		      12);
		icp_buffers_for_message_group = Nil;
		  ...
		  PUSH_SPECIAL(Icp_buffer_of_start_of_message_series_qm,icp_buffer_of_start_of_message_series_qm,
		    ...
		    PUSH_SPECIAL(Icp_byte_position_of_start_of_message_series_qm,icp_byte_position_of_start_of_message_series_qm,
		      ...
		      PUSH_SPECIAL(Number_of_icp_bytes_to_fill_buffer,number_of_icp_bytes_to_fill_buffer,
			      8);
			current_icp_buffer = Nil;
			PUSH_SPECIAL(Current_icp_buffer,current_icp_buffer,7);
			  current_write_icp_byte_position = Nil;
			  PUSH_SPECIAL(Current_write_icp_byte_position,current_write_icp_byte_position,
				  6);
			    number_of_icp_bytes_in_message_group = 
...
Object shutdown_speedup_simulation()
{
    ...
    PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,1);
      PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
	      0);
	if (Current_model_runtime_info_qm) {
	    reclaim_gensym_list_1(ISVREF(Current_model_runtime_info_qm,
		    (SI_Long)37L));
	    svref_arg_1 = Current_model_runtime_info_qm;
...
Object Speedup_tagname_string_index = UNBOUND;

Object Speedup_tagname_string = UNBOUND;
    ...
    Object speedup_tagname_string;
{
    ...
    x_note_fn_call(220,117);
    PUSH_SPECIAL(Speedup_tagname_string,speedup_tagname_string,1);
      speedup_tagname_string_index = FIX((SI_Long)0L);
      PUSH_SPECIAL(Speedup_tagname_string_index,speedup_tagname_string_index,
	      0);
...
Object parse_after_attribute_for_speedup_tagname()
{
	...
	return gensym_cons_1(name_or_attribute_designation,Nil);
}
...
void gspan_INIT()
{
    ...
    Object Qexternal_simulation_object_count;
    Object Qchain_of_available_external_simulation_objects, string_constant_40;
    ...
    Object Qoutput_vector_for_object, Qclasses_which_define, Qcleanup;
    ...
    Object Qproceed_with_edit, string_constant_33, string_constant_32;
    Object string_constant_31, list_constant_1, Qcreate_icon_description;
    ...
    Object string_constant_21, Qentity, Qitem;

    x_note_fn_call(220,129);
    SET_PACKAGE("AB");
    ...
    string_constant_28 = 
	    STATIC_STRING("n class block000004z8r83BBy83BBy836oy836oy00001o1l8o1l8l1l8z1m8p833Vy000004z8r83VTy83VTy836oy836oy00001n1l8o1l8l1n8p83DNy83Gy000");
    string_constant_29 = 
	    STATIC_STRING("004z8r83SJy83SJy836oy836oy00001n1l8o1l8l1n8p83Aly83Gy000004z8r83XTy83XTy836oy836oy00001n1l8o1l8l1n8p83Aky83Gy000004z8r83SIy83SIy");
    string_constant_30 = 
    ...
    string_constant_33 = 
	    STATIC_STRING("y1q83BBy08o8l8z1m8p833Vy1p83VTy08o8l1n8p83DNy83Gy1p83SJy08o8l1n8p83Aly83Gy1p83XTy08o8l1n8p83Aky83Gy1p83SIy08o8l1n8p83Aly83Gy");
    ...
    string_constant_34 = 
	    STATIC_STRING("1v1m83Aky83-K2y1o83Aky1n83-K2y1m9k83vy83Aky1nmln9l1m83Aly83Aky1m83Aly1m9k83Zy1n83-K2y1p1m9k9m83*my1m9k83-Ty1m9k9m83-Gy1nlm1mop1n");
    string_constant_35 = 
	    STATIC_STRING("83-K2y1o1m9k9m83*my1m9k83-Ty83-K2y1nlmo1m83DNy83-b6y1m83DNy1m9k83Zy1m83-b6y83-b5y1o83-b6y1n83-b5y1m9k83vy83-b5y1nmln9l1m83-b5y83");
    ...
    mutate_global_property(Qkeyword_strings_or_none,
	    SYMBOL_FUNCTION(Qwrite_symbol_from_slot),Qslot_value_writer);
    string_constant_37 = 
	    STATIC_STRING("1s1m83-*Oy83-6y1m83-7Oy83-6y1m83-EXy83Sy1m83wMy83-Uy1m83iay83-Uy1n834vy1p1m9k83bcy1m9k83Rdy83iay1m9k83Y+y83-EXy1n83bcynp1n834vy1");
    string_constant_38 = 
	    STATIC_STRING("o1m9k83-p*y1m9k83-uwy1m9k839ny83wMy1m83-uxyo1m834vy1m9k83Zy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_39 = 
	    STATIC_STRING("43Dy8m83hJy1n83hJy8n8k1l8n0000000knk0k0");
    ...
    Qexternal_simulation_object_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_40 = STATIC_STRING("1q83hJy8s83-TLy09k9l");
    clear_optimized_constants();
