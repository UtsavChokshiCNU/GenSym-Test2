...
Object Han_interpretation_mode = UNBOUND;
...
Object Gensym_code_for_linebreak = UNBOUND;

Object Gensym_char_or_code_for_linebreak = UNBOUND;

Object Gensym_esc_for_linebreak_qm = UNBOUND;

Object Gensym_code_for_paragraph_break = UNBOUND;

Object Gensym_char_or_code_for_paragraph_break = UNBOUND;

Object Gensym_esc_for_paragraph_break_qm = UNBOUND;

Object Gensym_code_for_capital_ligature_oe = UNBOUND;

Object Gensym_char_or_code_for_capital_ligature_oe = UNBOUND;

Object Gensym_esc_for_capital_ligature_oe_qm = UNBOUND;

Object Gensym_code_for_small_ligature_oe = UNBOUND;

Object Gensym_char_or_code_for_small_ligature_oe = UNBOUND;

Object Gensym_esc_for_small_ligature_oe_qm = UNBOUND;

Object Gensym_code_for_bullet = UNBOUND;

Object Gensym_char_or_code_for_bullet = UNBOUND;

Object Gensym_esc_for_bullet_qm = UNBOUND;

Object Gensym_code_for_small_letter_f_with_hook = UNBOUND;

Object Gensym_char_or_code_for_small_letter_f_with_hook = UNBOUND;

Object Gensym_esc_for_small_letter_f_with_hook_qm = UNBOUND;

Object Gensym_code_for_trade_mark_sign = UNBOUND;

Object Gensym_char_or_code_for_trade_mark_sign = UNBOUND;

Object Gensym_esc_for_trade_mark_sign_qm = UNBOUND;

Object Current_extended_utf_g_low_half_character_qm = UNBOUND;
...
void characters2_INIT()
{
	...
	if ( !(gensym_full_row == IFIX(Invalid_gensym_full_row))) {
	    gensymed_symbol = gensym_full_row << (SI_Long)8L;
	    gensymed_symbol_1 = (SI_Long)255L & unicode;
	    Gensym_code_for_bullet = FIX(gensymed_symbol + gensymed_symbol_1);
	}
	else
	...
	if ( !(gensym_full_row == IFIX(Invalid_gensym_full_row))) {
	    gensymed_symbol = gensym_full_row << (SI_Long)8L;
	    gensymed_symbol_1 = (SI_Long)255L & unicode;
	    Gensym_code_for_small_letter_f_with_hook = FIX(gensymed_symbol 
		    + gensymed_symbol_1);
	}
	else
