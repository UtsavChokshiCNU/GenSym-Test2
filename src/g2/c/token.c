    ...
    Object list_1;
{
  ...
  next_loop:
    ...
    new_list = gensym_cons_1(element,new_list);
    goto next_loop;
  end_loop:
    temp = new_list;
    goto end_1;
...
Object Chain_of_available_lexing_tables = UNBOUND;

Object Lexing_table_count = UNBOUND;
    ...
    Object lexing_table;
{
    ...
    svref_new_value = Chain_of_available_lexing_tables;
    SVREF(lexing_table,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_lexing_tables = lexing_table;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_lexing_table_variable, lexing_table_count_new_value;
    ...
    lexing_table_count_new_value = FIXNUM_ADD1(Lexing_table_count);
    Lexing_table_count = lexing_table_count_new_value;
...
Object Chain_of_available_internal_tokens = UNBOUND;

Object Internal_token_count = UNBOUND;
    ...
    Object internal_token;
{
    ...
    svref_new_value = Chain_of_available_internal_tokens;
    SVREF(internal_token,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_internal_tokens = internal_token;
    return VALUES_1(Nil);
}
...
Object make_permanent_internal_token_structure_internal()
{
    ...
    Object internal_token_count_new_value;
    ...
    internal_token_count_new_value = FIXNUM_ADD1(Internal_token_count);
    Internal_token_count = internal_token_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_internal_token_variable, svref_new_value;
    ...
    svref_new_value = 
	    SYMBOL_FUNCTION(Qalphabet_normalized_symbol_from_text_string);
    SVREF(def_structure_internal_token_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
...
Object Chain_of_available_fsm_states = UNBOUND;

Object Fsm_state_count = UNBOUND;
    ...
    Object fsm_state;
{
    ...
    svref_new_value = Chain_of_available_fsm_states;
    SVREF(fsm_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_fsm_states = fsm_state;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_fsm_state_variable, fsm_state_count_new_value;
    Object defstruct_g2_fsm_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(31,17);
    def_structure_fsm_state_variable = Nil;
    fsm_state_count_new_value = FIXNUM_ADD1(Fsm_state_count);
    Fsm_state_count = fsm_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_fsm_state_variable;
...
Object Chain_of_available_state_transitions = UNBOUND;

Object State_transition_count = UNBOUND;
    ...
    Object state_transition;
{
    ...
    svref_new_value = Chain_of_available_state_transitions;
    SVREF(state_transition,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_state_transitions = state_transition;
    return VALUES_1(Nil);
}
...
Object make_permanent_state_transition_structure_internal()
{
    ...
    Object state_transition_count_new_value;
    ...
    state_transition_count_new_value = FIXNUM_ADD1(State_transition_count);
    State_transition_count = state_transition_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_parse_objects = UNBOUND;

Object Parse_object_count = UNBOUND;
    ...
    Object parse_object;
{
    ...
    svref_new_value = Chain_of_available_parse_objects;
    SVREF(parse_object,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_parse_objects = parse_object;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_parse_object_variable, parse_object_count_new_value;
    ...
    parse_object_count_new_value = FIXNUM_ADD1(Parse_object_count);
    Parse_object_count = parse_object_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Current_lexing_rule_number = UNBOUND;

Object Current_character = UNBOUND;
...
Object empty_lexing_table()
{
    ...
    PUSH_SPECIAL(Current_lexing_rule_number,current_lexing_rule_number,0);
...
Object create_fsm_state()
{
    ...
    svref_new_value = gensym_cons_1(Current_lexing_rule_number,Nil);
    ...
    Object old_transition, new_destination;
{
    ...
    svref_new_value = CONSP(old_args) ? 
	    copy_tree_using_gensym_conses_1(old_args) : old_args;
    ...
    Object list_1, eql_test;
{
  ...
  next_loop:
	...
	duplicate_list = gensym_cons_1(element,duplicate_list);
    else
	result_list = gensym_cons_1(element,result_list);
    goto next_loop;
  end_loop:
    ...
    Object character_class_list;
{
  ...
  next_loop:
	...
	temp = TRUEP(Nil);
    if (temp)
	revised_list = gensym_cons_1(gensym_cons_1(element,element),
		revised_list);
	...
	if (temp) {
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    revised_list = gensym_cons_1(gensym_cons_1(FIXNUM_MIN(first_1,
    ...
    Object range_list;
{
	...
	inverted_list = gensym_cons_1(gensym_cons_1(Alphabet_min_code,
  ...
  next_loop:
	...
	inverted_list = 
		gensym_cons_1(gensym_cons_1(FIXNUM_SUB1(first_next),
		FIXNUM_SUB1(first_next)),inverted_list);
    else
	inverted_list = gensym_cons_1(gensym_cons_1(FIXNUM_ADD1(last_this),
		FIXNUM_SUB1(first_next)),inverted_list);
    rest_of_list = M_CDR(rest_of_list);
    goto next_loop;
  end_loop:
    if (FIXNUM_EQ(last_this,Alphabet_max_code))
	inverted_list = gensym_cons_1(gensym_cons_1(Alphabet_max_code,
    ...
    Object class_members_list;
{
    ...
    reclaim_gensym_tree_1(standardized_tree);
    return VALUES_1(inverted_tree);
}

Object Regular_expression_metacharacters = UNBOUND;

Object Built_in_character_codes = UNBOUND;

Object Current_tokenizer = UNBOUND;

Object Current_start_state = UNBOUND;

Object Current_lexing_strings = UNBOUND;

Object Current_lexing_patterns = UNBOUND;

Object Current_anchor_p = UNBOUND;

Object Known_regexp_functions = UNBOUND;
...
Object get_all_states()
{
    ...
    Object transition, ab_loop_list_, dest, gensymed_symbol, gensym_pop_store;
    Object cons_1, next_cons, cdr_new_value, temp_1;
    char temp;

    x_note_fn_call(31,49);
    to_be_done = Qnil;
    current_state_qm = Current_start_state;
    done_already = current_state_qm ? gensym_cons_1(current_state_qm,Nil) :
	     Qnil;
  ...
  end_1:;
	...
	temp = TRUEP(Qnil);
      end_2:;
	to_be_done = temp ? to_be_done : gensym_cons_1(dest,to_be_done);
    }
    goto next_loop_1;
  end_loop_1:;
    ...
    current_state_qm = gensym_pop_store;
    if (current_state_qm)
	done_already = gensym_cons_1(current_state_qm,done_already);
    goto next_loop;
  end_loop:
    temp_1 = done_already;
    goto end_3;
    ...
    Object state_1;
{
    ...
    reclaim_gensym_list_1(ISVREF(state_1,(SI_Long)1L));
    next_transition = Nil;
    ab_loop_list_ = current_transitions;
  next_loop:
    if ( !TRUEP(ab_loop_list_))
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(current_transitions);
    ...
    Object lexing_table;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(list_of_states);
    if (token_array) {
	i = (SI_Long)0L;
    ...
    Object exp_1, in_node, out_node;
{
    ...
    gensym_push_modify_macro_arg = 
	    ...
	    gensym_cons_1(exp_1,Nil),out_node);
    ...
    Object exp_1, in_node, out_node;
{
    ...
    gensym_push_modify_macro_arg = create_epsilon_state_transition(out_node);
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    SVREF(in_node,FIX((SI_Long)3L)) = svref_new_value;
...
Object pattern_transform_test(exp_1,in_node,out_node)
    Object exp_1, in_node, out_node;
{
    Object new_trans, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object svref_new_value;

    x_note_fn_call(31,58);
    new_trans = create_nonstandard_state_transition(CADR(exp_1),
	    copy_tree_using_gensym_conses_1(CDDR(exp_1)),out_node);
    gensym_push_modify_macro_arg = new_trans;
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    SVREF(in_node,FIX((SI_Long)3L)) = svref_new_value;
...
Object pattern_transform_either(exp_1,in_node,out_node)
    Object exp_1, in_node, out_node;
{
    Object arg, ab_loop_list_, new_start, new_end;
    Object gensym_push_modify_macro_arg, car_1, cdr_1, svref_new_value;
  ...
  next_loop:
    ...
    gensym_push_modify_macro_arg = create_epsilon_state_transition(new_start);
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    SVREF(in_node,FIX((SI_Long)3L)) = svref_new_value;
...
Object pattern_transform_kleene(exp_1,in_node,out_node)
    Object exp_1, in_node, out_node;
{
    Object new_in_node, new_out_node, gensym_push_modify_macro_arg, car_1;
    ...
    gensym_push_modify_macro_arg = 
	    create_epsilon_state_transition(new_in_node);
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    SVREF(in_node,FIX((SI_Long)3L)) = svref_new_value;
    ...
    Object exp_1, in_node, out_node;
{
    ...
    gensym_push_modify_macro_arg = create_standard_state_transition(temp,
	    gensym_cons_1(standardize_character_class_list(CADR(exp_1)),
	    Nil),out_node);
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    ...
    Object exp_1, in_node, out_node;
{
    ...
    temp = Alphabet_character_class_st_test;
    gensym_push_modify_macro_arg = create_standard_state_transition(temp,
	    gensym_cons_1(standardize_inverted_character_class_list(CADR(exp_1)),
	    Nil),out_node);
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(in_node,(SI_Long)3L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    ...
    Object pattern_and_token_defs, array_maker;
{
    ...
    Object svref_new_value, start_node, gensym_push_modify_macro_arg, car_1;
    Object cdr_1;
    SI_Long i;
    Declare_special(2);
    ...
    PUSH_SPECIAL(Current_lexing_patterns,current_lexing_patterns,1);
      current_lexing_rule_number = FIX((SI_Long)0L);
      PUSH_SPECIAL(Current_lexing_rule_number,current_lexing_rule_number,0);
    ...
    Object set_of_states;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, transition;
    Object ab_loop_list_, test, destination, gensymed_symbol, temp_1;
    char temp;

    x_note_fn_call(31,72);
    stack_qm = copy_list_using_gensym_conses_1(set_of_states);
    ep_closure = copy_list_using_gensym_conses_1(set_of_states);
    next_state = Nil;
    current_transitions = Nil;
  next_loop:
    if ( !TRUEP(stack_qm))
  ...
  next_loop_1:
	...
	temp = TRUEP(Qnil);
      end_1:;
	if ( !temp) {
	    ep_closure = gensym_cons_1(destination,ep_closure);
	    stack_qm = gensym_cons_1(destination,stack_qm);
	}
    }
    goto next_loop_1;
  end_loop_1:;
    ...
    Object state_1;
{
    ...
    bogus_temp_list = gensym_cons_1(state_1,Nil);
    single_states_closure = e_closure(bogus_temp_list);
    reclaim_gensym_list_1(bogus_temp_list);
    ...
    Object nfa_states;
{
    ...
    reclaim_gensym_list_1(ISVREF(new_state,(SI_Long)1L));
    ...
    Object allowed_transitions, attempted_transition;
{
	...
	if (add_this_destination_p) {
	  ...
	  end_1:;
	    if ( !temp)
		all_moves = gensym_cons_1(dest,all_moves);
	}
	goto next_loop;
      end_loop:
	answer = e_closure(all_moves);
	reclaim_gensym_list_1(all_moves);
	temp_1 = answer;
	goto end_2;
	temp_1 = Qnil;
      end_2:;
    ...
    Object list_of_nfa_states;
{
  ...
  next_loop_1:
    ...
    all_transitions = gensym_cons_1(trans,all_transitions);
    goto next_loop_1;
  end_loop_1:;
    goto next_loop;
  end_loop:
    collated_transitions = copy_list_using_gensym_conses_1(all_transitions);
    reclaim_gensym_list_1(all_transitions);
    ...
    Object source_state;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(duplicates);
    return VALUES_1(Nil);
}
    ...
    Object source_state, old_mappings;
{
    ...
    Object is_duplicate_qm, new_trans, gensym_push_modify_macro_arg, car_1;
    Object cdr_1, svref_new_value;
  ...
  next_loop:
	...
	if (is_duplicate_qm) {
	    ...
	    reclaim_gensym_list_1(nfa_destinations_qm);
	}
	else {
	    dfa_destination = create_fsm_state_for_dfa(nfa_destinations_qm);
	    nfa_destinations_qm = gensym_cons_1(dfa_destination,
		    nfa_destinations_qm);
	    new_mappings = gensym_cons_1(nfa_destinations_qm,new_mappings);
	}
    ...
    Object nondeterministic_lexer;
{
    ...
    Object new_mappings, current_state_qm, gensym_pop_store, cons_1, next_cons;
    Object temp, new_mapping, temp_1;
    SI_Long i, ab_loop_bind_;
    ...
    unmarked_dfa_states = gensym_cons_1(new_start_state,Nil);
    mappings_of_dfa_states_to_nfa_states = 
	    gensym_cons_1(gensym_cons_1(new_start_state,
	    initial_nfa_states),Nil);
    new_mappings = Nil;
  ...
  next_loop:
	...
	new_mapping = gensym_pop_store;
	unmarked_dfa_states = gensym_cons_1(CAR(new_mapping),
		unmarked_dfa_states);
	mappings_of_dfa_states_to_nfa_states = gensym_cons_1(new_mapping,
		mappings_of_dfa_states_to_nfa_states);
	i = i + (SI_Long)1L;
	goto next_loop_1;
      end_loop_1:;
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_tree_1(mappings_of_dfa_states_to_nfa_states);
    ...
    Object string_1, start_index, end_index;
{
    ...
    PUSH_SPECIAL(Current_character,current_character,0);
...
Object Preprocessing_tokenizer = UNBOUND;
...
Object G2_standard_tokenizer = UNBOUND;

Object G2_simple_tokenizer = UNBOUND;

Object G2_load_kb_tokenizer = UNBOUND;

Object G2_tokenizer_tokenizer = UNBOUND;

Object G2_symbol_tokenizer = UNBOUND;

Object G2_comment_tokenizer = UNBOUND;

Object Regular_expression_tokenizer = UNBOUND;
...
Object Chain_of_available_text_tokenization_states = UNBOUND;

Object Text_tokenization_state_count = UNBOUND;
    ...
    Object text_tokenization_state;
{
    ...
    svref_new_value = Chain_of_available_text_tokenization_states;
    SVREF(text_tokenization_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_text_tokenization_states = text_tokenization_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_text_tokenization_state_structure_internal()
{
    ...
    Object text_tokenization_state_count_new_value;
    ...
    text_tokenization_state_count_new_value = 
	    FIXNUM_ADD1(Text_tokenization_state_count);
    Text_tokenization_state_count = text_tokenization_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_g2_tokens = UNBOUND;

Object G2_token_count = UNBOUND;
    ...
    Object g2_token;
{
    ...
    svref_new_value = Chain_of_available_g2_tokens;
    SVREF(g2_token,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_g2_tokens = g2_token;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_g2_token_variable, g2_token_count_new_value;
    Object defstruct_g2_g2_token_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(31,105);
    def_structure_g2_token_variable = Nil;
    g2_token_count_new_value = FIXNUM_ADD1(G2_token_count);
    G2_token_count = g2_token_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_g2_token_variable;
...
Object Current_text_tokenization_state = UNBOUND;

Object Tokenize_with_editing_context_p = UNBOUND;
    ...
    Object end_line_index_qm, end_character_index_qm, return_partial_tokens_qm;
{
    ...
    PUSH_SPECIAL(Current_tokenizer,current_tokenizer,7);
      current_start_state = ISVREF(Current_tokenizer,(SI_Long)1L);
      PUSH_SPECIAL(Current_start_state,current_start_state,6);
	current_anchor_p = ISVREF(Current_tokenizer,(SI_Long)3L);
	PUSH_SPECIAL(Current_anchor_p,current_anchor_p,5);
	  svref_arg_1 = Current_text_tokenization_state;
    ...
    Object text_string_qm, tokenizer;
{
	...
	return_value = Qnil;
	text = gensym_cons_1(text_string_qm,Nil);
      next_loop:
	...
	if (token_value)
	    return_value = gensym_cons_1(token_value,return_value);
	goto next_loop;
      end_loop:
	reclaim_gensym_cons_1(text);
...
void token_INIT()
{
    ...
    char temp_1;
    Object AB_package, array_constant_9, list_constant_3, Qg2_token;
    Object Qreclaim_structure, Qoutstanding_g2_token_count;
    Object Qg2_token_structure_memory_usage, Qutilities2, Qg2_token_count;
    Object Qchain_of_available_g2_tokens, string_constant_15;
    ...
    Object Qtext_tokenization_state_structure_memory_usage;
    Object Qtext_tokenization_state_count;
    Object Qchain_of_available_text_tokenization_states, string_constant_13;
    Object string_constant_12, Qfalse, Qno_tokenizer_match_token_type;
    ...
    Object Qparse_object_structure_memory_usage, Qparse_object_count;
    Object Qchain_of_available_parse_objects, string_constant_11;
    Object string_constant_10, Qstate_transition;
    Object Qoutstanding_state_transition_count;
    Object Qstate_transition_structure_memory_usage, Qstate_transition_count;
    Object Qchain_of_available_state_transitions, string_constant_9;
    Object string_constant_8, Qfsm_state, Qoutstanding_fsm_state_count;
    Object Qfsm_state_structure_memory_usage, Qfsm_state_count;
    Object Qchain_of_available_fsm_states, string_constant_7;
    Object string_constant_6, Qinternal_token;
    Object Qoutstanding_internal_token_count;
    Object Qinternal_token_structure_memory_usage, Qinternal_token_count;
    Object Qchain_of_available_internal_tokens, string_constant_5;
    Object string_constant_4, Qlexing_table, Qoutstanding_lexing_table_count;
    Object Qlexing_table_structure_memory_usage, Qlexing_table_count;
    Object Qchain_of_available_lexing_tables, string_constant_3;
    ...
    string_constant_3 = STATIC_STRING("1q837Ay8s83-bfy09k9l");
    ...
    string_constant_4 = 
	    STATIC_STRING("43Dy8m83jAy1n83jAy8n8k1l8n0000000kok0k0");
    ...
    string_constant_5 = STATIC_STRING("1q83jAy8s83-Zay09k9l");
    clear_optimized_constants();
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8m83hby1n83hby8n8k1l8n0000000kok0k0");
    ...
    string_constant_7 = STATIC_STRING("1q83hby8s83-Uky09k9l");
    clear_optimized_constants();
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83nUy1n83nUy8n8k1l8n0000000kqk0k0");
    ...
    Qstate_transition_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_9 = STATIC_STRING("1q83nUy8s83-pIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83lSy1n83lSy8n8k1l8n0000000kpk0k0");
    ...
    string_constant_11 = STATIC_STRING("1q83lSy8s83-hLy09k9l");
    clear_optimized_constants();
  ...
  end_1:;
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qalphabetic,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qnumeric,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qhexadecimal,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qg2symbol,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qalphanumeric,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qwhitespace,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qdouble_quote,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qleft_bracket,
    ...
    Built_in_character_codes = gensym_cons_1(gensym_cons_1(Qright_bracket,
    ...
    Known_regexp_functions = gensym_cons_1(Qcanonical,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qnil,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qtest,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qseq,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qeither,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qkleene,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qpattern,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qab_plus,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qmaybe,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qab_dot,Known_regexp_functions);
    ...
    Known_regexp_functions = gensym_cons_1(Qcharacter_class,
    ...
    Known_regexp_functions = gensym_cons_1(Qinverted_class,
	    Known_regexp_functions);
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83nsy1n83nsy8n8k1l8n0000000k3Dyk0k0");
    ...
    Qtext_tokenization_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83nsy8s83-r0y09k9l");
    clear_optimized_constants();
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83hjy1n83hjy8n8k1l8n0000000krk0k0");
    ...
    string_constant_15 = STATIC_STRING("1q83hjy8s83-V7y09k9l");
    clear_optimized_constants();
