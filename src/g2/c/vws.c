    ...
    Object view, procedure, event, item, info, user_data_qm;
{
	...
	if (CONSP(item_or_value) && EQ(M_CDR(item_or_value),
	    ...
	    user_data_ev = gensym_cons_1(gensymed_symbol,Qab_structure);
	}
	else
	    user_data_ev = Qnil;
    }
...
Object Available_item_or_name_hash_hash_vector_43_vectors = UNBOUND;

Object Count_of_item_or_name_hash_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_item_or_name_hash_hash_vector_43_vectors_new_value, temp;
    XDeclare_area(1);

    x_note_fn_call(223,13);
    count_of_item_or_name_hash_hash_vector_43_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_item_or_name_hash_hash_vector_43_vectors);
...
Object make_item_or_name_hash_hash_vector()
{
    ...
    x_note_fn_call(223,14);
    if (Available_item_or_name_hash_hash_vector_43_vectors) {
	temp = M_CAR(Available_item_or_name_hash_hash_vector_43_vectors);
	temp_1 = M_CDR(Available_item_or_name_hash_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_item_or_name_hash_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = Available_item_or_name_hash_hash_vector_43_vectors;
	...
	Available_item_or_name_hash_hash_vector_43_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object item_or_name_hash_hash_vector_43_vector;
{
    ...
    cdr_new_value = Available_item_or_name_hash_hash_vector_43_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_item_or_name_hash_hash_vector_43_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}

/* MUTATE-ITEM-OR-NAME-HASH-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_item_or_name_hash_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(223,16);
    reclaim_item_or_name(M_CAR(entry_cons));
    reclaim_gensym_list_if_list(M_CDR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry = UNBOUND;

static Object Qequalw;             /* equalw */

/* CLEAR-ITEM-OR-NAME-HASH-TREE */
Object clear_item_or_name_hash_tree(item_or_name_hash_tree_for_hash_binary_tree)
    Object item_or_name_hash_tree_for_hash_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, old_key, old_entry;
    Object result;

    x_note_fn_call(223,17);
    element_qm = Nil;
  next_loop:
    element_qm = CDR(item_or_name_hash_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    temp = ISVREF(element_qm,(SI_Long)3L);
    gensymed_symbol = CAAR(temp);
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qequalw),
	    gensymed_symbol,item_or_name_hash_tree_for_hash_binary_tree,
	    hash_item_or_name(gensymed_symbol));
    MVS_2(result,old_key,old_entry);
    reclaim_item_or_name(old_key);
    reclaim_gensym_list_if_list(old_entry);
    goto next_loop;
  end_loop:;
    return VALUES_1(item_or_name_hash_tree_for_hash_binary_tree);
}
...
Object reclaim_item_or_name_hash(item_or_name_hash_hash_table)
    Object item_or_name_hash_hash_table;
{
    Object item_or_name_hash_tree_for_hash_binary_tree, element_qm;
    Object gensymed_symbol, old_key, old_entry, cdr_new_value, temp;
    SI_Long index_1;
    Object result;

    x_note_fn_call(223,21);
    index_1 = (SI_Long)0L;
  next_loop:
    if (index_1 >= (SI_Long)43L)
	goto end_loop;
    item_or_name_hash_tree_for_hash_binary_tree = 
	    ISVREF(item_or_name_hash_hash_table,index_1);
    element_qm = Nil;
  next_loop_1:
    element_qm = M_CDR(item_or_name_hash_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(item_or_name_hash_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(item_or_name_hash_tree_for_hash_binary_tree) = cdr_new_value;
    Available_gensym_conses = item_or_name_hash_tree_for_hash_binary_tree;
...
{
    Object key, temp_1, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;

    x_note_fn_call(223,25);
  ...
  next_loop:
	...
	if (equalw(gensymed_symbol_2,gensymed_symbol_4)) {
...
{
    Object key, temp_1, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4, entry, temp_2, temp_3;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;

    x_note_fn_call(223,26);
    key = copy_item_or_name(item_or_name);
    gensymed_symbol = IFIX(hash_item_or_name(key));
    temp = gensymed_symbol % (SI_Long)43L;
    temp_1 = SVREF(hash_table,FIX(temp));
  ...
  next_loop:
	...
	gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol_1));
	if (equalw(gensymed_symbol_2,gensymed_symbol_4)) {
	    entry = M_CDR(M_CAR(gensymed_symbol_1));
	    goto end_1;
	}
	gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	goto next_loop_1;
  ...
  end_2:;
    ...
    temp_1 = Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry;
    if ( !TRUEP(entry))
	temp_3 = handle;
    else if (ATOM(entry))
	...
	temp_3 = Qnil;
    return set_balanced_binary_tree_entry(temp_2,Qequalw,temp_1,T,key,
	    FIX(gensymed_symbol),temp_3);
}
...
{
    Object key, temp_1, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4, entry, old_key, old_entry, temp_2, temp_3, x;
    Object ab_loop_list_, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;
    Object result;

    x_note_fn_call(223,27);
    key = copy_item_or_name(item_or_name);
    gensymed_symbol = IFIX(hash_item_or_name(key));
    temp = gensymed_symbol % (SI_Long)43L;
    temp_1 = SVREF(hash_table,FIX(temp));
  ...
  end_2:;
	...
	if (EQL(handle,entry)) {
	    ...
	    temp = gensymed_symbol % (SI_Long)43L;
	    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qequalw),
		    key,SVREF(hash_table,FIX(temp)),FIX(gensymed_symbol));
	    MVS_2(result,old_key,old_entry);
	    reclaim_item_or_name(old_key);
	    reclaim_gensym_list_if_list(old_entry);
	}
	...
	if (EQL(handle,temp_1)) {
	    gensymed_symbol = IFIX(hash_item_or_name(key));
	    temp = gensymed_symbol % (SI_Long)43L;
	    return set_balanced_binary_tree_entry(SVREF(hash_table,
		    FIX(temp)),Qequalw,
		    Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry,T,
		    key,FIX(gensymed_symbol),CADR(entry));
	}
	else {
	    temp_1 = CADR(entry);
	    if (EQL(handle,temp_1)) {
		...
		return set_balanced_binary_tree_entry(SVREF(hash_table,
			FIX(temp)),Qequalw,
			Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry,
	...
	temp = gensymed_symbol % (SI_Long)43L;
	temp_2 = SVREF(hash_table,FIX(temp));
	temp_3 = Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry;
	x = Nil;
	ab_loop_list_ = entry;
	ab_loopvar_ = Nil;
	ab_loopvar__1 = Nil;
	...
	temp_1 = Qnil;
      end_3:;
	return set_balanced_binary_tree_entry(temp_2,Qequalw,temp_3,T,key,
		FIX(gensymed_symbol),temp_1);
    }
}
...
Object Chain_of_available_status_bars = UNBOUND;

Object Status_bar_count = UNBOUND;
    ...
    Object status_bar;
{
    ...
    x_note_fn_call(223,30);
    inline_note_reclaim_cons(status_bar,Nil);
    svref_new_value = Chain_of_available_status_bars;
    SVREF(status_bar,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_status_bars = status_bar;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_status_bar_variable, status_bar_count_new_value;
    Object defstruct_g2_status_bar_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(223,32);
    def_structure_status_bar_variable = Nil;
    status_bar_count_new_value = FIXNUM_ADD1(Status_bar_count);
    Status_bar_count = status_bar_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_status_bar_variable;

    x_note_fn_call(223,33);
    def_structure_status_bar_variable = Chain_of_available_status_bars;
...
Object reclaim_status_bar(status_bar)
    Object status_bar;
{
    x_note_fn_call(223,35);
    return reclaim_native_window(status_bar);
}

Object The_type_description_of_status_bar_pane = UNBOUND;

Object Chain_of_available_status_bar_panes = UNBOUND;

Object Status_bar_pane_count = UNBOUND;
    ...
    Object status_bar_pane;
{
    ...
    x_note_fn_call(223,38);
    inline_note_reclaim_cons(status_bar_pane,Nil);
    svref_new_value = Chain_of_available_status_bar_panes;
    SVREF(status_bar_pane,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_status_bar_panes = status_bar_pane;
    return VALUES_1(Nil);
}
...
Object make_permanent_status_bar_pane_structure_internal()
{
    ...
    Object status_bar_pane_count_new_value;
    Object defstruct_g2_status_bar_pane_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(223,40);
    def_structure_status_bar_pane_variable = Nil;
    status_bar_pane_count_new_value = FIXNUM_ADD1(Status_bar_pane_count);
    Status_bar_pane_count = status_bar_pane_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object status_bar_allocate_pane_handle(status_bar)
    Object status_bar;
{
    Object temp, temp_1, gensym_pop_store, cons_1, next_cons;

    x_note_fn_call(223,49);
    ...
    Object mouse_pointer;
{
	...
	if (event_qm) {
		...
		return invoke_view_callback_1(status_bar,procedure,
			...
			Nil,gensym_list_4(Qx,user_window_x,Qy,
			user_window_y),pane_qm ? ISVREF(pane_qm,
			(SI_Long)3L) : Nil);
	    else
		return VALUES_1(Nil);
	}
...
Object Chain_of_available_logbook_views = UNBOUND;

Object Logbook_view_count = UNBOUND;
    ...
    Object logbook_view;
{
    ...
    x_note_fn_call(223,68);
    inline_note_reclaim_cons(logbook_view,Nil);
    svref_new_value = Chain_of_available_logbook_views;
    SVREF(logbook_view,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_logbook_views = logbook_view;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_logbook_view_variable, logbook_view_count_new_value;
    Object defstruct_g2_logbook_view_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(223,70);
    def_structure_logbook_view_variable = Nil;
    logbook_view_count_new_value = FIXNUM_ADD1(Logbook_view_count);
    Logbook_view_count = logbook_view_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
static Object Qlogbook_type;       /* logbook-type */
...
Object create_logbook_view varargs_1(int, n)
{
    ...
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = Qlogbook_type;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = logbook_type;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    ...
    Object serial_number_qm;
{
	...
	if (current_logbook_qm()) {
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    gensymed_symbol = ISVREF(gensymed_symbol,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    ab_queue_form_ = gensymed_symbol;
	    ab_next_queue_element_ = Nil;
	  ...
	  next_loop_1:
	    if (EQ(ab_next_queue_element_,ab_queue_form_))
		goto end_loop_1;
	    message_1 = ISVREF(ab_next_queue_element_,(SI_Long)2L);
...
static Object Qoperator_logbook;   /* operator-logbook */
    ...
    Object gensym_window;
{
    ...
    x_note_fn_call(223,92);
    dock = ISVREF(Logbook_parameters,(SI_Long)41L);
    neighbor = Nil;
    hide_qm =  !TRUEP(ISVREF(Logbook_parameters,(SI_Long)38L));
    lbv = create_logbook_view(8,gensym_window,array_constant,
	    ISVREF(Logbook_parameters,(SI_Long)22L),
	    ISVREF(Logbook_parameters,(SI_Long)23L),Qoperator_logbook,dock,
	    neighbor,hide_qm ? T : Nil);
    if (current_logbook_qm()) {
    ...
    Object gensym_window;
{
    ...
    x_note_fn_call(223,103);
    dock_qm = Qright;
    neighbor_qm = Nil;
    lbv = create_logbook_view(7,gensym_window,array_constant_1,
	    ISVREF(Message_board_parameters,(SI_Long)22L),
	    ISVREF(Message_board_parameters,(SI_Long)23L),Qmessage_board,
	    dock_qm,neighbor_qm);
...
Object Tabular_view_action = UNBOUND;
...
Object Chain_of_available_tabular_views = UNBOUND;

Object Tabular_view_count = UNBOUND;
    ...
    Object tabular_view;
{
    ...
    x_note_fn_call(223,112);
    inline_note_reclaim_cons(tabular_view,Nil);
    svref_new_value = Chain_of_available_tabular_views;
    SVREF(tabular_view,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_tabular_views = tabular_view;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_tabular_view_variable, tabular_view_count_new_value;
    Object defstruct_g2_tabular_view_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(223,114);
    def_structure_tabular_view_variable = Nil;
    tabular_view_count_new_value = FIXNUM_ADD1(Tabular_view_count);
    Tabular_view_count = tabular_view_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object pct_tabular_view_reclaim_cell(cell)
    Object cell;
{
    x_note_fn_call(223,123);
    reclaim_unboxed_evaluation_value(CAR(cell));
    return reclaim_gensym_cons_1(cell);
}
    ...
    Object tbv;
{
  ...
  next_loop:
    ...
    if (logical_id_qm) {
	ab_loopvar__2 = gensym_cons_1(FIXNUMP(logical_id_qm) || 
    ...
    Object tbv, evalue_qm;
{
	...
	next_index = next_index + (SI_Long)1L;
	row = validated_elt;
	ab_loopvar__2 = gensym_cons_1(preprocess_tabular_view_row(tbv,row),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    Object tbv, evalue_qm;
{
	...
	row = validated_elt;
	ab_loopvar__2 = 
		gensym_cons_1(preprocess_tabular_view_replace_row(tbv,row),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    Object action, handle, ev_arg, g2_window;
{
    ...
    PUSH_SPECIAL(Tabular_view_action,tabular_view_action,0);
      if (EQ(action,Qdestroy)) {
    ...
    Object mouse_pointer;
{
	...
	if (tbv_qm && event_name_qm) {
	    ...
	    if (procedure) {
		temp = label_qm ? gensym_list_2(Qlabel,
			INLINE_UNSIGNED_BYTE_16_VECTOR_P(label_qm) != 
			(SI_Long)0L ? copy_text_string(label_qm) : 
			label_qm) : Nil;
		temp_1 = column_qm ? gensym_list_2(Qcolumn,column_qm) : Nil;
		temp_2 = keysym_qm ? gensym_list_2(Qkey,keysym_qm) : Nil;
    ...
    Object single_selection;
{
    ...
    x_note_fn_call(223,151);
    PUSH_SPECIAL(Row_height,row_height,0);
      tbv = make_tabular_view(gensym_window);
...
void views_INIT()
{
    ...
    Object Qtabular_view_count, Qchain_of_available_tabular_views;
    ...
    Object Qlogbook_view_structure_memory_usage, Qlogbook_view_count;
    Object Qchain_of_available_logbook_views, string_constant_29;
    ...
    Object Qstatus_bar_pane_structure_memory_usage, Qstatus_bar_pane_count;
    Object Qchain_of_available_status_bar_panes, string_constant_27;
    Object string_constant_26, Qstatus_bar, Qoutstanding_status_bar_count;
    Object Qstatus_bar_structure_memory_usage, Qstatus_bar_count;
    Object Qchain_of_available_status_bars, string_constant_25;
    ...
    Object Qmutate_item_or_name_hash_tree_for_hash_tree_entry;
    Object Qout_item_or_name_hash_hash_vector_43_vectors;
    Object Qitem_or_name_hash_hash_vector_43_vector_memory_usage;
    Object string_constant_23;
    Object Qcount_of_item_or_name_hash_hash_vector_43_vectors;
    Object Qavailable_item_or_name_hash_hash_vector_43_vectors;
    Object list_constant_10, Qg2_window;

    x_note_fn_call(223,154);
    SET_PACKAGE("AB");
    ...
    Qitem_or_name_hash_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_23 = STATIC_STRING("1q83-aOy83*By83-Oty09k9l");
    ...
    Qmutate_item_or_name_hash_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-ITEM-OR-NAME-HASH-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_item_or_name_hash_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_item_or_name_hash_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_item_or_name_hash_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_item_or_name_hash_tree_for_hash_tree_entry);
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8m83nVy1p83nVy83=Ly83*wy8n8k1l83=Ly0000001m1m8x83=Ly1m83My83-BAyk3Syk0k0");
    ...
    string_constant_25 = STATIC_STRING("1q83nVy8s83-pPy09k9l");
    clear_optimized_constants();
    ...
    string_constant_26 = 
	    STATIC_STRING("43Dy8m83nWy1n83nWy8n8k1l8n0000001m1m83My83-BBy1n8y83-6=y1n83-Dky83-Dly83-Dmykok0k0");
    ...
    string_constant_27 = STATIC_STRING("1q83nWy8s83-pQy09k9l");
    clear_optimized_constants();
    ...
    string_constant_28 = 
	    STATIC_STRING("43Dy8m83kfy1p83kfy83=Ly83*wy8n8k1l83=Ly0000001n1m8x83=Ly1m8y83-4py1m83My83-Aiyk3Qyk0k0");
    ...
    string_constant_29 = STATIC_STRING("1q83kfy8s83-cJy09k9l");
    clear_optimized_constants();
    ...
    Qlogbook_type = STATIC_SYMBOL("LOGBOOK-TYPE",AB_package);
    ...
    Qoperator_logbook = STATIC_SYMBOL("OPERATOR-LOGBOOK",AB_package);
    ...
    string_constant_30 = 
	    STATIC_STRING("43Dy8m83nky1p83nky83=Ly83*wy8n8k1l83=Ly0000001n1m8x83=Ly1m8y83-65y1m83My83-BCyk3Tyk0k0");
    ...
    string_constant_31 = STATIC_STRING("1q83nky8s83-qay09k9l");
    clear_optimized_constants();
