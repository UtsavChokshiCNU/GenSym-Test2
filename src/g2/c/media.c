    ...
    Object type, name;
{
	...
	temp_1 = FIXNUM_ADD(Simple_float_array_pool_memory_usage,incff_1_arg);
...
Object Chain_of_available_media_streams = UNBOUND;

Object Media_stream_count = UNBOUND;
    ...
    Object media_stream;
{
    ...
    svref_new_value = Chain_of_available_media_streams;
    SVREF(media_stream,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_media_streams = media_stream;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_media_stream_variable, media_stream_count_new_value;
    ...
    media_stream_count_new_value = FIXNUM_ADD1(Media_stream_count);
    Media_stream_count = media_stream_count_new_value;
    ...
    Object media_bin, location_sequence_or_file_descriptor;
{
    ...
    Object incff_1_arg, new_float, svref_new_value, info, file, ab_loop_list_;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	    ...
	    info = gensym_cons_1(gensymed_symbol,Qab_structure);
		...
		ab_loop_list_ = M_CDR(ab_loop_list_);
		ab_loopvar__2 = 
			gensym_cons_1(copy_as_wide_string(FIXNUM_LE(ISVREF(file,
			(SI_Long)1L),Maximum_in_place_array_size) ? 
			ISVREF(file,
    ...
    Object media_bin, file, parent_file_qm;
{
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(FIXNUM_LE(ISVREF(file,(SI_Long)1L),
		Maximum_in_place_array_size) ? ISVREF(file,(SI_Long)4L + 
		IFIX(Managed_array_index_offset)) : ISVREF(ISVREF(file,
		(SI_Long)2L),(SI_Long)4L));
	if (FIXNUM_LE(ISVREF(file,(SI_Long)1L),Maximum_in_place_array_size))
    ...
    Object file, end_block;
{
    ...
    result_1 = gensym_cons_1(wide_string_bv16,Nil);
    if (FIXNUM_LE(ISVREF(file,(SI_Long)1L),Maximum_in_place_array_size) ? 
    ...
    Object directory_1, file;
{
    ...
    x_note_fn_call(230,42);
    gensym_push_modify_macro_arg = file;
    ...
    Object directory_1, file;
{
    ...
    x_note_fn_call(230,43);
    svref_new_value = delete_gensym_element_1(file,
    ...
    Object file, stream;
{
    ...
    x_note_fn_call(230,44);
    gensym_push_modify_macro_arg = stream;
    car_1 = gensym_push_modify_macro_arg;
    ...
    Object file, stream;
{
    ...
    x_note_fn_call(230,45);
    svref_new_value = delete_gensym_element_1(stream,FIXNUM_LE(ISVREF(file,
	    (SI_Long)1L),Maximum_in_place_array_size) ? ISVREF(file,
	    (SI_Long)5L + IFIX(Managed_array_index_offset)) : 
	    ISVREF(ISVREF(file,(SI_Long)2L),(SI_Long)5L));
    if (FIXNUM_LE(ISVREF(file,(SI_Long)1L),Maximum_in_place_array_size))
	SVREF(file,FIX((SI_Long)7L)) = svref_new_value;
    else {
	svref_arg_1 = ISVREF(file,(SI_Long)2L);
    ...
    Object media_bin, stream;
{
    ...
    x_note_fn_call(230,47);
    svref_new_value = delete_gensym_element_1(stream,ISVREF(media_bin,
	    (SI_Long)21L));
    ISVREF(media_bin,(SI_Long)21L) = svref_new_value;
    return VALUES_1(Nil);
}
    ...
    Object sequence, reclaim_p;
{
  ...
  next_loop:
	...
	location = gensym_cons_1(temp,location);
    }
    else {
...
{
    x_note_fn_call(230,50);
    return VALUES_1(nconc2(location,text_string_p(extension) ? 
	    gensym_cons_1(extension,Nil) : extension));
}
    ...
    Object media_bin, file, depth;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	result_1 = gensym_cons_1(temp,Nil);
	sub_file = Nil;
	ab_loop_list_ = FIXNUM_LE(ISVREF(file,(SI_Long)1L),
		Maximum_in_place_array_size) ? ISVREF(file,(SI_Long)4L + 
		IFIX(Managed_array_index_offset)) : ISVREF(ISVREF(file,
    ...
    Object image_definition, decache_p;
{
	...
	structure_or_false = g2_media_bin_describe(temp,
		allocate_evaluation_sequence(gensym_cons_1(copy_constant_wide_string_given_length(array_constant_2,
		FIX((SI_Long)5L)),Nil)));
    ...
    Object file, owner_qm;
{
    ...
    x_note_fn_call(230,77);
    temp = owner_qm ? gensym_list_2(Qowner,owner_qm) : Nil;
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(media_file_evaluation_value(element,
		Nil),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	...
	element = M_CAR(ab_loop_list_);
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(copy_text_string(element),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	ab_loopvar__2 = gensym_cons_1(wide_string_bv16,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	temp_1 = gensym_list_2(Qsize_in_bytes,FIX(gensymed_symbol_2 + 
		gensymed_symbol_3));
    }
    else
	temp_1 = Nil;
...
void media_INIT()
{
    ...
    Object Qmedia_stream_count, Qchain_of_available_media_streams;
    ...
    string_constant_28 = 
	    STATIC_STRING("1q4z8r8u8u83V6y83V6y01p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1m3k");
    string_constant_29 = 
    ...
    string_constant_31 = 
	    STATIC_STRING("3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy+s3-9y3-1y3-0y3-5y3--ykp3A++y1ms3Hy83-Wy1o83Gy+s3fy3-*y3-5y3-Aykko3A++y1mt3ay83-Wy1o");
    string_constant_32 = 
	    STATIC_STRING("83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83V7");
    string_constant_33 = 
	    STATIC_STRING("y83V7y83V6y83V6y00001n1l8l1l83Cy1l8o000004z8r83VBy83VBy83V6y83V6y00001m1l8l1l8o000004z8r83V8y83V8y83V6y83V6y0k001m1l8l1l8o000004");
    string_constant_34 = 
	    STATIC_STRING("z8r83VAy83VAy83V6y83V6y00001m1l8l1l8o000004z8r83V9y83V9y83V6y83V6y00001m1l8l1l8o00000");
    string_constant_35 = 
	    STATIC_STRING("1s8q1n83V6y1m83-+y83Ry8t1m8u1p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1");
    string_constant_36 = 
    ...
    string_constant_38 = 
	    STATIC_STRING("mn3hy1m3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy5pMEDIA1ms3Hy83-Wy1o83Gy5o-BIN1mt3ay83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp");
    string_constant_39 = 
	    STATIC_STRING("3fy1m3ey3fy1m3eyp1p83V7y08l83Cy8o1o83VBy08l8o1o83V8yk8l8o1o83VAy08l8o1o83V9y08l8o");
    ...
    string_constant_40 = 
	    STATIC_STRING("43Dy8m83kiy1n83kiy8n8k1l8n0000001l1n8y83-4qy1o83-6Zy83-6ay83-6Yy83-6Xykrk0k0");
    ...
    string_constant_41 = STATIC_STRING("1q83kiy8s83-d9y09k9l");
    clear_optimized_constants();
    ...
    string_constant_46 = 
	    STATIC_STRING("ky3ky1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1m3ky3ky83-ny1q83qy1q1mkk1m3kyk1");
    string_constant_47 = 
    ...
    string_constant_49 = 
	    STATIC_STRING("y3ky1m3kyk1o83Gy+s3-Gy3-Jy3fykkkn3A++y1ms3Hy83-Wy1o83Gy+s3-Ey3-Fy3-Ey3-=ykko3A++y1mt3ay83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp");
    string_constant_50 = 
	    STATIC_STRING("3fy1m3ey3fy1m3eyp001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83Z5y83Z5y83AIy83AIy00001m1l8o1l8l0000");
    string_constant_51 = STATIC_STRING("0");
    string_constant_52 = 
	    STATIC_STRING("1q8q1o83AIy1m83Ry83-+y8t1m8v83AIy1n83--y01m8p83-*y1p83-Fy08l1m8p083Cy1m8u1p8w9k3ky3ky1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-");
    string_constant_53 = 
    ...
    string_constant_55 = 
	    STATIC_STRING("k3ky1mn3hy1n1m3hy3hy1m3hyn1m3ky3ky1n1m3ky3ky1mn3hy1m3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy5nTW-1ms3Hy83-Wy1o83Gy5oRSRC1mt3");
    string_constant_56 = 
	    STATIC_STRING("ay83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp1o83Z5y08o8l");
    ...
    string_constant_58 = 
	    STATIC_STRING("1s4z8r83-Fy83-Fy83Kxy83Kxy00001q1l8l1m8p83-ky1l83Cy1l83Uy1l83*-y1m83Dy53MySee comment in class block000004z8r83JYy83JYy83Kxy83Kx");
    string_constant_59 = 
	    STATIC_STRING("y00001o1l8o1l8l1m8p83Ky1l83Cy000004z8r83T4y83T4y83Kxy83Kxy00001p1m8p83T4y1l8o1l8l1l83Cy1l83Fy000004z8r8u8u83Kxy83Kxy01p8w9k3ky3k");
    string_constant_60 = 
	    STATIC_STRING("y13Fy1r83-1y2l83-Ly83-Xy2l83-my83-Ry2l83-ny83-gy2l835Jy83Ty2l835by83*2y2l835ay832Vy1l83-iy1l83-jy83-Ly1n83jy1mkk1m3ky3ky83-my1q8");
    string_constant_61 = 
    ...
    string_constant_64 = 
	    STATIC_STRING("Wy835ay1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3Ny83-Wy1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1ms3Ny83-Wy001o1l8l1l8o1l8z1m83Dy53YySee comme");
    string_constant_65 = 
	    STATIC_STRING("nt on ENTITY class definition000004z8r83TAy83TAy83Kxy83Kxy0+s3jy3gy3jykkkn3A++y001o1l8l1m8p83-qy1l83Fy1l83Cy000004z8r83XVy83XVy8");
    string_constant_66 = 
	    STATIC_STRING("3Kxy83Kxy00001p1m8p83T8y1l8o1l8l1l83Cy1l83Fy000004z8r83Cqy83Cqy83Kxy83Kxy00001p1m8p83T7y1l8o1l8l1l83Cy1l83Fy000004z8r83BKy83BKy8");
    string_constant_67 = 
	    STATIC_STRING("3Kxy83Kxy00001p1n8p83DGy83Gy1l8o1l8l1l83Cy1l83-3y00000");
    string_constant_68 = 
	    STATIC_STRING("1u8q1o83Kxy1m83Ry83-+y83Iy8t1p83-Fy08l1m8p83-ky83Cy1q83JYy08o8l1m8p83Ky83Cy1r83T4y01m8p83T4y8o8l83Cy83Fy1m8u1p8w9k3ky3ky13Fy1r83");
    string_constant_69 = 
	    STATIC_STRING("-1y2l83-Ly83-Xy2l83-my83-Ry2l83-ny83-gy2l835Jy83Ty2l835by83*2y2l835ay832Vy1l83-iy1l83-jy83-Ly1n83jy1mkk1m3ky3ky83-my1q83qy1q1m3h");
    string_constant_70 = 
    ...
    string_constant_72 = 
	    STATIC_STRING("1n1mnn1mk3ky1mkk835Jy1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Oy1m3eyp1mpp1mp3fy835by1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3Oy83-Wy835ay1o");
    string_constant_73 = 
	    STATIC_STRING("83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3Ny83-Wy1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1ms3Ny83-Wy1q83TAy+s3jy3gy3jykkkn3A++y8l1m8p83-qy83Fy83");
    string_constant_74 = 
	    STATIC_STRING("Cy1r83XVy01m8p83T8y8o8l83Cy83Fy1r83Cqy01m8p83T7y8o8l83Cy83Fy1r83BKy01n8p83DGy83Gy8o8l83Cy83-3y");
