...
{
    Object car_1, cdr_1, temp, gensymed_symbol, gensymed_symbol_1;
    ...
    Object item, structure;
{
    ...
    PUSH_SPECIAL(Breakpoint_level,breakpoint_level,0);
    ...
    Object new_table;
{
    ...
    Object amf_result, incff_1_arg, new_float, gensymed_symbol, feature_list;
    Object structure;
    double aref_new_value;
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(get_user_spelling(feature_name,
	    Qpart_feature),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
    ...
    Object rule;
{
    ...
    temp = gensym_list_2(Qpriority,ISVREF(rule,(SI_Long)26L));
	...
	temp_2 = gensym_list_2(Qscan_interval,temp_1);
    }
    else
	temp_2 = Nil;
    temp_3 = gensym_list_2(Qmay_request_event_updates,(SI_Long)0L != 
	    (IFIX(ISVREF(rule,(SI_Long)4L)) & (SI_Long)8L) ? 
	    Evaluation_true_value : Evaluation_false_value);
    temp_1 = gensym_list_2(Qmay_request_data_seeking,(SI_Long)0L != 
    ...
    structure = allocate_evaluation_structure(nconc2(temp,nconc2(temp_2,
	    ...
	    nconc2(gensym_list_2(Qmay_provide_data_on_request,(SI_Long)0L 
	    != (IFIX(ISVREF(rule,(SI_Long)4L)) & (SI_Long)2L) ? 
	    Evaluation_true_value : Evaluation_false_value),
	    gensym_list_2(Qmay_provide_event_updates,(SI_Long)0L != 
    ...
    Object display;
{
    ...
    temp = gensym_list_2(Qpriority,get_lookup_slot_value(display,
	...
	temp_1 = gensym_list_2(Qscan_interval,
	...
	temp_2 = gensym_list_2(Qinitial_scan_wait_interval,
...
static Object Qdata_point_value;   /* data-point-value */
    ...
    Object variable_or_parameter, use_unix_time_p;
{
	...
	if (logical_qm) {
		...
		current_value = gensym_cons_1(value,Qtruth_value);
	}
	else
	...
	temp_1 = current_value ? gensym_list_2(Qdata_point_value,
		current_value) : Qnil;
	return allocate_evaluation_structure(nconc2(temp_1,
		nconc2(collection_time ? 
		gensym_list_2(Qdata_point_collection_time,collection_time) 
		: Qnil,expiration_time ? 
		gensym_list_2(Qdata_point_expiration_time,expiration_time) 
		: Qnil)));
    }
    else
	return VALUES_1(Nil);
    ...
    Object variable_or_parameter, new_value, use_unix_time_p;
{
    ...
    Object new_float, current_computation_frame, old_collection_time, temp_2;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	    ...
	    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
	      ...
	      if (current_value) {
		  temp_2 = current_value_is_copy ? current_value : 
		  ...
		  temp_2 = 
			  ...
			  temp_2,expiration_time,collection_time,Nil);
	      }
	      else
		  temp_2 = put_has_no_value(variable_or_parameter);
	    POP_SPECIAL();
	}
    ...
    Object variable_or_parameter;
{
	...
	if (logical_qm) {
		...
		value_qm = gensym_cons_1(value,Qtruth_value);
	}
	else
    ...
    Object use_unix_time_p, start_index, end_index;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp_1, svref_new_value;
    Object amf_result, incff_1_arg, new_float, gensymed_symbol, item_or_value;
    Object x2;
    SI_Long gensymed_symbol_1, svref_arg_2;
    char logicalp, temp_2;
    double aref_new_value;
	...
	if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
		...
		if (FIXNUM_EQ(value,Truth))
		    ...
		    history_value = gensym_cons_1(value,Qtruth_value);
	    }
	    else
	...
	history_elements = gensym_cons_1(gensym_cons_1(gensymed_symbol,
    ...
    Object g2_array;
{
	...
	if (ISVREF(g2_array,(SI_Long)23L)) {
	  ...
	  next_loop:
	    ...
	    ab_loopvar__2 = gensym_cons_1(temp ? value : Nil,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
    ...
    Object g2_list;
{
	...
	if (EQ(ab_loopvar__1,ab_loopvar_))
	    goto end_loop;
	item_or_evaluation_value_element = ISVREF(ab_loopvar__1,(SI_Long)2L);
	...
	if (temp) {
	    ab_loopvar__4 = 
		    gensym_cons_1(FIXNUMP(item_or_evaluation_value_element) 
    ...
    Object g2_list, new_value;
{
	...
	if ( !TRUEP(Append_into_arrays_and_lists)) {
		...
		ab_loopvar__3 = Nil;
		ab_loopvar__4 = Nil;
		ab_loopvar__1 = ab_loopvar_ ? ISVREF(ab_loopvar_,
			(SI_Long)0L) : Nil;
	      next_loop_1:
		if (EQ(ab_loopvar__1,ab_loopvar_))
		    goto end_loop_1;
    ...
    Object element, top_level_p, items_allowed_p;
{
    ...
    Object svref_new_value, amf_result, incff_1_arg, new_float, x2;
    Object designation_qm, temp_2, temp_3;
	...
	if (temp_1) {
		...
		temp_2 = Bad_phrase;
		temp_3 = tformat_text_string(2,string_constant_10,element);
		return VALUES_2(temp_2,temp_3);
	    }
	}
	else
	    return VALUES_1(Nil);
...
Object Designation_marker = UNBOUND;
    ...
    Object slot_value, values_allowed_p, items_allowed_p;
{
	...
	if (text_string_p(element))
		...
		if (FIXNUM_EQ(gensymed_symbol,Truth))
		    ...
		    evaluation_value = gensym_cons_1(gensymed_symbol,
			    Qtruth_value);
	    }
	    else {
		if (CONSP(element)) {
	...
	if (designation_p)
	    ...
	    any_value_p = T;
	ab_loopvar__1 = gensym_cons_1(designation_p ? Nil : 
		evaluation_value,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	...
	ab_loopvar_ = ab_loopvar__1;
	ab_loopvar__1 = gensym_cons_1(designation_p ? 
	...
	if (any_value_p && (values_allowed_p ||  !TRUEP(use_designations_p)))
	    ...
	    reclaim_gensym_list_1(values_list_1);
	    values_sequence = Nil;
	}
	if (any_designation_p && items_allowed_p)
	    ...
	    reclaim_gensym_list_1(designations_list);
	...
	if (values_allowed_p && items_allowed_p && designations_sequence)
	    return allocate_evaluation_structure(nconc2(values_sequence ? 
		    gensym_list_2(Qvalues,values_sequence) : Nil,
		    gensym_list_2(Qitems,designations_sequence)));
	else {
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    element = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(copy_as_wide_string(element),Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	gensymed_symbol = ab_loopvar__1;
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
	...
	temp = gensym_cons_1(element,Qtruth_value);
    ...
    Object evaluation_value, frame, slot_description, gensymed_symbol;
{
    ...
    Object new_long, amf_available_array_cons_qm, amf_array, temp_2;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    SI_Long next_index, length_1;
    SI_int64 aref_new_value;
    double aref_new_value_1;
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    element = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(INLINE_DOUBLE_FLOAT_VECTOR_P(element) != 
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    element = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(copy_managed_float(element),Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	gensymed_symbol = ab_loopvar__1;
...
void grammar4a_INIT()
{
    ...
    Object Qsource_stepping_level, list_constant_216, Qbreakpoint_level;
    Object Qimage_palette, list_constant_245, list_constant_244;
    Object list_constant_243, list_constant_242, list_constant_241;
    Object list_constant_240, list_constant_239, list_constant_238;
    Object Qcustom_colors, Qcustom_grays, Qextended_colors, Qextended_grays;
    Object Qstandard_colors, Qstandard_grays, Qblack_and_white;
    Object list_constant_237, list_constant_236, Qnumber_of_menu_columns_spec;
    Object Qcolor_set_spec, list_constant_235, list_constant_234;
    Object list_constant_233, Qcolor_or_metacolor, Qstandard_set, Qall;
    Object list_constant_232, list_constant_228, Qcolor_menu_ordering, Qhue;
    Object Qalphabetic, Qintensity, Qcurrent_language;
    Object Qwhen_to_allow_multiple_menus, Qalways, Qalignment, Qright, Qcenter;
    Object Qleft, Qinteger_list, Qfloat_list, Qquantity_list;
    Object Qtruth_value_list, Qwhole_string_list, Qsymbol_list;
    ...
    Object list_constant_215, Qdesignation_marker, Qelement_type;
    Object list_constant_214, Qset_g2_list_sequence, Qget_g2_list_sequence;
    ...
    Object Qnon_action_button, Qchart, Qtrend_chart, Qsimulation_subtable;
    ...
    Object Qexit, Qrepeat, Qinfer, Qcall, Qbegin, Qfaction, Qworkspace;
    Object Qsubworkspace, Qeverything, Qnothing, Qthere, Qcollection;
    Object Qexpiration, Qsame, Qgiving, Qusing;
    ...
    Qfaction = STATIC_SYMBOL("FACTION",AB_package);
    ...
    list_constant_69 = STATIC_LIST((SI_Long)2L,Qavailable_frame_vector,Qusing);
    list_constant_70 = STATIC_LIST_STAR((SI_Long)32L,Qsymbol,Qgiving,
	    ...
	    Qfaction,Qbegin,Qend,Qreturn,Qcall,Qstart,Qinfer,Qrepeat,Qexit,
	    Qgo,Qwait,Qchecking,Qdo,Qcase,Qminus,Qcolor_pattern,Qsimulated,
	    list_constant_69);
    ...
    string_constant_16 = 
	    STATIC_STRING("1p1m83-D1y1m9k9l1m83-D1y1m9k833Ty1m83-D1y1m9k833Oy1m83-D1y1m9k833+y1m83-D1y1m9k83Fty");
    ...
    string_constant_17 = 
	    STATIC_STRING("1p1m83ldy1m9k832Ky1m83ldy1m9k83-6py1m83ldy1m9k83-*Py1m83ldy1m9k83ujy1m83ldy1m9k83-Gjy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Qtranslate_role_local_name_and_preposition = 
	    ...
	    AB_package);
    string_constant_18 = 
	    STATIC_STRING("13Qy1m833ny834Hy1m833ny83BFy1m833ny1n1m9k9l83gKy833ny1o833ny1o1m9k9l83*my1m9k83-Ty833ny1n9lmo9m1o833ny1p1m9k9l83*my83*Zy1m9k83-T");
    string_constant_19 = 
    ...
    string_constant_20 = 
	    STATIC_STRING("33ny1n9l2l1n830=ymopr1o83gKy1m83-Gy83t4y1mlm9o1o83gKy1n83-Gy83*Zy83t4y1nlmn9p1n83gKy1m1m9k83*ry1m9k83-Ty1n834Zy83*ry83=uy1n83gKy");
    string_constant_21 = 
	    STATIC_STRING("1n1m9k83*ry83*Zy1m9k83-Ty2l1n834Zy83*ry83=uym1n83gKy1m1m9k83b9y1m9k83-Ty1n834Zy83b9y83=uy1n83gKy1n1m9k83b9y83*Zy1m9k83-Ty2l1n834");
    string_constant_22 = 
	    STATIC_STRING("Zy83b9y83=uym1n83t4y1m1m9k8319y1m9k83gMy83kjy1n83t4y1m1m9k83Igy1m9k83=3y83gGy1n83t4y1p1m9k83Igy1m9k83=Gy1m9k9l839jy1m9k83-Ty1m83");
    string_constant_23 = 
	    STATIC_STRING("pvyo1n83t4y1p1m9k83Igy1m9k83=Gy1m9k9l1m9k83dy1m9k83=3y83fDy1n83t4y1p1m9k83Igy1m9k83=Gy1m9k83=ay1m9k83dy1m9k83=3y83fDy1n83t4y1p1m");
    string_constant_24 = 
	    STATIC_STRING("9k83Igy1m9k83=Gy1m9k9l1m9k83dy1m9k83-Ty83fDy1n83t4y1p1m9k83Igy1m9k83=Gy1m9k83=ay1m9k83dy1m9k83-Ty83fDy1n83t4y1p1m9k83Igy1m9k83=G");
    string_constant_25 = 
	    STATIC_STRING("y1m9k9l1m9k83py1m9k83-Ty83fEy1n83t4y1p1m9k83Igy1m9k83=Gy1m9k83=ay1m9k83py1m9k83-Ty83fEy1n83t4y1p1m9k83=Gy1m9k9l1m9k83dy1m9k9q1m9");
    string_constant_26 = 
	    STATIC_STRING("k83-Ty83pty1n83t4y1p1m9k83=Gy1m9k83=ay1m9k83dy1m9k9q1m9k83-Ty83pty1n83t4y1p1m9k83=Gy1m9k9l1m9k83py1m9k9q1m9k83-Ty83puy1n83t4y1p1");
    string_constant_27 = 
	    STATIC_STRING("m9k83=Gy1m9k83=ay1m9k83py1m9k9q1m9k83-Ty83puy1n83t4y1o1m9k83=Gy1m9k83h0y1m9k9q1m9k83-Ty83psy1n83t4y1o1m9k83=Gy1m9k83=ay1m9k9q1m9");
    string_constant_28 = 
	    STATIC_STRING("k83-Ty83psy1m83-OJy833ny1m83-OJy1m9k83Zy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qconstant_designation,
	    ...
	    Qslot_value_writer);
    string_constant_29 = 
	    STATIC_STRING("1t1m83-OLy83-GVy1m83-OLy1n1m9k9l83gKy833ny1m83-OLy1n1m9k9l83-OHy833ny1o83-OHy1m83*my1m9k83-Ty1mlm9m1o83-OHy1o83-Gy1m9k83=my83*my");
    string_constant_30 = 
	    STATIC_STRING("1m9k83-Ty1n830=yln9m1o83-OHy1n83*my83*Zy1m9k83-Ty1nlmn9n1o83-OHy1p83-Gy1m9k83=my83*my83*Zy1m9k83-Ty1n830=yln9m1m8383y83-OLy1m838");
    ...
    string_constant_32 = 
	    STATIC_STRING("1w1m83-OIy833ny1m83-OIy83-juy1m83-juy83-jty1m83-juy83-OKy1n83-jty1n1m9k9l1m9k83-2y83-2y1m83vyn1m83-OKy83Sy1m83-OKy83=By1m83-OKy9");
    string_constant_33 = 
	    STATIC_STRING("m1m83-OKy834my1m83-OKy83-Uy1m83-OKy830Sy1m83-OKy8s");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    ...
    string_constant_35 = 
	    STATIC_STRING("1s1m833*y83-7dy1m830By83-7dy1m8330y83-7dy1o83-7dy1m83*Zy83-psy1o9k1m83Wdy83=Kylm9l1o83-7dy1o1m9m83-9y830By1m9m83-Ay83-psy1o9k1m8");
    string_constant_36 = 
	    STATIC_STRING("3Wdy83=Kymo9l1m83-psy83r6y1m83-psy1m83r6y83-psy1n83r6y1n1m9m832sy83=xy1m9m832ty1mlm");
    clear_optimized_constants();
    push_optimized_constant(Qthe);
    ...
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_35,
	    string_constant_36)));
    string_constant_37 = 
	    STATIC_STRING("1q1m83F2y83-oMy1o83-oMy1m83*Zy83-oTy1o9k1m83Wdy83=Kylm9l1o83-oMy1o1m9m83-9y83F2y1m9m83-Ay83-oTy1o9k1m83Wdy83=Kymo9l1m83-oTy83-oD");
    string_constant_38 = 
	    STATIC_STRING("y1m83-oTy1m83r6y83-oTy1n83-oDy1n1m9m832sy836Ey1m9m832ty1mlm");
    clear_optimized_constants();
    push_optimized_constant(Qthe);
    push_optimized_constant(Qreparse_nth_element_designation);
    push_optimized_constant(Qquote);
