...
Object Ok_file_saving_mode_qm = UNBOUND;
...
Object Slots_to_skip_saving_in_ok_files = UNBOUND;

Object The_type_description_of_kb_transfer = UNBOUND;

Object Chain_of_available_kb_transfers = UNBOUND;

Object Kb_transfer_count = UNBOUND;
    ...
    Object kb_transfer;
{
    ...
    svref_new_value = Chain_of_available_kb_transfers;
    SVREF(kb_transfer,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_kb_transfers = kb_transfer;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_kb_transfer_variable, kb_transfer_count_new_value;
    ...
    kb_transfer_count_new_value = FIXNUM_ADD1(Kb_transfer_count);
    Kb_transfer_count = kb_transfer_count_new_value;
...
Object Available_kb_fsn_hash_table_hash_vector_131_vectors = UNBOUND;

Object Count_of_kb_fsn_hash_table_hash_vector_131_vectors = UNBOUND;
...
{
    Object count_of_kb_fsn_hash_table_hash_vector_131_vectors_new_value, temp;
    XDeclare_area(1);

    x_note_fn_call(134,10);
    count_of_kb_fsn_hash_table_hash_vector_131_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_kb_fsn_hash_table_hash_vector_131_vectors);
...
Object make_kb_fsn_hash_table_hash_vector()
{
    ...
    if (Available_kb_fsn_hash_table_hash_vector_131_vectors) {
	temp = M_CAR(Available_kb_fsn_hash_table_hash_vector_131_vectors);
	temp_1 = M_CDR(Available_kb_fsn_hash_table_hash_vector_131_vectors);
	inline_note_reclaim_cons(Available_kb_fsn_hash_table_hash_vector_131_vectors,
		Qab_gensym);
	cdr_arg = Available_kb_fsn_hash_table_hash_vector_131_vectors;
	...
	Available_kb_fsn_hash_table_hash_vector_131_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object kb_fsn_hash_table_hash_vector_131_vector;
{
    ...
    cdr_new_value = Available_kb_fsn_hash_table_hash_vector_131_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_kb_fsn_hash_table_hash_vector_131_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}

/* MUTATE-KB-FSN-HASH-TABLE-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_kb_fsn_hash_table_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
...
Object Fp_mutate_kb_fsn_hash_table_tree_for_hash_tree_entry = UNBOUND;

static Object Qframe_serial_number_equal_function;  /* frame-serial-number-equal-function */

/* CLEAR-KB-FSN-HASH-TABLE-TREE */
Object clear_kb_fsn_hash_table_tree(kb_fsn_hash_table_tree_for_hash_binary_tree)
    Object kb_fsn_hash_table_tree_for_hash_binary_tree;
{
    ...
    element_qm = Nil;
  next_loop:
    element_qm = CDR(kb_fsn_hash_table_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    ...
    temp = 
	    ...
	    gensymed_symbol,kb_fsn_hash_table_tree_for_hash_binary_tree,
	    frame_serial_number_hash_function(gensymed_symbol));
    old_key = temp;
    reclaim_frame_serial_number(old_key);
    goto next_loop;
  end_loop:;
    return VALUES_1(kb_fsn_hash_table_tree_for_hash_binary_tree);
}
...
Object reclaim_kb_fsn_hash_table(kb_fsn_hash_table_hash_table)
    Object kb_fsn_hash_table_hash_table;
{
    Object kb_fsn_hash_table_tree_for_hash_binary_tree, element_qm;
    Object gensymed_symbol, temp, old_key, cdr_new_value;
    SI_Long index_1;
  ...
  next_loop:
    if (index_1 >= (SI_Long)131L)
	goto end_loop;
    kb_fsn_hash_table_tree_for_hash_binary_tree = 
	    ISVREF(kb_fsn_hash_table_hash_table,index_1);
    element_qm = Nil;
  next_loop_1:
    element_qm = M_CDR(kb_fsn_hash_table_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(kb_fsn_hash_table_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(kb_fsn_hash_table_tree_for_hash_binary_tree) = cdr_new_value;
    Available_gensym_conses = kb_fsn_hash_table_tree_for_hash_binary_tree;
    ...
    Object frame_reference_balance_binary_tree;
{
  ...
  end_loop_1:;
	...
	frame_reference_balance_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
...
Object Chain_of_available_kb_saves = UNBOUND;

Object Kb_save_count = UNBOUND;
...
Object reclaim_kb_save_1(kb_save)
    Object kb_save;
{
    Object old_structure_being_reclaimed, frame_reference_balance_binary_tree;
    Object element_qm, temp, thing;
    ...
    if (element_qm)
	reclaim_frame_reference_balance_leaves(element_qm);
    inline_note_reclaim_cons(frame_reference_balance_binary_tree,Qab_gensym);
    temp = Available_gensym_conses;
    M_CDR(frame_reference_balance_binary_tree) = temp;
    Available_gensym_conses = frame_reference_balance_binary_tree;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    temp = Chain_of_available_kb_saves;
    SVREF(kb_save,FIX((SI_Long)0L)) = temp;
    Chain_of_available_kb_saves = kb_save;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_kb_save_variable, kb_save_count_new_value;
    Object defstruct_g2_kb_save_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(134,25);
    def_structure_kb_save_variable = Nil;
    kb_save_count_new_value = FIXNUM_ADD1(Kb_save_count);
    Kb_save_count = kb_save_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_kb_save_variable, svref_new_value, new_cons;
	...
	Chain_of_available_kb_saves = 
		ISVREF(def_structure_kb_save_variable,(SI_Long)0L);
    ...
    svref_new_value = make_kb_fsn_hash_table();
    SVREF(def_structure_kb_save_variable,FIX((SI_Long)20L)) = svref_new_value;
    ...
    svref_new_value = obtain_simple_gensym_string(Write_kb_buffer_length);
    SVREF(def_structure_kb_save_variable,FIX((SI_Long)25L)) = svref_new_value;
    ...
    svref_new_value = 
	    gensym_cons_1(gensym_list_2(copy_frame_serial_number(Current_frame_serial_number),
	    Kkb),Nil);
    SVREF(def_structure_kb_save_variable,FIX((SI_Long)39L)) = svref_new_value;
    svref_new_value = obtain_simple_gensym_string(Write_kb_buffer_length);
    SVREF(def_structure_kb_save_variable,FIX((SI_Long)40L)) = svref_new_value;
...
Object Kb_object_index_property_name_pool = UNBOUND;

Object Next_object_index_property_number = UNBOUND;
...
Object Chain_of_available_saving_contexts = UNBOUND;

Object Saving_context_count = UNBOUND;
    ...
    Object saving_context;
{
    ...
    reclaim_gensym_list_1(ISVREF(saving_context,(SI_Long)1L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_saving_contexts;
    SVREF(saving_context,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_saving_contexts = saving_context;
    return VALUES_1(Nil);
}
...
Object make_permanent_saving_context_structure_internal()
{
    ...
    Object saving_context_count_new_value;
    ...
    saving_context_count_new_value = FIXNUM_ADD1(Saving_context_count);
    Saving_context_count = saving_context_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_saving_context_variable, svref_new_value;
    ...
    svref_new_value = get_unix_time_to_the_second_as_managed_float();
    SVREF(def_structure_saving_context_variable,FIX((SI_Long)5L)) = 
	    svref_new_value;
...
Object Current_saving_context = UNBOUND;

Object Current_kb_save = UNBOUND;

Object Continuation_task_for_current_backup = UNBOUND;
...
Object flush_kb_write_buffer()
{
	...
	svref_new_value = nconc2(temp,
		gensym_cons_1(make_current_kb_write_buffer_copy(),Nil));
...
Object flush_compiled_kb_write_buffer()
{
	...
	svref_new_value = nconc2(temp,
		gensym_cons_1(make_current_compiled_kb_write_buffer_copy(),
		Nil));
...
Object reclaim_deferred_kb_save_write_buffers(buffer_list)
    Object buffer_list;
{
    Object buffer, gensym_pop_store, cons_1, next_cons, cdr_new_value;
...
{
    Object buffer, status, gensym_pop_store, svref_arg_1, cons_1, next_cons;
...
{
    Object ht, temp_1, gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_4;
    Object temp_2, svref_arg_1, svref_new_value;
  ...
  next_loop:
	...
	if (frame_serial_number_equal_function(gensymed_symbol_2,
		gensymed_symbol_4)) {
  ...
  end_2:;
	...
	temp_1 = Fp_mutate_kb_fsn_hash_table_tree_for_hash_tree_entry;
	svref_arg_1 = Current_kb_save;
	svref_new_value = add1(ISVREF(svref_arg_1,(SI_Long)21L));
	temp_1 = set_balanced_binary_tree_entry(temp_2,
    ...
    Object symbol, indexed_qm;
{
	...
	if (indexed_qm) {
	    ...
	    temp = Current_kb_save;
	    temp_1 = gensym_cons_1(symbol,ISVREF(Current_kb_save,
		    (SI_Long)28L));
	...
	if (value) {
	  ...
	  end_1:;
	    temp_1 = temp ? old_slot_value : 
		    gensym_cons_1(ISVREF(Current_kb_save,(SI_Long)37L),
		    old_slot_value);
	}
	else
	    temp_1 = delete_gensym_element_1(ISVREF(Current_kb_save,
...
Object Saving_parameters = UNBOUND;
    ...
    next_loop:
	  ...
	  next_loop_2:
		...
		if ( !((SI_Long)0L != (IFIX(ISVREF(object_frame,
			...
			ab_loopvar__2 = gensym_cons_1(object_frame,Nil);
		    else {
			...
			ab_loopvar__2 = block_denotation_qm && 
				object_frame_denotation_qm ? 
				gensym_cons_1(object_frame_denotation_qm,
				Nil) : Nil;
		    }
		}
		else
	  ...
	  temp = gensym_cons_1(nconc2(gensym_list_2(temp_3,temp),
		  object_class_references_for_saving_qm),Nil);
      }
      else
	  temp = Nil;
...
Object Frame_for_write_frame_for_kb = UNBOUND;

Object Slot_name_for_write_frame_for_kb = UNBOUND;

Object Slot_value_for_write_frame_for_kb = UNBOUND;
...
Object write_frame_for_kb varargs_1(int, n)
{
    ...
    Object slot_features, gensym_push_modify_macro_arg, car_1, cdr_1, temp_2;
    Object slot_value_to_save_qm;
    ...
    PUSH_SPECIAL(Frame_for_write_frame_for_kb,frame_for_write_frame_for_kb,1);
	  ...
	  PUSH_SPECIAL(Slot_name_for_write_frame_for_kb,slot_name_for_write_frame_for_kb,
		  0);
	  ...
	  next_loop:
		...
		gensym_push_modify_macro_arg = ISVREF(slot_description,
			(SI_Long)1L);
...
Object Chain_of_available_pseudo_frames = UNBOUND;

Object Pseudo_frame_count = UNBOUND;
    ...
    Object pseudo_frame;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_pseudo_frames;
    SVREF(pseudo_frame,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_pseudo_frames = pseudo_frame;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_pseudo_frame_variable, pseudo_frame_count_new_value;
    Object defstruct_g2_pseudo_frame_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(134,83);
    def_structure_pseudo_frame_variable = Nil;
    pseudo_frame_count_new_value = FIXNUM_ADD1(Pseudo_frame_count);
    Pseudo_frame_count = pseudo_frame_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object evaluation_value;
{
    ...
    PUSH_SPECIAL(Current_module_qm,current_module_qm,0);
...
Object Compiled_kb_indent = UNBOUND;
    ...
    Object form, c_type;
{
	...
	PUSH_SPECIAL(Compiled_kb_indent,compiled_kb_indent,0);
	  write_newline_for_compiled_kb();
	  name = Nil;
	  value = Nil;
    ...
    Object form;
{
	...
	if (EQ(temp,Qtagbody))
	    ...
	    write_gensym_string_for_compiled_kb(string_constant_33);
	    compiled_kb_indent = FIX(IFIX(Compiled_kb_indent) + (SI_Long)2L);
	    PUSH_SPECIAL(Compiled_kb_indent,compiled_kb_indent,1);
	      clause = Nil;
	      ab_loop_list_ = CDDR(form);
	    next_loop:
	      if ( !TRUEP(ab_loop_list_))
...
static Object Qcode_body;          /* code-body */
...
Object Write_all_byte_code_bodies_for_kb_p = UNBOUND;
    ...
    Object frame;
{
	...
	if (temp) {
	    ...
	    gensym_push_modify_macro_arg = gensym_cons_1(temp_1,
		    gensym_cons_1(frame,Nil));
	    car_1 = gensym_push_modify_macro_arg;
    ...
    Object kb_name;
{
	...
	if (SEVENTH(Consistency_tree_focus_shifts))
	    plist = nconc2(plist,gensym_list_2(Qclass_hierarchy_flags,
		    SEVENTH(Consistency_tree_focus_shifts)));
	if (Evaluator_tradeoff_info)
	    plist = nconc2(plist,gensym_list_2(Qgraphics_tuning_bits,
		    Evaluator_tradeoff_info));
	if (Drawing_task_tuning_info)
	    plist = nconc2(plist,gensym_list_2(Qperformance_tuning_bits,
		    Drawing_task_tuning_info));
	if ( !EQ(Qreal_time,ISVREF(Timing_parameters,(SI_Long)22L)))
	    nconc2(plist,gensym_list_2(Qsimulated_time,Gensym_time));
	...
	SAVE_VALUES(reclaim_gensym_list_1(plist));
    }
    POP_UNWIND_PROTECT(0);
    if (clean_version) {
    ...
    Object pane_description_qm, timestamp;
{
    ...
    temp_2 = pane_description_qm ? gensym_list_2(Qdetail_pane_description,
	    pane_description_qm) : Nil;
    plist = nconc2(gensymed_symbol,nconc2(temp_2,
	    nconc2(ISVREF(Current_kb_save,(SI_Long)11L) ? 
	    gensym_list_2(Qnumeric_symbols,ISVREF(Current_kb_save,
	    (SI_Long)11L)) : Nil,ISVREF(Current_kb_save,(SI_Long)35L) ? 
	    gensym_list_2(Qoriginal_kb_state_plist_written_qm,T) : Nil)));
    write_element_for_kb(plist);
...
Object Left_braket_written_qm = UNBOUND;
    ...
    Object block;
{
	...
	next_loop:
	  ...
	  converted_value_qm = nconc2(temp,object_frames_for_saving_qm ? 
		  gensym_cons_1(nconc2(gensym_list_2(CONSP(relation_instance) 
    ...
    Object definition;
{
    ...
    Object resulting_value, relation_instances_slot_description;
    Object slot_value_to_save, vector_slot_index_qm, user_vector_slot_index_qm;
    Object slot_name, lookup_structure_qm, slot_index_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, max_i, i, ab_loop_bind_;

    x_note_fn_call(134,133);
	...
	if (EQ(unique_slot_name,Qrelation_instances)) {
	    ...
	    gensymed_symbol_1 = Qdefinition;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(Qdefinition) & 
...
void kb_save1_INIT()
{
    ...
    Object Qleft_braket_written_qm, Qfloat_register_2, Qfloat_register_1;
    Object Qfixnum_register_2, Qfixnum_register_1, Qcall_function;
    Object Qcall_simple_function, Qget_variable, Qget_constant;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qpseudo_frame;
    Object Qreclaim_structure, Qoutstanding_pseudo_frame_count;
    Object Qpseudo_frame_structure_memory_usage, Qutilities2;
    Object Qpseudo_frame_count, Qchain_of_available_pseudo_frames;
    ...
    Object Qcontinuation_task_for_current_backup, Qcurrent_saving_context_qm;
    Object Qsaving_context, Qoutstanding_saving_context_count;
    Object Qsaving_context_structure_memory_usage, Qsaving_context_count;
    Object Qchain_of_available_saving_contexts, string_constant_65;
    Object string_constant_64, list_constant_8, Qreclaim_gensym_list_function;
    Object Qkb_object_index_property_name_pool, Qoutstanding_kb_save_count;
    Object Qkb_save_structure_memory_usage, Qkb_save_count;
    Object Qchain_of_available_kb_saves, string_constant_63;
    Object string_constant_62;
    Object Qmutate_kb_fsn_hash_table_tree_for_hash_tree_entry;
    Object Qout_kb_fsn_hash_table_hash_vector_131_vectors;
    Object Qkb_fsn_hash_table_hash_vector_131_vector_memory_usage;
    Object string_constant_61;
    Object Qcount_of_kb_fsn_hash_table_hash_vector_131_vectors;
    Object Qavailable_kb_fsn_hash_table_hash_vector_131_vectors;
    Object Qwrite_kb_buffer_length, Qkb_transfer;
    Object Qoutstanding_kb_transfer_count, Qkb_transfer_structure_memory_usage;
    Object Qkb_transfer_count, Qchain_of_available_kb_transfers;
    ...
    string_constant_60 = STATIC_STRING("1q83DKy8s83-b*y09k9l");
    ...
    Qkb_fsn_hash_table_hash_vector_131_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_61 = STATIC_STRING("1q83-avy83*By83-Oxy09k9l");
    clear_optimized_constants();
    ...
    Qmutate_kb_fsn_hash_table_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-KB-FSN-HASH-TABLE-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_kb_fsn_hash_table_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_kb_fsn_hash_table_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_kb_fsn_hash_table_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_kb_fsn_hash_table_tree_for_hash_tree_entry);
    ...
    string_constant_62 = 
	    STATIC_STRING("43Dy8m83THy1o83THy83DKy8n8k1l83DKy0000001m1m8x83DKy1m8y83-4kyk3kyk0k0");
    ...
    string_constant_63 = STATIC_STRING("1q83THy8s83-b-y09k9l");
    clear_optimized_constants();
    ...
    string_constant_64 = 
	    STATIC_STRING("43Dy8m83mhy1n83mhy8n8k1l8n0000001l1n8y83-5hy1q83-2My83-FUy83-CIy83-CJy83-CLy83-CKykvk0k0");
    ...
    string_constant_65 = STATIC_STRING("1q83mhy8s83-m9y09k9l");
    clear_optimized_constants();
    ...
    string_constant_66 = 
	    STATIC_STRING("43Dy8m83luy1n83luy8n8k1l8n0000001l1n8y83-5Fy1m83-9dy83-9cyknk0k0");
    ...
    string_constant_67 = STATIC_STRING("1q83luy8s83-jTy09k9l");
    clear_optimized_constants();
