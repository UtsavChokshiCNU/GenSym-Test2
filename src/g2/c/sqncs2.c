...
Object Pulse_rate_multiplier = UNBOUND;
...
Object Pulse_rate_options = UNBOUND;
...
Object put_expiration_date_where_slot_is_absent(frame,value)
    Object frame, value;
{
    x_note_fn_call(108,29);
    return VALUES_1(Nil);
}

Object Ok_modified = UNBOUND;

Object Ok_authorized_products = UNBOUND;

Object Ok_expiration_date_qm = UNBOUND;

Object Ok_authorized_packages = UNBOUND;

Object Ok_make_g2_secure_qm = UNBOUND;

Object Ok_number_of_processes_authorized = UNBOUND;

Object Ok_maximum_number_of_concurrent_floating_telewindows_allowed = UNBOUND;

Object Ok_maximum_number_of_concurrent_floating_tw2_allowed = UNBOUND;
...
Object Reference_date_for_interval_encoding = UNBOUND;
...
Object Floating_telewindows_limit = UNBOUND;

Object Floating_tw2_limit = UNBOUND;
...
Object Ctlc_cons_count = UNBOUND;

Object The_type_description_of_t2_nonce_data = UNBOUND;

Object Chain_of_available_t2_nonce_datas = UNBOUND;

Object T2_nonce_data_count = UNBOUND;
    ...
    Object t2_nonce_data;
{
    ...
    x_note_fn_call(108,64);
    inline_note_reclaim_cons(t2_nonce_data,Nil);
    svref_new_value = Chain_of_available_t2_nonce_datas;
    SVREF(t2_nonce_data,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_t2_nonce_datas = t2_nonce_data;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_t2_nonce_data_variable, t2_nonce_data_count_new_value;
    Object defstruct_g2_t2_nonce_data_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(108,66);
    def_structure_t2_nonce_data_variable = Nil;
    t2_nonce_data_count_new_value = FIXNUM_ADD1(T2_nonce_data_count);
    T2_nonce_data_count = t2_nonce_data_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object server_parameters;
{
    ...
    x_note_fn_call(108,87);
    PUSH_SPECIAL(Server_parameters,server_parameters,0);
...
Object Consider_asian_language_initializations_qm = UNBOUND;

Object Text_representation_of_our_ok_object = UNBOUND;

Object Authorized_products_of_this_machine = UNBOUND;
...
Object Default_format_structure = UNBOUND;
    ...
    Object ok;
{
    ...
    Object def_structure_schedule_task_variable, new_task, gensymed_symbol;
    ...
    Object code_2x, code_3x, code_4x, temp_3, checksum, date, start_date_qm;
    Object end_date_1, day, month, year, notification_text_string, system_1;
    Object option, cons_1, frame_note_qm, pkg, ab_loop_list_, ab_loopvar_;
    Object ab_loopvar__1, ab_loopvar__2, visible_product, code;
    ...
    SI_Long gensymed_symbol_8, gensymed_symbol_9, start_date, end_date;
    char temp_1;
    Declare_special(5);
    Object result;

    x_note_fn_call(108,98);
	...
	if ((SI_Long)18L <= IFIX(THIRD(Keytab_interface_inset))) {
	    ...
	    ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)0L);
	    ...
	    temp_2 = Immediate_task_queue;
	    SVREF(temp_2,FIX((SI_Long)1L)) = gensymed_symbol_1;
	...
	gensymed_symbol_2 = IFIX(inner_multiply(modularized_key,code_3x));
	gensymed_symbol_3 = IFIX(inner_multiply(code_1x,
		authorized_products_code));
	gensymed_symbol_4 = IFIX(inner_multiply(code_2x,code_4x));
	temp_3 = expiration_date_qm;
	if (temp_3);
	else
	...
	if (temp);
	    ...
	    temp = FIX((SI_Long)0L);
	gensymed_symbol_5 = IFIX(inner_multiply(temp_3,temp));
	gensymed_symbol_6 = number_of_processes_authorized ? 
		IFIX(inner_multiply(code_3x,
		number_of_processes_authorized)) : (SI_Long)0L;
	gensymed_symbol_7 = number_of_processes_authorized ? 
		IFIX(inner_multiply(code_4x,
		FIX(IFIX(number_of_processes_authorized) << (SI_Long)8L))) 
		: (SI_Long)0L;
	gensymed_symbol_8 = IFIX(inner_multiply(code_1x,
		maximum_number_of_concurrent_floating_telewindows_allowed));
	gensymed_symbol_9 = IFIX(inner_multiply(code_2x,
		FIX(IFIX(maximum_number_of_concurrent_floating_telewindows_allowed) 
		<< (SI_Long)8L)));
	checksum = mod(FIX(gensymed_symbol_2 ^ gensymed_symbol_3 ^ 
		gensymed_symbol_4 ^ gensymed_symbol_5 ^ gensymed_symbol_6 
		^ gensymed_symbol_7 ^ gensymed_symbol_8 ^ 
		gensymed_symbol_9),modulus);
	...
	if (temp_1);
		...
		gensymed_symbol = Format_structure_description;
		M_CAR(gensymed_symbol) = code_5;
		gensymed_symbol = M_CDR(gensymed_symbol);
		...
		M_CAR(gensymed_symbol) = temp_2;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = code_1;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = code_2;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = code_3;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = code_4;
		gensymed_symbol = M_CDR(gensymed_symbol);
		cons_1 = nth(FIX((SI_Long)10L),Format_structure_description);
		M_CAR(cons_1) = authorized_products_code;
		M_CAR(gensymed_symbol) = cons_1;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = expiration_date_qm;
		gensymed_symbol = M_CDR(gensymed_symbol);
		...
		ab_loopvar_ = Qnil;
	      end_1:;
		M_CAR(gensymed_symbol) = ab_loopvar_;
		gensymed_symbol = M_CDR(gensymed_symbol);
		M_CAR(gensymed_symbol) = number_of_processes_authorized;
		gensymed_symbol = M_CDR(gensymed_symbol);
		...
		second_new_value = FIXNUM_ADD1(SECOND(temp_2));
		M_SECOND(temp_2) = second_new_value;
...
Object Redef_class_instance = UNBOUND;

Object System_slot_accessor = UNBOUND;

Object Color_code_differences = UNBOUND;

Object Alternate_chaining_queue = UNBOUND;

Object Revert_to_fuzzy_cache_p = UNBOUND;
...
Object replace_format_using_equivalent_font(class_1)
    Object class_1;
{
    Object cons_1, ab_loop_iter_flag_, temp, future_task_schedule_modify_arg_8;
    Object future_task_schedule_modify_arg_11, old_structure_being_reclaimed;
    Object svref_new_value, def_structure_schedule_task_variable, task;
    SI_Long i;
    char svref_new_value_1;
    double future_task_schedule_modify_arg_3, aref_new_value;

    x_note_fn_call(108,103);
	...
	future_task_schedule_modify_arg_3 = 
		DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 2.0;
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qcall_post_prominent_notification);
	future_task_schedule_modify_arg_11 = 
		copy_text_string(SECOND(Color_code_differences));
	if (Alternate_chaining_queue) {
	    if (EQ(Alternate_chaining_queue,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Alternate_chaining_queue,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Alternate_chaining_queue);
	    inline_note_reclaim_cons(Alternate_chaining_queue,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Alternate_chaining_queue;
	    reclaim_schedule_task_args(ISVREF(Alternate_chaining_queue,
		    (SI_Long)9L));
	    temp = Alternate_chaining_queue;
	    SVREF(temp,FIX((SI_Long)9L)) = Nil;
	    Structure_being_reclaimed = old_structure_being_reclaimed;
	    temp = Alternate_chaining_queue;
	    svref_new_value = Chain_of_available_schedule_tasks;
	    SVREF(temp,FIX((SI_Long)0L)) = svref_new_value;
	    Chain_of_available_schedule_tasks = Alternate_chaining_queue;
	}
	def_structure_schedule_task_variable = 
		Chain_of_available_schedule_tasks;
	if (def_structure_schedule_task_variable) {
	...
	ISVREF(task,(SI_Long)10L) = FIX((SI_Long)4L);
	SVREF(task,FIX((SI_Long)11L)) = future_task_schedule_modify_arg_11;
	ISVREF(task,(SI_Long)12L) = FIX((SI_Long)900L);
	ISVREF(task,(SI_Long)13L) = FIX((SI_Long)700L);
	SVREF(task,FIX((SI_Long)14L)) = T;
	future_task_schedule_2(task);
	Alternate_chaining_queue = task;
	future_task_schedule_modify_arg_3 = 
		DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 4.0;
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qredraw_solid_rectangles_without_overlap);
	if (Revert_to_fuzzy_cache_p) {
	    if (EQ(Revert_to_fuzzy_cache_p,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Revert_to_fuzzy_cache_p,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Revert_to_fuzzy_cache_p);
	    inline_note_reclaim_cons(Revert_to_fuzzy_cache_p,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Revert_to_fuzzy_cache_p;
	    reclaim_schedule_task_args(ISVREF(Revert_to_fuzzy_cache_p,
		    (SI_Long)9L));
	    temp = Revert_to_fuzzy_cache_p;
	    SVREF(temp,FIX((SI_Long)9L)) = Nil;
	    Structure_being_reclaimed = old_structure_being_reclaimed;
	    temp = Revert_to_fuzzy_cache_p;
	    svref_new_value = Chain_of_available_schedule_tasks;
	    SVREF(temp,FIX((SI_Long)0L)) = svref_new_value;
	    Chain_of_available_schedule_tasks = Revert_to_fuzzy_cache_p;
	}
	def_structure_schedule_task_variable = 
		Chain_of_available_schedule_tasks;
	if (def_structure_schedule_task_variable) {
	...
	SVREF(task,FIX((SI_Long)11L)) = Nil;
	future_task_schedule_2(task);
	Revert_to_fuzzy_cache_p = task;
	return VALUES_1(Revert_to_fuzzy_cache_p);
    }
    else
	return VALUES_1(Nil);
}
...
Object Cached_matching_machine_id_qm = UNBOUND;
...
Object Grammar_rules_to_add_for_nupec_after_authorization = UNBOUND;
...
Object Daily_countdown = UNBOUND;

Object Hourly_countdown = UNBOUND;

Object Hour_of_last_message = UNBOUND;

Object Operative_task_list = UNBOUND;

Object Smoothed_subsecond_adjustment = UNBOUND;

/* PRINT-MESSAGE-WITH-LIST */
Object print_message_with_list(list_1,text)
    Object list_1, text;
{
    x_note_fn_call(108,108);
    twrite(text);
...
Object write_permitted_mode_list_from_slot(value,gensymed_symbol)
    Object value, gensymed_symbol;
{
    x_note_fn_call(108,114);
    return write_symbol_list(1,value);
}

Object Time_of_last_call_to_set_user_password = UNBOUND;
...
Object Authorized_users_list = UNBOUND;

Object Updated_users_list = UNBOUND;

/* AUTHORIZED-USER-P */
Object authorized_user_p(user_name)
    Object user_name;
{
    x_note_fn_call(108,117);
    ...
    Object encoded_password;
{
    ...
    x_note_fn_call(108,140);
    current_wide_string_list = Qdo_not_use;
    PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,9);
      wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
	      (SI_Long)3L));
      bv16_length = IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(wide_string_bv16));
      aref_arg_2 = bv16_length - (SI_Long)2L;
      ...
      UBYTE_16_ISASET_1(wide_string_bv16,(SI_Long)2048L,(SI_Long)0L);
      current_wide_string = wide_string_bv16;
      PUSH_SPECIAL(Current_wide_string,current_wide_string,8);
	fill_pointer_for_current_wide_string = FIX((SI_Long)0L);
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		7);
	  length_1 = IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(Current_wide_string));
...
Object Font_feature_list = UNBOUND;

Object Roman_character_map = UNBOUND;

Object Feature_blt = UNBOUND;
...
Object Write_proprietary_package_while_saving_xml_kb = UNBOUND;
...
Object Simulate_proprietary_qm = UNBOUND;
...
Object Supported_ok_file_format_version = UNBOUND;
...
Object G2_stream_of_ok_file_reader = UNBOUND;

Object Buffer_of_ok_file_reader = UNBOUND;

Object Buffer_index_of_ok_file_reader = UNBOUND;

Object Characters_in_buffer_of_ok_file_reader_qm = UNBOUND;

Object Buffer_length_of_ok_file_reader = UNBOUND;

Object Unread_char_of_ok_file_reader_qm = UNBOUND;

Object Line_number_of_ok_file_reader = UNBOUND;
...
Object compute_process_initial_value_for_pad_for_ok_file_reader()
{
    ...
    x_note_fn_call(108,159);
    temp = make_string(1,FIX((SI_Long)100L));
    return VALUES_1(temp);
}

Object Pad_for_ok_file_reader = UNBOUND;

Object Error_of_ok_file_reader_qm = UNBOUND;

Object File_format_version_of_g2_ok_file_qm = UNBOUND;

Object Authorized_user_records_of_g2_ok_file = UNBOUND;

Object Useful_machine_authorization_info = UNBOUND;

Object Slot_pad_of_ok_file_reader = UNBOUND;

Object Success_of_ok_file_reader_qm = UNBOUND;

Object Saw_more_than_one_machine_authorization_qm = UNBOUND;

Object Current_machine_ids_of_g2_ok_file_qm = UNBOUND;

Object Read_ok_file_buffer_1 = UNBOUND;
...
Object Chain_of_available_ok_file_tokens = UNBOUND;

Object Ok_file_token_count = UNBOUND;
    ...
    Object ok_file_token;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_ok_file_tokens;
    SVREF(ok_file_token,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_ok_file_tokens = ok_file_token;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_ok_file_token_variable, ok_file_token_count_new_value;
    Object defstruct_g2_ok_file_token_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(108,170);
    def_structure_ok_file_token_variable = Nil;
    ok_file_token_count_new_value = FIXNUM_ADD1(Ok_file_token_count);
    Ok_file_token_count = ok_file_token_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_ok_file_token_variable, svref_new_value;

    x_note_fn_call(108,171);
    def_structure_ok_file_token_variable = Chain_of_available_ok_file_tokens;
    ...
    svref_new_value = Line_number_of_ok_file_reader;
    SVREF(def_structure_ok_file_token_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    SVREF(def_structure_ok_file_token_variable,FIX((SI_Long)4L)) = Nil;
    return VALUES_1(def_structure_ok_file_token_variable);
}

Object Contour_of_ok_file_tokens = UNBOUND;
    ...
    Object kind, text;
{
    ...
    x_note_fn_call(108,172);
    result_1 = make_ok_file_token_1_1(kind,text);
    Contour_of_ok_file_tokens = gensym_cons_1(result_1,
...
Object reclaim_contour_of_ok_file_tokens()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(Contour_of_ok_file_tokens);
    ...
    Object value;
{
	...
	return reclaim_gensym_cons_1(value);
    }
    else {
    ...
    Object token_or_value;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(coerce_token_to_lisp(i),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
Object Unbound_value_for_ok_reader = UNBOUND;
...
Object read_ok_file varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Error_of_ok_file_reader_qm,error_of_ok_file_reader_qm,15);
      line_number_of_ok_file_reader = FIX((SI_Long)-1L);
      PUSH_SPECIAL(Line_number_of_ok_file_reader,line_number_of_ok_file_reader,
	      14);
	...
	if (PUSH_UNWIND_PROTECT(0)) {
		...
		PUSH_SPECIAL(G2_stream_of_ok_file_reader,g2_stream_of_ok_file_reader,
			13);
		  buffer_of_ok_file_reader = Read_ok_file_buffer_1;
		  PUSH_SPECIAL(Buffer_of_ok_file_reader,buffer_of_ok_file_reader,
			  12);
		    buffer_length_of_ok_file_reader = 
			    length(Buffer_of_ok_file_reader);
		    PUSH_SPECIAL(Buffer_length_of_ok_file_reader,buffer_length_of_ok_file_reader,
			    11);
		      unread_char_of_ok_file_reader_qm = Nil;
		      PUSH_SPECIAL(Unread_char_of_ok_file_reader_qm,unread_char_of_ok_file_reader_qm,
			      10);
			characters_in_buffer_of_ok_file_reader_qm = 
				g2_stream_read_into_buffer(Buffer_of_ok_file_reader,
				Buffer_length_of_ok_file_reader,
				G2_stream_of_ok_file_reader);
			PUSH_SPECIAL(Characters_in_buffer_of_ok_file_reader_qm,characters_in_buffer_of_ok_file_reader_qm,
				9);
			  buffer_index_of_ok_file_reader = FIX((SI_Long)0L);
			  PUSH_SPECIAL(Buffer_index_of_ok_file_reader,buffer_index_of_ok_file_reader,
				  8);
			    line_number_of_ok_file_reader = FIX((SI_Long)1L);
			    PUSH_SPECIAL(Line_number_of_ok_file_reader,line_number_of_ok_file_reader,
				    7);
			      file_format_version_of_g2_ok_file_qm = Nil;
			      PUSH_SPECIAL(File_format_version_of_g2_ok_file_qm,file_format_version_of_g2_ok_file_qm,
				      6);
				authorized_user_records_of_g2_ok_file = Nil;
				PUSH_SPECIAL(Authorized_user_records_of_g2_ok_file,authorized_user_records_of_g2_ok_file,
					5);
				  useful_machine_authorization_info = Nil;
				  PUSH_SPECIAL(Useful_machine_authorization_info,useful_machine_authorization_info,
					  4);
				    success_of_ok_file_reader_qm = Nil;
				    PUSH_SPECIAL(Success_of_ok_file_reader_qm,success_of_ok_file_reader_qm,
					    3);
				      saw_more_than_one_machine_authorization_qm 
					      = Nil;
				      PUSH_SPECIAL(Saw_more_than_one_machine_authorization_qm,saw_more_than_one_machine_authorization_qm,
					      2);
					slot_pad_of_ok_file_reader = 
						allocate_managed_simple_vector(FIX((SI_Long)20L));
					PUSH_SPECIAL(Slot_pad_of_ok_file_reader,slot_pad_of_ok_file_reader,
						1);
					  if ( 
					  ...
					  contour_of_ok_file_tokens = Nil;
					  PUSH_SPECIAL(Contour_of_ok_file_tokens,contour_of_ok_file_tokens,
						  0);
...
Object read_g2_ok_file_entity()
{
    ...
    x_note_fn_call(108,192);
    saw_at_least_one_machine_authorization_qm = Nil;
    contour_of_ok_file_tokens = Nil;
    PUSH_SPECIAL(Contour_of_ok_file_tokens,contour_of_ok_file_tokens,0);
...
Object read_machine_ok_file_entry()
{
	...
	next_loop_2:
	  ...
	  if ((SI_Long)4L < IFIX(length(element))) {
	      ...
	      temp_1 = gensym_cons_1(temp_1,
		      nconc2(copy_list_using_gensym_conses_1(nthcdr(FIX((SI_Long)9L),
		      element)),gensym_list_2(from_date_qm,to_date_qm)));
	  }
	  else
	      temp_1 = copy_list_using_gensym_conses_1(element);
	...
	end_3:;
	  ...
	  if (PUSH_AREA(Dynamic_area,0)) {
	      ...
	      reclaim_gensym_tree_1(authorized_products);
	      reclaim_gensym_tree_1(authorized_kb_packages_parse);
	      reclaim_gensym_tree_1(authorized_kb_packages);
	      temp_1 = reclaim_gensym_tree_1(expiration_date_parse);
	  }
	  POP_AREA(0);
      }
      else
...
Object G2passwdexe = UNBOUND;

static Object Qg2passwdexe;        /* g2passwdexe */

/* INITIALIZE-G2PASSWDEXE */
Object initialize_g2passwdexe()
{
    x_note_fn_call(108,203);
...
Object G2passwdexe_is_executable_p = UNBOUND;
...
Object Locked_to_kb_qm = UNBOUND;
    ...
    Object make_g2_secure_qm;
{
    ...
    Object code_2x, code_3x, code_4x, temp_3, checksum, date, start_date_qm;
    Object end_date_1, day, month, year, notification_text_string, system_1;
    Object option, cons_1, visible_product, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, code, second_new_value;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, gensymed_symbol_4;
    SI_Long gensymed_symbol_5, gensymed_symbol_6, gensymed_symbol_7;
    SI_Long gensymed_symbol_8, gensymed_symbol_9, gensymed_symbol_10;
    SI_Long gensymed_symbol_11, start_date, end_date;
    char temp;
    Declare_special(5);
    Object result;

    x_note_fn_call(108,211);
    modulus = New_modulus;
    if (machine_id &&  !TRUEP(shunned_machine_id_string_p(machine_id)) && 
	    code_1 && code_2 && code_3 && code_4 && code_5) {
	...
	gensymed_symbol_5 = IFIX(inner_multiply(temp_3,temp_1));
	gensymed_symbol_6 = number_of_processes_authorized ? 
		IFIX(inner_multiply(code_3x,
		number_of_processes_authorized)) : (SI_Long)0L;
	gensymed_symbol_7 = number_of_processes_authorized ? 
	...
	gensymed_symbol_9 = IFIX(inner_multiply(code_2x,
		FIX(IFIX(maximum_number_of_concurrent_floating_telewindows_allowed) 
		<< (SI_Long)8L)));
	gensymed_symbol_10 = IFIX(inner_multiply(code_3x,
		maximum_number_of_concurrent_floating_tw2_allowed));
	gensymed_symbol_11 = IFIX(inner_multiply(code_4x,
		ash(maximum_number_of_concurrent_floating_tw2_allowed,
		FIX((SI_Long)12L))));
	checksum = mod(FIX(gensymed_symbol_2 ^ gensymed_symbol_3 ^ 
		gensymed_symbol_4 ^ gensymed_symbol_5 ^ gensymed_symbol_6 
		^ gensymed_symbol_7 ^ gensymed_symbol_8 ^ 
		gensymed_symbol_9 ^ gensymed_symbol_10 ^ 
		gensymed_symbol_11),modulus);
	if (FIXNUM_EQ(checksum,code_5) && expiration_date_qm) {
	    date = get_universal_date();
	    if (expiration_date_qm && IFIX(expiration_date_qm) >= 
		    (SI_Long)8388608L) {
...
Object authorize_ab()
{
    ...
    PUSH_SPECIAL(Current_machine_ids_of_g2_ok_file_qm,current_machine_ids_of_g2_ok_file_qm,
	    1);
      if (PUSH_UNWIND_PROTECT(0)) {
...
void sequences2_INIT()
{
    ...
    Object gensymed_symbol, temp_2, write_bad_package_authorization_note_1;
    Object temp_3, temp_4, amf_available_array_cons_qm, amf_array, amf_result;
    Object incff_1_arg, new_float, named_dynamic_extent_description;
    Object reclaim_structure_for_ok_file_token_1;
    Object AB_package, list_constant_8, Qg2passwdexe_areyouthere_good_result;
    Object string_constant_226, Qg2passwdexe_areyouthere_arg;
    Object list_constant_131, Qsequences2, Qg2passwdexe_is_executable_p;
    Object Qinitialize_g2passwdexe, list_constant_130, Kfuncall;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qunbound_value_for_ok_reader_1;
    Object list_constant_129, list_constant_128, list_constant_127;
    Object list_constant_126, list_constant_111, list_constant_125;
    Object array_constant_98, list_constant_95, list_constant_102;
    Object Qpassword_validity, array_constant_97, list_constant_96, Qpassword;
    Object array_constant_96, list_constant_124, list_constant_123;
    ...
    Object list_constant_113, list_constant_112, Qinstallation_code;
    Object array_constant_95, Qserial_number, array_constant_94, Qcustomer;
    Object array_constant_93;
    Object Qmaximum_number_of_concurrent_floating_tw2_allowed;
    Object list_constant_110, list_constant_109, list_constant_108;
    Object list_constant_107, list_constant_106, list_constant_100;
    Object list_constant_101, list_constant_99, array_constant_92;
    Object list_constant_105, Qauthorization, list_constant_104;
    Object list_constant_103, array_constant_91, array_constant_90;
    ...
    Object list_constant_98, list_constant_97, array_constant_77;
    ...
    Object Qok_file_token, Qreclaim_structure;
    Object Qoutstanding_ok_file_token_count;
    Object Qok_file_token_structure_memory_usage, Qutilities2;
    Object Qok_file_token_count, Qchain_of_available_ok_file_tokens;
    Object string_constant_225, Qtype_description_of_type, string_constant_224;
    ...
    Object list_constant_94, Qread_ok_file_buffer_1, list_constant_93;
    Object Qpad_for_ok_file_reader;
    Object Qcompute_process_initial_value_for_pad_for_ok_file_reader;
    Object Qnamed_dynamic_extent_description, Qreading_ok_file;
    Object Qsimulate_proprietary_qm, Qclasses_which_define, Qcleanup;
    Object Qcleanup_for_kb_workspace, Qslot_putter, Qput_proprietary_package;
    Object Qslot_value_writer, Qwrite_proprietary_package_from_slot;
    Object string_constant_223, Qnil_function, string_constant_222;
    ...
    Object string_constant_206, Qput_user_password, Qput_permitted_user_modes;
    Object Qadministrator, Qab_gensym, Qwrite_permitted_mode_list_from_slot;
    ...
    Object Qrevert_to_fuzzy_cache_p, Qalternate_chaining_queue;
    Object string_constant_198, list_constant_53, Qkeytab1, Qchoose_keytab;
    ...
    Object Qconsider_asian_language_initializations_qm;
    ...
    Object list_constant_51, Qg2_is_secure, Qserver_parameters;
    Object Qvirtual_attributes_local_to_class, Qt2_nonce_hash;
    Object Qmutate_t2_nonce_hash_tree_entry, Qt2_nonce_data;
    Object Qoutstanding_t2_nonce_data_count;
    Object Qt2_nonce_data_structure_memory_usage, Qt2_nonce_data_count;
    Object Qchain_of_available_t2_nonce_datas, string_constant_159;
    Object string_constant_158, Qctlc_cons_count;
    Object Qwrite_authorization_interval_qm_from_slot;
    ...
    Object list_constant_9, Qpulse_rate_options, Qchoose_pulse_rate_multiplier;
    Object Qproduct, Qdevelopment_lic_level, Qrestricted_use_lic_level;
    Object Qruntime_lic_level, Qembedded_lic_level, Qfloating_lic_level;
    Object Qunauthorized_lic_level;

    x_note_fn_call(108,268);
    SET_PACKAGE("AB");
  ...
  end_loop:;
    ...
    string_constant_145 = 
	    STATIC_STRING("1y4z8r83Ufy83Ufy839Xy839Xy00001m1l8l1m8p83Cky000004z8r83Gxy83Gxy839Xy839Xy00001m1l8l1m8p839py000004z8r83Ksy83Ksy839Xy839Xy00001m");
    string_constant_146 = 
    ...
    string_constant_148 = 
	    STATIC_STRING("004z8r83XAy83XAy839Xy839Xy0k001m1l8l1l83Cy000004z8r83Ujy83Ujy839Xy839Xy00001m1l8l1m8p83Ky000004z8r83Gvy83Gvy839Xy839Xy00001m1l8l");
    string_constant_149 = 
	    STATIC_STRING("1m8p83Aqy000004z8r83Wwy83Wwy839Xy839Xy00001m1l8l1m8p83E4y000004z8r83Uuy83Uuy839Xy839Xy0k001m1l8l1m8p83*7y000004z8r83Uvy83Uvy839X");
    string_constant_150 = STATIC_STRING("y839Xy0k001m1l8l1m8p83*7y00000");
    string_constant_151 = 
	    STATIC_STRING("13Cy8q1m839Xy1l83-+y1o83Ufy08l1m8p83Cky1o83Gxy08l1m8p839py1o83Ksy08l1m8p83Apy1o83I3y08l1m8p830iy1o83I4y08l1m8p830iy1o83I5y08l1m8");
    string_constant_152 = 
	    STATIC_STRING("p830iy1o83I6y08l1m8p830iy1o83I7y08l1m8p830iy1o83XAyk8l83Cy1n83Ujy01m8p83Ky1o83Gvy08l1m8p83Aqy1o83Wwy08l1m8p83E4y1o83Uuyk8l1m8p83");
    string_constant_153 = STATIC_STRING("*7y1o83Uvyk8l1m8p83*7y");
    ...
    mutate_global_property(Qnon_negative_integer_or_none,
	    ...
	    Qslot_value_writer);
    string_constant_154 = STATIC_STRING("1m1m83-g-y83*7y1m83-g-y1m9k83Zy");
	...
	Ok_maximum_number_of_concurrent_floating_tw2_allowed = 
		FIX((SI_Long)128L);
    string_constant_155 = 
	    STATIC_STRING("1m1m83Cky83-xy1m83Cky1o1m9k83-Y5y1m9k83=Iy1m9k837Zy1m9k83-cRy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_156 = 
	    STATIC_STRING("1q1m839py83-jKy1m839py1m9k83Zy1m83-jKy83-9Vy1o83-jKy1n83-9Vy1m9k83vy83-jKy1nmln9l1m83-gGy1m9k83-Fry1m83-gGy83-Vy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_159 = STATIC_STRING("1q83niy8s83-qIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_160 = 
	    STATIC_STRING("1m1m83E4y83-Vy1o83E4y1m1m9k83=Ty1m9k83-bky09l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnil_function);
    ...
    mutate_global_property(Qmaximum_number_of_concurrent_floating_telewindows_allowed,
	    ...
	    Qslot_putter);
    string_constant_161 = 
	    STATIC_STRING("1n1n83Aqy83q5y1ll1n83Aqy1n83q5y1m9k83-ay83Aqy2lln1o83Aqy1m9k83Zyl9l");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnil_function);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_161));
    string_constant_162 = 
	    STATIC_STRING("1m1n83q5y1o839cy83-hAy83-hAy83-hAy1olmno1n83q5y1t839cy1m9k832+y8355y1m9k83=3y8355y1m9k83vy83-hAy83-hAy83-hAy1qlrstnp");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Qcreate_icon_description = STATIC_SYMBOL("CREATE-ICON-DESCRIPTION",
	    AB_package);
    string_constant_199 = 
	    STATIC_STRING("1n4z8r831ny831ny83H+y83H+y0k001n1l8o1l8l1m8p831ny000004z8r83Xny83Xny83H+y83H+y00001n1l8o1l8l1m8p83EMy000004z8r8u8u83H+y83H+y01p8");
    string_constant_200 = 
    ...
    string_constant_202 = 
	    STATIC_STRING("1p8q1m83H+y1l83-+y1p831nyk8o8l1m8p831ny1p83Xny08o8l1m8p83EMy1m8u1p8w9k3Gy3cy1o1o83*fy1muk1m3Cyq1muw1n83Oy1muw1mu3Qy1n83Oy1mk3Ey1");
	...
	temp_2 = FIXNUM_ADD(Simple_float_array_pool_memory_usage,incff_1_arg);
	Simple_float_array_pool_memory_usage = temp_2;
	amf_result = generate_float_vector(FIX((SI_Long)1L));
    }
    new_float = amf_result;
    ...
    string_constant_223 = 
	    STATIC_STRING("1n1o834Sy1m9k83Zyl9l1n834Sy1m1m9k9m1m9k839qy1l01n834Sy1m1m9k83-iOy839cy1lm");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnil_function);
    ...
    string_constant_224 = 
	    STATIC_STRING("43Dy8m83lHy1n83lHy8n8k1l8n0000001l1n8y83-52y1m83-1ky83-Ehykpk0k0");
    ...
    string_constant_225 = STATIC_STRING("1q83lHy8s83-gXy09k9l");
    clear_optimized_constants();
    ...
    list_constant_95 = STATIC_CONS(Qsymbol,Qnil);
    list_constant_111 = STATIC_LIST_STAR((SI_Long)3L,array_constant_28,
	    Qname,list_constant_95);
    ...
    list_constant_96 = STATIC_CONS(Qstring,Qnil);
    list_constant_112 = STATIC_LIST_STAR((SI_Long)3L,array_constant_29,
	    Qmachine_id,list_constant_96);
    ...
    list_constant_97 = STATIC_LIST((SI_Long)20L,Qmember,array_constant_59,
    ...
    list_constant_98 = STATIC_LIST((SI_Long)2L,Qlist_of,list_constant_97);
    list_constant_113 = STATIC_LIST((SI_Long)3L,array_constant_30,
	    Qauthorized_products,list_constant_98);
    ...
    list_constant_99 = STATIC_LIST((SI_Long)2L,Qmember,array_constant_78);
    ...
    list_constant_100 = STATIC_LIST((SI_Long)13L,Qmember,array_constant_79,
    ...
    list_constant_101 = STATIC_LIST((SI_Long)2L,Qmember,array_constant_91);
    list_constant_102 = STATIC_CONS(Qinteger,Qnil);
    list_constant_103 = STATIC_LIST_STAR((SI_Long)9L,Qlist_structure,
	    list_constant_99,Qinteger,list_constant_100,Qinteger,
	    list_constant_101,Qinteger,list_constant_100,list_constant_102);
    list_constant_104 = STATIC_LIST((SI_Long)3L,Qab_or,Qnull,
	    list_constant_103);
    list_constant_114 = STATIC_LIST((SI_Long)3L,array_constant_31,
	    Qexpiration_date_qm,list_constant_104);
    ...
    list_constant_105 = STATIC_CONS(Qlist_of,list_constant_102);
    list_constant_115 = STATIC_LIST((SI_Long)3L,array_constant_32,
	    Qauthorization,list_constant_105);
    ...
    list_constant_116 = STATIC_LIST((SI_Long)3L,array_constant_92,
    ...
    list_constant_106 = STATIC_LIST_STAR((SI_Long)3L,Qinteger,Qinteger,
	    list_constant_102);
    list_constant_107 = STATIC_LIST_STAR((SI_Long)3L,Qlist_structure,
	    Qsymbol,list_constant_106);
    list_constant_108 = STATIC_LIST_STAR((SI_Long)11L,Qlist_structure,
	    Qsymbol,list_constant_99,Qinteger,list_constant_100,Qinteger,
	    list_constant_101,Qinteger,list_constant_100,Qinteger,
	    list_constant_106);
    list_constant_109 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_107,
	    list_constant_108);
    list_constant_110 = STATIC_LIST((SI_Long)2L,Qlist_of,list_constant_109);
    list_constant_117 = STATIC_LIST((SI_Long)3L,array_constant_33,
	    Qauthorized_kb_packages,list_constant_110);
    ...
    list_constant_118 = STATIC_LIST_STAR((SI_Long)3L,array_constant_34,
	    Qnumber_of_processes_authorized,list_constant_102);
    ...
    list_constant_119 = STATIC_LIST_STAR((SI_Long)3L,array_constant_35,
	    Qmaximum_number_of_concurrent_floating_telewindows_allowed,
	    list_constant_102);
    ...
    Qmaximum_number_of_concurrent_floating_tw2_allowed = 
	    ...
	    AB_package);
    list_constant_120 = STATIC_LIST_STAR((SI_Long)3L,array_constant_36,
	    Qmaximum_number_of_concurrent_floating_tw2_allowed,
	    list_constant_102);
    ...
    list_constant_121 = STATIC_LIST_STAR((SI_Long)3L,array_constant_93,
	    Qcustomer,list_constant_95);
    ...
    list_constant_122 = STATIC_LIST_STAR((SI_Long)3L,array_constant_94,
	    Qserial_number,list_constant_96);
    ...
    list_constant_123 = STATIC_LIST_STAR((SI_Long)3L,array_constant_95,
	    Qinstallation_code,list_constant_96);
    list_constant_124 = STATIC_LIST((SI_Long)13L,list_constant_111,
    ...
    Slot_pad_descriptions_of_machine_authorization = list_constant_124;
    ...
    list_constant_126 = STATIC_LIST_STAR((SI_Long)3L,array_constant_96,
	    Qpassword,list_constant_96);
    ...
    list_constant_127 = STATIC_LIST_STAR((SI_Long)3L,array_constant_97,
	    Qpassword_validity,list_constant_102);
    ...
    list_constant_125 = STATIC_CONS(Qlist_of,list_constant_95);
    list_constant_128 = STATIC_LIST((SI_Long)3L,array_constant_98,
	    Qpermitted_user_modes,list_constant_125);
    list_constant_129 = STATIC_LIST((SI_Long)4L,list_constant_111,
	    list_constant_126,list_constant_127,list_constant_128);
    Slot_pad_descriptions_of_user = list_constant_129;
    ...
    Qinitialize_g2passwdexe = STATIC_SYMBOL("INITIALIZE-G2PASSWDEXE",
	    AB_package);
    list_constant_130 = STATIC_LIST((SI_Long)2L,Kfuncall,
	    Qinitialize_g2passwdexe);
    record_system_variable(Qg2passwdexe,Qsequences2,list_constant_130,Qnil,
	    Qnil,Qnil,Qnil);
    ...
    list_constant_131 = STATIC_LIST((SI_Long)2L,Qquote,Qunknown);
    record_system_variable(Qg2passwdexe_is_executable_p,Qsequences2,
	    list_constant_131,Qnil,Qnil,Qnil,Qnil);
    ...
    string_constant_226 = STATIC_STRING("-areyouthere");
    SET_SYMBOL_VALUE(Qg2passwdexe_areyouthere_arg,string_constant_226);
