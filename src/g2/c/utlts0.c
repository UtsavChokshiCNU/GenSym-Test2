...
Object Strange_cons = UNBOUND;

Object Debugging_consing = UNBOUND;

Object Cons_pool_conses_to_make_at_a_time = UNBOUND;

Object All_cons_pools = UNBOUND;

Object Available_gensym_conses = UNBOUND;

Object Available_gensym_conses_tail = UNBOUND;

Object Gensym_cons_counter = UNBOUND;
...
Object replenish_gensym_cons_pool()
{
    ...
    gensym_cons_counter_new_value = FIXNUM_ADD(Gensym_cons_counter,
	    incff_1_arg);
    Gensym_cons_counter = gensym_cons_counter_new_value;
    if (Available_gensym_conses)
	Available_gensym_conses = nconc2(CDR(new_conses),
		Available_gensym_conses);
    else {
	Available_gensym_conses = CDR(new_conses);
	Available_gensym_conses_tail = last(new_conses,_);
    }
    ...
    Object conses_needed_minus_one;
{
    ...
    new_conses = gensymed_symbol;
    if (Available_gensym_conses)
	Available_gensym_conses = nconc2(new_conses,Available_gensym_conses);
    else
	Available_gensym_conses = new_conses;
    incff_1_arg = new_conses_count;
    gensym_cons_counter_new_value = IFIX(Gensym_cons_counter) + incff_1_arg;
    Gensym_cons_counter = FIX(gensym_cons_counter_new_value);
    return VALUES_1(Nil);
}
...
Object Vector_of_simple_vector_pools = UNBOUND;

Object Simple_vector_pool_counts = UNBOUND;

Object Vector_of_oversized_simple_vector_pools = UNBOUND;

Object Oversized_simple_vector_pool_counts = UNBOUND;

Object Created_simple_vector_pool_vectors = UNBOUND;
...
Object Simple_vector_pool_memory_usage = UNBOUND;
    ...
    Object length_init;
{
	...
	if (length_1 <= IFIX(Replenished_simple_vector_size_limit)) {
		...
		ISVREF(local_vector_of_simple_vector_pools,index_1) = 
			vectors_made_so_far;
		incff_1_arg = Replenished_simple_vectors_to_make_at_a_time;
		temp = FIXNUM_ADD(Created_simple_vector_pool_vectors,
			incff_1_arg);
		Created_simple_vector_pool_vectors = temp;
		incff_1_arg = Replenished_simple_vectors_to_make_at_a_time;
		...
		temp = FIXNUM_ADD(Simple_vector_pool_memory_usage,incff_1_arg);
		Simple_vector_pool_memory_usage = temp;
		a = make_array(1,FIX(length_1));
	    }
	    POP_AREA(0);
	}
	else {
	    temp = FIXNUM_ADD1(Created_simple_vector_pool_vectors);
	    Created_simple_vector_pool_vectors = temp;
	    temp = FIXNUM_ADD1(ISVREF(local_simple_vector_pool_counts,
		    index_1));
	    ISVREF(local_simple_vector_pool_counts,index_1) = temp;
	    incff_1_arg = bytes_per_simple_vector(FIX(length_1));
	    temp = FIXNUM_ADD(Simple_vector_pool_memory_usage,incff_1_arg);
	    Simple_vector_pool_memory_usage = temp;
	    if (PUSH_AREA(Dynamic_area,0))
		a = make_array(1,FIX(length_1));
    ...
    Object required_size;
{
	...
	inline_note_reclaim_cons(pool_list,Qab_gensym);
	temp_1 = Available_gensym_conses;
	M_CDR(pool_list) = temp_1;
	Available_gensym_conses = pool_list;
	return VALUES_1(vector_1);
    }
    else {
	temp_1 = FIXNUM_ADD1(Allocated_byte_vectors);
	Allocated_byte_vectors = temp_1;
	incff_1_arg = 
		bytes_per_unsigned_byte_8_simple_array(FIX(rounded_up_length));
	temp_1 = FIXNUM_ADD(Bytes_in_allocated_byte_vectors,incff_1_arg);
	Bytes_in_allocated_byte_vectors = temp_1;
	if (pool_index) {
	    temp_1 = Byte_vector_pool_counts;
    ...
    Object byte_vector;
{
    ...
    svref_new_value = gensym_cons_1(byte_vector,ISVREF(Byte_vector_pools,
	    pool_index));
...
Object Byte_vector_16_pools = UNBOUND;

Object Byte_vector_16_pool_counts = UNBOUND;

Object Allocated_byte_vector_16_vectors = UNBOUND;
...
Object Bytes_in_allocated_byte_vector_16_vectors = UNBOUND;
...
Object Free_malloced_arrays = UNBOUND;

Object Largest_non_malloced_byte_vector_16_pool_index = UNBOUND;

Object Byte_vector_16_pool_number_to_malloc = UNBOUND;
    ...
    Object required_size;
{
	...
	temp_3 = FIXNUM_ADD1(Allocated_byte_vector_16_vectors);
	Allocated_byte_vector_16_vectors = temp_3;
	temp_3 = Byte_vector_16_pool_counts;
	svref_new_value = FIXNUM_ADD1(ISVREF(temp_3,pool_index));
	ISVREF(temp_3,pool_index) = svref_new_value;
	incff_1_arg = bytes_per_unsigned_byte_16_simple_array(FIX(length_1));
	temp_3 = FIXNUM_ADD(Bytes_in_allocated_byte_vector_16_vectors,
		incff_1_arg);
	Bytes_in_allocated_byte_vector_16_vectors = temp_3;
	if (IFIX(Byte_vector_16_pool_number_to_malloc) == (SI_Long)-1L || 
		pool_index < IFIX(Byte_vector_16_pool_number_to_malloc)) {
	    if (PUSH_AREA(Dynamic_area,0))
    ...
    Object byte_vector_16;
{
    ...
    pool_index = 
	    ...
	    Byte_vector_16_allocation_schemes));
    svref_arg_1 = Byte_vector_16_pools;
    svref_new_value = gensym_cons_1(byte_vector_16,
    ...
    Object byte_vector_16;
{
	...
	temp = Byte_vector_16_pool_counts;
	svref_new_value = FIXNUM_SUB1(ISVREF(temp,IFIX(pool_index)));
	SVREF(temp,pool_index) = svref_new_value;
	temp = FIXNUM_SUB1(Allocated_byte_vector_16_vectors);
	Allocated_byte_vector_16_vectors = temp;
	decff_1_arg = 
		bytes_per_unsigned_byte_16_simple_array(rounded_up_length);
	temp = FIXNUM_MINUS(Bytes_in_allocated_byte_vector_16_vectors,
		decff_1_arg);
	Bytes_in_allocated_byte_vector_16_vectors = temp;
...
void utilities0_INIT()
{
    ...
    Object string_constant_4, Qbyte_vector_16_memory_usage;
    Object Qoutstanding_byte_vector_16_vectors, AB_package, Qutilities0;
    Object Qbytes_in_allocated_byte_vector_16_vectors;
    Object Qallocated_byte_vector_16_vectors, list_constant_9;
    Object Qbyte_vector_16_pool_counts, list_constant_6;
    Object Qmake_byte_vector_16_pools, Kfuncall, list_constant_8;
    Object Qbyte_vector_16_pools, list_constant_4, string_constant_3;
    Object Qbyte_vector_memory_usage, Qoutstanding_byte_vectors;
    Object Qbytes_in_allocated_byte_vectors, Qallocated_byte_vectors;
    Object list_constant_7, Qbyte_vector_pool_counts, Qmake_byte_vector_pools;
    Object list_constant_5, Qbyte_vector_pools, Qmaximum_in_place_array_size;
    ...
    Object Qsimple_vector_pool_memory_usage;
    Object Qcreated_simple_vector_pool_vectors, list_constant_3;
    Object Qoversized_simple_vector_pool_counts, list_constant_2;
    Object Qvector_of_oversized_simple_vector_pools;
    Object Qsimple_vector_pool_counts;
    Object Qallocate_initial_managed_simple_vector_pool_array;
    Object Qvector_of_simple_vector_pools, Qmaximum_managed_simple_vector_size;
    Object string_constant_1, Qgensym_cons_memory_usage;
    Object Qoutstanding_gensym_conses, Qgensym_cons_counter;
    Object Qavailable_gensym_conses_tail, Qavailable_gensym_conses;
    Object Qstrange_cons, string_constant;
    ...
    if (Cons_pool_conses_to_make_at_a_time == UNBOUND)
    ...
    string_constant_1 = STATIC_STRING("1q83-Vmy9k83-Vly09l9m");
    ...
    list_constant_2 = STATIC_LIST((SI_Long)3L,Kfuncall,
	    Qallocate_initial_managed_simple_vector_pool_array,Qnil);
    ...
    record_system_variable(Qvector_of_oversized_simple_vector_pools,
	    Qutilities0,list_constant_2,Qnil,Qnil,Qnil,Qnil);
    ...
    record_system_variable(Qoversized_simple_vector_pool_counts,
	    Qutilities0,list_constant_3,Qnil,Qnil,Qnil,Qnil);
    ...
    SET_SYMBOL_FUNCTION(Qsvp_memory_usage,STATIC_FUNCTION(svp_memory_usage,
	    NIL,FALSE,0,0));
    string_constant_2 = STATIC_STRING("1q83-cfy83*By83-PJy09k9l");
    clear_optimized_constants();
    ...
    record_system_variable(Qbyte_vector_pools,Qutilities0,list_constant_5,
	    Qnil,Qt,Qnil,Qnil);
    ...
    string_constant_3 = STATIC_STRING("1q83-LDy1m9k1m83oKys83-JYy09l9m");
    clear_optimized_constants();
    ...
    string_constant_4 = STATIC_STRING("1q83-LCy1m9k1m83oKy3Cy83-JXy09l9m");
    clear_optimized_constants();
    push_optimized_constant(Qvector);
