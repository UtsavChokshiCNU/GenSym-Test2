...
Object Chain_of_available_uri_references = UNBOUND;

Object Uri_reference_count = UNBOUND;
    ...
    Object uri_reference;
{
    ...
    svref_new_value = Chain_of_available_uri_references;
    SVREF(uri_reference,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_uri_references = uri_reference;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_uri_reference_variable, uri_reference_count_new_value;
    ...
    uri_reference_count_new_value = FIXNUM_ADD1(Uri_reference_count);
    Uri_reference_count = uri_reference_count_new_value;
    ...
    Object line, headers;
{
    ...
    return VALUES_1(nconc2(gensym_list_2(temp,intern_text_string(1,
	    field_name)),headers));
}
    ...
    Object start_line_as_evaluation_value, header_lines_as_evaluation_value;
{
  ...
  next_loop:
    ...
    segment = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(copy_as_wide_string(segment),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
    ...
    temp = ISVREF(uri,(SI_Long)6L) ? gensym_list_2(Qquery,
    ...
    value_1 = allocate_evaluation_structure(nconc2(gensymed_symbol,
	    nconc2(temp,gensym_list_4(Qheaders,headers,Qtransfer_length,
    ...
    Object tag_name, ns_prefix, ns_uri, attributes, children;
{
    ...
    temp = gensym_list_2(Qtag_name,tag_name);
    temp_1 = ns_prefix ? gensym_list_2(Qns_prefix,ns_prefix) : Nil;
    temp_2 = ns_uri ? gensym_list_2(Qns_uri,ns_uri) : Nil;
    temp_3 = attributes ? gensym_list_2(Qattributes,
	    allocate_evaluation_structure(attributes)) : Nil;
    temp_3 = allocate_evaluation_structure(nconc2(temp,nconc2(temp_1,
	    nconc2(temp_2,nconc2(temp_3,children ? gensym_list_2(Qchildren,
    ...
    Object element;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_list_2(temp,xml_node_get_content(attr));
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
  ...
  next_loop_1:
	...
	goto end_loop_1;
    ab_loopvar__2 = 
	    gensym_cons_1(make_xml_evaluation_value_from_xml_node(child),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ...
    Object namespaces, header_entries, body_entries;
{
    ...
    temp_3 = gensym_list_2(Qxmlns_col_soap,
	    copy_as_wide_string(Soap_xml_namespace_uri));
    temp_4 = gensym_list_2(Qxmlns_col_soap12,
	    copy_as_wide_string(Soap12_xml_namespace_uri));
    temp_5 = gensym_list_2(Qxmlns_col_xsd,
	    copy_as_wide_string(Xsd_xml_namespace_uri));
    temp_6 = gensym_list_2(Qxmlns_col_xsi,
	...
	next_index = next_index + (SI_Long)2L;
	temp_7 = prefix;
	ab_loopvar__2 = gensym_list_2(temp_7,copy_as_wide_string(uri));
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
	...
	next_index = next_index + (SI_Long)1L;
	entry = validated_elt;
	ab_loopvar__2 = gensym_cons_1(FIXNUMP(entry) || entry && 
	...
	temp_7 = Qnil;
      end_2:;
	temp_8 = gensym_cons_1(make_xml_element_evaluation_value(temp_4,
  ...
  end_3:;
    temp_7 = 
	    ...
	    gensym_cons_1(make_xml_element_evaluation_value(temp_4,temp_5,
    ...
    Object message_1;
{
	...
	if ( !TRUEP(entry))
	    goto end_loop;
	ab_loopvar__2 = 
		gensym_cons_1(make_xml_element_evaluation_value_from_xml_element(entry),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
  ...
  next_loop_3:
    ...
    ab_loopvar__2 = gensym_list_2(temp,
    ...
    Object message_as_evaluation_value;
{
	...
	PUSH_SPECIAL(Current_xml_structures,current_xml_structures,0);
	  temp_3 = 
    ...
    Object response_as_evaluation_value;
{
	...
	switch (INTEGER_TO_SHORT(temp)) {
	  ...
	  case 500:
	    ...
	    current_xml_structures = Nil;
	    PUSH_SPECIAL(Current_xml_structures,current_xml_structures,7);
	      ...
	      temp = make_evaluation_structure_from_soap_message(message_2);
	      reclaim_evaluation_structure(response);
	      reclaim_xml_structures(1,Current_xml_structures);
	      reclaim_gensym_list_1(Current_xml_structures);
	      value_1 = temp;
    ...
    Object msg_struct_as_evaluation_value;
{
    ...
    end_loop:
      fault_p = Qnil;
    end_2:;
      temp = fault_p ? gensym_list_2(Qstatus_code,FIX((SI_Long)500L)) : Nil;
      ...
      temp_3 = allocate_evaluation_structure(nconc2(temp,
	      gensym_list_4(Qheaders,temp_3,Qentity,
    ...
    Object message_1, msg_ref, ns_prefix;
{
    ...
    temp_4 = gensym_list_2(temp_3,copy_as_wide_string(ns_uri));
  ...
  next_loop:
    ...
    next_index = next_index + (SI_Long)2L;
    ab_loopvar__2 = 
	    gensym_cons_1(make_xml_element_evaluation_value_from_web_service_message_part(name,
    ...
    Object name, value, ns_prefix, ns_uri;
{
	...
	temp_2 = gensym_cons_1(FIXNUMP(value) || value && SYMBOLP(value) ? 
    ...
    Object message_1;
{
  ...
  next_loop:
    ...
    upcase_text_string_in_place(field_name);
    ab_loopvar__2 = gensym_cons_1(intern_text_string(1,field_name),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ab_loopvar__1 = ab_loopvar__2;
    ab_loopvar__2 = gensym_cons_1(copy_wide_string(value),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ...
    Object value;
{
  ...
  next_loop:
    ...
    child = evaluation_sequence_aref(ab_children_,ab_index_);
    ab_index_ = FIXNUM_ADD1(ab_index_);
    ab_loopvar__2 = gensym_cons_1(FIXNUMP(child) || child && 
	    SYMBOLP(child) ? child : copy_evaluation_value_1(child),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
    ...
    temp = gensym_list_2(temp,temp_1);
    return VALUES_1(temp);
}
    ...
    Object binding, operation_name, address, input_message;
{
    ...
    if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
	    Maximum_in_place_array_size)) {
	temp_3 = action_qm ? gensym_list_2(Qaction,
	...
	temp_4 = gensym_list_2(Qnamespaces,gensym_cons_1(gensymed_symbol_2,
		Qab_structure));
	item_or_value = allocate_evaluation_structure(nconc2(temp_3,
		nconc2(temp_4,gensym_list_2(Qbody_entries,
		allocate_evaluation_sequence(gensym_cons_1(make_xml_element_evaluation_value_from_web_service_message(input_message,
  ...
  next_loop_1:
	...
	if (name)
	    change_slot_value(3,operation,input_p ? 
		    ...
		    Qweb_service_output_message,ns ? gensym_list_2(name,
		    ns) : gensym_cons_1(name,Nil));
    }
    ...
    Object document_text_as_evaluation_value;
{
    ...
    PUSH_SPECIAL(Current_xml_structures,current_xml_structures,7);
	  ...
	  top_of_stack = Cached_top_of_stack;
	  message_1 = tformat_stack_error_text_string(1,string_constant_98);
	  raw_stack_error_named_error(top_of_stack,message_1);
      }
...
void web_services_INIT()
{
    ...
    Object Quri_reference_count, Qchain_of_available_uri_references;
    ...
    string_constant_99 = 
	    STATIC_STRING("43Dy8m83oLy1n83oLy8n8k1l8n0000001l1n8y83-6Hy1r83-G1y83-G2y83-G-y83-G=y83-G*y83-G0y83-G+yksk0k0");
    ...
    string_constant_100 = STATIC_STRING("1q83oLy8s83-tuy09k9l");
    ...
    string_constant_102 = 
	    STATIC_STRING("1o4z8r83Chy83Chy83Rey83Rey00001o1l8l1m8p83Chy1l83Fy1l83Hy000004z8r83Rfy83Rfy83Rey83Rey00001m1l8l1m8p8306y000004z8r83Rhy83Rhy83Re");
    string_constant_103 = 
	    STATIC_STRING("y83Rey00001n1l8l1l83Fy1l83Hy000004z8r83Rgy83Rgy83Rey83Rey00001n1l8l1l83Fy1l83Hy00000");
    string_constant_104 = 
	    STATIC_STRING("1q8q1m83Rey1l83-Oy1p83Chy01m8p83Chy83Fy83Hy1n83Rfy01m8p8306y1o83Rhy083Fy83Hy1o83Rgy083Fy83Hy");
    ...
    string_constant_105 = STATIC_STRING("1m1n83Chy1m9k83Zy01m83Chy83-Vy");
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qweb_service_interface_operation,
	    list_constant_35);
    string_constant_110 = 
	    STATIC_STRING("1n4z8r83eMy83eMy9k9k00001m1l8l1m8p83*Vy000004z8r83eLy83eLy9k9k00001m1l8l1m8p83Fsy000004z8r83eOy83eOy9k9k00001m1l8l1m8p83Fsy00000");
    string_constant_111 = 
	    STATIC_STRING("1p8q1m9k1l831+y1n83eMy01m8p83*Vy1n83eLy01m8p83Fsy1n83eOy01m8p83Fsy");
    temp = regenerate_optimized_constant(string_constant_3);
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qweb_service_binding_operation,
	    list_constant_35);
    string_constant_117 = 
	    STATIC_STRING("1l4z8r83eAy83eAy9k9k00001m1l8l1m8p83*Vy00000");
    string_constant_118 = STATIC_STRING("1n8q1m9k1l831+y1n83eAy01m8p83*Vy");
    temp = regenerate_optimized_constant(string_constant_3);
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qweb_service_http_binding,
	    list_constant_36);
    string_constant_119 = 
	    STATIC_STRING("1l4z8r83eIy83eIy83eHy83eHy09k001m1l8l1m8p83Cgy00000");
    string_constant_120 = 
	    STATIC_STRING("1n8q1m83eHy1l836Sy1n83eIy9k1m8p83Cgy");
    temp = regenerate_optimized_constant(string_constant_3);
    clear_optimized_constants();
    ...
    string_constant_121 = STATIC_STRING("1m1m83Cgy1m9k9l1m83Cgy1m9k83-9Ay");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qget);
    ...
    check_if_superior_classes_are_defined(Qweb_service_http_operation,
	    list_constant_37);
    string_constant_122 = 
	    STATIC_STRING("1l4z8r83eKy83eKy83eJy83eJy00001m1l8l1m8p83=4y00000");
    string_constant_123 = STATIC_STRING("1n8q1m83eJy1l9k1n83eKy01m8p83=4y");
    temp = regenerate_optimized_constant(string_constant_3);
    ...
    check_if_superior_classes_are_defined(Qweb_service_soap_binding,
	    list_constant_36);
    string_constant_124 = STATIC_STRING("1m8q1m83-Giy1l836Sy");
    temp = regenerate_optimized_constant(string_constant_3);
    temp_1 = regenerate_optimized_constant(string_constant_3);
    ...
    check_if_superior_classes_are_defined(Qweb_service_soap_operation,
	    list_constant_37);
    string_constant_125 = 
	    STATIC_STRING("1l4z8r83eQy83eQy83ePy83ePy00001m1l8l1m8p83=4y00000");
    string_constant_126 = STATIC_STRING("1n8q1m83ePy1l9k1n83eQy01m8p83=4y");
    temp = regenerate_optimized_constant(string_constant_3);
    ...
    string_constant_127 = 
	    STATIC_STRING("1l4z8r83eNy83eNy83e9y83e9y00001m1l8l1m8p83*Vy00000");
    string_constant_128 = STATIC_STRING("1n8q1m83e9y1l831+y1n83eNy01m8p83*Vy");
    temp = regenerate_optimized_constant(string_constant_3);
    ...
    check_if_superior_classes_are_defined(Qweb_service_endpoint,
	    list_constant_35);
    string_constant_129 = 
	    STATIC_STRING("1n4z8r83eGy83eGy83eDy83eDy00001m1l8l1m8p83*Vy000004z8r83eFy83eFy83eDy83eDy00001m1l8l1m8p834py000004z8r83eEy83eEy83eDy83eDy00001m");
    string_constant_130 = STATIC_STRING("1l8l1m8p83=4y00000");
    string_constant_131 = 
	    STATIC_STRING("1p8q1m83eDy1l831+y1n83eGy01m8p83*Vy1n83eFy01m8p834py1n83eEy01m8p83=4y");
    temp = regenerate_optimized_constant(string_constant_3);
    ...
    check_if_superior_classes_are_defined(Qweb_service_description,
	    list_constant_35);
    string_constant_133 = 
	    STATIC_STRING("1m4z8r83eCy83eCy83eBy83eBy00001m1l8l1m8p83*Vy000004z8r83eRy83eRy83eBy83eBy00001m1l8l1m8p83=4y00000");
    string_constant_134 = 
	    STATIC_STRING("1o8q1m83eBy1l831+y1n83eCy01m8p83*Vy1n83eRy01m8p83=4y");
    temp = regenerate_optimized_constant(string_constant_3);
