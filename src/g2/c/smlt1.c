...
Object Chain_of_available_external_set_pointerss = UNBOUND;

Object External_set_pointers_count = UNBOUND;
    ...
    Object external_set_pointers;
{
    ...
    svref_new_value = Chain_of_available_external_set_pointerss;
    SVREF(external_set_pointers,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_external_set_pointerss = external_set_pointers;
    return VALUES_1(Nil);
}
...
Object make_permanent_external_set_pointers_structure_internal()
{
    ...
    Object external_set_pointers_count_new_value;
    ...
    external_set_pointers_count_new_value = 
	    FIXNUM_ADD1(External_set_pointers_count);
    External_set_pointers_count = external_set_pointers_count_new_value;
...
Object Chain_of_available_compound_fixnum_simulation_times = UNBOUND;

Object Compound_fixnum_simulation_time_count = UNBOUND;
    ...
    Object compound_fixnum_simulation_time;
{
    ...
    svref_new_value = Chain_of_available_compound_fixnum_simulation_times;
    SVREF(compound_fixnum_simulation_time,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_compound_fixnum_simulation_times = 
	    compound_fixnum_simulation_time;
    return VALUES_1(Nil);
}
...
Object make_permanent_compound_fixnum_simulation_time_structure_internal()
{
    ...
    Object compound_fixnum_simulation_time_count_new_value;
    ...
    compound_fixnum_simulation_time_count_new_value = 
	    FIXNUM_ADD1(Compound_fixnum_simulation_time_count);
...
Object Chain_of_available_model_runtime_infos = UNBOUND;

Object Model_runtime_info_count = UNBOUND;
    ...
    Object model_runtime_info;
{
    ...
    reclaim_gensym_list_1(ISVREF(model_runtime_info,(SI_Long)37L));
    SVREF(model_runtime_info,FIX((SI_Long)37L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_model_runtime_infos;
    SVREF(model_runtime_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_model_runtime_infos = model_runtime_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_model_runtime_info_structure_internal()
{
    ...
    Object model_runtime_info_count_new_value;
    Object defstruct_g2_model_runtime_info_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(185,44);
    def_structure_model_runtime_info_variable = Nil;
    model_runtime_info_count_new_value = FIXNUM_ADD1(Model_runtime_info_count);
    Model_runtime_info_count = model_runtime_info_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_model_runtime_info_variable, svref_new_value;

    x_note_fn_call(185,45);
    def_structure_model_runtime_info_variable = 
	    Chain_of_available_model_runtime_infos;
    ...
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)4L)) = 
	    svref_new_value;
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)5L)) = 
	    svref_new_value;
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)6L)) = 
	    svref_new_value;
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)7L)) = 
	    svref_new_value;
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)8L)) = 
	    svref_new_value;
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)9L)) = 
	    svref_new_value;
    ...
    svref_new_value = make_installation_set();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)19L)) = 
	    svref_new_value;
    svref_new_value = make_installation_set();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)20L)) = 
	    svref_new_value;
    svref_new_value = make_installation_set();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)21L)) = 
	    svref_new_value;
    ...
    svref_new_value = make_rederive_set();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)24L)) = 
	    svref_new_value;
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)25L)) = Nil;
    svref_new_value = make_external_set();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)26L)) = 
	    svref_new_value;
    ...
    svref_new_value = make_compound_fixnum_simulation_time_1();
    SVREF(def_structure_model_runtime_info_variable,FIX((SI_Long)33L)) = 
	    svref_new_value;
...
Object Main_model_runtime_info = UNBOUND;

Object Current_model_runtime_info_qm = UNBOUND;

Object Current_model_definition_qm = UNBOUND;
...
Object Within_simulate_until_consistent_with_gensym_time = UNBOUND;

Object Initializing_simulator_qm = UNBOUND;

Object Initializing_state_variables_qm = UNBOUND;
...
static Object Qno_value;           /* no-value */
...
Object Current_simulation_runtime_structure = UNBOUND;

Object Dont_backward_chain_in_sim_eval_qm = UNBOUND;
    ...
    Object top_of_stack, byte_code_body, local_var_vector;
{
	...
	if (local_var_vector_qm) {
	    ...
	    PUSH_SPECIAL(Dont_backward_chain_in_sim_eval_qm,dont_backward_chain_in_sim_eval_qm,
		    0);
...
Object Minimum_simulation_time_increment = UNBOUND;

/* INITIALIZE-MINIMUM-SIMULATION-TIME-INCREMENT */
Object initialize_minimum_simulation_time_increment()
{
    x_note_fn_call(185,60);
    return VALUES_1(DOUBLE_TO_DOUBLE_FLOAT(1.0 / 100000.0));
}

Object Simulation_time_managed_float = UNBOUND;

/* INITIALIZE-SIMULATION-TIME-MANAGED-FLOAT */
Object initialize_simulation_time_managed_float()
{
    x_note_fn_call(185,61);
    return allocate_managed_float_box();
}

Object Number_of_variables_to_process_at_a_time = UNBOUND;

Object Task_for_display_of_simulation_time = UNBOUND;

Object Ran_out_of_time_qm = UNBOUND;

Object Number_of_simulated_variables_processed = UNBOUND;

/* INITIALIZE-COMPOUND-SIMULATION-TIME */
Object initialize_compound_simulation_time()
{
    x_note_fn_call(185,62);
    return make_compound_fixnum_simulation_time_1();
}

Object Simulation_time_accumulator = UNBOUND;

Object Synchronous_model_queue = UNBOUND;

Object As_fast_as_possible_model_queue = UNBOUND;

Object Current_model_queue_qm = UNBOUND;

Object Processing_as_fast_as_possible_models_qm = UNBOUND;

Object Simulator_initialized_as_data_server_qm = UNBOUND;

Object The_type_description_of_model_queue = UNBOUND;

Object Chain_of_available_model_queues = UNBOUND;

Object Model_queue_count = UNBOUND;
    ...
    Object model_queue;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_model_queues;
    SVREF(model_queue,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_model_queues = model_queue;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_model_queue_variable, model_queue_count_new_value;
    Object defstruct_g2_model_queue_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(185,67);
    def_structure_model_queue_variable = Nil;
    model_queue_count_new_value = FIXNUM_ADD1(Model_queue_count);
    Model_queue_count = model_queue_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object model_runtime_info;
{
  ...
  end_loop:
	...
	svref_new_value = gensym_cons_1(model_runtime_info,Nil);
	SVREF(temp,FIX((SI_Long)1L)) = svref_new_value;
    }
    else {
	temp = gensym_cons_1(model_runtime_info,Nil);
	M_CDR(tail) = temp;
    }
    return VALUES_1(Qnil);
}
    ...
    Object model_runtime_info;
{
	...
	models_to_shutdown = 
		copy_list_using_gensym_conses_1(ISVREF(Current_model_queue_qm,
		(SI_Long)1L));
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(models_to_shutdown);
	...
	if (EQ(CAR(gensymed_symbol_2),gensymed_symbol)) {
		...
		temp = Current_model_queue_qm;
		svref_new_value = CDR(gensymed_symbol_2);
		SVREF(temp,FIX((SI_Long)1L)) = svref_new_value;
	    }
	...
	temp_1 = ISVREF(Current_model_queue_qm,(SI_Long)2L);
	if (EQ(model_runtime_info,CAR(temp_1))) {
	    temp_1 = ISVREF(Current_model_queue_qm,(SI_Long)2L);
	    if ( !TRUEP(CDR(temp_1))) {
...
Object simulate_until_consistent_with_gensym_time()
{
	...
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,2);
	  PUSH_SPECIAL(Number_of_simulated_variables_processed,number_of_simulated_variables_processed,
		  1);
	    Current_computation_flags = 
		    FIX(IFIX(Current_computation_flags) | (SI_Long)16L);
	    processing_as_fast_as_possible_models_qm = T;
	    PUSH_SPECIAL(Processing_as_fast_as_possible_models_qm,processing_as_fast_as_possible_models_qm,
		    0);
    ...
    Object model_queue;
{
    ...
    x_note_fn_call(185,78);
    if (ISVREF(model_queue,(SI_Long)1L)) {
	current_model_queue_qm = model_queue;
	PUSH_SPECIAL(Current_model_queue_qm,current_model_queue_qm,1);
	  ...
	  PUSH_SPECIAL(Ran_out_of_time_qm,ran_out_of_time_qm,0);
    ...
    Object model_runtime_info;
{
    ...
    x_note_fn_call(185,79);
    current_model_runtime_info_qm = Nil;
    current_model_definition_qm = Nil;
    PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,2);
	...
	if (Current_model_runtime_info_qm) {
		...
		PUSH_SPECIAL(Within_simulate_until_consistent_with_gensym_time,within_simulate_until_consistent_with_gensym_time,
			0);
...
Object initialize_simulator_as_data_server()
{
	...
	if (Current_model_runtime_info_qm) {
	    ...
	    PUSH_SPECIAL(Current_model_queue_qm,current_model_queue_qm,0);
...
Object initialize_simulator_1()
{
	...
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,2);
	  PUSH_SPECIAL(Number_of_simulated_variables_processed,number_of_simulated_variables_processed,
		...
		PUSH_SPECIAL(Initializing_simulator_qm,initializing_simulator_qm,
			0);
		  temp = Current_model_runtime_info_qm;
    ...
    Object variable, variable_simulation_runtime_structure;
{
    ...
    return reclaim_gensym_list_1(things_that_affect_runtime_formula);
}
    ...
    Object variable, variable_simulation_runtime_structure;
{
    ...
    Object new_cons, gensymed_symbol_5;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(3);
    ...
    Object variable, simulation_formula;
{
	...
	reclaim_gensym_list_1(ISVREF(runtime_structure,(SI_Long)18L));
    ...
    Object simulation_environment_vector, recaching_needed_qm;
{
	...
	if ( !(EQ(existing_flag_qm,Evaluation_true_value) || 
	    ...
	    reclaim_gensym_cons_1(existing_flag_qm);
    }
	...
	svref_new_value = gensym_cons_1(FIX(gensymed_symbol),Qtruth_value);
    ...
    Object cached_designation, runtime_structure;
{
    ...
    Object gensymed_symbol_4, temp_1, new_cons, gensymed_symbol_5;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(185,92);
    ...
    Object edit_cache, affects_installation_qm, runtime_structure_to_add;
{
  ...
  next_loop:
	...
	reclaim_gensym_cons_1(cons_to_reclaim);
    }
    else {
  ...
  end_loop:
	...
	if (affects_installation_qm) {
	    temp_1 = gensym_cons_1(runtime_structure_to_add,
...
Object Next_element_to_be_sorted_qm = UNBOUND;
...
Object sort_dependent_variable_info_1()
{
    ...
    x_note_fn_call(185,102);
    next_element_to_be_sorted_qm = 
	    ISVREF(ISVREF(Current_model_runtime_info_qm,(SI_Long)21L),
	    (SI_Long)9L);
    PUSH_SPECIAL(Next_element_to_be_sorted_qm,next_element_to_be_sorted_qm,0);
      runtime_info_qm = Nil;
    next_loop:
...
Object compute_initial_values_for_all_state_variables()
{
    ...
    x_note_fn_call(185,105);
    initializing_state_variables_qm = T;
    PUSH_SPECIAL(Initializing_state_variables_qm,initializing_state_variables_qm,
	    0);
      for_each_element_in_installation_set(ISVREF(Current_model_runtime_info_qm,
...
Object shutdown_simulator_1()
{
	...
	temp = lookup_kb_specific_property_value(Qsimulator_data_server,
		Data_server_kbprop);
	SVREF(task,FIX((SI_Long)11L)) = temp;
	temp = Current_g2_time;
	SVREF(task,FIX((SI_Long)12L)) = temp;
...
Object reclaim_simulation_update_table()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(ISVREF(Current_model_runtime_info_qm,(SI_Long)23L));
    svref_arg_1 = Current_model_runtime_info_qm;
...
Object clear_runtime_structures_caches()
{
	...
	end_loop:
	  ...
	  if ( !TRUEP(ISVREF(edit_cache_qm,(SI_Long)3L))) {
	      ...
	      reclaim_gensym_list_1(ISVREF(edit_cache_qm,(SI_Long)2L));
      ...
      gensymed_symbol = ISVREF(entity_involved_in_simulation_qm,(SI_Long)14L);
    ...
    Object variables_that_need_simulated_values;
{
  ...
  end_loop:;
    ...
    return reclaim_gensym_list_1(variables_that_need_simulated_values);
}

Object The_type_description_of_variable_group_update_structure = UNBOUND;

Object Chain_of_available_variable_group_update_structures = UNBOUND;

Object Variable_group_update_structure_count = UNBOUND;
    ...
    Object variable_group_update_structure;
{
    ...
    x_note_fn_call(185,132);
    inline_note_reclaim_cons(variable_group_update_structure,Nil);
    svref_new_value = Chain_of_available_variable_group_update_structures;
    SVREF(variable_group_update_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_variable_group_update_structures = 
	    variable_group_update_structure;
    return VALUES_1(Nil);
}
...
Object make_permanent_variable_group_update_structure_structure_internal()
{
    ...
    Object variable_group_update_structure_count_new_value;
    Object defstruct_g2_variable_group_update_structure_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(185,134);
    def_structure_variable_group_update_structure_variable = Nil;
    variable_group_update_structure_count_new_value = 
	    FIXNUM_ADD1(Variable_group_update_structure_count);
...
Object Chain_of_available_group_index_structures = UNBOUND;

Object Group_index_structure_count = UNBOUND;
    ...
    Object group_index_structure;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_group_index_structures;
    SVREF(group_index_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_group_index_structures = group_index_structure;
    return VALUES_1(Nil);
}
...
Object make_permanent_group_index_structure_structure_internal()
{
    ...
    Object group_index_structure_count_new_value;
    Object defstruct_g2_group_index_structure_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(185,141);
    def_structure_group_index_structure_variable = Nil;
    group_index_structure_count_new_value = 
	    FIXNUM_ADD1(Group_index_structure_count);
    Group_index_structure_count = group_index_structure_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object override_time_increment_for_update_qm;
{
    ...
    Object new_cons, gensymed_symbol_2, temp_2;
    char temp_1;
    Object result;

    x_note_fn_call(185,143);
...
Object collect_one_shot_data_for_simulator varargs_1(int, n)
{
    ...
    current_model_runtime_info_qm = Nil;
    current_model_definition_qm = Nil;
    PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,1);
      PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
	      0);
	if (model_runtime_info_qm) {
	    Current_model_runtime_info_qm = model_runtime_info_qm;
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,1);
	  ...
	  PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
		...
		if (temp) {
			...
			temp_1 = gensym_cons_1(Qsend_one_value,
				gensym_cons_1(new_float,
				interval_at_which_to_send_value_to_inference_engine));
		    }
		    else {
			amf_available_array_cons_qm = 
			...
			aref_new_value = DFLOAT_ISAREF_1(Current_g2_time,
				...
				(SI_Long)0L) - temp_2);
			DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
			temp_1 = gensym_cons_1(Qsend_one_value,new_float);
		    }
...
Object begin_collecting_data_for_simulator varargs_1(int, n)
{
    ...
    Object amf_result, incff_1_arg, new_float, current_model_runtime_info_qm;
	...
	if (model_runtime_info_qm) {
	    ...
	    if (ISVREF(Simulation_parameters,(SI_Long)24L)) {
		code = M_CAR(M_CDR(Edit_type_alias_mapping));
		temp_1 = FIXNUMP(code) ? (IFIX(code) & (SI_Long)4096L) != 
			(SI_Long)0L : TRUEP(Qnil);
		if (temp_1);
		else
		    temp_1 = TRUEP(M_CAR(M_CDR(Cache_g1_semantics_graph)));
		temp_1 =  !temp_1;
	    }
	    else
		temp_1 = TRUEP(Nil);
    ...
    Object interval;
{
	...
	goto next_loop;
      end_loop:;
	return reclaim_gensym_list_star_1(interval);
    }
	...
	PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
	  ...
	  PUSH_SPECIAL(Current_computation_frame,current_computation_frame,0);
		...
		aref_new_value = DFLOAT_ISAREF_1(Current_g2_time,
			...
			(SI_Long)0L) - temp_1);
		DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
		temp_2 = gensym_cons_1(collection_interval,new_float);
    ...
    Object variable;
{
	...
	svref_new_value = CONSP(temp_1) ? 
		gensym_cons_1(FIRST(interval_at_which_to_send_value_to_inference_engine_qm),
	...
	if (ISVREF(variable_simulation_runtime_structure_qm,(SI_Long)14L))
	    return reclaim_gensym_list_star_1(interval_at_which_to_send_value_to_inference_engine_qm);
	else
...
Object set_external_variable_for_simulator varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Put_current_value_called_from_simulator_p,put_current_value_called_from_simulator_p,
		0);
	  temp = value;
...
void simulate1_INIT()
{
    ...
    Object Qgroup_index_structure_count;
    Object Qchain_of_available_group_index_structures, string_constant_17;
    ...
    Object Qvariable_group_update_structure_count;
    Object Qchain_of_available_variable_group_update_structures;
    Object string_constant_15, string_constant_14, Qshutdown_simulator;
    Object list_constant_5, Qat_either_end, Qat_output_end, Qat_input_end;
    ...
    Object Qmodel_queue_structure_memory_usage, Qmodel_queue_count;
    Object Qchain_of_available_model_queues, string_constant_13;
    Object string_constant_12, Qsimulate1;
    Object Qsimulator_initialized_as_data_server_qm;
    Object Qprocessing_as_fast_as_possible_models_qm, Qcurrent_model_queue_qm;
    Object list_constant_4, Qas_fast_as_possible_model_queue;
    Object Qsynchronous_model_queue, Kfuncall, list_constant_3;
    Object Qsimulation_time_accumulator, Qinitialize_compound_simulation_time;
    Object Qtask_for_display_of_simulation_time;
    Object Qnumber_of_variables_to_process_at_a_time;
    Object Qinitialize_simulation_time_managed_float, list_constant_2;
    Object Qsimulation_time_managed_float;
    Object Qinitialize_minimum_simulation_time_increment, list_constant_1;
    Object Qminimum_simulation_time_increment, Qpost_on_message_board;
    Object Qinitializing_state_variables_qm, Qinitializing_simulator_qm;
    Object Qwithin_simulate_until_consistent_with_gensym_time, Qslot_putter;
    Object Qput_integration_algorithm, Qcurrent_model_definition_qm;
    Object Qcurrent_model_runtime_info_qm, list_constant;
    Object Qmain_model_runtime_info, Qinitialize_main_model_runtime_info;
    Object Qmodel_runtime_info, Qoutstanding_model_runtime_info_count;
    Object Qmodel_runtime_info_structure_memory_usage;
    Object Qmodel_runtime_info_count, Qchain_of_available_model_runtime_infos;
    Object string_constant_11, string_constant_10;
    Object Qcompound_fixnum_simulation_time;
    Object Qoutstanding_compound_fixnum_simulation_time_count;
    Object Qcompound_fixnum_simulation_time_structure_memory_usage;
    Object Qcompound_fixnum_simulation_time_count;
    Object Qchain_of_available_compound_fixnum_simulation_times;
    Object string_constant_9, string_constant_8, Qslot_value_reclaimer;
    Object Qreclaim_external_set_pointers_qm_value, Qexternal_set_pointers;
    Object Qoutstanding_external_set_pointers_count;
    Object Qexternal_set_pointers_structure_memory_usage;
    Object Qexternal_set_pointers_count;
    Object Qchain_of_available_external_set_pointerss, string_constant_7;
    Object string_constant_6;

    x_note_fn_call(185,164);
    SET_PACKAGE("AB");
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8m83hIy1n83hIy8n8k1l8n0000000kok0k0");
    ...
    Qexternal_set_pointers_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_7 = STATIC_STRING("1q83hIy8s83-TKy09k9l");
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83gBy1n83gBy8n8k1l8n0000001l1m83My83-A1yknk0k0");
    ...
    Qcompound_fixnum_simulation_time_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_9 = STATIC_STRING("1q83gBy8s83-NUy09k9l");
    clear_optimized_constants();
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83ksy1n83ksy8n8k1l8n0000000k3Zyk0k0");
    ...
    Qmodel_runtime_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_11 = STATIC_STRING("1q83ksy8s83-ePy09k9l");
    clear_optimized_constants();
    ...
    record_system_variable(Qsynchronous_model_queue,Qsimulate1,
	    list_constant_4,Qnil,Qnil,Qreclaim_model_queue_function,Qt);
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83kry1n83kry8n8k1l8n0000000krk0k0");
    ...
    string_constant_13 = STATIC_STRING("1q83kry8s83-eOy09k9l");
    clear_optimized_constants();
    ...
    list_constant_5 = STATIC_LIST((SI_Long)7L,Qconnected_to,Qat_port,
	    Qat_an_input,Qat_an_output,Qat_input_end,Qat_output_end,
	    Qat_either_end);
    List_of_roles_that_can_be_cached = list_constant_5;
    Qg2_defstruct_structure_name_connection_g2_struct = 
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83oWy1n83oWy8n8k1l8n0000000krk0k0");
    ...
    Qvariable_group_update_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q83oWy8s83-uYy09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83iHy1n83iHy8n8k1l8n0000000kmk0k0");
    ...
    Qgroup_index_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_17 = STATIC_STRING("1q83iHy8s83-Wgy09k9l");
    clear_optimized_constants();
