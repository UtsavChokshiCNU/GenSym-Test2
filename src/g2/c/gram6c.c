...
Object compile_icon_description_qm_for_slot varargs_1(int, n)
{
    ...
    Object superior, ab_loop_list_, ab_loop_it_, gensymed_symbol_1;
    Object gensymed_symbol_4, temp, temp_1, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
    Object sub_class_bit_vector, width, height, rest_1;
    Object unfixed_region_specification_list, region_specification_qm;
    Object variable_specification_qm, icon_background_layer_qm;
    Object icon_background_layer_spec_qm, stipple_qm, header_count;
    Object unfixed_element_list, element_list_1, element_list;
    ...
    Object variable_value_qm, bad_element, cdr_new_value, polychrome_header;
    Object variable_header, background_header;
		  ...
		  PUSH_SPECIAL(Current_icon_untransformed_height,current_icon_untransformed_height,
		    ...
		    PUSH_SPECIAL(Current_icon_variables_plist,current_icon_variables_plist,
		      ...
		      PUSH_SPECIAL(Current_icon_variables_override_plist,current_icon_variables_override_plist,
			      0);
			temp_2 = TRUEP(simple_polygon_p(CDR(element)));
		      POP_SPECIAL();
		    POP_SPECIAL();
		  POP_SPECIAL();
		POP_SPECIAL();
	...
	if (bad_background_layer_qm) {
		...
		if (CONSP(element) && EQ(CAR(element),Qfilled_polygon)) {
			...
			PUSH_SPECIAL(Current_icon_variables_plist,current_icon_variables_plist,
			  ...
			  PUSH_SPECIAL(Current_icon_variables_override_plist,current_icon_variables_override_plist,
				  0);
			    temp_2 = TRUEP(clockwise_polygon_p(CDR(element)));
			  POP_SPECIAL();
			POP_SPECIAL();
		      POP_SPECIAL();
		    POP_SPECIAL();
		    if ( !temp_2) {
			cdr_new_value = nreverse(CDR(element));
			M_CDR(element) = cdr_new_value;
		    }
		    temp = CDR(element);
		    current_icon_untransformed_width = width;
		    PUSH_SPECIAL(Current_icon_untransformed_width,current_icon_untransformed_width,
			...
			POP_SPECIAL();
		      POP_SPECIAL();
		    POP_SPECIAL();
		    cdr_new_value = phrase_cons(temp,temp_1);
		    M_CDR(element) = cdr_new_value;
		}
		goto next_loop_37;
	      end_loop_37:;
		...
		if (SYMBOLP(element) &&  !TRUEP(assq_function(element,
		    ...
		    cdr_new_value = phrase_cons(phrase_cons(element,
			    element),CDR(polychrome_header));
		...
		if ( !SYMBOLP(temp_1) && CDR(polychrome_header) &&  
			...
			CDR(polychrome_header)))) {
		    cdr_new_value = phrase_cons(phrase_cons(Qforeground,
    ...
    Object expression;
{
	...
	args = arg2_qm ? gensym_list_2(arg1,arg2) : 
		gensym_list_2(FIX((SI_Long)0L),arg1);
    ...
    Object expression;
{
  ...
  next_loop:
	...
	new_expression = gensym_cons_1(Qminus,new_expression);
    else if (EQ(symbol_or_sign,Qminus))
	new_expression = gensym_cons_1(Qplus,new_expression);
    else
	new_expression = gensym_cons_1(symbol_or_sign,new_expression);
    goto next_loop;
  end_loop:
...
Object add_plus_to_front(expression)
    Object expression;
{
    Object temp, gensym_pop_store, cons_1, next_cons, cdr_new_value, neg_num;
	...
	if (INTEGERP(temp) && IFIX(CAR(expression)) < (SI_Long)0L) {
	    ...
	    neg_num = gensym_pop_store;
	    return VALUES_1(nconc2(gensym_list_2(Qminus,FIX((SI_Long)-1L * 
		    IFIX(neg_num))),expression));
	}
	else {
	    expression = gensym_cons_1(Qplus,expression);
	    return VALUES_1(expression);
	}
    }
}
    ...
    Object expression;
{
	...
	return gensym_cons_1(expression,Nil);
    ...
    Object expression;
{
	...
	if (CDR(variables))
	    ...
	    reclaim_gensym_cons_1(variables);
	    return VALUES_1(result_1);
	}
    }
    else if (EQ(CAR(variables),Qminus)) {
	variables = gensym_cons_1(resolved_constants,variables);
	return VALUES_1(variables);
    }
    else {
	result_1 = add_plus_to_front(gensym_cons_1(resolved_constants,Nil));
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
	...
	region_info_qm = Nil;
    if (region_info_qm)
	result_1 = gensym_cons_1(region_info_qm,result_1);
    goto next_loop;
  end_loop:
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
	...
	temp = Nil;
    eval_list = gensym_cons_1(temp,eval_list);
    ab_loop_list_ = CDDR(ab_loop_list_);
    if ( !TRUEP(ab_loop_list_))
	goto end_loop;
    goto next_loop;
...
void grammar6c_INIT()
{
    ...
    string_constant_58 = 
	    STATIC_STRING("13jy1n835xy1p1m9k83-9y83lfy1m9k83vy83lfy1m9k83-Ay1mmo1n83fBy1q1m9k83*Hy1m9k83-9y83lfy1m9k83vy83lfy1m9k83-Ay1m83*Hy1mnp1m839iy835");
    string_constant_59 = 
	    STATIC_STRING("xy1m839iy1m839iy835xy1m83-bly1m1m9k835xy835xy1m83-bly1o1m9k83*fy835xy835xy835xy1n83-bly1o1m9k83oy1m9k83Yjy835xy835xy1n83jyno1n83");
    string_constant_60 = 
	    STATIC_STRING("-bly1p1m9k83oy1m9k83*fy835xy835xy835xy1o83=Rynop1n83-bly1m1m9k83Oy83-2Iy2l83Oym1n83-bly1m1m9k83Jy83-8Ly2l83Jym1n83-bly1n1m9k83oy");
    string_constant_61 = 
	    STATIC_STRING("1m9k83-iEy83wNy2l83qyn1m83-bly83-pUy1n83-pUy1n1m9k83-pVy1m9k83-Jpy83b*y1m83-Dqyn1n83-pUy1p1m9k83-pVy1m9k83-Jpy83b*y835xy835xy1o8");
    string_constant_62 = 
	    STATIC_STRING("3-Dqynop1m83-bly83-Eey1m83-Xvy1m9k83-Wy1m83-Xvy1m9k83=Ay1m83-Xvy1m9k83C0y1m83-*uy83-Xvy1m83-*uy83-6y1m83-bly83-=Fy1m8346y1m9k83S");
    string_constant_63 = 
	    STATIC_STRING("9y1n8346y1r1m9k83*4y83-Vy1m9k83-ay1m9k83=sy83-Vy1m9k83-ay83-Xky2mmpr1m83-Xky83-Xly1n83-Xky1n83-BWy1m9k83-ay83-Xly2l2l83-1yln1m83");
    string_constant_64 = 
	    STATIC_STRING("-Xly83-Xmy1n83-Xly1n83-ucy1m9k83-ay83-Xmy2l2l83-iyln1m83-Xmy83-Xny1n83-Xmy1n83-Xiy1m9k83-ay83-Xny2l2l83-jyln1m83-Xny83-bGy1n83-X");
    string_constant_65 = 
	    STATIC_STRING("ny1p1m9k83b*y1m9k83-Py83b*y1m9k83-ay83-bGy2l1m83b*ynp1n83-Xiy1o1m9k83-Xhy1m9k83-Py1m9k83*ny83qLy1lo1n83-Xiy1n1m9k83-Xhy1m9k83-Py");
    string_constant_66 = 
	    STATIC_STRING("83*vy1ln1o83-bGy1n83-bly1m9k83-ay83-bGy1nmln9l1o83-bGy1p83-BVy1m9k83-Py83-bly1m9k83-ay83-bGy1oolnp9m1n83-bGy1n83-BVy1m9k83-Py83-");
    string_constant_67 = 
	    STATIC_STRING("bly1n83-ayln1m83-bGy83-bly1o83-ucy1n1m9k83-iy1m9k83-Py83-udyn9n1n83-udy83-uby1m83vyl1o83-udy1n83-uby1m9k83vy83-udy1nmln9l1m83-uZ");
    string_constant_68 = 
	    STATIC_STRING("y83-6y1n83-uby1n83-uZy1m9k9o83Sy1mln1n83-uby1n83-uZy1m9k9o83-Uy1mln1n83-uby1n83-uZy1m9k9o83-Xvy1mln1n83-uby1n83-uZy1m9k9o835Uy1m");
    string_constant_69 = 
	    STATIC_STRING("ln1o83-BWy83-kayl9p1n83-kay83-kZy1m83vyl1o83-kay1n83-kZy1m9k83vy83-kay1nmln9l1n83-kZy1n83Yny1m9k9o83*vy2lln");
    ...
    string_constant_70 = 
	    STATIC_STRING("1n1m83b*y1m9k83-bjy1m83b*y1m9k83-dBy1m83b*y1m9k83-Pby");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_70));
    string_constant_71 = 
	    STATIC_STRING("1q1m83-2Iy839iy1m83-2Iy83-bpy1m83-bqy1m839iy83fBy1m83-bqy1m83-bpy83fBy1m83-bpy1m83-bqy835xy1m83-bpy1m83-bpy835xy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_71));
    string_constant_72 = 
	    STATIC_STRING("1q1m83-8Ly839iy1m83-8Ly83-h=y1m83-h0y1m839iy83fBy1m83-h0y1m83-h=y83fBy1m83-h=y1m83-h0y835xy1m83-h=y1m83-h=y835xy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_72));
    string_constant_73 = 
	    STATIC_STRING("1o1m83wNy1m83-Tiy835xy1m83-Tiy1m83-Tjy835xy1m83-Tjy835xy1m83-Tjy1m83-Tjy835xy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_73));
    Qarc = STATIC_SYMBOL("ARC",AB_package);
    string_constant_74 = 
	    STATIC_STRING("1n1m83lfy83-95y1m83-95y83Sy1m83-95y83-6y");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_74));
    string_constant_75 = 
	    STATIC_STRING("1v1m83lfy83-iAy1m83-iAy83-iCy1n83-iAy1m83-iCy83-o+y1n9klm1m83-o+y83-o-y1n83-o+y1m83-o-y83-o+y1n9klm1m83-iCy83-iBy1m83-iCy83-o-y1");
    string_constant_76 = 
	    STATIC_STRING("n83-o-y1m1m9l9k83-iBym1m83-o-y1m1m9l9m83-iBy1m83-iBy83-95y1n83-95y1n1m9l83-9y83lfy1m9l83-Aym");
    clear_optimized_constants();
    ...
    string_constant_78 = STATIC_STRING("1m1m83-YMy835Uy1n83-YMy1m9k83Zy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_78));
    string_constant_79 = 
	    STATIC_STRING("1m1n83ixy835Uy1m83Cmyl1n83ixy1n835Uy1m9k83=Gy835xy1n83Cmyln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_79));
    string_constant_80 = STATIC_STRING("1m1m83Coy83ixy1n83Coy1m9k83Zy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_80));
    string_constant_81 = STATIC_STRING("1l1n83-=Fy1m1m9k83Cmy83ixym");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_81));
    string_constant_82 = 
	    STATIC_STRING("1l1n83-Djy1p1m9k83-9y83Sy1m9k83vy83Sy1m9k83-Ay1mmo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_82));
    string_constant_83 = 
	    STATIC_STRING("1m1n83qMy835Uy1m83Cmyl1n83qMy1n835Uy1m9k83=Gy83-Djy1n83Cmyln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_83));
    string_constant_84 = STATIC_STRING("1l1n83qLy1m1m9k83Cmy83qMym");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_84));
    string_constant_85 = 
	    STATIC_STRING("1m1n83nry1p83-Uy1m9k83=Gy835xy1m9k83*Xy83-*uy1o83Gylnp1n83nry1p83-6y1m9k83=Gy835xy1m9k83*Xy83-*uy1o83Gylnp");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_85));
    string_constant_86 = STATIC_STRING("1m1m83FMy83nry1n83FMy1m9k83Zy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_86));
    string_constant_87 = STATIC_STRING("1l1n83-Eey1m1m9k83Gy83nrym");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_88 = STATIC_STRING("1m1m83CXy83b*y1n83CXy1m9k83Zy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_88));
    string_constant_89 = 
	    STATIC_STRING("1n1n83FDy83b*y1m83-Dqyl1n83FDy1n83b*y835xy835xy1o83-Dqylmn1n83FDy1m9k83Zy0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
