    ...
    Object dateline, erase_dateline, graph_rendering;
{
    ...
    PUSH_SPECIAL(Erase_dateline,erase_dateline,4);
	  ...
	  PUSH_SPECIAL(Erase_dateline,erase_dateline,3);
	    graph_rendering = (resumable_icp_state_1 ? 
		    TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : graph_rendering;
...
Object handle_icp_update_graph_dateline()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	      ...
	      PUSH_SPECIAL(Erase_dateline,erase_dateline,1);
		if (Icp_read_trace_cutoff_level_qm) {
		    if (Icp_read_trace_cutoff_level_qm) {
...
void windows3a_INIT()
{
    ...
    Object Qchain_of_available_ring_raster_for_graphs, string_constant_10;
    ...
    Object Qchain_of_available_graph_renderings, string_constant_8;
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8m83iCy1o83iCy831gy8n8k1l831gy0000001m1n8y83-47y1w83-28y83wly83-HEy83-HKy83--fy83-Gry83-*Ay83-Goy83-*7y83tAy83-Guy83--ay1m8x");
    string_constant_7 = STATIC_STRING("831gyk3Hyk0k0");
    temp = The_type_description_of_graph_rendering;
    The_type_description_of_graph_rendering = 
	    load_and_initialize_type_description(temp,
	    regenerate_optimized_constant(LIST_2(string_constant_6,
	    string_constant_7)));
    ...
    string_constant_8 = STATIC_STRING("1q83iCy8s83-WYy09k9l");
  ...
  end_1:;
    ...
    string_constant_9 = 
	    STATIC_STRING("43Dy8m83mby1n83mby8n8k1l8n0000000kpk0k0");
    ...
    Qring_raster_for_graph_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_10 = STATIC_STRING("1q83mby8s83-lry09k9l");
    clear_optimized_constants();
