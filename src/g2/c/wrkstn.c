...
Object Chain_of_available_workstation_events = UNBOUND;

Object Workstation_event_count = UNBOUND;
    ...
    Object workstation_event;
{
    ...
    svref_new_value = Chain_of_available_workstation_events;
    SVREF(workstation_event,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_workstation_events = workstation_event;
    return VALUES_1(Nil);
}
...
Object make_permanent_workstation_event_structure_internal()
{
    ...
    Object workstation_event_count_new_value;
    ...
    workstation_event_count_new_value = FIXNUM_ADD1(Workstation_event_count);
    Workstation_event_count = workstation_event_count_new_value;
...
Object Current_workstation_event = UNBOUND;
...
static Object Qcurrent_workstation_window;  /* current-workstation-window */
...
Object shift_lexical_analysis_of_current_workstation_qm()
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,7);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,6);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,5);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,4);
    ...
    Object namespace, name, arguments;
{
	...
	return gensym_list_3(namespace,name,
		copy_tree_using_gensym_conses_1(arguments));
    else
    ...
    Object event_interpretation;
{
	...
	return reclaim_gensym_tree_1(event_interpretation);
    else
	return VALUES_1(Nil);
}
...
Object Drawing_parameters = UNBOUND;
    ...
    Object drawing_parameters;
{
    ...
    PUSH_SPECIAL(Drawing_parameters,drawing_parameters,0);
    ...
    Object scheduled_qm;
{
    ...
    SVREF(new_task,FIX((SI_Long)11L)) = scheduled_qm;
...
static Object Qcurrent_drawing_transfer_mode;  /* current-drawing-transfer-mode */
    ...
    Object painting_p;
{
  ...
  next_loop:
	...
	SVREF(new_task,FIX((SI_Long)8L)) = temp;
	ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)1L);
	SVREF(new_task,FIX((SI_Long)11L)) = gensym_window;
	gensymed_symbol = ISVREF(Immediate_task_queue,(SI_Long)1L);
	def_structure_queue_element_variable = 
		Chain_of_available_queue_elements;
	if (def_structure_queue_element_variable)
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
			    ...
			    if ( !EQ(on_p,ISVREF(gensym_window,
					(SI_Long)68L))) {
				SVREF(gensym_window,FIX((SI_Long)68L)) = on_p;
				if ( !TRUEP(initializing_qm))
    ...
    Object slot_value, frame, slot_description;
{
    ...
    car_new_value = allocate_evaluation_sequence(gensym_list_2(dx,dy));
    ...
    GENSYM_RETURN_ONE(allocate_evaluation_structure(nconc2(gensymed_symbol,
	    snap_dx_qm ? gensym_list_2(Qsnap_to,
	    allocate_evaluation_sequence(gensym_list_2(snap_dx_qm,
	    snap_dy_qm))) : Nil)));
    return VALUES_1(Nil);
}
    ...
    Object drawing_parameters, new_value, gensymed_symbol;
{
    ...
    Object new_cons, gensymed_symbol_1, stack_of_slot_value_changes;
    Object gensymed_symbol_2, gensymed_symbol_3, frame_and_slot_or_atom;
    Object ab_loop_list_, ab_loop_it_, temp_2, gensym_pop_store, cons_1;
    Object next_cons;
    ...
    PUSH_SPECIAL(Drawing_parameters,drawing_parameters,1);
	  ...
	  if (Nil)
	      gensymed_symbol_1 = nconc2(gensym_list_2(Drawing_parameters,
	  ...
	  PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		...
		temp = Drawing_parameters;
		svref_new_value = IFIX(ISVREF(Drawing_parameters,
    ...
    Object drawing_params, value;
{
	...
	new_value = gensym_list_2(Qcustom_colors,Qsome_image_name);
    else if (EQ(value,Qcustom_gray))
	new_value = gensym_list_2(Qcustom_grays,Qsome_image_name);
    else
	new_value = value;
    if (Noting_changes_to_kb_p)
    ...
    Object drawing_parameters;
{
    ...
    Object temp, stack_of_slot_value_changes, frame, sub_vector_qm;
    Object method_function_qm, frame_status_qm, image_palette, image_name_qm;
    Object color_map_qm, temp_1, frame_and_slot_or_atom, ab_loop_list_;
    Object ab_loop_it_, temp_3, gensym_pop_store, cons_1, next_cons;
    SI_Long index_1, ab_loop_bind_;
    char temp_2;
    Declare_special(2);
    Object result;
	...
	if (system_table_installed_p(Drawing_parameters)) {
		...
		add_frame_note(4,Qdrawing_parameters_image_incomplete,
			Drawing_parameters,gensym_cons_1(image_name_qm,Nil),T);
	}
    ...
    Object workstation;
{
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
      ...
      current_workstation_1 = workstation;
      PUSH_SPECIAL(Current_workstation,current_workstation_1,12);
	current_workstation_window = ISVREF(Current_workstation,(SI_Long)1L);
	PUSH_SPECIAL(Current_workstation_window,current_workstation_window,11);
	  current_g2_window_for_this_workstation_qm = 
		  ISVREF(Current_workstation,(SI_Long)25L);
	  PUSH_SPECIAL(Current_g2_window_for_this_workstation_qm,current_g2_window_for_this_workstation_qm,
		  10);
			  ...
			  PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			    ...
			    PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				  ...
				  call_twng_disconnect_callbacks(ISVREF(workstation,
					  (SI_Long)1L));
			      if ( !TRUEP(ISVREF(workstation,(SI_Long)55L))) {
				  ...
				  PUSH_SPECIAL(Delete_corresponding_object_qm,delete_corresponding_object_qm,
					  0);
				    reclaim_icp_object_map_for_workstation(workstation);
				  POP_SPECIAL();
				  result = reclaim_workstation(workstation);
			      }
			      else
				  result = VALUES_1(Nil);
			    POP_SPECIAL();
    ...
    Object workstation;
{
	...
	PUSH_SPECIAL(Current_workstation_native_window_qm,current_workstation_native_window_qm,
	  ...
	  PUSH_SPECIAL(Type_of_current_workstation_window,type_of_current_workstation_window,
	    ...
	    poll_workstation();
	    drain_current_workstation_drawing_queue();
	    result = update_window(6,Current_workstation_window,
...
Object Trace_workstation_events = UNBOUND;
...
Object Task_to_run_service_workstations_final = UNBOUND;

Object Future_task_to_run_propagate_all_workspace_changes_to_image_planes = UNBOUND;

Object Current_task_to_run_propagate_all_workspace_changes_to_image_planes = UNBOUND;
...
Object maybe_schedule_task_to_run_propagate_all_workspace_changes_to_image_planes()
{
    ...
    Object temp_1, svref_new_value, def_structure_schedule_task_variable, task;
    Object current_task_schedule_modify_arg_8, ctask, p, v, q, gensymed_symbol;
    Object def_structure_queue_element_variable, gensymed_symbol_1;
    char svref_new_value_1, temp_2, g2_p;
    double temp, future_task_schedule_modify_arg_3, aref_new_value, arg, arg_1;
    ...
    if ( 
	    ...
	    (SI_Long)6L))) {
	temp = DOUBLE_FLOAT_TO_DOUBLE(Service_workstation_interval);
	future_task_schedule_modify_arg_3 = 
		DFLOAT_ISAREF_1(Current_real_time,(SI_Long)0L) + temp;
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qpropagate_all_workspace_changes_to_image_planes);
	if (Future_task_to_run_propagate_all_workspace_changes_to_image_planes) 
		    {
	    if (EQ(Future_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Future_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    (SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Future_task_to_run_propagate_all_workspace_changes_to_image_planes);
	    inline_note_reclaim_cons(Future_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = 
		    Future_task_to_run_propagate_all_workspace_changes_to_image_planes;
	    reclaim_schedule_task_args(ISVREF(Future_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    (SI_Long)9L));
	    temp_1 = 
		    Future_task_to_run_propagate_all_workspace_changes_to_image_planes;
	...
	if (Current_task_to_run_propagate_all_workspace_changes_to_image_planes) 
		    {
	    if (EQ(Current_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Current_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    (SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Current_task_to_run_propagate_all_workspace_changes_to_image_planes);
	    inline_note_reclaim_cons(Current_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = 
		    Current_task_to_run_propagate_all_workspace_changes_to_image_planes;
	    reclaim_schedule_task_args(ISVREF(Current_task_to_run_propagate_all_workspace_changes_to_image_planes,
		    (SI_Long)9L));
	    temp_1 = 
		    Current_task_to_run_propagate_all_workspace_changes_to_image_planes;
	    SVREF(temp_1,FIX((SI_Long)9L)) = Nil;
...
Object maybe_schedule_service_workstations_final()
{
	...
	if ( !(Task_to_run_service_workstations_final && 
	    ...
	    temp = DOUBLE_FLOAT_TO_DOUBLE(Service_workstations_final_interval);
	    future_task_schedule_modify_arg_3 = 
		    DFLOAT_ISAREF_1(Current_real_time,(SI_Long)0L) + temp;
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qservice_workstations_final);
	    if (Task_to_run_service_workstations_final) {
		if (EQ(Task_to_run_service_workstations_final,
			Current_schedule_task))
		    Current_schedule_task = Nil;
		if (ISVREF(Task_to_run_service_workstations_final,(SI_Long)6L))
		    cancel_and_reclaim_scheduled_queue_element_1(Task_to_run_service_workstations_final);
		inline_note_reclaim_cons(Task_to_run_service_workstations_final,
			Nil);
		old_structure_being_reclaimed = Structure_being_reclaimed;
		Structure_being_reclaimed = 
			Task_to_run_service_workstations_final;
		reclaim_schedule_task_args(ISVREF(Task_to_run_service_workstations_final,
			(SI_Long)9L));
		temp_1 = Task_to_run_service_workstations_final;
		SVREF(temp_1,FIX((SI_Long)9L)) = Nil;
		Structure_being_reclaimed = old_structure_being_reclaimed;
		temp_1 = Task_to_run_service_workstations_final;
		svref_new_value = Chain_of_available_schedule_tasks;
	    ...
	    ISVREF(task,(SI_Long)10L) = FIX((SI_Long)0L);
	    future_task_schedule_2(task);
	    Task_to_run_service_workstations_final = task;
	}
    }
    return VALUES_1(Nil);
}
...
{
    Object workstation, schedule_task_qm, future_task_schedule_modify_arg_8;
    ...
    char svref_new_value, temp_2, g2_p;
    double temp, future_task_schedule_modify_arg_3, aref_new_value, arg, arg_1;
	...
	future_task_schedule_modify_arg_3 = 
		DFLOAT_ISAREF_1(Current_real_time,(SI_Long)0L) + temp;
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qservice_workstation);
	future_task_schedule_modify_arg_11 = workstation;
	schedule_task_qm = ISVREF(workstation,(SI_Long)48L);
	if (schedule_task_qm) {
	...
	future_task_schedule_2(task);
	SVREF(workstation,FIX((SI_Long)48L)) = task;
    }
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qservice_workstation);
	current_task_schedule_modify_arg_11 = workstation;
	schedule_task_qm = ISVREF(workstation,(SI_Long)47L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	...
	if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	    Priority_of_next_task = p;
	return VALUES_1(SVREF(workstation,FIX((SI_Long)47L)) = task);
    }
    else
	return VALUES_1(Nil);
}
...
{
    Object old_structure_being_reclaimed, temp, svref_new_value, workstation;
    Object ab_loop_list_, gensym_window;
    ...
    temp = Nil;
    Future_task_to_run_propagate_all_workspace_changes_to_image_planes = temp;
    if (Current_task_to_run_propagate_all_workspace_changes_to_image_planes) {
	if (EQ(Current_task_to_run_propagate_all_workspace_changes_to_image_planes,
		Current_schedule_task))
	    Current_schedule_task = Nil;
    ...
    temp = Nil;
    Current_task_to_run_propagate_all_workspace_changes_to_image_planes = temp;
...
Object Do_g2_init_file_qm = UNBOUND;

Object Workstation_in_which_to_launch_recompilation_qm = UNBOUND;
    ...
    Object workstation;
{
    ...
    Object work_was_done_qm, initial_time_slice_expired_p;
    ...
    Object specific_structure_for_current_workstation_context;
    Object current_workstation_detail_pane, current_g2_user_mode_qm;
    Object new_g2_classic_ui_p, servicing_workstation_qm, gensymed_symbol;
    Object gensymed_symbol_1, index_of_top_of_backtrace_stack, svref_arg_2;
    Object login_state, workstation_event_qm, current_workstation_event;
    Object in_edit_warning_context_p, items_warned_in_edit_warning_context;
    Object event_interpretation_qm, context_of_handler_qm, element;
    Object ab_loop_list_, kb_search_state, frame_serial_number;
    Object elements_to_delete, ab_loopvar_, ab_loopvar__1, xa, ya;
    ...
    temp = Nil;
    SVREF(workstation,FIX((SI_Long)47L)) = temp;
    schedule_task_qm = ISVREF(workstation,(SI_Long)48L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
    ...
    temp = Nil;
    SVREF(workstation,FIX((SI_Long)48L)) = temp;
    ...
    PUSH_SPECIAL(With_icp_buffer_coelescing_scope_qm,with_icp_buffer_coelescing_scope_qm,
	    16);
      ...
      current_workstation_1 = workstation;
      PUSH_SPECIAL(Current_workstation,current_workstation_1,15);
	current_workstation_window = ISVREF(Current_workstation,(SI_Long)1L);
	PUSH_SPECIAL(Current_workstation_window,current_workstation_window,14);
	  current_g2_window_for_this_workstation_qm = 
		  ISVREF(Current_workstation,(SI_Long)25L);
	  PUSH_SPECIAL(Current_g2_window_for_this_workstation_qm,current_g2_window_for_this_workstation_qm,
		  13);
			...
			PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
			  ...
			  PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			    ...
			    end_loop:
			      ...
			      login_state = ISVREF(workstation,(SI_Long)28L);
				  ...
				  PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
					...
					current_workstation_event = 
						workstation_event_qm;
					PUSH_SPECIAL(Current_workstation_event,current_workstation_event,
						2);
					  in_edit_warning_context_p = T;
					  items_warned_in_edit_warning_context 
						  = Nil;
					  PUSH_SPECIAL(Items_warned_in_edit_warning_context,items_warned_in_edit_warning_context,
						  1);
					    PUSH_SPECIAL(In_edit_warning_context_p,in_edit_warning_context_p,
						    0);
				  ...
				  next_loop_1:
					...
					if (ab_loopvar_)
					    ...
					    elements_to_delete = ab_loopvar__1;
    ...
    Object image_plane;
{
	...
	if (Servicing_workstation_qm && EQ(Current_workstation,workstation))
	    return maybe_defer_refreshing_image_plane_2(image_plane,
		    workstation);
	else {
	    current_workstation_1 = workstation;
	    PUSH_SPECIAL(Current_workstation,current_workstation_1,11);
...
Object native_window_item_class(native_window)
    Object native_window;
{
    Object class_qm, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    ...
    Object g2_workspace_view;
{
	...
	temp_1 = image_plane_x_scale_mf(image_plane_qm);
    else {
	temp_1 = image_plane_x_scale_mf(image_plane_qm);
	temp_1 = allocate_evaluation_structure(gensym_list_4(Qx_scale,
		temp_1,Qy_scale,image_plane_y_scale_mf(image_plane_qm)));
    }
    return VALUES_1(temp_1);
}
    ...
    Object g2_window_or_file_name, current_only_p;
{
	...
	reclaim_gensym_cons_1(current_only_p);
    return VALUES_1(Nil);
}
...
void workstation_INIT()
{
    ...
    Object Qui_client_session_user_mode, Qworkstation;
    Object Qcurrent_ui_client_session, string_constant_86, string_constant_85;
    Object string_constant_84, string_constant_83, list_constant_61;
    Object Qui_client_session, string_constant_82, string_constant_81;
    ...
    Object string_constant_74, list_constant_60, Qobject, Qui_client_item;
    Object Qg2_cause_asynchronous_abort;
    ...
    Object string_constant_73, list_constant_59, Qnetwork_wire;
    ...
    Object Qtype_specification_simple_expansion, string_constant_69;
    ...
    Object Qsubstitute_class_and_kb_flags, Qworkspace_view, string_constant_68;
    Object string_constant_67, string_constant_66, string_constant_65;
    Object string_constant_64, string_constant_63, list_constant_45;
    Object Qcreate_icon_description, string_constant_62, string_constant_61;
    ...
    Object string_constant_51, string_constant_50, Qg2_extension;
    ...
    Object Qcontrol_request_for_g2_extension, string_constant_49;
    Object list_constant_44, string_constant_48, string_constant_47;
    Object string_constant_46, Qget_scale_of_view, Qinitial_scale_of_view;
    ...
    Object string_constant_45, list_constant_34, string_constant_42;
    Object string_constant_44, Qg2_native_view, string_constant_43;
    Object list_constant_33, string_constant_41, Qget_g2_window_of_view;
    ...
    Object string_constant_40, string_constant_39, list_constant_28;
    Object string_constant_38, string_constant_37, string_constant_36;
    Object string_constant_35, Qentity, Qitem, Qminimum_scheduling_interval_qm;
    Object Qcompile_minimum_scheduling_interval_qm_for_slot;
    Object Qwrite_minimum_scheduling_interval_qm_from_slot, string_constant_34;
    ...
    Object Qcurrent_task_to_run_propagate_all_workspace_changes_to_image_planes;
    Object Qfuture_task_to_run_propagate_all_workspace_changes_to_image_planes;
    Object Qtask_to_run_service_workstations_final;
    ...
    Object Qput_image_palette, string_constant_33, string_constant_32;
    Object string_constant_31, list_constant_19, list_constant_18;
    ...
    Object Qwrite_alignment_grid_from_slot, string_constant_30;
    Object string_constant_29, string_constant_28, Qalignment_grid_option;
    Object Qalignment_grid_options, string_constant_27;
    Object Qtransform_alist_into_plist, string_constant_26, Qfine_dot;
    ...
    Object Qprimary_selection_color, Ksystem_frame, string_constant_25;
    Object string_constant_24, list_constant_8;
    Object Qdefault_value_for_image_palette, string_constant_23;
    Object string_constant_22, string_constant_21, string_constant_20;
    Object string_constant_19, Qsystem_table, Qclose_telewindows_callback;
    ...
    Object Qnamed_dynamic_extent_description, Qservicing_workstation_event;
    Object Qunwind_qm, Qworkstation_event, Qreclaim_structure;
    Object Qoutstanding_workstation_event_count;
    Object Qworkstation_event_structure_memory_usage, Qutilities2;
    Object Qworkstation_event_count, Qchain_of_available_workstation_events;
    ...
    string_constant_17 = 
	    STATIC_STRING("43Dy8m83oly1n83oly8n8k1l8n0000001m1m83My83-BMy1n8y83-6Ry0kvk0k0");
    ...
    Qworkstation_event_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_18 = STATIC_STRING("1q83oly8s83-vty09k9l");
    ...
    string_constant_20 = 
	    STATIC_STRING("1r4z8r83Gay83Gay83KDy83KDy08k001o1l8o1l8l1l83Cy1m8p83Ky000004z8r83KCy83KCy83KDy83KDy08k001o1l8o1l8l1l83Cy1m8p83Ky000004z8r83Cny8");
    string_constant_21 = 
	    STATIC_STRING("3Cny83KDy83KDy01m8w9k001o1l8o1l8l1l83Cy1m8p83Cny000004z8r83a1y83a1y83KDy83KDy08k001m1l8l1m8p83Ky000004z8r83JHy83JHy83KDy83KDy083");
    string_constant_22 = 
	    STATIC_STRING("9+y001n1l8l1l8o1m8p83*vy000004z8r83JKy83JKy83KDy83KDy0839+y001n1l8l1l8o1m8p83*vy000004z8r83Aey83Aey83KDy83KDy00001m1l8l1m8p83Aey");
    string_constant_23 = STATIC_STRING("00000");
    string_constant_24 = 
	    STATIC_STRING("1t8q1n83KDy1l83-sy83ey1q83Gay8k1l8o1l8l1l83Cy1m8p83Ky1q83KCy8k1l8o1l8l1l83Cy1m8p83Ky1q83Cny1m8w9k1l8o1l8l1l83Cy1m8p83Cny1n83a1y8");
    string_constant_25 = 
	    STATIC_STRING("k1m8p83Ky1o83JHy839+y1l8o1m8p83*vy1o83JKy839+y1l8o1m8p83*vy1n83Aey01m8p83Aey");
    temp = regenerate_optimized_constant(string_constant_19);
    clear_optimized_constants();
    push_optimized_constant(Qdefault_value_for_image_palette);
    temp_2 = regenerate_optimized_constant(LIST_4(string_constant_20,
    ...
    string_constant_26 = 
	    STATIC_STRING("1m1n83Aey83f8y1m83-p+yl1o83Aey1n83f8y1m9k83vy83-JTy2l2l83-p+yln9l");
    clear_optimized_constants();
    ...
    string_constant_27 = 
	    STATIC_STRING("1m1n83f8y83-Vy2lll1n83f8y1p1m9k83-9y83-Vy1m9k83vy83-Vy1m9k83-Ay2lmo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_28 = 
	    STATIC_STRING("1n1n83-JSy1o1m9k83kZy1m9k83*ny1m9k83-Py83*vy2l83U+yo1n83-JSy1o1m9k83kZy1m9k83-8oy1m9k83-Py83pgy2l839Iyo1n83-JSy1n1m9k83-DKy1m9k8");
    string_constant_29 = STATIC_STRING("3=3y83f8y2l83-oiyn");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_28,
	    string_constant_29)));
    string_constant_30 = STATIC_STRING("1m1m83pgy1m9k83-DRy1m83pgy83gHy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_31 = 
	    STATIC_STRING("1r1n83Cny1n1m9k83fy1m9k83-ty1m9k83*2y837ny1n83Cny1m1m9k837Ry1m9k83sPy83-p8y1n83Cny1m1m9k837Ry1m9k83--cy83-pAy1n83Cny1m1m9k83-TEy");
    string_constant_32 = 
	    STATIC_STRING("1m9k83sPy83-TFy1n83Cny1m1m9k83-TEy1m9k83--cy83-TGy1n83Cny1o1m9k83J2y1m9k83sPy1m9k832+y835Uy1m83-PRyo1n83Cny1o1m9k83J2y1m9k83--cy");
    string_constant_33 = STATIC_STRING("1m9k832+y835Uy1m83-PSyo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qmillisecond_sleep_interval,
	    ...
	    Qslot_value_writer);
    string_constant_34 = STATIC_STRING("1m1m83Dny1m9k83gNy1m83Dny83lhy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_35 = STATIC_STRING("1n1m8v835Ky1l83Ly1l83Iy");
    string_constant_36 = 
	    STATIC_STRING("1q4z8r83WOy83WOy835Ky835Ky00001m1l8o1l8l000004z8r83WMy83WMy835Ky835Ky0k001p1l8l1m8p8360y1l83Fy1l8o1l83-4y000004z8r83WPy83WPy835K");
    string_constant_37 = 
	    STATIC_STRING("y835Ky0k001p1l8l1m8p8360y1l83Fy1l8o1l83-4y000004z8r83WQy83WQy835Ky835Ky0k001p1l8l1m8p8361y1l83Fy1l8o1l83-4y000004z8r83WLy83WLy83");
    string_constant_38 = 
	    STATIC_STRING("5Ky835Ky0k001p1l8l1m8p8361y1l83Fy1l8o1l83-4y000004z8r83WNy83WNy835Ky835Ky083E2y001p1l8l1m8p83-2y1l83Fy1l8o1l83-4y00000");
    string_constant_39 = 
	    STATIC_STRING("1s8q1p835Ky1m83Ry83-+y1m8v835Ky83Ly83Iy1o83WOy08o8l1q83WMyk1m8p8360y83Fy8o83-4y1q83WPyk1m8p8360y83Fy8o83-4y1q83WQyk1m8p8361y83Fy");
    string_constant_40 = 
	    STATIC_STRING("8o83-4y1q83WLyk1m8p8361y83Fy8o83-4y1q83WNy83E2y1m8p83-2y83Fy8o83-4y");
    ...
    string_constant_41 = STATIC_STRING("1m1l83Ly1l83Iy");
    string_constant_42 = STATIC_STRING("0");
    string_constant_43 = STATIC_STRING("1m8q1o831Gy1l835Ky83Ly83Iy");
    temp = regenerate_optimized_constant(string_constant_41);
    temp_2 = regenerate_optimized_constant(string_constant_42);
    ...
    string_constant_44 = STATIC_STRING("1n1m8v83Npy1l83Ly1l83Iy");
    string_constant_45 = STATIC_STRING("1m8q1p83Npy1l831Gy1m8v83Npy83Ly83Iy");
    ...
    string_constant_46 = STATIC_STRING("1p1m8v835Hy1l8t1l83Iy1l83Ly1l83-8y");
    string_constant_47 = 
	    STATIC_STRING("1n4z8r83NZy83NZy835Hy835Hy00001o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83Mey83Mey835Hy835Hy083Iiy001o1l8l1l83Fy1m8p83*iy1l83Hy000004z");
    string_constant_48 = 
	    STATIC_STRING("8r83NPy83NPy835Hy835Hy00001o1l8l1l83Fy1m8p83*iy1l83Hy00000");
    string_constant_49 = 
	    STATIC_STRING("1p8q1r835Hy1l83-Oy1m8v835Hy8t83Iy83Ly83-8y1p83NZy083Fy1m8p83*iy83Hy1p83Mey83Iiy83Fy1m8p83*iy83Hy1p83NPy083Fy1m8p83*iy83Hy");
    temp = regenerate_optimized_constant(string_constant_46);
    temp_2 = regenerate_optimized_constant(LIST_2(string_constant_47,
	    string_constant_48));
    ...
    string_constant_53 = 
	    STATIC_STRING("TY class definition000004z8r83egy83egy836vy836vy00001m1l8o1l8l000004z8r836uy836uy836vy836vy00001n1l8l1m8p831=y1l83Hy000004z8r838");
    string_constant_54 = 
	    STATIC_STRING("Zy838Zy836vy836vy00001n1l8l1m8p830Ky1l83Hy000004z8r83aoy83aoy836vy836vy00001n1l8l1m8p831fy1l83Hy000004z8r83Ncy83Ncy836vy836vy000");
    string_constant_55 = 
	    STATIC_STRING("01o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83Nly83Nly836vy836vy0k001n1l8l1m8p8360y1l83Fy000004z8r83Nny83Nny836vy836vy0k001n1l8l1m8p836");
    string_constant_56 = 
	    STATIC_STRING("0y1l83Fy000004z8r83Nky83Nky836vy836vy0k001n1l8l1m8p8361y1l83Fy000004z8r83Nay83Nay836vy836vy0k001n1l8l1m8p8361y1l83Fy000004z8r83N");
    string_constant_57 = 
	    STATIC_STRING("my83Nmy836vy836vy03-7y001n1l8l1m8p8361y1l83Fy000004z8r83Noy83Noy836vy836vy03-7y001n1l8l1m8p8361y1l83Fy000004z8r83Ney83Ney836vy83");
    string_constant_58 = 
	    STATIC_STRING("6vy00001o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83Ngy83Ngy836vy836vy00001o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83Niy83Niy836vy836vy00001");
    string_constant_59 = 
	    STATIC_STRING("o1l8l1l83Fy1m8p836Qy1l83Hy000004z8r83Nby83Nby836vy836vy00001o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83Nhy83Nhy836vy836vy00001o1l8l1l8");
    string_constant_60 = 
	    STATIC_STRING("3Fy1m8p83*iy1l83Hy000004z8r83Nfy83Nfy836vy836vy00001o1l8l1l83Fy1m8p83*iy1l83Hy000004z8r83a+y83a+y836vy836vy08k001n1m8p83Ky1l83Ey");
    string_constant_61 = 
	    STATIC_STRING("1l8l000004z8r83Njy83Njy836vy836vy03Baz001o1l8l1l83Fy1n8p83-hy83*iy1l83Hy000004z8r83Ndy83Ndy836vy836vy03Baz001o1l8l1l83Fy1n8p83-h");
    string_constant_62 = STATIC_STRING("y83*iy1l83Hy00000");
    string_constant_63 = 
    ...
    string_constant_64 = 
	    STATIC_STRING("hys1m3kyz1m3ky3Ly1m83*Hy1m3hy3Sy1m3ay3Vy1m3Gy3Vy1m83*Hy1mx3Sy1mu3Ly1muz1m83*Hy1mxs1m3Gyp1p83Jy1mp3cy1m3py3cy1m3uy3py1mk3py1o83eg");
    string_constant_65 = 
	    STATIC_STRING("y08o8l1o836uy01m8p831=y83Hy1o838Zy01m8p830Ky83Hy1o83aoy01m8p831fy83Hy1p83Ncy083Fy1m8p83*iy83Hy1o83Nlyk1m8p8360y83Fy1o83Nnyk1m8p8");
    string_constant_66 = 
	    STATIC_STRING("360y83Fy1o83Nkyk1m8p8361y83Fy1o83Nayk1m8p8361y83Fy1o83Nmy3-7y1m8p8361y83Fy1o83Noy3-7y1m8p8361y83Fy1p83Ney083Fy1m8p83*iy83Hy1p83N");
    string_constant_67 = 
	    STATIC_STRING("gy083Fy1m8p83*iy83Hy1p83Niy083Fy1m8p836Qy83Hy1p83Nby083Fy1m8p83*iy83Hy1p83Nhy083Fy1m8p83*iy83Hy1p83Nfy083Fy1m8p83*iy83Hy1p83a+y8");
    string_constant_68 = 
	    STATIC_STRING("k1m8p83Ky83Ey8l1p83Njy3Baz83Fy1n8p83-hy83*iy83Hy1p83Ndy3Baz83Fy1n8p83-hy83*iy83Hy");
    temp = regenerate_optimized_constant(string_constant_50);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    temp_2 = regenerate_optimized_constant(list(12,string_constant_51,
    ...
    add_class_to_environment(9,Qg2_window,list_constant_45,Nil,temp,Nil,
	    ...
	    string_constant_66,string_constant_67,string_constant_68)),Nil);
    ...
    string_constant_69 = STATIC_STRING("1m1m831fy1m9k83Zy1m831fy83Tey");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_70 = STATIC_STRING("1l1m8v833Uy");
    string_constant_71 = 
    ...
    string_constant_72 = STATIC_STRING("e: true,00000");
    string_constant_73 = 
	    STATIC_STRING("1n8q1n833Uy1l83=+y1m8v833Uy1o83=Hy1l2l83Tyn8l83Cy");
    temp = regenerate_optimized_constant(string_constant_70);
    temp_2 = regenerate_optimized_constant(LIST_2(string_constant_71,
	    string_constant_72));
    ...
    string_constant_74 = STATIC_STRING("1o1l83Ly1l83Iy1l83ey1l8t");
    string_constant_75 = 
	    STATIC_STRING("13Cy4z8r83dPy83dPy83dCy83dCy00001o1m8p831=y1l8o1l8l1l83Hy000004z8r83dQy83dQy83dCy83dCy00001p1m8p83-2y1l83Fy1l8o1l8l1l83Hy000004z");
    string_constant_76 = 
	    STATIC_STRING("8r83dKy83dKy83dCy83dCy00001p1m8p83*iy1l83Fy1l8o1l8l1l83Hy000004z8r83dDy83dDy83dCy83dCy00001q1l8l1m8p831ny1l83Fy1l83Ny1l8o1l83Hy0");
    string_constant_77 = 
	    STATIC_STRING("00004z8r83apy83apy83dCy83dCy00001o1l8l1l83Fy1m8p831fy1l83Hy000004z8r83dNy83dNy83dCy83dCy00001o1l8l1l83Fy1m8p836Qy1l83Hy000004z8r");
    string_constant_78 = 
	    STATIC_STRING("83dHy83dHy83dCy83dCy00001p1l8l1m8p8365y1l83Fy1l8o1l83Hy000004z8r83dJy83dJy83dCy83dCy00001p1l8l1n8p83-2y83*iy1l83Fy1l8o1l83Hy0000");
    string_constant_79 = 
	    STATIC_STRING("04z8r83dLy83dLy83dCy83dCy00001m1l8o1l8l000004z8r83dRy83dRy83dCy83dCy00001m1l8o1l8l000004z8r83dFy83dFy83dCy83dCy0i001m1l8o1l8l000");
    string_constant_80 = 
	    STATIC_STRING("004z8r83dOy83dOy83dCy83dCy03Baz001o1l8l1l83Fy1n8p83-hy83*iy1l83Hy000004z8r83dGy83dGy83dCy83dCy03Baz001o1l8l1l83Fy1n8p83-hy83*iy1");
    string_constant_81 = 
	    STATIC_STRING("l83Hy000004z8r83dMy83dMy83dCy83dCy00001q1m8p83-2y1l83Fy1l83Ny1l8o1l8l1l83Hy000004z8r83dIy83dIy83dCy83dCy00001q1m8p8365y1l83Fy1l8");
    string_constant_82 = 
	    STATIC_STRING("3Ny1l8o1l8l1l83Hy000004z8r83dEy83dEy83dCy83dCy00001p1l83Fy1l83Ny1l8o1l8l1l83Hy00000");
    string_constant_83 = 
	    STATIC_STRING("13Ey8q1q83dCy1m83-Oy836Py83Ly83Iy83ey8t1q83dPy01m8p831=y8o8l83Hy1r83dQy01m8p83-2y83Fy8o8l83Hy1r83dKy01m8p83*iy83Fy8o8l83Hy1r83dD");
    string_constant_84 = 
	    STATIC_STRING("y01m8p831ny83Fy83Ny8o83Hy1p83apy083Fy1m8p831fy83Hy1p83dNy083Fy1m8p836Qy83Hy1q83dHy01m8p8365y83Fy8o83Hy1q83dJy01n8p83-2y83*iy83Fy");
    string_constant_85 = 
	    STATIC_STRING("8o83Hy1o83dLy08o8l1o83dRy08o8l1o83dFyi8o8l1p83dOy3Baz83Fy1n8p83-hy83*iy83Hy1p83dGy3Baz83Fy1n8p83-hy83*iy83Hy1s83dMy01m8p83-2y83F");
    string_constant_86 = 
	    STATIC_STRING("y83Ny8o8l83Hy1s83dIy01m8p8365y83Fy83Ny8o8l83Hy1r83dEy083Fy83Ny8o8l83Hy");
    temp = regenerate_optimized_constant(string_constant_74);
    temp_2 = regenerate_optimized_constant(list(8,string_constant_75,
    ...
    add_class_to_environment(9,Qui_client_session,list_constant_61,Nil,
	    ...
	    regenerate_optimized_constant(LIST_4(string_constant_83,
	    string_constant_84,string_constant_85,string_constant_86)),Nil);
