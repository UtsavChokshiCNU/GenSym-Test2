...
Object Chain_of_available_gsi_local_functions = UNBOUND;

Object Gsi_local_function_count = UNBOUND;
    ...
    Object gsi_local_function;
{
    ...
    svref_new_value = Chain_of_available_gsi_local_functions;
    SVREF(gsi_local_function,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gsi_local_functions = gsi_local_function;
    return VALUES_1(Nil);
}
...
Object make_permanent_gsi_local_function_structure_internal()
{
    ...
    gsi_local_function_count_new_value = FIXNUM_ADD1(Gsi_local_function_count);
    Gsi_local_function_count = gsi_local_function_count_new_value;
...
Object Chain_of_available_gsi_remote_procedures = UNBOUND;

Object Gsi_remote_procedure_count = UNBOUND;
    ...
    Object gsi_remote_procedure;
{
    ...
    svref_new_value = Chain_of_available_gsi_remote_procedures;
    SVREF(gsi_remote_procedure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gsi_remote_procedures = gsi_remote_procedure;
    return VALUES_1(Nil);
}
...
Object make_permanent_gsi_remote_procedure_structure_internal()
{
    ...
    gsi_remote_procedure_count_new_value = 
	    FIXNUM_ADD1(Gsi_remote_procedure_count);
    Gsi_remote_procedure_count = gsi_remote_procedure_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object remote_procedure;
{
	...
	reclaim_gensym_tree_1(ISVREF(remote_procedure,(SI_Long)9L));
	SVREF(remote_procedure,FIX((SI_Long)9L)) = Nil;
    }
    if (ISVREF(remote_procedure,(SI_Long)10L)) {
	reclaim_gensym_tree_1(ISVREF(remote_procedure,(SI_Long)10L));
	SVREF(remote_procedure,FIX((SI_Long)10L)) = Nil;
    }
    if (ISVREF(remote_procedure,(SI_Long)11L)) {
	reclaim_gensym_tree_1(ISVREF(remote_procedure,(SI_Long)11L));
	SVREF(remote_procedure,FIX((SI_Long)11L)) = Nil;
    }
    if (ISVREF(remote_procedure,(SI_Long)12L)) {
	reclaim_gensym_tree_1(ISVREF(remote_procedure,(SI_Long)12L));
	SVREF(remote_procedure,FIX((SI_Long)12L)) = Nil;
    }
    return reclaim_gsi_remote_procedure_internal_1(remote_procedure);
}

Object Current_remote_procedure_identifier = UNBOUND;

Object Current_invocation_remotely_started_p = UNBOUND;

Object Rpc_argument_count_override_qm = UNBOUND;

Object The_type_description_of_remote_procedure_name = UNBOUND;

Object Chain_of_available_remote_procedure_names = UNBOUND;

Object Remote_procedure_name_count = UNBOUND;
    ...
    Object remote_procedure_name;
{
    ...
    svref_new_value = Chain_of_available_remote_procedure_names;
    SVREF(remote_procedure_name,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_remote_procedure_names = remote_procedure_name;
    return VALUES_1(Nil);
}
...
Object make_permanent_remote_procedure_name_structure_internal()
{
    ...
    remote_procedure_name_count_new_value = 
	    FIXNUM_ADD1(Remote_procedure_name_count);
    Remote_procedure_name_count = remote_procedure_name_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_remote_procedure_identifiers = UNBOUND;

Object Remote_procedure_identifier_count = UNBOUND;
    ...
    Object remote_procedure_identifier;
{
    ...
    reclaim_gensym_list_1(ISVREF(remote_procedure_identifier,(SI_Long)5L));
    ...
    svref_new_value = Chain_of_available_remote_procedure_identifiers;
...
Object make_permanent_remote_procedure_identifier_structure_internal()
{
    ...
    remote_procedure_identifier_count_new_value = 
	    FIXNUM_ADD1(Remote_procedure_identifier_count);
...
Object Chain_of_available_remote_procedure_item_passing_infos = UNBOUND;

Object Remote_procedure_item_passing_info_count = UNBOUND;
    ...
    Object remote_procedure_item_passing_info;
{
    ...
    svref_new_value = Chain_of_available_remote_procedure_item_passing_infos;
...
Object make_permanent_remote_procedure_item_passing_info_structure_internal()
{
    ...
    remote_procedure_item_passing_info_count_new_value = 
	    FIXNUM_ADD1(Remote_procedure_item_passing_info_count);
...
Object Chain_of_available_interned_remote_procedure_item_passing_infos = UNBOUND;

Object Interned_remote_procedure_item_passing_info_count = UNBOUND;
...
Object make_permanent_interned_remote_procedure_item_passing_info_structure_internal()
{
    ...
    interned_remote_procedure_item_passing_info_count_new_value = 
	    FIXNUM_ADD1(Interned_remote_procedure_item_passing_info_count);
    ...
    Object include_all_system_attributes_except_spec, kind_spec, varargs_p;
{
  ...
  next_loop:
    ...
    kind = CAR(kind_tail);
    ab_loopvar__2 = 
	    gensym_cons_1(make_remote_procedure_item_info(incl_attr,
  ...
  end_1:;
    list_to_intern = gensym_cons_1(varargs_p,list_of_interned_item_infos);
    temp = intern_list(list_to_intern);
    reclaim_gensym_list_1(list_to_intern);
    return VALUES_1(temp);
}
    ...
    Object list_of_return_kinds, remote_procedure_varargs_p;
{
    ...
    new_remote_procedure_identifier = 
	    ...
	    list_of_include_all_return_system_attributes_except,
	    list_of_return_kinds,remote_procedure_varargs_p));
    reclaim_gensym_tree_1(list_of_included_return_attributes);
    reclaim_gensym_tree_1(list_of_excluded_return_attributes);
    reclaim_gensym_tree_1(list_of_included_return_system_attributes);
    reclaim_gensym_tree_1(list_of_include_all_return_system_attributes);
    reclaim_gensym_tree_1(list_of_include_all_return_system_attributes_except);
    reclaim_gensym_tree_1(list_of_return_kinds);
    store_corresponding_icp_object(corresponding_icp_object_index,
	    new_remote_procedure_identifier);
    return VALUES_1(Nil);
}
...
Object Write_remote_value_items_kind = UNBOUND;

Object Gsi_remote_value_creates_instance_p = UNBOUND;

Object Gsi_remote_value_conses_logical_p = UNBOUND;

Object Write_value_of_gsi_item_p = UNBOUND;

Object Remote_value_is_binary_p = UNBOUND;

Object Remote_value_known_typetag = UNBOUND;
	...
	if ( !(resumable_icp_state_1 ? TRUEP(Resumable_icp_state) : 
		...
		switch (INTEGER_TO_CHAR(temp)) {
		  ...
		  case 5:
			...
			temp = gensym_cons_1(arg1,Qtruth_value);
		    break;
		  case 1:
		    if ((resumable_icp_state_1 ? 
			    TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
...
Object Item_copy_index_space = UNBOUND;
	...
	if (Icp_write_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_write_trace_level,current_icp_write_trace_level,
		  ...
		  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
			  1);
		    PUSH_SPECIAL(Item_copy_index_space,item_copy_index_space,
			    0);
	    ...
	    PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
		    1);
	      PUSH_SPECIAL(Item_copy_index_space,item_copy_index_space,0);
		if (ISVREF(Current_icp_socket,(SI_Long)48L))
		    Current_computation_flags = 
			    FIX(IFIX(Current_computation_flags) | 
			    (SI_Long)16L);
	...
	if (Icp_write_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_write_trace_level,current_icp_write_trace_level,
		  ...
		  item_copy_index_space = (resumable_icp_state_1 ? 
			  ...
			  !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
			  resumable_icp_pop() : Nil;
		  PUSH_SPECIAL(Item_copy_index_space,item_copy_index_space,1);
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	      ...
	      remote_value_known_typetag = IFIX(typetag) == (SI_Long)8L ? 
		      Nil : typetag;
	      PUSH_SPECIAL(Remote_value_known_typetag,remote_value_known_typetag,
		      0);
		i = (SI_Long)0L;
		...
		ab_loopvar__2 = gensym_cons_1(converted_value,Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
		    ab_loopvar_ = ab_loopvar__2;
    ...
    Object so_far, list_1;
{
	...
	converted_attribute = ATOM(attribute) ? attribute :  
		...
		THIRD(attribute));
	ab_loopvar__2 = gensym_cons_1(converted_attribute,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
Object Remote_procedure_identifier_array = UNBOUND;
...
void rpc_common1_INIT()
{
    ...
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, list_constant_2, Qrpc_common1;
    Object Qremote_procedure_identifier_array;
    Object Qmake_initial_remote_procedure_identifier_array, Kfuncall;
    Object Qremote_value_known_typetag;
    ...
    Object Qremote_procedure_identifier, list_constant_1;
    ...
    Object Qutilities2, Qinterned_remote_procedure_item_passing_info_count;
    Object Qchain_of_available_interned_remote_procedure_item_passing_infos;
    ...
    Object Qremote_procedure_item_passing_info_count;
    Object Qchain_of_available_remote_procedure_item_passing_infos;
    ...
    Object Qremote_procedure_identifier_count;
    Object Qchain_of_available_remote_procedure_identifiers;
    ...
    Object list_constant, Qicp_object_map_for_remote_procedure_name;
    Object Qoutstanding_remote_procedure_name_count;
    Object Qremote_procedure_name_structure_memory_usage;
    Object Qremote_procedure_name_count;
    Object Qchain_of_available_remote_procedure_names, string_constant_14;
    Object string_constant_13, Qgsi_remote_procedure;
    Object Qoutstanding_gsi_remote_procedure_count;
    Object Qgsi_remote_procedure_structure_memory_usage;
    Object Qgsi_remote_procedure_count;
    Object Qchain_of_available_gsi_remote_procedures, string_constant_12;
    Object string_constant_11, Qgsi_local_function;
    Object Qoutstanding_gsi_local_function_count;
    Object Qgsi_local_function_structure_memory_usage;
    Object Qgsi_local_function_count, Qchain_of_available_gsi_local_functions;
    ...
    string_constant_9 = 
	    STATIC_STRING("43Dy8m83iPy1n83iPy8n8k1l8n0000000kok0k0");
    ...
    Qgsi_local_function_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_10 = STATIC_STRING("1q83iPy8s83-Wqy09k9l");
    ...
    string_constant_11 = 
	    STATIC_STRING("43Dy8m83iQy1n83iQy8n8k1l8n0000001l1m83My83-AVykxk0k0");
    ...
    Qgsi_remote_procedure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_12 = STATIC_STRING("1q83iQy8s83-Wry09k9l");
    clear_optimized_constants();
    ...
    string_constant_13 = 
	    STATIC_STRING("43Dy8m8369y1n8369y8n8k1l8n0000001m1n8y83-5Uy1l83-Bmy1m83My83-B=ykok0k0");
    ...
    Qremote_procedure_name_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_14 = STATIC_STRING("1q8369y8s83-kpy09k9l");
    clear_optimized_constants();
    ...
    string_constant_15 = 
	    STATIC_STRING("43Dy8m83mLy1n83mLy8n8k1l8n0000001l1n8y83-5Sy1m83-Bky8368ykvk0k0");
    ...
    Qremote_procedure_identifier_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_16 = STATIC_STRING("1q83mLy8s83-koy09k9l");
    clear_optimized_constants();
    ...
    string_constant_17 = 
	    STATIC_STRING("43Dy8m8368y1n8368y8n8k1l8n0000001m1n8y83-5Ty1l83Ywy1m83My83-B*ykmk0k0");
    ...
    Qremote_procedure_item_passing_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_18 = STATIC_STRING("1q8368y8s83-Bly09k9l");
    clear_optimized_constants();
	...
	The_type_description_of_interned_remote_procedure_item_passing_info 
		= Nil;
    string_constant_19 = 
	    STATIC_STRING("43Dy8m83jCy1o83jCy8368y8n8k1l8368y0000001m1m8x8368y1n8y83-4hy1l83Ywykmk0k0");
    ...
    Qinterned_remote_procedure_item_passing_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_20 = STATIC_STRING("1q83jCy8s83-Zcy09k9l");
    clear_optimized_constants();
