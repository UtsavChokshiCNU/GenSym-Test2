...
Object One_integer = UNBOUND;

Object Minus_one_integer = UNBOUND;
...
Object Object_pool_meters = UNBOUND;
...
Object Single_element_string = UNBOUND;
...
Object Process_initializations_alist = UNBOUND;

Object No_saved_initial_value = UNBOUND;
    ...
    Object system_variable_name, initialization;
{
	...
	in_clear_kb_p = T;
	PUSH_SPECIAL(In_clear_kb_p,in_clear_kb_p,0);
...
Object Running_trace_function_p = UNBOUND;
...
SI_Long g2int_run_trace_function()
{
	...
	PUSH_SPECIAL(Running_trace_function_p,running_trace_function_p,0);
...
Object Unix_command_callback_function = UNBOUND;
...
Object Cached_fixnum_time_qm = UNBOUND;
...
Object Check_time_on_next_uuid = UNBOUND;

Object Time_to_check_network_events = UNBOUND;
...
Object Fixnum_time_interval_for_one_second = UNBOUND;
...
Object Known_process_ids_qm = UNBOUND;

Object All_foreign_function_images_qm = UNBOUND;

Object All_external_foreign_function_images_qm = UNBOUND;
...
Object Inner_abort_level_tag = UNBOUND;

Object Abort_level_0_tag = UNBOUND;
...
Object c_g2_probe_file_wide(namestring_1)
    Object namestring_1;
{
    Object temp;
...
Object c_g2_stream_open_wide(namestring_1,open_mode)
    Object namestring_1, open_mode;
{
    Object temp;
...
void primitives_INIT()
{
    ...
    Object Qall_external_foreign_function_images_qm;
    Object Qall_foreign_function_images_qm, Qknown_process_ids_qm;
    Object Qg2int_run_trace_function, Qnamed_dynamic_extent_description;
    Object Qno_saved_initial_value, list_constant_3, string_constant_17;
    Object string_constant_16, Qpm_print_structure, Qpm_composite_type_of;
    Object Qpm_type_of, Qpm_nthcdr, Qpm_elt, list_constant_2;
    Object Qframe_vector_pool, Qbyte_vector_16_pool, Qtoken_conses;
    Object Qgraphics_conses, Qslot_value_conses, Qgensym_conses;
