...
Object Chain_of_available_external_class_infos = UNBOUND;

Object External_class_info_count = UNBOUND;
    ...
    Object external_class_info;
{
    ...
    reclaim_list_of_external_methods(ISVREF(external_class_info,(SI_Long)2L));
    SVREF(external_class_info,FIX((SI_Long)2L)) = Nil;
    reclaim_list_of_external_methods(ISVREF(external_class_info,(SI_Long)3L));
    SVREF(external_class_info,FIX((SI_Long)3L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_external_class_infos;
    SVREF(external_class_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_external_class_infos = external_class_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_external_class_info_structure_internal()
{
    ...
    Object external_class_info_count_new_value;
    Object defstruct_g2_external_class_info_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(253,4);
    def_structure_external_class_info_variable = Nil;
    external_class_info_count_new_value = 
	    FIXNUM_ADD1(External_class_info_count);
    External_class_info_count = external_class_info_count_new_value;
    ...
    Object external_class_info_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(external_class_info_list);
    return VALUES_1(Nil);
}
...
Object Chain_of_available_external_method_infos = UNBOUND;

Object External_method_info_count = UNBOUND;
    ...
    Object external_method_info;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_external_method_infos;
    SVREF(external_method_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_external_method_infos = external_method_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_external_method_info_structure_internal()
{
    ...
    Object external_method_info_count_new_value;
    Object defstruct_g2_external_method_info_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(253,12);
    def_structure_external_method_info_variable = Nil;
    external_method_info_count_new_value = 
	    FIXNUM_ADD1(External_method_info_count);
    External_method_info_count = external_method_info_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object external_methods;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(external_methods);
    return VALUES_1(Nil);
}
    ...
    Object export_definition;
{
	...
	if (memq_function(export_type,list_constant) &&  
	    ...
	    ab_loopvar__2 = 
		    gensym_cons_1(make_export_info_for_one_class(export_class,
		    options),Nil);
	    if (ab_loopvar__1)
    ...
    Object export_class, procedure_names;
{
  ...
  next_loop:
    ...
    if (g2_procedure_qm) {
	ab_loopvar__2 = 
		gensym_cons_1(make_external_method_info_for_g2_method(export_class,
    ...
    Object g2_method, g2_method_definition_text;
{
    ...
    Object ab_loop_it_, method_info_qm, gensym_push_modify_macro_arg, car_1;
    Object cdr_1, svref_new_value;
    char temp;
    Declare_special(1);

    x_note_fn_call(253,28);
	  ...
	  if (EQ(class_name,ISVREF(class_info,(SI_Long)1L))) {
	    ...
	    end_1:;
		  ...
		  method_info_qm = 
			  ...
			  g2_method,Nil,T);
		  gensym_push_modify_macro_arg = method_info_qm;
    ...
    Object export_definition, exported_class;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, noted_here_p;
    char temp;
    Declare_special(1);

    x_note_fn_call(253,37);
	...
	next_loop:
	  ...
	  if ( !EQ(this_export_definition,export_definition)) {
	    ...
	    end_1:;
	      ...
	      temp = TRUEP(Nil);
	  if (temp) {
	      ab_loopvar__4 = gensym_cons_1(this_export_definition,Nil);
	      if (ab_loopvar__3)
		  M_CDR(ab_loopvar__3) = ab_loopvar__4;
	      else
		  ab_loopvar__2 = ab_loopvar__4;
	...
	if (CDR(duplicates_qm))
	    reclaim_gensym_list_1(duplicates_qm);
	    ...
	    delete_from_frame_note_particulars_list(exported_class,
		    Qduplicate_class_export,gensym_pop_store);
	}
    }
    else {
    ...
    Object export_definition, exported_class, options;
{
	...
	add_or_delete_as_item_referring_to_name(static_method);
	if ( !TRUEP(get_instance_with_name_if_any(Qprocedure,static_method)))
	    nonexistent_static_methods_qm = gensym_cons_1(static_method,
	...
	if (nonexistent_static_methods_qm) {
	    ...
	    add_to_frame_note_particulars_list_if_necessary(gensym_cons_1(exported_class,
		    nonexistent_static_methods_qm),
    ...
    Object export_definition, static_p;
{
	...
	new_method_info_list = Qnil;
      end_1:;
	reclaim_gensym_list_1(old_method_info_list);
	if (static_p)
    ...
    Object class_1, name;
{
  ...
  end_loop_1:
	...
	if (ATOM(frame_or_frames_with_this_name)) {
		...
		temp = TRUEP(Nil);
	    temp_1 = temp ? gensym_cons_1(frame_or_frames_with_this_name,
		    Nil) : Nil;
	}
	else {
	    frame = Nil;
    ...
    Object method_info, static_p;
{
	...
	matching_method_if_any = Qnil;
      end_1:;
	reclaim_gensym_list_1(g2_methods_qm);
    ...
    Object method_info, static_p;
{
	...
	temp_1 = gensym_cons_1(new_method_info,Nil);
    }
    else if (g2_procedure_qm)
	temp_1 = gensym_cons_1(method_info,Nil);
    else {
	clear_unexportable_external_method_frame_note(export_definition,
		method_info);
    ...
    Object export_definition;
{
	...
	method_info = M_CAR(ab_loop_list__1);
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	gensym_modify_macro_using_test_arg_1 = ISVREF(method_info,(SI_Long)3L);
	car_1 = gensym_modify_macro_using_test_arg_1;
	...
	temp = TRUEP(Qnil);
      end_1:;
	methods_for_this_class = temp ? cdr_1 : gensym_cons_1(car_1,cdr_1);
	goto next_loop_1;
      end_loop_1:;
    ...
    Object export_definition;
{
  ...
  next_loop_1:
    ...
    method_info = M_CAR(ab_loop_list__1);
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    ab_loopvar__4 = gensym_cons_1(ISVREF(method_info,(SI_Long)3L),Nil);
    if (ab_loopvar__3)
	M_CDR(ab_loopvar__3) = ab_loopvar__4;
    else
	ab_loopvar__2 = ab_loopvar__4;
    ...
    Object export_definition, export_specs;
{
  ...
  next_loop_2:
    ...
    goto next_loop_2;
  end_loop_2:;
    reclaim_gensym_list_1(old_class_info);
    ...
    Object export_definition, export_class, options;
{
	...
	gensym_push_modify_macro_arg = export_info_for_this_class_qm;
	car_1 = gensym_push_modify_macro_arg;
    ...
    Object export_info_for_this_class, export_class, options, try_parse_p;
{
  ...
  next_loop_2:
    ...
    goto next_loop_2;
  end_loop_2:;
    reclaim_gensym_list_1(old_static_method_info_list);
    ...
    Object export_info_for_this_class, export_class, options;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(external_method_struct,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
    reclaim_gensym_list_1(old_methods);
    ...
    Object class_name, class_info_attributes;
{
    ...
    x_note_fn_call(253,61);
    PUSH_SPECIAL(Class_info_attributes,class_info_attributes,2);
	  ...
	  if (lookup_global_or_kb_specific_property_value(class_name,
		  ...
		  PUSH_SPECIAL(Collecting_exported_method_text_p,collecting_exported_method_text_p,
			  1);
		    list_of_exported_method_texts = Nil;
		    PUSH_SPECIAL(List_of_exported_method_texts,list_of_exported_method_texts,
			    0);
		      exported_source_qm = 
		      ...
		      Class_info_attributes = 
			      gensym_cons_1(Qstatic_methods,
			      Class_info_attributes);
		      Class_info_attributes = 
			      gensym_cons_1(static_method_info,
			      Class_info_attributes);
		      Class_info_attributes = 
			      gensym_cons_1(Qinstance_methods,
			      Class_info_attributes);
		      Class_info_attributes = 
			      gensym_cons_1(instance_method_info,
			      Class_info_attributes);
		      if (exported_source_qm) {
			  Class_info_attributes = 
				  gensym_cons_1(Qexported_source,
				  Class_info_attributes);
			  Class_info_attributes = 
				  gensym_cons_1(exported_source_qm,
				  Class_info_attributes);
		      }
		      if (hand_coded_methods_qm) {
			  Class_info_attributes = 
				  gensym_cons_1(Qhand_coded_methods,
				  Class_info_attributes);
			  Class_info_attributes = 
				  gensym_cons_1(hand_coded_methods_qm,
				  Class_info_attributes);
		      }
		    POP_SPECIAL();
		  POP_SPECIAL();
		  ...
		  Class_info_attributes = gensym_cons_1(Qinstance_methods,
			  Class_info_attributes);
		  Class_info_attributes = 
			  gensym_cons_1(instance_method_info,
			  Class_info_attributes);
    ...
    Object method_info, method_text_qm;
{
	...
	if ( !(EQ(is_static,Evaluation_true_value) || EQ(is_static,
	    ...
	    reclaim_gensym_cons_1(is_static);
    }
    else {
	argument_types = 
	...
	method_info_attributes = gensym_cons_1(Qmethod_name,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(method_name,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(Qis_static,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(is_static,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(Qargument_types,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(argument_types,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(Qresult_types,
		method_info_attributes);
	method_info_attributes = gensym_cons_1(result_types,
		method_info_attributes);
	if (include_method_text_p) {
	    method_info_attributes = gensym_cons_1(Qg2_method_text,
		    method_info_attributes);
	    temp_1 = get_text_of_attribute(g2_internal_method_qm,Qtext,
		    ISVREF(ISVREF(g2_internal_method_qm,(SI_Long)1L),
		    (SI_Long)1L));
	    method_info_attributes = gensym_cons_1(temp_1,
		    method_info_attributes);
	}
	if (method_text_qm) {
	    method_info_attributes = gensym_cons_1(Qmethod_source,
		    method_info_attributes);
	    method_info_attributes = gensym_cons_1(method_text_qm,
		    method_info_attributes);
	}
    }
    ...
    Object arguments_or_results;
{
  ...
  next_loop:
	...
	if (EQ(tag,Qsequence) || EQ(tag,Qab_structure))
	    ...
	    temp = allocate_evaluation_structure(gensym_list_2(Qab_class,
		    CADR(type)));
	else {
    ...
    Object class_info;
{
    ...
    Object cdr_new_value, eval_list_of_sequence_elements, temp;

    x_note_fn_call(253,65);
    method_info = Nil;
  ...
  next_loop:
    ...
    method_text_qm = gensym_pop_store;
    ab_loopvar__2 = 
	    gensym_cons_1(get_evaluation_structure_for_one_external_method(method_info,
	    method_text_qm),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
    ...
    Object export_definition, class_name, additional_methods_qm;
{
  ...
  end_1:;
	...
	PUSH_SPECIAL(Collecting_frame_notes_for_class_export_p,collecting_frame_notes_for_class_export_p,
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	reclaim_gensym_list_1(extant_static_methods_list);
    ...
    Object export_definition, class_name, error_string_qm;
{
	...
	tail_value_1_qm = error_string_qm ? gensym_cons_1(error_string_qm,
		Nil) : Nil;
	if (tail_value_1_qm) {
	...
	add_to_frame_note_particulars_list_if_necessary(gensym_cons_1(class_name,
...
Object decache_implicit_external_instance_method_info_if_any(class_name)
    Object class_name;
{
    Object description_qm, export_definition_qm, gensym_pop_store, cons_1;
    Object next_cons, cdr_new_value, external_class_info;
    Object external_instance_method_info;

    x_note_fn_call(253,76);
    description_qm = 
	...
	external_class_info = gensym_pop_store;
    ...
    Object class_name;
{
    ...
    set_lookup_slot_value_1(export_definition,
	    Qexport_definition_specification,gensym_cons_1(Qjava,
	    gensym_cons_1(Qnil,
	    gensym_cons_1(gensym_cons_1(gensym_cons_1(class_name,Nil),Nil),
	    Nil))));
    if (description_qm) {
	svref_new_value = gensym_cons_1(class_info,Nil);
...
Object Global_output_stream_for_expand_syntax_template = UNBOUND;
    ...
    Object template_name, bindings, filename;
{
    ...
    PUSH_SPECIAL(Current_jemit_text_style_qm,current_jemit_text_style_qm,1);
      if (PUSH_CATCH(Kjemit_error,1)) {
	  global_output_stream_for_expand_syntax_template = 
		  Qunbound_in_protected_let;
	  PUSH_SPECIAL(Global_output_stream_for_expand_syntax_template,global_output_stream_for_expand_syntax_template,
		  0);
...
Object pop_listed_syntax_tree_binding_layer(key,bindings)
    Object key, bindings;
{
    Object raw_binding, gensymed_symbol, type, raw_contents, gensym_pop_store;
    Object cons_1, next_cons, cdr_new_value, demoted_contents, temp;

    x_note_fn_call(253,86);
    raw_binding = look_up_raw_syntax_tree_binding(key,bindings);
	...
	if (cons_1) {
	    ...
	    next_cons = Nil;
	M_CADDR(raw_binding) = next_cons;
	demoted_contents = gensym_pop_store;
    }
    else
	...
	temp = Qoptional_alternative;
    else if (EQ(type,Qlist_of_lists))
	temp = Qlist;
    else
	temp = Qnil;
    temp = gensym_list_4(key,temp,demoted_contents,
	    copy_tree_using_gensym_conses_1(demoted_contents));
    return VALUES_1(temp);
}
    ...
    Object bindings;
{
  ...
  next_loop:
	...
	cdr_new_value = 
		gensym_cons_1(copy_tree_using_gensym_conses_1(ephemeral_binding),
		Nil);
    ...
    Object bindings;
{
  ...
  next_loop:
    ...
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    if (memq_function(type,list_constant_2)) {
	reclaim_gensym_tree_1(exhausted_binding);
	third_new_value = copy_tree_using_gensym_conses_1(original_binding);
    ...
    Object indentation;
{
	...
	reclaim_gensym_tree_1(bindings_for_one_iteration);
	i = i + (SI_Long)1L;
	goto next_loop;
      end_loop:;
    }
    ...
    Object line_number, indentation, replicate_lines_p, needs_index_binding_p;
{
    ...
    Object temp, next_line, gensym_pop_store, cons_1, next_cons;
    SI_Long i, ab_loop_bind_;
    Declare_special(4);
    Object result;

    x_note_fn_call(253,97);
    if (replicate_lines_p) {
	index_1 = FIX((SI_Long)0L);
	index_binding_qm = needs_index_binding_p ? gensym_list_3(QLT_I_GT,
		Qsimple,copy_gensym_string(string_constant_7)) : Qnil;
	if (index_binding_qm)
	    bindings = gensym_cons_1(index_binding_qm,bindings);
    ...
    Object template_name, bindings, indentation;
{
    ...
    Object fill_pointer_for_current_gensym_string;
    Object total_length_of_current_gensym_string, current_twriting_output_type;
    Object temp_2, gensym_pop_store, cons_1, next_cons;
    SI_Long line_number, i, ab_loop_bind_;
    Declare_special(4);
    Object result;

    x_note_fn_call(253,98);
	...
	if (replicate_lines_p && subtree_to_insert_qm) {
	    ...
	    index_binding_qm = needs_index_binding_p ? 
		    gensym_list_3(QLT_I_GT,Qsimple,
		...
		if (index_binding_qm) {
		    ...
		    current_gensym_string = 
			    obtain_simple_gensym_string(FIX((SI_Long)2048L));
		    PUSH_SPECIAL(Current_gensym_string,current_gensym_string,
			    3);
...
void java3_INIT()
{
    ...
    Object Qexternal_method_info_count;
    Object Qchain_of_available_external_method_infos, string_constant_11;
    ...
    Object Qexternal_class_info_structure_memory_usage;
    Object Qexternal_class_info_count;
    Object Qchain_of_available_external_class_infos, string_constant_9;
    Object string_constant_8;

    x_note_fn_call(253,100);
    SET_PACKAGE("AB");
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83hGy1n83hGy8n8k1l8n0000001l1n8y83-3ey1n83w7y83wEy83w9ykok0k0");
    ...
    Qexternal_class_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_9 = STATIC_STRING("1q83hGy8s83-THy09k9l");
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83hHy1n83hHy8n8k1l8n0000001l1n8y83-3fy1q83rSy83rTy83wBy83-=gy83-=hy83wAykvk0k0");
    ...
    Qexternal_method_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_11 = STATIC_STRING("1q83hHy8s83-TJy09k9l");
    clear_optimized_constants();
