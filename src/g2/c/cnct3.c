    ...
    Object connection, blocks;
{
	...
	if (delta_qm) {
	    ...
	    temp = TRUEP(Nil);
	if (temp) {
	    gensymed_symbol = ISVREF(ISVREF(connection,(SI_Long)2L),
		    (SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)5L) : Nil;
...
{
    Object connection_frame_or_class, x2, stub_length, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp_1, temp_2, new_cons;
	...
	svref_new_value = IFIX(FIXNUM_MIN(stub_length,delta));
    else {
	temp_2 = FIXNUM_NEGATE(delta);
	svref_new_value = IFIX(FIXNUM_NEGATE(FIXNUM_MIN(stub_length,temp_2)));
    }
    return VALUES_1(ISVREF(connection,(SI_Long)6L) = FIX(svref_new_value));
}
    ...
    Object connection, loose_end;
{
	...
	if ( !TRUEP(delta_or_deltas)) {
	    ...
	    if (temp)
		note_change_to_connection_1(connection);
	    temp_1 = gensym_list_2(delta_or_deltas,link_1_delta);
	  ...
	  next_loop:
	    ...
	    goto next_loop;
	  end_loop:
	    temp_1 = gensym_cons_1(link_1_delta,Nil);
	...
	if ( !TRUEP(delta_or_deltas)) {
	    ...
	    if (temp)
		note_change_to_connection_1(connection);
	    temp_1 = gensym_list_2(FIX((SI_Long)0L),delta_or_deltas);
	    SVREF(connection,FIX((SI_Long)6L)) = temp_1;
	}
	else {
	    temp = TRUEP(Noting_changes_to_kb_p);
	    ...
	    if (temp)
		note_change_to_connection_1(connection);
	    temp_1 = gensym_cons_1(FIX((SI_Long)0L),ISVREF(connection,
		    (SI_Long)6L));
	    SVREF(connection,FIX((SI_Long)6L)) = temp_1;
	}
	temp = TRUEP(Noting_changes_to_kb_p);
    ...
    Object connection, loose_end;
{
	...
	if ( !TRUEP(delta_or_deltas)) {
	    ...
	    SVREF(connection,FIX((SI_Long)6L)) = svref_new_value;
	    reclaim_gensym_cons_1(old_delta_or_deltas);
	}
	temp = TRUEP(Noting_changes_to_kb_p);
	if (temp);
	else {
...
Object Delete_connections_without_leaving_stubs_qm = UNBOUND;
    ...
    Object block;
{
    ...
    Object sub_class_bit_vector, connection, connections, gensymed_symbol_4;
    Object gensymed_symbol_5, connection_item_table_binary_tree, element_qm;
    Object temp_2, slot_group_qm;
    ...
    end_1:
	  ...
	  gensymed_symbol = ISVREF(block_at_other_end_of_connection,
		  (SI_Long)14L);
	  gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		  (SI_Long)5L) : Nil;
	  ...
	  if (temp_1) {
		  ...
		  if (temp_1);
		      ...
		      gensymed_symbol = 
			      ISVREF(block_at_other_end_of_connection,
			      (SI_Long)14L);
			  ...
			  if (new_connection_for_block_at_other_end) {
			      ...
			      gensymed_symbol = 
				      ...
				      (SI_Long)14L);
			      gensymed_symbol = gensymed_symbol ? 
				      ISVREF(gensymed_symbol,(SI_Long)6L) :
				       Nil;
			      connections = gensymed_symbol;
			      if (connections) {
				  gensymed_symbol = CDR(connections);
				  gensymed_symbol_4 = connection;
				  gensymed_symbol_1 = 
	...
	inline_note_reclaim_cons(connection_item_table_binary_tree,Qab_gensym);
	temp_2 = Available_gensym_conses;
	M_CDR(connection_item_table_binary_tree) = temp_2;
    ...
    Object connection;
{
    ...
    Object temp_1, connections, gensymed_symbol_4, gensymed_symbol_5;
    Object output_end_object, output_end_position, output_end_side;
    Object new_output_end_connection, fsn, xa, ya;
    SI_Long input_end_position_on_side, gensymed_symbol_1, gensymed_symbol_2;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_3, output_end_position_on_side;
    ...
    PUSH_SPECIAL(Current_drawing_priority,current_drawing_priority,0);
	  ...
	  if (temp);
		  ...
		  gensymed_symbol = CDR(connections);
		  gensymed_symbol_4 = connection;
		  gensymed_symbol_1 = SXHASH_SYMBOL_1(connection) & 
			  IFIX(Most_positive_fixnum);
		  gensymed_symbol_2 = (SI_Long)0L;
		next_loop:
		  if ( !TRUEP(gensymed_symbol))
...
Object Junction_blocks_not_to_be_deleted = UNBOUND;
    ...
    Object junction_block;
{
    ...
    Object sub_class_bit_vector, new_cons, connection_table_1;
    Object connection_table_2, connection_item_1, connection_item_2, temp_2;
    Object gensymed_symbol_4, slot_group_qm, gensymed_symbol_5, temp_3;
	...
	if ( !TRUEP(junction_connections) ||  
		...
		temp = get_direction_of_connection(2,junction_connection_1,
			block_at_other_end_of_connection_1);
		if (EQ(temp,Qoutput)) {
		    temp_2 = gensym_cons_1(Qjunction_connection_1,Nil);
		...
		temp = get_direction_of_connection(2,junction_connection_2,
			block_at_other_end_of_connection_2);
		if (EQ(temp,Qoutput)) {
		    temp_2 = gensym_cons_1(Qjunction_connection_2,Nil);
...
Object add_new_connection_to_block varargs_1(int, n)
{
    ...
    Object connection_overall_width, loose_end_delta_x_in_workspace;
    Object loose_end_delta_y_in_workspace, side, position_on_side;
    Object make_connection_qm, desired_position_on_side_qm;
    Object current_link_1_delta, current_link_2_delta;
    Object loose_end_initial_orientation_horizontal_p, sub_class_bit_vector;
    Object delta_qm, gensymed_symbol_6, plist, loose_end_side, temp1;
    Object slot_group_qm, temp_3;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, connection_half_width;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5, svref_new_value;
    char temp;
    Declare_varargs_nonrelocating;
    Object result;
  ...
  end_17:;
	...
	if (temp) {
		...
		gensymed_symbol_2 = gensymed_symbol_2 - gensymed_symbol_3;
		gensymed_symbol_3 = (SI_Long)1L;
		desired_position_on_side_qm = FIX(gensymed_symbol_2 >>  -  
			- gensymed_symbol_3);
	...
	if (make_connection_qm && side && position_on_side) {
	    gensymed_symbol = ISVREF(ISVREF(ISVREF(ISVREF(loose_end,
		    (SI_Long)1L),(SI_Long)11L),(SI_Long)32L),(SI_Long)1L);
	    gensymed_symbol_1 = loose_end;
	    gensymed_symbol_4 = loose_end_delta_x_in_workspace;
		...
		if (plist && EQ(getfq_function_no_default(plist,
			...
			temp1 = 
				...
				(SI_Long)6L));
			reclaim_gensym_list_1(ISVREF(connection,(SI_Long)6L));
			temp = TRUEP(Noting_changes_to_kb_p);
			if (temp);
			else {
		...
		gensymed_symbol_3 = IFIX(position_on_side) << (SI_Long)2L;
    ...
    Object loose_end_1, loose_end_2;
{
    ...
    Object temp_1, temp_2, connection_item_table_binary_tree, element_qm;
    Object temp_3, gensymed_symbol_2, slot_group_qm;
    Object connection_2_frame_or_class, fsn, xa, ya;
	...
	if (EQ(ISVREF(connection_1,(SI_Long)2L),loose_end_1)) {
	    gensymed_symbol_1 = ISVREF(loose_end_1,(SI_Long)14L);
	    gensymed_symbol_1 = gensymed_symbol_1 ? 
	...
	if (EQ(ISVREF(connection_2,(SI_Long)2L),loose_end_2)) {
	    gensymed_symbol_1 = ISVREF(loose_end_2,(SI_Long)14L);
	    gensymed_symbol_1 = gensymed_symbol_1 ? 
		    ISVREF(gensymed_symbol_1,(SI_Long)5L) : Nil;
	...
	if (G2_has_v5_mode_windows_p) {
	    ...
	    gensymed_symbol_1 = ISVREF(ISVREF(connection_1,(SI_Long)3L),
		    (SI_Long)14L);
	    gensymed_symbol_1 = gensymed_symbol_1 ? 
		    ISVREF(gensymed_symbol_1,(SI_Long)5L) : Nil;
	...
	if (gensymed_symbol_1) {
	    ...
	    connection_item_table_binary_tree = gensymed_symbol_1;
	    element_qm = M_CDR(connection_item_table_binary_tree);
	    if (element_qm)
		reclaim_connection_item_table_leaves(element_qm);
	    ...
	    M_CDR(connection_item_table_binary_tree) = temp_3;
	    Available_gensym_conses = connection_item_table_binary_tree;
	...
	gensymed_symbol_1 = ISVREF(connection_1_fixed_end_block,(SI_Long)14L);
	gensymed_symbol_1 = gensymed_symbol_1 ? ISVREF(gensymed_symbol_1,
		(SI_Long)5L) : Nil;
    ...
    Object connection_1, connection_2;
{
    ...
    Object connection_1_cross_section_pattern, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp_1, temp_2, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
	...
	if (lookup_global_or_kb_specific_property_value(connection_1_connection_frame_or_class,
		Class_description_gkbprop)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = connection_1_connection_frame_or_class;
	    gensymed_symbol_2 = 
	...
	if (lookup_global_or_kb_specific_property_value(connection_2_connection_frame_or_class,
		Class_description_gkbprop)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = connection_2_connection_frame_or_class;
	    gensymed_symbol_2 = 
    ...
    Object connection_1, loose_end_1, connection_2, loose_end_2;
{
	...
	if (small_link_delta_p(link_2_delta)) {
	    ...
	    loose_end_orientations_same_p_1 = 
		    loose_end_orientations_same_p(connection_1,loose_end_1,
		    connection_2,loose_end_2);
	    new_last_deltas = gensym_cons_1(link_1_delta,Nil);
	}
	else
	    new_last_deltas = gensym_list_2(link_1_delta,link_2_delta);
	if ( !TRUEP(connection_1_delta_or_deltas))
	    ...
	    connection_1_delta_or_deltas = 
		    gensym_cons_1(connection_1_delta_or_deltas,
		    new_last_deltas);
	else
	    connection_1_delta_or_deltas = 
	...
	deltas_to_be_added_to_connection_1 = EQ(ISVREF(connection_2,
		...
		: 
		copy_list_using_gensym_conses_1(connection_2_delta_or_deltas)) 
	...
	if (absorb_link_when_joining_qm_1) {
	    ...
	    reclaim_gensym_cons_1(deltas_to_be_added_to_connection_1);
	}
	else
	...
	if (small_link_delta_p(link_2_delta)) {
	    ...
	    loose_end_orientations_same_p_1 = 
		    loose_end_orientations_same_p(connection_1,loose_end_1,
		    connection_2,loose_end_2);
	    connection_1_delta_or_deltas = gensym_cons_1(link_1_delta,
		    CDR(connection_1_delta_or_deltas) ? 
		    CDDR(connection_1_delta_or_deltas) : Nil);
	}
	else
	    connection_1_delta_or_deltas = gensym_cons_1(link_2_delta,
		    gensym_cons_1(link_1_delta,
		    CDR(connection_1_delta_or_deltas) ? 
		    CDDR(connection_1_delta_or_deltas) : Nil));
	absorb_link_when_joining_qm_1 = 
		absorb_link_when_joining_qm(loose_end_orientations_same_p_1,
	...
	if (reverse_connection_delta_pairs_for_output_connection_qm(connection_being_dragged_diagonal_p,
	    ...
	    reclaim_gensym_list_1(connection_1_delta_or_deltas);
	...
	if (absorb_link_when_joining_qm_1) {
	    ...
	    reclaim_gensym_cons_1(connection_1_delta_or_deltas);
	}
	else
    ...
    Object deltas;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    processed_deltas = gensym_cons_1(FIXNUM_NEGATE(delta),processed_deltas);
    goto next_loop;
  end_loop:
    ...
    Object deltas;
{
  ...
  next_loop:
	...
	goto end_loop;
    if (second_delta) {
	list_to_add = gensym_list_2(second_delta,first_delta);
	tail_of_list = CDR(list_to_add);
    }
    else {
	list_to_add = gensym_cons_1(first_delta,Nil);
...
Object Connection_handling_procedure_qm = UNBOUND;

Object Connection_handling_procedure_fsn_qm = UNBOUND;

Object Connection_handling_connection_queue = UNBOUND;
    ...
    Object queue;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(queue);
}

Object Connection_handling_fsn_queue = UNBOUND;

Object Connection_handling_window_queue = UNBOUND;

Object Connection_handling_connection_type_queue = UNBOUND;

Object Connection_handling_block_queue = UNBOUND;
...
Object g2_get_connection_to_handle()
{
    ...
    Object gensymed_symbol, xa, ya, temp_1, temp_2, temp_3, temp_4;
    char temp;
    ...
    temp_4 = gensym_pop_store;
    if (temp_4);
    else
	temp_4 = make_evaluation_truth_value_function(Falsity);
    return VALUES_4(temp_1,temp_2,temp_3,temp_4);
}
    ...
    Object block, connection_frame_1, name;
{
    ...
    Object gensymed_symbol_4, connection_item, svref_new_value;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
  ...
  end_2:;
	...
	if (ISVREF(connection_item,(SI_Long)2L)) {
	    reclaim_gensym_list_1(ISVREF(connection_item,(SI_Long)2L));
	    svref_new_value = gensym_cons_1(name,Nil);
	    return VALUES_1(SVREF(connection_item,FIX((SI_Long)2L)) = 
		    svref_new_value);
	}
	else {
	    if (ISVREF(connection_item,(SI_Long)1L))
		reclaim_gensym_list_1(ISVREF(connection_item,(SI_Long)1L));
	    svref_new_value = gensym_cons_1(name,Nil);
...
void connect3_INIT()
{
    ...
    Object Qconnection_handling_block_queue;
    Object Qconnection_handling_connection_type_queue;
    Object Qconnection_handling_window_queue, Qreclaim_slot_value_fsn_queue;
    Object Qconnection_handling_fsn_queue;
    Object Qconnection_handling_connection_queue, Qreclaim_frame_serial_number;
    Object Qconnection_handling_procedure_fsn_qm;
    Object Qconnection_handling_procedure_qm, list_constant_4;
    Object Qclasses_which_define, Qcleanup, Qcleanup_for_loose_end;
