    ...
    Object epilog_stream;
{
    ...
    PUSH_SPECIAL(Compile_reference_to_system_slot,compile_reference_to_system_slot,
	    0);
      emit_already_consed_instruction_to_stream(prolog_stream,
