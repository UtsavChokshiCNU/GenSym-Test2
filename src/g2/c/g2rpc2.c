...
Object Chain_of_available_resumable_circular_nodes = UNBOUND;

Object Resumable_circular_node_count = UNBOUND;
    ...
    Object resumable_circular_node;
{
    ...
    resumable_attribute_spec_qm = ISVREF(resumable_circular_node,(SI_Long)2L);
    ...
    svref_new_value = Chain_of_available_resumable_circular_nodes;
    SVREF(resumable_circular_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_circular_nodes = resumable_circular_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_circular_node_structure_internal()
{
    ...
    Object resumable_circular_node_count_new_value;
    ...
    resumable_circular_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_circular_node_count);
    Resumable_circular_node_count = resumable_circular_node_count_new_value;
...
Object Chain_of_available_resumable_value_nodes = UNBOUND;

Object Resumable_value_node_count = UNBOUND;
...
{
    Object old_structure_being_reclaimed, resumable_attribute_spec_qm;
    Object evaluation_value_qm, svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_value_nodes;
    SVREF(resumable_value_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_value_nodes = resumable_value_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_value_node_structure_internal()
{
    ...
    Object resumable_value_node_count_new_value;
    ...
    resumable_value_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_value_node_count);
    Resumable_value_node_count = resumable_value_node_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_resumable_instance_or_complex_value_node_mixins = UNBOUND;

Object Resumable_instance_or_complex_value_node_mixin_count = UNBOUND;
    ...
    Object resumable_instance_or_complex_value_node_mixin;
{
    ...
    resumable_attribute_spec_qm = 
	    ISVREF(resumable_instance_or_complex_value_node_mixin,(SI_Long)2L);
    if (CONSP(resumable_attribute_spec_qm))
	reclaim_gensym_list_1(resumable_attribute_spec_qm);
    SVREF(resumable_instance_or_complex_value_node_mixin,FIX((SI_Long)2L)) 
	    = Nil;
    reclaim_gensym_list_1(ISVREF(resumable_instance_or_complex_value_node_mixin,
	    (SI_Long)3L));
    SVREF(resumable_instance_or_complex_value_node_mixin,FIX((SI_Long)3L)) 
	    = Nil;
    reclaim_gensym_list_1(ISVREF(resumable_instance_or_complex_value_node_mixin,
	    (SI_Long)9L));
    SVREF(resumable_instance_or_complex_value_node_mixin,FIX((SI_Long)9L)) 
	    = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = 
	    Chain_of_available_resumable_instance_or_complex_value_node_mixins;
    SVREF(resumable_instance_or_complex_value_node_mixin,FIX((SI_Long)0L)) 
	    = svref_new_value;
    Chain_of_available_resumable_instance_or_complex_value_node_mixins = 
	    resumable_instance_or_complex_value_node_mixin;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_instance_or_complex_value_node_mixin_variable;
    Object resumable_instance_or_complex_value_node_mixin_count_new_value;
    ...
    def_structure_resumable_instance_or_complex_value_node_mixin_variable 
	    = Nil;
    resumable_instance_or_complex_value_node_mixin_count_new_value = 
	    FIXNUM_ADD1(Resumable_instance_or_complex_value_node_mixin_count);
...
Object Chain_of_available_resumable_instance_node_mixins = UNBOUND;

Object Resumable_instance_node_mixin_count = UNBOUND;
    ...
    Object resumable_instance_node_mixin;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_instance_node_mixin,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_instance_node_mixins;
    SVREF(resumable_instance_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_instance_node_mixins = 
	    resumable_instance_node_mixin;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_instance_node_mixin_variable, temp;
    ...
    temp = FIXNUM_ADD1(Resumable_instance_node_mixin_count);
    Resumable_instance_node_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_instance_node_mixins;
	SVREF(def_structure_resumable_instance_node_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_instance_node_mixins = 
		def_structure_resumable_instance_node_mixin_variable;
...
Object Chain_of_available_resumable_object_nodes = UNBOUND;

Object Resumable_object_node_count = UNBOUND;
    ...
    Object resumable_object_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_object_node,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_object_nodes;
    SVREF(resumable_object_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_object_nodes = resumable_object_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_object_node_structure_internal()
{
    ...
    Object resumable_object_node_count_new_value;
    ...
    resumable_object_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_object_node_count);
    Resumable_object_node_count = resumable_object_node_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_resumable_sequence_node_mixins = UNBOUND;

Object Resumable_sequence_node_mixin_count = UNBOUND;
    ...
    Object resumable_sequence_node_mixin;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_sequence_node_mixin,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_sequence_node_mixins;
    SVREF(resumable_sequence_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_sequence_node_mixins = 
	    resumable_sequence_node_mixin;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_sequence_node_mixin_variable, temp;
    ...
    temp = FIXNUM_ADD1(Resumable_sequence_node_mixin_count);
    Resumable_sequence_node_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_sequence_node_mixins;
	SVREF(def_structure_resumable_sequence_node_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_sequence_node_mixins = 
		def_structure_resumable_sequence_node_mixin_variable;
...
Object Chain_of_available_resumable_vector_node_mixins = UNBOUND;

Object Resumable_vector_node_mixin_count = UNBOUND;
    ...
    Object resumable_vector_node_mixin;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_vector_node_mixin,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_vector_node_mixins;
    SVREF(resumable_vector_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_vector_node_mixins = 
	    resumable_vector_node_mixin;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_vector_node_mixin_variable, temp;
    Object defstruct_g2_resumable_vector_node_mixin_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,41);
    def_structure_resumable_vector_node_mixin_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_vector_node_mixin_count);
    Resumable_vector_node_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_vector_node_mixins;
	SVREF(def_structure_resumable_vector_node_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_vector_node_mixins = 
		def_structure_resumable_vector_node_mixin_variable;
...
Object Chain_of_available_resumable_object_vector_nodes = UNBOUND;

Object Resumable_object_vector_node_count = UNBOUND;
    ...
    Object resumable_object_vector_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_object_vector_node,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_object_vector_nodes;
    SVREF(resumable_object_vector_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_object_vector_nodes = 
	    resumable_object_vector_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_object_vector_node_structure_internal()
{
    ...
    Object resumable_object_vector_node_count_new_value;
    ...
    resumable_object_vector_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_object_vector_node_count);
...
Object Chain_of_available_resumable_value_vector_nodes = UNBOUND;

Object Resumable_value_vector_node_count = UNBOUND;
    ...
    Object resumable_value_vector_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_value_vector_node,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_value_vector_nodes;
    SVREF(resumable_value_vector_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_value_vector_nodes = 
	    resumable_value_vector_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_value_vector_node_structure_internal()
{
    ...
    Object resumable_value_vector_node_count_new_value;
    ...
    resumable_value_vector_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_value_vector_node_count);
...
Object Size_of_cached_subsequence_for_resumable_history = UNBOUND;
...
{
    Object element_qm, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    ...
    Object icp_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(icp_list);
    return VALUES_1(Nil);
}

Object The_type_description_of_resumable_history_node = UNBOUND;

Object Chain_of_available_resumable_history_nodes = UNBOUND;

Object Resumable_history_node_count = UNBOUND;
    ...
    Object resumable_history_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_history_node,(SI_Long)9L));
    ...
    reclaim_gensym_list_1(ISVREF(resumable_history_node,(SI_Long)21L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_history_nodes;
    SVREF(resumable_history_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_history_nodes = resumable_history_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_history_node_structure_internal()
{
    ...
    Object resumable_history_node_count_new_value;
    ...
    resumable_history_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_history_node_count);
    Resumable_history_node_count = resumable_history_node_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_resumable_list_node_mixins = UNBOUND;

Object Resumable_list_node_mixin_count = UNBOUND;
    ...
    Object resumable_list_node_mixin;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_list_node_mixin,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_list_node_mixins;
    SVREF(resumable_list_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_list_node_mixins = resumable_list_node_mixin;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_list_node_mixin_variable, temp;
    Object defstruct_g2_resumable_list_node_mixin_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,67);
    def_structure_resumable_list_node_mixin_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_list_node_mixin_count);
    Resumable_list_node_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_list_node_mixins;
	SVREF(def_structure_resumable_list_node_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_list_node_mixins = 
		def_structure_resumable_list_node_mixin_variable;
...
Object Chain_of_available_resumable_object_list_nodes = UNBOUND;

Object Resumable_object_list_node_count = UNBOUND;
    ...
    Object resumable_object_list_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_object_list_node,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_object_list_nodes;
    SVREF(resumable_object_list_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_object_list_nodes = 
	    resumable_object_list_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_object_list_node_structure_internal()
{
    ...
    Object resumable_object_list_node_count_new_value;
    ...
    resumable_object_list_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_object_list_node_count);
...
Object Chain_of_available_resumable_value_list_nodes = UNBOUND;

Object Resumable_value_list_node_count = UNBOUND;
    ...
    Object resumable_value_list_node;
{
    ...
    reclaim_gensym_list_1(ISVREF(resumable_value_list_node,(SI_Long)9L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_value_list_nodes;
    SVREF(resumable_value_list_node,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_value_list_nodes = resumable_value_list_node;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_value_list_node_structure_internal()
{
    ...
    Object resumable_value_list_node_count_new_value;
    ...
    resumable_value_list_node_count_new_value = 
	    FIXNUM_ADD1(Resumable_value_list_node_count);
...
Object Chain_of_available_resumable_evaluation_sequence_node_mixins = UNBOUND;

Object Resumable_evaluation_sequence_node_mixin_count = UNBOUND;
    ...
    Object resumable_evaluation_sequence_node_mixin;
{
    ...
    svref_new_value = 
	    Chain_of_available_resumable_evaluation_sequence_node_mixins;
    SVREF(resumable_evaluation_sequence_node_mixin,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_resumable_evaluation_sequence_node_mixins = 
	    resumable_evaluation_sequence_node_mixin;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_evaluation_sequence_node_mixin_structure_internal()
{
    ...
    x_note_fn_call(168,85);
    def_structure_resumable_evaluation_sequence_node_mixin_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_evaluation_sequence_node_mixin_count);
    Resumable_evaluation_sequence_node_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_evaluation_sequence_node_mixins;
	SVREF(def_structure_resumable_evaluation_sequence_node_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_evaluation_sequence_node_mixins = 
		def_structure_resumable_evaluation_sequence_node_mixin_variable;
...
Object Chain_of_available_resumable_evaluation_sequence_nodes = UNBOUND;

Object Resumable_evaluation_sequence_node_count = UNBOUND;
    ...
    Object resumable_evaluation_sequence_node;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_evaluation_sequence_nodes;
    SVREF(resumable_evaluation_sequence_node,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_resumable_evaluation_sequence_nodes = 
	    resumable_evaluation_sequence_node;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_evaluation_sequence_node_variable, temp;
    Object defstruct_g2_resumable_evaluation_sequence_node_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,91);
    def_structure_resumable_evaluation_sequence_node_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_evaluation_sequence_node_count);
    Resumable_evaluation_sequence_node_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_evaluation_sequence_nodes;
	SVREF(def_structure_resumable_evaluation_sequence_node_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_evaluation_sequence_nodes = 
		def_structure_resumable_evaluation_sequence_node_variable;
...
Object Chain_of_available_resumable_evaluation_structure_nodes = UNBOUND;

Object Resumable_evaluation_structure_node_count = UNBOUND;
    ...
    Object resumable_evaluation_structure_node;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_evaluation_structure_nodes;
    SVREF(resumable_evaluation_structure_node,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_resumable_evaluation_structure_nodes = 
	    resumable_evaluation_structure_node;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_resumable_evaluation_structure_node_variable, temp;
    Object defstruct_g2_resumable_evaluation_structure_node_variable;
    Object the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,97);
    def_structure_resumable_evaluation_structure_node_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_evaluation_structure_node_count);
    Resumable_evaluation_structure_node_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_evaluation_structure_nodes;
	SVREF(def_structure_resumable_evaluation_structure_node_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_evaluation_structure_nodes = 
		def_structure_resumable_evaluation_structure_node_variable;
    ...
    Object inferior_attributes;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(inferior_attributes);
    return VALUES_1(Nil);
}
    ...
    Object internal_value_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(internal_value_list);
    return VALUES_1(Nil);
}

Object Available_object_circularity_hashtable_hash_vector_131_vectors = UNBOUND;

Object Count_of_object_circularity_hashtable_hash_vector_131_vectors = UNBOUND;
...
{
    Object count_of_object_circularity_hashtable_hash_vector_131_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(168,105);
    count_of_object_circularity_hashtable_hash_vector_131_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_object_circularity_hashtable_hash_vector_131_vectors);
...
Object make_object_circularity_hashtable_hash_vector()
{
    ...
    x_note_fn_call(168,106);
    if (Available_object_circularity_hashtable_hash_vector_131_vectors) {
	temp = 
		M_CAR(Available_object_circularity_hashtable_hash_vector_131_vectors);
	temp_1 = 
		M_CDR(Available_object_circularity_hashtable_hash_vector_131_vectors);
	inline_note_reclaim_cons(Available_object_circularity_hashtable_hash_vector_131_vectors,
		Qab_gensym);
	cdr_arg = 
...
/* RECLAIM-OBJECT-CIRCULARITY-HASHTABLE-TREE-FOR-HASH-LEAVES */
Object reclaim_object_circularity_hashtable_tree_for_hash_leaves(object_circularity_hashtable_tree_for_hash_binary_tree)
    Object object_circularity_hashtable_tree_for_hash_binary_tree;
{
    ...
    x_note_fn_call(168,108);
    less_than_branch_qm = Nil;
    greater_than_branch_qm = Nil;
    alist = Nil;
  next_loop:
    if ( !TRUEP(object_circularity_hashtable_tree_for_hash_binary_tree))
	goto end_loop;
    less_than_branch_qm = 
	    ISVREF(object_circularity_hashtable_tree_for_hash_binary_tree,
	    (SI_Long)1L);
    greater_than_branch_qm = 
	    ISVREF(object_circularity_hashtable_tree_for_hash_binary_tree,
	    (SI_Long)2L);
    alist = ISVREF(object_circularity_hashtable_tree_for_hash_binary_tree,
	    (SI_Long)3L);
    reclaim_binary_tree_element_1(object_circularity_hashtable_tree_for_hash_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
    if ( !TRUEP(ab_loop_list_))
  ...
  end_loop_1:;
	...
	reclaim_object_circularity_hashtable_tree_for_hash_leaves(less_than_branch_qm);
	object_circularity_hashtable_tree_for_hash_binary_tree = 
		greater_than_branch_qm;
    }
    else {
	...
	object_circularity_hashtable_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
Object clear_object_circularity_hashtable_tree(object_circularity_hashtable_tree_for_hash_binary_tree)
    Object object_circularity_hashtable_tree_for_hash_binary_tree;
{
    Object element_qm;

    x_note_fn_call(168,109);
    element_qm = CDR(object_circularity_hashtable_tree_for_hash_binary_tree);
    if (element_qm) {
	reclaim_object_circularity_hashtable_tree_for_hash_leaves(element_qm);
	M_CDR(object_circularity_hashtable_tree_for_hash_binary_tree) = Nil;
    }
    return VALUES_1(object_circularity_hashtable_tree_for_hash_binary_tree);
}
...
Object reclaim_object_circularity_hashtable(object_circularity_hashtable_hash_table)
    Object object_circularity_hashtable_hash_table;
{
    Object object_circularity_hashtable_tree_for_hash_binary_tree, element_qm;
    Object cdr_new_value, temp;
    SI_Long index_1;

    x_note_fn_call(168,113);
    index_1 = (SI_Long)0L;
  next_loop:
    if (index_1 >= (SI_Long)131L)
	goto end_loop;
    ...
    element_qm = M_CDR(object_circularity_hashtable_tree_for_hash_binary_tree);
    if (element_qm)
	reclaim_object_circularity_hashtable_tree_for_hash_leaves(element_qm);
    inline_note_reclaim_cons(object_circularity_hashtable_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(object_circularity_hashtable_tree_for_hash_binary_tree) = 
	    cdr_new_value;
    Available_gensym_conses = 
	    object_circularity_hashtable_tree_for_hash_binary_tree;
...
Object Chain_of_available_sending_resumable_objects = UNBOUND;

Object Sending_resumable_object_count = UNBOUND;
...
{
    Object old_structure_being_reclaimed, resumable_node_qm, svref_new_value;

    x_note_fn_call(168,116);
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_sending_resumable_objects;
    SVREF(sending_resumable_object,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_sending_resumable_objects = sending_resumable_object;
    return VALUES_1(Nil);
}
...
Object make_permanent_sending_resumable_object_structure_internal()
{
    ...
    Object sending_resumable_object_count_new_value;
    Object defstruct_g2_sending_resumable_object_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,118);
    def_structure_sending_resumable_object_variable = Nil;
    sending_resumable_object_count_new_value = 
	    FIXNUM_ADD1(Sending_resumable_object_count);
    Sending_resumable_object_count = sending_resumable_object_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_sending_resumable_object_variable, svref_new_value;

    x_note_fn_call(168,119);
    def_structure_sending_resumable_object_variable = 
	    Chain_of_available_sending_resumable_objects;
    ...
    SVREF(def_structure_sending_resumable_object_variable,
	    FIX((SI_Long)17L)) = Nil;
    svref_new_value = make_object_circularity_hashtable();
    SVREF(def_structure_sending_resumable_object_variable,
	    FIX((SI_Long)18L)) = svref_new_value;
    SVREF(def_structure_sending_resumable_object_variable,
	    FIX((SI_Long)19L)) = Nil;
    return VALUES_1(def_structure_sending_resumable_object_variable);
}
    ...
    Object object, resumable_object;
{
    ...
    Object circular_resumable_node_qm, current_icp_socket, current_icp_port;
    Object icp_object_index_qm, new_index, disable_resumability;
    ...
    double gensymed_symbol_8, gensymed_symbol_9, aref_new_value;
    Declare_special(14);
    Object result;

    x_note_fn_call(168,121);
  ...
  next_loop:
	...
	if (EQ(gensymed_symbol_2,gensymed_symbol_4)) {
	    circular_resumable_node_qm = M_CDR(M_CAR(gensymed_symbol_1));
	    goto end_1;
	}
	gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	goto next_loop_1;
      end_loop_1:
	circular_resumable_node_qm = Qnil;
      end_1:;
	goto end_2;
    }
    goto next_loop;
  ...
  end_2:;
	...
	PUSH_SPECIAL(Current_icp_socket,current_icp_socket,13);
	  current_icp_port = ISVREF(Current_icp_socket,(SI_Long)4L);
	  PUSH_SPECIAL(Current_icp_port,current_icp_port,12);
	    icp_object_index_qm = 
    ...
    Object object, resumable_object, resumable_node;
{
    ...
    x_note_fn_call(168,122);
    gensymed_symbol = IFIX(frame_hash_function(object));
    temp = ISVREF(resumable_object,(SI_Long)18L);
    temp_1 = gensymed_symbol % (SI_Long)131L;
    return set_balanced_binary_tree_entry(SVREF(temp,FIX(temp_1)),Qeq,Nil,
	    T,object,FIX(gensymed_symbol),resumable_node);
}
...
Object Chain_of_available_object_passing_infos = UNBOUND;

Object Object_passing_info_count = UNBOUND;
    ...
    Object object_passing_info;
{
    ...
    x_note_fn_call(168,127);
    inline_note_reclaim_cons(object_passing_info,Nil);
    svref_new_value = Chain_of_available_object_passing_infos;
    SVREF(object_passing_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_object_passing_infos = object_passing_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_object_passing_info_structure_internal()
{
    ...
    Object defstruct_g2_object_passing_info_variable, svref_new_value;
    SI_Long object_passing_info_count_new_value, gensymed_symbol;
    SI_Long gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(168,129);
    def_structure_object_passing_info_variable = Nil;
    object_passing_info_count_new_value = IFIX(Object_passing_info_count) 
	    + (SI_Long)100L;
    Object_passing_info_count = FIX(object_passing_info_count_new_value);
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
...
{
    Object def_structure_object_passing_info_variable;

    x_note_fn_call(168,130);
    def_structure_object_passing_info_variable = 
	    Chain_of_available_object_passing_infos;
...
Object G2_to_g2_uses_references_p = UNBOUND;
    ...
    Object registered_item;
{
	...
	PUSH_SPECIAL(Writing_resumable_icp_messages_p,writing_resumable_icp_messages_p,
	  ...
	  if ( !TRUEP(Inhibit_corresponding_icp_object_making)) {
	      ...
	      PUSH_SPECIAL(Corresponding_icp_object_index_for_item_reference,corresponding_icp_object_index_for_item_reference,
		      0);
		if (sensor_p)
    ...
    Object index_1, output_port_p;
{
	...
	set_balanced_binary_tree_entry(SVREF(index_space,FIX(temp_2)),Qeq,
    ...
    Object item, icp_socket;
{
    ...
    x_note_fn_call(168,155);
    deregister_corresponding_object_qm = T;
    PUSH_SPECIAL(Deregister_corresponding_object_qm,deregister_corresponding_object_qm,
	    0);
    ...
    Object system_item;
{
    ...
    x_note_fn_call(168,158);
    if ( !TRUEP(In_suspend_resume_p)) {
	do_not_reclaim_runs_while_inactive_entries = T;
	PUSH_SPECIAL(Do_not_reclaim_runs_while_inactive_entries,do_not_reclaim_runs_while_inactive_entries,
		0);
...
{
    x_note_fn_call(168,160);
    if (object_passing_info_qm) {
	reclaim_icp_object_map_for_registered_item(system_item);
	reclaim_gensym_tree_1(ISVREF(object_passing_info_qm,(SI_Long)2L));
...
Object g2_reclaim_sending_resumable_object varargs_1(int, n)
{
    ...
    Object this_resumable_object, gensymed_symbol, gensymed_symbol_1;
    Object previous_cons, this_resumable_object_cons_qm, temp;
    Object rpc_identifier_qm;
    Declare_varargs_nonrelocating;

    x_note_fn_call(168,162);
    INIT_ARGS_nonrelocating();
	...
	if (head_contents_qm) {
		...
		gensymed_symbol = ISVREF(icp_socket,(SI_Long)31L);
		gensymed_symbol_1 = Nil;
		if (gensymed_symbol) {
		    gensymed_symbol_1 = CDR(gensymed_symbol);
		    SVREF(icp_socket,FIX((SI_Long)31L)) = gensymed_symbol_1;
		    if ( !TRUEP(gensymed_symbol_1))
			SVREF(icp_socket,FIX((SI_Long)32L)) = Nil;
		...
		if (EQ(resumable_object,this_resumable_object)) {
		    ...
		    reclaim_gensym_cons_1(this_resumable_object_cons_qm);
		    goto end_1;
		}
	...
	temp = delete_gensym_element_1(resumable_object,
    ...
    Object child_node, parent_node;
{
    ...
    x_note_fn_call(168,165);
    new_tail = gensym_cons_1(child_node,Nil);
    ...
    Object resumable_object, last_attribute_p;
{
    ...
    Object history_qm, temp_2, temp_3, exported_attribute_names;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(168,168);
	...
	if (temp) {
		...
		if (temp) {
			...
			if (temp) {
			    ...
			    temp_3 = 
				    count_of_symbolic_attributes(inferior_attribute_names_qm);
			    if ( !TRUEP(ISVREF(child_object_or_value,
				    (SI_Long)20L))) {
				if (Noting_changes_to_kb_p)
				    note_change_to_block_1(child_object_or_value,
					    Qlist_structure);
				svref_new_value = 
					create_empty_g2_list_structure();
				SVREF(child_object_or_value,
					FIX((SI_Long)20L)) = svref_new_value;
			    }
			    temp_1 = ISVREF(ISVREF(child_object_or_value,
				...
				temp_1 = 
					ISVREF(ISVREF(child_object_or_value,
					(SI_Long)20L),(SI_Long)0L);
				child_node = 
				...
				if (temp) {
					...
					return gensym_list_2(Qsending_a_non_object_by_copy_to_a_pre_release_5_g2_or_gsi,
	    ...
	    if (last_attribute_p) {
		svref_new_value = gensym_cons_1(grandparent,
			ISVREF(child_node,(SI_Long)9L));
		...
		svref_new_value = gensym_cons_1(Nil,ISVREF(child_node,
			(SI_Long)9L));
		SVREF(child_node,FIX((SI_Long)9L)) = svref_new_value;
    ...
    Object ascending_node;
{
	...
	reclaim_gensym_list_1(superiors_qm);
	if (parent_qm) {
	...
	if (highest_superior_qm) {
		...
		gensym_cons = superiors_qm;
	      next_loop_2:
		inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		if (EQ(gensym_cons,highest_superior_cons_qm))
		    goto end_1;
	    ...
	    M_CDR(highest_superior_cons_qm) = temp_1;
	    Available_gensym_conses = superiors_qm;
	}
	else {
	    SVREF(ascending_node,FIX((SI_Long)6L)) = parent_qm;
	    ISVREF(ascending_node,(SI_Long)7L) = FIX((SI_Long)1L);
	    if (superiors_qm)
		reclaim_gensym_cons_1(superiors_qm);
	}
	return VALUES_1(Qnil);
    }
}
    ...
    Object resumable_object, current_node;
{
    ...
    Object remaining_attribute_names_qm, gensym_pop_store, cons_1, next_cons;
    Object temp, highest_index, current_index, contents, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, internal_list, list_index;
  ...
  check_timeslice:
	...
	list_elements_remain_p = EQ(ISVREF(internal_list,(SI_Long)3L),
		current_object);
	remaining_attribute_names_qm = ISVREF(current_node,(SI_Long)16L);
	if ( !list_elements_remain_p &&  !TRUEP(remaining_attribute_names_qm))
	    ...
	    next_element_qm = ISVREF(internal_list,(SI_Long)0L);
	    ...
	    last_attribute_p = remaining_attribute_names_qm ? Nil :  
		    !EQ(ISVREF(next_element_qm,(SI_Long)3L),
		    current_object) ? T : Nil;
	    contents = ISVREF(internal_list,(SI_Long)2L);
	    gensymed_symbol = contents;
	    temp_1 = FIXNUMP(gensymed_symbol);
	    if (temp_1);
	    else
    ...
    Object resumable_object;
{
    ...
    Object task, ctask, p, v, q, def_structure_queue_element_variable;
    Object gensymed_symbol_1, new_resumable_node;
    char g2_p;
    double aref_new_value;
    Declare_special(1);
    Object result;

    x_note_fn_call(168,171);
    rpc_throw_tag = Nil;
    PUSH_SPECIAL(Rpc_throw_tag,rpc_throw_tag,0);
	...
	next_loop:
	  ...
	  goto next_loop;
	end_loop:
	  reclaim_gensym_list_1(abort_info);
	  ...
	  if (time_slice_expired_p()) {
	      current_task_schedule_modify_arg_2 = ISVREF(resumable_object,
		      (SI_Long)14L);
	      current_task_schedule_modify_arg_8 = 
		      SYMBOL_FUNCTION(Qtry_to_transmit_resumable_object);
	      current_task_schedule_modify_arg_11 = resumable_object;
	      ...
	      result = VALUES_1(SVREF(resumable_object,FIX((SI_Long)19L)) 
		      = task);
	  }
	  else
	  ...
	  current_task_schedule_modify_arg_2 = ISVREF(resumable_object,
		  (SI_Long)14L);
	  current_task_schedule_modify_arg_8 = 
		  SYMBOL_FUNCTION(Qtry_to_preflight_resumable_object);
	  current_task_schedule_modify_arg_11 = resumable_object;
	  schedule_task_qm = ISVREF(resumable_object,(SI_Long)19L);
	  if (schedule_task_qm) {
	      if (EQ(schedule_task_qm,Current_schedule_task))
	  ...
	  if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	      Priority_of_next_task = p;
	  result = VALUES_1(SVREF(resumable_object,FIX((SI_Long)19L)) = task);
      }
      else
...
Object Rpc_object_arguments_to_run_or_schedule_qm = UNBOUND;
...
Object send_deferred_rpc_objects_if_any()
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(Rpc_object_arguments_to_run_or_schedule_qm);
...
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, kind;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(168,177);
	...
	Rpc_object_arguments_to_run_or_schedule_qm = 
		gensym_cons_1(rpc_value_or_object,
		Rpc_object_arguments_to_run_or_schedule_qm);
    }
    return VALUES_1(Nil);
}
...
{
    Object icp_socket, temp, first_resumable_object_qm, temp_1;
    Object gensymed_symbol, gensymed_symbol_1, waiting_object_qm;
    Object current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8;
    Object current_task_schedule_modify_arg_11, schedule_task_qm;
    Object old_structure_being_reclaimed, temp_3;
    Object def_structure_schedule_task_variable, task, ctask, p, v, q;
    Object def_structure_queue_element_variable;
    char temp_2, g2_p;
    double aref_new_value;

    x_note_fn_call(168,178);
	...
	current_task_schedule_modify_arg_2 = ISVREF(waiting_object_qm,
		(SI_Long)14L);
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qtry_to_transmit_resumable_object);
	current_task_schedule_modify_arg_11 = waiting_object_qm;
	schedule_task_qm = ISVREF(waiting_object_qm,(SI_Long)19L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	    ...
	    SVREF(schedule_task_qm,FIX((SI_Long)9L)) = Nil;
	    Structure_being_reclaimed = old_structure_being_reclaimed;
	    temp_3 = Chain_of_available_schedule_tasks;
	...
	if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	    Priority_of_next_task = p;
	SVREF(waiting_object_qm,FIX((SI_Long)19L)) = task;
    }
    return VALUES_1(Nil);
}

Object Default_most_recent_bandwidth_per_timeslice = UNBOUND;

Object Minimum_bandwidth_per_timeslice = UNBOUND;

Object Most_recent_bandwidth_per_timeslice_qm = UNBOUND;
    ...
    Object icp_port;
{
	...
	if (IFIX(new_bandwidth_available) > (SI_Long)0L) {
		...
		interning_details = 
			gensym_cons_1(gensym_cons_1(FIX(vector_index),
    ...
    Object resumable_value_list_node, resumable_object;
{
	...
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    return gensym_list_2(Qg2_value_list_length_changed,temp);
}
    ...
    Object icp_port;
{
  ...
  next_loop:
	...
	if (corresponding_index_qm)
	    interning_details = 
		    gensym_cons_1(gensym_cons_1(number_of_elements,
		    corresponding_index_qm),interning_details);
    }
    else
	goto end_loop;
    list_element = ISVREF(list_element,(SI_Long)0L);
    goto next_loop;
  end_loop:
    list_elements_remain_p = EQ(ISVREF(list_element,(SI_Long)3L),
	    ISVREF(resumable_value_list_node,(SI_Long)4L));
    ...
    Object potential_problem_name;
{
	...
	record_object_building_problem_on_receiving_side_1(potential_problem_name,
		...
		gensym_cons_1(problem_string_qm,Nil),
	...
	if (new_value_qm) {
		...
		PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
		  ...
		  if (ISVREF(variable_or_parameter,(SI_Long)24L)) {
		      ...
		      PUSH_SPECIAL(G2_time_at_start,g2_time_at_start,0);
    ...
    Object tag;
{
	...
	switch (INTEGER_TO_CHAR(tag)) {
	  case 13:
	    ...
	    temp = qualifier ? gensym_cons_1(Qclass_qualified_name,
		    gensym_cons_1(qualifier,gensym_cons_1(base_name,Nil))) 
		    : base_name;
	    break;
	  case 12:
    ...
    Object object, attribute_name, attribute_qualifier_qm, new_value_qm;
{
    ...
    Object gensym_list_tail, gensym_cons, cdr_new_value, error_text;
    Declare_catch(1);
    Object result;

    x_note_fn_call(168,207);
    if (PUSH_CATCH(Kstack_error,0)) {
	if ( !TRUEP(new_value_qm))
	    result = VALUES_1(T);
	else {
	    component = gensym_list_4(Qattribute,attribute_name,Nil,
    ...
    Object attribute_name_or_index, leaf;
{
	...
	if (EQ(attribute_type,Qattribute)) {
		...
		PUSH_SPECIAL(Allow_no_value_p,allow_no_value_p,0);
...
{
    Object current_subobject_qm, svref_arg_1, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, svref_new_value;

    x_note_fn_call(168,212);
    if ( !TRUEP(ISVREF(Current_receiving_resumable_object,(SI_Long)10L))) {
    ...
    Object attribute_name_or_index, class_name;
{
    ...
    Object new_object, gensym_push_modify_macro_arg, car_1, cdr_1;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(168,213);
    if (EQ(attribute_type,Qattribute)) {
	...
	if ( !temp) {
	    ...
	    gensym_push_modify_macro_arg = 
		    gensym_cons_1(Current_receiving_resumable_object,
		    current_subobject);
	    car_1 = gensym_push_modify_macro_arg;
	    gensymed_symbol = 
    ...
    Object object;
{
    ...
    Object receiving_resumable_object_qm, parent_object, gensym_pop_store;
    Object cons_1, next_cons, temp_1, gensymed_symbol_1, slot_group_qm;
    Object trailing_cons, receiving_resumable_object, ab_loop_list_;
    Object ab_loop_desetq_, reclaimable_cons;

    x_note_fn_call(168,215);
	...
	if (receiving_resumable_object_qm && 
	    ...
	    reclaim_gensym_cons_1(gensym_pop_store);
	  ...
	  next_loop:
		...
		reclaim_gensym_cons_1(CAR(reclaimable_cons));
		reclaim_gensym_cons_1(reclaimable_cons);
		return VALUES_1(parent_object);
	    }
    ...
    Object class_name;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, element_type;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;

    x_note_fn_call(168,218);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = class_name;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_name) & 
	    IFIX(Most_positive_fixnum);
    ...
    Object resumable_vector_length;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, sub_class_bit_vector, new_value_vector_qm, x2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;

    x_note_fn_call(168,219);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = class_name;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_name) & 
	    IFIX(Most_positive_fixnum);
    ...
    Object class_name, symbolic_attribute_count, resumable_list_length;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, sub_class_bit_vector, new_object_list_qm, x2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;

    x_note_fn_call(168,221);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = class_name;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_name) & 
	    IFIX(Most_positive_fixnum);
    ...
    Object resumable_list_length;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, sub_class_bit_vector, new_value_list_qm, x2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;

    x_note_fn_call(168,223);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = class_name;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_name) & 
	    IFIX(Most_positive_fixnum);
    ...
    Object number_of_elements, resumable_node, interning_details_qm;
{
    ...
    Object next_interning_index_qm, ab_loop_iter_flag_, gensym_pop_store;
    Object cons_1, next_cons, temp;
    SI_Long ab_loop_repeat_, vector_index;

    x_note_fn_call(168,224);
    ...
    if (interning_details_qm)
	reclaim_gensym_tree_1(interning_details_qm);
    return VALUES_1(Nil);
}
...
void g2_rpc2_INIT()
{
    ...
    Object Qmost_recent_bandwidth_per_timeslice_qm, Qg2_rpc2;
    Object Qrpc_object_arguments_to_run_or_schedule_qm;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qslot_value_reclaimer;
    Object Qreclaim_object_passing_info_qm_value, Qclasses_which_define;
    Object Qcleanup, Qsystem_item, Qcleanup_for_system_item, Qdeactivate;
    Object Qdeactivate_for_system_item;
    ...
    Object Qobject_passing_info_count;
    Object Qchain_of_available_object_passing_infos, string_constant_53;
    ...
    Object Qsending_resumable_object_count;
    Object Qchain_of_available_sending_resumable_objects, string_constant_51;
    ...
    Object string_constant_48;
    Object Qcount_of_object_circularity_hashtable_hash_vector_131_vectors;
    Object Qavailable_object_circularity_hashtable_hash_vector_131_vectors;
    Object Qresumable_evaluation_structure_node;
    ...
    Object Qresumable_evaluation_structure_node_count;
    Object Qchain_of_available_resumable_evaluation_structure_nodes;
    ...
    Object Qresumable_evaluation_sequence_node_count;
    Object Qchain_of_available_resumable_evaluation_sequence_nodes;
    ...
    Object Qresumable_evaluation_sequence_node_mixin_count;
    Object Qchain_of_available_resumable_evaluation_sequence_node_mixins;
    ...
    Object Qresumable_value_list_node_count;
    Object Qchain_of_available_resumable_value_list_nodes, string_constant_41;
    Object string_constant_30, string_constant_40, Qresumable_object_list_node;
    Object Qoutstanding_resumable_object_list_node_count;
    Object Qresumable_object_list_node_structure_memory_usage;
    Object Qresumable_object_list_node_count;
    Object Qchain_of_available_resumable_object_list_nodes, string_constant_39;
    Object string_constant_38, string_constant_37, Qresumable_list_node_mixin;
    Object Qoutstanding_resumable_list_node_mixin_count;
    Object Qresumable_list_node_mixin_structure_memory_usage;
    Object Qresumable_list_node_mixin_count;
    Object Qchain_of_available_resumable_list_node_mixins, string_constant_36;
    Object string_constant_35, Qresumable_history_node;
    Object Qoutstanding_resumable_history_node_count;
    Object Qresumable_history_node_structure_memory_usage;
    Object Qresumable_history_node_count;
    Object Qchain_of_available_resumable_history_nodes, string_constant_34;
    ...
    Object Qresumable_value_vector_node_count;
    Object Qchain_of_available_resumable_value_vector_nodes;
    ...
    Object Qresumable_object_vector_node_count;
    Object Qchain_of_available_resumable_object_vector_nodes;
    ...
    Object Qresumable_vector_node_mixin_count;
    Object Qchain_of_available_resumable_vector_node_mixins;
    ...
    Object Qresumable_sequence_node_mixin_count;
    Object Qchain_of_available_resumable_sequence_node_mixins;
    Object string_constant_23, string_constant_22, Qresumable_object_node;
    Object Qoutstanding_resumable_object_node_count;
    Object Qresumable_object_node_structure_memory_usage;
    Object Qresumable_object_node_count;
    Object Qchain_of_available_resumable_object_nodes, string_constant_21;
    ...
    Object Qresumable_instance_node_mixin_count;
    Object Qchain_of_available_resumable_instance_node_mixins;
    ...
    Object Qresumable_instance_or_complex_value_node_mixin_count;
    Object Qchain_of_available_resumable_instance_or_complex_value_node_mixins;
    Object string_constant_16, string_constant_15, Qresumable_value_node;
    Object Qoutstanding_resumable_value_node_count;
    Object Qresumable_value_node_structure_memory_usage;
    Object Qresumable_value_node_count;
    Object Qchain_of_available_resumable_value_nodes, string_constant_14;
    Object string_constant_13, Qresumable_circular_node;
    Object Qoutstanding_resumable_circular_node_count;
    Object Qresumable_circular_node_structure_memory_usage;
    Object Qresumable_circular_node_count;
    Object Qchain_of_available_resumable_circular_nodes, string_constant_12;
    Object string_constant_11;

    x_note_fn_call(168,232);
    SET_PACKAGE("AB");
    ...
    string_constant_11 = 
	    STATIC_STRING("43Dy8m83mRy1o83mRy83*Ay8n8k1l83*Ay0000001m1m8x83*Ay1n8y83-5Vy1n830ny83-Bvy83=jykok0k0");
    ...
    Qresumable_circular_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_12 = STATIC_STRING("1q83mRy8s83-lJy09k9l");
    ...
    string_constant_13 = 
	    STATIC_STRING("43Dy8m83mZy1o83mZy83*Ay8n8k1l83*Ay0000001m1m8x83*Ay1n8y83-5dy1n830ny83-Buy83=jykpk0k0");
    ...
    Qresumable_value_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_14 = STATIC_STRING("1q83mZy8s83-lay09k9l");
    clear_optimized_constants();
	...
	The_type_description_of_resumable_instance_or_complex_value_node_mixin 
		= Nil;
    string_constant_15 = 
	    STATIC_STRING("43Dy8m83*jy1p83*jy83*cy83*Ay8n8k1l83*cy0000001l1m8x83*cykuk0k0");
    temp = 
	    The_type_description_of_resumable_instance_or_complex_value_node_mixin;
    The_type_description_of_resumable_instance_or_complex_value_node_mixin 
	    = load_and_initialize_type_description(temp,
    ...
    Qresumable_instance_or_complex_value_node_mixin_structure_memory_usage 
	    ...
	    AB_package);
    string_constant_16 = STATIC_STRING("1q83*jy8s83-lRy09k9l");
    clear_optimized_constants();
    ...
    string_constant_17 = 
	    STATIC_STRING("43Dy8m83=Wy1q83=Wy83*jy83*cy83*Ay8n8k1l83*jy0000001l1m8x83*jyk3Eyk0k0");
    ...
    Qresumable_instance_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_18 = STATIC_STRING("1q83=Wy8s83-lQy09k9l");
    clear_optimized_constants();
    ...
    string_constant_19 = 
	    STATIC_STRING("43Dy8m83mWy1r83mWy83=Wy83*jy83*cy83*Ay8n8k1l83=Wy0000001n1m8x83=Wy1n8y83-5ay1r830oy832Iy831qy832Oy830ny832Hy83=jy1m83My83-B0yk3E");
    ...
    Qresumable_object_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_21 = STATIC_STRING("1q83mWy8s83-lWy09k9l");
    clear_optimized_constants();
    ...
    string_constant_22 = 
	    STATIC_STRING("43Dy8m830Ry1r830Ry83=Wy83*jy83*cy83*Ay8n8k1l83=Wy0000001l1m8x83=Wyk3Gyk0k0");
    ...
    Qresumable_sequence_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_23 = STATIC_STRING("1q830Ry8s83-lYy09k9l");
    clear_optimized_constants();
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8m837Oy1s837Oy830Ry83=Wy83*jy83*cy83*Ay8n8k1l830Ry0000001l1m8x830Ryk3Hyk0k0");
    ...
    Qresumable_vector_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_25 = STATIC_STRING("1q837Oy8s83-lcy09k9l");
    clear_optimized_constants();
    ...
    string_constant_26 = 
	    STATIC_STRING("43Dy8m83mXy1t83mXy837Oy830Ry83=Wy83*jy83*cy83*Ay8n8k1l837Oy0000001m1m8x837Oy1n8y83-5by1t830oy832Iy831qy832Oy830ny832Hy833Yy83Sky");
    ...
    Qresumable_object_vector_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_28 = STATIC_STRING("1q83mXy8s83-lXy09k9l");
    clear_optimized_constants();
    ...
    string_constant_29 = 
	    STATIC_STRING("43Dy8m83may1t83may837Oy830Ry83=Wy83*jy83*cy83*Ay8n8k1l837Oy0000001m1m8x837Oy1n8y83-5ey1t830oy832Iy831qy832Oy830ny832Hy833Yy83Sky");
    ...
    Qresumable_value_vector_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_31 = STATIC_STRING("1q83may8s83-lby09k9l");
    clear_optimized_constants();
    ...
    string_constant_32 = 
	    STATIC_STRING("43Dy8m83mUy1s83mUy830Ry83=Wy83*jy83*cy83*Ay8n8k1l830Ry0000001m1m8x830Ry1n8y83-5Yy1s830oy832Iy831qy832Oy830ny832Hy833Yy83=jyk3Ryk");
    ...
    Qresumable_history_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_34 = STATIC_STRING("1q83mUy8s83-lNy09k9l");
    clear_optimized_constants();
    ...
    string_constant_35 = 
	    STATIC_STRING("43Dy8m837Ny1s837Ny830Ry83=Wy83*jy83*cy83*Ay8n8k1l830Ry0000001l1m8x830Ryk3Hyk0k0");
    ...
    Qresumable_list_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_36 = STATIC_STRING("1q837Ny8s83-lSy09k9l");
    clear_optimized_constants();
    ...
    string_constant_37 = 
	    STATIC_STRING("43Dy8m83mVy1t83mVy837Ny830Ry83=Wy83*jy83*cy83*Ay8n8k1l837Ny0000001m1m8x837Ny1n8y83-5Zy1t830oy832Iy831qy832Oy830ny832Hy83Say833Yy");
    ...
    Qresumable_object_list_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_39 = STATIC_STRING("1q83mVy8s83-lUy09k9l");
    clear_optimized_constants();
    ...
    string_constant_40 = 
	    STATIC_STRING("43Dy8m83mYy1t83mYy837Ny830Ry83=Wy83*jy83*cy83*Ay8n8k1l837Ny0000001m1m8x837Ny1n8y83-5cy1t830oy832Iy831qy832Oy830ny832Hy83Say833Yy");
    ...
    Qresumable_value_list_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_41 = STATIC_STRING("1q83mYy8s83-lZy09k9l");
    clear_optimized_constants();
    ...
    string_constant_42 = 
	    STATIC_STRING("43Dy8m837My1q837My83*jy83*cy83*Ay8n8k1l83*jy0000001l1m8x83*jykxk0k0");
    ...
    Qresumable_evaluation_sequence_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_43 = STATIC_STRING("1q837My8s83-lLy09k9l");
    clear_optimized_constants();
    ...
    string_constant_44 = 
	    STATIC_STRING("43Dy8m83mSy1r83mSy837My83*jy83*cy83*Ay8n8k1l837My0000001m1m8x837My1n8y83-5Wy1n830oy83Z7y83=jykxk0k0");
    ...
    Qresumable_evaluation_sequence_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_45 = STATIC_STRING("1q83mSy8s83-lKy09k9l");
    clear_optimized_constants();
    ...
    string_constant_46 = 
	    STATIC_STRING("43Dy8m83mTy1r83mTy837My83*jy83*cy83*Ay8n8k1l837My0000001m1m8x837My1n8y83-5Xy1n830oy83Z7y83=jykyk0k0");
    ...
    Qresumable_evaluation_structure_node_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_47 = STATIC_STRING("1q83mTy8s83-lMy09k9l");
    clear_optimized_constants();
    ...
    Qobject_circularity_hashtable_hash_vector_131_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_48 = STATIC_STRING("1q83-gKy83*By83-P1y09k9l");
    clear_optimized_constants();
    ...
    string_constant_49 = 
	    STATIC_STRING("43Dy8m83moy1p83moy83Emy834Xy8n8k1l83Emy0000001n1m8x83Emy1m83My83-B3y1n8y83-5ny1w83-C1y83-8-y83-FBy83tLy83-C0y83-C+y83-Bxy83-C=y8");
    string_constant_50 = STATIC_STRING("3-FIy83-C-y83-Bwy83-C*yk3Jyk0k0");
    ...
    Qsending_resumable_object_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_51 = STATIC_STRING("1q83moy8s83-mry09k9l");
    clear_optimized_constants();
    ...
    string_constant_52 = 
	    STATIC_STRING("43Dy8m83lGy1m83lGy8k1l8k0000001m1m83*gy9k1m83=ey3-Wykok0k0");
    ...
    Qobject_passing_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_53 = STATIC_STRING("1q83lGy8s83-gNy09k9l");
    clear_optimized_constants();
    ...
    string_constant_54 = 
	    STATIC_STRING("1l1n83j-y1o1m9k831Sy1m9k83*ly1m9k83-Ty1m9k830Cy83gWy");
    clear_optimized_constants();
    ...
    Qunable_to_set_current_value_because_item_is_not_a_variable_or_parameter 
	    ...
	    AB_package);
    string_constant_55 = 
	    STATIC_STRING("1l1n83j-y1n1m9k83=hy1m9k83-Ty1m9k83Ry83=hy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
