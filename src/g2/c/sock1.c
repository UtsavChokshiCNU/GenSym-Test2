...
Object Chain_of_available_tcp_sockets = UNBOUND;

Object Tcp_socket_count = UNBOUND;
    ...
    Object tcp_socket;
{
    ...
    svref_new_value = Chain_of_available_tcp_sockets;
    SVREF(tcp_socket,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_tcp_sockets = tcp_socket;
    return VALUES_1(Nil);
}
...
Object make_permanent_tcp_socket_structure_internal()
{
    ...
    tcp_socket_count_new_value = FIXNUM_ADD1(Tcp_socket_count);
    Tcp_socket_count = tcp_socket_count_new_value;
...
Object Chain_of_available_socket_output_buffers = UNBOUND;

Object Socket_output_buffer_count = UNBOUND;
    ...
    Object socket_output_buffer;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_socket_output_buffers;
    SVREF(socket_output_buffer,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_socket_output_buffers = socket_output_buffer;
    return VALUES_1(Nil);
}
...
Object make_permanent_socket_output_buffer_structure_internal()
{
    ...
    socket_output_buffer_count_new_value = 
	    FIXNUM_ADD1(Socket_output_buffer_count);
    Socket_output_buffer_count = socket_output_buffer_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object tcp_socket;
{
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qsocket_close_cleanups);
...
void socket1_INIT()
{
    ...
    Object Qsocket_output_buffer_count;
    Object Qchain_of_available_socket_output_buffers, string_constant_8;
    Object Qtype_description_of_type, string_constant_7;
    ...
    Object Qtcp_socket_count, Qchain_of_available_tcp_sockets;
    ...
    string_constant_6 = STATIC_STRING("1q837Vy8s83-qiy09k9l");
    ...
    string_constant_7 = 
	    STATIC_STRING("43Dy8m83nNy1n83nNy8n8k1l8n0000000kqk0k0");
    ...
    Qsocket_output_buffer_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_8 = STATIC_STRING("1q83nNy8s83-ooy09k9l");
    clear_optimized_constants();
