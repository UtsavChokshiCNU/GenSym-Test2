    ...
    Object generic_formula;
{
    ...
    Object cdr_new_value, result_1, current_flag_state_qm, slot_description;
    Object new_cons, stack_of_slot_value_changes, gensymed_symbol_3;
  ...
  end_1:;
	...
	if (EQ(CAR(gensymed_symbol_2),gensymed_symbol)) {
		...
		cdr_new_value = CDR(gensymed_symbol_2);
	    ...
	    inline_note_reclaim_cons(gensymed_symbol_2,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(gensymed_symbol_2) = cdr_new_value;
	    Available_gensym_conses = gensymed_symbol_2;
	    goto end_2;
	}
    ...
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(generic_formula,
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  svref_new_value = IFIX(ISVREF(generic_formula,(SI_Long)5L)) | 
		  (SI_Long)16777216L;
	  ISVREF(generic_formula,(SI_Long)5L) = FIX(svref_new_value);
      }
	...
	next_loop_2:
	  ...
	  ab_loop_it_ = temp_1 ? (EQ(generic_formula,
...
Object Generic_simulation_formulas_used_p = UNBOUND;
...
Object Attribute_nesting_depth = UNBOUND;
    ...
    Object variable_or_parameter;
{
	...
	if (Nil) {
		...
		evaluation_value_qm = gensym_cons_1(value,Qtruth_value);
	}
	else
	...
	if (logical_qm) {
		...
		init_form_evaluation_value_qm = gensym_cons_1(value,
			Qtruth_value);
	}
	else
...
Object schedule_update_for_variable_expiration(variable)
    Object variable;
{
    Object task, task_1, temp_1, old_structure_being_reclaimed;
	...
	if ((temp ? IFIX(Most_negative_fixnum) : 
		...
		if (task_1) {
		    ...
		    Chain_of_available_schedule_tasks = task_1;
		}
		task_1 = Nil;
	    }
	...
	future_task_schedule_modify_arg_2 = Priority_of_expiration_update_task;
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qpropagate_variable_value_expiration);
	future_task_schedule_modify_arg_11 = variable;
	schedule_task_qm = ISVREF(variable,(SI_Long)39L);
	if (schedule_task_qm) {
	...
	SVREF(task_1,FIX((SI_Long)3L)) = svref_new_value ? T : Nil;
	SVREF(task_1,FIX((SI_Long)4L)) = future_task_schedule_modify_arg_2;
	SVREF(task_1,FIX((SI_Long)5L)) = Nil;
	SVREF(task_1,FIX((SI_Long)9L)) = Nil;
	SVREF(task_1,FIX((SI_Long)7L)) = Qpropagate_variable_value_expiration;
	SVREF(task_1,FIX((SI_Long)8L)) = future_task_schedule_modify_arg_8;
	ISVREF(task_1,(SI_Long)10L) = FIX((SI_Long)1L);
	SVREF(task_1,FIX((SI_Long)11L)) = future_task_schedule_modify_arg_11;
	future_task_schedule_2(task_1);
	return VALUES_1(ISVREF(variable,(SI_Long)39L) = task_1);
    }
}
...
Object Chain_of_available_simulation_infos = UNBOUND;

Object Simulation_info_count = UNBOUND;
    ...
    Object simulation_info;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_simulation_infos;
    SVREF(simulation_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_simulation_infos = simulation_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_simulation_info_structure_internal()
{
    ...
    Object simulation_info_count_new_value;
    ...
    simulation_info_count_new_value = FIXNUM_ADD1(Simulation_info_count);
    Simulation_info_count = simulation_info_count_new_value;
...
Object Chain_of_available_variable_simulation_runtime_structures = UNBOUND;

Object Variable_simulation_runtime_structure_count = UNBOUND;
    ...
    Object variable_simulation_runtime_structure;
{
    ...
    reclaim_gensym_list_1(ISVREF(variable_simulation_runtime_structure,
	    (SI_Long)18L));
    ...
    svref_new_value = 
	    Chain_of_available_variable_simulation_runtime_structures;
    SVREF(variable_simulation_runtime_structure,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_variable_simulation_runtime_structures = 
...
{
    Object def_structure_variable_simulation_runtime_structure_variable;
    Object variable_simulation_runtime_structure_count_new_value;
    ...
    variable_simulation_runtime_structure_count_new_value = 
	    FIXNUM_ADD1(Variable_simulation_runtime_structure_count);
...
{
    Object old_value, amf_available_array_cons_qm, amf_array, temp;
...
Object Global_list_of_all_data_servers = UNBOUND;

Object Data_server_kbprop = UNBOUND;

Object Data_server_or_alias_qm_kbprop = UNBOUND;

Object List_of_all_data_servers = UNBOUND;

Object The_type_description_of_data_server = UNBOUND;

Object Chain_of_available_data_servers = UNBOUND;

Object Data_server_count = UNBOUND;
    ...
    Object data_server;
{
    ...
    svref_new_value = Chain_of_available_data_servers;
    SVREF(data_server,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_data_servers = data_server;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_data_server_variable, data_server_count_new_value;
    ...
    data_server_count_new_value = FIXNUM_ADD1(Data_server_count);
    Data_server_count = data_server_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Data_server_pretty_name_alist = UNBOUND;
    ...
    Object variable, new_data_server_map, gensymed_symbol;
{
    ...
    Object collection_interval_qm, new_data_server_qm;
	...
	if ( !TRUEP(gensymed_symbol))
	    gensymed_symbol = replenish_gensym_cons_pool();
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(variable,
		    slot_description),gensym_cons_1(Nil,Nil));
	else {
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
...
Object Data_server_parameters = UNBOUND;
    ...
    Object data_server_parameters;
{
    ...
    PUSH_SPECIAL(Data_server_parameters,data_server_parameters,0);
    ...
    Object old_aliases, new_aliases;
{
    ...
    Object new_data_server_qm, cdr_new_value, interval_qm;
    Object current_wide_string_list, wide_string_bv16, current_wide_string;
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
	...
	old_alias_list = copy_list_using_gensym_conses_1(CDR(old_aliases));
    else
	old_alias_list = gensym_cons_1(old_aliases,Nil);
    if ( !TRUEP(new_aliases))
	new_alias_list = Nil;
    else if (EQ(CAR(new_aliases),Qand))
	new_alias_list = copy_list_using_gensym_conses_1(CDR(new_aliases));
    else
	new_alias_list = gensym_cons_1(new_aliases,Nil);
    undefined_data_server_names = Nil;
    data_server_structure = Nil;
    notification_text_string = Nil;
    aliases_to_remove = Nil;
    aliases_to_add = copy_list_using_gensym_conses_1(new_alias_list);
  ...
  next_loop:
	...
	aliases_to_remove = gensym_cons_1(old_alias_spec,aliases_to_remove);
    else if (EQ(SECOND(old_alias_spec),SECOND(new_spec_qm)))
	aliases_to_add = delete_gensym_element_1(new_spec_qm,aliases_to_add);
    goto next_loop;
  end_loop:;
    if (System_is_running || System_has_paused) {
	...
	next_loop_1:
	  ...
	  if ((SI_Long)0L != (IFIX(ISVREF(variable,(SI_Long)5L)) & 
		  ...
		  server_qm = ATOM(source_or_map) ? 
			  lookup_kb_specific_property_value(source_or_map,
			  Data_server_or_alias_qm_kbprop) : Nil;
		  temp_1 = gensym_cons_1(temp_1,server_qm ? server_qm : 
			  warn_of_undefined_data_server(variable,
			  source_or_map));
		  affected_variables = gensym_cons_1(temp_1,
			  affected_variables);
	      }
	  }
	  goto next_loop_1;
  ...
  next_loop_5:
    ...
    new_data_server_qm = server_qm ? server_qm : 
	    warn_of_undefined_data_server(variable,source_or_map);
    inline_note_reclaim_cons(affected_entry,Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(affected_entry) = cdr_new_value;
    Available_gensym_conses = affected_entry;
  ...
  end_loop_5:;
	...
	Available_gensym_conses = old_alias_list;
    }
    if (new_alias_list) {
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = new_alias_list;
    }
    if (aliases_to_add) {
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = aliases_to_add;
    }
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = aliases_to_remove;
    }
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = affected_variables;
	return VALUES_1(Nil);
    }
    else
	return VALUES_1(Nil);
    ...
    Object requestor, wake_ups;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    svref_new_value = delete_gensym_element_1(requestor,ISVREF(variable,
	    (SI_Long)36L));
...
Object perform_postponed_clean_ups(requestor,wake_ups)
    Object requestor, wake_ups;
{
    Object variable_cons, variable, cdr_of_cons, gensym_cons, cdr_new_value;
	...
	if (wake_ups &&  !((SI_Long)0L == inline_debugging_consing())) {
	    gensym_cons = wake_ups;
	  next_loop_1:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	    if (EQ(gensym_cons,variable_cons))
		goto end_1;
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(variable_cons) = cdr_new_value;
	Available_gensym_conses = wake_ups;
	return VALUES_1(Qnil);
    }
    else
	return VALUES_1(Nil);
...
Object clear_pending_wake_ups()
{
    ...
    Object pruned_interest_list, gensym_cons, cdr_new_value;
...
Object Explanation_variables = UNBOUND;
...
Object reclaim_explanation_variables()
{
  ...
  next_loop:
    ...
    reclaim_gensym_tree_1(CAR(var));
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(Explanation_variables);
    ...
    Object vars;
{
  ...
  next_loop:
    ...
    var = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp = copy_tree_using_gensym_conses_1(CAR(var));
    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(temp,
...
Object Chain_of_available_formula_invocations = UNBOUND;

Object Formula_invocation_count = UNBOUND;
    ...
    Object formula_invocation;
{
    ...
    schedule_task_qm = ISVREF(formula_invocation,(SI_Long)7L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value = Nil;
    SVREF(formula_invocation,FIX((SI_Long)7L)) = svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_formula_invocations;
    SVREF(formula_invocation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_formula_invocations = formula_invocation;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_formula_invocation_variable, temp;
    Object defstruct_g2_formula_invocation_variable, the_array;
    ...
    temp = FIXNUM_ADD1(Formula_invocation_count);
    Formula_invocation_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_formula_invocations;
    ...
    Object variable, wake_up_qm;
{
    ...
    PUSH_SPECIAL(Current_computation_instance,current_computation_instance,1);
    ...
    Object variable_or_parameter, wake_up_qm;
{
	...
	if (EQ(type,Qtext));
	    ...
	    reclaim_gensym_cons_1(result_1);
	else
    ...
    Object variable_or_parameter, wake_up_qm;
{
    ...
    Object timeout_qm, future_task_schedule_modify_arg_8;
    Object future_task_schedule_modify_arg_11, schedule_task_qm;
    Object old_structure_being_reclaimed, def_structure_schedule_task_variable;
    Object task;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp, logical_qm, svref_new_value;
	...
	if (temp) {
		...
		if (FIXNUM_EQ(value,Truth))
		    ...
		    result_1 = gensym_cons_1(value,Qtruth_value);
	    }
	    else
		...
		if ( !((IFIX(Current_computation_flags) & (SI_Long)256L) 
		    ...
		    Variables_that_did_not_have_values = 
			    gensym_cons_1(variable_or_parameter,
			    Variables_that_did_not_have_values);
		    temp_1 = gensym_cons_1(Qvalue_request_pending,
		...
		if (current_qm) {
			...
			if (timeout_qm) {
			    ...
			    future_task_schedule_modify_arg_8 = 
				    SYMBOL_FUNCTION(Qtask_to_detect_failure);
			    future_task_schedule_modify_arg_11 = 
				    variable_or_parameter;
			    schedule_task_qm = 
				    ISVREF(variable_or_parameter,(SI_Long)30L);
			    if (schedule_task_qm) {
				if (EQ(schedule_task_qm,Current_schedule_task))
				    Current_schedule_task = Nil;
				if (ISVREF(schedule_task_qm,(SI_Long)6L))
			    ...
			    DFLOAT_ISASET_1(temp_1,(SI_Long)1L,aref_new_value);
			    svref_new_value =  !TRUEP(Nil);
			    SVREF(task,FIX((SI_Long)3L)) = svref_new_value 
				    ? T : Nil;
			    ...
			    ISVREF(variable_or_parameter,(SI_Long)30L) = task;
			}
		    }
		    expiration = Nil;
		}
    ...
    Object variable;
{
    ...
    Object failed_sensor_probing_interval_qm;
    ...
    SI_Long svref_new_value;
    char temp_1, g2_p;
    double current_task_schedule_modify_arg_3, aref_new_value;
	...
	temp = Nil;
	ISVREF(variable,(SI_Long)30L) = temp;
    }
	...
	current_task_schedule_modify_arg_3 = 
		(double)IFIX(failed_sensor_probing_interval_qm);
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qtask_to_probe_failed_variable);
	current_task_schedule_modify_arg_11 = variable;
	schedule_task_qm = ISVREF(variable,(SI_Long)30L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	...
	DFLOAT_ISASET_1(temp,(SI_Long)1L,current_task_schedule_modify_arg_3);
	ISVREF(task,(SI_Long)4L) = FIX((SI_Long)8L);
	SVREF(task,FIX((SI_Long)5L)) = Nil;
	SVREF(task,FIX((SI_Long)9L)) = Nil;
	g2_p =  !TRUEP(Nil);
	...
	ISVREF(variable,(SI_Long)30L) = task;
    }
    return VALUES_1(Nil);
}
    ...
    Object variable, priority;
{
    ...
    Object priority_1, svref_new_value, old_structure_being_reclaimed, thing;
	...
	if (schedule_task_qm && (ISVREF(schedule_task_qm,(SI_Long)6L) || 
		...
		svref_new_value = schedule_task_qm;
	    }
	    else {
		if (schedule_task_qm) {
		    if (EQ(schedule_task_qm,Current_schedule_task))
	    ...
	    ISVREF(variable,(SI_Long)37L) = svref_new_value;
	}
...
Object Within_backward_chaining_task = UNBOUND;
  ...
  next_loop:
	...
	if (EQ(interesting_thing,original_variable))
		...
		loop_result = 
			...
			original_variable);
		if (loop_result)
		    loop_result = gensym_cons_1(interesting_thing,loop_result);
	    }
	}
    }
    if (loop_result)
    ...
    Object variable, path;
{
    ...
    return reclaim_gensym_list_1(path);
}
    ...
    Object variable, wake_up_qm;
{
    ...
    Object temp, specific_formula_qm, parent_entity_qm, slot_name;
...
Object cancel_formula_for_backward_chaining(variable)
    Object variable;
{
    Object formula_invocation_qm, schedule_task_qm;
    Object old_structure_being_reclaimed, svref_new_value;
	...
	schedule_task_qm = ISVREF(formula_invocation_qm,(SI_Long)7L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	svref_new_value = Nil;
	SVREF(formula_invocation_qm,FIX((SI_Long)7L)) = svref_new_value;
...
Object New_value_computed_in_formula_qm = UNBOUND;
...
Object Put_current_value_called_from_simulator_p = UNBOUND;
...
Object Put_current_evaluation_value_old_value_qm = UNBOUND;

Object Put_current_evaluation_value_return_value = UNBOUND;
    ...
    Object override_validity_interval_qm;
{
    ...
    Object svref_new_value, amf_result, incff_1_arg, new_float, new_value;
    Object temp_1, validity_interval_of_variable_qm;
    ...
    Object schedule_task_qm, old_structure_being_reclaimed, temp_4;
    Object interested_list_qm, thing_cons, cdr_of_cons_qm, thing, gensym_cons;
    ...
    double gensymed_symbol_3, temp_3;
	...
	new_float = amf_result;
	temp_1 = normalize_to_gensym_float(evaluation_value);
	...
	if (FIXNUMP(old_collection_time)) {
	    temp_1 = lfloat(old_collection_time,float_constant);
    ...
    if (temp_2) {
	if (history_spec_qm) {
	    temp_1 = get_or_make_history_buffer(variable_or_parameter,
		    history_spec_qm);
	    store_history_value(temp_1,history_spec_qm,
    ...
    temp_1 = unix_supplied_collection_time_qm;
    if (temp_1);
    else
	temp_1 = DOUBLE_TO_DOUBLE_FLOAT(DFLOAT_ISAREF_1(Current_g2_time,
		(SI_Long)0L));
    collection_time_of_new_current_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	...
	if (supplied_expiration_time_qm) {
		...
		expiration_time_of_new_current_value = temp_2 ? 
			Most_negative_fixnum : 
			LONG_TO_FIXNUM(inline_floor_1(gensymed_symbol_3));
	    }
	    else if (FLOATP(supplied_expiration_time_qm)) {
		temp_3 = DOUBLE_FLOAT_TO_DOUBLE(supplied_expiration_time_qm);
	...
	gensymed_symbol_1 = temp_2 ? IFIX(Most_negative_fixnum) : 
	...
	if ( !(EQ(evaluation_value,Evaluation_true_value) || 
	    ...
	    reclaim_gensym_cons_1(evaluation_value);
	...
	Put_current_evaluation_value_return_value = T;
    ...
    if (variable_qm) {
	svref_new_value_1 = IFIX(ISVREF(variable_or_parameter,
		(SI_Long)5L)) &  ~(SI_Long)32L;
	ISVREF(variable_or_parameter,(SI_Long)5L) = FIX(svref_new_value_1);
	schedule_task_qm = ISVREF(variable_or_parameter,(SI_Long)30L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	temp = Nil;
	ISVREF(variable_or_parameter,(SI_Long)30L) = temp;
	ISVREF(variable_or_parameter,(SI_Long)26L) = 
		expiration_time_of_new_current_value;
	...
	if (INLINE_DOUBLE_FLOAT_VECTOR_P(new_managed_value) != (SI_Long)0L 
		...
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(new_managed_value)) == 
		(SI_Long)1L)
	    temp_4 = aref1(new_managed_value,FIX((SI_Long)0L));
	else
	    temp_4 = new_managed_value;
	store_history_value(temp_1,history_spec_qm,temp_4,
	...
	if (interested_list_qm) {
	  ...
	  end_loop:
		...
		gensym_cons = interested_list_qm;
	      next_loop_1:
		inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		if (EQ(gensym_cons,thing_cons))
		    goto end_1;
		else if ( !TRUEP(gensym_cons))
		    goto end_1;
		else
	    ...
	    temp = Available_gensym_conses;
	    M_CDR(thing_cons) = temp;
	    Available_gensym_conses = interested_list_qm;
	}
    }
	...
	temp_1 = (SI_Long)0L != (IFIX(ISVREF(variable_or_parameter,
		(SI_Long)4L)) & (SI_Long)32L) ? T : Nil;
	if (temp_1);
	else
	    temp_1 = value_or_expiration_changed_qm;
    }
    else
	temp_1 = Nil;
    invoke_rules_for_forward_chaining(variable_or_parameter,
	    new_managed_value,new_value_type,temp_1,old_managed_value);
    if (value_or_expiration_changed_qm) {
	update_representations_of_variable_or_parameter_value(variable_or_parameter);
	if ( !TRUEP(variable_qm) &&  
		...
		if (FIXNUM_EQ(new_managed_value,Truth))
		    ...
		    evaluation_value_for_simulator = 
			    gensym_cons_1(new_managed_value,Qtruth_value);
	    }
	    else
		evaluation_value_for_simulator = 
...
/* MUTATE-ITEMS-NEEDING-INITIALIZATION-TREE-ENTRY */
Object mutate_items_needing_initialization_tree_entry(entry_cons,new_key,
	    new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(148,127);
    reclaim_frame_serial_number(M_CAR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_items_needing_initialization_tree_entry = UNBOUND;
...
Object clear_items_needing_initialization_tree(items_needing_initialization_binary_tree)
    Object items_needing_initialization_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, fsn, old_key;

    x_note_fn_call(148,128);
    element_qm = Nil;
  next_loop:
    element_qm = CDR(items_needing_initialization_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    ...
    fsn = gensymed_symbol;
    temp = 
	    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qframe_serial_number_equal_function),
	    gensymed_symbol,items_needing_initialization_binary_tree,
	    FIXNUMP(fsn) ? fsn : FIXNUM_LOGXOR(M_CAR(fsn),M_CDR(fsn)));
    old_key = temp;
    reclaim_frame_serial_number(old_key);
    goto next_loop;
  end_loop:;
    return VALUES_1(items_needing_initialization_binary_tree);
}

Object Items_needing_initialization_tree = UNBOUND;
    ...
    Object item;
{
    ...
    x_note_fn_call(148,129);
    gensymed_symbol = copy_frame_serial_number(ISVREF(item,(SI_Long)3L));
    temp = Items_needing_initialization_tree;
    temp_1 = Fp_mutate_items_needing_initialization_tree_entry;
    fsn = gensymed_symbol;
    return set_balanced_binary_tree_entry(temp,
...
Object Chain_of_available_inference_background_collections = UNBOUND;

Object Inference_background_collection_count = UNBOUND;
    ...
    Object inference_background_collection;
{
    ...
    svref_new_value = Nil;
    SVREF(inference_background_collection,FIX((SI_Long)3L)) = svref_new_value;
    SVREF(inference_background_collection,FIX((SI_Long)3L)) = Nil;
    schedule_task_qm = ISVREF(inference_background_collection,(SI_Long)5L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value = Nil;
    SVREF(inference_background_collection,FIX((SI_Long)5L)) = svref_new_value;
    SVREF(inference_background_collection,FIX((SI_Long)5L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_inference_background_collections;
    SVREF(inference_background_collection,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_inference_background_collections = 
	    inference_background_collection;
    return VALUES_1(Nil);
}
...
Object make_permanent_inference_background_collection_structure_internal()
{
    ...
    Object inference_background_collection_count_new_value;
    Object defstruct_g2_inference_background_collection_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(148,135);
    def_structure_inference_background_collection_variable = Nil;
    inference_background_collection_count_new_value = 
	    FIXNUM_ADD1(Inference_background_collection_count);
    ...
    Object variable, interval;
{
    ...
    Object temp, current_task_schedule_modify_arg_8;
    ...
    current_task_schedule_modify_arg_3 = FIXNUMP(interval) ? 
	    (double)IFIX(interval) : DFLOAT_ISAREF_1(interval,(SI_Long)0L);
    current_task_schedule_modify_arg_8 = 
	    SYMBOL_FUNCTION(Qperform_background_collection_for_inference_engine);
    current_task_schedule_modify_arg_11 = collection_structure;
    schedule_task_qm = ISVREF(collection_structure,(SI_Long)3L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	Priority_of_next_task = p;
    return VALUES_1(SVREF(collection_structure,FIX((SI_Long)3L)) = task);
}
...
{
    Object collection_structure, frame_serial_number_setf_arg, old, new_1;
    Object temp, current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8;
    Object current_task_schedule_modify_arg_11;
    ...
    if (priority_qm) {
	current_task_schedule_modify_arg_2 = priority_qm;
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qperform_background_collection_for_inference_engine);
	current_task_schedule_modify_arg_11 = collection_structure;
	current_task_schedule_modify_arg_12 = force_qm;
	schedule_task_qm = ISVREF(collection_structure,(SI_Long)5L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	    Priority_of_next_task = p;
	SVREF(collection_structure,FIX((SI_Long)5L)) = task;
    }
    else
    ...
    Object collection_structure, force_qm;
{
    ...
    Object variables_that_did_not_have_values, schedule_task_qm;
    Object old_structure_being_reclaimed, svref_new_value, thing;
    char temp;
    Declare_special(4);

    x_note_fn_call(148,140);
    variable = ISVREF(collection_structure,(SI_Long)1L);
    gensymed_symbol = ISVREF(variable,(SI_Long)3L);
    temp = SIMPLE_VECTOR_P(variable) ? EQ(ISVREF(variable,(SI_Long)1L),
	    Qavailable_frame_vector) : TRUEP(Qnil);
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,3);
	  ...
	  PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
		  2);
		...
		svref_new_value = Nil;
		SVREF(collection_structure,FIX((SI_Long)5L)) = svref_new_value;
    ...
    Object variable;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	pruned_interest_list = 
		delete_gensym_element_1(collection_structure,
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(ISVREF(collection_structure,(SI_Long)4L));
...
Object deactivate_subclass_of_entity_for_variable(variable)
    Object variable;
{
    Object source_or_map, server_qm, data_server_qm, temp, schedule_task_qm;
    Object old_structure_being_reclaimed, temp_1, thing, managed_float;
    Object cached_explanation, interested_list, ab_loop_list_, last_1, next_qm;
    SI_Long svref_new_value;

    x_note_fn_call(148,142);
    source_or_map = ISVREF(variable,(SI_Long)31L);
    server_qm = ATOM(source_or_map) ? 
	    lookup_kb_specific_property_value(source_or_map,
	    Data_server_or_alias_qm_kbprop) : Nil;
    ...
    temp_1 = Nil;
    ISVREF(variable,(SI_Long)30L) = temp_1;
    ...
    temp_1 = Nil;
    ISVREF(variable,(SI_Long)39L) = temp_1;
    svref_new_value = IFIX(ISVREF(variable,(SI_Long)5L)) &  ~(SI_Long)32L;
    ISVREF(variable,(SI_Long)5L) = FIX(svref_new_value);
  ...
  end_loop:;
	...
	M_CDR(last_1) = temp_1;
	Available_gensym_conses = interested_list;
    }
...
Object Indexed_attributes = UNBOUND;

/* MUTATE-INDEXED-ATTRIBUTE-DEFINING-CLASSES-TREE-ENTRY */
Object mutate_indexed_attribute_defining_classes_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    Object gensym_list, last_1, next_qm, cdr_new_value;

    x_note_fn_call(148,145);
    gensym_list = M_CDR(entry_cons);
    if (gensym_list) {
	last_1 = gensym_list;
	next_qm = Nil;
      next_loop:
...
Object Fp_mutate_indexed_attribute_defining_classes_tree_entry = UNBOUND;

/* CLEAR-INDEXED-ATTRIBUTE-DEFINING-CLASSES-TREE */
Object clear_indexed_attribute_defining_classes_tree(indexed_attribute_defining_classes_binary_tree)
    Object indexed_attribute_defining_classes_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, old_entry, last_1, next_qm;
    Object cdr_new_value;
    Object result;

    x_note_fn_call(148,146);
    element_qm = Nil;
  next_loop:
    element_qm = CDR(indexed_attribute_defining_classes_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    temp = ISVREF(element_qm,(SI_Long)3L);
    gensymed_symbol = CAAR(temp);
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
	    gensymed_symbol,indexed_attribute_defining_classes_binary_tree,
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = old_entry;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(indexed_attribute_defining_classes_binary_tree);
}

Object Available_indexed_attribute_parent_objects_hash_vector_43_vectors = UNBOUND;

Object Count_of_indexed_attribute_parent_objects_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_indexed_attribute_parent_objects_hash_vector_43_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(148,149);
    count_of_indexed_attribute_parent_objects_hash_vector_43_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_indexed_attribute_parent_objects_hash_vector_43_vectors);
...
Object make_indexed_attribute_parent_objects_hash_vector()
{
    ...
    x_note_fn_call(148,150);
    if (Available_indexed_attribute_parent_objects_hash_vector_43_vectors) {
	temp = 
		M_CAR(Available_indexed_attribute_parent_objects_hash_vector_43_vectors);
	temp_1 = 
		M_CDR(Available_indexed_attribute_parent_objects_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_indexed_attribute_parent_objects_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = 
...
/* MUTATE-INDEXED-ATTRIBUTE-PARENT-OBJECTS-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    Object indexed_attribute_defining_classes_binary_tree, element_qm;
    Object gensymed_symbol, old_entry, last_1, next_qm, cdr_new_value;
    Object result;

    x_note_fn_call(148,152);
    reclaim_evaluation_value(M_CAR(entry_cons));
    indexed_attribute_defining_classes_binary_tree = M_CDR(entry_cons);
    element_qm = Nil;
  next_loop:
    element_qm = M_CDR(indexed_attribute_defining_classes_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    ...
    goto next_loop;
  end_loop:
    inline_note_reclaim_cons(indexed_attribute_defining_classes_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(indexed_attribute_defining_classes_binary_tree) = cdr_new_value;
    Available_gensym_conses = indexed_attribute_defining_classes_binary_tree;
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry = UNBOUND;

static Object Qevaluation_value_equal_p;  /* evaluation-value-equal-p */

/* CLEAR-INDEXED-ATTRIBUTE-PARENT-OBJECTS-TREE */
Object clear_indexed_attribute_parent_objects_tree(indexed_attribute_parent_objects_tree_for_hash_binary_tree)
    Object indexed_attribute_parent_objects_tree_for_hash_binary_tree;
{
    Object element_qm, temp, gensymed_symbol, old_key, old_entry, old_entry_1;
    Object last_1, next_qm, cdr_new_value;
    Object result;

    x_note_fn_call(148,153);
    element_qm = Nil;
  next_loop:
    element_qm = 
	    CDR(indexed_attribute_parent_objects_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    temp = ISVREF(element_qm,(SI_Long)3L);
    gensymed_symbol = CAAR(temp);
    if (FIXNUMP(gensymed_symbol))
	temp = FIXNUM_ABS(gensymed_symbol);
    else if (SYMBOLP(gensymed_symbol))
	temp = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
		IFIX(Most_positive_fixnum));
    else if (text_string_p(gensymed_symbol))
	temp = compute_text_hash_code(gensymed_symbol);
    else
	temp = FIX((SI_Long)0L);
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qevaluation_value_equal_p),
	    gensymed_symbol,
	    indexed_attribute_parent_objects_tree_for_hash_binary_tree,temp);
    MVS_2(result,old_key,old_entry);
    reclaim_evaluation_value(old_key);
    element_qm = Nil;
  next_loop_1:
    element_qm = M_CDR(old_entry);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    gensymed_symbol = M_CAR(M_CAR(ISVREF(element_qm,(SI_Long)3L)));
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
	    gensymed_symbol,old_entry,frame_hash_function(gensymed_symbol));
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(last_1) = cdr_new_value;
	Available_gensym_conses = old_entry_1;
    }
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(old_entry,Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(old_entry) = cdr_new_value;
    Available_gensym_conses = old_entry;
    goto next_loop;
  end_loop:;
    return VALUES_1(indexed_attribute_parent_objects_tree_for_hash_binary_tree);
}
...
{
    Object indexed_attribute_parent_objects_tree_for_hash_binary_tree;
    Object element_qm, gensymed_symbol, temp, old_key, old_entry, old_entry_1;
    Object last_1, next_qm, cdr_new_value;
    SI_Long index_1;
    Object result;

    x_note_fn_call(148,157);
    index_1 = (SI_Long)0L;
  next_loop:
    if (index_1 >= (SI_Long)43L)
	goto end_loop;
    indexed_attribute_parent_objects_tree_for_hash_binary_tree = 
	    ISVREF(indexed_attribute_parent_objects_hash_table,index_1);
    element_qm = Nil;
  next_loop_1:
    element_qm = 
	    M_CDR(indexed_attribute_parent_objects_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    gensymed_symbol = M_CAR(M_CAR(ISVREF(element_qm,(SI_Long)3L)));
    if (FIXNUMP(gensymed_symbol))
  ...
  end_loop_2:
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(indexed_attribute_parent_objects_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(indexed_attribute_parent_objects_tree_for_hash_binary_tree) = 
	    cdr_new_value;
...
{
    Object indexed_attribute_hash_table_qm, new_cons, gensymed_symbol;
    Object new_attribute_value_tree, attribute_evaluation_value;
    Object stored_attribute_value_tree, temp_1, temp_2, element_qm, old_entry;
    Object last_1, next_qm, cdr_new_value, new_class_list, fsn;
    Object stored_class_list;
    SI_Long gensymed_symbol_1, temp;
    Object result;

    x_note_fn_call(148,163);
	...
	if (FIXNUMP(attribute_evaluation_value))
	    gensymed_symbol_1 = IFIX(FIXNUM_ABS(attribute_evaluation_value));
	...
	stored_attribute_value_tree = 
		set_balanced_binary_tree_entry(SVREF(indexed_attribute_hash_table_qm,
		FIX(temp)),Qevaluation_value_equal_p,Nil,Nil,
		attribute_evaluation_value,FIX(gensymed_symbol_1),
	...
	if (EQ(stored_attribute_value_tree,new_attribute_value_tree)) {
	    ...
	    temp_1 = Fp_mutate_indexed_attribute_defining_classes_tree_entry;
	    temp_2 = frame_hash_function(gensymed_symbol);
	    temp_2 = 
		    set_balanced_binary_tree_entry(new_attribute_value_tree,
		    Qeq,temp_1,T,gensymed_symbol,temp_2,
	    ...
	    element_qm = Nil;
	  next_loop:
	    element_qm = M_CDR(new_attribute_value_tree);
	    if ( !TRUEP(element_qm))
		goto end_loop;
	    gensymed_symbol = M_CAR(M_CAR(ISVREF(element_qm,(SI_Long)3L)));
	    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		    gensymed_symbol,new_attribute_value_tree,
		    frame_hash_function(gensymed_symbol));
	    old_entry = NTH_VALUE((SI_Long)1L, result);
	    if (old_entry) {
		last_1 = old_entry;
	    ...
	    goto next_loop;
	  end_loop:
	    inline_note_reclaim_cons(new_attribute_value_tree,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(new_attribute_value_tree) = cdr_new_value;
	    Available_gensym_conses = new_attribute_value_tree;
	    new_class_list = gensym_cons_1(defining_attribute_class,Nil);
	    fsn = ISVREF(attribute_parent_object,(SI_Long)3L);
	    stored_class_list = 
		    set_balanced_binary_tree_entry(stored_attribute_value_tree,
		    Qeq,Nil,Nil,attribute_parent_object,FIXNUMP(fsn) ? fsn 
		    : FIXNUM_LOGXOR(M_CAR(fsn),M_CDR(fsn)),new_class_list);
	    if ( !EQ(stored_class_list,new_class_list)) {
		if (memq_function(defining_attribute_class,stored_class_list))
		    temp_2 = reclaim_gensym_cons_1(new_class_list);
		else {
		    cdr_new_value = M_CDR(stored_class_list);
		    M_CDR(new_class_list) = cdr_new_value;
		    temp_2 = M_CDR(stored_class_list) = new_class_list;
		}
	    }
	    else
		temp_2 = Nil;
...
Object remove_indexed_attribute_parent(attribute,attribute_defining_class,
    ...
    Object attribute_parent_object;
{
    Object hash_table_qm, temp_1, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4, defining_classes_tree_qm, classes_list_qm;
    Object old_entry, last_1, next_qm, cdr_new_value, old_key, element_qm;
    Object old_entry_1, remaining_classes;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;
    char temp_2;
    Object result;

    x_note_fn_call(148,164);
	...
	gensymed_symbol_2 = attribute_value;
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    if (evaluation_value_equal_p(gensymed_symbol_2,
			gensymed_symbol_4)) {
		defining_classes_tree_qm = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_1;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_1;
	  end_loop_1:
	    defining_classes_tree_qm = Qnil;
	  end_1:;
	    goto end_2;
	}
	goto next_loop;
	...
	gensymed_symbol_2 = attribute_parent_object;
	gensymed_symbol = IFIX(frame_hash_function(attribute_parent_object));
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop_2:
	if ( !TRUEP(gensymed_symbol_1))
	    goto end_loop_2;
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_3:
		...
		classes_list_qm = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_3;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_3;
	  end_loop_3:
	    classes_list_qm = Qnil;
	  end_3:;
	    goto end_4;
	}
	goto next_loop_2;
	...
	if ( !EQ(M_CAR(classes_list_qm),attribute_defining_class))
		...
		temp_2 = EQ(ISVREF(ISVREF(M_CAR(gensymed_symbol_1),
			(SI_Long)0L),(SI_Long)0L),M_CDR(gensymed_symbol_1));
	    }
	    else
		temp_2 =  !TRUEP(M_CDR(defining_classes_tree_qm));
	    if (temp_2) {
		if (FIXNUMP(attribute_value))
		    gensymed_symbol = IFIX(FIXNUM_ABS(attribute_value));
		else if (SYMBOLP(attribute_value))
		...
		if ( !TRUEP(element_qm))
		    goto end_loop_5;
		gensymed_symbol_1 = M_CAR(M_CAR(ISVREF(element_qm,
			(SI_Long)3L)));
		result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
			gensymed_symbol_1,old_entry,
			frame_hash_function(gensymed_symbol_1));
		old_entry_1 = NTH_VALUE((SI_Long)1L, result);
		if (old_entry_1) {
		    last_1 = old_entry_1;
		    next_qm = Nil;
	    ...
	    temp_1 = Fp_mutate_indexed_attribute_defining_classes_tree_entry;
	    temp_1 = 
		    set_balanced_binary_tree_entry(defining_classes_tree_qm,
		    Qeq,temp_1,T,gensymed_symbol_1,
...
Object put_parent_for_its_indexed_attributes varargs_1(int, n)
{
    ...
    Object attribute_value_qm, ab_loop_desetq_, gensymed_symbol;
    ...
    Object indexed_attribute;
{
    ...
    Object ab_loopvar_, class_1, slot_description, temp, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    ...
    Object old_class_name_if_different_qm;
{
    ...
    Object any_class_instances_qm, gensymed_symbol, gensymed_symbol_1;
	...
	if (SYMBOLP(current_class_name_qm)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = current_class_name_qm;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(current_class_name_qm) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
	...
	if (SYMBOLP(old_class_name_qm)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = old_class_name_qm;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(old_class_name_qm) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_10:
	    if ( !TRUEP(gensymed_symbol))
    ...
    Object indexed_item_list, class_name, attribute_name, attribute_value;
{
    ...
    Object parent_and_class_tree_qm, empty_list_p_qm, scope_conses;
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    if (evaluation_value_equal_p(gensymed_symbol_2,
			gensymed_symbol_4)) {
		parent_and_class_tree_qm = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_1;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_1;
	...
	if (parent_and_class_tree_qm && class_description) {
	    ...
	    next_loop_4:
		  ...
		  gensymed_symbol = gensymed_symbol & gensymed_symbol_3;
	...
	if (EQ(attribute,Quuid) && class_description) {
	    ...
	    temp_2 = TRUEP(Nil);
	if (temp_2 ? TRUEP(text_string_p(attribute_value)) : TRUEP(Nil)) {
	    item_or_item_list = 
    ...
    Object class_name, attribute_name, attribute_value;
{
    ...
    Object indexed_attribute_table_qm, item_or_not_found, temp_1;
    Object gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_4;
    Object parent_and_class_tree_qm, scope_conses, ab_node_stack_;
    Object ab_current_node_, ab_next_node_qm_, ab_current_alist_;
    Object ab_entry_cons_, item, class_list, ab_less_than_branch_qm_;
    Object defining_class, ab_loop_list_, sub_class_bit_vector;
    Object slot_description_qm, defining_class_of_attribute_qm;
    Object item_or_item_list;
    SI_Long gensymed_symbol, temp, gensymed_symbol_3;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5;
    char temp_2;
...
void variables_INIT()
{
    ...
    Object Qmutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry;
    ...
    Object Qcount_of_indexed_attribute_parent_objects_hash_vector_43_vectors;
    Object Qavailable_indexed_attribute_parent_objects_hash_vector_43_vectors;
    Object Qmutate_indexed_attribute_defining_classes_tree_entry, Qvariables;
    Object Qindexed_attributes, Qindexed_attribute_classes;
    ...
    Object Qinference_background_collection_count;
    Object Qchain_of_available_inference_background_collections;
    ...
    Object Qmutate_items_needing_initialization_tree_entry;
    Object Qput_current_value_called_from_simulator_p;
    ...
    Object Qformula_invocation_structure_memory_usage;
    Object Qformula_invocation_count, Qchain_of_available_formula_invocations;
    Object string_constant_238, string_constant_237, Qslot_putter;
    Object Qput_data_server_aliases, Qslot_value_writer;
    Object Qwrite_data_server_aliases_from_slot;
    ...
    Object Qdata_server_parameters;
    ...
    Object Qdata_server_count, Qchain_of_available_data_servers;
    Object string_constant_230, string_constant_229, string_constant_228;
    Object list_constant_9, Qlist_of_all_data_servers, Kfuncall;
    Object Qdata_server_or_alias_qm, Qvariable_simulation_runtime_structure;
    ...
    Object Qvariable_simulation_runtime_structure_count;
    Object Qchain_of_available_variable_simulation_runtime_structures;
    Object string_constant_227, string_constant_226, Qsimulation_info;
    Object Qoutstanding_simulation_info_count;
    Object Qsimulation_info_structure_memory_usage, Qsimulation_info_count;
    Object Qchain_of_available_simulation_infos, string_constant_225;
    ...
    string_constant_36 = 
	    STATIC_STRING("1p8q1o836wy1l83*sy1m8v836wy8t1o83--y01m8p83-*y1m83Dy53*syWill allow 0 or more author entries. each author entry may have a date.");
    string_constant_37 = 
	    STATIC_STRING(" ~\nauthors: ([ name: symbol, date: gensym-time ] * ), editor-grammar: struct, defining-class: item, writable: true\n1n83-0y01m8p8");
    ...
    string_constant_44 = 
	    STATIC_STRING("default &lt;integer&gt;), ~\nbreakpoint-level: (or default &lt;integer&gt;)]000004z8r83Q2y83Q2y835Ty835Ty00001n1l8l1l8o1l83Cy0000");
    string_constant_45 = 
	    STATIC_STRING("04z8r83Q3y83Q3y835Ty835Ty00001n1l8l1l8o1l83Cy00000");
    string_constant_46 = 
	    STATIC_STRING("1s8q1o835Ty1l83*sy1m8v835Ty8t1o83--y01m8p83-*y1m83Dy53*syWill allow 0 or more author entries. each author entry may have a date.");
    string_constant_47 = 
	    STATIC_STRING("3-0y1q83ry01n8p835Ty83Gy8o8l83-5y1q83-py08l83Ey83Cy1m8p83-py1o83Q2y08o83Cy1o83Q3y08o83Cy");
    ...
    string_constant_51 = 
	    STATIC_STRING(" default &lt;integer&gt;)]000004z8r83c5y83c5y830Cy830Cy03RtKe+z001n1l8o1l8l1m83Dy5rExport\?000004z8r83-Ky83-Ky830Cy830Cy00001p1l8");
    string_constant_52 = 
	    STATIC_STRING("o1l8z1l8l1l83Cy1m83Dy5qExport000004z8r83J0y83J0y830Cy830Cy00001p1l8o1l8l1m8p83bDy1l83Fy1l83Hy000004z8r83dty83dty830Cy830Cy00001n");
    string_constant_53 = 
	    STATIC_STRING("1l8o1l8l1m83Dy5yExport: Struct000004z8r83Fqy83Fqy830Cy830Cy00001p1m8p830hy1l8o1l8z1l8l1m83Dy5yExport: Struct000004z8r83aEy83aEy8");
    string_constant_54 = 
	    STATIC_STRING("30Cy830Cy00001n1l83Ey1l8l1m83Dy53CyPossible export.000004z8r83N1y83N1y830Cy830Cy00001o1l83Ey1l8l1l83Hy1m83Dy5tInternal.00000");
    string_constant_55 = 
	    STATIC_STRING("1v8q1r830Cy1l83-Oy1m8v830Cy8t83-8y83Iy83Ly1p83-Iy08o8l1m8p831ry1r83-py08l8z83Ey83Cy1m8p83-py1p83c5y3RtKe+z8o8l1m83Dy5rExport\?1r8");
    string_constant_56 = 
	    STATIC_STRING("3-Ky08o8z8l83Cy1m83Dy5qExport1r83J0y08o8l1m8p83bDy83Fy83Hy1p83dty08o8l1m83Dy5yExport: Struct1r83Fqy01m8p830hy8o8z8l1m83Dy5yExpor");
    string_constant_57 = 
	    STATIC_STRING("t: Struct1p83aEy083Ey8l1m83Dy53CyPossible export.1q83N1y083Ey8l83Hy1m83Dy5tInternal.");
    ...
    string_constant_61 = 
	    STATIC_STRING("pported. This\ncomment should show up on options, despite it being placed on frame-flags.000004z8r83Kty83Kty83*dy83*dy03RtKe+z001");
    string_constant_62 = 
    ...
    string_constant_63 = 
	    STATIC_STRING("000004z8r83c7y83c7y83*dy83*dy00001m1l8o1l8l000004z8r83bby83bby83*dy83*dy00001m1l8o1l8l000004z8r837Py837Py83*dy83*dy00001q1l83Ey1");
    string_constant_64 = 
	    STATIC_STRING("l8l1l8z1m8p83aDy1l83Fy1m83=dy832Ly000004z8r83Cfy83Cfy83*dy83*dy00001p1l83Ey1l8l1l8z1m8p830hy1l83Ny000004z8r83WZy83WZy83*dy83*dy0");
    string_constant_65 = 
    ...
    string_constant_66 = 
	    STATIC_STRING("l8z1m8p832gy000004z8r83b0y83b0y83*dy83*dy00001m1l8o1l8l000004z8r83M=y83M=y83*dy83*dy00001m1l8o1l8l000004z8r83bsy83bsy83*dy83*dy0");
    string_constant_67 = 
	    STATIC_STRING("0001m1l8o1l8l000004z8r83bqy83bqy83*dy83*dy00001m1l8o1l8l000004z8r83bVy83bVy83*dy83*dy00001m1l8o1l8l000004z8r83bpy83bpy83*dy83*dy");
    string_constant_68 = 
	    STATIC_STRING("00001m1l8o1l8l000004z8r83bTy83bTy83*dy83*dy00001m1l8o1l8l000004z8r83bUy83bUy83*dy83*dy00001m1l8o1l8l000004z8r83H=y83H=y83*dy83*d");
    string_constant_69 = 
    ...
    string_constant_71 = 
	    STATIC_STRING("3Kty3RtKe+z8o8l1q830uy08o8l8z1m8p830uy1q831xy08o8l1n8p83D-y83Gy83-5y1o83c7y08o8l1o83bby08o8l1s837Py083Ey8l8z1m8p83aDy83Fy1m83=dy");
    string_constant_72 = 
	    STATIC_STRING("832Ly1r83Cfy083Ey8l8z1m8p830hy83Ny1p83WZy01m8p83E1y83Ey8l1q83*My83BLy8o8l8z1m8p83*My1q83Auy08o8l8z1m8p832gy1o83b0y08o8l1o83M=y08");
    string_constant_73 = 
	    STATIC_STRING("o8l1o83bsy08o8l1o83bqy08o8l1o83bVy08o8l1o83bpy08o8l1o83bTy08o8l1o83bUy08o8l1o83H=y08l8o1o83H0y08l8o");
    ...
    string_constant_218 = 
	    STATIC_STRING("2Ly00001p1m8p83A+y1l8o1l8l1l8z1l83Cy000004z8r83aCy83aCy832Ly832Ly00001n1n8p83F7y83Gy1l8o1l8l000004z8r83Kpy83Kpy832Ly832Ly00001m1");
    string_constant_219 = 
	    STATIC_STRING("l8o1l8l000004z8r83JWy83JWy832Ly832Ly0k001m1l8o1l8l000004z8r83aHy83aHy832Ly832Ly00001m1l8o1l8l000004z8r83aIy83aIy832Ly832Ly00001o");
    string_constant_220 = 
	    STATIC_STRING("1m8p830hy1l8o1l8l1l8z000004z8r83Xfy83Xfy832Ly832Ly00001o1l8o1l8l1l83Cy1l83Uy000004z8r83aJy83aJy832Ly832Ly00001n1l8l1l8o1l83Cy000");
    string_constant_221 = 
	    STATIC_STRING("004z8r83aKy83aKy832Ly832Ly00001n1l8l1l8o1l83Cy00000");
    string_constant_222 = 
	    STATIC_STRING("1w8q1p832Ly1m83Ry9k1m8v832Ly8t83ey1r83-py08l83Ey83Cy8z1m8p83-py1r83FNy01m8p83A+y8o8l8z83Cy1p83aCy01n8p83F7y83Gy8o8l1o83Kpy08o8l1");
    string_constant_223 = 
	    STATIC_STRING("o83JWyk8o8l1o83aHy08o8l1q83aIy01m8p830hy8o8l8z1q83Xfy08o8l83Cy83Uy1o83aJy08o83Cy1o83aKy08o83Cy");
    ...
    string_constant_224 = 
	    STATIC_STRING("43Dy8m83nCy1n83nCy8n8k1l8n0000000k3Cyk0k0");
    ...
    string_constant_225 = STATIC_STRING("1q83nCy8s83-oIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_226 = 
	    STATIC_STRING("43Dy8m83oXy1n83oXy8n8k1l8n0000001l1m83My83-BJyk3Myk0k0");
    ...
    Qvariable_simulation_runtime_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_227 = STATIC_STRING("1q83oXy8s83-uay09k9l");
    clear_optimized_constants();
    ...
    string_constant_228 = 
	    STATIC_STRING("43Dy8m83BVy1n83BVy8n8k1l8n0000001l1n8y83-3Py1z83-7Ey83xFy83xEy83xPy83xDy83-Cfy83xHy83xMy83xNy83xGy83xIy83xLy83xJy83xOy83xKyk3Dyk");
    ...
    string_constant_230 = STATIC_STRING("1q83BVy8s83-Pky09k9l");
    clear_optimized_constants();
    ...
    string_constant_232 = 
	    STATIC_STRING("1o4z8r83BWy83BWy83J6y83J6y00001o1l8l1l83Ey1l83Cy1m8p83BWy000004z8r83YBy83YBy83J6y83J6y0o001o1l8l1l8o1l83Cy1m8p83-Zy000004z8r83NJ");
    string_constant_233 = 
	    STATIC_STRING("y83NJy83J6y83J6y00001o1l8l1l83Ey1l83Cy1m8p83Ky000004z8r83R5y83R5y83J6y83J6y00001n1l8l1l83Ey1l83Cy00000");
    string_constant_234 = 
	    STATIC_STRING("1q8q1n83J6y1l83-sy83ey1q83BWy08l83Ey83Cy1m8p83BWy1q83YByo8l8o83Cy1m8p83-Zy1q83NJy08l83Ey83Cy1m8p83Ky1p83R5y08l83Ey83Cy");
    ...
    string_constant_235 = 
	    STATIC_STRING("1p1m83BWy1m9k83Zy1m83BWy83-bxy1m83-bxy83-Pjy1o83-bxy1n83-Pjy1m9k83vy83-bxy1n83-tyln9l1n83-Pjy1p83*My1m9k83Cpy1m9k83-Cgy1m9k83-rH");
    ...
    string_constant_237 = 
	    STATIC_STRING("43Dy8m83hVy1o83hVy830Ey8n8k1l830Ey0000001m1m8x830Ey1n8y83-3ky1n83wry83wqy83woykxk0k0");
    ...
    Qformula_invocation_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_238 = STATIC_STRING("1q83hVy8s83-UVy09k9l");
    clear_optimized_constants();
    ...
    string_constant_27 = 
	    STATIC_STRING("In ~NF, an attempt was made to conclude that the variable ~NF has no ~\n         value.  The attempt failed, because the variable was not ~\n         active.");
    Qmutate_items_needing_initialization_tree_entry = 
	    STATIC_SYMBOL("MUTATE-ITEMS-NEEDING-INITIALIZATION-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_items_needing_initialization_tree_entry,
	    STATIC_FUNCTION(mutate_items_needing_initialization_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_items_needing_initialization_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_items_needing_initialization_tree_entry);
    ...
    string_constant_239 = 
	    STATIC_STRING("43Dy8m83j3y1n83j3y8n8k1l8n0000001l1n8y83-4ey1l83-=Wykrk0k0");
    ...
    Qinference_background_collection_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_240 = STATIC_STRING("1q83j3y8s83-Z0y09k9l");
    clear_optimized_constants();
    ...
    record_system_variable(Qindexed_attributes,Qvariables,Nil,Qnil,Qnil,
	    Qnil,Qt);
    Qmutate_indexed_attribute_defining_classes_tree_entry = 
	    STATIC_SYMBOL("MUTATE-INDEXED-ATTRIBUTE-DEFINING-CLASSES-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_indexed_attribute_defining_classes_tree_entry,
	    STATIC_FUNCTION(mutate_indexed_attribute_defining_classes_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_indexed_attribute_defining_classes_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_indexed_attribute_defining_classes_tree_entry);
    ...
    Qindexed_attribute_parent_objects_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_241 = STATIC_STRING("1q83-Yvy83*By83-Ory09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qout_indexed_attribute_parent_objects_hash_vector_43_vectors,
	    ...
	    NIL,FALSE,0,0));
    Qmutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-INDEXED-ATTRIBUTE-PARENT-OBJECTS-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_indexed_attribute_parent_objects_tree_for_hash_tree_entry);
