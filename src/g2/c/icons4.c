    ...
    Object icon_editor, new_image;
{
    ...
    Object temp_1, stack_of_slot_value_changes, gensymed_symbol_2;
    Object gensymed_symbol_3, current_wide_string_list, wide_string_bv16;
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    ...
    SI_Long temp_2, bv16_length, aref_new_value, length_1;
    char temp_3;
    Declare_special(6);
    Object result;
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,5);
	  ...
	  temp_2 = IFIX(ISVREF(workspace,(SI_Long)5L)) | (SI_Long)16777216L;
	  ISVREF(workspace,(SI_Long)5L) = FIX(temp_2);
      }
	  ...
	  if (new_variables) {
	      fixed_variables = gensym_cons_1(Qvariables,fixed_variables);
	...
	end_1:;
	  ...
	  if (EQUAL(old_image,new_image))
	      ...
	      new_drawing_element = copy_tree_using_gensym_conses_1(new_image);
		  ...
		  if ( !TRUEP(FOURTH(layer))) {
		      temp_1 = last(drawing_elements,_);
		      M_FOURTH(layer) = temp_1;
		  }
		  temp_1 = FOURTH(layer);
	      ...
	      changed_qm = copy_tree_using_gensym_conses_1(new_image);
	      M_CAR(old_image_place) = changed_qm;
	  }
	  else {
	      temp_1 = delete_gensym_element_1(old_image,THIRD(layer));
	      M_THIRD(layer) = temp_1;
	      temp_1 = last(THIRD(layer),_);
	      M_FOURTH(layer) = temp_1;
	      changed_qm = T;
	  }
	  if (Nil)
	      reclaim_icon_editor_slot_value(ISVREF(engine,(SI_Long)14L));
	  temp_1 = copy_tree_using_gensym_conses_1(new_image);
    ...
    Object icon_editor, text;
{
    ...
    Object slot_description, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object temp_1, stack_of_slot_value_changes, gensymed_symbol_2;
    Object gensymed_symbol_3, layer, sublist, drawing_element, old_text_place;
    Object old_text, icon_editor_engine, new_drawing_element, drawing_elements;
    Object frame_and_slot_or_atom, ab_loop_list_, ab_loop_it_;
    Object gensym_pop_store, cons_1, next_cons;
	...
	end_1:;
	  ...
	  if (EQUAL(old_text,text))
	      ...
	      temp_1 = delete_gensym_element_1(old_text,THIRD(layer));
	      M_THIRD(layer) = temp_1;
	      temp_1 = last(THIRD(layer),_);
	      M_FOURTH(layer) = temp_1;
	      changed_qm = T;
...
Object update_icon_editor_status(icon_editor)
    Object icon_editor;
{
    Object engine, layer, drawing_element, ab_loop_list_, image_name_qm;
    ...
    Object icon_editor;
{
    ...
    Object layer, ab_loop_list_, ab_loop_it_, drawing_elements_present_qm;
    Object stipple_spec, icon_description_qm;
    char temp;
...
Object update_class_definition_for_icon_editor(icon_editor)
    Object icon_editor;
{
    Object class_definition, superior, ab_loop_list_, ab_loop_it_;
	...
	temp_2 = TRUEP(Nil);
    if (temp_2) {
	change_slot_value(3,class_definition,
		Qicon_description_for_class_qm,
		extract_icon_description_from_icon_editor(icon_editor));
	return update_change_log_attribute(class_definition,
		get_slot_description_of_class_description_function(Qicon_description_for_class_qm,
		ISVREF(class_definition,(SI_Long)1L),Nil),Nil);
    }
    else
    ...
    Object list_of_dotted_pairs;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    cdr_new_value = gensym_cons_1(CDR(dotted_pair),Nil);
    ...
    Object icon_editor, deleting_drawing_element_p_qm;
{
    ...
    Object layer_to_delete, svref_new_value, temp_3, temp_4;
    SI_Long temp_2;
	...
	layer_to_delete_is_empty_p =  !TRUEP(THIRD(layer_to_delete));
	M_FOURTH(layer_to_delete) = Nil;
	reclaim_icon_editor_slot_value(layer_to_delete);
	layer_to_delete = Nil;
	if (IFIX(ISVREF(engine,(SI_Long)7L)) > (SI_Long)0L) {
	    svref_new_value = FIXNUM_SUB1(ISVREF(engine,(SI_Long)7L));
	    SVREF(engine,FIX((SI_Long)7L)) = svref_new_value;
	    temp_2 = IFIX(FIXNUM_SUB1(layer_index_to_delete));
	    reset_current_layer(engine,FIX(MAX(temp_2,(SI_Long)0L)));
	}
	...
	if (IFIX(ISVREF(engine,(SI_Long)5L)) == (SI_Long)0L) {
	    ...
	    temp_1 = ISVREF(engine,(SI_Long)6L);
	    temp_1 = FIRST(temp_1);
	    temp_3 = image_of_layer_qm(ISVREF(engine,(SI_Long)6L));
	    temp_4 = text_of_layer_qm(ISVREF(engine,(SI_Long)6L));
	    enqueue_icon_editor_engine_event(icon_editor,FIX((SI_Long)21L),
		    temp_1,temp_3,temp_4,stipple_of_layer_qm(ISVREF(engine,
		    (SI_Long)6L)));
	}
...
{
    Object layer, drawing_elements, drawing_element, ab_loop_list_, image_qm;
    Object text_qm, stipple_qm;
    ...
    Object arg_4_qm;
{
    ...
    Object ab_loop_list_, current_layer, temp_5, layer_index, layer, label;
    Object elements, new_current_layer_qm, group_points_into_one_layer_qm;
    Object new_list_of_elements, list_of_point_elements, ab_loopvar_;
    Object ab_loopvar__1, current_label, current_image, current_text;
    Object current_stipple, new_drawing_element, drawing_elements, x_value;
    Object y_value, ab_loop_desetq_, gensymed_symbol_1, decomposed_polygon_qm;
    Object new_color, new_region_qm, new_image_qm, new_text_qm, new_stipple_qm;
    ...
    if (temp) {
	reclaim_gensym_tree_1(arg_1_qm);
	reclaim_gensym_tree_1(arg_2_qm);
	reclaim_gensym_tree_1(arg_3_qm);
	reclaim_gensym_tree_1(arg_4_qm);
	...
	if (! !((SI_Long)-128L <= temp_1 && temp_1 <= (SI_Long)127L))
		...
		if (IFIX(current_layer_index) <= (SI_Long)0L) {
		    ...
		    drawing_elements_1 = THIRD(layer_1);
		    layer_2 = delete_specific_layer(layer_index_2,
			    icon_editor_engine);
		    label_2 = FIRST(layer_2);
		    element = Nil;
		    ab_loop_list_ = THIRD(layer_2);
		  next_loop:
		    if ( !TRUEP(ab_loop_list_))
			goto end_loop;
		    element = M_CAR(ab_loop_list_);
		    ab_loop_list_ = M_CDR(ab_loop_list_);
		    drawing_elements_1 = gensym_cons_1(element,
			    drawing_elements_1);
		    goto next_loop;
		  end_loop:;
		    M_THIRD(layer_1) = drawing_elements_1;
		    temp_4 = last(drawing_elements_1,_);
		    M_FOURTH(layer_1) = temp_4;
		    reclaim_icon_editor_slot_value(SECOND(layer_1));
		    M_SECOND(layer_1) = Nil;
		    reclaim_icon_editor_slot_value(SECOND(layer_2));
		    reclaim_gensym_list_1(layer_2);
		...
		break;
	      case 11:
		current_layer = ISVREF(engine,(SI_Long)6L);
		number_of_elements = IFIX(length(THIRD(current_layer)));
		if (number_of_elements < (SI_Long)2L)
		  ...
		  next_loop_2:
		    ...
		    if ( !(EQ(FIRST(element),Qpoint) && 
			    group_points_into_one_layer_qm)) {
			new_list_of_elements = gensym_cons_1(element,Nil);
			new_current_layer_qm = gensym_list_4(label,Nil,
				new_list_of_elements,new_list_of_elements);
		  ...
		  end_loop_2:
			...
			new_current_layer_qm = gensym_list_4(label,Nil,
				list_of_point_elements,list_of_point_elements);
			put_layer_before_specific_layer(new_current_layer_qm,
				layer_index,engine_1);
			layer_index = FIXNUM_ADD1(layer_index);
		    }
		    reclaim_gensym_list_1(elements);
		...
		break;
	      case 32:
		icon_editor_engine = engine;
		new_drawing_element = gensym_list_2(Qpoint,
			gensym_list_2(arg_1_qm,arg_2_qm));
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		reclaim_icon_editor_slot_value(SECOND(layer));
		M_SECOND(layer) = Nil;
		...
		if (drawing_elements) {
		    if ( !TRUEP(FOURTH(layer))) {
			temp_4 = last(drawing_elements,_);
			M_FOURTH(layer) = temp_4;
		    }
		    temp_4 = FOURTH(layer);
		...
		break;
	      case 34:
		icon_editor_engine = engine;
		new_drawing_element = gensym_list_3(Qlines,
			gensym_list_2(arg_1_qm,arg_2_qm),
			gensym_list_2(arg_3_qm,arg_4_qm));
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		reclaim_icon_editor_slot_value(SECOND(layer));
		M_SECOND(layer) = Nil;
		...
		break;
	      case 35:
		icon_editor_engine = engine;
		new_drawing_element = gensym_cons_1(Qlines,
		...
		break;
	      case 36:
		icon_editor_engine = engine;
		temp_4 = gensym_cons_1(CDR(arg_1_qm),Nil);
		M_CDR(arg_1_qm) = temp_4;
		temp_3 = arg_1_qm;
		temp_4 = gensym_cons_1(CDR(arg_2_qm),Nil);
		M_CDR(arg_2_qm) = temp_4;
		temp_2 = gensym_list_2(Qarc,arg_2_qm);
		temp_4 = gensym_cons_1(CDR(arg_3_qm),Nil);
		M_CDR(arg_3_qm) = temp_4;
		new_drawing_element = gensym_list_4(Qlines,temp_3,temp_2,
			arg_3_qm);
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		reclaim_icon_editor_slot_value(SECOND(layer));
		...
		temp_4 = gensym_list_2(arg_1_qm,arg_2_qm);
		M_CAR(gensymed_symbol_1) = temp_4;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		temp_4 = gensym_list_2(arg_1_qm,arg_4_qm);
		M_CAR(gensymed_symbol_1) = temp_4;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		temp_4 = gensym_list_2(arg_3_qm,arg_4_qm);
		M_CAR(gensymed_symbol_1) = temp_4;
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		temp_4 = gensym_list_2(arg_3_qm,arg_2_qm);
		M_CAR(gensymed_symbol_1) = temp_4;
		...
		break;
	      case 38:
		icon_editor_engine = engine;
		new_drawing_element = gensym_cons_1(Qoutline,
			convert_list_of_dotted_pairs_to_list_of_lists(arg_1_qm));
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		reclaim_icon_editor_slot_value(SECOND(layer));
		...
		break;
	      case 39:
		icon_editor_engine = engine;
		new_drawing_element = gensym_list_4(Qcircle,
			gensym_list_2(FIXNUM_MINUS(arg_1_qm,arg_3_qm),
			arg_2_qm),gensym_list_2(arg_1_qm,
			FIXNUM_MINUS(arg_2_qm,arg_3_qm)),
			gensym_list_2(FIXNUM_ADD(arg_1_qm,arg_3_qm),arg_2_qm));
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		reclaim_icon_editor_slot_value(SECOND(layer));
		M_SECOND(layer) = Nil;
		...
		break;
	      case 40:
		icon_editor_engine = engine;
		new_drawing_element = gensym_list_3(Qsolid_rectangle,
			gensym_list_2(arg_1_qm,arg_2_qm),
			gensym_list_2(arg_3_qm,arg_4_qm));
		layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		drawing_elements = THIRD(layer);
		...
		if (decomposed_polygon_qm) {
		    icon_editor_engine = engine;
		    new_drawing_element = gensym_cons_1(Qfilled_polygon,
			    gensym_cons_1(arg_1_qm,decomposed_polygon_qm));
		    layer = ISVREF(icon_editor_engine,(SI_Long)6L);
		    drawing_elements = THIRD(layer);
		    reclaim_icon_editor_slot_value(SECOND(layer));
		    M_SECOND(layer) = Nil;
		...
		break;
	      case 42:
		icon_editor_engine = engine;
		new_drawing_element = gensym_list_4(Qfilled_circle,
			gensym_list_2(FIXNUM_MINUS(arg_1_qm,arg_3_qm),
			arg_2_qm),gensym_list_2(arg_1_qm,
			FIXNUM_MINUS(arg_2_qm,arg_3_qm)),
			gensym_list_2(FIXNUM_ADD(arg_1_qm,arg_3_qm),arg_2_qm));
		...
		temp_4 = copy_tree_using_gensym_conses_1(new_image_qm);
		...
		break;
	      case 31:
		current_layer = ISVREF(engine,(SI_Long)6L);
		drawing_elements = THIRD(current_layer);
		...
		if (IFIX(number_of_drawing_elements) <= (SI_Long)0L)
			...
			if ( !TRUEP(CDDR(rest_of_elements))) {
			    ...
			    M_FOURTH(layer) = rest_of_elements;
			    goto end_1;
			}
		...
		handle_new_layer_creation_in_engine(icon_editor,temp_2,Nil,
			temp_3,
			copy_tree_including_leaves_using_icon_editor_conses(THIRD(temp_5)));
		break;
	      case 58:
	      case 59:
		...
		icon_height = ISVREF(ISVREF(icon_editor,(SI_Long)11L),
			(SI_Long)2L);
		current_layer = ISVREF(engine,(SI_Long)6L);
		current_drawing_elements_qm = THIRD(current_layer);
		if (current_drawing_elements_qm) {
			...
			temp_4 = last(new_drawing_elements_qm,_);
			M_FOURTH(current_layer) = temp_4;
			M_THIRD(current_layer) = new_drawing_elements_qm;
    ...
    Object delete_as_item_referring_to_name_qm;
{
    ...
    Object drawing_element, ab_loop_list__1, image_name_qm;
    Declare_special(3);
    Object result;

    x_note_fn_call(236,26);
	...
	if (Defer_consistency_analysis_qm &&  
		...
		end_loop_1:;
		  goto next_loop;
		end_loop:;
		  if (any_qm &&  !TRUEP(Add_as_item_referring_to_name_qm) 
			  &&  !TRUEP(Delete_as_item_referring_to_name_qm)) {
		      update_icon_editor_status(icon_editor_qm);
		      handle_icon_editor_visual_event(icon_editor_qm,
			      FIX((SI_Long)38L),Nil,Nil);
		      result = handle_icon_editor_visual_event(icon_editor_qm,
			      FIX((SI_Long)21L),Nil,Nil);
		  }
		  else
		      result = VALUES_1(Nil);
