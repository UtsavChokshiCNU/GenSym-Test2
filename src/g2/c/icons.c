...
{
    x_note_fn_call(64,0);
    return reclaim_gensym_list_1(slot_value_list);
}

Object The_type_description_of_icon_description = UNBOUND;

Object Chain_of_available_icon_descriptions = UNBOUND;

Object Icon_description_count = UNBOUND;
    ...
    Object icon_description;
{
    ...
    svref_new_value = Chain_of_available_icon_descriptions;
    SVREF(icon_description,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_icon_descriptions = icon_description;
    return VALUES_1(Nil);
}
...
Object make_permanent_icon_description_structure_internal()
{
    ...
    Object icon_description_count_new_value;
    ...
    icon_description_count_new_value = FIXNUM_ADD1(Icon_description_count);
    Icon_description_count = icon_description_count_new_value;
...
Object G2gl_object_icon_substitutions_may_be_in_use_p = UNBOUND;
    ...
    Object slot_value;
{
	...
	inline_note_reclaim_cons(slot_value,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(slot_value) = cdr_new_value;
...
{
    x_note_fn_call(64,10);
    return VALUES_1(SVREF(icon_description,FIX((SI_Long)12L)) = class_name);
}

Object Icon_renderings_being_bulk_decached = UNBOUND;
    ...
    Object icon_rendering, icon_description;
{
	...
	if (EQ(CAR(rest_of_icon_renderings),icon_rendering)) {
	    ...
	    reclaim_gensym_cons_1(rest_of_icon_renderings);
	    return VALUES_0();
	}
    ...
    Object icon_renderings;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(icon_renderings);
}
...
Object Current_icon_untransformed_width = UNBOUND;

Object Current_icon_untransformed_height = UNBOUND;

Object Current_icon_variables_plist = UNBOUND;

Object Current_icon_variables_override_plist = UNBOUND;
    ...
    Object line_drawing_description, substitution_list;
{
    ...
    x_note_fn_call(64,26);
    current_icon_substitution_list = substitution_list;
    PUSH_SPECIAL(Current_icon_substitution_list,current_icon_substitution_list,
	    0);
    ...
    Object sorted_values, default_sorted_values;
{
  ...
  next_loop:
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	result_1 = gensym_cons_1(copy_for_slot_value(default_value),result_1);
	goto next_loop_1;
      end_loop:
	...
	result_1 = 
		gensym_cons_1(copy_for_slot_value(CAR(remaining_sorted_values)),
		result_1);
	match_p = T;
    }
    else {
	result_1 = 
		gensym_cons_1(copy_for_slot_value(CAR(remaining_default_sorted_values)),
		result_1);
	match_p = Nil;
    }
    ...
    Object region_extrema, line_drawing_description;
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = gensym_cons_1(gensym_list_3(tile_edge_size_in_pixels,
	    rows,columns),Nil);
    if (ab_loopvar_)
    ...
    Object line_drawing_description;
{
  ...
  next_loop_2:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    reclaim_gensym_list_1(elem);
    goto next_loop_2;
  end_loop_2:;
    reclaim_gensym_list_1(bitmap_size_parameters);
    ...
    Object icon_description, icon_attributes_plist;
{
  ...
  end_loop_1:
	...
	PUSH_SPECIAL(Icon_renderings_being_bulk_decached,icon_renderings_being_bulk_decached,
		0);
	...
	next_loop_2:
	  ...
	  goto next_loop_2;
	end_loop_2:;
	  reclaim_gensym_list_1(Icon_renderings_being_bulk_decached);
	POP_SPECIAL();
    }
    temp = Qnil;
  end_1:;
	...
	icon_rendering = create_icon_rendering(icon_description,
		...
		array_of_bitmap_counts,number_of_bitmaps_for_rendering,
		bitmap_memory_used_for_rendering);
	temp_1 = gensym_cons_1(icon_rendering,ISVREF(icon_description,
		(SI_Long)9L));
	SVREF(icon_description,FIX((SI_Long)9L)) = temp_1;
	temp = icon_rendering;
    }
    ...
    Object gensym_window_in_non_icp_case_qm, icon_rendering;
{
    ...
    Object new_stored_raster, temp;
    Declare_special(11);
    Object result;

    x_note_fn_call(64,38);
...
Object Printing_icon_current_region_index_qm = UNBOUND;
    ...
    Object icon_height, reflection_and_rotation, icon_line_color_value;
{
	...
	PUSH_SPECIAL(Send_image_data_immediately_qm,send_image_data_immediately_qm,
		0);
...
Object create_icon_description varargs_1(int, n)
{
    ...
    Object first_element, polychrome_header, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, cdr_new_value, temp, temp_1, icon_description;
    Declare_varargs_nonrelocating;

    x_note_fn_call(64,55);
	...
	polychrome_header = gensym_cons_1(Qpolychrome,Nil);
	icon_line_drawing_description = gensym_cons_1(polychrome_header,
		icon_line_drawing_description);
	...
	if (memq_function(Qforeground,CDR(icon_line_drawing_description))) {
	    gensym_push_modify_macro_arg = gensym_cons_1(Qforeground,
		    Qforeground);
	    car_1 = gensym_push_modify_macro_arg;
	    cdr_1 = CDR(polychrome_header);
	    cdr_new_value = gensym_cons_1(car_1,cdr_1);
...
Object get_savable_image_info_for_image_name(image_name)
    Object image_name;
{
    x_note_fn_call(64,56);
    return gensym_cons_1(Qimage_info,Nil);
}
...
Object Current_region_minimum_x = UNBOUND;

Object Current_region_minimum_y = UNBOUND;

Object Current_region_maximum_x = UNBOUND;

Object Current_region_maximum_y = UNBOUND;
    ...
    Object width, height, line_drawing_description, computed_values_plist;
{
    ...
    x_note_fn_call(64,60);
    current_region_minimum_x = Nil;
    PUSH_SPECIAL(Current_region_minimum_x,current_region_minimum_x,11);
      current_region_minimum_y = Nil;
      PUSH_SPECIAL(Current_region_minimum_y,current_region_minimum_y,10);
	current_region_maximum_x = Nil;
	PUSH_SPECIAL(Current_region_maximum_x,current_region_maximum_x,9);
	  current_region_maximum_y = Nil;
	  PUSH_SPECIAL(Current_region_maximum_y,current_region_maximum_y,8);
	    first_element = CAR(line_drawing_description);
...
{
    x_note_fn_call(64,64);
    return list_star(3,Qfilled_polygon,simple_polygon,decompose_polygon(2,
	    simple_polygon,Qcons));
}

Object Global_temp_1 = UNBOUND;

Object Global_temp_2 = UNBOUND;

Object Global_temp_3 = UNBOUND;
...
void icons_INIT()
{
    ...
    Object AB_package, list_constant_48, list_constant_47, list_constant_46;
    Object list_constant_45, list_constant_44, list_constant_43;
    Object list_constant_32, list_constant_30, list_constant_42;
    Object list_constant_34, list_constant_41, list_constant_35;
    Object list_constant_33, list_constant_29, list_constant_28;
    Object list_constant_26, list_constant_40, list_constant_39;
    Object list_constant_36, list_constant_38, list_constant_37;
    Object list_constant_31, list_constant_27, list_constant_25;
    ...
    Object list_constant_12, list_constant_11, list_constant_10, Qicons;
    Object Qg2gl_object_icon_substitutions_may_be_in_use_p, Qicon_description;
    Object Qreclaim_structure, Qoutstanding_icon_description_count;
    Object Qicon_description_structure_memory_usage, Qutilities2;
    Object Qicon_description_count, Qchain_of_available_icon_descriptions;
    ...
    string_constant = 
	    STATIC_STRING("43Dy8m8u1n8u8n8k1l8n0000001m1m83My83-AZy1n8y83-4Iy1u83-Gpy83-*8y83-HBy83-HHy83-*vy83-=-y83-=*y83-*wy83-*Uy83-=+ykyk0k0");
    ...
    Qicon_description_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_1 = STATIC_STRING("1q8u8s83-Xjy09k9l");
    ...
    list_constant_10 = STATIC_CONS(Qforeground,Qforeground);
    list_constant = STATIC_CONS(list_constant_10,Qnil);
    ...
    Reflection_and_rotation_multiplication_table_prop = 
	    Qreflection_and_rotation_multiplication_table;
    list_constant_11 = STATIC_CONS(Qreflected_clockwise_270,Qnil);
    list_constant_12 = STATIC_LIST_STAR((SI_Long)18L,Qnil,Qnormal,Qnormal,
	    ...
	    Qreflected_clockwise_270,list_constant_11);
    mutate_global_property(Qnormal,mutate_global_property(Qnil,
	    list_constant_12,
	    Qreflection_and_rotation_multiplication_table),
	    Qreflection_and_rotation_multiplication_table);
    list_constant_13 = STATIC_LIST((SI_Long)18L,Qnil,Qclockwise_90,Qnormal,
    ...
    mutate_global_property(Qclockwise_90,list_constant_13,
	    Qreflection_and_rotation_multiplication_table);
    list_constant_14 = STATIC_LIST((SI_Long)18L,Qnil,Qclockwise_180,
    ...
    mutate_global_property(Qclockwise_180,list_constant_14,
	    Qreflection_and_rotation_multiplication_table);
    list_constant_15 = STATIC_LIST((SI_Long)18L,Qnil,Qclockwise_270,
    ...
    mutate_global_property(Qclockwise_270,list_constant_15,
	    Qreflection_and_rotation_multiplication_table);
    list_constant_16 = STATIC_LIST((SI_Long)18L,Qnil,Qreflected,Qnormal,
    ...
    mutate_global_property(Qreflected,list_constant_16,
	    Qreflection_and_rotation_multiplication_table);
    list_constant_17 = STATIC_LIST((SI_Long)18L,Qnil,
    ...
    mutate_global_property(Qreflected_clockwise_90,list_constant_17,
	    Qreflection_and_rotation_multiplication_table);
    list_constant_18 = STATIC_LIST((SI_Long)18L,Qnil,
	    ...
	    Qclockwise_90);
    mutate_global_property(Qreflected_clockwise_180,list_constant_18,
	    Qreflection_and_rotation_multiplication_table);
    ...
    mutate_global_property(Qreflected_clockwise_270,list_constant_19,
	    Qreflection_and_rotation_multiplication_table);
    ...
    list_constant_20 = STATIC_CONS(FIX((SI_Long)2L),Qnil);
    list_constant_23 = STATIC_CONS(FIX((SI_Long)2L),list_constant_20);
    list_constant_21 = STATIC_LIST_STAR((SI_Long)3L,Qminus,Qwidth,
	    list_constant_20);
    list_constant_22 = STATIC_LIST_STAR((SI_Long)3L,Qminus,Qheight,
	    list_constant_20);
    list_constant_24 = STATIC_LIST((SI_Long)2L,list_constant_21,
	    list_constant_22);
    ...
    list_constant_34 = STATIC_CONS(Qwidth,list_constant_4);
    list_constant_25 = STATIC_CONS(FIX((SI_Long)3L),Qnil);
    list_constant_26 = STATIC_LIST_STAR((SI_Long)3L,Qminus,Qwidth,
	    list_constant_25);
    list_constant_35 = STATIC_CONS(list_constant_26,list_constant_25);
    list_constant_31 = STATIC_CONS(FIX((SI_Long)3L),list_constant_25);
    list_constant_27 = STATIC_LIST_STAR((SI_Long)3L,Qminus,Qheight,
	    list_constant_25);
    list_constant_28 = STATIC_CONS(list_constant_27,Qnil);
    list_constant_32 = STATIC_CONS(FIX((SI_Long)3L),list_constant_28);
    list_constant_29 = STATIC_CONS(Qheight,Qnil);
    list_constant_30 = STATIC_CONS(FIX((SI_Long)0L),list_constant_29);
    list_constant_33 = STATIC_CONS(list_constant_30,Qnil);
    list_constant_36 = STATIC_LIST_STAR((SI_Long)3L,list_constant_31,
	    list_constant_32,list_constant_33);
    list_constant_37 = STATIC_LIST_STAR((SI_Long)4L,list_constant_8,
	    list_constant_34,list_constant_35,list_constant_36);
    list_constant_38 = STATIC_LIST((SI_Long)3L,list_constant_8,
	    list_constant_34,list_constant_35);
    list_constant_39 = STATIC_LIST((SI_Long)3L,list_constant_8,
	    list_constant_35,list_constant_31);
    list_constant_40 = STATIC_LIST((SI_Long)3L,list_constant_31,
	    list_constant_30,list_constant_8);
    list_constant_6 = STATIC_LIST((SI_Long)6L,Qfilled_polygon,
	    list_constant_37,list_constant_38,list_constant_36,
	    list_constant_39,list_constant_40);
    list_constant_41 = STATIC_CONS(list_constant_26,list_constant_28);
    list_constant_42 = STATIC_CONS(Qwidth,list_constant_29);
    list_constant_43 = STATIC_LIST_STAR((SI_Long)6L,list_constant_32,
	    list_constant_41,list_constant_35,list_constant_34,
	    list_constant_42,list_constant_33);
    list_constant_44 = STATIC_LIST((SI_Long)3L,list_constant_41,
	    list_constant_35,list_constant_34);
    list_constant_45 = STATIC_LIST((SI_Long)3L,list_constant_42,
	    list_constant_32,list_constant_41);
    list_constant_46 = STATIC_LIST((SI_Long)3L,list_constant_41,
	    list_constant_34,list_constant_42);
    list_constant_47 = STATIC_LIST((SI_Long)3L,list_constant_42,
	    list_constant_30,list_constant_32);
    ...
    list_constant_48 = STATIC_CONS(Qpending_indicator,Qtransparent);
    list_constant_9 = STATIC_LIST_STAR((SI_Long)3L,Qpolychrome,
	    list_constant_48,list_constant);
