...
/* RECLAIM-RELATION-INSTANCE-TREE-LEAVES */
Object reclaim_relation_instance_tree_leaves(relation_instance_tree_binary_tree)
    Object relation_instance_tree_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(relation_instance_tree_binary_tree))
	goto end_loop;
    less_than_branch_qm = ISVREF(relation_instance_tree_binary_tree,
	    (SI_Long)1L);
    greater_than_branch_qm = ISVREF(relation_instance_tree_binary_tree,
	    (SI_Long)2L);
    alist = ISVREF(relation_instance_tree_binary_tree,(SI_Long)3L);
    reclaim_binary_tree_element_1(relation_instance_tree_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
    if ( !TRUEP(ab_loop_list_))
  ...
  end_loop_1:;
	...
	reclaim_relation_instance_tree_leaves(less_than_branch_qm);
	relation_instance_tree_binary_tree = greater_than_branch_qm;
    }
    else {
	...
	relation_instance_tree_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
...
/* CLEAR-RELATION-INSTANCE-TREE-TREE */
Object clear_relation_instance_tree_tree(relation_instance_tree_binary_tree)
    Object relation_instance_tree_binary_tree;
{
    Object element_qm;

    x_note_fn_call(105,3);
    element_qm = CDR(relation_instance_tree_binary_tree);
    if (element_qm) {
	reclaim_relation_instance_tree_leaves(element_qm);
	M_CDR(relation_instance_tree_binary_tree) = Nil;
    }
    return VALUES_1(relation_instance_tree_binary_tree);
}
    ...
    Object relation_instances;
{
	...
	if (temp_1) {
	    ...
	    temp = EQ(ISVREF(ISVREF(M_CAR(gensymed_symbol),(SI_Long)0L),
		    (SI_Long)0L),M_CDR(gensymed_symbol)) ? T : Nil;
	}
	else
...
Object get_relation_instance_function(key,tree)
    Object key, tree;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;

    x_note_fn_call(105,5);
    gensymed_symbol = CDR(tree);
    gensymed_symbol_1 = key;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(key) & IFIX(Most_positive_fixnum);
    ...
    Object tree;
{
    ...
    if (tree) {
	element_qm = M_CDR(tree);
	if (element_qm)
	    reclaim_relation_instance_tree_leaves(element_qm);
	inline_note_reclaim_cons(tree,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(tree) = cdr_new_value;
	Available_gensym_conses = tree;
	temp = Nil;
    }
    else
	temp = Nil;
...
Object Chain_of_available_relation_instances = UNBOUND;

Object Relation_instance_count = UNBOUND;
    ...
    Object relation_instance;
{
    ...
    svref_new_value = Chain_of_available_relation_instances;
    SVREF(relation_instance,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_relation_instances = relation_instance;
    return VALUES_1(Nil);
}
...
Object make_permanent_relation_instance_structure_internal()
{
    ...
    Object defstruct_g2_relation_instance_variable, svref_new_value;
    SI_Long relation_instance_count_new_value, gensymed_symbol;
    SI_Long gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(105,11);
    def_structure_relation_instance_variable = Nil;
    relation_instance_count_new_value = IFIX(Relation_instance_count) + 
	    (SI_Long)100L;
    Relation_instance_count = FIX(relation_instance_count_new_value);
...
{
    Object def_structure_relation_instance_variable;
...
/* RECLAIM-RELATED-ITEM-TREE-LEAVES */
Object reclaim_related_item_tree_leaves(related_item_tree_binary_tree)
    Object related_item_tree_binary_tree;
{
    Object less_than_branch_qm, greater_than_branch_qm, alist, alist_entry;
    Object ab_loop_list_, cdr_new_value, last_1, next_qm, temp;
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(related_item_tree_binary_tree))
	goto end_loop;
    less_than_branch_qm = ISVREF(related_item_tree_binary_tree,(SI_Long)1L);
    greater_than_branch_qm = ISVREF(related_item_tree_binary_tree,(SI_Long)2L);
    alist = ISVREF(related_item_tree_binary_tree,(SI_Long)3L);
    reclaim_binary_tree_element_1(related_item_tree_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
    if ( !TRUEP(ab_loop_list_))
  ...
  end_loop_1:;
    ...
    if (less_than_branch_qm && greater_than_branch_qm) {
	reclaim_related_item_tree_leaves(less_than_branch_qm);
	related_item_tree_binary_tree = greater_than_branch_qm;
    }
    else {
	temp = less_than_branch_qm;
	if (temp);
	    ...
	    temp = greater_than_branch_qm;
	related_item_tree_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
...
/* CLEAR-RELATED-ITEM-TREE-TREE */
Object clear_related_item_tree_tree(related_item_tree_binary_tree)
    Object related_item_tree_binary_tree;
{
    Object element_qm;

    x_note_fn_call(105,14);
    element_qm = CDR(related_item_tree_binary_tree);
    if (element_qm) {
	reclaim_related_item_tree_leaves(element_qm);
	M_CDR(related_item_tree_binary_tree) = Nil;
    }
    return VALUES_1(related_item_tree_binary_tree);
}
...
{
    Object new_cons, gensymed_symbol, blocks, temp;
	...
	set_balanced_binary_tree_entry(blocks,Qeq,Nil,T,gensymed_symbol,
...
Object reclaim_relation_instance(instance)
    Object instance;
{
    Object temp, related_item_tree_binary_tree, element_qm, cdr_new_value;

    x_note_fn_call(105,16);
    temp = ISVREF(instance,(SI_Long)2L);
    SVREF(instance,FIX((SI_Long)2L)) = Nil;
    related_item_tree_binary_tree = temp;
    element_qm = M_CDR(related_item_tree_binary_tree);
    if (element_qm)
	reclaim_related_item_tree_leaves(element_qm);
    inline_note_reclaim_cons(related_item_tree_binary_tree,Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(related_item_tree_binary_tree) = cdr_new_value;
    Available_gensym_conses = related_item_tree_binary_tree;
    temp = reclaim_relation_instance_structure_1(instance);
    return VALUES_1(temp);
}
    ...
    Object relation_instance;
{
    ...
    head = gensym_list_2(ISVREF(relation_instance,(SI_Long)0L),
    ...
    next_loop:
      ...
      if (block) {
	  ab_loopvar__2 = gensym_cons_1(copy_for_slot_value(block),Nil);
	  if (ab_loopvar__1)
    ...
    Object relation_instances;
{
	...
	next_loop:
	  ...
	  if (new_entry) {
	      ab_loopvar__2 = gensym_cons_1(new_entry,Nil);
	      if (ab_loopvar__1)
		  M_CDR(ab_loopvar__1) = ab_loopvar__2;
	      else
		  ab_loopvar_ = ab_loopvar__2;
    ...
    Object related_items;
{
    ...
    next_loop:
      ...
      if (related_item) {
	  ab_loopvar__2 = gensym_cons_1(related_item,Nil);
	  if (ab_loopvar__1)
	      M_CDR(ab_loopvar__1) = ab_loopvar__2;
	  else
	      ab_loopvar_ = ab_loopvar__2;
...
Object upgrade_relation_instance(block)
    Object block;
{
    Object old_relation_instances_qm, new_cons, gensymed_symbol;
    Object new_relation_instances;

    x_note_fn_call(105,23);
	...
	if (old_relation_instances_qm)
	    reclaim_gensym_tree_1(old_relation_instances_qm);
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(block,Qrelation_instances);
	return VALUES_1(SVREF(block,FIX((SI_Long)12L)) = 
		new_relation_instances);
    }
    else
	return VALUES_1(Nil);
    ...
    Object old_relation_instances, new_relation_instances;
{
  ...
  next_loop_1:
    ...
    set_balanced_binary_tree_entry(temp,Qeq,Nil,T,gensymed_symbol,temp_1,
	    instance);
    goto next_loop_1;
  end_loop_1:;
    gensymed_symbol = name;
    temp = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & IFIX(Most_positive_fixnum));
    set_balanced_binary_tree_entry(new_relation_instances,Qeq,Nil,T,
...
Object initial_relationships(class_1)
    Object class_1;
{
    x_note_fn_call(105,27);
    return VALUES_1(Nil);
}

Object In_write_module_as_clear_text_p = UNBOUND;
    ...
    Object block;
{
	...
	next_loop:
	  ...
	  next_loop_2:
		...
		ab_loopvar__3 = gensym_cons_1(related_item,Nil);
		if (ab_loopvar__2)
	  ...
	  POP_SPECIAL();
	  if (related_items_qm) {
	      temp_2 = gensym_list_2(Qrelation_name_reference,
		      name_reference_to_export);
	      temp = gensym_list_2(Qrelation_is_inverted, 
	    ...
	    end_loop_4:
	      ...
	      temp_3 = Qnil;
	    end_2:;
	      temp_3 = gensym_list_2(Qrelated_items,temp_3);
	      reclaim_gensym_list_1(related_items_qm);
	      ab_loopvar__1 = 
		      gensym_cons_1(allocate_evaluation_structure(nconc2(temp_2,
    ...
    Object block, new_value;
{
	...
	next_loop:
	  ...
	  temp = gensym_cons_1(relation_frame,Nil);
	  ab_loopvar__2 = gensym_cons_1(nconc2(temp,
	...
	if ( !TRUEP(relation_frame)) {
	    reclaim_gensym_list_1(related_items);
	  ...
	  next_loop_4:
		...
		if (temp_1) {
			...
			relations_to_add_information_qm = 
				...
				gensym_cons_1(gensym_list_4(relation_frame,
    ...
    if (string_of_errors_qm) {
	reclaim_gensym_tree_1(relations_to_add_information_qm);
	reclaim_gensym_tree_1(old_relations_for_block_qm);
    ...
    Object relation;
{
    ...
    Object items_in_relation_qm, temp_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    Declare_special(1);

    x_note_fn_call(105,31);
    relation_name = ISVREF(relation,(SI_Long)22L);
	...
	end_loop:
      ...
      if (relation_instances) {
	  gensymed_symbol = CDR(relation_instances);
	  gensymed_symbol_1 = class_of_subject_name_reference;
	  gensymed_symbol_2 = 
	...
	end_2:;
	  ...
	  collector_list = gensym_cons_1(block,collector_list);
      goto next_loop;
    end_loop_1:;
    POP_SPECIAL();
    scope_conses = Scope_conses;
...
Object Grammar_categories_getting_yes_no_feature = UNBOUND;
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,42);
    old_value = ISVREF(relation,(SI_Long)22L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qrelation_name);
    SVREF(relation,FIX((SI_Long)22L)) = value;
    if (old_value)
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,44);
    old_value = ISVREF(relation,(SI_Long)23L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qinverse_of_relation);
    SVREF(relation,FIX((SI_Long)23L)) = value;
    if (old_value)
	delete_from_directory_of_names(old_value,Qrelation_name);
    if (value)
	add_to_directory_of_names(value,Qrelation_name);
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,46);
    old_value = ISVREF(relation,(SI_Long)20L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qclass_of_subject);
    SVREF(relation,FIX((SI_Long)20L)) = value;
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,47);
    old_value = ISVREF(relation,(SI_Long)21L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qclass_of_object);
    SVREF(relation,FIX((SI_Long)21L)) = value;
    if ( !TRUEP(initializing_qm)) {
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,48);
    old_value = ISVREF(relation,(SI_Long)24L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qtype_of_relation);
    SVREF(relation,FIX((SI_Long)24L)) = value;
    if ( !TRUEP(initializing_qm)) {
    ...
    Object relation, value, initializing_qm;
{
    ...
    x_note_fn_call(105,49);
    old_value_qm = ISVREF(relation,(SI_Long)25L);
    new_value_qm = value ? ( !TRUEP(ISVREF(relation,(SI_Long)23L)) ? T : 
	    Nil) : Qnil;
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(relation,Qrelation_is_symmetric);
    SVREF(relation,FIX((SI_Long)25L)) = new_value_qm;
    if ( !TRUEP(initializing_qm)) {
	update_relation_instances_if_necessary(relation,
    ...
    Object invoke_rules_for_relation_chaining_qm;
{
    ...
    Object unique_reverse_qm, subject_and_object_switched_qm, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, error_string;
    Object sub_class_bit_vector, temp_1, the_block, blocks, error_string_qm;
    Object previously_related_item, related_items, scope_conses;
    Object ab_node_stack_, ab_current_node_, ab_skip_list_form_;
    Object ab_binary_tree_form_, temp_2, ab_skip_list_p_, ab_next_node_;
    Object ab_tail_node_, ab_current_alist_, ab_entry_cons_, item;
    Object ab_less_than_branch_qm_, subject_related_items;
    Object object_related_items, ab_loop_it_, temp_3, temp_4, instance_items;
    Object new_cons, new_tree;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp;
    Declare_special(1);

    x_note_fn_call(105,50);
    if (Noting_changes_to_kb_p)
	...
	gensymed_symbol = CDR(subject_instances);
	...
	if (gensymed_symbol_2 < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
	    if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
		subject_instance_form = M_CDR(M_CAR(gensymed_symbol));
		goto end_1;
	    }
	    gensymed_symbol = M_CDR(gensymed_symbol);
	    goto next_loop_1;
	  end_loop_1:
	    subject_instance_form = Qnil;
	  end_1:;
	    goto end_2;
	}
	goto next_loop;
	...
	if (object_instances) {
	    gensymed_symbol = CDR(object_instances);
	  ...
	  next_loop_2:
		...
		gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
		if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
		    object_instance_form = M_CDR(M_CAR(gensymed_symbol));
		    goto end_3;
		}
		gensymed_symbol = M_CDR(gensymed_symbol);
		goto next_loop_3;
	      end_loop_3:
		object_instance_form = Qnil;
	      end_3:;
		goto end_4;
	    }
	    goto next_loop_2;
	...
	if (unique_forward_qm && subject_instance_form) {
	    ...
	    end_9:;
	    POP_SPECIAL();
	    temp =  !EQ(temp_1,previously_related_item);
	}
	else
	    temp = TRUEP(Nil);
	if (temp) {
	...
	if (temp) {
		...
		temp_1 = item2;
	    error_string_qm = uniqueness_message(temp_3,given_name,temp_2,
	...
	temp_1 = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
		IFIX(Most_positive_fixnum));
	set_balanced_binary_tree_entry(instance_items,Qeq,Nil,T,
	...
	if (subject_instances) {
	    ...
	    set_balanced_binary_tree_entry(temp_1,Qeq,Nil,T,
		    gensymed_symbol,temp_2,subject_instance_form);
	}
	else {
	    if (Noting_changes_to_kb_p)
		note_change_to_block_1(subject,Qrelation_instances);
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
		Available_gensym_conses = M_CDR(new_cons);
		gensymed_symbol = new_cons;
	    ...
	    temp_1 = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
		    IFIX(Most_positive_fixnum));
	    set_balanced_binary_tree_entry(new_tree,Qeq,Nil,T,
		    gensymed_symbol,temp_1,subject_instance_form);
	    SVREF(subject,FIX((SI_Long)12L)) = new_tree;
	}
    }
	...
	if (object_instance_form) {
		...
		temp_2 = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
			IFIX(Most_positive_fixnum));
		set_balanced_binary_tree_entry(temp_1,Qeq,Nil,T,
			gensymed_symbol,temp_2,object_instance_form);
	    }
	    else {
		if (Noting_changes_to_kb_p)
		    note_change_to_block_1(object,Qrelation_instances);
		new_cons = Available_gensym_conses;
		if (new_cons) {
		    Available_gensym_conses = M_CDR(new_cons);
		    gensymed_symbol = new_cons;
		...
		temp_1 = FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
			IFIX(Most_positive_fixnum));
		set_balanced_binary_tree_entry(new_tree,Qeq,Nil,T,
			gensymed_symbol,temp_1,object_instance_form);
		SVREF(object,FIX((SI_Long)12L)) = new_tree;
	    }
	}
    ...
    Object remove_given_name_direction_only_qm;
{
    ...
    Object object_instance_form, other_name, relation, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, error_string, blocks;
    Object found_item, temp_1, scope_conses, ab_node_stack_, ab_current_node_;
    Object ab_skip_list_form_, ab_binary_tree_form_, ab_skip_list_p_;
    Object ab_next_node_, ab_tail_node_, ab_current_alist_, ab_entry_cons_;
    Object item, ab_less_than_branch_qm_, temp_2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    Declare_special(1);

    x_note_fn_call(105,52);
    if (Noting_changes_to_kb_p)
	note_change_to_runtime_data_for_block_1(item1);
    if (Noting_changes_to_kb_p)
	note_change_to_runtime_data_for_block_1(item2);
    ...
    blocks = ISVREF(subject_instance_form,(SI_Long)2L);
    gensymed_symbol = CDR(blocks);
    gensymed_symbol_1 = item1;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(item1) & IFIX(Most_positive_fixnum);
    gensymed_symbol_3 = (SI_Long)0L;
  next_loop_2:
    if ( !TRUEP(gensymed_symbol))
	goto end_loop_2;
	...
	gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
	if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
	    found_item = M_CDR(M_CAR(gensymed_symbol));
	    goto end_3;
	}
	gensymed_symbol = M_CDR(gensymed_symbol);
	goto next_loop_3;
  ...
  end_4:;
	...
	delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),item1,
		blocks,FIX(SXHASH_SYMBOL_1(item1) & 
		IFIX(Most_positive_fixnum)));
	temp =  !TRUEP(blocks);
	if (temp);
	else {
		...
		temp = EQ(ISVREF(ISVREF(M_CAR(gensymed_symbol),
			(SI_Long)0L),(SI_Long)0L),M_CDR(gensymed_symbol));
	    }
	    else
		temp =  !TRUEP(M_CDR(blocks));
	    if (temp);
	    else {
		scope_conses = Scope_conses;
		ab_node_stack_ = Nil;
	...
	if (temp) {
	    ...
	    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		    given_name,temp_1,FIX(SXHASH_SYMBOL_1(given_name) & 
		    IFIX(Most_positive_fixnum)));
	...
	if ( !EQ(item1,item2) ||  !EQ(given_name,other_name)) {
		...
		gensymed_symbol = CDR(blocks);
		gensymed_symbol_1 = item2;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(item2) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop_8:
		if ( !TRUEP(gensymed_symbol))
		...
		if (found_item) {
		    ...
		    set_balanced_binary_tree_entry(blocks,Qeq,Nil,T,
			    gensymed_symbol,
			    FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
			    IFIX(Most_positive_fixnum)),Nil);
		    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
			    item2,blocks,FIX(SXHASH_SYMBOL_1(item2) & 
			    IFIX(Most_positive_fixnum)));
		}
		temp =  !TRUEP(blocks);
		if (temp);
		...
		if (temp) {
		    ...
		    set_balanced_binary_tree_entry(temp_1,Qeq,Nil,T,
			    ...
			    IFIX(Most_positive_fixnum)),Nil);
		    temp_1 = other_name;
		    temp_2 = object_instances;
		    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
			    temp_1,temp_2,FIX(SXHASH_SYMBOL_1(other_name) 
			    & IFIX(Most_positive_fixnum)));
...
Object Resolving_definitional_name_conflicts_qm = UNBOUND;
    ...
    Object relation, new_name, old_name, new_name_is_inverse_p_qm;
{
    ...
    Object ab_less_than_branch_qm_, ab_node_stack__1, ab_current_node__1;
    Object ab_skip_list_p__1, ab_next_node__1, ab_tail_node__1;
    Object ab_current_alist__1, ab_entry_cons__1, related_subject_item;
    Object subject_relation_instances_qm, ab_node_stack__2, ab_current_node__2;
    Object ab_skip_list_p__2, ab_next_node__2, ab_tail_node__2;
    Object ab_current_alist__2, ab_entry_cons__2;
    Object subject_relation_instance_form, subject_relation_name;
    Object subject_relation;
    char temp;
    Declare_special(4);
    Object result;

    x_note_fn_call(105,56);
    relation_is_symmetric_p_qm = ISVREF(relation,(SI_Long)25L);
    scope_conses = Scope_conses;
    ab_loopvar_ = Nil;
    ab_loopvar__1 = Nil;
    item = Nil;
    PUSH_SPECIAL(Scope_conses,scope_conses,3);
	...
	end_loop:
	  ...
	  next_loop_2:
		...
		SVREF(relation_instance_form,FIX((SI_Long)0L)) = new_name;
		if ( !(new_name_is_inverse_p_qm || 
			...
			if (EQ(relation,subject_relation) &&  
			    ...
			    SVREF(subject_relation_instance_form,
				    FIX((SI_Long)0L)) = other_name_qm;
			goto next_loop_6;
		      end_loop_7:;
		      POP_SPECIAL();
		      goto next_loop_4;
    ...
    Object relation, new_subject_class, old_subject_class;
{
	...
	if (SYMBOLP(new_subject_class)) {
	    ...
	    gensymed_symbol_1 = new_subject_class;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(new_subject_class) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
	...
	if ( !temp_2) {
		...
		gensymed_symbol = CDR(Symbol_properties_table);
		gensymed_symbol_1 = old_subject_class;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(old_subject_class) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop_8:
		if ( !TRUEP(gensymed_symbol))
    ...
    Object relation, new_object_class, old_object_class;
{
    ...
    x_note_fn_call(105,58);
    if ( !EQ(new_object_class,Qitem) &&  !EQ(new_object_class,
	    old_object_class)) {
	if (SYMBOLP(new_object_class)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = new_object_class;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(new_object_class) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
	...
	if ( !temp_2) {
		...
		gensymed_symbol = CDR(Symbol_properties_table);
		gensymed_symbol_1 = old_object_class;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(old_object_class) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop_8:
		if ( !TRUEP(gensymed_symbol))
    ...
    Object relation, new_symmetric_flag, old_symmetric_flag;
{
	...
	if (new_symmetric_flag &&  !TRUEP(ISVREF(relation,(SI_Long)23L)) 
	    ...
	    end_loop_2:;
	      goto next_loop;
	    end_loop_1:
	      reclaim_gensym_tree_1(copy_of_relation_instances_qm);
	    POP_SPECIAL();
	    relation_name = Nil;
	    relation_subject = Nil;
	    relation_object = Nil;
...
Object Initializing_clear_text_p = UNBOUND;
...
{
    Object old_relation_instances, relation_instances, scope_conses;
    Object ab_node_stack_, ab_current_node_, ab_skip_list_form_;
    Object ab_binary_tree_form_, gensymed_symbol, temp, ab_skip_list_p_;
    Object ab_next_node_, ab_tail_node_, ab_current_alist_, ab_entry_cons_;
    Object relation_instance_form, given_name, other_name_qm;
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, object_instance_form;
    Object ab_loop_list_, name, tree, found_item, item_1;
    ...
    x_note_fn_call(105,65);
    if (Initializing_clear_text_p)
	return VALUES_1(Nil);
    old_relation_instances = ISVREF(item,(SI_Long)12L);
    if ( !TRUEP(old_relation_instances) || CONSP(old_relation_instances) 
	    &&  !EQ(CAR(old_relation_instances),Qrelation_instance_tree))
	return VALUES_1(Nil);
    if (Noting_changes_to_kb_p)
	...
	next_loop:
	  ...
	  if ( !TRUEP(relation_instance_form));
		...
		if (object_instances_qm) {
			...
			gensymed_symbol = CDR(object_instances_qm);
			gensymed_symbol_1 = other_name_qm;
			gensymed_symbol_2 = SXHASH_SYMBOL_1(other_name_qm) 
				& IFIX(Most_positive_fixnum);
			gensymed_symbol_3 = (SI_Long)0L;
		      next_loop_6:
			if ( !TRUEP(gensymed_symbol))
			...
			temp = Qnil;
		      end_3:;
			object_instance_forms = gensym_cons_1(temp,Nil);
		    }
		}
		else
		    object_instance_forms = Nil;
		...
		if ( !temp_1 ?  !EQ(item2,item) :  !EQ(item2,item) ||  
		  ...
		  next_loop_8:
			...
			gensymed_symbol_2 = SXHASH_SYMBOL_1(item) & 
				IFIX(Most_positive_fixnum);
			gensymed_symbol_3 = (SI_Long)0L;
		      next_loop_9:
			if ( !TRUEP(gensymed_symbol))
			...
			if ( !TRUEP(found_item));
			    ...
			    set_balanced_binary_tree_entry(tree,Qeq,Nil,T,
				    gensymed_symbol,
				    FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
				    IFIX(Most_positive_fixnum)),Nil);
			    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
				    item,tree,FIX(SXHASH_SYMBOL_1(item) & 
				    IFIX(Most_positive_fixnum)));
			    temp_1 =  !TRUEP(tree);
			    if (temp_1);
			    else {
		...
		goto next_loop_2;
	      ...
	      POP_SPECIAL();
	      gensymed_symbol = given_name;
	      set_balanced_binary_tree_entry(relation_instances,Qeq,Nil,T,
		      gensymed_symbol,FIX(SXHASH_SYMBOL_1(gensymed_symbol) 
		      & IFIX(Most_positive_fixnum)),Nil);
	      deleted_names = gensym_cons_1(given_name,deleted_names);
	  ...
	  if (deleted_names) {
	    ...
	    next_loop_14:
	      ...
	      delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),temp,
		      relation_instances,FIX(SXHASH_SYMBOL_1(name) & 
		      IFIX(Most_positive_fixnum)));
	      goto next_loop_14;
	    end_loop_14:;
...
{
    Object scope_conses, ab_loopvar_, ab_loopvar__1, item;
    Object old_relation_instances;
    char temp;
    Declare_special(1);
    Object result;

    x_note_fn_call(105,67);
	...
	next_loop:
	  ...
	  ab_loopvar__1 = ISVREF(ab_loopvar__1,(SI_Long)6L);
	  old_relation_instances = ISVREF(item,(SI_Long)12L);
	  if ( !( !TRUEP(old_relation_instances) || 
		  CONSP(old_relation_instances) &&  
		  !EQ(CAR(old_relation_instances),Qrelation_instance_tree)))
...
{
    Object relation_instances, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, relation_instance_form, other_name, scope_conses;
    Object ab_node_stack_, ab_current_node_, ab_skip_list_form_;
    Object ab_binary_tree_form_, temp, ab_skip_list_p_, ab_next_node_;
    Object ab_tail_node_, ab_current_alist_, ab_entry_cons_, item2;
    Object subject_instances, subject_instance_form, ab_less_than_branch_qm_;
    Object tree, found_item, ab_node_stack__1, ab_current_node__1;
    Object ab_skip_list_p__1, ab_next_node__1, ab_tail_node__1;
    Object ab_current_alist__1, ab_entry_cons__1, item_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;
    Declare_special(2);

    x_note_fn_call(105,68);
    relation_instances = ISVREF(item,(SI_Long)12L);
    if (relation_instances) {
	gensymed_symbol = CDR(relation_instances);
	gensymed_symbol_1 = relation_name;
	...
	if (gensymed_symbol_2 < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
	    if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
		relation_instance_form = M_CDR(M_CAR(gensymed_symbol));
		goto end_1;
	    }
	    gensymed_symbol = M_CDR(gensymed_symbol);
	    goto next_loop_1;
	  end_loop_1:
	    relation_instance_form = Qnil;
	  end_1:;
	    goto end_2;
	}
	goto next_loop;
	...
	if (relation_instance_form) {
		...
		gensymed_symbol = relation_name;
		set_balanced_binary_tree_entry(relation_instances,Qeq,Nil,
			T,gensymed_symbol,
			FIX(SXHASH_SYMBOL_1(gensymed_symbol) & 
			IFIX(Most_positive_fixnum)),Nil);
		delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
			relation_name,relation_instances,
    ...
    Object block, relation_instance;
{
    ...
    Object ab_less_than_branch_qm_, relation_instances, gensymed_symbol_4;
    Object gensymed_symbol_5, relation_instance_form, the_block, blocks;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    Declare_special(1);
	...
	if (class_of_block_qm) {
	    ...
	    next_loop:
		  ...
		  if (relation_instances) {
		      gensymed_symbol = CDR(relation_instances);
		      gensymed_symbol_4 = relation_instance_name;
		      gensymed_symbol_1 = 
		    ...
		    end_2:;
			  ...
			  gensymed_symbol = CDR(blocks);
			  gensymed_symbol_4 = the_block;
			  gensymed_symbol_1 = SXHASH_SYMBOL_1(the_block) & 
				  IFIX(Most_positive_fixnum);
			  gensymed_symbol_2 = (SI_Long)0L;
			next_loop_4:
			  if ( !TRUEP(gensymed_symbol))
	...
	if (temp) {
	    ...
	    next_loop_6:
		  ...
		  if (relation_instances) {
		      gensymed_symbol = CDR(relation_instances);
		      gensymed_symbol_4 = other_name;
		      gensymed_symbol_1 = SXHASH_SYMBOL_1(other_name) & 
			      IFIX(Most_positive_fixnum);
		      gensymed_symbol_2 = (SI_Long)0L;
		    next_loop_8:
		      if ( !TRUEP(gensymed_symbol))
    ...
    Object item;
{
    ...
    Object relation_instances, gensymed_symbol_4, gensymed_symbol_5, the_block;
    Object blocks, sublist;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(105,73);
    copy_of_relation_instances_qm = 
...
void relations_INIT()
{
    ...
    Object Qrelation_instance_count, Qchain_of_available_relation_instances;
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83mIy1m83mIy8k1l8k0000001o1m83*gy9k1m83=ey3-Wy1n8y83-5Qy1n83-Bby83-Bcy83-Bay1m83My83-B-yknk0k0");
    ...
    Qrelation_instance_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83mIy8s83-kiy09k9l");
    clear_optimized_constants();
    ...
    string_constant_30 = 
	    STATIC_STRING("z8r83Spy83Spy837Ky837Ky00001p1l8l1l8o1m8p83Ehy1l83Uy1m83Dy53aytype = (or symbol none), writable = true000004z8r83d+y83d+y837Ky83");
    string_constant_31 = 
	    STATIC_STRING("7Ky083Day001o1l8l1l8o1m8p83EDy1m83Dy53-*ytype = (member one-to-one, one-to-many, many-to-one, many-to-many)000004z8r83Yqy83Yqy83");
    string_constant_32 = 
    ...
    string_constant_33 = 
	    STATIC_STRING("p83Ky1l8z1m83Dy53Rywritable = true, type = boolean000004z8r83Yry83Yry837Ky837Ky00001q1l8l1l83Ey1l83Fy1l83-3y1m8p83Yry1m83Dy53Ryw");
    string_constant_34 = 
	    STATIC_STRING("ritable = false, type = string000004z8r83Zry83Zry837Ky837Ky00001m1l8l1l8o000004z8r8u8u837Ky837Ky01p8w9k3uy3ay1l1v83Jy1mzk1mzz1m3");
    string_constant_35 = 
    ...
    string_constant_40 = 
	    STATIC_STRING("permitted.1r83Spy08l8o1m8p83Ehy83Uy1m83Dy53aytype = (or symbol none), writable = true1q83d+y83Day8l8o1m8p83EDy1m83Dy53-*ytype = ");
    string_constant_41 = 
	    STATIC_STRING("(member one-to-one, one-to-many, many-to-one, many-to-many)1p83Yqy08o1m8p83Eiy1m83Dy53bywritable = true, type = (or none boolean");
    string_constant_42 = 
	    STATIC_STRING(")1r83Egy08l8z1m8p83Ky8z1m83Dy53Rywritable = true, type = boolean1s83Yry08l83Ey83Fy83-3y1m8p83Yry1m83Dy53Rywritable = false, type");
    string_constant_43 = 
	    STATIC_STRING(" = string1o83Zry08l8o1n8u1p8w9k3uy3ay1l1v83Jy1mzk1mzz1m3fyz1m3fyk1m3uy3Gy1m3fy3ay1m3fy3Ly1mz3Ly1mz3ay1mk3Gy1m83Dy53*MyShould we ");
    string_constant_44 = 
    ...
    mutate_global_property(Qrelation_name_qm,Nil,
	    Quse_slot_value_compiler_for_default_overrides_p);
    string_constant_46 = 
	    STATIC_STRING("1r1m83EDy1m9k83-gjy1m83EDy1m9k83-giy1m83EDy1m9k83-ciy1m83EDy1m9k83Day1m83Ehy834Uy1m83Ehy1m9k83Zy1m83Eiy83Ky");
    clear_optimized_constants();
