...
Object Time_of_frame_edit_base_time = UNBOUND;

Object Text_time_stamp_seconds = UNBOUND;
    ...
    Object frame_edit_timestamp;
{
	...
	result = gensym_cons_1(gensymed_symbol,Qab_structure);
    }
    POP_LOCAL_ALLOCATION(0,0);
    return result;
}
...
Object Do_not_update_frame_authors_qm = UNBOUND;
    ...
    Object last_edit_timestamp;
{
    ...
    new_entry = gensym_cons_1(author_qm,last_edit_timestamp);
    ...
    new_value =  
	    ...
	    author_qm)) ? new_entry : gensym_cons_1(new_entry,
...
Object Fixup_authors_to_skip = UNBOUND;
    ...
    Object author_or_authors;
{
	...
	if ( !TRUEP(author) &&  !TRUEP(timestamp) &&  
		...
		if (temp);
		    ...
		    temp = Qunknown;
		temp = gensym_cons_1(temp,timestamp);
	    }
	    else {
		temp = author;
		if (temp);
    ...
    Object author_or_authors;
{
	...
	if (previous_author_or_authors) {
	    ...
	    temp = Nil;
	return gensym_cons_1(author,temp);
    }
}
...
{
    Object svref_arg_1, new_last_cons, svref_new_value;
    ...
    Object scrapbook;
{
    ...
    Object next_queue_element, sub_class_bit_vector, gensymed_symbol_4;
  ...
  next_loop:
	...
	goto end_loop;
    subblock = ISVREF(queue_element,(SI_Long)2L);
	...
	if (temp) {
	    ...
	    gensymed_symbol_4 = ISVREF(queue_element,(SI_Long)1L);
	    SVREF(gensymed_symbol_4,FIX((SI_Long)0L)) = gensymed_symbol;
	    SVREF(gensymed_symbol,FIX((SI_Long)1L)) = gensymed_symbol_4;
...
Object Chain_of_available_text_inserter_spots = UNBOUND;

Object Text_inserter_spot_count = UNBOUND;
    ...
    Object text_inserter_spot;
{
    ...
    svref_new_value = Chain_of_available_text_inserter_spots;
    SVREF(text_inserter_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_text_inserter_spots = text_inserter_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_text_inserter_spot_structure_internal()
{
    ...
    Object text_inserter_spot_count_new_value;
    Object defstruct_g2_text_inserter_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(127,29);
    def_structure_text_inserter_spot_variable = Nil;
    text_inserter_spot_count_new_value = FIXNUM_ADD1(Text_inserter_spot_count);
    Text_inserter_spot_count = text_inserter_spot_count_new_value;
    ...
    Object text_string_as_evaluation_value, g2_window_as_evaluation_value;
{
	...
	temp_1 = gensym_cons_1(value_1,Qtruth_value);
...
Object check_kanji_code_entry_text varargs_1(int, n)
{
    ...
    Object gensym_character_code, text_string_to_insert;
    SI_Long code_digit_length, first_char, start_index, i, ab_loop_bind_, row;
	  ...
	  end_loop_1:
		...
		PUSH_SPECIAL(Current_edit_state,current_edit_state,2);
		  current_edit_workspace = ISVREF(Current_edit_state,
			  (SI_Long)12L);
		  PUSH_SPECIAL(Current_edit_workspace,current_edit_workspace,
			  1);
			...
			PUSH_SPECIAL(Han_interpretation_mode,han_interpretation_mode,
				0);
			  if (EQ(other_script_case_qm,Qunicode))
				  ...
				  if ( !(unicode_full_row == 
				      ...
				      gensymed_symbol_1 = unicode_full_row 
					      << (SI_Long)8L;
    ...
    Object edit_state;
{
    ...
    x_note_fn_call(127,65);
    gensymed_symbol = ISVREF(ISVREF(edit_state,(SI_Long)13L),(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
    ab_queue_form_ = gensymed_symbol;
    ab_next_queue_element_ = Nil;
...
Object parse_text_for_slot varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	  ...
	  result = change_slot_description_value_function(frame,
		  slot_description,gensym_cons_1(No_value,text),Nil,Nil);
	POP_SPECIAL();
	return result;
    }
    else {
	...
	PUSH_SPECIAL(Current_workstation,current_workstation_1,14);
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
				...
				PUSH_SPECIAL(Keep_edit_workspace_hidden_no_matter_what_qm,keep_edit_workspace_hidden_no_matter_what_qm,
				  ...
				  enter_editing_context(21,frame,
					  ...
					  ISVREF(frame,(SI_Long)1L)),text,
					  T,Nil,Nil,Nil,Nil,Nil,Nil,Nil,
					  Nil,Nil,Nil,Nil,Nil,Nil,T,T,
					  slot_component_name_qm,
					  slot_component_indicator_qm);
				  current_edit_state = 
					  Specific_structure_for_current_workstation_context;
				  PUSH_SPECIAL(Current_edit_state,current_edit_state,
					  1);
				    ...
				    PUSH_SPECIAL(Current_edit_workspace,current_edit_workspace,
					    0);
				      svref_arg_1 = Current_edit_state;
				      SVREF(svref_arg_1,FIX((SI_Long)57L)) 
					      = runtime_change_qm;
				    POP_SPECIAL();
				  POP_SPECIAL();
				  editing_context = 
    ...
    Object frame;
{
    ...
    x_note_fn_call(127,72);
    if (Servicing_workstation_qm)
	return recompile_item_1(frame);
    else {
    ...
    Object frame;
{
    ...
    x_note_fn_call(127,73);
    in_recompile_item_p = T;
    PUSH_SPECIAL(In_recompile_item_p,in_recompile_item_p,0);
...
Object find_position_in_text_given_image_plane varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Current_image_plane,current_image_plane,28);
      ...
      PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,27);
	PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,26);
	  PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,25);
	    PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,24);
		...
		PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			22);
		  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,21);
...
Object make_subcommand_menu varargs_1(int, n)
{
  ...
  next_loop:
    ...
    PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
	    0);
      translation_qm = translation_for_symbol_qm(1,subcommand_symbol);
    POP_SPECIAL();
  ...
  next_loop_1:
    ...
    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(cell,Nil),Nil);
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
    ...
    Object row_index, column_index;
{
	...
	if (first_icon_cell_subblock_qm) {
	    sub_class_bit_vector = 
		    ISVREF(ISVREF(first_icon_cell_subblock_qm,(SI_Long)1L),
		    (SI_Long)19L);
	    superior_class_bit_number = 
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    return indicate_editor_subcommand_button_pending_state(first_icon_cell_subblock_qm,
...
Object Chain_of_available_subcommand_states = UNBOUND;

Object Subcommand_state_count = UNBOUND;
    ...
    Object subcommand_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_subcommand_states;
    SVREF(subcommand_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_subcommand_states = subcommand_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_subcommand_state_structure_internal()
{
    ...
    Object subcommand_state_count_new_value;
    Object defstruct_g2_subcommand_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(127,91);
    def_structure_subcommand_state_variable = Nil;
    subcommand_state_count_new_value = FIXNUM_ADD1(Subcommand_state_count);
    Subcommand_state_count = subcommand_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_subcommand_state_variable, svref_new_value;

    x_note_fn_call(127,92);
    def_structure_subcommand_state_variable = 
	    Chain_of_available_subcommand_states;
    ...
    SVREF(def_structure_subcommand_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_subcommand_state_variable);
}
    ...
    Object choice_symbol_list;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(translate_subcommand_menu_choice_as_appropriate(choice,
    ...
    Object choice, language;
{
    ...
    PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
	    0);
      result = translation_for_symbol_qm(2,choice,language);
    POP_SPECIAL();
    return result;
}
    ...
    Object choice, language_qm;
{
	...
	return gensym_cons_1(choice,temp);
    }
    else
...
Object Kfep_search_limit_1 = UNBOUND;

Object Kfep_search_limit_2 = UNBOUND;
    ...
    Object kfep_conversion_choices;
{
  ...
  next_loop_1:
	...
	goto end_loop;
    ab_loop_repeat_ = ab_loop_repeat_ - (SI_Long)1L;
    ab_loopvar__3 = gensym_cons_1(make_text_cell(2,
  ...
  end_loop:
    ...
    temp_1 = Qnil;
  end_1:;
    ab_loopvar__1 = gensym_cons_1(temp_1,Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
...
Object Trace_parsing_context_p = UNBOUND;

Object Trace_parsing_context_tokenizing_p = UNBOUND;

Object The_type_description_of_parsing_token = UNBOUND;

Object Chain_of_available_parsing_tokens = UNBOUND;

Object Parsing_token_count = UNBOUND;
    ...
    Object parsing_token;
{
    ...
    x_note_fn_call(127,135);
    inline_note_reclaim_cons(parsing_token,Nil);
    svref_new_value = Chain_of_available_parsing_tokens;
    SVREF(parsing_token,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_parsing_tokens = parsing_token;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_parsing_token_variable, parsing_token_count_new_value;
    Object defstruct_g2_parsing_token_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(127,137);
    def_structure_parsing_token_variable = Nil;
    parsing_token_count_new_value = FIXNUM_ADD1(Parsing_token_count);
    Parsing_token_count = parsing_token_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Current_parsing_context_text = UNBOUND;

Object Current_parsing_context_text_length = UNBOUND;

Object Current_parsing_context_line = UNBOUND;

Object Current_parsing_context_character = UNBOUND;

Object The_type_description_of_parsing_context = UNBOUND;

Object Chain_of_available_parsing_contexts = UNBOUND;

Object Parsing_context_count = UNBOUND;
    ...
    Object parsing_context;
{
    ...
    reclaim_chain_of_incomplete_phrases(ISVREF(parsing_context,(SI_Long)36L));
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_parsing_contexts;
    SVREF(parsing_context,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_parsing_contexts = parsing_context;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_parsing_context_variable, temp;
    Object defstruct_g2_parsing_context_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(127,144);
    def_structure_parsing_context_variable = Nil;
    temp = FIXNUM_ADD1(Parsing_context_count);
    Parsing_context_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_parsing_contexts;
...
{
    Object def_structure_parsing_context_variable, svref_new_value;

    x_note_fn_call(127,145);
    def_structure_parsing_context_variable = 
	    Chain_of_available_parsing_contexts;
    ...
    svref_new_value = copy_of_current_frame_serial_number_function();
    SVREF(def_structure_parsing_context_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    ...
    SVREF(def_structure_parsing_context_variable,FIX((SI_Long)62L)) = 
	    svref_new_value;
    svref_new_value = make_hfep_hanc_type_function();
    SVREF(def_structure_parsing_context_variable,FIX((SI_Long)63L)) = 
	    svref_new_value;
    ...
    Object pc, string_1;
{
    ...
    x_note_fn_call(127,163);
    current_edit_state = pc;
    PUSH_SPECIAL(Current_edit_state,current_edit_state,5);
	  ...
	  reclaim_text_string(string_to_tokenize);
      ...
      current_parsing_context_text = gensym_cons_1(string_to_tokenize,Nil);
      PUSH_SPECIAL(Current_parsing_context_text,current_parsing_context_text,
	      3);
	current_parsing_context_text_length = text_start_index;
	PUSH_SPECIAL(Current_parsing_context_text_length,current_parsing_context_text_length,
		2);
	  current_parsing_context_line = FIX((SI_Long)1L);
	  PUSH_SPECIAL(Current_parsing_context_line,current_parsing_context_line,
		  1);
	    ...
	    PUSH_SPECIAL(Current_parsing_context_character,current_parsing_context_character,
		    0);
	      ...
	      svref_new_value = FIXNUM_ADD(ISVREF(pc,(SI_Long)108L),
		      incff_1_arg);
	      SVREF(pc,FIX((SI_Long)108L)) = svref_new_value;
	      reclaim_gensym_cons_1(Current_parsing_context_text);
	      reclaim_text_string(string_to_tokenize);
	      if ( !(ISVREF(pc,(SI_Long)103L) && 
    ...
    Object parsing_token;
{
	...
	prompts = gensym_cons_1(temp,prompts);
	goto next_loop;
      end_loop:
...
void edit2_INIT()
{
    ...
    Object Qparsing_context_count, Qchain_of_available_parsing_contexts;
    ...
    Object Qparsing_token_structure_memory_usage, Qparsing_token_count;
    Object Qchain_of_available_parsing_tokens, string_constant_86;
    ...
    Object Qsubcommand_state_structure_memory_usage, Qsubcommand_state_count;
    Object Qchain_of_available_subcommand_states, string_constant_68;
    ...
    Object Qtext_inserter_spot_structure_memory_usage;
    Object Qtext_inserter_spot_count, Qchain_of_available_text_inserter_spots;
    Object string_constant_47, string_constant_46, string_constant_45;
    Object list_constant_6, string_constant_41, string_constant_44;
    Object string_constant_43, string_constant_42, string_constant_40;
    Object string_constant_39, string_constant_38, string_constant_37;
    Object Qtext_inserter, string_constant_36, list_constant_5;
    Object string_constant_35, string_constant_34, string_constant_33;
    Object string_constant_32, Qitem, string_constant_31, string_constant_30;
    Object string_constant_29, string_constant_28, string_constant_27;
    Object list_constant_4, string_constant_26, string_constant_25;
    Object string_constant_24, string_constant_23, string_constant_22;
    Object string_constant_21, Qtext_box, Qlight_gray, float_constant_1;
    Object float_constant;

    x_note_fn_call(127,181);
    SET_PACKAGE("AB");
    ...
    string_constant_21 = 
	    STATIC_STRING("1p4z8r83ry83ry839vy839vy00001o1l8l1n8p83-ey83Gy1l8o1l83-3y000004z8r83xy83xy839vy839vy083Zpy001n1l8l1m83Dy73-9y3-1y3-qy3-iy3-hy3-");
    string_constant_22 = 
    ...
    string_constant_27 = 
	    STATIC_STRING("1r8q1m839vy1l83-ly1n83ry01n8p83-ey83Gy1n83xy83Zpy1m83Dy73-9y3-1y3-qy3-iy3-hy3-ky3-my3Sy3-my3-Xy3-qy3-my3fy3-Yy3-hy3-ky3-fy3-Ty3-");
    string_constant_28 = 
    ...
    string_constant_37 = STATIC_STRING("1l1m8v83eXy");
    string_constant_38 = STATIC_STRING("1m8q1n83eXy1l832Ry1m8v83eXy");
    ...
    string_constant_46 = 
	    STATIC_STRING("43Dy8m83npy1o83npy83Qy8n8k1l83Qy0000001l1m8x83Qykqk0k0");
    ...
    Qtext_inserter_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_47 = STATIC_STRING("1q83npy8s83-qxy09k9l");
    ...
    string_constant_55 = 
	    STATIC_STRING("1n4z8r83b5y83b5y9k9k00001n1l8l1l8o1l83Fy000004z8r83b4y83b4y9k9k00001n1l8l1l8o1l83Fy000004z8r83b3y83b3y9k9k00001n1l8l1l8o1l83Fy00");
    string_constant_56 = STATIC_STRING("000");
    string_constant_57 = 
	    STATIC_STRING("1p8q1m9k1l9l1p83b5y08l8o83Fy1p83b4y08l8o83Fy1p83b3y08l8o83Fy");
    temp = regenerate_optimized_constant(string_constant_20);
    clear_optimized_constants();
    ...
    string_constant_58 = 
	    STATIC_STRING("13Ly83-My83*Ky83*2y83-Ny83fy83byl83ayo83Wyl83cyo83ny1l83-uy83ty3Iy83sy3Dy83uyk83wy83-dy83iy32Cy");
    ...
    string_constant_59 = 
	    STATIC_STRING("13Ly83-My83*Ky83*2y83-Ny83fy83byl83ayn83Wyl83cyn83ny1l83-ry83ty3Dy83syz83uym83wy83-dy83iy31Qy");
    ...
    Qextra_large_subcommand_menu_item_format = 
	    ...
	    AB_package);
    string_constant_60 = 
	    STATIC_STRING("13Ry83-My83*Ky83*2y83-Ny83fy83-7y3V+y83*3y3O+y83*+y3-G+y83byl83ayo83Wyl83cyo83ny1l8311y83ty3Oy83sy3Hy83uyk83wy83-dy83iy32Cy");
    ...
    string_constant_61 = 
	    STATIC_STRING("13Hy83*oy83=wy832py836Ky832py836Jy832py832Py832py8308ym830Aym8309ym8307ym83=Dyl83=Nyl");
    ...
    string_constant_62 = 
	    STATIC_STRING("13Ly83-My83*Ky83*2y83-Ny83fy83byr83ayn83Wyr83cyn83ny1l83-uy83ty3Gy83syz83uyk83wy83-dy83iy32Cy");
    ...
    string_constant_63 = 
	    STATIC_STRING("13Ny83-My83*Ky83*2y83-Ny83fy83byq83aym83aym83Wyq83cym83ny1l83-ry83tyz83syx83uym83wy83-dy83iy31Qy");
    ...
    Qtoken_menu_item_format = STATIC_SYMBOL("TOKEN-MENU-ITEM-FORMAT",
	    AB_package);
    string_constant_64 = 
	    STATIC_STRING("13Jy83-My83byr83ayn83Wyr83cyn83ny1l83-uy83ty3Gy83syz83uyk83wy83-dy83iy32Cy832cy3uy");
    ...
    string_constant_65 = 
	    STATIC_STRING("13Hy83-My83byq83aym83Wyq83cym83ny1l83-ry83tyz83syx83uym83wy83-dy83iy31Qy");
    ...
    string_constant_66 = 
	    STATIC_STRING("1z83*oy83=wy83*2y83=Dyk83=Nyk8308yk830Ayk8309yk8307yk");
    ...
    string_constant_67 = 
	    STATIC_STRING("43Dy8m83nZy1o83nZy83-Sy8n8k1l83-Sy0000001m1n8y83-61y1n83-E-y83-Day83-CZy1m8x83-Sykqk0k0");
    ...
    Qsubcommand_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_68 = STATIC_STRING("1q83nZy8s83-ppy09k9l");
    clear_optimized_constants();
    ...
    string_constant_70 = 
	    STATIC_STRING("1n13Ky8378y2l83-LRy+3Cy3=*ay3==3y3=*Vy3=*xy30qfy32fUykkkkkkkkq3A++y2l83dSy+3Cy32F9y30vOy31BIy3=*6y32o4y3=-Jykkkkkkkkq3A++y2l83m9");
    string_constant_71 = 
	    STATIC_STRING("y+s32F9y30vOy3129y31gRy34T8ykp3A++y2l9k+3Cy3=*ay3==3y3=*Vy3=*xy33n*y30s2ykkkkkkkkq3A++y2l837cy+s32Nmy32Iiykkkkm3A++y2l83gXy+s3=*");
    string_constant_72 = 
	    STATIC_STRING("dy3===y3==4ykkkn3A++y2l83Ipy+s3=*ly3==Gy3==uykkkn3A++y2l83lXy+s3==My3==uy3=*ry3==4ykko3A++y2l9l+s3156y35LWykkkkm3A++y2l83-=ey+s3");
    string_constant_73 = 
	    STATIC_STRING("28xy311Xykkkkm3A++y2l83*qy+s33Zty317Hykkkkm3A++y2l83-PTy+3Cy3=*dy3===y3==4y3Bu2y328xy311Xykkkkkkkkq3A++y2l83-asy+s32uUy31fJykkkk");
    string_constant_74 = 
	    STATIC_STRING("m3A++y2l83-auy+s3=*dy3=*xy3=*dy3==6ykko3A++y2l83-XQy+s3=-ky3=*5y3=-8y3=-cykko3A++y2l83vdy+s347jy34cQykkkkm3A++y2l83-OZy+s31W5y32");
    string_constant_75 = 
	    STATIC_STRING("BNykkkkm3A++y2l837Fy+s32eTy31+Ly34VOykkkn3A++y2l83-iQy+s3159y31+Ly34VOykkkn3A++y2l83-ocy+s3=*ry3=*fy3===y3==Jykko3A++y2l83-J5y+s");
    string_constant_76 = 
	    STATIC_STRING("3=*Uy3=*hy3=*ty3==Jy3==4ykp3A++y2l83-T4y+3Cy31W5y32BNy33h0y31Nky327Ty31unykkkkkkkkq3A++y2l83-nqy+3Cy31W5y32BNy33h0y31Nky33qgy31i");
    string_constant_77 = 
	    STATIC_STRING("Bykkkkkkkkq3A++y1z83kIy2l83-LRy+s38pay3828ykkkkm3A++y2l83dSy+s37lny36neykkkkm3A++y2l83m9y+s38Qey387Oy37B0ykkkn3A++y2l9k+s37-Pykk");
    string_constant_78 = 
	    STATIC_STRING("kkkl3A++y2l837cy+s384Ky38SHykkkkm3A++y2l83gXy+s38KWy37SWy37DCy36qiykko3A++y2l83Ipy+s37kSy37-uy36qiykkkn3A++y2l83lXy+s37oLy38Pmy3");
    string_constant_79 = 
	    STATIC_STRING("6qiykkkn3A++y2l9l+s38Z+y38Miy36qiykkkn3A++y2l83-=ey+s37-uy38Miy36qiykkkn3A++y2l83*qy+3Cy3988y37*my38Imy3Sy38Kgy36qiy36qiykkkkkkk");
    string_constant_80 = 
	    STATIC_STRING("r3A++y2l83-PTy+3Cy386Wy39-ey37Qby39HKy37bmy380Oy3Sy37-uy38N8y370Vy36qiykkkv3A++y2l83vdy+s38K-y37eqykkkkm3A++y2l83-X*y+s39HOy36q+");
    string_constant_81 = 
	    STATIC_STRING("ykkkkm3A++y1t83-CBy2l83-LRy+3Cy3CQy3D*y3Cuy3Cny3Cvy3Cqy3D*y3D8ykkkkkks3A++y2l9k+3Cy3CJy3Ciy3Csy3Cwy3Cvy3D3y3Cqy3D*y3D8ykkkkkt3A+");
    string_constant_82 = 
	    STATIC_STRING("+y2l83lXy+3Cy3CEy3D-y3D*y3Ciy3Cky3Cqy3D*y3D8ykkkkkks3A++y2l83m9y+3Cy3CEy3Cwy3D-y3D-y3D*y3Ciy3Cvy3Cwy3Cky3Cqy3D*y3D8ykkw3A++y2l83");
    string_constant_83 = 
	    STATIC_STRING("dSy+s3CQy3D*y3Csy3Ciy3D*ykp3A++y2l837cy+3Cy3CQy3Cjy3Cvy3Cwy3Cky3Cqy3D*y3D8ykkkkkks3A++y2l83vdy+3Cy3CCy3Cvy3Cly3Cty3Cqy3Cry3D-y3C");
    string_constant_84 = 
	    STATIC_STRING("sy3Cqy3Crykkkku3A++y2l83-PZy+3Cy3CMy3Cqy3D+y3Cqy3Cty3Cty3Cqy3D2y3Ciykkkkkt3A++y");
    clear_optimized_constants();
    ...
    string_constant_85 = 
	    STATIC_STRING("43Dy8m83lVy1n83lVy8n8k1l8n0000000kxk0k0");
    ...
    string_constant_86 = STATIC_STRING("1q83lVy8s83-hOy09k9l");
    clear_optimized_constants();
    ...
    string_constant_87 = 
	    STATIC_STRING("43Dy8m83lUy1p83lUy83Bsy83-Sy8n8k1l83Bsy0000001m1m8x83Bsy1m83My83-Alyk3-hyk0k0");
    ...
    string_constant_88 = STATIC_STRING("1q83lUy8s83-hNy09k9l");
    clear_optimized_constants();
