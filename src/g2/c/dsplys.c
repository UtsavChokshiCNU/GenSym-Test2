    ...
    Object dial_marking_label;
{
    ...
    if ( !((SI_Long)0L != (IFIX(ISVREF(dial_marking_label,(SI_Long)5L)) & 
	    (SI_Long)2048L))) {
	gensymed_symbol = ISVREF(dial_marking_label,(SI_Long)14L);
    ...
    Object ruling_for_dial_qm, dial;
{
	...
	if (EQ(ab_next_queue_element_,ab_queue_form_))
	    goto end_loop;
	dial_marking_label = ISVREF(ab_next_queue_element_,(SI_Long)2L);
...
Object Do_not_update_simulated_value_qm = UNBOUND;
    ...
    Object dial;
{
    ...
    Object gensymed_symbol_4, svref_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    ...
    Object pointer_for_dial;
{
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	  ...
	  end_loop_1:;
	    ...
	    result = reclaim_gensym_tree_1(list_of_points_for_pointer);
	}
	POP_LOCAL_ALLOCATION(0,0);
	return result;
    }
    ...
    Object ruling_for_meter_qm, meter;
{
	...
	gensymed_symbol = ISVREF(ruling_for_meter,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)4L) : Nil;
	ab_queue_form_ = gensymed_symbol;
	ab_next_queue_element_ = Nil;
	...
	if (EQ(ab_next_queue_element_,ab_queue_form_))
	    goto end_loop;
	meter_marking_label = ISVREF(ab_next_queue_element_,(SI_Long)2L);
	ab_next_queue_element_ = ISVREF(ab_next_queue_element_,(SI_Long)0L);
    ...
    Object marker_for_meter;
{
    ...
    SAVE_STACK();
    gensymed_symbol = ISVREF(marker_for_meter,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)5L) : Nil;
...
{
    Object readout_table, format_name, readout_table_format, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, sub_class_bit_vector, svref_new_value;
    ...
    gensymed_symbol_1 = readout_table_class;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(readout_table_class) & 
  ...
  end_4:;
	...
	svref_new_value = gensym_cons_1(gensym_list_2(Nil,
		make_initial_readout_table_value_text(readout_table)),Nil);
	SVREF(readout_table,FIX((SI_Long)19L)) = svref_new_value;
    }
    else {
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(readout_table,Qtable_rows);
	temp_1 = make_initial_readout_table_expression_text(readout_table);
	svref_new_value = gensym_cons_1(gensym_list_2(temp_1,
		make_initial_readout_table_value_text(readout_table)),Nil);
	SVREF(readout_table,FIX((SI_Long)19L)) = svref_new_value;
    }
    ...
    Object digital_clock;
{
    ...
    Object future_task_schedule_modify_arg_4, thing;
	...
	future_task_schedule_modify_arg_2 = 
		get_lookup_slot_value(digital_clock,Qdisplay_update_priority);
	...
	if (FIXNUMP(get_lookup_slot_value(digital_clock,
		...
		future_task_schedule_modify_arg_4 = float_constant_2;
	}
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qupdate_display_for_digital_clock);
	future_task_schedule_modify_arg_11 = digital_clock;
	schedule_task_qm = ISVREF(digital_clock,(SI_Long)20L);
	if (schedule_task_qm) {
	...
	temp = ISVREF(task,(SI_Long)1L);
	aref_new_value = 
		DOUBLE_FLOAT_TO_DOUBLE(future_task_schedule_modify_arg_4);
    ...
    Object digital_clock;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, variable, ab_loop_list_;
    Object pruned_interest_list, gensym_list, last_1, next_qm, frame;
    ...
    temp = Nil;
    ISVREF(digital_clock,(SI_Long)20L) = temp;
    schedule_task_qm = ISVREF(digital_clock,(SI_Long)21L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    temp = Nil;
    ISVREF(digital_clock,(SI_Long)21L) = temp;
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    pruned_interest_list = delete_gensym_element_1(digital_clock,
    ...
    goto next_loop;
  end_loop:;
    gensym_list = get_lookup_slot_value_given_default(digital_clock,
	    Qthings_this_display_is_interested_in,Nil);
    if (gensym_list) {
	last_1 = gensym_list;
	next_qm = Nil;
...
Object Current_computation_slot_component_group = UNBOUND;
...
Object update_cell_based_display_computation_style varargs_1(int, n)
{
    ...
    Object gensymed_symbol_3, current_computation_frame;
	...
	PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	  ...
	  if ( !TRUEP(current_flag_state_qm)) {
	      ...
	      svref_new_value = IFIX(ISVREF(display_frame,(SI_Long)5L)) | 
		      (SI_Long)16777216L;
	  ...
	  PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
		  4);
	    PUSH_SPECIAL(Current_computation_style,current_computation_style,
		    3);
...
{
    Object temp, type_name, x2, sub_class_bit_vector, schedule_task_qm;
    Object current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8;
    Object current_task_schedule_modify_arg_10;
    ...
    Object gensymed_symbol_3, def_structure_queue_element_variable;
	...
	temp = delete_gensym_element_1(variable,ISVREF(thing,(SI_Long)17L));
	...
	if (SIMPLE_VECTOR_P(thing)) {
	    ...
	    temp_1 = TRUEP(Nil);
	if (temp_1) {
	    temp = delete_gensym_element_1(variable,ISVREF(thing,
		    (SI_Long)14L));
		...
		Qg2_defstruct_structure_name_inference_background_collection_g2_struct)) 
		    {
	    temp = delete_gensym_element_1(variable,ISVREF(thing,(SI_Long)4L));
		...
		if (temp_1) {
			...
			set_non_savable_lookup_slot_value(thing,
				...
				delete_gensym_element_1(variable,
			...
			if ( !(schedule_task_qm && 
			    ...
			    SVREF(task,FIX((SI_Long)12L)) = 
				    current_task_schedule_modify_arg_12;
			    ctask =  !TRUEP(ISVREF(task,(SI_Long)3L)) ? T :
				     Nil;
			    if (ctask);
			    else
			    ...
			    return VALUES_1(ISVREF(thing,(SI_Long)21L) = task);
			}
			else
			    return VALUES_1(Nil);
		    }
    ...
    Object thing, variable;
{
    ...
    if (SIMPLE_VECTOR_P(thing) && EQ(ISVREF(thing,(SI_Long)0L),
	    Qg2_defstruct_structure_name_rule_instance_g2_struct)) {
	svref_new_value = delete_gensym_element_1(variable,ISVREF(thing,
		(SI_Long)17L));
	...
	if (temp_1) {
		...
		Qg2_defstruct_structure_name_inference_background_collection_g2_struct)) 
		    {
	    svref_new_value = delete_gensym_element_1(variable,
		    ISVREF(thing,(SI_Long)4L));
		...
		if (temp_1) {
			...
			PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
				0);
			  temp = delete_gensym_element_1(variable,
...
{
    Object new_event_detector, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object svref_new_value;

    x_note_fn_call(172,93);
    new_event_detector = make_event_detector_1(event_type,block,
	    event_consumer,extra_info);
    gensym_push_modify_macro_arg = new_event_detector;
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(block,(SI_Long)15L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    ISVREF(block,(SI_Long)15L) = svref_new_value;
    gensym_push_modify_macro_arg = new_event_detector;
    car_1 = gensym_push_modify_macro_arg;
    cdr_1 = ISVREF(event_consumer,(SI_Long)16L);
    svref_new_value = gensym_cons_1(car_1,cdr_1);
    SVREF(event_consumer,FIX((SI_Long)16L)) = svref_new_value;
    return VALUES_1(Nil);
}
...
{
    Object event_list, event, ab_loop_list_, block, svref_new_value;

    x_note_fn_call(172,94);
    event_list = ISVREF(event_consumer,(SI_Long)16L);
    event = Nil;
  ...
  next_loop:
    ...
    svref_new_value = delete_gensym_element_1(event,ISVREF(block,
	    (SI_Long)15L));
    ISVREF(block,(SI_Long)15L) = svref_new_value;
    reclaim_event_detector_1(event);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(event_list);
    SVREF(event_consumer,FIX((SI_Long)16L)) = Nil;
    return VALUES_1(Nil);
}
...
{
    Object consumer, monitored_block, svref_new_value;

    x_note_fn_call(172,95);
    consumer = ISVREF(event_detector,(SI_Long)3L);
    monitored_block = ISVREF(event_detector,(SI_Long)2L);
    svref_new_value = delete_gensym_element_1(event_detector,
	    ISVREF(consumer,(SI_Long)16L));
    SVREF(consumer,FIX((SI_Long)16L)) = svref_new_value;
    svref_new_value = delete_gensym_element_1(event_detector,
	    ISVREF(monitored_block,(SI_Long)15L));
    ISVREF(monitored_block,(SI_Long)15L) = svref_new_value;
...
void displays_INIT()
{
    ...
    Object Qdisplays, Qdo_not_update_simulated_value_qm;
    Object Qdetermine_standard_dial_ruling, string_constant_34;
    ...
    string_constant_8 = 
	    STATIC_STRING("04z8r83ZYy83ZYy836ky836ky03*my001m1l8o1l8l000004z8r83ZVy83ZVy836ky836ky0k001m1l8o1l8l000004z8r83Wqy83Wqy836ky836ky0p001m1l8o1l8l");
    string_constant_9 = 
	    STATIC_STRING("000004z8r83Jhy83Jhy836ky836ky03uy001m1l8o1l8l000004z8r83Jiy83Jiy836ky836ky03uy001m1l8o1l8l000004z8r83Jjy83Jjy836ky836ky03uy001m1");
    string_constant_10 = 
	    STATIC_STRING("l8o1l8l000004z8r83Tsy83Tsy836ky836ky03ay001m1l8o1l8l000004z8r83Tuy83Tuy836ky836ky0u001m1l8o1l8l000004z8r83DYy83DYy836ky836ky09l0");
    string_constant_11 = 
	    STATIC_STRING("01o1m8p8388y1l8o1l8l1l8z000004z8r83RPy83RPy836ky836ky00001m1l8o1l8l000004z8r83Cty83Cty836ky836ky09m001o1m8p8388y1l8o1l8l1l8z0000");
    string_constant_12 = 
	    STATIC_STRING("04z8r83Jdy83Jdy836ky836ky09n001m1l8o1l8l000004z8r83JZy83JZy836ky836ky09o001m1l8o1l8l000004z8r83MXy83MXy836ky836ky09p001m1l8o1l8l");
    string_constant_13 = 
	    STATIC_STRING("000004z8r83Xty83Xty836ky836ky0p001m1l8o1l8l000004z8r83K6y83K6y836ky836ky0w001m1l8o1l8l000004z8r83=gy83=gy836ky836ky00001o1n8p831");
    string_constant_14 = 
    ...
    string_constant_16 = 
	    STATIC_STRING("6ky836ky0m001o1m8p83-Zy1l83Ey1l8l1l8z000004z8r83=Py83=Py836ky836ky00001o1m8p83Ky1l83Ey1l8l1l8z000004z8r830xy830xy836ky836ky00001");
    string_constant_17 = 
    ...
    string_constant_22 = 
	    STATIC_STRING("8o8l83Hy1o83J4y08o8l1o83ZYy3*my8o8l1o83ZVyk8o8l1o83Wqyp8o8l1o83Jhy3uy8o8l1o83Jiy3uy8o8l1o83Jjy3uy8o8l1o83Tsy3ay8o8l1o83Tuyu8o8l1");
    string_constant_23 = 
	    STATIC_STRING("q83DYy9l1m8p8388y8o8l8z1o83RPy08o8l1q83Cty9m1m8p8388y8o8l8z1o83Jdy9l8o8l1o83JZy9n8o8l1o83MXy9o8o8l1o83Xtyp8o8l1o83K6yw8o8l1q83=g");
    string_constant_24 = 
	    STATIC_STRING("y01n8p831*y83Gy83Ey8l83-5y1p830wy083Ey83Cy8l1o830cy083Ey8l1q8300yp1m8p83=Qy83Ey8l8z1q830Hym1m8p83=Qy83Ey8l8z1q830Gym1m8p83-Zy83E");
    string_constant_25 = 
    ...
    string_constant_27 = 
	    STATIC_STRING("1n4z8r83ZZy83ZZy83ZTy83ZTy00001m1l8o1l8l000004z8r83ZWy83ZWy83ZTy83ZTy00001m1l8o1l8l000004z8r83Gby83Gby83ZTy83ZTy00001m1l8o1l8l00");
    string_constant_28 = STATIC_STRING("000");
    string_constant_29 = 
	    STATIC_STRING("1p8q1n83ZTy1l9k8t1o83ZZy08o8l1o83ZWy08o8l1o83Gby08o8l");
    ...
    string_constant_30 = 
	    STATIC_STRING("1l4z8r83Xvy83Xvy83Xuy83Xuy00001m1l8o1l8l00000");
    string_constant_31 = STATIC_STRING("1n8q1n83Xuy1l9k8t1o83Xvy08o8l");
    temp = regenerate_optimized_constant(string_constant_26);
    ...
    string_constant_33 = STATIC_STRING("1m8q1m83v5y1l83-ly");
    ...
    string_constant_38 = 
	    STATIC_STRING("ry835my835my00001o1l83-4y1l8o1l8l1l83Hy000004z8r83Zay83Zay835my835my03Ly001m1l8o1l8l000004z8r83ZXy83ZXy835my835my030Fy001m1l8o1l");
    string_constant_39 = 
	    STATIC_STRING("8l000004z8r83Wry83Wry835my835my0p001m1l8o1l8l000004z8r83Tvy83Tvy835my835my0z001m1l8o1l8l000004z8r83eWy83eWy835my835my0n001m1l8o1");
    string_constant_40 = 
	    STATIC_STRING("l8l000004z8r83aey83aey835my835my03Qy001m1l8o1l8l000004z8r83VWy83VWy835my835my03fy001m1l8o1l8l000004z8r83DZy83DZy835my835my09l001");
    string_constant_41 = 
	    STATIC_STRING("o1m8p839Ry1l8o1l8l1l8z000004z8r83RSy83RSy835my835my00001m1l8o1l8l000004z8r83Cuy83Cuy835my835my09m001o1m8p839Ry1l8o1l8l1l8z000004");
    string_constant_42 = 
	    STATIC_STRING("z8r83Jfy83Jfy835my835my09n001m1l8o1l8l000004z8r83Jby83Jby835my835my09o001m1l8o1l8l000004z8r83MYy83MYy835my835my09p001m1l8o1l8l00");
    string_constant_43 = 
	    STATIC_STRING("0004z8r83K7y83K7y835my835my03Gy001m1l8o1l8l000004z8r83=gy83=gy835my835my00001p1n8p831*y83Gy1l83-4y1l83Ey1l8l1l83-5y000004z8r830w");
    string_constant_44 = 
    ...
    string_constant_46 = 
	    STATIC_STRING("1m8p83-Zy1l83-4y1l83Ey1l8l1l8z000004z8r83=Py83=Py835my835my00001p1m8p83Ky1l83-4y1l83Ey1l8l1l8z000004z8r830xy830xy835my835my00001");
    string_constant_47 = 
    ...
    string_constant_51 = 
	    STATIC_STRING("y1n83jy1m3-Byl1m3-Cy30dy1n83jy1mk30dy1m3-Cy30ey1q830dy083-4y8o8l83Hy1q830ry083-4y8o8l83Hy1o83Zay3Ly8o8l1o83ZXy30Fy8o8l1o83Wryp8o");
    string_constant_52 = 
	    STATIC_STRING("8l1o83Tvyz8o8l1o83eWyn8o8l1o83aey3Qy8o8l1o83VWy3fy8o8l1q83DZy9l1m8p839Ry8o8l8z1o83RSy08o8l1q83Cuy9m1m8p839Ry8o8l8z1o83Jfy9l8o8l1");
    string_constant_53 = 
	    STATIC_STRING("o83Jby9n8o8l1o83MYy9o8o8l1o83K7y3Gy8o8l1r83=gy01n8p831*y83Gy83-4y83Ey8l83-5y1p830wy083-4y83Ey8l1p830cy083-4y83Ey8l1r8300yp1m8p83");
    string_constant_54 = 
	    STATIC_STRING("=Qy83-4y83Ey8l8z1r830Hym1m8p83=Qy83-4y83Ey8l8z1r830Gym1m8p83-Zy83-4y83Ey8l8z1r83=Py01m8p83Ky83-4y83Ey8l8z1p830xy083-4y83Ey8l1p83");
    string_constant_55 = 
    ...
    string_constant_56 = 
	    STATIC_STRING("1l4z8r83K5y83K5y83ZUy83ZUy00001m1l8o1l8l00000");
    string_constant_57 = STATIC_STRING("1n8q1n83ZUy1l9k8t1o83K5y08o8l");
    temp = regenerate_optimized_constant(string_constant_26);
    ...
    string_constant_58 = 
	    STATIC_STRING("1m4z8r8u8u83Umy83Umy01p8w9k3Gy3ay1m1n83qy1n1mk3Gy1muu1mu3Qy1n1mk3Gy1muu1mu3Qy1n83jy1muk1m3Gy3ay001o1l8l1l8o1l8z1m83Dy53YySee com");
    string_constant_59 = 
	    STATIC_STRING("ment on ENTITY class definition000004z8r83Uny83Uny83Umy83Umy00001m1l8o1l8l00000");
    string_constant_60 = 
	    STATIC_STRING("1o8q1n83Umy1l83-+y8t1m8u1p8w9k3Gy3ay1m1n83qy1n1mk3Gy1muu1mu3Qy1n1mk3Gy1muu1mu3Qy1n83jy1muk1m3Gy3ay1o83Uny08o8l");
    temp = regenerate_optimized_constant(string_constant_26);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    ...
    string_constant_64 = 
	    STATIC_STRING("00001o1n8p83-ey83Gy1l83Ey1l8l1m83Dy5zExport: string.000004z8r834*y834*y834Ty834Ty00001p1l8l1l8z1l83Ey1m8p83*Wy1m83Dy53JyExport t");
    string_constant_65 = 
    ...
    string_constant_67 = 
	    STATIC_STRING("001q1m8p83=Qy1l83-4y1l83Ey1l8l1l8z1m83Dy53Lyexport time interval part000004z8r830Gy830Gy834Ty834Ty0m001p1m8p83-Zy1l83-4y1l83Ey1l");
    string_constant_68 = 
    ...
    string_constant_69 = 
	    STATIC_STRING("04z8r83Zxy83Zxy834Ty834Ty08k001o1m8p01l83-4y1l83Ey1l8l000004z8r830xy830xy834Ty834Ty00001n1l83-4y1l83Ey1l8l000004z8r830sy830sy834");
    string_constant_70 = 
    ...
    string_constant_71 = 
	    STATIC_STRING(" in related classes. Should be in\n a multiple-inheritance mixin.000004z8r83JIy83JIy834Ty834Ty083Ydy001l1l8l000004z8r8366y8366y83");
    string_constant_72 = 
	    STATIC_STRING("4Ty834Ty00001q1l83Fy1l83Hy1m8p83dry1l83Ey1l8l1m83Dy53vyExport: currently in attribute tables. Not showing up in doc\?000004z8r83-");
    string_constant_73 = 
    ...
    string_constant_76 = 
	    STATIC_STRING("rt numerical-expression-parse\?1q835cy01n8p83-ey83Gy83Ey8l1m83Dy5zExport: string.1r834*y08l8z83Ey1m8p83*Wy1m83Dy53JyExport text-f");
    string_constant_77 = 
    ...
    string_constant_78 = 
	    STATIC_STRING("p83=Qy83-4y83Ey8l8z1m83Dy53Lyexport time interval part1r830Gym1m8p83-Zy83-4y83Ey8l8z1s83=Py01m8p83Ky83-4y83Ey8l8z1m83Dy53eyExpor");
    string_constant_79 = 
	    STATIC_STRING("t and alias to show-simulated-values\? \?1q83Zxy8k1m8p083-4y83Ey8l1p830xy083-4y83Ey8l1q830sy083-4y83Ey8l1m83Dy53*JyAssociated with");
    string_constant_80 = 
    ...
    string_constant_81 = 
	    STATIC_STRING("e mixin.1m83JIy83Ydy1s8366y083Fy83Hy1m8p83dry83Ey8l1m83Dy53vyExport: currently in attribute tables. Not showing up in doc\?1r83-p");
    ...
    string_constant_83 = 
	    STATIC_STRING("1x83*oy8308yl830Ayl8309yl8307yl83=Dyl83=Nyl");
    ...
    string_constant_89 = 
	    STATIC_STRING("1l83Hy1m8p83dqy1l83Ey1l8l1m83Dy53vyExport: currently in attribute tables. Not showing up in doc\?000004z8r83-py83-py836ly836ly000");
    string_constant_90 = 
    ...
    string_constant_92 = 
	    STATIC_STRING("1r8q1o836ly1l834Ty1m8v836ly8t1p83=gy083Ny83Ey8l1q834*y2lno83Ny8l83Ey8z1r83=Py083Ny83-4y83Ey8l8z1r8366y083Fy83Hy1m8p83dqy83Ey8l1q");
