...
Object compile_function_definition_for_slot varargs_1(int, n)
{
    ...
    Object slot_description, new_cons, gensymed_symbol_1, cdr_new_value;
    ...
    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,1);
	  ...
	  if (Nil)
	      gensymed_symbol_1 = nconc2(gensym_list_2(function_definition,
	  ...
	  PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		...
		svref_new_value = IFIX(ISVREF(function_definition,
			(SI_Long)5L)) | (SI_Long)16777216L;
		ISVREF(function_definition,(SI_Long)5L) = FIX(svref_new_value);
	    }
    ...
    Object function_definition, new_byte_code_body, initializing_qm;
{
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  gensymed_symbol_2,gensymed_symbol_3);
	  svref_new_value = IFIX(ISVREF(function_definition,(SI_Long)5L)) 
		  | (SI_Long)16777216L;
	  ISVREF(function_definition,(SI_Long)5L) = FIX(svref_new_value);
      }
      if (Noting_changes_to_kb_p)
	...
	next_loop:
	  ...
	  ab_loop_it_ = temp ? (EQ(function_definition,
		  M_CAR(frame_and_slot_or_atom)) ? T : Nil) : Nil;
	  if (ab_loop_it_) {
    ...
    Object gensymed_symbol;
{
    ...
    reclaim_gensym_list_1(slot_value_list_of_values);
...
Object compile_keep_tabular_function_sorted_qm_for_slot varargs_1(int, n)
{
    ...
    Object sub_class_bit_vector, class_name_qm, gensymed_symbol_4;
    ...
    Object tabular_function_of_1_arg;
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = 
	    gensym_cons_1(allocate_evaluation_structure(gensym_list_4(Qx,
	    temp,Qf_of_x,value ? (FIXNUMP(value) || value && 
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(tabular_args);
    reclaim_gensym_list_1(tabular_values);
...
Object compile_add_or_delete_rows_for_slot varargs_1(int, n)
{
    ...
    Object amf_result, incff_1_arg, new_float, phrase_number;
    Object rest_of_arg_data_qm_old_value, new_arg;
	...
	if ( !TRUEP(delete_this_qm)) {
	    ab_loopvar__1 = gensym_cons_1(arg_qm,Nil);
	    if (ab_loopvar_)
		M_CDR(ab_loopvar_) = ab_loopvar__1;
	    else
		new_args = ab_loopvar__1;
	...
	if ( !TRUEP(delete_this_qm)) {
	    ab_loopvar__1 = gensym_cons_1(value_qm,Nil);
	    if (ab_loopvar__2)
		M_CDR(ab_loopvar__2) = ab_loopvar__1;
	    else
		new_values = ab_loopvar__1;
	...
	args = new_args;
	reclaim_gensym_list_1(values_1);
	values_1 = new_values;
    }
    else {
	...
	ab_loopvar__1 = gensym_cons_1(copy_for_slot_value(new_arg),Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	    new_args = ab_loopvar__1;
	...
	ab_loopvar__1 = gensym_cons_1(copy_for_slot_value(new_value),Nil);
	if (ab_loopvar__2)
	    M_CDR(ab_loopvar__2) = ab_loopvar__1;
	else
	    new_values = ab_loopvar__1;
    ...
    Object tabular_function_of_1_arg, x_in_window, y_in_window;
{
    ...
    Object temp_4, aref_arg_2_1, gensym_list_of_wide_strings, string_1;
    Object ab_loop_list_, new_cons, gensymed_symbol, short_string;
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(gensym_list_2(text_cell,text_cell_1),Nil);
    if (ab_loopvar__1)
  ...
  end_1:;
    temp =  !TRUEP(New_g2_classic_ui_p) ? gensym_cons_1(gensym_list_2(Nil,
	    make_text_cell(2,
	    gensym_cons_1(copy_constant_wide_string_given_length(array_constant_2,
	    FIX((SI_Long)15L)),Nil),class_format)),Nil) : Nil;
    temp_1 = gensym_list_2(Nil,make_text_cell_for_slot(5,
    ...
    temp_2 = make_text_cell(2,
	    gensym_cons_1(copy_constant_wide_string_given_length(array_constant_3,
	    FIX((SI_Long)3L)),Nil),attribute_value_format);
    temp_3 = get_primary_name_for_frame_if_any(tabular_function_of_1_arg);
    if (temp_3);
    else
	temp_3 = Qf;
    temp_3 = nconc2(temp,nconc2(gensym_list_2(temp_1,gensym_list_2(temp_2,
	    make_text_cell(2,gensym_cons_1(tformat_text_string(2,
	    string_constant_7,temp_3),Nil),attribute_value_format))),
	    table_rows));
...
void functions_INIT()
{
    ...
    string_constant_14 = 
	    STATIC_STRING("4z8r83ry83ry836ty836ty00001p1l8l1n8p836ty83Gy1l83-5y1l8o1l83-3y000004z8r83MSy83MSy836ty836ty00001n1l8o1l8l1l83Cy000004z8r83MTy83");
    string_constant_15 = 
	    STATIC_STRING("MTy836ty836ty00001m1l8l1l83Cy000004z8r83MWy83MWy836ty836ty00001m1l8l1l83Cy000004z8r83MVy83MVy836ty836ty00001m1l8l1l83Cy00000");
    string_constant_16 = 
	    STATIC_STRING("1u8q1o836ty1l83*sy1m8v836ty8t1n83--y01m8p83-*y1n83-0y01m8p83-0y1n83-Fy01m8p01o83ry01n8p836ty83Gy83-5y1p83MSy08o8l83Cy1o83MTy08l8");
    string_constant_17 = STATIC_STRING("3Cy1o83MWy08l83Cy1o83MVy08l83Cy");
    ...
    string_constant_18 = 
	    STATIC_STRING("1t1n836ty1o83-7Ry83-UPy1m9k9l83=xy1nlmo1n836ty1o83-7Ry83-UPy1m9k9l831Py1nlmo1m83-UPy1m1m9k83-9y1m9k83-Ay1n83-UPy1n1m9k83-9y83-UR");
    string_constant_19 = 
	    STATIC_STRING("y1m9k83-Ay1lm1n83-UPy1o1m9k83-9y83-URy1m9k83vy83-UQy2lmo1n83-UQy1m83-URy1m9k83-Ay1ll1n83-UQy1n83-URy1m9k83vy83-UQy2lln1m83-URy83");
    string_constant_20 = STATIC_STRING("-6y1m83-7Ry83-6y");
    ...
    string_constant_25 = 
	    STATIC_STRING("1p8q1o83AKy1l83*sy1m8v83AKy8t1n83--y01m8p83-*y1n83-0y01m8p83-0y1o83ry01n8p83Fhy83Gy83-5y");
    ...
    string_constant_26 = 
	    STATIC_STRING("1p1n83Fhy1q1m9k83Fgy1m9k83-Ty1m9k83-d8y1m9k83poy1m9k83-Py83-tby1lq1m83-tby83-tay1o83-tby1n83-tay1m9k83vy83-tby1nmln9l1m83-tay83-");
    string_constant_27 = 
	    STATIC_STRING("6y1n83-tay1p83-6y1m9k83-9y1m9k83-oby83-6y1m9k83-Ay2lol");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_36 = 
	    STATIC_STRING("1s4z8r83Acy83Acy837Uy837Uy00001q1m8p83Acy1l8l1l83Ey1l83Ny1l83KJy1l83Hy000004z8r83d-y83d-y837Uy837Uy083-Hy001m1l8l1l8o000004z8r83");
    string_constant_37 = 
	    STATIC_STRING("d*y83d*y837Uy837Uy083-Hy001m1l8l1l8o000004z8r839Ey839Ey837Uy837Uy083Agy001o1m8p839Ey1l8l1l8z1l8o000004z8r83FLy83FLy837Uy837Uy08k");
    string_constant_38 = 
    ...
    string_constant_39 = 
	    STATIC_STRING("z8r83X+y83X+y837Uy837Uy0k001n1l8l1l8o1l83Cy00000");
    string_constant_40 = 
	    STATIC_STRING("1u8q1o837Uy1l834gy1m8v837Uy8t1s83Acy01m8p83Acy8l83Ey83Ny83KJy83Hy1o83d-y83-Hy8l8o1o83d*y83-Hy8l8o1q839Ey83Agy1m8p839Ey8l8z8o1q83");
    string_constant_41 = 
	    STATIC_STRING("FLy8k1m8p83Ky8l8z8o1p83IIy08l8o83Cy1p83IJy08l8o83Cy1p83X+yk8l8o83Cy");
    ...
    string_constant_42 = 
	    STATIC_STRING("13Uy1n83Acy1n83-JGy83-Vy83-m*y1mlm1n83Acy1o83-JGy83-Vy83-m*y83-m=y1nlmo1n83Acy1o83-JGy83-Vy83-m*y83-m-y1olm0o1n83Acy1p83-JGy83-V");
    string_constant_43 = 
	    STATIC_STRING("y83-m*y83-m=y83-m-y1olmop1n83Acy1n83-JGy1m9k83-t3y83-m*y1mlm1n83Acy1o83-JGy1m9k83-t3y83-m*y83-m=y1nlmo1n83Acy1o83-JGy1m9k83-t3y8");
    string_constant_44 = 
	    STATIC_STRING("3-m*y83-m-y1olm0o1n83Acy1p83-JGy1m9k83-t3y83-m*y83-m=y83-m-y1olmop1n83Acy1m83-JGy83-m*y1ll1n83Acy1n83-JGy83-m*y83-m=y1nl0n1n83Ac");
    string_constant_45 = 
	    STATIC_STRING("y1n83-JGy83-m*y83-m-y1ol00n1n83Acy1o83-JGy83-m*y83-m=y83-m-y1ol0no1m83-JGy1m9k83pWy1m83-JGy1m9k9l1n83-m=y1n1m9k83=Gy1m9k9m1m9k83");
    string_constant_46 = 
	    STATIC_STRING("HBy83HBy1n83-m=y1n1m9k83=Gy1m9k9m1m9k9n9n1n83-m=y1o1m9k83HAy1m9k83-H9y1m9k9o83-qZy1m83HAyo1n83-m=y1o1m9k835+y1m9k83-H9y1m9k9o83-");
    string_constant_47 = 
	    STATIC_STRING("qZy1m835+yo1n83-m-y1o1m9k83=Fy1m9k83-H9y1m9k9o83-qXy1m83=Fyo1n83-m-y1v1m9k83=Fy1m9k83-H9y1m9k9o83-qXy1m9k83-ty1m9k83-TUy1m9k83-9");
    string_constant_48 = 
	    STATIC_STRING("y1m9k83-H9y1m9k83-Ay1m9k9o83-qXy1n83=Fyov1m83-m*y1m9k83-m+y1m83-m*y1m9k83-m0y1m83-qYy1m9k83-Hy1m83-qYy1m9k83-2y1m83-qYy1m9k9p1m8");
    string_constant_49 = 
	    STATIC_STRING("3-qXy83-qZy1o83-qXy1n83-qZy1m9k83vy83-qXy1n83vyln9q1n83-qXy1n83-qZy1m9k83vy1m9k83-Sny1n83vyln1m83-qZy83-Hy1m83-qZy83-2y1m83-qZy8");
    string_constant_50 = 
	    STATIC_STRING("3-Uy1m839Ey1m9k83=Ty1n839Ey1m1m9k83*uy1m9k83Agym1n839Ey1m1m9k83*uy1m9k9rm");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_53 = STATIC_STRING("1m8q1n83bLy1l83A8y83Iy");
