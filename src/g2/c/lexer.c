    ...
    Object pattern, evaluator_name, preprocessor_errors_qm;
{
    ...
    PUSH_SPECIAL(Preprocessor_errors_qm,preprocessor_errors_qm,5);
      current_wide_string_list = Qdo_not_use;
      PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		(SI_Long)3L));
	  ...
	  PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		...
		if (Preprocessor_errors_qm) {
		  ...
		  next_loop:
		    ...
		    goto next_loop;
		  end_loop:
		    reclaim_gensym_tree_1(Preprocessor_errors_qm);
		}
    ...
    Object unparsable_patterns, duplicate_patterns;
{
  ...
  next_loop:
    ...
    message_1 = format_note_for_preprocessor_error(name,expression,
	    preprocessor_errors);
    formatted_list = gensym_cons_1(message_1,formatted_list);
    goto next_loop;
  end_loop:;
    name = Nil;
  ...
  next_loop_1:
    ...
    formatted_list = gensym_cons_1(temp,formatted_list);
    goto next_loop_1;
  end_loop_1:;
    ...
    Object tokenizer, pattern_notes, duplicate_patterns;
{
	...
	reclaim_gensym_list_1(duplicate_patterns);
	reclaim_gensym_tree_1(pattern_notes);
    }
    return VALUES_1(Nil);
}
    ...
    Object token_notes;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(token_notes);
    return VALUES_1(Nil);
}
    ...
    Object tokenizer, source_text, start_index;
{
    ...
    current_tokenizer = get_lookup_slot_value_given_default(tokenizer,
	    Qlexing_table,Nil);
    PUSH_SPECIAL(Current_tokenizer,current_tokenizer,3);
      current_start_state = ISVREF(Current_tokenizer,(SI_Long)1L);
      PUSH_SPECIAL(Current_start_state,current_start_state,2);
	current_anchor_p = ISVREF(Current_tokenizer,(SI_Long)3L);
	PUSH_SPECIAL(Current_anchor_p,current_anchor_p,1);
	  current_anchor_p = T;
    ...
    Object patterns;
{
	...
	PUSH_SPECIAL(Current_lexing_strings,current_lexing_strings,0);
	...
	next_loop:
	  ...
	  if ( !TRUEP(parsed_expression)) {
	      ...
	      unparsable_patterns = gensym_cons_1(gensym_list_3(name,
		      expression,
		      preprocessed_expression_or_list_of_errors),
		      unparsable_patterns);
	  }
		...
		end_1:;
		  duplicate_pattern_names = temp_1 ? 
			  duplicate_pattern_names : gensym_cons_1(name,
			  duplicate_pattern_names);
	      }
	      Current_lexing_strings = gensym_cons_1(gensym_cons_1(name,
		      preprocessed_expression_or_list_of_errors),
    ...
    Object tokens;
{
	...
	if ( !TRUEP(parsed_expression))
	    unparsable_tokens = gensym_cons_1(gensym_list_3(action,
		    expression,preprocessed_expression),unparsable_tokens);
	else {
	    reclaim_wide_string(preprocessed_expression);
	    parsed_tokens = gensym_cons_1(gensym_list_2(action,
		    copy_tree_using_gensym_conses_1(parsed_expression)),
		    parsed_tokens);
	}
	goto next_loop;
      end_loop:
    ...
    Object patterns_strings, tokenizer;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(patterns_strings);
    ...
    Object tokens_cons, tokenizer;
{
    ...
    reclaim_gensym_tree_1(tokens_cons);
    ...
    Object tokenizer, patterns_definition, gensymed_symbol;
{
    ...
    Object tokens_cons, unparsable_tokens, gensym_pop_store, cons_1, next_cons;
    ...
    PUSH_SPECIAL(Current_lexing_strings,current_lexing_strings,0);
	  ...
	  tokens_cons = gensym_cons_1(Nil,tokens_cons);
    ...
    Object slot_value, frame, slot_description;
{
	...
	ab_loopvar__1 = gensym_cons_1(new_structure,Nil);
	if (ab_loopvar_)
...
void lexer_INIT()
{
    ...
    string_constant_14 = 
	    STATIC_STRING("o1l8l000004z8r83Xky83Xky83AGy83AGy00001l1l8l000004z8r83cFy83cFy83AGy83AGy00001l1l8l000004z8r837Ay837Ay83AGy83AGy00001l1l8l00000");
    string_constant_15 = 
    ...
    string_constant_18 = STATIC_STRING("o8l1n83Xky08l1n83cFy08l1n837Ay08l");
    ...
    string_constant_19 = STATIC_STRING("1l1m83mCy83-Uy");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_19));
    string_constant_20 = STATIC_STRING("1l1n83-khy1n83-Rjy83-BXy83-Rjym");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_20));
    string_constant_21 = 
	    STATIC_STRING("13Ny1m83-BXy83-kDy1n83-BXy1m83-LSy83-kDy1m83-Jjym1m83-kDy83-Jgy1n83-Jgy1n83-kEy83-Jfy83-Jgy1n83h0yln1m83-Jgy83-kEy1n83-kEy1m83-i");
    string_constant_22 = 
	    STATIC_STRING("My83-kEy1n83-mvylm1m83-kEy83-iMy1m83-iMy83-Kdy1m83-iMy83-bCy1n83-bCy1m83-Kdy83-bBy1m83-bAyl1n83-bCy1m83-Kdy83-i4y1m83-i4yl1n83-b");
    string_constant_23 = 
	    STATIC_STRING("Cy1m83-Kdy83-jqy1m83-d4yl1m83-g*y83-BTy1m83-g*y83-Xey1m83-g*y83-lny1n83-Kdy1n83-bSy83-kDy83-lpym1m83-Kdy83-M9y1n83-Kdy83vMy1l83v");
    string_constant_24 = 
	    STATIC_STRING("My1m83-Kdy83-g*y1n83-M9y1n83-bQy83-A+y83-lny1m83-M9ym1n83-M9y1o83-bQy83-LSy83-A+y83-lny1m83-Zmyn1n83-A+y83-jwy1ll1n83-A+y1m83-jw");
    string_constant_25 = 
	    STATIC_STRING("y83-A+y2llm1m83-jwy83-M8y1m83-jwy83-BTy1n83-M8y1n83-BTy83-Xey83-BTy2lln1m83-YJy83-YIy");
    ...
    set_slot_value_to_evaluation_value_function(Qtokens_definition,
	    tokens_definition_evaluation_getter_1);
    string_constant_31 = STATIC_STRING("1m1m83FSy1m9k83Zy1m83FSy83-F8y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_31));
    string_constant_32 = 
	    STATIC_STRING("1m1n83-F8y83-F7y1ll1n83-F8y1m83-F7y83-F8y2llm");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_32));
    string_constant_33 = STATIC_STRING("1l1n83-F7y1m83mCy83-F6y2lml");
    ...
    string_constant_34 = STATIC_STRING("1m1m83-F6y1m9k9l1m83-F6y83-2y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
