...
Object Initial_java_class = UNBOUND;
    ...
    Object gensym_window_for_workstation_qm;
{
    ...
    Object future_task_schedule_modify_arg_8, old_structure_being_reclaimed;
    ...
    char temp, svref_new_value;
    double temp_1, temp_2, future_task_schedule_modify_arg_3, aref_new_value;
    Declare_stack_pointer;
    Declare_catch(3);
    Declare_special(1);
    XDeclare_area(1);
    ...
    PUSH_SPECIAL(Current_draw_paper_p,current_draw_paper_p,0);
      display_credits(0);
    POP_SPECIAL();
    ...
    write_console_p = T;
    PUSH_SPECIAL(Write_console_p,write_console_p,0);
  ...
  next_loop_14:
	...
	if (error_occurred_p) {
	    ...
	    future_task_schedule_modify_arg_3 = 
		    DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 30.0;
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qwarn_user_of_previously_aborted_g2);
	    if (Task_to_warn_user_of_previously_aborted_g2) {
		if (EQ(Task_to_warn_user_of_previously_aborted_g2,
			Current_schedule_task))
		    Current_schedule_task = Nil;
		if (ISVREF(Task_to_warn_user_of_previously_aborted_g2,
			(SI_Long)6L))
		    cancel_and_reclaim_scheduled_queue_element_1(Task_to_warn_user_of_previously_aborted_g2);
		inline_note_reclaim_cons(Task_to_warn_user_of_previously_aborted_g2,
			Nil);
		...
		reclaim_schedule_task_args(ISVREF(Task_to_warn_user_of_previously_aborted_g2,
			(SI_Long)9L));
		temp_3 = Task_to_warn_user_of_previously_aborted_g2;
		SVREF(temp_3,FIX((SI_Long)9L)) = Nil;
		Structure_being_reclaimed = old_structure_being_reclaimed;
		temp_3 = Task_to_warn_user_of_previously_aborted_g2;
		temp_5 = Chain_of_available_schedule_tasks;
		SVREF(temp_3,FIX((SI_Long)0L)) = temp_5;
	    ...
	    Task_to_warn_user_of_previously_aborted_g2 = task;
	}
    }
    else
	g2_event_loop();
    ...
    Object require_maximally_within_pane_qm;
{
	...
	PUSH_SPECIAL(Transform_image_operation_hint,transform_image_operation_hint,
		0);
...
Object Image_plane_for_finding_object_near_mouse = UNBOUND;

Object X_in_window_for_finding_object_near_mouse = UNBOUND;

Object Y_in_window_for_finding_object_near_mouse = UNBOUND;

Object Image_x_scale_for_finding_object_near_mouse = UNBOUND;

Object Image_y_scale_for_finding_object_near_mouse = UNBOUND;

Object Classes_of_objects_to_not_consider_qm = UNBOUND;

Object Mouse_x_in_workspace = UNBOUND;

Object Mouse_y_in_workspace = UNBOUND;
    ...
    Object classes_of_objects_to_not_consider_qm;
{
    ...
    PUSH_SPECIAL(Classes_of_objects_to_not_consider_qm,classes_of_objects_to_not_consider_qm,
	    13);
      PUSH_SPECIAL(Objects_to_not_consider_qm,objects_to_not_consider_qm,12);
	...
	PUSH_SPECIAL(Mouse_y_in_workspace,mouse_y_in_workspace,11);
	  PUSH_SPECIAL(Mouse_x_in_workspace,mouse_x_in_workspace,10);
	    PUSH_SPECIAL(Image_y_scale_for_finding_object_near_mouse,image_y_scale_for_finding_object_near_mouse,
		    9);
	      PUSH_SPECIAL(Image_x_scale_for_finding_object_near_mouse,image_x_scale_for_finding_object_near_mouse,
		      8);
		PUSH_SPECIAL(Y_in_window_for_finding_object_near_mouse,y_in_window_for_finding_object_near_mouse,
			7);
		  PUSH_SPECIAL(X_in_window_for_finding_object_near_mouse,x_in_window_for_finding_object_near_mouse,
			  6);
		    PUSH_SPECIAL(Image_plane_for_finding_object_near_mouse,image_plane_for_finding_object_near_mouse,
			    5);
			...
			POP_SPECIAL();
		      ...
		      PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
			      3);
			...
			loose_top_edge_of_visible_workspace_area = 
				FIXNUM_MAX(temp_2,temp);
			PUSH_SPECIAL(Loose_top_edge_of_visible_workspace_area,loose_top_edge_of_visible_workspace_area,
				2);
			  ...
			  PUSH_SPECIAL(Loose_right_edge_of_visible_workspace_area,loose_right_edge_of_visible_workspace_area,
				  1);
			    ...
			    loose_bottom_edge_of_visible_workspace_area = 
				    FIXNUM_MIN(temp_2,temp);
			    PUSH_SPECIAL(Loose_bottom_edge_of_visible_workspace_area,loose_bottom_edge_of_visible_workspace_area,
				    0);
			      object_qm = 
				  ...
				  if (temp_3);
					  ...
					  if (IFIX(scale) == (SI_Long)4096L)
					      ...
					      temp = FIX(unshifted_result 
						      >>  -  - (SI_Long)12L);
					  }
					  else
					      temp = scalef_function(scale,
						      FIX(value_1));
					  temp_3 =  !NUM_LT(temp,
    ...
    Object block_being_searched_is_workspace_p;
{
    ...
    Object connection, connections, gensymed_symbol_1, gensymed_symbol_4;
    Object sub_class_bit_vector, connection_frame_or_class, x2;
    Object cross_section_pattern, temp_2, new_cons, global_properties;
    ...
    SI_Long sub_class_vector_index, gensymed_symbol_5, expansion_factor;
    SI_Long gross_distance_from_connection, effective_distance_from_connection;
    char temp_1;
    Object result;
    ...
    gensymed_symbol = ISVREF(block_to_search,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
  ...
  next_loop:
	...
	if (subblocks &&  !EQ(ISVREF(subblocks,(SI_Long)0L),subblocks)) {
	    gensymed_symbol = ISVREF(subblock,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    ...
	    ab_loop_it_ = Nil;
	    if (ab_queue_form__1)
		ab_next_queue_element__1 = ISVREF(ab_queue_form__1,
			(SI_Long)0L);
	  next_loop_1:
	    if (EQ(ab_next_queue_element__1,ab_queue_form__1))
		goto end_loop_1;
	    subsubblock = ISVREF(ab_next_queue_element__1,(SI_Long)2L);
	    ab_next_queue_element__1 = ISVREF(ab_next_queue_element__1,
		    (SI_Long)0L);
	    ab_loop_it_ = 
  ...
  end_loop:
	...
	gensymed_symbol = ISVREF(nearest_block_qm,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)6L) : Nil;
	...
	gensymed_symbol_2 = IFIX(Qnil);
      end_21:;
	gensymed_symbol_3 = (SI_Long)1L;
	expansion_factor = gensymed_symbol_2 >>  -  - gensymed_symbol_3;
...
Object find_object_near_workstation_event varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Objects_to_not_consider_qm,objects_to_not_consider_qm,1);
    ...
    Object x_in_window, y_in_window, image_plane;
{
	...
	if ( !TRUEP(thing_qm))
		...
		gensymed_symbol_3 = ISVREF(maybe_a_table,(SI_Long)14L);
...
Object Chain_of_available_block_near_mouse_caches = UNBOUND;

Object Block_near_mouse_cache_count = UNBOUND;
    ...
    Object block_near_mouse_cache;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_block_near_mouse_caches;
    SVREF(block_near_mouse_cache,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_block_near_mouse_caches = block_near_mouse_cache;
    return VALUES_1(Nil);
}
...
Object make_permanent_block_near_mouse_cache_structure_internal()
{
    ...
    Object block_near_mouse_cache_count_new_value;
    ...
    block_near_mouse_cache_count_new_value = 
	    FIXNUM_ADD1(Block_near_mouse_cache_count);
    Block_near_mouse_cache_count = block_near_mouse_cache_count_new_value;
...
{
    Object def_structure_block_near_mouse_cache_variable, svref_new_value;
    ...
    SVREF(def_structure_block_near_mouse_cache_variable,FIX((SI_Long)11L)) 
	    = Nil;
    svref_new_value = frame_serial_number_0();
    ...
    Object workspace, mouse_pointer;
{
	...
	if ( !(FIXNUM_LE(left,x_in_window) && FIXNUM_LT(x_in_window,right) 
	    ...
	    bottom_edge_of_draw_area = FIX(gensymed_symbol + 
		    gensymed_symbol_1);
	    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,28);
	      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,27);
		PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,26);
		  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
			  25);
		    current_window_1 = ISVREF(ISVREF(image_plane,
			    (SI_Long)2L),(SI_Long)2L);
		    PUSH_SPECIAL(Current_window,current_window_1,24);
		      drawing_on_window = Nil;
		      PUSH_SPECIAL(Drawing_on_window,drawing_on_window,23);
			current_drawing_transfer_mode = 
				EQ(Current_drawing_transfer_mode,Kxor) ? 
				Current_drawing_transfer_mode : 
				ISVREF(Current_window,(SI_Long)30L);
			PUSH_SPECIAL(Current_drawing_transfer_mode,current_drawing_transfer_mode,
				22);
			  type_of_current_window = ISVREF(Current_window,
				  (SI_Long)1L);
			  PUSH_SPECIAL(Type_of_current_window,type_of_current_window,
				  21);
			    current_native_window_qm = 
				    ISVREF(Current_window,(SI_Long)17L);
			    PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,
				    20);
			      current_color_map = ISVREF(Current_window,
				      (SI_Long)20L);
			      PUSH_SPECIAL(Current_color_map,current_color_map,
				      19);
				...
				PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
					18);
				  ...
				  PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
					  17);
				    current_frame_transform_qm = Nil;
				    current_image_x_scale = 
						...
						PUSH_SPECIAL(Loose_bottom_edge_of_visible_workspace_area,loose_bottom_edge_of_visible_workspace_area,
						  ...
						  PUSH_SPECIAL(Loose_right_edge_of_visible_workspace_area,loose_right_edge_of_visible_workspace_area,
							...
							PUSH_SPECIAL(Current_image_plane,current_image_plane,
								6);
							  PUSH_SPECIAL(Current_pane,current_pane,
								  5);
							    color_or_metacolor 
								    = 
								    ISVREF(image_plane,
    ...
    Object block, mouse_pointer;
{
	...
	PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,28);
	  PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,27);
	    PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,26);
	      PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,25);
		...
		PUSH_SPECIAL(Current_window,current_window_1,24);
		  ...
		  PUSH_SPECIAL(Drawing_on_window,drawing_on_window,23);
			...
			PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,
			  ...
			  current_color_map = ISVREF(Current_window,
				  (SI_Long)20L);
			  PUSH_SPECIAL(Current_color_map,current_color_map,19);
			    temp = ISVREF(Current_color_map,(SI_Long)5L);
			    if (temp);
			    else
				temp = map_to_color_value_1(Qwhite);
						  ...
						  PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
							...
							PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
							  ...
							  bottom_edge_of_frame 
								  ...
								  ISVREF(frame_description_reference,
								  (SI_Long)7L));
							  PUSH_SPECIAL(Bottom_edge_of_frame,bottom_edge_of_frame,
								  3);
							    PUSH_SPECIAL(Right_edge_of_frame,right_edge_of_frame,
								    2);
							      PUSH_SPECIAL(Top_edge_of_frame,top_edge_of_frame,
								      1);
								PUSH_SPECIAL(Left_edge_of_frame,left_edge_of_frame,
									0);
								  gensymed_symbol 
									  = 
									  IFIX(Current_x_origin_of_drawing);
								  ...
								  result = track_mouse_over_frame(mouse_pointer,
									  ISVREF(frame_description_reference,
									  (SI_Long)2L),
									  block,
									  Left_edge_of_frame,
...
Object Gensym_logo_style = UNBOUND;
...
Object make_text_for_gensym_g2()
{
    ...
    return gensym_cons_1(copy_text_string(EQ(Gensym_logo_style,Qnew_large) 
	    || EQ(Gensym_logo_style,Qnew_large_2) || EQ(Gensym_logo_style,
	    Qnew_large_with_tagline) ? string_constant_4 : 
...
static Object string_constant_6;   /* "G2~c with " */
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  tformat(2,string_constant_6,FIX((SI_Long)174L));
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	return gensym_cons_1(temp_1,Nil);
    }
    else
	return VALUES_1(Nil);
}
...
static Object string_constant_7;   /* " Prototype" */

static Object string_constant_8;   /* " Alpha" */

static Object string_constant_9;   /* " Beta" */
...
Object make_text_for_type_of_g2_license()
{
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  if ( !TRUEP(T))
		      temp = error((SI_Long)2L,
			      "The value of RELEASE-QUALITY-OF-CURRENT-GENSYM-PRODUCT-LINE (~s), is not one of (0 1 2 3).",
			      Release_quality_of_current_gensym_product_line);
		  else
	      ...
	      temp_1 = FIXNUMP(code) ? (IFIX(code) & (SI_Long)64L) != 
		      (SI_Long)0L : TRUEP(Qnil);
	      if (temp_1);
	      else
		  temp_1 = 
		  ...
		  twrite_beginning_of_wide_string(array_constant_12,
			  FIX((SI_Long)17L));
	      code = M_CAR(M_CDR(Learned_list_to_expedite_ui));
	      temp_1 = FIXNUMP(code) ? (IFIX(code) & (SI_Long)1024L) != 
		      (SI_Long)0L : TRUEP(Qnil);
	      if (temp_1);
	      else
		  temp_1 = 
	...
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    return gensym_list_2(temp,stringw(FIX((SI_Long)8232L)));
}
...
Object make_text_for_local_identification()
{
    ...
    return gensym_cons_1(write_local_identification_info_text_string(),Nil);
}

Object Interrim_no_mark_logo_p = UNBOUND;

static Object string_constant_11;  /* " Gensym  G2" */
...
Object display_credits varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Gensym_logo_style,gensym_logo_style,0);
      workstation = Nil;
    ...
    next_loop:
	  ...
	  if (Interrim_no_mark_logo_p)
	      temp = gensym_cons_1(gensym_list_2(Nil,make_text_cell(2,
		      gensym_cons_1(copy_text_string(string_constant_11),
	      ...
	      temp = EQ(Gensym_logo_style,Qnew_large_2) ? 
		      gensym_list_2(gensym_list_2(Nil,logo),
		      gensym_list_2(Nil,g2)) : 
		      gensym_cons_1(gensym_list_2(logo,g2),Nil);
	  }
	  if (EQ(Gensym_logo_style,Qnew_large) || EQ(Gensym_logo_style,
		  Qnew_large_2) || EQ(Gensym_logo_style,
		  Qnew_large_with_tagline))
	  ...
	  temp_1 = gensym_list_2(temp_2,make_text_cell(2,temp_1,temp_4));
	  workspace = make_workspace(4,Qtemporary_workspace,Nil,
		  make_or_reformat_table(3,nconc2(temp,
		  gensym_list_2(temp_1,gensym_list_2(Nil,make_text_cell(2,
    ...
    Object name, bindings;
{
	...
	next_loop_1:
	  ...
	  if (temp_1) {
	      handler_string = CONSP(handler) ? 
		      translated_string_for_symbol(1,SECOND(handler)) : Nil;
	      if (handler_string) {
		  current_wide_string_list = Qdo_not_use;
		  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
			...
			PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
			  ...
			  PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
				  0);
			    tformat(3,string_constant_12,array_constant_14,
				    handler_string);
			    temp = copy_out_current_wide_string();
			  POP_SPECIAL();
			POP_SPECIAL();
		  ...
		  if (key_patterns_and_classes) {
			...
			POP_SPECIAL();
		      POP_SPECIAL();
		      key_cell = make_text_cell(2,gensym_cons_1(key_string,
			      Nil),Qhelp_key_name_format);
		      ...
		      handler_cell = make_text_cell(2,gensym_cons_1(pretty,
			      Nil),Qhelp_key_binding_format);
		      element = Nil;
		    ...
		    next_loop_3:
		      ...
		      goto next_loop_3;
		    end_loop_3:;
		      reclaim_gensym_list_1(key_patterns_and_classes);
		      key_patterns_and_classes = Nil;
		      row = gensym_cons_1(key_cell,row);
		      row = gensym_cons_1(handler_cell,row);
		  ...
		  key_patterns_and_classes = 
			  gensym_cons_1(gensym_cons_1(key_pattern,class_1),
			  key_patterns_and_classes);
	...
	end_loop:;
	  if (key_patterns_and_classes) {
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	      key_cell = make_text_cell(2,gensym_cons_1(key_string,Nil),
		      Qhelp_key_name_format);
	      pretty = text_string_p(previous_handler) ? 
		      copy_text_string(previous_handler) : 
		      ui_command_name_for_describe_keymap(previous_handler);
	      handler_cell = make_text_cell(2,gensym_cons_1(pretty,Nil),
	  ...
	  temp = gensym_cons_1(gensym_list_4(Nil,Nil,Nil,make_text_cell(2,
		  gensym_cons_1(name,Nil),Qhelp_title_format)),Nil);
    ...
    Object name, key_for_accent;
{
  ...
  end_loop:
    ...
    temp = make_text_cell(2,
	    ...
	    text_cell_format_name);
    temp = gensym_list_4(temp,make_text_cell(2,
    ...
    Object wide_character;
{
	...
	switch (INTEGER_TO_UNSIGNED_CHAR(wide_character)) {
	  case 9:
	    char_or_string = array_constant_15;
	    break;
	  case 32:
    ...
    Object base_and_presentations_characters;
{
    ...
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object presentation, more_qm, ab_loop_list_, temp, temp_1, aref_arg_2_1;
    Object gensym_list_of_wide_strings, string_1, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, new_cons, gensymed_symbol, short_string;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    Declare_special(5);
    ...
    Object base_and_presentations_characters;
{
    ...
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object base_character, more_qm, ab_loop_list_, temp, temp_1, aref_arg_2_1;
    Object gensym_list_of_wide_strings, string_1, ab_loopvar_, ab_loopvar__1;
    Object ab_loopvar__2, new_cons, gensymed_symbol, short_string;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    Declare_special(5);
...
static Object string_constant_14;  /* "Alt+i " */

static Object string_constant_15;  /* "Alt+i" */

static Object string_constant_16;  /* " or " */

static Object string_constant_17;  /* ", or " */
    ...
    Object type_ins;
{
    ...
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object l, temp, aref_arg_2_1, gensym_list_of_wide_strings, string_1;
    Object ab_loop_list_, ab_loopvar_, ab_loopvar__1, ab_loopvar__2, new_cons;
    Object gensymed_symbol, short_string, temp_1;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    Declare_special(5);
...
Object make_diacritic_header_table_row()
{
    ...
    text_cell_format_name = Qspecial_character_help_text_cell_format;
    temp = make_text_cell(2,
	    convert_text_string_to_text(copy_constant_wide_string_given_length(array_constant_20,
    ...
    return gensym_list_4(temp,temp_1,temp_2,make_text_cell(2,
...
Object make_standalone_special_character_rows()
{
  ...
  end_1:;
    if (row_qm) {
	ab_loopvar__2 = gensym_cons_1(row_qm,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object editor_special_character_alist_entry;
{
	...
	temp_1 = Qnil;
      end_1:;
	reclaim_gensym_list_1(gensym_list_of_wide_strings);
	temp_1 = make_text_cell(2,temp_1,text_cell_format_name);
	return gensym_list_2(temp_1,make_text_cell(2,
...
Object make_diacritic_help_table_rows()
{
    ...
    temp_1 = gensym_cons_1(make_diacritic_header_table_row(),Nil);
    name = Nil;
    key_for_accent = Nil;
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(make_diacritic_table_row(name,
	    key_for_accent),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
...
Object make_standalone_special_character_help_table_rows()
{
    ...
    temp = gensym_cons_1(gensym_list_4(Nil,Nil,Nil,make_text_cell(2,
	    ...
	    FIX((SI_Long)29L))),
	    Qspecial_character_help_header_text_cell_format)),Nil);
    temp_1 = gensym_cons_1(make_standalone_header_table_row(),Nil);
...
static Object string_constant_18;  /* "Hangul (KS C 5601)" */

static Object string_constant_19;  /* "Cyrillic (ISO 8859-5)" */

static Object string_constant_20;  /* "Kanji (JIS)" */

static Object string_constant_21;  /* "Unicode 2.0" */

static Object string_constant_22;  /* "For ~a" */

static Object list_constant_5;     /* # */

static Object string_constant_23;  /* "Unicode" */

static Object string_constant_24;  /* "Enter Alt+i followed by a ~d-digit ~a hex code.  ~
    ...
    Object language;
{
	...
	charset_name = string_constant_20;
    else if (EQ(script,Qunicode))
	charset_name = string_constant_21;
    else
	charset_name = Qnil;
    code_digit_length = EQ(script,Qcyrillic) ? (SI_Long)2L : (SI_Long)4L;
    temp = gensym_list_4(Nil,Nil,Nil,make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(2,
	    string_constant_22,memq_function(language,list_constant_5) ? 
	    language : string_constant_23)),
	    Qspecial_character_help_header_text_cell_format));
    return gensym_list_2(temp,gensym_list_4(Nil,Nil,Nil,make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(3,
	    string_constant_24,FIX(code_digit_length),charset_name)),
...
Object Return_from_breakpoint_task = UNBOUND;
    ...
    Object value;
{
	...
	Chain_of_available_schedule_tasks = Return_from_breakpoint_task;
    }
    temp = Nil;
    Return_from_breakpoint_task = temp;
...
Object return_from_breakpoint varargs_1(int, n)
{
    ...
    Object immediate_task_schedule_modify_arg_7, old_structure_being_reclaimed;
    Object temp, svref_new_value, def_structure_schedule_task_variable;
    Object new_task, gensymed_symbol, def_structure_queue_element_variable;
	...
	SVREF(new_task,FIX((SI_Long)8L)) = 
		immediate_task_schedule_modify_arg_3;
	ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)1L);
	SVREF(new_task,FIX((SI_Long)11L)) = 
		immediate_task_schedule_modify_arg_7;
	gensymed_symbol = ISVREF(Immediate_task_queue,(SI_Long)1L);
	...
	temp = Immediate_task_queue;
	SVREF(def_structure_queue_element_variable,FIX((SI_Long)0L)) = temp;
...
static Object string_constant_25;  /* "Disabling debugging by changing the \"Tracing and breakpoints enabled?\" ~
...
Object debugger_disable_debugging()
{
    ...
    notify_user(1,string_constant_25);
    change_slot_value(3,Debugging_parameters,
	    Qmessage_and_breakpoint_overrides,Nil);
    return return_from_breakpoint(0);
}

Object Allow_debugger_pause = UNBOUND;

Object Computation_instance_at_breakpoint = UNBOUND;

Object Computation_frame_at_breakpoint = UNBOUND;

Object All_computation_instances_above_breakpoint = UNBOUND;

Object May_return_from_breakpoint = UNBOUND;

Object Pane_for_debugger_pause = UNBOUND;

static Object string_constant_26;  /* "System will remain paused at this breakpoint.  ~
...
Object Breakpoints_enabled_p = UNBOUND;
...
Object Result_of_enter_dialog_for_t2_for_pause_for_internal_error_or_debug = UNBOUND;
    ...
    Object message_or_halt_info, debug_case_qm;
{
    ...
    if (debug_case_qm) {
	temp = gensym_list_3(Qtext,copy_text_string(message_1),
		Qbreakpoint_message);
	temp_1 = gensym_list_2(temp,gensym_list_3(Qbutton,
		copy_constant_wide_string_given_length(array_constant_27,
		FIX((SI_Long)17L)),Qdisable_debugging));
	temp_2 = Allow_debugger_pause ? 
		gensym_cons_1(gensym_list_3(Qbutton,
	...
	temp = nconc2(temp_1,nconc2(temp_2,gensym_list_2(temp,
		gensym_list_3(Qitem,Current_computation_frame,
		Qitem_causing_breakpoint))));
    }
    else {
	temp = gensym_list_3(Qtext,copy_text_string(message_1),Qabort_message);
	temp = gensym_list_2(temp,gensym_list_3(Qbutton,
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				...
				enter_dialog(15,temp,
					...
					Qreturn_from_breakpoint,Nil,Nil,
    ...
    Object message_1;
{
    ...
    temp = copy_text_string(message_1);
    temp_1 = copy_constant_wide_string_given_length(array_constant_27,
	    FIX((SI_Long)17L));
    temp_2 = Allow_debugger_pause ? 
	    copy_constant_wide_string_given_length(array_constant_28,
	    FIX((SI_Long)5L)) : 
    ...
    temp_4 = Allow_debugger_pause ? 
	    gensym_cons_1(Current_workstation_detail_pane,Nil) : Qnil;
    ...
    Object procedure;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(dynamic_breakpoint_enabled_p(bkpt) ? 
	    line : FIXNUM_LOGIOR(line,Editor_disabled_breakpoint_flag),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_loop:
    ...
    fixnum_list = Qnil;
  end_1:;
    reclaim_gensym_list_1(breakpoints);
    return VALUES_1(fixnum_list);
}

static Object array_constant_31;   /* # */

static Object string_constant_27;  /* "G2 Break in ~NF" */

static Object string_constant_28;  /* ", line ~d" */

static Object string_constant_29;  /* ", instruction ~d" */
    ...
    Object halt_info, computation_frame, gensym_window;
{
	...
	if (temp) {
	    ...
	    source_code = copy_wide_string(array_constant_31);
    }
    current_wide_string_list = Qdo_not_use;
    PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
      wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
	...
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		    0);
	      tformat(2,string_constant_27,computation_frame);
	      if (ISVREF(halt_info,(SI_Long)6L))
		  tformat(2,string_constant_28,ISVREF(halt_info,(SI_Long)6L));
	      tformat(2,string_constant_29,ISVREF(halt_info,(SI_Long)5L));
    ...
    return reclaim_gensym_tree_1(options);
}
		  ...
		  PUSH_SPECIAL(Current_workstation_context,current_workstation_context,
			...
			PUSH_SPECIAL(Current_workstation_detail_pane,current_workstation_detail_pane,
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
				...
				if ( !TRUEP(CDR(temp)))
				    goto end_loop_2;
				if (EQ(stack,ISVREF(workstation,(SI_Long)17L)))
				    goto end_loop_2;
    ...
    Object message_or_halt_info, debug_case_qm;
{
    ...
    PUSH_SPECIAL(Computation_instance_at_breakpoint,computation_instance_at_breakpoint,
      ...
      PUSH_SPECIAL(Computation_frame_at_breakpoint,computation_frame_at_breakpoint,
	      3);
	all_computation_instances_above_breakpoint = debug_case_qm ? 
		...
		: Nil;
	PUSH_SPECIAL(All_computation_instances_above_breakpoint,all_computation_instances_above_breakpoint,
		2);
	  may_return_from_breakpoint = T;
	  PUSH_SPECIAL(May_return_from_breakpoint,may_return_from_breakpoint,
		  1);
	    result_of_enter_dialog_for_t2_for_pause_for_internal_error_or_debug 
		    = Nil;
	    PUSH_SPECIAL(Result_of_enter_dialog_for_t2_for_pause_for_internal_error_or_debug,result_of_enter_dialog_for_t2_for_pause_for_internal_error_or_debug,
		    0);
		  ...
		  if (CONSP(return_value) && EQ(CAR(return_value),
		      ...
		      reclaim_gensym_cons_1(return_value);
		  }
		  maybe_schedule_service_workstations(T);
		  if ( !TRUEP(May_return_from_breakpoint)) {
		      ...
		      raw_stack_error_1(FIX((SI_Long)-1L),Qerror,
			      copy_constant_wide_string_given_length(array_constant_32,
			      FIX((SI_Long)56L)));
		  }
	      }
	    POP_SPECIAL();
...
Object change_mode()
{
	...
	PUSH_SPECIAL(Doing_password_change_p,doing_password_change_p,0);
    ...
    Object symbol;
{
    ...
    tformat(2,string_constant_30,string_1);
...
static Object string_constant_31;  /* "Please modify user settings." */
...
static Object string_constant_32;  /* "Please enter user mode alias." */
...
Object g2_alias_prompt_message()
{
	...
	return VALUES_1(string_constant_32);
}

static Object Qg2_password_change_prompt;  /* g2-password-change-prompt */

static Object string_constant_33;  /* "Change your password." */
...
Object g2_password_change_prompt_message()
{
	...
	return VALUES_1(string_constant_33);
}
    ...
    Object value, g2_login;
{
	...
	PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
		0);
	  tformat(2,string_constant_34,g2_password_change_prompt_message());
	POP_SPECIAL();
	temp = Current_localization_purpose_qm;
	if (temp);
	else
	...
	PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
		0);
	  temp = value ? twrite_login_failure_translation_symbol(value) : Nil;
	POP_SPECIAL();
	SAVE_VALUES(VALUES_1(temp));
	remove_last_item_in_current_localization_domains();
	result = RESTORE_VALUES();
	...
	PUSH_SPECIAL(Current_localization_purpose_qm,current_localization_purpose_qm,
	  ...
	  if (EQ(ISVREF(g2_login,(SI_Long)25L),Qalias_creation))
	      tformat(2,string_constant_34,g2_alias_prompt_message());
	  else
	      tformat(2,string_constant_34,g2_login_prompt_message());
	POP_SPECIAL();
	temp = Current_localization_purpose_qm;
	if (temp);
	else
...
Object Chain_of_available_g2_login_states = UNBOUND;

Object G2_login_state_count = UNBOUND;
    ...
    Object g2_login_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_g2_login_states;
    SVREF(g2_login_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_g2_login_states = g2_login_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_g2_login_state_structure_internal()
{
    ...
    Object g2_login_state_count_new_value;
    ...
    g2_login_state_count_new_value = FIXNUM_ADD1(G2_login_state_count);
    G2_login_state_count = g2_login_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_g2_login_state_variable, svref_new_value;
    ...
    SVREF(def_structure_g2_login_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_g2_login_state_variable);
}
...
Object Kb_restrictions = UNBOUND;
    ...
    Object how_entered;
{
	...
	if (Doing_password_change_p) {
	    ...
	    temp = enter_context_in_current_workstation(3,Qg2_login,
		    make_user_settings_editor_state(3,g2_login,
		    modal_case_qm ? T : Nil,password_change_case_qm ? T : 
		    Nil),modal_case_qm ? T : Nil);
	    remove_last_item_in_current_localization_domains();
	    SAVE_VALUES(VALUES_1(temp));
	    remove_last_item_in_current_localization_domains();
	    result = RESTORE_VALUES();
	    ...
	    g2_login_state = make_user_settings_editor_state(4,g2_login,
		    modal_case_qm ? T : Nil,password_change_case_qm ? T : 
		    Nil,EQ(how_entered,Qalias_creation) ? T : Nil);
...
Object enter_user_settings_editor_1 varargs_1(int, n)
{
    ...
    return enter_context_in_current_workstation(3,Qg2_login,g2_login_state,
	     !TRUEP(memq_function(ISVREF(ISVREF(g2_login_state,
	    (SI_Long)3L),(SI_Long)25L),list_constant_6)) ? T : Nil);
}
...
static Object string_constant_35;  /* "User Mode Alias Creation" */

static Object string_constant_36;  /* "User Settings Editor" */
...
Object make_user_settings_editor_state varargs_1(int, n)
{
    ...
    g2_login_subcommand_menu = make_subcommand_menu(1,
	    gensym_list_3(Qcancel,Qdisconnect,Qend));
	...
	change_slot_value(3,g2_login_workspace,Qtitle_bar_caption_text,
		...
		copy_text_string(string_constant_35) : 
		copy_text_string(string_constant_36)));
    }
...
static Object string_constant_37;  /* "Can not choose user mode to non-existend user mode" */

static Object Qduplicate_new_password_required;  /* duplicate-new-password-required */

static Object string_constant_38;  /* "Sorry, but parent user mode for this alias is incorrect." */
...
Object do_end_button_for_g2_login()
{
	...
	notify_user(2,string_constant_30,string_constant_37);
	...
	if (is_user_mode_present(get_lookup_slot_value_given_default(g2_login,
	    ...
	    result = notify_user(1,string_constant_38);
    }
    else
	result = finish_g2_login(g2_login,Current_workstation,
	...
	if (temp)
		...
		if ( !temp_2)
		    ...
		    temp = 
			    ...
			    string_constant_10 : encoded_old_password,
...
static Object string_constant_39;  /* "~a \"~a\" ~a ~a ~a" */
    ...
    Object file_name, user_name, old_password_hashed, new_password_hashed;
{
	...
	command_line = tformat_text_string(6,string_constant_39,
    ...
    Object command_line, message_text_string;
{
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		notify_user_at_console_and_on_logbook(2,string_constant_40,
			message_text_string);
		result = VALUES_1(Nil);
	    }
	}
...
static Object string_constant_41;  /* "Changing password for user ~s, running ~s outside of G2 on the G2 OK file ~s" */

/* SAVING-NEW-PASSWORD-FORMAT-CONTROL-STRING */
Object saving_new_password_format_control_string()
{
    x_note_fn_call(130,138);
...
static Object string_constant_42;  /* "~a \"~a\" ~a ~a ~a ~a ~a" */

static Object string_constant_43;  /* "Updated ~a: added a user entry for ~a" */
    ...
    Object user_name, clear_password, list_of_modes, universal_date;
{
    ...
    PUSH_SPECIAL(Write_symbols_in_lower_case_qm,write_symbols_in_lower_case_qm,
	  ...
	  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	    ...
	    POP_SPECIAL();
	  POP_SPECIAL();
	  operation_name_for_add = copy_wide_string(array_constant_36);
	  ...
	  if ( !TRUEP(error_symbol_qm)) {
	      ...
	      if (PUSH_UNWIND_PROTECT(0)) {
		  g2passwdexe_file_name = G2passwdexe;
		  command_line = tformat_text_string(8,string_constant_42,
...
static Object string_constant_44;  /* "~a \"~a\" ~a ~a \"~a\" ~a ~a" */

static Object string_constant_45;  /* "x" */

static Object string_constant_46;  /* "Updated ~a: deleted the user entry for ~a" */
    ...
    Object user_name;
{
    ...
    PUSH_SPECIAL(Write_symbols_in_lower_case_qm,write_symbols_in_lower_case_qm,
	  ...
	  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	    ...
	    POP_SPECIAL();
	  POP_SPECIAL();
	  operation_name_for_delete = copy_wide_string(array_constant_37);
	  ok_file_namestring_qm = g2_ok_file_probe() ? gensym_namestring(1,
		  Authorizing_ok_pathname) : Nil;
	  copy = copy_gensym_pathname(Authorizing_ok_pathname);
	  svref_new_value = copy_wide_string(array_constant_38);
	  ...
	  if ( !TRUEP(error_symbol_qm)) {
	      ...
	      if (PUSH_UNWIND_PROTECT(0)) {
		  g2passwdexe_file_name = G2passwdexe;
		  command_line = tformat_text_string(8,string_constant_44,
			  g2passwdexe_file_name,ok_file_namestring_qm,
			  operation_name_for_delete,user_name_as_string,
			  tmp_file_namestring,string_constant_45,
			  string_constant_45);
		  current_wide_string_list = Qdo_not_use;
		  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,
			  4);
...
static Object string_constant_47;  /* "Updated ~a: modified the password-validity entry ~
				    *                   for ~a"
				    */
    ...
    Object user_name, universal_date;
{
    ...
    PUSH_SPECIAL(Write_symbols_in_lower_case_qm,write_symbols_in_lower_case_qm,
	  ...
	  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	    ...
	    POP_SPECIAL();
	  POP_SPECIAL();
	  operation_name = copy_wide_string(array_constant_39);
	  ok_file_namestring_qm = g2_ok_file_probe() ? gensym_namestring(1,
		  Authorizing_ok_pathname) : Nil;
	  dummy_encoded_password = copy_wide_string(array_constant_40);
	  dummy_mode_list = copy_wide_string(array_constant_41);
	  if ( !TRUEP(ok_file_namestring_qm))
	      error_symbol_qm = Qok_file_not_found;
	  if ( !TRUEP(error_symbol_qm)) {
	      g2passwdexe_file_name = Qunbound_in_protected_let;
...
static Object string_constant_48;  /* "Reinstall authorized users?~
...
Object reinstall_authorized_users()
{
    ...
    x_note_fn_call(130,143);
    pathname_qm = g2_ok_file_probe();
    if (pathname_qm) {
	namestring_1 = gensym_namestring(1,pathname_qm);
	confirm_or_cancel(3,tformat_text_string(2,string_constant_48,
...
Object g2_reinstall_authorized_users()
{
    ...
    x_note_fn_call(130,144);
    value_1 = Nil;
    fresh_error_string_qm = read_ok_file_again();
    temp = fresh_error_string_qm;
    if (temp);
    else
	temp = copy_text_string(array_constant_42);
    value_1 = temp;
    temp = copy_as_wide_string(value_1);
    return VALUES_1(temp);
}

static Object string_constant_49;  /* "Reinstalling authorized users from ~s." */

static Object string_constant_50;  /* "~%~a" */

static Object string_constant_51;  /* "~a~%Please wait . . . " */

static Object string_constant_52;  /* "Reinstallation of authorized users completed " */

static Object string_constant_53;  /* "unsuccessfully! ERROR: ~a" */

static Object string_constant_54;  /* "successfully." */
...
Object read_ok_file_again()
{
	...
	if (pathname_qm) {
		...
		PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		  ...
		  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		    ...
		    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			    0);
		      twrite_standard_secure_g2_notification_header();
		      tformat(2,string_constant_49,namestring_1);
		      message_text_string = copy_out_current_wide_string();
		    POP_SPECIAL();
		  POP_SPECIAL();
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    notify_user_at_console_and_on_logbook(2,string_constant_50,
		    message_text_string);
	    error_qm = Nil;
	    temp = make_message(1,tformat_text_string(2,string_constant_51,
		    message_text_string));
	    ...
	    PUSH_SPECIAL(Current_long_operation_notification_workspace,current_long_operation_notification_workspace,
		    3);
	      frame_serial_number = 
	      ...
	      PUSH_SPECIAL(Fixnum_time_at_start_of_current_long_notification,fixnum_time_at_start_of_current_long_notification,
		      2);
		if (PUSH_UNWIND_PROTECT(0)) {
		    doing_long_operation_with_notification_qm = T;
		    long_operation_notification_has_been_put_up_qm = Nil;
		    PUSH_SPECIAL(Long_operation_notification_has_been_put_up_qm,long_operation_notification_has_been_put_up_qm,
			    1);
		      PUSH_SPECIAL(Doing_long_operation_with_notification_qm,doing_long_operation_with_notification_qm,
			      0);
			if ( !TRUEP(Nil)) {
		...
		PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		  ...
		  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		    ...
		    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			    0);
		      twrite_standard_secure_g2_notification_header();
		      tformat(1,string_constant_52);
		      if (error_qm)
			  tformat(2,string_constant_53,error_qm);
		      else
...
static Object string_constant_55;  /* "Secure G2: (" */

static Object string_constant_56;  /* "; User: ~a)  " */
...
Object Event_handler_args = UNBOUND;
    ...
    Object event_interpretation, mouse_pointer;
{
    ...
    PUSH_SPECIAL(Event_handler_args,event_handler_args,2);
      command_qm = Nil;
      frame_qm = Nil;
    ...
    Object menu_name, mouse_pointer;
{
    ...
    x_note_fn_call(130,157);
    ui_command_context = Qstart_generic;
    PUSH_SPECIAL(Ui_command_context,ui_command_context,0);
    ...
    end_1:;
	  ...
	  result = reclaim_gensym_list_1(applicable_commands);
      }
      else {
	  menu_item_qm = 
...
Object Chain_of_available_user_mode_aliass = UNBOUND;

Object User_mode_alias_count = UNBOUND;
    ...
    Object user_mode_alias;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_user_mode_aliass;
    SVREF(user_mode_alias,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_user_mode_aliass = user_mode_alias;
    return VALUES_1(Nil);
}
...
Object make_permanent_user_mode_alias_structure_internal()
{
    ...
    Object user_mode_alias_count_new_value;
    Object defstruct_g2_user_mode_alias_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(130,163);
    def_structure_user_mode_alias_variable = Nil;
    user_mode_alias_count_new_value = FIXNUM_ADD1(User_mode_alias_count);
    User_mode_alias_count = user_mode_alias_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
static Object string_constant_58;  /* "Sorry, but alias or user mode with name ~a already exist." */

static Object string_constant_59;  /* "Sorry, but alias name ~a is incorrect because ~a" */
    ...
    Object alias_name;
{
    ...
    x_note_fn_call(130,168);
    if (is_user_mode_present(alias_name)) {
	notify_user(2,string_constant_58,alias_name);
	return VALUES_1(Nil);
    }
    error_value = validate_as_possible_user_mode(alias_name);
    if (error_value) {
	notify_user(3,string_constant_59,alias_name,
...
Object Kb_configuration = UNBOUND;
...
static Object string_constant_60;  /* "Alias name" */

static Object string_constant_61;  /* "Parent user mode name" */

static Object string_constant_62;  /* "Date of alias creation" */

static Object string_constant_63;  /* "Who created the alias" */

static Object string_constant_64;  /* "User Mode Aliases" */
    ...
    Object user_mode_aliases;
{
  ...
  next_loop:
    ...
    alias_name = make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(2,
	    string_constant_30,ISVREF(user_mode_alias,(SI_Long)1L))),
	    cell_format);
    parent_user_mode = make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(2,
	    string_constant_30,ISVREF(user_mode_alias,(SI_Long)2L))),
	    cell_format);
    current_wide_string_list = Qdo_not_use;
    PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
      wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
    ...
    who_created_the_alias = make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(2,
	    string_constant_30,ISVREF(user_mode_alias,(SI_Long)4L))),
	    cell_format);
  ...
  end_loop:;
    ...
    temp = gensym_list_4(temp_1,temp_2,temp,make_text_cell(2,
	    convert_text_string_to_text(tformat_text_string(1,
	    string_constant_63)),cell_format));
    rows = gensym_cons_1(temp,rows);
    ...
    change_slot_value(3,workspace,Qtitle_bar_caption_text,
	    convert_text_string_to_text(copy_text_string(string_constant_64)));
...
void run_INIT()
{
    ...
    Object Qg2_add_alias, Qcompare_aliases, Qkb_configuration, Quser_interface;
    Object Qconfigure, Quser_mode_alias, Qreclaim_structure;
    Object Qoutstanding_user_mode_alias_count;
    Object Quser_mode_alias_structure_memory_usage, Qutilities2;
    Object Quser_mode_alias_count, Qchain_of_available_user_mode_aliass;
    ...
    Object Qg2_login_state_structure_memory_usage, Qg2_login_state_count;
    Object Qchain_of_available_g2_login_states, string_constant_121;
    ...
    Object Qstatus_table_frame_serial_number, Qrun;
    Object Qreturn_from_breakpoint_task, list_constant_37, list_constant_36;
    ...
    Object list_constant_26, list_constant_25, string_constant_99;
    Object list_constant_24, string_constant_98, list_constant_23;
    Object string_constant_97, list_constant_22, string_constant_96;
    Object string_constant_95, string_constant_94, string_constant_93;
    Object string_constant_92, list_constant_21, string_constant_91;
    ...
    Object list_constant_14, array_constant_43, array_constant_44, Qgspan;
    Object Qget_gensym_logo_style, list_constant_13, Qgensym_logo_style;
    Object Kfuncall, list_constant_12, Qall_optional_modules_for_display;
    Object Qgenerate_spot, Qworkspace, Qgenerate_spot_for_workspace;
    Object Qblock_near_mouse_cache, Qoutstanding_block_near_mouse_cache_count;
    Object Qblock_near_mouse_cache_structure_memory_usage;
    Object Qblock_near_mouse_cache_count;
    Object Qchain_of_available_block_near_mouse_caches, string_constant_67;
    Object string_constant_66, list_constant_11, Qedit_cursor;
    Object Qsmall_edit_cursor, Qnamed_dynamic_extent_description;
    Object Qfinding_object_near_mouse, Qrun_top_level_event_handler;
    Object Qsystem_icon_title_string, Qsystem_window_title_string;
    Object string_constant_65, Qlaunch_ab, Qlaunch_function_qm;
    Object Qsystem_run_function, Qsystem_top_level_function;
    Object Qrun_ab_process_top_level;

    x_note_fn_call(130,178);
    SET_PACKAGE("AB");
    ...
    mutate_global_property(Qab,string_constant_65,Qsystem_window_title_string);
    ...
    string_constant_66 = 
	    STATIC_STRING("43Dy8m83fTy1n83fTy8n8k1l8n0000001l1n8y83-2wy0k3Cyk0k0");
    ...
    Qblock_near_mouse_cache_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_67 = STATIC_STRING("1q83fTy8s83-Kry09k9l");
    ...
    string_constant_6 = STATIC_STRING("G2~c with ");
    array_constant_43 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)0L,(SI_Long)8482L);
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)6L,(SI_Long)1L);
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)7L,(SI_Long)57344L);
    list_constant_14 = STATIC_CONS(Qicp,array_constant_43);
    list_constant_15 = STATIC_CONS(Qgsi,array_constant_43);
    Qgspan = STATIC_SYMBOL("GSPAN",AB_package);
    array_constant_44 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)0L,(SI_Long)174L);
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)6L,(SI_Long)1L);
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)7L,(SI_Long)57344L);
    list_constant_16 = STATIC_CONS(Qgspan,array_constant_44);
    list_constant_17 = STATIC_CONS(Qgfi,array_constant_43);
    ...
    string_constant_7 = STATIC_STRING(" Prototype");
    string_constant_8 = STATIC_STRING(" Alpha");
    string_constant_9 = STATIC_STRING(" Beta");
    string_constant_10 = STATIC_STRING("");
    array_constant_10 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_10,(SI_Long)0L,(SI_Long)41L);
    ...
    UBYTE_16_ISASET_1(array_constant_11,(SI_Long)1L,(SI_Long)40L);
    UBYTE_16_ISASET_1(array_constant_11,(SI_Long)2L,(SI_Long)82L);
    ...
    UBYTE_16_ISASET_1(array_constant_11,(SI_Long)9L,(SI_Long)41L);
    ...
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)4L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)5L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)6L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)7L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)8L,(SI_Long)99L);
    ...
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)13L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)14L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)15L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)16L,(SI_Long)41L);
    UBYTE_16_ISASET_1(array_constant_12,(SI_Long)22L,(SI_Long)17L);
    ...
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)3L,(SI_Long)109L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)4L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)5L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)6L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)7L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)8L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)9L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_13,(SI_Long)10L,(SI_Long)41L);
    ...
    string_constant_11 = STATIC_STRING(" Gensym  G2");
    ...
    Qname_or_names_for_frame = STATIC_SYMBOL("NAME-OR-NAMES-FOR-FRAME",
	    AB_package);
    string_constant_68 = STATIC_STRING("1r83*oy832Py83-Ry83=Dyk83=Nyk");
    ...
    SET_SYMBOL_FUNCTION(Qspot_generator_for_credits_table_format,
	    ...
	    FALSE,2,2));
    string_constant_69 = 
	    STATIC_STRING("13Ty83-Qy83-Ny83-Ry83-By083wy083byk83ay3Ry83Wy3Gy83cyk83kyk83ny1l83iVy83ty3-Wy83sy3-4y83uyk83-7y3a+y83*3y3S+y83*+y3q+y83iy35Ky");
    mutate_global_property(Qprogram_title_format,
	    regenerate_optimized_constant(string_constant_69),
	    Qformat_description);
    string_constant_70 = 
	    STATIC_STRING("13Ty83-Qy83-Ny838Ay83-By083wy083byk83ay3Gy83Wy3Gy83cy3Gy83kyk83ny1l83iVy83ty3-Wy83sy3-4y83uyk83-7y3a+y83*3y3S+y83*+y3q+y83iy35Ky");
    mutate_global_property(Qnew_small_logo_program_title_format,
	    regenerate_optimized_constant(string_constant_70),
	    Qformat_description);
    string_constant_71 = 
	    STATIC_STRING("13Ry83-Qy83-Ny838Ay83-By083wy083byk83ay3Gy83Wy3Gy83cy3Gy83kyk83ny1l83iVy83ty3-Wy83sy3-4y83uyk83-7y3a+y83*3y3S+y83*+y3q+y");
    ...
    string_constant_79 = 
	    STATIC_STRING("1l4z8r8u8u83aWy83aWy01n8w9kl001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition00000");
    string_constant_80 = STATIC_STRING("1n8q1m83aWy1l838sy1m8u1n8w9kl");
    temp = regenerate_optimized_constant(string_constant_76);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_gensym_logo_description);
    ...
    string_constant_81 = STATIC_STRING("1m8q1m83-*Ry1l9k");
    temp = regenerate_optimized_constant(string_constant_76);
    ...
    string_constant_82 = 
	    STATIC_STRING("1z83*oy83=wy083=Dyk83=Nyk8308yk830Ayk8309yk8307yk");
    ...
    string_constant_83 = 
	    STATIC_STRING("13Py83-Qy83-By083wy83-dy83byn83aym83Wyv83cym83kyk83-=yu83ny1l83-ry83ty3Gy83sy3Cy83uyk83-7y3K+y83iy3=Ty");
    ...
    string_constant_84 = 
	    STATIC_STRING("13Py83-Qy83-By083wy83-cy83byn83aym83Wyv83cym83kyk83-=yu83ny1l83-ry83tyz83syw83uyk83-7y3K+y83iy3=Ty");
    ...
    array_constant_14 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_14,(SI_Long)0L,(SI_Long)99L);
    ...
    UBYTE_16_ISASET_1(array_constant_14,(SI_Long)4L,(SI_Long)115L);
    ...
    Qspecial_character_help_header_text_cell_format = 
	    ...
	    AB_package);
    string_constant_87 = 
	    STATIC_STRING("13Ty83-Qy83-By083wy83-dy83byn83ayp83Wyv83cyp83kyk83-=yu83-Ny83*2y83*Ky83fy83ny1l83-ry83ty3Ey83syz83uyk83-7y3K+y83iy3=4y");
    ...
    UBYTE_16_ISASET_1(array_constant_16,(SI_Long)1L,(SI_Long)112L);
    ...
    array_constant_17 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_17,(SI_Long)0L,(SI_Long)82L);
    ...
    UBYTE_16_ISASET_1(array_constant_17,(SI_Long)14L,(SI_Long)6L);
    ...
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)3L,(SI_Long)98L);
    ...
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)7L,(SI_Long)107L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)8L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)9L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)10L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)11L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)12L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)13L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)14L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)15L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)16L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)22L,(SI_Long)17L);
    UBYTE_16_ISASET_1(array_constant_18,(SI_Long)23L,(SI_Long)57344L);
    string_constant_13 = STATIC_STRING(" ");
    string_constant_14 = STATIC_STRING("Alt+i ");
    string_constant_15 = STATIC_STRING("Alt+i");
    string_constant_16 = STATIC_STRING(" or ");
    string_constant_17 = STATIC_STRING(", or ");
    ...
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)1L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)2L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)3L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)4L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)5L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)6L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)7L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)8L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)9L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)10L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)11L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)12L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)13L,(SI_Long)99L);
    ...
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)17L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)22L,(SI_Long)18L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)23L,(SI_Long)57344L);
    array_constant_21 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)0L,(SI_Long)66L);
    ...
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)5L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)6L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)7L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)8L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)9L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)10L,(SI_Long)99L);
    ...
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)14L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)22L,(SI_Long)15L);
    ...
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)2L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)3L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)4L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)5L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)6L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)7L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)8L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)9L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)10L,(SI_Long)113L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)11L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)12L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)13L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)14L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)15L,(SI_Long)101L);
    ...
    array_constant_23 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)0L,(SI_Long)68L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)1L,(SI_Long)105L);
    ...
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)5L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)6L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)7L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)8L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)14L,(SI_Long)9L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)15L,(SI_Long)57344L);
    array_constant_24 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)0L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)1L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)2L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)3L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)4L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)5L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)6L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)7L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)8L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)9L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)10L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)11L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)12L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)13L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)14L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)15L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)16L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)22L,(SI_Long)17L);
    ...
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)17L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)18L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)19L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)20L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)21L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)22L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)23L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)24L,(SI_Long)68L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)25L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)26L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)27L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)28L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)29L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)30L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)31L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)32L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)33L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)38L,(SI_Long)34L);
    ...
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)3L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)4L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)5L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)6L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)7L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)8L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)9L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)10L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)11L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)12L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)13L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)14L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)15L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)16L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)17L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)18L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)19L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)20L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)21L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)22L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)23L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)24L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)25L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)26L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)27L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)28L,(SI_Long)115L);
    ...
    string_constant_18 = STATIC_STRING("Hangul (KS C 5601)");
    string_constant_19 = STATIC_STRING("Cyrillic (ISO 8859-5)");
    string_constant_20 = STATIC_STRING("Kanji (JIS)");
    string_constant_21 = STATIC_STRING("Unicode 2.0");
    string_constant_22 = STATIC_STRING("For ~a");
    list_constant_5 = STATIC_LIST((SI_Long)3L,Qjapanese,Qkorean,Qrussian);
    string_constant_23 = STATIC_STRING("Unicode");
    string_constant_24 = 
    ...
    array_constant_27 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)0L,(SI_Long)68L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)1L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)2L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)3L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)4L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)5L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)6L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)7L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)8L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)9L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)10L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)11L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)12L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)13L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)14L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)15L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)16L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)22L,(SI_Long)17L);
    ...
    array_constant_28 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)0L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)1L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)2L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)3L,(SI_Long)115L);
    ...
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)2L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)3L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)4L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)5L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)6L,(SI_Long)117L);
    ...
    array_constant_30 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_30,(SI_Long)0L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_30,(SI_Long)1L,(SI_Long)75L);
    ...
    array_constant_31 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)32L));
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)0L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)1L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)2L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)3L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)4L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)5L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)6L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)7L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)8L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)9L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)10L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)11L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)12L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)13L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)14L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)15L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)16L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)17L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)18L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)19L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)20L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)21L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)22L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)23L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)24L,(SI_Long)121L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)25L,(SI_Long)46L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)30L,(SI_Long)26L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)31L,(SI_Long)57344L);
    string_constant_27 = STATIC_STRING("G2 Break in ~NF");
    string_constant_28 = STATIC_STRING(", line ~d");
    string_constant_29 = STATIC_STRING(", instruction ~d");
    ...
    array_constant_32 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)64L));
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)0L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)1L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)2L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)3L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)4L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)5L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)6L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)7L,(SI_Long)114L);
    ...
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)11L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)12L,(SI_Long)118L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)13L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)14L,(SI_Long)99L);
    ...
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)21L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)22L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)23L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)24L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)25L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)26L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)27L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)28L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)29L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)30L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)31L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)32L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)33L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)34L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)35L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)36L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)37L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)38L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)39L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)40L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)41L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)42L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)43L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)44L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)45L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)46L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)47L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)48L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)49L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)50L,(SI_Long)107L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)51L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)52L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)53L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)54L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)55L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)62L,(SI_Long)56L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)63L,(SI_Long)57344L);
    ...
    string_constant_100 = 
	    STATIC_STRING("1z83*oy83=wy083=Dyk83=Nyl8308yl830Ayl8309yl8307yl");
    ...
    Qmemory_management_table_text_cell_format_for_data = 
	    ...
	    AB_package);
    string_constant_101 = 
	    STATIC_STRING("1x83-Qy83wy83-cy83kyk83byn83ayn83Wyn83cyn");
    ...
    Qmemory_management_table_text_cell_format_for_headers = 
	    ...
	    AB_package);
    string_constant_102 = 
	    STATIC_STRING("13Dy83-Qy83wy83-dy83kyk83-Ny083*Ky083byn83ayn83Wyn83cyn");
    ...
    string_constant_104 = 
	    STATIC_STRING("13Dy4z8r83C8y83C8y838Uy838Uy00001p1l8l1m8p83C8y1l83Ey1l83Fy1l83-3y000004z8r83NGy83NGy838Uy838Uy00001n1m8p83E*y1l83Ey1l8l000004z8");
    string_constant_105 = 
	    STATIC_STRING("r83NHy83NHy838Uy838Uy00001n1m8p831ny1l83Ey1l8l000004z8r83NFy83NFy838Uy838Uy00001n1m8p831=y1l83Ey1l8l000004z8r83NIy83NIy838Uy838U");
    string_constant_106 = 
	    STATIC_STRING("y00001n1m8p83C9y1l8o1l8l000004z8r83NDy83NDy838Uy838Uy00001n1m8p831fy1l8o1l8l000004z8r83NEy83NEy838Uy838Uy00001n1m8p830Ky1l8o1l8l");
    string_constant_107 = 
	    STATIC_STRING("000004z8r83N9y83N9y838Uy838Uy00001n1m8p01l8o1l8l000004z8r83N3y83N3y838Uy838Uy0k001m1l83Ey1l8l000004z8r83N5y83N5y838Uy838Uy00001m");
    string_constant_108 = 
	    STATIC_STRING("1l8o1l8l000004z8r83N8y83N8y838Uy838Uy00001m1l8o1l8l000004z8r83NAy83NAy838Uy838Uy00001n1m8p831ny1l8o1l8l000004z8r83N4y83N4y838Uy8");
    string_constant_109 = 
	    STATIC_STRING("38Uy00001n1m8p831ny1l8o1l8l000004z8r83N7y83N7y838Uy838Uy00001n1m8p831ny1l8o1l8l000004z8r83N6y83N6y838Uy838Uy00001m1l8o1l8l000004");
    string_constant_110 = 
	    STATIC_STRING("z8r83NCy83NCy838Uy838Uy00001n1m8p831ny1l8o1l8l000004z8r83NBy83NBy838Uy838Uy00001m1l8o1l8l00000");
    string_constant_111 = 
	    STATIC_STRING("13Fy8q1m838Uy1l83-+y1q83C8y01m8p83C8y83Ey83Fy83-3y1p83NGy01m8p83E*y83Ey8l1p83NHy01m8p831ny83Ey8l1p83NFy01m8p831=y83Ey8l1p83NIy01");
    string_constant_112 = 
	    STATIC_STRING("m8p83C9y8o8l1p83NDy01m8p831fy8o8l1p83NEy01m8p830Ky8o8l1p83N9y01m8p08o8l1o83N3yk83Ey8l1o83N5y08o8l1o83N8y08o8l1p83NAy01m8p831ny8o");
    string_constant_113 = 
	    STATIC_STRING("8l1p83N4y01m8p831ny8o8l1p83N7y01m8p831ny8o8l1o83N6y08o8l1p83NCy01m8p831ny8o8l1o83NBy08o8l");
    temp = regenerate_optimized_constant(string_constant_76);
    ...
    G2_login_class_description = 
	    ...
	    Class_description_gkbprop);
    string_constant_114 = STATIC_STRING("1l1m83C8y1m9k83-Rpy");
    clear_optimized_constants();
    ...
    mutate_global_property(Qname_qm,T,
	    Quse_slot_value_compiler_for_default_overrides_p);
    string_constant_116 = STATIC_STRING("1m1m83C9y83xny1m83C9y83xly");
    ...
    string_constant_117 = STATIC_STRING("1l1m83a7y1m9k83-V*y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_31 = STATIC_STRING("Please modify user settings.");
    string_constant_118 = STATIC_STRING("1l1m83a7y1m9k83-Ury");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_32 = STATIC_STRING("Please enter user mode alias.");
    string_constant_119 = STATIC_STRING("1l1m83a7y1m9k83-V2y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    Qg2_password_change_prompt = STATIC_SYMBOL("G2-PASSWORD-CHANGE-PROMPT",
	    AB_package);
    string_constant_33 = STATIC_STRING("Change your password.");
    ...
    string_constant_120 = 
	    STATIC_STRING("43Dy8m83hgy1o83hgy83-Sy8n8k1l83-Sy0000001m1n8y83-3ry1p838Uy83xey83xfy83-=Iy83xdy1m8x83-Syksk0k0");
    ...
    string_constant_121 = STATIC_STRING("1q83hgy8s83-V=y09k9l");
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Quser_settings_editor_workspace,
	    list_constant_38);
    string_constant_123 = 
	    STATIC_STRING("1l4z8r83*Ly83*Ly83dly83dly0u001n1l8l1l8o1m8p83*7y00000");
    string_constant_124 = STATIC_STRING("1n8q1m83dly1l8318y1m83*Lyu");
    temp = regenerate_optimized_constant(string_constant_76);
    ...
    Qtitle_bar_caption_text = STATIC_SYMBOL("TITLE-BAR-CAPTION-TEXT",
	    AB_package);
    string_constant_35 = STATIC_STRING("User Mode Alias Creation");
    string_constant_36 = STATIC_STRING("User Settings Editor");
    ...
    Qcannot_find_g2_ok_file = STATIC_SYMBOL("CANNOT-FIND-G2-OK-FILE",
	    AB_package);
    string_constant_39 = STATIC_STRING("~a \"~a\" ~a ~a ~a");
    ...
    array_constant_33 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_33,(SI_Long)0L,(SI_Long)34L);
    UBYTE_16_ISASET_1(array_constant_33,(SI_Long)1L,(SI_Long)40L);
    UBYTE_16_ISASET_1(array_constant_33,(SI_Long)6L,(SI_Long)2L);
    ...
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)6L,(SI_Long)1L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)7L,(SI_Long)57344L);
    array_constant_35 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)0L,(SI_Long)41L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)1L,(SI_Long)34L);
    ...
    array_constant_36 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)0L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)1L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)2L,(SI_Long)100L);
    ...
    string_constant_42 = STATIC_STRING("~a \"~a\" ~a ~a ~a ~a ~a");
    string_constant_43 = 
	    STATIC_STRING("Updated ~a: added a user entry for ~a");
    array_constant_37 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)0L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)1L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)2L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)3L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)4L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)5L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)14L,(SI_Long)6L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)15L,(SI_Long)57344L);
    array_constant_38 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)0L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)1L,(SI_Long)77L);
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)2L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)6L,(SI_Long)3L);
    ...
    Qcan_not_write_tmp_file = STATIC_SYMBOL("CAN-NOT-WRITE-TMP-FILE",
	    AB_package);
    string_constant_44 = STATIC_STRING("~a \"~a\" ~a ~a \"~a\" ~a ~a");
    string_constant_45 = STATIC_STRING("x");
    string_constant_46 = 
	    STATIC_STRING("Updated ~a: deleted the user entry for ~a");
    array_constant_39 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)0L,(SI_Long)109L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)1L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)2L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)3L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)4L,(SI_Long)102L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)5L,(SI_Long)121L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)6L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)7L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)8L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)9L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)10L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)11L,(SI_Long)121L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)12L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)13L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)14L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)15L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)16L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)22L,(SI_Long)17L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)23L,(SI_Long)57344L);
    array_constant_40 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)32L));
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)0L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)1L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)2L,(SI_Long)109L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)3L,(SI_Long)109L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)4L,(SI_Long)121L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)5L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)6L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)7L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)8L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)9L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)10L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)11L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)12L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)13L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)14L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)15L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)16L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)17L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)18L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)19L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)20L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)21L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)30L,(SI_Long)22L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)31L,(SI_Long)57344L);
    ...
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)7L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)8L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)9L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)10L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)11L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)12L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)13L,(SI_Long)115L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)14L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)22L,(SI_Long)15L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)23L,(SI_Long)57344L);
    string_constant_47 = 
    ...
    string_constant_125 = 
	    STATIC_STRING("13Jy83-My83ny1l83-Kpy83ty3Gy83syz83-7y3N+y83*3y3G+y83*+y3u+y83kyk83-=y3My83-By083-Ny83fy83*ky83fy");
    ...
    array_constant_42 = STATIC_ARRAY(list_constant_10,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)0L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)1L,(SI_Long)107L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)6L,(SI_Long)2L);
    ...
    string_constant_51 = STATIC_STRING("~a~%Please wait . . . ");
    string_constant_52 = 
	    STATIC_STRING("Reinstallation of authorized users completed ");
    string_constant_53 = STATIC_STRING("unsuccessfully! ERROR: ~a");
    string_constant_54 = STATIC_STRING("successfully.");
    SET_SYMBOL_FUNCTION(Qread_ok_file_again,
	    STATIC_FUNCTION(read_ok_file_again,NIL,FALSE,0,0));
    string_constant_55 = STATIC_STRING("Secure G2: (");
    string_constant_56 = STATIC_STRING("; User: ~a)  ");
    ...
    string_constant_127 = 
	    STATIC_STRING("43Dy8m83oPy1n83oPy8n8k1l8n0000000kpk0k0");
    ...
    string_constant_128 = STATIC_STRING("1q83oPy8s83-u2y09k9l");
    clear_optimized_constants();
    ...
    Qattributes_table_format = STATIC_SYMBOL("ATTRIBUTES-TABLE-FORMAT",
	    AB_package);
    string_constant_60 = STATIC_STRING("Alias name");
    string_constant_61 = STATIC_STRING("Parent user mode name");
    string_constant_62 = STATIC_STRING("Date of alias creation");
    string_constant_63 = STATIC_STRING("Who created the alias");
    string_constant_64 = STATIC_STRING("User Mode Aliases");
}
