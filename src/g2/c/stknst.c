...
Object print_op_and_constant(pc,instructions,constants,environment)
    Object pc, instructions, constants, environment;
{
    Object constant, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long constant_index, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
...
Object print_op_and_constant_long(pc,instructions,constants,environment)
    Object pc, instructions, constants, environment;
{
    Object constant_index, constant, gensymed_symbol, gensymed_symbol_1;
...
{
    Object constant_index, constant, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, x2;
    SI_Long code_constant, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    ...
    Object byte_code_stream, table_base, table_length, else_tag, tag_table;
{
    ...
    register_byte_code_tag_resolution_point(byte_code_stream,
	    gensym_cons_1(else_tag,
	    copy_list_using_gensym_conses_1(tag_table)));
    ...
    Object thing;
{
    ...
    Object amf_result, incff_1_arg, new_float, temp_1, x2, gensymed_symbol;
    Object sub_class_bit_vector, managed_number_or_value, value, type;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
    double aref_new_value;

    x_note_fn_call(206,129);
    if (FIXNUMP(thing)) {
...
{
    Object temp, x2, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(206,130);
    if ( !TRUEP(thing))
...
/* TYPECODE-MISMATCH-FOR-PLACE-REFERENCE */
Object typecode_mismatch_for_place_reference(value,value_typecode)
    Object value, value_typecode;
{
    x_note_fn_call(206,136);
    if (CONSP(value) && EQ(M_CDR(value),Qplace_reference))
	return VALUES_1(EQ(value_typecode,Item_typecode) ? T : Nil);
    else
	return VALUES_1(Nil);
}
...
static Object string_constant_72;  /* "The item named ~a cannot be referred to because it belongs to another faction." */

static Object string_constant_73;  /* "No item named ~a exists." */
    ...
    Object name;
{
    ...
    return tformat_stack_error_text_string(2,frame_with_name_qm ? ( 
	    ...
	    string_constant_72) : string_constant_73,name);
}
...
static Object string_constant_74;  /* "The attribute ~A of ~NF is read-only." */

static Object string_constant_75;  /* "The attribute ~A exists in ~NF, but the attribute contained ~
				    *                            nothing, causing this reference to fail."
				    */

static Object string_constant_76;  /* "The system defined attribute ~a of ~NF cannot be ~
...
static Object string_constant_77;  /* "The attribute ~a::~a does not exist in ~NF, since ~a is not ~
				    *                  a defined class."
				    */

static Object string_constant_78;  /* "The attribute ~a::~a does not exist in ~NF, since ~NF is not ~
				    *                  an instance of the class ~a."
				    */

static Object string_constant_79;  /* "The attribute ~a exists in ~NF, but is not defined for ~
				    *                  the superior-class ~a."
				    */

static Object string_constant_80;  /* "The attribute ~a does not exist in ~NF~a." */

static Object string_constant_81;  /* ", though this attribute is defined for other classes" */

static Object string_constant_82;  /* "" */

static Object string_constant_83;  /* "The attribute ~NS exists in ~NF, but the attribute contained ~
				    *                nothing, causing this reference to fail."
				    */

static Object string_constant_84;  /* "The attribute ~NS of ~NF contained an item which was " */

static Object string_constant_85;  /* "~a." */

static Object string_constant_86;  /* "inactive or disabled." */

static Object string_constant_87;  /* "An attempt to reference the ~A::~A of ~NF failed to return a value." */

static Object string_constant_88;  /* "An attempt to reference the ~A of ~NF failed to return a value." */

static Object Qab_structure;       /* structure */

static Object string_constant_89;  /* "The attribute ~(~a~) was not found in ~NV." */

static Object string_constant_90;  /* "The attribute ~NV was not found." */
    ...
    Object attribute, item_or_structure, class_specific_attribute_class_qm;
{
	...
	if ( !TRUEP(slot_description_qm)) {
		...
		if (evaluator_slot_info_qm &&  
		    ...
		    tformat(3,string_constant_76,attribute,item_or_structure);
	    }
	    else {
		if (class_specific_attribute_class_qm) {
			...
			gensymed_symbol_1 = class_specific_attribute_class_qm;
			gensymed_symbol_2 = 
		...
		if (temp)
			...
			tformat(4,string_constant_80,attribute,
				item_or_structure,
		...
		tformat(4,string_constant_84,slot_description_qm,
			ISVREF(item_or_structure,(SI_Long)1L),
			item_or_structure);
		temp_2 = ISVREF(slot_value_qm,(SI_Long)8L);
		if ( ! !TRUEP(CAR(temp_2))) {
		    temp_2 = ISVREF(slot_value_qm,(SI_Long)8L);
		    tformat(2,string_constant_85,CAR(temp_2));
		}
		else
		    tformat(1,string_constant_86);
	    }
	    else if (class_specific_attribute_class_qm)
		tformat(4,string_constant_87,
			class_specific_attribute_class_qm,attribute,
			item_or_structure);
	    else
	...
	PUSH_SPECIAL(Evaluation_value_writing_target_length_qm,evaluation_value_writing_target_length_qm,
		0);
	  tformat(3,string_constant_89,attribute,item_or_structure);
	POP_SPECIAL();
    }
    else
	tformat(2,string_constant_90,attribute);
    return VALUES_1(Nil);
}
...
Object Allow_inline_evaluate_role_instructions_p = UNBOUND;
    ...
    Object variable_or_parameter;
{
	...
	if (Current_model_runtime_info_qm) {
	    ...
	    PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
		    1);
	      current_model_definition_qm = Nil;
	      PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,
		      0);
		simulation_info_qm = 
	...
	if (Current_model_runtime_info_qm) {
	    ...
	    PUSH_SPECIAL(Do_not_update_simulated_value_qm,do_not_update_simulated_value_qm,
		    0);
	      if (SIMPLE_VECTOR_P(variable_or_parameter) && 
		      EQ(ISVREF(variable_or_parameter,(SI_Long)0L),
		      Qg2_defstruct_structure_name_temporary_constant_g2_struct)) 
...
static Object string_constant_91;  /* "Error in evaluator.  The out of line evaluator #~a did not exist.  Please ~
...
{
    x_note_fn_call(206,149);
    return tformat_stack_error_text_string(2,string_constant_91,
	    evaluator_number);
}
...
static Object string_constant_92;  /* "funcall-instruction emitter" */

static Object string_constant_93;  /* "No instruction description for funcalled-instruction ~a." */
...
Object emit_funcall_instruction_byte_codes varargs_1(int, n)
{
	...
	return compiler_bug(3,string_constant_92,string_constant_93,
    ...
    Object item_or_place, pretty_slot_name, class_qualifier_qm, top_of_stack;
{
	...
	temp_1 = 
		make_evaluation_place_reference_to_place(gensym_list_4(Qattribute,
	...
	if (temp_2) {
		...
		if ( !TRUEP(visible_slot_qm)) {
			...
			if (actual_name_qm && actual_slot_description_qm 
			    ...
			    gensymed_symbol = 
				    make_gensym_list_1(FIX((SI_Long)5L));
...
{
    x_note_fn_call(206,155);
    return VALUES_1(Nil);
}

Object Procedure_start_time = UNBOUND;

Object Procedure_end_time = UNBOUND;

Object Procedure_current_time = UNBOUND;

Object Execution_time_stack = UNBOUND;
...
static Object string_constant_94;  /* "At most 255 values can be returned, ~a in this statement." */
...
{
    x_note_fn_call(206,158);
    write_byte_code_to_stream(byte_code_stream,FIX((SI_Long)55L));
    if (IFIX(values_to_return) > (SI_Long)255L)
	return compiler_error(2,string_constant_94,values_to_return);
    else
	return write_byte_code_to_stream(byte_code_stream,values_to_return);
}

static Object string_constant_95;  /* "Procedure ~NF is requesting ~a values and ~NF can return only ~a." */
...
{
    x_note_fn_call(206,159);
    return tformat_stack_error_text_string(5,string_constant_95,
    ...
    Object returning_code_body_invocation;
{
	...
	argument_strings_for_trace = gensym_cons_1(temp_1,
	...
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    next_loop:
	      ...
	      goto next_loop;
	    end_loop:;
	      reclaim_gensym_list_1(return_value_strings);
...
static Object string_constant_96;  /* "Attempted to call a remote procedure across ~NF, but could not because ~
...
{
    x_note_fn_call(206,167);
    return tformat_stack_error_text_string(2,string_constant_96,
	    non_icp_interface);
}

static Object string_constant_97;  /* "Calling remote procedure ~NF(" */

static Object string_constant_98;  /* ") across ~NF." */
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  Forgive_long_procedure_instruction_qm = T;
		  tformat(2,string_constant_97,remote_procedure);
		  write_procedure_argument_list(argument_list);
		  tformat(2,string_constant_98,icp_interface);
		  gensymed_symbol = copy_out_current_wide_string();
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
...
Object abort_called_code_bodies_function()
{
    ...
    Object code_body, code_bodies_next_tail, gensym_cons, cdr_new_value;
    Declare_special(1);
    Object result;

    x_note_fn_call(206,171);
    called_code_bodies = ISVREF(Current_computation_instance,(SI_Long)13L);
    if (called_code_bodies) {
	called_code_bodies_copy = 
		copy_list_using_gensym_conses_1(called_code_bodies);
	...
	end_loop:
	  if (called_code_bodies_copy &&  !((SI_Long)0L == 
	      ...
	      gensym_cons = called_code_bodies_copy;
	    next_loop_1:
	      inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	      if (EQ(gensym_cons,code_bodies_tail))
		  goto end_1;
	  ...
	  cdr_new_value = Available_gensym_conses;
	  M_CDR(code_bodies_tail) = cdr_new_value;
	  Available_gensym_conses = called_code_bodies_copy;
...
static Object string_constant_99;  /* "open role iteration emitter" */

static Object string_constant_100;  /* "Iterations can only handle zero or one domain roles, not ~a domains." */
...
{
    x_note_fn_call(206,174);
    if (IFIX(domain_count) != (SI_Long)0L && IFIX(domain_count) != (SI_Long)1L)
	compiler_bug(3,string_constant_99,string_constant_100,domain_count);
    register_byte_code_tag_resolution_point(byte_code_stream,no_values_tag);
...
Object emit_call_scheduled_code_body_byte_codes(byte_code_stream,
    ...
    Object byte_code_stream, code_body_number, argument_count;
{
    x_note_fn_call(206,180);
    write_byte_code_to_stream(byte_code_stream,FIX((SI_Long)69L));
    write_byte_code_to_stream(byte_code_stream,code_body_number);
    return write_byte_code_to_stream(byte_code_stream,argument_count);
}

static Object string_constant_101;  /* "Attempted to get a value from ~NF, but it was not a ~a." */

static Object string_constant_102;  /* "Expected some kind of value, but received ~NV." */
    ...
    Object thing, class_1;
{
	...
	temp = TRUEP(Nil);
    return tformat_stack_error_text_string(3,temp ? string_constant_101 : 
	    string_constant_102,thing,class_1);
}
...
{
    x_note_fn_call(206,187);
    return tformat_stack_error_text_string(1,string_constant_103);
}
...
{
    x_note_fn_call(206,188);
    if ((SI_Long)1L <= IFIX(Warning_message_level))
	return give_warning_1(2,FIX((SI_Long)1L),string_constant_104);
    else
	return VALUES_1(Nil);
}
...
static Object string_constant_105;  /* "An unknown type of current computation instance was encountered in ~
...
Object clean_up_wake_ups_state_if_any()
{
	...
	if (temp) {
		...
		give_warning_1(2,FIX((SI_Long)1L),string_constant_105);
	}
    }
    return VALUES_1(Nil);
}
...
{
    Object temp, gensymed_symbol, gensymed_symbol_1, type_name;
    ...
    Object old_structure_being_reclaimed, temp_2;
    Object def_structure_schedule_task_variable, task;
    char gensymed_symbol_2, temp_1, future_task_schedule_modify_arg_6;
    char svref_new_value;
    double float_delay, arg, arg_1, gensymed_symbol_3;
    double future_task_schedule_modify_arg_3, aref_new_value;

    x_note_fn_call(206,193);
	...
	if (SIMPLE_VECTOR_P(gensymed_symbol)) {
	    ...
	    temp_1 = TRUEP(Nil);
	if (temp_1) {
	    future_task_schedule_modify_arg_2 = gensymed_symbol_1;
	    future_task_schedule_modify_arg_3 = gensymed_symbol_3;
	    future_task_schedule_modify_arg_6 = gensymed_symbol_2;
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qwake_up_code_body_invocation);
	    future_task_schedule_modify_arg_11 = gensymed_symbol;
	    schedule_task_qm = ISVREF(gensymed_symbol,(SI_Long)7L);
	    if (schedule_task_qm) {
		...
		temp_2 = Chain_of_available_schedule_tasks;
	    ...
	    SVREF(gensymed_symbol,FIX((SI_Long)7L)) = task;
	}
	else {
	    future_task_schedule_modify_arg_2 = gensymed_symbol_1;
	    future_task_schedule_modify_arg_3 = gensymed_symbol_3;
...
static Object string_constant_106;  /* "Attempted to call ~NF as a function, but it is an instance of the class ~(~a~)." */

/* NOT-A-FUNCTION-MESSAGE */
Object not_a_function_message(non_function)
    Object non_function;
{
    x_note_fn_call(206,196);
    return tformat_stack_error_text_string(3,string_constant_106,
...
{
    x_note_fn_call(206,197);
    return VALUES_1(Nil);
}

static Object string_constant_107;  /* "Can't call the function ~NF because its status is not OK." */
...
static Object string_constant_108;  /* "Argument number ~a to the foreign function ~NF was the ~
    ...
    Object argument_count, top_of_stack;
{
  ...
  next_loop:
	...
	temp = tformat_stack_error_text_string(4,string_constant_108,
...
static Object string_constant_109;  /* "Calling ~NF with ~a arguments, it requires 1." */

static Object string_constant_110;  /* "The tabular function ~NF, can not take the value ~NV." */

static Object string_constant_111;  /* "The tabular function ~NF, given the value ~NV, did not return a value." */

static Object Qtrue;               /* true */

static Object Qfalse;              /* false */

static Object string_constant_112;  /* "~A ~NF ~A, ~A.  ~A ~A.  ~A" */

static Object string_constant_113;  /* "The tabular function" */

static Object string_constant_114;  /* "returned a datum which is not a number" */

static Object string_constant_115;  /* "symbol, truth value, or text" */

static Object string_constant_116;  /* "This is an internal G2 error caused by" */

static Object string_constant_117;  /* "some unusual use of tabular functions" */

static Object string_constant_118;  /* "Please report this bug to Gensym software support." */
    ...
    Object arg_count;
{
    ...
    x_note_fn_call(206,199);
    if (IFIX(arg_count) != (SI_Long)1L)
	return tformat_stack_error_text_string(3,string_constant_109,
		tabular_function,arg_count);
    gensymed_symbol = tabular_function;
    temp = ISVREF(gensymed_symbol,(SI_Long)8L);
    if ( ! !TRUEP(CAR(temp)))
	return tformat_stack_error_text_string(2,string_constant_107,
		gensymed_symbol);
	...
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(3,string_constant_111,
		tabular_function,evaluation_value_qm);
	return raw_stack_error_named_error(top_of_stack_1,message_1);
    }
    else if (FIXNUMP(value));
	...
	return tformat_stack_error_text_string(8,string_constant_112,
		string_constant_113,tabular_function,string_constant_114,
...
static Object string_constant_119;  /* "Unknown thing ~a given as argument to tabular function." */
    ...
    Object argument, unknown_ok_qm, top_of_stack;
{
	...
	if (temp) {
	    ...
	    temp_1 = tformat_stack_error_text_string(2,string_constant_119,
		    argument);
	    return VALUES_2(Nil,temp_1);
	}
    }
...
static Object string_constant_120;  /* "The recursion limit ~a has been exceeded while attempting to call ~NF.  ~a, ~a" */

static Object string_constant_121;  /* "The stack has overflowed while attempting to call the function ~NF.  ~
				     *          There are currently ~a function calls on the stack.  ~a."
				     */

static Object string_constant_122;  /* "The function ~NF received ~a arguments, but it requires ~a." */
    ...
    Object stack_program_counter_init, byte_code_body, constant_vector;
{
    ...
    if (recursion_depth > IFIX(ISVREF(Inference_engine_parameters,
	    (SI_Long)22L)))
	return tformat_stack_error_text_string(5,string_constant_120,
	...
	return tformat_stack_error_text_string(4,string_constant_122,
...
static Object string_constant_123;  /* "Calling function ~NF(" */
    ...
    Object function_definition, local_stack, top_of_stack, argument_count;
{
	...
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		    0);
	      tformat(2,string_constant_123,function_definition);
...
static Object string_constant_124;  /* " from function ~NF." */
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  twrite_beginning_of_wide_string(array_constant_85,
			  FIX((SI_Long)7L));
	      tformat(2,string_constant_124,Current_computation_frame);
	      result = copy_out_current_wide_string();
	    POP_SPECIAL();
	  POP_SPECIAL();
	POP_SPECIAL();
...
static Object string_constant_125;  /* " ~NF" */

static Object string_constant_126;  /* " ~NV" */
    ...
    Object argument;
{
	...
	return tformat(2,string_constant_126,argument);
}

static Object string_constant_127;  /* "calling ~(~a~):" */
    ...
    Object function_name, arguments;
{
	...
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		    0);
	      tformat(2,string_constant_127,function_name);
	      argument = Nil;
...
static Object string_constant_128;  /* "returning:" */
...
static Object string_constant_129;  /* "The number of arguments to the System Procedure ~a is ~
				     *              beyond the maximum allowed.  Please report this error to ~
				     *              Gensym Software Support."
				     */

static Object string_constant_130;  /* "Attempting to make a system call to ~A, which is not defined.  ~
				     *              Please report this G2 internal error to Gensym software support."
				     */

static Object string_constant_131;  /* "System call tracing limit reached." */

static Object string_constant_132;  /* "Missing return value ~a in System Procedure.  Please ~
    ...
    Object expected_return_value_count;
{
    ...
    Object new_1, svref_new_value, arg, ab_loop_list_, top_of_stack_1;
    Object message_1, gensymed_symbol, arg1_qm, arg2_qm, arg3_qm, arg4_qm;
    Object arg5_qm, arg6_qm, arg7_qm, arg8_qm, arg9_qm, arg10_qm, temp_2;
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(stack_value,Nil);
    if (ab_loopvar__1)
  ...
  end_1:;
	...
	if (IFIX(argument_count) > (SI_Long)10L) {
	    ...
	    top_of_stack_1 = Cached_top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_130,lisp_function_name);
	    raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
	...
	switch (INTEGER_TO_CHAR(argument_count)) {
	  case 0:
	    ...
	    break;
	  case 1:
	    temp_2 = SYMBOL_FUNCTION(lisp_function_name);
	    result = FUNCALL_1(temp_2,arg1_qm);
	    break;
	  case 2:
	    temp_2 = SYMBOL_FUNCTION(lisp_function_name);
	    result = FUNCALL_2(temp_2,arg1_qm,arg2_qm);
	    break;
	  case 3:
	    temp_2 = SYMBOL_FUNCTION(lisp_function_name);
	    result = FUNCALL_3(temp_2,arg1_qm,arg2_qm,arg3_qm);
	    break;
	  case 4:
	    temp_2 = SYMBOL_FUNCTION(lisp_function_name);
	    result = FUNCALL_4(temp_2,arg1_qm,arg2_qm,arg3_qm,arg4_qm);
	    break;
	  case 5:
	    temp_2 = SYMBOL_FUNCTION(lisp_function_name);
	    result = FUNCALL_5(temp_2,arg1_qm,arg2_qm,arg3_qm,arg4_qm,arg5_qm);
	    break;
	  case 6:
	...
	if (FIXNUMP(Trace_system_calls_p)) {
		...
		notify_user_at_console(1,string_constant_131);
  ...
  next_loop_2:
	...
	top_of_stack_1 = Cached_top_of_stack;
	message_1 = tformat_stack_error_text_string(2,string_constant_132,
	...
	if (return_values) {
	  ...
	  end_loop_3:
	    ...
	    temp_1 = Available_gensym_conses;
	    M_CDR(last_1) = temp_1;
	    Available_gensym_conses = return_values;
	}
    }
	...
	reversed_return_value_list_qm = gensym_cons_1(return_value_qm,
  ...
  next_loop_4:
    ...
    goto next_loop_4;
  end_loop_4:;
    reclaim_gensym_list_1(return_values);
    reclaim_gensym_list_1(reversed_return_value_list_qm);
...
static Object string_constant_133;  /* "~a is not a defined class." */

static Object Qnot_user_instantiable;  /* not-user-instantiable */

static Object string_constant_134;  /* "In a CREATE statement, attempted to make an instance of ~a, ~
				     *          but you cannot instantiate a class which is not a final ~
				     *          menu choice."
				     */

static Object string_constant_135;  /* "When creating transient instances of the class ~a, you should not ~
				     *          use the additional CONNECTED grammar."
				     */

static Object string_constant_136;  /* "The connection style specifier ~
				     *          in a CREATE action evaluated to ~s ~
				     *          which is not one of the valid styles diagonal, or orthogonal."
				     */

static Object string_constant_137;  /* "The connection direction specifier in a CREATE action evaluated to ~s ~
...
Object execute_create_connection_stack_instruction_internal(class_1,
    ...
    Object top_of_stack;
{
    Object delta_list_qm, top_of_stack_1, message_1, gensymed_symbol;
    ...
    Object validated_elt, x2, delta_tail_qm, number, cdr_new_value;
    Object portname_1_qm_temp, position_1_qm_temp, side_1_qm_temp;
    Object make_new_stub_1_qm_temp, end_1_item_temp;
    Object transient_connection_error_qm, new_transient_connection_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5, next_index, length_1;
    char temp_2;
    Declare_special(1);
    Object result;

    x_note_fn_call(206,210);
    delta_list_qm = Nil;
    if (position_1_qm)
	position_1_qm = l_round(position_1_qm,_);
    if (position_2_qm)
  ...
  end_4:;
    ...
    if ( !temp_2) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_135,class_1);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_135,class_1);
	    raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
    if (style_qm &&  !TRUEP(memq_function(style_qm,Valid_styles))) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_136,style_qm);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_136,style_qm);
	    raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
    if (direction_qm &&  !TRUEP(memq_function(direction_qm,
		Valid_directions))) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_137,direction_qm);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_137,direction_qm);
	    raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
	...
	ab_loopvar__2 = gensym_cons_1(element,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	if (NUMBERP(temp_1))
	    delta_list_qm = 
		    copy_list_using_gensym_conses_1(vertices_list_or_constant_vertex_list_qm);
    }
    else {
	...
	if (temp_2) {
	  ...
	  next_loop_9:
		...
		delta_list_qm = gensym_cons_1(ltruncate(NUM_GT(number,
		...
		number = evaluation_quantity_value(element);
		temp_1 = FIX((SI_Long)0L);
		cdr_new_value = gensym_cons_1(ltruncate(NUM_GT(number,
			temp_1) ? add(number,float_constant) : 
			minus(number,float_constant),_),Nil);
		M_CDR(delta_tail_qm) = cdr_new_value;
    ...
    PUSH_SPECIAL(Transient_connection_error_qm,transient_connection_error_qm,
	    0);
	  ...
	  reclaim_gensym_list_1(delta_list_qm);
...
static Object string_constant_138;  /* "A CREATE action could not make a connection to the ~
    ...
    Object end_item_qm, top_of_stack;
{
    ...
    x_note_fn_call(206,211);
    if (end_item_qm && no_manual_connections_p(end_item_qm)) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_138,end_item_qm);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_138,end_item_qm);
	    return raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
    else
...
static Object string_constant_139;  /* "A connection side specifier in a CREATE action evaluated to ~s ~
    ...
    Object side_qm, top_of_stack;
{
    ...
    x_note_fn_call(206,212);
    if (side_qm &&  !TRUEP(memq_function(side_qm,Valid_sides))) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_139,side_qm);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_139,side_qm);
	    return raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
    else
...
static Object string_constant_140;  /* "A connection end position specifier in a CREATE action evaluated to ~s ~
    ...
    Object position_qm, top_of_stack;
{
    ...
    x_note_fn_call(206,213);
    if (position_qm &&  !(IFIX(position_qm) >= (SI_Long)0L)) {
	if (Disable_stack_error)
	    return tformat_text_string(2,string_constant_140,position_qm);
	else {
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_140,position_qm);
	    return raw_stack_error_named_error(top_of_stack_1,message_1);
	}
    }
    else
...
static Object string_constant_141;  /* "In a CREATE action, attempt to make a connection between ~NF and ~NF ~
...
static Object string_constant_144;  /* "In a CREATE action, attempt to make a connection to ~NF was ~
    ...
    Object error_qm, top_of_stack;
{
	...
	if (EQ(kind_of_error,Qnot_same_workspace))
	    ...
	    format_string = string_constant_144;
	else
	    format_string = Qnil;
	if (Disable_stack_error)
...
static Object string_constant_145;  /* "  ~a = " */

static Object string_constant_146;  /* "~%" */

static Object string_constant_147;  /* "In ~a" */

static Object string_constant_148;  /* " {about to execute instruction ~a}." */

static Object string_constant_149;  /* "~%~%At source code line #~d." */

static Object string_constant_150;  /* "~%~%~a" */

static Object string_constant_151;  /* "~%~%Stack:~%" */

static Object string_constant_152;  /* "  Empty stack~%" */

static Object string_constant_153;  /* "~%Environment:~%~a" */
    ...
    Object local_stack, local_var_vector, byte_code_body;
{
    ...
    PUSH_SPECIAL(Code_body,code_body,5);
      current_wide_string_list = Qdo_not_use;
      PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		(SI_Long)3L));
	  ...
	  PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
		...
		PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		  ...
		  next_loop:
		    if (index_1 > ab_loop_bind_)
			goto end_loop;
		    tformat(2,string_constant_145,FIX(index_1));
		    write_stored_value(ISVREF(local_stack,index_1));
		    tformat(1,string_constant_146);
		    index_1 = index_1 + (SI_Long)1L;
		    goto next_loop;
		  end_loop:;
	...
	PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
	  ...
	  PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	    ...
	    PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	      ...
	      PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		      0);
		tformat(2,string_constant_147,procedure_and_arguments_as_text);
		tformat(2,string_constant_148,current_program_counter);
		if (source_code_qm) {
		    tformat(2,string_constant_149,line_index_qm);
		    twrite_general_string(source_code_qm);
		}
		if (halt_message_qm)
		    tformat(2,string_constant_150,halt_message_qm);
		tformat(1,string_constant_151);
		if (stack_qm)
		    twrite_general_string(stack_qm);
		else
		    tformat(1,string_constant_152);
		tformat(2,string_constant_153,env);
		message_1 = copy_out_current_wide_string();
	      POP_SPECIAL();
	    POP_SPECIAL();
	  POP_SPECIAL();
...
static Object string_constant_154;  /* "~%[ ~a~d ~a~a] " */
...
static Object string_constant_159;  /* "?" */
    ...
    Object non_word_wrapped_text, line_index;
{
  ...
  next_loop:
	...
	goto end_loop;
    tformat(5,string_constant_154,line_no < (SI_Long)10L ? 
	    string_constant_155 : string_constant_156,FIX(line_no),line_no 
	    == IFIX(line_index) ? string_constant_157 : 
...
static Object string_constant_160;  /* "Cannot show ~NF.  The show action has been restricted for this item." */
    ...
    Object local_stack, top_of_stack, constant_vector;
{
	...
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(2,string_constant_160,
		item);
	raw_stack_error_named_error(top_of_stack_1,message_1);
    }
...
Object emit_push_value_or_none_from_local_var_byte_codes(byte_code_stream,
    ...
    Object byte_code_stream, var_spot;
{
    x_note_fn_call(206,220);
    write_byte_code_to_stream(byte_code_stream,FIX((SI_Long)102L));
    write_byte_code_to_stream(byte_code_stream,SECOND(var_spot));
    return emit_typecode_to_stream(byte_code_stream,var_spot);
}

static Object string_constant_161;  /* "Top-of-stack was not -1." */

/* CHECK-STACK-ERROR-MESSAGE */
Object check_stack_error_message()
{
    x_note_fn_call(206,221);
    return tformat_stack_error_text_string(1,string_constant_161);
}
...
static Object string_constant_162;  /* " is not a valid element for the ~A ~NF." */

static Object string_constant_163;  /* "G2-array" */

static Object string_constant_164;  /* "G2-list" */
    ...
    Object g2_array_or_list, bad_item_or_datum;
{
    ...
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object x2, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    Object managed_number_or_value, temp_1, sub_class_bit_vector;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp;
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  if (gensymed_symbol && ISVREF(gensymed_symbol,(SI_Long)16L))
		      tformat(2,string_constant_125,bad_item_or_datum);
		  else {
		      gensymed_symbol_1 = bad_item_or_datum;
			  ...
			  print_constant(2,temp_1,ISVREF(bad_item_or_datum,
				  (SI_Long)2L));
		      }
		      else
		  ...
		  if (sub_class_vector_index < 
		      ...
		      temp = TRUEP(Nil);
		  tformat(3,string_constant_162,temp ? string_constant_163 
			  : string_constant_164,g2_array_or_list);
		  text_string = copy_out_current_wide_string();
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
    ...
    Object unknown_allowed_qm;
{
    ...
    Object amf_result, incff_1_arg, new_float, new_result, temp_2;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    double aref_new_value;

    x_note_fn_call(206,223);
...
static Object string_constant_165;  /* "pop-into-block-of-local-vars emitter" */

static Object string_constant_166;  /* "An invalid variable location, ~a, was given." */
    ...
    Object byte_code_stream, first_var_spot, count_1;
{
    ...
    x_note_fn_call(206,226);
    if ( !TRUEP(valid_var_spot_p(first_var_spot))) {
	compiler_bug(3,string_constant_165,string_constant_166,first_var_spot);
    ...
    Object local_vars, cache_index, value_count, target_index;
{
	...
	temp_1 = Nil;
    new_element = gensym_cons_1(value_count,temp_1);
    if ( !TRUEP(action_cache)) {
	action_cache = gensym_cons_1(gensym_cons_1(new_element,Nil),
		Qaction_cache);
	return VALUES_1(SVREF(local_vars,cache_index) = action_cache);
    }
    else {
	temp = gensym_cons_1(new_element,M_CAR(action_cache));
	return VALUES_1(M_CAR(action_cache) = temp);
    }
}

static Object string_constant_167;  /* "add to action cache byte code emitter" */
...
static Object string_constant_168;  /* "The action cache location ~a wasn't local." */

static Object string_constant_169;  /* "The initial spot ~a wasn't local." */

static Object string_constant_170;  /* "An element of the variable block was out of order or not local.  ~
    ...
    Object action_cache_var_spot, var_spot_block, location_string;
{
	...
	if ( !FIXNUMP(index_1) || IFIX(index_1) != expected_index) {
	    compiler_bug(4,location_string,string_constant_170,
...
static Object string_constant_171;  /* "An internal G2 error has occurred restoring action-cache ~
    ...
    Object local_vars, cache_index, value_count, target_index, top_of_stack;
{
	...
	if (cache_list) {
		...
		message_1 = tformat_stack_error_text_string(3,
			string_constant_171,value_count,count_1);
		raw_stack_error_named_error(top_of_stack_1,message_1);
	    }
	    if (IFIX(value_count) != (SI_Long)0L) {
		index_1 = (SI_Long)0L;
	    ...
	    inline_note_reclaim_cons(cache_to_restore,Qab_gensym);
	    temp = Available_gensym_conses;
	    M_CDR(cache_to_restore) = temp;
	    Available_gensym_conses = cache_to_restore;
	    inline_note_reclaim_cons(cache_list,Qab_gensym);
	    temp = Available_gensym_conses;
	    M_CDR(cache_list) = temp;
...
static Object string_constant_172;  /* "restore from action cache byte code emitter" */
    ...
    Object byte_code_stream, action_cache_var_spot, var_spot_block, empty_tag;
{
    ...
    x_note_fn_call(206,232);
    if (action_cache_and_var_spot_block_ok_p(action_cache_var_spot,
	    var_spot_block,string_constant_172)) {
...
Object g2_get_top_level_transient_items_and_connections()
{
	...
	end_loop:
	  ...
	  if ((SI_Long)0L != (IFIX(ISVREF(block,(SI_Long)5L)) & 
		  ...
		  & (SI_Long)262144L))))
	      pre_item_sequence = gensym_cons_1(block,pre_item_sequence);
	  ...
	  end_1:
		...
		temp = TRUEP(Nil);
	    if (temp)
		pre_connection_sequence = gensym_cons_1(connection,
    ...
    Object evaluation_sequence;
{
    ...
    x_note_fn_call(206,238);
    clear_procedure_invocations();
    items_to_delete = Nil;
	...
	goto next_loop;
      ...
      PUSH_SPECIAL(Inhibit_updating_module_related_frame_notes_for_all_workspaces_qm,inhibit_updating_module_related_frame_notes_for_all_workspaces_qm,
	      0);
...
static Object string_constant_173;  /* "NUPEC-SYNCHRONIZE" */

static Object string_constant_174;  /* "This knowledge base was written in a NUPEC enhanced ~
				     *        version of G2, but this version of G2 is not enhanced ~
				     *        for NUPEC.  The NUPEC SYNCHRONIZE instruction cannot ~
				     *        be executed."
				     */

static Object string_constant_175;  /* "In the NUPEC synchronize action, ~NF is not an instance of a class ~
				     *          containing the G2-to-G2-data-inferface capability."
				     */

static Object string_constant_176;  /* "In the NUPEC synchronize action, ~a is not a defined class." */
    ...
    Object local_stack, top_of_stack, constant_vector, arg_count;
{
    ...
    Object items_to_synchronize, item, class_1, ab_loop_list_, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    ...
    x_note_fn_call(206,239);
    if (Evaluating_simulator_procedure_qm)
	not_a_simulator_procedure_instruction(string_constant_173,
		top_of_stack);
	...
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(1,string_constant_174);
	raw_stack_error_named_error(top_of_stack_1,message_1);
    }
	...
	items_to_synchronize = gensym_cons_1(item,items_to_synchronize);
	stack_index = FIXNUM_ADD1(stack_index);
	goto next_loop;
      end_loop:;
    }
  ...
  end_4:;
	...
	reclaim_gensym_list_1(items_to_synchronize);
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(2,string_constant_176,
		class_1);
	raw_stack_error_named_error(top_of_stack_1,message_1);
    }
    goto next_loop_1;
...
Object Items_to_traverse = UNBOUND;
    ...
    Object item;
{
    ...
    x_note_fn_call(206,240);
    if (serve_item_p(item)) {
	Items_to_traverse = gensym_cons_1(item,Items_to_traverse);
...
Object variables_and_parameters_in_items(item_list)
    Object item_list;
{
    Object items_to_traverse, items_to_return, item_cons, item, cdr_new_value;
    Object sub_class_bit_vector, slot_description, class_description;
    ...
    x_note_fn_call(206,241);
    items_to_traverse = copy_list_using_gensym_conses_1(item_list);
    items_to_return = Nil;
    PUSH_SPECIAL(Items_to_traverse,items_to_traverse,1);
      item_cons = Nil;
      item = Nil;
    next_loop:
      ...
      inline_note_reclaim_cons(item_cons,Qab_gensym);
      cdr_new_value = Available_gensym_conses;
      M_CDR(item_cons) = cdr_new_value;
      Available_gensym_conses = item_cons;
      sub_class_bit_vector = ISVREF(ISVREF(item,(SI_Long)1L),(SI_Long)19L);
	  ...
	  if (sub_class_vector_index < 
	      ...
	      temp = TRUEP(Nil);
	  if (temp)
	      items_to_return = gensym_cons_1(item,items_to_return);
	...
	end_loop_1:;
	  ...
	  if (temp) {
	    ...
	    next_loop_3:
		  ...
		  temp = TRUEP(Nil);
	      if (temp ? TRUEP(serve_item_p(subblock)) : TRUEP(Nil)) {
		  Items_to_traverse = gensym_cons_1(subblock,
			  Items_to_traverse);
		  scope_conses = Scope_conses;
		  ab_node_stack_ = Nil;
		  ab_current_node_ = Nil;
		  gensymed_symbol_3 = ISVREF(subblock,(SI_Long)14L);
		  gensymed_symbol_3 = gensymed_symbol_3 ? 
			  ISVREF(gensymed_symbol_3,(SI_Long)6L) : Nil;
		  ...
		  end_2:
		    ...
		    if ((temp ? 
			    ...
			    : TRUEP(Nil))
			Items_to_traverse = 
				gensym_cons_1(connection_frame_or_class,
				Items_to_traverse);
		    goto next_loop_4;
		  end_loop_6:;
		  POP_SPECIAL();
...
static Object string_constant_177;  /* "Cannot modify the element at index ~a in ~NA.  This item is not ~
				     *          a g2-list, g2-array, or sequence in an attribute of an item."
				     */

static Object string_constant_178;  /* "An attempt was made to refer to element ~a of ~NF, but it is ~
    ...
    Object item_or_place_reference, index_1, top_of_stack;
{
	...
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(3,string_constant_177,
    ...
    if (temp) {
	top_of_stack_1 = top_of_stack;
	message_1 = tformat_stack_error_text_string(4,string_constant_178,
		index_1,item_or_place_reference,
	...
	if (stored_item_or_value_qm) {
		...
		if (temp);
		    ...
		    gensymed_symbol_4 = CDR(Defined_evaluation_value_types);
		    gensymed_symbol = SXHASH_SYMBOL_1(gensymed_symbol_3) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_1 = (SI_Long)0L;
		  next_loop:
		    if ( !TRUEP(gensymed_symbol_4))
			goto end_loop;
		    gensymed_symbol_1 = IFIX(ISVREF(gensymed_symbol_4,
			    (SI_Long)0L));
		    if (gensymed_symbol < gensymed_symbol_1)
			gensymed_symbol_4 = ISVREF(gensymed_symbol_4,
				(SI_Long)1L);
			...
			if ( !TRUEP(gensymed_symbol_4))
			    goto end_loop_1;
			gensymed_symbol_5 = M_CAR(M_CAR(gensymed_symbol_4));
			if (EQ(gensymed_symbol_3,gensymed_symbol_5)) {
			    temp = TRUEP(M_CDR(M_CAR(gensymed_symbol_4)));
			    goto end_1;
			}
	...
	temp_1 = servable_item_element_qm;
    else if (place_reference_qm) {
	svref_arg_1 = M_CAR(item_or_place_reference);
	svref_new_value = gensym_list_3(Qelement,index_1,
		ISVREF(M_CAR(item_or_place_reference),(SI_Long)0L));
	SVREF(svref_arg_1,FIX((SI_Long)0L)) = svref_new_value;
	temp_1 = item_or_place_reference;
    }
    else
	temp_1 = 
		make_evaluation_place_reference_to_place(gensym_list_3(Qelement,
...
static Object string_constant_180;  /* "An internal error has just occured in the type-check-class-inline ~
    ...
    Object thing, class_number, top_of_stack;
{
	...
	if ( !(FIXNUM_LE(FIX((SI_Long)0L),temp) && FIXNUM_LE(temp,
	    ...
	    top_of_stack_1 = top_of_stack;
	    message_1 = tformat_stack_error_text_string(2,
		    string_constant_180,class_number);
...
static Object string_constant_181;  /* "An error occured while concluding a formula result.  ~a" */
    ...
    Object problem_description;
{
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  tformat(2,string_constant_181,problem_description);
...
static Object string_constant_182;  /* " (~a)" */
    ...
    Object pc, instructions, constants, environment;
{
    ...
    return tformat(2,string_constant_182,FIX(arg));
}

static Object string_constant_183;  /* "About to execute the activity: " */

static Object string_constant_184;  /* "~%Within: " */
...
static Object string_constant_185;  /* "begin activity byte code emitter" */

static Object string_constant_186;  /* "The given activity number, ~a, was out of range." */
    ...
    Object byte_code_stream, activity, suppress_profile_qm;
{
	...
	if (FIXNUM_MINUSP(activity) || FIXNUM_GT(activity,
		...
		(SI_Long)127L) {
	    compiler_bug(3,string_constant_185,string_constant_186,activity);
...
static Object string_constant_187;  /* "The designated item does not exist." */

static Object string_constant_188;  /* "~NF cannot be referenced because it is disabled or inactive." */
    ...
    Object item_or_item_name_qm;
{
	...
	temp = string_constant_188;
    else
	temp = string_constant_187;
    return tformat_stack_error_text_string(2,temp,item_or_item_name_qm);
}

static Object Qget_faction_instance_with_name_if_any;  /* get-faction-instance-with-name-if-any */

static Object Qcurrent_faction_global;  /* current-faction-global */

/* GET-CUR-FACTION-ITEM */
Object get_cur_faction_item(item)
    Object item;
{
    Object name_or_names, name;

    x_note_fn_call(206,254);
    name_or_names = get_lookup_slot_value_given_default(item,
	    Qname_or_names_for_frame,Nil);
    name = name_or_names ? (SYMBOLP(name_or_names) ? name_or_names : 
	    M_CAR(name_or_names)) : Nil;
    return FUNCALL_SYMBOL_3(Qget_faction_instance_with_name_if_any,
	    M_CAR(SYMBOL_VALUE(Qcurrent_faction_global)),Qitem,name);
}
    ...
    Object byte_code_stream, name_constant, no_item_ok_qm;
{
    ...
    x_note_fn_call(206,255);
    write_byte_code_to_stream(byte_code_stream,FIX((SI_Long)128L));
    name_constant_cons = gensym_cons_1(name_constant,Cached_name_cons_marker);
    constant_index = 
	    register_internal_constant_in_byte_code_stream(byte_code_stream,
	    name_constant_cons);
    reclaim_gensym_cons_1(name_constant_cons);
...
static Object string_constant_189;  /* "An attribute of ~NF contained nothing, causing this reference to fail." */
    ...
    Object constant_vector_index, constant_vector_attribute_cache, item;
{
	...
	return tformat_stack_error_text_string(2,string_constant_189,item);
}
    ...
    Object class_specific_attribute_class_qm;
{
    ...
    reclaim_gensym_list_1(attribute_constant_list);
    emit_long_code_constant_to_stream(byte_code_stream,constant_index);
...
static Object string_constant_190;  /* "The g2-array ~NF contains no element at index ~a." */
...
{
    x_note_fn_call(206,260);
    return tformat_stack_error_text_string(3,string_constant_190,item,
	    index_value);
}
...
static Object string_constant_191;  /* "move-from-local-var emitter" */
...
Object emit_move_from_surrounding_local_var_byte_codes(byte_code_stream,
    ...
    Object byte_code_stream, var_spot;
{
    x_note_fn_call(206,262);
    if ( !(valid_var_spot_p(var_spot) &&  
	    !TRUEP(memq_function(CAR(var_spot),list_constant_6)))) {
	compiler_bug(3,string_constant_191,string_constant_69,var_spot);
	var_spot = list_constant_2;
    }
...
void stack_inst_INIT()
{
    ...
    Object string_constant_193, string_constant_192;
    ...
    Object Qruling_for_dial, Qdefault_junction, Qchart, Qaction_button;
    Object Qconnection_post, Qnon_kb_workspace, Qdependent_frame, Qdefinition;
    Object list_constant_29, Qfloat_array, Qinteger_array, Qitem_array;
    Object Qg2_array, Qtruth_value_list, Qtext_list, Qsymbol_list;
    Object Qquantity_list, Qfloat_list, Qinteger_list, Qitem_list, Qg2_list;
    Object Qtabular_function, Qbounding_box, Qicon_editor_table_info_frame;
    Object Qobject_definition, Qicon_editor_workspace, Qworkspace, Qentity;
    Object Qg2_window, Qarrow_button, Qtype_in_box, Qgeneric_action_button;
    Object Qbutton, Qtype_in_text_box, Qslider_needle, Qbutton_label;
    Object Qslider_readout, Qquestion_mark_box, Qrule, Qvalue_array;
    Object Qvalue_list, Qtruth_value_array, Qtext_array, Qsymbol_array;
    Object Qquantity_array, Qpprint_type_check_float_instruction;
    Object Qstack_type_check_float_body;
    ...
    string_constant_72 = 
	    STATIC_STRING("The item named ~a cannot be referred to because it belongs to another faction.");
    string_constant_73 = STATIC_STRING("No item named ~a exists.");
    ...
    string_constant_82 = STATIC_STRING("");
    string_constant_83 = 
    ...
    string_constant_85 = STATIC_STRING("~a.");
    string_constant_86 = STATIC_STRING("inactive or disabled.");
    string_constant_87 = 
    ...
    string_constant_90 = STATIC_STRING("The attribute ~NV was not found.");
    ...
    string_constant_92 = STATIC_STRING("funcall-instruction emitter");
    string_constant_93 = 
    ...
    string_constant_97 = STATIC_STRING("Calling remote procedure ~NF(");
    string_constant_98 = STATIC_STRING(") across ~NF.");
    ...
    string_constant_99 = STATIC_STRING("open role iteration emitter");
    string_constant_100 = 
    ...
    string_constant_112 = STATIC_STRING("~A ~NF ~A, ~A.  ~A ~A.  ~A");
    string_constant_113 = STATIC_STRING("The tabular function");
    string_constant_114 = 
	    STATIC_STRING("returned a datum which is not a number");
    string_constant_115 = STATIC_STRING("symbol, truth value, or text");
    string_constant_116 = 
    ...
    Recursion_warning_explanation_1 = string_constant_192;
    string_constant_193 = 
    ...
    Recursion_warning_explanation_2 = string_constant_193;
    string_constant_120 = 
    ...
    Qtracing_and_breakpoints = STATIC_SYMBOL("TRACING-AND-BREAKPOINTS",
	    AB_package);
    string_constant_123 = STATIC_STRING("Calling function ~NF(");
    ...
    string_constant_124 = STATIC_STRING(" from function ~NF.");
	...
	Trace_system_calls_p = Nil;
    string_constant_125 = STATIC_STRING(" ~NF");
    string_constant_126 = STATIC_STRING(" ~NV");
    string_constant_127 = STATIC_STRING("calling ~(~a~):");
    string_constant_128 = STATIC_STRING("returning:");
    Qfunction_keeps_procedure_environment_valid_qm = 
    ...
    string_constant_131 = STATIC_STRING("System call tracing limit reached.");
    string_constant_132 = 
    ...
    string_constant_133 = STATIC_STRING("~a is not a defined class.");
    ...
    string_constant_145 = STATIC_STRING("  ~a = ");
    string_constant_146 = STATIC_STRING("~%");
    string_constant_147 = STATIC_STRING("In ~a");
    string_constant_148 = STATIC_STRING(" {about to execute instruction ~a}.");
    string_constant_149 = STATIC_STRING("~%~%At source code line #~d.");
    string_constant_150 = STATIC_STRING("~%~%~a");
    string_constant_151 = STATIC_STRING("~%~%Stack:~%");
    string_constant_152 = STATIC_STRING("  Empty stack~%");
    string_constant_153 = STATIC_STRING("~%Environment:~%~a");
    string_constant_154 = STATIC_STRING("~%[ ~a~d ~a~a] ");
    ...
    string_constant_159 = STATIC_STRING("\t");
    ...
    make_and_register_stack_instruction_description(Qpush_value_or_none_from_local_var,
	    ...
	    Qstack_push_value_or_none_from_local_var_body,
	    SYMBOL_FUNCTION(Qpprint_push_from_local_var_instruction));
    string_constant_161 = STATIC_STRING("Top-of-stack was not -1.");
    ...
    string_constant_163 = STATIC_STRING("G2-array");
    string_constant_164 = STATIC_STRING("G2-list");
    ...
    string_constant_169 = STATIC_STRING("The initial spot ~a wasn\'t local.");
    string_constant_170 = 
    ...
    string_constant_173 = STATIC_STRING("NUPEC-SYNCHRONIZE");
    string_constant_174 = 
    ...
    make_and_register_stack_instruction_description(Qnth_element,
	    ...
	    SYMBOL_FUNCTION(Qpprint_nth_element_instruction));
    string_constant_179 = STATIC_STRING(" ~(~a~)");
    ...
    string_constant_182 = STATIC_STRING(" (~a)");
    ...
    string_constant_183 = STATIC_STRING("About to execute the activity: ");
    string_constant_184 = STATIC_STRING("~%Within: ");
    Insert_begin_activity_instruction_into_byte_code_stream_qm = T;
    string_constant_185 = STATIC_STRING("begin activity byte code emitter");
    string_constant_186 = 
	    STATIC_STRING("The given activity number, ~a, was out of range.");
    string_constant_187 = STATIC_STRING("The designated item does not exist.");
    string_constant_188 = 
	    STATIC_STRING("~NF cannot be referenced because it is disabled or inactive.");
    Qget_faction_instance_with_name_if_any = 
	    STATIC_SYMBOL("GET-FACTION-INSTANCE-WITH-NAME-IF-ANY",AB_package);
    Qcurrent_faction_global = STATIC_SYMBOL("CURRENT-FACTION-GLOBAL",
	    AB_package);
    ...
    string_constant_191 = STATIC_STRING("move-from-local-var emitter");
