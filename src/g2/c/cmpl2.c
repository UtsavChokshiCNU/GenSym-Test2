    ...
    Object left_side_of_formula_qm, focus_names, continuation_qm;
{
  ...
  next_loop:
    ...
    PUSH_SPECIAL(List_of_known_names,list_of_known_names,1);
      if (Compiling_rule_p)
      ...
      PUSH_SPECIAL(Compiling_antecedent_p,compiling_antecedent_p,0);
...
Object Forward_compiled_antecedent = UNBOUND;

Object Forward_compiled_consequent_qm = UNBOUND;
    ...
    Object forward_reference_compiled_consequent_expression_qm, focus_names;
{
    ...
    forward_compiled_antecedent = 
	    forward_reference_compiled_antecedent_expression;
    PUSH_SPECIAL(Forward_compiled_antecedent,forward_compiled_antecedent,1);
      forward_compiled_consequent_qm = 
	      forward_reference_compiled_consequent_expression_qm;
      PUSH_SPECIAL(Forward_compiled_consequent_qm,forward_compiled_consequent_qm,
	      0);
	inverse_references_for_designations = Nil;
	focus_name = Nil;
...
Object In_non_top_level_context_qm = UNBOUND;
    ...
    Object expression_for_compilation;
{
    ...
    PUSH_SPECIAL(Inside_action_iteration_p,inside_action_iteration_p,0);
    ...
    Object expression_for_compilation;
{
    ...
    PUSH_SPECIAL(In_non_top_level_context_qm,in_non_top_level_context_qm,0);
...
Object Iteration_forms_for_embedded_expressions_qm = UNBOUND;

Object Insertion_location_for_embedded_expressions_qm = UNBOUND;

static Object Qcontext_iteration_forms;  /* context-iteration-forms */
    ...
    Object expression_for_compilation;
{
	...
	PUSH_SPECIAL(Iteration_forms_for_embedded_expressions_qm,iteration_forms_for_embedded_expressions_qm,
		3);
	  insertion_location_for_embedded_expressions_qm = Nil;
	  PUSH_SPECIAL(Insertion_location_for_embedded_expressions_qm,insertion_location_for_embedded_expressions_qm,
		  2);
	    ...
	    PUSH_SPECIAL(Local_iteration_forms,local_iteration_forms,1);
    ...
    Object compiling_with_focus_qm, rule_keyword;
{
    ...
    PUSH_SPECIAL(Compiled_consequent_2,compiled_consequent_2,0);
...
void compile2_INIT()
{
    ...
    Object Qcompile2, Qin_non_top_level_context_qm, Qchange_icon_color;
    Object Qconclude_has_no_value, Qconclude_has_no_current_value;
    Object Qconclude_not, Qconclude, Qcreate_by_cloning, Qcreate_connection;
    Object Qconnected_between, Qsub_expression, Qcreate_explanation, Qcreate;
