...
Object Current_new_table = UNBOUND;

Object Current_cell = UNBOUND;

Object Current_row = UNBOUND;

Object Current_column = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Row_maximum,
...
Object exit_part_feature_row_maximum()
{
    ...
    Row_maximum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Column_maximum = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Column_maximum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_column_maximum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Column_maximum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Cell_contents = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Cell_contents,
	    Part_feature_recall_stack);
...
Object exit_part_feature_cell_contents()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Cell_contents = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Text_value = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Text_value,
	    Part_feature_recall_stack);
...
Object exit_part_feature_text_value()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Text_value = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Column_width = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Column_width,
	    Part_feature_recall_stack);
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Row_height,
	    Part_feature_recall_stack);
    ...
    Object new_table, cell_format_or_none, gensymed_symbol;
{
    ...
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,2);
	  ...
	  result = VALUES_1(SVREF(new_table,FIX((SI_Long)19L)) = 
		  cell_format_or_none);
      }
      else {
	  erase_part_of_block(new_table,ISVREF(new_table,(SI_Long)19L));
	  if (Noting_changes_to_kb_p)
	      note_change_to_block_1(new_table,Qdefault_cell_format);
	  SVREF(new_table,FIX((SI_Long)19L)) = cell_format_or_none;
	  ...
	  PUSH_SPECIAL(Projection_focus_annotation,projection_focus_annotation,
	    ...
	    POP_SPECIAL();
	  POP_SPECIAL();
	  result = redraw_part_of_block(ISVREF(new_table,(SI_Long)19L));
      }
    POP_SPECIAL();
    return result;
}
    ...
    Object new_table, computation_style_or_none, initializing_qm;
{
    ...
    SVREF(new_table,FIX((SI_Long)20L)) = computation_style_or_none;
    if ( !TRUEP(initializing_qm))
	recompile_item(new_table);
    return VALUES_1(computation_style_or_none);
}
...
Object compile_table_dimensions_for_slot varargs_1(int, n)
{
	...
	result = compile_part_description(table_dimensions_parse,Qnew_table);
...
static Object Qrow_maximum;        /* row-maximum */
...
static Object Qcolumn_maximum;     /* column-maximum */
    ...
    Object freeform_table, new_cell_annotations, initializing_qm;
{
	...
	if ( !TRUEP(initializing_qm)) {
	    current_annotated_frame = freeform_table;
	    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,0);
	      reclaim_part_description(ISVREF(freeform_table,(SI_Long)18L));
	    POP_SPECIAL();
	}
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(freeform_table,Qcell_annotations);
	return VALUES_2(SVREF(freeform_table,FIX((SI_Long)18L)) = 
	...
	PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	  ...
	  PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,0);
	    ...
	    if (edit_action)
		table_block_insert_or_delete(freeform_table,row_index,
			column_index,edit_action,count_1);
	    if ((SI_Long)0L < IFIX(column_delta))
		result = VALUES_3(Qadd_column,column_delta,FIX((SI_Long)0L));
    ...
    Object feature_value, new_table;
{
    ...
    Object gensymed_symbol, expression_cell_qm, evaluation_value;
    Object wide_string_bv16, result_1, gensymed_symbol_2;
	...
	if (FIXNUMP(subfeature_value))
		...
		eval_value = gensym_cons_1(gensymed_symbol,Qtruth_value);
	}
	else
	...
	if (EQ(subfeature_name,Qexpression_cell_index)) {
		...
		expression_cell_qm = FIXNUM_LE(ISVREF(managed_array_qm,
			...
			(SI_Long)2L),IFIX(subfeature_value) & (SI_Long)1023L);
		if (expression_cell_qm && ISVREF(expression_cell_qm,
			(SI_Long)6L)) {
		    temp = eval_attrs_struct;
		    evaluation_value = ISVREF(expression_cell_qm,(SI_Long)6L);
    ...
    Object feature_value;
{
    ...
    Object amf_result, incff_1_arg, new_float, gensymed_symbol;
    double aref_new_value;
...
static Object Qtext_value;         /* text-value */
  ...
  next_loop:
	...
	if (EQ(feature_name,Qcell_contents)) {
		...
		width = UBYTE_16_ISAREF_1(expression_of_cell_qm,length_1 - 
			(SI_Long)2L) + 
			((UBYTE_16_ISAREF_1(expression_of_cell_qm,length_1 
		...
		if (expression_cell_qm && ISVREF(expression_cell_qm,
		    ...
		    evaluation_value = ISVREF(expression_cell_qm,(SI_Long)6L);
		    set_evaluation_structure_slot(cell_structure,
			    Qcell_display_value,FIXNUMP(evaluation_value) 
			    || evaluation_value && 
		...
		set_evaluation_structure_slot(cell_structure,Qcell_format,
			format_structure_qm);
	    }
    ...
    Object new_expression_value, new_eval_attrs, expression_type;
{
	...
	if ( !(expression_p || tracing_substruct_p)) {
	    ab_loopvar__2 = gensym_cons_1(new_subfeature_name,Nil);
	    if (ab_loopvar__1)
	...
	if ( !(expression_p || tracing_substruct_p)) {
	    ab_loopvar__2 = gensym_cons_1(CONSP(new_subfeature_value) && 
	...
	if (tracing_substruct_p) {
	  ...
	  next_loop_1:
	    ...
	    ab_loopvar__4 = gensym_cons_1(internal_tracing_name,Nil);
	    if (ab_loopvar__3)
		M_CDR(ab_loopvar__3) = ab_loopvar__4;
	    else
		ab_loopvar__2 = ab_loopvar__4;
	    ab_loopvar__3 = ab_loopvar__4;
	    ab_loopvar__4 = gensym_cons_1(tracing_value,Nil);
	    if (ab_loopvar__3)
		M_CDR(ab_loopvar__3) = ab_loopvar__4;
	    else
		ab_loopvar__2 = ab_loopvar__4;
	...
	temp = Nil;
    new_expression_description = gensym_cons_1(Qcompiled_cell_expression,temp);
    ...
    PUSH_SPECIAL(Current_edit_state,current_edit_state,0);
	  ...
	  temp = nconc2(new_expression_description,
		  gensym_list_2(Qexpression_cell_index,
	  ...
	  new_cell_expression = gensym_cons_1(temp,new_eval_attrs ? 
    ...
    Object new_eval_attrs;
{
    ...
    PUSH_SPECIAL(Current_cell,current_cell,1);
      PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,0);
    ...
    Object new_value;
{
    ...
    i = (SI_Long)0L;
    current_row = Nil;
    PUSH_SPECIAL(Current_row,current_row,1);
    ...
    next_loop:
      ...
      j = (SI_Long)0L;
      current_cell = Nil;
      PUSH_SPECIAL(Current_cell,current_cell,0);
	ab_loop_iter_flag_ = T;
	held_vector_1 = M_CAR(gensymed_symbol);
	length_2 = IFIX(ISVREF(held_vector_1,(SI_Long)1L));
      next_loop_1:
	  ...
	  end_loop_2:
		...
		if (SYMBOLP(new_format_value))
			...
			temp = 
				...
				gensym_list_2(Qexpression_source_text,
				CDR(compiled_cell_expression_or_bad_phrase)));
			reclaim_gensym_cons_1(compiled_cell_expression_or_bad_phrase);
    ...
    Object freeform_table;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = 
	    gensym_cons_1(make_sequence_of_freeform_table_row(freeform_table,
	    row_part),Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,2);
	  PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	    ...
	    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,0);
	      ...
	      svref_new_value = make_table_annotation(Qrow,new_row_maximum,
		      FIX((SI_Long)1L));
    ...
    Object new_table;
{
    ...
    Object column_maximum, current_annotated_frame, svref_new_value, new_value;
    Object function_qm;
  ...
  end_1:;
	...
	if (temp);
	    ...
	    temp = FIX((SI_Long)4L);
	row_maximum = temp;
	PUSH_SPECIAL(Row_maximum,row_maximum,3);
	  temp = get_simple_part_feature(cell_annotations_for_class_1,
		  Qcolumn_maximum);
	  if (temp);
	  else
	      temp = FIX((SI_Long)3L);
	  column_maximum = temp;
	  PUSH_SPECIAL(Column_maximum,column_maximum,2);
	    current_annotated_frame = new_table;
	    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,1);
	      ...
	      svref_new_value = 
		      ...
		      class_description,Nil),(SI_Long)6L);
	      SVREF(new_table,FIX((SI_Long)20L)) = svref_new_value;
	      new_value = make_frame(Qg2_cell_array);
	      initialize_slot_description_value(new_table,
...
static Object Qrow_height;         /* row-height */

static Object Qcolumn_width;       /* column-width */
    ...
    Object which_kind, row_count, column_count;
{
    ...
    Object incff_1_arg, new_float, prototype_cell, gensymed_symbol;
    Object gensymed_symbol_1, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    Object ab_loopvar__3, ab_loopvar__4, temp_2, result_1;
    ...
    PUSH_SPECIAL(Row_maximum,row_maximum,1);
      column_maximum = columnwise_p ? column_count : FIX((SI_Long)1L);
      PUSH_SPECIAL(Column_maximum,column_maximum,0);
	if (EQ(which_kind,Qrow)) {
	    ...
	    prototype_cell = gensym_list_3(Qcell,Qrow_height,new_float);
	}
	    ...
	    prototype_cell = gensym_list_3(Qcell,Qcolumn_width,new_float);
	}
	...
	if (column_index > ab_loop_bind__1)
	    goto end_loop_1;
	ab_loopvar__4 = gensym_cons_1(copy_for_slot_value(prototype_cell),Nil);
	if (ab_loopvar__3)
	    M_CDR(ab_loopvar__3) = ab_loopvar__4;
	else
	    ab_loopvar__2 = ab_loopvar__4;
	...
	temp_2 = Qnil;
      end_1:;
	ab_loopvar__2 = gensym_cons_1(gensym_list_3(Qrow,Qsubparts,
		gensym_list_2(Qcell,temp_2)),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	temp_2 = Qnil;
      end_2:;
	temp = gensym_list_2(Qrow,temp_2);
	M_CAR(gensymed_symbol_1) = temp;
    ...
    Object new_table, g2_cell_array, cell_index, old_value_qm, new_value_qm;
{
    ...
    Object cell_part, temp_2, item_or_value, svref_new_value, arg_lists;
    Object arg_list, ab_loop_list__1, arg_list_to_send;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5, svref_arg_2;
    char temp;
    Declare_special(2);
    Object result;
	...
	if ( !(temp ? TRUEP(evaluation_value_eql(2,old_value_qm,
	    ...
	    PUSH_SPECIAL(Notification_data_version_map,notification_data_version_map,
		    1);
	      if (SIMPLE_VECTOR_P(new_table) && 
		      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(new_table)) > 
		      (SI_Long)2L &&  !EQ(ISVREF(new_table,(SI_Long)1L),
		  ...
		  if (temp) {
		      ...
		      temp_1 = get_workspace_if_any(new_table);
	      }
	      else if (SIMPLE_VECTOR_P(new_table) && EQ(ISVREF(new_table,
		      (SI_Long)0L),
		      Qg2_defstruct_structure_name_connection_g2_struct))
		  temp_1 = workspace_of_connection_qm(new_table);
	      else
		  temp_1 = Qnil;
	      if (temp_1) {
		  if (SIMPLE_VECTOR_P(new_table) && 
		...
		next_loop_5:
		  ...
		  ab_loop_list_ = M_CDR(ab_loop_list_);
		  gensymed_symbol_1 = ISVREF(representation,(SI_Long)3L);
		  ...
		  if ( !temp ? 
		    ...
		    next_loop_6:
			  ...
			  if ( !TRUEP(evaluatedp)) {
			      ...
			      PUSH_SPECIAL(Current_lookup_data,current_lookup_data,
				      0);
				result = expression_cell_index_to_cell_coordinates(3,
					cell_index,new_table,T);
				MVS_4(result,cell_x,cell_y,cell,cell_part);
				if (cell_x && cell_y && cell && cell_part) {
				    cell_attribute_name = 
				    ...
				    if (FIXNUM_LE(ISVREF(gensymed_symbol_1,
					    (SI_Long)1L),
					...
					temp_2 = ISVREF(gensymed_symbol_1,
						(gensymed_symbol_2 >>  -  
						- (SI_Long)10L) + (SI_Long)2L);
					svref_arg_2 = gensymed_symbol_2 & 
						(SI_Long)1023L;
					...
					temp_2 = ISVREF(gensymed_symbol_1,
						(SI_Long)2L);
					SVREF(temp_2,FIX((SI_Long)7L)) = 
						Qcell_attribute_name;
				    }
				    if (FIXNUM_LE(ISVREF(gensymed_symbol_1,
					    (SI_Long)1L),
					    Maximum_in_place_array_size)) {
					item_or_value = cell_attribute_name;
					if (SIMPLE_VECTOR_P(item_or_value) 
						&& 
						IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
						> (SI_Long)2L &&  
					...
					svref_new_value = temp ? 
						get_reference_to_item(item_or_value) 
						: item_or_value;
					SVREF(temp_2,FIX((SI_Long)10L)) = 
						svref_new_value;
				    }
				    temp_1 = 
					    gensym_cons_1(gensymed_symbol_1,
					    Qab_structure);
				}
				else
				    temp_1 = Nil;
				send_versioned_ws_notification_internal(Qitem_change,
					new_table,temp_1);
				version_or_data = Current_lookup_data;
			      POP_SPECIAL();
    ...
    return VALUES_1(cell_updated_qm);
}
...
Object expression_cell_index_to_cell_coordinates varargs_1(int, n)
{
  ...
  next_loop_1:
    ...
    bg_color_expression_cell_index_qm = bg_color_qm && CONSP(bg_color_qm) ?
	     get_simple_part_feature(bg_color_qm,Qexpression_cell_index) : 
	    Qnil;
    cell_contents_qm = get_simple_part_feature(cell_part,Qcell_contents);
    compiled_cell_expression_qm = cell_contents_qm ? CAR(cell_contents_qm) 
	    : Qnil;
    expression_cell_index_qm = compiled_cell_expression_qm && 
	    EQ(CAR(compiled_cell_expression_qm),Qcompiled_cell_expression) 
  ...
  end_1:;
    if (resulting_x)
	return VALUES_4(resulting_x,resulting_y,resulting_cell_qm,
		cell_part_name_qm);
...
Object Postpone_cell_erase_until_redraw_p = UNBOUND;

Object Background_color_value_from_postponed_erase = UNBOUND;

Object Text_value_from_postponed_erase = UNBOUND;

Object Reclaim_text_value_from_postponed_erase_p = UNBOUND;

Object Updated_only_qm = UNBOUND;
    ...
    Object new_table, cell_index, old_value_qm, new_value_qm;
{
	...
	return cell_updated_in_paint_mode(new_table,cell_index,
		old_value_qm,new_value_qm);
    else {
	projection_focus_method = Qcell;
	projection_focus_cell_index = cell_index;
	PUSH_SPECIAL(Projection_focus_cell_index,projection_focus_cell_index,
		7);
	  PUSH_SPECIAL(Projection_focus_method,projection_focus_method,6);
	    ...
	    updated_only_qm = T;
	    PUSH_SPECIAL(Updated_only_qm,updated_only_qm,5);
	      PUSH_SPECIAL(Reclaim_text_value_from_postponed_erase_p,reclaim_text_value_from_postponed_erase_p,
		      4);
		PUSH_SPECIAL(Text_value_from_postponed_erase,text_value_from_postponed_erase,
			3);
		  PUSH_SPECIAL(Background_color_value_from_postponed_erase,background_color_value_from_postponed_erase,
			  2);
		    PUSH_SPECIAL(Postpone_cell_erase_until_redraw_p,postpone_cell_erase_until_redraw_p,
			    1);
			  ...
			  expression_cell = ISVREF(ISVREF(temp,
				  (IFIX(cell_index) >>  -  - (SI_Long)10L) 
				  + (SI_Long)2L),IFIX(cell_index) & 
				  (SI_Long)1023L);
		      }
		      ...
		      PUSH_SPECIAL(Projection_focus_cell_new_cached_value,projection_focus_cell_new_cached_value,
			      0);
			gensymed_symbol = 
...
Object Off_window_color_map = UNBOUND;
    ...
    Object new_table, cell_index, old_value_qm, new_value_qm;
{
    ...
    PUSH_SPECIAL(Projection_focus_cell_new_cached_value,projection_focus_cell_new_cached_value,
	    2);
      PUSH_SPECIAL(Projection_focus_cell_index,projection_focus_cell_index,1);
	PUSH_SPECIAL(Projection_focus_method,projection_focus_method,0);
	...
	PUSH_SPECIAL(Current_drawing_priority,current_drawing_priority,13);
	  current_annotated_frame = new_table;
	  PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,12);
	    projection_mode = Qinvalidate_projection_mode;
	    PUSH_SPECIAL(Projection_mode,projection_mode,11);
		...
		PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			9);
		  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,8);
		    PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
			    7);
		      current_background_color_value = FIX((SI_Long)0L);
		      current_foreground_color_value = FIX((SI_Long)0L);
		      current_color_map = Off_window_color_map;
		      PUSH_SPECIAL(Current_color_map,current_color_map,6);
			PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
			  ...
			  PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
			    ...
			    PUSH_SPECIAL(Current_thing_changed,current_thing_changed,
				    3);
			      PUSH_SPECIAL(Current_kind_of_change,current_kind_of_change,
				      2);
				PUSH_SPECIAL(Projection_focus_cell_index,projection_focus_cell_index,
					1);
    ...
    Object new_table, cell_index;
{
    ...
    current_annotated_frame = new_table;
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,11);
      projection_mode = Qcompute_path_of_focus_projection_mode;
      projection_focus_method = Qcell;
      projection_focus_cell_index = cell_index;
      projection_focus_path = Nil;
      PUSH_SPECIAL(Projection_focus_path,projection_focus_path,10);
	PUSH_SPECIAL(Projection_focus_cell_index,projection_focus_cell_index,
		9);
	  PUSH_SPECIAL(Projection_focus_method,projection_focus_method,8);
	    PUSH_SPECIAL(Projection_mode,projection_mode,7);
	      current_image_x_scale = FIX((SI_Long)4096L);
	      current_image_y_scale = FIX((SI_Long)4096L);
	      current_x_origin_of_drawing = FIX((SI_Long)0L);
	      current_y_origin_of_drawing = FIX((SI_Long)0L);
		...
		PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			5);
		  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,4);
		    PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
			    3);
		      current_background_color_value = FIX((SI_Long)0L);
		      current_foreground_color_value = FIX((SI_Long)0L);
		      current_color_map = Off_window_color_map;
		      PUSH_SPECIAL(Current_color_map,current_color_map,2);
			PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
				1);
			  PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
				  0);
		...
		POP_SPECIAL();
	      ...
	      result = make_evaluation_place_reference_to_place(component_accessor,
		      new_table);
	    POP_SPECIAL();
	  POP_SPECIAL();
	POP_SPECIAL();
    ...
    Object new_table, cell_index, include_denotation_for_block;
{
	...
	denote_component_of_block(2,include_denotation_for_block,
		component_accessor);
	return reclaim_evaluation_place_reference(place_reference);
    }
}
    ...
    Object new_table, component_particulars;
{
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,3);
	  parent_part_description = simple_eval(parent_component_particulars);
	  if (parent_part_description && 
		...
		PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
			1);
		  current_annotated_frame = new_table;
		  PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,
			  0);
		    if (EQ(part_feature,Qcell_contents))
			result = recompile_component_of_part_description(parent_part_description,
				part_feature,Qcell_expression_and_text);
    ...
    Object path, root;
{
  ...
  end_loop_1:;
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(reversed_path);
    ...
    Object new_table;
{
    ...
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,1);
      ...
      PUSH_SPECIAL(Projection_mode,projection_mode,0);
	result = project_new_table();
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
...
{
    Object row, column, subpart_description_qm, projection_mode;
    Object current_tracking_x_in_window, current_tracking_y_in_window;
    Object create_subpart_upon_tracking_p, current_tracking_subcomponent;
    Declare_special(5);
    ...
    current_tracking_subcomponent = gensym_list_3(Nil,Nil,Nil);
    PUSH_SPECIAL(Current_tracking_subcomponent,current_tracking_subcomponent,
	    4);
      PUSH_SPECIAL(Create_subpart_upon_tracking_p,create_subpart_upon_tracking_p,
	      3);
	PUSH_SPECIAL(Current_tracking_y_in_window,current_tracking_y_in_window,
		2);
	  PUSH_SPECIAL(Current_tracking_x_in_window,current_tracking_x_in_window,
		  1);
	    PUSH_SPECIAL(Projection_mode,projection_mode,0);
	      project_new_table();
	      row = FIRST(Current_tracking_subcomponent);
	      column = SECOND(Current_tracking_subcomponent);
	      subpart_description_qm = THIRD(Current_tracking_subcomponent);
	      reclaim_gensym_list_1(Current_tracking_subcomponent);
	    POP_SPECIAL();
	  POP_SPECIAL();
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    return VALUES_4(Current_annotated_frame,row,column,subpart_description_qm);
}

Object The_type_description_of_new_table_spot = UNBOUND;

Object Chain_of_available_new_table_spots = UNBOUND;

Object New_table_spot_count = UNBOUND;
    ...
    Object new_table_spot;
{
    ...
    svref_new_value = Chain_of_available_new_table_spots;
    SVREF(new_table_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_new_table_spots = new_table_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_new_table_spot_structure_internal()
{
    ...
    Object new_table_spot_count_new_value;
    ...
    new_table_spot_count_new_value = FIXNUM_ADD1(New_table_spot_count);
    New_table_spot_count = new_table_spot_count_new_value;
...
Object Chain_of_available_new_table_cell_spots = UNBOUND;

Object New_table_cell_spot_count = UNBOUND;
    ...
    Object new_table_cell_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_new_table_cell_spots;
    SVREF(new_table_cell_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_new_table_cell_spots = new_table_cell_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_new_table_cell_spot_structure_internal()
{
    ...
    Object new_table_cell_spot_count_new_value;
    ...
    new_table_cell_spot_count_new_value = 
	    FIXNUM_ADD1(New_table_cell_spot_count);
    New_table_cell_spot_count = new_table_cell_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_new_table_background_spots = UNBOUND;

Object New_table_background_spot_count = UNBOUND;
    ...
    Object new_table_background_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_new_table_background_spots;
    SVREF(new_table_background_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_new_table_background_spots = new_table_background_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_new_table_background_spot_structure_internal()
{
    ...
    Object new_table_background_spot_count_new_value;
    ...
    new_table_background_spot_count_new_value = 
	    FIXNUM_ADD1(New_table_background_spot_count);
    ...
    Object new_table, mouse_pointer;
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,25);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,24);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,23);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,22);
	    temp = left_edge_within_pane(ISVREF(image_plane,(SI_Long)19L),
		    image_plane);
	    ...
	    temp = right_edge_within_pane(ISVREF(image_plane,(SI_Long)21L),
		    image_plane);
	    Right_edge_of_draw_area = FIXNUM_MIN(temp,Right_edge_of_draw_area);
		...
		PUSH_SPECIAL(Current_window,current_window_1,21);
		  ...
		  PUSH_SPECIAL(Drawing_on_window,drawing_on_window,20);
			...
			PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,
			  ...
			  current_color_map = ISVREF(Current_window,
				  (SI_Long)20L);
			  PUSH_SPECIAL(Current_color_map,current_color_map,16);
						  ...
						  PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
							...
							PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
							  ...
							  PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,
							    ...
							    result = push_last_spot(mouse_pointer,
								    temp,
								    new_table);
							  POP_SPECIAL();
							POP_SPECIAL();
    ...
    Object new_table, kind_of_change, what_changed;
{
    ...
    current_annotated_frame = new_table;
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,10);
      projection_mode = Qupdate_dependencies;
      current_kind_of_change = kind_of_change;
      current_thing_changed = what_changed;
      PUSH_SPECIAL(Current_thing_changed,current_thing_changed,9);
	PUSH_SPECIAL(Current_kind_of_change,current_kind_of_change,8);
	  PUSH_SPECIAL(Projection_mode,projection_mode,7);
	    current_image_x_scale = FIX((SI_Long)4096L);
	    current_image_y_scale = FIX((SI_Long)4096L);
	    current_x_origin_of_drawing = FIX((SI_Long)0L);
	    ...
	    PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	      ...
	      PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		      5);
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,4);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,3);
		    current_background_color_value = FIX((SI_Long)0L);
		    current_foreground_color_value = FIX((SI_Long)0L);
		    current_color_map = Off_window_color_map;
		    PUSH_SPECIAL(Current_color_map,current_color_map,2);
...
Object update_new_table_size()
{
    ...
    PUSH_SPECIAL(Maximum_height,maximum_height,1);
      PUSH_SPECIAL(Maximum_width,maximum_width,0);
	gensymed_symbol = 
		ISVREF(ISVREF(ISVREF(ISVREF(Current_annotated_frame,
		(SI_Long)1L),(SI_Long)11L),(SI_Long)46L),(SI_Long)1L);
	gensymed_symbol_1 = Current_annotated_frame;
...
Object project_new_table()
{
    ...
    Object old_current_part_description, new_cons, gensymed_symbol, temp_1;
    Object old_current_part_description_1, old_current_part_description_2;
    Object old_current_part_description_3, block_background_color;
    Object block_background_color_value;
    ...
    Object background_color_feature_value, focus_enabled_qm_1, temp_3;
    Object cell_expression, gensymed_symbol_3, new_text_value, svref_new_value;
    Object svref_arg_1, color_or_metacolor, text_cell_background_color_value;
    Object old_color_value_2, erase_instead_qm, supress_text_qm;
    Object x_magnification_qm, y_magnification_qm, magnified_x_scale;
    Object magnified_y_scale, scale, value, temp_4, new_background_color_value;
    ...
    SI_Long bottom_edge_of_row_in_window, temp_2;
    ...
    PUSH_SPECIAL(Current_text_cell_plist,current_text_cell_plist,13);
      PUSH_SPECIAL(Current_text_box_format,current_text_box_format,12);
	PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
		11);
	  PUSH_SPECIAL(Current_computation_style,current_computation_style,10);
	    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
	      ...
	      PUSH_SPECIAL(Maintain_stack_of_current_part_descriptions_p,maintain_stack_of_current_part_descriptions_p,
		      8);
		PUSH_SPECIAL(Stack_of_current_part_descriptions,stack_of_current_part_descriptions,
			7);
		  PUSH_SPECIAL(Part_feature_recall_stack,part_feature_recall_stack,
			  6);
		    ...
		    block_background_color = dragging_qm ? Qtransparent : 
			...
			block_background_color_value = 
			    ...
			    EQ(block_background_color,Qworkspace_foreground))
			block_background_color_value = 
				Current_foreground_color_value;
		    ...
		    PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
			  ...
			  gensymed_symbol_2 = 
				  ...
				  right_edge_of_block));
		      right_edge_of_block_in_window = gensymed_symbol_1 + 
			      gensymed_symbol_2;
			  ...
			  gensymed_symbol_2 = 
				  IFIX(scalef_function(Current_image_y_scale,
				  bottom_edge_of_block));
		      bottom_edge_of_block_in_window = gensymed_symbol_1 + 
			      gensymed_symbol_2;
		      ...
		      if (suppress_details_qm) {
			  border_color = ISVREF(Current_text_box_format,
				  (SI_Long)23L);
			  if (border_color);
			  else
			      border_color = Qblack;
			  ...
			  if (IFIX(Current_image_y_scale) == (SI_Long)4096L)
				  ...
				  < row_border_height && row_border_height 
			  ...
			  if (focus_enabled_qm) {
			      if ( !EQ(Qtransparent,block_background_color)) {
				  old_color_value_1 = 
					  Current_background_color_value;
				  current_background_color_value = 
					  Current_background_color_value;
			  ...
			  Projection_focus_path = 
				  gensym_cons_1(gensym_list_3(Qpart_description_of_frame,
				  gensym_list_2(Qquote,Qcell_annotations),
				  Qit),Projection_focus_path);
			  Projection_focus_path = 
				  gensym_cons_1(copy_for_slot_value(list_constant_9),
				  Projection_focus_path);
		      }
		      else if (EQ(Projection_mode,
		    ...
		    next_loop:
		      ...
		      bottom_edge_of_row_in_window = gensymed_symbol_1 + 
			      gensymed_symbol_2;
		      temp_2 = bottom_edge_of_row_in_window + 
			      row_border_height_in_window;
		      bottom_of_lower_row_border_in_window = MIN(temp_2,
			      bottom_edge_of_block_in_window);
		      if (EQ(Projection_mode,Qdraw_projection_mode) || 
			      EQ(Projection_mode,Qdenote_projection_mode) 
			      || EQ(Projection_mode,
			      Qcompute_path_of_focus_projection_mode) || 
			      EQ(Projection_mode,Qcleanup_projection_mode))
			  temp = T;
		      else if (EQ(Projection_mode,Qtracking_projection_mode))
			  temp = top_edge_of_row_in_window < 
				  IFIX(Current_tracking_y_in_window) ? 
				  (IFIX(Current_tracking_y_in_window) < 
				  bottom_edge_of_row_in_window ? T : Nil) :
				   Qnil;
		      else if (EQ(Projection_mode,Qupdate_dependencies) || 
			      EQ(Projection_mode,
				  Qinvalidate_projection_mode)) {
			  if (EQ(Current_kind_of_change,Qsize))
			      temp = row_index == IFIX(Row_maximum) ? T : Nil;
			    ...
			    next_loop_1:
				  ...
				  computed_feature_qm = CAR(cell_contents_qm);
			      else if (evaluated_computed_part_feature_p(background_color_qm))
				  computed_feature_qm = background_color_qm;
			      else
				  computed_feature_qm = Nil;
			  ...
			  if (EQ(Projection_mode,
				  Qcompute_path_of_focus_projection_mode))
			      Projection_focus_path = 
				      gensym_cons_1(copy_for_slot_value(list_constant_10),
				      Projection_focus_path);
			next_loop_2:
			  if (column_index > ab_loop_bind__1)
			      goto end_loop_2;
			  if ( !TRUEP(ab_loop_list__2))
			      goto end_loop_2;
			  column_default_cell_subpart = M_CAR(ab_loop_list__2);
			  ab_loop_list__2 = M_CDR(ab_loop_list__2);
			  ...
			  color_value = EQ(Projection_mode,
				  ...
				  Current_background_color_value : 
				  Current_background_color_value;
			  old_color_value_1 = Current_background_color_value;
			  current_background_color_value = 
				  Current_background_color_value;
			  PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
				  4);
			    ...
			    PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
				  ...
				  if (INLINE_DOUBLE_FLOAT_VECTOR_P(Current_width_of_formatted_part) 
				      ...
				      temp = Current_width_of_formatted_part;
				  column_width_as_fixnum = ltruncate(temp,_);
			      }
			      ...
			      right_edge_of_column_in_window = 
				      gensymed_symbol_1 + gensymed_symbol_2;
			      temp_2 = right_edge_of_column_in_window + 
				      column_border_width_in_window;
				  ...
				  if (EQ(Projection_mode,
				      ...
				      M_FIFTH(temp_1) = FIX(fifth_new_value);
				      Projection_focus_path = 
					      gensym_cons_1(copy_for_slot_value(focus_is_on_cell_contents 
					      ? list_constant_11 : 
					      list_constant_12),
					      Projection_focus_path);
				      wrapup_scan_flag = T;
					  ...
					  temp_1 = 
						  Current_tracking_subcomponent;
					  M_SECOND(temp_1) = FIX(column_index);
					  temp_1 = 
						  Current_tracking_subcomponent;
					  temp_3 = Current_part_description;
					  M_THIRD(temp_1) = temp_3;
					  wrapup_scan_flag = T;
				      }
				  }
				  else if (EQ(Projection_mode,
					  ...
					  svref_new_value = ISVREF(temp_1,
						  (SI_Long)23L);
					  svref_arg_1 = 
						  Current_text_box_format;
					  temp_3 = ISVREF(svref_arg_1,
						  (SI_Long)24L);
					  if (Noting_changes_to_kb_p)
					      note_change_to_block_1(temp_1,
						      Qtext_cell_line_color_qm);
					  SVREF(temp_1,FIX((SI_Long)23L)) 
						  = temp_3;
					  if (Noting_changes_to_kb_p)
					      note_change_to_block_1(svref_arg_1,
					...
					if (Postpone_cell_erase_until_redraw_p 
					    ...
					    PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
					      ...
					      set_current_background_color_value(color_value);
					      erase_instead_qm = T;
					      PUSH_SPECIAL(Erase_instead_qm,erase_instead_qm,
						      0);
						supress_text_qm = 
							suppress_details_qm;
						if (supress_text_qm);
					...
					if (Erase_instead_qm && 
					    ...
					    Background_color_value_from_postponed_erase 
						    = 
						    gensym_cons_1(gensym_cons_1(temp_4,
						    temp),
						    Background_color_value_from_postponed_erase);
					}
					else if ( 
					    ...
					    changing_colors_of_graphic_elements_qm 
						    = 
						    Changing_colors_of_graphic_elements_qm;
					    PUSH_SPECIAL(Changing_colors_of_graphic_elements_qm,changing_colors_of_graphic_elements_qm,
						    0);
					      if (Postpone_cell_erase_until_redraw_p)
						  Changing_colors_of_graphic_elements_qm 
							  = T;
			...
			end_loop_2:
			  if (EQ(Projection_mode,Qupdate_dependencies)) {
			      if (EQ(Current_kind_of_change,Qsize)) {
				  Maximum_width = FIX(column_border_width 
					  + IFIX(right_edge_of_column) - 
					  IFIX(left_edge_of_block));
				  Maximum_height = FIX(row_border_height + 
    ...
    Object datum, width;
{
	...
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    temp_1 = convert_text_string_to_text(temp_1);
    return format_text(8,temp_1,Current_text_box_format,
    ...
    Object part_description, subpart_type, index_of_subpart_to_delete_init;
{
    ...
    PUSH_SPECIAL(Subparts,subparts,0);
      bit_to_reclaim = Nil;
    ...
    Object target_table, row_index, column_index, edit_action, count_1;
{
    ...
    Object current_flag_state_qm, slot_description, new_cons, gensymed_symbol;
    Object gensymed_symbol_1, cdr_new_value, stack_of_slot_value_changes;
    Object gensymed_symbol_2, gensymed_symbol_3, incff_1_arg, temp, temp_1;
    Object decff_1_arg, target_row_part_description, ab_loop_list_;
    ...
    Object next_cons;
    SI_Long svref_new_value, ab_loop_repeat_;
    char temp_2;
    Declare_special(1);
    Object result;
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(target_table,
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  gensymed_symbol_2,gensymed_symbol_3);
	  svref_new_value = IFIX(ISVREF(target_table,(SI_Long)5L)) | 
		  (SI_Long)16777216L;
	  ISVREF(target_table,(SI_Long)5L) = FIX(svref_new_value);
      }
      if (EQ(edit_action,Qadd_row)) {
	  incff_1_arg = count_1;
	  final_row_maximum = FIXNUM_ADD(final_row_maximum,incff_1_arg);
	  temp = make_table_annotation(Qrow,count_1,original_column_maximum);
	  temp_1 = make_table_annotation(Qcell,count_1,
		  original_column_maximum);
	  result = VALUES_3(temp,Nil,temp_1);
      }
      else if (EQ(edit_action,Qadd_column)) {
	  incff_1_arg = count_1;
	  final_column_maximum = FIXNUM_ADD(final_column_maximum,incff_1_arg);
	  temp = make_table_annotation(Qcolumn,original_row_maximum,count_1);
	  temp_1 = make_table_annotation(Qcell,original_row_maximum,count_1);
	  result = VALUES_3(Nil,temp,temp_1);
      }
	...
	next_loop_1:
	  ...
	  goto next_loop_1;
	end_loop_1:;
	  temp_1 = get_subpart_collection(target_column_annotations,
		  Qsubparts,Qrow);
	  temp_1 = FIRST(temp_1);
	  temp = get_subpart_collection(insert_column_annotations,
		  Qsubparts,Qrow);
	  insert_subpart_descriptions(temp_1,FIRST(temp),Qcell,column_index);
      }
      else if (EQ(edit_action,Qdelete_column)) {
	  ab_loop_repeat_ = IFIX(count_1);
	next_loop_2:
	...
	end_loop_3:;
	  temp_1 = get_subpart_collection(target_column_annotations,
		  Qsubparts,Qrow);
	  delete_subpart(FIRST(temp_1),Qcell,column_index);
	  goto next_loop_2;
	end_loop_2:;
      }
	...
	next_loop_4:
	  ...
	  ab_loop_it_ = temp_2 ? (EQ(target_table,
    ...
    Object new_table, edit_action, image_plane, x_in_window, y_in_window;
{
    ...
    current_annotated_frame = new_table;
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,44);
      current_block_of_dependent_frame = new_table;
      PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	      43);
	...
	PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,42);
	  PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,41);
	    PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,40);
	      PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,39);
		current_image_x_scale = FIX((SI_Long)4096L);
		current_image_y_scale = FIX((SI_Long)4096L);
		current_x_origin_of_drawing = FIX((SI_Long)0L);
		current_y_origin_of_drawing = FIX((SI_Long)0L);
												  ...
												  PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
												    ...
												    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,
													  ...
													  cell_subpart 
														  ...
														  result);
													  result = start_edit_of_annotation_subexpression(4,
														  Current_annotated_frame,
														  cell_subpart,
													  ...
													  MVS_3(result,
														  ...
														  row_index,
														  column_index);
													  result = table_block_insert_or_delete(table,
    ...
    Object original_x_in_window, original_y_in_window;
{
	...
	return VALUES_1(Nil);
    current_annotated_frame = freeform_table;
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,21);
      current_window_1 = ISVREF(ISVREF(image_plane,(SI_Long)2L),(SI_Long)2L);
      PUSH_SPECIAL(Current_window,current_window_1,20);
	drawing_on_window = Nil;
	PUSH_SPECIAL(Drawing_on_window,drawing_on_window,19);
	  current_drawing_transfer_mode = EQ(Current_drawing_transfer_mode,
		  Kxor) ? Current_drawing_transfer_mode : 
		  ISVREF(Current_window,(SI_Long)30L);
	  PUSH_SPECIAL(Current_drawing_transfer_mode,current_drawing_transfer_mode,
		  18);
	    type_of_current_window = ISVREF(Current_window,(SI_Long)1L);
	    PUSH_SPECIAL(Type_of_current_window,type_of_current_window,17);
	      current_native_window_qm = ISVREF(Current_window,(SI_Long)17L);
	      PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,
		      16);
		current_color_map = ISVREF(Current_window,(SI_Long)20L);
		PUSH_SPECIAL(Current_color_map,current_color_map,15);
		  temp = ISVREF(Current_color_map,(SI_Long)5L);
		  if (temp);
		  else
		      temp = map_to_color_value_1(Qwhite);
			...
			PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			  ...
			  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,
			    ...
			    PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
			      ...
			      PUSH_SPECIAL(Current_frame_transform_qm,current_frame_transform_qm,
				      8);
				current_pane = ISVREF(image_plane,(SI_Long)2L);
				current_image_plane = image_plane;
				loose_left_edge_of_visible_workspace_area 
					= ISVREF(image_plane,(SI_Long)23L);
				loose_top_edge_of_visible_workspace_area = 
					ISVREF(image_plane,(SI_Long)24L);
				loose_right_edge_of_visible_workspace_area 
					= ISVREF(image_plane,(SI_Long)25L);
				loose_bottom_edge_of_visible_workspace_area 
					= ISVREF(image_plane,(SI_Long)26L);
				color_or_metacolor = ISVREF(image_plane,
					(SI_Long)5L) ? 
					ISVREF(ISVREF(image_plane,
					...
					PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
					  ...
					  PUSH_SPECIAL(Current_image_plane,current_image_plane,
						...
						if (row_index && 
							...
							result = change_in_freeform_table_dimensions_is_ok_p(freeform_table,
								FIX(row_delta),
								FIX(column_delta));
						}
						else
...
Object Current_description_of_new_table = UNBOUND;
...
Object describe_new_table()
{
    ...
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,11);
      ...
      PUSH_SPECIAL(Current_description_of_new_table,current_description_of_new_table,
	      10);
	PUSH_SPECIAL(Projection_focus_method,projection_focus_method,9);
	  PUSH_SPECIAL(Current_projection_function_for_funcall,current_projection_function_for_funcall,
		  8);
	    PUSH_SPECIAL(Projection_mode,projection_mode,7);
	      current_image_x_scale = FIX((SI_Long)4096L);
	      current_image_y_scale = FIX((SI_Long)4096L);
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	      result = VALUES_1(Current_description_of_new_table);
	    POP_SPECIAL();
	  POP_SPECIAL();
	POP_SPECIAL();
      POP_SPECIAL();
...
static Object Qformatted_part;     /* formatted-part */
    ...
    Object why_called;
{
    ...
    temp_1 = gensym_cons_1(copy_text_string(string_constant_11),Nil);
    temp_2 = describe_part_from_current_extent(Qcomputation_style_description);
    temp_3 = gensym_cons_1(copy_text_string(string_constant_12),Nil);
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		...
		next_loop_1:
		  ...
		  if (part_has_feature_p(outstanding_part_description,
		      ...
		      ab_loopvar__4 = gensym_list_2(temp,
	    ...
	    end_loop:
	      ...
	      temp = Qnil;
	    end_2:;
	      cummulative_part_description = gensym_cons_1(part_type,temp);
	      write_part_description(4,cummulative_part_description,T,
		      FIX((SI_Long)5L),T);
	      reclaim_gensym_list_1(cummulative_part_description);
...
void new_tables_INIT()
{
    ...
    Object AB_package, Qnamed_dynamic_extent_description;
    Object Qprojecting_to_collect_description_for_new_table, list_constant_136;
    Object Qnew_tables, Qprojection_funcall_on_focus, list_constant_126;
    ...
    Object Qprojection_of_new_table_accumulating_size, list_constant_127;
    Object Qprojection_update_dependencies, Qupdate_part_dependencies;
    ...
    Object Qnew_table_background_spot_count;
    Object Qchain_of_available_new_table_background_spots, string_constant_38;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_37, Qunique_structure_type_of_ab_name_qm;
    Object Qab_name_of_unique_structure_type;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qnew_table_cell_spot;
    Object Qoutstanding_new_table_cell_spot_count;
    Object Qnew_table_cell_spot_structure_memory_usage;
    Object Qnew_table_cell_spot_count;
    Object Qchain_of_available_new_table_cell_spots, string_constant_36;
    Object string_constant_35, Qnew_table_spot;
    Object Qoutstanding_new_table_spot_count;
    Object Qnew_table_spot_structure_memory_usage, Qnew_table_spot_count;
    Object Qchain_of_available_new_table_spots, string_constant_34;
    Object string_constant_33, Qdraw, Qdraw_for_new_table;
    ...
    Object Qinitialize_off_window_color_map, list_constant_125;
    Object Qoff_window_color_map, Kfuncall, Qexpression_cell_updated;
    Object Qexpression_cell_updated_for_new_table;
    Object Qupdate_frame_status_and_notes;
    Object Qupdate_frame_status_and_notes_for_new_table, list_constant_124;
    Object Qsubpart_defaults, list_constant_123, list_constant_122;
    Object list_constant_121, Qborder_color, string_constant_32;
    Object Qinitialize_after_reading, Qinitialize_after_reading_for_new_table;
    Object Qinitialize, Qinitialize_for_new_table, Qset_table_cells;
    Object Qget_table_cells, Qinitial_table_cells, list_constant_120;
    Object list_constant_119, list_constant_117, list_constant_118;
    Object list_constant_116, list_constant_115, list_constant_114, Qab_or;
    Object list_constant_113, list_constant_112, list_constant_111;
    Object list_constant_110, list_constant_109, list_constant_108;
    Object list_constant_87, list_constant_107, list_constant_106;
    Object list_constant_105, Qmay_request_data_seeking;
    Object Qmay_request_event_updates, Qtime_out_when_requesting_data_seeking;
    Object Qupdate_only_when_shown, Qvalue_domain, Qinitial_scan_wait_interval;
    Object Qscan_interval, Qpriority, list_constant_90, list_constant_88;
    Object list_constant_104, list_constant_103, list_constant_102, Qtext_size;
    Object Qtext_alignment, Qtext_color, list_constant_101, list_constant_100;
    Object list_constant_99, list_constant_98, list_constant_97;
    Object list_constant_96, Qextra_large, Qlarge, Qsmall, list_constant_95;
    Object Qright, Qcenter, Qleft, list_constant_67, list_constant_94;
    Object list_constant_93, list_constant_92, list_constant_91;
    Object list_constant_89, list_constant_86, list_constant_85;
    Object list_constant_84, list_constant_83, list_constant_82;
    Object list_constant_81, list_constant_80, list_constant_79;
    Object list_constant_70, list_constant_57, list_constant_78;
    Object list_constant_77, list_constant_76, list_constant_75;
    Object list_constant_74, list_constant_73, list_constant_72;
    Object list_constant_71, list_constant_69, Qg2_simulator;
    Object Qinference_engine, list_constant_68, list_constant_66;
    Object list_constant_65, Qdatum, Qtext, Qab_class;
    Object Qvirtual_attributes_local_to_class, list_constant_64;
    ...
    Object string_constant_31, string_constant_30, Qreduce_annotation;
    Object Qslot_value_writer, Qwrite_table_dimensions_from_slot;
    Object list_constant_55, Qtable_size, string_constant_29;
    Object string_constant_28, string_constant_27, string_constant_26;
    Object string_constant_25, list_constant_54, string_constant_24;
    ...
    Object string_constant_18, list_constant_53, string_constant_17;
    ...
    Object string_constant_13, list_constant_45, Qtable_dimension_p;
    Object list_constant_32, Qexit_subpart_exceptions;
    Object Qenter_subpart_exceptions, Qsubpart_exceptions, list_constant_37;
    Object list_constant_29, Qexit_subpart_defaults, Qenter_subpart_defaults;
    Object list_constant_26, Qexit_part_feature_subparts;
    Object Qenter_part_feature_subparts, list_constant_44, list_constant_38;
    Object list_constant_40, list_constant_39, Qparts, list_constant_43;
    ...
    Object list_constant_36, list_constant_33, list_constant_35;
    Object list_constant_34, Qline_color, Qhidden_features, list_constant_25;
    Object list_constant_31, list_constant_30, Qcall_handlers;
    Object list_constant_28, list_constant_27, list_constant_24;
    Object list_constant_23, list_constant_22, list_constant_21;
    Object list_constant_20, Qbasic_part, Qediting_new_table, list_constant_18;
    Object list_constant_17, Qworking_on_new_table, Qfor_image_plane;
    Object list_constant_16, Qworking_on_annotated_frame;
    ...
    string_constant_13 = STATIC_STRING("is not in the range from 1 to 100");
    Qtype_error_printer = STATIC_SYMBOL("TYPE-ERROR-PRINTER",AB_package);
    mutate_global_property(Qtable_dimension,string_constant_13,
	    Qtype_error_printer);
    ...
    string_constant_15 = 
	    STATIC_STRING("1p4z8r83ZIy83ZIy839Uy839Uy00001n1l8o1l8l1l83Cy000004z8r83IFy83IFy839Uy839Uy00001n1l8o1l8l1l83Cy000004z8r833jy833jy839Uy839Uy0000");
    string_constant_16 = 
    ...
    string_constant_17 = STATIC_STRING("32wy00000");
    string_constant_18 = 
	    STATIC_STRING("1r8q1m839Uy1l9k1p83ZIy08o8l83Cy1p83IFy08o8l83Cy1p833jy08o8l83Cy1q833py08o8l83Cy1m8p832vy1q833qy08o8l83Cy1m8p832wy");
    temp = regenerate_optimized_constant(string_constant_14);
    temp_2 = regenerate_optimized_constant(LIST_3(string_constant_15,
    ...
    add_class_to_environment(9,Qnew_table,list_constant_53,Nil,temp,Nil,
	    ...
	    regenerate_optimized_constant(string_constant_18),Nil);
    ...
    temp = regenerate_optimized_constant(LIST_4(string_constant_19,
	    string_constant_20,string_constant_21,string_constant_22));
    temp_2 = regenerate_optimized_constant(LIST_2(string_constant_23,
	    string_constant_24));
    add_class_to_environment(9,Qfreeform_table,list_constant_54,Nil,temp,
	    Nil,temp_2,list_constant_54,
	    regenerate_optimized_constant(LIST_5(string_constant_25,
    ...
    string_constant_30 = 
	    STATIC_STRING("1o1n83A7y1n83-qTy1m9k83-ay83-qKy1n83-ayln1n83A7y1n83-qKy1m9k83-ay83-qTy1n83-ayln1o83-qKy1o1m9k9l1m9k83-gCy1m9k9m83Sy1n83BSymo9n1");
    string_constant_31 = 
	    STATIC_STRING("o83-qTy1o1m9k9l1m9k83-gDy1m9k9m83Sy1n83BSymo9n");
    clear_optimized_constants();
    ...
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_30,
	    string_constant_31)));
    ...
    list_constant_121 = STATIC_CONS(string_constant_32,Qnil);
    ...
    string_constant_34 = STATIC_STRING("1q837Ey8s83-fiy09k9l");
    clear_optimized_constants();
    ...
    string_constant_35 = 
	    STATIC_STRING("43Dy8m83l6y1p83l6y837Ey83Qy8n8k1l837Ey0000001l1m8x837Eyktk0k0");
    ...
    Qnew_table_cell_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_36 = STATIC_STRING("1q83l6y8s83-fhy09k9l");
    clear_optimized_constants();
    ...
    string_constant_37 = 
	    STATIC_STRING("43Dy8m83l5y1p83l5y837Ey83Qy8n8k1l837Ey0000001l1m8x837Eykqk0k0");
    ...
    Qnew_table_background_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_38 = STATIC_STRING("1q83l5y8s83-fgy09k9l");
    clear_optimized_constants();
