    ...
    Object full_command, directory_1, initial_timeout_qm, callback_qm;
{
    ...
    PUSH_SPECIAL(Unix_command_callback_function,unix_command_callback_function,
	    0);
...
Object Current_cvs_command = UNBOUND;

Object Cvs_command_initial_timeout = UNBOUND;

Object Permit_cvs_timeout_dialog_p = UNBOUND;

Object Cvs_command_timed_out_p = UNBOUND;

Object Source_code_control_is_enabled_by_default = UNBOUND;
...
Object Ms_to_wait_for_cvs = UNBOUND;
...
Object Workstations_with_their_stacks_for_timeout_of_source_code_control = UNBOUND;

Object Ui_client_interfaces_for_timeout_of_source_code_control = UNBOUND;
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
			    ...
			    PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			      ...
			      PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				      0);
				result = maybe_put_up_scc_timeout_dialog_for_workstation_1();
			      POP_SPECIAL();
			    POP_SPECIAL();
			  POP_SPECIAL();
			POP_SPECIAL();
    ...
    Object ui_client_interface;
{
	...
	temp = gensym_list_3(Qtext,tformat_text_string(2,string_constant,
		Current_cvs_command),Qscc_timeout_message);
	temp = gensym_cons_1(ui_client_interface,enter_dialog_for_t2(5,
		Qscc_timeout,gensym_list_2(temp,gensym_list_3(Qbutton,
...
Object Return_to_waiting_for_cvs_p = UNBOUND;
...
Object cvs_command_timeout_callback()
{
	...
	PUSH_SPECIAL(Ms_to_wait_for_cvs,ms_to_wait_for_cvs,0);
    ...
    Object workstation_or_workstation_alist_qm;
{
    ...
    PUSH_SPECIAL(Handle_ui_client_interface_messages_immediately_p,handle_ui_client_interface_messages_immediately_p,
	    0);
...
Object run_cvs_command_with_string_output varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Internal_status_of_most_recent_file_operation,internal_status_of_most_recent_file_operation,
	    3);
      if (pathname_1)
      ...
      PUSH_SPECIAL(Current_cvs_command,current_cvs_command,2);
	workstations_with_their_stacks_for_timeout_of_source_code_control 
		= Nil;
	PUSH_SPECIAL(Workstations_with_their_stacks_for_timeout_of_source_code_control,workstations_with_their_stacks_for_timeout_of_source_code_control,
		1);
	  cvs_command_timed_out_p = Nil;
	  PUSH_SPECIAL(Cvs_command_timed_out_p,cvs_command_timed_out_p,0);
...
Object Local_source_code_control_buffer = UNBOUND;

Object Local_source_code_control_number_of_characters = UNBOUND;

Object In_local_source_code_control_scope_p = UNBOUND;
    ...
    Object pathname_1;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = gensym_cons_1(user,Nil);
	if (ab_loopvar_)
...
Object Result_of_ask_user_about_checking_pathname_out_for_editing = UNBOUND;

Object Return_from_ask_user_about_checking_pathname_out_for_editing_p = UNBOUND;

Object Workstations_with_their_stacks_for_ask_user_about_checking_pathname_out_for_editing = UNBOUND;

Object Ui_client_interfaces_for_ask_user_about_checking_pathname_out_for_editing = UNBOUND;
			...
			PUSH_SPECIAL(Current_workstation_detail_pane,current_workstation_detail_pane,
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
			    ...
			    PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			      ...
			      PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				      0);
				result = ask_user_about_checking_pathname_out_for_editing_for_workstation_1(question);
			      POP_SPECIAL();
			    POP_SPECIAL();
			  POP_SPECIAL();
			POP_SPECIAL();
    ...
    Object question;
{
    ...
    return enter_dialog(15,temp,temp_1,temp_2,
	    ...
	    gensym_cons_1(T,Nil),
	    Qexit_from_ask_user_about_checking_pathname_out_for_editing,
	    gensym_cons_1(Nil,Nil),ISVREF(ISVREF(Current_workstation,
    ...
    Object ui_client_interface, question;
{
    ...
    if ( !TRUEP(assq_function(ui_client_interface,
		...
		{
	temp = gensym_list_3(Qtext,copy_text_string(question),
		Qcheck_out_for_editing_question);
	temp_1 = gensym_list_3(Qbutton,copy_text_string(array_constant_4),
		Qyes);
	temp_1 = gensym_cons_1(ui_client_interface,enter_dialog_for_t2(5,
		Qask_user_about_checking_out_a_file,gensym_list_3(temp,
		temp_1,gensym_list_3(Qbutton,
    ...
    Object pathname_1;
{
    ...
    PUSH_SPECIAL(Result_of_ask_user_about_checking_pathname_out_for_editing,result_of_ask_user_about_checking_pathname_out_for_editing,
	    2);
      return_from_ask_user_about_checking_pathname_out_for_editing_p = Nil;
      PUSH_SPECIAL(Return_from_ask_user_about_checking_pathname_out_for_editing_p,return_from_ask_user_about_checking_pathname_out_for_editing_p,
	      1);
...
Object update_saving_parameters_status_attributes varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Saving_parameters,saving_parameters,4);
	  if (Saving_parameters) {
		...
		PUSH_SPECIAL(In_local_source_code_control_scope_p,in_local_source_code_control_scope_p,
			2);
		  PUSH_SPECIAL(Local_source_code_control_number_of_characters,local_source_code_control_number_of_characters,
			  1);
		    PUSH_SPECIAL(Local_source_code_control_buffer,local_source_code_control_buffer,
			    0);
			  ...
			  others = gensym_cons_1(temp,others);
		      }
		      change_slot_value(3,Saving_parameters,
...
Object All_permanently_changed_things_are_marked = UNBOUND;
    ...
    Object saving_parameters;
{
    ...
    PUSH_SPECIAL(Saving_parameters,saving_parameters,0);
      result = VALUES_1(Nil);
    POP_SPECIAL();
    return result;
}
...
Object Clear_text_saving_problems_were_encountered_p = UNBOUND;

Object Return_from_save_to_caller_for_continuation_qm = UNBOUND;
...
Object save_kb varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Ok_file_saving_mode_qm,ok_file_saving_mode_qm,6);
	  ...
	  if ( !(reject_save_kb_if_run_time_only(type_of_kb_save) || 
	    ...
	    end_initial_stream_opening:;
	      if (temp_2) {
		  current_saving_context = Current_saving_context_qm;
		  PUSH_SPECIAL(Current_saving_context,current_saving_context,
			  5);
		    enable_saving_compiled_kbs_p = 
			    ISVREF(Current_saving_context,(SI_Long)10L);
		    PUSH_SPECIAL(Enable_saving_compiled_kbs_p,enable_saving_compiled_kbs_p,
			...
			PUSH_SPECIAL(Write_xml_object_items_collected,write_xml_object_items_collected,
				2);
			  total_items_in_file = Nil;
			  PUSH_SPECIAL(Total_items_in_file,total_items_in_file,
				  1);
			    Current_computation_flags = 
				    FIX(IFIX(Current_computation_flags) &  
				    ~(SI_Long)2048L);
...
Object Save_kb_state_for_system_procedure_save = UNBOUND;
    ...
    Object saving_compiled_kbs_p, log_message_for_commit_after_saving_qm;
{
  ...
  next_loop:
    ...
    if (kb_save_qm) {
	ab_loopvar__1 = gensym_cons_1(kb_save_qm,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
    ...
    Object include_transient_kb_workspaces_qm, module_qm;
{
	...
	if ((temp ? include_transient_kb_workspaces_qm || (SI_Long)0L != 
		...
		TRUEP(Nil)) {
	    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(workspace_qm,
    ...
    Object saving_context;
{
    ...
    PUSH_SPECIAL(Current_saving_context,current_saving_context,5);
      ...
      PUSH_SPECIAL(Enable_saving_compiled_kbs_p,enable_saving_compiled_kbs_p,
	      4);
	current_computation_flags = Current_computation_flags;
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,3);
	  write_xml_object_items_collected = Nil;
	  PUSH_SPECIAL(Write_xml_object_items_collected,write_xml_object_items_collected,
		  2);
	    total_items_in_file = Nil;
	...
	if (temp);
		...
		if (temp_1) {
		    current_task_schedule_modify_arg_2 = 
			    ISVREF(Saving_parameters,(SI_Long)22L);
		    current_task_schedule_modify_arg_8 = 
			    SYMBOL_FUNCTION(Qcontinue_current_kb_save_or_backup);
		    current_task_schedule_modify_arg_11 = saving_context;
		    if (Continuation_task_for_current_backup) {
			if (EQ(Continuation_task_for_current_backup,
				Current_schedule_task))
			    Current_schedule_task = Nil;
			if (ISVREF(Continuation_task_for_current_backup,
				(SI_Long)6L))
			    cancel_and_reclaim_scheduled_queue_element_1(Continuation_task_for_current_backup);
			inline_note_reclaim_cons(Continuation_task_for_current_backup,
				Nil);
			old_structure_being_reclaimed = 
				Structure_being_reclaimed;
			Structure_being_reclaimed = 
				Continuation_task_for_current_backup;
			reclaim_schedule_task_args(ISVREF(Continuation_task_for_current_backup,
				(SI_Long)9L));
			temp_2 = Continuation_task_for_current_backup;
		    ...
		    Continuation_task_for_current_backup = task;
		    temp = Continuation_task_for_current_backup;
		}
		else {
		    current_task_schedule_modify_arg_2 = 
			    ISVREF(Saving_parameters,(SI_Long)22L);
		    current_task_schedule_modify_arg_8 = 
			    SYMBOL_FUNCTION(Qterminate_kb_save_or_backup);
		    current_task_schedule_modify_arg_11 = saving_context;
		    if (Continuation_task_for_current_backup) {
			if (EQ(Continuation_task_for_current_backup,
				Current_schedule_task))
...
Object Save_only_if_interrupting_qm = UNBOUND;

Object Use_minimal_time_slice_for_continue_current_kb_save_p = UNBOUND;

Object Dont_cerror_for_slot_changes_while_on_window_qm = UNBOUND;

Object Continue_current_kb_save_failure = UNBOUND;
	  ...
	  end_loop:;
		...
		if (ISVREF(Current_saving_context,(SI_Long)6L))
			...
			gensym_push_modify_macro_arg = 
				gensym_cons_1(temp_2,
				gensym_cons_1(node_to_insert_qm,Nil));
...
{
    Object temp, gensym_pop_store, temp_1, cons_1, next_cons, temp_2;
    Object new_nodes, gensym_push_modify_macro_arg, car_1, cdr_1;
    ...
    new_nodes = write_kb_traversal_state_node(temp,gensym_pop_store);
    temp = ISVREF(Current_kb_save,(SI_Long)39L);
    if ( !TRUEP(CDAR(temp))) {
	temp = ISVREF(Current_kb_save,(SI_Long)39L);
...
Object Finish_current_kb_save_failure = UNBOUND;
...
Object check_frame_reference_balance_for_completed_save()
{
    ...
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object first_1, ab_node_stack_, ab_current_node_, ab_next_node_qm_;
    Object ab_current_alist_, ab_entry_cons_, calling_function;
    Object ab_less_than_branch_qm_, ab_loop_list_, temp_1;
	...
	ab_loopvar__1 = Nil;
	block = Nil;
	PUSH_SPECIAL(Scope_conses,scope_conses,8);
	  ...
	  PUSH_SPECIAL(Note_blocks_in_tformat,note_blocks_in_tformat,7);
		...
		PUSH_SPECIAL(Current_wide_string,current_wide_string,4);
		  ...
		  PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
			...
			ab_next_node_qm_ = ISVREF(Current_kb_save,
				(SI_Long)33L);
			...
			next_loop_2:
			  if (ab_current_alist_) {
				...
				end_loop_2:;
			      ...
			      if (ab_current_node_) {
				  ab_next_node_qm_ = 
					  ISVREF(ab_current_node_,(SI_Long)2L);
				  ab_current_alist_ = 
    ...
    Object saving_context, termination_reason_qm, stream_error_message_qm;
{
    ...
    Object current_task_schedule_modify_arg_12;
    Object current_task_schedule_modify_arg_13, old_structure_being_reclaimed;
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qterminate_kb_save_or_backup);
	current_task_schedule_modify_arg_11 = saving_context;
	current_task_schedule_modify_arg_12 = termination_reason_qm;
	current_task_schedule_modify_arg_13 = stream_error_message_qm;
	if (Continuation_task_for_current_backup) {
	    if (EQ(Continuation_task_for_current_backup,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Continuation_task_for_current_backup,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Continuation_task_for_current_backup);
	    inline_note_reclaim_cons(Continuation_task_for_current_backup,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Continuation_task_for_current_backup;
	    reclaim_schedule_task_args(ISVREF(Continuation_task_for_current_backup,
		    (SI_Long)9L));
	    temp = Continuation_task_for_current_backup;
	    SVREF(temp,FIX((SI_Long)9L)) = Nil;
	...
	SVREF(task,FIX((SI_Long)13L)) = current_task_schedule_modify_arg_13;
	ctask =  !TRUEP(ISVREF(task,(SI_Long)3L)) ? T : Nil;
	if (ctask);
	else
	    ctask = System_is_running;
	...
	if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	    Priority_of_next_task = p;
	Continuation_task_for_current_backup = task;
	return VALUES_1(Continuation_task_for_current_backup);
    }
}
    ...
    Object saving_context, termination_reason_qm, stream_error_message_qm;
{
    ...
    Object compiled_stream_qm, old_structure_being_reclaimed, svref_new_value;
    Object temp_1;
    Declare_special(6);
	...
	temp = Nil;
	Continuation_task_for_current_backup = temp;
...
Object Terminate_kb_save_stream_error_message_qm = UNBOUND;
    ...
    Object module_information, slot_name_or_t_in_change_case_qm;
{
    ...
    PUSH_SPECIAL(Module_information,module_information,1);
...
Object The_only_dynamic_computation_style = UNBOUND;
...
void kb_save3_INIT()
{
    ...
    Object list_constant_58, Qfinish_current_kb_save_failure;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, list_constant_57;
    Object Qcontinue_current_kb_save_failure, Qerror_writing_file_3;
    Object Qerror_writing_file_2, Qerror_writing_file_1, list_constant_56;
    Object list_constant_55, Qsave_kb, Qdeinstall_system_table;
    ...
    Object Qjournalling_status, Qkb_save3;
    Object Qall_permanently_changed_things_are_marked, Qnamed;
    Object list_constant_52, list_constant_51, list_constant_50, Qab_structure;
    Object list_constant_49, list_constant_48, list_constant_47;
    Object list_constant_46, Quse_slot_value_compiler_for_default_overrides_p;
    ...
    Object list_constant_12, Qsource_code_control_support_enabled_p, Kfuncall;
    Object Ksystem_frame, string_constant_123, string_constant_122;
    Object string_constant_121, string_constant_120, string_constant_119;
    Object list_constant_11, string_constant_118, string_constant_117;
    ...
    Object string_constant_107, Qsystem_table;
    ...
    string_constant_108 = 
	    STATIC_STRING("13Iy4z8r83TBy83TBy83Zjy83Zjy0s001n1l8o1l8l1m8p83-Zy000004z8r83S+y83S+y83Zjy83Zjy00001o1l83Ey1l8l1l83Fy1m8p83H9y000004z8r83LVy83L");
    string_constant_109 = 
	    STATIC_STRING("Vy83Zjy83Zjy00001o1l83Ey1l8l1l83Fy1m8p83LVy000004z8r83TEy83TEy83Zjy83Zjy00001n1n8p83-ey83Gy1l83Ey1l8l000004z8r83KZy83KZy83Zjy83Z");
    string_constant_110 = 
	    STATIC_STRING("jy00001n1l83Ey1l8l1m8p83Ky000004z8r83KYy83KYy83Zjy83Zjy00001n1l83Ey1l8l1m8p83Ky000004z8r83TPy83TPy83Zjy83Zjy00001o1l83Ey1l8l1m8p");
    string_constant_111 = 
	    STATIC_STRING("83TPy1l83Fy000004z8r83Fiy83Fiy83Zjy83Zjy083Py001n1l83Ey1l8l1m8p0000004z8r83JQy83JQy83Zjy83Zjy01m83Boy9k001n1l83Ey1l8l1m8p0000004");
    string_constant_112 = 
	    STATIC_STRING("z8r83Ziy83Ziy83Zjy83Zjy00001n1l83Ey1l8l1m8p83Ky000004z8r83G-y83G-y83Zjy83Zjy083Fdy001n1l83Ey1l8l1m8p83G-y000004z8r83I*y83I*y83Zj");
    string_constant_113 = 
	    STATIC_STRING("y83Zjy00001p1l8o1l8l1l83Cy1m8p83I*y1l83Fy000004z8r83Iwy83Iwy83Zjy83Zjy00001p1l83Ey1l8l1m8p83LVy1l83Fy1l83Hy000004z8r83Yfy83Yfy83");
    string_constant_114 = 
	    STATIC_STRING("Zjy83Zjy00001q1l83Ey1l8l1m8p01l83Fy1l83Hy1l83-4y000004z8r83Vvy83Vvy83Zjy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83aby83ab");
    string_constant_115 = 
	    STATIC_STRING("y83Zjy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83acy83acy83Zjy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83Vuy83Vuy83Z");
    string_constant_116 = 
	    STATIC_STRING("jy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83doy83doy83Zjy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83e=y83e=y83Zjy83");
    string_constant_117 = 
	    STATIC_STRING("Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83WWy83WWy83Zjy83Zjy00001p1l83Ey1l8l1m8p01l83Fy1l83Hy000004z8r83HKy83HKy83Zjy83Zjy0");
    string_constant_118 = 
	    STATIC_STRING("0001p1l83Ey1l8l1m8p01l83Fy1l83Hy00000");
    string_constant_119 = 
	    STATIC_STRING("13Ky8q1n83Zjy1l83-sy83ey1p83TBys8o8l1m8p83-Zy1q83S+y083Ey8l83Fy1m8p83H9y1q83LVy083Ey8l83Fy1m8p83LVy1p83TEy01n8p83-ey83Gy83Ey8l1p");
    string_constant_120 = 
	    STATIC_STRING("83KZy083Ey8l1m8p83Ky1p83KYy083Ey8l1m8p83Ky1q83TPy083Ey8l1m8p83TPy83Fy1p83Fiy83Py83Ey8l1m8p01p83JQy1m83Boy9k83Ey8l1m8p01p83Ziy083");
    string_constant_121 = 
	    STATIC_STRING("Ey8l1m8p83Ky1p83G-y83Fdy83Ey8l1m8p83G-y1r83I*y01l8o1l8l1l83Cy1m8p83I*y83Fy1r83Iwy083Ey8l1m8p83LVy83Fy83Hy1s83Yfy083Ey8l1m8p083Fy");
    string_constant_122 = 
	    STATIC_STRING("83Hy83-4y1r83Vvy083Ey8l1m8p083Fy83Hy1r83aby083Ey8l1m8p083Fy83Hy1r83acy083Ey8l1m8p083Fy83Hy1r83Vuy083Ey8l1m8p083Fy83Hy1r83doy083E");
    string_constant_123 = 
	    STATIC_STRING("y8l1m8p083Fy83Hy1r83e=y083Ey8l1m8p083Fy83Hy1r83WWy083Ey8l1m8p083Fy83Hy1r83HKy083Ey8l1m8p083Fy83Hy");
    ...
    set_slot_value_to_evaluation_value_function(Qxml_primitive_value_style,
	    xml_primitive_value_style_evaluation_getter_1);
    string_constant_124 = 
	    STATIC_STRING("1p1n83-Fsy1n83-tey1m9k83vy83-tfy1mln1n83-tey1m1m9k837gy1m9k83fny83-JZy1n83-tey1o1m9k830Iy1m9k9l1m9k837gy1m9k83fny83Boy1n83-tfy1o");
    string_constant_125 = 
	    STATIC_STRING("1m9k9m1m9k837ey1m9k8331y1m9k83-K=y9m1n83-tfy1q1m9k830Iy1m9k9l1m9k9m1m9k837ey1m9k8331y1m9k83-K=y83-Rcy");
    clear_optimized_constants();
    ...
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_124,
	    string_constant_125)));
    string_constant_126 = STATIC_STRING("1m1m83Fiy1m9k83Py1m83Fiy83-Fsy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
