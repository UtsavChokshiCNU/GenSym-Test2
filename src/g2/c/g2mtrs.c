    ...
    Object sensor, interval;
{
    ...
    if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	current_task_schedule_modify_arg_2 = ISVREF(Data_server_parameters,
		(SI_Long)22L);
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qcollect_one_shot_data_for_g2_meters);
	current_task_schedule_modify_arg_11 = sensor;
    ...
    Object sensor;
{
    ...
    svref_new_value = Nil;
    return VALUES_1(ISVREF(sensor,(SI_Long)40L) = svref_new_value);
}
...
Object Percent_running = UNBOUND;
...
Object Metered_clock_tick_length = UNBOUND;
...
Object Maximum_clock_tick_length = UNBOUND;
...
Object Available_uo_memory_usage_information_hash_vector_43_vectors = UNBOUND;

Object Count_of_uo_memory_usage_information_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_uo_memory_usage_information_hash_vector_43_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(247,20);
    count_of_uo_memory_usage_information_hash_vector_43_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_uo_memory_usage_information_hash_vector_43_vectors);
...
Object make_uo_memory_usage_information_hash_vector()
{
    ...
    if (Available_uo_memory_usage_information_hash_vector_43_vectors) {
	temp = 
		M_CAR(Available_uo_memory_usage_information_hash_vector_43_vectors);
	temp_1 = 
		M_CDR(Available_uo_memory_usage_information_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_uo_memory_usage_information_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = Available_uo_memory_usage_information_hash_vector_43_vectors;
	...
	Available_uo_memory_usage_information_hash_vector_43_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object uo_memory_usage_information_tree_for_hash_binary_tree;
{
  ...
  end_loop_1:;
	...
	uo_memory_usage_information_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
...
Object Uo_memory_usage_information_hash_table = UNBOUND;
    ...
    Object uo_memory_usage_information_hash_table;
{
    ...
    PUSH_SPECIAL(Uo_memory_usage_information_hash_table,uo_memory_usage_information_hash_table,
	    0);
      result_1 = Nil;
      index_1 = (SI_Long)0L;
    next_loop:
    ...
    Object uo_memory_usage_information_hash_table;
{
    ...
    next_loop:
      ...
      inline_note_reclaim_cons(uo_memory_usage_information_tree_for_hash_binary_tree,
	      Qab_gensym);
      temp = Available_gensym_conses;
      M_CDR(uo_memory_usage_information_tree_for_hash_binary_tree) = temp;
      Available_gensym_conses = 
	      uo_memory_usage_information_tree_for_hash_binary_tree;
...
Object Chain_of_available_class_instances_memory_infos = UNBOUND;

Object Class_instances_memory_info_count = UNBOUND;
    ...
    Object class_instances_memory_info;
{
    ...
    svref_new_value = Chain_of_available_class_instances_memory_infos;
    SVREF(class_instances_memory_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_class_instances_memory_infos = 
	    class_instances_memory_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_class_instances_memory_info_structure_internal()
{
    ...
    Object class_instances_memory_info_count_new_value;
    ...
    class_instances_memory_info_count_new_value = 
	    FIXNUM_ADD1(Class_instances_memory_info_count);
...
Object Class_name_max_length = UNBOUND;
    ...
    Object output;
{
    ...
    Object memory_usage_info, ab_less_than_branch_qm_, wide_string_bv16;
    ...
    SI_Long temp, tmpf, gensymed_symbol_2, gensymed_symbol_3;
    Declare_special(2);
    Object result;
    ...
    consumed_memory_column_title_len = 
	    ...
	    ((UBYTE_16_ISAREF_1(Consumed_memory_column_title,length_1 - 
	    (SI_Long)1L) & (SI_Long)8191L) << (SI_Long)16L);
    PUSH_SPECIAL(Class_name_max_length,class_name_max_length,1);
	  ...
	  next_loop:
		...
		if (gensymed_symbol_2 <= (SI_Long)999999L)
		    gensymed_symbol_2 = gensymed_symbol_2 < 
			    (SI_Long)10000L ? (gensymed_symbol_2 < 
			    (SI_Long)100L ? (gensymed_symbol_2 < 
			    (SI_Long)10L ? (SI_Long)1L : (SI_Long)2L) : 
			    gensymed_symbol_2 < (SI_Long)1000L ? 
...
static Object string_constant_18;  /* "Frame Vector Pools" */
    ...
    Object output;
{
    ...
    write_array_pool_statistics_table(string_constant_18,temp,temp_1,
    ...
    Object length_function, output;
{
    ...
    Object ab_loopvar__1, rows, columns, column_1, ab_loop_list__1, first_qm;
    Object out, percent_out, ab_loop_iter_flag_, temp;
    SI_Long column_count, pool, column, ab_loop_bind_;
  ...
  next_loop_3:
	...
	goto end_loop_3;
    column_1 = M_CAR(ab_loop_list__1);
    ab_loop_list__1 = M_CDR(ab_loop_list__1);
    if ( !TRUEP(ab_loop_iter_flag_))
	first_qm = Nil;
    max_size = CAR(column_1);
    temp = CDR(column_1);
    reclaimed = CAR(temp);
    temp = CDR(column_1);
    temp = CDR(temp);
    ...
    percent_out = chestnut_floorf_function(FIX(IFIX(out) * (SI_Long)100L),
	    FIX(MAX(IFIX(count_1),(SI_Long)1L)));
    if ( !TRUEP(first_qm))
	g2_stream_write_string(string_constant_25,output);
    ...
    reclaim_gensym_list_1(column_1);
...
Object Simple_string_stats_namestring = UNBOUND;

Object Simple_string_stats_header_needed = UNBOUND;

Object Reclaimed_strings_reported = UNBOUND;

Object Allocated_strings_reported = UNBOUND;
    ...
    Object length_1, string_qm, allocation_qm;
{
    ...
    x_note_fn_call(247,63);
    SAVE_STACK();
    log_simple_string_data = Nil;
    PUSH_SPECIAL(Log_simple_string_data,log_simple_string_data,2);
...
Object Input_string_for_backtrace_text_buffer_for_string_metering = UNBOUND;

Object Backtrace_text_buffer_for_string_metering = UNBOUND;

Object Input_gensym_string_for_buffer_for_string_metering = UNBOUND;

Object Buffer_for_string_metering = UNBOUND;
...
void g2_meters_INIT()
{
    ...
    Object Qmaximum_clock_tick_length, list_constant_15, list_constant_14;
    Object list_constant_13, string_constant_70, list_constant_12;
    Object list_constant_11, list_constant_10, Qclock_tick_length;
    Object Qmetered_clock_tick_length, string_constant_69, list_constant_9;
    Object list_constant_8, list_constant_7, Qpercent_run_time;
    Object Qpercent_running, Qwrite_global_memory_statistics;
    ...
    Object Qclass_instances_memory_info_count;
    Object Qchain_of_available_class_instances_memory_infos;
    ...
    Object Qcount_of_uo_memory_usage_information_hash_vector_43_vectors;
    Object Qavailable_uo_memory_usage_information_hash_vector_43_vectors;
    Object list_constant_5, Qrun, Qmake_boxed_floating_zero, Kfuncall;
    ...
    Quo_memory_usage_information_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_66 = STATIC_STRING("1q83-tiy83*By83-PAy09k9l");
    ...
    string_constant_67 = 
	    STATIC_STRING("43Dy8m83fxy1n83fxy8n8k1l8n0000000kqk0k0");
    ...
    Qclass_instances_memory_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_68 = STATIC_STRING("1q83fxy8s83-MYy09k9l");
    clear_optimized_constants();
    ...
    System_statistics_writers = system_statistics_writers_new_value;
    string_constant_18 = STATIC_STRING("Frame Vector Pools");
    ...
    string_constant_69 = STATIC_STRING("1l1m83*Dy1m9k83-hfy");
    clear_optimized_constants();
    ...
    string_constant_70 = STATIC_STRING("1l1m83*Dy1m9k83-Mhy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_72 = STATIC_STRING("1l1m83*Dy1m9k83-ZQy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_73 = STATIC_STRING("1l1m83*Dy1m9k83-dHy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_74 = STATIC_STRING("1l1m83*Dy1m9k83-dIy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_75 = STATIC_STRING("1l1m83*Dy1m9k83-dFy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_76 = STATIC_STRING("1l1m83*Dy1m9k83-dGy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_77 = STATIC_STRING("1l1m83*Dy1m9k83-dCy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_78 = STATIC_STRING("1l1m83*Dy1m9k83-dDy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_79 = STATIC_STRING("1l1m83*Dy1m9k83-kJy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_80 = STATIC_STRING("1l1m83*Dy1m9k83-kKy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_81 = STATIC_STRING("1l1m83*Dy1m9k83-kPy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_82 = STATIC_STRING("1l1m83*Dy1m9k83-kQy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_83 = STATIC_STRING("1l1m83*Dy1m9k83-kVy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_84 = STATIC_STRING("1l1m83*Dy1m9k83-kWy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_85 = STATIC_STRING("1l1m83*Dy1m9k83-kFy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_86 = STATIC_STRING("1l1m83*Dy1m9k83-kGy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_87 = STATIC_STRING("1l1m83*Dy1m9k83-kLy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_88 = STATIC_STRING("1l1m83*Dy1m9k83-kMy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_89 = STATIC_STRING("1l1m83*Dy1m9k83-kRy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_90 = STATIC_STRING("1l1m83*Dy1m9k83-kSy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_91 = STATIC_STRING("1l1m83*Dy1m9k83-kHy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_92 = STATIC_STRING("1l1m83*Dy1m9k83-kIy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_93 = STATIC_STRING("1l1m83*Dy1m9k83-kNy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_94 = STATIC_STRING("1l1m83*Dy1m9k83-kOy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_95 = STATIC_STRING("1l1m83*Dy1m9k83-kTy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_96 = STATIC_STRING("1l1m83*Dy1m9k83-kUy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
