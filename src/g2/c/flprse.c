...
Object Filename_special_character_registry = UNBOUND;

Object Lt_end_of_sequence_gt = UNBOUND;

Object Lt_colon_gt = UNBOUND;

Object Lt_slash_gt = UNBOUND;

Object Lt_dot_gt = UNBOUND;

Object Lt_tilde_gt = UNBOUND;

Object Lt_asterisk_gt = UNBOUND;

Object Lt_left_bracket_gt = UNBOUND;

Object Lt_right_bracket_gt = UNBOUND;

Object Lt_semicolon_gt = UNBOUND;

Object Lt_double_quote_gt = UNBOUND;

Object Lt_space_gt = UNBOUND;

Object Lt_hyphen_gt = UNBOUND;

Object Lt_left_angle_bracket_gt = UNBOUND;

Object Lt_right_angle_bracket_gt = UNBOUND;

Object Lt_sharp_sign_gt = UNBOUND;

Object Lt_exclamation_gt = UNBOUND;

Object Lt_comma_gt = UNBOUND;

Object Lt_backslash_gt = UNBOUND;
...
static Object Qlt_end_of_sequence_gt;  /* <end-of-sequence> */
...
Object tokenize_filename varargs_1(int, n)
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(entry,Nil);
	if (ab_loopvar__1)
  ...
  next_loop_1:
	...
	if (accumulated_chars) {
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    tokenized_filename = gensym_cons_1(temp_1,tokenized_filename);
	    reclaim_gensym_list_1(accumulated_chars);
	    accumulated_chars = Nil;
	}
	tokenized_filename = gensym_cons_1(CAR(special_character_entry),
		tokenized_filename);
    }
    else
	accumulated_chars = gensym_cons_1(char_1,accumulated_chars);
  ...
  end_loop_1:
    ...
    reclaim_gensym_list_1(special_character_registry);
    reclaim_text_string(private_filename);
    return nreverse(gensym_cons_1(Qlt_end_of_sequence_gt,tokenized_filename));
    return VALUES_1(Qnil);
}

Object Trace_filename_parsing_p = UNBOUND;

Object The_type_description_of_filename_parser_information = UNBOUND;

Object Chain_of_available_filename_parser_informations = UNBOUND;

Object Filename_parser_information_count = UNBOUND;
    ...
    Object filename_parser_information;
{
    ...
    svref_new_value = Chain_of_available_filename_parser_informations;
...
Object make_permanent_filename_parser_information_structure_internal()
{
    ...
    filename_parser_information_count_new_value = 
	    FIXNUM_ADD1(Filename_parser_information_count);
    ...
    Object parser_info;
{
    ...
    x_note_fn_call(41,7);
    reclaim_gensym_list_1(ISVREF(parser_info,(SI_Long)2L));
  ...
  next_loop:
    ...
    entry = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    reclaim_gensym_list_1(THIRD(entry));
    reclaim_gensym_list_1(entry);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(previous_stack);
    token = Nil;
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(ISVREF(parser_info,(SI_Long)1L));
    ...
    Object sublists;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(coalesce_filename_tokens_1(sublist_item),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	if (CONSP(sublist_item))
	    reclaim_gensym_list_1(sublist_item);
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(sublists_in_order);
    ...
    Object reversed_list;
{
    ...
    reclaim_gensym_list_1(list_in_order);
    return VALUES_1(temp);
}
    ...
    Object new_sequence, parser_info, increment;
{
    ...
    end_of_sequence_list = gensym_cons_1(Qlt_end_of_sequence_gt,Nil);
    gensym_push_modify_macro_arg = 
	    gensym_list_3(FIXNUM_ADD(ISVREF(parser_info,(SI_Long)7L),
    ...
    if (new_sequence) {
	copy_of_new_sequence = copy_list_using_gensym_conses_1(new_sequence);
    ...
    Object parser_info;
{
    ...
    return reclaim_gensym_list_1(previous_info);
}
...
Object All_known_file_systems = UNBOUND;

Object Accept_any_version_component_p = UNBOUND;

Object Nodes_for_unix_filename_parser = UNBOUND;
    ...
    Object type_list;
{
	...
	if (text_string_p(match_0) && EQ(match_1,Lt_colon_gt) && 
	    ...
	    directory_list = gensym_cons_1(Kabsolute,directory_list);
    ...
    Object type_list;
{
	...
	if (directory_1) {
		...
		directory_1 = gensym_cons_1(Krelative,directory_1);
	}
	...
	directory_item = gensym_cons_1(lt_anything_gt,directory_item);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)8L);
	goto parser_traverse;
    ...
    Object type_list;
{
	...
	if (EQ(match_0,Lt_tilde_gt) && EQ(match_1,Lt_end_of_sequence_gt)) {
	    directory_list = gensym_cons_1(Khome,directory_list);
	...
	if (EQ(match_0,Lt_dot_gt) && EQ(match_1,Lt_end_of_sequence_gt)) {
	    directory_list = gensym_cons_1(Krelative,directory_list);
	    svref_new_value_1 = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)2L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value_1);
	    next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)6L);
	...
	if (EQ(match_0,Lt_dot_gt) && EQ(match_1,Lt_dot_gt) && EQ(match_2,
	    ...
	    directory_list = gensym_cons_1(Kup,directory_list);
	    svref_new_value_1 = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)3L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value_1);
	    next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)6L);
	...
	if (EQ(match_0,Lt_asterisk_gt) && EQ(match_1,Lt_end_of_sequence_gt)) {
	    directory_list = gensym_cons_1(Kwild,directory_list);
	    svref_new_value_1 = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)2L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value_1);
	    next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)6L);
    ...
    directory_list = 
	    gensym_cons_1(copy_list_using_gensym_conses_1(directory_item),
	    directory_list);
    next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)6L);
    goto parser_traverse;
    error_in_unix_filename_parser(parser_info);
    ...
    Object type_list;
{
    ...
    next_node = Nil;
    reclaim_gensym_list_1(directory_item);
    directory_item = Nil;
    ...
    Object type_list;
{
    ...
    if (match_1) {
	if (EQ(match_0,Lt_dot_gt) && EQ(match_1,Lt_end_of_sequence_gt)) {
	    new_directory_component = gensym_cons_1(Krelative,Nil);
	    if (directory_1) {
	...
	if (EQ(match_0,Lt_dot_gt) && EQ(match_1,Lt_dot_gt) && EQ(match_2,
		Lt_end_of_sequence_gt)) {
	    new_directory_component = gensym_cons_1(Kup,Nil);
	    if (directory_1) {
		temp = last(directory_1,_);
		M_CDR(temp) = new_directory_component;
	    }
    ...
    Object type_list;
{
    ...
    lt_anything_gt = current_token;
    if ( !EQ(Qlt_end_of_sequence_gt,lt_anything_gt)) {
	name_list = gensym_cons_1(lt_anything_gt,name_list);
	svref_new_value_1 = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value_1;
	next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)4L);
	goto parser_traverse;
    ...
    Object type_list;
{
	...
	if (name)
	    ...
	    name = coalesce_reversed_filename_list_1(nconc2(type_list,
		    gensym_cons_1(string_constant,Nil)));
	svref_new_value_1 = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value_1;
	next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)0L);
	goto parser_traverse;
    ...
    if (EQ(current_token,Lt_dot_gt)) {
	type_list = nconc2(type_list,name ? gensym_list_2(string_constant,
		name) : gensym_cons_1(string_constant,Nil));
	type = coalesce_reversed_filename_list_1(type_list);
	type_list = Nil;
	if (name)
    ...
    lt_anything_gt = current_token;
    if ( !EQ(Qlt_end_of_sequence_gt,lt_anything_gt)) {
	type_list = gensym_cons_1(lt_anything_gt,type_list);
	svref_new_value_1 = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value_1;
	next_node = ISVREF(Nodes_for_unix_filename_parser,(SI_Long)1L);
	goto parser_traverse;
    ...
    Object type_list;
{
    ...
    next_node = Nil;
    reclaim_gensym_list_1(name_type_version_list);
    ...
    Object filename;
{
	...
	svref_new_value = 
		copy_list_using_gensym_conses_1(ISVREF(parser_info,
		(SI_Long)1L));
...
Object Vms_directory_filenames_can_dangle_p = UNBOUND;
    ...
    Object directory_list, directory_item_qm;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    if (CONSP(component))
	reclaim_gensym_list_1(component);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(directory_list);
    reclaim_gensym_list_1(directory_item_qm);
    return VALUES_1(Nil);
}

Object Nodes_for_vms_filename_parser = UNBOUND;
    ...
    Object doing_dual_directory_p;
{
	...
	if (text_string_p(match_0) && EQ(match_1,Lt_double_quote_gt) && 
	    ...
	    host = coalesce_filename_items_1(gensym_list_4(lt_word_gt_0,
    ...
    Object doing_dual_directory_p;
{
	...
	if (EQ(match_0,Lt_left_bracket_gt) && EQ(match_1,Lt_dot_gt) && 
	    ...
	    directory_1 = gensym_list_2(Krelative,Kwild_inferiors);
	    svref_new_value = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)5L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value);
	...
	if (EQ(match_0,Lt_left_bracket_gt) && EQ(match_1,
		    Lt_right_bracket_gt)) {
	    dual_directory_impossible_p = T;
	    directory_1 = gensym_cons_1(Krelative,Nil);
	    svref_new_value = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)2L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value);
	    next_node = ISVREF(Nodes_for_vms_filename_parser,(SI_Long)6L);
	...
	if (EQ(match_0,Lt_left_bracket_gt) && string_eq_w(array_constant_1,
	    ...
	    dual_directory_impossible_p = T;
	    directory_1 = gensym_cons_1(Kabsolute,Nil);
	    svref_new_value = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)3L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value);
	    next_node = ISVREF(Nodes_for_vms_filename_parser,(SI_Long)6L);
	...
	if (EQ(match_0,Lt_left_bracket_gt) && string_eq_w(array_constant_1,
	    ...
	    dual_directory_impossible_p = T;
	    directory_1 = gensym_list_2(Kabsolute,Kwild_inferiors);
	    svref_new_value = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)6L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value);
	    next_node = ISVREF(Nodes_for_vms_filename_parser,(SI_Long)6L);
    ...
    Object doing_dual_directory_p;
{
	...
	if (EQ(match_0,Lt_dot_gt) && EQ(match_1,Lt_dot_gt) && EQ(match_2,
	    ...
	    directory_list = gensym_cons_1(Kwild_inferiors,directory_list);
	    svref_new_value = IFIX(ISVREF(parser_info,(SI_Long)7L)) + 
		    (SI_Long)4L;
	    ISVREF(parser_info,(SI_Long)7L) = FIX(svref_new_value);
	...
	if (Vms_directory_filenames_can_dangle_p) {
		...
		directory_item_qm = nreverse(directory_item_qm);
		directory_list = 
			gensym_cons_1(copy_list_using_gensym_conses_1(directory_item_qm),
			directory_list);
		reclaim_gensym_list_1(directory_item_qm);
	    }
	    directory_1 = coalesce_filename_sublists_1(directory_list);
    ...
    lt_anything_gt = current_token;
    if ( !EQ(Qlt_end_of_sequence_gt,lt_anything_gt)) {
	directory_item_qm = gensym_cons_1(lt_anything_gt,directory_item_qm);
	svref_new_value_1 = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value_1;
	next_node = ISVREF(Nodes_for_vms_filename_parser,(SI_Long)10L);
	goto parser_traverse;
    ...
    Object doing_dual_directory_p;
{
    ...
    if (EQ(current_token,Lt_left_bracket_gt)) {
	reclaim_gensym_list_1(type_list);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_vms_filename_parser,(SI_Long)0L);
	goto parser_traverse;
...
Object Limit_dos_filename_component_lengths_p = UNBOUND;

Object Allow_extensionless_dos_filenames_p = UNBOUND;

Object Character_case_mode_for_generalized_dos = UNBOUND;

Object Nodes_for_generalized_dos_filename_parser = UNBOUND;
    ...
    Object name_and_type_list, name_list, type_list;
{
	...
	if (wildcard_encountered_p) {
		...
		reclaim_gensym_list_1(directory_item);
	    if (directory_list)
		reclaim_gensym_tree_1(directory_list);
    ...
    Object name_and_type_list, name_list, type_list;
{
	...
	name_list = gensym_cons_1(lt_word_gt,name_list);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_generalized_dos_filename_parser,
		(SI_Long)3L);
	...
	name_list = gensym_cons_1(Lt_asterisk_gt,name_list);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_generalized_dos_filename_parser,
		(SI_Long)3L);
    ...
    Object name_and_type_list, name_list, type_list;
{
    ...
    lt_word_gt = current_token;
    if (text_string_p(lt_word_gt)) {
	type_list = gensym_cons_1(lt_word_gt,type_list);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_generalized_dos_filename_parser,
		(SI_Long)1L);
    ...
    if (EQ(current_token,Lt_asterisk_gt)) {
	type_list = gensym_cons_1(Lt_asterisk_gt,type_list);
	svref_new_value = FIXNUM_ADD1(ISVREF(parser_info,(SI_Long)7L));
	SVREF(parser_info,FIX((SI_Long)7L)) = svref_new_value;
	next_node = ISVREF(Nodes_for_generalized_dos_filename_parser,
		(SI_Long)1L);
    ...
    Object name_and_type_list, name_list, type_list;
{
    ...
    next_node = Nil;
    reclaim_gensym_list_1(name_and_type_list);
    if (Limit_dos_filename_component_lengths_p) {
    ...
    Object filename;
{
    ...
    PUSH_SPECIAL(Limit_dos_filename_component_lengths_p,limit_dos_filename_component_lengths_p,
	    2);
      allow_extensionless_dos_filenames_p = T;
      PUSH_SPECIAL(Allow_extensionless_dos_filenames_p,allow_extensionless_dos_filenames_p,
	      1);
	character_case_mode_for_generalized_dos = Kall_uppercase;
	PUSH_SPECIAL(Character_case_mode_for_generalized_dos,character_case_mode_for_generalized_dos,
		0);
...
Object Last_deletable_token_in_namestring = UNBOUND;
...
void file_parse_INIT()
{
    ...
    Object Qconvert_file_strings_to_uppercase_p;
    Object Qgenerate_generalized_dos_namestring, list_constant_25, Qlt_dot_gt;
    Object Qlt_backslash_gt, AB_package, Qgenerate_vms_namestring;
    Object array_constant_6, list_constant_23, Qlt_semicolon_gt;
    Object list_constant_28, Qlt_hyphen_gt, Qlt_asterisk_gt;
    Object Qlt_right_bracket_gt, Qlt_left_bracket_gt, list_constant_29;
    Object list_constant_27, Qlt_colon_gt, Qgenerate_unix_namestring;
    Object array_constant_5, Qlt_tilde_gt, list_constant_26, Qlt_slash_gt;
    ...
    Object Qparse_vms_filename, Qlt_space_gt, Qlt_double_quote_gt;
    Object Qfinal_unix_parser_node, Qerror_in_unix_filename_parser;
    Object Qparse_unix_filename_node_100, Qparse_unix_filename_node_101;
    Object Qparse_unix_filename_node_102, Qparse_unix_filename_node_103;
    Object Qparse_unix_filename_node_104, Qparse_unix_filename_node_105;
    Object Qparse_unix_filename_node_106, Qparse_unix_filename_node_108;
    Object Qparse_unix_filename_node_109, Qparse_unix_filename_node_110;
    Object Qparse_unix_filename_node_111, Qparse_unix_filename, Qfile_parse;
    Object Qaccept_any_version_component_p, Qfilename_parser_information;
    ...
    Object Qfilename_parser_information_count;
    Object Qchain_of_available_filename_parser_informations;
    ...
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qequalw, Qlt_comma_gt;
    Object Qlt_exclamation_gt, Qlt_sharp_sign_gt, Qlt_right_angle_bracket_gt;
    Object Qlt_left_angle_bracket_gt;
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83hMy1n83hMy8n8k1l8n0000001m1n8y83-3gy01m83My83-AFykuk0k0");
    ...
    Qfilename_parser_information_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q83hMy8s83-Thy09k9l");
