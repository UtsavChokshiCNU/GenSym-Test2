...
Object Printer_setup = UNBOUND;

static Object Qprinter_setup;      /* printer-setup */
    ...
    Object printer_setup;
{
    ...
    PUSH_SPECIAL(Printer_setup,printer_setup,0);
      frame = Printer_setup;
...
static Object Qprint_spooling;     /* print-spooling */
...
Object Native_printer_information = UNBOUND;
    ...
    Object plist;
{
    ...
    Object temp, temp_1, amf_available_array_cons_qm, amf_array;
    Object svref_new_value, amf_result, incff_1_arg, new_float, lm, tm, rm, bm;
  ...
  next_loop:
    ...
    if (value_qm) {
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(margin,
		copy_list_using_gensym_conses_1(value_qm)),Nil);
	if (ab_loopvar__1)
  ...
  end_1:;
    ...
    temp = gensym_cons_1(Qpaper_orientation,Qportrait);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    temp = gensym_cons_1(Qcolor_conversion,Qfull_color);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    temp = gensym_cons_1(Qquality,quality);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    temp = gensym_cons_1(Qprinter_identification,
	    INLINE_UNSIGNED_BYTE_16_VECTOR_P(printer) != (SI_Long)0L ? 
	    copy_text_string(printer) : printer);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    temp = gensym_cons_1(Qfrom_page,from_page);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    temp = gensym_cons_1(Qto_page,to_page);
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    ...
    temp_1 = gensym_list_2(new_float,Qinch);
    amf_available_array_cons_qm = 
	    ISVREF(Vector_of_simple_float_array_pools,(SI_Long)1L);
    if (amf_available_array_cons_qm) {
	amf_array = M_CAR(amf_available_array_cons_qm);
    ...
    temp = gensym_cons_1(Qpaper_size,gensym_list_3(Qcustom,temp_1,
	    gensym_list_2(new_float,Qinch)));
    M_CAR(gensymed_symbol_1) = temp;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    amf_available_array_cons_qm = 
	    ISVREF(Vector_of_simple_float_array_pools,(SI_Long)1L);
    ...
    DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
    bm = new_float;
    temp = gensym_cons_1(Qpaper_margins,gensym_list_4(gensym_list_2(lm,
	    Qinch),gensym_list_2(tm,Qinch),gensym_list_2(rm,Qinch),
	    gensym_list_2(bm,Qinch)));
    M_CAR(gensymed_symbol_1) = temp;
    return VALUES_1(nconc2(gensymed_symbol,nconc2(pathname_qm ? 
	    gensym_cons_1(gensym_cons_1(Qab_pathname,
...
Object postscript_convert_linear_distance_to_postscript_units_mf varargs_1(int, n)
{
    ...
    Object amf_result, incff_1_arg, new_float;
    double temp_2, temp_3, aref_new_value;
    Declare_varargs_nonrelocating;
    XDeclare_area(1);
    XDeclare_frontier(1);
    Object result;
	...
	if (inverse) {
	    ...
	    new_float = amf_result;
	    temp_2 = DOUBLE_FLOAT_TO_DOUBLE(x);
	    temp_3 = DOUBLE_FLOAT_TO_DOUBLE(units_multiplier);
	    aref_new_value = 72.0 * (1.0 / temp_2) * temp_3;
	    DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
	    ...
	    temp_2 = DOUBLE_FLOAT_TO_DOUBLE(x);
	    temp_3 = DOUBLE_FLOAT_TO_DOUBLE(units_multiplier);
	    aref_new_value = 72.0 * temp_2 * temp_3;
	    DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
	    result = VALUES_1(new_float);
	}
    }
...
Object Printing_in_progress_p = UNBOUND;

Object Printing_format = UNBOUND;

Object Gensym_window_for_printing = UNBOUND;

Object Output_window_for_printing_qm = UNBOUND;

Object Bitmap_for_printing_qm = UNBOUND;

Object Printing_pass_number = UNBOUND;

Object Last_postscript_composite_object_index = UNBOUND;

Object Postscript_composite_object_mapping = UNBOUND;

Object Fonts_used_in_print_job = UNBOUND;

Object Kanji_fonts_used_in_print_job = UNBOUND;

Object Fonts_needing_corresponding_kanji_font = UNBOUND;

Object Postscript_object_mapping_for_graph_renderings = UNBOUND;

Object Postscript_object_mapping_for_icon_renderings = UNBOUND;

Object Postscript_computed_variables_mapping = UNBOUND;

Object Postscript_printing_icon_renderings = UNBOUND;

Object Postscript_current_graph_line_drawing_index = UNBOUND;

Object Postscript_emitting_definition = UNBOUND;

Object Postscript_definition_operation_counter = UNBOUND;

Object Printing_graph_rendering_color_list_qm = UNBOUND;
...
Object Postscript_emit_integers_as_color_differences = UNBOUND;

Object Postscript_emit_composite_object_without_name = UNBOUND;
...
Object postscript_emit_composite_object_definition varargs_1(int, n)
{
    ...
    postscript_definition_operation_counter = FIX((SI_Long)0L);
    PUSH_SPECIAL(Postscript_definition_operation_counter,postscript_definition_operation_counter,
	    1);
      PUSH_SPECIAL(Postscript_emitting_definition,postscript_emitting_definition,
	      0);
	...
	if (EQ(body_function,Qpostscript_emit_icon_rendering_inner)) {
		...
		Postscript_computed_variables_mapping = 
			gensym_cons_1(computed_values_plist_copy,
			Postscript_computed_variables_mapping);
	    ...
	    Postscript_composite_object_mapping = 
		    gensym_cons_1(object_index,
		    Postscript_composite_object_mapping);
	    Postscript_composite_object_mapping = gensym_cons_1(object,
		    Postscript_composite_object_mapping);
	}
    ...
    Object object_mapping;
{
  ...
  next_loop:
    ...
    reclaim_gensym_list_1(key);
    ab_loop_list_ = CDDR(ab_loop_list_);
    if ( !TRUEP(ab_loop_list_))
	goto end_loop;
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(object_mapping);
    return VALUES_1(Nil);
}
...
Object Chain_of_available_line_drawing_for_printings = UNBOUND;

Object Line_drawing_for_printing_count = UNBOUND;
    ...
    Object line_drawing_for_printing;
{
    ...
    svref_new_value = Chain_of_available_line_drawing_for_printings;
    SVREF(line_drawing_for_printing,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_line_drawing_for_printings = line_drawing_for_printing;
    return VALUES_1(Nil);
}
...
Object make_permanent_line_drawing_for_printing_structure_internal()
{
    ...
    Object line_drawing_for_printing_count_new_value;
    ...
    line_drawing_for_printing_count_new_value = 
	    FIXNUM_ADD1(Line_drawing_for_printing_count);
    ...
    Object tree_qm;
{
	...
	temp = reclaim_gensym_cons_1(tree_qm);
    }
    return VALUES_1(temp);
}
    ...
    Object renderings;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(renderings);
    ...
    Object line_drawing, width, height, computed_values_plist;
{
  ...
  end_loop:
    ...
    Postscript_printing_icon_renderings = 
	    gensym_cons_1(line_drawing_for_printing,
	    Postscript_printing_icon_renderings);
    return VALUES_1(line_drawing_for_printing);
    return VALUES_1(Qnil);
}
    ...
    Object line_drawing_for_printing;
{
    ...
    PUSH_SPECIAL(Printing_icon_current_region_index_qm,printing_icon_current_region_index_qm,
	    0);
...
Object Current_graph_rendering_embedded_icons = UNBOUND;
    ...
    Object graph_rendering;
{
	...
	PUSH_SPECIAL(Current_graph_rendering_embedded_icons,current_graph_rendering_embedded_icons,
		1);
	  temp = postscript_emit_composite_object_definition(3,
	  ...
	  PUSH_SPECIAL(Postscript_current_graph_line_drawing_index,postscript_current_graph_line_drawing_index,
		  0);
	    ...
	    Postscript_object_mapping_for_graph_renderings = 
		    gensym_cons_1(index_1,
		    Postscript_object_mapping_for_graph_renderings);
	    Postscript_object_mapping_for_graph_renderings = 
		    gensym_cons_1(ISVREF(graph_rendering,(SI_Long)16L),
		    Postscript_object_mapping_for_graph_renderings);
...
Object postscript_emit_graph_rendering_embedded_icons()
{
  ...
  next_loop:
    ...
    reclaim_gensym_list_1(triple);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(Current_graph_rendering_embedded_icons);
    return VALUES_1(Qnil);
}
    ...
    Object font_map, text_line;
{
    ...
    Object character_1, code, temp, gensym_modify_macro_using_test_arg_1;
	...
	Fonts_used_in_print_job = gensym_cons_1(font_used,
	...
	if (non_latin_used_so_far_qm) {
	    gensym_modify_macro_using_test_arg_1 = font_used;
    ...
    Object base_font, non_latin_wide_character;
{
	...
	Kanji_fonts_used_in_print_job = gensym_cons_1(base_font,
		gensym_cons_1(Nil,Kanji_fonts_used_in_print_job));
    code = FIX((SI_Long)0L);
  ...
  end_1:;
	...
	temp_1 = gensym_cons_1(gensym_cons_1(kanji_code,code),Nil);
	M_CDR(tail_of_font_list) = temp_1;
	return VALUES_1(code);
    }
    else {
	tail = memq_function(base_font,Kanji_fonts_used_in_print_job);
	temp_1 = gensym_cons_1(gensym_cons_1(kanji_code,FIX((SI_Long)0L)),Nil);
	M_CADR(tail) = temp_1;
...
{
    Object characters_per_row, character_in_hex, character_index, i;
    SI_Long width, height, row, ab_loop_bind_, column, ab_loop_bind__1;
    SI_Long aref_new_value, ab_loop_repeat_, j;
  ...
  next_loop:
    if (row >= ab_loop_bind_)
	goto end_loop;
    column = (SI_Long)0L;
    ab_loop_bind__1 = width;
  next_loop_1:
    if (column >= ab_loop_bind__1)
	goto end_loop_1;
    character_index = add1(character_index);
    aref_new_value = UBYTE_16_ISAREF_1(array_constant_5,((column + 
	    (SI_Long)0L < IFIX(bounding_box_width) && row < 
	    IFIX(bounding_box_height) ? IFIX(aref2(character_bitmap,
	    FIX(column + (SI_Long)0L),FIX(row))) : (SI_Long)0L) << 
	    (SI_Long)3L) + ((column + (SI_Long)1L < 
	    IFIX(bounding_box_width) && row < IFIX(bounding_box_height) ? 
	    IFIX(aref2(character_bitmap,FIX(column + (SI_Long)1L),
	    FIX(row))) : (SI_Long)0L) << (SI_Long)2L) + ((column + 
	    (SI_Long)2L < IFIX(bounding_box_width) && row < 
	    IFIX(bounding_box_height) ? IFIX(aref2(character_bitmap,
	    FIX(column + (SI_Long)2L),FIX(row))) : (SI_Long)0L) << 
	    (SI_Long)1L) + (column + (SI_Long)3L < 
	    IFIX(bounding_box_width) && row < IFIX(bounding_box_height) ? 
	    IFIX(aref2(character_bitmap,FIX(column + (SI_Long)3L),
	    FIX(row))) : (SI_Long)0L));
    UBYTE_16_ISASET_1(character_in_hex,IFIX(character_index),aref_new_value);
    column = column + (SI_Long)4L;
    goto next_loop_1;
  end_loop_1:;
    row = row + (SI_Long)1L;
    goto next_loop;
    ...
    Object font, text_string;
{
    ...
    Object unicode, code, extended_code, unicode_1, code_1, temp_2;
    Object gensym_character_code_qm, character_code, char_1;
    Object simple_gensym_character_code;
    SI_Long temp, character_1, row, gensym_full_row, gensymed_symbol;
...
Object postscript_emit_color_value(color_value)
    Object color_value;
{
    x_note_fn_call(97,99);
    return postscript_emit_atom(color_value);
}

Object Adding_from_graph_rendering_p = UNBOUND;
    ...
    Object font_map;
{
    ...
    x_note_fn_call(97,107);
    postscript_emit_composite_object_without_name = T;
    PUSH_SPECIAL(Postscript_emit_composite_object_without_name,postscript_emit_composite_object_without_name,
	    0);
    ...
    Object list_of_colors, use_differences_p;
{
    ...
    x_note_fn_call(97,108);
    postscript_emit_composite_object_without_name = T;
    postscript_emit_integers_as_color_differences = use_differences_p;
    PUSH_SPECIAL(Postscript_emit_integers_as_color_differences,postscript_emit_integers_as_color_differences,
	    1);
      PUSH_SPECIAL(Postscript_emit_composite_object_without_name,postscript_emit_composite_object_without_name,
	      0);
...
Object emit_printing_color_map()
{
  ...
  end_loop:
    ...
    PUSH_SPECIAL(Standard_gensym_color_alist,standard_gensym_color_alist,0);
      color_value = (SI_Long)0L;
      ab_loop_bind_ = IFIX(length(Standard_gensym_color_alist));
      color_qm = Nil;
      alist_entry_qm = Nil;
    ...
    Object color_value, line_drawing_description;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    triple = gensym_list_3(reserve_composite_object_index(),color_value,
	    line_drawing_description);
    Current_graph_rendering_embedded_icons = gensym_cons_1(triple,
    ...
    Object rotated_width_in_ws, rotated_height_in_ws;
{
    ...
    x_note_fn_call(97,144);
    PUSH_SPECIAL(Image_top_offset_in_ws,image_top_offset_in_ws,1);
      PUSH_SPECIAL(Image_left_offset_in_ws,image_left_offset_in_ws,0);
	if (IFIX(Printing_pass_number) == (SI_Long)2L) {
    ...
    Object top_edge_in_icon_rendering, list_of_color_differences;
{
    ...
    x_note_fn_call(97,151);
    if (IFIX(Printing_pass_number) == (SI_Long)1L) {
	printing_pass_number = FIX((SI_Long)2L);
	PUSH_SPECIAL(Printing_pass_number,printing_pass_number,0);
	  if ( 
    ...
    Object color_value, color_values_for_rasters_qm;
{
    ...
    x_note_fn_call(97,201);
    if (IFIX(Printing_pass_number) == (SI_Long)1L) {
	printing_pass_number = FIX((SI_Long)2L);
	printing_graph_rendering_color_list_qm = color_values_for_rasters_qm;
	adding_from_graph_rendering_p = T;
	PUSH_SPECIAL(Adding_from_graph_rendering_p,adding_from_graph_rendering_p,
		2);
	  PUSH_SPECIAL(Printing_graph_rendering_color_list_qm,printing_graph_rendering_color_list_qm,
		  1);
	    PUSH_SPECIAL(Printing_pass_number,printing_pass_number,0);
	      if ( 
    ...
    Object dateline, erase_dateline, graph_rendering;
{
    ...
    x_note_fn_call(97,202);
    PUSH_SPECIAL(Erase_dateline,erase_dateline,0);
      if (IFIX(Printing_pass_number) == (SI_Long)2L) {
...
Object File_template_instance_counter = UNBOUND;
...
Object Platform_independent_print_spool_command_file_name = UNBOUND;
...
Object Background_processes = UNBOUND;

Object Background_processes_task = UNBOUND;

Object Current_background_process = UNBOUND;
...
Object Chain_of_available_processs = UNBOUND;

Object Process_count = UNBOUND;
    ...
    Object process;
{
    ...
    x_note_fn_call(97,249);
    inline_note_reclaim_cons(process,Nil);
    svref_new_value = Chain_of_available_processs;
    SVREF(process,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_processs = process;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_process_variable, process_count_new_value;
    Object defstruct_g2_process_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(97,251);
    def_structure_process_variable = Nil;
    process_count_new_value = FIXNUM_ADD1(Process_count);
    Process_count = process_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_process_variable;

    x_note_fn_call(97,252);
    def_structure_process_variable = Chain_of_available_processs;
    if (def_structure_process_variable) {
	Chain_of_available_processs = 
		ISVREF(def_structure_process_variable,(SI_Long)0L);
...
{
    Object task_priority, future_task_schedule_modify_arg_2;
    ...
    double task_start_time, future_task_schedule_modify_arg_3, aref_new_value;

    x_note_fn_call(97,255);
	...
	future_task_schedule_modify_arg_2 = task_priority;
	future_task_schedule_modify_arg_3 = task_start_time;
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qservice_background_processes);
	if (Background_processes_task) {
	    if (EQ(Background_processes_task,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Background_processes_task,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Background_processes_task);
	    inline_note_reclaim_cons(Background_processes_task,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Background_processes_task;
	    reclaim_schedule_task_args(ISVREF(Background_processes_task,
		    (SI_Long)9L));
	    temp = Background_processes_task;
	    SVREF(temp,FIX((SI_Long)9L)) = Nil;
	    Structure_being_reclaimed = old_structure_being_reclaimed;
	    temp = Background_processes_task;
	    svref_new_value = Chain_of_available_schedule_tasks;
	    SVREF(temp,FIX((SI_Long)0L)) = svref_new_value;
	    Chain_of_available_schedule_tasks = Background_processes_task;
	}
	...
	Background_processes_task = task;
	return VALUES_1(Background_processes_task);
    }
    else
	return VALUES_1(Nil);
}
...
{
    Object process, ab_loop_list_, old_structure_being_reclaimed, temp;
    Object svref_new_value, temp_1;

    x_note_fn_call(97,256);
    process = Nil;
  ...
  end_loop:;
	...
	temp = Nil;
	Background_processes_task = temp;
    ...
    Object printing_stream;
{
    ...
    x_note_fn_call(97,260);
    PUSH_SPECIAL(Printing_stream,printing_stream,0);
    ...
    Object window_width_1, window_height_1;
{
  ...
  end_loop_1:
    ...
    PUSH_SPECIAL(Gensym_window_for_printing,gensym_window_for_printing,0);
    ...
    Object workspace, x_offset, y_offset;
{
    ...
    PUSH_SPECIAL(Allow_invalidate_on_printing_window_p,allow_invalidate_on_printing_window_p,
	    0);
...
Object Native_printing_icon_x_in_window = UNBOUND;

Object Native_printing_icon_y_in_window = UNBOUND;

Object Native_printing_color_differences = UNBOUND;
    ...
    Object left, top, right, bottom, color_value;
{
    ...
    x_note_fn_call(97,268);
    if (IFIX(Printing_pass_number) == (SI_Long)2L) {
	current_window_1 = Output_window_for_printing_qm;
	PUSH_SPECIAL(Current_window,current_window_1,3);
	  type_of_current_window = ISVREF(Current_window,(SI_Long)1L);
	  PUSH_SPECIAL(Type_of_current_window,type_of_current_window,2);
	    current_native_window_qm = ISVREF(Current_window,(SI_Long)17L);
	    PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,1);
    ...
    Object top_edge_in_icon_rendering, list_of_color_differences;
{
    ...
    native_printing_icon_x_in_window = FIXNUM_MINUS(clipped_left_edge,
	    left_edge_in_icon_rendering);
    PUSH_SPECIAL(Native_printing_icon_x_in_window,native_printing_icon_x_in_window,
	    7);
      native_printing_icon_y_in_window = FIXNUM_MINUS(clipped_top_edge,
	      top_edge_in_icon_rendering);
      PUSH_SPECIAL(Native_printing_icon_y_in_window,native_printing_icon_y_in_window,
	      6);
	native_printing_color_differences = list_of_color_differences;
	PUSH_SPECIAL(Native_printing_color_differences,native_printing_color_differences,
		5);
	  printing_icon_current_region_index_qm = Nil;
	  PUSH_SPECIAL(Printing_icon_current_region_index_qm,printing_icon_current_region_index_qm,
		  4);
    ...
    Object rotated_width_in_ws, rotated_height_in_ws;
{
    ...
    x_note_fn_call(97,290);
    PUSH_SPECIAL(Image_top_offset_in_ws,image_top_offset_in_ws,5);
      PUSH_SPECIAL(Image_left_offset_in_ws,image_left_offset_in_ws,4);
	if (IFIX(Printing_pass_number) == (SI_Long)2L) {
	    current_window_1 = Output_window_for_printing_qm;
	    PUSH_SPECIAL(Current_window,current_window_1,3);
	      type_of_current_window = ISVREF(Current_window,(SI_Long)1L);
    ...
    Object dateline, erase_dateline, graph_rendering;
{
    ...
    x_note_fn_call(97,291);
    PUSH_SPECIAL(Erase_dateline,erase_dateline,4);
      if (IFIX(Printing_pass_number) == (SI_Long)2L) {
	  current_window_1 = Output_window_for_printing_qm;
	  PUSH_SPECIAL(Current_window,current_window_1,3);
	    type_of_current_window = ISVREF(Current_window,(SI_Long)1L);
    ...
    Object gensym_window, width, height;
{
	...
	if (pixmap_qm) {
	    ...
	    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,29);
	      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,28);
		PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,27);
		  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
			...
			PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,
			  ...
			  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
			    ...
			    PUSH_SPECIAL(Current_window,current_window_1,21);
			      drawing_on_window = Nil;
			      PUSH_SPECIAL(Drawing_on_window,drawing_on_window,
				      20);
				  ...
				  PUSH_SPECIAL(Type_of_current_window,type_of_current_window,
					...
					PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
					  ...
					  PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
					    ...
					    PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,
						    13);
					      drawing_on_window = T;
					      PUSH_SPECIAL(Drawing_on_window,drawing_on_window,
						      12);
    ...
    Object image_plane;
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,34);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,33);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,32);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,31);
	    current_image_x_scale = FIX((SI_Long)4096L);
	    current_image_y_scale = FIX((SI_Long)4096L);
	    current_x_origin_of_drawing = FIX((SI_Long)0L);
	    current_y_origin_of_drawing = FIX((SI_Long)0L);
	    PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	      ...
	      PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		      29);
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,28);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,27);
		    current_window_1 = Gensym_window_for_printing;
		    PUSH_SPECIAL(Current_window,current_window_1,26);
		      drawing_on_window = Nil;
		      PUSH_SPECIAL(Drawing_on_window,drawing_on_window,25);
			current_drawing_transfer_mode = 
			  ...
			  PUSH_SPECIAL(Type_of_current_window,type_of_current_window,
				...
				PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
				  ...
				  PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
					...
					PUSH_SPECIAL(Current_draw_paper_p,current_draw_paper_p,
						16);
					  PUSH_SPECIAL(Current_scratchpad_raster_type,current_scratchpad_raster_type,
						  15);
					    drawing_on_window = T;
					    PUSH_SPECIAL(Drawing_on_window,drawing_on_window,
						  ...
						  PUSH_SPECIAL(Icp_printing_message_handler_array,icp_printing_message_handler_array,
							  13);
						    temp = 
									  ...
									  PUSH_SPECIAL(Number_of_icp_bytes_to_fill_buffer,number_of_icp_bytes_to_fill_buffer,
										...
										PUSH_SPECIAL(Number_of_icp_bytes_in_message_group,number_of_icp_bytes_in_message_group,
										  ...
										  PUSH_SPECIAL(Writing_icp_message_group,writing_icp_message_group,
											...
											PUSH_SPECIAL(Current_window,current_window_1,
												0);
											  synchronize_icp_on_window_with_drawing(Current_window,
												  Left_edge_of_draw_area,
												  Top_edge_of_draw_area,
	...
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    return image_plane_drawing_is_completely_finished_qm(image_plane);
}
...
Object Chain_of_available_background_print_workspace_process_state_blocks = UNBOUND;

Object Background_print_workspace_process_state_block_count = UNBOUND;
    ...
    Object background_print_workspace_process_state_block;
{
    ...
    SVREF(background_print_workspace_process_state_block,FIX((SI_Long)0L)) 
	    = svref_new_value;
    Chain_of_available_background_print_workspace_process_state_blocks = 
	    background_print_workspace_process_state_block;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_background_print_workspace_process_state_block_variable;
    Object background_print_workspace_process_state_block_count_new_value;
    Object defstruct_g2_background_print_workspace_process_state_block_variable;
    Object the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(97,310);
    def_structure_background_print_workspace_process_state_block_variable 
	    = Nil;
    background_print_workspace_process_state_block_count_new_value = 
	    FIXNUM_ADD1(Background_print_workspace_process_state_block_count);
    ...
    Object workspace, output_window_qm, plist;
{
	...
	PUSH_SPECIAL(Output_window_for_printing_qm,output_window_for_printing_qm,
		19);
	  native_printer_information = output_window_qm && plist ? 
		  compute_native_printer_information(plist) : Qnil;
	  PUSH_SPECIAL(Native_printer_information,native_printer_information,
		  18);
	    paper_size = printer_setup_particular(Qpaper_size);
	    ...
	    PUSH_SPECIAL(Printing_format,printing_format,17);
	      gensym_window_for_printing = 
		      ...
		      window_frame_width),window_frame_width));
	      PUSH_SPECIAL(Gensym_window_for_printing,gensym_window_for_printing,
		      16);
		printing_stream = make_printing_stream(Printing_format);
		PUSH_SPECIAL(Printing_stream,printing_stream,15);
		  image_plane = Nil;
		  blank_page_p = Nil;
		  pathname_1 = 
		  ...
		  PUSH_SPECIAL(Bitmap_for_printing_qm,bitmap_for_printing_qm,
			  14);
		    last_postscript_composite_object_index = FIX((SI_Long)0L);
		    PUSH_SPECIAL(Last_postscript_composite_object_index,last_postscript_composite_object_index,
			    13);
		      postscript_composite_object_mapping = Nil;
		      PUSH_SPECIAL(Postscript_composite_object_mapping,postscript_composite_object_mapping,
			      12);
			postscript_object_mapping_for_icon_renderings = Nil;
			PUSH_SPECIAL(Postscript_object_mapping_for_icon_renderings,postscript_object_mapping_for_icon_renderings,
				11);
			  postscript_computed_variables_mapping = Nil;
			  PUSH_SPECIAL(Postscript_computed_variables_mapping,postscript_computed_variables_mapping,
				  10);
			    postscript_printing_icon_renderings = Nil;
			    PUSH_SPECIAL(Postscript_printing_icon_renderings,postscript_printing_icon_renderings,
				    9);
			      postscript_object_mapping_for_graph_renderings 
				      = Nil;
			      PUSH_SPECIAL(Postscript_object_mapping_for_graph_renderings,postscript_object_mapping_for_graph_renderings,
				      8);
				fonts_used_in_print_job = Nil;
				PUSH_SPECIAL(Fonts_used_in_print_job,fonts_used_in_print_job,
					7);
				  kanji_fonts_used_in_print_job = Nil;
				  PUSH_SPECIAL(Kanji_fonts_used_in_print_job,kanji_fonts_used_in_print_job,
					  6);
				    fonts_needing_corresponding_kanji_font 
					    = Nil;
				    PUSH_SPECIAL(Fonts_needing_corresponding_kanji_font,fonts_needing_corresponding_kanji_font,
					    5);
					...
					PUSH_SPECIAL(Postscript_definition_operation_counter,postscript_definition_operation_counter,
					  ...
					  PUSH_SPECIAL(Printing_icon_current_region_index_qm,printing_icon_current_region_index_qm,
					    ...
					    printing_pass_number = 
						    FIX((SI_Long)1L);
					    PUSH_SPECIAL(Printing_pass_number,printing_pass_number,
						    1);
					      printing_pass_is_for_header 
						      = Nil;
					      emit_postscript_line_length 
						      = FIX((SI_Long)0L);
					      PUSH_SPECIAL(Emit_postscript_line_length,emit_postscript_line_length,
						      0);
						initial_tile_offset = 
    ...
    Object state_block;
{
    ...
    reclaim_gensym_list_1(ISVREF(state_block,(SI_Long)43L));
    ...
    reclaim_postscript_printing_icon_renderings(ISVREF(state_block,
	    (SI_Long)46L));
    reclaim_gensym_list_1(ISVREF(state_block,(SI_Long)47L));
    reclaim_gensym_list_1(ISVREF(state_block,(SI_Long)48L));
    reclaim_gensym_list_1(ISVREF(state_block,(SI_Long)49L));
    reclaim_gensym_list_1(ISVREF(state_block,(SI_Long)50L));
    temp = 
...
{
    Object workspace, workspace_serial_number, output_window_for_printing_qm;
    ...
    Object postscript_units_per_workspace_unit_mf, x_tile_step, y_tile_step;
    Object printing_format, gensym_window_for_printing, printing_stream;
    Object image_plane, blank_page_p, pathname_1, bitmap_for_printing_qm;
    ...
    Object multipage_legends_p, page_number, x_tile_offset, y_tile_offset;
    Object state_1, substate, background_process_return_status;
    ...
    PUSH_SPECIAL(Emit_postscript_line_length,emit_postscript_line_length,40);
      PUSH_SPECIAL(Printing_pass_number,printing_pass_number,39);
	PUSH_SPECIAL(Printing_icon_current_region_index_qm,printing_icon_current_region_index_qm,
		38);
	  PUSH_SPECIAL(Postscript_definition_operation_counter,postscript_definition_operation_counter,
		  37);
		  ...
		  PUSH_SPECIAL(Fonts_used_in_print_job,fonts_used_in_print_job,
			...
			PUSH_SPECIAL(Postscript_computed_variables_mapping,postscript_computed_variables_mapping,
			  ...
			  PUSH_SPECIAL(Postscript_object_mapping_for_icon_renderings,postscript_object_mapping_for_icon_renderings,
				...
				PUSH_SPECIAL(Bitmap_for_printing_qm,bitmap_for_printing_qm,
					26);
				  PUSH_SPECIAL(Printing_stream,printing_stream,
					  25);
				    PUSH_SPECIAL(Gensym_window_for_printing,gensym_window_for_printing,
					    24);
				      PUSH_SPECIAL(Printing_format,printing_format,
					      23);
					PUSH_SPECIAL(Native_printer_information,native_printer_information,
						22);
					  PUSH_SPECIAL(Output_window_for_printing_qm,output_window_for_printing_qm,
						...
						PUSH_SPECIAL(Printing_in_progress_p,printing_in_progress_p,
							20);
						  if (EQ(Printing_format,
							  Qpostscript))
						      temp =  
						  ...
						  if (IFIX(state_1) == 
							  ...
							  priority_of_next_task 
								  = 
								  Most_positive_fixnum;
							  PUSH_SPECIAL(Priority_of_next_task,priority_of_next_task,
								  1);
							    PUSH_SPECIAL(Maximum_time_slice_size,maximum_time_slice_size,
								    0);
...
void printing_INIT()
{
    ...
    Object Qutilities2, Qbackground_print_workspace_process_state_block_count;
    Object Qchain_of_available_background_print_workspace_process_state_blocks;
    Object string_constant_208, Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_207, Qunique_structure_type_of_ab_name_qm;
    ...
    Object Qprocess_count, Qchain_of_available_processs, string_constant_206;
    Object string_constant_205, Qprocess_description, Qprinting;
    Object Qbackground_processes_task, Qbackground_processes;
    Object string_constant_204, list_constant_82;
    Object Qfile_template_instance_counter;
    ...
    Object list_constant_116, list_constant_115, list_constant_114, Qkanji16;
    Object Qthai16, Qhebrew16, Qslavic16, list_constant_113, list_constant_112;
    ...
    Object list_constant_83, list_constant_84, Qline_drawing_for_printing;
    Object Qoutstanding_line_drawing_for_printing_count;
    Object Qline_drawing_for_printing_structure_memory_usage;
    Object Qline_drawing_for_printing_count;
    Object Qchain_of_available_line_drawing_for_printings, string_constant_203;
    Object string_constant_202, Qnamed_dynamic_extent_description;
    ...
    string_constant_177 = 
	    STATIC_STRING("1q4z8r83Y9y83Y9y83ETy83ETy01m1n83AWy3-Wy83Csy2l838+y837ny001n1l8o1l8l1m8p83EVy000004z8r83XYy83XYy83ETy83ETy01q2l83EGy83DPy2l83EF");
    string_constant_178 = 
	    STATIC_STRING("y83EOy1n83DOy9k83Csy1n83FTy9l83Csy1n83Eoy9m83Csy1n83B*y9n83Csy001n1l8o1l8l1m8p83ESy000004z8r83Y7y83Y7y83ETy83ETy01n2l83F9y+3Cy3-");
    string_constant_179 = 
    ...
    string_constant_180 = 
	    STATIC_STRING("004z8r83YAy83YAy83ETy83ETy0s001n1l8o1l8l1m8p83-Zy000004z8r83EWy83EWy83ETy83ETy083EPy001n1l8o1l8l1m8p83EWy000004z8r83XXy83XXy83ET");
    string_constant_181 = STATIC_STRING("y83ETy00001n1l8o1l8l1m8p83Ky00000");
    float_constant_11 = STATIC_FLOAT(0.5);
    string_constant_182 = 
	    STATIC_STRING("1s8q1n83ETy1l83-sy83ey1p83Y9y1m1n83AWy3-Wy83Csy2l838+y837ny8o8l1m8p83EVy1p83XYy1q2l83EGy83DPy2l83EFy83EOy1n83DOy9k83Csy1n83FTy9k");
    string_constant_183 = 
	    STATIC_STRING("83Csy1n83Eoy9k83Csy1n83B*y9k83Csy8o8l1m8p83ESy1p83Y7y1n2l83F9y5uprint-*.ps1l83F8y2l83ERy5runknown8o8l1m8p83EUy1p83YAys8o8l1m8p83");
    string_constant_184 = 
	    STATIC_STRING("-Zy1p83EWy83EPy8o8l1m8p83EWy1p83XXy08o8l1m8p83Ky");
    ...
    string_constant_185 = 
	    STATIC_STRING("1v1m83-2Fy1m83-Hy83-2Gy1m83-2Gy1m9k83Csy1m83-2Gy1m9k83-YZy1m83-2Gy1m9k83-Loy1m83-2Gy1m9k83-Lpy1m83-2Gy1m9k83-Mmy1m83-2Gy1m9k83-U");
    string_constant_186 = 
	    STATIC_STRING("5y1m83-2Gy1m9k83-Tby1m83-2Gy1m9k83-dky1m83-2Gy1m9k83-dly1m83-2Gy1m9k83-dty");
    clear_optimized_constants();
    ...
    list_constant_23 = STATIC_LIST((SI_Long)5L,list_constant_77,
	    ...
	    list_constant_81);
    string_constant_187 = STATIC_STRING("1l1n83EVy1n83AWy1m9k83-ay838+y1mln");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_187));
    string_constant_188 = 
	    STATIC_STRING("1l1n83AWy1o1m9k83*ry1m9k83-mIy1m9k83-Py83-1ly2l83AWyo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_188));
    string_constant_189 = 
	    STATIC_STRING("1l1n838+y1o1m9k83*ny1m9k83t9y1m9k83-Py83-1jy2l838+yo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_189));
    string_constant_190 = 
	    STATIC_STRING("1m1m83-1ly1m9k83-mDy1n83-1ly1p83-Hy1m9k83*ry1m9k83Fgy1m9k83Xly83-2Gy1mlp");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_190));
    string_constant_191 = 
	    STATIC_STRING("1n1m83-1jy1m9k837ny1m83-1jy1m9k83--cy1m83-1jy1m9k83-Umy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_191));
    string_constant_192 = 
	    STATIC_STRING("1n1n83EWy1m9k83EPy83EPy1n83EWy1m1m9k83-SUy1m9k83EPy83-Sjy1n83EWy1m9k83-amy83-amy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qprinter_translation_details,T,
	    Quse_slot_value_compiler_for_default_overrides_p);
    string_constant_193 = 
	    STATIC_STRING("1v1n83ESy1v83EGy1m9k83-ay83EFy1m9k83-ay83DOy1m9k83-ay83FTy1m9k83-ay83Eoy1m9k83-ay83B*y1qlnprtv1n83EGy1o1m9k83-hHy1m9k83nGy1m9k83");
    string_constant_194 = 
	    STATIC_STRING("-Py83-8hy2l83EGyo1n83-8hy1n83-2Fy1m9k83*uy83-2Fy1n83J2yln1n83EFy1o1m9k83-hHy1m9k83-gwy1m9k83-Py83-hIy2l83EFyo1m83-hIy1m9k83EOy1m");
    string_constant_195 = 
	    STATIC_STRING("83-hIy1m9k83-bJy1n83DOy1m1m9k83*hy83-cly2l83DOym1n83FTy1m1m9k83hy83-cly2l83FTym1n83Eoy1m1m9k83-cy83-cly2l83Eoym1n83B*y1m1m9k83gy");
    string_constant_196 = 
	    STATIC_STRING("83-cly2l83B*ym1n83-cly1n1m9k83-cky1m9k83-Py83-2Fyn");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_197 = 
	    STATIC_STRING("1z1m83-8hy1m9k83DPy1m83-8hy1m9k83-bYy1m83-8hy1m9k83-bPy1m83-8hy1m9k83-Ivy1m83-8hy1m9k83-Iwy1m83-8hy1m9k83-Ixy1m83-8hy1m9k83-J+y1");
    string_constant_198 = 
	    STATIC_STRING("m83-8hy1m9k83-J-y1m83-8hy1m9k83-J*y1m83-8hy1m9k83-KPy1m83-8hy1m9k83-KQy1m83-8hy1m9k83-KRy1m83-8hy1m9k83-KSy1m83-8hy1m9k83-KTy1m8");
    string_constant_199 = STATIC_STRING("3-8hy1m9k83-KUy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_200 = 
	    STATIC_STRING("1o1n83EUy1p83F9y1m9k83-ay83F8y1m9k83-ay83ERy1nlnp1n83F9y1p1m9k83-p1y1m9k83-Tgy1m9k83-qky1m9k83-Py83-Uy2l83F9yp1n83F8y1q1m9k83-p0");
    string_constant_201 = 
	    STATIC_STRING("y1m9k83LOy1m9k83=3y1m9k83-iUy1m9k83-Py83Ky2l83F8yq1n83ERy1o1m9k83-iUy1m9k83-Y6y1m9k83-Py83-Uy2l83ERyo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_202 = 
	    STATIC_STRING("43Dy8m83kay1n83kay8n8k1l8n0000001l1n8y83-4ny1o83-29y83-Gqy83-*9y83snykpk0k0");
    ...
    Qline_drawing_for_printing_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_203 = STATIC_STRING("1q83kay8s83-bmy09k9l");
    clear_optimized_constants();
    ...
    list_constant_83 = STATIC_CONS(FIX((SI_Long)0L),Qnil);
    list_constant_84 = STATIC_CONS(FIX((SI_Long)0L),list_constant_83);
    list_constant_26 = STATIC_CONS(Qnil,list_constant_84);
    Qnormal = STATIC_SYMBOL("NORMAL",AB_package);
    list_constant_85 = STATIC_CONS(Qnormal,list_constant_84);
    Qclockwise_90 = STATIC_SYMBOL("CLOCKWISE-90",AB_package);
    list_constant_86 = STATIC_LIST((SI_Long)3L,Qclockwise_90,
	    FIX((SI_Long)0L),FIX((SI_Long)90L));
    Qclockwise_180 = STATIC_SYMBOL("CLOCKWISE-180",AB_package);
    list_constant_87 = STATIC_LIST((SI_Long)3L,Qclockwise_180,
	    FIX((SI_Long)0L),FIX((SI_Long)180L));
    Qclockwise_270 = STATIC_SYMBOL("CLOCKWISE-270",AB_package);
    list_constant_88 = STATIC_LIST((SI_Long)3L,Qclockwise_270,
	    FIX((SI_Long)0L),FIX((SI_Long)270L));
    Qreflected = STATIC_SYMBOL("REFLECTED",AB_package);
    list_constant_89 = STATIC_LIST_STAR((SI_Long)3L,Qreflected,
	    FIX((SI_Long)1L),list_constant_83);
    Qreflected_clockwise_90 = STATIC_SYMBOL("REFLECTED-CLOCKWISE-90",
	    AB_package);
    list_constant_90 = STATIC_LIST((SI_Long)3L,Qreflected_clockwise_90,
	    FIX((SI_Long)1L),FIX((SI_Long)-90L));
    Qreflected_clockwise_180 = STATIC_SYMBOL("REFLECTED-CLOCKWISE-180",
	    AB_package);
    list_constant_91 = STATIC_LIST((SI_Long)3L,Qreflected_clockwise_180,
	    FIX((SI_Long)1L),FIX((SI_Long)-180L));
    Qreflected_clockwise_270 = STATIC_SYMBOL("REFLECTED-CLOCKWISE-270",
	    AB_package);
    list_constant_92 = STATIC_LIST((SI_Long)3L,Qreflected_clockwise_270,
    ...
    list_constant_93 = STATIC_CONS(Qforeground,Qforeground);
    list_constant_27 = STATIC_CONS(list_constant_93,Qnil);
    ...
    list_constant_95 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)260L),
	    FIX((SI_Long)5L));
    list_constant_96 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)261L),
	    FIX((SI_Long)6L));
    list_constant_97 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)262L),
	    FIX((SI_Long)7L));
    list_constant_98 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)263L),
	    FIX((SI_Long)8L));
    list_constant_99 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)280L),
	    FIX((SI_Long)9L));
    list_constant_100 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)281L),
	    FIX((SI_Long)10L));
    list_constant_101 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)323L),
	    FIX((SI_Long)11L));
    list_constant_102 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)324L),
	    FIX((SI_Long)12L));
    list_constant_103 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)346L),
	    FIX((SI_Long)13L));
    list_constant_104 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)347L),
	    FIX((SI_Long)14L));
    list_constant_105 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)377L),
	    FIX((SI_Long)15L));
    list_constant_94 = STATIC_CONS(FIX((SI_Long)16L),Qnil);
    list_constant_106 = STATIC_CONS(FIX((SI_Long)378L),list_constant_94);
    list_constant_107 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)379L),
	    FIX((SI_Long)17L));
    list_constant_108 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)380L),
	    FIX((SI_Long)18L));
    list_constant_109 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)779L),
	    FIX((SI_Long)19L));
    list_constant_110 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)368L),
	    FIX((SI_Long)20L));
    list_constant_111 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)369L),
	    FIX((SI_Long)21L));
    list_constant_112 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)336L),
	    FIX((SI_Long)22L));
    list_constant_113 = STATIC_LIST((SI_Long)2L,FIX((SI_Long)337L),
	    FIX((SI_Long)23L));
    list_constant_28 = STATIC_LIST((SI_Long)19L,list_constant_95,
    ...
    list_constant_114 = STATIC_LIST((SI_Long)8L,FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L));
    list_constant_115 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    ...
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    list_constant_114);
    list_constant_116 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    ...
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    list_constant_115);
    list_constant_117 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    ...
	    FIX((SI_Long)144L),FIX((SI_Long)144L),FIX((SI_Long)144L),
	    list_constant_116);
    list_constant_118 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)169L),
    ...
    list_constant_119 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)144L),
	    ...
	    list_constant_118);
    list_constant_120 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)187L),
	    ...
	    list_constant_119);
    list_constant_121 = STATIC_LIST_STAR((SI_Long)32L,FIX((SI_Long)144L),
    ...
    Postscript_encoding_for_tilde_escape_characters = make_array(3,
	    add1(FIX((SI_Long)255L)),Kinitial_contents,list_constant_122);
    ...
    string_constant_204 = STATIC_STRING("g2print");
    ...
    string_constant_205 = 
	    STATIC_STRING("43Dy8m839ny1n839ny8n8k1l8n0000001l1n8y83-5Ay0ksk0k0");
    ...
    string_constant_206 = STATIC_STRING("1q839ny8s83-jHy09k9l");
    clear_optimized_constants();
    push_optimized_constant(Qoutstanding_process_count);
    push_optimized_constant(Qprocess_structure_memory_usage);
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_206));
	...
	The_type_description_of_background_print_workspace_process_state_block 
		= Nil;
    string_constant_207 = 
	    STATIC_STRING("43Dy8m83fMy1n83fMy8n8k1l8n0000001m1n8y83-2ry01m83My83-A6yk3-0yk0k0");
    temp_1 = 
	    The_type_description_of_background_print_workspace_process_state_block;
    The_type_description_of_background_print_workspace_process_state_block 
	    = load_and_initialize_type_description(temp_1,
    ...
    Qbackground_print_workspace_process_state_block_structure_memory_usage 
	    ...
	    AB_package);
    string_constant_208 = STATIC_STRING("1q83fMy8s83-KXy09k9l");
    clear_optimized_constants();
