...
Object Simulation_procedure_completion_form = UNBOUND;
...
Object Set_of_variables_to_simulation_evaluate = UNBOUND;

Object Current_simulation_category = UNBOUND;

Object Working_on_variables_that_need_simulated_values_stack_qm = UNBOUND;

Object Variable_is_at_bottom_of_stack_qm = UNBOUND;

Object Dont_proceed_to_next_variable_qm = UNBOUND;

Object Within_simulator_for_stack_error_qm = UNBOUND;
    ...
    Object rest_of_set, simulation_category;
{
    ...
    x_note_fn_call(186,10);
  next_loop:
    if ( !TRUEP(rest_of_set))
	goto end_loop;
    current_computation_flags = FIX((SI_Long)18L);
    PUSH_SPECIAL(Current_computation_flags,current_computation_flags,23);
	...
	PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
	  ...
	  PUSH_SPECIAL(Current_computation_frame,current_computation_frame,20);
		...
		PUSH_SPECIAL(Current_environment,current_environment,17);
		  ...
		  PUSH_SPECIAL(Evaluating_simulator_procedure_qm,evaluating_simulator_procedure_qm,
		    ...
		    PUSH_SPECIAL(Explanation_variables,explanation_variables,
		      ...
		      PUSH_SPECIAL(Stack_expiration,stack_expiration,14);
			...
			PUSH_SPECIAL(Variables_that_did_not_have_values,variables_that_did_not_have_values,
			  ...
			  set_of_variables_to_simulation_evaluate = 
				  rest_of_set;
			  PUSH_SPECIAL(Set_of_variables_to_simulation_evaluate,set_of_variables_to_simulation_evaluate,
				  12);
			    current_simulation_category = simulation_category;
			    PUSH_SPECIAL(Current_simulation_category,current_simulation_category,
				    11);
				...
				PUSH_SPECIAL(Dont_backward_chain_in_sim_eval_qm,dont_backward_chain_in_sim_eval_qm,
				  ...
				  PUSH_SPECIAL(Dont_proceed_to_next_variable_qm,dont_proceed_to_next_variable_qm,
					  8);
				    working_on_variables_that_need_simulated_values_stack_qm 
					    = Nil;
				    PUSH_SPECIAL(Working_on_variables_that_need_simulated_values_stack_qm,working_on_variables_that_need_simulated_values_stack_qm,
					    7);
				      variable_is_at_bottom_of_stack_qm = Nil;
				      PUSH_SPECIAL(Variable_is_at_bottom_of_stack_qm,variable_is_at_bottom_of_stack_qm,
					      6);
					within_simulator_for_stack_error_qm 
						= T;
					PUSH_SPECIAL(Within_simulator_for_stack_error_qm,within_simulator_for_stack_error_qm,
						5);
					  ...
					  PUSH_SPECIAL(Saved_warning_level,saved_warning_level,
						...
						saved_source_stepping_level 
							= Nil;
						PUSH_SPECIAL(Saved_source_stepping_level,saved_source_stepping_level,
							1);
    ...
    Object variable;
{
    ...
    x_note_fn_call(186,11);
    current_computation_flags = FIX((SI_Long)18L);
    PUSH_SPECIAL(Current_computation_flags,current_computation_flags,22);
      current_computation_activity = FIX((SI_Long)0L);
      PUSH_SPECIAL(Current_computation_activity,current_computation_activity,
	      21);
	current_computation_component_particulars = Nil;
	PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
		20);
	  current_computation_frame = Nil;
	  PUSH_SPECIAL(Current_computation_frame,current_computation_frame,19);
	    current_computation_instance = Nil;
	    PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
		    18);
	      current_computation_style = Nil;
	      PUSH_SPECIAL(Current_computation_style,current_computation_style,
		      17);
		current_environment = Qsimulator;
		PUSH_SPECIAL(Current_environment,current_environment,16);
		  evaluating_simulator_procedure_qm = Nil;
		  PUSH_SPECIAL(Evaluating_simulator_procedure_qm,evaluating_simulator_procedure_qm,
			  15);
		    explanation_variables = Nil;
		    PUSH_SPECIAL(Explanation_variables,explanation_variables,
			    14);
		      stack_expiration = Qnever;
		      PUSH_SPECIAL(Stack_expiration,stack_expiration,13);
			variables_that_did_not_have_values = Nil;
			PUSH_SPECIAL(Variables_that_did_not_have_values,variables_that_did_not_have_values,
				12);
			  set_of_variables_to_simulation_evaluate = 
...
Object enter_next_simulation_variable_context()
{
	...
	if (EQ(Current_simulation_category,Qdependent) || 
		...
		if (temp_list)
		    reclaim_gensym_cons_1(temp_list);
		if (runtime_info_qm)
    ...
    Object value_known_qm, simulation_environment_vector;
{
    ...
    Object gensymed_symbol_2, type_specification, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, svref_new_value, simulation_info_qm, k_value;
    Object runtime_structure, managed_number_or_value, previous_value;
    Object integer_portion, micro_time, h, managed_number, current_value;
    Object new_value, top_of_stack, message_1;
    ...
    Object variable_simulation_runtime_structure;
{
	...
	if (EQ(Current_environment,Qsimulator)) {
	    ...
	    if ( !TRUEP(ISVREF(simulation_runtime_information_qm,
		    (SI_Long)23L))) {
		svref_arg_1 = Current_model_runtime_info_qm;
		gensym_push_modify_macro_arg = Current_computation_instance;
		car_1 = gensym_push_modify_macro_arg;
	    ...
	    if ( !TRUEP(ISVREF(simulation_runtime_information_qm,
		    (SI_Long)23L))) {
		svref_arg_1 = Current_model_runtime_info_qm;
		gensym_push_modify_macro_arg = variable;
		car_1 = gensym_push_modify_macro_arg;
		cdr_1 = ISVREF(svref_arg_1,(SI_Long)30L);
		svref_new_value = gensym_cons_1(car_1,cdr_1);
		SVREF(svref_arg_1,FIX((SI_Long)30L)) = svref_new_value;
...
void simulate2_INIT()
{
    Object AB_package, Qcurrent_computation_frame, Qsimulation_initial_value;
    Object list_constant_2, Qsimulate2, Qwithin_simulator_for_stack_error_qm;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, list_constant_1, Qsimulate1;
    Object Qsimulation_procedure_completion_form;
    Object Qrestart_simulator_after_procedure, Qsimulate_one_cycle;

    x_note_fn_call(186,43);
    SET_PACKAGE("AB");
