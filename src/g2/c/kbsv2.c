    ...
    Object record_window_position_too_qm, module_qm;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = 
		gensym_cons_1(make_image_plane_description(image_plane,
    ...
    Object image_plane, record_window_position_too_qm;
{
    ...
    return VALUES_1(nconc2(gensymed_symbol,record_window_position_too_qm ? 
	    gensym_list_2(record_window_position_too_qm ? 
...
static Object Qmain_kb_being_read_qm;  /* main-kb-being-read? */
...
Object restore_image_planes_to_pane_now_or_later varargs_1(int, n)
{
  ...
  next_loop_1:
    ...
    if (temp) {
	Saved_detail_pane_description = delete_gensym_element_1(entry,
    ...
    Object workspace;
{
  ...
  next_loop_1:
    ...
    if (temp) {
	Saved_detail_pane_description = 
		delete_gensym_element_1(image_plane_description,
		Saved_detail_pane_description);
...
Object Last_assigned_kb_serial_number = UNBOUND;
...
Object Ui_client_interface_saved_icp_socket_list = UNBOUND;

Object Ui_client_interface_saved_session_list = UNBOUND;
...
Object Deleting_ui_client_interfaces_for_clear_kb = UNBOUND;
...
Object save_and_delete_ui_client_interfaces()
{
    ...
    PUSH_SPECIAL(Deleting_ui_client_interfaces_for_clear_kb,deleting_ui_client_interfaces_for_clear_kb,
	    1);
      scope_conses = Scope_conses;
      ab_loopvar_ = Nil;
      ab_loopvar__1 = Nil;
    ...
    Object frame, representation_list;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(restore_ui_client_session_item_representation(representation_data,
	    frame),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
...
Object restore_ui_client_interfaces()
{
    ...
    Object cons_1, next_cons, cdr_new_value, temp, slot_name, ab_loop_list_;
    Object value, ab_loop_list__1, sessions, current_icp_socket, network_type;
  ...
  next_loop:
    ...
    temp = CDR(frame_spec);
    slot_value_list = CAR(temp);
    temp = CDR(frame_spec);
    temp = CDR(temp);
    representation_list = CAR(temp);
  ...
  end_1:;
    ...
    icp_object_map = Nil;
    PUSH_SPECIAL(Current_icp_socket,current_icp_socket,1);
    next_loop_2:
      ...
      temp = CDR(temp);
      temp = CDR(temp);
      remote_process_initialization_string = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      name_or_names_for_frame = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      ...
      temp = CDR(temp);
      temp = CDR(temp);
      module_information_callback_qm = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      ...
      temp = CDR(temp);
      temp = CDR(temp);
      module_information_callback_data = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      ...
      temp = CDR(temp);
      temp = CDR(temp);
      progress_callback_data = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
      ...
      temp = CDR(temp);
      temp = CDR(temp);
      session_position_list = CAR(temp);
      temp = CDR(frame_spec);
      temp = CDR(temp);
      temp = CDR(temp);
      temp = CDR(temp);
	...
	next_loop_3:
	  ...
	  change_slot_value(3,session,Qui_client_session_parent_interface,
		  ui_client_interface);
	  ab_loopvar__2 = gensym_cons_1(session,Nil);
	  if (ab_loopvar__1)
	      M_CDR(ab_loopvar__1) = ab_loopvar__2;
	  else
	      ab_loopvar_ = ab_loopvar__2;
	...
	end_2:;
	  change_slot_value(3,ui_client_interface,
		  Qui_client_interface_sessions,temp);
	  change_slot_value(3,ui_client_interface,
...
Object clear_kb varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
      ...
      in_clear_kb_p = T;
      PUSH_SPECIAL(In_clear_kb_p,in_clear_kb_p,13);
    ...
    Object keep_locations_entry_qm, try_to_do_deferred_user_notifications_qm;
{
    ...
    old_kb_specific_property_list_property_name = 
	    Current_kb_specific_property_list_property_name;
    PUSH_SPECIAL(Releasing_kb_qm,releasing_kb_qm,1);
...
Object Ignore_kb_state_changes_p = UNBOUND;
    ...
    Object frame, kb_state_variable;
{
	...
	if (EQ(kb_state_variable,Qworkspace_frame)) {
	    ...
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)3L) : FIX((SI_Long)0L);
	    temp_3 = gensym_list_4(temp_1,temp_2,temp_3,gensymed_symbol);
	}
	else if (EQ(kb_state_variable,Qitem_position) || 
		EQ(kb_state_variable,Qicon_position)) {
	    temp_3 = item_x_position(frame);
	    temp_3 = gensym_cons_1(temp_3,item_y_position(frame));
	}
	    ...
	    temp_3 = copy_tree_using_gensym_conses_1(ISVREF(frame,
		    (SI_Long)20L));
	...
	return set_non_savable_lookup_slot_value(frame,
		Qoriginal_kb_state_plist,gensym_cons_1(kb_state_variable,
		gensym_cons_1(temp_3,original_kb_state_plist)));
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object frame, slot_description;
{
	...
	if (plist_entry);
	    ...
	    temp = gensym_list_2(Qtext_of_changed_slots,Nil);
	...
	if ( !temp_1) {
		...
		temp = 
			...
			slot_description);
	    second_new_value = gensym_cons_1(slot_denotation,
		    gensym_cons_1(temp,SECOND(plist_entry)));
    ...
    Object frame, slot_description_or_symbol_or_state_plist;
{
	...
	if ( !TRUEP(memq_function(slot_denotation,
		attributes_permamently_changed)))
	    attributes_permamently_changed = gensym_cons_1(slot_denotation,
		    attributes_permamently_changed);
	goto next_loop_1;
      end_loop_1:;
	ab_loop_list_ = CDDR(ab_loop_list_);
    ...
    Object frame;
{
	...
	Kb_state_changes = gensym_cons_1(Nil,Kb_state_changes);
	set_non_savable_lookup_slot_value(frame,
    ...
    Object frame;
{
	...
	set_non_savable_lookup_slot_value(frame,
		Qkb_state_changes_previous_cons_qm,Nil);
	M_CDR(this_cons) = Nil;
	reclaim_gensym_cons_1(this_cons);
    ...
    Object frame;
{
  ...
  next_loop:
	...
	change_slot_value(3,frame,Qbox_translation_and_text,
		gensym_cons_1(CAR(temp),original_value));
	M_CADR(plist) = Nil;
    }
    else if (EQ(kb_state_variable,Qg2_array_length))
...
Object Default_g2_init_pathname = UNBOUND;
...
Object Pathname_for_disabling_g2_init_command_line = UNBOUND;
...
Object Command_line_qm = UNBOUND;
...
Object do_g2_init_file()
{
	...
	if (PUSH_UNWIND_PROTECT(1)) {
		...
		PUSH_SPECIAL(Doing_g2_init_file_p,doing_g2_init_file_p,1);
		  ...
		  if (init_file_stream_qm) {
		      ...
		      PUSH_SPECIAL(Command_line_qm,command_line_qm,0);
		      next_loop:
...
Object Default_g2_kb_pathname = UNBOUND;
...
Object Pathname_for_disabling_g2_kb_command_line = UNBOUND;
...
Object do_g2_kb_load_at_launch()
{
	...
	if (kb_file_pathname_qm) {
		...
		start_on_load_p = 
			get_gensym_environment_variable(array_constant_7);
	    PUSH_SPECIAL(Doing_g2_init_kb_p,doing_g2_init_kb_p,0);
...
Object Transients_to_delete = UNBOUND;

Object Represented_frames_in_limbo = UNBOUND;
...
Object kb_is_savable_p()
{
    ...
    PUSH_SPECIAL(Transients_to_delete,transients_to_delete,2);
      PUSH_SPECIAL(Represented_frames_in_limbo,represented_frames_in_limbo,1);
    ...
    Object transients_to_delete;
{
    ...
    PUSH_SPECIAL(Transients_to_delete,transients_to_delete,6);
      PUSH_SPECIAL(Represented_frames_in_limbo,represented_frames_in_limbo,5);
    ...
    Object kb_workspace;
{
	...
	gensymed_symbol = ISVREF(parent_qm,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)5L) : Nil;
    ...
    Object block;
{
  ...
  next_loop:
	...
	if (temp)
	    ...
	    gensymed_symbol = ISVREF(parent_1,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)5L) : Nil;
	    temp_1 = gensymed_symbol;
	    if (temp_1);
...
Object Kb_save_termination_reason_qm = UNBOUND;
...
Object reject_save_kb_if_not_savable()
{
    ...
    PUSH_SPECIAL(Transients_to_delete,transients_to_delete,0);
...
void kb_save2_INIT()
{
    ...
    Object Qpathname_for_disabling_g2_kb_command_line;
    Object Qinitializer_for_pathname_for_disabling_g2_kb_command_line;
    Object Kfuncall, Qdefault_g2_kb_pathname;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qkb_save2;
    Object Qautostart_reason_in_init_file_qm;
    Object Qautostart_after_doing_init_file_qm, Qdoing_g2_init_kb_p;
    Object Qdoing_g2_init_file_p, list_constant_14;
    Object Qpathname_for_disabling_g2_init_command_line;
    Object Qinitializer_for_pathname_for_disabling_g2_init_command_line;
    Object Kabsolute, list_constant_13, Qdefault_g2_init_pathname;
    Object Qinitialize_default_g2_init_pathname, Qtext_box_format;
    Object Qtext_cell_plist_for_text_box, Qworkspace_foreground_color_qm;
    Object Qworkspace_background_color_qm, Qicon_attributes_plist;
    Object Qnot_savable, Qdependant, Qdepreciated;
    Object Qrestore_ui_client_interfaces;
    Object Qui_client_interface_saved_session_list;
    Object Qui_client_interface_saved_icp_socket_list;
    Object Qinitialize_current_kb_serial_number;
    Object Qlast_assigned_kb_serial_number, list_constant_11;
    Object Qcurrent_kb_serial_number;
