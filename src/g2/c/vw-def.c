...
Object Chain_of_available_access_errors = UNBOUND;

Object Access_error_count = UNBOUND;
    ...
    Object access_error;
{
    ...
    svref_new_value = Chain_of_available_access_errors;
    SVREF(access_error,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_access_errors = access_error;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_access_error_variable, access_error_count_new_value;
    ...
    access_error_count_new_value = FIXNUM_ADD1(Access_error_count);
    Access_error_count = access_error_count_new_value;
...
Object Chain_of_available_class_subscriptionss = UNBOUND;

Object Class_subscriptions_count = UNBOUND;
    ...
    Object class_subscriptions;
{
    ...
    svref_new_value = Chain_of_available_class_subscriptionss;
    SVREF(class_subscriptions,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_class_subscriptionss = class_subscriptions;
    return VALUES_1(Nil);
}
...
Object make_permanent_class_subscriptions_structure_internal()
{
    ...
    Object class_subscriptions_count_new_value;
    ...
    class_subscriptions_count_new_value = 
	    FIXNUM_ADD1(Class_subscriptions_count);
    Class_subscriptions_count = class_subscriptions_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_class_subscriptions = UNBOUND;

Object Class_subscription_count = UNBOUND;
    ...
    Object class_subscription;
{
    ...
    svref_new_value = Chain_of_available_class_subscriptions;
    SVREF(class_subscription,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_class_subscriptions = class_subscription;
    return VALUES_1(Nil);
}
...
Object make_permanent_class_subscription_structure_internal()
{
    ...
    Object class_subscription_count_new_value;
    ...
    class_subscription_count_new_value = FIXNUM_ADD1(Class_subscription_count);
    Class_subscription_count = class_subscription_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Notification_data_version_map = UNBOUND;

Object Current_lookup_data = UNBOUND;
    ...
    Object arg_list, subscription_handle;
{
  ...
  next_loop:
    ...
    return_list = gensym_cons_1(temp,return_list);
    goto next_loop;
  end_loop:
    return_list = gensym_cons_1(subscription_handle,return_list);
    ...
    Object arg_lists;
{
  ...
  end_loop_1:;
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(arg_lists);
    return VALUES_1(Qnil);
}

Object The_type_description_of_javalink_versioned_call_data = UNBOUND;

Object Chain_of_available_javalink_versioned_call_datas = UNBOUND;

Object Javalink_versioned_call_data_count = UNBOUND;
    ...
    Object javalink_versioned_call_data;
{
    ...
    svref_new_value = Chain_of_available_javalink_versioned_call_datas;
    SVREF(javalink_versioned_call_data,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_javalink_versioned_call_datas = 
	    javalink_versioned_call_data;
    return VALUES_1(Nil);
}
...
Object make_permanent_javalink_versioned_call_data_structure_internal()
{
    ...
    Object javalink_versioned_call_data_count_new_value;
    ...
    javalink_versioned_call_data_count_new_value = 
	    FIXNUM_ADD1(Javalink_versioned_call_data_count);
    ...
    Object notification_type, item, data;
{
	...
	new_arg_lists_end = gensym_cons_1(gensym_list_3(notification_type,
		item,data),Nil);
...
{
    Object representation, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object svref_new_value;
...
Object Available_representation_handle_hash_vector_109_vectors = UNBOUND;

Object Count_of_representation_handle_hash_vector_109_vectors = UNBOUND;
...
{
    Object count_of_representation_handle_hash_vector_109_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(93,47);
    count_of_representation_handle_hash_vector_109_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_representation_handle_hash_vector_109_vectors);
...
Object make_representation_handle_hash_vector()
{
    ...
    if (Available_representation_handle_hash_vector_109_vectors) {
	temp = M_CAR(Available_representation_handle_hash_vector_109_vectors);
	temp_1 = 
		M_CDR(Available_representation_handle_hash_vector_109_vectors);
	inline_note_reclaim_cons(Available_representation_handle_hash_vector_109_vectors,
		Qab_gensym);
	cdr_arg = Available_representation_handle_hash_vector_109_vectors;
	...
	Available_representation_handle_hash_vector_109_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object representation_handle_hash_vector_109_vector;
{
    ...
    cdr_new_value = Available_representation_handle_hash_vector_109_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_representation_handle_hash_vector_109_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}

/* MUTATE-REPRESENTATION-HANDLE-TREE-FOR-HASH-TREE-ENTRY */
Object mutate_representation_handle_tree_for_hash_tree_entry(entry_cons,
	    new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(93,50);
    IDENTITY(M_CDR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_representation_handle_tree_for_hash_tree_entry = UNBOUND;

/* CLEAR-REPRESENTATION-HANDLE-TREE */
Object clear_representation_handle_tree(representation_handle_tree_for_hash_binary_tree)
    Object representation_handle_tree_for_hash_binary_tree;
{
    ...
    element_qm = Nil;
  next_loop:
    element_qm = CDR(representation_handle_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    ...
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
	    gensymed_symbol,
	    representation_handle_tree_for_hash_binary_tree,gensymed_symbol);
    old_entry = NTH_VALUE((SI_Long)1L, result);
    IDENTITY(old_entry);
    goto next_loop;
  end_loop:;
    return VALUES_1(representation_handle_tree_for_hash_binary_tree);
}
...
Object reclaim_representation_handle(representation_handle_hash_table)
    Object representation_handle_hash_table;
{
    Object representation_handle_tree_for_hash_binary_tree, element_qm;
  ...
  next_loop:
    if (index_1 >= (SI_Long)109L)
	goto end_loop;
    representation_handle_tree_for_hash_binary_tree = 
	    ISVREF(representation_handle_hash_table,index_1);
    element_qm = Nil;
  next_loop_1:
    element_qm = M_CDR(representation_handle_tree_for_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop_1;
    ...
    goto next_loop_1;
  end_loop_1:
    inline_note_reclaim_cons(representation_handle_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(representation_handle_tree_for_hash_binary_tree) = cdr_new_value;
    Available_gensym_conses = representation_handle_tree_for_hash_binary_tree;
...
Object The_representation_handle_hashtable = UNBOUND;
    ...
    Object handle, representation;
{
    ...
    temp = The_representation_handle_hashtable;
    temp_1 = gensymed_symbol % (SI_Long)109L;
    return set_balanced_binary_tree_entry(SVREF(temp,FIX(temp_1)),Qeq,
	    Fp_mutate_representation_handle_tree_for_hash_tree_entry,T,
	    handle,FIX(gensymed_symbol),representation);
}
    ...
    Object handle;
{
  ...
  end_2:;
	...
	temp_1 = gensymed_symbol % (SI_Long)109L;
	result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		handle,SVREF(temp,FIX(temp_1)),FIX(gensymed_symbol));
	old_entry = NTH_VALUE((SI_Long)1L, result);
	IDENTITY(old_entry);
	return VALUES_1(Nil);
    }
...
Object Current_callback_representation_subscription_handle = UNBOUND;
    ...
    Object representation, color_or_pattern, specific_region_qm;
{
	...
	temp = gensym_cons_1(gensymed_symbol_2,Qab_structure);
    }
    else
    ...
    next_loop:
	  ...
	  if (EQ(kind,Qby_copy_with_handle)) {
	      ...
	      temp_2 = make_remote_procedure_item_info(Nil,Nil,Nil,Nil,Nil,
		      kind);
	      car_new_value = gensym_list_4(Qcopy,temp_1,temp_2,
	      ...
	      ensure_registration_on_network(argument,ISVREF(icp_socket,
		      (SI_Long)5L));
	      car_new_value = gensym_cons_1(Qhandle,argument);
	  }
	  else {
	      temp_2 = argument;
	      car_new_value = gensym_list_3(Qcopy,temp_2,
	  ...
	  car_new_value = gensym_cons_1(Qvalue,argument);
...
Object Chain_of_available_deferred_updates = UNBOUND;

Object Deferred_update_count = UNBOUND;
    ...
    Object deferred_update;
{
    ...
    svref_new_value = Chain_of_available_deferred_updates;
    SVREF(deferred_update,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_deferred_updates = deferred_update;
    return VALUES_1(Nil);
}
...
Object make_permanent_deferred_update_structure_internal()
{
    ...
    Object deferred_update_count_new_value;
    ...
    deferred_update_count_new_value = FIXNUM_ADD1(Deferred_update_count);
    Deferred_update_count = deferred_update_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object ws, slots_to_update;
{
	...
	if (EQ(next_queue_element,queue))
	    goto end_loop;
	gensymed_symbol = ISVREF(next_queue_element,(SI_Long)2L);
  ...
  next_loop_2:
    ...
    temp_2 = CDR(ab_loop_list_);
    item = CAR(temp_2);
    item_datas_to_export = gensym_cons_1(item_data,item_datas_to_export);
    items_to_export = gensym_cons_1(item,items_to_export);
    ab_loop_list_ = CDDR(ab_loop_list_);
    if ( !TRUEP(ab_loop_list_))
	goto end_loop_2;
    goto next_loop_2;
    ...
    Object thing, slots_to_update;
{
	...
	structure = gensym_cons_1(gensymed_symbol_3,Qab_structure);
	slot = Nil;
...
void view_def_INIT()
{
    ...
    Object AB_package, string_constant_30, list_constant_4, string_constant_28;
    Object string_constant_14, string_constant_29, Qtc_representation;
    ...
    Object Qdeferred_update_count, Qchain_of_available_deferred_updates;
    Object string_constant_27, Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_26, Qunique_structure_type_of_ab_name_qm;
    ...
    Object Qitem_representation_denotation, string_constant_25;
    Object string_constant_24, string_constant_23, Qcallback_representation;
    Object Qreclaim_callback_representation_callback_serial_number_value;
    Object Qcallback_representation_callback_serial_number, string_constant_22;
    Object list_constant_1, string_constant_21, string_constant_20;
    Object list_constant_3, Qview_def, Qthe_representation_handle_hashtable;
    Object Qmake_representation_handle_table, Kfuncall;
    Object Qmutate_representation_handle_tree_for_hash_tree_entry;
    ...
    Object string_constant_19;
    Object Qcount_of_representation_handle_hash_vector_109_vectors;
    Object Qavailable_representation_handle_hash_vector_109_vectors;
    Object list_constant_2, Qlocal_pseudo_socket, string_constant_18;
    Object Qobject_definition_representation, string_constant_17;
    Object Qrepresentation, Qreclaim_represented_frame_value;
    Object Qrepresented_frame, Qreclaim_representation_address_value;
    Object Qrepresentation_address, string_constant_16, list_constant;
    Object string_constant_15, Qsystem_item, Qjavalink_versioned_call_data;
    Object Qoutstanding_javalink_versioned_call_data_count;
    Object Qjavalink_versioned_call_data_structure_memory_usage;
    Object Qjavalink_versioned_call_data_count;
    Object Qchain_of_available_javalink_versioned_call_datas;
    Object string_constant_13, string_constant_12;
    Object Qnamed_dynamic_extent_description, Qjavalink_notification_versions;
    Object Qclass_subscription, Qoutstanding_class_subscription_count;
    Object Qclass_subscription_structure_memory_usage;
    Object Qclass_subscription_count, Qchain_of_available_class_subscriptions;
    Object string_constant_11, string_constant_10, Qclass_subscriptions;
    Object Qoutstanding_class_subscriptions_count;
    Object Qclass_subscriptions_structure_memory_usage;
    Object Qclass_subscriptions_count;
    Object Qchain_of_available_class_subscriptionss, string_constant_9;
    ...
    Object Qaccess_error_structure_memory_usage, Qaccess_error_count;
    Object Qchain_of_available_access_errors, string_constant_7;
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8m83f4y1n83f4y8n8k1l8n0000001l1n8y83-2oy1m83pPy83pQyknk0k0");
    ...
    string_constant_7 = STATIC_STRING("1q83f4y8s83-J6y09k9l");
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83g-y1n83g-y8n8k1l8n0000000knk0k0");
    ...
    Qclass_subscriptions_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_9 = STATIC_STRING("1q83g-y8s83-Mcy09k9l");
    clear_optimized_constants();
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8m83g+y1n83g+y8n8k1l8n0000001l1n8y83-3Ey1n83s6y83s7y83s8ykok0k0");
    ...
    Qclass_subscription_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_11 = STATIC_STRING("1q83g+y8s83-Mby09k9l");
    clear_optimized_constants();
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83kAy1n83kAy8n8k1l8n0000000knk0k0");
    ...
    Qjavalink_versioned_call_data_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83kAy8s83-ahy09k9l");
    clear_optimized_constants();
    ...
    string_constant_14 = STATIC_STRING("1l1l8t");
    string_constant_15 = 
	    STATIC_STRING("1m4z8r83Z0y83Z0y836By836By00001m1l8l1l8o000004z8r83Z1y83Z1y836By836By00001m1l8l1l8o00000");
    string_constant_16 = 
	    STATIC_STRING("1o8q1n836By1l833ay8t1n83Z0y08o1n83Z1y08o");
    ...
    check_if_superior_classes_are_defined(Qobject_definition_representation,
	    list_constant_1);
    string_constant_17 = 
	    STATIC_STRING("1l4z8r83X6y83X6y83X5y83X5y00001m1l8l1l8o00000");
    string_constant_18 = STATIC_STRING("1n8q1n83X5y1l836By8t1n83X6y08o");
    temp = regenerate_optimized_constant(string_constant_14);
    temp_1 = regenerate_optimized_constant(string_constant_17);
    ...
    Qrepresentation_handle_hash_vector_109_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83-l2y83*By83-P2y09k9l");
    clear_optimized_constants();
    ...
    Qmutate_representation_handle_tree_for_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-REPRESENTATION-HANDLE-TREE-FOR-HASH-TREE-ENTRY",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_representation_handle_tree_for_hash_tree_entry,
	    STATIC_FUNCTION(mutate_representation_handle_tree_for_hash_tree_entry,
	    NIL,FALSE,3,3));
    Fp_mutate_representation_handle_tree_for_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_representation_handle_tree_for_hash_tree_entry);
    ...
    string_constant_21 = STATIC_STRING("000");
    string_constant_22 = 
    ...
    check_if_superior_classes_are_defined(Qitem_representation,
	    list_constant_4);
    string_constant_23 = 
	    STATIC_STRING("1n4z8r83T-y83T-y83T+y83T+y00001m1l8l1l8o000004z8r83T=y83T=y83T+y83T+y08k001m1l8l1l8o000004z8r83T*y83T*y83T+y83T+y00001m1l8l1l8o0");
    string_constant_24 = STATIC_STRING("0000");
    string_constant_25 = 
	    STATIC_STRING("1p8q1n83T+y1l830Xy8t1n83T-y08o1n83T=y8k8o1n83T*y08o");
    temp = regenerate_optimized_constant(string_constant_14);
    temp_1 = regenerate_optimized_constant(LIST_2(string_constant_23,
	    string_constant_24));
    ...
    string_constant_26 = 
	    STATIC_STRING("43Dy8m83gey1n83gey8n8k1l8n0000000kqk0k0");
    ...
    string_constant_27 = STATIC_STRING("1q83gey8s83-QSy09k9l");
    clear_optimized_constants();
    ...
    string_constant_28 = STATIC_STRING("0");
    string_constant_29 = STATIC_STRING("1m8q1n83-EWy1l830Xy8t");
    temp = regenerate_optimized_constant(string_constant_14);
    ...
    string_constant_30 = STATIC_STRING("1m8q1n83-H7y1l830Xy8t");
    temp = regenerate_optimized_constant(string_constant_14);
    temp_1 = regenerate_optimized_constant(string_constant_28);
