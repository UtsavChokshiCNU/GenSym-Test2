...
Object reclaim_proc_alist_head_and_temporary_constants(alist,tail)
    Object alist, tail;
{
    Object trailer_qm, alist_cons, value_cons, temporary_constant_qm;
    Object cdr_new_value, gensym_cons;
  ...
  end_loop:
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(trailer_qm) = cdr_new_value;
...
Object Procedure_alist = UNBOUND;
...
Object Chain_of_available_code_body_invocations = UNBOUND;

Object Code_body_invocation_count = UNBOUND;
    ...
    Object code_body_invocation;
{
    ...
    svref_new_value = Nil;
    SVREF(code_body_invocation,FIX((SI_Long)7L)) = svref_new_value;
    ...
    svref_new_value = Chain_of_available_code_body_invocations;
    SVREF(code_body_invocation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_code_body_invocations = code_body_invocation;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_code_body_invocation_variable, temp;
    Object defstruct_g2_code_body_invocation_variable, the_array;
    ...
    temp = FIXNUM_ADD1(Code_body_invocation_count);
    Code_body_invocation_count = temp;
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_code_body_invocations;
	SVREF(def_structure_code_body_invocation_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_code_body_invocations = 
		def_structure_code_body_invocation_variable;
    ...
    Object code_body_invocation;
{
	...
	reclaim_gensym_list_1(back_pointer);
    ...
    Object code_body_invocation;
{
    ...
    svref_new_value = gensym_list_2(Nil,code_body_invocation);
...
Object Chain_of_available_remote_procedure_calls = UNBOUND;

Object Remote_procedure_call_count = UNBOUND;
    ...
    Object remote_procedure_call;
{
    ...
    schedule_task_qm = ISVREF(remote_procedure_call,(SI_Long)7L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value = Nil;
    SVREF(remote_procedure_call,FIX((SI_Long)7L)) = svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_remote_procedure_calls;
    SVREF(remote_procedure_call,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_remote_procedure_calls = remote_procedure_call;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_remote_procedure_call_variable, temp;
    Object defstruct_g2_remote_procedure_call_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(161,23);
    def_structure_remote_procedure_call_variable = Nil;
    temp = FIXNUM_ADD1(Remote_procedure_call_count);
    Remote_procedure_call_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_remote_procedure_calls;
	SVREF(def_structure_remote_procedure_call_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_remote_procedure_calls = 
		def_structure_remote_procedure_call_variable;
...
Object Chain_of_available_system_rpcs = UNBOUND;

Object System_rpc_count = UNBOUND;
    ...
    Object system_rpc;
{
    ...
    svref_new_value = Chain_of_available_system_rpcs;
    SVREF(system_rpc,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_system_rpcs = system_rpc;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_system_rpc_variable, system_rpc_count_new_value;
    Object defstruct_g2_system_rpc_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(161,33);
    def_structure_system_rpc_variable = Nil;
    system_rpc_count_new_value = FIXNUM_ADD1(System_rpc_count);
    System_rpc_count = system_rpc_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_system_rpc_variable;
...
Object Available_procedure_invocations_hash_vector_43_vectors = UNBOUND;

Object Count_of_procedure_invocations_hash_vector_43_vectors = UNBOUND;
...
{
    Object count_of_procedure_invocations_hash_vector_43_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(161,38);
    count_of_procedure_invocations_hash_vector_43_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_procedure_invocations_hash_vector_43_vectors);
...
Object make_procedure_invocations_hash_vector()
{
    ...
    if (Available_procedure_invocations_hash_vector_43_vectors) {
	temp = M_CAR(Available_procedure_invocations_hash_vector_43_vectors);
	temp_1 = M_CDR(Available_procedure_invocations_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_procedure_invocations_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = Available_procedure_invocations_hash_vector_43_vectors;
	cdr_new_value = Available_gensym_conses;
	M_CDR(cdr_arg) = cdr_new_value;
	Available_gensym_conses = 
		Available_procedure_invocations_hash_vector_43_vectors;
	Available_procedure_invocations_hash_vector_43_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object procedure_invocations_hash_vector_43_vector;
{
    ...
    cdr_new_value = Available_procedure_invocations_hash_vector_43_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_procedure_invocations_hash_vector_43_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}

/* RECLAIM-PROCEDURE-INVOCATIONS-TREE-FOR-HASH-LEAVES */
Object reclaim_procedure_invocations_tree_for_hash_leaves(procedure_invocations_tree_for_hash_binary_tree)
    Object procedure_invocations_tree_for_hash_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(procedure_invocations_tree_for_hash_binary_tree))
	goto end_loop;
    less_than_branch_qm = 
	    ISVREF(procedure_invocations_tree_for_hash_binary_tree,
	    (SI_Long)1L);
    greater_than_branch_qm = 
	    ISVREF(procedure_invocations_tree_for_hash_binary_tree,
	    (SI_Long)2L);
    alist = ISVREF(procedure_invocations_tree_for_hash_binary_tree,
	    (SI_Long)3L);
    reclaim_binary_tree_element_1(procedure_invocations_tree_for_hash_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
  ...
  end_loop_1:;
	...
	reclaim_procedure_invocations_tree_for_hash_leaves(less_than_branch_qm);
	procedure_invocations_tree_for_hash_binary_tree = 
		greater_than_branch_qm;
    }
    else {
	...
	procedure_invocations_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
...
Object clear_procedure_invocations_tree(procedure_invocations_tree_for_hash_binary_tree)
    Object procedure_invocations_tree_for_hash_binary_tree;
{
    Object element_qm;

    x_note_fn_call(161,42);
    element_qm = CDR(procedure_invocations_tree_for_hash_binary_tree);
    if (element_qm) {
	reclaim_procedure_invocations_tree_for_hash_leaves(element_qm);
	M_CDR(procedure_invocations_tree_for_hash_binary_tree) = Nil;
    }
    return VALUES_1(procedure_invocations_tree_for_hash_binary_tree);
}
...
Object reclaim_procedure_invocations(procedure_invocations_hash_table)
    Object procedure_invocations_hash_table;
{
    Object procedure_invocations_tree_for_hash_binary_tree, element_qm;
  ...
  next_loop:
    ...
    element_qm = M_CDR(procedure_invocations_tree_for_hash_binary_tree);
    if (element_qm)
	reclaim_procedure_invocations_tree_for_hash_leaves(element_qm);
    inline_note_reclaim_cons(procedure_invocations_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(procedure_invocations_tree_for_hash_binary_tree) = cdr_new_value;
    Available_gensym_conses = procedure_invocations_tree_for_hash_binary_tree;
    ...
    Object invocation, procedure;
{
	...
	ISVREF(procedure,(SI_Long)26L) = new_tree;
    }
    ...
    temp = set_balanced_binary_tree_entry(SVREF(temp,FIX(temp_1)),Qeq,Nil,
	    T,invocation,FIX(gensymed_symbol),invocation);
    return VALUES_1(temp);
}
    ...
    Object invocation, procedure;
{
    ...
    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),invocation,
	    SVREF(invocations,FIX(temp)),FIX(gensymed_symbol));
    return VALUES_1(Nil);
}
    ...
    Object proc;
{
  ...
  next_loop_1:
	...
	temp = d;
    ab_loopvar__4 = gensym_cons_1(temp,Nil);
    if (ab_loopvar__3)
    ...
    Object invocations, procedure;
{
    ...
    ISVREF(procedure,(SI_Long)26L) = Nil;
...
Object List_of_previously_optimized_procedures = UNBOUND;
...
Object compile_procedure_definition_for_slot varargs_1(int, n)
{
    ...
    Object prin, prins_to_abort, ab_loopvar_, ab_loopvar__1;
    Object ab_less_than_branch_qm_, invocation, ab_loop_list_, temp;
    ...
    Object dynamic_breakpoint_validity;
{
    ...
    return gensym_cons_1(dynamic_breakpoint_address,
	    gensym_cons_1(dynamic_breakpoint_line,
	    gensym_cons_1(dynamic_breakpoint_nth_code_body,
	    gensym_cons_1(dynamic_breakpoint_status,
	    gensym_cons_1(dynamic_breakpoint_validity,Nil)))));
}
...
{
    Object dynamic_breakpoints_qm, temp, temp_1, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, dynamic_breakpoint_settings_new_value;
	...
	gensym_push_modify_macro_arg = make_dynamic_breakpoint(temp,line,
		temp_1,status,address_qm ? Dynamic_breakpoint_valid : 
		Dynamic_breakpoint_invalid);
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = get_lookup_slot_value_given_default(procedure,
		Qdynamic_breakpoint_settings,Nil);
	dynamic_breakpoint_settings_new_value = gensym_cons_1(car_1,cdr_1);
	if (Noting_changes_to_kb_p)
    ...
    Object procedure;
{
    ...
    if (get_lookup_slot_value_given_default(procedure,
	    Qdynamic_breakpoint_settings,Nil)) {
	delete_frame_note_if_any(Qinvalid_dynamic_breakpoint,procedure);
	reclaim_gensym_tree_1(get_lookup_slot_value_given_default(procedure,
		Qdynamic_breakpoint_settings,Nil));
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(procedure,Qdynamic_breakpoint_settings);
    ...
    Object procedure, info;
{
    ...
    Object cdr_new_value, stack_of_slot_value_changes, line, status;
    Object ab_loop_list_, ab_loop_desetq_, temp, frame_and_slot_or_atom;
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(procedure,
	...
	next_loop_1:
	  ...
	  ab_loop_it_ = temp_1 ? (EQ(procedure,
    ...
    Object proc;
{
  ...
  next_loop:
    ...
    M_CAR(gensymed_symbol_1) = car_new_value;
    ab_loopvar__1 = 
	    gensym_cons_1(allocate_evaluation_structure(gensymed_symbol),Nil);
    if (ab_loopvar_)
	M_CDR(ab_loopvar_) = ab_loopvar__1;
    else
    ...
    Object procedure;
{
    Object invocations, scope_conses, ab_hash_table_, ab_tree_form_;
    Object ab_node_stack_, ab_current_node_, ab_current_alist_, ab_entry_cons_;
    Object invocation_to_abort, ab_less_than_branch_qm_, temp;
    SI_Long ab_table_length_, ab_index_;
    Declare_special(1);
...
Object Chain_of_available_procedure_invocations = UNBOUND;

Object Procedure_invocation_count = UNBOUND;
    ...
    Object procedure_invocation;
{
    ...
    schedule_task_qm = ISVREF(procedure_invocation,(SI_Long)7L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    svref_new_value = Nil;
    SVREF(procedure_invocation,FIX((SI_Long)7L)) = svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_procedure_invocations;
    SVREF(procedure_invocation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_procedure_invocations = procedure_invocation;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_procedure_invocation_variable, temp;
    Object defstruct_g2_procedure_invocation_variable, the_array;
    SI_Long gensymed_symbol, gensymed_symbol_1, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(161,109);
    def_structure_procedure_invocation_variable = Nil;
    temp = FIXNUM_ADD1(Procedure_invocation_count);
    Procedure_invocation_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_procedure_invocations;
	SVREF(def_structure_procedure_invocation_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_procedure_invocations = 
		def_structure_procedure_invocation_variable;
    ...
    Object procedure, module;
{
    Object invocations, scope_conses, ab_hash_table_, ab_tree_form_;
    Object ab_node_stack_, ab_current_node_, ab_current_alist_, ab_entry_cons_;
    Object invocation, procedure_deletion_qm, ab_less_than_branch_qm_;
    SI_Long ab_table_length_, ab_index_;
    Declare_special(1);
    Object result;
    ...
    Object block, new_breakpoints;
{
    Object invocations, scope_conses, ab_hash_table_, ab_tree_form_;
    Object ab_node_stack_, ab_current_node_, ab_current_alist_, ab_entry_cons_;
    Object invocation, ab_less_than_branch_qm_;
    SI_Long ab_table_length_, ab_index_;
    Declare_special(1);
    ...
    Object args;
{
    ...
    Object managed_number_or_value, temp, gensymed_symbol, gensymed_symbol_1;
...
Object Within_writing_procedure_invocation_p = UNBOUND;
    ...
    Object invocation, ignored_frame;
{
	...
	PUSH_SPECIAL(Within_writing_procedure_invocation_p,within_writing_procedure_invocation_p,
		0);
    ...
    Object code_body_invocation;
{
    ...
    SVREF(new_task,FIX((SI_Long)11L)) = immediate_task_schedule_modify_arg_7;
    ...
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)1L)) = 
	    gensymed_symbol;
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = new_task;
    ...
    Object code_body_invocation;
{
    ...
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)0L)) = 
	    gensymed_symbol;
    temp = Immediate_task_queue;
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)1L)) = temp;
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = new_task;
    gensymed_symbol_1 = def_structure_queue_element_variable;
    temp = Immediate_task_queue;
    ...
    Object computation_instance, priority, containing_frame;
{
    ...
    Object gensymed_symbol_1;
    char current_task_schedule_modify_arg_5, g2_p;
    double aref_new_value;

    x_note_fn_call(161,123);
    current_task_schedule_modify_arg_2 = priority;
    current_task_schedule_modify_arg_5 = (SI_Long)0L != 
	    (IFIX(ISVREF(containing_frame,(SI_Long)4L)) & (SI_Long)16777216L);
    current_task_schedule_modify_arg_8 = 
	    SYMBOL_FUNCTION(Qexecute_computation_instance);
    current_task_schedule_modify_arg_11 = computation_instance;
    ...
    g2_p =  !current_task_schedule_modify_arg_5;
    ...
    SVREF(computation_instance,FIX((SI_Long)7L)) = task;
    return VALUES_1(Nil);
}
    ...
    Object computation_instance;
{
    ...
    current_task_schedule_modify_arg_2 = Priority_of_current_task;
    current_task_schedule_modify_arg_8 = 
	    SYMBOL_FUNCTION(Qexecute_computation_instance);
    current_task_schedule_modify_arg_11 = computation_instance;
    schedule_task_qm = ISVREF(computation_instance,(SI_Long)7L);
    ...
    Object computation_instance, priority, containing_frame;
{
    ...
    v = ctask ? Current_task_queue_vector : Deferred_task_queue_vector;
    q = ISVREF(v,IFIX(p));
    gensymed_symbol = ISVREF(q,(SI_Long)0L);
    def_structure_queue_element_variable = Chain_of_available_queue_elements;
    if (def_structure_queue_element_variable)
	Chain_of_available_queue_elements = 
		ISVREF(def_structure_queue_element_variable,(SI_Long)0L);
    ...
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)0L)) = 
	    gensymed_symbol;
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)1L)) = q;
    SVREF(def_structure_queue_element_variable,FIX((SI_Long)2L)) = task;
    gensymed_symbol_1 = def_structure_queue_element_variable;
    SVREF(q,FIX((SI_Long)0L)) = gensymed_symbol_1;
    SVREF(gensymed_symbol,FIX((SI_Long)1L)) = gensymed_symbol_1;
    SVREF(task,FIX((SI_Long)6L)) = gensymed_symbol_1;
    if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	Priority_of_next_task = p;
    ...
    Object priority;
{
    ...
    Object schedule_task_qm, computation_instance;
    Object old_structure_being_reclaimed, svref_new_value, temp_1;
	...
	if ( !TRUEP(schedule_task_qm))
	    goto end_loop;
	computation_instance = ISVREF(schedule_task_qm,(SI_Long)11L);
...
Object Forgive_long_procedure_instruction_qm = UNBOUND;
    ...
    Object value;
{
	...
	if (temp)
		...
		PUSH_SPECIAL(Evaluation_value_writing_target_length_qm,evaluation_value_writing_target_length_qm,
		  ...
		  result = print_constant(2,temp_1,ISVREF(value,(SI_Long)2L));
		POP_SPECIAL();
		return result;
	    }
    ...
    Object arguments_known_to_be_correct_p_qm;
{
    ...
    Object new_cons, x2, gensymed_symbol_4, amf_available_array_cons_qm;
    Object amf_array, temp_3, svref_new_value, amf_result, incff_1_arg;
    Object new_float;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
  ...
  next_loop:
	...
	if (temp_1) {
	    ...
	    reclaim_gensym_list_1(generated_argument_list);
	...
	if (temp_1) {
		...
		if (FIXNUM_EQ(value,Truth))
		    ...
		    value = gensym_cons_1(value,Qtruth_value);
	    }
	    else
    ...
    Object arguments_known_to_be_correct_p_qm;
{
    ...
    Object amf_result, incff_1_arg, new_float, name;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, stack_index, ab_loop_bind_;
    ...
    Object procedure, argument_list, icp_socket;
{
    ...
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object gensymed_symbol_2, gensymed_symbol_4, type1, type2;
    Object handled_object_qm, frame, symbol, sub_class_bit_vector;
    SI_Long index_1, ab_loop_bind_, gensymed_symbol, bv16_length, aref_arg_2;
    SI_Long aref_new_value, length_1, gensymed_symbol_3;
    SI_Long superior_class_bit_number, sub_class_vector_index;
	...
	if ( !(SIMPLE_VECTOR_P(argument_qm) && EQ(ISVREF(argument_qm,
		...
		reclaim_gensym_cons_1(argument_qm);
		argument_qm = temp_2;
		...
		gensymed_symbol_2 = argument_qm;
		temp_3 = FIXNUMP(gensymed_symbol_2);
		if (temp_3);
		else
		    temp_3 = 
			    INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_2) 
			    != (SI_Long)0L ? 
			    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_2)) 
			    == (SI_Long)1L : TRUEP(Qnil);
		if (temp_3);
		else
		    temp_3 = INLINE_LONG_VECTOR_P(gensymed_symbol_2) != 
			    (SI_Long)0L ? 
			    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(gensymed_symbol_2)) 
			    == (SI_Long)1L : TRUEP(Qnil);
		if (temp_3);
		else
		    temp_3 = gensymed_symbol_2 ? 
			    SYMBOLP(gensymed_symbol_2) : TRUEP(Qnil);
		if (temp_3);
		else
		    temp_3 = 
			    INLINE_UNSIGNED_BYTE_16_VECTOR_P(gensymed_symbol_2) 
			    != (SI_Long)0L;
		if (temp_3);
		else if (CONSP(gensymed_symbol_2)) {
		    gensymed_symbol_2 = M_CDR(gensymed_symbol_2);
		    temp_3 = EQ(gensymed_symbol_2,Qtruth_value);
		    if (temp_3);
		    else
			temp_3 = EQ(gensymed_symbol_2,Qiteration_state);
		    if (temp_3);
		    else if (SYMBOLP(gensymed_symbol_2)) {
			gensymed_symbol_1 = 
				CDR(Defined_evaluation_value_types);
			gensymed_symbol = 
				SXHASH_SYMBOL_1(gensymed_symbol_2) & 
				IFIX(Most_positive_fixnum);
			gensymed_symbol_3 = (SI_Long)0L;
		      next_loop_1:
			if ( !TRUEP(gensymed_symbol_1))
...
{
    Object arg_trailer, argument_cons, argument, gensym_cons, cdr_new_value;
	...
	if (argument_list &&  !((SI_Long)0L == inline_debugging_consing())) {
	    gensym_cons = argument_list;
	  next_loop_1:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	    if (EQ(gensym_cons,arg_trailer))
		goto end_1;
	    else if ( !TRUEP(gensym_cons))
		goto end_1;
	    else
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(arg_trailer) = cdr_new_value;
	Available_gensym_conses = argument_list;
	return VALUES_1(Qnil);
    }
    else
	return VALUES_1(Nil);
...
/* REGISTER-TOP-LEVEL-PROCEDURE-INVOCATION */
Object register_top_level_procedure_invocation(procedure_invocation)
    Object procedure_invocation;
{
...
/* DEREGISTER-TOP-LEVEL-PROCEDURE-INVOCATION */
Object deregister_top_level_procedure_invocation(procedure_invocation)
    Object procedure_invocation;
{
    Object svref_arg_1;
    ...
    Object arguments_known_to_be_correct_p, prepare_p, thread_qm;
{
    ...
    Object sub_class_bit_vector, error_text_qm, temp_1, gensymed_symbol_3;
    ...
    Object invocation, invocation_frame_qm, svref_new_value;
    Object gensym_push_modify_macro_arg, car_1, cdr_1, procedure_tracing_qm;
    Object base_code_body, byte_code_body, called_environment_array_length;
    Object called_environment, initial_stack_index, ab_loop_iter_flag_;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, stack_index, ab_loop_bind_;
    SI_Long index_1, non_argument_index;
    char temp;
	...
	if (temp) {
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    return generate_procedure_invocation_error(5,top_of_stack_qm,
	...
	temp_1 = procedure;
	return generate_procedure_invocation_error(4,top_of_stack_qm,
	...
	if (invocation_class &&  !EQ(invocation_class,Qprocedure_invocaton)) {
	    ...
	    gensymed_symbol_4 = invocation_class;
	    gensymed_symbol = SXHASH_SYMBOL_1(invocation_class) & 
		    IFIX(Most_positive_fixnum);
	  ...
	  end_2:;
		...
		gensymed_symbol_3 = set_balanced_binary_tree_entry(temp_2,
			Qeq,Nil,T,gensymed_symbol_3,temp_1,gensymed_symbol_4);
	    }
	...
	if (temp)
		...
		return generate_procedure_invocation_error(3,
		...
		svref_new_value = ISVREF(procedure,(SI_Long)21L);
		...
		svref_new_value = ISVREF(base_code_body,(SI_Long)4L);
		SVREF(invocation,FIX((SI_Long)5L)) = svref_new_value;
		svref_new_value = ISVREF(base_code_body,(SI_Long)5L);
		...
		if ( !(IFIX(called_environment_array_length) == (SI_Long)0L)) {
		  ...
		  next_loop_8:
		    ...
		    if ( !TRUEP(ab_loop_iter_flag_))
			index_1 = index_1 + (SI_Long)1L;
		    svref_new_value = ISVREF(local_stack,stack_index);
		    ISVREF(called_environment,index_1) = svref_new_value;
...
{
    Object invocation, gensym_push_modify_macro_arg, car_1, cdr_1;
...
Object Closing_procedure_invocation = UNBOUND;
    ...
    Object procedure_invocation_to_delete;
{
    ...
    Object old_structure_being_reclaimed, schedule_task_qm;
    Object old_structure_being_reclaimed_1;
    Declare_special(1);
	...
	deregister_top_level_procedure_invocation(procedure_invocation_to_delete);
    if (completion_form_qm) {
	closing_procedure_invocation = procedure_invocation_to_delete;
	PUSH_SPECIAL(Closing_procedure_invocation,closing_procedure_invocation,
		0);
    ...
    schedule_task_qm = ISVREF(procedure_invocation_to_delete,(SI_Long)7L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
    ...
    temp_1 = Nil;
    SVREF(procedure_invocation_to_delete,FIX((SI_Long)7L)) = temp_1;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    temp_1 = Chain_of_available_procedure_invocations;
    SVREF(procedure_invocation_to_delete,FIX((SI_Long)0L)) = temp_1;
    Chain_of_available_procedure_invocations = procedure_invocation_to_delete;
    return VALUES_1(Nil);
}
    ...
    Object code_body_invocation;
{
    ...
    code_bodies_to_close = gensym_cons_1(code_body_invocation,Nil);
  ...
  next_loop:
	...
	if (SIMPLE_VECTOR_P(invocation) && EQ(ISVREF(invocation,
	    ...
	    code_bodies_to_close = gensym_cons_1(invocation,
	...
	close_code_body_invocation_1(gensym_pop_store);
    }
    goto next_loop;
  end_loop:;
    return VALUES_1(Qnil);
    ...
    Object code_body_invocation;
{
    ...
    Object lock_holder, temp, schedule_task_qm, old_structure_being_reclaimed;
    Object wake_ups, variable, ab_loop_list_, pruned_interest_list, last_1;
    Object next_qm, gensymed_symbol, gensymed_symbol_1, temp_1, trailer;
    Object cons_1, old_structure_being_reclaimed_1;
    ...
    if (lock_holder) {
	temp = delete_gensym_element_1(code_body_invocation,
    ...
    temp = Nil;
    SVREF(code_body_invocation,FIX((SI_Long)7L)) = temp;
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    pruned_interest_list = delete_gensym_element_1(code_body_invocation,
  ...
  end_loop:
	...
	if (gensymed_symbol_1) {
		...
		inline_note_reclaim_cons(gensymed_symbol_1,Qab_gensym);
		temp = Available_gensym_conses;
		M_CDR(gensymed_symbol_1) = temp;
		Available_gensym_conses = gensymed_symbol_1;
...
Object validate_all_procedure_invocations()
{
    ...
    Object completion_form_qm, top_of_stack_qm, validated_args_p, prepare_p;
{
    ...
    Object gensymed_symbol_1, temp_1, type_name;
    ...
    char gensymed_symbol_2, temp_2, future_task_schedule_modify_arg_6;
    char svref_new_value;
    double gensymed_symbol_3, temp, gensymed_symbol_4;
...
Object abort_procedure_invocation varargs_1(int, n)
{
    ...
    Object ab_current_node_, ab_current_alist_, ab_entry_cons_, invocation_qm;
...
Object clear_procedure_invocations()
{
    ...
    Object error_name_or_error_object, error_message;
{
    ...
    handling_code_body_invocation = ISVREF(protected_code_body_invocation,
	    (SI_Long)12L);
    called_code_bodies = 
	    copy_list_using_gensym_conses_1(ISVREF(handling_code_body_invocation,
	    (SI_Long)13L));
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(called_code_bodies);
...
Object Check_for_circular_formula_paths_qm = UNBOUND;
    ...
    Object formula_invocation;
{
    ...
    Current_computation_component_particulars = 
	    gensym_list_2(Qcell_array_element,ISVREF(expression_cell,
	    (SI_Long)5L));
    ...
    Object formula_invocation;
{
    ...
    Object gensymed_symbol, gensym_list, gensym_list_tail, gensym_cons, temp;
    Object old_structure_being_reclaimed, schedule_task_qm;
    Object old_structure_being_reclaimed_1;

    x_note_fn_call(161,192);
    generic_formula_qm = ISVREF(formula_invocation,(SI_Long)9L);
    variable = ISVREF(formula_invocation,(SI_Long)8L);
    ...
    gensym_list = component_particulars;
    gensym_list_tail = M_CDR(component_particulars);
    ...
    temp = Nil;
    SVREF(formula_invocation,FIX((SI_Long)7L)) = temp;
    ...
    Object invocation;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(invocations_list);
...
static Object Qcurrent_computation_instance;  /* current-computation-instance */
...
void proc_utils_INIT()
{
    ...
    Object string_constant_138, string_constant_137, list_constant_19;
    Object Qcreate_icon_description, string_constant_136, string_constant_135;
    Object string_constant_134, string_constant_133, string_constant_132;
    Object string_constant_131, string_constant_130, Qnote_name_change;
    ...
    Object string_constant_111, Qproc_utils;
    Object Qcheck_for_circular_formula_paths_qm;
    Object Qclear_computation_context_variables;
    ...
    Object Qab_or, list_constant_5, Qforgive_long_procedure_instruction_qm;
    Object Qschedule_computation_instance_execution;
    ...
    Object Qprocedure_invocation_count;
    Object Qchain_of_available_procedure_invocations, string_constant_107;
    ...
    Object string_constant_73;
    Object Qcount_of_procedure_invocations_hash_vector_43_vectors;
    Object Qavailable_procedure_invocations_hash_vector_43_vectors;
    Object Qsystem_rpc, Qoutstanding_system_rpc_count;
    Object Qsystem_rpc_structure_memory_usage, Qsystem_rpc_count;
    Object Qchain_of_available_system_rpcs, string_constant_72;
    Object string_constant_71, Qremote_procedure_call;
    Object Qoutstanding_remote_procedure_call_count;
    Object Qremote_procedure_call_structure_memory_usage;
    Object Qremote_procedure_call_count;
    Object Qchain_of_available_remote_procedure_calls, string_constant_70;
    Object string_constant_69, Qcode_body_invocation;
    Object Qoutstanding_code_body_invocation_count;
    Object Qcode_body_invocation_structure_memory_usage;
    Object Qcode_body_invocation_count;
    Object Qchain_of_available_code_body_invocations, string_constant_68;
    ...
    Object list_constant_2, Qcode_body, string_constant_64, string_constant_63;
    Object string_constant_62, string_constant_61, string_constant_60;
    Object Qdependent_frame, Qevaluating_simulator_procedure_qm;
    Object Qprocedure_evaluator;

    x_note_fn_call(161,235);
    SET_PACKAGE("AB");
    ...
    string_constant_61 = 
	    STATIC_STRING("1t4z8r83YJy83YJy83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83bGy83bGy83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83ZBy83ZBy83I8y83I8y0000");
    string_constant_62 = 
	    STATIC_STRING("1n1l8o1l8l1l83Cy000004z8r83V1y83V1y83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83Kfy83Kfy83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83Key");
    string_constant_63 = 
	    STATIC_STRING("83Key83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83I9y83I9y83I8y83I8y00001n1l8o1l8l1l83Cy000004z8r83IAy83IAy83I8y83I8y00001n1l8o1l8l1");
    string_constant_64 = 
	    STATIC_STRING("l83Cy000004z8r83IBy83IBy83I8y83I8y00001n1l8o1l8l1l83Cy00000");
    string_constant_65 = 
	    STATIC_STRING("1v8q1m83I8y1l83=fy1p83YJy08o8l83Cy1p83bGy08o8l83Cy1p83ZBy08o8l83Cy1p83V1y08o8l83Cy1p83Kfy08o8l83Cy1p83Key08o8l83Cy1p83I9y08o8l83");
    ...
    string_constant_67 = 
	    STATIC_STRING("43Dy8m833my1o833my830Ey8n8k1l830Ey0000001m1m8x830Ey1m830ly83sIyk3Iyk0k0");
    ...
    Qcode_body_invocation_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_68 = STATIC_STRING("1q833my8s83-Mqy09k9l");
    ...
    string_constant_69 = 
	    STATIC_STRING("43Dy8m83mKy1p83mKy833my830Ey8n8k1l833my0000001m1n8y83-5Ry1o83-Bjy83-Biy83-Bgy83-Bfy1m8x833myk3Nyk0k0");
    ...
    Qremote_procedure_call_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_70 = STATIC_STRING("1q83mKy8s83-kny09k9l");
    clear_optimized_constants();
    ...
    string_constant_71 = 
	    STATIC_STRING("43Dy8m83ngy1n83ngy8n8k1l8n0000001l1n8y83-63y1n83-EHy83-EDy83-EIykok0k0");
    ...
    string_constant_72 = STATIC_STRING("1q83ngy8s83-qFy09k9l");
    clear_optimized_constants();
    ...
    Qprocedure_invocations_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_73 = STATIC_STRING("1q83-9Ty83*By83tCy09k9l");
    clear_optimized_constants();
    ...
    string_constant_77 = 
	    STATIC_STRING("Uy000004z8r83W7y83W7y83=Vy83=Vy0k001n1l8l1l83Hy1l83Ny000004z8r83-0y83-0y83=Vy83=Vy00001q1l8l1m8p83-0y1l83Fy1l83Ey1l83Uy1m83Dy53-");
    string_constant_78 = 
    ...
    string_constant_86 = 
	    STATIC_STRING("this procedure.000004z8r833ry833ry83=Vy83=Vy0q001p1m8p83-Zy1l8o1l8l1l8z1l83Cy000004z8r834ny834ny83=Vy83=Vy083Py001p1m8p838Gy1l8o");
    string_constant_87 = 
    ...
    string_constant_92 = 
	    STATIC_STRING("Add attribute-mimics for individual flags.000004z8r83Xgy83Xgy83=Vy83=Vy00001m1l8l1l83Cy000004z8r83V5y83V5y83=Vy83=Vy00001m1l8l1l");
    string_constant_93 = 
	    STATIC_STRING("83Cy000004z8r83KEy83KEy83=Vy83=Vy00001m1l8l1l83Cy000004z8r83RKy83RKy83=Vy83=Vy00001m1l8l1l83Cy00000");
    string_constant_94 = 
    ...
    string_constant_101 = 
	    STATIC_STRING("urn a unique instance of this class for ~\n       this execution of this procedure.1r833ryq1m8p83-Zy8o8l8z83Cy1r834ny83Py1m8p838G");
    string_constant_102 = 
    ...
    string_constant_105 = 
	    STATIC_STRING("8l83Cy1m83Dy53cyAdd attribute-mimics for individual flags.1o83Xgy08l83Cy1o83V5y08l83Cy1o83KEy08l83Cy1o83RKy08l83Cy");
    ...
    Qprocedure_invocation_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_107 = STATIC_STRING("1q831jy8s83-jFy09k9l");
    clear_optimized_constants();
    ...
    string_constant_109 = 
	    STATIC_STRING("1l4z8r83YLy83YLy831jy831jy00001n1l8o1l8l1l83Hy00000");
    string_constant_110 = 
	    STATIC_STRING("1n8q1o831jy1m83Ry83-+y1m8v831jy83ey1p83YLy08o8l83Hy");
    ...
    check_if_superior_classes_are_defined(Qmethod_declaration,
	    list_constant_19);
    string_constant_111 = STATIC_STRING("1m1m8v837Cy1l8t");
    string_constant_112 = 
    ...
    string_constant_114 = 
	    STATIC_STRING("ult &lt;integer&gt;), ~\nbreakpoint-level: (or default &lt;integer&gt;)]000004z8r83Z3y83Z3y837Cy837Cy00001o1l83Ey1l8l1l83Cy1m8p83");
    string_constant_115 = 
    ...
    string_constant_126 = 
	    STATIC_STRING("13Cy8q1o837Cy1l83=Vy1m8v837Cy8t1p83-Fy08l1m8p83-ky83Cy1q83-py083Ey8l83Cy1m8p01q83Z3y083Ey8l83Cy1m8p83Ky1m8u1s8w9k3-My3-My1p1p83J");
    string_constant_127 = 
    ...
    temp = regenerate_optimized_constant(string_constant_111);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    temp_1 = regenerate_optimized_constant(list(14,string_constant_112,
    ...
    add_class_to_environment(9,Qmethod_declaration,list_constant_19,Nil,
	    ...
	    regenerate_optimized_constant(LIST_4(string_constant_126,
	    string_constant_127,string_constant_128,string_constant_129)),Nil);
    ...
    string_constant_133 = 
	    STATIC_STRING("y3cy1n83jy1m3cy3-*y1m3-Ay3-Ay03*dy3*dy001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83YNy83YNy834My83");
    string_constant_134 = 
	    STATIC_STRING("4My00001r1l8o1l8l1l83Cy1l83Fy1m8p83YNy1l83*-y1m83Dy53Xyexport, writable = false, type string00008k4z8r83YMy83YMy834My834My00001p");
    string_constant_135 = 
    ...
    string_constant_136 = STATIC_STRING("3Cy1l8z1l83-5y1m8p83Ky00000");
    string_constant_137 = 
    ...
    string_constant_140 = 
	    STATIC_STRING("y03*dy3*dy1t83YNy08o8l83Cy83Fy1m8p83YNy83*-y1m83Dy53Xyexport, writable = false, type string1r83YMy08o8l83Cy83*-y1m83Dy53kyexport");
    string_constant_141 = 
	    STATIC_STRING(", writable = false, type class-name (symbol)1s83A5y08o8l83Cy8z83-5y1m8p83Ky");
    temp = regenerate_optimized_constant(LIST_2(string_constant_130,
	    string_constant_131));
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    temp_1 = regenerate_optimized_constant(LIST_5(string_constant_132,
    ...
    add_class_to_environment(9,Qab_method,list_constant_19,Nil,temp,Nil,
	    ...
	    regenerate_optimized_constant(LIST_5(string_constant_137,
	    string_constant_138,string_constant_139,string_constant_140,
	    string_constant_141)),Nil);
