    ...
    Object queue;
{
  ...
  next_loop:
    ...
    MVS_2(result,object,priority);
    if (object)
	result_1 = gensym_cons_1(gensym_cons_1(object,priority),result_1);
    else
	goto end_1;
    goto next_loop;
  end_loop:
    ...
    Object priority_queue;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(queue_contents_1);
    return VALUES_1(result_1);
}
...
void priority_queues_INIT()
{
    ...
    Qmake_priority_queue_initial_object_table = 
	    ...
	    AB_package);
    string_constant_2 = 
	    STATIC_STRING("1p4z8r8u8u839ly839ly01v8w9k3ky3ky13Gy1q83-1y2l83*Ny83Ty2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l83*Uy83Ty1l83-iy1l83-jy83-Ly1n83jy1");
    string_constant_3 = 
    ...
    string_constant_8 = 
	    STATIC_STRING("on000004z8r83YCy83YCy839ly839ly01m83*9y9l001m1l8o1l8l000004z8r83YEy83YEy839ly839ly01m83*9y9m001m1l8o1l8l000004z8r83YDy83YDy839ly");
    string_constant_9 = 
	    STATIC_STRING("839ly01m83*9y9n001m1l8o1l8l000004z8r83YFy83YFy839ly839ly0k001m1l8o1l8l00000");
    string_constant_10 = 
    ...
    string_constant_11 = 
	    STATIC_STRING("l of top-priority item, all in logarithmic time1m8u1v8w9k3ky3ky13Gy1q83-1y2l83*Ny83Ty2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l83*Uy");
    string_constant_12 = 
    ...
    string_constant_16 = 
	    STATIC_STRING("1q1p83*Ny3Ny3My3dy3cy1p83-Lykk3ky3ky1p83-nykk3ky3ky1p83-mykk3ky3ky1p83*Nykk3ky3ky1p83*Uysq3Gy3My1o83YCy1m83*9y9l8o8l1o83YEy1m83*");
    string_constant_17 = 
	    STATIC_STRING("9y9m8o8l1o83YDy1m83*9y9n8o8l1o83YFyk8o8l");
