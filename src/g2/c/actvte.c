    ...
    Object frame;
{
	...
	if (temp_1);
		...
		if (temp) {
		    ...
		    if (connection_qm) {
			gensymed_symbol_3 = ISVREF(ISVREF(connection_qm,
    ...
    Object item;
{
    ...
    PUSH_SPECIAL(In_suspend_resume_p,in_suspend_resume_p,0);
...
Object Existence_classes_already_checked = UNBOUND;
...
{
    Object result_1, last_1, next_qm, cdr_new_value;
	...
	Available_gensym_conses = Existence_classes_already_checked;
    }
    Existence_classes_already_checked = Nil;
    ...
    Object possible_dependent_frame, frame;
{
  ...
  next_loop:
	...
	Existence_classes_already_checked = gensym_cons_1(class_1,
...
Object Items_needing_initialization = UNBOUND;

/* ACTIVATE-IN-NEW-ACTIVATION-UNIT */
Object activate_in_new_activation_unit(item)
    Object item;
{
    Object gensymed_symbol, frame, sub_vector_qm, function_qm, temp;
...
static Object Qitems_needing_initialization;  /* items-needing-initialization */
...
Object initialize_items_needing_initialization()
{
    ...
    Object ab_current_alist_, ab_entry_cons_, frame_serial_number, item;
    Object ab_less_than_branch_qm_, gensymed_symbol, xa, ya;
    Object sub_class_bit_vector, initial_value_qm, temp_1, interval_qm;
    Object source_or_map, server_qm, data_server_qm;
	...
	PUSH_SPECIAL(Initializing_items_needing_initialization,initializing_items_needing_initialization,
		1);
	  scope_conses = Scope_conses;
	  ab_node_stack_ = Nil;
	  ab_current_node_ = Nil;
	  ab_next_node_qm_ = Items_needing_initialization_tree;
	  ...
	  next_loop_2:
		...
		if (initial_value_qm &&  !TRUEP(Warmbooting_qm)) {
			...
			temp_1 = item;
			put_current_value(6,temp_1,initial_value_qm,
		...
		if (sub_class_vector_index < 
		    ...
		    temp = TRUEP(Nil);
		interval_qm = temp ? ISVREF(item,(SI_Long)32L) : Nil;
		if (interval_qm) {
			...
			if (EQ(data_server_qm,Qcomputation))
				...
				Qg2_defstruct_structure_name_data_server_g2_struct)) 
				    {
			    temp_1 = SYMBOL_FUNCTION(ISVREF(data_server_qm,
				    (SI_Long)3L));
			    FUNCALL_2(temp_1,item,interval_qm);
			}
		    }
		}
	    }
...
Object clean_up_items_needing_initialization()
{
    ...
    if ( !TRUEP(Items_needing_initialization))
	clear_items_needing_initialization_tree(Items_needing_initialization_tree);
    temp = Items_needing_initialization;
    Items_needing_initialization = T;
    return VALUES_1( !TRUEP(temp) ? T : Nil);
}
    ...
    Object kb_frame;
{
    ...
    Object collected_updates_to_sensor_attributes, gensymed_symbol, frame;
    Object sub_vector_qm, function_qm, gensymed_symbol_1, gensymed_symbol_2;
    Object class_description, ab_loop_list_, gensymed_symbol_3, x2, temp;
    ...
    Object kb_workspace;
{
    ...
    Object gensymed_symbol_1, ab_queue_form_, ab_next_queue_element_, subblock;
    Object within_activate_for_kb_workspace, gensymed_symbol_2, scope_conses;
	...
	PUSH_SPECIAL(Collected_updates_to_sensor_attributes,collected_updates_to_sensor_attributes,
	  ...
	  PUSH_SPECIAL(Collecting_updates_to_sensor_attributes_p,collecting_updates_to_sensor_attributes_p,
	    ...
	    if (frame_not_bad_p(kb_workspace) &&  !((SI_Long)0L != 
			...
			(SI_Long)8192L))) {
		gensymed_symbol_1 = ISVREF(kb_workspace,(SI_Long)14L);
		gensymed_symbol_1 = gensymed_symbol_1 ? 
		...
		PUSH_SPECIAL(Within_activate_for_kb_workspace,within_activate_for_kb_workspace,
			1);
		  if (ab_queue_form_)
		...
		next_loop:
		  ...
		  inline_funcall_1(gensymed_symbol_1,gensymed_symbol_2);
		  gensymed_symbol_1 = ISVREF(subblock,(SI_Long)14L);
		  gensymed_symbol_1 = gensymed_symbol_1 ? 
    ...
    Object kb_workspace, ancestor_not_activatable_qm;
{
    ...
    gensymed_symbol_3 = ISVREF(kb_workspace,(SI_Long)14L);
    gensymed_symbol_3 = gensymed_symbol_3 ? ISVREF(gensymed_symbol_3,
	    (SI_Long)4L) : Nil;
    ...
    Object entity;
{
    Object collecting_updates_to_sensor_attributes_p;
    Object collected_updates_to_sensor_attributes, gensymed_symbol;
    Object subworkspace_list, frame, sub_vector_qm, function_qm;
    Object gensymed_symbol_1, subworkspace, ab_loop_list_, gensymed_symbol_2;
    ...
    Object kb_workspace;
{
    ...
    Object ab_loop_it_, old_structure_being_reclaimed, temp_1;
    Object def_structure_schedule_task_variable, task, ctask, p, v, q;
    Object def_structure_queue_element_variable, frame, sub_vector_qm;
	...
	if ( !((SI_Long)0L != (IFIX(ISVREF(kb_workspace,(SI_Long)5L)) & 
		...
		if (temp) {
		    ...
		    SVREF(task,FIX((SI_Long)11L)) = kb_workspace;
		    temp_1 = copy_frame_serial_number(ISVREF(kb_workspace,
			    (SI_Long)3L));
		    SVREF(task,FIX((SI_Long)12L)) = temp_1;
		    temp_1 = Window_instigating_this_rule_instance_qm;
		    SVREF(task,FIX((SI_Long)13L)) = temp_1;
...
{
    Object block, kb_workspace_qm, residue, old_structure_being_reclaimed;
	...
	if (kb_workspace_qm) {
		...
		SVREF(task,FIX((SI_Long)11L)) = kb_workspace_qm;
		ctask =  !TRUEP(ISVREF(task,(SI_Long)3L)) ? T : Nil;
		if (ctask);
		else
		    ctask = System_is_running;
    ...
    Object kb_workspace;
{
    ...
    Object ab_loop_iter_flag_, future_task_schedule_modify_arg_2;
    ...
    char temp, future_task_schedule_modify_arg_6, svref_new_value;
    double temp_2, future_task_schedule_modify_arg_3;
  ...
  next_loop_2:
    ...
    future_task_schedule_modify_arg_3 = temp_2 + (double)temp_3;
    future_task_schedule_modify_arg_4 = FIXNUMP(scan_interval) ? 
	    (double)IFIX(scan_interval) : DFLOAT_ISAREF_1(scan_interval,
	    (SI_Long)0L);
    future_task_schedule_modify_arg_6 = (SI_Long)0L != (IFIX(ISVREF(rule,
    ...
    temp_1 = ISVREF(task,(SI_Long)1L);
    DFLOAT_ISASET_1(temp_1,(SI_Long)1L,future_task_schedule_modify_arg_4);
...
void activate_INIT()
{
    ...
    Object Qitems_needing_initialization_tree;
    ...
    Object Qmanually_disable_for_kb_frame, Qexistence_classes_already_checked;
    Object Qin_suspend_resume_p, Qnote_ancestor_manually_enabled;
