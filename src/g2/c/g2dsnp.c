...
Object Chain_of_available_source_nupec_synchronizations = UNBOUND;

Object Source_nupec_synchronization_count = UNBOUND;
    ...
    Object source_nupec_synchronization;
{
    ...
    svref_new_value = Chain_of_available_source_nupec_synchronizations;
    SVREF(source_nupec_synchronization,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_source_nupec_synchronizations = 
	    source_nupec_synchronization;
    return VALUES_1(Nil);
}
...
Object make_permanent_source_nupec_synchronization_structure_internal()
{
    ...
    Object source_nupec_synchronization_count_new_value;
    ...
    source_nupec_synchronization_count_new_value = 
	    FIXNUM_ADD1(Source_nupec_synchronization_count);
    ...
    Object source_nupec_synchronization_icp_socket;
{
    ...
    SVREF(def_structure_source_nupec_synchronization_variable,
	    FIX((SI_Long)10L)) = Nil;
    svref_new_value = put_up_nupec_synchronization_progress_display();
    SVREF(def_structure_source_nupec_synchronization_variable,
...
Object Chain_of_available_target_nupec_synchronizations = UNBOUND;

Object Target_nupec_synchronization_count = UNBOUND;
    ...
    Object target_nupec_synchronization;
{
    ...
    schedule_task_qm = ISVREF(target_nupec_synchronization,(SI_Long)5L);
    if (schedule_task_qm) {
    ...
    svref_new_value = Nil;
    SVREF(target_nupec_synchronization,FIX((SI_Long)5L)) = svref_new_value;
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_target_nupec_synchronizations;
    SVREF(target_nupec_synchronization,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_target_nupec_synchronizations = 
	    target_nupec_synchronization;
    return VALUES_1(Nil);
}
...
Object make_permanent_target_nupec_synchronization_structure_internal()
{
    ...
    Object target_nupec_synchronization_count_new_value;
    ...
    target_nupec_synchronization_count_new_value = 
	    FIXNUM_ADD1(Target_nupec_synchronization_count);
...
Object Current_source_nupec_synchronization = UNBOUND;

Object Current_target_nupec_synchronization = UNBOUND;

Object The_type_description_of_nupec_synchronize_variable_or_parameter = UNBOUND;

Object Chain_of_available_nupec_synchronize_variable_or_parameters = UNBOUND;

Object Nupec_synchronize_variable_or_parameter_count = UNBOUND;
    ...
    Object nupec_synchronize_variable_or_parameter;
{
    ...
    svref_new_value = 
	    ...
	    (SI_Long)3L));
    SVREF(nupec_synchronize_variable_or_parameter,FIX((SI_Long)3L)) = 
	    svref_new_value;
    SVREF(nupec_synchronize_variable_or_parameter,FIX((SI_Long)3L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = 
	    Chain_of_available_nupec_synchronize_variable_or_parameters;
    SVREF(nupec_synchronize_variable_or_parameter,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_nupec_synchronize_variable_or_parameters = 
...
{
    Object def_structure_nupec_synchronize_variable_or_parameter_variable;
    Object nupec_synchronize_variable_or_parameter_count_new_value;
    ...
    nupec_synchronize_variable_or_parameter_count_new_value = 
	    FIXNUM_ADD1(Nupec_synchronize_variable_or_parameter_count);
    ...
    Object structure;
{
    ...
    svref_new_value = 
	    reclaim_managed_number_or_value_function(ISVREF(structure,
	    (SI_Long)3L));
    SVREF(structure,FIX((SI_Long)3L)) = svref_new_value;
    SVREF(structure,FIX((SI_Long)3L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = 
	    Chain_of_available_nupec_synchronize_variable_or_parameters;
    SVREF(structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_nupec_synchronize_variable_or_parameters = structure;
    return VALUES_1(Nil);
}

Object The_type_description_of_local_nupec_variable = UNBOUND;

Object Chain_of_available_local_nupec_variables = UNBOUND;

Object Local_nupec_variable_count = UNBOUND;
    ...
    Object local_nupec_variable;
{
    ...
    svref_new_value = Chain_of_available_local_nupec_variables;
    SVREF(local_nupec_variable,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_local_nupec_variables = local_nupec_variable;
    return VALUES_1(Nil);
}
...
Object make_permanent_local_nupec_variable_structure_internal()
{
    ...
    Object local_nupec_variable_count_new_value;
    ...
    local_nupec_variable_count_new_value = 
	    FIXNUM_ADD1(Local_nupec_variable_count);
    Local_nupec_variable_count = local_nupec_variable_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object synchronization_list, g2_to_g2_interface_object;
{
  ...
  end_loop:;
    ...
    PUSH_SPECIAL(Current_source_nupec_synchronization,current_source_nupec_synchronization,
	    9);
      maximum_time_slice_size = Icp_socket_processing_time_limit;
      PUSH_SPECIAL(Maximum_time_slice_size,maximum_time_slice_size,8);
	time_slice_start_time = FIX((SI_Long)0L);
	PUSH_SPECIAL(Time_slice_start_time,time_slice_start_time,7);
	  if (socket_qm) {
	    next_loop_1:
...
Object handle_icp_nupec_synchronize__body(variable_count,year,month,day,
    ...
    Object variable_count, year, month, day, hour, minute, second_1;
{
    Object reject_reason_qm, offset_for_remote_gensym_time, svref_arg_1;
    Object current_task_schedule_modify_arg_8, schedule_task_qm;
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qreceive_nupec_synchronize_task);
	schedule_task_qm = ISVREF(svref_arg_1,(SI_Long)5L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	SVREF(svref_arg_1,FIX((SI_Long)5L)) = task;
    }
    return VALUES_1(Nil);
}
    ...
    Object v_or_p, history_block;
{
    ...
    Object incff_1_arg, new_float, index_2, vector_1;
    Object store_managed_number_or_value_arg, new_managed_array, element_index;
    Object svref_new_value, index_3;
    ...
    SI_Long incff_1_arg_1, bv16_length, aref_new_value_1, length_1;
    double aref_new_value;
    Declare_special(7);
    XDeclare_area(1);
    XDeclare_frontier(1);
	...
	goto next_loop;
      end_loop:;
	incff_1_arg_1 = history_values;
	history_received = history_received + incff_1_arg_1;
			...
			PUSH_SPECIAL(Number_of_icp_bytes_in_message_group,number_of_icp_bytes_in_message_group,
			  ...
			  PUSH_SPECIAL(Writing_icp_message_group,writing_icp_message_group,
				...
				if (IFIX(CAR(history_block_spec)) == 
					...
					reclaim_gensym_cons_1(THIRD(history_block_spec));
				    reclaim_gensym_list_1(history_block_spec);
				    history_block_spec = Nil;
				    temp_1 = CDR(variable_cons);
				    SVREF(sync_object,FIX((SI_Long)1L)) = 
					    temp_1;
				    reclaim_gensym_cons_1(variable_cons);
...
void g2ds_nupec_INIT()
{
    ...
    Object Qlocal_nupec_variable_count;
    Object Qchain_of_available_local_nupec_variables, string_constant_19;
    ...
    Object Qnupec_synchronize_variable_or_parameter_count;
    Object Qchain_of_available_nupec_synchronize_variable_or_parameters;
    Object string_constant_17, string_constant_16, Qint1;
    Object Qcurrent_target_nupec_synchronization;
    ...
    Object Qtarget_nupec_synchronization_count;
    Object Qchain_of_available_target_nupec_synchronizations;
    ...
    Object Qsource_nupec_synchronization_count;
    Object Qchain_of_available_source_nupec_synchronizations;
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83nOy1n83nOy8n8k1l8n0000001l1n8y83-6+y1n83-DWy83-DXy83-DVykyk0k0");
    ...
    Qsource_nupec_synchronization_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83nOy8s83-oty09k9l");
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83nly1n83nly8n8k1l8n0000001l1n8y83-66y1n83-EUy83-ETy83-EVyktk0k0");
    ...
    Qtarget_nupec_synchronization_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q83nly8s83-qhy09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83lEy1n83lEy8n8k1l8n0000001m1n8y83-50y1p83-7py83-7oy83-7ly83-7my83-7ny1m83My83-Akyktk0k0");
    ...
    Qnupec_synchronize_variable_or_parameter_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_17 = STATIC_STRING("1q83lEy8s83-gIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83key1n83key8n8k1l8n0000001l1n8y83-4oy1l83-2Tyknk0k0");
    ...
    Qlocal_nupec_variable_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83key8s83-cBy09k9l");
    clear_optimized_constants();
    ...
    string_constant_21 = 
	    STATIC_STRING("1l4z8r83YPy83YPy83X3y83X3y0k001p1l8l1l83Hy1l8o1l83Fy1m8p83X4y00000");
    string_constant_22 = 
	    STATIC_STRING("1n8q1m83X3y1l83-+y1r83YPyk8l83Hy8o83Fy1m8p83X4y");
