...
Object Player_control_stack = UNBOUND;

Object Player_value_stack = UNBOUND;

Object Player_current_instruction = UNBOUND;

Object Player_lexical_binding_stack = UNBOUND;

Object Player_definition_stack = UNBOUND;

Object Player_location_stack = UNBOUND;

Object Player_named_locations = UNBOUND;
...
Object Player_target_gensym_window_g2_struct_qm = UNBOUND;

Object Best_text_matched_by_player = UNBOUND;

Object Player_mouse_x = UNBOUND;

Object Player_mouse_y = UNBOUND;

Object Last_player_mouse_x = UNBOUND;

Object Last_player_mouse_y = UNBOUND;

Object Last_player_event_time = UNBOUND;

Object Player_pace = UNBOUND;
    ...
    Object name;
{
    ...
    Player_definition_stack = gensym_cons_1(gensym_cons_1(name,Nil),
...
Object player_release_definitions(name)
    Object name;
{
    Object entry_name, definition_records, ab_loop_desetq_, gensym_pop_store;
    Object cons_1, next_cons, cdr_new_value, definition_kind, definition_name;
  ...
  next_loop:
    ...
    ab_loop_desetq_ = gensym_pop_store;
...
static Object Qplayer_definition_stack;  /* player-definition-stack */

/* PLAYER-RECORD-DEFINITION */
Object player_record_definition(kind,name)
    Object kind, name;
{
    Object cdr_arg, gensym_push_modify_macro_arg, car_1, cdr_1, cdr_new_value;

    x_note_fn_call(246,13);
    if (BOUNDP(Qplayer_definition_stack) && Player_definition_stack) {
	cdr_arg = FIRST(Player_definition_stack);
	gensym_push_modify_macro_arg = gensym_cons_1(kind,name);
...
Object execute_player()
{
    ...
    Object player_current_instruction, temp, head, handler;
    Declare_special(1);
    Object result;

    x_note_fn_call(246,16);
    gensym_pop_store = Nil;
    ...
    player_current_instruction = gensym_pop_store;
    PUSH_SPECIAL(Player_current_instruction,player_current_instruction,0);
      if ( !TRUEP(Player_current_instruction)) {
	  Player_value_stack = gensym_cons_1(Player_current_instruction,
		  Player_value_stack);
	  result = VALUES_1(Player_value_stack);
      }
      else if (SYMBOLP(Player_current_instruction)) {
	  temp = player_symbol_value(Player_current_instruction);
	  Player_value_stack = gensym_cons_1(temp,Player_value_stack);
	  result = VALUES_1(Player_value_stack);
      }
    ...
    Object handler;
{
  ...
  end_1:;
	...
	call_site = gensym_cons_1(temp_1,call_site);
	goto next_loop_1;
      end_loop_1:
	...
	Player_control_stack = gensym_cons_1(gensym_list_4(Qdo_call,
...
Object player_instruction_do_call(form)
    Object form;
{
    Object call, args_so_far, total_args, call_site, gensym_pop_store, cons_1;
    Object next_cons, temp;
    SI_Long i, ab_loop_bind_;

    x_note_fn_call(246,18);
    call = SECOND(form);
	...
	call_site = gensym_cons_1(gensym_pop_store,call_site);
	i = i + (SI_Long)1L;
	goto next_loop;
      end_loop:;
	player_do_call_finally(get(FIRST(call),Qplayer_symbol_function,_),
		call_site);
	return reclaim_gensym_list_1(form);
    }
    else {
	temp = add1(args_so_far);
	M_THIRD(form) = temp;
	Player_control_stack = gensym_cons_1(form,Player_control_stack);
	Player_control_stack = gensym_cons_1(nth(args_so_far,call),
    ...
    Object handler, call_site;
{
    ...
    x_note_fn_call(246,19);
    if (call_site)
	Player_control_stack = 
		gensym_cons_1(gensym_list_2(Qreclaim_player_tree,
		call_site),Player_control_stack);
    if (LISTP(handler)) {
	player_parse_arguments(SECOND(handler),call_site);
	Player_control_stack = gensym_cons_1(THIRD(handler),
		Player_control_stack);
	return VALUES_1(Player_control_stack);
    }
    ...
    Object lambda_list, actuals;
{
	...
	Player_control_stack = gensym_cons_1(gensym_list_2(Qunbind,
	...
	Player_lexical_binding_stack = 
		gensym_cons_1(gensym_cons_1(parameter_name,actual),
		Player_lexical_binding_stack);
	goto next_loop;
      end_loop:
	return VALUES_1(Qnil);
...
Object player_instruction_quote(form)
    Object form;
{
    x_note_fn_call(246,21);
    Player_value_stack = gensym_cons_1(SECOND(form),Player_value_stack);
    return VALUES_1(Player_value_stack);
}
...
Object player_instruction_progn(form)
    Object form;
{
    x_note_fn_call(246,22);
    Player_control_stack = gensym_cons_1(gensym_list_4(Qprogn_1,
...
Object player_instruction_progn_1(form)
    Object form;
{
    Object index_1, max_1, statements, statement, gensym_pop_store, cons_1;
    Object next_cons, temp;

    x_note_fn_call(246,23);
    index_1 = SECOND(form);
    max_1 = THIRD(form);
    statements = FOURTH(form);
    statement = nth(index_1,statements);
    if (NUM_EQ(index_1,max_1))
	reclaim_gensym_list_1(Player_current_instruction);
    else {
	gensym_pop_store = Nil;
	cons_1 = Player_value_stack;
	if (cons_1) {
    ...
    Player_control_stack = gensym_cons_1(statement,Player_control_stack);
    return VALUES_1(Player_control_stack);
}
    ...
    Object form;
{
    ...
    x_note_fn_call(246,24);
    test_form = SECOND(form);
    then_form = THIRD(form);
    else_form = FOURTH(form);
    Player_control_stack = gensym_cons_1(else_form,Player_control_stack);
    Player_control_stack = gensym_cons_1(then_form,Player_control_stack);
    Player_control_stack = gensym_cons_1(list_constant,Player_control_stack);
    Player_control_stack = gensym_cons_1(test_form,Player_control_stack);
    return VALUES_1(Player_control_stack);
}
...
Object player_instruction_if_1(form)
    Object form;
{
    Object gensym_pop_store, cons_1, next_cons, temp, then_form, else_form;
    Object player_value_stack_old_value, temp_1;

    x_note_fn_call(246,25);
    gensym_pop_store = Nil;
    cons_1 = Player_control_stack;
    if (cons_1) {
	gensym_pop_store = M_CAR(cons_1);
...
Object player_instruction_tagbody(form)
    Object form;
{
    x_note_fn_call(246,26);
    Player_control_stack = gensym_cons_1(gensym_list_4(Qplayer_tagbody_1,
...
Object player_instruction_player_tagbody_1(form)
    Object form;
{
    Object index_1, max_1, statements, statement_or_tag, gensym_pop_store;
    Object cons_1, next_cons, temp;

    x_note_fn_call(246,27);
    index_1 = SECOND(form);
    max_1 = THIRD(form);
    statements = FOURTH(form);
	...
	Player_control_stack = gensym_cons_1(statement_or_tag,
		Player_control_stack);
	return VALUES_1(Player_control_stack);
    }
    else
...
Object player_instruction_let_star_bind(form)
    Object form;
{
    Object temp, binding_in_progress, gensym_pop_store, cons_1, next_cons;
    Object temp_1, temp1, temp2, temp3;

    x_note_fn_call(246,29);
    temp = SECOND(form);
	...
	next_cons = Nil;
    Player_value_stack = next_cons;
    M_CDR(binding_in_progress) = gensym_pop_store;
    temp = SECOND(form);
    temp1 = CDR(temp);
	...
	temp = SECOND(form);
	temp = FIRST(temp);
	Player_control_stack = gensym_cons_1(CDR(temp),Player_control_stack);
	return VALUES_1(Player_control_stack);
    }
    else
	return reclaim_gensym_list_1(form);
    ...
    Object form;
{
  ...
  next_loop:
    ...
    lexical_variable_init_form = SYMBOLP(binding_spec) ? Nil : 
	    SECOND(binding_spec);
    ab_loopvar__2 = LIST_1(gensym_cons_1(lexical_variable_name,
  ...
  end_loop:
    ...
    temp = Qnil;
  end_1:;
    Player_control_stack = gensym_cons_1(gensym_list_2(Qlet_star_bind,
    ...
    Object how_many_ticks;
{
    ...
    x_note_fn_call(246,32);
    temp = gensym_list_2(Qwait_until,FIXNUM_ADD(how_many_ticks,
	    c_native_clock_ticks_or_cache(Nil,Nil)));
    Player_control_stack = gensym_cons_1(temp,Player_control_stack);
    return VALUES_1(Nil);
}
...
Object Icp_player_message_handler_array = UNBOUND;
...
Object Current_score_of_best_match_for_eyes = UNBOUND;

Object Current_best_match_for_eyes = UNBOUND;

Object Current_text_focus_for_eyes_qm = UNBOUND;

Object Current_x_for_eyes_qm = UNBOUND;

Object Current_y_for_eyes_qm = UNBOUND;
    ...
    Object current_text_focus_for_eyes_qm;
{
    ...
    x_note_fn_call(246,39);
    SAVE_STACK();
    PUSH_SPECIAL(Current_text_focus_for_eyes_qm,current_text_focus_for_eyes_qm,
	    9);
      ...
      PUSH_SPECIAL(Current_score_of_best_match_for_eyes,current_score_of_best_match_for_eyes,
	      8);
	PUSH_SPECIAL(Current_best_match_for_eyes,current_best_match_for_eyes,
		7);
	  PUSH_SPECIAL(Current_y_for_eyes_qm,current_y_for_eyes_qm,6);
	    PUSH_SPECIAL(Current_x_for_eyes_qm,current_x_for_eyes_qm,5);
...
{
    x_note_fn_call(246,48);
    Player_location_stack = gensym_cons_1(gensym_cons_1(Player_mouse_x,
...
{
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, location_record;
    Object x, y;

    x_note_fn_call(246,49);
    gensym_pop_store = Nil;
    ...
    location_record = gensym_pop_store;
    x = CAR(location_record);
    y = CDR(location_record);
    reclaim_gensym_cons_1(location_record);
    ...
    Object name;
{
    ...
    x_note_fn_call(246,50);
    alist_entry = assq_function(name,Player_named_locations);
    if (alist_entry);
    else {
	new_entry = gensym_cons_1(name,gensym_cons_1(Nil,Nil));
	Player_named_locations = gensym_cons_1(new_entry,
    ...
    Object string_1;
{
    ...
    x_note_fn_call(246,54);
    temp = gensym_list_4(Qtype_1,string_1,lengthw(string_1),FIX((SI_Long)0L));
    Player_control_stack = gensym_cons_1(temp,Player_control_stack);
    return VALUES_1(Nil);
}
...
Object clear_player()
{
    ...
    x_note_fn_call(246,62);
    Player_value_stack = Nil;
    Player_control_stack = Nil;
    reclaim_gensym_tree_1(Player_location_stack);
    Player_location_stack = Nil;
    reclaim_gensym_tree_1(Player_named_locations);
    ...
    Object form;
{
    ...
    x_note_fn_call(246,66);
    clear_player();
    copy_of_form = copy_tree_and_atoms_using_player_conses(form);
    Player_control_stack = 
	    gensym_cons_1(gensym_list_2(Qreclaim_player_tree,copy_of_form),
	    Player_control_stack);
    Player_control_stack = gensym_cons_1(copy_of_form,Player_control_stack);
    return resume_player();
}

Object Player_icp_connection = UNBOUND;
    ...
    Object form;
{
    ...
    x_note_fn_call(246,71);
    temp = copy_tree_and_atoms_using_player_conses(form);
    Player_control_stack = gensym_cons_1(temp,Player_control_stack);
    return VALUES_1(Player_control_stack);
}

Object Player_require_modules_already_sent = UNBOUND;
...
Object play_test varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Player_require_modules_already_sent,player_require_modules_already_sent,
	    0);
      ...
      reclaim_gensym_list_1(Player_require_modules_already_sent);
...
{
    Object result_1, gensym_pop_store, cons_1, next_cons, cdr_new_value;
    Object location_record, x, y;
    Declare_catch(1);

    x_note_fn_call(246,75);
    result_1 = C_boolean_true;
...
void player_INIT()
{
    ...
    Object Qplayer_release_definitions, Qresume_player, list_constant_40;
    Object Qplayer_server_push_control_stack, list_constant_39, Qmain;
    Object list_constant_38, list_constant_37, list_constant_36;
    Object Qplayer_mark_definitions, Qremote_test, Qclear_player;
    Object Qremote_eval_once, Qremote_eval, Qplayer, Qplayer_icp_connection;
    Object list_constant_35, Qtype_control_v, list_constant_34;
    Object Qplayer_function, list_constant_33, Qtype_character;
    Object list_constant_32, Qtype_control_t, list_constant_31;
    Object list_constant_30, list_constant_29, Qtype_control_y;
    Object list_constant_28, list_constant_27, list_constant_26;
    Object Qtype_control_x, list_constant_25, list_constant_24;
    Object list_constant_23, Qtype_control_b, list_constant_22;
    Object list_constant_21, list_constant_20, Qtype_control_s;
    Object list_constant_19, list_constant_18, list_constant_17;
    Object Qtype_control_j, list_constant_16, list_constant_15;
    Object list_constant_14, Qtype_entry, list_constant_13, list_constant_10;
    Object list_constant_12, list_constant_11, Qtype_control_return;
    Object list_constant_9, list_constant_8, list_constant_7;
    Object Qplayer_move_to_instance, Qmove_to_instance;
    ...
    Object Qplayer_pace, Qlast_player_event_time, Qlast_player_mouse_y;
    Object Qlast_player_mouse_x, Qplayer_mouse_y, Qplayer_mouse_x;
    Object Qbest_text_matched_by_player;
    Object Qplayer_target_gensym_window_g2_struct_qm, Qplayer_named_locations;
    Object Qplayer_location_stack, Qplayer_lexical_binding_stack;
    Object Kno_initial_value, Qplayer_current_instruction, Qplayer_value_stack;
    Object Qplayer_control_stack, list_constant_6, Qplayer_state;

    x_note_fn_call(246,92);
    SET_PACKAGE("AB");
    ...
    list_constant_6 = STATIC_LIST((SI_Long)2L,Qquote,Qpaused);
    record_system_variable(Qplayer_state,Qplayer,list_constant_6,Qnil,Qnil,
	    Qnil,Qnil);
    ...
    list_constant_7 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\r'));
    list_constant_8 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_7);
    list_constant_9 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_8);
    set_player_symbol_function(Qtype_control_return,list_constant_9);
    ...
    list_constant_10 = STATIC_CONS(Qstring,Qnil);
    list_constant_11 = STATIC_CONS(Qtype,list_constant_10);
    list_constant_12 = STATIC_CONS(Qtype_control_return,Qnil);
    list_constant_13 = STATIC_LIST((SI_Long)3L,Qprogn,list_constant_11,
	    list_constant_12);
    list_constant_14 = STATIC_LIST((SI_Long)3L,Qplayer_function,
	    list_constant_10,list_constant_13);
    set_player_symbol_function(Qtype_entry,list_constant_14);
    ...
    list_constant_15 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\n'));
    list_constant_16 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_15);
    list_constant_17 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_16);
    set_player_symbol_function(Qtype_control_j,list_constant_17);
    ...
    list_constant_18 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\023'));
    list_constant_19 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_18);
    list_constant_20 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_19);
    set_player_symbol_function(Qtype_control_s,list_constant_20);
    ...
    list_constant_21 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\002'));
    list_constant_22 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_21);
    list_constant_23 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_22);
    set_player_symbol_function(Qtype_control_b,list_constant_23);
    ...
    list_constant_24 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\030'));
    list_constant_25 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_24);
    list_constant_26 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_25);
    set_player_symbol_function(Qtype_control_x,list_constant_26);
    ...
    list_constant_27 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\031'));
    list_constant_28 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_27);
    list_constant_29 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_28);
    set_player_symbol_function(Qtype_control_y,list_constant_29);
    ...
    list_constant_30 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\024'));
    list_constant_31 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_30);
    list_constant_32 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_31);
    set_player_symbol_function(Qtype_control_t,list_constant_32);
    ...
    list_constant_33 = STATIC_LIST((SI_Long)2L,Qtype_character,CHR('\026'));
    list_constant_34 = STATIC_LIST((SI_Long)2L,Qprogn,list_constant_33);
    list_constant_35 = STATIC_LIST((SI_Long)3L,Qplayer_function,Qnil,
	    list_constant_34);
    set_player_symbol_function(Qtype_control_v,list_constant_35);
    ...
    list_constant_36 = STATIC_LIST((SI_Long)2L,Qquote,Qremote_test);
    ...
    list_constant_37 = STATIC_LIST((SI_Long)2L,Qplayer_release_definitions,Qt);
    list_constant_38 = STATIC_LIST((SI_Long)2L,Qquote,list_constant_37);
    list_constant_3 = STATIC_LIST((SI_Long)2L,
	    Qplayer_server_push_control_stack,list_constant_38);
    Qmain = STATIC_SYMBOL("MAIN",AB_package);
    list_constant_39 = STATIC_CONS(Qmain,Qnil);
