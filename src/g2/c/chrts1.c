...
Object Chart_pen_x = UNBOUND;

Object Chart_pen_y = UNBOUND;

Object Chart_pen_color = UNBOUND;

Object Chart_pen_color_value = UNBOUND;

Object Chart_really_drawing = UNBOUND;

Object Current_chart_raster_color_value = UNBOUND;

Object Chart_current_raster_is_polychrome_p = UNBOUND;

Object Chart_current_raster_is_monochrome_raster_list_p = UNBOUND;

Object Chart_color_value_for_this_raster = UNBOUND;
    ...
    Object text_string;
{
    ...
    PUSH_SPECIAL(Chart_color_value_for_this_raster,chart_color_value_for_this_raster,
	    2);
      PUSH_SPECIAL(Chart_pen_color_value,chart_pen_color_value,1);
	PUSH_SPECIAL(Chart_pen_color,chart_pen_color_1,0);
    ...
    Object generator;
{
    ...
    return reclaim_gensym_cons_1(generator);
}
    ...
    Object chart;
{
  ...
  end_1:;
	...
	SVREF(chart,FIX((SI_Long)19L)) = Qline_chart_style;
    }
    ...
    Object chart;
{
  ...
  end_1:;
	...
	return map_over_part_description(Qstandardize_text_size_feature_in_part_description,
...
Object Chain_of_available_chart_spots = UNBOUND;

Object Chart_spot_count = UNBOUND;
    ...
    Object chart_spot;
{
    ...
    svref_new_value = Chain_of_available_chart_spots;
    SVREF(chart_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_chart_spots = chart_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_chart_spot_variable, chart_spot_count_new_value;
    Object defstruct_g2_chart_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(178,27);
    def_structure_chart_spot_variable = Nil;
    chart_spot_count_new_value = FIXNUM_ADD1(Chart_spot_count);
    Chart_spot_count = chart_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_chart_spot_variable;
    ...
    Object chart, mouse_pointer;
{
    ...
    return push_last_spot(mouse_pointer,make_chart_spot_1(),chart);
}
...
static Object Qdata_series;        /* data-series */
    ...
    Object chart;
{
  ...
  end_1:;
    if (method_function_qm)
	inline_funcall_1(method_function_qm,frame);
    return change_slot_value(3,chart,Qdata_series,Nil);
}
...
Object Current_chart_frame = UNBOUND;
    ...
    Object graph_rendering, chart;
{
    ...
    svref_new_value = delete_gensym_element_1(graph_rendering,ISVREF(chart,
	    (SI_Long)16L));
    return VALUES_1(ISVREF(chart,(SI_Long)16L) = svref_new_value);
}
    ...
    Object chart;
{
    ...
    Object temp_4, svref_new_value, current_graph_rendering;
    ...
    PUSH_SPECIAL(Current_chart_frame,current_chart_frame,1);
      graph_rendering = Nil;
    ...
    end_loop:
	  ...
	  unshifted_result = IFIX(Current_image_x_scale) * width_of_block 
		  + (SI_Long)2048L;
	  width_of_block_in_window = FIX(unshifted_result >>  -  - 
		  (SI_Long)12L);
      }
      else
	  width_of_block_in_window = scalef_function(Current_image_x_scale,
		  FIX(width_of_block));
	  ...
	  height_of_block_in_window = FIX(height_of_block);
	      ...
	      IFIX(Isqrt_of_most_positive_fixnum)) {
	  unshifted_result = IFIX(Current_image_y_scale) * height_of_block 
		  + (SI_Long)2048L;
	  ...
	  height_of_block_in_window = 
		  scalef_function(Current_image_y_scale,FIX(height_of_block));
      ...
      temp_3 = Current_window;
      temp_4 = get_reference_to_item(chart);
      graph_rendering = make_decacheable_graph_rendering(13,temp,
	      ...
	      width_of_block_in_window,height_of_block_in_window,chart,
	      temp_3,temp_4,FIXNUM_MAX(width_of_block_in_window,
	      height_of_block_in_window));
	  ...
	  svref_new_value = map_to_color_value(Qwhite);
      SVREF(graph_rendering,FIX((SI_Long)9L)) = svref_new_value;
      current_graph_rendering = graph_rendering;
      PUSH_SPECIAL(Current_graph_rendering,current_graph_rendering,0);
	paint_graph_rendering_raster();
      POP_SPECIAL();
      svref_new_value = gensym_cons_1(graph_rendering,ISVREF(chart,
	      (SI_Long)16L));
      ISVREF(chart,(SI_Long)16L) = svref_new_value;
      result = VALUES_1(graph_rendering);
      goto end_1;
      result = VALUES_1(Qnil);
    end_1:;
...
Object Current_grid = UNBOUND;

Object Grid_color = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Grid_color,
...
Object exit_part_feature_grid_color()
{
    ...
    Grid_color = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Grid_visible = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Grid_visible,
	    Part_feature_recall_stack);
...
Object exit_part_feature_grid_visible()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Grid_visible = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Current_chart = UNBOUND;

Object Data_series_subparts = UNBOUND;

Object Chart_left = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_left,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_left()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_left = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_top = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_top,
	    Part_feature_recall_stack);
    Chart_top = new_value;
    return VALUES_1(Nil);
}
...
Object exit_part_feature_chart_top()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_top = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_right = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_right,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_right()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_right = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_bottom = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_bottom,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_bottom()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_bottom = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_right_margin = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_right_margin,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_right_margin()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_right_margin = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_top_margin = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_top_margin,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_top_margin()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_top_margin = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_left_margin = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_left_margin,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_left_margin()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_left_margin = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_bottom_margin = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_bottom_margin,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_bottom_margin()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_bottom_margin = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_tuple_1_minimum = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_tuple_1_minimum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_tuple_1_minimum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_tuple_1_minimum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_tuple_1_maximum = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_tuple_1_maximum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_tuple_1_maximum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_tuple_1_maximum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_tuple_2_minimum = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_tuple_2_minimum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_tuple_2_minimum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_tuple_2_minimum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_tuple_2_maximum = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_tuple_2_maximum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_tuple_2_maximum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_tuple_2_maximum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_origin_x = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_origin_x,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_origin_x()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_origin_x = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Chart_origin_y = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Chart_origin_y,
	    Part_feature_recall_stack);
...
Object exit_part_feature_chart_origin_y()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Chart_origin_y = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Current_data_series = UNBOUND;

Object Data_series_index = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_index,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_index()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_index = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_source_kind = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_source_kind,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_source_kind()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_source_kind = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_info_1 = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_info_1,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_info_1()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_info_1 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_info_2 = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_info_2,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_info_2()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_info_2 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_failed_to_compile = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = 
	    gensym_cons_1(Data_series_failed_to_compile,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_failed_to_compile()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_failed_to_compile = gensym_pop_store;
    return VALUES_1(Nil);
}
...
Object Data_series_data_cache_1_qm = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_data_cache_1_qm,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_data_cache_1_qm()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_data_cache_1_qm = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_data_cache_2_qm = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_data_cache_2_qm,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_data_cache_2_qm()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_data_cache_2_qm = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_illustration_kind = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = 
	    gensym_cons_1(Data_series_illustration_kind,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_illustration_kind()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_illustration_kind = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_generator_info_1 = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_generator_info_1,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_generator_info_1()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_generator_info_1 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_generator_info_2 = UNBOUND;
    ...
    Object new_value;
{
    ...
    Part_feature_recall_stack = gensym_cons_1(Data_series_generator_info_2,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_generator_info_2()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_generator_info_2 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_series_connect_first_and_last_point = UNBOUND;
...
Object enter_part_feature_data_series_connect_first_and_last_point(new_value)
    Object new_value;
{
    x_note_fn_call(178,89);
    Part_feature_recall_stack = 
	    gensym_cons_1(Data_series_connect_first_and_last_point,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_series_connect_first_and_last_point()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_series_connect_first_and_last_point = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Current_chart_data_point = UNBOUND;

Object Data_point_index = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-INDEX */
Object enter_part_feature_data_point_index(new_value)
    Object new_value;
{
    x_note_fn_call(178,91);
    Part_feature_recall_stack = gensym_cons_1(Data_point_index,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_index()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_index = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_tuple_valid_qm = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-TUPLE-VALID? */
Object enter_part_feature_data_point_tuple_valid_qm(new_value)
    Object new_value;
{
    x_note_fn_call(178,93);
    Part_feature_recall_stack = gensym_cons_1(Data_point_tuple_valid_qm,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_tuple_valid_qm()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_tuple_valid_qm = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_tuple_1 = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-TUPLE-1 */
Object enter_part_feature_data_point_tuple_1(new_value)
    Object new_value;
{
    x_note_fn_call(178,95);
    Part_feature_recall_stack = gensym_cons_1(Data_point_tuple_1,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_tuple_1()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_tuple_1 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_tuple_2 = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-TUPLE-2 */
Object enter_part_feature_data_point_tuple_2(new_value)
    Object new_value;
{
    x_note_fn_call(178,97);
    Part_feature_recall_stack = gensym_cons_1(Data_point_tuple_2,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_tuple_2()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_tuple_2 = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_x = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-X */
Object enter_part_feature_data_point_x(new_value)
    Object new_value;
{
    x_note_fn_call(178,99);
    Part_feature_recall_stack = gensym_cons_1(Data_point_x,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_x()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_x = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_y = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-Y */
Object enter_part_feature_data_point_y(new_value)
    Object new_value;
{
    x_note_fn_call(178,101);
    Part_feature_recall_stack = gensym_cons_1(Data_point_y,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_y()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_y = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_first_x = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-FIRST-X */
Object enter_part_feature_data_point_first_x(new_value)
    Object new_value;
{
    x_note_fn_call(178,103);
    Part_feature_recall_stack = gensym_cons_1(Data_point_first_x,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_first_x()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_first_x = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_first_y = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-FIRST-Y */
Object enter_part_feature_data_point_first_y(new_value)
    Object new_value;
{
    x_note_fn_call(178,105);
    Part_feature_recall_stack = gensym_cons_1(Data_point_first_y,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_first_y()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_first_y = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_last_x = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-LAST-X */
Object enter_part_feature_data_point_last_x(new_value)
    Object new_value;
{
    x_note_fn_call(178,107);
    Part_feature_recall_stack = gensym_cons_1(Data_point_last_x,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_last_x()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_last_x = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_last_y = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-LAST-Y */
Object enter_part_feature_data_point_last_y(new_value)
    Object new_value;
{
    x_note_fn_call(178,109);
    Part_feature_recall_stack = gensym_cons_1(Data_point_last_y,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_last_y()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_last_y = gensym_pop_store;
    return VALUES_1(Nil);
}
...
{
    x_note_fn_call(178,112);
    exit_data_point_indicator_1();
    return VALUES_1(Nil);
}

Object Data_point_indicator = UNBOUND;

Object Data_point_indicator_projection_function = UNBOUND;
...
Object enter_part_feature_data_point_indicator_projection_function(new_value)
    Object new_value;
{
    x_note_fn_call(178,113);
    Part_feature_recall_stack = 
	    gensym_cons_1(Data_point_indicator_projection_function,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_indicator_projection_function()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_indicator_projection_function = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_show_indicator = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-SHOW-INDICATOR */
Object enter_part_feature_data_point_show_indicator(new_value)
    Object new_value;
{
    x_note_fn_call(178,115);
    Part_feature_recall_stack = gensym_cons_1(Data_point_show_indicator,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_show_indicator()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_show_indicator = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Data_point_show_connecting_line = UNBOUND;

/* ENTER-PART-FEATURE-DATA-POINT-SHOW-CONNECTING-LINE */
Object enter_part_feature_data_point_show_connecting_line(new_value)
    Object new_value;
{
    x_note_fn_call(178,117);
    Part_feature_recall_stack = 
	    gensym_cons_1(Data_point_show_connecting_line,
	    Part_feature_recall_stack);
...
Object exit_part_feature_data_point_show_connecting_line()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Data_point_show_connecting_line = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Current_axis = UNBOUND;

Object Axis_heading = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-HEADING */
Object enter_part_feature_axis_heading(new_value)
    Object new_value;
{
    x_note_fn_call(178,119);
    Part_feature_recall_stack = gensym_cons_1(Axis_heading,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_heading()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_heading = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_index = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-INDEX */
Object enter_part_feature_axis_index(new_value)
    Object new_value;
{
    x_note_fn_call(178,121);
    Part_feature_recall_stack = gensym_cons_1(Axis_index,
	    Part_feature_recall_stack);
...
Object Axis_minimum = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-MINIMUM */
Object enter_part_feature_axis_minimum(new_value)
    Object new_value;
{
    x_note_fn_call(178,127);
    Part_feature_recall_stack = gensym_cons_1(Axis_minimum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_minimum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_minimum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_crossover = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-CROSSOVER */
Object enter_part_feature_axis_crossover(new_value)
    Object new_value;
{
    x_note_fn_call(178,129);
    Part_feature_recall_stack = gensym_cons_1(Axis_crossover,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_crossover()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_crossover = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_maximum = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-MAXIMUM */
Object enter_part_feature_axis_maximum(new_value)
    Object new_value;
{
    x_note_fn_call(178,131);
    Part_feature_recall_stack = gensym_cons_1(Axis_maximum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_maximum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_maximum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_count = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-TICKMARK-COUNT */
Object enter_part_feature_axis_tickmark_count(new_value)
    Object new_value;
{
    x_note_fn_call(178,133);
    Part_feature_recall_stack = gensym_cons_1(Axis_tickmark_count,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_count()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_count = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_step = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-TICKMARK-STEP */
Object enter_part_feature_axis_tickmark_step(new_value)
    Object new_value;
{
    x_note_fn_call(178,135);
    Part_feature_recall_stack = gensym_cons_1(Axis_tickmark_step,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_step()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_step = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_automatic = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-AUTOMATIC */
Object enter_part_feature_axis_automatic(new_value)
    Object new_value;
{
    x_note_fn_call(178,137);
    Part_feature_recall_stack = gensym_cons_1(Axis_automatic,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_automatic()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_automatic = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_count_as_fixnum = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-TICKMARK-COUNT-AS-FIXNUM */
Object enter_part_feature_axis_tickmark_count_as_fixnum(new_value)
    Object new_value;
{
    x_note_fn_call(178,139);
    Part_feature_recall_stack = 
	    gensym_cons_1(Axis_tickmark_count_as_fixnum,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_count_as_fixnum()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_count_as_fixnum = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_label_frequency = UNBOUND;

/* ENTER-PART-FEATURE-AXIS-TICKMARK-LABEL-FREQUENCY */
Object enter_part_feature_axis_tickmark_label_frequency(new_value)
    Object new_value;
{
    x_note_fn_call(178,141);
    Part_feature_recall_stack = 
	    gensym_cons_1(Axis_tickmark_label_frequency,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_label_frequency()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_label_frequency = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_label_max_digits_before_point = UNBOUND;
...
Object enter_part_feature_axis_tickmark_label_max_digits_before_point(new_value)
    Object new_value;
{
    x_note_fn_call(178,143);
    Part_feature_recall_stack = 
	    gensym_cons_1(Axis_tickmark_label_max_digits_before_point,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_label_max_digits_before_point()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_label_max_digits_before_point = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_label_max_digits_after_point = UNBOUND;
...
Object enter_part_feature_axis_tickmark_label_max_digits_after_point(new_value)
    Object new_value;
{
    x_note_fn_call(178,145);
    Part_feature_recall_stack = 
	    gensym_cons_1(Axis_tickmark_label_max_digits_after_point,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_label_max_digits_after_point()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_label_max_digits_after_point = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_tickmark_label_max_digits_in_exponent = UNBOUND;
...
Object enter_part_feature_axis_tickmark_label_max_digits_in_exponent(new_value)
    Object new_value;
{
    x_note_fn_call(178,147);
    Part_feature_recall_stack = 
	    gensym_cons_1(Axis_tickmark_label_max_digits_in_exponent,
	    Part_feature_recall_stack);
...
Object exit_part_feature_axis_tickmark_label_max_digits_in_exponent()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Axis_tickmark_label_max_digits_in_exponent = gensym_pop_store;
    return VALUES_1(Nil);
}
...
Object Number_of_significant_digits = UNBOUND;

/* ENTER-PART-FEATURE-NUMBER-OF-SIGNIFICANT-DIGITS */
Object enter_part_feature_number_of_significant_digits(new_value)
    Object new_value;
{
    x_note_fn_call(178,150);
    Part_feature_recall_stack = gensym_cons_1(Number_of_significant_digits,
	    Part_feature_recall_stack);
...
Object exit_part_feature_number_of_significant_digits()
{
	...
	next_cons = Nil;
    Part_feature_recall_stack = next_cons;
    Number_of_significant_digits = gensym_pop_store;
    return VALUES_1(Nil);
}

Object Axis_is_discrete_p = UNBOUND;
...
static Object Qaxis_minimum;       /* axis-minimum */

static Object Qaxis_maximum;       /* axis-maximum */
...
static Object Qaxis_crossover;     /* axis-crossover */
    ...
    Object data_maximum;
{
    ...
    axis_minimum = Nil;
    axis_maximum = Nil;
    PUSH_SPECIAL(Axis_maximum,axis_maximum,1);
      PUSH_SPECIAL(Axis_minimum,axis_minimum,0);
    ...
    Object axis_with_crossover, axis;
{
	...
	arg_1 = DOUBLE_FLOAT_TO_DOUBLE(min_1);
	return set_simple_part_feature(axis_with_crossover,Qaxis_crossover,
		make_slot_value_float(arg < arg_1 &&  
		!inline_nanp_for_comparison(arg) &&  
...
static Object Qdata_series_info_1;  /* data-series-info-1 */

static Object Qdata_series_info_2;  /* data-series-info-2 */
    ...
    Object chart_frame;
{
	...
	next_loop:
	  ...
	  data_series_source_temp2 = info_2 ? evaluate_designation(info_2,
		  Nil) : Nil;
	  if ( !TRUEP(get_simple_part_feature(data_series,
	      ...
	      if (SIMPLE_VECTOR_P(data_series_source_temp1) && 
		      ...
		      > (SI_Long)2L &&  
		      !EQ(ISVREF(data_series_source_temp1,(SI_Long)1L),
	  ...
	  if (temp) {
	      sub_class_bit_vector = 
		      ISVREF(ISVREF(data_series_source_temp1,(SI_Long)1L),
		      (SI_Long)19L);
	      ...
	      if (SIMPLE_VECTOR_P(data_series_source_temp2) && 
		      ...
		      > (SI_Long)2L &&  
		      !EQ(ISVREF(data_series_source_temp2,(SI_Long)1L),
		      Qavailable_frame_vector)) {
...
static Object Qdata_series_source_kind;  /* data-series-source-kind */
    ...
    Object chart_frame;
{
	...
	next_loop:
	  ...
	  data_series_source_temp = 
		  evaluate_designation(get_simple_part_feature(data_series,
		  Qdata_series_info_1),Nil);
	  if (EQ(Qone_g2_quantity_list,get_simple_part_feature(data_series,
	      ...
	      if (SIMPLE_VECTOR_P(data_series_source_temp) && 
		      ...
		      > (SI_Long)2L &&  !EQ(ISVREF(data_series_source_temp,
...
Object Tickmark_label_min_height = UNBOUND;

Object Tickmark_label_char_width = UNBOUND;

Object Tickmark_label_min_width = UNBOUND;

static Object Qaxis_heading;       /* axis-heading */

static Object Qaxis_tickmark_count;  /* axis-tickmark-count */

static Object Qaxis_tickmark_step;  /* axis-tickmark-step */
...
static Object Qaxis_tickmark_count_as_fixnum;  /* axis-tickmark-count-as-fixnum */

static Object Qaxis_tickmark_label_frequency;  /* axis-tickmark-label-frequency */
...
Object compute_axis_tickmarks_and_style varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Axis_tickmark_label_frequency,axis_tickmark_label_frequency,
	    0);
...
Object simple_scatter_plot_data_series_projection_method()
{
	...
	if (inline_funcall_0(gensymed_symbol)) {
	    ...
	    PUSH_SPECIAL(Data_point_index,data_point_index,0);
	...
	PUSH_SPECIAL(Data_point_last_y,data_point_last_y,3);
	  PUSH_SPECIAL(Data_point_last_x,data_point_last_x,2);
	    PUSH_SPECIAL(Data_point_y,data_point_y,1);
	      PUSH_SPECIAL(Data_point_x,data_point_x,0);
...
Object Tick_mark_part_to_draw = UNBOUND;
    ...
    Object new_value;
{
    ...
    x_note_fn_call(178,185);
    Part_feature_recall_stack = gensym_cons_1(Data_point_indicator,
	    Part_feature_recall_stack);
...
{
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, new_value, temp;

    x_note_fn_call(178,186);
    gensym_pop_store = Nil;
    cons_1 = Part_feature_recall_stack;
    if (cons_1) {
	gensym_pop_store = M_CAR(cons_1);
...
static Object Qsubparts;           /* subparts */
...
Object compute_chart_statistics()
{
    ...
    Object temp_1, old_current_part_description_1;
    Object old_current_part_description_2, current_data_series, ab_loop_list_;
    Object current_computed_data_series, ab_loop_list__1, data_series_index;
    Object ab_loop_iter_flag_, old_current_part_description_3;
    Object old_current_part_description_4, old_current_part_description_5;
    ...
    Object part_feature_index, exit_feature_handler, gensym_pop_store, cons_1;
    Object next_cons;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
	...
	PUSH_SPECIAL(Part_exceptions_from_parents,part_exceptions_from_parents,
	  ...
	  PUSH_SPECIAL(Current_text_box_format,current_text_box_format,7);
	    PUSH_SPECIAL(Chart_bottom,chart_bottom,6);
	      PUSH_SPECIAL(Chart_right,chart_right,5);
		PUSH_SPECIAL(Chart_left,chart_left,4);
		  PUSH_SPECIAL(Chart_top,chart_top,3);
		    ...
		    PUSH_SPECIAL(Current_data_series,current_data_series,2);
		      ...
		      PUSH_SPECIAL(Data_series_index,data_series_index,1);
			...
			if (PUSH_LOCAL_ALLOCATION(Local_area,1,1)) {
				...
				data_series_generator_next_tuple_method = 
					...
					_);
				data_point_index = Nil;
				PUSH_SPECIAL(Data_point_index,data_point_index,
					0);
				  tag_temp = UNIQUE_TAG(Qnil);
				  if (PUSH_CATCH(tag_temp,0)) {
				      Data_point_index = FIX((SI_Long)1L);
...
Object assure_chart_transform_is_uptodate()
{
    ...
    Object current_axis, ab_loop_list_, axis_index, ab_loop_iter_flag_;
    Object old_current_part_description_4, axis_is_discrete_p;
    Object part_feature_index, exit_feature_handler, gensym_pop_store, cons_1;
    Object next_cons, chart_horizontal_device_range;
    Object chart_vertical_device_range;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
	  ...
	  PUSH_SPECIAL(Current_text_box_format,current_text_box_format,7);
		...
		PUSH_SPECIAL(Chart_left,chart_left,4);
		  PUSH_SPECIAL(Chart_top,chart_top,3);
		    ...
		    PUSH_SPECIAL(Current_axis,current_axis,2);
		      axis_index = FIX((SI_Long)1L);
		      PUSH_SPECIAL(Axis_index,axis_index,1);
			ab_loop_iter_flag_ = T;
		      next_loop:
			if ( !TRUEP(ab_loop_list_))
			    goto end_loop;
			...
			PUSH_SPECIAL(Axis_is_discrete_p,axis_is_discrete_p,0);
			  if (EQ(Axis_heading,Qnorth)) {
...
static Object Qgrid_visible;       /* grid-visible */
...
Object project_chart()
{
    ...
    Object color_or_metacolor, svref_new_value, scale, gensymed_symbol, value;
    Object temp_1, w1, h1, part_exceptions_from_parents, chart_top, chart_left;
    Object chart_right, chart_bottom, current_text_box_format;
    Object old_current_part_description, new_cons;
    ...
    Object gensym_pop_store, cons_1, next_cons, current_data_series;
    Object current_computed_data_series, ab_loop_list__1, data_series_index;
    ...
    x_note_fn_call(178,190);
    SAVE_STACK();
    chart_really_drawing = T;
    PUSH_SPECIAL(Chart_really_drawing,chart_really_drawing,19);
      chart_current_raster_is_polychrome_p = 
	      EQ(ISVREF(Current_graph_rendering,(SI_Long)6L),
	      Qpolychrome_raster) ? T : Nil;
      PUSH_SPECIAL(Chart_current_raster_is_polychrome_p,chart_current_raster_is_polychrome_p,
	      18);
	chart_current_raster_is_monochrome_raster_list_p = 
		EQ(ISVREF(Current_graph_rendering,(SI_Long)6L),
		Qmonochrome_raster_list) ? T : Nil;
	PUSH_SPECIAL(Chart_current_raster_is_monochrome_raster_list_p,chart_current_raster_is_monochrome_raster_list_p,
		17);
	  chart_pen_x = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Chart_pen_x,chart_pen_x,16);
	    chart_pen_y = FIX((SI_Long)0L);
	    PUSH_SPECIAL(Chart_pen_y,chart_pen_y,15);
	      chart_pen_color_1 = Qblack;
	      PUSH_SPECIAL(Chart_pen_color,chart_pen_color_1,14);
		chart_pen_color_value = Chart_really_drawing ? 
			map_to_color_value(Qblack) : FIX((SI_Long)0L);
		PUSH_SPECIAL(Chart_pen_color_value,chart_pen_color_value,13);
		  if (Chart_current_raster_is_monochrome_raster_list_p || 
			  Chart_current_raster_is_polychrome_p)
		  ...
		  if (EQ(color_or_metacolor,Qbackground))
		      ...
		      svref_new_value = map_to_color_value(color_or_metacolor);
		  ...
		  temp_1 = ISVREF(Current_chart_frame,(SI_Long)8L);
		  if ( !( !TRUEP(CAR(temp_1)) && ((SI_Long)0L != 
			  (IFIX(ISVREF(Current_chart_frame,(SI_Long)5L)) & 
			  (SI_Long)1L) ||  !TRUEP(Inside_breakpoint_p) && 
			  (SI_Long)0L != (IFIX(ISVREF(Current_chart_frame,
			  (SI_Long)4L)) & (SI_Long)16777216L) &&  
			  !((SI_Long)0L != 
			  (IFIX(ISVREF(Current_chart_frame,(SI_Long)4L)) & 
			  (SI_Long)8192L)))) ||  
		      ...
		      result = chart_line(FIX(w2),FIX((SI_Long)0L));
		  }
		  else {
		      part_exceptions_from_parents = Nil;
		      PUSH_SPECIAL(Part_exceptions_from_parents,part_exceptions_from_parents,
			...
			current_text_box_format = temp_1;
			PUSH_SPECIAL(Current_text_box_format,current_text_box_format,
				11);
			  PUSH_SPECIAL(Chart_bottom,chart_bottom,10);
			    PUSH_SPECIAL(Chart_right,chart_right,9);
			      PUSH_SPECIAL(Chart_left,chart_left,8);
				PUSH_SPECIAL(Chart_top,chart_top,7);
				  ...
				  old_current_part_description_1 = 
					  Current_part_description;
				  temp_1 = ISVREF(Current_chart_frame,
					  (SI_Long)21L);
				  if (temp_1);
				  else
				      temp_1 = list_constant_1;
				  Current_part_description = temp_1;
				  if (Maintain_stack_of_current_part_descriptions_p) 
					      {
				      new_cons = Available_gensym_conses;
				      if (new_cons) {
				  ...
				  temp_1 = ISVREF(Current_text_box_format,
					  (SI_Long)48L);
				  if (temp_1);
				  else
				      temp_1 = Qblack;
				  chart_pen_color(temp_1);
				  chart_frame_rectangle(FIX((SI_Long)0L),
					  FIX((SI_Long)0L),FIX(width),
					  FIX(height));
				  ...
				  chart_origin_y = Nil;
				  grids_visible = Nil;
				  PUSH_SPECIAL(Chart_origin_y,chart_origin_y,
					  6);
				    PUSH_SPECIAL(Chart_origin_x,chart_origin_x,
					    5);
				      PUSH_SPECIAL(Data_series_subparts,data_series_subparts,
					      4);
					...
					grids_visible = temp_1;
					if (grids_visible) {
					    tick_mark_part_to_draw = Qgrid;
					    PUSH_SPECIAL(Tick_mark_part_to_draw,tick_mark_part_to_draw,
						    3);
					      chart_pen_color(Formatted_part_true_line_color);
					      old_current_part_description_3 
						      = 
					      ...
					      ab_loop_list_ = 
						      ...
						      Qcomputed_annotations,
						      Nil),Qsubparts,Qaxis);
					      PUSH_SPECIAL(Current_axis,current_axis,
						      2);
						axis_index = FIX((SI_Long)1L);
						PUSH_SPECIAL(Axis_index,axis_index,
							1);
						  ab_loop_iter_flag_ = T;
						next_loop_1:
						  if ( !TRUEP(ab_loop_list_))
						  ...
						  axis_is_discrete_p = 
							  ...
							  : 
							  plot_north_axis_label_tickmarks_as_integers_p(Current_chart_frame);
						  PUSH_SPECIAL(Axis_is_discrete_p,axis_is_discrete_p,
							  0);
					    ...
					    end_loop_3:;
					      ...
					      ab_loop_list_ = 
						      Data_series_subparts;
					      PUSH_SPECIAL(Current_data_series,current_data_series,
						      1);
						current_computed_data_series 
							= Nil;
						ab_loop_list__1 = 
						...
						data_series_index = 
							FIX((SI_Long)1L);
						PUSH_SPECIAL(Data_series_index,data_series_index,
							0);
						  ab_loop_iter_flag_ = T;
						next_loop_4:
						  if ( !TRUEP(ab_loop_list_))
...
static Object Qsubpart_defaults;   /* subpart-defaults */

static Object Qsubpart_exceptions;  /* subpart-exceptions */
    ...
    Object colors_so_far, part_description;
{
  ...
  next_loop:
	...
	temp_1 = TRUEP(Qnil);
      end_1:;
	colors_so_far = temp_1 ? cdr_1 : gensym_cons_1(car_1,cdr_1);
    }
    ab_loop_list_ = CDDR(ab_loop_list_);
    if ( !TRUEP(ab_loop_list_))
	goto end_loop;
    ...
    Object graph_rendering, current_chart_raster_color_value;
{
    ...
    x_note_fn_call(178,193);
    PUSH_SPECIAL(Current_chart_raster_color_value,current_chart_raster_color_value,
	    2);
...
static Object Qdata_series_failed_to_compile;  /* data-series-failed-to-compile */
...
Object compile_data_series_descriptions_for_slot varargs_1(int, n)
{
    ...
    Object compilation_result, bad_phrase_qm, current_annotated_frame;
    Object slot_description, new_cons, gensymed_symbol_1, temp;
    ...
    Object second_new_value, frame_and_slot_or_atom, ab_loop_it_, temp_2;
    Object gensym_pop_store, cons_1, next_cons;
    char temp_1;
    Declare_varargs_nonrelocating;
    Declare_special(5);

    x_note_fn_call(178,200);
    INIT_ARGS_nonrelocating();
    parse_result = REQUIRED_ARG_nonrelocating();
	...
	PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,4);
	  slot_description = 
	  ...
	  if ( !TRUEP(gensymed_symbol))
	      gensymed_symbol = replenish_gensym_cons_pool();
	  if (Nil)
	      gensymed_symbol_1 = nconc2(gensym_list_2(chart,
	  ...
	  PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	    ...
	    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
		    1);
		...
		goto next_loop;
	      end_loop:
		reclaim_gensym_list_1(component_particulars_with_frame_notes_1);
	      POP_SPECIAL();
	    POP_SPECIAL();
	    current_computation_frame = chart;
	    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
		    2);
	      current_computation_component_particulars = 
		      gensym_list_2(Qdata_series,FIX((SI_Long)0L));
	      PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
		      1);
		data_series = Nil;
		ab_loop_list_ = REST(parse_result);
		data_series_index = FIX((SI_Long)1L);
		PUSH_SPECIAL(Data_series_index,data_series_index,0);
		  designation_1 = Nil;
		...
		next_loop_1:
		  ...
		  designation_2_qm = 
			  copy_for_phrase(get_simple_part_feature(data_series,
			  Qdata_series_info_2));
		  compilation_1_qm = compile_expression(designation_1,Nil,Nil);
		  compilation_2_qm = designation_2_qm ? 
			  compile_expression(designation_2_qm,Nil,Nil) : Nil;
		  ...
		  if ( !TRUEP(compilation_1_qm) || designation_2_qm &&  
		...
		temp_1 = TRUEP(Nil);
	    if ( !temp_1)
		update_all_representations_of_slot(chart,slot_description,
			Nil,Nil);
    ...
    return VALUES_2(compilation_result,bad_phrase_qm);
}
...
{
    Object parse_result, chart, gensymed_symbol;
    Object result_1, error_message_qm, current_annotated_frame;
    Declare_varargs_nonrelocating;
    Declare_special(1);
    Object result;

    x_note_fn_call(178,205);
    INIT_ARGS_nonrelocating();
    parse_result = REQUIRED_ARG_nonrelocating();
    chart = REQUIRED_ARG_nonrelocating();
    gensymed_symbol = REQUIRED_ARG_nonrelocating();
    ...
    current_annotated_frame = chart;
    PUSH_SPECIAL(Current_annotated_frame,current_annotated_frame,0);
    ...
    Object plist, slot_name;
{
    ...
    Object temp_1, svref_new_value, amf_result, incff_1_arg, new_float;
    Object gensymed_symbol;
    double aref_new_value;

    x_note_fn_call(178,207);
...
static Object Qgrid_color;         /* grid-color */
...
static Object Qnumber_of_significant_digits;  /* number-of-significant-digits */
...
static Object Qcurrent_part_description;  /* current-part-description */

static Object Qlookup_subpart_of_collection;  /* lookup-subpart-of-collection */

static Object Qpart_index;         /* part-index */
    ...
    Object subpart_list, path;
{
	...
	attributes = Nil;
    result_1 = Nil;
    PUSH_SPECIAL(Subpart_exceptions,subpart_exceptions,1);
      PUSH_SPECIAL(Subpart_defaults,subpart_defaults,0);
	if (Subpart_defaults) {
	    part = Nil;
	    values_1 = Nil;
	  ...
	  next_loop_1:
	    ...
	    temp = subpart_features(temp,
		    gensym_cons_1(gensym_cons_1(gensymed_symbol,
		    Qab_structure),copy_list_using_gensym_conses_1(path)));
	...
	if (attributes) {
		...
		temp = gensym_cons_1(gensymed_symbol,Qab_structure);
	    }
	    else {
		gensymed_symbol = allocate_managed_array(1,FIX((SI_Long)2L 
			+ (SI_Long)1L));
...
static Object Qchart_data_point;   /* chart-data-point */
    ...
    Object l1, l2;
{
    ...
    x_note_fn_call(178,231);
    l3 = nreverse(copy_list_using_gensym_conses_1(l1));
    elt_1 = Nil;
    ab_loop_list_ = l2;
  next_loop:
    if ( !TRUEP(ab_loop_list_))
    ...
    Object slot_value, frame, slot_description;
{
    ...
    x_note_fn_call(178,233);
    if (slot_value) {
	subpart_defaults = getfq_function_no_default(CDR(slot_value),
		Qsubpart_defaults);
	PUSH_SPECIAL(Subpart_defaults,subpart_defaults,1);
	  subpart_exceptions = getfq_function_no_default(CDR(slot_value),
		  Qsubpart_exceptions);
	  PUSH_SPECIAL(Subpart_exceptions,subpart_exceptions,0);
		...
		reclaim_gensym_list_1(chart_axis_features_internal);
		reclaim_gensym_list_1(chart_data_series_features_internal);
...
static Object Qaxis_tickmark_label_max_digits_in_exponent;  /* axis-tickmark-label-max-digits-in-exponent */

static Object Qaxis_tickmark_label_max_digits_before_point;  /* axis-tickmark-label-max-digits-before-point */

static Object Qaxis_tickmark_label_max_digits_after_point;  /* axis-tickmark-label-max-digits-after-point */
    ...
    Object chart, computed_annotations, axis_number;
{
    ...
    Object incff_1_arg, new_float, svref_new_value, structure;
    SI_Long gensymed_symbol_1, svref_arg_2;
    char temp_2;
    double aref_new_value;
    Declare_special(5);
    ...
    x_note_fn_call(178,236);
    requested_axis = get_subpart_of_collection(computed_annotations,
	    Qsubparts,Qaxis,axis_number);
    current_chart_frame = chart;
    PUSH_SPECIAL(Current_chart_frame,current_chart_frame,4);
      current_computation_frame = chart;
      PUSH_SPECIAL(Current_computation_frame,current_computation_frame,3);
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	    slot_value_number = get_simple_part_feature(requested_axis,
		    Qaxis_crossover);
	    ...
	    PUSH_SPECIAL(Axis_crossover,axis_crossover,2);
	      slot_value_number = get_simple_part_feature(requested_axis,
		      Qaxis_minimum);
	      if (INLINE_DOUBLE_FLOAT_VECTOR_P(slot_value_number) != 
		      (SI_Long)0L && 
	      ...
	      PUSH_SPECIAL(Axis_minimum,axis_minimum,1);
		slot_value_number = get_simple_part_feature(requested_axis,
			Qaxis_maximum);
		if (INLINE_DOUBLE_FLOAT_VECTOR_P(slot_value_number) != 
			(SI_Long)0L && 
		...
		PUSH_SPECIAL(Axis_maximum,axis_maximum,0);
		  temp = axis_number;
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		      ...
		      temp_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
		      SVREF(temp_1,FIX((SI_Long)1L)) = Qaxis_is_discrete;
		  }
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size)) {
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size))
		      SVREF(gensymed_symbol,FIX((SI_Long)5L)) = Qaxis_heading;
		  else {
		      temp_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		      ...
		      temp_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
		      SVREF(temp_1,FIX((SI_Long)5L)) = Qaxis_crossover;
		  }
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size)) {
		      amf_available_array_cons_qm = 
		      ...
		      new_float = amf_result;
		      aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(Axis_crossover);
		      DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size))
		      SVREF(gensymed_symbol,FIX((SI_Long)9L)) = Qaxis_minimum;
		  else {
		      temp_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		      ...
		      new_float = amf_result;
		      aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(Axis_minimum);
		      DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
		      item_or_value = new_float;
		      if (SIMPLE_VECTOR_P(item_or_value) && 
			      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size))
		      SVREF(gensymed_symbol,FIX((SI_Long)11L)) = Qaxis_maximum;
		  else {
		      temp_1 = ISVREF(gensymed_symbol,(SI_Long)2L);
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		      ...
		      new_float = amf_result;
		      aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(Axis_maximum);
		      DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
		      item_or_value = new_float;
		      if (SIMPLE_VECTOR_P(item_or_value) && 
			      IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
		  ...
		  structure = gensym_cons_1(gensymed_symbol,Qab_structure);
		  if (max_digits_in_exponent)
		      set_evaluation_structure_slot(structure,
			      Qmax_digits_in_exponent,max_digits_in_exponent);
		  ...
		  if (max_digits_after_point)
		      set_evaluation_structure_slot(structure,
			      Qmax_digits_after_point,max_digits_after_point);
		  temp = structure;
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
    ...
    Object chart;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__1 = 
		gensym_cons_1(build_data_series_structure(data_series_element),
		Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
...
static Object Qdata_series_data_cache_1_qm;  /* data-series-data-cache-1? */

static Object Qdata_series_cache_2;  /* data-series-cache-2 */

static Object Qdata_series_data_cache_2_qm;  /* data-series-data-cache-2? */
    ...
    Object managed_float_array;
{
	...
	aref_new_value = DFLOAT_ISAREF_1(ISVREF(managed_float_array,
		...
		(SI_Long)1023L);
	DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
	ab_loopvar__2 = gensym_cons_1(new_float,Nil);
	if (ab_loopvar__1)
    ...
    Object chart;
{
	...
	current_graph_rendering = get_or_make_graph_rendering_for_chart(chart);
	PUSH_SPECIAL(Current_graph_rendering,current_graph_rendering,1);
	  if (EQ(ISVREF(Current_window,(SI_Long)1L),Qicp) || 
		  Current_graph_rendering && 
		  ISVREF(Current_graph_rendering,(SI_Long)7L) && 
		  ISVREF(ISVREF(Current_graph_rendering,(SI_Long)7L),
		  (SI_Long)1L)) {
		...
		if (IFIX(scale) == (SI_Long)4096L)
		    ...
		    gensymed_symbol_2 = IFIX(scalef_function(scale,value));
		SAVE_VALUES(draw_current_graph_rendering(temp,temp_1,
			temp_2,FIX(gensymed_symbol + gensymed_symbol_2)));
...
Object refresh_images_of_chart(chart)
    Object chart;
{
    x_note_fn_call(178,243);
    return update_chart(chart);
}
    ...
    Object chart, erase_renderings_qm;
{
    ...
    x_note_fn_call(178,244);
    if (erase_renderings_qm)
	update_images_of_block(chart,T,T);
    copy_of_renderings = copy_list_using_gensym_conses_1(ISVREF(chart,
	    (SI_Long)16L));
    rendering = Nil;
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(copy_of_renderings);
    return VALUES_1(Qnil);
}
...
Object recompute_and_draw_chart(chart)
    Object chart;
{
    x_note_fn_call(178,245);
    update_the_computed_annotations(chart);
    return update_images_of_block(chart,Nil,T);
}
    ...
    Object chart;
{
    ...
    Object amf_result, incff_1_arg, new_float, computed_horizontal_axis;
    Object computed_vertical_axis, result_1, all_computed_data_series;
    Object gensymed_symbol_2, gensymed_symbol_3, new_computed_annotations;
    Object chart_tuple_1_minimum, chart_tuple_1_maximum, chart_tuple_2_minimum;
    Object chart_tuple_2_maximum, current_computation_frame;
    Object data_series_subparts, part_exceptions_from_parents, chart_top;
    Object chart_left, chart_right, chart_bottom, current_text_box_format;
    Object old_current_part_description, new_cons;
    Object old_current_part_description_1, old_current_part_description_2;
    Object managed_number_or_value, temp_2, font_structure;
    Object tickmark_label_char_width, tickmark_label_min_height;
    Object tickmark_label_min_width, part_feature_index, exit_feature_handler;
    Object gensym_pop_store, cons_1, next_cons;
    ...
    x_note_fn_call(178,246);
    current_chart_frame = chart;
    PUSH_SPECIAL(Current_chart_frame,current_chart_frame,20);
      ...
      if ( !TRUEP(CAR(temp)) && ((SI_Long)0L != (IFIX(ISVREF(chart,
	      ...
	      (SI_Long)16777216L) &&  !((SI_Long)0L != (IFIX(ISVREF(chart,
	      (SI_Long)4L)) & (SI_Long)8192L)))) {
	  chart_really_drawing = Nil;
	  PUSH_SPECIAL(Chart_really_drawing,chart_really_drawing,19);
	    chart_pen_x = FIX((SI_Long)0L);
	    PUSH_SPECIAL(Chart_pen_x,chart_pen_x,18);
	      chart_pen_y = FIX((SI_Long)0L);
	      PUSH_SPECIAL(Chart_pen_y,chart_pen_y,17);
		chart_pen_color_1 = Qblack;
		PUSH_SPECIAL(Chart_pen_color,chart_pen_color_1,16);
		  chart_pen_color_value = Chart_really_drawing ? 
			  map_to_color_value(Qblack) : FIX((SI_Long)0L);
		  PUSH_SPECIAL(Chart_pen_color_value,chart_pen_color_value,15);
		    chart_annotations = ISVREF(chart,(SI_Long)21L);
		    requested_horizontal_axis = 
			    get_subpart_of_collection(chart_annotations,
			    Qsubpart_exceptions,Qaxis,FIX((SI_Long)1L));
		    requested_vertical_axis = 
			    get_subpart_of_collection(chart_annotations,
			    Qsubpart_exceptions,Qaxis,FIX((SI_Long)2L));
		    gensymed_symbol = make_gensym_list_1(FIX((SI_Long)11L));
		    gensymed_symbol_1 = gensymed_symbol;
		    ...
		    M_CAR(gensymed_symbol_1) = new_float;
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    M_CAR(gensymed_symbol_1) = Qnumber_of_significant_digits;
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    ...
		    result_1 = Nil;
		    ab_loop_repeat_ = IFIX(length(ISVREF(chart,(SI_Long)20L)));
		  next_loop:
		    if ( !((SI_Long)0L < ab_loop_repeat_))
			goto end_loop;
		    ab_loop_repeat_ = ab_loop_repeat_ - (SI_Long)1L;
		    result_1 = gensym_cons_1(gensym_cons_1(Qdata_series,
			    Nil),result_1);
		    goto next_loop;
		  end_loop:
		  ...
		  end_1:;
		    ...
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    temp_1 = gensym_list_4(Qaxis,
			    gensym_list_2(computed_horizontal_axis,
		    ...
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    gensymed_symbol_2 = make_gensym_list_1(FIX((SI_Long)7L));
		    ...
		    DFLOAT_ISASET_1(new_float,(SI_Long)0L,10.0);
		    M_CAR(gensymed_symbol_3) = new_float;
		    temp_1 = gensym_list_2(Qaxis,
			    gensym_cons_1(gensymed_symbol_2,Nil));
		    M_CAR(gensymed_symbol_1) = temp_1;
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    M_CAR(gensymed_symbol_1) = Qgrid_visible;
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    temp_1 = get_simple_part_feature(chart_annotations,
			    Qgrid_visible);
		    M_CAR(gensymed_symbol_1) = temp_1;
		    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		    ...
		    chart_tuple_2_maximum = 
			    make_temporary_constant_no_expiration(float_constant,
			    Qnumber);
		    PUSH_SPECIAL(Chart_tuple_2_maximum,chart_tuple_2_maximum,
			    14);
		      PUSH_SPECIAL(Chart_tuple_2_minimum,chart_tuple_2_minimum,
			      13);
			PUSH_SPECIAL(Chart_tuple_1_maximum,chart_tuple_1_maximum,
				12);
			  PUSH_SPECIAL(Chart_tuple_1_minimum,chart_tuple_1_minimum,
				  11);
			    current_computation_frame = Current_chart_frame;
			    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,
				    10);
			      data_series_subparts = 
				      ISVREF(Current_chart_frame,(SI_Long)20L);
			      PUSH_SPECIAL(Data_series_subparts,data_series_subparts,
				      9);
				part_exceptions_from_parents = Nil;
				PUSH_SPECIAL(Part_exceptions_from_parents,part_exceptions_from_parents,
				  ...
				  chart_right = FIX(gensymed_symbol_4 - 
					  gensymed_symbol_5);
				  gensymed_symbol = 
					  ISVREF(Current_chart_frame,
					  (SI_Long)14L);
				  ...
				  gensymed_symbol = gensymed_symbol ? 
					  ...
					  (SI_Long)1L) : FIX((SI_Long)0L);
				  gensymed_symbol_5 = IFIX(gensymed_symbol);
				  chart_bottom = FIX(gensymed_symbol_4 - 
					  gensymed_symbol_5);
				  temp = 
					  get_instance_with_name_if_any(Qformat_frame,
					  Qdynamic_text_cell_format);
				  ...
				  PUSH_SPECIAL(Current_text_box_format,current_text_box_format,
					...
					PUSH_SPECIAL(Chart_left,chart_left,4);
					  PUSH_SPECIAL(Chart_top,chart_top,3);
					    ...
					    change_slot_value(3,chart,
						    Qcomputed_annotations,
						    new_computed_annotations);
					    update_subscriptions_from_virtual_attribute_change(chart,
						...
						tickmark_label_char_width 
							...
							/ 256.0);
						PUSH_SPECIAL(Tickmark_label_char_width,tickmark_label_char_width,
							2);
						  tickmark_label_min_height 
							  ...
							  * 
							  ...
							  (SI_Long)5L)));
						  PUSH_SPECIAL(Tickmark_label_min_height,tickmark_label_min_height,
							  1);
						    temp_3 = 
						    ...
						    tickmark_label_min_width 
							    ...
							    * temp_3);
						    PUSH_SPECIAL(Tickmark_label_min_width,tickmark_label_min_width,
							    0);
...
static Object Qchart_left_margin;  /* chart-left-margin */

static Object Qchart_right_margin;  /* chart-right-margin */

static Object Qchart_top_margin;   /* chart-top-margin */

static Object Qchart_bottom_margin;  /* chart-bottom-margin */
    ...
    Object requested_horizontal_axis, computed_horizontal_axis;
{
    ...
    Object old_current_part_description, new_cons, gensymed_symbol, temp;
    Object current_axis, ab_loop_list_, axis_index, ab_loop_iter_flag_;
    Object old_current_part_description_1, axis_is_discrete_p, temp_1;
    Object label_significant_digits, decff_1_arg, part, slot_value_number;
    Object crossover, min_1, max_1, delta, part_feature_index;
    Object exit_feature_handler, gensym_pop_store, cons_1, next_cons;
    Object label_count, chart_left_margin, chart_right_margin;
    Object chart_top_margin, chart_bottom_margin;
	...
	PUSH_SPECIAL(Current_axis,current_axis,2);
	  ...
	  next_loop:
	    ...
	    PUSH_SPECIAL(Axis_is_discrete_p,axis_is_discrete_p,0);
		  ...
		  north_tickmark_label_min_height = Tickmark_label_min_height;
		  ...
		  Tickmark_label_min_width = DOUBLE_TO_DOUBLE_FLOAT(6.0 * 
			  temp_3);
		  east_char_width = char_width;
		  east_tickmark_label_char_width = Tickmark_label_char_width;
	      }
	      part = axis;
	      set_simple_part_feature(part,
		      Qaxis_tickmark_label_max_digits_before_point,whole);
	      set_simple_part_feature(part,
		      Qaxis_tickmark_label_max_digits_after_point,fraction);
	      set_simple_part_feature(part,
	...
	half_label_width = IFIX(east_char_width) * ((IFIX(unaligned_size) 
	...
	if (FIXNUM_GE(FIXNUM_ADD(left_margin,right_margin),
	    ...
	    left_margin = FIX(IFIX(FIXNUM_MINUS(Chart_right,Chart_left)) - 
		    (IFIX(right_margin) >>  -  - (SI_Long)1L) - 
		    IFIX(east_char_width));
	...
	PUSH_SPECIAL(Chart_bottom_margin,chart_bottom_margin,3);
	  PUSH_SPECIAL(Chart_top_margin,chart_top_margin,2);
	    PUSH_SPECIAL(Chart_right_margin,chart_right_margin,1);
	      PUSH_SPECIAL(Chart_left_margin,chart_left_margin,0);
		if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		    temp_3 = 
    ...
    Object all_computed_data_series;
{
    ...
    Object new_cons, gensymed_symbol, temp, second_new_value;
    ...
    x_note_fn_call(178,255);
    current_computation_component_particulars = gensym_list_2(Qdata_series,
	    FIX((SI_Long)0L));
    PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
	    2);
      current_data_series = Nil;
      ab_loop_list_ = Data_series_subparts;
      PUSH_SPECIAL(Current_data_series,current_data_series,1);
    ...
    Object designation_qm;
{
    ...
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object temp, managed_number_or_value, temp_1, class_1, gensymed_symbol;
    ...
    Object sub_class_bit_vector, data_values, length_2, data_cache, nan_count;
    Object data_value, ab_loop_list_, value, ab_loop_iter_flag_, aref_arg_1;
    Object plural_string;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5, i;
    char temp_2;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		if ((SI_Long)1L <= IFIX(Warning_message_level) &&  
		    ...
		    PUSH_SPECIAL(Note_blocks_in_tformat,note_blocks_in_tformat,
			    6);
		...
		if ( !temp_2) {
		  ...
		  end_loop_16:
		    ...
		    reclaim_gensym_list_1(data_values);
    ...
    Object chart, new_chart_style, initializing_qm;
{
    ...
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(chart,Qchart_style);
    SVREF(chart,FIX((SI_Long)19L)) = new_chart_style;
    gensymed_symbol = ISVREF(ISVREF(ISVREF(ISVREF(chart,(SI_Long)1L),
	...
	update_chart(chart);
    return VALUES_1(new_chart_style);
}
    ...
    Object chart, new_data_series, initializing_qm;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, cdr_new_value;
    Object stack_of_slot_value_changes, gensymed_symbol_2, gensymed_symbol_3;
    Object temp, frame_and_slot_or_atom, ab_loop_list_, ab_loop_it_;
    Object gensym_pop_store, cons_1, next_cons;
    SI_Long svref_new_value;
    char temp_1;
    Declare_special(1);

    x_note_fn_call(178,259);
    result_1 = Nil;
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(chart,slot_description),
		gensym_cons_1(Nil,Nil));
    else {
	new_cons = Available_gensym_conses;
	if (new_cons) {
	    Available_gensym_conses = M_CDR(new_cons);
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  gensymed_symbol_2,gensymed_symbol_3);
	  svref_new_value = IFIX(ISVREF(chart,(SI_Long)5L)) | 
		  (SI_Long)16777216L;
	  ISVREF(chart,(SI_Long)5L) = FIX(svref_new_value);
      }
      gensymed_symbol = ISVREF(ISVREF(ISVREF(ISVREF(chart,(SI_Long)1L),
	      (SI_Long)11L),(SI_Long)34L),(SI_Long)1L);
      gensymed_symbol_1 = chart;
      ...
      temp = SVREF(chart,FIX((SI_Long)20L)) = new_data_series;
      gensymed_symbol = ISVREF(ISVREF(ISVREF(ISVREF(chart,(SI_Long)1L),
	      (SI_Long)11L),(SI_Long)33L),(SI_Long)1L);
      gensymed_symbol_1 = chart;
      inline_funcall_1(gensymed_symbol,gensymed_symbol_1);
	...
	next_loop:
	  ...
	  ab_loop_it_ = temp_1 ? (EQ(chart,M_CAR(frame_and_slot_or_atom)) ?
		   T : Nil) : Nil;
	  if (ab_loop_it_) {
	      temp_1 = TRUEP(ab_loop_it_);
	      goto end_1;
    ...
    if ( !TRUEP(initializing_qm))
	update_chart(chart);
    return VALUES_1(new_data_series);
}
    ...
    Object chart, new_annotations, initializing_qm;
{
    ...
    SVREF(chart,FIX((SI_Long)21L)) = new_annotations;
    gensymed_symbol = ISVREF(ISVREF(ISVREF(ISVREF(chart,(SI_Long)1L),
	    (SI_Long)11L),(SI_Long)33L),(SI_Long)1L);
    gensymed_symbol_1 = chart;
    inline_funcall_1(gensymed_symbol,gensymed_symbol_1);
    if ( !TRUEP(initializing_qm))
	update_chart(chart);
    return VALUES_1(new_annotations);
}
    ...
    Object chart;
{
    ...
    Object initial_scan_wait_interval, future_task_schedule_modify_arg_2;
    ...
    Object def_structure_schedule_task_variable, task, frame, sub_vector_qm;
    ...
    x_note_fn_call(178,261);
    current_computation_frame = chart;
    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,0);
      computation_style_description = get_default_computation_style_of_class();
      priority = get_simple_part_feature(computation_style_description,
	      Qpriority);
      initial_scan_wait_interval = 
	      get_simple_part_feature(computation_style_description,Qpriority);
      if ( !TRUEP(In_suspend_resume_p)) {
	  future_task_schedule_modify_arg_2 = priority;
	  future_task_schedule_modify_arg_3 = 
		  DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 
		  (double)IFIX(initial_scan_wait_interval);
	  future_task_schedule_modify_arg_8 = SYMBOL_FUNCTION(Qupdate_chart);
	  future_task_schedule_modify_arg_11 = chart;
	  schedule_task_qm = ISVREF(chart,(SI_Long)18L);
	  if (schedule_task_qm) {
    ...
    Object chart;
{
    ...
    Object frame, sub_vector_qm, method_function_qm;
    SI_Long svref_new_value_1, index_1, ab_loop_bind_;

    x_note_fn_call(178,262);
    if ( !TRUEP(In_suspend_resume_p)) {
	schedule_task_qm = ISVREF(chart,(SI_Long)18L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
	...
	svref_new_value = Nil;
	ISVREF(chart,(SI_Long)18L) = svref_new_value;
	svref_new_value_1 = IFIX(ISVREF(chart,(SI_Long)5L)) &  ~(SI_Long)1L;
	ISVREF(chart,(SI_Long)5L) = FIX(svref_new_value_1);
    }
    frame = chart;
    sub_vector_qm = ISVREF(ISVREF(ISVREF(frame,(SI_Long)1L),(SI_Long)11L),
	    (SI_Long)7L);
  ...
  end_1:;
	...
	update_chart(chart);
	svref_new_value_1 = IFIX(ISVREF(chart,(SI_Long)5L)) | (SI_Long)1L;
	return VALUES_1(ISVREF(chart,(SI_Long)5L) = FIX(svref_new_value_1));
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object right_edge_of_bounding_box, bottom_edge_of_bounding_box;
{
	...
	if (G2_has_v5_mode_windows_p &&  
		...
		(SI_Long)0L))
	    send_ws_representations_item_moved(chart,FIX(delta_left_edge),
		    FIX(delta_top_edge));
	enlarge_workspace_for_block_rectangle_if_necessary(chart,Nil);
	result = recompute_and_draw_chart(chart);
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object chart;
{
    ...
    return change_size_of_chart(chart,left,top,right,bottom);
}
    ...
    Object chart;
{
  ...
  end_1:;
	...
	return add_frame_note(5,Qno_data_series_chart_note,chart,Nil,T,Nil);
    else
	return VALUES_1(Nil);
}
...
void charts1_INIT()
{
    ...
    Object Qreduce_annotation_1, Qreduce_annotation, string_constant_40;
    ...
    Object Qwrite_data_series_descriptions_from_slot, string_constant_33;
    Object string_constant_32, Qdata_series_description;
    Object Qcompile_chart_style_for_slot, Qwrite_chart_style_from_slot;
    Object string_constant_31, list_constant_162, list_constant_156;
    Object list_constant_161, list_constant_150, list_constant_160;
    Object list_constant_148, list_constant_159, list_constant_158, Qcolumn;
    Object Qdata_point_indicator, list_constant_116;
    Object Qdata_point_show_connecting_line, Qdata_point_show_indicator;
    Object list_constant_157, list_constant_155, Qsmall, list_constant_154;
    Object list_constant_153, Qsquare, list_constant_152, list_constant_151;
    Object list_constant_149, list_constant_147, list_constant_146;
    Object Qsimple_scatter_plot, Qdata_series_illustration_kind;
    Object Qdata_series_connect_first_and_last_point, list_constant_145;
    ...
    Object list_constant_141, Qdata_series_index, list_constant_140;
    Object list_constant_139, Qaxis_series_close_generator;
    Object Qaxis_series_next_tuple, Qaxis_series_open_generator;
    Object float_constant_7, float_constant_6, list_constant_137;
    Object Qexit_part_feature_number_of_significant_digits;
    ...
    Object string_constant_30, Qsimple_type_specification, list_constant_136;
    ...
    Object Qenter_part_feature_axis_automatic, Qaxis_automatic, Qboolean;
    Object list_constant_129, Qexit_part_feature_axis_tickmark_step;
    ...
    Object string_constant_29, Qsimple_type_writer;
    ...
    Object Qenter_part_feature_axis_index, Qaxis_index, list_constant_121;
    ...
    Object Qparts, list_constant_112, list_constant_35, list_constant_111;
    ...
    Object Qdata_point_indicator_projection_function, list_constant_108;
    Object Qexit_data_point_indicator, Qenter_data_point_indicator;
    Object list_constant_107, list_constant_106, Qcall_handlers;
    Object list_constant_105, list_constant_104;
    Object Qexit_part_feature_data_point_last_y;
    Object Qenter_part_feature_data_point_last_y, Qdata_point_last_y;
    Object list_constant_103, Qexit_part_feature_data_point_last_x;
    Object Qenter_part_feature_data_point_last_x, Qdata_point_last_x;
    Object list_constant_102, Qexit_part_feature_data_point_first_y;
    Object Qenter_part_feature_data_point_first_y, Qdata_point_first_y;
    Object list_constant_101, Qexit_part_feature_data_point_first_x;
    Object Qenter_part_feature_data_point_first_x, Qdata_point_first_x;
    Object list_constant_100, Qexit_part_feature_data_point_y;
    Object Qenter_part_feature_data_point_y, Qdata_point_y, list_constant_99;
    Object Qexit_part_feature_data_point_x, Qenter_part_feature_data_point_x;
    Object Qdata_point_x, list_constant_98;
    Object Qexit_part_feature_data_point_tuple_2;
    Object Qenter_part_feature_data_point_tuple_2, Qdata_point_tuple_2;
    Object list_constant_97, Qexit_part_feature_data_point_tuple_1;
    Object Qenter_part_feature_data_point_tuple_1, Qdata_point_tuple_1;
    Object list_constant_96, Qexit_part_feature_data_point_tuple_valid_qm;
    Object Qenter_part_feature_data_point_tuple_valid_qm;
    Object Qdata_point_tuple_valid_qm, list_constant_95;
    Object Qexit_part_feature_data_point_index;
    Object Qenter_part_feature_data_point_index, Qdata_point_index;
    Object list_constant_38, list_constant_94, list_constant_72;
    Object list_constant_93, list_constant_92, list_constant_73;
    Object list_constant_91, Qtext_alginment, Qborder_thickness;
    Object Qallow_individual_exceptions_in_parents, Qdata_point;
    Object Quser_spelling, list_constant_90;
    ...
    Object Qenter_part_feature_data_series_generator_info_2;
    Object Qdata_series_generator_info_2, list_constant_88;
    Object Qexit_part_feature_data_series_generator_info_1;
    Object Qenter_part_feature_data_series_generator_info_1;
    Object Qdata_series_generator_info_1, list_constant_87;
    ...
    Object list_constant_75, Qchildren_part_types, Qformatted_part;
    Object list_constant_71, Qexit_part_feature_chart_origin_y;
    Object Qenter_part_feature_chart_origin_y, Qchart_origin_y;
    Object list_constant_70, Qexit_part_feature_chart_origin_x;
    Object Qenter_part_feature_chart_origin_x, Qchart_origin_x;
    Object list_constant_69, Qexit_part_feature_chart_tuple_2_maximum;
    Object Qenter_part_feature_chart_tuple_2_maximum, Qchart_tuple_2_maximum;
    Object Qtemporary_constant, list_constant_68;
    Object Qexit_part_feature_chart_tuple_2_minimum;
    Object Qenter_part_feature_chart_tuple_2_minimum, Qchart_tuple_2_minimum;
    Object list_constant_67, Qexit_part_feature_chart_tuple_1_maximum;
    Object Qenter_part_feature_chart_tuple_1_maximum, Qchart_tuple_1_maximum;
    Object list_constant_66, Qexit_part_feature_chart_tuple_1_minimum;
    Object Qenter_part_feature_chart_tuple_1_minimum, Qchart_tuple_1_minimum;
    Object list_constant_65, Qexit_part_feature_chart_bottom_margin;
    ...
    Object Qchart_bottom, list_constant_60, Qexit_part_feature_chart_right;
    Object Qenter_part_feature_chart_right, Qchart_right, list_constant_59;
    Object Qexit_part_feature_chart_top, Qenter_part_feature_chart_top;
    Object Qchart_top, list_constant_58, Qexit_part_feature_chart_left;
    Object Qenter_part_feature_chart_left, Qchart_left, list_constant_57;
    Object list_constant_55, list_constant_54, list_constant_53;
    Object list_constant_48, list_constant_52, list_constant_51;
    Object list_constant_50, list_constant_49, Qother_descendant_part_types;
    ...
    Object list_constant_40, list_constant_37, list_constant_36, Qbasic_part;
    Object Qworking_on_chart, Qcharts, Qslot_value_reclaimer;
    ...
    Object Qchart_spot_structure_memory_usage, Qutilities2, Qchart_spot_count;
    Object Qchain_of_available_chart_spots, string_constant_28;
    ...
    Object Qinitialize_for_chart, string_constant_26, string_constant_25;
    Object list_constant_34, string_constant_24, string_constant_23;
    Object string_constant_22, string_constant_21, string_constant_20;
    Object string_constant_19, string_constant_18, Qitem;
    Object Qinitialize_the_transform, list_constant_33, Qcharts1;
    Object Qthe_transform, Kfuncall, Qassert_frame_notes_for_block;
    Object Qretract_frame_notes_for_block, Qchart_drawing;

    x_note_fn_call(178,270);
    SET_PACKAGE("AB");
    ...
    string_constant_18 = STATIC_STRING("1l1m8v836dy");
    string_constant_19 = 
    ...
    string_constant_21 = 
	    STATIC_STRING(". This\ncomment should show up on options, despite it being placed on frame-flags.000004z8r83Qvy83Qvy836dy836dy00001m1l8l1l8o0000");
    string_constant_22 = 
	    STATIC_STRING("04z8r83U-y83U-y836dy836dy01m1l833My1l83Hsy001n1l8l1l8o1l83Hy000004z8r83Hty83Hty836dy836dy00001n1l8l1l8o1l83Hy000004z8r83Iey83Iey");
    string_constant_23 = 
    ...
    string_constant_25 = 
	    STATIC_STRING("1u8q1n836dy1m83Ry9k1m8v836dy1m83-Ey3C+y1o83Qvy08l8o1p83U-y1m1l833My1l83Hsy8l8o83Hy1p83Hty08l8o83Hy1o83Iey083Hy8l1q837wy01m8p837w");
    string_constant_26 = 
    ...
    temp_2 = regenerate_optimized_constant(list(6,string_constant_19,
	    string_constant_20,string_constant_21,string_constant_22,
	    string_constant_23,string_constant_24));
    ...
    string_constant_27 = 
	    STATIC_STRING("43Dy8m83fsy1o83fsy83Qy8n8k1l83Qy0000001l1m8x83Qykqk0k0");
    ...
    string_constant_28 = STATIC_STRING("1q83fsy8s83-MEy09k9l");
    clear_optimized_constants();
    ...
    string_constant_29 = STATIC_STRING("not a nonnegative number");
    Qtype_error_printer = STATIC_SYMBOL("TYPE-ERROR-PRINTER",AB_package);
    mutate_global_property(Qsimple_nonnegative_number,string_constant_29,
	    Qtype_error_printer);
    ...
    mutate_global_property(Qsimple_number_for_significant_digits,
	    string_constant_30,Qtype_error_printer);
    ...
    string_constant_31 = STATIC_STRING("1l1m837wy83-6y");
    ...
    string_constant_32 = 
	    STATIC_STRING("1o1m83-Pdy83-V-y1n83-V-y1o1m9k833Wy830By1m9k83-uly830By1r8385y83-Phy83-hBy83-Peyo83-Pfym1m83-Pdy83-Pgy1n83-Pgy1m1m9k833Wy830By1p");
    string_constant_33 = STATIC_STRING("8385y83-Phy83-ggy83-Peym");
    clear_optimized_constants();
    ...
    add_grammar_rules_for_list(5,Qchart_annotations,Qchart_annotation,Qsc,
	    Nil,Qnone);
    string_constant_34 = STATIC_STRING("1m1m83-MDy83wmy1m83-MDy83-A0y");
    ...
    string_constant_35 = 
	    STATIC_STRING("13Cy1o83wmy1n1m9k9l1m9k83U+y83-N7y2lmn9m1o83wmy1n1m9k9l1m9k83bmy83-N7y2lmn9m1o83wmy1n1m9k9l1m9k83Avy83-N7y2lmn9m1o83wmy1n1m9k9l1");
    string_constant_36 = 
	    STATIC_STRING("m9k83HHy83-N7y2lmn9m1o83wmy1n1m9k9l1m9k83-Wcy83-N7y2lmn9m1o83wmy1o1m9k9l1m9k83--ky1m9k83*Iy832Uy1n83BSymo9n1n83-N7y1m1m9k83*Iy83");
    string_constant_37 = 
	    STATIC_STRING("*vy1m83BSym1n83-N7y1o1m9k83-Ty83fry1m9k83*Iy83*vy1mmo1o83wmy1o1m9k9l1m9k83-Eky1m9k83*Iy83-Ely1n83BSymo9n1o83wmy1q1m9k9l1m9k83-Ek");
    string_constant_38 = 
	    STATIC_STRING("y1m9k83-Ty83fry1m9k83*Iy83-Ely1nomq9n1o83wmy1o1m9k9l1m9k83bgy1m9k83*Iy83nny1n83BSymo9n1o83wmy1q1m9k9l1m9k83bgy1m9k83-Ty83fry1m9k");
    string_constant_39 = 
	    STATIC_STRING("83*Iy83nny1nomq9n1o83wmy1n1m9k9l1m9k83=sy83-RDy2lmn9m1o83wmy1n1m9k9l1m9k83*4y83-RDy2lmn9m1n83-RDy1m1m9k9o83-Hy1m83BSym1n83-RDy1o");
    string_constant_40 = STATIC_STRING("1m9k83-Ty83fry1m9k9o83-Hy1mmo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_41 = 
	    STATIC_STRING("13Iy1o83-A0y1q1m9k9l1m9k83-Ywy1m9k83-Ty83fry1m9k83*Iy83-Yxy1nomq9m1m83-Yxy1m9k83Yjy1m83-Yxy1m9k83ly1m83-Yxy1m9k83aqy1m83-Yxy1m9k");
    string_constant_42 = 
	    STATIC_STRING("83-PNy1m83-Yxy1m9k83-H9y1m83-Yxy1m9k83-N8y1m83-Yxy1m9k83-Kby1m83-Yxy1m9k83-oqy1m83-Yxy1m9k83-opy1o83-A0y1n1m9k9l1m9k83-Z+y83-Kvy");
    string_constant_43 = 
	    STATIC_STRING("2lmn9n1o83-A0y1n1m9k9l1m9k83-O-y83-Kvy2lmn9n1o83-A0y1n1m9k9l1m9k83-bny83-Kvy2lmn9n1n83-Kvy1o1m9k83-Ty83fry1m9k83*Iy832Uy1mmo1o83");
    string_constant_44 = 
	    STATIC_STRING("-A0y1n1m9k9l1m9k83-KNy83-gHy2lmn9n1o83-A0y1n1m9k9l1m9k83-gEy83-gHy2lmn9n1o83-A0y1n1m9k9l1m9k83-KLy83-gHy2lmn9n1o83-A0y1n1m9k9l1m");
    string_constant_45 = 
	    STATIC_STRING("9k83-KMy83-gHy2lmn9n1o83-A0y1n1m9k9l1m9k83-gFy83-gHy2lmn9n1o83-A0y1n1m9k9l1m9k83-rJy83-gHy2lmn9n1n83-gHy1o1m9k83-Ty83fry1m9k9o83");
    string_constant_46 = 
	    STATIC_STRING("-Hy1mmo1o83-A0y1n1m9k9l1m9k83--ky83-Kvy2lmn9n");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qthe);
    push_optimized_constant(Qreduce_annotation);
    ...
    string_constant_47 = 
	    STATIC_STRING("1p1o83fry1o1m9k83=by83-hPy1m9k83-Ty83fry1p9lo1m9k83-pqy1m9k1n9mm83-hPy09n1o83fry1o83-hPy83-Hy1m9k83-Ty83fry1p9lo1m9k83-pry1m9k1n");
    string_constant_48 = 
	    STATIC_STRING("9ml83-hPym9n1o83fry1m1m9k83=by83-hPy1p9l83BSy1m9k83-pqy1m9k1n9mm83-hPy09n1o83fry1m83-hPy83Sy1p9l83BSy1m9k83-pry1m9k1n9ml83-hPym9");
    string_constant_49 = STATIC_STRING("n1m83-hPy83-6y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    add_grammar_rules_function(regenerate_optimized_constant(LIST_3(string_constant_47,
