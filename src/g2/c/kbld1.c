...
Object Break_if_name_inconsistency_qm = UNBOUND;

Object Plist_has_been_checked_p = UNBOUND;

Object Need_to_check_plist_p = UNBOUND;
...
Object Complete_kb_name_qm = UNBOUND;
...
Object find_differences_in_frames_if_any varargs_1(int, n)
{
	...
	if (just_see_if_there_are_any_qm)
	    ...
	    return gensym_cons_1(Qab_class,Nil);
    }
    else {
	...
	if (temp) {
		...
		ab_loopvar__2 = 
			gensym_cons_1(denote_slot_using_slot_value_conses(slot_description,
...
Object Available_subseries_of_values_64_vectors = UNBOUND;

Object Count_of_subseries_of_values_64_vectors = UNBOUND;
...
{
    Object count_of_subseries_of_values_64_vectors_new_value, temp;
    XDeclare_area(1);

    x_note_fn_call(132,5);
    count_of_subseries_of_values_64_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_subseries_of_values_64_vectors);
...
Object make_subseries_of_values()
{
    ...
    if (Available_subseries_of_values_64_vectors) {
	temp = M_CAR(Available_subseries_of_values_64_vectors);
	temp_1 = M_CDR(Available_subseries_of_values_64_vectors);
	inline_note_reclaim_cons(Available_subseries_of_values_64_vectors,
		Qab_gensym);
	cdr_arg = Available_subseries_of_values_64_vectors;
	cdr_new_value = Available_gensym_conses;
	M_CDR(cdr_arg) = cdr_new_value;
	Available_gensym_conses = Available_subseries_of_values_64_vectors;
	Available_subseries_of_values_64_vectors = temp_1;
    }
    else
    ...
    Object subseries_of_values_64_vector;
{
    ...
    cdr_new_value = Available_subseries_of_values_64_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_subseries_of_values_64_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}
...
Object convert_series_of_values_to_list varargs_1(int, n)
{
  ...
  next_loop_1:
	...
	goto end_loop_1;
    ab_loopvar__4 = gensym_cons_1(copy_values_qm ? 
    ...
    Object series_of_values;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(series_of_values);
}
...
Object Collecting_updates_to_sensor_attributes_p = UNBOUND;

Object Collected_updates_to_sensor_attributes = UNBOUND;
...
Object clone_frame varargs_1(int, n)
{
    ...
    superior_frame_being_cloned_qm = OPTIONAL_ARG_P_nonrelocating() ? 
	    OPTIONAL_ARG_nonrelocating() : Nil;
    PUSH_SPECIAL(Superior_frame_being_cloned_qm,superior_frame_being_cloned_qm,
	    5);
      END_ARGS_nonrelocating();
      collecting_updates_to_sensor_attributes_p = T;
      collected_updates_to_sensor_attributes = Nil;
      PUSH_SPECIAL(Collected_updates_to_sensor_attributes,collected_updates_to_sensor_attributes,
	      4);
	PUSH_SPECIAL(Collecting_updates_to_sensor_attributes_p,collecting_updates_to_sensor_attributes_p,
		3);
	  ...
	  PUSH_SPECIAL(Current_computation_frame,current_computation_frame,2);
		...
		if ( !(EQ(old_slot_value,slot_init_form) || do_not_clone_qm)) {
			...
			if (EQ(representation_frame,old_frame)) {
			    ab_loopvar_ = gensym_cons_1(new_frame,Nil);
			    if (ab_loopvar__1)
			...
			ab_loop_list__1 = M_CDR(ab_loop_list__1);
			ab_loopvar__2 = gensym_cons_1(clone_frame(1,plot),Nil);
			if (ab_loopvar_)
    ...
    Object new_frame, slot_description, old_text_slot_value;
{
	...
	temp_1 = gensym_cons_1(temp,nconc2(temp_1,include_ellipsis_qm ? 
		gensym_cons_1(copy_text_string(Ellipsis_text_string),Nil) :
		 Nil));
    }
    else
	temp_1 = Nil;
    ...
    Object slot_group_for_block_qm, old_frame, new_frame;
{
	...
	gensymed_symbol_3 = ISVREF(old_frame,(SI_Long)14L);
	...
	goto next_loop_1;
      end_loop_1:
	reclaim_gensym_list_1(blocks_in_bounding_box_qm);
	if (workspace_case_qm) {
	    block = Nil;
	    cloned_block = Nil;
...
Object Attempting_save_via_system_procedure_qm = UNBOUND;

Object G2_window_for_save_via_system_procedure_qm = UNBOUND;

Object Default_kb_pathname_qm = UNBOUND;
...
Object Recent_loaded_kbs = UNBOUND;
...
Object Clear_text_grammar_rules_added_p = UNBOUND;

static Object string_constant;     /* "1m1m83-CGy83dpy1m83-CGy83g6y" */
...
Object Compiled_code_grammar_rules_added_p = UNBOUND;

static Object string_constant_1;   /* "1l1m83-CGy83vby" */
...
Object Source_code_control_grammar_is_present_p = UNBOUND;

static Object string_constant_2;   /* "1y1m8335y1p83mgy83LTy83j=y83dpy83g6y1m8335y1o83mgy83LTy83j=y83g6y1m8335y1p83mgy83LTy83j=y83g6y83dpy1m8335y1p83mgy83LTy83dpy83j=y" */

static Object string_constant_3;   /* "83g6y1m8335y1o83mgy83LTy83dpy83g6y1m8335y1p83mgy83LTy83dpy83g6y83j=y1m8335y1n83mgy83LTy83g6y1m8335y1o83mgy83LTy83g6y83j=y1m8335y" */

static Object string_constant_4;   /* "1p83mgy83LTy83g6y83j=y83dpy1m8335y1o83mgy83LTy83g6y83dpy1m8335y1p83mgy83LTy83g6y83dpy83j=y1m8335y1l83-DTy1n83-1by1r1m9k837cy1m9k" */

static Object string_constant_5;   /* "832+y1m9k83aay1m9k83I2y1m9k83Ioy1m9k83HAy1m9k83-c8y83-tmy1n83-1by1t1m9k830Iy1m9k9l1m9k837cy1m9k832+y1m9k83aay1m9k83I2y1m9k83Ioy1" */

static Object string_constant_6;   /* "m9k83HAy1m9k83-c8y83-Rby" */
...
Object File_punctuation_mark_grammar_rules = UNBOUND;
    ...
    Object text_tail_qm, text_string_to_insert_qm;
{
	...
	PUSH_SPECIAL(Vms_directory_filenames_can_dangle_p,vms_directory_filenames_can_dangle_p,
		0);
...
Object Automatically_resolve_conflicts_by_default = UNBOUND;

Object Update_before_loading_by_default = UNBOUND;
    ...
    Object file_command, workspace, edit_box;
{
    ...
    Object svref_new_value, column_top_edge, column_right_edge_so_far, row;
    Object ab_loop_list_, label, name, check_box, ab_loop_desetq_, temp;
    Object temp_1, right_edge, bottom_edge;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, svref_new_value_1, column;
  ...
  next_loop_1:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loop_desetq_ = nthcdr(FIX(column + column),row);
	...
	if ( !EQ(name,Qupdate_before_loading))
	    column_right_edge_so_far = FIXNUM_MAX(column_right_edge_so_far,
		    right_edge);
    ...
    Object edit_workspace, button_name;
{
    ...
    gensymed_symbol = ISVREF(edit_workspace,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
    ab_queue_form_ = gensymed_symbol;
    ab_next_queue_element_ = Nil;
    ...
    Object merge_case_qm;
{
	...
	temp_1 = gensym_list_2(temp_1,
		gensym_directory_and_above_namestring_as_text_string(1,
		default_pathname));
    }
    else {
	temp_1 =  !TRUEP(ISVREF(default_pathname,(SI_Long)4L)) ? 
		gensym_cons_1(make_lost_spaces_text_element(FIX((SI_Long)0L)),
		Nil) : Nil;
	temp_1 = nconc2(temp_1,
		gensym_cons_1(gensym_namestring_as_text_string(1,
		default_pathname),Nil));
    }
    svref_new_value = gensym_cons_1(temp,temp_1);
    ...
    Object load_command, user_supplied_wild_pathname_qm;
{
	...
	PUSH_SPECIAL(Match_regular_expression_for_g2_stream_directory_hook,match_regular_expression_for_g2_stream_directory_hook,
		0);
	  file_type = Nil;
...
Object All_file_namestrings_in_directory_of_names = UNBOUND;

Object All_directory_namestrings_in_directory_of_names = UNBOUND;

Object Defaults_namestring_for_directory_of_names_qm = UNBOUND;
  ...
  next_loop:
	...
	if (directory_p)
	    All_directory_namestrings_in_directory_of_names = 
		    gensym_cons_1(nicer_enough_namestring_as_text_string,
		    All_directory_namestrings_in_directory_of_names);
	else
    ...
    Object kb_load_file_command;
{
  ...
  end_loop:
    change_slot_value(3,kb_load_file_command,
	    ...
	    gensym_list_2(FIX(number_of_directories),FIX(number_of_files)));
    return VALUES_1(Qnil);
}
    ...
    Object file_command;
{
	...
	external_foreign_image_connection_spec_qm = 
		gensym_list_3(transport_type,host_name,port_number_or_name);
    }
    else
...
Object Autostart_after_doing_init_file_qm = UNBOUND;

Object Autostart_reason_in_init_file_qm = UNBOUND;
    ...
    Object only_changed_modules_qm;
{
	...
	if ( !TRUEP(default_pathname_qm))
		...
		temp_1 = gensym_list_3(default_pathname_qm,command_symbol,
			emit_c_code_qm);
		temp_2 = gensym_cons_1(default_pathname_qm,Nil);
    ...
    Object gensym_pathname_1;
{
	...
	if (truename_qm)
		...
		goto next_loop;
	      end_loop:;
		reclaim_gensym_list_1(directory_qm);
	    }
	}
    ...
    Object directory_pathname;
{
	...
	if (EQ(load_case_qm,Qconnect_to_foreign_image)) {
		...
		filtered_directory = gensym_cons_1(directory_item,
			filtered_directory);
	}
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(unfiltered_directory);
    ...
    Object install_system_tables_if_merge_case_qm, update_before_loading_qm;
{
    ...
    PUSH_SPECIAL(Gensym_file_error_occurred_p,gensym_file_error_occurred_p,1);
	...
	if (PUSH_CATCH(Qgensym_file_error_catch_tag,1)) {
		...
		parameters = gensym_list_4(directory_pathname,
		...
		if ( !EQ(parameters,Qunbound_in_protected_let))
		    reclaim_gensym_list_1(parameters);
	    }
	    if (title) {
    ...
    Object load_case_qm;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(ascii_filename,Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
    reclaim_gensym_list_1(pathnames);
...
Object System_statistics_writers = UNBOUND;
...
Object Kb_flags_for_saving = UNBOUND;
...
Object Kb_flags_from_last_kb_read = UNBOUND;

Object System_version_from_last_kb_read = UNBOUND;

Object System_revision_from_last_kb_read = UNBOUND;

Object System_quality_from_last_kb_read = UNBOUND;
...
void kb_load1_INIT()
{
    ...
    Object list_constant_17, Qkb_load1, Qwarmbooting_with_catch_up_qm;
    Object Qwarmbooting_qm, Qkb_save, Qruntime_data_only;
    ...
    Object Qfile_command_directory_namestring_as_text_string_qm;
    Object Qdefaults_namestring_for_directory_of_names_qm;
    Object Qall_directory_namestrings_in_directory_of_names;
    Object Qall_file_namestrings_in_directory_of_names, Qcleanup;
    ...
    Object Qcommand, Qcurrent_foreign_image_pathname_qm;
    Object Qcurrent_statistics_file_pathname_qm;
    Object Qcurrent_attribute_file_pathname_qm, list_constant_42;
    Object list_constant_41, Qdo_not_update_before_loading;
    Object Qresolve_conflicts_manually;
    ...
    Object Qrecent_loaded_kbs, Qdefault_kb_pathname_qm;
    Object Qg2_window_for_save_via_system_procedure_qm;
    Object Qattempting_save_via_system_procedure_qm, Qcurrent_kb_pathname_qm;
    Object Qrun, Qdo_g2_init_file_qm, Qout_subseries_of_values_64_vectors;
    Object Qsubseries_of_values_64_vector_memory_usage, string_constant_46;
    Object Qutilities2, Qcount_of_subseries_of_values_64_vectors;
    Object Qavailable_subseries_of_values_64_vectors;
    Object Qreclaim_if_text_string_function, Qcomplete_kb_name_qm;
    Object array_constant_14, Qdo_plist_checking, Qneed_to_check_plist_p;
    Object Qbreak_if_name_inconsistency_qm, Qsubstitute_class_and_kb_flags;
    ...
    Qsubseries_of_values_64_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_46 = STATIC_STRING("1q83-pty83*By83-P6y09k9l");
    clear_optimized_constants();
    ...
    string_constant_48 = 
	    STATIC_STRING("13Fy1n8335y1m83-2Qy83wLy1nlm01n8335y1o83-2Qy83wLy1m9k83vy83-awy1nlmo1n8335y1o83Dgy83wLy1m9k83vy83-b+y1nlmo1m8335y1m83-CHy83LTy1m");
    string_constant_49 = 
	    STATIC_STRING("8335y1m83mgy83LTy1m8335y1n83mgy83LTy83j=y1m8335y1o83mgy83LTy83j=y83dpy1m8335y1n83mgy83LTy83dpy1m8335y1o83mgy83LTy83dpy83j=y1m833");
    string_constant_50 = 
	    STATIC_STRING("5y1m83-CFy83vFy1m8335y1n83-CFy83vFy83j=y1m8335y1o83-CFy83vFy83j=y83dpy1m8335y1n83-CFy83vFy83dpy1m8335y1o83-CFy83vFy83dpy83j=y1m8");
    string_constant_51 = 
	    STATIC_STRING("335y1m9l838Ky1m8335y1m9l83uvy1m8335y1m9l1m9k83-V4y1n8335y1n9l83uvy838Ky1nlnm1m8335y83tNy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qdo_plist_checking_again,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    string_constant = STATIC_STRING("1m1m83-CGy83dpy1m83-CGy83g6y");
    ...
    mutate_global_property(Qes_c_c,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    string_constant_1 = STATIC_STRING("1l1m83-CGy83vby");
    SET_SYMBOL_FUNCTION(Qes_c_c,STATIC_FUNCTION(es_c_c,NIL,FALSE,0,0));
    string_constant_52 = 
	    STATIC_STRING("1l1n83j=y1p1m9k83vy1m9k83-=Ny1m9k830*y1m9k83-l5y1m9k83-eay83j=y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_52));
    Qmessage = STATIC_SYMBOL("MESSAGE",AB_package);
    string_constant_53 = 
	    STATIC_STRING("1l1n83g6y1s1m9k83vy1m9k83sQy1m9k835+y1m9k83-m8y1m9k83=Fy1m9k9l1m9k9m83-Uy1m83g6ys");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_54 = 
	    STATIC_STRING("1l1n83vby1n1m9k83vy1m9k83-SPy1m9k83I2y83vby");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_54));
    string_constant_55 = 
	    STATIC_STRING("1l1n83dpy1o1m9k83vy1m9k83Fmy1m9k83-Mfy1m9k83Gy83dpy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_56 = 
	    STATIC_STRING("13cy1m83Cwy8335y1n83Cwy1m1m9k836Gy1m9k830Jy83-pEy1m83wLy83LTy1m83wLy83-hey1m83wLy1m83uvy83-hey1m83LTy838Ky1m83LTy83uvy1m83LTy1m8");
    string_constant_57 = 
	    STATIC_STRING("3uvy838Ky1m83vFy83vEy1m83vFy83-QNy1n83-1by1n1m9k83q7y1m9k83-lBy1m9k83-Nmy83-l9y1n83-1by1n1m9k83-chy1m9k83-lBy1m9k83-Nmy83-lAy1n8");
    string_constant_58 = 
	    STATIC_STRING("3-1by1n1m9k83-L4y1m9k83-UUy1m9k83-tjy9l1m83-1by83-RUy1m83-axy83-1by1n83-axy1n1m9k83-ZPy1m9k8l1m9k83-qWy83-ZOy1n83-RUy1m1m9k83-pG");
    string_constant_59 = 
	    STATIC_STRING("y1m9k83-JPy83-pDy1n83-RUy1n1m9k9m1m9k83-pGy1m9k83-JPy83-fWy1n83-RUy1m1m9k83-v4y1m9k83-JPy83-v2y1n83-RUy1v1m9k83-v4y1m9k83-JPy1m9");
    string_constant_60 = 
	    STATIC_STRING("k83-ty1m9k83-m6y1m9k832+y1m9k83-ojy1m9k831Ay1m9k83*5y1m9k83hLy1m9k83*5y1m9k83liy83-v3y1n83mgy1o1m9k83Cy1m9k83Vty83Duy1m9k83*5y1m");
    string_constant_61 = 
	    STATIC_STRING("83mgyn1n83mgy1o1m9k83Cy1m9k83-ruy1m9k83Vty1m9k83*5y1m83mgy83-wdy1n83-CFy1o1m9k83Cy1m9k83Vty83Duy1m9k83-=qy1m83-CFyn1n83-CFy1o1m9");
    string_constant_62 = 
	    STATIC_STRING("k83Cy1m9k83-ruy1m9k83Vty1m9k83-=qy1m83-CFy83-wdy1n9n1o1m9k9o1m9k830Jy1m9k83-pNy1m9k83*5y9n1n83-2Qy1m1m9k9p1m9k83kDy9p1n83-2Qy1m1");
    string_constant_63 = 
	    STATIC_STRING("m9k9q1m9k83kDy9q1n83Dgy1m1m9k9q1m9k83kDy9q1n83-CHy1o1m9k83Cy1m9k831Sy1m9k83kDy1m9k83*5y83THy1m83tNy1m83-c5y83wLy1n83tNy1p1m9k83v");
    string_constant_64 = 
	    STATIC_STRING("Hy1m9k832+y1m9k830*y1m9k83wcy1m9k83-YRy1l9r1n83-c5y1o1m9k836iy1m9k83=3y1m9k83wcy1m9k83Cmy9s1n83tNy1r1m9k836iy1m9k83=3y1m9k83w6y1");
    string_constant_65 = 
	    STATIC_STRING("m9k83wcy1m9k83Cmy1m9k83=Gy83-ULy1m9tr1n83-ULy1p1m9k83bcy1m9k83Rdy83-Uy1m9k83Y+y83Sy1n83bcynp1n83-c5y1o1m9k83vHy1m9k832+y1m9k83wc");
    string_constant_66 = 
	    STATIC_STRING("y1m9k83Cmy9u1n83tNy1r1m9k83vHy1m9k832+y1m9k83w6y1m9k83wcy1m9k83Cmy1m9k83=Gy83-ULy1m9vr1n83-c5y1n1m9k9p1m9k83-qy1m9k83LOy9w1n83-h");
    string_constant_67 = 
	    STATIC_STRING("ey1n1m9k83Xly1m9k83vDy1m9k9x83-hey1n83uvy1p1m9k83-9y838Ky1m9k83*uy1m9k83Py1m9k83-Aym1n83-QNy1p1m9k83-9y83vEy1m9k83*uy1m9k83Py1m9");
    ...
    string_constant_2 = 
	    STATIC_STRING("1y1m8335y1p83mgy83LTy83j=y83dpy83g6y1m8335y1o83mgy83LTy83j=y83g6y1m8335y1p83mgy83LTy83j=y83g6y83dpy1m8335y1p83mgy83LTy83dpy83j=y");
    string_constant_3 = 
	    STATIC_STRING("83g6y1m8335y1o83mgy83LTy83dpy83g6y1m8335y1p83mgy83LTy83dpy83g6y83j=y1m8335y1n83mgy83LTy83g6y1m8335y1o83mgy83LTy83g6y83j=y1m8335y");
    string_constant_4 = 
	    STATIC_STRING("1p83mgy83LTy83g6y83j=y83dpy1m8335y1o83mgy83LTy83g6y83dpy1m8335y1p83mgy83LTy83g6y83dpy83j=y1m8335y1l83-DTy1n83-1by1r1m9k837cy1m9k");
    string_constant_5 = 
	    STATIC_STRING("832+y1m9k83aay1m9k83I2y1m9k83Ioy1m9k83HAy1m9k83-c8y83-tmy1n83-1by1t1m9k830Iy1m9k9l1m9k837cy1m9k832+y1m9k83aay1m9k83I2y1m9k83Ioy1");
    string_constant_6 = STATIC_STRING("m9k83HAy1m9k83-c8y83-Rby");
    string_constant_69 = 
	    STATIC_STRING("1p1n83-DTy1n83-DUy1m9k837cy83LTy1m83-mPyn1n83-DTy1n83-DUy1m9k8331y83LTy1m83-mMyn1n83-DTy1n83-DUy1m9k83-t1y83LTy1m83-mOyn1n83-DTy");
    string_constant_70 = 
	    STATIC_STRING("1r83-DUy1m9k83sQy83LTy1m9k83=Fy1m9k9l1m9k9m83-Uy1n83-mLynr1n83-DTy1n83-DUy1m9k83-C2y83LTy1m83-mNyn");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qlog);
    push_optimized_constant(Qmessage);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_69,
	    string_constant_70)));
    string_constant_71 = 
	    STATIC_STRING("1l1m83-DUy1n1m9k83aay1m9k83I2y1m9k83Ioy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_72 = 
	    STATIC_STRING("1r1m83CKy83-Viy1m83CKy1m83-Viy83CKy1m83-Viy838Ky1m83-Viy83vEy1m83-Viy83-Tdy1m83vEy83-2y1m83vEy83-Uy");
    ...
    check_if_superior_classes_are_defined(Qkb_load_file_command,
	    list_constant_44);
    string_constant_76 = 
	    STATIC_STRING("1u4z8r83ry83ry83TFy83TFy00001o1l8l1n8p83CKy83Gy1l8o1l83-3y000004z8r83Iuy83Iuy83TFy83TFy00001n1l8l1m8p83LPy1l83Fy000004z8r83Ivy83");
    string_constant_77 = 
	    STATIC_STRING("Ivy83TFy83TFy00001l1l8l000004z8r83J-y83J-y83TFy83TFy00001l1l8l000004z8r83Ity83Ity83TFy83TFy00001n1l8l1m8p83Jxy1l83Fy000004z8r83Q");
    string_constant_78 = 
	    STATIC_STRING("4y83Q4y83TFy83TFy00001l1l8l000004z8r83LQy83LQy83TFy83TFy00001l1l8l000004z8r83UJy83UJy83TFy83TFy01l+3Cy3-ty3-dy3-7y3-vy3-ty3-Uy3-");
    string_constant_79 = 
	    STATIC_STRING("*y3-ey3-8y3-vykkkku3A++y001l1l8l000004z8r83VOy83VOy83TFy83TFy00001l1l8l000004z8r83Z9y83Z9y83TFy83TFy00001l1l8l00000");
    string_constant_80 = 
	    STATIC_STRING("1w8q1m83TFy1l8335y1n83ry01n8p83CKy83Gy1o83Iuy01m8p83LPy83Fy1m83Ivy01m83J-y01o83Ity01m8p83Jxy83Fy1m83Q4y01m83LQy01m83UJy1l5u{kK}{");
    string_constant_81 = STATIC_STRING("bBlL}1m83VOy01m83Z9y0");
    temp = regenerate_optimized_constant(string_constant_73);
    ...
    make_menu_description(Qpathnames_in_directory,Qnil,Qnil,Qnil,Qnil,Qnil,
	    ...
	    regenerate_optimized_constant(string_constant_93));
    string_constant_94 = STATIC_STRING("1m1m83*Yy83-hay1n83*Yy83-TIy0");
    ...
    string_constant_95 = 
	    STATIC_STRING("13Jy83*oy837Ty083=wy08308yk830Ayk8309yk8307yk832Py083=Dyk836Ky083=Nyk836Jy0");
	...
	Kb_flags_for_saving = FIX((SI_Long)281L);
