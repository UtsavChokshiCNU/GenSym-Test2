...
Object Current_state_stack = UNBOUND;

Object Current_token_stack = UNBOUND;

Object Current_input_stack = UNBOUND;

Object Current_lr_states = UNBOUND;

Object Current_nonterminals = UNBOUND;

Object Current_parse_table = UNBOUND;

Object Current_productions = UNBOUND;

Object Current_terminals = UNBOUND;

Object Lr0_follow = UNBOUND;

Object Preprocessor_errors_qm = UNBOUND;

Object The_type_description_of_production = UNBOUND;

Object Chain_of_available_productions = UNBOUND;

Object Production_count = UNBOUND;
    ...
    Object production;
{
    ...
    svref_new_value = Chain_of_available_productions;
    SVREF(production,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_productions = production;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_production_variable, production_count_new_value;
    Object defstruct_g2_production_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(79,4);
    def_structure_production_variable = Nil;
    production_count_new_value = FIXNUM_ADD1(Production_count);
    Production_count = production_count_new_value;
...
{
    Object def_structure_production_variable;
...
Object Chain_of_available_possible_phrases = UNBOUND;

Object Possible_phrase_count = UNBOUND;
    ...
    Object possible_phrase;
{
    ...
    svref_new_value = Chain_of_available_possible_phrases;
    SVREF(possible_phrase,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_possible_phrases = possible_phrase;
    return VALUES_1(Nil);
}
...
Object make_permanent_possible_phrase_structure_internal()
{
    ...
    Object possible_phrase_count_new_value;
    ...
    possible_phrase_count_new_value = FIXNUM_ADD1(Possible_phrase_count);
    Possible_phrase_count = possible_phrase_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_set_of_possible_phrasess = UNBOUND;

Object Set_of_possible_phrases_count = UNBOUND;
    ...
    Object set_of_possible_phrases;
{
    ...
    svref_new_value = Chain_of_available_set_of_possible_phrasess;
    SVREF(set_of_possible_phrases,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_set_of_possible_phrasess = set_of_possible_phrases;
    return VALUES_1(Nil);
}
...
Object make_permanent_set_of_possible_phrases_structure_internal()
{
    ...
    Object set_of_possible_phrases_count_new_value;
    ...
    set_of_possible_phrases_count_new_value = 
	    FIXNUM_ADD1(Set_of_possible_phrases_count);
    Set_of_possible_phrases_count = set_of_possible_phrases_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_parse_tables = UNBOUND;

Object Parse_table_count = UNBOUND;
    ...
    Object parse_table;
{
    ...
    svref_new_value = Chain_of_available_parse_tables;
    SVREF(parse_table,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_parse_tables = parse_table;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_parse_table_variable, parse_table_count_new_value;
    ...
    parse_table_count_new_value = FIXNUM_ADD1(Parse_table_count);
    Parse_table_count = parse_table_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object nonterm;
{
  ...
  next_loop:
	...
	temp = TRUEP(Qnil);
      end_1:;
	answer = temp ? answer : gensym_cons_1(next_symbol,answer);
    }
    i = i + (SI_Long)1L;
    goto next_loop;
  end_loop:
    ...
    Object nonterm, prod;
{
    ...
    answer = first_can_be(nonterm,reversed_rhs) ? ISVREF(prod,(SI_Long)1L) 
	    : Nil;
    reclaim_gensym_list_1(reversed_rhs);
...
Object nonterms_which_have_productions_which_may_end_with(nonterm)
    Object nonterm;
{
    Object prod, answer, whatever, gensym_modify_macro_using_test_arg_1, car_1;
  ...
  next_loop:
	...
	if ( !EQ(whatever,nonterm)) {
	    gensym_modify_macro_using_test_arg_1 = whatever;
	  ...
	  end_loop_1:
	    temp = TRUEP(Qnil);
	  end_1:;
	    answer = temp ? cdr_1 : gensym_cons_1(car_1,cdr_1);
	}
    }
    i = i + (SI_Long)1L;
    goto next_loop;
    ...
    Object rhs, omit;
{
	...
	if ( !TRUEP(yn_1))
	  ...
	  end_loop_1:
	    temp_1 = TRUEP(Qnil);
	  end_1:;
	    answer = temp_1 ? answer : gensym_cons_1(yn_1,answer);
	    done_qm = T;
	}
	else if (epsilon_production_p(yn_1)) {
	    new_omit = gensym_cons_1(yn_1,
		    copy_list_using_gensym_conses_1(omit));
	    answer = lr_first(yn_1);
	    yn_1 = CAR(rhs);
	    rhs = CDR(rhs);
	    done_qm = memq_function(yn_1,new_omit);
	    reclaim_gensym_list_1(new_omit);
	}
	else {
	    answer = lr_first(yn_1);
	    done_qm = T;
...
Object lr_first_of_nonterminal(symb,omit)
    Object symb, omit;
{
    Object real_omit, prod, answer, lhs, rhs, first_of_rhs, gensym_pop_store;
    Object cons_1, next_cons, cdr_new_value;
    Object gensym_modify_macro_using_test_arg_1, car_1, cdr_1, key_result;
    Object x_element, ab_loop_list_, ab_loop_it_, temp_1;
    SI_Long ab_loop_bind_, i, ab_loop_bind__1, i_1;
    char temp;

    x_note_fn_call(79,33);
    real_omit = gensym_cons_1(symb,copy_list_using_gensym_conses_1(omit));
    ab_loop_bind_ = IFIX(length(Current_productions));
    i = (SI_Long)0L;
    prod = Nil;
    answer = Qnil;
  ...
  next_loop:
	...
	gensym_modify_macro_using_test_arg_1 = gensym_pop_store;
	car_1 = gensym_modify_macro_using_test_arg_1;
	cdr_1 = answer;
	key_result = car_1;
	x_element = Nil;
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(real_omit);
    temp_1 = answer;
    goto end_3;
    temp_1 = Qnil;
  end_3:;
    ...
    Object symb;
{
	...
	temp = gensym_cons_1(symb,Nil);
    else {
	stupid_tmp_list = gensym_cons_1(symb,Nil);
	lr_first_symb = lr_first_of_nonterminal(symb,stupid_tmp_list);
	reclaim_gensym_list_1(stupid_tmp_list);
	temp = lr_first_symb;
    }
    return VALUES_1(temp);
}
    ...
    Object nonterm, omit;
{
    ...
    Object new_omit, follow_lhs, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, gensym_modify_macro_using_test_arg_1, car_1, cdr_1;
  ...
  next_loop:
	...
	follow_nonterm = copy_list_using_gensym_conses_1(computed_already_qm);
    else if (memq_function(lhs,omit))
	follow_nonterm = lbreak((SI_Long)1L,"Cannot handle this.~%");
    else {
	new_omit = gensym_cons_1(lhs,copy_list_using_gensym_conses_1(omit));
  ...
  end_loop_2:
    temp_1 = TRUEP(Qnil);
  end_1:;
    answer = temp_1 ? cdr_1 : gensym_cons_1(car_1,cdr_1);
    i = i + (SI_Long)1L;
    goto next_loop_1;
  end_loop_1:
    goto end_2;
  end_2:;
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(nonterms_which_have_productions_which_may_end_with_nonterm);
    return VALUES_1(answer);
}
...
Object follow_1(nonterm,omit)
    Object nonterm, omit;
{
    Object follow, all_betas, beta, ab_loop_list_, first_beta;
    ...
    if (EQ(nonterm,ISVREF(ISVREF(Current_productions,(SI_Long)0L),
	    (SI_Long)1L)))
	follow = gensym_cons_1(Nil,follow);
  ...
  end_loop_2:
    temp = TRUEP(Qnil);
  end_1:;
    follow = temp ? cdr_1 : gensym_cons_1(car_1,cdr_1);
    i = i + (SI_Long)1L;
    goto next_loop_1;
  end_loop_1:
    goto end_2;
  end_2:;
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(all_betas);
    follow_nonterm = 
...
Object create_follow_a_list()
{
  ...
  next_loop:
    ...
    Lr0_follow = gensym_cons_1(gensym_cons_1(nonterminal,nonterm_follow),
	    Lr0_follow);
    goto next_loop;
  end_loop:;
    return VALUES_1(Nil);
...
Object collect_nonterminals()
{
  ...
  next_loop:
	...
	nonterms = gensym_cons_1(lhs,nonterms);
    i = i - (SI_Long)1L;
    goto next_loop;
  end_loop:
    temp = nonterms;
    ...
    Object nonterms;
{
  ...
  next_loop_1:
	...
	termls = gensym_cons_1(symb,termls);
    goto next_loop_1;
  end_loop_1:;
    i = i + (SI_Long)1L;
    goto next_loop;
  ...
  next_loop:
	...
	if ( !TRUEP(production_member_of_possible_phrases_p(prod,
	    ...
	    new_possible_phrase = create_possible_phrase(prod,
		    FIX((SI_Long)0L));
	    answer = gensym_cons_1(new_possible_phrase,answer);
	}
    }
    ...
    Object initial_possible_phrase_or_phrases;
{
    ...
    answer = LISTP(initial_possible_phrase_or_phrases) ? 
	    copy_list_using_gensym_conses_1(initial_possible_phrase_or_phrases) 
	    : gensym_cons_1(initial_possible_phrase_or_phrases,Nil);
  next_loop:
    if (done_qm)
	goto end_loop;
    done_qm = T;
  ...
  next_loop_1:
	...
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	answer = gensym_cons_1(item,answer);
	done_qm = Nil;
	goto next_loop_2;
      end_loop_2:;
    }
    ...
    Object set_of_possible_phrases, gram_sym;
{
	...
	if (EQ(gram_sym,symbol_after_dot(possible_phrase))) {
	    new_possible_phrase = 
		    ...
		    (SI_Long)2L)));
	    unclosed = gensym_cons_1(new_possible_phrase,unclosed);
	}
	goto next_loop;
      end_loop:;
...
{
    Object list_of_shift_state, shift_state, gensym_pop_store, cons_1;
  ...
  next_loop:
    ...
    reclaim_possible_phrase_1(gensym_pop_store);
    i = i + (SI_Long)1L;
    goto next_loop;
  end_loop:;
...
Object create_lr_states()
{
    ...
    Object new_list, duplicate_set, gensym_pop_store, cons_1, next_cons;
    Object gensym_push_modify_macro_arg, car_1, cdr_1, closure_length;
    Object array_version, each_set, ab_loop_iter_flag_, temp_1;
    SI_Long ab_loop_bind_, i;

    x_note_fn_call(79,52);
    current_set = make_set_of_possible_phrases_1();
    all_sets = gensym_cons_1(current_set,Nil);
    closure = gensym_cons_1(current_set,Nil);
  ...
  next_loop_1:
	...
	if (duplicate_set) {
	  ...
	  end_loop_2:;
	    ...
	    all_sets = gensym_cons_1(new_set,all_sets);
	    to_be_processed = gensym_cons_1(new_set,to_be_processed);
	}
    }
    goto next_loop_1;
  end_loop_1:;
  ...
  next_loop_3:
    ...
    if (new_list) {
	if (duplicate_set) {
	    gensym_push_modify_macro_arg = gensym_list_2(gram_sym,
		    duplicate_set);
	  ...
	  end_loop_4:;
	    ...
	    new_set = make_set_of_possible_phrases_1();
	    SVREF(new_set,FIX((SI_Long)1L)) = new_list;
	    gensym_push_modify_macro_arg = gensym_list_2(gram_sym,new_set);
	    car_1 = gensym_push_modify_macro_arg;
	    cdr_1 = ISVREF(current_set,(SI_Long)3L);
	    temp = gensym_cons_1(car_1,cdr_1);
	    SVREF(current_set,FIX((SI_Long)3L)) = temp;
  ...
  end_loop_3:;
	...
	current_set = gensym_pop_store;
	closure = gensym_cons_1(current_set,closure);
    }
    else
	current_set = Nil;
    goto next_loop;
    ...
    Object list_of_productions;
{
    ...
    svref_new_value = gensym_cons_1(CAAR(list_of_productions),Nil);
...
Object create_action_transitions()
{
    ...
    Object next_sym, shift_state, gensym_push_modify_macro_arg, car_1, cdr_1;
  ...
  next_loop_1:
	...
	if ( ! !TRUEP(shift_state)) {
	    gensym_push_modify_macro_arg = gensym_list_2(next_sym,
		    gensym_list_2(Qshift,shift_state));
	    car_1 = gensym_push_modify_macro_arg;
	...
	gensym_push_modify_macro_arg = gensym_list_2(Nil,
		gensym_cons_1(Qaccept,Nil));
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = ISVREF(current_set,(SI_Long)2L);
	svref_new_value = gensym_cons_1(car_1,cdr_1);
	SVREF(current_set,FIX((SI_Long)2L)) = svref_new_value;
	...
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	gensym_push_modify_macro_arg = gensym_list_2(term,
		gensym_list_2(Qab_reduce,production));
	car_1 = gensym_push_modify_macro_arg;
	cdr_1 = ISVREF(current_set,(SI_Long)2L);
	svref_new_value = gensym_cons_1(car_1,cdr_1);
	SVREF(current_set,FIX((SI_Long)2L)) = svref_new_value;
  ...
  end_loop_1:;
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_tree_1(Lr0_follow);
    Lr0_follow = Nil;
    return VALUES_1(Nil);
}
    ...
    Object productions;
{
    ...
    lr0_follow = Qnil;
    PUSH_SPECIAL(Lr0_follow,lr0_follow,4);
      current_productions = create_augmented_grammar(CDR(productions));
      PUSH_SPECIAL(Current_productions,current_productions,3);
	current_nonterminals = collect_nonterminals();
	PUSH_SPECIAL(Current_nonterminals,current_nonterminals,2);
	  current_terminals = 
		  symbols_in_grammar_which_are_not_nonterminals(Current_nonterminals);
	  PUSH_SPECIAL(Current_terminals,current_terminals,1);
	    current_lr_states = create_lr_states();
	    PUSH_SPECIAL(Current_lr_states,current_lr_states,0);
    ...
    Object new_state, new_token;
{
    ...
    Current_token_stack = gensym_cons_1(new_token,Current_token_stack);
    Current_state_stack = gensym_cons_1(new_state,Current_state_stack);
    gensym_pop_store = Nil;
    ...
    Object production_struct;
{
    ...
    Object thing_on_top_of_stack, value_on_top_of_stack, gensym_pop_store;
    Object cons_1, next_cons, temp, gensymed_symbol, gensymed_symbol_1;
    Object current_edit_state, temp_1, transformed_reduction, non_terminal;
    Object next_state, new_parse_object;
    SI_Long i;
    Declare_special(1);
  ...
  next_loop:
    ...
    thing_on_top_of_stack = gensym_pop_store;
  ...
  end_loop:;
    ...
    PUSH_SPECIAL(Current_edit_state,current_edit_state,0);
      ...
      temp_1 = 
	      copy_tree_using_gensym_conses_1(transform_by_template(ISVREF(production_struct,
	      (SI_Long)3L)));
      if (gensymed_symbol) {
	  temp = Current_edit_state;
    ...
    Current_token_stack = gensym_cons_1(new_parse_object,Current_token_stack);
    i = IFIX(last_constituent_index);
  next_loop_1:
    if (i < (SI_Long)0L)
	goto end_loop_1;
    reclaim_gensym_tree_1(ISVREF(Current_transform_constituent_array,i));
    i = i - (SI_Long)1L;
    goto next_loop_1;
  end_loop_1:;
    Current_state_stack = gensym_cons_1(next_state,Current_state_stack);
    return VALUES_1(Nil);
}
    ...
    Object input_stack;
{
    ...
    Object return_value, top_token, ip, action, temp, gensym_pop_store, cons_1;
    Object next_cons, cdr_new_value, answer_token;
    Declare_special(3);

    x_note_fn_call(79,60);
    current_input_stack = token_reverse(input_stack);
    PUSH_SPECIAL(Current_input_stack,current_input_stack,2);
      current_state_stack = gensym_cons_1(ISVREF(Current_lr_states,
	      (SI_Long)0L),Nil);
      PUSH_SPECIAL(Current_state_stack,current_state_stack,1);
	current_token_stack = Qnil;
	PUSH_SPECIAL(Current_token_stack,current_token_stack,0);
	  return_value = Nil;
	  top_token = Nil;
	  ip = Nil;
	  action = Nil;
	next_loop:
	  ...
	  if (EQ(temp,Qaccept)) {
		  ...
		  next_cons = Nil;
	      Current_token_stack = next_cons;
	      answer_token = gensym_pop_store;
	      return_value = ISVREF(answer_token,(SI_Long)4L);
	      reclaim_parse_object_1(answer_token);
	      reclaim_gensym_list_1(Current_state_stack);
	      reclaim_gensym_list_1(Current_token_stack);
	      reclaim_gensym_list_1(Current_input_stack);
	      temp = return_value;
	      goto end_1;
	  }
...
Object Regexp_preprocessing_parser = UNBOUND;
    ...
    Object source_string, start_position, end_position;
{
	...
	Preprocessor_errors_qm = gensym_cons_1(gensym_list_2(variable_name,
    ...
    Object source_string, start_position, end_position;
{
    ...
    if ( !TRUEP(replacement_for_pattern)) {
	twrite_beginning_of_wide_string(array_constant,FIX((SI_Long)2L));
	Preprocessor_errors_qm = gensym_cons_1(gensym_list_2(class_name,
    ...
    Object source_string, include_variables_p;
{
    ...
    PUSH_SPECIAL(Current_tokenizer,current_tokenizer,8);
      current_start_state = ISVREF(Current_tokenizer,(SI_Long)1L);
      PUSH_SPECIAL(Current_start_state,current_start_state,7);
	current_anchor_p = ISVREF(Current_tokenizer,(SI_Long)3L);
	PUSH_SPECIAL(Current_anchor_p,current_anchor_p,6);
...
Object Number_of_lexing_tables_in_cache = UNBOUND;
...
Object clear_lexing_table_cache()
{
  ...
  next_loop:
    ...
    reclaim_dfa(M_CDR(i));
    reclaim_gensym_cons_1(i);
    goto next_loop;
  end_loop:
    Number_of_lexing_tables_in_cache = FIX((SI_Long)0L);
    reclaim_gensym_list_1(Cache_of_lexing_tables);
    Cache_of_lexing_tables = 
	    gensym_cons_1(Tail_of_lexing_table_cache_marker,Nil);
    return VALUES_1(Nil);
}
    ...
    Object text_string, lexing_table;
{
    ...
    temp = gensym_cons_1(copy_text_string(text_string),lexing_table);
    Cache_of_lexing_tables = gensym_cons_1(temp,Cache_of_lexing_tables);
    ...
    Object search_pattern;
{
	...
	if (INLINE_UNSIGNED_BYTE_16_VECTOR_P(preprocessed_string_or_errors) 
	    ...
	    regexp_parse = Nil;
	if (regexp_parse) {
	    tokenizer_definition = gensym_list_2(Nil,gensym_list_2(Qgoal,
		    regexp_parse));
	    lexing_table_for_regexp = 
		    compile_lexing_table(tokenizer_definition);
	    reclaim_gensym_cons_1(CDADR(tokenizer_definition));
	    reclaim_gensym_cons_1(M_CAR(CDR(tokenizer_definition)));
	    reclaim_gensym_cons_1(CDR(tokenizer_definition));
	    reclaim_gensym_cons_1(tokenizer_definition);
...
Object Regular_expression_parser = UNBOUND;
    ...
    Object string_1;
{
  ...
  next_loop:
	...
	stack = gensym_cons_1(next_token,stack);
    }
    else {
	reclaim_parse_object_1(next_token);
    ...
    Object expression;
{
    ...
    PUSH_SPECIAL(Current_parse_table,current_parse_table,4);
      PUSH_SPECIAL(Current_terminals,current_terminals,3);
	PUSH_SPECIAL(Current_nonterminals,current_nonterminals,2);
	  PUSH_SPECIAL(Current_lr_states,current_lr_states,1);
	    PUSH_SPECIAL(Current_productions,current_productions,0);
	      ...
	      reclaim_gensym_tree_1(stack_of_tokens);
	      temp = result_1;
	    POP_SPECIAL();
	  POP_SPECIAL();
	POP_SPECIAL();
    ...
    Object wide_string;
{
	...
	lookup = gensym_list_2(new_string,parsed_string);
	svref_arg_1 = Cache_of_regular_expressions;
...
void parse2_INIT()
{
    ...
    Object Qparse_table_structure_memory_usage, Qutilities2;
    Object Qparse_table_count, Qchain_of_available_parse_tables;
    Object string_constant_7, Qtype_description_of_type;
    ...
    Object Qset_of_possible_phrases_structure_memory_usage;
    Object Qset_of_possible_phrases_count;
    Object Qchain_of_available_set_of_possible_phrasess, string_constant_5;
    Object string_constant_4, Qpossible_phrase;
    Object Qoutstanding_possible_phrase_count;
    Object Qpossible_phrase_structure_memory_usage, Qpossible_phrase_count;
    Object Qchain_of_available_possible_phrases, string_constant_3;
    Object string_constant_2, Qproduction, Qoutstanding_production_count;
    Object Qproduction_structure_memory_usage, Qproduction_count;
    Object Qchain_of_available_productions, string_constant_1, string_constant;
  ...
  end_loop:;
    ...
    string_constant = STATIC_STRING("43Dy8m83lpy1n83lpy8n8k1l8n0000000kok0k0");
    ...
    string_constant_1 = STATIC_STRING("1q83lpy8s83-jJy09k9l");
    ...
    string_constant_2 = 
	    STATIC_STRING("43Dy8m83ljy1n83ljy8n8k1l8n0000000knk0k0");
    ...
    string_constant_3 = STATIC_STRING("1q83ljy8s83-iLy09k9l");
    clear_optimized_constants();
    ...
    string_constant_4 = 
	    STATIC_STRING("43Dy8m83mry1n83mry8n8k1l8n0000000kok0k0");
    ...
    Qset_of_possible_phrases_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_5 = STATIC_STRING("1q83mry8s83-n6y09k9l");
    clear_optimized_constants();
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8m83lTy1n83lTy8n8k1l8n0000000kpk0k0");
    ...
    string_constant_7 = STATIC_STRING("1q83lTy8s83-hMy09k9l");
    clear_optimized_constants();
