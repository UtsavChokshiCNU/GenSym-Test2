...
Object Ascii_to_kana_map = UNBOUND;

Object Maximum_length_of_ascii_string = UNBOUND;

Object Kana_to_ascii_map = UNBOUND;

Object Maximum_length_of_kana_string = UNBOUND;

Object Available_jis_map_hash_vector_307_vectors = UNBOUND;

Object Count_of_jis_map_hash_vector_307_vectors = UNBOUND;
...
{
    Object count_of_jis_map_hash_vector_307_vectors_new_value, temp;
    XDeclare_area(1);

    x_note_fn_call(122,3);
    count_of_jis_map_hash_vector_307_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_jis_map_hash_vector_307_vectors);
...
Object make_jis_map_hash_vector()
{
    ...
    if (Available_jis_map_hash_vector_307_vectors) {
	temp = M_CAR(Available_jis_map_hash_vector_307_vectors);
	temp_1 = M_CDR(Available_jis_map_hash_vector_307_vectors);
	inline_note_reclaim_cons(Available_jis_map_hash_vector_307_vectors,
		Qab_gensym);
	cdr_arg = Available_jis_map_hash_vector_307_vectors;
	cdr_new_value = Available_gensym_conses;
	M_CDR(cdr_arg) = cdr_new_value;
	Available_gensym_conses = Available_jis_map_hash_vector_307_vectors;
	Available_jis_map_hash_vector_307_vectors = temp_1;
    }
    else
    ...
    Object jis_map_hash_vector_307_vector;
{
    ...
    cdr_new_value = Available_jis_map_hash_vector_307_vectors;
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    Available_jis_map_hash_vector_307_vectors = gensymed_symbol;
    return VALUES_1(Nil);
}

/* RECLAIM-JIS-MAP-TREE-FOR-HASH-LEAVES */
Object reclaim_jis_map_tree_for_hash_leaves(jis_map_tree_for_hash_binary_tree)
    Object jis_map_tree_for_hash_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(jis_map_tree_for_hash_binary_tree))
	goto end_loop;
    less_than_branch_qm = ISVREF(jis_map_tree_for_hash_binary_tree,
	    (SI_Long)1L);
    greater_than_branch_qm = ISVREF(jis_map_tree_for_hash_binary_tree,
	    (SI_Long)2L);
    alist = ISVREF(jis_map_tree_for_hash_binary_tree,(SI_Long)3L);
    reclaim_binary_tree_element_1(jis_map_tree_for_hash_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
  ...
  end_loop_1:;
	...
	reclaim_jis_map_tree_for_hash_leaves(less_than_branch_qm);
	jis_map_tree_for_hash_binary_tree = greater_than_branch_qm;
    }
    else {
	...
	jis_map_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
/* CLEAR-JIS-MAP-TREE */
Object clear_jis_map_tree(jis_map_tree_for_hash_binary_tree)
    Object jis_map_tree_for_hash_binary_tree;
{
    Object element_qm;

    x_note_fn_call(122,7);
    element_qm = CDR(jis_map_tree_for_hash_binary_tree);
    if (element_qm) {
	reclaim_jis_map_tree_for_hash_leaves(element_qm);
	M_CDR(jis_map_tree_for_hash_binary_tree) = Nil;
    }
    return VALUES_1(jis_map_tree_for_hash_binary_tree);
}
...
Object reclaim_jis_map(jis_map_hash_table)
    Object jis_map_hash_table;
{
    Object jis_map_tree_for_hash_binary_tree, element_qm, cdr_new_value, temp;
    SI_Long index_1;

    x_note_fn_call(122,11);
    index_1 = (SI_Long)0L;
  next_loop:
    if (index_1 >= (SI_Long)307L)
	goto end_loop;
    jis_map_tree_for_hash_binary_tree = ISVREF(jis_map_hash_table,index_1);
    element_qm = M_CDR(jis_map_tree_for_hash_binary_tree);
    if (element_qm)
	reclaim_jis_map_tree_for_hash_leaves(element_qm);
    inline_note_reclaim_cons(jis_map_tree_for_hash_binary_tree,Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(jis_map_tree_for_hash_binary_tree) = cdr_new_value;
    Available_gensym_conses = jis_map_tree_for_hash_binary_tree;
    ISVREF(jis_map_hash_table,index_1) = Nil;
    index_1 = index_1 + (SI_Long)1L;
    goto next_loop;
  end_loop:;
    temp = reclaim_jis_map_hash_vector(jis_map_hash_table);
    return VALUES_1(temp);
}
...
Object initialize_ascii_kana_converters_if_neccessary()
{
	...
	if (STRINGP(kana_string_or_translation_marker)) {
	    ...
	    set_balanced_binary_tree_entry(SVREF(new_kana_to_ascii_map,
		    FIX(temp)),Qstring_eq,Nil,T,
		    kana_string_or_translation_marker,FIX(gensymed_symbol),
		    ascii_string);
	}
	gensymed_symbol = IFIX(sxhashw(ascii_string));
	temp = gensymed_symbol % (SI_Long)307L;
	set_balanced_binary_tree_entry(SVREF(new_ascii_to_kana_map,
		FIX(temp)),Qstring_eq,Nil,T,ascii_string,
    ...
    Object maximum_length_of_substring_to_consider;
{
    ...
    Object end_index_for_substring, gensymed_symbol_1, gensymed_symbol_2;
    Object gensymed_symbol_4;
    SI_Long length_of_substring, gensymed_symbol, temp_1, gensymed_symbol_3;

    x_note_fn_call(122,13);
  ...
  next_loop:
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_2:
	    ...
	    if (string_eq(2,gensymed_symbol_2,gensymed_symbol_4)) {
		mapped_string_qm = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_1;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_2;
	  end_loop_2:
	    mapped_string_qm = Qnil;
	  end_1:;
	    goto end_2;
	}
	goto next_loop_1;
...
Object Last_roman_kana_g2_length = UNBOUND;
...
Object Last_roman_kata_g2_length = UNBOUND;
...
Object Kfep_converters_have_been_initialized_qm = UNBOUND;
...
Object Current_kb_serial_number = UNBOUND;
...
static Object Qspecified_kfep_index_filename_qm;  /* specified-kfep-index-filename? */
...
static Object Qspecified_kfep_main_filename_qm;  /* specified-kfep-main-filename? */
...
static Object Qspecified_kfep_kojin_filename_qm;  /* specified-kfep-kojin-filename? */
...
void kfep2_INIT()
{
    ...
    Object Qkfep2, Qkfep_converters_have_been_initialized_qm;
    Object Qlast_roman_kata_g2_length, Qlast_roman_kana_g2_length;
    ...
    Object Qutilities2, Qcount_of_jis_map_hash_vector_307_vectors;
    Object Qavailable_jis_map_hash_vector_307_vectors;
    Object Qmaximum_length_of_kana_string, Qkana_to_ascii_map, Qkfep3;
    Object Qmaximum_length_of_ascii_string, Qascii_to_kana_map;
    ...
    Object string_constant_7, string_constant_6, Qascii_and_kana_suffix_pairs;
    Object list_constant;

    x_note_fn_call(122,25);
    SET_PACKAGE("AB");
    ...
    Qjis_map_hash_vector_307_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_47 = STATIC_STRING("1q83-aky83*By83-Ovy09k9l");
