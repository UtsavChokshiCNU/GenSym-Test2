...
Object G2gl_parameters = UNBOUND;
...
Object Module_information = UNBOUND;
    ...
    Object workspace, entity;
{
    ...
    Object svref_new_value, frame, sub_vector_qm, function_qm, temp_1;
	...
	svref_new_value = gensym_cons_1(workspace,ISVREF(entity,(SI_Long)18L));
	SVREF(entity,FIX((SI_Long)18L)) = svref_new_value;
...
Object Inhibit_updating_module_related_frame_notes_for_all_workspaces_qm = UNBOUND;
...
Object Subworkspace_currently_being_deleted_qm = UNBOUND;
    ...
    Object subworkspaces, entity;
{
  ...
  next_loop:
	...
	PUSH_SPECIAL(Subworkspace_currently_being_deleted_qm,subworkspace_currently_being_deleted_qm,
		0);
  ...
  end_loop:
    ...
    reclaim_gensym_list_1(subworkspaces);
    return VALUES_1(Nil);
}
    ...
    Object entity, use_managed_floats_p;
{
    ...
    Object new_float, height_of_icon_after_magnification, rotated_by_90_p_1;
    SI_Long gensymed_symbol;
    double aref_new_value;

    x_note_fn_call(91,22);
    icon_description_qm = ISVREF(entity,(SI_Long)16L);
    if (icon_description_qm) {
	icon_attributes_plist = ISVREF(entity,(SI_Long)17L);
...
Object System_version_from_kb_being_read = UNBOUND;
    ...
    Object entity;
{
	...
	if (temp_2) {
	  ...
	  next_loop_1:
	    ...
	    if (pair_qm) {
		ab_loopvar__2 = 
			gensym_cons_1(copy_tree_using_gensym_conses_1(pair_qm),
			Nil);
		if (ab_loopvar__1)
	...
	if (temp_2 ? 
	  ...
	  end_3:;
		...
		if (temp);
		    ...
		    temp = default_color;
		ab_loopvar__1 = gensym_cons_1(gensym_cons_1(temp_1,temp),Nil);
		if (ab_loopvar_)
	...
	if (multichrome_icon_p(entity) && icon_attributes_plist && 
		...
		new_color =  !EQ(line_color,region) && EQ(line_color,
			...
			line_color : color;
		ab_loopvar__2 = gensym_cons_1(gensym_cons_1(region,
			new_color),Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
    ...
    Object icon_description, width, height, rotated_p;
{
  ...
  next_loop:
	...
	change_icon_attribute(iconic_entity,Qreflection_and_rotation,
		orientation);
    ab_loopvar__2 = gensym_list_2(orientation,iconic_entity);
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
...
{
    x_note_fn_call(91,37);
    return reclaim_gensym_list_1(plist_of_rubber_stamp_widgets);
}

Object Resize_box_rubber_stamp_widget = UNBOUND;
    ...
    Object na_icon_description_qm, width, height;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_list_2(situation,iconic_entity);
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
...
Object Left_scroll_arrow_rubber_stamp_widget = UNBOUND;

Object Top_scroll_arrow_rubber_stamp_widget = UNBOUND;

Object Right_scroll_arrow_rubber_stamp_widget = UNBOUND;

Object Bottom_scroll_arrow_rubber_stamp_widget = UNBOUND;

Object Scroll_bar_elevator_rubber_stamp_widget = UNBOUND;

Object Right_marker_for_cascading_menu_rubber_stamp_widget = UNBOUND;

Object Left_marker_for_cascading_menu_rubber_stamp_widget = UNBOUND;
    ...
    Object right_edge_in_workspace, bottom_edge_in_workspace;
{
    ...
    PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,3);
      ...
      PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,2);
	...
	PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,1);
	  ...
	  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,0);
    ...
    Object bottom_edge, region_to_change, old_color, new_color;
{
    ...
    Object ab_loopvar__2, ab_loop_desetq_, new_cons, gensymed_symbol, temp;
    Object current_drawing_transfer_mode, last_1, next_qm;
    Declare_special(1);

    x_note_fn_call(91,41);
  ...
  end_loop:
	...
	end_loop_1:
	  ...
	  temp = Available_gensym_conses;
	  M_CDR(last_1) = temp;
	  Available_gensym_conses = current_color_list;
      }
      if (new_color_list) {
	...
	end_loop_2:
	  ...
	  temp = Available_gensym_conses;
	  M_CDR(last_1) = temp;
	  Available_gensym_conses = new_color_list;
      }
    POP_SPECIAL();
    return VALUES_1(Qnil);
}
    ...
    Object background_color_value_or_values;
{
	...
	next_loop_1:
	  if ( !TRUEP(p))
	      goto end_loop_1;
	  ab_loopvar__2 = gensym_cons_1(FIX(color_meaning_transparent),Nil);
	  if (ab_loopvar__1)
	      M_CDR(ab_loopvar__1) = ab_loopvar__2;
	  else
	      ab_loopvar_ = ab_loopvar__2;
	...
	next_loop_2:
	  ...
	  goto next_loop_2;
	end_loop_2:
	  reclaim_gensym_list_1(working_color_difference_list);
      }
    ...
    Object block_is_currently_being_dragged_p;
{
	...
	PUSH_SPECIAL(Y_in_window_of_graphic_element,y_in_window_of_graphic_element,
		7);
	  PUSH_SPECIAL(X_in_window_of_graphic_element,x_in_window_of_graphic_element,
		  6);
	    PUSH_SPECIAL(Background_color_value_of_graphic_element,background_color_value_of_graphic_element,
		    5);
	      PUSH_SPECIAL(Foreground_color_value_of_graphic_element,foreground_color_value_of_graphic_element,
		      4);
		PUSH_SPECIAL(Quality_of_graphic_element,quality_of_graphic_element,
			3);
		  PUSH_SPECIAL(Rotation_of_graphic_element,rotation_of_graphic_element,
			  2);
		    PUSH_SPECIAL(Y_scale_of_graphic_element,y_scale_of_graphic_element,
			    1);
		      PUSH_SPECIAL(X_scale_of_graphic_element,x_scale_of_graphic_element,
			      0);
    ...
    Object block_right, block_bottom, block_is_currently_being_dragged_p;
{
    ...
    Object ab_loopvar__1, ab_loopvar__2, ab_loop_desetq_, new_cons;
    Object gensymed_symbol, car_new_value, right, bottom, bleeding_hack;
    Object image_plane, left_edge_of_workspace_area_within_pane;
    ...
    Object right_or_bottom_extension_for_bleeding_1, temp_2, scale, value;
    Object temp_3, temp_4, temp_5, right_in_window, bottom_in_window;
	...
	if ( !EQ(Current_drawing_transfer_mode,Kpaint_infered_from_xor)) {
	    ...
	    car_new_value = FIXNUM_LOGXOR(color_value_1,color_value_2);
	}
	else if (EQ(real_color,Qbackground))
	    car_new_value = EQ(Current_drawing_transfer_mode,
		    Kpaint_infered_from_xor) ? Transparent_color_value : 
		    FIX((SI_Long)0L);
	else if (EQ(real_color,Qtransparent))
	    car_new_value = EQ(Current_drawing_transfer_mode,
		...
		color_value_1 = map_to_color_value(real_color);
	    car_new_value = FIXNUM_LOGXOR(color_value_1,
		    Current_background_color_value);
	}
	else {
	    if (EQ(real_color,Qbackground))
	...
	height_star = gensymed_symbol_1 + gensymed_symbol_2 + 
		gensymed_symbol_3;
	temp_3 = FIX(MAX(left_star,
		IFIX(left_edge_of_workspace_area_within_pane)));
	temp_4 = FIX(MAX(top_star,
	...
	temp_5 = FIX(MIN(gensymed_symbol_1,gensymed_symbol_2));
	...
	result = VALUES_4(temp_3,temp_4,temp_5,temp);
	...
	PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
	  ...
	  if (color_qm) {
		  ...
		  if (EQ(Qbackground,Qbackground))
		      ...
		      color_value_2 = map_to_color_value(Qbackground);
		  temp_4 = FIXNUM_LOGXOR(color_value_1,color_value_2);
	      }
	      else if (EQ(color_qm,Qbackground))
		  temp_4 = EQ(Current_drawing_transfer_mode,
			  Kpaint_infered_from_xor) ? 
		  ...
		  if (EQ(color_qm,Qbackground))
		      ...
		      color_value_1 = map_to_color_value(color_qm);
		  temp_4 = FIXNUM_LOGXOR(color_value_1,
			  Current_background_color_value);
	      }
	      else {
		  if (EQ(color_qm,Qbackground))
    ...
    Object entity, changed_regions;
{
    ...
    Object ab_loop_desetq_, temp, gensymed_symbol, last_1, next_qm;
    Object cdr_new_value;

    x_note_fn_call(91,47);
    icon_description_qm = ISVREF(entity,(SI_Long)16L);
    if (icon_description_qm) {
	icon_attributes_plist = ISVREF(entity,(SI_Long)17L);
    ...
    Object new_foreground_color_or_colors, new_line_color_qm;
{
    ...
    Object old_color_values, ab_loopvar__2, new_cons, gensymed_symbol, temp;
    Object last_1, next_qm, cdr_new_value;
    Declare_special(1);
    Object result;

    x_note_fn_call(91,49);
    icon_description_qm = ISVREF(entity,(SI_Long)16L);
    if (icon_description_qm) {
	icon_attributes_plist = ISVREF(entity,(SI_Long)17L);
	...
	PUSH_SPECIAL(Current_foreground_color_value,current_foreground_color_value,
	  ...
	  if (CONSP(old_foreground_color_or_colors)) {
		...
		end_loop_2:
		  ...
		  cdr_new_value = Available_gensym_conses;
		  M_CDR(last_1) = cdr_new_value;
		  Available_gensym_conses = old_color_value_or_values;
		  result = VALUES_1(Nil);
	      }
	      else
		  result = VALUES_1(Nil);
...
Object Default_entity_line_drawing_description_template = UNBOUND;
...
Object create_default_entity_icon_description(icon_width,icon_height)
    Object icon_width, icon_height;
{
    x_note_fn_call(91,53);
    return create_icon_description(3,icon_width,icon_height,
	    gensym_cons_1(nsubst(3,icon_width,Kwidth,nsubst(3,icon_height,
	    Kheight,
	    copy_tree_using_gensym_conses_1(Default_entity_line_drawing_description_template))),
	    Nil));
}
	...
	if (workspace_qm) {
		...
		if (temp)
			...
			if (temp_1) {
				...
				region = 
					make_region_from_rectangle(FIXNUM_SUB1(extreme_left_edge),
					FIXNUM_SUB1(extreme_top_edge),
					FIXNUM_ADD1(extreme_right_edge),
					FIX((SI_Long)5L + 
    ...
    Object new_line_color_qm;
{
	...
	if (color_pattern_is_default_qm) {
	    reclaim_gensym_tree_1(new_color_pattern);
...
Object Executing_change_item_color_instruction_p = UNBOUND;
    ...
    Object entity, note_as_kb_state_change_qm, color_change_pattern;
{
    ...
    Object current_color_list, new_color_list, new_cons, last_1, next_qm;
    Object cdr_new_value, changing_colors_of_graphic_elements_qm;
    ...
    x_note_fn_call(91,113);
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,2);
      if (ISVREF(entity,(SI_Long)16L)) {
	  current_color_pattern = current_color_pattern_of_entity(entity);
	  new_color_pattern = 
		  copy_tree_using_gensym_conses_1(current_color_pattern);
...
Object get_connection_color_pattern varargs_1(int, n)
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(color_or_region,color),
		Nil);
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
...
Object get_text_box_color_pattern varargs_1(int, n)
{
    ...
    Object override_pattern, symbol, property_name, gensymed_symbol;
    ...
    Object override_pattern;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_cons_1(color_or_region,
		color_qm),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
...
void entities_INIT()
{
    ...
    Object Qleft_marker_for_cascading_menu_rubber_stamp_widget;
    ...
    Object Qright_marker_for_cascading_menu_rubber_stamp_widget;
    Object list_constant_177, list_constant_176, list_constant_175;
    Object list_constant_174, list_constant_173, list_constant_172;
    Object Qscroll_bar_elevator_rubber_stamp_widget, list_constant_171;
    Object list_constant_170, Qborder, list_constant_169, Qdark_color;
    Object list_constant_168, Qlight_color, list_constant_167, Qface_color;
    Object list_constant_166, list_constant_165, list_constant_117;
    Object list_constant_164, list_constant_163, list_constant_162;
    Object list_constant_159, list_constant_161, list_constant_118;
    Object list_constant_160, list_constant_112, list_constant_158;
    Object list_constant_16, Qsolid_rectangle, list_constant_109;
    Object list_constant_106, list_constant_108, list_constant_107;
    Object list_constant_157, Qbottom_scroll_arrow_rubber_stamp_widget;
    Object list_constant_141, list_constant_156, list_constant_155;
    Object Qarrow_color, list_constant_131, list_constant_130;
    Object list_constant_129, list_constant_128, list_constant_127;
    Object list_constant_154, list_constant_153, list_constant_152;
    Object list_constant_151, list_constant_15, list_constant_150;
    Object list_constant_149, Qright_scroll_arrow_rubber_stamp_widget;
    Object list_constant_148, list_constant_147, list_constant_146;
    Object list_constant_145, list_constant_144, list_constant_143;
    Object list_constant_20, list_constant_142;
    Object Qtop_scroll_arrow_rubber_stamp_widget, list_constant_140;
    Object list_constant_139, list_constant_138, list_constant_137;
    Object list_constant_136, list_constant_135, list_constant_134;
    Object Qleft_scroll_arrow_rubber_stamp_widget, list_constant_133;
    Object list_constant_132, list_constant_126, list_constant_125;
    Object list_constant_124, list_constant_123, list_constant_122;
    Object list_constant_121, list_constant_120, list_constant_119;
    Object list_constant_116, list_constant_114, list_constant_115;
    Object list_constant_113, list_constant_111, list_constant_110;
    Object Qlight_gray, Qdark_gray, list_constant_105;
    Object Qclose_box_rubber_stamp_widget, list_constant_53, list_constant_104;
    Object list_constant_103, Qmake_title_bar_widget_icon_description;
    Object list_constant_102, list_constant_101, list_constant_82, Qsmoke;
    Object list_constant_81, list_constant_80, list_constant_79;
    Object list_constant_78, list_constant_77, list_constant_100;
    Object list_constant_99, list_constant_98, list_constant_94;
    Object list_constant_97, list_constant_96, list_constant_95;
    Object list_constant_85, list_constant_86, list_constant_93;
    Object list_constant_92, list_constant_91, list_constant_87;
    Object list_constant_90, list_constant_89, list_constant_88;
    Object list_constant_84, list_constant_83, list_constant_76;
    Object list_constant_75, list_constant_74, list_constant_70;
    Object list_constant_73, list_constant_72, list_constant_71;
    Object list_constant_62, list_constant_60, list_constant_61;
    Object list_constant_69, list_constant_68, list_constant_67;
    Object list_constant_63, list_constant_66, list_constant_65;
    Object list_constant_64, list_constant_58, list_constant_57;
    Object list_constant_54, list_constant_56, list_constant_55;
    Object list_constant_46, list_constant_18, list_constant_17;
    Object list_constant_45, list_constant_19, list_constant_52;
    Object list_constant_51, list_constant_47, list_constant_50;
    Object list_constant_49, list_constant_40, list_constant_48;
    Object list_constant_43, list_constant_42, list_constant_41;
    Object list_constant_37, list_constant_39, list_constant_38;
    Object list_constant_35, Qbackground_layer, Qvariables, list_constant_33;
    Object list_constant_32, list_constant_31, list_constant_30;
    Object list_constant_29, Qresize_box_rubber_stamp_widget, list_constant_28;
    Object list_constant_27, list_constant_26, list_constant_22;
    Object list_constant_25, list_constant_24, list_constant_23;
    Object list_constant_14, Qinitialize_after_reading;
    ...
    string_constant_22 = 
	    STATIC_STRING("1t4z8r8u8u83-+y83-+y00001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83Riy83Riy83-+y83-+y00001o1l8l1l8");
    string_constant_23 = 
    ...
    string_constant_24 = 
	    STATIC_STRING("000004z8r83FGy83FGy83-+y83-+y00001s1l83Ey1l8l1l830Yy1l83Hy1l8z1l83Fy1l83-4y1l83Ny000004z8r83bAy83bAy83-+y83-+y00001n1l8l1l8o1l83");
    string_constant_25 = 
	    STATIC_STRING("Cy000004z8r83Zgy83Zgy83-+y83-+y00001m1l8l1l8o000004z8r83L5y83L5y83-+y83-+y00001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83L4y83L4y83-+y83");
    string_constant_26 = 
	    STATIC_STRING("-+y00001o1l83Ey1l8l1l83Ny1l83Hy000004z8r83L3y83L3y83-+y83-+y00001o1l83Ey1l8l1l83Ny1l83Hy00000");
    string_constant_27 = 
    ...
    string_constant_41 = 
	    STATIC_STRING("finition1q83Riy08l8o83Cy1m83Dy53QyExport as Icon-attributes part1u83Amy083Ey8l830Yy83Hy8z83Fy83-4y83Ny1u83FGy083Ey8l830Yy83Hy8z8");
    string_constant_42 = 
	    STATIC_STRING("3Fy83-4y83Ny1p83bAy08l8o83Cy1o83Zgy08l8o1q83L5y01l83Ey1l8l1l83Ny1l83Hy1q83L4y01l83Ey1l8l1l83Ny1l83Hy1q83L3y01l83Ey1l8l1l83Ny1l83");
    ...
    string_constant_45 = STATIC_STRING("1m8q1m83-==y1l83-+y");
    ...
    string_constant_46 = 
	    STATIC_STRING("1q1m83g3y1m9k9l1m83g3y1m9k83-Duy1m83g3y1m9k83Avy1m83g3y1m9k83wby1m83g3y1m9k83HHy1m83g3y1m9k83bmy");
    clear_optimized_constants();
    ...
    string_constant_47 = 
	    STATIC_STRING("1u1m83--by1m9k83-Y*y1m83--by1m9k83-Y=y1m83--by1m9k9l1m83--by1m9k83-Y-y1m83--by1m9k83-Xwy1m83--by1m9k9m1m83--by1m9k9n1m83--by1m9k");
    string_constant_48 = STATIC_STRING("9o1m83--by1m9k9p1m83--by1m9k83bgy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
