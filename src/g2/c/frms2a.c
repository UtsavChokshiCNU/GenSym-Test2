...
Object Frame_vector_pool_vector = UNBOUND;

Object Frame_vector_pool_counts_vector = UNBOUND;

Object Frame_vector_count = UNBOUND;

Object Outstanding_frame_vector_count = UNBOUND;

Object Frame_vector_memory_used = UNBOUND;
...
Object create_frame_vector_and_replenish_pool(size)
    Object size;
{
    Object temp, incff_1_arg, temp_1, new_cons, gensymed_symbol, size_list;
    Object vector_index, svref_new_value, last_created_vector, vector_holder;
    ...
    incff_1_arg = FIXNUM_TIMES(temp,bytes_per_simple_vector(size));
    temp_1 = FIXNUM_ADD(Frame_vector_memory_used,incff_1_arg);
    Frame_vector_memory_used = temp_1;
    incff_1_arg = Frame_vectors_to_make_at_a_time;
    temp_1 = FIXNUM_ADD(Frame_vector_count,incff_1_arg);
    Frame_vector_count = temp_1;
    ...
    incff_1_arg = Frame_vectors_to_make_at_a_time;
    svref_new_value = FIXNUM_ADD(ISVREF(temp_1,IFIX(vector_index)),
	    incff_1_arg);
    SVREF(temp_1,vector_index) = svref_new_value;
	...
	inline_note_reclaim_cons(size_list,Qab_gensym);
	temp_1 = Available_gensym_conses;
	M_CDR(size_list) = temp_1;
	Available_gensym_conses = size_list;
...
Object Do_not_initialize_specializations = UNBOUND;

Object Uuid_for_next_frame_qm = UNBOUND;

Object Class_description_for_next_frame_qm = UNBOUND;

Object Tracking_items_p = UNBOUND;

Object Reading_kb_p = UNBOUND;

Object Called_within_clear_text_loading = UNBOUND;
    ...
    Object eval_slot_init_forms_p, class_known_to_be_system_item_p;
{
    ...
    Object gensymed_symbol_4, temp, gensymed_symbol_5, svref_new_value, frame;
    Object lookup_structure, slot_description, ab_loop_list_;
    Object vector_slot_index_qm, temp_1, next_qm, previous_qm;
    Object last_instance_qm;
	...
	temp = FIXNUM_ADD1(Outstanding_frame_vector_count);
	Outstanding_frame_vector_count = temp;
...
Object Frame_being_made = UNBOUND;
    ...
    Object frame;
{
    ...
    PUSH_SPECIAL(Noting_changes_to_kb_p,noting_changes_to_kb_p,2);
	...
	PUSH_SPECIAL(Frame_being_made,frame_being_made,0);
...
Object Queue_of_classes_to_be_undefined = UNBOUND;

Object Within_delete_frame_scope_qm = UNBOUND;
...
{
    Object reclaimed_slot_init_forms, slot_init_form, class_1;
    Object slot_description, ab_loop_list_, ab_loop_desetq_, temp, car_1;
    Object cdr_1, slot_value;
    char temp_1;

    x_note_fn_call(84,18);
    reclaimed_slot_init_forms = Nil;
    slot_init_form = Nil;
    class_1 = Nil;
    slot_description = Nil;
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    slot_init_form = ISVREF(slot_description,(SI_Long)6L);
    if ( !TRUEP(memq_function(slot_init_form,reclaimed_slot_init_forms))) {
	reclaimed_slot_init_forms = gensym_cons_1(slot_init_form,
		reclaimed_slot_init_forms);
    ...
    goto next_loop;
  end_loop:
    if (reclaimed_slot_init_forms)
	reclaim_gensym_list_1(reclaimed_slot_init_forms);
    return VALUES_1(Qnil);
}
    ...
    Object class_description;
{
    ...
    Object owner_class, class_description_pop_store, cons_1, next_cons;
    Object cdr_new_value, scope_conses, ab_loopvar_, subclass;
    Object subclass_class_description_qm, subclass_slot_description_qm, temp;
    Object reclaim_argument;
    Declare_special(1);

    x_note_fn_call(84,19);
  ...
  next_loop:
	...
	Available_class_description_conses = cons_1;
    }
    else
	next_cons = Nil;
	...
	end_loop_1:;
	POP_SPECIAL();
	reclaim_argument = gensym_cons_1(gensym_cons_1(class_1,
		slot_description),Nil);
	reclaim_list_of_slot_descriptions(reclaim_argument);
	reclaim_gensym_tree_1(reclaim_argument);
    }
    goto next_loop;
  end_loop:;
    temp = slot_descriptions_function(class_description,Nil);
    return VALUES_1(temp);
}
    ...
    Object class_1, class_description, old_class_description_qm;
{
	...
	if ( !TRUEP(old_class_description_qm)) {
	    Class_bit_numbers_pool = 
		    gensym_cons_1(ISVREF(class_description,(SI_Long)18L),
		    Class_bit_numbers_pool);
    ...
    Object class_list;
{
    ...
    reclaim_gensym_list_1(sorted_class_list);
    if (Releasing_kb_qm)
	return reclaim_gensym_list_1(class_list);
    else
	return VALUES_1(Nil);
}
    ...
    Object class_list;
{
  ...
  next_loop_1:
    ...
    class_description = 
	    lookup_global_or_kb_specific_property_value(class_1,
	    Class_description_gkbprop);
    Class_bit_numbers_pool = gensym_cons_1(ISVREF(class_description,
...
Object Frame_being_read_qm = UNBOUND;

Object Tracked_items_call_vector_table = UNBOUND;

Object Profiling_structure = UNBOUND;

static Object Qframe_being_read_qm;  /* frame-being-read? */
    ...
    Object frame;
{
    ...
    Object already_within_delete_frame_qm, gensymed_symbol_3;
    ...
    Object slot_value_reclaimer_qm, lookup_structure, old, temp_3, next_qm;
    Object previous_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, svref_new_value;
    SI_Long method_index, max_i, i, ab_loop_bind_, new_1;
    char temp;
    Declare_special(1);

    x_note_fn_call(84,25);
	...
	if ( !TRUEP(already_within_delete_frame_qm)) {
		...
		reclaim_gensym_list_1(Queue_of_classes_to_be_undefined);
		Queue_of_classes_to_be_undefined = Nil;
	    }
	}
	...
	if (temp ?  
	    ...
	    Queue_of_classes_to_be_undefined = 
		    ...
		    gensym_cons_1(class_name_of_user_class_definition_frame_qm,
		    Nil));
	...
	if (frame_is_system_item_qm) {
	    ...
	    temp_3 = FIXNUM_SUB1(Outstanding_frame_vector_count);
	    Outstanding_frame_vector_count = temp_3;
    ...
    Object class_1;
{
  ...
  end_loop_1:
    ...
    reclaim_gensym_list_1(instance_list);
    return VALUES_1(Qnil);
}
	...
	next_loop_1:
	  ...
	  if (temp_1) {
	      ...
	      set_non_savable_lookup_slot_value(slot_value,
		      ...
		      gensym_cons_1(new_attribute_name,user_class) : 
		      new_attribute_name);
    ...
    Object user_class, attribute_name;
{
    ...
    Object current_parent_attribute_name, cdr_new_value;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
    Declare_special(1);
    Object result;

    x_note_fn_call(84,32);
    scope_conses = Scope_conses;
    ab_loopvar_ = Nil;
    ab_loopvar_ = user_class;
    subclass = Nil;
    ...
    next_loop:
      ...
      gensymed_symbol_1 = subclass;
      gensymed_symbol_2 = SXHASH_SYMBOL_1(subclass) & 
	      IFIX(Most_positive_fixnum);
      gensymed_symbol_3 = (SI_Long)0L;
    next_loop_1:
      if ( !TRUEP(gensymed_symbol))
	...
	next_loop_9:
	  ...
	  if (temp_2) {
	      ...
	      temp_2 = FIXNUM_LT(temp,position(2,
	  ...
	  if (temp_2) {
	      ...
	      cdr_new_value = ISVREF(existing_slot_description_qm,(SI_Long)3L);
    ...
    Object user_class, attribute_name;
{
    ...
    Object temp, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, ab_loopvar__1, instance, slot_value, x2;
...
{
    Object x2, gensymed_symbol, sub_class_bit_vector, new_cons;
    Object gensymed_symbol_4, temp_1;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(84,34);
	...
	if (temp_1) {
		...
		if (SYMBOLP(possible_type_name)) {
		  ...
		  next_loop:
			...
			gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
			if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
			    defined_evaluation_value_type_qm = 
			...
			goto next_loop_1;
		      end_loop_1:
			defined_evaluation_value_type_qm = Qnil;
		      end_1:;
			goto end_2;
		    }
		    goto next_loop;
...
void frames2a_INIT()
{
    ...
    Object Qwithin_delete_frame_scope_qm, Qqueue_of_classes_to_be_undefined;
    ...
    Object Qframe_being_made, string_constant_16, Qframe_vector_memory_usage;
    Object Qframe_vector_memory_used, Qoutstanding_frame_vector_count;
    Object Qframe_vector_count, list_constant_2;
    Object Qframe_vector_pool_counts_vector, Qcreate_frame_vector_pool_vector;
    Object list_constant_1, Qframe_vector_pool_vector;
    ...
    SET_SYMBOL_FUNCTION(Qframe_serial_number_recycled_function,
	    ...
	    FALSE,0,0));
    string_constant_1 = 
	    STATIC_STRING("1v4z8r83AQy83AQy833ay833ay00001p1m8p83AQy1l8o1l8l1l83Cy1l83Uy000004z8r83MGy83MGy833ay833ay01m83*9y9k001n1l8o1l8l1m83Dy5sInternal");
    string_constant_2 = 
    ...
    string_constant_4 = 
	    STATIC_STRING(". This\ncomment should show up on options, despite it being placed on frame-flags.000004z8r83MEy83MEy833ay833ay0k001m1l8l1l8o0000");
    string_constant_5 = 
	    STATIC_STRING("04z8r83I+y83I+y833ay833ay00001n1l8o1l8l1m83Dy5sInternal000004z8r83I-y83I-y833ay833ay00001n1l8o1l8l1m83Dy5sInternal000004z8r83Xcy");
    string_constant_6 = 
	    STATIC_STRING("83Xcy833ay833ay00001m1l8l1m83Dy53-fyBackpointer to frame which holds this item. ~\n Depending on the type of frame this may be of");
    string_constant_7 = 
    ...
    string_constant_8 = 
	    STATIC_STRING("this item.000004z8r83X8y83X8y833ay833ay00001n1l8l1l83Ey1l83Hy000004z8r83Gsy83Gsy833ay833ay00001n1l8l1l83Ey1l83Hy000004z8r83Sxy83");
    string_constant_9 = 
	    STATIC_STRING("Sxy833ay833ay00001n1l8l1l83Ey1l83Hy00000");
    string_constant_10 = 
	    STATIC_STRING("1x8q1n833ay1l83Epy8t1r83AQy01m8p83AQy8o8l83Cy83Uy1p83MGy1m83*9y9k8o8l1m83Dy5sInternal1s83-Eyk8l8o1m8p083Hy83*8y1m83Dy5305yCurren");
    string_constant_11 = 
    ...
    string_constant_13 = 
	    STATIC_STRING("gs.1o83MEyk8l8o1p83I+y08o8l1m83Dy5sInternal1p83I-y08o8l1m83Dy5sInternal1o83Xcy08l1m83Dy53-fyBackpointer to frame which holds thi");
    string_constant_14 = 
    ...
    string_constant_15 = 
	    STATIC_STRING("\n parent-frame which holds this item.1p83X8y08l83Ey83Hy1p83Gsy08l83Ey83Hy1p83Sxy08l83Ey83Hy");
    ...
    Qframe_vector_pool_vector = STATIC_SYMBOL("FRAME-VECTOR-POOL-VECTOR",
	    AB_package);
    SET_SYMBOL_VALUE_LOCATION(Qframe_vector_pool_vector,
	    Frame_vector_pool_vector);
    ...
    list_constant_1 = STATIC_LIST((SI_Long)3L,Kfuncall,
	    Qcreate_frame_vector_pool_vector,Qnil);
    record_system_variable(Qframe_vector_pool_vector,Qframes2a,
    ...
    string_constant_16 = STATIC_STRING("1q83-Ujy83*By83-Uiy83-h5y09k");
    clear_optimized_constants();
    ...
    string_constant_24 = 
	    STATIC_STRING("1m8q1r83-Ffy1l83Ry1m8v83Ry8t83-8y83Ly83Iy");
