...
static Object Qcurrent_workstation;  /* current-workstation */
...
Object system_state_change_from_scheduler(action)
    Object action;
{
    Object temp, old_structure_being_reclaimed, temp_1;
	...
	SVREF(new_task,FIX((SI_Long)11L)) = action;
	...
	SVREF(def_structure_queue_element_variable,FIX((SI_Long)0L)) = temp_1;
...
{
    Object expiration_qm, temp_1, gensymed_symbol, gensymed_symbol_1;
	...
	if (EQ(class_1,Qkb_workspace))
	  ...
	  end_2:;
		...
		gensymed_symbol = set_balanced_binary_tree_entry(temp_2,
	  ...
	  end_18:;
		...
		gensymed_symbol = set_balanced_binary_tree_entry(temp_4,
			Qeq,Nil,T,gensymed_symbol,temp_3,gensymed_symbol_1);
	    }
	    global_properties = gensymed_symbol;
	    gensymed_symbol = CDR(global_properties);
	    gensymed_symbol_1 = 
    ...
    Object mouse_pointer;
{
	...
	if (temp) {
	    ...
	    return make_partial_command(Qnew_workspace,
		    gensym_list_2(temp_1,snapshot_command_argument(temp_2)));
	}
	else
	    return VALUES_1(Nil);
    }
...
Object get_workspace_command_translator(mouse_pointer)
    Object mouse_pointer;
{
    x_note_fn_call(226,20);
    if (named_workspaces_exist_p())
	return make_partial_command(Qget_workspace,
		gensym_cons_1(snapshot_command_argument(Plus_missing_argument_plus),
		Nil));
    else
	return VALUES_1(Nil);
}
    ...
    Object pathname_1;
{
    ...
    x_note_fn_call(226,29);
    if (recent_loaded_kb_tester_function(pathname_1)) {
	default_kb_pathname_qm = pathname_1;
	PUSH_SPECIAL(Default_kb_pathname_qm,default_kb_pathname_qm,0);
    ...
    Object mouse_pointer;
{
	...
	if (T) {
	    ...
	    return make_partial_command(Qprinter_setup,
		    gensym_cons_1(snapshot_command_argument(temp),Nil));
	}
	else
	    return VALUES_1(Nil);
    }
    ...
    Object module;
{
	...
	if (system_table_suite_qm) {
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    temp_1 = gensym_list_2(module,Nil);
...
Object com_close_telewindows_connection()
{
	...
	return confirm_or_cancel(3,temp,
		...
		gensym_cons_1(Current_workstation_window,Nil));
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object g2_window_as_evaluation_value;
{
	...
	temp_1 = gensym_cons_1(value_2,Qtruth_value);
			...
			PUSH_SPECIAL(Current_workstation_detail_pane,current_workstation_detail_pane,
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
				...
				block_or_blocks = ATOM(item_or_items) ? 
					item_or_items : 
					copy_list_using_gensym_conses_1(item_or_items);
				if (image_plane_if_move_case_qm)
				    result = enter_move_dragging_context(4,
					    block_or_blocks,
					    FIX((SI_Long)0L),
					    FIX((SI_Long)0L),
					    image_plane_if_move_case_qm);
				else
				    result = enter_transfer_dragging_context(1,
					    block_or_blocks);
			      POP_SPECIAL();
			    POP_SPECIAL();
			  POP_SPECIAL();
...
Object Editor_toolbar_user_callback = UNBOUND;
    ...
    Object apply_changes_qm, g2_window;
{
    ...
    current_workstation_1 = workstation;
    PUSH_SPECIAL(Current_workstation,current_workstation_1,13);
      current_workstation_window = ISVREF(Current_workstation,(SI_Long)1L);
      PUSH_SPECIAL(Current_workstation_window,current_workstation_window,12);
	current_g2_window_for_this_workstation_qm = 
		ISVREF(Current_workstation,(SI_Long)25L);
	PUSH_SPECIAL(Current_g2_window_for_this_workstation_qm,current_g2_window_for_this_workstation_qm,
		11);
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				...
				if (native_window_qm) {
				    ...
				    svref_arg_1 = Current_edit_state;
				    SVREF(svref_arg_1,FIX((SI_Long)76L)) = T;
    ...
    Object pos_y_as_evaluation_value, g2_window_as_evaluation_value;
{
    ...
    PUSH_SPECIAL(Editor_prompt_filter_qm,editor_prompt_filter_qm,2);
      override_preferred_editor = estructure_slot(options,
	      Qpreferred_editor,Nil);
      PUSH_SPECIAL(Override_preferred_editor,override_preferred_editor,1);
	editor_caption_text_override_qm = estructure_slot(options,Qtitle,Nil);
	PUSH_SPECIAL(Editor_caption_text_override_qm,editor_caption_text_override_qm,
		0);
	...
	reclaim_gensym_cons_1(modal_as_evaluation_value);
    IDENTITY(g2_window_as_evaluation_value);
    return VALUES_0();
}
...
Object Edit_states = UNBOUND;

Object Highest_state_index = UNBOUND;
...
{
    Object editor_handle, g2_window, value_1, ws, es, retval;
    Object current_workstation_1, current_workstation_window;
    Object current_g2_window_for_this_workstation_qm;
    Object type_of_current_workstation_window;
    Object current_workstation_native_window_qm, temp;
			  ...
			  PUSH_SPECIAL(Current_g2_user_mode_qm,current_g2_user_mode_qm,
				...
				PUSH_SPECIAL(Current_edit_state,current_edit_state,
				  ...
				  PUSH_SPECIAL(Current_edit_workspace,current_edit_workspace,
					...
					SVREF(svref_arg_1,editor_handle) = Nil;
				    }
				  POP_SPECIAL();
				POP_SPECIAL();
			      POP_SPECIAL();
    ...
    Object text, options, g2_window;
{
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
			    ...
			    PUSH_SPECIAL(Current_edit_state,current_edit_state,
			      ...
			      PUSH_SPECIAL(Current_edit_workspace,current_edit_workspace,
				      0);
				insert_text_string_at_cursor(3,text,Nil,Nil);
			      POP_SPECIAL();
			    POP_SPECIAL();
			  POP_SPECIAL();
			POP_SPECIAL();
    ...
    return reclaim_evaluation_value(options);
}
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
				...
				if (item_qm && 
					...
					item_qm))
				    result = item_menu_command_permitted_p(ISVREF(command,
					    (SI_Long)20L),item_qm);
				else
				    result = VALUES_1(Nil);
			    }
				...
				result = VALUES_1(Nil);
				    ...
				    Qui_command_named)) {
				if (command_applicable_p(2,command,item_qm))
				    result = command_unrestricted_p(2,
					    command,item_qm);
				else
				    result = VALUES_1(Nil);
			    }
			    else
				result = command_unrestricted_p(2,command,
					item_qm);
			  POP_SPECIAL();
			POP_SPECIAL();
		      POP_SPECIAL();
    ...
    Object kb_workspace, g2_window, x_in_workspace, y_in_workspace;
{
    ...
    x_note_fn_call(226,207);
    current_workstation_1 = ISVREF(g2_window,(SI_Long)20L);
    PUSH_SPECIAL(Current_workstation,current_workstation_1,16);
      current_workstation_window = ISVREF(Current_workstation,(SI_Long)1L);
      PUSH_SPECIAL(Current_workstation_window,current_workstation_window,15);
	current_g2_window_for_this_workstation_qm = 
		ISVREF(Current_workstation,(SI_Long)25L);
	PUSH_SPECIAL(Current_g2_window_for_this_workstation_qm,current_g2_window_for_this_workstation_qm,
		14);
		  ...
		  PUSH_SPECIAL(Specific_structure_for_current_workstation_context,specific_structure_for_current_workstation_context,
			...
			PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
			  ...
			  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
			    ...
			    initial_half_extent_of_bounding_box = (SI_Long)50L;
			    x_in_window = Nil;
			    y_in_window = Nil;
			    current_frame_transform_qm = Nil;
			    current_image_x_scale = ISVREF(image_plane_qm,
				    (SI_Long)11L);
			    current_image_y_scale = ISVREF(image_plane_qm,
				    (SI_Long)12L);
				  ...
				  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
				    ...
				    PUSH_SPECIAL(Current_frame_transform_qm,current_frame_transform_qm,
					  ...
					  gensymed_symbol_1 = 
						  ...
						  FIX(value)));
				      x_in_window = FIX(gensymed_symbol + 
					      gensymed_symbol_1);
				      gensymed_symbol = 
					  ...
					  gensymed_symbol_1 = 
						  IFIX(scalef_function(scale,
						  FIX(value)));
				      y_in_window = FIX(gensymed_symbol + 
					      gensymed_symbol_1);
				    POP_SPECIAL();
				  POP_SPECIAL();
				POP_SPECIAL();
				...
				temp = SYMBOLP(gensymed_symbol_2) ? 
					...
					: gensymed_symbol_2;
				result = FUNCALL_4(temp,kb_workspace,
					image_plane_qm,x_in_window,
					y_in_window);
			    }
			    else
				result = VALUES_1(Nil);
    ...
    Object mouse_pointer;
{
	...
	if (T) {
		...
		temp = Plus_missing_argument_plus;
	    return make_partial_command(Qdo_scrolling,gensym_list_3(temp_1,
		    temp_2,snapshot_command_argument(temp)));
	}
	else
	    return VALUES_1(Nil);
    ...
    Object mouse_pointer;
{
	...
	if (T) {
		...
		temp = Plus_missing_argument_plus;
	    return make_partial_command(Qfull_scale,gensym_list_3(temp_1,
		    temp_2,snapshot_command_argument(temp)));
	}
	else
	    return VALUES_1(Nil);
    ...
    Object mouse_pointer;
{
	...
	if (T) {
		...
		temp = Plus_missing_argument_plus;
	    return make_partial_command(Qscale_to_fit,gensym_list_3(temp_1,
		    temp_2,snapshot_command_argument(temp)));
	}
	else
	    return VALUES_1(Nil);
...
Object Global_table_of_attributes_pane_pointer = UNBOUND;

Object Global_table_of_hidden_attributes_pane_pointer = UNBOUND;

Object Global_nmsci_id_for_attributes_pane = UNBOUND;

Object Global_nmsci_id_for_hidden_attributes_pane = UNBOUND;

Object Global_nms_menu_choiced_item_id = UNBOUND;

/* COM-TABLE-OF-ATTRIBUTES-PANE */
Object com_table_of_attributes_pane(frame,g2_window)
    Object frame, g2_window;
{
    x_note_fn_call(226,269);
    ...
    Object mouse_pointer;
{
	...
	if (temp) {
	    ...
	    return make_partial_command(Qtable_of_hidden_attributes_pane,
		    gensym_list_2(temp_2,snapshot_command_argument(temp_1)));
	}
	else
	    return VALUES_1(Nil);
    }
    ...
    Object frame, g2_window;
{
	...
	if (frame) {
	    ...
	    Global_table_of_attributes_pane = g2_ui_create_property_grid(5,
		    temp,Nil,gensym_cons_1(gensymed_symbol,Qab_structure),
	    ...
	    Global_table_of_attributes_pane = g2_ui_create_property_grid(5,
		    array_constant,Nil,gensym_cons_1(gensymed_symbol,
    ...
    Object frame, g2_window;
{
	...
	Global_table_of_hidden_attributes_pane = 
		...
		gensym_cons_1(gensymed_symbol,Qab_structure),g2_window,
    ...
    Object frame;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = 
		gensym_cons_1(create_node_for_table_of_attributes_pane(frame,
    ...
    Object frame;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = 
		gensym_cons_1(create_node_for_table_of_hidden_attributes_pane(frame,
    ...
    Object mouse_pointer;
{
	...
	if (allow_table_command_p(frame)) {
		...
		temp = Plus_missing_argument_plus;
	    return make_partial_command(Qtable,gensym_list_3(temp_1,temp_2,
		    snapshot_command_argument(temp)));
	}
	else
	    return VALUES_1(Nil);
...
Object Alternate_symbols_for_translation = UNBOUND;
...
Object Native_login_dialog = UNBOUND;
...
Object Native_alias_creation_dialog = UNBOUND;
...
Object post_native_login_dialog varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Alternate_symbols_for_translation,alternate_symbols_for_translation,
	    5);
...
void commands1_INIT()
{
    ...
    string_constant_93 = 
	    STATIC_STRING("1r83-PVy83-Ocy83-hWy83-Qfy83-ZMy83-eqy83-PUy");
