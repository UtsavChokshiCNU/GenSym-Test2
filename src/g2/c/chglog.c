    ...
    Object change_logging_kb_version_timestamp, change_logging_kb_version_uuid;
{
    ...
    return gensym_cons_1(change_logging_kb_version_number,
	    gensym_cons_1(change_logging_kb_version_timestamp,
	    gensym_cons_1(change_logging_kb_version_uuid,Nil)));
}
...
Object make_initial_version_information_for_change_logging()
{
    ...
    return gensym_cons_1(make_version_information_entry_for_change_logging(FIX((SI_Long)1L)),
	    Nil);
}
    ...
    Object mouse_pointer;
{
	...
	if (temp) {
	    ...
	    return make_partial_command(Qflush_version_information_for_change_logging_from_table,
		    gensym_list_4(temp_2,temp_3,temp_4,
...
{
    Object gensymed_symbol, sub_class_bit_vector, top_of_stack, message_1;
    Object temp_1, rest_1, slot_description, new_cons, gensymed_symbol_4;
    Object temp_2, stack_of_slot_value_changes, entry_to_delete;
	...
	if (FIXNUM_EQ(entry_number,CAAR(temp_1))) {
	  ...
	  next_loop:
		...
		if (Nil)
		    gensymed_symbol_4 = nconc2(gensym_list_2(sav_params,
		...
		PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		  ...
		  M_CAR(temp_2) = Nil;
		  reclaim_gensym_list_1(entry_to_delete);
		  temp = 
...
Object Version_control_parameters = UNBOUND;
    ...
    Object version_control_parameters, value, initializing_qm;
{
    ...
    PUSH_SPECIAL(Version_control_parameters,version_control_parameters,0);
...
static Object Qversion_control_parameters;  /* version-control-parameters */
...
{
    Object vc_parameters_qm, buddy_slot_description, new_cons, gensymed_symbol;
    Object gensymed_symbol_1, cdr_new_value, stack_of_slot_value_changes, temp;
	...
	if ( !TRUEP(gensymed_symbol))
	    gensymed_symbol = replenish_gensym_cons_pool();
	if (Nil)
	    gensymed_symbol_1 = nconc2(gensym_list_2(vc_parameters_qm,
		    buddy_slot_description),gensym_cons_1(Nil,Nil));
	else {
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
		Available_gensym_conses = M_CDR(new_cons);
	...
	PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
	  ...
	  if (Noting_changes_to_kb_p)
	      note_change_to_block_1(vc_parameters_qm,
		      Qenable_kb_change_logging);
	  temp = set_lookup_slot_value_1(vc_parameters_qm,
		  Qenable_kb_change_logging,value);
...
Object External_diff_program_qm = UNBOUND;

Object External_diff_options_qm = UNBOUND;
...
Object Delete_files_after_external_diff_p = UNBOUND;
...
Object external_diff_files()
{
  ...
  end_loop:
    temp_1 = 
	    ...
	    Qoutput_filename,Nil));
    result_qm = allocate_evaluation_structure(gensym_list_4(Qdiff_output,
	    temp_1,Qdiff_error,
	    read_text_file_into_wide_string(get_lookup_slot_value_given_default(Version_control_parameters,
	    Qerror_filename,Nil))));
    ...
    Object change_log_entry_uuid_of_save;
{
    ...
    return gensym_cons_1(change_log_entry_slot_name,
	    gensym_cons_1(change_log_entry_class_qualifier_qm,
	    gensym_cons_1(change_log_entry_edit_type,
	    gensym_cons_1(change_log_entry_timestamp,
	    gensym_cons_1(change_log_entry_author,
	    gensym_cons_1(change_log_entry_revision,
	    gensym_cons_1(change_log_entry_tags_qm,
	    gensym_cons_1(change_log_entry_type_of_text_stored,
	    gensym_cons_1(change_log_entry_slot_value_text,
	    gensym_cons_1(change_log_entry_log_qm,
	    gensym_cons_1(change_log_entry_uuid_of_save,Nil)))))))))));
}
    ...
    Object slot_name, class_qualifier_qm, revision_number;
{
    ...
    return gensym_list_2(class_qualifier_qm ? gensym_cons_1(slot_name,
	    class_qualifier_qm) : slot_name,revision_number);
}
    ...
    Object frame;
{
  ...
  end_1:;
	...
	temp = change_log_information_entry(slot_name,class_qualifier_qm,
		CAR(temp));
	revision_list = gensym_cons_1(temp,revision_list);
    }
    goto next_loop;
  end_loop:
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(frame,Qchange_log_information);
    set_lookup_slot_value_1(frame,Qchange_log_information,gensym_cons_1(T,
	    revision_list));
    return VALUES_1(Qnil);
}
    ...
    Object frame_change_entries, frame;
{
  ...
  next_loop_1:
	...
	slot_status_qm = gensym_list_2(slot_name,
		Initial_change_log_revision_number);
	revision_list = gensym_cons_1(slot_status_qm,revision_list);
    }
    ...
    replacement_entry = make_change_log_entry_for_slot(slot_name,Nil,
	    ...
	    gensym_cons_1(tag_qm,Nil) : Nil,Qfull_text,slot_value_text,Nil,
	    copy_for_slot_value(module_uuid));
    new_frame_change_log = gensym_cons_1(replacement_entry,
  ...
  end_loop:
	...
	if (get_slot_description_of_class_description_function(slot_name,
	    ...
	    temp_3 = gensym_cons_1(Qpost_load,Nil);
	    ...
	    new_frame_change_log = gensym_cons_1(temp,new_frame_change_log);
	}
	goto next_loop_2;
      end_loop_2:;
    }
    ...
    Object frame, slot_name, class_qualifier_qm;
{
  ...
  end_loop:;
    ...
    temp_2 = get_lookup_slot_value_given_default(frame,
	    Qchange_log_information,Nil);
    gensym_push_modify_macro_arg = change_log_information_entry(slot_name,
	    class_qualifier_qm,initial_revision);
    ...
    Object frame, slot_name, qualifier_qm, new_text, module_uuid;
{
    ...
    set_non_savable_lookup_slot_value(frame,Qframe_change_log,Nil);
    new_frame_change_log = gensym_cons_1(new_entry_for_slot,
	    new_frame_change_log);
    ...
    Object frame;
{
	...
	temp = ISVREF(basic_table,(SI_Long)19L);
	car_new_value = nconc2(gensym_list_3(Nil,Nil,Nil),CAR(temp));
    ...
    Object entry_qm, item;
{
	...
	temp = CDDR(temp);
	car_new_value = 
		allocate_evaluation_sequence(copy_list_using_gensym_conses_1(CAR(temp)));
	M_CAR(gensymed_symbol_1) = car_new_value;
	gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    ...
    Object frame_change_log, item;
{
  ...
  next_loop:
    ...
    entry = M_CAR(ab_loop_list_);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = gensym_cons_1(make_change_log_entry_eval_struct(entry,
	    item),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
    ...
    Object item, slot_name, identifier, new_tag;
{
	...
	if ( !TRUEP(found_entry_qm))
		...
		if ( !TRUEP(CAR(temp))) {
		    temp = CDDDDR(found_entry_qm);
		    car_arg = CDDR(temp);
		    car_new_value = gensym_cons_1(new_tag,Nil);
		    ...
		    temp = CDDDDR(found_entry_qm);
		    car_arg = CDDR(temp);
		    gensym_push_modify_macro_arg = new_tag;
		    car_1 = gensym_push_modify_macro_arg;
		    cdr_1 = CAR(car_arg);
    ...
    Object found_entry_qm, new_tag;
{
	...
	if ( !TRUEP(CDR(temp))) {
	    temp = CDDDDR(found_entry_qm);
	    temp = CDDR(temp);
	    reclaim_gensym_list_1(CAR(temp));
	    temp = CDDDDR(found_entry_qm);
	    car_arg = CDDR(temp);
	    M_CAR(car_arg) = Nil;
	}
		...
		M_CAR(car_arg) = car_new_value;
		reclaim_gensym_cons_1(cons_to_delete);
	    }
	    else {
		temp = CDDDDR(found_entry_qm);
		temp = CDDR(temp);
		delete_gensym_element_1(new_tag,CAR(temp));
	    }
	}
    }
    return VALUES_1(found_entry_qm);
    ...
    Object frame, log_p;
{
    ...
    Object temp, stack_of_slot_value_changes, temp_1, frame_and_slot_or_atom;
...
void change_log_INIT()
{
    ...
    string_constant_61 = 
	    STATIC_STRING("1q4z8r83KXy83KXy83e*y83e*y00001n1l83Ey1l8l1m8p83Ky000004z8r83bdy83bdy83e*y83e*y00001q1l8l1l83Ey1m8p01l83Uy1l83Hy1l83Ny000004z8r8");
    string_constant_62 = 
	    STATIC_STRING("3bey83bey83e*y83e*y00001q1l8l1l83Ey1m8p01l83Uy1l83Hy1l83Ny000004z8r83XSy83XSy83e*y83e*y00001q1l8l1l83Ey1m8p01l83Uy1l83Hy1l83Ny00");
    string_constant_63 = 
	    STATIC_STRING("0004z8r83Khy83Khy83e*y83e*y00001q1l8l1l83Ey1m8p01l83Uy1l83Hy1l83Ny000004z8r83IKy83IKy83e*y83e*y00001q1l8l1l83Ey1m8p01l83Uy1l83Hy");
    string_constant_64 = STATIC_STRING("1l83Ny00000");
    string_constant_65 = 
	    STATIC_STRING("1s8q1n83e*y1l83-sy83ey1p83KXy083Ey8l1m8p83Ky1s83bdy08l83Ey1m8p083Uy83Hy83Ny1s83bey08l83Ey1m8p083Uy83Hy83Ny1s83XSy08l83Ey1m8p083U");
    string_constant_66 = 
	    STATIC_STRING("y83Hy83Ny1s83Khy08l83Ey1m8p083Uy83Hy83Ny1s83IKy08l83Ey1m8p083Uy83Hy83Ny");
