...
Object Chain_of_available_expression_for_compilations = UNBOUND;

Object Expression_for_compilation_count = UNBOUND;
    ...
    Object expression_for_compilation;
{
    ...
    svref_new_value = Chain_of_available_expression_for_compilations;
    SVREF(expression_for_compilation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_expression_for_compilations = 
...
Object make_permanent_expression_for_compilation_structure_internal()
{
    ...
    Object expression_for_compilation_count_new_value;
    ...
    expression_for_compilation_count_new_value = 
	    FIXNUM_ADD1(Expression_for_compilation_count);
...
Object Chain_of_available_for_structures = UNBOUND;

Object For_structure_count = UNBOUND;
    ...
    Object for_structure;
{
    ...
    svref_new_value = Chain_of_available_for_structures;
    SVREF(for_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_for_structures = for_structure;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_for_structure_variable, for_structure_count_new_value;
    ...
    for_structure_count_new_value = FIXNUM_ADD1(For_structure_count);
    For_structure_count = for_structure_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_reference_structures = UNBOUND;

Object Reference_structure_count = UNBOUND;
    ...
    Object reference_structure;
{
    ...
    svref_new_value = Chain_of_available_reference_structures;
    SVREF(reference_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_reference_structures = reference_structure;
    return VALUES_1(Nil);
}
...
Object make_permanent_reference_structure_structure_internal()
{
    ...
    Object reference_structure_count_new_value;
    ...
    reference_structure_count_new_value = 
	    FIXNUM_ADD1(Reference_structure_count);
    Reference_structure_count = reference_structure_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Compiled_antecedent_1 = UNBOUND;

Object Compiled_consequent_1 = UNBOUND;

Object Compiled_consequent_2 = UNBOUND;

Object List_of_expressions_for_compilation = UNBOUND;

Object List_of_for_structures = UNBOUND;

Object List_of_reference_structures = UNBOUND;
...
Object Focus_range = UNBOUND;

Object Needed_domain = UNBOUND;

Object Global_domain = UNBOUND;

Object Expression_list_indicator = UNBOUND;

Object Color_change_indicator = UNBOUND;

Object Color_changes_indicator = UNBOUND;

Object Nil_indicator = UNBOUND;

Object Local_names_not_associated_with_roles = UNBOUND;
...
Object Compilation_local_name_symbol_counter = UNBOUND;

Object Compilation_local_name_listed_next_symbol = UNBOUND;

Object Compilation_local_name_symbol_supply = UNBOUND;
...
Object interned_compilation_local_name_symbol()
{
	...
	temp = FIXNUM_ADD1(Compilation_local_name_symbol_counter);
	Compilation_local_name_symbol_counter = temp;
	if (PUSH_AREA(Dynamic_area,0))
	...
	temp_1 = CAR(Compilation_local_name_listed_next_symbol);
	temp = FIXNUM_ADD1(Compilation_local_name_symbol_counter);
	Compilation_local_name_symbol_counter = temp;
	Compilation_local_name_listed_next_symbol = 
	...
	temp = FIXNUM_ADD1(Compilation_local_name_symbol_counter);
	Compilation_local_name_symbol_counter = temp;
	temp = Compilation_local_name_listed_next_symbol;
	if (PUSH_AREA(Dynamic_area,0))
...
Object Bad_rule = UNBOUND;

Object Focus_name_for_rule_or_formula_compilation = UNBOUND;

Object Focus_too_narrow_qm = UNBOUND;

Object Fatal_focus_error_info_qm = UNBOUND;

Object Fatal_focus_error_info_for_all_compilations = UNBOUND;

Object Focus_local_name_for_rule_compilation_qm = UNBOUND;

Object Compiling_antecedent_p = UNBOUND;

Object List_of_known_names = UNBOUND;

Object Alist_of_local_names_and_role_names = UNBOUND;

Object Names_used_for_more_than_one_item = UNBOUND;

Object Role_names_and_local_names_for_runtime_items = UNBOUND;

Object Focus_local_names_for_focus_role_name = UNBOUND;

Object Local_name_errors = UNBOUND;

Object Inside_action_iteration_p = UNBOUND;

Object Top_level_reference_tree = UNBOUND;

Object Pattern_checking_inverse_references = UNBOUND;

Object Wrapper_references_for_left_side_of_formula_qm = UNBOUND;

Object Designations_from_explicit_iteration_forms = UNBOUND;

Object Source_designations_from_explicit_iteration_forms = UNBOUND;

Object Compiling_rule_p = UNBOUND;

Object Compiling_expression_p = UNBOUND;

Object Context_iteration_forms = UNBOUND;

Object Non_context_top_level_binding_forms = UNBOUND;

Object Number_of_no_binds = UNBOUND;

Object Assignment_section_forms = UNBOUND;

Object Post_compiler_warning_note_qm = UNBOUND;

Object Attribute_name_errors = UNBOUND;

Object Allow_in_line_designations_qm = UNBOUND;

Object Reference_structures_originating_from_within_existence_predicate = UNBOUND;

Object Local_iteration_forms = UNBOUND;

Object Local_insertion_location = UNBOUND;
    ...
    Object using_section;
{
    ...
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(Current_computation_frame,
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,35);
      compilation_local_name_symbol_counter = FIX((SI_Long)1L);
      compilation_local_name_listed_next_symbol = 
	      Compilation_local_name_symbol_supply;
      PUSH_SPECIAL(Compilation_local_name_listed_next_symbol,compilation_local_name_listed_next_symbol,
	      34);
	PUSH_SPECIAL(Compilation_local_name_symbol_counter,compilation_local_name_symbol_counter,
		33);
	  list_of_expressions_for_compilation = Nil;
	  PUSH_SPECIAL(List_of_expressions_for_compilation,list_of_expressions_for_compilation,
		  32);
	    list_of_for_structures = Nil;
	    PUSH_SPECIAL(List_of_for_structures,list_of_for_structures,31);
	      list_of_reference_structures = Nil;
	      PUSH_SPECIAL(List_of_reference_structures,list_of_reference_structures,
		      30);
		focus_name_for_rule_or_formula_compilation = focus_name_qm;
		PUSH_SPECIAL(Focus_name_for_rule_or_formula_compilation,focus_name_for_rule_or_formula_compilation,
			29);
		  list_of_known_names = Nil;
		  PUSH_SPECIAL(List_of_known_names,list_of_known_names,28);
		    names_used_for_more_than_one_item = Nil;
		    PUSH_SPECIAL(Names_used_for_more_than_one_item,names_used_for_more_than_one_item,
			    27);
		      role_names_and_local_names_for_runtime_items = Nil;
		      PUSH_SPECIAL(Role_names_and_local_names_for_runtime_items,role_names_and_local_names_for_runtime_items,
			      26);
			alist_of_local_names_and_role_names = Nil;
			PUSH_SPECIAL(Alist_of_local_names_and_role_names,alist_of_local_names_and_role_names,
				25);
			  local_names_not_associated_with_roles = Nil;
			  PUSH_SPECIAL(Local_names_not_associated_with_roles,local_names_not_associated_with_roles,
				  24);
			    top_level_reference_tree = Nil;
			    PUSH_SPECIAL(Top_level_reference_tree,top_level_reference_tree,
				    23);
			      local_name_errors = Nil;
			      PUSH_SPECIAL(Local_name_errors,local_name_errors,
				      22);
				focus_local_names_for_focus_role_name = Nil;
				PUSH_SPECIAL(Focus_local_names_for_focus_role_name,focus_local_names_for_focus_role_name,
					21);
				  non_context_top_level_binding_forms = Nil;
				  PUSH_SPECIAL(Non_context_top_level_binding_forms,non_context_top_level_binding_forms,
					  20);
				    attribute_name_errors = Nil;
				    PUSH_SPECIAL(Attribute_name_errors,attribute_name_errors,
					    19);
				      reference_structures_originating_from_within_existence_predicate 
					      = Nil;
				      PUSH_SPECIAL(Reference_structures_originating_from_within_existence_predicate,reference_structures_originating_from_within_existence_predicate,
					      18);
					local_iteration_forms = Nil;
					PUSH_SPECIAL(Local_iteration_forms,local_iteration_forms,
						17);
					  local_insertion_location = Nil;
					  PUSH_SPECIAL(Local_insertion_location,local_insertion_location,
						  16);
					    rule = Current_computation_frame;
					    designations_from_explicit_iteration_forms 
						    = Nil;
					    PUSH_SPECIAL(Designations_from_explicit_iteration_forms,designations_from_explicit_iteration_forms,
						    15);
					      source_designations_from_explicit_iteration_forms 
						      = Nil;
					      PUSH_SPECIAL(Source_designations_from_explicit_iteration_forms,source_designations_from_explicit_iteration_forms,
						      14);
						rule_translation = 
						...
						PUSH_SPECIAL(Compiling_antecedent_p,compiling_antecedent_p,
							13);
						  inside_action_iteration_p 
							  = Nil;
						  PUSH_SPECIAL(Inside_action_iteration_p,inside_action_iteration_p,
							  12);
						    pattern_checking_inverse_references 
							    = Nil;
						    PUSH_SPECIAL(Pattern_checking_inverse_references,pattern_checking_inverse_references,
							    11);
						      chaining_category_qm 
							      = Nil;
						      focus_local_name_for_rule_compilation_qm 
							      = Nil;
						      PUSH_SPECIAL(Focus_local_name_for_rule_compilation_qm,focus_local_name_for_rule_compilation_qm,
							      10);
							focus_too_narrow_qm 
								= Nil;
							PUSH_SPECIAL(Focus_too_narrow_qm,focus_too_narrow_qm,
								9);
							  fatal_focus_error_info_qm 
								  = Nil;
							  PUSH_SPECIAL(Fatal_focus_error_info_qm,fatal_focus_error_info_qm,
								  8);
							    fatal_focus_error_info_for_all_compilations 
								    = Nil;
							    PUSH_SPECIAL(Fatal_focus_error_info_for_all_compilations,fatal_focus_error_info_for_all_compilations,
								    7);
							      compiling_rule_p 
								      = T;
							      PUSH_SPECIAL(Compiling_rule_p,compiling_rule_p,
								      6);
								context_iteration_forms 
									= Nil;
								PUSH_SPECIAL(Context_iteration_forms,context_iteration_forms,
									5);
								  compiled_antecedent_1 
									  = 
									  Nil;
								  PUSH_SPECIAL(Compiled_antecedent_1,compiled_antecedent_1,
									  4);
								    compiled_consequent_1 
									    = 
									    Nil;
								    PUSH_SPECIAL(Compiled_consequent_1,compiled_consequent_1,
									    3);
								      ...
								      compiled_consequent_2 
									      = 
									      Nil;
								      PUSH_SPECIAL(Compiled_consequent_2,compiled_consequent_2,
									      2);
									number_of_no_binds 
										= 
										FIX((SI_Long)0L);
									PUSH_SPECIAL(Number_of_no_binds,number_of_no_binds,
										1);
    ...
    Object expression, left_side_of_formula_qm, focus_names;
{
    ...
    Object ab_loop_list_, ab_loop_it_, temp_3, gensym_pop_store, cons_1;
    Object next_cons;
    char temp_2;
    ...
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    stack_of_slot_value_changes = gensymed_symbol;
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,23);
      compilation_local_name_symbol_counter = FIX((SI_Long)1L);
      compilation_local_name_listed_next_symbol = 
	      Compilation_local_name_symbol_supply;
      PUSH_SPECIAL(Compilation_local_name_listed_next_symbol,compilation_local_name_listed_next_symbol,
	...
	PUSH_SPECIAL(Compilation_local_name_symbol_counter,compilation_local_name_symbol_counter,
	  ...
	  PUSH_SPECIAL(Compiler_warnings,compiler_warnings,20);
	    PUSH_SPECIAL(Compiler_errors,compiler_errors,19);
		  ...
		  PUSH_SPECIAL(List_of_expressions_for_compilation,list_of_expressions_for_compilation,
			  18);
		    list_of_for_structures = Nil;
		    PUSH_SPECIAL(List_of_for_structures,list_of_for_structures,
			    17);
		      list_of_reference_structures = Nil;
		      PUSH_SPECIAL(List_of_reference_structures,list_of_reference_structures,
			      16);
			...
			PUSH_SPECIAL(Focus_name_for_rule_or_formula_compilation,focus_name_for_rule_or_formula_compilation,
				15);
			  list_of_known_names = Nil;
			  PUSH_SPECIAL(List_of_known_names,list_of_known_names,
				  14);
			    names_used_for_more_than_one_item = Nil;
			    PUSH_SPECIAL(Names_used_for_more_than_one_item,names_used_for_more_than_one_item,
				    13);
					  ...
					  PUSH_SPECIAL(Non_context_top_level_binding_forms,non_context_top_level_binding_forms,
						...
						PUSH_SPECIAL(Local_iteration_forms,local_iteration_forms,
						  ...
						  PUSH_SPECIAL(Local_insertion_location,local_insertion_location,
						    ...
						    wrapper_references_for_left_side_of_formula_qm 
							    = Nil;
						    PUSH_SPECIAL(Wrapper_references_for_left_side_of_formula_qm,wrapper_references_for_left_side_of_formula_qm,
							    1);
						      compiling_expression_p 
							      = T;
						      PUSH_SPECIAL(Compiling_expression_p,compiling_expression_p,
							      0);
							delete_all_frame_notes_for_rule_or_expression(Nil);
...
Object List_of_compiler_frame_note_types = UNBOUND;

Object List_of_bad_status_compiler_frame_note_types = UNBOUND;
...
Object Unknown_references = UNBOUND;
    ...
    Object particulars, frame;
{
	...
	PUSH_SPECIAL(Unknown_references,unknown_references,0);
	  last_time_qm = Nil;
	next_loop:
...
{
    Object problem_qm, name, ignore, ab_loop_list_, ab_loop_desetq_;
  ...
  next_loop:
    ...
    gensymed_symbol_2 = SXHASH_SYMBOL_1(name) & IFIX(Most_positive_fixnum);
    ...
    Object focus_name_qm;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    add_to_frame_note_particulars_list_if_necessary(gensym_list_2(focus_name_qm,
...
Object Special_globally_known_references = UNBOUND;

static Object Qreference_to_item_or_datum_qm;  /* reference-to-item-or-datum? */

static Object Qunknown_references;  /* unknown-references */
    ...
    Object reference_tree, focus_name_qm;
{
    ...
    next_loop:
	  ...
	  Unknown_references = nconc2(Unknown_references,
		  gensym_cons_1(ISVREF(root_reference_structure,
		  (SI_Long)2L),Nil));
      goto next_loop;
    end_loop:
    ...
    Object reference_structure;
{
    ...
    if (temp_1) {
	Unknown_references = nconc2(Unknown_references,
		gensym_cons_1(ISVREF(reference_structure,(SI_Long)2L),Nil));
...
Object Role_and_domains_for_nth_element_expression = UNBOUND;
    ...
    Object reference_structure;
{
	...
	PUSH_SPECIAL(Role_and_domains_for_nth_element_expression,role_and_domains_for_nth_element_expression,
		0);
    ...
    Object reference_structure;
{
	...
	temp = 
		...
		(SI_Long)3L)));
	return add_to_frame_note_particulars_list_if_necessary(gensym_cons_1(temp,
    ...
    Object compiled_antecedent_1;
{
    ...
    PUSH_SPECIAL(Compiled_antecedent_1,compiled_antecedent_1,0);
    ...
    Object compiled_consequent_1;
{
    ...
    PUSH_SPECIAL(Compiled_consequent_1,compiled_consequent_1,0);
    ...
    Object generic_simulation_formula, compiling_initialization_form_qm;
{
    ...
    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,1);
      PUSH_SPECIAL(Allow_in_line_designations_qm,allow_in_line_designations_qm,
	      0);
...
void compile1_INIT()
{
    ...
    Object AB_package, list_constant_20, Qcompile1;
    Object Qspecial_globally_known_references, list_constant_19, Qoperator;
    Object list_constant_18, Qframe_note_writer_1;
    ...
    Object Qillegal_attribute, Qallow_in_line_designations_qm;
    Object Qcompiling_expression_p, Qcompiling_rule_p;
    Object Qsource_designations_from_explicit_iteration_forms;
    Object Qdesignations_from_explicit_iteration_forms;
    Object Qwrapper_references_for_left_side_of_formula_qm;
    Object Qpattern_checking_inverse_references, Qinside_action_iteration_p;
    Object Qcompiling_antecedent_p, Qfocus_local_name_for_rule_compilation_qm;
    Object Qfatal_focus_error_info_for_all_compilations;
    Object Qfatal_focus_error_info_qm, Qfocus_too_narrow_qm, list_constant_17;
    Object Qbad_rule, string_constant_37, Kfuncall, list_constant_16;
    Object Qutilities3, Qcompilation_local_name_symbol_supply;
    Object Qcompilation_local_name_1, Qlocal_names_not_associated_with_roles;
    Object list_constant_15, Qnil_indicator, string_constant_36;
    Object list_constant_14, Qcolor_changes_indicator, string_constant_35;
    Object list_constant_13, Qcolor_change_indicator, string_constant_34;
    Object list_constant_12, Qexpression_list_indicator, string_constant_33;
    Object list_constant_11, Qglobal_domain, string_constant_32;
    Object list_constant_10, Qneeded_domain, string_constant_31;
    Object list_constant_9, Qfocus_range, string_constant_30;
    Object Qfunction_definition;
    ...
    Object Qreference_structure_count;
    Object Qchain_of_available_reference_structures, string_constant_29;
    ...
    Object Qfor_structure_structure_memory_usage, Qfor_structure_count;
    Object Qchain_of_available_for_structures, string_constant_27;
    ...
    Object Qexpression_for_compilation_count;
    Object Qchain_of_available_expression_for_compilations, string_constant_25;
    Object string_constant_24;
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8m83hFy1n83hFy8n8k1l8n0000000kpk0k0");
    ...
    Qexpression_for_compilation_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_25 = STATIC_STRING("1q83hFy8s83-TAy09k9l");
    ...
    string_constant_26 = 
	    STATIC_STRING("43Dy8m83hQy1n83hQy8n8k1l8n0000000kpk0k0");
    ...
    string_constant_27 = STATIC_STRING("1q83hQy8s83-UDy09k9l");
    clear_optimized_constants();
    ...
    string_constant_28 = 
	    STATIC_STRING("43Dy8m83mAy1n83mAy8n8k1l8n0000000kxk0k0");
    ...
    Qreference_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_29 = STATIC_STRING("1q83mAy8s83-kBy09k9l");
    clear_optimized_constants();
