    ...
    Object block, value;
{
    ...
    Object gensymed_symbol_2, slot_group_qm, temp;
  ...
  end_loop:;
	...
	gensymed_symbol = upgrade_subblocks(value);
	if (slot_group_qm)
...
Object Blocks_with_connections_from_kb_read = UNBOUND;
    ...
    Object symbol, frame;
{
	...
	if (class_name_qm)
	    return gensym_cons_1(Qclass_qualified_name,
		    gensym_cons_1(class_name_qm,gensym_cons_1(slot_name,Nil)));
	else
...
Object Gathering_normally_editable_slots_for_search_qm = UNBOUND;
	...
	if (getf(value,Qitem_position,_) || getf(value,Qicon_position,_)) {
	  ...
	  next_loop:
	    ...
	    if ( !(EQ(indicator,Qitem_position) || EQ(indicator,
		    Qicon_position))) {
		ab_loopvar__2 = gensym_list_2(indicator,value_1);
		if (ab_loopvar__2) {
		    if (ab_loopvar__1)
			M_CDR(ab_loopvar__1) = ab_loopvar__2;
		    else
    ...
    Object block, class_or_classes, not_of_class_case_qm;
{
    ...
    Object subblock_to_delete, xa, ya;
    ...
    Object images_info;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_tree_1(images_info);
}
...
Object Count_of_pending_workspace_drawing = UNBOUND;
...
{
    Object decff_1_arg, count_of_pending_workspace_drawing_new_value;

    x_note_fn_call(87,46);
    decff_1_arg = length(changed_blocks);
    count_of_pending_workspace_drawing_new_value = 
	    FIXNUM_MINUS(Count_of_pending_workspace_drawing,decff_1_arg);
    Count_of_pending_workspace_drawing = 
	    count_of_pending_workspace_drawing_new_value;
    reclaim_gensym_list_1(changed_blocks);
    return VALUES_1(Nil);
}
...
{
    Object count_of_pending_workspace_drawing_new_value;

    x_note_fn_call(87,47);
    count_of_pending_workspace_drawing_new_value = 
	    FIXNUM_SUB1(Count_of_pending_workspace_drawing);
    Count_of_pending_workspace_drawing = 
	    count_of_pending_workspace_drawing_new_value;
...
Object Workspace_image_plane_per_window = UNBOUND;

Object Image_plane_is_obscured_p = UNBOUND;
    ...
    Object workspace;
{
	...
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)4L) : Nil;
	subblocks = gensymed_symbol;
	return VALUES_1( !(subblocks &&  !EQ(ISVREF(subblocks,(SI_Long)0L),
		subblocks)) ? T : Nil);
    }
    else
	return VALUES_1(Nil);
    ...
    Object plist, indicator, value;
{
	...
	goto next_loop;
      end_loop:
	return gensym_cons_1(indicator,gensym_cons_1(value,plist));
	return VALUES_1(Qnil);
    }
    else {
	previous_cons = Nil;
...
void frames4_INIT()
{
    ...
    Object list_constant_16, list_constant_15, Qgrid, AB_package, Qvisible;
    ...
    Object Qleave_text_representation_as_a_single_line_qm;
    ...
    string_constant_6 = 
	    STATIC_STRING("13Ky4z8r83S2y83S2y83*ry83*ry00001m1l8l1l8o000004z8r83*Ly83*Ly83*ry83*ry03Qy001n1l8l1l8o1m8p83*7y000004z8r83Xey83Xey83*ry83*ry000");
    string_constant_7 = 
	    STATIC_STRING("01o1l8l1l8o1l83Cy1l83Uy000004z8r83Xqy83Xqy83*ry83*ry00001n1l8l1l8o1l83Cy000004z8r83Wsy83Wsy83*ry83*ry0k001m1l8l1l8o000004z8r83We");
    string_constant_8 = 
	    STATIC_STRING("y83Wey83*ry83*ry0k001m1l8l1l83Ey000004z8r834sy834sy83*ry83*ry00001n1l8l1l8o1l83Cy000004z8r834ty834ty83*ry83*ry00001n1l8l1l8o1l83");
    string_constant_9 = 
	    STATIC_STRING("Cy000004z8r83Soy83Soy83*ry83*ry00001m1l8l1l8o000004z8r83Hky83Hky83*ry83*ry00001m1l8l1l8o000004z8r83efy83efy83*ry83*ry00001m1l8l1");
    string_constant_10 = 
	    STATIC_STRING("l83Ey000004z8r83eYy83eYy83*ry83*ry00001m1l8l1l83Ey000004z8r83eay83eay83*ry83*ry00001m1l8l1l83Ey000004z8r833gy833gy83*ry83*ry0000");
    string_constant_11 = 
	    STATIC_STRING("1m1l8l1m8p833gy000004z8r8340y8340y83*ry83*ry00001m1l8l1m8p8337y000004z8r83cCy83cCy83*ry83*ry00001n1l8l1m8p83Gy1l83Ny000004z8r836");
    string_constant_12 = 
	    STATIC_STRING("Hy836Hy83*ry83*ry00001n1l8l1m8p83Ky1l83Ny000004z8r834ky834ky83*ry83*ry00001m1l8l1m8p833cy000004z8r83eey83eey83*ry83*ry00001l1l8l");
    string_constant_13 = 
	    STATIC_STRING("000004z8r83eZy83eZy83*ry83*ry0k001m1l8l1l8o000004z8r83e4y83e4y83*ry83*ry00001o1l83Ey1l8l1l83Cy1m8p83e4y000004z8r83dby83dby83*ry8");
    string_constant_14 = 
	    STATIC_STRING("3*ry00001n1l83Ey1l8l1l83Cy000004z8r83Y1y83Y1y83*ry83*ry00001o1l83Ey1l8l1l83Cy1m8p83Ky000004z8r834Sy834Sy83*ry83*ry00001o1l8o1l8l");
    string_constant_15 = 
    ...
    string_constant_19 = 
	    STATIC_STRING("13My8q1n83*ry1l9k8t1o83S2y08l8o1p83*Ly3Qy8l8o1m8p83*7y1q83Xey08l8o83Cy83Uy1p83Xqy08l8o83Cy1o83Wsyk8l8o1o83Weyk8l83Ey1p834sy08l8o");
    string_constant_20 = 
	    STATIC_STRING("83Cy1p834ty08l8o83Cy1o83Soy08l8o1o83Hky08l8o1o83efy08l83Ey1o83eYy08l83Ey1o83eay08l83Ey1n833gy01m8p833gy1n8340y01m8p8337y1p83cCy0");
    string_constant_21 = 
	    STATIC_STRING("8l1m8p83Gy83Ny1p836Hy08l1m8p83Ky83Ny1o834ky08l1m8p833cy1m83eey01o83eZyk8l8o1q83e4y083Ey8l83Cy1m8p83e4y1p83dby083Ey8l83Cy1q83Y1y0");
    string_constant_22 = 
    ...
    string_constant_26 = STATIC_STRING("1l1m83x1y83-6y");
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_26));
    string_constant_27 = STATIC_STRING("1m1m8337y83x1y1m8337y1m9k83Zy");
    clear_optimized_constants();
    ...
    string_constant_28 = 
	    STATIC_STRING("1l4z8r83XHy83XHy832Ay832Ay00001m1l8l1l8o00000");
    string_constant_29 = STATIC_STRING("1n8q1n832Ay1l83*ry8t1o83XHy08l8o");
    temp = regenerate_optimized_constant(string_constant_5);
