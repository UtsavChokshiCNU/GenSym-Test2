...
Object reclaim_evaluation_action_cache(action_cache)
    Object action_cache;
{
    Object first_cons, trailer, current_cons, element_cons, cdr_new_value;
    Object gensym_cons;
	...
	inline_note_reclaim_cons(element_cons,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(element_cons) = cdr_new_value;
	Available_gensym_conses = element_cons;
	trailer = current_cons;
	current_cons = M_CDR(current_cons);
	goto next_loop;
      end_loop:
	if (first_cons &&  !((SI_Long)0L == inline_debugging_consing())) {
	    gensym_cons = first_cons;
	  next_loop_1:
	...
	Available_gensym_conses = first_cons;
    }
    if (action_cache) {
	inline_note_reclaim_cons(action_cache,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(action_cache) = cdr_new_value;
	Available_gensym_conses = action_cache;
    }
    return VALUES_1(Nil);
}
    ...
    Object action_cache;
{
  ...
  next_loop:
    ...
    temp = count_1;
    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(temp,IFIX(count_1) != 
  ...
  end_loop:
    ...
    temp = Qnil;
  end_1:;
    temp = gensym_cons_1(temp,Qaction_cache);
...
Object validate_all_rule_instances()
{
    ...
    Object rule_instance, rule_instance_state, context_vector;
    Object environment_length, frame_serial_number;
    Object rule_instances_to_dismiss_qm, ab_less_than_branch_qm_;
    Object ab_loop_list_, gensymed_symbol, temp_1, old_key, old_entry;
...
Object Current_computation_style = UNBOUND;

Object Evaluating_simulator_procedure_qm = UNBOUND;
...
{
    Object rule_instance, rule, temp_1, schedule_task_qm, timeout_qm;
    ...
    Object future_task_schedule_modify_arg_13, old_structure_being_reclaimed;
    Object temp_2, def_structure_schedule_task_variable, task, variable_list;
    Object frame_serial_number_setf_arg, old, new_1, temp_3, gensymed_symbol;
    Object old_key, old_entry, cached_variables;
    SI_Long gensymed_symbol_1, temp_4;
    char temp, continue_rule_qm, svref_new_value;
	...
	if (timeout_qm) {
	    future_task_schedule_modify_arg_2 = ISVREF(rule_instance,
		    (SI_Long)14L);
	    ...
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qschedule_computation_instance_execution);
	    future_task_schedule_modify_arg_11 = rule_instance;
	    future_task_schedule_modify_arg_12 = ISVREF(rule_instance,
		    (SI_Long)14L);
	    future_task_schedule_modify_arg_13 = rule;
	    schedule_task_qm = ISVREF(rule_instance,(SI_Long)13L);
	    if (schedule_task_qm) {
	    ...
	    SVREF(rule_instance,FIX((SI_Long)13L)) = task;
	}
    }
...
Object List_of_generated_contexts = UNBOUND;

Object List_of_generated_contexts_tail = UNBOUND;
...
{
    Object new_cons, gensymed_symbol, new_environment, value, temp;
    ...
    Object rule, prefix, initial_environment_qm, constraint_alist;
{
    ...
    Object reclaim_role_value_qm, new_prefix, gensymed_symbol_1;
    Object gensymed_symbol_4, quantifier_of_range, role_to_invert, fourth_cons;
	...
	gensymed_symbol_1 = T;
	gensymed_symbol_4 = role_continuation;
    ...
    Object interested_party_qm, priority_qm, constraint_alist;
{
    ...
    Object rule_instance, existing_or_new_rule_instance, new_cons;
    Object gensymed_symbol, vector_1, value, x2, fsn, temp_2;
    ...
    Object schedule_task_qm, scheduled_qm, gensymed_symbol_4, ri_priority;
    Object old_hurry_and_repeat_priority, last_1, next_qm;
    SI_Long context_length, scheduled_instance_count, hash, index_1;
    SI_Long ab_loop_bind_, gensymed_symbol_1, gensymed_symbol_2, temp_3;
    char temp_1, now_qm;
  ...
  end_1:;
    ...
    temp_3 = gensymed_symbol_1 % (SI_Long)43L;
    existing_or_new_rule_instance = 
	    set_balanced_binary_tree_entry(SVREF(hash_table,FIX(temp_3)),
	    Qequal_rule_context,Nil,Nil,rule_context,
	    FIX(gensymed_symbol_1),rule_instance);
    if ( !EQ(rule_instance,existing_or_new_rule_instance)) {
	temp_1 = EQ(existing_or_new_rule_instance,
		Current_computation_instance);
	if (temp_1);
	else {
	    context_vector = ISVREF(existing_or_new_rule_instance,(SI_Long)2L);
	    temp_1 = TRUEP(valid_rule_context_vector_p(context_vector,
	...
	gensymed_symbol = ISVREF(rule,(SI_Long)14L);
	...
	SVREF(rule_instance,FIX((SI_Long)4L)) = temp_2;
	temp_2 = ISVREF(rule,(SI_Long)36L);
	SVREF(rule_instance,FIX((SI_Long)6L)) = temp_2;
	temp_2 = ISVREF(rule,(SI_Long)35L);
	SVREF(rule_instance,FIX((SI_Long)5L)) = temp_2;
	...
	if (explanation_related_features_enabled_func_qm()) {
	    temp_2 = M_CAR(rule_context);
	    SVREF(rule_instance,FIX((SI_Long)22L)) = temp_2;
	}
	frame_serial_number_setf_arg = Current_frame_serial_number;
	old = ISVREF(rule_instance,(SI_Long)11L);
	new_1 = frame_serial_number_setf_arg;
	...
	if (EQ(purpose,Qbackward_chaining)) {
	    temp_2 = gensym_cons_1(gensym_cons_1(Qbackward_chaining,
		    interested_party_qm),Nil);
	    SVREF(rule_instance,FIX((SI_Long)16L)) = temp_2;
	    add_rule_instance_to_variable_interests(interested_party_qm,
		    rule_instance);
	}
	else {
	    temp_2 = gensym_cons_1(purpose,Nil);
	    SVREF(rule_instance,FIX((SI_Long)16L)) = temp_2;
	}
	if (Profiling_enabled_qm)
	...
	temp_2 = Gensym_time;
	SVREF(rule_instance,FIX((SI_Long)18L)) = temp_2;
	temp_2 = Window_instigating_this_rule_instance_qm;
	SVREF(rule_instance,FIX((SI_Long)20L)) = temp_2;
	...
	if (Current_ri_completion_notification_collection_qm) {
	    temp_2 = Current_ri_completion_notification_collection_qm;
	    gensym_push_modify_macro_arg = rule_instance;
	    car_1 = gensym_push_modify_macro_arg;
	    cdr_1 = M_CAR(temp_2);
	    car_new_value = gensym_cons_1(car_1,cdr_1);
	    M_CAR(temp_2) = car_new_value;
	    temp_2 = Current_ri_completion_notification_collection_qm;
	    SVREF(rule_instance,FIX((SI_Long)26L)) = temp_2;
	}
	schedule_computation_instance_execution(rule_instance,
	...
	if (EQ(purpose,Qbackward_chaining)) {
	    ...
	    SVREF(existing_or_new_rule_instance,FIX((SI_Long)16L)) = temp_2;
	    add_rule_instance_to_variable_interests(interested_party_qm,
		    existing_or_new_rule_instance);
	}
	else {
	...
	if ((SI_Long)0L != IFIX(ISVREF(existing_or_new_rule_instance,
		...
		temp_2 =  !TRUEP(old_hurry_and_repeat_priority) ? 
  ...
  end_loop:
	...
	M_CDR(last_1) = temp_2;
	Available_gensym_conses = list_of_rule_context_vectors;
    }
...
{
    Object trailing_cons, leading_cons, item, cdr_new_value, cdr_1;
    Object gensymed_symbol, temp, old_key, old_entry;
    SI_Long gensymed_symbol_1, temp_1;
    Object result;
  ...
  next_loop:
	...
	if (trailing_cons) {
	    cdr_new_value = M_CDR(leading_cons);
		...
		gensymed_symbol = ISVREF(rule_instance,(SI_Long)10L);
		gensymed_symbol_1 = IFIX(M_CAR(gensymed_symbol));
		temp = ISVREF(ISVREF(rule_instance,(SI_Long)8L),(SI_Long)27L);
		temp_1 = gensymed_symbol_1 % (SI_Long)43L;
		result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qequal_rule_context),
			gensymed_symbol,SVREF(temp,FIX(temp_1)),
			FIX(gensymed_symbol_1));
		MVS_2(result,old_key,old_entry);
		reclaim_rule_context(old_key);
		dismiss_rule_instance(old_entry);
	...
	inline_note_reclaim_cons(leading_cons,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(leading_cons) = cdr_new_value;
	Available_gensym_conses = leading_cons;
	inline_note_reclaim_cons(item,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(item) = cdr_new_value;
	Available_gensym_conses = item;
	return VALUES_1(Nil);
    }
...
{
    Object change_priority_of_task_arg, schedule_task_qm, priority;
    Object svref_new_value, old_structure_being_reclaimed, variable;
    ...
    Object rule;
{
    ...
    return gensym_list_3(temp,temp_1,rule_bindings_parse(rule));
}
    ...
    Object groups;
{
  ...
  next_loop:
	...
	ab_loop_list__1 = M_CDR(ab_loop_list__1);
	results = gensym_cons_1(gensym_cons_1(starter,partial),results);
	goto next_loop_1;
      end_loop_1:
	reclaim_gensym_list_1(partials);
    }
    else
	results = gensym_cons_1(gensym_cons_1(starter,Nil),results);
    goto next_loop;
  end_loop:;
    ...
    Object clique_groups;
{
  ...
  next_loop_1:
    ...
    elts = gensym_cons_1(temp,elts);
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(cliques);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(clique_groups);
    ...
    Object seq, row_selector, group_selector_qm;
{
    ...
    Object candidate_rule, candidate_parse, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, cdr_new_value, groupings, clique_groups, ab_loopvar_;
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:
    new_row = gensym_cons_1(gensym_cons_1(gensym_list_2(rule,parse),Nil),Nil);
    results = gensym_cons_1(new_row,results);
    candidates_qm = Qnil;
  end_1:;
    if (candidates_qm) {
	if (group_selector_qm) {
	  ...
	  next_loop_2:
		...
		gensym_push_modify_macro_arg = gensym_list_2(rule,parse);
		car_1 = gensym_push_modify_macro_arg;
		cdr_1 = CDR(group);
	  ...
	  end_loop_2:
	    gensym_push_modify_macro_arg = 
		    gensym_cons_1(gensym_list_2(rule,parse),Nil);
	    car_1 = gensym_push_modify_macro_arg;
  ...
  next_loop_3:
    ...
    if (CDR(groupings)) {
	ab_loopvar__1 = 
		gensym_cons_1(create_cliques_from_groupings(groupings),Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
  ...
  next_loop_6:
    ...
    goto next_loop_6;
  end_loop_6:
    reclaim_gensym_list_1(group);
    goto next_loop_5;
  end_loop_5:
    reclaim_gensym_list_1(row);
    goto next_loop_4;
  end_loop_4:
    reclaim_gensym_list_1(results);
    rule_parse_pair = Nil;
    ab_loop_list_ = normalized_parses;
  ...
  next_loop_7:
    ...
    reclaim_gensym_list_1(normalized_parse);
    reclaim_gensym_list_1(rule_parse_pair);
    goto next_loop_7;
  end_loop_7:
    reclaim_gensym_list_1(normalized_parses);
    goto end_4;
    temp = Qnil;
  end_4:;
    return VALUES_1(temp);
    ...
    Object rule, new_priority, gensymed_symbol;
{
    ...
    Object schedule_task_qm, change_priority_of_task_arg, priority;
    Object svref_new_value, old_structure_being_reclaimed, scope_conses;
	...
	if (hash_table_qm) {
		...
		end_loop_1:;
		  ...
		  if (schedule_task_qm && (ISVREF(schedule_task_qm,
		      ...
		      SVREF(rule_instance,FIX((SI_Long)13L)) = svref_new_value;
		  }
	      }
	      goto next_loop;
	    end_loop_3:;
...
void new_rules_INIT()
{
    ...
    Object Qlist_of_generated_contexts_tail, Qlist_of_generated_contexts;
