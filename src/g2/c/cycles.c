...
{
    Object current_fixnum_time, old_gensym_time, scheduler_mode, aref_arg_1;
    Object millisecond_minimum_scheduling_interval_qm, gensymed_symbol_1;
    char temp;
    double current_unix_time, floored_unix_time, gensymed_symbol, arg, arg_1;
    double temp_1, aref_new_value, float_minimum_scheduling_interval;
    double gensymed_symbol_2, gensymed_symbol_3;
    XDeclare_area(1);
    XDeclare_frontier(1);
	...
	if (Warmbooting_qm) {
		...
		gensymed_symbol = floored_unix_time - 
	...
	if (EQ(scheduler_mode,Qreal_time) || EQ(scheduler_mode,
		...
		gensymed_symbol_2 = EQ(scheduler_mode,Qreal_time) ? 
			DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) : 
			current_unix_time;
		gensymed_symbol_3 = float_minimum_scheduling_interval;
		gensymed_symbol_2 = gensymed_symbol_2 + gensymed_symbol_3;
		gensymed_symbol_3 = current_unix_time;
		gensymed_symbol_2 = gensymed_symbol_2 - gensymed_symbol_3;
...
{
    Object abort_p, abort_1, server, ab_loop_list_, pause_function_qm;
    Declare_varargs;
...
Object system_start()
{
    ...
    Object window_instigating_this_rule_instance_qm, server, scope_conses;
    Object ab_loopvar_, ab_loopvar__1, frame, gensymed_symbol;
    Object gensymed_symbol_1, g2_extension, block, message_board_qm;
    Object sub_class_bit_vector, collecting_updates_to_sensor_attributes_p;
	...
	end_1:;
	  ...
	  PUSH_SPECIAL(Window_instigating_this_rule_instance_qm,window_instigating_this_rule_instance_qm,
	    ...
	    System_has_aborted = Nil;
	    update_g2_run_state();
	    preset_gensym_time_for_initialization();
	    Items_needing_initialization = Nil;
	    server = Nil;
	    ab_loop_list_ = List_of_all_data_servers;
	  next_loop_1:
	    if ( !TRUEP(ab_loop_list_))
...
Object system_reset()
{
    ...
    Object blocks_needing_representations_of_status_refreshed, items_to_delete;
    ...
    Object serial_number, ab_loop_list_, gensymed_symbol, xa, ya, superior_qm;
    ...
    Object temp_2, ab_less_than_branch_qm_, g2_extension, gensymed_symbol_1;
    Object gensymed_symbol_2, message_board_qm;
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
	  ...
	  system_has_paused = Nil;
	  system_is_running = Nil;
	  PUSH_SPECIAL(System_is_running,system_is_running,1);
	    PUSH_SPECIAL(System_has_paused,system_has_paused,0);
	      complete_save_after_running_if_necessary();
	    POP_SPECIAL();
	  POP_SPECIAL();
...
Object system_resume()
{
    ...
    Object ab_loop_desetq_, temp_1, server, resume_function_qm;
    char temp;
    ...
    Object seed;
{
    ...
    PUSH_SPECIAL(User_random_seed_qm,user_random_seed_qm,0);
    ...
    Object timing_parameters;
{
    ...
    PUSH_SPECIAL(Timing_parameters,timing_parameters,0);
...
Object Countdown_for_checking = UNBOUND;
...
Object schedule_g2_legacy_heartbeat_tasks_if_necessary()
{
	...
	current_task_schedule_modify_arg_2 = 
		Legacy_multisecond_heartbeat_adjustment_priority;
	current_task_schedule_modify_arg_3 = 
		Legacy_multisecond_heartbeat_adjustment_interval;
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qdo_legacy_multisecond_heartbeat_adjustments);
	if (Countdown_for_checking) {
	    if (EQ(Countdown_for_checking,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(Countdown_for_checking,(SI_Long)6L))
		cancel_and_reclaim_scheduled_queue_element_1(Countdown_for_checking);
	    inline_note_reclaim_cons(Countdown_for_checking,Nil);
	    old_structure_being_reclaimed = Structure_being_reclaimed;
	    Structure_being_reclaimed = Countdown_for_checking;
	    reclaim_schedule_task_args(ISVREF(Countdown_for_checking,
		    (SI_Long)9L));
	    temp = Countdown_for_checking;
	    ...
	    Chain_of_available_schedule_tasks = Countdown_for_checking;
	}
	...
	Countdown_for_checking = task;
    }
    return VALUES_1(Nil);
}

Object Place_for_for_telewindows_modernization = UNBOUND;

Object Priority_for_telewindows_modernization = UNBOUND;

Object Interval_for_telewindows_modernization = UNBOUND;
...
{
    Object schedule_task_qm, future_task_schedule_modify_arg_2;
	...
	if ( !(schedule_task_qm && (ISVREF(schedule_task_qm,(SI_Long)6L) 
	    ...
	    future_task_schedule_modify_arg_2 = 
		    Priority_for_telewindows_modernization;
	    future_task_schedule_modify_arg_3 = 
		    DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 
		    (double)IFIX(Interval_for_telewindows_modernization);
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qdo_legacy_subsecond_heartbeat_adjustments);
	    if (Place_for_for_telewindows_modernization) {
		if (EQ(Place_for_for_telewindows_modernization,
			Current_schedule_task))
		    Current_schedule_task = Nil;
		if (ISVREF(Place_for_for_telewindows_modernization,
			(SI_Long)6L))
		    cancel_and_reclaim_scheduled_queue_element_1(Place_for_for_telewindows_modernization);
		inline_note_reclaim_cons(Place_for_for_telewindows_modernization,
			Nil);
		old_structure_being_reclaimed = Structure_being_reclaimed;
		Structure_being_reclaimed = 
			Place_for_for_telewindows_modernization;
		reclaim_schedule_task_args(ISVREF(Place_for_for_telewindows_modernization,
			(SI_Long)9L));
		temp = Place_for_for_telewindows_modernization;
		SVREF(temp,FIX((SI_Long)9L)) = Nil;
		Structure_being_reclaimed = old_structure_being_reclaimed;
		temp = Place_for_for_telewindows_modernization;
		svref_new_value = Chain_of_available_schedule_tasks;
	    ...
	    Place_for_for_telewindows_modernization = task;
	}
    }
    return VALUES_1(Nil);
}

Object Multiplicative_counter_for_evaluation = UNBOUND;

Object Modulus_counter_for_evaluation = UNBOUND;

Object Previous_modulus_counter_for_evaluation = UNBOUND;
	...
	if (Separate_imminent_actions_p) {
		...
		if (old_guardian_1_qm && old_guardian_2_qm && 
			...
			if (timestamp) {
				...
				reclaim_gensym_list_1(timestamp);
			}
...
Object run_one_scheduler_cycle()
{
    ...
    PUSH_SPECIAL(Time_slice_start_time,time_slice_start_time,1);
      index_of_top_of_backtrace_stack = Index_of_top_of_backtrace_stack;
      PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
	      0);
	if (FIXNUM_LE(FIXNUM_ADD(Index_of_top_of_backtrace_stack,
...
Object Priority_1_last_gensym_time = UNBOUND;

Object Priority_2_last_gensym_time = UNBOUND;

Object Priority_3_last_gensym_time = UNBOUND;

Object Priority_4_last_gensym_time = UNBOUND;

Object Priority_5_last_gensym_time = UNBOUND;

Object Priority_6_last_gensym_time = UNBOUND;

Object Priority_7_last_gensym_time = UNBOUND;

Object Priority_8_last_gensym_time = UNBOUND;

Object Priority_9_last_gensym_time = UNBOUND;

Object Priority_10_last_gensym_time = UNBOUND;

Object Meter_lag_time_variables = UNBOUND;

Object G2_meter_task_count = UNBOUND;
...
Object schedule_data_server_accept_data_calls()
{
	...
	if ( !(Data_server_accept_data_task && 
	    ...
	    future_task_schedule_modify_arg_3 = 
		    ...
		    (SI_Long)0L)) + 1.0;
	    future_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qcall_data_server_accept_data_functions);
	    if (Data_server_accept_data_task) {
		if (EQ(Data_server_accept_data_task,Current_schedule_task))
		    Current_schedule_task = Nil;
		if (ISVREF(Data_server_accept_data_task,(SI_Long)6L))
		    cancel_and_reclaim_scheduled_queue_element_1(Data_server_accept_data_task);
		inline_note_reclaim_cons(Data_server_accept_data_task,Nil);
		old_structure_being_reclaimed = Structure_being_reclaimed;
		Structure_being_reclaimed = Data_server_accept_data_task;
		reclaim_schedule_task_args(ISVREF(Data_server_accept_data_task,
			(SI_Long)9L));
		temp = Data_server_accept_data_task;
		SVREF(temp,FIX((SI_Long)9L)) = Nil;
		Structure_being_reclaimed = old_structure_being_reclaimed;
		temp = Data_server_accept_data_task;
		svref_new_value = Chain_of_available_schedule_tasks;
	    ...
	    ISVREF(task,(SI_Long)10L) = FIX((SI_Long)0L);
	    future_task_schedule_2(task);
	    Data_server_accept_data_task = task;
	}
    }
    return VALUES_1(Nil);
}
...
Object schedule_immediate_data_server_accept_data_calls()
{
	...
	if (Data_server_accept_data_task) {
	    ...
	    svref_new_value = Chain_of_available_schedule_tasks;
	    SVREF(temp,FIX((SI_Long)0L)) = svref_new_value;
	    Chain_of_available_schedule_tasks = Data_server_accept_data_task;
	}
	def_structure_schedule_task_variable = 
		Chain_of_available_schedule_tasks;
	if (def_structure_schedule_task_variable) {
...
Object cancel_data_server_accept_data_calls()
{
    ...
    temp = Nil;
    Data_server_accept_data_task = temp;
    return VALUES_1(Nil);
}
    ...
    Object data_server;
{
	...
	if ( !temp) {
	    current_task_schedule_modify_arg_2 = 
		    ISVREF(Data_server_parameters,(SI_Long)22L);
	    current_task_schedule_modify_arg_8 = 
		    SYMBOL_FUNCTION(Qaccept_data_and_reschedule_if_necessary);
	    current_task_schedule_modify_arg_11 = data_server;
	    schedule_task_qm = ISVREF(data_server,(SI_Long)13L);
	    if (schedule_task_qm) {
	    ...
	    if (ctask && FIXNUM_LT(p,Priority_of_next_task))
		Priority_of_next_task = p;
	    return VALUES_1(SVREF(data_server,FIX((SI_Long)13L)) = task);
	}
	else
	    return VALUES_1(Nil);
    }
    ...
    Object data_server, continuation_time;
{
	...
	if ( !TRUEP(FUNCALL_0(SYMBOL_FUNCTION(ISVREF(data_server,
	    ...
	    SVREF(task,FIX((SI_Long)11L)) = data_server;
	    SVREF(task,FIX((SI_Long)12L)) = continuation_time;
	    ctask =  !TRUEP(ISVREF(task,(SI_Long)3L)) ? T : Nil;
	    if (ctask);
	    else
		ctask = System_is_running;
...
void cycles_INIT()
{
    ...
    Object AB_package, Qcycles, Qdata_server_accept_data_task;
    Object Qg2_meter_task_limit, Qg2_meter_task_count, list_constant_13;
    Object Qpriority_10_last_gensym_time, Qpriority_9_last_gensym_time;
    Object Qpriority_8_last_gensym_time, Qpriority_7_last_gensym_time;
    Object Qpriority_6_last_gensym_time, Qpriority_5_last_gensym_time;
    Object Qpriority_4_last_gensym_time, Qpriority_3_last_gensym_time;
    Object Qpriority_2_last_gensym_time, Qpriority_1_last_gensym_time;
    Object string_constant_18;
    Object Qg2_meters_scheduler_time_lag_variable_names_format;
    Object Qprevious_modulus_counter_for_evaluation;
    Object Qmultiplicative_counter_for_evaluation;
    Object Qinitialize_interval_for_telewindows_modernization;
    Object list_constant_12, Qinterval_for_telewindows_modernization, Kfuncall;
    Object Qplace_for_for_telewindows_modernization;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, float_constant_1;
    Object Qcountdown_for_checking, Qslot_value_writer;
    ...
    Object Qclasses_which_define, Qdeinstall_system_table, Qtiming_parameters;
    ...
    string_constant_17 = 
	    STATIC_STRING("1n1n83FRy1m1m9k83Yey1m9k831Ay83Edy1n83FRy1m1m9k83-Csy1m9k831Ay83-o9y1n83FRy1o1m9k83*5y1m9k83hLy1m9k83*5y1m9k83liy83-TYy");
