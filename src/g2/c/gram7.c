...
{
    Object class_1, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
	...
	if ( !TRUEP(change_qm))
		...
		if ( !TRUEP(member(4,attribute_name,ISVREF(definition,
			...
			gensymed_symbol = CDR(Symbol_properties_table);
			gensymed_symbol_1 = target_class;
			gensymed_symbol_2 = SXHASH_SYMBOL_1(target_class) 
				& IFIX(Most_positive_fixnum);
			gensymed_symbol_3 = (SI_Long)0L;
		      next_loop_8:
			if ( !TRUEP(gensymed_symbol))
    ...
    Object ignored_value, readout_table;
{
	...
	PUSH_SPECIAL(Default_float_to_text_format,default_float_to_text_format,
		0);
...
Object compile_display_expression_for_slot varargs_1(int, n)
{
    ...
    Object sub_class_bit_vector, part_feature_index, exit_feature_handler;
    Object gensym_pop_store, cons_1, next_cons, frame_and_slot_or_atom;
	...
	PUSH_SPECIAL(Current_computation_style,current_computation_style,2);
	  ...
	  PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
		...
		if (Nil)
		    gensymed_symbol_1 = nconc2(gensym_list_2(display_frame,
		...
		PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		  ...
		  if ( !TRUEP(current_flag_state_qm)) {
		      ...
		      inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
			      gensymed_symbol_2,gensymed_symbol_3);
		      svref_new_value = IFIX(ISVREF(display_frame,
			      (SI_Long)5L)) | (SI_Long)16777216L;
		      ISVREF(display_frame,(SI_Long)5L) = FIX(svref_new_value);
		  }
...
Object Graph_expression_uses_local_name_qm = UNBOUND;
...
Object compile_list_of_graph_expressions_for_slot varargs_1(int, n)
{
    ...
    Object temp, stack_of_slot_value_changes;
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(graph,slot_description),
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,3);
      ...
      PUSH_SPECIAL(Graph_expression_uses_local_name_qm,graph_expression_uses_local_name_qm,
	      2);
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,1);
	  ...
	  if (CONSP(parse_result) && EQ(CAR(parse_result),Qsc)) {
	      ...
	      current_computation_component_particulars = 
		      gensym_cons_1(Qgraph_expression,FIX((SI_Long)1L));
	      PUSH_SPECIAL(Current_computation_component_particulars,current_computation_component_particulars,
		      0);
		...
		goto next_loop;
	      end_loop:
		reclaim_gensym_cons_1(Current_computation_component_particulars);
...
static Object Qautomatic_deadlock_detection_frequency;  /* automatic-deadlock-detection-frequency */
    ...
    Object miscellaneous_parameters;
{
    ...
    x_note_fn_call(204,81);
    PUSH_SPECIAL(Miscellaneous_parameters,miscellaneous_parameters,0);
    ...
    Object miscellaneous_parameters, value, gensymed_symbol;
{
    ...
    PUSH_SPECIAL(Miscellaneous_parameters,miscellaneous_parameters,0);
      ...
      svref_new_value = 
	      delete_gensym_element_1(Qright_click_lifts_to_top_in_native_ui,
	      value);
...
{
    x_note_fn_call(204,89);
    return VALUES_1(ISVREF(Miscellaneous_parameters,(SI_Long)31L));
}

static Object Qdisconnect_dead_connections_qm;  /* disconnect-dead-connections? */

/* DISCONNECT-DEAD-CONNECTIONS?-FROM-SYSTEM-TABLE */
Object disconnect_dead_connections_qm_from_system_table()
{
    x_note_fn_call(204,90);
    return get_lookup_slot_value_given_default(Miscellaneous_parameters,
	    Qdisconnect_dead_connections_qm,Nil);
}

/* DEAD-CONNECTION-TIMEOUT-FROM-SYSTEM-TABLE */
Object dead_connection_timeout_from_system_table()
{
    x_note_fn_call(204,91);
    return VALUES_1(ISVREF(Miscellaneous_parameters,(SI_Long)36L));
}

static Object Quse_unicode_for_filenames_qm;  /* use-unicode-for-filenames? */

/* USE-UNICODE-FOR-FILENAMES?-FROM-SYSTEM-TABLE */
Object use_unicode_for_filenames_qm_from_system_table()
{
    x_note_fn_call(204,92);
    return get_lookup_slot_value_given_default(Miscellaneous_parameters,
	    Quse_unicode_for_filenames_qm,T);
}
...
Object backward_compatible_g2_feature_list_evaluation_getter(slot_value,
    ...
    Object slot_value, frame, slot_description;
{
    x_note_fn_call(204,99);
    GENSYM_RETURN_ONE(slot_value ? 
	    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(slot_value)) 
	    : Nil);
    return VALUES_1(Nil);
}
	...
	if (CONSP(temp)) {
	  ...
	  next_loop:
	    ...
	    set_evaluation_structure_slot(gensymed_symbol_2,Qregion_color,
		    source_region_color);
	    ab_loopvar__1 = gensym_cons_1(gensymed_symbol_2,Nil);
	    if (ab_loopvar_)
		M_CDR(ab_loopvar_) = ab_loopvar__1;
	    else
...
Object G2_meter_names_and_forms = UNBOUND;
    ...
    Object slot_value, frame, slot_description;
{
	...
	goto next_loop;
      end_loop:;
	temp_1 = home_1 ? gensym_list_2(Qhome,home_1) : Nil;
	temp_2 = name ? gensym_list_2(Qname,name) : Nil;
	temp_3 = remote_class_prefix ? gensym_list_2(Qremote_class_prefix,
		remote_class_prefix) : Nil;
	temp = default_remote_class ? gensym_list_2(Qdefault_remote_class,
		default_remote_class) : Nil;
	temp = allocate_evaluation_structure(nconc2(temp_1,nconc2(temp_2,
		nconc2(temp_3,nconc2(temp,nconc2(reference_lookup ? 
		gensym_list_2(Qreference_lookup,reference_lookup) : Nil,
		reference_creation ? gensym_list_2(Qreference_creation,
		reference_creation) : Nil))))));
    }
    GENSYM_RETURN_ONE(temp);
    return VALUES_1(Nil);
...
{
    Object direct_superiors_of_defined_class, symbol, property_name;
    ...
    Object possibly_aliased_slot_name, class_definition;
{
  ...
  end_1:;
    ...
    foundation_class = most_refined_foundation_class_of_direct_superiors(2,
	    direct_superiors_of_defined_class,unaliased_slot_name);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = foundation_class;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(foundation_class) & 
	    IFIX(Most_positive_fixnum);
    gensymed_symbol_3 = (SI_Long)0L;
  next_loop_1:
    if ( !TRUEP(gensymed_symbol))
    ...
    Object evaluation_value, frame, slot_description, gensymed_symbol;
{
	...
	if ( !EQ(temp_1,No_value)) {
	    ...
	    grammar_category_qm = 
		    ...
		    defining_class,Nil);
	    if (EQ(unaliased_slot_name,Qsimulation_details))
		initialization_phrase = gensym_list_3(Kfuncall,
    ...
    Object evaluation_value, frame, slot_description, gensymed_symbol;
{
	...
	if ( !EQ(temp_1,No_value)) {
		...
		initialization_phrase = gensym_list_2(Kfuncall,
    ...
    Object slot_value, frame, slot_description;
{
    ...
    Object new_float, svref_new_value, temp_3;
    SI_Long gensymed_symbol_1, svref_arg_2;
    char temp_1;
    double aref_new_value;
    XDeclare_area(1);
	...
	if (CONSP(slot_value) && EQ(M_CAR(slot_value),
	    ...
	    temp_3 = gensym_cons_1(gensymed_symbol,Qab_structure);
	}
	else {
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    v = CAR(temp);
    if (v) {
	ab_loopvar__2 = gensym_cons_1(p,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	ab_loopvar__1 = ab_loopvar__2;
	ab_loopvar__2 = 
		gensym_cons_1(make_evaluation_value_from_lisp_value(v),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object value, frame, slot_description;
{
    ...
    x_note_fn_call(204,228);
    gensymed_symbol = CDR(value);
    events = CAR(gensymed_symbol);
    gensymed_symbol = CDR(gensymed_symbol);
    modes = CAR(gensymed_symbol);
    temp = gensym_list_2(Qevents,
	    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(events)));
    GENSYM_RETURN_ONE(allocate_evaluation_structure(nconc2(temp,
	    gensym_list_2(Qmodes,
	    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(modes))))));
    return VALUES_1(Nil);
}
...
void grammar7_INIT()
{
    ...
    Object string_constant_178, string_constant_177, Qview_preferences;
    ...
    Object string_constant_176, Qworkspace_title_bar_text, list_constant_395;
    ...
    Object Qwrite_workspace_title_bar_text_from_slot, string_constant_175;
    Object string_constant_174, Qnil_function;
    ...
    Object string_constant_170, Qput_default_window_style;
    ...
    Object Qwrite_initial_margin_for_workspaces_from_slot, string_constant_169;
    ...
    Object string_constant_165, Qcharting_library_type_select;
    Object Qwrite_charting_library_type_select_from_slot;
    Object Qcompile_charting_library_type_select_for_slot, string_constant_164;
    Object Ksystem_frame, Qgrammar7, string_constant_163, string_constant_162;
    ...
    Object Qsystem_table, string_constant_146, string_constant_145;
    Object string_constant_144, string_constant_143, string_constant_142;
    Object Qcheck_ddd_dddd_format, Qsimplify_associative_operation;
    Object Qwrite_date_qm_from_slot, Qdate_qm, Qcompile_date_qm_for_slot;
    ...
    x_note_fn_call(204,230);
    SET_PACKAGE("AB");
    string_constant_101 = 
	    STATIC_STRING("1s1m83*My83-Piy1m83-Piy83-6y1n83BXy1m1m9k83-Z=y1m9k83-Scy83BLy1n83*My1m1m9k83-Z=y1m9k83-Scy83BLy1n83BXy1m1m9k830Jy1m9k83nFy83F5y");
    string_constant_102 = 
	    STATIC_STRING("1n83*My1m1m9k830Jy1m9k83nFy83F5y1n83BXy1m1m9k830Jy1m9k835my83CAy1n83*My1m1m9k830Jy1m9k835my83CAy");
    ...
    string_constant_103 = 
	    STATIC_STRING("13dy1n83-QUy1p1m9k83-l-y1m9k83-qy83*my1m9k83=3y83*my1n9lnp1n83-QUy1v1m9k83=cy1m9k9m1m9k83-qy830Ty1m9k83-Ty1m9k838Dy1m9k831Ly1m9k");
    string_constant_145 = 
	    STATIC_STRING("-tRy1m83-tMy83-tNy1n836qylm9k1o83-tNy1m83VXy83-tRy1n836qylm9k1m83-tMy83=xy1n83-tMy1p83=xy1m9l83*5y83=Zy1m9l831Ay1m9l83A*y1n838Py");
    string_constant_146 = 
	    STATIC_STRING("l1m9l832ny1n83-tMy1o83=xy1m9l83*5y83=Zy1m9l83-oy1n838Pyl1m9l832Ky1o83-tMy1n83=xy1m9l83*5y83J9y1n83J9yln9m1m83=xy83-tOy");
    clear_optimized_constants();
    push_optimized_constant(Qsimplify_associative_operation);
    push_optimized_constant(Qquote);
    ...
    string_constant_148 = 
	    STATIC_STRING("13Ky4z8r83Z-y83Z-y83Vqy83Vqy00001n1l8o1l8l1m8p83Ky000004z8r83D+y83D+y83Vqy83Vqy01o8w9k83=uy83*Ly001n1l8o1l8l1m8p83D+y000004z8r83");
    string_constant_149 = 
	    STATIC_STRING("axy83axy83Vqy83Vqy00001n1l8o1l8l1m8p83Ky000004z8r83NQy83NQy83Vqy83Vqy01m83*9y9l001p1l8o1l8l1l83Hy1l83Fy1m8p83NQy000004z8r83Ify83");
    string_constant_150 = 
	    STATIC_STRING("Ify83Vqy83Vqy00001m1l8l1m8p83Ky000004z8r83H2y83H2y83Vqy83Vqy00001n1l8o1l8l1m8p83H3y000004z8r83a2y83a2y83Vqy83Vqy00001n1l8l1l83Cy");
    string_constant_151 = 
	    STATIC_STRING("1m8p83Ky000004z8r83D1y83D1y83Vqy83Vqy0835oy001o1l8l1l83Hy1l83Ny1m8p83D1y000004z8r83DTy83DTy83Vqy83Vqy00001o1l8l1l83Hy1l83Ny1m8p8");
    string_constant_152 = 
	    STATIC_STRING("3DTy000004z8r83Kuy83Kuy83Vqy83Vqy00001n1l83Ey1l8l1m8p83Ky000004z8r83Ihy83Ihy83Vqy83Vqy00001n1l83Ey1l8l1m8p83Ky000004z8r83JRy83JR");
    string_constant_153 = 
	    STATIC_STRING("y83Vqy83Vqy00001n1l8o1l8l1m8p830Ky000004z8r83Y4y83Y4y83Vqy83Vqy08k001o1m8p83Ky1l8o1l8l1l83Cy000004z8r83H-y83H-y83Vqy83Vqy00001o1");
    string_constant_154 = 
	    STATIC_STRING("m8p83BYy1l8o1l8l1l83Cy000004z8r83Lcy83Lcy83Vqy83Vqy083Py001n1m8p83C3y1l8o1l8l000004z8r83Ldy83Ldy83Vqy83Vqy0n001n1m8p83C2y1l8o1l8");
    string_constant_155 = 
	    STATIC_STRING("l000004z8r83HXy83HXy83Vqy83Vqy083=Oy001n1l8o1l8l1m8p83Ky000004z8r83Huy83Huy83Vqy83Vqy083CUy001o1m8p83B7y1l8o1l8l1l83Cy000004z8r8");
    string_constant_156 = 
	    STATIC_STRING("3ehy83ehy83Vqy83Vqy00001n1l8o1l8l1m8p83Ky000004z8r83S-y83S-y83Vqy83Vqy00001n1l8o1l8l1m8p83Ky000004z8r83GZy83GZy83Vqy83Vqy00001n1");
    string_constant_157 = 
	    STATIC_STRING("l8l1l83Cy1m8p83Ky000004z8r83K*y83K*y83Vqy83Vqy00001n1l8l1l83Cy1m8p83Ky000004z8r83JAy83JAy83Vqy83Vqy03=4y001o1l8o1l8l1l83Cy1m8p83");
    string_constant_158 = 
	    STATIC_STRING("-Vy000004z8r83diy83diy83Vqy83Vqy08k001n1l8l1l83Cy1m8p83Ky00000");
    string_constant_159 = 
	    STATIC_STRING("13My8q1n83Vqy1l83-sy83ey1p83Z-y08o8l1m8p83Ky1p83D+y1o8w9k83=uy83*Ly8o8l1m8p83D+y1p83axy08o8l1m8p83Ky1r83NQy1m83*9y9l8o8l83Hy83Fy");
    string_constant_160 = 
	    STATIC_STRING("1m8p83NQy1o83Ify08l1m8p83Ky1p83H2y08o8l1m8p83H3y1p83a2y01l8l1l83Cy1m8p83Ky1q83D1y835oy8l83Hy1l83Ny1m8p83D1y1q83DTy08l83Hy1l83Ny1");
    string_constant_161 = 
	    STATIC_STRING("m8p83DTy1p83Kuy083Ey8l1m8p83Ky1p83Ihy083Ey8l1m8p83Ky1p83JRy08o8l1m8p830Ky1q83Y4y8k1m8p83Ky8o8l83Cy1q83H-y01m8p83BYy8o8l83Cy1p83L");
    string_constant_162 = 
	    STATIC_STRING("cy83Py1m8p83C3y8o8l1p83Ldyn1m8p83C2y8o8l1p83HXy83=Oy8o8l1m8p83Ky1q83Huy83CUy1m8p83B7y1l8o1l8l1l83Cy1p83ehy08o8l1m8p83Ky1p83S-y08");
    string_constant_163 = 
	    STATIC_STRING("o8l1m8p83Ky1p83GZy01l8l1l83Cy1m8p83Ky1p83K*y01l8l1l83Cy1m8p83Ky1q83JAy3=4y1l8o1l8l1l83Cy1m8p83-Vy1p83diy8k1l8l1l83Cy1m8p83Ky");
    ...
    temp_1 = regenerate_optimized_constant(list(11,string_constant_148,
    ...
    add_class_to_environment(9,Qmiscellaneous_parameters,list_constant_130,
	    ...
	    regenerate_optimized_constant(LIST_5(string_constant_159,
	    string_constant_160,string_constant_161,string_constant_162,
	    string_constant_163)),Nil);
    ...
    string_constant_164 = STATIC_STRING("1m1m83B7y1m9k83CUy1m83B7y1m9k83-aiy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    set_slot_value_to_evaluation_value_function(Qcharting_library_type_select,
	    charting_library_type_select_evaluation_getter_1);
    string_constant_165 = STATIC_STRING("1m1m83BYy83-oy1m83BYy1m9k8329y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_165));
    ...
    Qallow_only_one_table_display_for_item_qm = 
	    ...
	    AB_package);
    Qdisconnect_dead_connections_qm = 
	    STATIC_SYMBOL("DISCONNECT-DEAD-CONNECTIONS\?",AB_package);
    Quse_unicode_for_filenames_qm = 
	    STATIC_SYMBOL("USE-UNICODE-FOR-FILENAMES\?",AB_package);
    ...
    string_constant_166 = 
	    STATIC_STRING("1r1m83D+y83Sy1n83-KZy1p1m9k83-YDy1m9k83guy1m9k9l1m9k83Buy1m9k9m83-YEy1n83-KZy1o1m9k83-TMy1m9k83-GWy1m9k83*Xy1m9k9n83-TSy1n83-KZy");
    string_constant_167 = 
	    STATIC_STRING("1p1m9k9o1m9k83-d7y1m9k836+y1m9k83*Xy1m9k83-Nky83-iSy1n83-KZy1q1m9k83-Ypy1m9k83-Kjy1m9k83-Ty1m9k83*qy1m9k83*Xy1m9k83-Nky83-Yqy1n8");
    string_constant_168 = 
	    STATIC_STRING("3-KZy1q1m9k83-YDy1m9k83-DKy1m9k83R*y1m9k83*Xy1m9k832oy1m9k83-gqy83-YGy1n83-KZy1r1m9k9p1m9k83*ly1m9k839Xy1m9k83=Iy1m9k9q1m9k83-7G");
    string_constant_169 = STATIC_STRING("y1m9k83-WTy83-Twy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_170 = 
	    STATIC_STRING("1q1m83C3y1m9k83Py1m83C3y1m9k9l1m83C3y1m9k83-T8y1m83C3y1m9k83-Kly1m83C3y1m9k83-UEy1m83C2y83*7y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_171 = 
	    STATIC_STRING("1x1m83DUy1m9k83Py1m83DUy83-Uy1m83DWy83-Uy1m83DVy832fy1m9l83-tqy1m83Aty1m9k8329y1m83Aty83-tqy1n83-tqy1m1m9k835+y83-cIy1lm1n83-tqy");
    string_constant_172 = 
	    STATIC_STRING("1m1m9k835+y83-oy1lm1n83-tqy1s1m9k835+y83-cIy1m9k83=Uy83-oy1m9k83vy1m9k83-vHy1m9k83-NAy1m9k9m1mmo1n83-tqy1s1m9k835+y83-oy1m9k83=U");
    string_constant_173 = 
	    STATIC_STRING("y83-cIy1m9k83vy1m9k83-vHy1m9k83-NAy1m9k9m1mmo1n83-cIy1m83Sy1m9k83Djyl1n83-cIy1m83Sy1m9k9nl");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qclose_log_file);
    push_optimized_constant(Qfirst);
    push_optimized_constant(Qmessage);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_3(string_constant_171,
    ...
    mutate_global_property(Qworkspace_title_bar_text,T,
	    Quse_slot_value_compiler_for_default_overrides_p);
    string_constant_174 = 
	    STATIC_STRING("1t1o833cy1m9k83Py09l1m833cy83-rny1m83-rny83-o7y1m83-rny83-Niy1m83-o7y83-Uy1n83-o7y1m1m9k9m1m9k83-Gy83-Gy1n83-o7y1n1m9k9m1m9k83*J");
    string_constant_175 = 
	    STATIC_STRING("y1m9k83-X0y83-qLy1n83-Niy1r1m9k9m1m9k83=hy1m9k8312y1m9k83=by1m9k83vy1m9k83XKy83-o7y1m83=hyr1n83-Niy1m1m9k9m1m9k83=hy83=hy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qnil_function);
    push_optimized_constant(Qthe);
    add_grammar_rules_function(regenerate_optimized_constant(LIST_2(string_constant_174,
	    string_constant_175)));
    ...
    string_constant_176 = 
	    STATIC_STRING("1n1n83-ury1m1m9k83-Ggy1m9k83R*y2l83-uuy8k1n83-ury1m9k83-thy2l83-thy8k1n83-ury1m1m9k83wOy1m9k83nGy2l83-Txy8k");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    set_slot_value_to_evaluation_value_function(Qview_preferences,
	    view_preferences_evaluation_getter_1);
    string_constant_177 = 
	    STATIC_STRING("1n1n83Asy1m1m9k830Py83-ZYy1m830Pym1n83Asy1q1m9k830Py83-ZYy1m9k83vy1m9k839Zy1m9k83*Xy839Sy1n830Pymq1n83Asy1m9k8329y1m830Py0");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_177));
    string_constant_178 = 
	    STATIC_STRING("1n1m83-ZXy1m9k831iy1m83-ZXy1m9k834Wy1n83-ZXy1m1m9k83Cxy1m9k83=+y836iy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
