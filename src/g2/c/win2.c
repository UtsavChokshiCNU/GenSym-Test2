...
void windows2_INIT()
{
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83nwy1n83nwy8n8k1l8n0000001l1n8y83-6By1p83--=y83-F=y83-F+y83-F-y83-F*ykrk0k0");
    ...
    string_constant_9 = STATIC_STRING("1q83nwy8s83-rOy09k9l");
