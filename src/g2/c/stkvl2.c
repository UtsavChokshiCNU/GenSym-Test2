    ...
    Object expression;
{
    ...
    Stack_nodes_to_reclaim = gensym_cons_1(gensymed_symbol,
	...
	if (possible_indexed_attribute_qm)
	    temp = indexed_attribute_new_domain_qm ? 
		    gensym_cons_1(convert_expression_to_stack_node_tree(indexed_attribute_new_domain_qm),
		    Nil) : Nil;
	else {
	    domain = Nil;
	  ...
	  next_loop:
	    ...
	    ab_loopvar__2 = 
		    gensym_cons_1(convert_expression_to_stack_node_tree(domain),
		    Nil);
	    if (ab_loopvar__1)
	...
	svref_new_value = gensym_cons_1(temp_1,temp);
    ...
    Object expression;
{
    ...
    x_note_fn_call(209,8);
    gensymed_symbol = make_stack_node_instruction_1_1(Qexists,Nil);
    Stack_nodes_to_reclaim = gensym_cons_1(gensymed_symbol,
	    Stack_nodes_to_reclaim);
    instruction_node = gensymed_symbol;
    svref_new_value = 
	    gensym_cons_1(convert_expression_to_stack_node_tree(SECOND(expression)),
	    Nil);
    SVREF(instruction_node,FIX((SI_Long)2L)) = svref_new_value;
    GENSYM_RETURN_ONE(instruction_node);
    return VALUES_1(Nil);
...
Object eval_current_subsecond_real_time_funcalled()
{
    ...
    aref_new_value = temp_1 - DFLOAT_ISAREF_1(G2_time_at_start,(SI_Long)0L);
    DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
    return VALUES_1(new_float);
}
    ...
    Object expression;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = 
	    gensym_cons_1(convert_expression_to_stack_node_tree(argument),Nil);
    if (ab_loopvar_)
    ...
    Object top_of_stack, local_stack;
{
	...
	reclaim_gensym_cons_1(unknown_allowed_arg);
    ...
    Object top_of_stack, local_stack;
{
	...
	reclaim_gensym_cons_1(evaluation_truth_value);
...
{
    Object e_float_1, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float, temp_1;
    Object e_float_2, result_1;
    SI_Long result_2;
    char temp_3;
    double aref_new_value, float_register_1, temp_2, arg, arg_1;

    x_note_fn_call(209,69);
	...
	if (FIXNUMP(number_1))
		...
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(number_1)) == (SI_Long)1L) {
	    temp_1 = convert_g2longint_to_double(aref1(number_1,
		    FIX((SI_Long)0L)));
	...
	if (FIXNUMP(number_2))
		...
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(number_2)) == (SI_Long)1L) {
	    temp_1 = convert_g2longint_to_double(aref1(number_2,
		    FIX((SI_Long)0L)));
	    aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	}
	else
    ...
    temp_2 = DOUBLE_FLOAT_TO_DOUBLE(Most_positive_fixnum_as_float);
    arg = float_register_1 - temp_2;
	...
	temp_2 = DOUBLE_FLOAT_TO_DOUBLE(Most_negative_fixnum_as_float);
	arg = temp_2 - float_register_1;
	arg_1 = DOUBLE_FLOAT_TO_DOUBLE(Rational_float_epsilon);
	temp_3 = arg > arg_1 &&  !inline_nanp_for_comparison(arg) ?  
		!inline_nanp_for_comparison(arg_1) : TRUEP(Qnil);
    }
...
Object Random_real_0_result = UNBOUND;
...
Object random_real_0()
{
    ...
    temp_1 = coerce(g2_random(Most_positive_fixnum),Qdouble_float);
    temp_2 = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
    temp_3 = DOUBLE_FLOAT_TO_DOUBLE(Plus_recip_most_positive_fixnum_plus);
...
{
    Object numerator_ef, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float, temp_1;
    Object denominator_ef;
    SI_int64 n_1, d;
    double aref_new_value;

    x_note_fn_call(209,74);
	...
	if (INLINE_DOUBLE_FLOAT_VECTOR_P(numerator_1) != (SI_Long)0L && 
		...
		aref_new_value = (double)IFIX(numerator_1);
		    ...
		    (SI_Long)1L) {
		temp_1 = convert_g2longint_to_double(aref1(numerator_1,
			FIX((SI_Long)0L)));
		aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	    }
	    else
	...
	if (INLINE_DOUBLE_FLOAT_VECTOR_P(denominator_1) != (SI_Long)0L && 
		...
		aref_new_value = (double)IFIX(denominator_1);
		    ...
		    (SI_Long)1L) {
		temp_1 = convert_g2longint_to_double(aref1(denominator_1,
			FIX((SI_Long)0L)));
		aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	    }
	    else
	...
	temp_1 = aref1(numerator_1,FIX((SI_Long)0L));
	n_1 = INTEGER_TO_INT64(temp_1);
	temp_1 = aref1(denominator_1,FIX((SI_Long)0L));
	d = INTEGER_TO_INT64(temp_1);
	temp_1 = make_evaluation_long(minus(INT64_TO_INTEGER(n_1),
...
{
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, remainder_result;
    double aref_new_value;

    x_note_fn_call(209,75);
    amf_available_array_cons_qm = 
	    ISVREF(Vector_of_simple_float_array_pools,(SI_Long)1L);
    if (amf_available_array_cons_qm) {
	amf_array = M_CAR(amf_available_array_cons_qm);
    ...
    Object quantity;
{
	...
	result_1 = gensym_cons_1(result_1,Qtruth_value);
...
Object eval_truth_value_integer_funcalled(integer_arg)
    Object integer_arg;
{
    Object integer_value, result_1, new_cons, gensymed_symbol;

    x_note_fn_call(209,79);
    ...
    Object pattern, evaluator_name, preprocessor_errors_qm;
{
    ...
    x_note_fn_call(209,96);
    PUSH_SPECIAL(Preprocessor_errors_qm,preprocessor_errors_qm,0);
...
{
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, text_length, end_index;
    Object start_index, number_qm, kind;
    double aref_new_value;
    XDeclare_area(1);
    XDeclare_frontier(1);
    Object result;

    x_note_fn_call(209,109);
    ...
    Object truth_value;
{
    ...
    if ( !(EQ(truth_value,Evaluation_true_value) || EQ(truth_value,
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(truth_value);
    return VALUES_1(result_1);
}
    ...
    Object text;
{
    ...
    Object svref_new_value, amf_result, incff_1_arg, new_float, temp_2;
    char temp_3;
    double aref_new_value;
    Declare_special(1);
    XDeclare_area(1);
    ...
    x_note_fn_call(209,112);
    text_value = text;
    PUSH_SPECIAL(Text_value,text_value,0);
	  ...
	  if (FIXNUM_GE(start_index,end_index)) {
		  ...
		  if (EQ(FIX((SI_Long)0L),result_1)) {
		      temp_2 = minus(end_index,start_index);
		      temp = FIX((SI_Long)10L);
		      temp_3 = NUM_LT(temp_2,temp);
		  }
		  else
		      temp_3 = TRUEP(Nil);
		  if (temp_3)
    ...
    Object text;
{
    ...
    Object extended_code, unicode, gensym_character_code_qm;
    ...
    Object symbol;
    SI_Long length_1, i, ab_loop_bind_, row, gensym_full_row, gensymed_symbol;
...
Object Day_of_the_week_names = UNBOUND;
...
{
    Object given_name, relation_instances, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, relation_instance_form, the_block, blocks;
    Object result_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(209,127);
    ...
    Object given_relation_name, item1, item2;
{
	...
	temp = TRUEP(Nil);
    result_1 = temp ? Evaluation_false_value : Evaluation_true_value;
    return VALUES_1(result_1);
}
    ...
    Object truth_value;
{
	...
	temp = gensym_cons_1(result_value,Qtruth_value);
    return VALUES_1(temp);
}
    ...
    Object expression;
{
  ...
  end_loop:
    ...
    svref_new_value = gensym_cons_1(temp,arg_nodes);
    ...
    Object expression;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(compile_stack_expression(arg,
		Qitem_or_datum),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__1 = 
		gensym_cons_1(convert_expression_to_stack_node_tree(argument),
		Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
    ...
    Object item1, item2;
{
    ...
    Object ab_less_than_branch_qm_, the_block, blocks, gensymed_symbol_1;
    Object gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;
    Declare_special(1);

    x_note_fn_call(209,151);
    relation_instances = ISVREF(item2,(SI_Long)12L);
    if (relation_instances) {
	...
	next_loop_2:
	  ...
	  if (gensymed_symbol_2 < gensymed_symbol_3)
	    ...
	    next_loop_3:
	      ...
	      gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
	      if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
		  ab_loop_it_ = M_CDR(M_CAR(gensymed_symbol));
		  goto end_1;
	      }
	      gensymed_symbol = M_CDR(gensymed_symbol);
	      goto next_loop_3;
...
Object eval_is_of_class_funcalled(item_or_datum_to_test,type_or_class)
    Object item_or_datum_to_test, type_or_class;
{
    Object type_specification_of_user_type_qm, result_1, x, gensymed_symbol;
	...
	if (FIXNUM_EQ(result_1,Truth))
	    ...
	    temp_1 = gensym_cons_1(result_1,Qtruth_value);
    }
    else
	temp_1 = Evaluation_false_value;
    return VALUES_1(temp_1);
    ...
    Object block1, block2;
{
  ...
  end_loop:
    ...
    result_1 = Qnil;
  end_1:;
    reclaim_gensym_tree_1(connected_items_qm);
    return VALUES_1(result_1);
}
    ...
    Object item, module, search_hierarchy_p;
{
	...
	reclaim_gensym_cons_1(search_hierarchy_p);
    return VALUES_1(result_1);
}
		...
		PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		  ...
		  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		    ...
		    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			  ...
			  temp = TRUEP(Nil);
		      temp_1 = temp ? g2_text : g2_text;
		      tformat(4,string_constant_58,evaluator_name,temp_1,
    ...
    Object lat1, long1, lat2, long2, radius;
{
    ...
    double gensymed_symbol_1, temp_3, sin_value, gensymed_symbol_2;
    double gensymed_symbol_3, gensymed_symbol_4, gensymed_symbol_5;
    double aref_new_value;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(209,194);
	...
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(lat1_value);
	temp_1 = DOUBLE_FLOAT_TO_DOUBLE(lat2_value);
	sin_value = sin((temp_3 - temp_1) / 2.0);
	gensymed_symbol_2 = sin_value * sin_value;
	temp_1 = DOUBLE_FLOAT_TO_DOUBLE(lat1_value);
	gensymed_symbol_3 = cos(temp_1);
	temp_1 = DOUBLE_FLOAT_TO_DOUBLE(lat2_value);
	gensymed_symbol_4 = cos(temp_1);
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(long1_value);
	temp_1 = DOUBLE_FLOAT_TO_DOUBLE(long2_value);
	sin_value = sin((temp_3 - temp_1) / 2.0);
    ...
    Object expression;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(convert_expression_to_stack_node_tree(arg),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
    ...
    Object printed_representation_text;
{
    ...
    x_note_fn_call(209,223);
    write_strings_parsably_qm = T;
    result_1 = Nil;
    PUSH_SPECIAL(Write_strings_parsably_qm,write_strings_parsably_qm,5);
      current_wide_string_list = Qdo_not_use;
      PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		(SI_Long)3L));
    ...
    Object top_of_stack, local_stack;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(gensym_cons_1(seq,
  ...
  next_loop_2:
    ...
    goto next_loop_2;
  end_loop_2:;
    reclaim_gensym_list_1(sequence_pairs);
...
Object eval_with_unsaved_changes_funcalled(item)
    Object item;
{
    x_note_fn_call(209,260);
    return VALUES_1(item_has_unsaved_changes_p(item) ? 
	    Evaluation_true_value : Evaluation_false_value);
}

Object Mark_for_modules_with_unsaved_changes = UNBOUND;
    ...
    Object arg_compareoperator;
{
    ...
    x_note_fn_call(209,265);
    temp = kb_g2nke_count_history_matching_op(arg_subj,arg_n,arg_nstart,
	    arg_fellow_val,arg_requiredgoodsize,arg_compareoperator);
    return VALUES_1(temp);
}

Object Cached_subj = UNBOUND;

Object Cached_n = UNBOUND;

Object Cached_nstart = UNBOUND;

Object Cached_fellow_val = UNBOUND;

Object Cached_eventflag = UNBOUND;

Object Cached_event_bit = UNBOUND;

Object Cached_requiredgoodsize = UNBOUND;

Object Cached_compareoperator = UNBOUND;

Object Cached_result = UNBOUND;
...
Object eval_is_resized_by_the_user_funcalled(item)
    Object item;
{
    x_note_fn_call(209,270);
    return VALUES_1(Evaluation_true_value);
}

/* EVAL-NUMBER-OF-ARGUMENTS-FOR-PROCEDURE-FUNCALLED */
Object eval_number_of_arguments_for_procedure_funcalled(proc)
    Object proc;
{
    Object result_1;

    x_note_fn_call(209,271);
    result_1 = ISVREF(proc,(SI_Long)23L);
    return VALUES_1(result_1);
}
...
void stack_eval2_INIT()
{
    ...
    Object Qeval_number_of_arguments_for_procedure_funcalled;
    Object Qpprint_functional_evaluator, list_constant_107, list_constant_19;
    Object Qnumber_of_arguments_for_procedure, AB_package, list_constant_106;
    Object list_constant_96, Qeval_is_resized_by_the_user_funcalled;
    Object list_constant_22, list_constant_55, Qis_resized_by_the_user;
    ...
    Object Qin_the_tracked_item_set, Qeval_network_interface_for_funcalled;
    Object list_constant_97, Qnetwork_interface_for, Qnetwork_interface;
    Object Qeval_find_java_class_funcalled, list_constant_33, Qfind_java_class;
    Object Qprocedure, Qeval_remove_evaluated_attribute_funcalled;
    Object list_constant_95, list_constant_67, Qstack_special_form_converter;
    ...
    Object Qeval_current_real_time_in_line, Qcurrent_real_time;
    ...
    register_funcalled_evaluator(make_evaluator_description(Qis_resized_by_the_user,
	    ...
	    Funcall_eval_type_1_arg);
    Qnumber_of_arguments_for_procedure = 
	    STATIC_SYMBOL("NUMBER-OF-ARGUMENTS-FOR-PROCEDURE",AB_package);
    list_constant_106 = STATIC_CONS(Qab_class,list_constant_96);
    list_constant_107 = STATIC_CONS(list_constant_106,Qnil);
    Qeval_number_of_arguments_for_procedure_funcalled = 
	    STATIC_SYMBOL("EVAL-NUMBER-OF-ARGUMENTS-FOR-PROCEDURE-FUNCALLED",
	    AB_package);
    SET_SYMBOL_FUNCTION(Qeval_number_of_arguments_for_procedure_funcalled,
	    STATIC_FUNCTION(eval_number_of_arguments_for_procedure_funcalled,
	    NIL,FALSE,1,1));
    register_funcalled_evaluator(make_evaluator_description(Qnumber_of_arguments_for_procedure,
	    Qnumber_of_arguments_for_procedure,FIX((SI_Long)1L),
	    list_constant_19,list_constant_107,Qinteger,Qnil,
	    SYMBOL_FUNCTION(Qeval_number_of_arguments_for_procedure_funcalled),
	    Nil,FIX((SI_Long)151L),Nil,
	    SYMBOL_FUNCTION(Qpprint_functional_evaluator),
	    Qeval_number_of_arguments_for_procedure_funcalled),
	    FIX((SI_Long)151L),Funcall_eval_type_1_arg);
}
