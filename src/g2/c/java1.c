    ...
    Object external_procedure, slot_value, initializing_p;
{
    ...
    Object gensymed_symbol_4, temp_2, stack_of_slot_value_changes;
    Object gensymed_symbol_5, gensymed_symbol_6, frame_and_slot_or_atom;
    Object ab_loop_list_, ab_loop_it_, gensym_pop_store, cons_1, next_cons;
	...
	if (temp) {
	    ...
	    if (Nil)
		gensymed_symbol_4 = 
			nconc2(gensym_list_2(external_procedure,
	    ...
	    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		  ...
		  svref_new_value = IFIX(ISVREF(external_procedure,
    ...
    Object mouse_pointer;
{
	...
	if (temp ?  
	    ...
	    return make_partial_command(Qedit_external_procedure,
		    gensym_cons_1(snapshot_command_argument(temp_1),Nil));
	}
	else
	    return VALUES_1(Nil);
    }
...
Object Analyzing_export_definition_for_consistency_p = UNBOUND;
    ...
    Object delete_as_item_referring_to_name_qm;
{
    ...
    PUSH_SPECIAL(Delete_as_item_referring_to_name_qm,delete_as_item_referring_to_name_qm,
	    3);
	...
	else if ( !TRUEP(Analyzing_export_definition_for_consistency_p)) {
	    compiled_item_being_analyzed = export_definition;
	    analyzing_export_definition_for_consistency_p = T;
	    PUSH_SPECIAL(Analyzing_export_definition_for_consistency_p,analyzing_export_definition_for_consistency_p,
		    1);
	      PUSH_SPECIAL(Compiled_item_being_analyzed,compiled_item_being_analyzed,
		      0);
		delete_all_consistency_analysis_frame_notes(1,
			export_definition);
		result = analyze_export_definition_for_consistency(export_definition);
	      POP_SPECIAL();
	    POP_SPECIAL();
	}
	else
    ...
    Object export_definition;
{
  ...
  next_loop:
	...
	classes_encountered = gensym_cons_1(export_class,classes_encountered);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(classes_encountered);
...
Object Collecting_frame_notes_for_class_export_p = UNBOUND;

Object Collected_frame_notes_for_class_export_qm = UNBOUND;
    ...
    Object external_definition;
{
	...
	if (EQ(language,Qjava)) {
	  ...
	  next_loop:
		...
		PUSH_SPECIAL(Collecting_frame_notes_for_class_export_p,collecting_frame_notes_for_class_export_p,
			6);
		  collected_frame_notes_for_class_export_qm = Nil;
		  PUSH_SPECIAL(Collected_frame_notes_for_class_export_qm,collected_frame_notes_for_class_export_qm,
			  5);
		    temp_1 = class_name;
...
Object Chain_of_available_java_symbols = UNBOUND;

Object Java_symbol_count = UNBOUND;
    ...
    Object java_symbol;
{
    ...
    svref_new_value = Chain_of_available_java_symbols;
    SVREF(java_symbol,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_symbols = java_symbol;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_java_symbol_variable, java_symbol_count_new_value;
    ...
    java_symbol_count_new_value = FIXNUM_ADD1(Java_symbol_count);
    Java_symbol_count = java_symbol_count_new_value;
...
Object The_java_symbol_table = UNBOUND;
    ...
    Object stringw_1;
{
    ...
    The_java_symbol_table = gensym_cons_1(java_symbol,The_java_symbol_table);
    return VALUES_1(java_symbol);
}

Object The_type_description_of_java_class = UNBOUND;

Object Chain_of_available_java_classs = UNBOUND;

Object Java_class_count = UNBOUND;
    ...
    Object java_class;
{
    ...
    svref_new_value = Chain_of_available_java_classs;
    SVREF(java_class,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_classs = java_class;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_java_class_variable, java_class_count_new_value;
    Object defstruct_g2_java_class_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(251,35);
    def_structure_java_class_variable = Nil;
    java_class_count_new_value = FIXNUM_ADD1(Java_class_count);
    Java_class_count = java_class_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_java_class_variable;
...
Object Chain_of_available_java_descriptors = UNBOUND;

Object Java_descriptor_count = UNBOUND;
    ...
    Object java_descriptor;
{
    ...
    svref_new_value = Chain_of_available_java_descriptors;
    SVREF(java_descriptor,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_descriptors = java_descriptor;
    return VALUES_1(Nil);
}
...
Object make_permanent_java_descriptor_structure_internal()
{
    ...
    Object java_descriptor_count_new_value;
    ...
    java_descriptor_count_new_value = FIXNUM_ADD1(Java_descriptor_count);
    Java_descriptor_count = java_descriptor_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_java_fields = UNBOUND;

Object Java_field_count = UNBOUND;
    ...
    Object java_field;
{
    ...
    svref_new_value = Chain_of_available_java_fields;
    SVREF(java_field,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_fields = java_field;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_java_field_variable, java_field_count_new_value;
    Object defstruct_g2_java_field_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(251,47);
    def_structure_java_field_variable = Nil;
    java_field_count_new_value = FIXNUM_ADD1(Java_field_count);
    Java_field_count = java_field_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_java_field_variable;
...
Object Chain_of_available_java_methods = UNBOUND;

Object Java_method_count = UNBOUND;
    ...
    Object java_method;
{
    ...
    svref_new_value = Chain_of_available_java_methods;
    SVREF(java_method,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_methods = java_method;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_java_method_variable, java_method_count_new_value;
    ...
    java_method_count_new_value = FIXNUM_ADD1(Java_method_count);
    Java_method_count = java_method_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_java_code_exceptions = UNBOUND;

Object Java_code_exception_count = UNBOUND;
    ...
    Object java_code_exception;
{
    ...
    svref_new_value = Chain_of_available_java_code_exceptions;
    SVREF(java_code_exception,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_code_exceptions = java_code_exception;
    return VALUES_1(Nil);
}
...
Object make_permanent_java_code_exception_structure_internal()
{
    ...
    Object java_code_exception_count_new_value;
    ...
    java_code_exception_count_new_value = 
	    FIXNUM_ADD1(Java_code_exception_count);
    Java_code_exception_count = java_code_exception_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_java_codes = UNBOUND;

Object Java_code_count = UNBOUND;
    ...
    Object java_code;
{
    ...
    svref_new_value = Chain_of_available_java_codes;
    SVREF(java_code,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_java_codes = java_code;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_java_code_variable, java_code_count_new_value;
    Object defstruct_g2_java_code_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(251,65);
    def_structure_java_code_variable = Nil;
    java_code_count_new_value = FIXNUM_ADD1(Java_code_count);
    Java_code_count = java_code_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_java_code_variable;
...
Object Chain_of_available_class_file_streams = UNBOUND;

Object Class_file_stream_count = UNBOUND;
    ...
    Object class_file_stream;
{
    ...
    svref_new_value = Chain_of_available_class_file_streams;
    SVREF(class_file_stream,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_class_file_streams = class_file_stream;
    return VALUES_1(Nil);
}
...
Object make_permanent_class_file_stream_structure_internal()
{
    ...
    Object class_file_stream_count_new_value;
    ...
    class_file_stream_count_new_value = FIXNUM_ADD1(Class_file_stream_count);
    Class_file_stream_count = class_file_stream_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object cfs;
{
	...
	switch (INTEGER_TO_CHAR(temp)) {
	  case 7:
	    return gensym_list_2(Qab_class,cfs_read_u2(cfs));
	  case 9:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qfieldref,temp,cfs_read_u2(cfs));
	  case 10:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qmethodref,temp,cfs_read_u2(cfs));
	  case 11:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qinterfacemethoddref,temp,cfs_read_u2(cfs));
	  case 8:
	    if (Debug_read_java_class_p)
		format((SI_Long)2L,T,"in the string case~%");
	    return gensym_list_2(Qstring,cfs_read_u2(cfs));
	  case 3:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qinteger,temp,cfs_read_u2(cfs));
	  case 4:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qinteger,temp,cfs_read_u2(cfs));
	  case 5:
	  ...
	  case 12:
	    temp = cfs_read_u2(cfs);
	    return gensym_list_3(Qnameandtype,temp,cfs_read_u2(cfs));
	  case 1:
    ...
    Object jc, cfs, owner_type;
{
  ...
  next_loop:
	...
	if (source_file_constant_qm && 
	    ...
	    attribute = gensym_list_2(Qsource_file,source_file_constant_qm);
	else
	    error((SI_Long)2L,"class file reading error ~s",
	...
	if (constant_value_constant_qm && 
	    ...
	    attribute = gensym_list_2(Qab_constant_value,
	...
	attribute = gensym_list_2(Qcode,read_java_code(jc,cfs,owner_type));
    ...
    Object descriptor;
{
  ...
  next_loop:
	...
	argument_types = gensym_cons_1(type,argument_types);
	i = new_i;
    }
    goto next_loop;
  end_loop:
    ...
    Object descriptor, position_1;
{
	...
	switch ((char)temp) {
	  ...
	  case 91:
	    ...
	    temp_1 = gensym_list_2(Qarray,sub_type);
...
Object Current_jemit_text_style_qm = UNBOUND;
...
Object Deferring_errors_for_class_export_p = UNBOUND;

Object Deferred_errors_for_class_export_qm = UNBOUND;
    ...
    Object class_path, unzipped_class_directory, override_parent_qm;
{
  ...
  end_1:;
	...
	PUSH_SPECIAL(Deferring_errors_for_class_export_p,deferring_errors_for_class_export_p,
		1);
	  deferred_errors_for_class_export_qm = Nil;
	  PUSH_SPECIAL(Deferred_errors_for_class_export_qm,deferred_errors_for_class_export_qm,
		  0);
    ...
    Object additional_methods_qm;
{
    ...
    PUSH_SPECIAL(Current_jemit_text_style_qm,current_jemit_text_style_qm,0);
    ...
    Object out, class_description, unique_names;
{
  ...
  next_loop:
    ...
    current_wide_string_list = Qdo_not_use;
    PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,5);
      wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
	      (SI_Long)3L));
      bv16_length = IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(wide_string_bv16));
      aref_arg_2 = bv16_length - (SI_Long)2L;
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  if (temp_1) {
			  ...
			  if (FIXNUM_EQ(managed_value,Truth))
			      ...
			      initial_value = gensym_cons_1(managed_value,
				      Qtruth_value);
		      }
		      else
...
Object Collecting_exported_method_text_p = UNBOUND;

Object List_of_exported_method_texts = UNBOUND;
    ...
    Object out, class_description, methods, static_p;
{
  ...
  next_loop:
	...
	List_of_exported_method_texts = 
		gensym_cons_1(exported_method_text_qm,
		List_of_exported_method_texts);
    goto next_loop;
  end_loop:
    return VALUES_1(Qnil);
...
Object Current_jemit_stream = UNBOUND;

Object Current_jemit_indent = UNBOUND;

Object Current_jemit_node_stack = UNBOUND;

Object Current_jemit_compound_statement_list = UNBOUND;

Object Current_jemit_return_type_specification_qm = UNBOUND;

Object Current_jemit_class_description = UNBOUND;

Object Current_jemit_class_object_table = UNBOUND;

Object Current_jemit_self_name = UNBOUND;

Object Current_jemit_locals = UNBOUND;

Object Current_jemit_args = UNBOUND;
    ...
    Object out, class_description, method, static_p;
{
    ...
    x_note_fn_call(251,113);
    temp = ISVREF(method,(SI_Long)20L);
    compiled_gesture = CAR(temp);
    name = CAR(compiled_gesture);
    current_jemit_args = CADR(compiled_gesture);
    PUSH_SPECIAL(Current_jemit_args,current_jemit_args,14);
      returns = CADDR(compiled_gesture);
      current_jemit_locals = CADDDR(compiled_gesture);
      PUSH_SPECIAL(Current_jemit_locals,current_jemit_locals,13);
	body = FIFTH(compiled_gesture);
	current_jemit_class_object_table = Nil;
	PUSH_SPECIAL(Current_jemit_class_object_table,current_jemit_class_object_table,
		12);
	  current_jemit_stream = out;
	  PUSH_SPECIAL(Current_jemit_stream,current_jemit_stream,11);
	    current_jemit_indent = FIX((SI_Long)4L);
	    PUSH_SPECIAL(Current_jemit_indent,current_jemit_indent,10);
	      current_jemit_node_stack = Nil;
	      PUSH_SPECIAL(Current_jemit_node_stack,current_jemit_node_stack,
		      9);
		current_jemit_self_name = CAAR(Current_jemit_args);
		PUSH_SPECIAL(Current_jemit_self_name,current_jemit_self_name,
			8);
		  current_jemit_class_description = class_description;
		  PUSH_SPECIAL(Current_jemit_class_description,current_jemit_class_description,
			  7);
		    current_jemit_compound_statement_list = CADR(body);
		    PUSH_SPECIAL(Current_jemit_compound_statement_list,current_jemit_compound_statement_list,
			    6);
		      current_jemit_return_type_specification_qm = 
			      CAR(returns);
		      PUSH_SPECIAL(Current_jemit_return_type_specification_qm,current_jemit_return_type_specification_qm,
			      5);
    ...
    Object locals;
{
    ...
    x_note_fn_call(251,116);
    current_jemit_indent = FIX(IFIX(Current_jemit_indent) + (SI_Long)4L);
    PUSH_SPECIAL(Current_jemit_indent,current_jemit_indent,5);
      name = Nil;
      type = Nil;
...
void java1_INIT()
{
    ...
    Object list_constant_11, AB_package, Qarray_length, list_constant_39;
    Object string_constant_158, list_constant_19, Qarray_element;
    Object Qnth_sequence_element, list_constant_38, string_constant_157;
    Object list_constant_20, string_constant_156, Qconditional, Qif_expression;
    Object list_constant_37, list_constant_36, string_constant_155;
    Object string_constant_154, Qless_than_equal, Qless_than_equal_fixnum;
    Object Qgreater_than_equal_quantity, list_constant_35, list_constant_23;
    Object Qrelational, Qless_than, Qless_than_fixnum, Qless_than_quantity;
    Object list_constant_34, string_constant_153, Qgreater_than_equal;
    Object Qgreater_than_equal_fixnum, list_constant_33, Qgreater_than;
    Object Qgreater_than_fixnum, Qgreater_than_quantity, list_constant_32;
    Object string_constant_152, Qequal_fixnum, Qequal_quantity;
    Object list_constant_31, string_constant_151, Qequality, Qbitwise_and;
    Object list_constant_30, string_constant_150, Qbitwise_or;
    Object list_constant_29, string_constant_149, Qior, Qnegate, Qnegate_float;
    Object Qnegate_quantity, Qnegate_fixnum, list_constant_28;
    Object list_constant_27, string_constant_148, Qremainder, Qremainder_float;
    Object Qremainder_quantity, Qremainder_fixnum, list_constant_26;
    Object string_constant_147, Qmultiplicative, Qdivide, Qdivide_float;
    Object Qdivide_fixnum, list_constant_25, Qquotient, Qquotient_float;
    Object Qquotient_quantity, Qquotient_fixnum, string_constant_146;
    Object Qmultiply, Qmultiply_float, Qmultiply_quantity, Qmultiply_fixnum;
    Object list_constant_24, string_constant_145, Qsubtract, Qsubtract_float;
    Object Qsubtract_quantity, Qsubtract_fixnum, list_constant_22;
    Object string_constant_144, Qadditive, Qg2_add, Qadd_float, Qadd_quantity;
    Object Qadd_fixnum, list_constant_21, string_constant_143;
    Object list_constant_18, Qconditional_or, Qconditional_and, Qab_xor;
    Object Qshift, Qpostfix, list_constant_17, Qitem_or_datum, Qno_item;
    ...
    Object Qclass_file_stream_count, Qchain_of_available_class_file_streams;
    ...
    Object Qjava_code_count, Qchain_of_available_java_codes;
    Object string_constant_140, string_constant_139, Qjava_code_exception;
    Object Qoutstanding_java_code_exception_count;
    Object Qjava_code_exception_structure_memory_usage;
    Object Qjava_code_exception_count;
    Object Qchain_of_available_java_code_exceptions, string_constant_138;
    Object string_constant_137, Qjava_method, Qoutstanding_java_method_count;
    Object Qjava_method_structure_memory_usage, Qjava_method_count;
    Object Qchain_of_available_java_methods, string_constant_136;
    Object string_constant_135, Qjava_field, Qoutstanding_java_field_count;
    Object Qjava_field_structure_memory_usage, Qjava_field_count;
    Object Qchain_of_available_java_fields, string_constant_134;
    Object string_constant_133, Qjava_descriptor;
    Object Qoutstanding_java_descriptor_count;
    Object Qjava_descriptor_structure_memory_usage, Qjava_descriptor_count;
    Object Qchain_of_available_java_descriptors, string_constant_132;
    Object string_constant_131, Qjava_class, Qoutstanding_java_class_count;
    Object Qjava_class_structure_memory_usage, Qjava_class_count;
    Object Qchain_of_available_java_classs, string_constant_130;
    Object string_constant_129, Qjava_symbol, Qoutstanding_java_symbol_count;
    Object Qjava_symbol_structure_memory_usage, Qjava_symbol_count;
    Object Qchain_of_available_java_symbols, string_constant_128;
    Object string_constant_127, Qg2_export_definitions_system_rpc_internal;
    Object Qg2_export_definitions, Qsystem_defined_rpc, list_constant_16;
    Object list_constant_15, list_constant_14, string_constant_126;
    Object string_constant_125, string_constant_124, string_constant_123;
    Object string_constant_122, string_constant_121, Qslot_value_writer;
    ...
    Object Qexport_specification, Qexport_language, string_constant_120;
    ...
    Object string_constant_110, list_constant_13, Qcreate_icon_description;
    ...
    Object string_constant_100, string_constant_88, string_constant_99;
    Object string_constant_98, string_constant_97, list_constant_12, Qitem;
    Object Qentity, Qedit, list_constant_10, Qduplicate_class_export;
    Object Qput_external_procedure_definition, Qwrite_tw_method_name_from_slot;
    Object Qtw_method_name, Qqualified_name, string_constant_96;
    Object string_constant_95, string_constant_94, string_constant_93;
    Object string_constant_92, Qicon_color, string_constant_91;
    Object string_constant_90, string_constant_89, string_constant_87;
    Object string_constant_86, string_constant_56, Qinitialize;
    Object Qinitialize_for_external_method_declaration, string_constant_85;
    ...
    Object list_constant_9, string_constant_67, string_constant_66;
    ...
    x_note_fn_call(251,141);
    SET_PACKAGE("AB");
    AB_package = STATIC_PACKAGE("AB");
    Qexternal_procedure = STATIC_SYMBOL("EXTERNAL-PROCEDURE",AB_package);
    Qentity = STATIC_SYMBOL("ENTITY",AB_package);
    list_constant_9 = STATIC_LIST((SI_Long)2L,Qblock,Qentity);
    check_if_superior_classes_are_defined(Qexternal_procedure,list_constant_9);
    string_constant_56 = STATIC_STRING("1l1l8t");
    ...
    string_constant_61 = 
	    STATIC_STRING("k000004z8r8u8u8358y8358y01p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk");
    string_constant_62 = 
    ...
    string_constant_64 = 
	    STATIC_STRING("hy1m3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy+s3-1y3-qy3-my3Zy3-eykp3A++y1ms3Hy83-Wy1o83Gy+s3-Cy3-ky3-hy3-Vykko3A++y1ms3Yy83-");
    string_constant_65 = 
	    STATIC_STRING("Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r");
    string_constant_66 = 
	    STATIC_STRING("8359y8359y8358y8358y00001q1n8p83Q5y83Gy1l8o1l8l1l83Cy1l83-3y1l83Uy000004z8r83L1y83L1y8358y8358y00001m1l8o1l8l000004z8r83L2y83L2y");
    string_constant_67 = STATIC_STRING("8358y8358y00001m1l8o1l8l00000");
    string_constant_68 = 
	    STATIC_STRING("1t8q1n8358y1m9k83-+y8t1n83--y01m8p83-*y1n83-0y01m8p83-0y1p83-Fy08l1m8p083Cy1m8u1p8w9l3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83");
    string_constant_69 = 
    ...
    string_constant_71 = 
	    STATIC_STRING("y3ky1mk3ky1mn3hy1n1m3hy3hy1m3hyn1m3ky3ky1n1m3ky3ky1mn3hy1m3hy3hy9m1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy5pExt\'l1ms3Hy83-Wy1o83Gy5o");
    string_constant_72 = 
	    STATIC_STRING("Proc1ms3Yy83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp1s8359y01n8p83Q5y83Gy8o8l83Cy83-3y83Uy1o83L1y08o8l1o83L2y08o");
    string_constant_73 = STATIC_STRING("8l");
    temp = regenerate_optimized_constant(string_constant_56);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    push_optimized_constant(Qicon_color);
    temp_1 = regenerate_optimized_constant(list(11,string_constant_57,
    ...
    push_optimized_constant(Qcreate_icon_description);
    push_optimized_constant(Qicon_color);
    add_class_to_environment(9,Qexternal_procedure,list_constant_9,Nil,
	    temp,Nil,temp_1,list_constant_9,
	    regenerate_optimized_constant(list(6,string_constant_68,
	    string_constant_69,string_constant_70,string_constant_71,
	    string_constant_72,string_constant_73)),Nil);
    ...
    list_constant_10 = STATIC_CONS(Qexternal_procedure,Qnil);
    ...
    string_constant_75 = 
	    STATIC_STRING("9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1m3ky3ky83-ny1q83qy1q1mkk1m3k");
    string_constant_76 = 
    ...
    string_constant_78 = 
	    STATIC_STRING("m3ky3ky1m3kyk1o83Gy+s3-1y3-qy3-my3Zy3-eykp3A++y1ms3Hy83-Wy1o83Gy+s3-0y3-Xy3-Vy3-eykko3A++y1ms3ay83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny");
    string_constant_79 = 
    ...
    string_constant_81 = 
	    STATIC_STRING("1p8q1n83L=y1l8358y8t1p83-Fy08l1m8p83-ky83Cy1m8u1p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=");
    string_constant_82 = 
    ...
    string_constant_84 = 
	    STATIC_STRING("1m3ky3ky1n1m3ky3ky1mn3hy1m3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy5pExt\'l1ms3Hy83-Wy1o83Gy5oDecl1ms3ay83-Wy1o83Oy1m3eyp1mpp1");
    string_constant_85 = 
    ...
    push_optimized_constant(Qcreate_icon_description);
    push_optimized_constant(Qicon_color);
    temp_1 = regenerate_optimized_constant(list(7,string_constant_74,
    ...
    add_class_to_environment(9,Qexternal_method_declaration,
	    list_constant_10,Nil,temp,Nil,temp_1,list_constant_10,
	    regenerate_optimized_constant(LIST_5(string_constant_81,
	    string_constant_82,string_constant_83,string_constant_84,
	    string_constant_85)),Nil);
    ...
    check_if_superior_classes_are_defined(Qexternal_method,list_constant_10);
    string_constant_86 = 
	    STATIC_STRING("1n4z8r8u8u83L-y83L-y01p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1m3k");
    string_constant_87 = 
    ...
    string_constant_89 = 
	    STATIC_STRING("3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy+s3-1y3-qy3-my3Zy3-eykp3A++y1ms3Hy83-Wy1o83Gy+s3-9y3-Xy3-my3-aykko3A++y1mt3ay83-Wy1o");
    string_constant_90 = 
	    STATIC_STRING("83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83L0");
    string_constant_91 = 
	    STATIC_STRING("y83L0y83L-y83L-y00001p1l8o1l8l1l83Cy1l83Fy1m8p83cty000004z8r83L*y83L*y83L-y83L-y00001n1l8o1l8l1l83Cy00000");
    string_constant_92 = 
	    STATIC_STRING("1p8q1n83L-y1l8358y8t1m8u1p8w9k3uy3uy1y1r83-1y2l83-Ly83-Xy2l83-ny83-gy2l83-my83-Ry2l9l83Ty2l83=-y83fy2l83=*y83*Gy83-Ly1n83jy1mkk1");
    string_constant_93 = 
    ...
    string_constant_95 = 
	    STATIC_STRING("y1m3hy3hy9l1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Gy5pExt\'l1ms3Hy83-Wy1o83Gy5oMeth1mt3ay83-Wy1o83Oy1m3eyp1mpp1mp3fy83-ny1o83Oy1mp3fy1");
    string_constant_96 = 
	    STATIC_STRING("m3ey3fy1m3eyp1r83L0y08o8l83Cy83Fy1m8p83cty1p83L*y08o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_56);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    push_optimized_constant(Qicon_color);
    ...
    push_optimized_constant(Qcreate_icon_description);
    push_optimized_constant(Qicon_color);
    add_class_to_environment(9,Qexternal_method,list_constant_10,Nil,temp,
    ...
    make_ui_command(5,Qedit_external_procedure,list_constant_10,Qnil,Qedit,
	    Qnil);
    ...
    list_constant_13 = STATIC_CONS(Qitem,list_constant_12);
    check_if_superior_classes_are_defined(Qexport_definition,list_constant_13);
    string_constant_97 = STATIC_STRING("1m1l83Iy1l8t");
    string_constant_98 = 
	    STATIC_STRING("1q4z8r8u8u83Kvy83Kvy01p8w9k3ky3ky13Xy1z83-1y2l83-Ly83-Xy2l83-my83-Ry2l83-ny83-gy2l835Jy83Ty2l83UDy8334y2l83UCy83*Gy2l83UEy83fy2l");
    string_constant_99 = 
	    STATIC_STRING("83UFy83*Gy2l83UHy83fy2l83UGy83-gy2l83UIy83-Ry2l83aNy83fy2l835by83*2y2l835ay832Vy1l83-iy1l83-jy83-Ly1n83jy1mkk1m3ky3ky83-my1q83qy");
    string_constant_100 = 
	    STATIC_STRING("3hy3hy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp835Jy1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Oy1m3eyp1mpp1mp3fy83aNy1r83qy1r1m3Ny3Ey1m3Ny3Oy1m3Ry");
    string_constant_101 = 
    ...
    string_constant_102 = 
	    STATIC_STRING("3Ey1m3Ny3Ey1n1m3Ny3Ey1m3Ly3Ty1m3Jy3Oy83UDy1n83qy1n1m3Cyr1m3Cy3Hy1ms3Hy1n1m3Cyr1m3Cy3Hy1ms3Hy83UCy1n83qy1n1ms3Hy1m3Cyz1m3Ky3Hy1n1");
    string_constant_103 = 
	    STATIC_STRING("ms3Hy1m3Cyz1m3Ky3Hy83UEy1p83Oy1ms3Hy1m3Cyr1m3Ky3Hy1ms3Hy83UFy1n83jy1m3Jyt1m3Yy3Jy83UHy1p83Jy1m3Py3Gy1m3Py3Iy1m3Wy3Iy1m3Wy3Gy1p83");
    string_constant_104 = 
    ...
    string_constant_105 = 
	    STATIC_STRING("3Zys83UGy1o83Oy1m3Yyt1m3Jyt1m3Jy3Jy83UIy1o83Oy1m3Yyt1m3Yy3Jy1m3Jy3Jy835by1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3dy83-Wy835ay1o83Gy+");
    string_constant_106 = 
	    STATIC_STRING("s3-6y3-Ty3-oy3-Tykko3A++y1mt3cy83-Wy1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1ms3cy83-Wy001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY c");
    string_constant_107 = 
	    STATIC_STRING("lass definition000004z8r83Bxy83Bxy83Kvy83Kvy083DBy001m1l8l1m8p83Bxy000004z8r83C+y83C+y83Kvy83Kvy00001m1l8l1m8p83C+y000004z8r83e5");
    string_constant_108 = 
	    STATIC_STRING("y83e5y83Kvy83Kvy00001n1l8l1l83Hy1l83Ny000004z8r83N0y83N0y83Kvy83Kvy00001p1m8p83Yby1l8o1l8l1l83Hy1l83Fy000004z8r83GUy83GUy83Kvy83");
    string_constant_109 = 
	    STATIC_STRING("Kvy00001o1n8p83DCy83Gy1l8o1l8l1l83Cy00000");
    string_constant_110 = 
	    STATIC_STRING("1s8q1o83Kvy1m83Ry83-+y83Iy8t1m8u1p8w9k3ky3ky13Xy1z83-1y2l83-Ly83-Xy2l83-my83-Ry2l83-ny83-gy2l835Jy83Ty2l83UDy8334y2l83UCy83*Gy2l");
    string_constant_111 = 
	    STATIC_STRING("83UEy83fy2l83UFy83*Gy2l83UHy83fy2l83UGy83-gy2l83UIy83-Ry2l83aNy83fy2l835by83*2y2l835ay832Vy1l83-iy1l83-jy83-Ly1n83jy1mkk1m3ky3ky");
    string_constant_112 = 
    ...
    string_constant_113 = 
	    STATIC_STRING("3ky1mn3hy1m3hy3hy83-ny1o83Oy1mp3fy1m3ey3fy1m3eyp835Jy1p83Jy1mkk1mk3ky1m3ky3ky1m3kyk1o83Oy1m3eyp1mpp1mp3fy83aNy1r83qy1r1m3Ny3Ey1m");
    string_constant_114 = 
    ...
    string_constant_115 = 
	    STATIC_STRING("3Jy3Oy1m3Jy3Ey1m3Ny3Ey1n1m3Ny3Ey1m3Ly3Ty1m3Jy3Oy83UDy1n83qy1n1m3Cyr1m3Cy3Hy1ms3Hy1n1m3Cyr1m3Cy3Hy1ms3Hy83UCy1n83qy1n1ms3Hy1m3Cyz");
    string_constant_116 = 
	    STATIC_STRING("1m3Ky3Hy1n1ms3Hy1m3Cyz1m3Ky3Hy83UEy1p83Oy1ms3Hy1m3Cyr1m3Ky3Hy1ms3Hy83UFy1n83jy1m3Jyt1m3Yy3Jy83UHy1p83Jy1m3Py3Gy1m3Py3Iy1m3Wy3Iy1");
    string_constant_117 = 
    ...
    string_constant_118 = 
	    STATIC_STRING("y1m3Zy3Ky1m3Zys83UGy1o83Oy1m3Yyt1m3Jyt1m3Jy3Jy83UIy1o83Oy1m3Yyt1m3Yy3Jy1m3Jy3Jy835by1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3dy83-Wy8");
    string_constant_119 = 
	    STATIC_STRING("35ay1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1mt3cy83-Wy1o83Gy+s3-6y3-Ty3-oy3-Tykko3A++y1ms3cy83-Wy1n83Bxy83DBy1m8p83Bxy1n83C+y01m8p83C+y");
    string_constant_120 = 
	    STATIC_STRING("1o83e5y083Hy83Ny1r83N0y01m8p83Yby8o8l83Hy83Fy1q83GUy01n8p83DCy83Gy8o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_97);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    temp_1 = regenerate_optimized_constant(list(13,string_constant_98,
	    string_constant_99,string_constant_88,string_constant_100,
    ...
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    add_class_to_environment(9,Qexport_definition,list_constant_13,Nil,
	    temp,Nil,temp_1,list_constant_13,
	    regenerate_optimized_constant(list(11,string_constant_110,
    ...
    mutate_global_property(Qexport_definition_specification,
	    ...
	    Qslot_value_writer);
    string_constant_121 = 
	    STATIC_STRING("13Hy1n83Bxy1m9k83DBy83DBy1n83C+y83-aWy1m83DByl1n83-aWy83-aVy1ll1n83-aWy1n83-aVy1m9k83-ay83-aWy2lln1n83-aVy1o1m9k83-Gy83-6y1m9k83");
    string_constant_122 = 
	    STATIC_STRING("=Fy83-aby1nm83I2yo1n83-ZZy1m9k83D0y83D0y1n83-ZZy1m9k83I2y83I2y1n83-aby83-aay1ll1n83-aby1n83-aay1m9k83-ty83-aby2lln1n83-aay1m1m9k");
    string_constant_123 = 
	    STATIC_STRING("83-pMy83-dgy1m83-pMym1n83-aay1p1m9k839Zy1m9k9l1m9k831Ly1m9k83-dhy83-dgy1m83-Ykyp1n83-aay1p1m9k830*y1m9k831Ly1m9k83-dhy1m9k83vsy8");
    string_constant_124 = 
	    STATIC_STRING("3-dgy1m83-T*yp1n83-aay1m1m9k83vDy83-Uy1m83vDym1n83-aay1m1m9k839cy83-Uy1m839cym1n83-aay1m1m9k83-YUy83-ady1m83-YUym1n83-aay1m1m9k8");
    string_constant_125 = 
	    STATIC_STRING("3-May83-Uy1m83-Maym1n83-aay1m1m9k83-q+y83-6y1m83-q+ym1n83-dgy83-6y1ll1n83-dgy1n83-6y1m9k83vy83-dgy2lln1n83-ady83-Uy1ll1n83-ady1n");
    string_constant_126 = STATIC_STRING("83-Uy1m9k83vy83-ady2lln");
    clear_optimized_constants();
    ...
    list_constant_14 = STATIC_LIST((SI_Long)2L,Qab_class,Qexport_definition);
    list_constant_15 = STATIC_LIST((SI_Long)3L,Qexport_definition,Ktype,
	    list_constant_14);
    list_constant_16 = STATIC_CONS(list_constant_15,Qnil);
    ...
    string_constant_127 = 
	    STATIC_STRING("43Dy8m83T9y1n83T9y8n8k1l8n0000000knk0k0");
    ...
    string_constant_128 = STATIC_STRING("1q83T9y8s83-agy09k9l");
    clear_optimized_constants();
    ...
    string_constant_129 = 
	    STATIC_STRING("43Dy8m83jby1n83jby8n8k1l8n0000000kyk0k0");
    ...
    string_constant_130 = STATIC_STRING("1q83jby8s83-aUy09k9l");
    clear_optimized_constants();
    push_optimized_constant(Qoutstanding_java_class_count);
    push_optimized_constant(Qjava_class_structure_memory_usage);
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_130));
    ...
    string_constant_131 = 
	    STATIC_STRING("43Dy8m83jhy1n83jhy8n8k1l8n0000000kok0k0");
    ...
    string_constant_132 = STATIC_STRING("1q83jhy8s83-aZy09k9l");
    clear_optimized_constants();
    ...
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_132));
    ...
    string_constant_133 = 
	    STATIC_STRING("43Dy8m83jjy1n83jjy8n8k1l8n0000000ksk0k0");
    ...
    string_constant_134 = STATIC_STRING("1q83jjy8s83-acy09k9l");
    clear_optimized_constants();
    push_optimized_constant(Qoutstanding_java_field_count);
    push_optimized_constant(Qjava_field_structure_memory_usage);
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_134));
    ...
    string_constant_135 = 
	    STATIC_STRING("43Dy8m83jsy1n83jsy8n8k1l8n0000000kuk0k0");
    ...
    string_constant_136 = STATIC_STRING("1q83jsy8s83-aey09k9l");
    clear_optimized_constants();
    push_optimized_constant(Qoutstanding_java_method_count);
    push_optimized_constant(Qjava_method_structure_memory_usage);
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_136));
    ...
    string_constant_137 = 
	    STATIC_STRING("43Dy8m83jgy1n83jgy8n8k1l8n0000000kpk0k0");
    ...
    Qjava_code_exception_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_138 = STATIC_STRING("1q83jgy8s83-aYy09k9l");
    clear_optimized_constants();
    ...
    update_object_pool_meters_list(regenerate_optimized_constant(string_constant_138));
    ...
    string_constant_139 = 
	    STATIC_STRING("43Dy8m83jfy1n83jfy8n8k1l8n0000000kqk0k0");
    ...
    string_constant_140 = STATIC_STRING("1q83jfy8s83-aXy09k9l");
    clear_optimized_constants();
    ...
    string_constant_141 = 
	    STATIC_STRING("43Dy8m83fwy1n83fwy8n8k1l8n0000001l1n8y83-3Dy1l83s5yknk0k0");
    ...
    Qclass_file_stream_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_142 = STATIC_STRING("1q83fwy8s83-MXy09k9l");
    clear_optimized_constants();
    ...
    array_constant_16 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_17 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)32L));
    ...
    array_constant_18 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_19 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_20 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_21 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_22 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_23 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_24 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_25 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_26 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_27 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_28 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_29 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_30 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_31 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    list_constant_17 = STATIC_CONS(Qno_item,Qnil);
    ...
    array_constant_32 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_33 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_34 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_35 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_36 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_37 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_38 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_39 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_40 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_41 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_42 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_43 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_44 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_45 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_46 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_47 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_48 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_49 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_50 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_51 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_52 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_53 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_54 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_55 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_56 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_57 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_58 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_59 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_60 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_61 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    list_constant_19 = STATIC_LIST((SI_Long)2L,Qarg,FIX((SI_Long)1L));
    string_constant_143 = STATIC_STRING(" + ");
    list_constant_20 = STATIC_LIST((SI_Long)2L,Qarg,FIX((SI_Long)2L));
    list_constant_21 = STATIC_LIST((SI_Long)3L,list_constant_19,
	    string_constant_143,list_constant_20);
    mutate_global_property(Qg2_add,list_constant_21,
	    Qjava_operator_emitter_template);
    ...
    list_constant_22 = STATIC_LIST((SI_Long)3L,list_constant_20,
	    string_constant_144,list_constant_19);
    mutate_global_property(Qsubtract,list_constant_22,
	    Qjava_operator_emitter_template);
    ...
    list_constant_23 = STATIC_CONS(list_constant_20,Qnil);
    list_constant_24 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_145,list_constant_23);
    mutate_global_property(Qmultiply,list_constant_24,
	    Qjava_operator_emitter_template);
    ...
    list_constant_25 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_146,list_constant_23);
    mutate_global_property(Qquotient,list_constant_25,
	    Qjava_operator_emitter_template);
    ...
    mutate_global_property(Qdivide,list_constant_25,
	    Qjava_operator_emitter_template);
    ...
    list_constant_26 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_147,list_constant_23);
    mutate_global_property(Qremainder,list_constant_26,
	    Qjava_operator_emitter_template);
    ...
    list_constant_27 = STATIC_CONS(list_constant_19,Qnil);
    list_constant_28 = STATIC_CONS(string_constant_148,list_constant_27);
    mutate_global_property(Qnegate,list_constant_28,
	    Qjava_operator_emitter_template);
    ...
    list_constant_29 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_149,list_constant_23);
    mutate_global_property(Qbitwise_or,list_constant_29,
	    Qjava_operator_emitter_template);
    ...
    list_constant_30 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_150,list_constant_23);
    mutate_global_property(Qbitwise_and,list_constant_30,
	    Qjava_operator_emitter_template);
    ...
    list_constant_31 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_151,list_constant_23);
    mutate_global_property(Qequal,list_constant_31,
	    Qjava_operator_emitter_template);
    ...
    list_constant_32 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_152,list_constant_23);
    mutate_global_property(Qgreater_than,list_constant_32,
	    Qjava_operator_emitter_template);
    ...
    mutate_global_property(Qgreater_than_equal,Qrelational,
	    Qjava_operator_precedence);
    list_constant_33 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_34,list_constant_23);
    mutate_global_property(Qgreater_than_equal,list_constant_33,
	    Qjava_operator_emitter_template);
    ...
    list_constant_34 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_153,list_constant_23);
    mutate_global_property(Qless_than,list_constant_34,
	    Qjava_operator_emitter_template);
    ...
    mutate_global_property(Qless_than_equal,Qrelational,
	    Qjava_operator_precedence);
    list_constant_35 = STATIC_LIST_STAR((SI_Long)3L,list_constant_19,
	    string_constant_33,list_constant_23);
    mutate_global_property(Qless_than_equal,list_constant_35,
	    Qjava_operator_emitter_template);
    ...
    list_constant_36 = STATIC_LIST((SI_Long)2L,Qarg,FIX((SI_Long)3L));
    list_constant_37 = STATIC_LIST((SI_Long)5L,list_constant_19,
	    string_constant_154,list_constant_20,string_constant_155,
	    list_constant_36);
    mutate_global_property(Qconditional,list_constant_37,
	    Qjava_operator_emitter_template);
    ...
    list_constant_38 = STATIC_LIST((SI_Long)4L,list_constant_19,
	    string_constant_156,list_constant_20,string_constant_157);
    mutate_global_property(Qarray_element,list_constant_38,
	    Qjava_operator_emitter_template);
    ...
    string_constant_158 = STATIC_STRING(".length");
    list_constant_39 = STATIC_LIST((SI_Long)2L,list_constant_19,
	    string_constant_158);
    mutate_global_property(Qarray_length,list_constant_39,
	    Qjava_operator_emitter_template);
    ...
    array_constant_62 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_63 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_64 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_65 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_66 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_67 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_68 = STATIC_ARRAY(list_constant_11,(SI_Long)1L,
	    FIX((SI_Long)8L));
