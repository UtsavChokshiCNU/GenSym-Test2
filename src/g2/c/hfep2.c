...
Object Hfep_state = UNBOUND;

Object Hfep_action = UNBOUND;

Object Hfep_cho_ksc2c = UNBOUND;

Object Hfep_jung_ksc2c = UNBOUND;

Object Hfep_jong_ksc2c = UNBOUND;

Object The_type_description_of_hfep_hanc_type = UNBOUND;

Object Chain_of_available_hfep_hanc_types = UNBOUND;

Object Hfep_hanc_type_count = UNBOUND;
    ...
    Object hfep_hanc_type;
{
    ...
    x_note_fn_call(125,2);
    inline_note_reclaim_cons(hfep_hanc_type,Nil);
    svref_new_value = Chain_of_available_hfep_hanc_types;
    SVREF(hfep_hanc_type,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_hfep_hanc_types = hfep_hanc_type;
    return VALUES_1(Nil);
}
...
Object make_permanent_hfep_hanc_type_structure_internal()
{
    ...
    Object hfep_hanc_type_count_new_value;
    Object defstruct_g2_hfep_hanc_type_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(125,4);
    def_structure_hfep_hanc_type_variable = Nil;
    hfep_hanc_type_count_new_value = FIXNUM_ADD1(Hfep_hanc_type_count);
    Hfep_hanc_type_count = hfep_hanc_type_count_new_value;
...
Object Current_hfep_cchar = UNBOUND;

Object Current_hfep_nchar = UNBOUND;

Object Current_hfep_c_state = UNBOUND;

Object Current_hfep_c_act = UNBOUND;
...
void hfep2_INIT()
{
    ...
    Object Qhfep_hanc_type_count, Qchain_of_available_hfep_hanc_types;
    ...
    string_constant_21 = 
	    STATIC_STRING("43Dy8m83iWy1n83iWy8n8k1l8n0000000ksk0k0");
    ...
    string_constant_22 = STATIC_STRING("1q83iWy8s83-X3y09k9l");
