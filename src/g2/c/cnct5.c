...
Object Transient_connection_error_qm = UNBOUND;
    ...
    Object connection_vertices_qm, report_errors_qm;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, loose_end;
    ...
    x_note_fn_call(103,0);
    if (input_end_object_qm && output_end_object_qm) {
	gensymed_symbol = ISVREF(input_end_object_qm,(SI_Long)14L);
	...
	PUSH_SPECIAL(Region_invalidation_is_preferred,region_invalidation_is_preferred,
	  ...
	  PUSH_SPECIAL(Current_drawing_priority,current_drawing_priority,1);
	    stub_length_to_use_qm = connection_vertices_qm ? 
		    FIX((SI_Long)0L) : Nil;
	    PUSH_SPECIAL(Stub_length_to_use_qm,stub_length_to_use_qm,0);
		  ...
		  if (input_end_object_connection_qm && 
		      ...
		      output_end_loose_end = 
			      ...
			      output_end_object_qm);
		      gensymed_symbol = ISVREF(input_end_loose_end,
			      (SI_Long)14L);
		  ...
		  if (input_end_object_connection_qm) {
			  ...
			  temp_2 = connection_vertices_qm;
			  temp_3 = ISVREF(array_constant,
				  IFIX(ISVREF(input_end_object_connection_qm,
		  ...
		  reclaim_gensym_list_1(connection_vertices_qm);
		  if (output_end_object_qm)
...
Object Permit_transfer_of_permanent_items_p = UNBOUND;
    ...
    Object blocks, reference_fsn;
{
    ...
    Object ab_less_than_branch_qm_, connections, ab_loop_list__1;
    Object gensymed_symbol_1, gensymed_symbol_4, connection_item, temp_2, old;
    Object svref_new_value, sub_class_bit_vector, loose_end;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, new_1;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5;
    char temp;
    Declare_special(1);

    x_note_fn_call(103,6);
  ...
  next_loop:
	...
	if (temp) {
	    ...
	    gensymed_symbol_1 = conn;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(conn) & 
	  ...
	  end_4:;
	    ...
	    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),temp_1,
		    temp_2,FIX(SXHASH_SYMBOL_1(conn) & 
		    IFIX(Most_positive_fixnum)));
		...
		if (CONSP(temp_1))
		    reclaim_gensym_list_1(ISVREF(conn,(SI_Long)6L));
...
Object connect_loose_end_to_block varargs_1(int, n)
{
    ...
    Object slot_group_qm, connection_item_table_binary_tree, element_qm;
    Object temp_2, connection_item_table, new_cons, connection_item;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, end_position;
    char temp_1, loose_end_is_input_end;
    Declare_varargs_nonrelocating;
    Declare_special(1);

    x_note_fn_call(103,8);
    ...
    temp = Nil;
    gensymed_symbol_3 = ISVREF(origin_loose_end,(SI_Long)14L);
    gensymed_symbol_3 = gensymed_symbol_3 ? ISVREF(gensymed_symbol_3,
	    (SI_Long)6L) : Nil;
    connection_item_table_binary_tree = gensymed_symbol_3;
