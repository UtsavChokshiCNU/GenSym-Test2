...
Object Available_foreign_function_registry_internal_hash_vector_131_vectors = UNBOUND;

Object Count_of_foreign_function_registry_internal_hash_vector_131_vectors = UNBOUND;
...
{
    Object count_of_foreign_function_registry_internal_hash_vector_131_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(215,2);
    count_of_foreign_function_registry_internal_hash_vector_131_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_foreign_function_registry_internal_hash_vector_131_vectors);
...
Object make_foreign_function_registry_internal_hash_vector()
{
    ...
    if (Available_foreign_function_registry_internal_hash_vector_131_vectors) {
	temp = 
		M_CAR(Available_foreign_function_registry_internal_hash_vector_131_vectors);
	temp_1 = 
		M_CDR(Available_foreign_function_registry_internal_hash_vector_131_vectors);
	inline_note_reclaim_cons(Available_foreign_function_registry_internal_hash_vector_131_vectors,
		Qab_gensym);
	cdr_arg = 
...
/* RECLAIM-FOREIGN-FUNCTION-REGISTRY-INTERNAL-TREE-FOR-HASH-LEAVES */
Object reclaim_foreign_function_registry_internal_tree_for_hash_leaves(foreign_function_registry_internal_tree_for_hash_binary_tree)
    Object foreign_function_registry_internal_tree_for_hash_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(foreign_function_registry_internal_tree_for_hash_binary_tree))
	goto end_loop;
    less_than_branch_qm = 
	    ISVREF(foreign_function_registry_internal_tree_for_hash_binary_tree,
	    (SI_Long)1L);
    ...
    alist = 
	    ISVREF(foreign_function_registry_internal_tree_for_hash_binary_tree,
	    (SI_Long)3L);
    reclaim_binary_tree_element_1(foreign_function_registry_internal_tree_for_hash_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
  ...
  end_loop_1:;
	...
	reclaim_foreign_function_registry_internal_tree_for_hash_leaves(less_than_branch_qm);
	foreign_function_registry_internal_tree_for_hash_binary_tree = 
		greater_than_branch_qm;
    }
    else {
	...
	foreign_function_registry_internal_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
Object clear_foreign_function_registry_internal_tree(foreign_function_registry_internal_tree_for_hash_binary_tree)
    Object foreign_function_registry_internal_tree_for_hash_binary_tree;
{
    Object element_qm;
    ...
    element_qm = 
	    CDR(foreign_function_registry_internal_tree_for_hash_binary_tree);
    if (element_qm) {
	reclaim_foreign_function_registry_internal_tree_for_hash_leaves(element_qm);
	M_CDR(foreign_function_registry_internal_tree_for_hash_binary_tree) 
		= Nil;
    }
    return VALUES_1(foreign_function_registry_internal_tree_for_hash_binary_tree);
}
    ...
    Object foreign_function_registry_internal_hash_table;
{
  ...
  next_loop:
    ...
    if (element_qm)
	reclaim_foreign_function_registry_internal_tree_for_hash_leaves(element_qm);
    inline_note_reclaim_cons(foreign_function_registry_internal_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(foreign_function_registry_internal_tree_for_hash_binary_tree) = 
	    cdr_new_value;
...
Object Foreign_function_registry = UNBOUND;

Object The_type_description_of_element_of_foreign_linking_info = UNBOUND;

Object Chain_of_available_element_of_foreign_linking_infos = UNBOUND;

Object Element_of_foreign_linking_info_count = UNBOUND;
    ...
    Object element_of_foreign_linking_info;
{
    ...
    svref_new_value = Chain_of_available_element_of_foreign_linking_infos;
    SVREF(element_of_foreign_linking_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_element_of_foreign_linking_infos = 
	    element_of_foreign_linking_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_element_of_foreign_linking_info_structure_internal()
{
    ...
    Object element_of_foreign_linking_info_count_new_value;
    ...
    element_of_foreign_linking_info_count_new_value = 
	    FIXNUM_ADD1(Element_of_foreign_linking_info_count);
...
Object Chain_of_available_foreign_function_entrys = UNBOUND;

Object Foreign_function_entry_count = UNBOUND;
    ...
    Object foreign_function_entry;
{
    ...
    x_note_fn_call(215,24);
    inline_note_reclaim_cons(foreign_function_entry,Nil);
    svref_new_value = Chain_of_available_foreign_function_entrys;
    SVREF(foreign_function_entry,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_foreign_function_entrys = foreign_function_entry;
    return VALUES_1(Nil);
}
...
Object make_permanent_foreign_function_entry_structure_internal()
{
    ...
    Object foreign_function_entry_count_new_value;
    Object defstruct_g2_foreign_function_entry_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(215,26);
    def_structure_foreign_function_entry_variable = Nil;
    foreign_function_entry_count_new_value = 
	    FIXNUM_ADD1(Foreign_function_entry_count);
    Foreign_function_entry_count = foreign_function_entry_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object entry;
{
	...
	reclaim_gensym_list_1(ISVREF(entry,(SI_Long)4L));
	SVREF(entry,FIX((SI_Long)4L)) = Nil;
    }
    if (ISVREF(entry,(SI_Long)7L)) {
	reclaim_gensym_list_1(ISVREF(entry,(SI_Long)7L));
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(serial_numbers);
    ...
    Object foreign_function_return_type, foreign_image_info;
{
    ...
    Object old_entry_qm, new_entry;
    SI_Long gensymed_symbol, temp_1, gensymed_symbol_3;

    x_note_fn_call(215,29);
    ...
    gensymed_symbol_2 = foreign_function_name;
  ...
  next_loop:
	...
	if (string_eq_w(gensymed_symbol_2,gensymed_symbol_4)) {
	    old_entry_qm = M_CDR(M_CAR(gensymed_symbol_1));
	    goto end_1;
	}
  ...
  end_2:;
    if (old_entry_qm) {
	reclaim_gensym_list_1(foreign_function_type_list);
	...
	temp = Foreign_function_registry;
	temp_1 = gensymed_symbol % (SI_Long)131L;
	set_balanced_binary_tree_entry(SVREF(temp,FIX(temp_1)),
...
Object Chain_of_available_foreign_function_image_infos = UNBOUND;

Object Foreign_function_image_info_count = UNBOUND;
    ...
    Object foreign_function_image_info;
{
    ...
    x_note_fn_call(215,32);
    inline_note_reclaim_cons(foreign_function_image_info,Nil);
    svref_new_value = Chain_of_available_foreign_function_image_infos;
    SVREF(foreign_function_image_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_foreign_function_image_infos = 
	    foreign_function_image_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_foreign_function_image_info_structure_internal()
{
    ...
    Object foreign_function_image_info_count_new_value;
    Object defstruct_g2_foreign_function_image_info_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(215,34);
    def_structure_foreign_function_image_info_variable = Nil;
    foreign_function_image_info_count_new_value = 
	    FIXNUM_ADD1(Foreign_function_image_info_count);
...
{
    Object def_structure_foreign_function_image_info_variable, svref_new_value;

    x_note_fn_call(215,35);
    def_structure_foreign_function_image_info_variable = 
	    Chain_of_available_foreign_function_image_infos;
    ...
    SVREF(def_structure_foreign_function_image_info_variable,
	    FIX((SI_Long)1L)) = Nil;
    svref_new_value = make_empty_foreign_linking_info();
    SVREF(def_structure_foreign_function_image_info_variable,
    ...
    Object foreign_function_image_info;
{
    ...
    x_note_fn_call(215,36);
    temp = ISVREF(foreign_function_image_info,(SI_Long)6L);
    return VALUES_1(temp);
}

Object Unused_foreign_image_indices = UNBOUND;

Object Highest_foreign_image_index = UNBOUND;
...
{
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, info_in_list;
    Object ab_loop_list_, cons_in_list, ab_loop_iter_flag_;

    x_note_fn_call(215,42);
  ...
  next_loop:
	...
	cdr_new_value = CDDR(cons_in_list);
	M_CDR(cons_in_list) = cdr_new_value;
...
Object Chain_of_available_foreign_function_call_infos = UNBOUND;

Object Foreign_function_call_info_count = UNBOUND;
    ...
    Object foreign_function_call_info;
{
    ...
    x_note_fn_call(215,45);
    inline_note_reclaim_cons(foreign_function_call_info,Nil);
    svref_new_value = Chain_of_available_foreign_function_call_infos;
    SVREF(foreign_function_call_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_foreign_function_call_infos = 
	    foreign_function_call_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_foreign_function_call_info_structure_internal()
{
    ...
    Object foreign_function_call_info_count_new_value;
    Object defstruct_g2_foreign_function_call_info_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(215,47);
    def_structure_foreign_function_call_info_variable = Nil;
    foreign_function_call_info_count_new_value = 
	    FIXNUM_ADD1(Foreign_function_call_info_count);
    ...
    Object slot_value, frame, slot_description;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__1 = gensym_cons_1(EQ(argument_description,Qab_real) ? 
	    Qfloat : argument_description,Nil);
    if (ab_loopvar_)
    ...
    Object image_info;
{
    ...
    Object temp, unlinked_element, unlinked_declaration, gensymed_symbol_4;
    ...
    SI_Long gensymed_symbol_2, temp_1, gensymed_symbol_3;
    Declare_stack_pointer;
    Declare_catch(1);
    Object result;

    x_note_fn_call(215,63);
    SAVE_STACK();
  ...
  end_loop_1:;
    ...
    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qstring_eq_w),
	    gensymed_symbol,SVREF(temp,FIX(temp_1)),FIX(gensymed_symbol_2));
    reclaim_foreign_function_entry(entry);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(entry_list);
  ...
  next_loop_2:
    ...
    gensymed_symbol_1 = ISVREF(unlinked_declaration,(SI_Long)21L);
    gensymed_symbol_2 = IFIX(sxhashw(gensymed_symbol_1));
    temp = Foreign_function_registry;
    temp_1 = gensymed_symbol_2 % (SI_Long)131L;
    temp = SVREF(temp,FIX(temp_1));
  ...
  end_loop_3:
    temp = Qnil;
  end_2:;
    update_foreign_function_linking(unlinked_declaration,temp,T);
  ...
  end_loop_2:
	...
	goto next_loop_5;
      end_loop_5:;
	reclaim_gensym_list_1(connection_spec_qm);
    ...
    Object foreign_function_declaration, entry_for_foreign_function;
{
	...
	add_to_frame_note_particulars_list_if_necessary(gensym_list_3(Qargcount_mismatch,
    ...
    Object foreign_function_declaration, entry_for_foreign_function;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_list_3(FIX(index_1),
  ...
  end_1:;
	...
	add_to_frame_note_particulars_list_if_necessary(gensym_cons_1(Qargtype_mismatch,
    ...
    Object foreign_function_declaration, entry_for_foreign_function;
{
	...
	add_to_frame_note_particulars_list_if_necessary(gensym_list_3(Qreturn_type_mismatch,
...
{
    Object image_info, unlinked_element, gensym_push_modify_macro_arg, car_1;
    Object cdr_1, svref_new_value;

    x_note_fn_call(215,78);
	...
	ISVREF(foreign_function_declaration,(SI_Long)22L) = 
		entry_for_foreign_function_qm;
	gensym_push_modify_macro_arg = foreign_function_declaration;
...
{
    Object temp, gensymed_symbol_2, gensymed_symbol_4;
    SI_Long gensymed_symbol_1, temp_1, gensymed_symbol_3;

    x_note_fn_call(215,79);
	...
	temp = Qnil;
      end_2:;
	update_foreign_function_linking(foreign_function_declaration,temp,T);
    }
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(foreign_function_declaration,
		Qname_in_foreign_image);
...
Object link_completed_foreign_function_declarations()
{
    ...
    Object gensymed_symbol_2, gensymed_symbol_4;
    SI_Long gensymed_symbol_1, temp_3, gensymed_symbol_3;
    char temp;
    Declare_special(1);

    x_note_fn_call(215,80);
    ...
    next_loop_2:
	  ...
	  goto end_loop_2;
      gensymed_symbol_3 = IFIX(ISVREF(gensymed_symbol_2,(SI_Long)0L));
      if (gensymed_symbol_1 < gensymed_symbol_3)
	...
	next_loop_3:
	  if ( !TRUEP(gensymed_symbol_2))
	      goto end_loop_3;
	  gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol_2));
	  if (string_eq_w(gensymed_symbol,gensymed_symbol_4)) {
    ...
    end_loop_2:
      temp_2 = Qnil;
    end_2:;
      update_foreign_function_linking(temp_1,temp_2,T);
      goto next_loop;
    end_loop_1:;
    POP_SPECIAL();
    return VALUES_1(Nil);
    ...
    Object list_of_foreign_function_registrations;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(list_of_foreign_function_registrations);
    return VALUES_1(Nil);
}
...
Object read_icp_list_of_foreign_function_registrations_qm()
{
	...
	next_loop_1:
	  if (index_2 > ab_loop_bind__1)
	      goto end_loop_1;
	  ab_loopvar__4 = gensym_cons_1(read_icp_integer(),Nil);
	  if (ab_loopvar__3)
...
Object read_icp_foreign_function_value()
{
    ...
    Object resumable_icp_state_1, icp_suspend_1, top, value, key, arg1;
    double aref_new_value, value_1;
    Declare_special(1);
    Object result;

    x_note_fn_call(215,90);
    if (Disable_resumability) {
	if (Icp_read_trace_cutoff_level_qm) {
	    tracep = EQ(Icp_read_trace_cutoff_level_qm,T) ? T : Nil;
	    if (tracep);
		...
		switch (INTEGER_TO_CHAR(type_tag)) {
		  ...
		  case 6:
		    ...
		    break;
		  case 3:
		    temp_1 = intern_text_string(1,read_icp_text_string());
		    break;
		  case 4:
		    temp_1 = read_icp_text_string();
		    break;
		  default:
		    temp_1 = Nil;
		    break;
...
Object Tcp_ip_port_offset_for_foreign_images = UNBOUND;

Object Foreign_image_connection_mode = UNBOUND;
...
{
    x_note_fn_call(215,93);
    return VALUES_1(Qtcp_ip);
}

Object Cached_tcpip_listener_address_qm = UNBOUND;
...
Object Spawn_command_line_process_failure = UNBOUND;
...
Object Foreign_image_connection_checkup_interval_in_ms = UNBOUND;

Object Total_foreign_image_connection_checkup_interval_in_ms = UNBOUND;

Object Ff_connect_finalized = UNBOUND;
    ...
    Object connection_specification;
{
    ...
    x_note_fn_call(215,98);
    SAVE_STACK();
    display_events_were_enabled = (SI_Long)0L != ne_display_events_enabled();
    ne_disable_display_events();
    if (PUSH_UNWIND_PROTECT(0)) {
	scheduler_enabled_qm = Nil;
	PUSH_SPECIAL(Scheduler_enabled_qm,scheduler_enabled_qm,2);
	  ff_connect_finalized = Nil;
	  PUSH_SPECIAL(Ff_connect_finalized,ff_connect_finalized,1);
	    initial_icp_version_info_enabled_p = Nil;
	    PUSH_SPECIAL(Initial_icp_version_info_enabled_p,initial_icp_version_info_enabled_p,
		    0);
    ...
    Object image_info;
{
    ...
    connection_specification = EQ(Foreign_image_connection_mode,Qtcp_ip) ? 
	    gensym_list_4(Qtcp_ip,host_name,port_or_task,Nil) : Nil;
    icp_connection_qm = 
	...
	reclaim_gensym_list_1(connection_specification);
	temp = Nil;
    }
    return VALUES_1(temp);
}
...
Object Maximum_retries_for_foreign_image_connection = UNBOUND;

Object Milliseconds_between_retries_for_foreign_image_connection = UNBOUND;

Object Milliseconds_to_sleep_before_connecting_to_foreign_image = UNBOUND;

Object Milliseconds_to_sleep_after_connection_on_pc_platforms = UNBOUND;
    ...
    Object image_info;
{
  ...
  next_loop:
    ...
    failed_socket_indices = gensym_cons_1(unused_index,failed_socket_indices);
    g2ext_sys_sleep(IFIX(Milliseconds_between_retries_for_foreign_image_connection));
...
Object Tcpip_external_foreign_image_prologue = UNBOUND;
...
Object initialize_foreign_function_image_if_possible varargs_1(int, n)
{
	...
	All_foreign_function_images_qm = gensym_cons_1(image_info,
...
Object Wait_interval_before_killing_foreign_process = UNBOUND;
    ...
    Object foreign_image_info;
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, temp_1, future_task_schedule_modify_arg_8;
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qkill_foreign_image_process_unconditionally);
	future_task_schedule_modify_arg_11 = foreign_process_id_qm;
	schedule_task_qm = ISVREF(foreign_image_info,(SI_Long)11L);
	if (schedule_task_qm) {
	...
	SVREF(foreign_image_info,FIX((SI_Long)11L)) = task;
    }
    ...
    Object list_of_foreign_images;
{
    ...
    x_note_fn_call(215,114);
    copy_of_list_of_foreign_images = 
	    copy_list_using_gensym_conses_1(list_of_foreign_images);
    image = Nil;
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(copy_of_list_of_foreign_images);
    return VALUES_1(Nil);
}
    ...
    Object list_of_foreign_function_registrations, icp_socket_of_foreign_image;
{
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(FOURTH(registration));
  ...
  end_1:;
    ...
    entries_to_connect = gensym_cons_1(entry,entries_to_connect);
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(registration);
	...
	entry = M_CAR(ab_loop_list_);
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(ISVREF(entry,(SI_Long)1L),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	if ( !EQ(names_of_entries,Qunbound_in_protected_let))
	    reclaim_gensym_list_1(names_of_entries);
    }
    CONTINUE_UNWINDING(0);
    RESTORE_STACK();
...
Object Cached_timed_out_foreign_function_name_qm = UNBOUND;
    ...
    Object foreign_image_info;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(STRINGP(component) ? 
    ...
    Object top_of_stack;
{
    ...
    Object foreign_result_qm, gensym_pop_store, cons_1, next_cons;
	...
	if (PUSH_UNWIND_PROTECT(2)) {
	    ...
	    PUSH_SPECIAL(During_ffi_call_qm,during_ffi_call_qm,2);
	      PUSH_SPECIAL(Active_icp_sockets,active_icp_sockets,1);
		if (PUSH_UNWIND_PROTECT(1)) {
		    Active_icp_sockets = 
			    gensym_cons_1(foreign_image_socket,Nil);
		    ...
		    if (PUSH_UNWIND_PROTECT(0)) {
			scheduler_enabled_qm = Nil;
			PUSH_SPECIAL(Scheduler_enabled_qm,scheduler_enabled_qm,
				0);
		...
		if (Active_icp_sockets) {
			...
			if (SIMPLE_VECTOR_P(foreign_image_socket) && 
			    ...
			    reclaim_gensym_list_1(Active_icp_sockets);
		    }
		}
	...
	if (foreign_image_socket) {
		...
		if ( !(SIMPLE_VECTOR_P(foreign_image_socket) && 
			...
			if (EQ(maybe_foreign_image_socket_qm,
			    ...
			    reclaim_gensym_cons_1(CDR(previous_cons));
...
void g2_foreign_INIT()
{
    ...
    Object AB_package, Qg2_foreign, Qcached_timed_out_foreign_function_name_qm;
    ...
    Object Qforeign_image_connection_mode, Kfuncall;
    Object Qtcp_ip_port_offset_for_foreign_images, Qclasses_which_define;
    Object Qcleanup, Qcleanup_for_foreign_function_declaration;
    ...
    Object Qcurrent_foreign_function_call_info, Qforeign_function_call_info;
    Object Qreclaim_structure, Qoutstanding_foreign_function_call_info_count;
    Object Qforeign_function_call_info_structure_memory_usage, Qutilities2;
    Object Qforeign_function_call_info_count;
    Object Qchain_of_available_foreign_function_call_infos, string_constant_67;
    Object Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_66, Qunique_structure_type_of_ab_name_qm;
    Object Qab_name_of_unique_structure_type, Qhighest_foreign_image_index;
    Object Qunused_foreign_image_indices, Qforeign_function_image_info;
    Object Qoutstanding_foreign_function_image_info_count;
    Object Qforeign_function_image_info_structure_memory_usage;
    Object Qforeign_function_image_info_count;
    Object Qchain_of_available_foreign_function_image_infos;
    Object string_constant_65, string_constant_64, Qforeign_function_entry;
    Object Qoutstanding_foreign_function_entry_count;
    Object Qforeign_function_entry_structure_memory_usage;
    Object Qforeign_function_entry_count;
    Object Qchain_of_available_foreign_function_entrys, string_constant_63;
    ...
    Object Qelement_of_foreign_linking_info_count;
    Object Qchain_of_available_element_of_foreign_linking_infos;
    Object string_constant_61, string_constant_60, list_constant_5;
    Object Qforeign_function_registry, Qmake_foreign_function_registry;
    ...
    Object Qcount_of_foreign_function_registry_internal_hash_vector_131_vectors;
    Object Qavailable_foreign_function_registry_internal_hash_vector_131_vectors;

    x_note_fn_call(215,139);
    SET_PACKAGE("AB");
    ...
    Qforeign_function_registry_internal_hash_vector_131_vector_memory_usage 
	    ...
	    AB_package);
    string_constant_59 = STATIC_STRING("1q83-UKy83*By83-Oly09k9l");
    ...
    string_constant_60 = 
	    STATIC_STRING("43Dy8m83h1y1n83h1y8n8k1l8n0000001l1n8y83-3Yy1m83x=y83vcykpk0k0");
    ...
    Qelement_of_foreign_linking_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_61 = STATIC_STRING("1q83h1y8s83-SIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_62 = 
	    STATIC_STRING("43Dy8m83hSy1n83hSy8n8k1l8n0000001m1n8y83-3iy1p836py83wfy83wdy83why83wgy1m83My83-AGyktk0k0");
    ...
    Qforeign_function_entry_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_63 = STATIC_STRING("1q83hSy8s83-UIy09k9l");
    clear_optimized_constants();
    ...
    string_constant_64 = 
	    STATIC_STRING("43Dy8m83hTy1n83hTy8n8k1l8n0000001m1n8y83-3jy01m83My83-AHykzk0k0");
    ...
    Qforeign_function_image_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_65 = STATIC_STRING("1q83hTy8s83-UJy09k9l");
    clear_optimized_constants();
    ...
    string_constant_66 = 
	    STATIC_STRING("43Dy8m83hRy1n83hRy8n8k1l8n0000001l1n8y83-3hy0kpk0k0");
    ...
    Qforeign_function_call_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_67 = STATIC_STRING("1q83hRy8s83-UHy09k9l");
    clear_optimized_constants();
    ...
    string_constant_73 = 
	    STATIC_STRING("k000004z8r83ry83ry835Cy835Cy00001p1l8o1l8l1n8p835Cy83Gy1l83-5y1l83-3y000004z8r83WBy83WBy835Cy835Cy00001n1l8o1l8l1l83Cy000004z8r8");
    string_constant_74 = 
	    STATIC_STRING("3WCy83WCy835Cy835Cy00001o1l8o1l8l1m8p836py1m83Dy53Cyexport as string000004z8r83Lvy83Lvy835Cy835Cy00001n1l8o1l8l1l83Hy000004z8r83");
    string_constant_75 = 
	    STATIC_STRING("dWy83dWy835Cy835Cy00001n1l8o1l8l1l83Hy000004z8r83FQy83FQy835Cy835Cy083Py001q1l8o1l8l1l8z1m8p8336y1l83Cy1m83Dy53Jyexport as time-");
    string_constant_76 = 
	    STATIC_STRING("interval000004z8r83JCy83JCy835Cy835Cy00001p1m8p83Luy1l8o1l8l1l83Ny1l83Cy000004z8r83JDy83JDy835Cy835Cy00001p1m8p83Lwy1l8o1l8l1l83");
    string_constant_77 = STATIC_STRING("Ny1l83Cy00000");
    string_constant_78 = 
	    STATIC_STRING("1x8q1o835Cy1l83*sy1m8v835Cy8t1n83--y01m8p83-*y1n83-0y01m8p83-0y1p83-Fy08l1m8p083Hy1q83ry08o8l1n8p835Cy83Gy83-5y1p83WBy08o8l83Cy1");
    string_constant_79 = 
	    STATIC_STRING("q83WCy08o8l1m8p836py1m83Dy53Cyexport as string1p83Lvy08o8l83Hy1p83dWy08o8l83Hy1s83FQy83Py8o8l8z1m8p8336y83Cy1m83Dy53Jyexport as ");
    string_constant_80 = 
	    STATIC_STRING("time-interval1r83JCy01m8p83Luy8o8l83Ny83Cy1r83JDy01m8p83Lwy8o8l83Ny83Cy");
    ...
    string_constant_81 = 
	    STATIC_STRING("13Dy1n835Cy1m1m9k83gcy83-UGy2llm1n83-UGy1s1m9k83wcy1m9k9l83-7Ry1m9k83-9y83-UFy1m9k83-Ay1m9k9m83-UOy1plsmnp1n83-UGy1r1m9k83wcy1m9");
    string_constant_82 = 
	    STATIC_STRING("k9l83-7Ry1m9k83-9y1m9k83-Ay1m9k9m83-UOy1plrmn01m83-UFy83-UNy1o83-UFy1n83-UNy1m9k83vy83-UFy1nmln9n1m83-7Ry83-6y1m83-UNy1m9k83Sy1m");
    string_constant_83 = 
	    STATIC_STRING("83-UNy1m9k9o1m83-UNy1m9k83-2y1m83-UNy1m9k83Gy1m83-UOy1m9k83Sy1m83-UOy1m9k9o1m83-UOy1m9k83-2y1m83-UOy1m9k83Gy1m836py83-Uy1m836py1");
    string_constant_84 = 
	    STATIC_STRING("m9k83Zy1n836py1o1m9k83-Qoy1m9k832+y1m9k83ury1m9k83Gy83Zy");
    clear_optimized_constants();
