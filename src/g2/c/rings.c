...
void rings_INIT()
{
    ...
    string_constant = 
	    STATIC_STRING("43Dy8m834Yy1n834Yy8n8k1l8n0000001l1m8y83-5fykqk0k0");
    ...
    Qring_buffer_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_1 = STATIC_STRING("1q834Yy8s83-lqy09k9l");
    ...
    string_constant_2 = 
	    STATIC_STRING("43Dy8m83nuy1o83nuy834Yy8n8k1l834Yy0000001m1m8x834Yy1m8y83-6Aykrk0k0");
    ...
    Qthrashing_ratio_ring_buffer_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_3 = STATIC_STRING("1q83nuy8s83-rFy09k9l");
    clear_optimized_constants();
