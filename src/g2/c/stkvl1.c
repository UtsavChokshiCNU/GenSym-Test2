...
{
    Object e_float_base, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float, temp_1;
    Object e_float_power;
	...
	if (FIXNUMP(base_number))
		...
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(base_number)) == (SI_Long)1L) {
	    temp_1 = convert_g2longint_to_double(aref1(base_number,
		    FIX((SI_Long)0L)));
	...
	if (FIXNUMP(power_number))
		...
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(power_number)) == (SI_Long)1L) {
	    temp_1 = convert_g2longint_to_double(aref1(power_number,
		    FIX((SI_Long)0L)));
	    aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	}
	else
    ...
    Object expression;
{
  ...
  next_loop:
	...
	ab_loopvar__1 = 
		gensym_cons_1(convert_expression_to_stack_node_tree(binding_expression_qm),
		Nil);
	if (ab_loopvar_)
  ...
  end_loop:
    ...
    svref_new_value = nconc2(temp,
	    gensym_cons_1(convert_expression_to_stack_node_tree(sub_expression),
	    Nil));
    ...
    Object top_of_stack, local_stack;
{
    ...
    Object gensymed_symbol_5, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, wide_string_bv16_1;
    ...
    Object general_case_list;
{
    ...
    PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,10);
      ...
      PUSH_SPECIAL(Current_wide_string,current_wide_string,9);
	fill_pointer_for_current_wide_string = FIX((SI_Long)0L);
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		8);
	  length_1 = IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(Current_wide_string));
    ...
    Object value, format_string_or_unit;
{
    ...
    text_value = Nil;
    PUSH_SPECIAL(Text_value,text_value,5);
      current_wide_string_list = Qdo_not_use;
      PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		(SI_Long)3L));
    ...
    Object expression;
{
    ...
    svref_new_value = gensym_list_2(symbol_expression,symbol_value_1);
    ...
    Object top_of_stack, local_stack;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_4, sub_class_bit_vector;
    Object managed_current_value, current_value, svref_new_value;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
	...
	if (implied_attribute_name_qm) {
		...
		implied_attribute_role_qm = 
			gensym_list_3(Qclass_qualified_name,
		...
		gensymed_symbol_1 = attribute_value;
		...
		reclaim_gensym_list_1(implied_attribute_role_qm);
		implied_attribute_role_qm = Nil;
	    }
	}
	else {
...
Object funcall_is_and_possibly_unknown_inst(top_of_stack,local_stack)
    Object top_of_stack, local_stack;
{
    Object item_or_datum_arg, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, datum_arg_qm, symbolic_value_arg, symbolic_value;
    ...
    Object value1, value2, band_value;
{
	...
	temp_1 = gensym_cons_1(result_value,Qtruth_value);
    return VALUES_1(temp_1);
}
    ...
    Object truth_value_1, truth_value_2;
{
    ...
    if ( !(EQ(truth_value_1,Evaluation_true_value) || EQ(truth_value_1,
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(truth_value_1);
    if ( !(EQ(truth_value_2,Evaluation_true_value) || EQ(truth_value_2,
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(truth_value_2);
    ...
    Object top_of_stack, local_stack;
{
    ...
    Object converted_units_qm, collection_time_qm, result_qm;
    Object gensymed_symbol_1, gensymed_symbol_4, integer_portion, micro_time;
    Object aref_arg_1, managed_number_or_value, return_value_qm, stack_arg;
    SI_Long stack_arg_count, gensymed_symbol_2, gensymed_symbol_3, i;
    SI_Long ab_loop_bind_, decff_1_arg, top_of_stack_new_value;
	...
	if (time_units_qm &&  !TRUEP(converted_units_qm)) {
	    gensymed_symbol_1 = time_units_qm;
	    temp = FIXNUMP(gensymed_symbol_1);
	    if (temp);
	    else
		temp = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_1) != 
    ...
    Object top_of_stack, local_stack;
{
	...
	svref_new_value = gensym_cons_1(result_1,Qtruth_value);
    SVREF(local_stack,top_of_stack) = svref_new_value;
    return VALUES_1(Nil);
}
    ...
    Object top_of_stack, local_stack;
{
    ...
    if ( !(EQ(stack_arg_1,Evaluation_true_value) || EQ(stack_arg_1,
	    Evaluation_false_value)))
	reclaim_gensym_cons_1(stack_arg_1);
	...
	svref_new_value = 
		gensym_cons_1(previous_expression_could_supply_value,
		Qtruth_value);
