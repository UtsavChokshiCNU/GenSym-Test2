...
Object Chain_of_available_event_detectors = UNBOUND;

Object Event_detector_count = UNBOUND;
    ...
    Object event_detector;
{
    ...
    svref_new_value = Chain_of_available_event_detectors;
    SVREF(event_detector,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_event_detectors = event_detector;
    return VALUES_1(Nil);
}
...
Object make_permanent_event_detector_structure_internal()
{
    ...
    Object event_detector_count_new_value;
    ...
    event_detector_count_new_value = FIXNUM_ADD1(Event_detector_count);
    Event_detector_count = event_detector_count_new_value;
    ...
    Object designation;
{
	...
	ab_loopvar__2 = 
		gensym_cons_1(simple_installation_designation(domain),Nil);
	if (ab_loopvar__1)
	...
	temp_2 = Qnil;
      end_1:;
	return gensym_cons_1(temp,gensym_cons_1(temp_1,temp_2));
    }
}
    ...
    Object designation;
{
    ...
    return copy_tree_using_gensym_conses_1(simple_role_of_role(role_of_designation(designation)));
}
    ...
    Object designation;
{
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(make_simple_designation_slot_value_copy(domain),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
...
Object Function_templates = UNBOUND;
...
Object Action_templates = UNBOUND;
    ...
    Object entity;
{
  ...
  next_loop_1:
    temp = CDR(Available_gensym_conses);
    temp = CDR(temp);
  ...
  end_loop_1:
	...
	gensymed_symbol_2 = Available_gensym_conses;
      next_loop_2:
  ...
  end_1:;
    ...
    car_new_value = get_lookup_slot_value_given_default(child,
	    Qparent_attribute_name,Nil);
    M_CAR(gensymed_symbol_2) = car_new_value;
    gensymed_symbol_2 = M_CDR(gensymed_symbol_2);
    car_new_value = parent_name_cons_qm;
    if (car_new_value);
    else
	car_new_value = parent_name_or_names_qm;
    M_CAR(gensymed_symbol_2) = car_new_value;
    gensymed_symbol_2 = M_CDR(gensymed_symbol_2);
...
Object reclaim_parent_stack(parent_stack)
    Object parent_stack;
{
    Object trailer, current_entry_cons, entry, name_cons_cons, gensym_cons;
	...
	if (M_CAR(name_cons_cons)) {
	    gensym_cons = M_CAR(name_cons_cons);
	...
	if (entry &&  !((SI_Long)0L == inline_debugging_consing())) {
	  ...
	  next_loop_1:
	    inline_note_reclaim_cons(gensym_cons,Qab_gensym);
	    if (EQ(gensym_cons,name_cons_cons))
		goto end_1;
	...
	cdr_new_value = Available_gensym_conses;
	M_CDR(name_cons_cons) = cdr_new_value;
	...
	Available_gensym_conses = parent_stack;
	temp = Qnil;
    }
    else
	temp = Nil;
...
Object Cached_classes_for_forward_chaining = UNBOUND;

Object Cached_classes_for_backward_chaining = UNBOUND;

/* DECACHE-CLASS-CHAINING-LISTS */
Object decache_class_chaining_lists()
{
    Object class_1, ab_loop_list_, cache;
	...
	reclaim_gensym_list_1(cache);
	mutate_kb_specific_property_value(class_1,Nil,
		Cached_class_backward_chaining_list_kbprop);
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(Cached_classes_for_backward_chaining);
	Cached_classes_for_backward_chaining = Nil;
    }
	...
	goto next_loop_1;
      end_loop_1:;
	reclaim_gensym_list_1(Cached_classes_for_forward_chaining);
	Cached_classes_for_forward_chaining = Nil;
    }
    return VALUES_1(Nil);
}

Object Links_and_objects = UNBOUND;
    ...
    Object object, new_value_sense, chaining_as_well_as_events_qm;
{
    ...
    Object cache_qm, ab_loop_list_, class_1, specific_list, link_sense;
    Object designation, temp, temp_2, role, continuation, expiration_qm;
    Object gensymed_symbol_1, gensymed_symbol_2, new_cons, cdr_new_value;
    char temp_1;
    Object result;
  ...
  end_loop_1:
	...
	if (specific_list) {
	    specific_list = copy_list_using_gensym_conses_1(specific_list);
	    if (cache_qm)
	...
	goto next_loop_2;
      end_loop_2:
	mutate_kb_specific_property_value(M_CAR(classes),gensym_cons_1(Nil,
		cache_qm),Cached_class_forward_chaining_list_kbprop);
	Cached_classes_for_forward_chaining = gensym_cons_1(M_CAR(classes),
...
{
    Object link_1, class_description, classes, gensymed_symbol, list_1;
    Object cache_qm, ab_loop_list_, class_1, specific_list, symbolic_value;
    Object sense, designation, temp, temp_2, role, continuation, expiration_qm;
    Object gensymed_symbol_1, gensymed_symbol_2, new_cons, cdr_new_value;
    char temp_1;
    Object result;
    ...
    Object chaining_as_well_as_events_qm, old_managed_value;
{
    ...
    Object object_qm, cdr_new_value, gensym_cons, expiration;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);
	...
	next_loop:
	  ...
	  inline_note_reclaim_cons(link_entry,Qab_gensym);
	  cdr_new_value = Available_gensym_conses;
	  M_CDR(link_entry) = cdr_new_value;
	  Available_gensym_conses = link_entry;
	...
	end_loop:
	  if (Links_and_objects) {
		...
		end_1:;
	      ...
	      cdr_new_value = Available_gensym_conses;
	      M_CDR(trailer) = cdr_new_value;
	      Available_gensym_conses = Links_and_objects;
	      Links_and_objects = Nil;
	  }
      }
    ...
    Object variable_names_qm;
{
    ...
    Object link_sense, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object cdr_new_value, parent_frame_qm;
    char new_value_sense;

    x_note_fn_call(154,32);
    ...
    Object variable_name_or_names_qm;
{
    ...
    Object symbolic_value, sense, new_cons, gensymed_symbol_1, cdr_new_value;
    Object link_symbolic_value, link_sense, parent_frame_qm, name_for_variable;
    char temp_1;

    x_note_fn_call(154,33);
...
Object Initializing_items_needing_initialization = UNBOUND;
...
{
    Object name_for_variable, ab_loop_list_, link_1, list_1, ab_loop_list__1;
    Object link_sense, temp, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object cdr_new_value, parent_frame_qm;
    char temp_1;

    x_note_fn_call(154,35);
    name_for_variable = Nil;
    ab_loop_list_ = variable_name_or_names_qm;
  next_loop:
    if ( !TRUEP(ab_loop_list_))
    ...
    Object variable, new_value, data_type, chaining_as_well_as_events_qm;
{
    ...
    Object triggerable_event_detectors, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, temp;
    char temp_1;

    x_note_fn_call(154,36);
    variable_name_or_names_qm = 
	    get_lookup_slot_value_given_default(variable,
	    Qname_or_names_for_frame,Nil);
    if (variable_name_or_names_qm && SYMBOLP(variable_name_or_names_qm)) {
	variable_name_or_names_qm = 
		gensym_cons_1(variable_name_or_names_qm,Nil);
	...
	if (EQ(ISVREF(event_detector,(SI_Long)1L),Qreceives_a_value) &&  
	    ...
	    ab_loopvar__2 = gensym_cons_1(event_detector,Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
  ...
  next_loop_1:
    ...
    event_detector = gensym_pop_store;
  ...
  end_loop_1:;
	...
	if (event_detectors) {
	  ...
	  next_loop_2:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    if (EQ(ISVREF(event_detector,(SI_Long)1L),Qreceives_a_value)) {
		temp = ISVREF(event_detector,(SI_Long)4L);
		temp_1 = EQ(temp,
			get_lookup_slot_value_given_default(variable,
			Qparent_attribute_name,Nil));
	    }
	...
	inline_note_reclaim_cons(variable_name_cons_qm,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(variable_name_cons_qm) = cdr_new_value;
	Available_gensym_conses = variable_name_cons_qm;
    }
    return reclaim_parent_stack(parent_stack);
}

Object Names_and_info_for_chaining = UNBOUND;

Object Designations_in_rule = UNBOUND;
    ...
    Object expression, template_1, rule, sense;
{
  ...
  next_loop:
	...
	designation = gensym_cons_1(Qany,copy_for_slot_value(sub_expression));
	note_links_for_dynamic_roles(rule,
    ...
    Object designation;
{
    ...
    x_note_fn_call(154,46);
    if (CONSP(designation)) {
	temp = gensym_cons_1(local_name_for_designation(designation),
		designation);
	Designations_in_rule = gensym_cons_1(temp,Designations_in_rule);
    ...
    Object designation;
{
	...
	temp = 
		copy_tree_using_gensym_conses_1(role_of_designation(designation));
	local_copy = gensym_list_3(temp_1,temp,
...
Object note_link_for_forward_chaining varargs_1(int, n)
{
  ...
  end_loop:
    Names_and_info_for_chaining = 
	    gensym_cons_1(gensym_cons_1(chaining_list_symbol,new_link),
	    Names_and_info_for_chaining);
    return VALUES_1(Qnil);
}
    ...
    Object rule, translation;
{
    ...
    x_note_fn_call(154,52);
    current_block_of_dependent_frame = Qdependent_frame_has_no_owner;
    PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	    1);
      names_and_info_for_chaining = Nil;
      PUSH_SPECIAL(Names_and_info_for_chaining,names_and_info_for_chaining,0);
    ...
    Object chaining_links;
{
	...
	if (sub_class_vector_index < 
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    mutate_kb_specific_property_value(name,gensym_cons_1(link_1,
    ...
    Object chaining_links;
{
	...
	if (temp) {
	    temp_1 = name;
	    temp_2 = delete_gensym_element_1(link_1,
		    lookup_kb_specific_property_value(name,
		    Forward_chaining_list_kbprop));
    ...
    Object name, backward_chaining_link;
{
    ...
    x_note_fn_call(154,56);
    temp = delete_gensym_element_1(backward_chaining_link,
	    lookup_kb_specific_property_value(name,
	    Backward_chaining_list_kbprop));
    ...
    Object expression, template_1;
{
  ...
  next_loop:
	...
	designation = gensym_cons_1(Qany,copy_for_slot_value(argument));
	lookup_previous_reference_and_note_designation(designation);
	reclaim_slot_value(designation);
    }
    else if (EQ(argument_type,Qother));
    ...
    Object rule, designation, symbolic_value_qm;
{
  ...
  end_loop:
    Names_and_info_for_chaining = 
	    gensym_cons_1(gensym_cons_1(chaining_symbol,new_link),
	    Names_and_info_for_chaining);
    return VALUES_1(Qnil);
}
...
{
    Object link_1, class_description, classes, gensymed_symbol, list_1;
    Object cache_qm, ab_loop_list_, class_1, specific_list, symbolic_value_qm;
    Object designation, temp;
    char temp_1;

    x_note_fn_call(154,63);
    link_1 = Nil;
    class_description = ISVREF(object,(SI_Long)1L);
    classes = ISVREF(class_description,(SI_Long)2L);
    gensymed_symbol = M_CAR(classes);
...
{
    Object link_1, class_description, classes, gensymed_symbol, list_1;
    Object cache_qm, ab_loop_list_, class_1, specific_list, designation, temp;
    char temp_1;

    x_note_fn_call(154,64);
    link_1 = Nil;
    class_description = ISVREF(object,(SI_Long)1L);
    classes = ISVREF(class_description,(SI_Long)2L);
    gensymed_symbol = M_CAR(classes);
...
{
    Object new_precedence, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object cdr_new_value, new_entry, splice_point, link_position, temp;

    x_note_fn_call(154,65);
  ...
  end_loop:
	...
	cdr_new_value = M_CDR(splice_point);
	M_CDR(new_entry) = cdr_new_value;
...
Object withdraw_backward_chaining(variable)
    Object variable;
{
    Object new_rules_qm, interest_list, schedule_task_qm;
    Object old_structure_being_reclaimed, temp, interesting_thing;
	...
	if (SIMPLE_VECTOR_P(interesting_thing) && 
		...
		temp_1 = TRUEP(Nil);
	    if (temp_1) {
		pruned_interest_list = delete_gensym_element_1(variable,
	...
	if (interest_list) {
	  ...
	  end_loop_1:
	    ...
	    temp = Available_gensym_conses;
	    M_CDR(last_1) = temp;
	    Available_gensym_conses = interest_list;
	}
    }
...
{
    Object pruned_interests, schedule_task_qm;
    ...
    Object temp_1, def_structure_schedule_task_variable, task, ctask, p, v, q;
    Object gensymed_symbol, def_structure_queue_element_variable;
    Object gensymed_symbol_1;
    char temp, g2_p;
    double aref_new_value;

    x_note_fn_call(154,68);
    pruned_interests = delete_gensym_element_1(rule_instance,
	    ISVREF(variable,(SI_Long)35L));
	...
	temp = TRUEP(Nil);
    if (temp) {
	current_task_schedule_modify_arg_2 = ISVREF(variable,(SI_Long)42L);
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qexecute_backward_chaining_for_rules);
	...
	ISVREF(variable,(SI_Long)37L) = task;
    }
    return VALUES_1(Nil);
}
    ...
    Object variable, rule_instance;
{
    ...
    x_note_fn_call(154,69);
    svref_new_value = gensym_cons_1(rule_instance,ISVREF(variable,
	    (SI_Long)35L));
    ISVREF(variable,(SI_Long)35L) = svref_new_value;
    if (Backward_chaining_displays)
	update_backward_chaining_displays_function(variable);
    return VALUES_1(Nil);
}
    ...
    Object variable;
{
    ...
    Object temp, cdr_new_value, last_1, next_qm;

    x_note_fn_call(154,71);
  ...
  end_loop:
	...
	Available_gensym_conses = link_list;
    }
    ISVREF(variable,(SI_Long)41L) = Nil;
    ...
    Object variable;
{
    ...
    Object rest_of_links_qm, temp, cdr_new_value;

    x_note_fn_call(154,72);
    if ( !TRUEP(ISVREF(variable,(SI_Long)35L))) {
	link_list = ISVREF(variable,(SI_Long)41L);
	link_entry = Nil;
	link_1 = Nil;
	...
	inline_note_reclaim_cons(link_list,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(link_list) = cdr_new_value;
	Available_gensym_conses = link_list;
	inline_note_reclaim_cons(link_entry,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(link_entry) = cdr_new_value;
    ...
    Object variable, data_type;
{
    ...
    Object name_for_parent, ab_loop_list__1, name_for_variable, cdr_new_value;
    char temp_1;

    x_note_fn_call(154,74);
	...
	name_or_names_for_variable_qm = 
		gensym_cons_1(name_or_names_for_variable_qm,Nil);
...
Object invoke_rules_for_movement_chaining varargs_1(int, n)
{
    ...
    Object cdr_new_value, last_1, next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_varargs_nonrelocating;
    ...
    next_loop:
	  ...
	  if (EQ(role_qm,Qkb_workspace)) {
	      if ((SI_Long)0L != (IFIX(ISVREF(recipient,(SI_Long)4L)) & 
		      (SI_Long)67108864L)) {
		  gensymed_symbol_3 = ISVREF(recipient,(SI_Long)14L);
    ...
    Object object, mover;
{
    ...
    Object cache_qm, class_1, specific_list, designation, temp;
    char temp_1;

    x_note_fn_call(154,77);
    object_names_qm = get_lookup_slot_value_given_default(object,
	    Qname_or_names_for_frame,Nil);
    if (object_names_qm && SYMBOLP(object_names_qm)) {
	object_names_qm = gensym_cons_1(object_names_qm,Nil);
  ...
  end_loop_10:;
	...
	inline_note_reclaim_cons(object_name_cons_qm,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(object_name_cons_qm) = cdr_new_value;
	Available_gensym_conses = object_name_cons_qm;
    }
    return reclaim_parent_stack(parent_stack);
}
    ...
    Object object, key_sense, precomputed_links_and_objects;
{
    ...
    Object gensymed_symbol_3, cdr_new_value, last_1, next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);

    x_note_fn_call(154,79);
    if (SIMPLE_VECTOR_P(Current_computation_frame) && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(Current_computation_frame)) > 
	    (SI_Long)2L &&  !EQ(ISVREF(Current_computation_frame,
	    (SI_Long)1L),Qavailable_frame_vector)) {
...
Object Queue_existential_rules = UNBOUND;

Object Queue_existential_rules_tail = UNBOUND;
    ...
    Object new_frame, sense;
{
	...
	PUSH_SPECIAL(Links_and_objects,links_and_objects,0);
	  if (T) {
		  ...
		  ISVREF(new_task,(SI_Long)10L) = FIX((SI_Long)4L);
		  SVREF(new_task,FIX((SI_Long)11L)) = new_frame;
		  SVREF(new_task,FIX((SI_Long)12L)) = sense;
		  temp = copy_frame_serial_number(fsn);
		  SVREF(new_task,FIX((SI_Long)13L)) = temp;
		  temp = Links_and_objects;
		  SVREF(new_task,FIX((SI_Long)14L)) = temp;
    ...
    Object new_frame;
{
    ...
    x_note_fn_call(154,82);
    schedule_task_to_invoke_existential_rules(new_frame,Qis_created);
    gensymed_symbol = ISVREF(new_frame,(SI_Long)14L);
    ...
    Object object;
{
    Object links_and_objects, link_entry, ab_loop_list_, link_1, recipient;
    Object sub_class_bit_vector, temp_1, role_qm, local_name_qm, chain_object;
    Object current_computation_frame, cdr_new_value, last_1, next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(2);
    ...
    x_note_fn_call(154,89);
    links_and_objects = Nil;
    PUSH_SPECIAL(Links_and_objects,links_and_objects,1);
    ...
    Object object;
{
    ...
    Object ab_loop_list_, link_1, list_1, ab_loop_list__1, stored_sense;
    Object new_cons, gensymed_symbol, gensymed_symbol_1, cdr_new_value;
    Object parent_stack_entry, parent_frame, class_description, classes;
    Object cache_qm, class_1, specific_list, designation, temp;
    char temp_1;

    x_note_fn_call(154,91);
    object_names_qm = get_lookup_slot_value_given_default(object,
	    Qname_or_names_for_frame,Nil);
    if (object_names_qm && SYMBOLP(object_names_qm)) {
	object_names_qm = gensym_cons_1(object_names_qm,Nil);
  ...
  end_loop:;
	...
	if (EQ(stored_sense,Qfails_to_receive_a_value)) {
		...
		if ( !TRUEP(gensymed_symbol_1))
		    gensymed_symbol_1 = replenish_gensym_cons_pool();
		M_CAR(gensymed_symbol_1) = link_1;
		M_CDR(gensymed_symbol_1) = parent_frame;
		inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
		M_CAR(gensymed_symbol) = gensymed_symbol_1;
		cdr_new_value = Links_and_objects;
		M_CDR(gensymed_symbol) = cdr_new_value;
    ...
    Object new_expression_qm;
{
    ...
    PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	  ...
	  PUSH_SPECIAL(Names_and_info_for_chaining,names_and_info_for_chaining,
		  0);
	  ...
	  next_loop_1:
		...
		temp = old_name;
		temp_1 = delete_gensym_element_1(chaining_link,
	  ...
	  end_loop_1:;
	    ...
	    reclaim_gensym_cons_1(old_name_and_info);
	    goto next_loop;
	  end_loop:;
	    reclaim_gensym_list_1(Names_and_info_for_chaining);
	  POP_SPECIAL();
      }
	  ...
	  next_loop_2:
	    ...
	    mutate_kb_specific_property_value(new_name,
		    gensym_cons_1(new_link,
		    lookup_kb_specific_property_value(new_name,
		    Forward_chaining_list_kbprop)),
		    Forward_chaining_list_kbprop);
	    reclaim_gensym_cons_1(new_name_and_info);
	    goto next_loop_2;
	  end_loop_2:;
	    result = reclaim_gensym_list_1(Names_and_info_for_chaining);
	  POP_SPECIAL();
      }
      else
	  result = VALUES_1(Nil);
...
{
    Object links_and_objects, schedule_task_qm, old_structure_being_reclaimed;
    Object temp, link_entry, ab_loop_list_, link_1, recipient, last_1, next_qm;
    Declare_special(1);

    x_note_fn_call(154,95);
    links_and_objects = Nil;
    PUSH_SPECIAL(Links_and_objects,links_and_objects,0);
      ...
      temp = Nil;
      ISVREF(variable,(SI_Long)39L) = temp;
    ...
    Object object;
{
    ...
    Object sub_class_bit_vector, new_cons, gensymed_symbol_3;
    Object gensymed_symbol_4, cdr_new_value, class_description, classes;
    Object cache_qm, class_1, specific_list;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp_2;

    x_note_fn_call(154,97);
    object_names_qm = get_lookup_slot_value_given_default(object,
	    Qname_or_names_for_frame,Nil);
    if (object_names_qm && SYMBOLP(object_names_qm)) {
	object_names_qm = gensym_cons_1(object_names_qm,Nil);
  ...
  next_loop_3:
	...
	M_CAR(gensymed_symbol_4) = link_1;
	...
	cdr_new_value = Links_and_objects;
	M_CDR(gensymed_symbol_3) = cdr_new_value;
	inline_note_allocate_cons(gensymed_symbol_3,Qab_gensym);
	Links_and_objects = gensymed_symbol_3;
    }
    goto next_loop_3;
  end_loop_3:;
    goto next_loop;
    ...
    Object parent_frame, attribute_name, old_value, class_if_specific_qm;
{
    Object links_and_objects, trailer, link_entry_cons, link_entry, link_1;
    Object recipient, sub_class_bit_vector, temp_1, role_qm, local_name_qm;
    Object object_qm, cdr_new_value, gensym_cons;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);

    x_note_fn_call(154,98);
    links_and_objects = Nil;
    PUSH_SPECIAL(Links_and_objects,links_and_objects,0);
    ...
    Object parent_frame, attribute_name;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, temp, parent_names_qm;
    Object parent_name_cons_qm, parent_stack, link_1, list_1, stored_sense;
    Object gensymed_symbol, temp_1, gensymed_symbol_1, frame_to_chain_qm;
    Object new_cons;

    x_note_fn_call(154,101);
  ...
  next_loop_4:
	...
	if ( !TRUEP(parent_stack)) {
	    ...
	    parent_name_cons_qm = parent_names_qm && 
		    SYMBOLP(parent_names_qm) ? 
		    gensym_cons_1(parent_names_qm,Nil) : Nil;
	    gensymed_symbol = Nil;
	  next_loop_5:
	    temp_1 = CDR(Available_gensym_conses);
	    temp_1 = CDR(temp_1);
	  ...
	  end_2:;
	    ...
	    parent_stack = gensym_cons_1(gensymed_symbol,
	...
	if (frame_to_chain_qm) {
		...
		gensymed_symbol_1 = replenish_gensym_cons_pool();
	    M_CAR(gensymed_symbol_1) = link_1;
	    M_CDR(gensymed_symbol_1) = frame_to_chain_qm;
	    inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
	    M_CAR(gensymed_symbol) = gensymed_symbol_1;
	    temp = Links_and_objects;
    ...
    Object relation, subject, object, adding_relation_qm;
{
    ...
    Object constraint_alist, gensym_cons, cdr_new_value, last_1, next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);
    ...
    next_loop:
	  ...
	  if ( !(second_role_qm ?  !TRUEP(second_chain_object_qm) : 
		  ...
		  constraint_alist = gensym_cons_1(gensym_cons_1(temp_1,
			  second_chain_object_qm),Nil);
		  generate_and_schedule_rule_instances(recipient,role_qm,
			  local_name_qm,chain_object,Qforward_chaining,Nil,
			  ISVREF(recipient,(SI_Long)26L),constraint_alist);
		  gensym_cons = CAR(constraint_alist);
		  inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		  cdr_new_value = Available_gensym_conses;
		  M_CDR(gensym_cons) = cdr_new_value;
		  Available_gensym_conses = gensym_cons;
		  inline_note_reclaim_cons(constraint_alist,Qab_gensym);
		  cdr_new_value = Available_gensym_conses;
		  M_CDR(constraint_alist) = cdr_new_value;
		  Available_gensym_conses = constraint_alist;
	      }
	      else if (role_qm)
		  generate_and_schedule_rule_instances(recipient,role_qm,
			  local_name_qm,chain_object,Qforward_chaining,Nil,
    ...
    Object relation, subject, adding_relation_qm;
{
    ...
    Object gensymed_symbol_1, cdr_new_value, parent_stack_entry;
    Object parent_frame_qm, class_description, classes, list_1, cache_qm;
    Object class_1, specific_list, designation, temp_1;
    char temp;

    x_note_fn_call(154,104);
    subject_names_qm = get_lookup_slot_value_given_default(subject,
	    Qname_or_names_for_frame,Nil);
    if (subject_names_qm && SYMBOLP(subject_names_qm)) {
	subject_names_qm = gensym_cons_1(subject_names_qm,Nil);
  ...
  next_loop_6:
	...
	if ( !TRUEP(gensymed_symbol_1))
	    gensymed_symbol_1 = replenish_gensym_cons_pool();
	M_CAR(gensymed_symbol_1) = link_1;
	M_CDR(gensymed_symbol_1) = subject;
	inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
	M_CAR(gensymed_symbol) = gensymed_symbol_1;
	cdr_new_value = Links_and_objects;
	M_CDR(gensymed_symbol) = cdr_new_value;
  ...
  end_loop_6:;
	...
	inline_note_reclaim_cons(subject_name_cons_qm,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(subject_name_cons_qm) = cdr_new_value;
	Available_gensym_conses = subject_name_cons_qm;
    }
    return reclaim_parent_stack(parent_stack);
}
    ...
    Object connection, block, disconnecting_qm;
{
    ...
    Object gensym_cons, cdr_new_value, last_1, next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);
    ...
    Object connection_structure, block, disconnecting_qm;
{
  ...
  next_loop_7:
	...
	if ( !TRUEP(gensymed_symbol_1))
	    gensymed_symbol_1 = replenish_gensym_cons_pool();
	M_CAR(gensymed_symbol_1) = link_1;
	M_CDR(gensymed_symbol_1) = connection;
	inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
	M_CAR(gensymed_symbol) = gensymed_symbol_1;
	cdr_new_value = Links_and_objects;
	M_CDR(gensymed_symbol) = cdr_new_value;
    ...
    Object connection, disconnecting_qm;
{
  ...
  end_loop_1:;
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(input_end_entities_or_triples_found_in_search);
    return reclaim_gensym_tree_1(output_end_entities_or_triples_found_in_search);
}
    ...
    Object disconnecting_qm;
{
    ...
    Object link_1, list_1, ab_loop_list__1, new_cons, gensymed_symbol;
    Object gensymed_symbol_1, cdr_new_value, class_description, classes;
    Object cache_qm, class_1, specific_list, designation, temp;
    char temp_1;

    x_note_fn_call(154,113);
    subject_names_qm = 
  ...
  next_loop_7:
	...
	if ( !TRUEP(gensymed_symbol_1))
	    gensymed_symbol_1 = replenish_gensym_cons_pool();
	M_CAR(gensymed_symbol_1) = link_1;
	M_CDR(gensymed_symbol_1) = input_set_entity;
	inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
	M_CAR(gensymed_symbol) = gensymed_symbol_1;
	cdr_new_value = Links_and_objects;
	M_CDR(gensymed_symbol) = cdr_new_value;
...
{
    Object links_and_objects, link_entry, ab_loop_list_, link_1, recipient;
    Object sub_class_bit_vector, temp_1, cdr_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);
    ...
    next_loop:
      ...
      goto next_loop;
    end_loop:;
      result = reclaim_gensym_list_1(Links_and_objects);
    POP_SPECIAL();
    return result;
}
...
{
    Object link_1, ab_loop_list_, new_cons, gensymed_symbol, gensymed_symbol_1;
    Object cdr_new_value;

    x_note_fn_call(154,116);
    link_1 = Nil;
    ab_loop_list_ = 
    ...
    Object event_name, item, event_object;
{
    ...
    Object second_designation, second_role_qm, second_local_name_qm;
    Object link_entry, ab_loop_list_, link_1, recipient, sub_class_bit_vector;
    Object temp_1, constraint_alist, gensym_cons, cdr_new_value, last_1;
    Object next_qm;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    ...
    Object item, event_name;
{
    ...
    Object ab_loop_list_, link_1, ab_loop_list__1, new_cons, gensymed_symbol;
    Object gensymed_symbol_1, cdr_new_value, parent_stack_entry;
    Object parent_frame_qm, class_description, classes, list_1, cache_qm;
    Object class_1, specific_list, designation, temp;
    char temp_1;

    x_note_fn_call(154,120);
    item_names_qm = get_lookup_slot_value_given_default(item,
	    Qname_or_names_for_frame,Nil);
    if (item_names_qm && SYMBOLP(item_names_qm)) {
	item_names_qm = gensym_cons_1(item_names_qm,Nil);
  ...
  end_loop_6:;
	...
	inline_note_reclaim_cons(item_name_cons_qm,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(item_name_cons_qm) = cdr_new_value;
	Available_gensym_conses = item_name_cons_qm;
    }
    return reclaim_parent_stack(parent_stack);
}
    ...
    Object rule;
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = gensym_cons_1(gensym_cons_1(gensymed_symbol,
	    Qab_structure),Nil);
    if (ab_loopvar_)
    ...
    Object var;
{
    ...
    next_loop:
      ...
      ab_loop_list_ = M_CDR(ab_loop_list_);
      ab_loopvar__2 = gensym_cons_1(ISVREF(link_1,(SI_Long)2L),Nil);
      if (ab_loopvar__1)
	  M_CDR(ab_loopvar__1) = ab_loopvar__2;
      else
	  ab_loopvar_ = ab_loopvar__2;
...
void chaining_INIT()
{
    ...
    Object Qg2_get_forward_chaining_focus_info, list_constant_4;
    Object Qg2_invoke_generic_event_rules, G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qclasses_which_define, Qcopy_frame;
    Object Qcopy_frame_for_backward_chaining_link, string_constant_59;
    Object list_constant_3, string_constant_58, string_constant_57;
    Object string_constant_45, Qconnection, Qfor_every_literal;
    Object Qthere_exists_literal, Qchaining, Qlinks_and_objects;
    Object Qcached_classes_for_backward_chaining;
    Object Qcached_classes_for_forward_chaining, Qevent_detector;
    Object Qreclaim_structure, Qoutstanding_event_detector_count;
    Object Qevent_detector_structure_memory_usage, Qutilities2;
    Object Qevent_detector_count, Qchain_of_available_event_detectors;
    Object string_constant_56, Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_55, Qunique_structure_type_of_ab_name_qm;
    Object Qab_name_of_unique_structure_type;
    Object Qcopy_frame_for_forward_chaining_link;
    Object Qcopy_frame_for_true_value_update_recipient, string_constant_54;
    ...
    Object string_constant_47, string_constant_46, Qdependent_frame;
    ...
    check_if_superior_classes_are_defined(Qforward_chaining_link,
	    list_constant_3);
    string_constant_45 = STATIC_STRING("1l1l8t");
    string_constant_46 = 
	    STATIC_STRING("1t4z8r83M4y83M4y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M1y83M1y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M2y83M2y83M0y83M0y0000");
    string_constant_47 = 
	    STATIC_STRING("1n1l8o1l8l1l83Cy000004z8r83M3y83M3y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M9y83M9y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M8y");
    string_constant_48 = 
	    STATIC_STRING("83M8y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M5y83M5y83M0y83M0y00001n1l8o1l8l1l83Cy000004z8r83M6y83M6y83M0y83M0y00001n1l8o1l8l1");
    string_constant_49 = 
	    STATIC_STRING("l83Cy000004z8r83M7y83M7y83M0y83M0y00001n1l8o1l8l1l83Cy00000");
    string_constant_50 = 
	    STATIC_STRING("1v8q1n83M0y1l83=fy8t1p83M4y08o8l83Cy1p83M1y08o8l83Cy1p83M2y08o8l83Cy1p83M3y08o8l83Cy1p83M9y08o8l83Cy1p83M8y08o8l83Cy1p83M5y08o8l");
    string_constant_51 = STATIC_STRING("83Cy1p83M6y08o8l83Cy1p83M7y08o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_45);
    temp_1 = regenerate_optimized_constant(LIST_4(string_constant_46,
	    string_constant_47,string_constant_48,string_constant_49));
    add_class_to_environment(9,Qforward_chaining_link,list_constant_3,Nil,
	    temp,Nil,temp_1,list_constant_3,
	    regenerate_optimized_constant(LIST_2(string_constant_50,
	    string_constant_51)),Nil);
    ...
    check_if_superior_classes_are_defined(Qtrue_value_update_recipient,
	    list_constant_3);
    string_constant_52 = 
	    STATIC_STRING("1n4z8r83cqy83cqy83cry83cry00001n1l8o1l8l1l83Cy000004z8r83cpy83cpy83cry83cry00001n1l8o1l8l1l83Cy000004z8r83coy83coy83cry83cry0000");
    string_constant_53 = STATIC_STRING("1n1l8o1l8l1l83Cy00000");
    string_constant_54 = 
	    STATIC_STRING("1p8q1n83cry1l83=fy8t1p83cqy08o8l83Cy1p83cpy08o8l83Cy1p83coy08o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_45);
    temp_1 = regenerate_optimized_constant(LIST_2(string_constant_52,
	    string_constant_53));
    add_class_to_environment(9,Qtrue_value_update_recipient,
	    list_constant_3,Nil,temp,Nil,temp_1,list_constant_3,
	    regenerate_optimized_constant(string_constant_54),Nil);
    ...
    string_constant_55 = 
	    STATIC_STRING("43Dy8m83hEy1n83hEy8n8k1l8n0000001l1n8y83-3dy1o83vqy83vpy83vny83voykpk0k0");
    ...
    string_constant_56 = STATIC_STRING("1q83hEy8s83-Ssy09k9l");
    ...
    temp_1 = regenerate_optimized_constant(LIST_2(string_constant_57,
	    string_constant_58));
    add_class_to_environment(9,Qbackward_chaining_link,list_constant_3,Nil,
	    temp,Nil,temp_1,list_constant_3,
