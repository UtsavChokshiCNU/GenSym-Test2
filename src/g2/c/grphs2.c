    ...
    Object graph;
{
    ...
    temp = FIRST(temp);
    graph_grid = FIRST(temp);
    PUSH_SPECIAL(Redraw_as_well_as_reformat_p,redraw_as_well_as_reformat_p,0);
      plot = Nil;
...
Object Painting_for_graph_activation_p = UNBOUND;
    ...
    Object graph;
{
    ...
    Object method_function_qm, temp_1, graph_grid_qm;
    ...
    if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	future_task_schedule_modify_arg_2 = get_lookup_slot_value(graph,
	...
	if (FIXNUMP(get_lookup_slot_value(graph,Qdisplay_update_interval)))
		...
		future_task_schedule_modify_arg_4 = float_constant;
	}
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qupdate_display_for_graph);
	future_task_schedule_modify_arg_11 = graph;
	schedule_task_qm = ISVREF(graph,(SI_Long)20L);
	if (schedule_task_qm) {
  ...
  end_1:;
	...
	PUSH_SPECIAL(Painting_for_graph_activation_p,painting_for_graph_activation_p,
		1);
	  PUSH_SPECIAL(Redraw_as_well_as_reformat_p,redraw_as_well_as_reformat_p,
		  0);
    ...
    Object graph;
{
    ...
    temp = Nil;
    ISVREF(graph,(SI_Long)20L) = temp;
    schedule_task_qm = ISVREF(graph,(SI_Long)21L);
    if (schedule_task_qm) {
	if (EQ(schedule_task_qm,Current_schedule_task))
	    Current_schedule_task = Nil;
	if (ISVREF(schedule_task_qm,(SI_Long)6L))
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    pruned_interest_list = delete_gensym_element_1(graph,ISVREF(variable,
	    (SI_Long)36L));
    ...
    goto next_loop;
  end_loop:;
    gensym_list = get_lookup_slot_value_given_default(graph,
	    Qthings_this_display_is_interested_in,Nil);
    if (gensym_list) {
	last_1 = gensym_list;
	next_qm = Nil;
    ...
    Object graph_type;
{
    ...
    PUSH_SPECIAL(Redraw_as_well_as_reformat_p,redraw_as_well_as_reformat_p,0);
      ...
      temp_1 = gensym_cons_1(new_graph_grid,Nil);
      temp = gensym_list_2(temp_1,
	      gensym_cons_1(make_horizontal_axis_graph_heading_text(new_graph),
	      Nil));
...
Object Minimum_grid_width = UNBOUND;

Object Minimum_grid_height = UNBOUND;

Object Desired_low_value_for_horizontal_axis = UNBOUND;

Object Desired_high_value_for_horizontal_axis = UNBOUND;

Object Desired_low_value_for_vertical_axis = UNBOUND;

Object Desired_high_value_for_vertical_axis = UNBOUND;

Object Number_of_horizontal_grid_lines = UNBOUND;

Object Number_of_vertical_grid_lines = UNBOUND;

Object Low_value_for_horizontal_grid_lines = UNBOUND;

Object High_value_for_horizontal_grid_lines = UNBOUND;

Object Interval_between_horizontal_grid_lines = UNBOUND;

Object Low_value_for_vertical_grid_lines = UNBOUND;

Object High_value_for_vertical_grid_lines = UNBOUND;

Object Interval_between_vertical_grid_lines = UNBOUND;

Object Label_scale_for_vertical_grid_lines = UNBOUND;

Object Problems_reformatting_graph_qm = UNBOUND;

Object Finished_storing_in_plot_data_1_qm = UNBOUND;

Object Changing_graph_margins_qm = UNBOUND;
...
Object make_or_reformat_graph_grid varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Minimum_grid_width,minimum_grid_width,2);
	  minimum_grid_height = Nil;
	  PUSH_SPECIAL(Minimum_grid_height,minimum_grid_height,1);
	    ...
	    PUSH_SPECIAL(Problems_reformatting_graph_qm,problems_reformatting_graph_qm,
		    0);
		  ...
		  if (new_graph_qm)
		      set_edges_of_block(graph_grid,FIX((SI_Long)0L),
			      ...
			      (SI_Long)31L),ISVREF(graph_format,(SI_Long)32L));
		  else {
		      ...
		      change_edges_of_block(graph_grid,temp,temp_1,temp_2,
		  ...
		  svref_new_value_1 = width_of_graph_grid_block - 
			  IFIX(FIXNUM_ADD(ISVREF(graph_grid,(SI_Long)38L),
	      ...
	      if (graph_grid_qm && 
			  ...
			  {
		  if ( !(need_to_reformat_horizontal_axis_qm(graph_grid,
		  ...
		  if ( !TRUEP(horizontal_axis_grid_format_not_changed_p)) {
		      ...
		      put_up_new_labels_for_horizontal_graph_axis(graph_grid,
			      graph_format, 
			      !TRUEP(absolute_range_specified_p(temp)) ? T 
			      : Nil);
		  }
    ...
    Object erase_qm, graph_grid;
{
    ...
    PUSH_SPECIAL(Current_minimal_grid_draw_has_seen_one_image_plane_p,current_minimal_grid_draw_has_seen_one_image_plane_p,
	    2);
      PUSH_SPECIAL(Current_graph_grid_in_minimal_update,current_graph_grid_in_minimal_update,
	      1);
	changing_colors_of_graphic_elements_qm = T;
	PUSH_SPECIAL(Changing_colors_of_graphic_elements_qm,changing_colors_of_graphic_elements_qm,
		0);
...
Object compute_new_parameters_for_horizontal_axis_of_grid varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Desired_low_value_for_horizontal_axis,desired_low_value_for_horizontal_axis,
		6);
	  desired_high_value_for_horizontal_axis = Nil;
	  PUSH_SPECIAL(Desired_high_value_for_horizontal_axis,desired_high_value_for_horizontal_axis,
		  5);
		...
		PUSH_SPECIAL(Label_scale_for_vertical_grid_lines,label_scale_for_vertical_grid_lines,
			4);
		  PUSH_SPECIAL(Interval_between_vertical_grid_lines,interval_between_vertical_grid_lines,
			  3);
		    PUSH_SPECIAL(Number_of_vertical_grid_lines,number_of_vertical_grid_lines,
			    2);
		      PUSH_SPECIAL(High_value_for_vertical_grid_lines,high_value_for_vertical_grid_lines,
			      1);
			PUSH_SPECIAL(Low_value_for_vertical_grid_lines,low_value_for_vertical_grid_lines,
				0);
    ...
    Object high_value_for_horizontal_axis, new_high_value_for_horizontal_axis;
{
    ...
    reclaim_gensym_list_1(ISVREF(graph_grid,(SI_Long)51L));
	...
	if (i > ab_loop_bind_)
	    goto end_loop;
	svref_new_value = gensym_cons_1(mod(position_of_next_grid_line,
...
Object Range_too_small_qm = UNBOUND;
    ...
    Object graph_grid, graph_format;
{
	...
	PUSH_SPECIAL(Desired_low_value_for_vertical_axis,desired_low_value_for_vertical_axis,
		8);
	  desired_high_value_for_vertical_axis = Nil;
	  PUSH_SPECIAL(Desired_high_value_for_vertical_axis,desired_high_value_for_vertical_axis,
		  7);
	    ...
	    PUSH_SPECIAL(Range_too_small_qm,range_too_small_qm,6);
		...
		end_1:;
	      ...
	      PUSH_SPECIAL(Interval_between_horizontal_grid_lines,interval_between_horizontal_grid_lines,
		      5);
		PUSH_SPECIAL(Number_of_horizontal_grid_lines,number_of_horizontal_grid_lines,
			4);
		  PUSH_SPECIAL(High_value_for_horizontal_grid_lines,high_value_for_horizontal_grid_lines,
			  3);
		    PUSH_SPECIAL(Low_value_for_horizontal_grid_lines,low_value_for_horizontal_grid_lines,
			    2);
		      ...
		      PUSH_SPECIAL(Vertical_axis_range,vertical_axis_range,1);
			PUSH_SPECIAL(Low_value_for_vertical_axis,low_value_for_vertical_axis,
				0);
			  if (exact_specification_qm) {
			      Low_value_for_vertical_axis = 
    ...
    Object axis, graph_grid;
{
  ...
  next_loop:
	...
	goto end_loop;
    axis_label = ISVREF(ab_next_queue_element_,(SI_Long)2L);
    ...
    if ( !TRUEP(get_lookup_slot_value_given_default(axis_label,
	    ...
	    !TRUEP(get_lookup_slot_value_given_default(axis_label,
	    Qhorizontal_or_vertical_axis_label_qm,Nil)) || 
	    EQ(get_lookup_slot_value_given_default(axis_label,
	    Qhorizontal_or_vertical_axis_label_qm,Nil),axis))) {
    ...
    Object plot_min_and_max_qm, graph_grid;
{
    ...
    PUSH_SPECIAL(Plot_min_and_max_qm,plot_min_and_max_qm,1);
	...
	svref_new_value =  !TRUEP(plot_pattern_qm) &&  
		...
		gensym_cons_1(plot_color,gensym_cons_1(plot_pattern_qm,
		Plot_min_and_max_qm ? gensym_cons_1(Plot_min_and_max_qm,
		Nil) : Nil));
    ...
    Object most_recent_extremum_maximum_for_pixel_p;
{
    ...
    Object ring_buffer, oldest_active_element_index_for_ring_buffer;
    SI_Long temp_2;
    double aref_new_value;
    Declare_special(2);
    Object result;
    ...
    PUSH_SPECIAL(Most_recent_extremum_maximum_for_pixel_p,most_recent_extremum_maximum_for_pixel_p,
	    1);
      PUSH_SPECIAL(X_value_on_graph,x_value_on_graph,0);
	...
	if (ISVREF(data_buffer_for_plot,(SI_Long)3L)) {
		...
		temp_2 = IFIX(index_2) & (SI_Long)1023L;
		if (INLINE_DOUBLE_FLOAT_VECTOR_P(value) != (SI_Long)0L && 
			IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(value)) == 
			    (SI_Long)1L) {
		    amf_available_array_cons_qm = 
	    ...
	    index_2 = ISVREF(data_buffer_for_plot,(SI_Long)1L);
	    ring_buffer = data_buffer_for_plot;
	    temp_2 = FIXNUM_EQ(index_2,FIXNUM_SUB1(ISVREF(ring_buffer,
		    (SI_Long)4L))) ? (SI_Long)0L : IFIX(FIXNUM_ADD1(index_2));
	    ISVREF(data_buffer_for_plot,(SI_Long)1L) = FIX(temp_2);
	    index_1 = ISVREF(data_buffer_for_plot,(SI_Long)1L);
	    temp = FIXNUM_ADD1(ISVREF(data_buffer_for_plot,(SI_Long)5L));
	    SVREF(data_buffer_for_plot,FIX((SI_Long)5L)) = temp;
	    vector_1 = ISVREF(data_buffer_for_plot,(SI_Long)6L);
	...
	if (ISVREF(data_buffer_for_plot,(SI_Long)3L)) {
		...
		if (INLINE_DOUBLE_FLOAT_VECTOR_P(value) != (SI_Long)0L && 
		    ...
		    new_float = value;
		result = VALUES_1(ISVREF(temp,temp_2) = new_float);
	    }
	}
      POP_SPECIAL();
    POP_SPECIAL();
...
Object set_up_next_plot_marker_if_appropriate_for_new_plot_data()
{
	...
	if (temp_2) {
	    ...
	    temp = Current_data_buffer_for_plot;
	    svref_new_value = 
		    gensym_cons_1(ISVREF(Current_data_buffer_for_plot,
    ...
    Object use_simulation_history_qm;
{
    ...
    Object incff_1_arg, new_float, ring_buffer;
    Object oldest_active_element_index_for_ring_buffer;
    SI_Long temp_3;
	...
	if (ISVREF(Current_data_buffer_for_plot,(SI_Long)3L)) {
	    ...
	    temp_3 = FIXNUM_EQ(index_2,FIXNUM_SUB1(ISVREF(ring_buffer,
		    (SI_Long)4L))) ? (SI_Long)0L : IFIX(FIXNUM_ADD1(index_2));
	    ISVREF(temp_1,(SI_Long)1L) = FIX(temp_3);
	    index_1 = ISVREF(Current_data_buffer_for_plot,(SI_Long)1L);
	    temp_1 = Current_data_buffer_for_plot;
	    temp_2 = FIXNUM_ADD1(ISVREF(Current_data_buffer_for_plot,
		    (SI_Long)5L));
    ...
    Object plot, graph_grid;
{
	...
	if ( !TRUEP(ISVREF(data_buffer_for_plot,(SI_Long)3L))) {
	    ...
	    PUSH_SPECIAL(Plot_min_and_max_qm,plot_min_and_max_qm,0);
    ...
    Object horizontal_axis_grid_format_not_changed_p, plot_number;
{
	...
	PUSH_SPECIAL(Current_block_of_dependent_frame,current_block_of_dependent_frame,
	  ...
	  PUSH_SPECIAL(Low_and_high_values_specified_for_vertical_axis_qm,low_and_high_values_specified_for_vertical_axis_qm_1,
		  2);
	    display_evaluation_should_use_simulated_values_qm = 
	    ...
	    PUSH_SPECIAL(Low_value_for_horizontal_axis,low_value_for_horizontal_axis,
		    1);
		  ...
		  if ( !TRUEP(horizontal_axis_grid_format_not_changed_p) 
		      ...
		      PUSH_SPECIAL(Grid_width,grid_width,0);
    ...
    Object low_value_for_horizontal_axis_arg;
{
    ...
    x_note_fn_call(174,73);
    low_and_high_values_specified_for_vertical_axis_qm_1 = 
	    low_and_high_values_specified_for_vertical_axis_qm_arg;
    PUSH_SPECIAL(Low_and_high_values_specified_for_vertical_axis_qm,low_and_high_values_specified_for_vertical_axis_qm_1,
	    28);
      scale_y_data_points_qm = scale_y_data_points_qm_arg;
      PUSH_SPECIAL(Scale_y_data_points_qm,scale_y_data_points_qm,27);
	low_value_for_horizontal_axis = low_value_for_horizontal_axis_arg;
	PUSH_SPECIAL(Low_value_for_horizontal_axis,low_value_for_horizontal_axis,
		26);
	  current_plot = plot;
	  PUSH_SPECIAL(Current_plot,current_plot,25);
	    current_graph_grid = graph_grid;
	    PUSH_SPECIAL(Current_graph_grid,current_graph_grid,24);
	      current_data_buffer_for_plot = data_buffer_for_plot;
	      PUSH_SPECIAL(Current_data_buffer_for_plot,current_data_buffer_for_plot,
		      23);
		current_plot_number = plot_number;
		PUSH_SPECIAL(Current_plot_number,current_plot_number,22);
		  minimum_and_maximum_y_value_set_qm = Nil;
		  PUSH_SPECIAL(Minimum_and_maximum_y_value_set_qm,minimum_and_maximum_y_value_set_qm,
			  21);
		    fixnum_minimum_y_value = Nil;
		    PUSH_SPECIAL(Fixnum_minimum_y_value,fixnum_minimum_y_value,
			    20);
		      fixnum_maximum_y_value = Nil;
		      PUSH_SPECIAL(Fixnum_maximum_y_value,fixnum_maximum_y_value,
			      19);
			most_recent_extremum_maximum_p = Nil;
			PUSH_SPECIAL(Most_recent_extremum_maximum_p,most_recent_extremum_maximum_p,
				18);
			  variable = 
				  get_variable_given_graph_expression(display_expression,
				  display_evaluation_should_use_simulated_values_qm);
			  previous_cascaded_ring_buffer_accessed = Nil;
			  PUSH_SPECIAL(Previous_cascaded_ring_buffer_accessed,previous_cascaded_ring_buffer_accessed,
				  17);
			    previous_index_for_ring_buffer = Nil;
			    PUSH_SPECIAL(Previous_index_for_ring_buffer,previous_index_for_ring_buffer,
				    16);
			      grid_width = ISVREF(graph_grid,(SI_Long)34L);
			      PUSH_SPECIAL(Grid_width,grid_width,15);
				grid_height = ISVREF(graph_grid,(SI_Long)35L);
				PUSH_SPECIAL(Grid_height,grid_height,14);
				  plot_min_and_max_qm = Nil;
				  PUSH_SPECIAL(Plot_min_and_max_qm,plot_min_and_max_qm,
					  13);
				    history_time_to_evaluate_display_expression_with 
					    = start_time;
				    PUSH_SPECIAL(History_time_to_evaluate_display_expression_with,history_time_to_evaluate_display_expression_with,
					    12);
				      erase_dateline = 
					      compute_erase_dateline(graph_grid);
				      PUSH_SPECIAL(Erase_dateline,erase_dateline,
					      11);
					plot_marker_qm = 
						plot_marker_given_plot(plot);
					PUSH_SPECIAL(Plot_marker_qm,plot_marker_qm,
						10);
					  interval_between_plot_markers = 
						  ISVREF(graph_grid,
						  (SI_Long)54L);
					  PUSH_SPECIAL(Interval_between_plot_markers,interval_between_plot_markers,
						  9);
					    x_value_on_graph = Nil;
					    PUSH_SPECIAL(X_value_on_graph,x_value_on_graph,
						    8);
						...
						current_cascaded_ring_buffer 
							= 
							history_buffer_of_stored_values;
						PUSH_SPECIAL(Current_cascaded_ring_buffer,current_cascaded_ring_buffer,
							6);
						  ring_buffer_for_history_time 
							  = 
							  get_ring_buffer_in_cascade_for_history_time(history_buffer_of_stored_values,
							  start_time);
						  PUSH_SPECIAL(Ring_buffer_for_history_time,ring_buffer_for_history_time,
							  5);
						    ...
						    index_for_stop_time = 
							    get_history_index_by_binary_search(history_buffer_of_stored_values,
							    stop_time,T);
						    PUSH_SPECIAL(Index_for_stop_time,index_for_stop_time,
							    4);
						      temp_1 = 
						      ...
						      stop_index_time = 
							      inline_floor_1(temp_2);
						      current_index = Nil;
						      PUSH_SPECIAL(Current_index,current_index,
							      3);
							...
							many_more_data_points_than_pixels_qm 
								...
								* 
								number_of_pixels_in_time_range 
								? T : Nil;
							PUSH_SPECIAL(Many_more_data_points_than_pixels_qm,many_more_data_points_than_pixels_qm,
								2);
							  x_data_min_set_qm 
								  = Nil;
							  PUSH_SPECIAL(X_data_min_set_qm,x_data_min_set_qm,
								  1);
							    finished_storing_in_plot_data_1_qm 
								    = Nil;
							    PUSH_SPECIAL(Finished_storing_in_plot_data_1_qm,finished_storing_in_plot_data_1_qm,
								    0);
							      if (start_index_time 
								      < 
								      IFIX(start_time) 
    ...
    Object plot_marker_class, x, y, graph_line_color_value, x_scale, y_scale;
{
    ...
    Object resulting_value, icon_description_qm, current_image_x_scale;
    Object current_image_y_scale, icon_rendering, line_drawing_description;
    Object monochrome_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, unshifted_result;
    Declare_special(2);

    x_note_fn_call(174,83);
...
void graphs2_INIT()
{
    ...
    Object Qcompute_minimum_right_edge_for_graph_grid;
