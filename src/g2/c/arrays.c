    ...
    Object managed_g2_array_qm, g2_array;
{
	...
	if (CONSP(managed_g2_array_qm)) {
		...
		reclaim_gensym_tree_1(managed_g2_array_qm);
		if (Noting_changes_to_kb_p)
		    note_change_to_block_1(g2_array,Qmanaged_g2_array);
		SVREF(g2_array,FIX((SI_Long)23L)) = Nil;
	    }
	    else {
		reclaim_managed_g2_array(M_CAR(managed_g2_array_qm),
			ISVREF(g2_array,(SI_Long)21L));
		M_CAR(managed_g2_array_qm) = Nil;
		reclaim_gensym_cons_1(managed_g2_array_qm);
	    }
	}
	else
...
{
    Object element_type, old_length, temp, managed_g2_array_qm;
    ...
    if (temp_1) {
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(g2_array,Qg2_array_length);
	SVREF(g2_array,FIX((SI_Long)20L)) = new_length;
    }
    else {
	if (ISVREF(g2_array,(SI_Long)24L) &&  !TRUEP(initializing_qm) &&  
		!TRUEP(ISVREF(g2_array,(SI_Long)23L))) {
	    if (Noting_changes_to_kb_p)
		note_change_to_block_1(g2_array,Qmanaged_g2_array);
	    managed_g2_array_qm = allocate_managed_g2_array(4,old_length,
		    element_type,Nil,Nil);
	    SVREF(g2_array,FIX((SI_Long)23L)) = managed_g2_array_qm;
	}
	else
	...
	if ( !(initializing_qm ||  !TRUEP(managed_g2_array_qm) || 
	    ...
	    if (Noting_changes_to_kb_p)
		note_change_to_block_1(g2_array,Qmanaged_g2_array);
	    svref_new_value = adjust_managed_g2_array(3,
		    managed_g2_array_qm,new_length,element_type);
	    SVREF(g2_array,FIX((SI_Long)23L)) = svref_new_value;
...
static Object Qarray_is_permanent;  /* array-is-permanent */
    ...
    Object g2_array, value, gensymed_symbol;
{
    ...
    temp = ISVREF(g2_array,(SI_Long)24L);
    if (Noting_changes_to_kb_p)
	note_change_to_block_1(g2_array,Qarray_is_permanent);
    SVREF(g2_array,FIX((SI_Long)24L)) = value;
    return VALUES_1(temp);
}
    ...
    Object g2_array, new_initial_values, gensymed_symbol;
{
    ...
    if (Nil)
	gensymed_symbol_1 = nconc2(gensym_list_2(g2_array,
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
	  ...
	  svref_new_value = IFIX(ISVREF(g2_array,(SI_Long)5L)) | 
		  (SI_Long)16777216L;
	  ISVREF(g2_array,(SI_Long)5L) = FIX(svref_new_value);
      }
	...
	next_loop:
	  ...
	  ab_loop_it_ = temp ? (EQ(g2_array,M_CAR(frame_and_slot_or_atom)) 
		  ? T : Nil) : Nil;
	  if (ab_loop_it_) {
    ...
    Object g2_array, new_element_type, initializing_qm;
{
    ...
    Object gensymed_symbol_3, temp, frame_and_slot_or_atom, ab_loop_list_;
    ...
    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,0);
      ...
      temp = ISVREF(g2_array,(SI_Long)21L);
      if (Noting_changes_to_kb_p)
	  note_change_to_block_1(g2_array,Qg2_array_element_type);
      SVREF(g2_array,FIX((SI_Long)21L)) = new_element_type;
      result_1 = temp;
      if ( !TRUEP(current_flag_state_qm)) {
	  svref_new_value = IFIX(ISVREF(g2_array,(SI_Long)5L)) &  
		  ~(SI_Long)16777216L;
    ...
    Object value;
{
    ...
    Object amf_result, incff_1_arg, new_float, car_1, cdr_1, temp_1;
	...
	if (temp_2) {
	    temp_1 = CDR(value);
	    if (CONSP(temp_1) && EQ(CADR(value),Qtruth_value)) {
		...
		temp_2 = INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_1) 
			!= (SI_Long)0L ? 
		...
		temp_2 = gensymed_symbol_1 ? SYMBOLP(gensymed_symbol_1) : 
			TRUEP(Qnil);
	    if (temp_2);
	    else
		temp_2 = 
    ...
    Object g2_array, index_1, item_or_datum_qm;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, x2;
    Object frame_p_qm, frame_serial_number_qm, new_element;
    Object frame_serial_number_setf_arg, old, new_1;
    SI_Long temp_1, gensymed_symbol_2, gensymed_symbol_3, adjusted_index;
    char temp_3;
    double aref_new_value;
	...
	if (CONSP(item_or_datum_qm) && EQ(M_CDR(item_or_datum_qm),
		...
		if (EQ(convert_type_or_unit_of_measure_to_type(M_CAR(M_CDR(item_or_datum_qm))),
			...
			value = gensym_cons_1(managed_value,Qtruth_value);
		}
		else
	...
	if (frame_p_qm)
		...
		if (EQ(convert_type_or_unit_of_measure_to_type(M_CAR(M_CDR(item_or_datum_qm))),
			...
			new_element = gensym_cons_1(managed_value,
				Qtruth_value);
		}
		else
	...
	if (item_or_datum_qm) {
		...
		gensymed_symbol_1 = Nil;
	    temp_3 = gensymed_symbol_1 ? TRUEP(ISVREF(gensymed_symbol_1,
    ...
    Object g2_array;
{
	...
	if (temp) {
	    ab_loopvar__2 = gensym_cons_1(array_element_to_save_qm,Nil);
	    if (ab_loopvar__1)
...
Object convert_saved_array_values_to_g2_array_structure()
{
    ...
    Object saved_array_values, managed_g2_array, value, ab_loop_list_;
    Object value_to_set, ab_loop_iter_flag_, x2;
    SI_Long index_1, ab_loop_bind_;
    char temp;
    Declare_special(1);

    x_note_fn_call(145,45);
	...
	end_loop:
      ...
      saved_array_values = ISVREF(g2_array,(SI_Long)23L);
	  ...
	  if (Noting_changes_to_kb_p)
	      note_change_to_block_1(g2_array,Qmanaged_g2_array);
	  SVREF(g2_array,FIX((SI_Long)23L)) = managed_g2_array;
	  value = Nil;
    ...
    Object g2_array, index_1;
{
    ...
    Object amf_result, incff_1_arg, new_float, value, text_element_qm;
    Object value_qm, datum_element_qm;
    SI_Long gensymed_symbol_1;
    char temp_1;
    double aref_new_value;

    x_note_fn_call(145,46);
    element_type = ISVREF(g2_array,(SI_Long)21L);
	...
	if (value_qm) {
		...
		temp = gensym_cons_1(value_qm,Qtruth_value);
	}
	else
	    temp = Nil;
    }
    ...
    Object reclaim_new_datum_when_necessary_qm;
{
	...
	if (reclaim_new_datum_when_necessary_qm) {
		...
		reclaim_gensym_cons_1(item_or_datum_qm);
	}
    }
    else if (EQ(element_type,Qitem_or_datum)) {
	adjusted_index = IFIX(index_1) * (SI_Long)2L;
...
Object Do_not_initialize_g2_array_elements_p = UNBOUND;

/* INITIALIZE-G2-ARRAY */
Object initialize_g2_array(g2_array)
    Object g2_array;
{
    Object length_1, element_type, temp, sub_class_bit_vector, svref_new_value;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp_1;

    x_note_fn_call(145,49);
	...
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(g2_array,Qmanaged_g2_array);
	svref_new_value = allocate_managed_g2_array(4,length_1,
		element_type,Nil,Nil);
	SVREF(g2_array,FIX((SI_Long)23L)) = svref_new_value;
	if (ISVREF(g2_array,(SI_Long)23L) && IFIX(ISVREF(g2_array,
		(SI_Long)20L)) > (SI_Long)0L) {
...
Object finish_initialization_of_cloned_g2_array(g2_array)
    Object g2_array;
{
    Object managed_g2_array_or_cons, svref_new_value;

    x_note_fn_call(145,50);
    managed_g2_array_or_cons = ISVREF(g2_array,(SI_Long)23L);
    if (CONSP(managed_g2_array_or_cons)) {
	if (Noting_changes_to_kb_p)
	    note_change_to_block_1(g2_array,Qmanaged_g2_array);
	svref_new_value = M_CAR(managed_g2_array_or_cons);
	SVREF(g2_array,FIX((SI_Long)23L)) = svref_new_value;
	return reclaim_gensym_cons_1(managed_g2_array_or_cons);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object g2_array;
{
    ...
    x_note_fn_call(145,53);
    list_of_initial_values = ISVREF(g2_array,(SI_Long)22L);
    managed_g2_array = ISVREF(g2_array,(SI_Long)23L);
    element_type = ISVREF(g2_array,(SI_Long)21L);
    ...
    else if (FIXNUM_EQ(ISVREF(g2_array,(SI_Long)20L),
	    length(list_of_initial_values)))
...
{
    x_note_fn_call(145,58);
    return fill_managed_g2_array_at_position(ISVREF(g2_array,(SI_Long)23L),
	    item_or_value_qm,starting_position,ISVREF(g2_array,(SI_Long)21L));
}
    ...
    Object g2_array;
{
	...
	if (IFIX(array_length) > (SI_Long)0L) {
	    ...
	    array_length_1 = IFIX(ISVREF(array,(SI_Long)20L));
...
Object read_array_data(g2_array)
    Object g2_array;
{
    Object array_length, managed_g2_array, element_type, items_present_p;
    Object real_index, index_1, element, index_2, value, temp, x2;
    Object frame_serial_number_setf_arg, old, new_1, svref_new_value, temp_3;
    ...
    Object g2_array, g2_list;
{
    ...
    SI_Long inner_index, ab_loop_bind_, incff_1_arg_1;
    char temp;
    double aref_new_value;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(145,65);
    ...
    Object key_array, data_array_1, data_array_2_qm, left_init, right_init;
{
    ...
    Object amf_result, incff_1_arg, new_float, svref_new_value;
    ...
    Object key_array, data_array_1, data_array_2_qm, left_init, right_init;
{
    ...
    Object incff_1_arg, new_float, svref_new_value, temp_3, temp_4;
	...
	value = FIXNUM_LE(ISVREF(a,(SI_Long)1L),
		...
		IFIX(Managed_array_index_offset)) : ISVREF(ISVREF(a,(left 
		>>  -  - (SI_Long)10L) + (SI_Long)2L),left & (SI_Long)1023L);
	temp_3 = INLINE_DOUBLE_FLOAT_VECTOR_P(value) != (SI_Long)0L && 
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(value)) == (SI_Long)1L ? 
		DOUBLE_TO_DOUBLE_FLOAT(DFLOAT_ISAREF_1(value,(SI_Long)0L)) 
		: value;
	value = FIXNUM_LE(ISVREF(a,(SI_Long)1L),
    ...
    Object g2_array;
{
    ...
    Object amf_result, incff_1_arg, new_float, x2, designation_qm, temp_2;
    Object new_cons, gensymed_symbol_3, top_of_stack, text_string, snapshots;
    ...
    SI_Long outer_index, inner_index, ab_loop_bind_, gensymed_symbol_1;
    SI_Long incff_1_arg_1, bv16_length, aref_arg_2, aref_new_value_1, length_1;
    char temp;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	  ...
	  next_loop_1:
		...
		if (temp) {
		    ...
		    if (designation_qm) {
			temp_2 = 
				copy_tree_using_gensym_conses_1(designation_qm);
		...
		M_CDR(tail_qm) = gensymed_symbol_2;
	    }
	    else
    ...
    Object element, g2_list;
{
  ...
  next_loop:
	...
	goto end_loop;
    item_or_value = ISVREF(ab_loopvar__1,(SI_Long)2L);
    ...
    Object element, g2_array;
{
	...
	temp = TRUEP(Nil);
    if (temp) {
	value_to_match = INLINE_DOUBLE_FLOAT_VECTOR_P(element) != 
	...
	temp = TRUEP(Nil);
    if (temp)
	value_to_match = CONSP(element) && EQ(M_CDR(element),Qtruth_value) 
		? M_CAR(element) : Nil;
    ...
    Object rbfn, x, y;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, maximum_activation;
    Object current_activation, managed_x, managed_y, managed_difference;
    Object managed_array_2, sqdist, shape_factor, gensymed_symbol_1;
    Object managed_sum, managed_center_vector, s, f, shape_vector;
    Object managed_shape_vector, weight_vector, managed_weight_vector;
    SI_Long gensymed_symbol, i, ab_loop_bind_, j, ab_loop_bind__1, aref_arg_2;
    SI_Long k, ab_loop_bind__2;
    double aref_new_value, temp_1, temp_2, temp_3, arg, arg_1;

    x_note_fn_call(145,81);
	...
	goto next_loop_1;
      end_loop_1:;
	temp_1 =  - DFLOAT_ISAREF_1(sqdist,(SI_Long)0L);
	temp_2 = DOUBLE_FLOAT_TO_DOUBLE(shape_factor);
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(shape_factor);
	aref_new_value = exp(temp_1 / (temp_2 * temp_3));
    ...
    Object symbol, item_to_clone;
{
    ...
    Object newly_cloned_item_qm, top_of_stack, message_1, gensymed_symbol;
    ...
    SI_Long gensymed_symbol_2, gensymed_symbol_3, bv16_length, aref_arg_2;
    SI_Long aref_new_value, length_1, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;
    Declare_special(7);

    x_note_fn_call(145,82);
...
void arrays_INIT()
{
    ...
    Object string_constant_50, Qfloat_array, string_constant_48;
    Object string_constant_47, array_constant_1, string_constant_46;
    Object Qquantity_array, string_constant_45, list_constant_4;
    Object string_constant_26, string_constant_44, string_constant_43;
    Object Qtruth_value_array, string_constant_42, string_constant_41;
    Object string_constant_40, string_constant_39, Qtext_array;
    Object string_constant_38, string_constant_37, string_constant_36;
    Object string_constant_35, Qsymbol_array, string_constant_34;
    Object string_constant_33, string_constant_32, string_constant_31;
    Object Qvalue_array, string_constant_30, list_constant_3;
    Object string_constant_29, string_constant_28, string_constant_27;
    Object string_constant_25, string_constant_24, Qslot_putter;
    Object Qput_g2_array_element_type, Qput_g2_array_initial_values;
    Object Qframe_note_writer_1, Qput_array_is_permanent, Qput_g2_array_length;
    Object Qslot_value_reclaimer, Qreclaim_managed_g2_array_value;
    Object Qinitial_values, Qelement_type, Qarray_length, string_constant_23;
    ...
    Qcreate_icon_description = STATIC_SYMBOL("CREATE-ICON-DESCRIPTION",
	    AB_package);
    string_constant_12 = 
	    STATIC_STRING("1q4z8r835Ey835Ey831Yy831Yy0k001o1l8o1m8p835Ey1l8l1l8z000004z8r83-vy83-vy831Yy831Yy083=Ky001o1l8o1m8p83-Yy1l8l1l83Fy000004z8r83-w");
    string_constant_13 = 
	    STATIC_STRING("y83-wy831Yy831Yy00001p1l8o1m8p839Ly1l8l1l8z1l83Cy000004z8r83Uky83Uky831Yy831Yy00001r1l8o1l8l1m8p835fy1l83Uy1l83Cy1l83Ny1l83Fy000");
    string_constant_14 = 
    ...
    string_constant_20 = 
	    STATIC_STRING(" array. <!--from managed-g2-array-->\n</ul>1q835Eyk8o1m8p835Ey8l8z1q83-vy83=Ky8o1m8p83-Yy8l83Fy1r83-wy08o1m8p839Ly8l8z83Cy1t83Uky");
    string_constant_21 = 
    ...
    string_constant_25 = 
	    STATIC_STRING("1m4z8r83-vy83-vy834Fy834Fy083Ry001p1l8l1l83Fy1l8z1l8o1m8p83-Yy000004z8r83-wy83-wy834Fy834Fy00001p1l8l1m8p836jy1l8o1l8z1l83Cy0000");
    ...
    string_constant_29 = 
	    STATIC_STRING("1m4z8r83-vy83-vy830vy830vy083=oy001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy830vy830vy01l9k001p1l8l1m8p839Ky1l8o1l8z1l83Cy0000");
    ...
    string_constant_32 = 
	    STATIC_STRING("1m4z8r83-vy83-vy834dy834dy083-2y001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy834dy834dy01l830Jy001p1l8l1m8p831ky1l8o1l8z1l83Cy0");
    ...
    string_constant_36 = 
	    STATIC_STRING("1m4z8r83-vy83-vy834hy834hy083Gy001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy834hy834hy01l+skkkkkkk3A++y001p1l8l1m8p837fy1l8o1l8");
    ...
    string_constant_40 = 
	    STATIC_STRING("1m4z8r83-vy83-vy834ly834ly083-hy001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy834ly834ly01l3Baz001p1l8l1m8p831my1l8o1l8z1l83Cy00");
    ...
    string_constant_44 = 
	    STATIC_STRING("1m4z8r83-vy83-vy8316y8316y083-Hy001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy8316y8316y01l9k001p1l8l1m8p830Qy1l8o1l8z1l83Cy0000");
    string_constant_45 = 
    ...
    string_constant_47 = 
	    STATIC_STRING("1m4z8r83-vy83-vy833wy833wy09k001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy833wy833wy01l9l001p1l8l1m8p831Xy1l8o1l8z1l83Cy00000");
    string_constant_48 = 
    ...
    string_constant_50 = 
	    STATIC_STRING("1m4z8r83-vy83-vy831cy831cy083Sy001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy831cy831cy01lk001p1l8l1m8p831dy1l8o1l8z1l83Cy00000");
    string_constant_51 = 
    ...
    string_constant_52 = 
	    STATIC_STRING("1m4z8r83-vy83-vy83UUy83UUy083=By001o1l8l1l8o1m8p83-Yy1l83Fy000004z8r83-wy83-wy83UUy83UUy01lk001p1l8l1m8p83UVy1l8o1l8z1l83Cy00000");
    string_constant_53 = 
	    STATIC_STRING("1o8q1n83UUy1l8316y1m8v831cy1m83-vy83=By1n83-wy1lk1m8p83UVy");
    temp = regenerate_optimized_constant(string_constant_49);
