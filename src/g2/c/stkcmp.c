    ...
    Object function_name, function_definition, expression, arguments;
{
	...
	PUSH_SPECIAL(Compiler_warnings,compiler_warnings,16);
	  PUSH_SPECIAL(Compiler_errors,compiler_errors,15);
		...
		PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,
		  ...
		  PUSH_SPECIAL(Goto_tags_in_compilation,goto_tags_in_compilation,
			  13);
		    PUSH_SPECIAL(New_goto_tag_counter,new_goto_tag_counter,12);
						  ...
						  PUSH_SPECIAL(Outermost_stack_frame_var_binding_qm,outermost_stack_frame_var_binding_qm,
						    ...
						    end_1:;
						      expression_bound_local_names 
							      ...
							      phrase_cons(temp_1,
							      temp_2));
						      PUSH_SPECIAL(Expression_bound_local_names,expression_bound_local_names,
							      1);
							unknown_allowed = 
							...
							if ( 
							    ...
							    inhibit_free_reference_recording 
								    = T;
							    PUSH_SPECIAL(Inhibit_free_reference_recording,inhibit_free_reference_recording,
								    0);
							      unknown_no_item_allowed_compile_qm 
								      = 
								      compile_stack_expression_into_nodes(name_resolution_compile_qm,
    ...
    Object initial_value_expression_qm;
{
    ...
    compiler_errors = Nil;
    compiler_warnings = Nil;
    PUSH_SPECIAL(Compiler_warnings,compiler_warnings,14);
      PUSH_SPECIAL(Compiler_errors,compiler_errors,13);
	remove_compiler_error_and_warning_frame_notes();
	if (PUSH_UNWIND_PROTECT(3)) {
	    new_goto_tag_counter = FIX((SI_Long)0L);
	    goto_tags_in_compilation = Nil;
	    ...
	    PUSH_SPECIAL(Lexically_visible_goto_tags,lexically_visible_goto_tags,
	      ...
	      PUSH_SPECIAL(Goto_tags_in_compilation,goto_tags_in_compilation,
		      11);
		PUSH_SPECIAL(New_goto_tag_counter,new_goto_tag_counter,10);
		  if (PUSH_UNWIND_PROTECT(2)) {
		      lexically_visible_code_bodies = Nil;
		      code_body_entries_in_compilation = Nil;
		      PUSH_SPECIAL(Code_body_entries_in_compilation,code_body_entries_in_compilation,
...
{
    Object role, domain_qm, temp, gensymed_symbol, gensymed_symbol_1;
	...
	if (EQ(CAR(designation),Qthe)) {
		...
		if (temp)
		    ...
		    gensymed_symbol_2 = SXHASH_SYMBOL_1(role) & 
...
Object Conclude_parent_attribute_bindings = UNBOUND;

Object Local_name_to_cached_designation_alist = UNBOUND;

Object Rule_certainty_var = UNBOUND;

Object Rule_expiration_var = UNBOUND;

Object Conclude_attribute_binding_symbol_counter = UNBOUND;

Object Conclude_attribute_binding_listed_next_symbol = UNBOUND;

Object Conclude_attribute_binding_symbol_supply = UNBOUND;
...
Object interned_conclude_attribute_binding_symbol()
{
	...
	temp = FIXNUM_ADD1(Conclude_attribute_binding_symbol_counter);
	Conclude_attribute_binding_symbol_counter = temp;
	...
	temp_1 = CAR(Conclude_attribute_binding_listed_next_symbol);
	temp = FIXNUM_ADD1(Conclude_attribute_binding_symbol_counter);
	Conclude_attribute_binding_symbol_counter = temp;
	Conclude_attribute_binding_listed_next_symbol = 
	...
	temp = FIXNUM_ADD1(Conclude_attribute_binding_symbol_counter);
	Conclude_attribute_binding_symbol_counter = temp;
	temp = Conclude_attribute_binding_listed_next_symbol;
	if (PUSH_AREA(Dynamic_area,0))
    ...
    Object rule, parse_and_compilations;
{
    ...
    PUSH_SPECIAL(Rule_certainty_var,rule_certainty_var,21);
      certainty_var_spot = Nil;
      rule_expiration_var = Nil;
      PUSH_SPECIAL(Rule_expiration_var,rule_expiration_var,20);
	...
	PUSH_SPECIAL(Local_name_to_cached_designation_alist,local_name_to_cached_designation_alist,
		19);
	  conclude_parent_attribute_bindings = Nil;
	  PUSH_SPECIAL(Conclude_parent_attribute_bindings,conclude_parent_attribute_bindings,
		  18);
	  ...
	  end_loop:
	    ...
	    compiler_errors = Nil;
	    compiler_warnings = Nil;
	    PUSH_SPECIAL(Compiler_warnings,compiler_warnings,17);
	      PUSH_SPECIAL(Compiler_errors,compiler_errors,16);
		remove_compiler_error_and_warning_frame_notes();
				...
				PUSH_SPECIAL(Lexically_visible_code_bodies,lexically_visible_code_bodies,
				  ...
				  if (PUSH_UNWIND_PROTECT(2)) {
					...
					if (PUSH_UNWIND_PROTECT(1)) {
						...
						PUSH_SPECIAL(Conclude_attribute_binding_listed_next_symbol,conclude_attribute_binding_listed_next_symbol,
							7);
						  PUSH_SPECIAL(Conclude_attribute_binding_symbol_counter,conclude_attribute_binding_symbol_counter,
							  6);
						    gensymed_symbol = 
							    CAR(Lexically_visible_code_bodies);
...
Object Current_let_action_bindings = UNBOUND;
    ...
    Object action, expiration_var_spot, push_stack_frame_vars_instruction;
{
    ...
    PUSH_SPECIAL(Current_let_action_bindings,current_let_action_bindings,0);
      gensymed_symbol = action;
      gensymed_symbol = CDR(gensymed_symbol);
    ...
    Object stack_node_instruction;
{
    ...
    Object amf_result, incff_1_arg, new_float, new_constant, small_text;
...
Object Sorted_static_evaluate_role_dispatchers = UNBOUND;
    ...
    Object stack_node_instruction;
{
  ...
  end_loop_1:;
	...
	if (place_reference_allowed_qm) {
		...
		temp_2 = 
			gensym_cons_1(choose_stack_node_instructions_and_types(2,
...
Object Already_mutated_evaluators = UNBOUND;
    ...
    Object expression;
{
    ...
    Object ab_loopvar__1, amf_available_array_cons_qm, amf_array;
    ...
    PUSH_SPECIAL(Expression_bound_local_names,expression_bound_local_names,0);
	  ...
	  if (ATOM(expression) ? expression && SYMBOLP(expression) : 
		...
		end_loop:
		  ...
		  temp_1 = gensym_cons_1(temp,arg_nodes);
		  SVREF(node,FIX((SI_Long)2L)) = temp_1;
		  result = VALUES_1(node);
		  goto end_1;
...
Object Compile_reference_to_system_slot = UNBOUND;
    ...
    Object designation;
{
	...
	new_designation = gensym_cons_1(temp,gensym_cons_1(temp_1,
		CDDR(designation)));
	stack_list = 
		gensym_cons_1(convert_designation_to_stack_node_tree(new_designation),
		Nil);
	reclaim_gensym_cons_1(CDR(new_designation));
    ...
    Object combine_index;
{
    ...
    svref_new_value = gensym_list_2(temp,
    ...
    Object stack_node, required_type;
{
	...
	Stack_nodes_to_reclaim = gensym_cons_1(gensymed_symbol,
		Stack_nodes_to_reclaim);
	new_node = gensymed_symbol;
	svref_new_value = gensym_cons_1(stack_node,Nil);
	SVREF(new_node,FIX((SI_Long)2L)) = svref_new_value;
    ...
    Object stack_node;
{
	...
	ab_loopvar__1 = gensym_cons_1(expiration_node,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	...
	temp_1 = gensym_cons_1(stack_node,expiration_nodes);
...
void stack_comp_INIT()
{
    ...
    Object Qvalue_array, Qunique_value_of_role_instruction_name, Qfloat_array;
    ...
    Object Qconclude_attribute_binding_symbol_supply;
    Object Qconclude_attribute_binding_1, Kfuncall, Qstack_comp;
    Object Qrule_expiration_var, Qrule_certainty_var;
    Object Qlocal_name_to_cached_designation_alist;
    Object Qconclude_parent_attribute_bindings, Qfunction_can_return_unknown;
    Object Qno_item, Qunknown_datum;
