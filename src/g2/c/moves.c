...
Object Current_dragging_states = UNBOUND;
    ...
    Object a_cons;
{
    ...
    return reclaim_gensym_cons_1(a_cons);
}

Object The_type_description_of_dragging_state = UNBOUND;

Object Chain_of_available_dragging_states = UNBOUND;

Object Dragging_state_count = UNBOUND;
    ...
    Object dragging_state;
{
    ...
    reclaim_gensym_list_1(ISVREF(dragging_state,(SI_Long)3L));
    SVREF(dragging_state,FIX((SI_Long)3L)) = Nil;
    reclaim_dragging_list_of_pane_cursors(ISVREF(dragging_state,(SI_Long)26L));
    SVREF(dragging_state,FIX((SI_Long)26L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_dragging_states;
    SVREF(dragging_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_dragging_states = dragging_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_dragging_state_structure_internal()
{
    ...
    Object dragging_state_count_new_value;
    ...
    dragging_state_count_new_value = FIXNUM_ADD1(Dragging_state_count);
    Dragging_state_count = dragging_state_count_new_value;
...
{
    Object def_structure_dragging_state_variable, svref_new_value;
    ...
    SVREF(def_structure_dragging_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    ...
    Object l;
{
  ...
  next_loop:
    ...
    reclaim_gensym_tree_1(x);
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(l);
}

Object Explicit_dragger_x_in_window_qm = UNBOUND;

Object Explicit_dragger_y_in_window_qm = UNBOUND;
...
Object enter_dragging_context_1 varargs_1(int, n)
{
	...
	blocks_to_drag_qm = 
		gensym_cons_1(image_plane_block_or_blocks_to_drag,Nil);
    ...
    dragging_state = make_dragging_state_1(dragging_style,outline,
	    ...
	    mouse_up_exits_this_context_qm,
	    original_workspace_of_objects_being_dragged_qm);
    Current_dragging_states = gensym_cons_1(dragging_state,
...
Object Do_not_invoke_rules_for_user_icon_movement_qm = UNBOUND;
    ...
    Object block_or_blocks;
{
	...
	gensymed_symbol = ISVREF(block_or_blocks,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)6L) : Nil;
    ...
    Object mouse_pointer;
{
	...
	PUSH_SPECIAL(Explicit_dragger_y_in_window_qm,explicit_dragger_y_in_window_qm,
		1);
	  PUSH_SPECIAL(Explicit_dragger_x_in_window_qm,explicit_dragger_x_in_window_qm,
		  0);
    ...
    Object dragging_state;
{
	...
	if ( !TRUEP(ISVREF(dragging_state,(SI_Long)7L))) {
	    ...
	    reclaim_gensym_list_1(objects_being_dragged);
	}
	image_plane_qm = ISVREF(dragging_state,(SI_Long)5L);
	if (image_plane_qm)
	    remove_image_plane_cursor(image_plane_qm,dragging_state);
    }
    Current_dragging_states = delete_gensym_element_1(dragging_state,
	    Current_dragging_states);
    gensymed_symbol = 
	    ISVREF(ISVREF(ISVREF(The_type_description_of_dragging_state,
    ...
    Object dragging_state;
{
	...
	if (place_connection_if_orthogonal_qm(connection_being_dragged,d1,
	    ...
	    gensymed_symbol_3 = ISVREF(loose_end,(SI_Long)14L);
    ...
    Object loose_end, connection, final_image_plane;
{
    ...
    objects_to_not_consider = gensym_list_2(loose_end,connection);
    object_qm = Nil;
  next_loop:
	...
	temp_2 = TRUEP(Nil);
    if (temp_2)
	objects_to_not_consider = gensym_cons_1(object_qm,
  ...
  end_loop:
    temp_1 = Qnil;
  end_1:;
    reclaim_gensym_list_1(objects_to_not_consider);
...
Object Chain_of_available_move_dragging_states = UNBOUND;

Object Move_dragging_state_count = UNBOUND;
    ...
    Object move_dragging_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_move_dragging_states;
    SVREF(move_dragging_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_move_dragging_states = move_dragging_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_move_dragging_state_structure_internal()
{
    ...
    Object move_dragging_state_count_new_value;
    ...
    move_dragging_state_count_new_value = 
	    FIXNUM_ADD1(Move_dragging_state_count);
    Move_dragging_state_count = move_dragging_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_move_dragging_state_variable, svref_new_value;
    ...
    svref_new_value = copy_of_current_frame_serial_number_function();
    SVREF(def_structure_move_dragging_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_move_dragging_state_variable);
}
...
Object Chain_of_available_transfer_dragging_states = UNBOUND;

Object Transfer_dragging_state_count = UNBOUND;
    ...
    Object transfer_dragging_state;
{
    ...
    reclaim_gensym_list_function(ISVREF(transfer_dragging_state,(SI_Long)3L));
    SVREF(transfer_dragging_state,FIX((SI_Long)3L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_transfer_dragging_states;
    SVREF(transfer_dragging_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_transfer_dragging_states = transfer_dragging_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_transfer_dragging_state_structure_internal()
{
    ...
    Object transfer_dragging_state_count_new_value;
    ...
    transfer_dragging_state_count_new_value = 
	    FIXNUM_ADD1(Transfer_dragging_state_count);
    Transfer_dragging_state_count = transfer_dragging_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_transfer_dragging_state_variable, svref_new_value;
...
Object offer_to_recompile_after_transfer()
{
    ...
    return enter_dialog(7,temp,Nil,Nil,
	    ...
	    gensym_list_2(Qtransfer_dragging,Qno_recompile));
}
...
Object Current_image_plane_qm = UNBOUND;
    ...
    Object just_erase_if_currently_drawn_qm;
{
	...
	PUSH_SPECIAL(Current_image_plane_qm,current_image_plane_qm,5);
    ...
    Object erase_qm, draw_qm;
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,53);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,52);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,51);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,50);
	    ...
	    PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	      ...
	      PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		      48);
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,47);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,46);
										  ...
										  PUSH_SPECIAL(Loose_right_edge_of_visible_workspace_area,loose_right_edge_of_visible_workspace_area,
											...
											PUSH_SPECIAL(Current_image_plane,current_image_plane,
											  ...
											  PUSH_SPECIAL(Current_pane,current_pane,
											    ...
											    PUSH_SPECIAL(Outer_native_image_plane,outer_native_image_plane,
												    3);
											      current_native_image_plane 
												      = 
												      image_plane;
											      PUSH_SPECIAL(Current_native_image_plane,current_native_image_plane,
												      2);
												if ( 
											  ...
											  PUSH_SPECIAL(Current_pane,current_pane,
												...
												if ( 
												  ...
												  if ( 
													  !EQ(image_plane,
													  Current_native_image_plane))
												      result = nip_begin_drawing(Current_native_image_plane);
												  else
												      result = VALUES_1(Nil);
											      }
											      else
    ...
    Object erase_qm, workspace_enclosing_drawing, blocks, connections;
{
    ...
    PUSH_SPECIAL(Current_drawing_transfer_mode,current_drawing_transfer_mode,
      ...
      PUSH_SPECIAL(Update_images_in_xor_overlay_p,update_images_in_xor_overlay_p,
	      0);
    ...
    Object image_plane, cursor;
{
	...
	gensym_push_modify_macro_arg = cursor;
    ...
    Object image_plane, cursor;
{
    ...
    svref_new_value = delete_gensym_element_1(cursor,ISVREF(image_plane,
	    (SI_Long)27L));
...
Object add_image_plane_cursors_to_current_window()
{
	...
	right_edge_of_draw_area = Right_edge_of_draw_area;
	bottom_edge_of_draw_area = Bottom_edge_of_draw_area;
	PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,12);
	  PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,11);
	    PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,10);
	      PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,9);
	  ...
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,50);
		...
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,47);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,46);
		    ...
		    PUSH_SPECIAL(Current_window,current_window_1,45);
		      drawing_on_window = Nil;
		      PUSH_SPECIAL(Drawing_on_window,drawing_on_window,44);
			current_drawing_transfer_mode = 
    ...
    Object cursor;
{
	...
	return reclaim_gensym_list_1(cursor);
    else if (selection_highlight_cursor_p(cursor))
	return reclaim_gensym_list_1(cursor);
    else
	return VALUES_1(Nil);
    ...
    Object image_plane_cursors;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(image_plane_cursors);
}
    ...
    Object selectable, workspace, dx, dy;
{
    ...
    PUSH_SPECIAL(Current_image_plane,current_image_plane,53);
    next_loop:
      if ( !TRUEP(ab_loop_list_))
	  goto end_loop;
	  ...
	  if (cursors) {
		...
		PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,
			51);
		  PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,50);
		    PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
			    49);
		      current_image_x_scale = FIX((SI_Long)4096L);
		      current_image_y_scale = FIX((SI_Long)4096L);
    ...
    Object image_plane, cursor, new_color;
{
    ...
    PUSH_SPECIAL(Current_image_plane,current_image_plane,53);
      ...
      right_edge_of_draw_area = ISVREF(gensym_window,(SI_Long)9L);
      bottom_edge_of_draw_area = ISVREF(gensym_window,(SI_Long)10L);
      PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,52);
	PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,51);
	  PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,50);
	    PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,49);
	      current_image_x_scale = FIX((SI_Long)4096L);
	      current_image_y_scale = FIX((SI_Long)4096L);
	      current_x_origin_of_drawing = FIX((SI_Long)0L);
	      current_y_origin_of_drawing = FIX((SI_Long)0L);
		...
		PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
			47);
		  PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,46);
		    PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,
			    45);
		      left_edge_of_draw_area = Left_edge_of_draw_area;
		      top_edge_of_draw_area = Top_edge_of_draw_area;
    ...
    Object thing, image_plane;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(cursor,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
    ...
    Object object_or_connection;
{
    ...
    Object stack, sub, gensym_pop_store, cons_1, next_cons, temp_1;
    Object gensymed_symbol, ab_queue_form_, ab_next_queue_element_;
  ...
  next_loop:
	...
	temp = delete_gensym_element_1(object_or_connection,
  ...
  end_loop:
    if (object_is_a_frame_qm) {
	stack = gensym_cons_1(object_or_connection,Nil);
	sub = Nil;
      next_loop_2:
	if ( !TRUEP(stack))
	    goto end_loop_2;
	...
	if (EQ(temp_1,Tree_traversal_marker)) {
		...
		next_cons = Nil;
	    stack = next_cons;
	    sub = gensym_pop_store;
	}
	else if (IDENTITY(temp_1)) {
	    gensymed_symbol = ISVREF(temp_1,(SI_Long)14L);
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)4L) : Nil;
	    ab_queue_form_ = gensymed_symbol;
	    ab_next_queue_element_ = Nil;
	  ...
	  next_loop_3:
	    if (EQ(ab_next_queue_element_,ab_queue_form_))
		goto end_loop_3;
	    gensymed_symbol = ISVREF(ab_next_queue_element_,(SI_Long)2L);
	  ...
	  end_1:;
		...
		temp_2 = T ? infs : copy_list_using_gensym_conses_1(infs);
    ...
    Object block;
{
  ...
  next_loop:
	...
	if (EQ(ISVREF(dragging_state,(SI_Long)21L),Qmove_dragging_style)) {
	    svref_new_value = delete_gensym_element_1(block,
		    ISVREF(dragging_state,(SI_Long)3L));
...
Object remove_block_from_xor_overlay(block)
    Object block;
{
    Object stack, sub, gensym_pop_store, cons_1, next_cons, cdr_new_value;
    Object temp, gensymed_symbol, ab_queue_form_, ab_next_queue_element_;
    Object ab_loopvar_, ab_loopvar__1, ab_loopvar__2, infs, temp_1, temp_2;
    SI_Long svref_new_value;
    char value;
  ...
  next_loop:
	...
	if ( !TRUEP(infs))
	    ...
	    temp_1 = T ? infs : copy_list_using_gensym_conses_1(infs);
	    temp_2 = gensym_cons_1(Tree_traversal_marker,Nil);
	    stack = nconc2(temp_1,nconc2(temp_2,nconc2(gensym_cons_1(temp,
		    Nil),stack)));
	}
    }
    if (sub) {
    ...
    Object block;
{
  ...
  next_loop:
	...
	objects_being_dragged = 
		...
		(SI_Long)3L));
	reclaim_gensym_list_1(ISVREF(dragging_state,(SI_Long)3L));
	reclaim_gensym_list_1(ISVREF(dragging_state,(SI_Long)6L));
	SVREF(dragging_state,FIX((SI_Long)3L)) = Nil;
  ...
  next_loop:
    ...
    end_1:
	  ...
	  if ( !TRUEP(memq_function(loose_end_maybe,blocks))) {
	      cdr_new_value = gensym_cons_1(loose_end_maybe,CDR(blocks));
    ...
    Object blocks;
{
  ...
  next_loop:
    ...
    end_1:
	  ...
	  ab_loopvar__4 = gensym_cons_1(connection,Nil);
	  if (ab_loopvar__3)
    ...
    Object dragging_state;
{
    ...
    Object ab_loop_list_, stack, sub, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, temp, gensymed_symbol, ab_queue_form_;
    Object ab_next_queue_element_, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    Object infs, temp_1, temp_2;
    SI_Long svref_new_value;
    char value;
    Declare_special(2);
    Object result;
	...
	next_loop_1:
	  ...
	  if (EQ(temp,Tree_traversal_marker)) {
	    ...
	    end_1:;
		  ...
		  temp_1 = T ? infs : copy_list_using_gensym_conses_1(infs);
		  temp_2 = gensym_cons_1(Tree_traversal_marker,Nil);
		  stack = nconc2(temp_1,nconc2(temp_2,
    ...
    Object dragging_state;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, temp_1;
    Object gensymed_symbol, ab_queue_form_, ab_next_queue_element_;
    Object ab_loopvar_, ab_loopvar__1, ab_loopvar__2, infs, temp_2, temp_3;
...
Object shift_blocks_with_their_external_connections varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Do_not_update_selection_highlights,do_not_update_selection_highlights,
		0);
	  block = Nil;
	  ab_loop_list_ = blocks;
	next_loop:
    ...
    Object image_plane, x_offset_from_dragger, y_offset_from_dragger;
{
    ...
    temp = gensym_list_3(Qimage_plane,image_plane,ISVREF(image_plane,
	    (SI_Long)5L));
...
Object erase_outline_of_image_plane_being_dragged varargs_1(int, n)
{
	...
	temp = CDDDR(temp);
	temp = 
		copy_list_using_gensym_conses_1(copy_tree_using_gensym_conses_1(CDDR(temp)));
    }
    else
	temp = Nil;
    objects_being_dragged = ISVREF(dragging_state,(SI_Long)3L);
  ...
  end_loop:
    temp_1 = CDDDR(objects_being_dragged);
    reclaim_gensym_list_1(CDDR(temp_1));
    ...
    Object delta_y_in_workspace;
{
    ...
    blocks = ATOM(block_or_blocks) ? gensym_cons_1(block_or_blocks,Nil) : 
	    copy_list_using_gensym_conses_1(block_or_blocks);
    result = group_blocks_for_move_or_transfer(blocks);
    ...
    reclaim_gensym_list_1(list_of_blocks);
    return reclaim_gensym_list_1(external_connections_to_drag);
}
    ...
    Object note_as_kb_state_change_qm;
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,0);
      blocks = ATOM(blocks) ? gensym_cons_1(blocks,Nil) : 
	      copy_list_using_gensym_conses_1(blocks);
      result = group_blocks_for_move_or_transfer(blocks);
      MVS_3(result,list_of_blocks,external_connections_to_drag,confine_qm);
      if (confine_qm) {
	  reclaim_gensym_list_1(external_connections_to_drag);
...
Object Transfer_in_progress = UNBOUND;

Object Saved_position_or_next_lower_thing = UNBOUND;
    ...
    Object delta_y_in_workspace, note_as_kb_state_change_qm;
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,5);
      gensymed_symbol = ISVREF(CAR(blocks),(SI_Long)14L);
      gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	      (SI_Long)5L) : Nil;
      original_workspace_qm = gensymed_symbol;
      current_drawing_priority = Kdraw_as_late_as_possible;
      PUSH_SPECIAL(Current_drawing_priority,current_drawing_priority,4);
	region_invalidation_is_preferred = T;
	...
	PUSH_SPECIAL(Saved_position_or_next_lower_thing,saved_position_or_next_lower_thing,
	  ...
	  PUSH_SPECIAL(Region_invalidation_is_preferred,region_invalidation_is_preferred,
	    ...
	    PUSH_SPECIAL(Transfer_in_progress,transfer_in_progress,1);
    ...
    Object block_or_blocks;
{
    ...
    Object gensymed_symbol_4, gensym_cons, cdr_new_value, temp;
    SI_Long svref_new_value;
    Declare_special(2);
	...
	if (Compiled_items_deferred_for_analysis) {
	  ...
	  end_loop_1:
	    ...
	    Available_gensym_conses = Compiled_items_deferred_for_analysis;
	}
	temp = gensymed_symbol;
      POP_SPECIAL();
    POP_SPECIAL();
...
Object Chain_of_available_selection_handle_spots = UNBOUND;

Object Selection_handle_spot_count = UNBOUND;
    ...
    Object selection_handle_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_selection_handle_spots;
    SVREF(selection_handle_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_selection_handle_spots = selection_handle_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_selection_handle_spot_structure_internal()
{
    ...
    Object selection_handle_spot_count_new_value;
    ...
    selection_handle_spot_count_new_value = 
	    FIXNUM_ADD1(Selection_handle_spot_count);
    Selection_handle_spot_count = selection_handle_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
					...
					PUSH_SPECIAL(Loose_top_edge_of_visible_workspace_area,loose_top_edge_of_visible_workspace_area,
					  ...
					  PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
						...
						next_loop:
						  ...
						  goto next_loop;
						end_loop:;
						  reclaim_gensym_list_1(handle_positions);
						  if (handle_qm)
						      result = push_selection_handle_spot(mouse_pointer,
							      block,
							      Qresize,
							      handle_qm,x0,
							      y0_1);
...
Object Selection_handle_icon = UNBOUND;
    ...
    Object icon_description, color, x_in_window, y_in_window;
{
    ...
    current_image_x_scale = FIX((SI_Long)4096L);
    current_image_y_scale = FIX((SI_Long)4096L);
    PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,3);
      PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,2);
	gensymed_symbol = IFIX(Current_x_origin_of_drawing);
	scale = Current_image_x_scale;
	...
	PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
	  ...
	  PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
		  0);
	    icon_attributes_plist = gensym_list_2(Qicon_color_pattern,
		    gensym_list_2(gensym_cons_1(Qfill,color),
		    gensym_cons_1(Qline,Qforeground)));
	    ...
	    result = reclaim_gensym_tree_1(icon_attributes_plist);
	  POP_SPECIAL();
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    ...
    Object block, color;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(handles);
}
    ...
    Object thing, image_plane;
{
	...
	PUSH_SPECIAL(Current_drawing_transfer_mode,current_drawing_transfer_mode,
		19);
	  type_of_current_window = ISVREF(Current_window,(SI_Long)1L);
	  PUSH_SPECIAL(Type_of_current_window,type_of_current_window,18);
	    current_native_window_qm = ISVREF(Current_window,(SI_Long)17L);
	    PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,17);
	      current_color_map = ISVREF(Current_window,(SI_Long)20L);
...
Object Chain_of_available_drag_handle_states = UNBOUND;

Object Drag_handle_state_count = UNBOUND;
    ...
    Object drag_handle_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_drag_handle_states;
    SVREF(drag_handle_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_drag_handle_states = drag_handle_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_drag_handle_state_structure_internal()
{
    ...
    Object drag_handle_state_count_new_value;
    ...
    drag_handle_state_count_new_value = FIXNUM_ADD1(Drag_handle_state_count);
    Drag_handle_state_count = drag_handle_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_drag_handle_state_variable, svref_new_value;
    ...
    svref_new_value = copy_of_current_frame_serial_number_function();
    SVREF(def_structure_drag_handle_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_drag_handle_state_variable);
}
    ...
    Object color, corner_being_moved, blocks;
{
    ...
    Object amf_result, incff_1_arg, new_float, resize_cursor_x_scale;
    Object resize_cursor_y_scale, resize_cursor_color, resize_cursor_rects;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
  ...
  next_loop:
    ...
    ab_loopvar__2 = gensym_cons_1(gensym_list_4(x,y,width,height),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
    ...
    return gensym_cons_1(resize_cursor_x_scale,
	    gensym_cons_1(resize_cursor_y_scale,
	    gensym_cons_1(resize_cursor_color,resize_cursor_rects)));
}
			  ...
			  PUSH_SPECIAL(Drawing_on_window,drawing_on_window,44);
				...
				PUSH_SPECIAL(Current_native_window_qm,current_native_window_qm,
				  ...
				  PUSH_SPECIAL(Current_color_map,current_color_map,
					...
					temp_1 = map_to_color_value_1(Qwhite);
				    current_background_color_value = temp_1;
				    PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
					    39);
				      temp_1 = ISVREF(Current_color_map,
					      (SI_Long)4L);
...
void moves_INIT()
{
    ...
    Object Qinternal, string_constant_20, Qabort_workstation_context;
    ...
    Object Qdrag_handle_state_count, Qchain_of_available_drag_handle_states;
    ...
    Object list_constant_14, Qmoves, Qselection_handle_icon, list_constant_13;
    ...
    Object list_constant_9, list_constant_7, list_constant_8, list_constant_6;
    Object Qoutline, list_constant_4, list_constant_5, Qsolid_rectangle;
    Object list_constant_3, list_constant_2, Qpolychrome, Qitem;
    Object Qtype_of_frame_represented, Qabstract_type, Qimage_plane_spot;
    Object Qenclosing_spot_type, Qinnermost_spot_p, Qselection_handle_spot;
    Object Qoutstanding_selection_handle_spot_count;
    Object Qselection_handle_spot_structure_memory_usage;
    Object Qselection_handle_spot_count;
    Object Qchain_of_available_selection_handle_spots, string_constant_17;
    Object string_constant_16, Qsaved_position_or_next_lower_thing;
    Object Qreenter_editor_if_not_hand_placed, Qtransfer_dragging_state;
    Object Qtop_level_is_selection_style;
    Object Qoutstanding_transfer_dragging_state_count;
    Object Qtransfer_dragging_state_structure_memory_usage;
    Object Qtransfer_dragging_state_count;
    Object Qchain_of_available_transfer_dragging_states, string_constant_15;
    Object string_constant_14, Qmove_dragging_state;
    Object Qoutstanding_move_dragging_state_count;
    Object Qmove_dragging_state_structure_memory_usage;
    Object Qmove_dragging_state_count;
    Object Qchain_of_available_move_dragging_states, string_constant_13;
    Object string_constant_12, Qdragging_state, Qresume_workstation_context;
    Object Qsuspend_workstation_context, list_constant_1, Qtrend_chart;
    Object Qfreeform_table, Qchart, Qdefinition, Qbutton, Qmeter, Qdial;
    Object Qtext_box, Qtable, Qmouse_up_in_dragging_state;
    Object Qmouse_down_in_dragging_state, Qmouse_motion_in_dragging_state;
    Object string_constant_11, list_constant, Qscreen_layout;
    Object Qoutstanding_dragging_state_count;
    Object Qdragging_state_structure_memory_usage, Qdragging_state_count;
    Object Qchain_of_available_dragging_states, string_constant_10;
    Object string_constant_9, string_constant_8;
    Object Qreclaim_dragging_cons_function, Qreclaim_dragging_list_function;
    Object Qcurrent_dragging_states;
    ...
    string_constant_8 = 
	    STATIC_STRING("43Dy8m83gsy1o83gsy83-Sy8n8k1l83-Sy0000001m1n8y83-3Uy1u83vNy83-8*y83-Gwy83-=Hy83-HDy83-HJy83w8y83-H0y83-75y83-8Iy1m8x83-Syk3Nyk0k");
    string_constant_9 = STATIC_STRING("0");
    ...
    string_constant_10 = STATIC_STRING("1q83gsy8s83-Rmy09k9l");
    ...
    list_constant = STATIC_LIST((SI_Long)2L,Qdragging,Qscreen_layout);
    make_context_description(Qdragging,Qtop_level,Qnil,list_constant);
    ...
    make_keymap(Qdragging,Qnil,
	    regenerate_optimized_constant(string_constant_11),Qinternal,
	    Qnil,Qnil,Qnil,Qnil);
    ...
    list_constant_1 = STATIC_LIST((SI_Long)9L,Qtable,Qtext_box,Qdial,
	    Qmeter,Qbutton,Qdefinition,Qchart,Qfreeform_table,Qtrend_chart);
    Classes_that_do_not_normally_connect = list_constant_1;
    Qg2_defstruct_structure_name_class_description_g2_struct = 
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83l-y1o83l-y83-Sy8n8k1l83-Sy0000001m1n8y83-4xy01m8x83-Syknk0k0");
    ...
    Qmove_dragging_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83l-y8s83-eny09k9l");
    clear_optimized_constants();
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83o=y1o83o=y83-Sy8n8k1l83-Sy0000001m1n8y83-6Cy01m8x83-Sykqk0k0");
    ...
    Qtransfer_dragging_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q83o=y8s83-s5y09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83Zsy1p83Zsy83F=y83Qy8n8k1l83F=y0000001l1m8x83F=yksk0k0");
    ...
    Qselection_handle_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_17 = STATIC_STRING("1q83Zsy8s83-mly09k9l");
    clear_optimized_constants();
    ...
    list_constant_2 = STATIC_CONS(Qfill,Qbackground);
    Qline = STATIC_SYMBOL("LINE",AB_package);
    list_constant_3 = STATIC_CONS(Qline,Qforeground);
    list_constant_10 = STATIC_LIST((SI_Long)3L,Qpolychrome,list_constant_2,
	    list_constant_3);
    Qsolid_rectangle = STATIC_SYMBOL("SOLID-RECTANGLE",AB_package);
    list_constant_4 = STATIC_CONS(FIX((SI_Long)0L),Qnil);
    list_constant_6 = STATIC_CONS(FIX((SI_Long)0L),list_constant_4);
    list_constant_5 = STATIC_CONS(FIX((SI_Long)6L),Qnil);
    list_constant_7 = STATIC_CONS(FIX((SI_Long)6L),list_constant_5);
    list_constant_11 = STATIC_LIST((SI_Long)3L,Qsolid_rectangle,
	    list_constant_6,list_constant_7);
    Qoutline = STATIC_SYMBOL("OUTLINE",AB_package);
    list_constant_8 = STATIC_CONS(FIX((SI_Long)0L),list_constant_5);
    list_constant_9 = STATIC_CONS(FIX((SI_Long)6L),list_constant_4);
    list_constant_12 = STATIC_LIST((SI_Long)5L,Qoutline,list_constant_6,
	    list_constant_8,list_constant_7,list_constant_9);
    list_constant_13 = STATIC_LIST((SI_Long)5L,list_constant_10,Qfill,
	    list_constant_11,Qline,list_constant_12);
    list_constant_14 = STATIC_LIST((SI_Long)6L,Kfuncall,
	    Qmake_iconic_entity_with_specific_icon_description,
	    list_constant_13,FIX((SI_Long)6L),FIX((SI_Long)6L),Qnil);
    Qreclaim_rubber_stamp_widgets = 
	    STATIC_SYMBOL("RECLAIM-RUBBER-STAMP-WIDGETS",AB_package);
    record_system_variable(Qselection_handle_icon,Qmoves,list_constant_14,
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83gry1o83gry83-Sy8n8k1l83-Sy0000001m1m8y83-3Ty1m8x83-Sykvk0k0");
    ...
    Qdrag_handle_state_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83gry8s83-Rly09k9l");
    clear_optimized_constants();
    ...
    make_keymap(Qdrag_handle,Qdrag_handle,
	    regenerate_optimized_constant(string_constant_20),Qinternal,
	    Qnil,Qnil,Qnil,Qnil);
