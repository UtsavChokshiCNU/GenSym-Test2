    ...
    Object length_1, malloc_p;
{
	...
	if (Log_simple_string_data) {
		...
		if (zerop(String_allocations_until_next_report)) {
		    ...
		    temp = FIXNUM_SUB1(String_allocations_until_next_report);
		    String_allocations_until_next_report = temp;
		}
	    }
	}
    }
...
{
    Object string_pool_vector, temp, temp_1, ab_loop_iter_flag_, decff_1_arg;
	...
	if (gensym_string_length_1 >= IFIX(Min_string_length_to_report)) {
		...
		temp = FIXNUM_SUB1(String_reclaims_until_next_report);
		String_reclaims_until_next_report = temp;
	    }
	}
    }
    if (gensym_string_length_1 > (SI_Long)0L) {
	temp_1 = CHR('&');
	SET_SCHAR(simple_gensym_string,FIX((SI_Long)0L),temp_1);
	...
	Simple_gensym_string_byte_use_counter = temp;
	temp = Long_simple_gensym_string_counts;
	svref_new_value = FIXNUM_SUB1(ISVREF(temp,index_1));
	...
	temp = ISVREF(string_pool_vector,index_1);
...
Object Block_class_description = UNBOUND;
...
void utilities1_INIT()
{
    ...
    Object string_constant_19, G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object string_constant_18, Qnamed_dynamic_extent_description;
    Object Qoutputting_to_gensym_string, Qutilities1, string_constant_17;
    ...
    SET_SYMBOL_FUNCTION(Qcompute_memory_used_by_simple_gensym_strings,
	    ...
	    NIL,FALSE,0,0));
    string_constant_16 = STATIC_STRING("1q83-o3y83-o6y83-o2y09k9l");
    ...
    SET_SYMBOL_FUNCTION(Qcompute_memory_used_by_adjustable_gensym_strings,
	    ...
	    NIL,FALSE,0,0));
    string_constant_17 = STATIC_STRING("1q83-JNy9k83-JMy09l9m");
    clear_optimized_constants();
    ...
    string_constant_21 = STATIC_STRING("43Dy8m8k00000004ukkkkkkkkkk0kkk0k0");
