...
Object initialize_simulation_control_specifications()
{
    ...
    return gensym_cons_1(Qsynchronously,Nil);
}
    ...
    Object variable;
{
    ...
    PUSH_SPECIAL(Current_model_runtime_info_qm,current_model_runtime_info_qm,
	    1);
      current_model_definition_qm = Nil;
      PUSH_SPECIAL(Current_model_definition_qm,current_model_definition_qm,0);
    ...
    Object variable;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_2, svref_new_value, temp_2;
    char temp;
	...
	if (EQ(CAR(gensymed_symbol_2),gensymed_symbol)) {
		...
		SVREF(temp_1,FIX((SI_Long)30L)) = svref_new_value;
	    }
    ...
    Object model_definition, designation, deinstall_instead_qm;
{
	...
	if (EQ(CAR(designation),Qab_class)) {
	    ...
	    gensymed_symbol = ISVREF(model_definition,(SI_Long)14L);
    ...
    Object item;
{
	...
	PUSH_SPECIAL(Inhibit_model_install_qm,inhibit_model_install_qm,0);
...
Object Install_item_in_model_if_appropriate = UNBOUND;
    ...
    Object model_definition;
{
    ...
    x_note_fn_call(188,63);
    model_runtime_info_qm = ISVREF(model_definition,(SI_Long)20L);
    time_used_to_adjust_histories_qm = 
	    get_model_simulation_time(model_definition);
    PUSH_SPECIAL(Time_used_to_adjust_histories_qm,time_used_to_adjust_histories_qm,
	    0);
...
Object Current_a_matrix = UNBOUND;

Object Current_lu_matrix = UNBOUND;

Object Current_index_array = UNBOUND;

Object Current_b_vector = UNBOUND;

Object Current_x_vector = UNBOUND;
    ...
    Object a, indx, lu;
{
    ...
    x_note_fn_call(188,75);
    current_a_matrix = a;
    current_index_array = indx;
    current_lu_matrix = lu;
    PUSH_SPECIAL(Current_lu_matrix,current_lu_matrix,2);
      PUSH_SPECIAL(Current_index_array,current_index_array,1);
	PUSH_SPECIAL(Current_a_matrix,current_a_matrix,0);
    ...
    Object lu, vv, indx, j;
{
  ...
  next_loop:
    ...
    row = ISVREF(FIXNUM_LE(ISVREF(lu,(SI_Long)1L),
	    ...
	    - (SI_Long)10L) + (SI_Long)2L),i & (SI_Long)1023L),(SI_Long)23L);
  ...
  next_loop_1:
    ...
    managed_float_array = ISVREF(FIXNUM_LE(ISVREF(lu,(SI_Long)1L),
	    ...
	    - (SI_Long)10L) + (SI_Long)2L),k & (SI_Long)1023L),(SI_Long)23L);
    ...
    Object lu_matrix, index_1, b_vector, x_vector;
{
    ...
    x_note_fn_call(188,81);
    if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	current_lu_matrix = lu_matrix;
	current_index_array = index_1;
	current_b_vector = b_vector;
	current_x_vector = x_vector;
	PUSH_SPECIAL(Current_x_vector,current_x_vector,3);
	  PUSH_SPECIAL(Current_b_vector,current_b_vector,2);
	    PUSH_SPECIAL(Current_index_array,current_index_array,1);
	      PUSH_SPECIAL(Current_lu_matrix,current_lu_matrix,0);
    ...
    Object vector1, vector2, vector3, add_or_subtract;
{
    ...
    subtract_arrays_instead_qm = IFIX(add_or_subtract) != (SI_Long)0L ? T :
	     Nil;
    PUSH_SPECIAL(Subtract_arrays_instead_qm,subtract_arrays_instead_qm,0);
      if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
    ...
    Object vector1, vector2;
{
	...
	if (gensymed_symbol == IFIX(Truth))
	    ...
	    result = gensym_cons_1(FIX(gensymed_symbol),Qtruth_value);
    }
    POP_LOCAL_ALLOCATION(0,0);
    return result;
}
    ...
    Object vector1, vector2;
{
  ...
  next_loop:
	...
	if (target_is_integer_array_p && FLOATP(source_value)) {
	    ...
	    temp_2 = truncate_evaluation_float_function(new_float,
		    Qg2_array_copy,Cached_top_of_stack);
	}
	else
	    temp_2 = source_value;
	set_quantity_element(managed_array_2,temp,temp_2);
	if (FIXNUM_GE(j,n_minus_1)) {
	    j = Nil;
	    goto end_1;
	}
    ...
    Object managed_array_for_matrix_2;
{
    ...
    Object managed_array_for_matrix_2_row_for_column, svref_new_value;
    Object svref_new_value_1, temp, amf_available_array_cons_qm, amf_array;
    Object amf_result, incff_1_arg, new_float, temp_2, j_1, n_minus_1, temp_3;
    Object end_value_of_j;
    SI_Long j, ab_loop_bind_, temp_1;
    double aref_new_value;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(188,126);
	...
	if (EQ(type,Qinteger)) {
	  ...
	  next_loop:
	    ...
	    if (FIXNUM_LE(ISVREF(managed_array_for_matrix_2_row_for_column,
		    (SI_Long)1L),Maximum_in_place_array_size)) {
		temp = FIXNUM_ADD(i,Managed_array_index_offset);
		SVREF(managed_array_for_matrix_2_row_for_column,temp) = 
			svref_new_value;
	    }
	    else {
		temp = ISVREF(managed_array_for_matrix_2_row_for_column,
	    ...
	    if (FIXNUM_LE(ISVREF(managed_array_for_matrix_2_row,
		    (SI_Long)1L),Maximum_in_place_array_size)) {
		temp_1 = j + IFIX(Managed_array_index_offset);
		ISVREF(managed_array_for_matrix_2_row,temp_1) = 
			svref_new_value_1;
	    }
	    else {
		temp = ISVREF(managed_array_for_matrix_2_row,(j >>  -  - 
			(SI_Long)10L) + (SI_Long)2L);
		temp_1 = j & (SI_Long)1023L;
		ISVREF(temp,temp_1) = svref_new_value_1;
	    }
	    j = j + (SI_Long)1L;
	    goto next_loop;
	  end_loop:
	  ...
	  next_loop_1:
	    ...
	    temp = ISVREF(managed_array_for_matrix_2_row,(j >>  -  - 
		    (SI_Long)10L) + (SI_Long)2L);
	    temp_1 = j & (SI_Long)1023L;
	    aref_new_value = DFLOAT_ISAREF_1(temp_2,(SI_Long)0L);
	    DFLOAT_ISASET_1(temp,temp_1,aref_new_value);
	    reclaim_managed_simple_float_array_of_length_1(temp_2);
	    j = j + (SI_Long)1L;
	    goto next_loop_1;
	  end_loop_1:
	    return VALUES_1(Qnil);
	  ...
	  next_loop_2:
	    ...
	    temp_3 = FIXNUM_ADD(j_1,Max_number_of_array_elements_to_do);
	    end_value_of_j = FIXNUM_MIN(n_minus_1,temp_3);
	...
	managed_array_for_matrix_2_row_for_column = 
		ISVREF(get_matrix_row(managed_array_for_matrix_2,FIX(j)),
		(SI_Long)23L);
	temp = ISVREF(managed_array_for_matrix_2_row_for_column,(IFIX(i) 
		>>  -  - (SI_Long)10L) + (SI_Long)2L);
	temp_1 = IFIX(i) & (SI_Long)1023L;
	aref_new_value = 
    ...
    Object vector1, vector2;
{
	...
	temp = TRUEP(Nil);
    if (temp)
	return g2_integer_vector_multiply(vector1,vector2);
    else {
	sub_class_bit_vector = ISVREF(ISVREF(vector1,(SI_Long)1L),
		(SI_Long)19L);
	superior_class_bit_number = 
	...
	if (temp) {
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    return g2_float_vector_multiply(vector1,vector2);
	else {
	    sub_class_bit_vector = ISVREF(ISVREF(vector1,(SI_Long)1L),
		    (SI_Long)19L);
	    superior_class_bit_number = 
		...
		temp = TRUEP(Nil);
	    if (temp)
		return g2_quantity_vector_multiply(vector1,vector2);
	    else
		return signal_invalid_vectors(gensym_list_2(vector1,
    ...
    Object vector1, vector2, x;
{
	...
	return g2_integer_scalar_multiply(vector1,vector2,x);
    else {
	sub_class_bit_vector = ISVREF(ISVREF(vector1,(SI_Long)1L),
		(SI_Long)19L);
	superior_class_bit_number = 
	...
	if (temp ? FLOATP(x) : TRUEP(Nil))
	    return g2_float_scalar_multiply(vector1,vector2,x);
	else
	    return g2_quantity_scalar_multiply(vector1,vector2,x);
    }
}
    ...
    Object vector1, vector2;
{
    ...
    Object new_float, managed_sum;
    SI_Long j, ab_loop_bind_;
    double aref_new_value, sum;

    x_note_fn_call(188,131);
    n_1 = check_array_lengths_compatible(2,vector1,vector2);
    managed_array_1 = ISVREF(vector1,(SI_Long)23L);
    managed_array_2 = ISVREF(vector2,(SI_Long)23L);
    amf_available_array_cons_qm = 
    ...
    Object vector1, vector2;
{
    Object n_1, managed_array_1, managed_array_2, amf_available_array_cons_qm;
    Object amf_array, temp, svref_new_value, amf_result, incff_1_arg;
    Object new_float, sum_box, j, n_minus_1, temp_1, end_value_of_j;
    double temp_2, temp_3, temp_4, aref_new_value, sum;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(188,133);
    n_1 = check_array_lengths_compatible(2,vector1,vector2);
    managed_array_1 = ISVREF(vector1,(SI_Long)23L);
    managed_array_2 = ISVREF(vector2,(SI_Long)23L);
    amf_available_array_cons_qm = 
  ...
  next_loop:
    n_minus_1 = FIXNUM_SUB1(n_1);
    temp_1 = FIXNUM_ADD(j,Max_number_of_array_elements_to_do);
    end_value_of_j = FIXNUM_MIN(n_minus_1,temp_1);
    if (FIXNUM_GT(j,n_minus_1))
	return VALUES_1(Nil);
    if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
      next_loop_1:
	temp_2 = DFLOAT_ISAREF_1(sum_box,(SI_Long)0L);
	temp_1 = get_quantity_element(managed_array_1,j);
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	temp_1 = get_quantity_element(managed_array_2,j);
	temp_4 = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	aref_new_value = temp_2 + temp_3 * temp_4;
	DFLOAT_ISASET_1(sum_box,(SI_Long)0L,aref_new_value);
	if (FIXNUM_GE(j,n_minus_1)) {
	    j = Nil;
	    goto end_1;
    ...
    Object managed_array_for_matrix_2, managed_array_for_matrix_3_row;
{
    ...
    Object incff_1_arg, new_float, sum_box, k_1, n_minus_1, temp_2;
    Object end_value_of_j;
    SI_Long k, ab_loop_bind_, gensymed_symbol, gensymed_symbol_1;
    SI_Long gensymed_symbol_2, temp_1;
    double aref_new_value, temp_3, temp_4, temp_5;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(188,138);
    if (EQ(type,Qinteger)) {
	sum = FIX((SI_Long)0L);
	k = (SI_Long)0L;
	ab_loop_bind_ = IFIX(n_1);
	...
	k_1 = FIX((SI_Long)0L);
      next_loop_2:
	n_minus_1 = FIXNUM_SUB1(n_1);
	temp_2 = FIXNUM_ADD(k_1,Max_number_of_array_elements_to_do);
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	  next_loop_3:
	    ...
	    temp_2 = get_quantity_element(managed_array_for_matrix_1_row,k_1);
	    temp_4 = DOUBLE_FLOAT_TO_DOUBLE(temp_2);
	    temp_2 = get_quantity_element(managed_array_for_matrix_2_row,j);
    ...
    Object value_array, index_array, full_array;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, boxed_zero;
    SI_Long j, ab_loop_bind_, temp_1;
    double arg, arg_1, aref_new_value;
    Object result;

    x_note_fn_call(188,154);
    n_1 = ISVREF(full_array,(SI_Long)20L);
    l = check_array_lengths_compatible(2,value_array,index_array);
    value_managed_array = ISVREF(value_array,(SI_Long)23L);
    index_managed_array = ISVREF(index_array,(SI_Long)23L);
  ...
  next_loop:
	...
	temp = ISVREF(value_managed_array,(IFIX(sparse_index) >>  -  - 
		(SI_Long)10L) + (SI_Long)2L);
	temp_1 = IFIX(sparse_index) & (SI_Long)1023L;
    ...
    Object end_index_2, full_array_initialized_qm;
{
    ...
    Object amf_array, temp, svref_new_value, amf_result, incff_1_arg;
    Object new_float, boxed_zero, l2, max_index_2, full_index, top_of_stack;
    Object message_1, index_managed_array_2, value_managed_array_2;
    Object value_array_length, sparse_index;
    SI_Long j, ab_loop_bind_, temp_1;
    double aref_new_value, arg, arg_1, temp_2, temp_3;
    Object result;

    x_note_fn_call(188,155);
    if ( !TRUEP(full_array_initialized_qm))
  ...
  next_loop:
	...
	temp = ISVREF(value_managed_array,(j >>  -  - (SI_Long)10L) + 
		(SI_Long)2L);
	temp_1 = j & (SI_Long)1023L;
	temp_2 = DFLOAT_ISAREF_1(ISVREF(value_managed_array,(j >>  -  - 
		(SI_Long)10L) + (SI_Long)2L),j & (SI_Long)1023L);
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(alpha);
	aref_new_value = temp_2 + temp_3 * DFLOAT_ISAREF_1(value_box,
		(SI_Long)0L);
	DFLOAT_ISASET_1(temp,temp_1,aref_new_value);
	temp = ISVREF(full_managed_array,(IFIX(full_index) >>  -  - 
		(SI_Long)10L) + (SI_Long)2L);
	temp_1 = IFIX(full_index) & (SI_Long)1023L;
	aref_new_value = DFLOAT_ISAREF_1(boxed_zero,(SI_Long)0L);
	DFLOAT_ISASET_1(temp,temp_1,aref_new_value);
    }
    j = j + (SI_Long)1L;
  ...
  next_loop_1:
	...
	temp_1 = IFIX(sparse_index) & (SI_Long)1023L;
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(alpha);
	aref_new_value = temp_3 * DFLOAT_ISAREF_1(value_box,(SI_Long)0L);
	DFLOAT_ISASET_1(temp,temp_1,aref_new_value);
	if (FIXNUM_LE(ISVREF(index_managed_array,(SI_Long)1L),
		Maximum_in_place_array_size)) {
	    temp = FIXNUM_ADD(sparse_index,Managed_array_index_offset);
    ...
    Object full_array_initialized_qm;
{
    ...
    Object full_managed_array, value_box, amf_available_array_cons_qm;
    Object amf_array, temp, svref_new_value, amf_result, incff_1_arg;
    Object new_float, product_box, boxed_zero, full_index, top_of_stack;
    Object message_1, index_managed_array_2, gensymed_symbol;
    Object gensymed_symbol_1;
    SI_Long j, ab_loop_bind_, aref_arg_2;
    double aref_new_value, arg, arg_1;

    x_note_fn_call(188,156);
    if ( !TRUEP(full_array_initialized_qm))
	g2_float_sparse_scatter(value_array_2,index_array_2,full_array,
		begin_index_2,end_index_2);
    n_1 = ISVREF(full_array,(SI_Long)20L);
    ...
    Object full_array_initialized_qm;
{
    ...
    Object full_managed_array, value_box, amf_available_array_cons_qm;
    Object amf_array, temp, svref_new_value, amf_result, incff_1_arg;
    Object new_float, product_box, sub_class_bit_vector, integer_array_qm;
    Object full_index, j, n_minus_1, temp_1, end_value_of_j, top_of_stack;
    Object message_1, index_managed_array_2;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    double aref_new_value, arg, arg_1, temp_2, temp_3, temp_4;
    XDeclare_area(1);
    XDeclare_frontier(1);

    x_note_fn_call(188,161);
    if ( !TRUEP(full_array_initialized_qm))
	g2_quantity_sparse_scatter(value_array_2,index_array_2,full_array,
		begin_index_2,end_index_2);
    n_1 = ISVREF(full_array,(SI_Long)20L);
  ...
  next_loop:
	...
	temp_1 = get_quantity_element(full_managed_array,full_index);
	...
	if ( !(arg == arg_1 &&  !inline_nanp_for_comparison(arg) &&  
		!inline_nanp_for_comparison(arg_1))) {
	    temp_2 = DFLOAT_ISAREF_1(product_box,(SI_Long)0L);
	    temp_3 = DFLOAT_ISAREF_1(value_box,(SI_Long)0L);
	    temp_1 = get_quantity_element(value_managed_array,j);
	    temp_4 = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	    aref_new_value = temp_2 + temp_3 * temp_4;
	    DFLOAT_ISASET_1(product_box,(SI_Long)0L,aref_new_value);
	}
...
Object quantity_accumulation_for_sparse_min(accumulation,value_array,j)
    Object accumulation, value_array, j;
{
    Object element_value, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    double aref_new_value, arg, arg_1;

    x_note_fn_call(188,171);
    ...
    Object value_array, index_array, index_1;
{
	...
	if (FIXNUM_EQ(FIXNUM_LE(ISVREF(index_managed_array,(SI_Long)1L),
		...
		new_float = amf_result;
		temp_2 = get_quantity_element(ISVREF(value_array,
			(SI_Long)23L),FIX(j));
		aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_2);
		DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
		result = VALUES_1(new_float);
...
void simulate5_INIT()
{
    ...
    Object Qsubtract_arrays_instead_qm, Qg2_initialize_matrix_add;
    Object Qg2_lu_backward_substitute_row, Qg2_lu_forward_substitute_row;
    Object Qg2_initialize_lubksb, Qg2_lu_crout, Qg2_lu_compute_scaling;
    Object Qg2_initialize_lu_decompose, Qget_current_model_definition;
    Object Qget_model_simulation_time_increment;
    ...
    Object Qdeinstall_system_table, Qsimulation_parameters;
    ...
    Object Qinstall_item_in_model_if_appropriate;
    ...
    Object Qinitialize_for_model_definition, Qmodels_used_p;
    ...
    string_constant_52 = 
	    STATIC_STRING("1q83Oy1mu3ky1muu1m3Qy3ay1m3kyu1m3ky3ky001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83Vry83Vry837Dy83");
    string_constant_53 = 
	    STATIC_STRING("7Dy01m83*9y9l001m1l8l1l8o000004z8r83T0y83T0y837Dy837Dy00001m1n8p83D9y83Gy1l8l000004z8r83Bgy83Bgy837Dy837Dy01m83*9y9m001n1l8l1l8z");
    string_constant_54 = 
	    STATIC_STRING("1m8p832iy000004z8r83D=y83D=y837Dy837Dy0833uy001n1l8l1l8z1m8p833Py000004z8r83L7y83L7y837Dy837Dy00001m1l8l1n8p834vy83Gy000004z8r83");
    string_constant_55 = 
	    STATIC_STRING("F4y83F4y837Dy837Dy00001n1l8l1l8z1m8p8306y000004z8r83Exy83Exy837Dy837Dy00001n1l8l1l8z1m8p83Ky000004z8r83dvy83dvy837Dy837Dy00001l1");
    string_constant_56 = 
	    STATIC_STRING("l8l000004z8r83e-y83e-y837Dy837Dy00001l1l8l000004z8r83aLy83aLy837Dy837Dy00001m1l8l1l8o000004z8r83Vsy83Vsy837Dy837Dy083Wcy001o1l8l");
    string_constant_57 = 
	    STATIC_STRING("1l83Fy1m8p83-qy1l83Hy000004z8r83F1y83F1y837Dy837Dy01m83*9y9n001n1l8l1l8z1m8p839xy00000");
    string_constant_58 = 
    ...
    string_constant_59 = 
	    STATIC_STRING("m3tyl1m3ty3ty1ml3ty1q83Oy1mu3ky1muu1m3Qy3ay1m3kyu1m3ky3ky1o83Vry1m83*9y9l8l8o1o83T0y01n8p83D9y83Gy8l1p83Bgy1m83*9y9m8l8z1m8p832i");
    string_constant_60 = 
	    STATIC_STRING("y1p83D=y833uy8l8z1m8p833Py1o83L7y08l1n8p834vy83Gy1p83F4y08l8z1m8p8306y1p83Exy08l8z1m8p83Ky1n83dvy08l1n83e-y08l1o83aLy08l8o1p83Vs");
    string_constant_61 = 
	    STATIC_STRING("y83Wcy83Fy1m8p83-qy83Hy1p83F1y1m83*9y9n8l8z1m8p839xy");
    ...
    string_constant_62 = 
	    STATIC_STRING("1s1n83D9y83-aLyl1o83D9y1n83-aLy1m9k83vy83D9y1nmln9l1m83-aLy839Wy1m83-aLy83-vfy1n83-aLy1m1m9k83=by83-Gy2l83-Gym1n83-aLy1o1m9k83=b");
    string_constant_63 = 
	    STATIC_STRING("y83-Gy1m9k83-Fvy83-vfy1n83-Gymo1m83-vfy83eby1n83-vfy1m1m9k837Zy1m9k83*ry1l83nty");
    clear_optimized_constants();
