    ...
    Object sysproc_list;
{
    ...
    return reclaim_gensym_list_1(sysproc_list);
}
...
Object G2_stream_status_slot_description = UNBOUND;

Object Name_of_file_slot_description = UNBOUND;

Object Access_direction_slot_description = UNBOUND;

Object Position_in_file_slot_description = UNBOUND;

Object File_system_slot_description = UNBOUND;
    ...
    Object language_parameters, text_conversion_style_name_qm, gensymed_symbol;
{
    ...
    PUSH_SPECIAL(Language_parameters,language_parameters,1);
      ...
      if (Nil)
	  gensymed_symbol_1 = nconc2(gensym_list_2(Language_parameters,
	...
	if ( !TRUEP(current_flag_state_qm)) {
	    ...
	    temp = Language_parameters;
	    svref_new_value = IFIX(ISVREF(Language_parameters,
...
/* EXPORT-FILENAME-FROM-G2-STRING */
Object export_filename_from_g2_string(g2_filestring)
    Object g2_filestring;
{
    x_note_fn_call(165,25);
    return export_text_string(2,g2_filestring,use_unicode_for_filenames() ?
	     Qg2_directory_pathname_w : Qg2_directory_pathname);
}
    ...
    Object g2_filestring;
{
    ...
    filestring = export_filename_from_g2_string(g2_filestring);
    ...
    Object g2_filestring, create_it;
{
	...
	reclaim_gensym_cons_1(create_it);
    ...
    Object g2_stream_frame, g2_new_position, extend_file_if_necessary;
{
	...
	reclaim_gensym_cons_1(extend_file_if_necessary);
    ...
    Object g2_old_filestring, g2_new_filestring;
{
    ...
    old_filestring = export_filename_from_g2_string(g2_old_filestring);
    new_filestring = export_filename_from_g2_string(g2_new_filestring);
    ...
    Object text_list_frame;
{
  ...
  next_loop:
    ...
    ab_loopvar__4 = gensym_cons_1(element,Nil);
    if (ab_loopvar__3)
  ...
  end_loop:
    ...
    temp = Qnil;
  end_1:;
    directory_components = gensym_cons_1(Kabsolute,temp);
    ...
    reclaim_gensym_list_1(directory_components);
    ...
    Object g2_directory_string;
{
	...
	if (pathnames_in_directory) {
		...
		reclaim_gensym_list_1(pathnames_in_directory);
	}
	CONTINUE_UNWINDING(1);
    }
    ...
    Object g2_directory_string;
{
	...
	if ( !EQ(subdirectories_in_directory,Qunbound_in_protected_let))
	    reclaim_gensym_list_1(subdirectories_in_directory);
    }
    if (directory_string) {
	if ( !EQ(directory_string,Qunbound_in_protected_let))
	    reclaim_text_string(directory_string);
...
Object devices_on_machine_lisp_side()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(device_names);
    return VALUES_1(list_frame);
}
    ...
    Object pathname_1;
{
    ...
    if ( !TRUEP(plist))
	temp = allocate_evaluation_structure(gensym_list_2(Qversion_text,
		copy_as_wide_string(string_constant_6)));
    else {
    ...
    Object g2_process_namestring;
{
	...
	if ( !(arg == arg_1 &&  !inline_nanp_for_comparison(arg) &&  
	    ...
	    Known_process_ids_qm = gensym_cons_1(new_float,
...
Object Available_sysproc_continuation_hashtable_hash_vector_131_vectors = UNBOUND;

Object Count_of_sysproc_continuation_hashtable_hash_vector_131_vectors = UNBOUND;
...
{
    Object count_of_sysproc_continuation_hashtable_hash_vector_131_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(165,84);
    count_of_sysproc_continuation_hashtable_hash_vector_131_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_sysproc_continuation_hashtable_hash_vector_131_vectors);
...
Object make_sysproc_continuation_hashtable_hash_vector()
{
    ...
    x_note_fn_call(165,85);
    if (Available_sysproc_continuation_hashtable_hash_vector_131_vectors) {
	temp = 
		M_CAR(Available_sysproc_continuation_hashtable_hash_vector_131_vectors);
	temp_1 = 
		M_CDR(Available_sysproc_continuation_hashtable_hash_vector_131_vectors);
	inline_note_reclaim_cons(Available_sysproc_continuation_hashtable_hash_vector_131_vectors,
		Qab_gensym);
	cdr_arg = 
    ...
    Object sysproc_continuation_hashtable_tree_for_hash_binary_tree;
{
  ...
  end_loop_1:;
	...
	sysproc_continuation_hashtable_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
Object Sysproc_continuation_table = UNBOUND;

Object Highest_remote_spawn_index = UNBOUND;

Object Used_remote_spawn_indices_qm = UNBOUND;
    ...
    Object completion_form;
{
    ...
    Used_remote_spawn_indices_qm = gensym_cons_1(remote_spawn_index,
	    Used_remote_spawn_indices_qm);
    temp = reclaim_gensym_list_1(completion_form);
    return VALUES_1(temp);
}
    ...
    Object g2_process_namestring, g2_window;
{
	...
	install_code_body_invocation_completion_form(code_body_invocation_to_receive_spawn_status,
		gensym_list_2(Qclean_up_sysproc_continuation,
		remote_spawn_index));
...
Object kill_process_lisp_side(g2_process_id)
    Object g2_process_id;
{
    Object first_known_process_id_qm, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, process_id_cons, known_process_id, ab_loop_list_;
    SI_Long return_status;
	...
	if (arg == arg_1 &&  !inline_nanp_for_comparison(arg) &&  
		...
		if (arg == arg_1 &&  !inline_nanp_for_comparison(arg) &&  
		  ...
		  next_loop:
			...
			cdr_new_value = CDDR(process_id_cons);
			M_CDR(process_id_cons) = cdr_new_value;
			goto end_loop;
		    }
...
Object get_network_addresses_lisp_side()
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = gensym_cons_1(address,Nil);
    if (ab_loopvar_)
...
static Object string_constant_19;  /* "~NF is not a remote gensym-window" */
...
/* G2-GET-TW-VERSION */
Object g2_get_tw_version(g2_window)
    Object g2_window;
{
    Object gensym_window, top_of_stack, message_1, icp_socket, revision;
    Object build_identification, gensymed_symbol, gensymed_symbol_1;
    Object car_new_value;

    x_note_fn_call(165,117);
    ...
    revision = get_remote_icp_version_info_value(icp_socket,
	    Qrevision_number_of_current_gensym_product_line,FIX((SI_Long)0L));
    build_identification = 
	    copy_as_wide_string(get_remote_icp_version_info_value(icp_socket,
	    Qbuild_identification_string,array_constant_1));
    gensymed_symbol = make_gensym_list_1(FIX((SI_Long)8L));
    gensymed_symbol_1 = gensymed_symbol;
    M_CAR(gensymed_symbol_1) = Qmajor_version_number;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    car_new_value = remote_icp_major_version(icp_socket);
    M_CAR(gensymed_symbol_1) = car_new_value;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = Qminor_version_number;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    car_new_value = remote_icp_minor_version(icp_socket);
    M_CAR(gensymed_symbol_1) = car_new_value;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = Qrevision;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = revision;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = Qbuild_identification;
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = build_identification;
    return allocate_evaluation_structure(gensymed_symbol);
}
...
Object unix_time_to_text_y2k_lisp_side(unix_time,use_seconds)
    Object unix_time, use_seconds;
{
    x_note_fn_call(165,123);
    return unix_time_to_text_internal(unix_time,use_seconds,T);
}

static Object string_constant_20;  /* "Currently Windows NT platforms cannot display time values before January 1, 1970 in text form. Unix-time should be no less than 0.0. " */

static Object string_constant_21;  /* "~d/~d/~d" */

static Object string_constant_22;  /* "~d/~d/0~d" */

static Object string_constant_23;  /* " " */

static Object string_constant_24;  /* "~d:" */

static Object string_constant_25;  /* "0" */

static Object string_constant_26;  /* "~d" */

static Object string_constant_27;  /* ":" */

static Object string_constant_28;  /* "p.m." */

static Object string_constant_29;  /* "a.m." */
    ...
    Object unix_time, use_seconds, use_4_digit_year;
{
	...
	if ( !(EQ(use_seconds,Evaluation_true_value) || EQ(use_seconds,
		Evaluation_false_value)))
	    reclaim_gensym_cons_1(use_seconds);
	current_wide_string_list = Qdo_not_use;
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		  (SI_Long)3L));
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  if (use_4_digit_year)
		      tformat(4,string_constant_21,month,date,year);
		  else {
...
{
    Object value_1, amf_available_array_cons_qm, amf_array, temp;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    double aref_new_value;

    x_note_fn_call(165,126);
    value_1 = Nil;
...
void file_sysproc_INIT()
{
    ...
    Object Qg2_get_environment_variable, Qunix_time_to_text_y2k_lisp_side;
    Object Qunix_time_to_text_lisp_side, Qis_dst_used_lisp_side;
    Object Qlocal_time_lisp_side, Qunix_time_at_start_lisp_side;
    Object Qunix_time_lisp_side, Qg2_get_tw_version, list_constant_9;
    ...
    Object Qcount_of_sysproc_continuation_hashtable_hash_vector_131_vectors;
    Object Qavailable_sysproc_continuation_hashtable_hash_vector_131_vectors;
    ...
    Object Qnamed, Qtype_specification_simple_expansion, list_constant_8;
    ...
    Object string_constant_59, string_constant_58, list_constant_2;
    ...
    Object list_constant_7, Qfile_sysproc, Qfile_system_slot_description;
    Object Qfile_system, Qget_slot_description_from_class, Kfuncall;
    Object list_constant_6, Qposition_in_file_slot_description;
    Object Qposition_in_file, list_constant_5;
    Object Qaccess_direction_slot_description, Qaccess_direction;
    Object list_constant_4, Qname_of_file_slot_description, Qname_of_file;
    Object list_constant_3, Qg2_stream_status_slot_description;
    Object Qg2_stream_status, Qcleanup, Qcleanup_for_g2_stream;
    ...
    Object string_constant_30, Qentity, Qitem;

    x_note_fn_call(165,127);
    SET_PACKAGE("AB");
    AB_package = STATIC_PACKAGE("AB");
    Qg2_stream = STATIC_SYMBOL("G2-STREAM",AB_package);
    Qitem = STATIC_SYMBOL("ITEM",AB_package);
    Qentity = STATIC_SYMBOL("ENTITY",AB_package);
    list_constant_2 = STATIC_LIST((SI_Long)2L,Qitem,Qentity);
    check_if_superior_classes_are_defined(Qg2_stream,list_constant_2);
    string_constant_30 = STATIC_STRING("1m1l83Iy1l83Ly");
    Qcreate_icon_description = STATIC_SYMBOL("CREATE-ICON-DESCRIPTION",
	    AB_package);
    string_constant_31 = 
	    STATIC_STRING("13Ey4z8r8u8u83NWy83NWy01p8w9k3-Wy3ky1w1p83Jy1m3ayt1m3ay3ay1m3-=y3ay1m3-=yt1n83Oy1m3gy3Dy1m3wy3Dy1n83Oy1m3iy3Hy1m3py3Hy1n83Oy1m3h");
    string_constant_32 = 
    ...
    string_constant_36 = 
	    STATIC_STRING("m3-Iy3Jy1m3-Iyv001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition000004z8r83WFy83WFy83NWy83NWy00001p1l8l1l8o1l83Fy");
    string_constant_37 = 
	    STATIC_STRING("1m8p83-qy1l83Hy000004z8r831vy831vy83NWy83NWy00001p1l8l1l8o1l83Fy1m8p83-qy1l83Hy000004z8r83GQy83GQy83NWy83NWy083I1y001p1l8l1l8o1l");
    string_constant_38 = 
	    STATIC_STRING("83Fy1m8p83-qy1l83Hy000004z8r83Y*y83Y*y83NWy83NWy00001p1l8l1l8o1l83Fy1m8p83-qy1l83Hy000004z8r83NXy83NXy83NWy83NWy0835ry001p1l8l1l");
    string_constant_39 = 
	    STATIC_STRING("8o1l83Fy1m8p83-qy1l83Hy000004z8r83Scy83Scy83NWy83NWy00001n1l8o1l8l1l83Hy000004z8r83Shy83Shy83NWy83NWy00001n1l8o1l8l1l83Hy000004z");
    string_constant_40 = 
	    STATIC_STRING("8r83SYy83SYy83NWy83NWy00001n1l8o1l8l1l83Hy000004z8r83SXy83SXy83NWy83NWy0k001n1l8o1l8l1l83Hy000004z8r83SVy83SVy83NWy83NWy0k001n1l");
    string_constant_41 = 
	    STATIC_STRING("8o1l8l1l83Hy000004z8r83SZy83SZy83NWy83NWy0k001n1l8o1l8l1l83Hy000004z8r83=ly83=ly83NWy83NWy00001p1m8p830Uy1l83-4y1l83Ey1l8l1l83Hy");
    string_constant_42 = 
	    STATIC_STRING("000004z8r83Siy83Siy83NWy83NWy00001n1l8o1l8l1l83Hy000004z8r83Sey83Sey83NWy83NWy00001n1l8o1l8l1l83Hy000004z8r83Sfy83Sfy83NWy83NWy0");
    string_constant_43 = 
	    STATIC_STRING("0001n1l8o1l8l1l83Hy000004z8r83Sdy83Sdy83NWy83NWy00001n1l8o1l8l1l83Hy000004z8r83Sgy83Sgy83NWy83NWy00001n1l8o1l8l1l83Hy00000");
    string_constant_44 = 
	    STATIC_STRING("13Gy8q1o83NWy1m83Ry83-+y83Iy83Ly1m8u1p8w9k3-Wy3ky1w1p83Jy1m3ayt1m3ay3ay1m3-=y3ay1m3-=yt1n83Oy1m3gy3Dy1m3wy3Dy1n83Oy1m3iy3Hy1m3py");
    string_constant_45 = 
    ...
    string_constant_49 = 
	    STATIC_STRING("v1n1m3-Ry3Dy1m3-Iy3Jy1m3-Iyv1q83WFy08o83Fy1m8p83-qy83Hy1q831vy08o83Fy1m8p83-qy83Hy1q83GQy83I1y8o83Fy1m8p83-qy83Hy1q83Y*y08o83Fy1");
    string_constant_50 = 
	    STATIC_STRING("m8p83-qy83Hy1q83NXy835ry8o83Fy1m8p83-qy83Hy1p83Scy08o8l83Hy1p83Shy08o8l83Hy1p83SYy08o8l83Hy1p83SXyk8o8l83Hy1p83SVyk8o8l83Hy1p83S");
    string_constant_51 = 
	    STATIC_STRING("Zyk8o8l83Hy1r83=ly01m8p830Uy83-4y83Ey8l83Hy1p83Siy08o8l83Hy1p83Sey08o8l83Hy1p83Sfy08o8l83Hy1p83Sdy08o8l83Hy1p83Sgy08o8l83Hy");
    ...
    clear_optimized_constants();
    push_optimized_constant(Qcreate_icon_description);
    add_class_to_environment(9,Qg2_stream,list_constant_2,Nil,temp,Nil,
	    temp_1,list_constant_2,regenerate_optimized_constant(list(8,
    ...
    record_system_variable(Qposition_in_file_slot_description,
	    Qfile_sysproc,list_constant_6,Qnil,Qnil,Qnil,Qnil);
    ...
    string_constant_55 = 
	    STATIC_STRING("ion is available at this time)000004z8r83Kwy83Kwy83=ly83=ly09k001m1l8l1m8p83B5y000004z8r83Ffy83Ffy83=ly83=ly00001m1l8l1m8p83Ffy0");
    string_constant_56 = 
	    STATIC_STRING("00004z8r83L+y83L+y83=ly83=ly083EKy001m1l8l1m8p83DQy000004z8r83Cby83Cby83=ly83=ly08378y001m1l8l1m8p83Cby000004z8r83Sjy83Sjy83=ly8");
    string_constant_57 = STATIC_STRING("3=ly00001n1l8l1l83Hy1l83Fy00000");
    string_constant_58 = 
	    STATIC_STRING("1t8q1m83=ly1m83Ry83-+y1n83--y01m8p83-*y1n83-0y01m8p83-0y1n83Kwy9k1m8p83B5y1n83Ffy01m8p83Ffy1n83L+y83EKy1m8p83DQy1n83Cby8378y1m8p");
    string_constant_59 = STATIC_STRING("83Cby1o83Sjy083Hy83Fy");
    temp = regenerate_optimized_constant(string_constant_25);
    clear_optimized_constants();
    ...
    clear_optimized_constants();
    push_optimized_constant(Qab_gensym);
    add_class_to_environment(9,Qtext_conversion_style,list_constant_2,Nil,
    ...
    list_constant_1 = STATIC_LIST((SI_Long)3L,Qab_or,list_constant_8,Qsymbol);
    ...
    set_slot_value_to_evaluation_value_function(Qtext_conversion_style_name_qm,
	    text_conversion_style_name_qm_evaluation_getter_1);
    string_constant_60 = STATIC_STRING("1m1m830Uy1m9k83Zy1m830Uy83-Edy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_60));
    string_constant_61 = STATIC_STRING("1l1m83-Edy83-6y");
    ...
    mutate_global_property(Qunconvertible_character_spec,
	    ...
	    Qslot_value_writer);
    string_constant_63 = 
	    STATIC_STRING("1q1m83DQy1m9k83EKy1m83DQy1m9k83-PDy1m83DQy1m9k83-bgy1m83DQy1m9k83-PMy1m83DQy1m9k83-t8y1m83DQy1m9k83-t9y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    mutate_global_property(Qline_separator,
	    ...
	    Qslot_value_writer);
    string_constant_64 = 
	    STATIC_STRING("1o1m83Cby1m9k8378y1m83Cby1m9k83kIy1m83Cby1m9k83-MMy1m83Cby1m9k83-MNy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_64));
    string_constant_65 = 
	    STATIC_STRING("13My1m83B5y1m9k83oMy1m83B5y1m9k83kNy1m83B5y1m9k83kOy1m83B5y1m9k83kPy1m83B5y1m9k83kQy1m83B5y1m9k83kUy1m83B5y1m9k83kTy1m83B5y1m9k8");
    string_constant_66 = 
	    STATIC_STRING("3kVy1m83B5y1m9k83kWy1m83B5y1m9k83kRy1m83B5y1m9k83kSy1m83B5y1m9k83kBy1m83B5y1m9k83-ajy1m83B5y1m9k83-nBy1m83B5y1m9k83kKy1m83B5y1m9");
    string_constant_67 = 
	    STATIC_STRING("k83-bEy1m83B5y1m9k83Puy1m83B5y1m9k83-Vby1m83B5y1m9k83-t4y1m83B5y1m9k83-t6y1m83B5y1m9k83-tBy1m83B5y1m9k83-tCy1m83B5y1m9k83-tEy1m8");
    string_constant_68 = 
	    STATIC_STRING("3B5y1m9k83-tFy1m83B5y1m9k9l1m83B5y1m9k83-w+y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    push_optimized_constant(Qab_gensym);
    ...
    Qsysproc_continuation_hashtable_hash_vector_131_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_69 = STATIC_STRING("1q83-qAy83*By83-P7y09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qg2_get_version,STATIC_FUNCTION(g2_get_version,NIL,
	    FALSE,0,0));
    Qg2_get_tw_version = STATIC_SYMBOL("G2-GET-TW-VERSION",AB_package);
    gensymed_symbol = Nil;
    mutate_global_property(Qg2_get_tw_version,gensymed_symbol,
	    Qfunction_keeps_procedure_environment_valid_qm);
    Qicp = STATIC_SYMBOL("ICP",AB_package);
    string_constant_19 = STATIC_STRING("~NF is not a remote gensym-window");
    ...
    SET_SYMBOL_FUNCTION(Qg2_get_tw_version,
	    STATIC_FUNCTION(g2_get_tw_version,NIL,FALSE,1,1));
    ...
    string_constant_21 = STATIC_STRING("~d/~d/~d");
    string_constant_22 = STATIC_STRING("~d/~d/0~d");
    string_constant_23 = STATIC_STRING(" ");
    string_constant_24 = STATIC_STRING("~d:");
    string_constant_26 = STATIC_STRING("~d");
    string_constant_27 = STATIC_STRING(":");
    string_constant_28 = STATIC_STRING("p.m.");
    string_constant_29 = STATIC_STRING("a.m.");
