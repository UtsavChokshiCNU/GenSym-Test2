...
Object Chain_of_available_snapshot_invocation_infos = UNBOUND;

Object Snapshot_invocation_info_count = UNBOUND;
    ...
    Object snapshot_invocation_info;
{
    ...
    svref_new_value = Chain_of_available_snapshot_invocation_infos;
    SVREF(snapshot_invocation_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_snapshot_invocation_infos = snapshot_invocation_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_snapshot_invocation_info_structure_internal()
{
    ...
    Object snapshot_invocation_info_count_new_value;
    ...
    snapshot_invocation_info_count_new_value = 
	    FIXNUM_ADD1(Snapshot_invocation_info_count);
    Snapshot_invocation_info_count = snapshot_invocation_info_count_new_value;
...
Object Chain_of_available_snapshot_of_blocks = UNBOUND;

Object Snapshot_of_block_count = UNBOUND;
    ...
    Object snapshot_of_block;
{
    ...
    svref_new_value = Chain_of_available_snapshot_of_blocks;
    SVREF(snapshot_of_block,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_snapshot_of_blocks = snapshot_of_block;
    return VALUES_1(Nil);
}
...
Object make_permanent_snapshot_of_block_structure_internal()
{
    ...
    Object snapshot_of_block_count_new_value;
    Object defstruct_g2_snapshot_of_block_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(95,14);
    def_structure_snapshot_of_block_variable = Nil;
    snapshot_of_block_count_new_value = FIXNUM_ADD1(Snapshot_of_block_count);
    Snapshot_of_block_count = snapshot_of_block_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Current_computation_instance = UNBOUND;

Object Cached_stack_frame_base = UNBOUND;
...
Object Snapshots_of_related_blocks = UNBOUND;
    ...
    Object block_or_snapshot_of_block;
{
  ...
  end_1:;
	...
	Snapshots_of_related_blocks = nconc2(temp_1,
		gensym_cons_1(SIMPLE_VECTOR_P(block_or_snapshot_of_block) 
		&& EQ(ISVREF(block_or_snapshot_of_block,(SI_Long)0L),
		Qg2_defstruct_structure_name_snapshot_of_block_g2_struct) ?
    ...
    Object snapshots;
{
	...
	goto next_loop;
      end_loop:;
	return reclaim_gensym_list_1(snapshots);
    }
    else
	return VALUES_1(Nil);
}
...
{
    x_note_fn_call(95,22);
    if (blocks)
	return gensym_cons_1(text_string,blocks);
    else
    ...
    Object error_text;
{
    ...
    if (CONSP(error_text))
	return reclaim_gensym_list_1(error_text);
    else
	return VALUES_1(Nil);
}
...
Object Stack_of_deferred_notification_strings = UNBOUND;
...
Object try_to_do_deferred_user_notifications()
{
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(reversed_stack);
	return VALUES_1(T);
    }
    else
	return VALUES_1(Nil);
    ...
    Object notification_string;
{
	...
	Stack_of_deferred_notification_strings = 
		gensym_cons_1(Snapshots_of_related_blocks ? 
		gensym_cons_1(notification_string,
    ...
    Object debugging_parameters;
{
    ...
    x_note_fn_call(95,37);
    PUSH_SPECIAL(Debugging_parameters,debugging_parameters,0);
...
Object Warning_message_level = UNBOUND;

Object Tracing_message_level = UNBOUND;

Object Breakpoint_level = UNBOUND;

Object Source_stepping_level = UNBOUND;

Object Debugging_reset = UNBOUND;

Object Disassemble_enabled_qm = UNBOUND;

Object Show_procedure_invocation_hierarchy_on_debugger_pause_p = UNBOUND;
...
static Object Qsource_stepping_level;  /* source-stepping-level */
...
static Object Qgenerate_source_annotation_info;  /* generate-source-annotation-info */
...
Object Disable_tracing_and_breakpoints_warning = UNBOUND;
...
Object Saved_warning_level = UNBOUND;

Object Saved_tracing_level = UNBOUND;

Object Saved_breakpoint_level = UNBOUND;

Object Saved_source_stepping_level = UNBOUND;

Object Trace_messages_within_extent_of_rule = UNBOUND;

/* RESET-DEBUGGING-PARAMETERS */
Object reset_debugging_parameters()
{
    x_note_fn_call(95,63);
    Warning_message_level = 
	    get_lookup_slot_value_given_default(Debugging_parameters,
	    Qwarning_message_level,FIX((SI_Long)2L));
    Tracing_message_level = 
...
Object Suppress_warning_message_header_qm = UNBOUND;

/* RESET-SUPPRESS-HEADER-VARIABLE */
Object reset_suppress_header_variable()
{
    x_note_fn_call(95,66);
		...
		PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		  ...
		  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		    ...
		    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		      ...
		      PUSH_SPECIAL(Calling_tformat_for_give_warning_qm,calling_tformat_for_give_warning_qm,
			      0);
			if (EQ(arg1,No_arg))
    ...
    Object g2_window_qm, clogged_qm;
{
    ...
    x_note_fn_call(95,94);
    SAVE_STACK();
    defer_notifications_qm = T;
    PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,7);
      if ((SI_Long)2L <= IFIX(Warning_message_level) &&  
...
Object Current_message_serial_number = UNBOUND;
...
void debug_INIT()
{
    ...
    Object Qfix_frame_with_substitute_class, Qdebugging_parameters;
    ...
    Object Qab_debug, Qsuppress_warning_message_header_qm;
    Object Qtrace_messages_within_extent_of_rule, Qsaved_source_stepping_level;
    Object Qsaved_breakpoint_level, Qsaved_tracing_level, Qsaved_warning_level;
    Object Qslot_putter, Qput_message_and_breakpoint_overrides;
    ...
    Object Qinstall_system_table_for_debugging_parameters, Qdebugging_reset;
    ...
    Object Qsnapshot_of_block_count, Qchain_of_available_snapshot_of_blocks;
    ...
    Object Qsnapshot_invocation_info_count;
    Object Qchain_of_available_snapshot_invocation_infos, string_constant_50;
    Object string_constant_49;

    x_note_fn_call(95,99);
    SET_PACKAGE("AB");
    ...
    string_constant_49 = 
	    STATIC_STRING("43Dy8m83nLy1n83nLy8n8k1l8n0000001m1n8y83-5wy1p83-DOy83-DNy83-DLy83-DPy83-DMy1m83My83-B7ykqk0k0");
    ...
    Qsnapshot_invocation_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_50 = STATIC_STRING("1q83nLy8s83-oky09k9l");
    ...
    string_constant_51 = 
	    STATIC_STRING("43Dy8m83nMy1n83nMy8n8k1l8n0000001m1m8y83-5xy1m830ly83-DQykok0k0");
    ...
    Qsnapshot_of_block_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_52 = STATIC_STRING("1q83nMy8s83-oly09k9l");
    clear_optimized_constants();
    ...
    string_constant_56 = 
	    STATIC_STRING("r83a*y83a*y8386y8386y08k001n1l8l1l83Cy1m8p83Ky000004z8r83K-y83K-y8386y8386y00001n1l8l1l83Cy1m8p83Ky000004z8r83Pvy83Pvy8386y8386y");
    string_constant_57 = 
	    STATIC_STRING("08k001n1l8l1l83Cy1m8p83Ky000004z8r83cLy83cLy8386y8386y00001o1l83Ey1m8p83FUy1l8l1l83Cy000004z8r83cNy83cNy8386y8386y00001p1l8l1l83");
    string_constant_58 = 
	    STATIC_STRING("Ey1l83Ny1l83Hy1m83Dy5sInternal000004z8r83cMy83cMy8386y8386y00001p1l8l1l83Ey1l83Ny1l83Hy1m83Dy5sInternal000004z8r83cKy83cKy8386y8");
    string_constant_59 = 
	    STATIC_STRING("386y00001p1l8l1l83Ey1l83Ny1l83Hy1m83Dy5sInternal000004z8r83RVy83RVy8386y8386y00001m1l8l1l83Cy000004z8r83KFy83KFy8386y8386y03=4y0");
    string_constant_60 = 
	    STATIC_STRING("01o1l83Ey1m8p83Biy1l8l1l83Hy000004z8r83bWy83bWy8386y8386y00001p1l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal000004z8r83bXy83bXy8386y8386y");
    string_constant_61 = 
	    STATIC_STRING("00001p1l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal000004z8r83bYy83bYy8386y8386y00001p1l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal000004z8r83bZy8");
    string_constant_62 = 
	    STATIC_STRING("3bZy8386y8386y00001p1l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal000004z8r83bay83bay8386y8386y00001o1l8o1l8l1l83Cy1l83Ny000004z8r83Uoy83U");
    string_constant_63 = 
	    STATIC_STRING("oy8386y8386y00001p1l8o1l8l1l83Hy1l83Ny1m83Dy5sInternal000004z8r83Upy83Upy8386y8386y00001p1l8o1l8l1l83Hy1l83Ny1m83Dy5sInternal000");
    string_constant_64 = 
    ...
    string_constant_66 = 
	    STATIC_STRING("a*y8k1l8l1l83Cy1m8p83Ky1p83K-y01l8l1l83Cy1m8p83Ky1p83Pvy8k1l8l1l83Cy1m8p83Ky1q83cLy01l83Ey1m8p83FUy1l8l1l83Cy1q83cNy01l83Ey1l83N");
    string_constant_67 = 
	    STATIC_STRING("y1l83Hy1m83Dy5sInternal1q83cMy01l83Ey1l83Ny1l83Hy1m83Dy5sInternal1q83cKy01l83Ey1l83Ny1l83Hy1m83Dy5sInternal1o83RVy08l83Cy1q83KFy");
    string_constant_68 = 
	    STATIC_STRING("3=4y1l83Ey1m8p83Biy1l8l1l83Hy1r83bWy01l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal1r83bXy01l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal1r83bYy01l8");
    string_constant_69 = 
	    STATIC_STRING("o1l8l1l83Cy1l83Ny1m83Dy5sInternal1r83bZy01l8o1l8l1l83Cy1l83Ny1m83Dy5sInternal1q83bay01l8o1l8l1l83Cy1l83Ny1r83Uoy01l8o1l8l1l83Hy1");
    string_constant_70 = 
	    STATIC_STRING("l83Ny1m83Dy5sInternal1r83Upy01l8o1l8l1l83Hy1l83Ny1m83Dy5sInternal1r83H*y01l8o1l8l1l83Hy1l83Ny1m83Dy5sInternal");
    ...
    mutate_global_property(Qbreakpoint_level,
	    ...
	    Qslot_value_writer);
    string_constant_71 = 
	    STATIC_STRING("1m1n83A-y1q1m9kk1m9k83-9y1m9k83=Ty1m9k83aay1m9k83-Doy1m9k83-Ayl1n83A-y1p1m9kl1m9k83-9y1m9k83aay1m9k83-Doy1m9k83-Ayl");
    clear_optimized_constants();
    ...
    mutate_global_property(Qsource_stepping_level,
	    ...
	    Qslot_value_writer);
    string_constant_72 = 
	    STATIC_STRING("1n1n83-dXy1p1m9k83=Ty1m9k83fXy1m9k83=Uy1m9k83-FDy1m9k83Djyl1n83-dXy1q1m9k83=Ty1m9k83fXy1m9k83vy1m9k83-FDy1m9k83Djy1m9k83h6ym1n83");
    string_constant_73 = 
	    STATIC_STRING("-dXy1p1m9k83fXy1m9k83-ty1m9k83-FDy1m9k83Djy1m9k83h6yp");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_74 = 
	    STATIC_STRING("1y1m83-py1m9k83Py1m83-py83-s*y1m83-s*y83-v5y1o83-s*y1n83-v5y1m9k83-ay83-s*y1nmln9l1m83-s*y83-s=y1o83-s*y1n83-s=y1m9k83-ay83-s*y1");
    string_constant_75 = 
	    STATIC_STRING("nmln9l1m83-s*y83-L3y1o83-s*y1n83-L3y1m9k83-ay83-s*y1nmln9l1m83-s*y83-ovy1o83-s*y1n83-ovy1m9k83-ay83-s*y1nmln9l1n83-v5y1o1m9k83ob");
    string_constant_76 = 
	    STATIC_STRING("y1m9k9m1m9k83-21y832Ty2l83obyo1n83-s=y1o1m9k83-s-y1m9k9m1m9k83-21y836My2l83-s-yo1n83-L3y1n1m9k83B0y1m9k83-21y8352y2l83B0yn1n83-o");
    string_constant_77 = 
	    STATIC_STRING("vy1o1m9k83aay1m9k83-Doy1m9k83-21y83A-y2l83-ouyo");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
