...
Object Chain_of_available_g2_list_elements = UNBOUND;

Object G2_list_element_count = UNBOUND;
...
Object make_permanent_g2_list_element_structure_internal()
{
    ...
    Object g2_list_element_count_new_value, the_array;
    Object defstruct_g2_g2_list_element_variable;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(81,4);
    def_structure_g2_list_element_variable = Nil;
    g2_list_element_count_new_value = FIXNUM_ADD1(G2_list_element_count);
    G2_list_element_count = g2_list_element_count_new_value;
    ...
    Object node;
{
    ...
    Chain_of_available_g2_list_elements = node;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_g2_list_element_variable, new_list;
    ...
    SVREF(def_structure_g2_list_element_variable,FIX((SI_Long)1L)) = Nil;
    SVREF(def_structure_g2_list_element_variable,FIX((SI_Long)2L)) = 
    ...
    SVREF(new_list,FIX((SI_Long)2L)) = G2_list_structure_marker;
    ...
    Object g2_list_structure;
{
    ...
    svref_new_value = Chain_of_available_g2_list_elements;
    SVREF(g2_list_structure,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_g2_list_elements = g2_list_structure;
    return VALUES_1(Nil);
}
...
{
    x_note_fn_call(81,9);
    SVREF(g2_list_structure,FIX((SI_Long)0L)) = g2_list_structure;
    return VALUES_1(SVREF(g2_list_structure,FIX((SI_Long)1L)) = 
	    g2_list_structure);
}
...
Object g2_list_structure_clear(g2_list_structure)
    Object g2_list_structure;
{
    Object next_element_structure, element_structure, svref_new_value;

    x_note_fn_call(81,10);
    next_element_structure = Nil;
    element_structure = ISVREF(g2_list_structure,(SI_Long)0L);
  next_loop:
    if (EQ(element_structure,g2_list_structure))
	goto end_loop;
    ...
    svref_new_value = Chain_of_available_g2_list_elements;
    SVREF(element_structure,FIX((SI_Long)0L)) = svref_new_value;
...
Object reclaim_eval_alist(alist)
    Object alist;
{
    Object trailer, cons_1, gensym_cons, cdr_new_value;
	...
	if ( !TRUEP(cons_1))
	    goto end_loop;
	reclaim_gensym_cons_1(M_CAR(cons_1));
	trailer = cons_1;
	cons_1 = M_CDR(cons_1);
	goto next_loop;
      end_loop:
...
/* RECLAIM-EVALUATION-TYPES-LEAVES */
Object reclaim_evaluation_types_leaves(evaluation_types_binary_tree)
    Object evaluation_types_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(evaluation_types_binary_tree))
	goto end_loop;
    less_than_branch_qm = ISVREF(evaluation_types_binary_tree,(SI_Long)1L);
    greater_than_branch_qm = ISVREF(evaluation_types_binary_tree,(SI_Long)2L);
    alist = ISVREF(evaluation_types_binary_tree,(SI_Long)3L);
    reclaim_binary_tree_element_1(evaluation_types_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
  ...
  end_loop_1:;
	...
	reclaim_evaluation_types_leaves(less_than_branch_qm);
	evaluation_types_binary_tree = greater_than_branch_qm;
    }
    else {
	...
	evaluation_types_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
/* CLEAR-EVALUATION-TYPES-TREE */
Object clear_evaluation_types_tree(evaluation_types_binary_tree)
    Object evaluation_types_binary_tree;
{
    Object element_qm;

    x_note_fn_call(81,15);
    element_qm = CDR(evaluation_types_binary_tree);
    if (element_qm) {
	reclaim_evaluation_types_leaves(element_qm);
	M_CDR(evaluation_types_binary_tree) = Nil;
    }
    return VALUES_1(evaluation_types_binary_tree);
}

Object Defined_evaluation_value_types = UNBOUND;

Object Defined_evaluation_datum_types = UNBOUND;
    ...
    Object fixnum_truth_value;
{
	...
	temp = gensym_cons_1(fixnum_truth_value,Qtruth_value);
    return VALUES_1(temp);
}
    ...
    Object evaluation_truth_value;
{
	...
	return gensym_cons_1(M_CAR(evaluation_truth_value),Qtruth_value);
}
...
Object make_evaluation_float_from_evaluation_long varargs_1(int, n)
{
    ...
    new_float = amf_result;
    temp_1 = lfloat(aref1(evaluation_long,FIX((SI_Long)0L)),float_constant);
...
Object Test_removal_of_unsigned_vector_16 = UNBOUND;
    ...
    Object x;
{
    ...
    temp = Test_removal_of_unsigned_vector_16 ? x : gensym_cons_1(x,
	    Qunsigned_vector_16);
    return VALUES_1(temp);
}
    ...
    Object unsigned_vector_16;
{
	...
	inline_note_reclaim_cons(unsigned_vector_16,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(unsigned_vector_16) = cdr_new_value;
	Available_gensym_conses = unsigned_vector_16;
    }
    return VALUES_1(Nil);
}
    ...
    Object member_1;
{
    ...
    if (member_1) {
	inline_note_reclaim_cons(member_1,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(member_1) = cdr_new_value;
	Available_gensym_conses = member_1;
    }
    return VALUES_1(Nil);
}
...
Object Chain_of_available_uuid_blocks = UNBOUND;

Object Uuid_block_count = UNBOUND;
    ...
    Object uuid_block;
{
    ...
    svref_new_value = Chain_of_available_uuid_blocks;
    SVREF(uuid_block,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_uuid_blocks = uuid_block;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_uuid_block_variable, uuid_block_count_new_value;
    Object defstruct_g2_uuid_block_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(81,59);
    def_structure_uuid_block_variable = Nil;
    uuid_block_count_new_value = FIXNUM_ADD1(Uuid_block_count);
    Uuid_block_count = uuid_block_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_uuid_block_variable;
    ...
    Object table;
{
    ...
    if (CONSP(table))
	reclaim_gensym_list_1(table);
    else if (SIMPLE_VECTOR_P(table))
	reclaim_managed_simple_vector(table);
    return VALUES_1(Nil);
}

/* MUTATE-UUID-BLOCK-HASH-TREE-ENTRY */
Object mutate_uuid_block_hash_tree_entry(entry_cons,new_key,new_entry)
    Object entry_cons, new_key, new_entry;
{
    x_note_fn_call(81,63);
    uuid_block_hash_key_reclaimer(M_CAR(entry_cons));
    uuid_block_hash_entry_reclaimer(M_CDR(entry_cons));
    M_CAR(entry_cons) = new_key;
    M_CDR(entry_cons) = new_entry;
    return VALUES_1(Nil);
}

Object Fp_mutate_uuid_block_hash_tree_entry = UNBOUND;

static Object Quuid_eq;            /* uuid= */

/* CLEAR-UUID-BLOCK-HASH-TREE */
Object clear_uuid_block_hash_tree(uuid_block_hash_binary_tree)
    Object uuid_block_hash_binary_tree;
{
    ...
    element_qm = Nil;
  next_loop:
    element_qm = CDR(uuid_block_hash_binary_tree);
    if ( !TRUEP(element_qm))
	goto end_loop;
    temp = ISVREF(element_qm,(SI_Long)3L);
    gensymed_symbol = CAAR(temp);
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Quuid_eq),
	    gensymed_symbol,uuid_block_hash_binary_tree,
    ...
    goto next_loop;
  end_loop:;
    return VALUES_1(uuid_block_hash_binary_tree);
}
...
Object reclaim_uuid_block_hash_table(table)
    Object table;
{
    Object element_qm, gensymed_symbol, old_key, old_entry, cdr_new_value;
    Object result;

    x_note_fn_call(81,66);
    element_qm = Nil;
  next_loop:
    element_qm = M_CDR(table);
    if ( !TRUEP(element_qm))
	goto end_loop;
    gensymed_symbol = M_CAR(M_CAR(ISVREF(element_qm,(SI_Long)3L)));
    result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Quuid_eq),
	    gensymed_symbol,table,sxhashw(gensymed_symbol));
    MVS_2(result,old_key,old_entry);
    uuid_block_hash_key_reclaimer(old_key);
    uuid_block_hash_entry_reclaimer(old_entry);
    goto next_loop;
  end_loop:
    inline_note_reclaim_cons(table,Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(table) = cdr_new_value;
    Available_gensym_conses = table;
    return VALUES_1(Nil);
}
...
Object Uuid_block_hash_table = UNBOUND;
    ...
    Object uuid_block;
{
	...
	result = delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Quuid_eq),
		gensymed_symbol,temp,sxhashw(gensymed_symbol));
	MVS_2(result,old_key,old_entry);
	uuid_block_hash_key_reclaimer(old_key);
	uuid_block_hash_entry_reclaimer(old_entry);
    }
...
Object Uuid_hash_block_table_for_merge_kb = UNBOUND;
    ...
    Object uuid_block, uuid_offset, referenced_item;
{
    ...
    new_item_reference = gensym_cons_1(held_vector,Qitem_reference);
...
Object Lazy_assignment_of_uuids = UNBOUND;

/* GET-ITEM-REFERENCE-FOR-NEW-UUID */
Object get_item_reference_for_new_uuid()
{
    Object item_reference, svref_arg_1, svref_new_value, temp, uuid;

    x_note_fn_call(81,72);
    if (Lazy_assignment_of_uuids) {
	item_reference = allocate_evaluation_item_reference(Nil,Nil,Nil);
	svref_arg_1 = M_CAR(item_reference);
	svref_new_value = FIXNUM_ADD1(ISVREF(svref_arg_1,(SI_Long)0L));
...
{
    Object uuid_block_key, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, uuid_block, item_reference_table;
    Object item_reference_qm, table_item_reference, ab_loop_list_, held_vector;
    Object temp, actual_uuid_block_key, temp_1, temp_2, temp_3;
    Object gensym_push_modify_macro_arg, car_1, cdr_1, table, offset;
    Object svref_new_value;
    SI_Long uuid_least_16_bits, uuid_offset, uuid_block_least_16_bits;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, index_1;
    ...
    gensymed_symbol = CDR(Uuid_block_hash_table);
    gensymed_symbol_1 = uuid_block_key;
    gensymed_symbol_2 = IFIX(sxhashw(uuid_block_key));
  ...
  next_loop:
	...
	if (uuid_eq(gensymed_symbol_1,gensymed_symbol_4)) {
	    uuid_block = M_CDR(M_CAR(gensymed_symbol));
	    goto end_1;
	}
  ...
  end_2:;
	...
	if (VECTORP(create_p)) {
	    temp = uuid_block ? copy_uuid_block(uuid_block) : Nil;
	    SVREF(create_p,FIX((SI_Long)1L)) = temp;
	...
	if ( !TRUEP(item_reference_table)) {
	    if (uuid_block) {
		temp = gensym_cons_1(item_reference_qm,Nil);
		...
		uuid_block = make_uuid_block_1(actual_uuid_block_key,
			gensym_cons_1(item_reference_qm,Nil));
		temp = M_CAR(item_reference_qm);
		SVREF(temp,FIX((SI_Long)1L)) = uuid_block;
		gensymed_symbol = actual_uuid_block_key;
		temp_1 = Uuid_block_hash_table;
		temp_2 = Fp_mutate_uuid_block_hash_tree_entry;
		temp_3 = sxhashw(gensymed_symbol);
		set_balanced_binary_tree_entry(temp_1,Quuid_eq,temp_2,T,
			gensymed_symbol,temp_3,uuid_block);
	    }
	}
	else if (CONSP(item_reference_table)) {
	    if (FIXNUM_LT(length(item_reference_table),
		    Item_reference_table_list_length_limit)) {
		gensym_push_modify_macro_arg = item_reference_qm;
		...
		goto next_loop_4;
	      end_loop_4:;
		reclaim_gensym_list_1(item_reference_table);
	...
	temp = M_CAR(item_reference_qm);
	svref_new_value = FIXNUM_ADD1(ISVREF(temp,(SI_Long)0L));
    ...
    Object item_reference;
{
	...
	if (CONSP(item_reference_table)) {
	    temp = delete_gensym_element_1(item_reference,
		    item_reference_table);
	    SVREF(uuid_block,FIX((SI_Long)3L)) = temp;
	}
	else if (SIMPLE_VECTOR_P(item_reference_table))
    ...
    if (item_reference) {
	inline_note_reclaim_cons(item_reference,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(item_reference) = temp;
	Available_gensym_conses = item_reference;
    }
    return VALUES_1(Nil);
}
...
Object copy_evaluation_item_reference(item_reference)
    Object item_reference;
{
    Object held_vector, svref_new_value;

    x_note_fn_call(81,80);
    held_vector = M_CAR(item_reference);
    svref_new_value = FIXNUM_ADD1(ISVREF(held_vector,(SI_Long)0L));
    SVREF(held_vector,FIX((SI_Long)0L)) = svref_new_value;
...
Object Collecting_denotation_errors_p = UNBOUND;

Object Denotation_error_list = UNBOUND;
...
Object allocate_new_nonce_internal()
{
    ...
    x_note_fn_call(81,91);
    always_use_current_time_for_uuid = T;
    PUSH_SPECIAL(Always_use_current_time_for_uuid,always_use_current_time_for_uuid,
	    0);
      result = make_uuid();
    POP_SPECIAL();
    return result;
    ...
    Object eval_list_of_contents;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(eval_list_of_contents);
    ...
    Object simple_vector, first_element_index_init, count_init;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    temp_2 = gensym_cons_1(held_vector,Qsequence);
    ...
    Object sequence;
{
    ...
    if (sequence) {
	inline_note_reclaim_cons(sequence,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(sequence) = temp;
	Available_gensym_conses = sequence;
    }
    return VALUES_1(Nil);
}
    ...
    Object sequence;
{
    ...
    temp = gensym_cons_1(held_vector,Qsequence);
    return VALUES_1(temp);
}
    ...
    Object length_1;
{
    ...
    temp = gensym_cons_1(new_vector,Qsequence);
    return VALUES_1(temp);
}
    ...
    Object sequence, index_to_remove;
{
  ...
  next_loop:
    ...
    if ( !(index_1 == remove_1)) {
	ab_loopvar__1 = gensym_cons_1(FIXNUMP(element) || element && 
...
Object Evaluation_value_indentation_depth = UNBOUND;

Object Evaluation_value_writing_target_length_qm = UNBOUND;

Object Indent_sequences_and_structures_p = UNBOUND;

Object Leave_text_representation_as_a_single_line_qm = UNBOUND;
    ...
    Object eval_cons_property_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(eval_cons_property_list);
    temp_1 = gensym_cons_1(held_vector,Qab_structure);
    return VALUES_1(temp_1);
}
    ...
    Object simple_vector, first_key_index, key_count_times_two;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    temp_2 = gensym_cons_1(held_vector,Qab_structure);
    return VALUES_1(temp_2);
}
...
Object reclaim_evaluation_structure(structure)
    Object structure;
{
    Object held_vector, ref_count, temp, svref_new_value;
    SI_Long gensymed_symbol, index_1, ab_loop_bind_, svref_arg_2;

    x_note_fn_call(81,130);
	...
	if (FIXNUM_LE(ISVREF(held_vector,(SI_Long)1L),
	    ...
	    temp = ISVREF(held_vector,(gensymed_symbol >>  -  - 
		    (SI_Long)10L) + (SI_Long)2L);
	    svref_arg_2 = gensymed_symbol & (SI_Long)1023L;
	    svref_new_value = FIXNUM_SUB1(ref_count);
	    ISVREF(temp,svref_arg_2) = svref_new_value;
	}
    }
    if (structure) {
	inline_note_reclaim_cons(structure,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(structure) = temp;
	Available_gensym_conses = structure;
    }
    return VALUES_1(Nil);
}
    ...
    Object structure;
{
    ...
    temp = gensym_cons_1(held_vector,Qab_structure);
    return VALUES_1(temp);
}
    ...
    Object structure, symbol;
{
  ...
  next_loop:
	...
	temp_1 = attribute;
	gensymed_symbol = index_1 + (SI_Long)1L;
	ab_loopvar__1 = gensym_list_2(temp_1,FIXNUM_LE(ISVREF(held_vector,
		(SI_Long)1L),Maximum_in_place_array_size) ? 
  ...
  end_loop:
	...
	reclaim_gensym_list_1(new_attributes);
	temp_1 = Nil;
	goto end_1;
    }
    temp_1 = Qnil;
...
Object Maximum_number_of_slots_in_structure_type = UNBOUND;
...
Object Boolean_composition_over_symbols_allows_top_level_symbols_p = UNBOUND;
    ...
    Object exp_1;
{
    ...
    x_note_fn_call(81,143);
    if (CONSP(exp_1)) {
	boolean_composition_over_symbols_allows_top_level_symbols_p = T;
	PUSH_SPECIAL(Boolean_composition_over_symbols_allows_top_level_symbols_p,boolean_composition_over_symbols_allows_top_level_symbols_p,
		0);
    ...
    Object value, type;
{
	...
	temp_1 = make_evaluation_long(value);
    else if (EQ(type,Qnumber))
	temp_1 = make_evaluation_quantity(value);
	...
	if (FIXNUM_EQ(value,Truth))
	    ...
	    temp_1 = gensym_cons_1(value,Qtruth_value);
    }
    else if (EQ(type,Qsymbol))
	temp_1 = value;
    else if (EQ(type,Qtext))
	temp_1 = copy_as_wide_string(value);
    else
	temp_1 = EQ(type,Qnumber) || EQ(type,Qinteger) || EQ(type,Qfloat) 
		|| EQ(type,Qlong) || 
    ...
    Object value;
{
    ...
    Object temp_2, svref_new_value, amf_result, incff_1_arg, new_float;
    Object gensymed_symbol;
    char temp_1;
    double aref_new_value;

    x_note_fn_call(81,154);
    ...
    Object value, type_of_value;
{
	...
	if (FIXNUM_EQ(value,Truth))
	    ...
	    temp = gensym_cons_1(value,Qtruth_value);
    }
...
Object reclaim_evaluation_value(evaluation_value)
    Object evaluation_value;
{
    Object cdr_1, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(81,156);
	...
	if (EQ(cdr_1,Qtruth_value)) {
		...
		gensymed_symbol_1 = cdr_1;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(cdr_1) & 
...
Object reclaim_eval_list_of_item_or_datum(list_1)
    Object list_1;
{
    Object trailer, cons_1, thing, gensym_cons, cdr_new_value;

    x_note_fn_call(81,159);
    if (list_1) {
	trailer = Nil;
	cons_1 = list_1;
      next_loop:
...
Object copy_evaluation_value_1(evaluation_value)
    Object evaluation_value;
{
    Object cdr_1, temp, car_arg, car_new_value, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(81,160);
    if (CONSP(evaluation_value)) {
	cdr_1 = M_CDR(evaluation_value);
	if (EQ(cdr_1,Qtruth_value))
	    temp = EQ(evaluation_value,Evaluation_true_value) || 
		    EQ(evaluation_value,Evaluation_false_value) ? 
		    evaluation_value : 
		    gensym_cons_1(M_CAR(evaluation_value),Qtruth_value);
	else if (EQ(cdr_1,Qiteration_state)) {
...
Object evaluation_value_value(evaluation_value)
    Object evaluation_value;
{
    Object cdr_1, temp, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(81,164);
    if (CONSP(evaluation_value)) {
	cdr_1 = M_CDR(evaluation_value);
	if (EQ(cdr_1,Qtruth_value))
...
Object evaluation_value_type(evaluation_value)
    Object evaluation_value;
{
    Object temp, cdr_1, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(81,165);
...
Object evaluation_value_p_function(evaluation_value)
    Object evaluation_value;
{
    Object gensymed_symbol, temp, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;

    x_note_fn_call(81,166);
...
{
    Object evaluation_value_1, evaluation_value_2;
    Object is_case_sensitive_p, temp, cdr_1, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, comparitor_qm, temp_2;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;
    double arg, arg_1;
    Declare_varargs_nonrelocating;

    x_note_fn_call(81,171);
    INIT_ARGS_nonrelocating();
	...
	if (INLINE_LONG_VECTOR_P(evaluation_value_2) != (SI_Long)0L && 
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(evaluation_value_2)) == 
		(SI_Long)1L) {
	    temp_2 = aref1(evaluation_value_1,FIX((SI_Long)0L));
	    temp = aref1(evaluation_value_2,FIX((SI_Long)0L));
	    return VALUES_1(NUM_EQ(temp_2,temp) ? T : Nil);
	}
	else
	    return VALUES_1(Nil);
    }
    ...
    Object temporary_constant;
{
	...
	if (FIXNUM_EQ(managed_value,Truth))
	    ...
	    managed_value = gensym_cons_1(managed_value,Qtruth_value);
    }
    ...
    Object list_1;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(make_evaluation_value_from_temporary_constant(temporary_constant),
	    Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
    ...
    Object obsolete_datum;
{
    ...
    x_note_fn_call(81,178);
    reclaim_evaluation_value(M_CAR(obsolete_datum));
    if (obsolete_datum) {
	inline_note_reclaim_cons(obsolete_datum,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(obsolete_datum) = cdr_new_value;
	Available_gensym_conses = obsolete_datum;
    }
    return VALUES_1(Nil);
}
    ...
    Object obsolete_datum;
{
    ...
    x_note_fn_call(81,179);
    evaluation_value = M_CAR(obsolete_datum);
    temp = gensym_cons_1(FIXNUMP(evaluation_value) || evaluation_value && 
	    SYMBOLP(evaluation_value) ? evaluation_value : 
...
Object evaluation_value_type_specification_p(thing)
    Object thing;
{
    Object temp, gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(81,182);
...
Object member_type_specification_p(type_specification)
    Object type_specification;
{
    Object elt_1, ab_loop_list_, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp_1;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(81,213);
...
Object type_specification_type_p(thing,type)
    Object thing, type;
{
    Object temp, value, x2, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, aggregate_type_name_of_value;
    Object aggregate_type_name, elt_1, ab_loop_list_, ab_loop_it_;
    Object sub_class_bit_vector, union_type, intersection_type;
    Object function_symbol, type_name;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_1;

    x_note_fn_call(81,217);
	...
	if (EQ(type,Qnumber)) {
		...
		gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
		temp = EQ(gensymed_symbol_1,Qtruth_value) ? T : Nil;
		if (temp);
		else
		    temp = EQ(gensymed_symbol_1,Qiteration_state) ? T : Nil;
		if (temp);
		else if (SYMBOLP(gensymed_symbol_1)) {
		    gensymed_symbol = CDR(Defined_evaluation_value_types);
		    gensymed_symbol_2 = SXHASH_SYMBOL_1(gensymed_symbol_1) 
			    & IFIX(Most_positive_fixnum);
		    gensymed_symbol_3 = (SI_Long)0L;
		  next_loop:
		    if ( !TRUEP(gensymed_symbol))
...
Object class_in_attribute_conforms_to_type_p varargs_1(int, n)
{
    ...
    Object class_for_instantiation, temp, gensymed_symbol, gensymed_symbol_1;
	...
	if (SYMBOLP(class_for_instantiation)) {
	    ...
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(class_for_instantiation) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
...
Object Internal_g2_element_types_that_can_contain_datum = UNBOUND;

Object G2_element_types_that_can_contain_datum = UNBOUND;

/* CATEGORY-IS-NOT-G2-ELEMENT-DATUM-TYPE */
Object category_is_not_g2_element_datum_type(category_symbol)
    Object category_symbol;
{
    x_note_fn_call(81,221);
...
{
    Object evaluation_value;
    Object beautifully_qm, possible_type_name, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;
    Declare_varargs_nonrelocating;
	...
	if (CONSP(evaluation_value)) {
		...
		gensymed_symbol = CDR(Defined_evaluation_value_types);
		gensymed_symbol_1 = possible_type_name;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(possible_type_name) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop:
		if ( !TRUEP(gensymed_symbol))
    ...
    Object type_specification;
{
    ...
    Object ab_current_alist_, ab_entry_cons_, type, defined_types, ab_loopvar_;
    Object ab_loopvar__1, ab_less_than_branch_qm_, possible_type_name;
	...
	if (EQ(type_specification,Qitem_or_datum))
	    ...
	    ab_next_node_qm_ = Defined_evaluation_value_types;
	    ...
	    next_loop:
	      ...
	      ab_loopvar__1 = gensym_cons_1(get_property_value_function(3,
	      ...
	      goto next_loop;
	    end_loop_1:
	      defined_types = nconc2(gensym_list_2(Qdatum,list_constant_3),
		      defined_types);
	      write_combined_type_specification(Qab_or,defined_types);
	      reclaim_gensym_list_1(defined_types);
	    POP_SPECIAL();
	}
	else
	...
	if (temp) {
	    ...
	    twrite_beginning_of_wide_string(array_constant_28,
		    FIX((SI_Long)7L));
	    temp_1 = CDR(type_specification);
	    more_than_two_p = CDDR(temp_1);
	  ...
	  end_loop_4:;
		...
		temp_1 = get_property_value_function(3,
			get_symbol_properties_function(type_name),
			Qtype_specification_simple_expansion,Nil);
	    write_type_specification(temp_1);
	}
	else
...
Object Set_of_all_component_kinds = UNBOUND;
...
Object Chain_of_available_attribute_mimics = UNBOUND;

Object Attribute_mimic_count = UNBOUND;
    ...
    Object attribute_mimic;
{
    ...
    x_note_fn_call(81,237);
    inline_note_reclaim_cons(attribute_mimic,Nil);
    svref_new_value = Chain_of_available_attribute_mimics;
    SVREF(attribute_mimic,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_attribute_mimics = attribute_mimic;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_attribute_mimic_variable;
    Object attribute_mimic_count_new_value, the_array;
    Object defstruct_g2_attribute_mimic_variable;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(81,239);
    def_structure_attribute_mimic_variable = Nil;
    attribute_mimic_count_new_value = FIXNUM_ADD1(Attribute_mimic_count);
    Attribute_mimic_count = attribute_mimic_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_virtual_attributes = UNBOUND;

Object Virtual_attribute_count = UNBOUND;
    ...
    Object virtual_attribute;
{
    ...
    x_note_fn_call(81,243);
    inline_note_reclaim_cons(virtual_attribute,Nil);
    svref_new_value = Chain_of_available_virtual_attributes;
    SVREF(virtual_attribute,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_virtual_attributes = virtual_attribute;
    return VALUES_1(Nil);
}
...
Object make_permanent_virtual_attribute_structure_internal()
{
    ...
    Object virtual_attribute_count_new_value;
    Object defstruct_g2_virtual_attribute_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(81,245);
    def_structure_virtual_attribute_variable = Nil;
    virtual_attribute_count_new_value = FIXNUM_ADD1(Virtual_attribute_count);
    Virtual_attribute_count = virtual_attribute_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Virtual_attributes_not_local_to_a_class = UNBOUND;

Object All_virtual_attributes = UNBOUND;
    ...
    Object frame, attribute;
{
	...
	temp = type_specification_type_p(frame,frame_type_spec) ? 
		make_evaluation_place_reference_to_place(gensym_list_3(Qvirtual_attribute,
...
Object Chain_of_available_category_evaluator_interfaces = UNBOUND;

Object Category_evaluator_interface_count = UNBOUND;
    ...
    Object category_evaluator_interface;
{
    ...
    x_note_fn_call(81,256);
    inline_note_reclaim_cons(category_evaluator_interface,Nil);
    svref_new_value = Chain_of_available_category_evaluator_interfaces;
    SVREF(category_evaluator_interface,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_category_evaluator_interfaces = 
...
Object make_permanent_category_evaluator_interface_structure_internal()
{
    ...
    Object category_evaluator_interface_count_new_value;
    Object defstruct_g2_category_evaluator_interface_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(81,258);
    def_structure_category_evaluator_interface_variable = Nil;
    category_evaluator_interface_count_new_value = 
	    FIXNUM_ADD1(Category_evaluator_interface_count);
    ...
    Object name, value;
{
    ...
    x_note_fn_call(81,262);
    svref_arg_1 = get_category_evaluator_interface(name);
    return VALUES_1(SVREF(svref_arg_1,FIX((SI_Long)2L)) = value);
}

Object Last_reason_for_complex_type_rejection = UNBOUND;

Object Structure_slot_not_bound = UNBOUND;

Object Reason_for_type_failure = UNBOUND;

Object Type_at_type_failure = UNBOUND;

Object Value_at_type_failure = UNBOUND;

Object Context_of_type_failure = UNBOUND;

Object Last_slot_checked_of_type_failure = UNBOUND;

Object Structure_specs_allow_unknown_slots_p = UNBOUND;

Object Current_category_name_for_type_specification_type_p = UNBOUND;
    ...
    Object thing, type;
{
	...
	if (EQ(temp,Qab_or))
	  ...
	  end_1:;
	    ...
	    PUSH_SPECIAL(Current_category_name_for_type_specification_type_p,current_category_name_for_type_specification_type_p,
		    0);
	      temp = CADR(type);
	      if (SYMBOLP(temp) && EQ(CADR(type),Qcolor_or_metacolor))
		  temp =  !EQ(color_or_metacolor_p(thing),Nil) ? T : Nil;
    ...
    Object type;
{
  ...
  next_loop:
    ...
    ab_loopvar__2 = copy_list_using_gensym_conses_1(CDR(member_type));
    if (ab_loopvar__2) {
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
  ...
  end_loop:
    ...
    temp = Qnil;
  end_1:;
    return gensym_cons_1(Qmember,temp);
}
    ...
    Object thing, type;
{
	...
	if (temp) {
	  ...
	  next_loop:
		...
		Context_of_type_failure = gensym_cons_1(FIX(index_1),
    ...
    Object thing, type;
{
	...
	if (temp_1);
	    ...
	    actual_slot_type = gensym_list_2(Qnamed,type_1);
	    temp = type_specification_type_p__with_explanation(slot_value,
		    actual_slot_type);
	    reclaim_gensym_list_1(actual_slot_type);
	    temp_1 = TRUEP(temp);
	}
	else
	    temp_1 = 
	...
	if (temp_1);
	    ...
	    Context_of_type_failure = gensym_cons_1(slot_name,
		    Context_of_type_failure);
	    temp_1 = TRUEP(Nil);
	}
	if ( !temp_1) {
    ...
    Object type;
{
    ...
    x_note_fn_call(81,268);
    if (CONSP(type)) {
	temp = CAR(type);
	if (EQ(temp,Qsequence))
	    return gensym_cons_1(Qsequence,Nil);
	else if (EQ(temp,Qab_structure))
	    return gensym_cons_1(Qab_structure,Nil);
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    ab_loopvar__2 = gensym_cons_1(make_simplified_type(type1),Nil);
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
		ab_loopvar_ = ab_loopvar__2;
	  ...
	  end_1:;
	    ...
	    return copy_tree_using_gensym_conses_1(type);
    }
    else
		  ...
		  if (EQ(reason,Qsequence_too_short))
		    ...
		    end_1:;
		      tformat(3,string_constant_40,last_slot_checked,
			      allowed_slots);
		      reclaim_gensym_list_1(allowed_slots);
		  }
...
Object check_type_error_message varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Maximum_number_of_slots_in_structure_type,maximum_number_of_slots_in_structure_type,
	    0);
...
Object explanation_for_type_error_qm varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Structure_specs_allow_unknown_slots_p,structure_specs_allow_unknown_slots_p,
	    5);
      value_at_type_failure = Nil;
      PUSH_SPECIAL(Value_at_type_failure,value_at_type_failure,4);
	type_at_type_failure = Nil;
    ...
    Object ev, keys_to_omit;
{
    ...
    Object amf_available_array_cons_qm, amf_array, temp, svref_new_value;
    Object amf_result, incff_1_arg, new_float, new_long, temp_1, x2;
    SI_Long next_index, length_1, gensymed_symbol_1;
    SI_int64 aref_new_value_1;
    char temp_2;
    double aref_new_value;

    x_note_fn_call(81,275);
	...
	return VALUES_1(new_float);
	    ...
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(ev)) == (SI_Long)1L) {
	new_long = allocate_managed_long_box();
	temp_1 = aref1(ev,FIX((SI_Long)0L));
	aref_new_value_1 = INTEGER_TO_INT64(temp_1);
...
void types_INIT()
{
    Object temp, reclaim_structure_for_g2_list_element_1, new_cons;
    Object gensymed_symbol, temp_1, evaluation_unsigned_vector_16_eq_1;
    ...
    Object list_constant_36, Qstructure_slot_not_bound, Qreclaim_structure;
    ...
    Object Qcategory_evaluator_interface_count;
    Object Qchain_of_available_category_evaluator_interfaces;
    Object string_constant_59, Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_58, Qunique_structure_type_of_ab_name_qm;
    ...
    Object Qvirtual_attribute_structure_memory_usage, Qvirtual_attribute_count;
    Object Qchain_of_available_virtual_attributes, string_constant_57;
    Object string_constant_56, Qattribute_mimic;
    Object Qoutstanding_attribute_mimic_count;
    Object Qattribute_mimic_structure_memory_usage, Qattribute_mimic_count;
    Object Qchain_of_available_attribute_mimics, string_constant_55;
    Object Qg2_defstruct_structure_name_attribute_mimic_g2_struct;
    Object string_constant_54, Qattribute_mimics_of_class, string_constant_53;
    ...
    Object list_constant_17, list_constant_26, Qsingular_of_numeric_data_type;
    Object Qdo_not_carry_global_property_value_into_kbs_qm;
    Object Qcategory_is_not_g2_element_datum_type, list_constant_35;
    Object Qitem_or_value, Qvalue, Qquantity, list_constant_34;
    Object list_constant_18, Qtype_specification_for_no_item, list_constant_33;
    Object Qtype_specification_for_unknown;
    Object Qtype_specification_for_iteration_state, list_constant_32;
    Object Qtype_specification_for_item, list_constant_31;
    Object Qtype_symbols_subtype_alist, list_constant_30, list_constant_29;
    Object list_constant_20, list_constant_22, list_constant_28;
    Object list_constant_27, list_constant_21, list_constant_25;
    Object list_constant_24, list_constant_23, Qevaluation_obsolete_datum_eql;
    Object Qdeep_copy_evaluation_obsolete_datum;
    Object Qcopy_evaluation_obsolete_datum, Qreclaim_evaluation_obsolete_datum;
    Object list_constant_19, Qevaluation_structure_eql;
    ...
    Object list_constant_16, Qreclaim_uuid_block_hash_table, list_constant_15;
    Object Qtypes, Quuid_hash_block_table_for_merge_kb, Quuid_block_hash_table;
    Object Qmake_uuid_block_hash_function, Kfuncall;
    Object Qmutate_uuid_block_hash_tree_entry, Quuid_block;
    Object Qoutstanding_uuid_block_count, Quuid_block_structure_memory_usage;
    Object Quuid_block_count, Qchain_of_available_uuid_blocks;
    Object string_constant_52, string_constant_51, Qwrite_evaluation_member;
    Object Qevaluation_member_eql, Qcopy_evaluation_member;
    Object Qreclaim_evaluation_member, list_constant_14;
    ...
    Object Qreclaim_evaluation_unsigned_vector_16, list_constant_13;
    Object Qdefined_evaluation_type_validator, Qevaluation_types;
    Object Qnumeric_data_type, list_constant_12, Qg2_list_structure_marker;
    Object Qg2_list_element, Qoutstanding_g2_list_element_count;
    Object Qg2_list_element_structure_memory_usage, Qg2_list_element_count;
    Object Qchain_of_available_g2_list_elements, string_constant_50;
    Object Qg2_defstruct_structure_name_g2_list_element_g2_struct;
    Object string_constant_49;

    x_note_fn_call(81,277);
    SET_PACKAGE("AB");
    if (The_type_description_of_g2_list_element == UNBOUND)
	The_type_description_of_g2_list_element = Nil;
    string_constant_49 = 
	    STATIC_STRING("43Dy8m83hfy1m83hfy8k1l8k0000001m1m83*gy9k1n8y83-3qy1o83-2Ly83-2Ny83-2Jy83-2Kykok0k0");
    ...
    string_constant_50 = STATIC_STRING("1q83hfy8s83-Uwy09k9l");
    clear_optimized_constants();
    ...
    set_balanced_binary_tree_entry(temp,Qeq,Nil,T,gensymed_symbol,
    ...
    list_constant_13 = STATIC_CONS(Qunsigned_vector_16,Qnil);
    set_property_value_function(get_symbol_properties_function(Qunsigned_vector_16),
	    Qtype_specification_of_defined_evaluation_type,list_constant_13);
    ...
    Defined_evaluation_datum_types = temp_1;
    list_constant_14 = STATIC_CONS(Qmember,Qnil);
    set_property_value_function(get_symbol_properties_function(Qmember),
	    Qtype_specification_of_defined_evaluation_type,list_constant_14);
    ...
    string_constant_51 = 
	    STATIC_STRING("43Dy8m83oVy1n83oVy8n8k1l8n0000001m1n8y83-6Jy1m83-GAy83-G9y1m83My83-BIykok0k0");
    ...
    string_constant_52 = STATIC_STRING("1q83oVy8s83-uFy09k9l");
    clear_optimized_constants();
    ...
    record_direct_structure_method(Qreclaim_structure,Quuid_block,
	    reclaim_structure_for_uuid_block_1);
    Qmutate_uuid_block_hash_tree_entry = 
	    STATIC_SYMBOL("MUTATE-UUID-BLOCK-HASH-TREE-ENTRY",AB_package);
    SET_SYMBOL_FUNCTION(Qmutate_uuid_block_hash_tree_entry,
	    STATIC_FUNCTION(mutate_uuid_block_hash_tree_entry,NIL,FALSE,3,3));
    Fp_mutate_uuid_block_hash_tree_entry = 
	    SYMBOL_FUNCTION(Qmutate_uuid_block_hash_tree_entry);
    ...
    record_system_variable(Quuid_block_hash_table,Qtypes,list_constant_15,
    ...
    record_system_variable(Quuid_hash_block_table_for_merge_kb,Qtypes,
	    list_constant_15,Qnil,Qnil,Qreclaim_uuid_block_hash_table,Qt);
    ...
    Defined_evaluation_datum_types = temp_1;
    list_constant_16 = STATIC_CONS(Qitem_reference,Qnil);
    set_property_value_function(get_symbol_properties_function(Qitem_reference),
	    Qtype_specification_of_defined_evaluation_type,list_constant_16);
    ...
    list_constant_18 = STATIC_CONS(Qno_item,Qnil);
    ...
    list_constant_19 = STATIC_CONS(Qobsolete_datum,Qnil);
    set_property_value_function(get_symbol_properties_function(Qobsolete_datum),
	    Qtype_specification_of_defined_evaluation_type,list_constant_19);
    ...
    list_constant_20 = STATIC_CONS(Qsymbol,Qnil);
    list_constant_23 = STATIC_LIST_STAR((SI_Long)9L,Qdatum,Qnumber,
	    Qinteger,Qlong,Qfloat,Qtext,Qtruth_value,Qboolean,
	    list_constant_20);
    list_constant_21 = STATIC_CONS(Qlong,Qnil);
    list_constant_24 = STATIC_LIST_STAR((SI_Long)4L,Qnumber,Qinteger,
	    Qfloat,list_constant_21);
    list_constant_25 = STATIC_CONS(Qinteger,Qnil);
    list_constant_26 = STATIC_CONS(Qfloat,Qnil);
    list_constant_27 = STATIC_CONS(Qtext,Qnil);
    list_constant_22 = STATIC_CONS(Qboolean,Qnil);
    list_constant_28 = STATIC_CONS(Qtruth_value,list_constant_22);
    list_constant_29 = STATIC_CONS(Qitem_or_datum,list_constant_23);
    list_constant_30 = STATIC_CONS(Qevaluation_value,list_constant_23);
    list_constant_31 = STATIC_LIST((SI_Long)11L,list_constant_23,
	    list_constant_24,list_constant_25,list_constant_21,
	    list_constant_26,list_constant_27,list_constant_28,
	    list_constant_22,list_constant_20,list_constant_29,
	    list_constant_30);
    SET_SYMBOL_VALUE(Qtype_symbols_subtype_alist,list_constant_31);
    ...
    SET_SYMBOL_VALUE(Qtype_specification_for_item,list_constant_32);
    ...
    list_constant_33 = STATIC_CONS(Qunknown_datum,Qnil);
    SET_SYMBOL_VALUE(Qtype_specification_for_unknown,list_constant_33);
    ...
    SET_SYMBOL_VALUE(Qtype_specification_for_no_item,list_constant_18);
    ...
    list_constant_34 = STATIC_LIST_STAR((SI_Long)10L,Qnumber,Qinteger,
	    Qlong,Qfloat,Qsymbol,Qtruth_value,Qtext,Qdatum,Qitem_or_datum,
	    list_constant_4);
    if (Internal_g2_element_types_that_can_contain_datum == UNBOUND)
	Internal_g2_element_types_that_can_contain_datum = list_constant_34;
    ...
    list_constant_35 = STATIC_LIST_STAR((SI_Long)10L,Qquantity,Qinteger,
	    Qlong,Qfloat,Qsymbol,Qtruth_value,Qtext,Qvalue,Qitem_or_value,
	    list_constant_4);
    if (G2_element_types_that_can_contain_datum == UNBOUND)
	G2_element_types_that_can_contain_datum = list_constant_35;
    ...
    array_constant_17 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_18 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_19 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    list_constant_6 = STATIC_LIST_STAR((SI_Long)5L,Qnumber,Qpure_number,
	    Qinteger,Qlong,list_constant_26);
    Qwide_string = STATIC_SYMBOL("WIDE-STRING",AB_package);
    array_constant_20 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_21 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_22 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_23 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_24 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_25 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)40L));
    ...
    array_constant_26 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_27 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)80L));
    ...
    array_constant_28 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_29 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_30 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_31 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_32 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_33 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_34 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_35 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)24L));
    ...
    array_constant_36 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_37 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_38 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_39 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_40 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_41 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)8L));
    ...
    array_constant_42 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_43 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_44 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    array_constant_45 = STATIC_ARRAY(list_constant_17,(SI_Long)1L,
	    FIX((SI_Long)16L));
    ...
    Qsymbol_name_wide_string = STATIC_SYMBOL("SYMBOL-NAME-WIDE-STRING",
	    AB_package);
    string_constant_53 = STATIC_STRING("NO-COMPONENT-VALUE");
    No_component_value = make_symbol(string_constant_53);
    ...
    string_constant_54 = 
	    STATIC_STRING("43Dy8m83fGy1m83fGy8k1l8k0000001m1m83*gy9k1n8y83-2qy1p83q+y83q0y83q*y83q-y83q=ykpk0k0");
    ...
    string_constant_55 = STATIC_STRING("1q83fGy8s83-K5y09k9l");
    clear_optimized_constants();
    ...
    Qprint_virtual_attribute = STATIC_SYMBOL("PRINT-VIRTUAL-ATTRIBUTE",
	    AB_package);
    string_constant_56 = 
	    STATIC_STRING("43Dy8m83oZy1n83oZy8n8k1l8n0000001m1n8y83-6Ky1r83-Gdy83-GZy83-Gfy83-Gay83-Gcy83-Gby83-Gey1m83=0y9kksk0k0");
    ...
    Qvirtual_attribute_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_57 = STATIC_STRING("1q83oZy8s83-uty09k9l");
    clear_optimized_constants();
    ...
    string_constant_58 = 
	    STATIC_STRING("43Dy8m83fiy1n83fiy8n8k1l8n0000001l1n8y83-35y1l83rfykok0k0");
    ...
    Qcategory_evaluator_interface_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_59 = STATIC_STRING("1q83fiy8s83-Lcy09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_VALUE_LOCATION(Qstructure_slot_not_bound,
	    Structure_slot_not_bound);
    list_constant_36 = STATIC_CONS(Qstructure_slot_not_bound,Qnil);
    if (Structure_slot_not_bound == UNBOUND)
	Structure_slot_not_bound = list_constant_36;
