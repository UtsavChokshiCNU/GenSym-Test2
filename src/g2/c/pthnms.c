...
Object Local_file_system = UNBOUND;
...
Object Local_filename_parser = UNBOUND;
...
Object Local_namestring_generator = UNBOUND;
...
Object Convert_file_strings_to_uppercase_p = UNBOUND;

Object The_type_description_of_gensym_pathname = UNBOUND;

Object Chain_of_available_gensym_pathnames = UNBOUND;

Object Gensym_pathname_count = UNBOUND;
    ...
    Object gensym_pathname_1;
{
    ...
    svref_new_value = Chain_of_available_gensym_pathnames;
    SVREF(gensym_pathname_1,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gensym_pathnames = gensym_pathname_1;
    return VALUES_1(Nil);
}
...
Object make_permanent_gensym_pathname_structure_internal()
{
    ...
    gensym_pathname_count_new_value = FIXNUM_ADD1(Gensym_pathname_count);
    Gensym_pathname_count = gensym_pathname_count_new_value;
...
Object Gensym_default_pathname_defaults = UNBOUND;
    ...
    Object pathname_1;
{
	...
	next_loop:
	  ...
	  goto next_loop;
	end_loop:
	  reclaim_gensym_list_1(gensym_pathname_directory);
      }
    ...
    Object directory_string;
{
	...
	if (directory_pathname_qm) {
	  ...
	  next_loop:
	    ...
	    ab_loop_list_ = M_CDR(ab_loop_list_);
	    ab_loopvar__2 = 
		    gensym_cons_1(copy_pathname_contents(directory_component),
		    Nil);
	    if (ab_loopvar__1)
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = 
		gensym_cons_1(copy_pathname_contents(directory_component),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
Object All_gensym_pathnames_containing_open_streams = UNBOUND;
    ...
    Object directory_list;
{
  ...
  next_loop:
	...
	if (retain_relative_marker_p)
	    result_directory_list = gensym_cons_1(directory_component,
...
Object Inside_handling_gensym_file_errors_scope_p = UNBOUND;

Object Gensym_file_error_occurred_p = UNBOUND;
    ...
    Object file_error_string, arguments_list;
{
	...
	result = gensym_cons_1(file_error_string,arguments_list);
	...
	if (arguments_list) {
	  ...
	  next_loop:
	    ...
	    goto next_loop;
	  end_loop:
	    reclaim_gensym_list_1(arguments_list);
	}
	return abort_g2(0);
    }
}

Object Report_filename_parsing_errors_in_development_p = UNBOUND;
    ...
    Object convertible_thing;
{
    ...
    PUSH_SPECIAL(Report_filename_parsing_errors_in_development_p,report_filename_parsing_errors_in_development_p,
	    1);
	...
	PUSH_SPECIAL(Convert_file_strings_to_uppercase_p,convert_file_strings_to_uppercase_p,
	  ...
	  if (PUSH_UNWIND_PROTECT(0)) {
		  ...
		  next_loop:
		    ...
		    reclaimable_components = gensym_cons_1(temp_1,
		  ...
		  end_loop:
		    remaining_directory_qm = 
			    copy_list_using_gensym_conses_1(gensym_pathname_directory1);
		  ...
		  next_loop_1:
		    ...
		    goto next_loop_1;
		  end_loop_1:
		    reclaim_gensym_list_1(reclaimable_components);
		    reclaim_gensym_list_1(ISVREF(pathname_qm,(SI_Long)3L));
		  next_loop_2:
    ...
    Object convertible_thing;
{
    ...
    PUSH_SPECIAL(Convert_file_strings_to_uppercase_p,convert_file_strings_to_uppercase_p,
	  ...
	  if (ISVREF(pathname_qm,(SI_Long)4L) || ISVREF(pathname_qm,
		  ...
		  svref_new_value = gensym_cons_1(Kabsolute,Nil);
		  ...
		  if ( !TRUEP(memq_function(CAR(directory_subcomponents),
			  list_constant_2)))
		      directory_subcomponents = gensym_cons_1(Krelative,
    ...
    PUSH_SPECIAL(Convert_file_strings_to_uppercase_p,convert_file_strings_to_uppercase_p,
	  ...
	  if (valid_directory_p(pathname_qm)) {
	      ...
	      svref_new_value = nconc2(ISVREF(pathname_qm,(SI_Long)3L),
		      gensym_cons_1(final_directory_component,Nil));
	      SVREF(pathname_qm,FIX((SI_Long)3L)) = svref_new_value;
    ...
    Object convertible_thing;
{
	...
	if (temp) {
	    ...
	    result = signal_gensym_file_error(string_constant_5,
		    gensym_cons_1(convertible_thing,Nil));
	    RESTORE_STACK();
	    return result;
	}
    }
...
Object Merge_pathnames_rules = UNBOUND;

Object Merge_pathnames_rules_sorted_p = UNBOUND;
    ...
    Object old_contents, new_contents;
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(old_contents);
    }
    else if (text_string_p(old_contents))
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	ab_loopvar__2 = gensym_cons_1(text_string_p(new_component) ? 
    ...
    Object directory_containing_up, default_directory;
{
  ...
  next_loop:
    ...
    reclaim_text_string(gensym_pop_store);
    goto next_loop;
  end_loop:
...
Object Process_specific_system_pathname = UNBOUND;
...
Object Object_file_pathname_for_machine = UNBOUND;
    ...
    Object pathname_1, type;
{
    ...
    x_note_fn_call(40,92);
    directory_1 = ISVREF(pathname_1,(SI_Long)3L);
    obj_file_dir = EQ(Object_file_pathname_for_machine,
	    Kappend_to_directory) && CONSP(directory_1) ? 
	    nconc2(copy_list_using_gensym_conses_1(directory_1),
	    gensym_cons_1(G2_machine_type_string,Nil)) : directory_1;
    ...
    if (EQ(Object_file_pathname_for_machine,Kappend_to_directory) && 
	    CONSP(directory_1))
	reclaim_gensym_list_1(obj_file_dir);
...
void pathnames_INIT()
{
    ...
    Object list_constant_6, Qfile_systems_which_store_device_names, Qcoral;
    Object list_constant_5, Qfile_systems_which_distinguish_by_version;
    Object list_constant_4, Qpathnames, Qgensym_default_pathname_defaults;
    ...
    Object Qgensym_pathname_count, Qchain_of_available_gensym_pathnames;
    ...
    string_constant_9 = 
	    STATIC_STRING("43Dy8m9k1n9k8n8k1l8n0000001m1n8y83-40y1q83-+sy83-+qy83-+ry83-+ty83-+uy83-+vy1m83My83-AMykvk0k0");
    ...
    string_constant_10 = STATIC_STRING("1q9k8s83-Vpy09l9m");
    clear_optimized_constants();
    push_optimized_constant(Qgensym_pathname);
    ...
    SET_SYMBOL_VALUE_LOCATION(Qfile_systems_which_distinguish_by_version,
	    File_systems_which_distinguish_by_version);
    list_constant_5 = STATIC_CONS(Qvms,Qnil);
    ...
    list_constant_6 = STATIC_LIST((SI_Long)2L,Qvms,Qcoral);
    SET_SYMBOL_VALUE(Qfile_systems_which_store_device_names,list_constant_6);
