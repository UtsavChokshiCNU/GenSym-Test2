...
Object Attributes_collector = UNBOUND;

Object Attributes_collector_tail = UNBOUND;
    ...
    Object tree;
{
    ...
    if (SYMBOLP(tree)) {
	if (EQ(tree,Kkb))
	    return copy_list_using_gensym_conses_1(Top_level_kb_elements_for_saving);
...
Object Definitions_for_saving = UNBOUND;
    ...
    Object definition;
{
    ...
    temp = savable_definition_p(definition_for_class_of_definition) ? 
	    gensym_cons_1(definition_for_class_of_definition,Nil) : Qnil;
	...
	if (savable_definition_p(lookup_global_or_kb_specific_property_value(superior,
		Class_definition_gkbprop))) {
	    ab_loopvar__2 = 
		    gensym_cons_1(lookup_global_or_kb_specific_property_value(superior,
    ...
    Object definition;
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(journal_consed_dependent_definitions_qm);
...
Object traverse_definitions_of_kb_for_saving()
{
  ...
  next_loop_2:
    ...
    if (((SI_Long)0L != (IFIX(ISVREF(uomd,(SI_Long)4L)) & (SI_Long)1L) || 
		...
		value) {
	ab_loopvar__3 = gensym_cons_1(uomd,Nil);
	if (ab_loopvar__2)
  ...
  end_1:;
    ...
    next_loop_3:
	  ...
	  ab_loopvar__3 = gensym_cons_1(definition,Nil);
	  if (ab_loopvar__2)
	      M_CDR(ab_loopvar__2) = ab_loopvar__3;
	  else
	      ab_loopvar__1 = ab_loopvar__3;
  ...
  next_loop_4:
    ...
    goto next_loop_4;
  end_loop_4:
    return_value = copy_list_using_gensym_conses_1(Definitions_for_saving);
    reclaim_gensym_list_1(journal_consed_definition_list);
    reclaim_gensym_list_1(Definitions_for_saving);
  ...
  end_3:;
	...
	end_loop_6:
	  ...
	  ab_loopvar__4 = gensym_cons_1(definition,Nil);
	  if (ab_loopvar__3)
	      M_CDR(ab_loopvar__3) = ab_loopvar__4;
	  else
	      ab_loopvar__2 = ab_loopvar__4;
...
{
    x_note_fn_call(231,8);
    if (ISVREF(Current_saving_context,(SI_Long)3L))
	return gensym_cons_1(Qloose_end,gensym_cons_1(Qitem,Nil));
    else
	return VALUES_1(Nil);
}
    ...
    Object class_1;
{
    ...
    x_note_fn_call(231,9);
    temp = 
	    copy_list_using_gensym_conses_1(lookup_global_or_kb_specific_property_value(class_1,
  ...
  end_4:;
	...
	if (sub_class_vector_index < 
	    ...
	    kb_workspace_subclass_p = (SI_Long)0L < gensymed_symbol_2 ? T :
		     Nil;
	}
	else
  ...
  next_loop_8:
	...
	end_9:
	  ...
	  ab_loopvar__5 = gensym_cons_1(connection,Nil);
	  if (ab_loopvar__4)
	  ...
	  if (temp_3 ? TRUEP(has_slot_values_to_save_p(1,frame_or_class)) :
		   TRUEP(Nil)) {
	      ab_loopvar__5 = gensym_cons_1(frame_or_class,Nil);
	      if (ab_loopvar__4)
		  M_CDR(ab_loopvar__4) = ab_loopvar__5;
	      else
		  ab_loopvar__3 = ab_loopvar__5;
    ...
    Object tree;
{
	...
	if (sub_class_vector_index < 
	    ...
	    kb_workspace_qm = Nil;
	gensymed_symbol_3 = ISVREF(tree,(SI_Long)14L);
	...
	if (collectable_qm && kb_workspace_qm) {
	    ...
	    end_1:
		  ...
		  ab_loopvar__3 = gensym_cons_1(connection_frame_or_class,Nil);
		  if (ab_loopvar__2)
		      M_CDR(ab_loopvar__2) = ab_loopvar__3;
		  else
		      ab_loopvar__1 = ab_loopvar__3;
	...
	PUSH_SPECIAL(Attributes_collector_tail,attributes_collector_tail,1);
	  PUSH_SPECIAL(Attributes_collector,attributes_collector,0);
	...
	if (temp_2) {
	    ...
	    temp = subworkspace_qm && ((SI_Long)0L != 
		    ...
		    (SI_Long)262144L)) ? gensym_cons_1(subworkspace_qm,
		    Nil) : Nil;
	    ...
	    temp = nconc2(temp,other_inferior_qm ? 
		    gensym_cons_1(other_inferior_qm,Nil) : Nil);
	}
	else
	    temp = Nil;
    ...
    Object block;
{
	...
	if (has_slot_values_to_save_p(1,block)) {
	    new_cons = gensym_cons_1(block,Nil);
...
Object Remove_as_inferior_block_1 = UNBOUND;
...
Object Blocks_with_specialized_method_qm = UNBOUND;

Object Interesting_blocks_found_in_search = UNBOUND;
    ...
    Object add_instances_if_class_definition, include_connections_qm;
{
	...
	Interesting_blocks_found_in_search = gensym_cons_1(block,
  ...
  next_loop_6:
	...
	if ( !EQ(get_specific_method(method_name,class_description_qm,
		arg_count,Nil,Nil,Nil),reference_method))
	    Blocks_with_specialized_method_qm = gensym_cons_1(subblock,
		    Blocks_with_specialized_method_qm);
	else
  ...
  end_loop_6:;
	...
	if (workspace_class_description_qm &&  
		...
		reference_method))
	    Blocks_with_specialized_method_qm = gensym_cons_1(subworkspace,
		    Blocks_with_specialized_method_qm);
	else {
	...
	if (other_inferior_qm && class_description_qm) {
	    if ( !EQ(get_specific_method(method_name,class_description_qm,
		    arg_count,Nil,Nil,Nil),reference_method)) {
		Blocks_with_specialized_method_qm = 
			gensym_cons_1(other_inferior_qm,
			Blocks_with_specialized_method_qm);
...
{
    Object Qremove_as_inferior_block_1, AB_package;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package, Qslot_group_for_block_qm;
    Object Qmodule_system_table_belongs_to_qm;
