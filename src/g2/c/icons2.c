...
{
    Object new_cons, gensymed_symbol, gensymed_symbol_1, car_new_value;
    ...
    car_new_value = gensym_list_2(Qpolychrome,gensymed_symbol_1);
    ...
    Object bottom_edge_to_clip_in_workspace, put_rectangle_marker_instead_qm;
{
	...
	temp_2 = gensym_list_2(FIX((SI_Long)0L),FIX((SI_Long)0L));
	M_CAR(gensymed_symbol_3) = temp_2;
	gensymed_symbol_3 = M_CDR(gensymed_symbol_3);
	temp_2 = gensym_list_2(FIX((SI_Long)0L),FIX(desired_icon_height));
	M_CAR(gensymed_symbol_3) = temp_2;
	gensymed_symbol_3 = M_CDR(gensymed_symbol_3);
	temp_2 = gensym_list_2(FIX(desired_icon_width),
		FIX(desired_icon_height));
	M_CAR(gensymed_symbol_3) = temp_2;
	gensymed_symbol_3 = M_CDR(gensymed_symbol_3);
	temp_2 = gensym_list_2(FIX(desired_icon_width),FIX((SI_Long)0L));
	M_CAR(gensymed_symbol_3) = temp_2;
	temp_3 = gensym_cons_1(gensymed_symbol_2,Nil);
    }
    else
	temp_3 = gensym_cons_1(gensym_list_3(Qlines,
		gensym_list_2(FIX((SI_Long)0L),right_end_of_line_higher_qm 
		? FIX(desired_icon_height) : FIX((SI_Long)0L)),
		gensym_list_2(FIX(desired_icon_width),
    ...
    temp_3 = gensym_cons_1(line_marker,
	    copy_frame_serial_number(Current_frame_serial_number));
    temp_2 = gensym_cons_1(temp_3,ISVREF(view_pad,(SI_Long)12L));
    ...
    Object icon_editor, layer, layer_index_init, x_scale_init, y_scale_init;
{
    ...
    list_of_layers = gensym_cons_1(layer,Nil);
    ...
    reclaim_gensym_cons_1(list_of_layers);
    ...
    temp_1 = gensym_list_4(Qpolychrome,gensym_cons_1(Qborder,Qtransparent),
	    gensym_cons_1(Qtransparent,Qtransparent),
	    gensym_cons_1(Qoutline,Qblack));
    M_CAR(gensymed_symbol_6) = temp_1;
    gensymed_symbol_6 = M_CDR(gensymed_symbol_6);
    M_CAR(gensymed_symbol_6) = Qborder;
    gensymed_symbol_6 = M_CDR(gensymed_symbol_6);
    temp_1 = gensym_list_3(Qsolid_rectangle,gensym_list_2(FIX((SI_Long)0L),
	    FIX((SI_Long)0L)),gensym_list_2(scaled_width_of_layer_box,
	    FIX(scaled_height_of_layer_box)));
    M_CAR(gensymed_symbol_6) = temp_1;
    gensymed_symbol_6 = M_CDR(gensymed_symbol_6);
    M_CAR(gensymed_symbol_6) = Qtransparent;
    gensymed_symbol_6 = M_CDR(gensymed_symbol_6);
    temp_1 = gensym_list_3(Qsolid_rectangle,gensym_list_2(border_width,
	    border_width),
	    gensym_list_2(FIXNUM_MINUS(scaled_width_of_layer_box,
    ...
    gensymed_symbol_6 = M_CDR(gensymed_symbol_6);
    gensymed_symbol_7 = make_gensym_list_1(FIX((SI_Long)5L));
    gensymed_symbol_8 = gensymed_symbol_7;
    M_CAR(gensymed_symbol_8) = Qoutline;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(FIX((SI_Long)0L),FIX((SI_Long)0L));
    M_CAR(gensymed_symbol_8) = temp_1;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(FIX((SI_Long)0L),FIX(scaled_height_of_layer_box));
    M_CAR(gensymed_symbol_8) = temp_1;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(scaled_width_of_layer_box,
	    FIX(scaled_height_of_layer_box));
    M_CAR(gensymed_symbol_8) = temp_1;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(scaled_width_of_layer_box,FIX((SI_Long)0L));
    M_CAR(gensymed_symbol_8) = temp_1;
    ...
    M_CAR(gensymed_symbol_8) = Qoutline;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(FIX(icon_outline_left_edge_in_border_icon),
    ...
    M_CAR(gensymed_symbol_8) = temp_1;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(FIX(icon_outline_right_edge_in_border_icon),
	    FIX(icon_outline_bottom_edge_in_border_icon));
    M_CAR(gensymed_symbol_8) = temp_1;
    gensymed_symbol_8 = M_CDR(gensymed_symbol_8);
    temp_1 = gensym_list_2(FIX(icon_outline_right_edge_in_border_icon),
    ...
    Object x_in_workspace, y_in_workspace, layer_box, layers_pad;
{
    ...
    gensymed_symbol_1 = ISVREF(border_icon,(SI_Long)14L);
    gensymed_symbol_1 = gensymed_symbol_1 ? ISVREF(gensymed_symbol_1,
	    (SI_Long)5L) : Nil;
    ...
    Object icon_editor;
{
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:;
    return reclaim_gensym_list_1(reversed_layers);
}
    ...
    Object icon_editor, x_in_workspace, y_in_workspace;
{
  ...
  end_loop:
  end_1:;
    reclaim_gensym_list_1(reversed_layers);
...
Object create_icon_editor_tables()
{
  ...
  next_loop:
    ...
    table = create_icon_editor_table(FIRST(table_coordinate),
	    ...
	    copy_list_using_gensym_conses_1(names_of_slots),
	    use_small_fonts_qm);
    ...
    tables = gensym_cons_1(table,tables);
    goto next_loop;
  end_loop:;
    ...
    Object class_definition;
{
    ...
    bounding_box = make_bounding_box(FIX((SI_Long)110L),FIX((SI_Long)110L));
    ...
    y_origin_in_workspace = FIXNUM_ADD(y_in_workspace,
	    bounding_box_border_width);
    add_to_workspace(4,bounding_box,workspace,x_in_workspace,y_in_workspace);
    ...
    bounding_box = make_bounding_box(FIX((SI_Long)160L),FIX((SI_Long)160L));
    ...
    gensymed_symbol_3 = (SI_Long)1L;
    inner_width = gensymed_symbol_1 - gensymed_symbol_2 - gensymed_symbol_3;
    gensymed_symbol = ISVREF(bounding_box,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)3L) : FIX((SI_Long)0L);
    gensymed_symbol_1 = IFIX(gensymed_symbol);
  ...
  next_loop:
    ...
    buttons = gensym_cons_1(button,buttons);
    goto next_loop;
  end_loop:;
  ...
  next_loop_1:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    add_to_workspace(4,ISVREF(button,(SI_Long)5L),workspace,ISVREF(button,
	    (SI_Long)1L),ISVREF(button,(SI_Long)2L));
    goto next_loop_1;
  end_loop_1:;
  ...
  next_loop_2:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    add_to_workspace(4,ISVREF(table,(SI_Long)6L),workspace,ISVREF(table,
	    (SI_Long)1L),ISVREF(table,(SI_Long)2L));
    goto next_loop_2;
  end_loop_2:;
    ...
    Object new_layer, specific_layer_index, icon_editor_engine;
{
	...
	SVREF(icon_editor_engine,FIX((SI_Long)5L)) = svref_new_value;
	    ...
	    (SI_Long)5L))) {
	new_tail = gensym_cons_1(new_layer,Nil);
	...
	cons_to_splice_in = gensym_cons_1(new_layer,
    ...
    Object specific_layer_index, icon_editor_engine;
{
	...
	if (IFIX(specific_layer_index) <= (SI_Long)0L) {
	    ...
	    reclaim_gensym_cons_1(old_layers);
	    ...
	    reclaim_gensym_cons_1(cons_to_splice_out);
	    temp_1 = FIXNUM_SUB1(ISVREF(icon_editor_engine,(SI_Long)5L));
	    SVREF(icon_editor_engine,FIX((SI_Long)5L)) = temp_1;
	}
    ...
    Object put_before_this_layer_index, icon_editor_engine;
{
    ...
    x_note_fn_call(234,37);
    new_layer = gensym_list_4(color_label,Nil,
    ...
    Object icon_editor, visual_event_init, arg_1_qm, arg_2_qm;
{
	...
	if ( !((SI_Long)-128L <= temp_1 && temp_1 <= (SI_Long)127L))
		...
		cross_marker = 
			...
			gensym_cons_1(gensym_list_2(Qpoint,
			gensym_list_2(FIX(marker_relative_center),
			FIX(marker_relative_center))),Nil) : 
			gensym_list_2(gensym_list_3(Qlines,
			gensym_list_2(FIX((SI_Long)0L),
			FIX(marker_relative_center)),
			gensym_list_2(FIX(marker_extent),
			FIX(marker_relative_center))),gensym_list_3(Qlines,
			gensym_list_2(FIX(marker_relative_center),
			FIX((SI_Long)0L)),
			gensym_list_2(FIX(marker_relative_center),
			FIX(marker_extent))))),FIX(marker_extent),
			FIX(marker_extent));
		temp_2 = gensym_cons_1(cross_marker,
			copy_frame_serial_number(Current_frame_serial_number));
		svref_new_value = gensym_cons_1(temp_2,ISVREF(view_pad,
			(SI_Long)12L));
		...
		put_line_marker_in_view_pad(temp_2,temp_3,temp_4,temp_5,
			...
			+ gensymed_symbol_2),visual_event == (SI_Long)16L ?
			 T : Nil);
		reclaim_gensym_cons_1(arg_1_qm);
		return reclaim_gensym_cons_1(arg_2_qm);
	      case 17:
		view_pad = ISVREF(icon_editor,(SI_Long)12L);
		engine = ISVREF(icon_editor,(SI_Long)11L);
		x_origin_in_workspace = ISVREF(view_pad,(SI_Long)5L);
		...
		circle_marker = 
			...
			Qiconic_entity,
			wrap_polychrome_declaration_around_slot_value_conses(color,
			gensym_cons_1(desired_icon_width == (SI_Long)0L && 
			desired_icon_height == (SI_Long)0L ? 
			gensym_list_2(Qpoint,
			gensym_list_2(FIX((SI_Long)0L),FIX((SI_Long)0L))) :
			 gensym_list_4(Qcircle,gensym_list_2(FIX(x1),
			FIX(y1_1)),gensym_list_2(FIX(x2),FIX(y2)),
			gensym_list_2(FIX(x3),FIX(y3))),Nil)),
			FIX(icon_width),FIX(icon_height));
		temp_2 = gensym_cons_1(circle_marker,
			copy_frame_serial_number(Current_frame_serial_number));
		svref_new_value = gensym_cons_1(temp_2,ISVREF(view_pad,
			(SI_Long)12L));
		SVREF(view_pad,FIX((SI_Long)12L)) = svref_new_value;
		...
		if (min_x_in_view_pad_qm) {
		    ...
		    temp_3 = 
			    wrap_polychrome_declaration_around_slot_value_conses(color,
			    gensym_cons_1(gensym_list_4(Qlines,
			    gensym_list_2(FIX(x0_in_icon),FIX(y0_in_icon)),
			    gensym_list_2(Qarc,
			    gensym_list_2(FIX(x1_in_icon),
			    FIX(y1_in_icon))),
			    gensym_list_2(FIX(x2_in_icon),
			    FIX(y2_in_icon))),Nil));
		    ...
		    temp_2 = gensym_cons_1(arc_marker,
			    copy_frame_serial_number(Current_frame_serial_number));
		    svref_new_value = gensym_cons_1(temp_2,ISVREF(view_pad,
			    (SI_Long)12L));
		    SVREF(view_pad,FIX((SI_Long)12L)) = svref_new_value;
		...
		if (marker_stack_qm) {
		    ...
		    SVREF(view_pad,FIX((SI_Long)12L)) = svref_new_value;
		    return reclaim_gensym_cons_1(marker_stack_qm);
		}
		else
		    return VALUES_1(Nil);
	      case 20:
		...
		if (CONSP(arg_1_qm))
		    new_value = memq_function(slot_name,list_constant) ? 
			    ...
			    Nil,Nil,Nil) : 
			    copy_tree_using_gensym_conses_1(arg_1_qm);
		...
		svref_new_value = 
			...
			gensym_list_2(copy_for_slot_value(background_layer),
			gensym_list_3(Qeditor_scaling,x_scale,y_scale)) : 
			copy_for_slot_value(background_layer));
...
void icons2_INIT()
{
    ...
    check_if_superior_classes_are_defined(Qbig_icon_editor_text_button,
	    list_constant_3);
    string_constant_25 = STATIC_STRING("1m8q1m83qay1l83*Ty");
    temp = regenerate_optimized_constant(string_constant_22);
    temp_1 = regenerate_optimized_constant(string_constant_22);
    ...
    string_constant_26 = 
	    STATIC_STRING("1l4z8r8u8u83aXy83aXy01o8w9k3uy3Qy001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class definition00000");
    string_constant_27 = STATIC_STRING("1n8q1m83aXy1l83*Ty1m8u1o8w9k3uy3Qy");
    temp = regenerate_optimized_constant(string_constant_22);
    ...
    string_constant_28 = 
	    STATIC_STRING("1l4z8r8u8u83Xwy83Xwy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1r83Jy1m3Pyy1m3Py3Cy1m3Ry3Cy1m3Ryy1m3Qyy1m3Qyz001o1l8l1l8o1l8z1m83Dy53YySee");
    string_constant_29 = 
	    STATIC_STRING(" comment on ENTITY class definition00000");
    string_constant_30 = 
	    STATIC_STRING("1n8q1m83Xwy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1r83Jy1m3Pyy1m3Py3Cy1m3Ry3Cy1m3Ryy1m3Qyy1m3Qyz");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    string_constant_31 = 
	    STATIC_STRING("1l4z8r8u8u83Txy83Txy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1n83Oy1muu1m3ky3Gy001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class def");
    string_constant_32 = STATIC_STRING("inition00000");
    string_constant_33 = 
	    STATIC_STRING("1n8q1m83Txy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1n83Oy1muu1m3ky3Gy");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    string_constant_34 = 
	    STATIC_STRING("1l4z8r8u8u83U1y83U1y01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1p83Oy1muu1m3Qy3Ly1m3Lyw1m3kyr001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTI");
    string_constant_35 = STATIC_STRING("TY class definition00000");
    string_constant_36 = 
	    STATIC_STRING("1n8q1m83U1y1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1p83Oy1muu1m3Qy3Ly1m3Lyw1m3kyr");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    string_constant_37 = 
	    STATIC_STRING("1l4z8r8u8u83Gey83Gey01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83Oy1m3Ly3Iy1m83*Hy1m3Yyu1m3Syp001o1l8l1l8o1l8z1m83Dy53YySee comment on E");
    string_constant_38 = STATIC_STRING("NTITY class definition00000");
    string_constant_39 = 
	    STATIC_STRING("1n8q1m83Gey1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83Oy1m3Ly3Iy1m83*Hy1m3Yyu1m3Syp");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qoutlined_rectangle_button,
	    list_constant_3);
    string_constant_40 = 
	    STATIC_STRING("1l4z8r8u8u83XRy83XRy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1p83Jy1mzp1m3fyp1m3fy3Ly1mz3Ly001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTI");
    string_constant_41 = 
	    STATIC_STRING("1n8q1m83XRy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1p83Jy1mzp1m3fyp1m3fy3Ly1mz3Ly");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qoutlined_polygon_button,
	    list_constant_3);
    string_constant_42 = 
	    STATIC_STRING("1l4z8r8u8u83XQy83XQy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1s83Jy1muz1m3Dyp1m3byp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly001o1l8l1l8o1l8z1m83D");
    string_constant_43 = 
	    STATIC_STRING("y53YySee comment on ENTITY class definition00000");
    string_constant_44 = 
	    STATIC_STRING("1n8q1m83XQy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1s83Jy1muz1m3Dyp1m3byp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qoutlined_circle_button,
	    list_constant_3);
    string_constant_45 = 
	    STATIC_STRING("1l4z8r8u8u83XMy83XMy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83*fy1m3Eyz1m3Qyn1m3cyz001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY cl");
    string_constant_46 = STATIC_STRING("ass definition00000");
    string_constant_47 = 
	    STATIC_STRING("1n8q1m83XMy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83*fy1m3Eyz1m3Qyn1m3cyz");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qfilled_rectangle_button,
	    list_constant_3);
    string_constant_48 = 
	    STATIC_STRING("1l4z8r8u8u83LYy83LYy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1n83jy1mzp1m3fy3Ly001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY class def");
    string_constant_49 = 
	    STATIC_STRING("1n8q1m83LYy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1n83jy1mzp1m3fy3Ly");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qfilled_circle_button,
	    list_constant_3);
    string_constant_50 = 
	    STATIC_STRING("1l4z8r8u8u83LWy83LWy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83=Ry1m3Eyz1m3Qyn1m3cyz001o1l8l1l8o1l8z1m83Dy53YySee comment on ENTITY cl");
    string_constant_51 = 
	    STATIC_STRING("1n8q1m83LWy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1o83=Ry1m3Eyz1m3Qyn1m3cyz");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qfilled_polygon_button,
	    list_constant_3);
    string_constant_52 = 
	    STATIC_STRING("1l4z8r8u8u83LXy83LXy01q8w9k3uy3Qy1l2l83-by83Ty1m83-by1r83qy1r1muz1m3Dyp1m3ayp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly1n1muz1m3Dyp1m3ayp1");
    string_constant_53 = 
    ...
    string_constant_55 = 
	    STATIC_STRING("1n8q1m83LXy1l83*Ty1m8u1q8w9k3uy3Qy1l2l83-by83Ty1m83-by1r83qy1r1muz1m3Dyp1m3ayp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly1n1muz1m3Dyp1m3ayp");
    string_constant_56 = 
    ...
    check_if_superior_classes_are_defined(Qoutlined_filled_rectangle_button,
	    list_constant_3);
    string_constant_57 = 
	    STATIC_STRING("1l4z8r8u8u83XPy83XPy01q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1p83Jy1mzp1m3fyp1m3fy3Ly1mz3Ly83-by1n83jy1m3Dyr1m3dy3Jy001o1l8l1");
    string_constant_58 = 
	    STATIC_STRING("l8o1l8z1m83Dy53YySee comment on ENTITY class definition00000");
    string_constant_59 = 
	    STATIC_STRING("1n8q1m83XPy1l83*Ty1m8u1q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1p83Jy1mzp1m3fyp1m3fy3Ly1mz3Ly83-by1n83jy1m3Dyr1m3dy3Jy");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
    ...
    check_if_superior_classes_are_defined(Qoutlined_filled_polygon_button,
	    list_constant_3);
    string_constant_60 = 
	    STATIC_STRING("1l4z8r8u8u83XOy83XOy01q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1s83Jy1muz1m3Dyp1m3byp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly83-by1r83q");
    string_constant_61 = 
    ...
    string_constant_63 = 
	    STATIC_STRING("1n8q1m83XOy1l83*Ty1m8u1q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1s83Jy1muz1m3Dyp1m3byp1m3Qy3Dy1m3ky3Dy1m3fy3Ly1m3Gy3Ly83-by1r83");
    string_constant_64 = 
    ...
    check_if_superior_classes_are_defined(Qoutlined_filled_circle_button,
	    list_constant_3);
    string_constant_66 = 
	    STATIC_STRING("1l4z8r8u8u83XNy83XNy01q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1o83*fy1m3Eyz1m3Qyn1m3cyz83-by1o83=Ry1m3Gyz1m3Qyp1m3ayz001o1l8l1");
    string_constant_67 = 
	    STATIC_STRING("1n8q1m83XNy1l83*Ty1m8u1q8w9k3uy3Qy1m2l832Dy83Ty2l83-by83Ty1o832Dy1o83*fy1m3Eyz1m3Qyn1m3cyz83-by1o83=Ry1m3Gyz1m3Qyp1m3ayz");
    temp = regenerate_optimized_constant(string_constant_22);
    clear_optimized_constants();
    push_optimized_constant(Qcreate_action_button_description);
