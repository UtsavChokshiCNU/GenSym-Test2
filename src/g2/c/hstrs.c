...
Object Chain_of_available_history_ring_buffers = UNBOUND;

Object History_ring_buffer_count = UNBOUND;
    ...
    Object history_ring_buffer;
{
    ...
    svref_new_value = Chain_of_available_history_ring_buffers;
    SVREF(history_ring_buffer,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_history_ring_buffers = history_ring_buffer;
    return VALUES_1(Nil);
}
...
Object make_permanent_history_ring_buffer_structure_internal()
{
    ...
    Object history_ring_buffer_count_new_value;
    ...
    history_ring_buffer_count_new_value = 
	    FIXNUM_ADD1(History_ring_buffer_count);
    History_ring_buffer_count = history_ring_buffer_count_new_value;
...
Object Chain_of_available_cascaded_ring_buffers = UNBOUND;

Object Cascaded_ring_buffer_count = UNBOUND;
    ...
    Object cascaded_ring_buffer;
{
    ...
    svref_new_value = Chain_of_available_cascaded_ring_buffers;
    SVREF(cascaded_ring_buffer,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_cascaded_ring_buffers = cascaded_ring_buffer;
    return VALUES_1(Nil);
}
...
Object make_permanent_cascaded_ring_buffer_structure_internal()
{
    ...
    Object cascaded_ring_buffer_count_new_value;
    ...
    cascaded_ring_buffer_count_new_value = 
	    FIXNUM_ADD1(Cascaded_ring_buffer_count);
    Cascaded_ring_buffer_count = cascaded_ring_buffer_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object cascaded_ring_buffer;
{
    ...
    svref_new_value = 
	    copy_tree_using_gensym_conses_1(ISVREF(cascaded_ring_buffer,
	    (SI_Long)1L));
    ...
    Object cascaded_ring_buffer;
{
    ...
    return gensym_cons_1(newest_ring_buffer,ISVREF(newest_ring_buffer,
	    (SI_Long)1L));
}
    ...
    Object cascaded_ring_buffer;
{
    ...
    return gensym_cons_1(oldest_ring_buffer,ISVREF(oldest_ring_buffer,
	    (SI_Long)2L));
}
...
Object get_history_g2_time varargs_1(int, n)
{
	...
	if (Nil) {
		...
		history_time = gensym_cons_1(value,Qtruth_value);
	}
	else
    ...
    Object cascaded_ring_buffer, element_index, simulated_value_qm;
{
    ...
    Object amf_result, incff_1_arg, new_float, temp_1, ring_buffer;
    Object base_time_qm, vector_1, value, history_time, new_float_1;
    double aref_new_value, history_time_float, gensymed_symbol;
    double gensymed_symbol_1;
    ...
    new_float = amf_result;
    temp_1 = ISVREF(cascaded_ring_buffer,(SI_Long)4L);
    ring_buffer = CAR(temp_1);
    base_time_qm = ISVREF(cascaded_ring_buffer,(SI_Long)10L);
    vector_1 = ISVREF(ring_buffer,(SI_Long)7L);
    if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
	    Managed_array_unique_marker)) {
    ...
    Object cascaded_ring_buffer, element_index, simulated_history_qm;
{
    ...
    new_float = amf_result;
    if ( !TRUEP(simulated_history_qm)) {
	temp_1 = get_history_g2_time(2,cascaded_ring_buffer,element_index);
	temp_2 = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	aref_new_value = temp_2 - DFLOAT_ISAREF_1(G2_time_at_start,
		(SI_Long)0L);
    }
    else {
	temp_1 = get_history_g2_time(3,cascaded_ring_buffer,element_index,
		simulated_history_qm);
    ...
    Object thing, cascaded_ring_buffer;
{
    ...
    gensym_modify_macro_using_test_arg_1 = thing;
    ...
    Object thing, cascaded_ring_buffer;
{
    ...
    svref_new_value = delete_gensym_element_1(thing,
    ...
    Object cascaded_ring_buffer;
{
    ...
    if (clients_qm) {
	reclaim_gensym_list_1(clients_qm);
    ...
    Object cascaded_history_ring_buffer;
{
    ...
    reclaim_gensym_tree_1(ISVREF(cascaded_history_ring_buffer,(SI_Long)3L));
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(ISVREF(cascaded_history_ring_buffer,(SI_Long)4L));
    ...
    Object time_1, storing_simulated_value_qm;
{
    ...
    Object amf_result, incff_1_arg, new_float, time_adjusted_for_history;
    Object ab_loop_list_;
    SI_Long temp_3, integer_granularity;
    char temp, overwrite_value_if_duplicate_time_qm;
    double base_time_value, time_value, time_offset, arg, arg_1, temp_4;
    double temp_5, floored_time_float, subsecond_time, float_granularity;
	...
	if ( !TRUEP(history_granularity_qm) || 
	    ...
	    temp_3 = IFIX(history_granularity_qm) / (SI_Long)1000L;
	    integer_granularity = temp_3;
	    temp_4 = (double)integer_granularity;
	    temp_5 = DOUBLE_FLOAT_TO_DOUBLE(History_timestamp_epsilon);
	    time_adjusted_for_history = DOUBLE_TO_DOUBLE_FLOAT(temp_4 * 
		    inline_ffloor_1((time_offset + temp_5) / 
    ...
    Object history_granularity_qm;
{
    ...
    SI_Long temp_1, integer_granularity;
    double aref_new_value, temp_2, temp_3, floored_current_time;
	...
	temp_1 = IFIX(history_granularity_qm) / (SI_Long)1000L;
	integer_granularity = temp_1;
	amf_available_array_cons_qm = 
		ISVREF(Vector_of_simple_float_array_pools,(SI_Long)1L);
	if (amf_available_array_cons_qm) {
	    amf_array = M_CAR(amf_available_array_cons_qm);
	...
	new_float = amf_result;
	temp_2 = (double)integer_granularity;
	temp_3 = DOUBLE_FLOAT_TO_DOUBLE(History_timestamp_epsilon);
	aref_new_value = temp_2 * 
		inline_ffloor_1((DFLOAT_ISAREF_1(Current_g2_time,
		(SI_Long)0L) + temp_3) / (double)integer_granularity);
	DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
	return VALUES_1(new_float);
    }
    else {
	...
	if (arg < arg_1 &&  !inline_nanp_for_comparison(arg) &&  
	    ...
	    aref_new_value = floored_current_time + float_granularity * 
		    inline_ffloor_1((subsecond_of_current_time + temp_3) / 
		    float_granularity);
	    DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
	    return VALUES_1(new_float);
	}
    ...
    Object millisecond_interval_between_data_points_qm;
{
	...
	reclaim_gensym_tree_1(ISVREF(new_cascaded_ring_buffer,(SI_Long)3L));
	SVREF(new_cascaded_ring_buffer,FIX((SI_Long)3L)) = Nil;
    }
    svref_new_value = 
	    gensym_cons_1(gensym_list_3(maximum_number_of_data_points_qm,
	    maximum_age_of_data_points_qm,
	...
	if (existing_ring_buffer_qm) {
		...
		reclaim_gensym_list_1(ISVREF(new_cascaded_ring_buffer,
			(SI_Long)4L));
	...
	if ( !TRUEP(ISVREF(new_cascaded_ring_buffer,(SI_Long)4L))) {
	    ...
	    svref_new_value = gensym_cons_1(ring_buffer_shell,Nil);
...
Object store_history_element_in_cascaded_ring_buffer varargs_1(int, n)
{
    ...
    Object element_index, amf_available_array_cons_qm, amf_array;
    Object svref_new_value, amf_result, incff_1_arg, new_float;
    Object gensymed_symbol, ab_loop_list_, index_2;
    SI_Long temp_3;
    char temp_2;
	...
	temp_1 = nconc2(ISVREF(cascaded_ring_buffer,(SI_Long)4L),
		gensym_cons_1(new_ring_buffer,Nil));
	...
	if (overwrite_value_if_duplicate_time_qm) {
		...
		if ( !TRUEP(ISVREF(ring_buffer,(SI_Long)3L))) {
		  ...
		  next_loop:
			...
			if (amf_available_array_cons_qm) {
			    ...
			    SVREF(temp_4,FIX((SI_Long)1L)) = svref_new_value;
			    inline_note_reclaim_cons(amf_available_array_cons_qm,
				    Qab_gensym);
			    temp_4 = Available_gensym_conses;
			    M_CDR(amf_available_array_cons_qm) = temp_4;
			    ...
			    Created_simple_float_array_pool_arrays = temp_4;
			    incff_1_arg = 
				    bytes_per_double_float_simple_array(FIX((SI_Long)1L));
			    temp_4 = 
				    FIXNUM_ADD(Simple_float_array_pool_memory_usage,
				    incff_1_arg);
			    Simple_float_array_pool_memory_usage = temp_4;
			    amf_result = 
		...
		if (FIXNUM_LE(ISVREF(temp_1,(SI_Long)1L),
		    ...
		    temp_4 = FIXNUM_ADD(newest_active_element_index,
			    Managed_array_index_offset);
		    SVREF(temp_1,temp_4) = svref_new_value;
		}
		else {
    ...
    Object cascaded_ring_buffer, value, time_1;
{
    ...
    Object element_index, amf_available_array_cons_qm, amf_array;
    Object svref_new_value, amf_result, incff_1_arg, new_float, ring_buffer;
    Object index_2, oldest_active_element_index_for_ring_buffer;
    SI_Long temp_3;
    double aref_new_value;
	...
	if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
	    ...
	    if (FIXNUM_LE(ISVREF(temp_1,(SI_Long)1L),
		    Maximum_in_place_array_size)) {
		temp_2 = FIXNUM_ADD(index_1,Managed_array_index_offset);
		return VALUES_1(SVREF(temp_1,temp_2) = svref_new_value);
	    }
	    else {
		temp_1 = ISVREF(temp_1,(IFIX(index_1) >>  -  - 
			(SI_Long)10L) + (SI_Long)2L);
		temp_3 = IFIX(index_1) & (SI_Long)1023L;
		return VALUES_1(ISVREF(temp_1,temp_3) = svref_new_value);
	    }
	}
    }
}
...
Object Data_point_value = UNBOUND;
...
Object store_old_data_in_history_ring_buffer varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Data_point_value,data_point_value,0);
      overwrite_value_if_duplicate_time_qm = 
	  ...
	  if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
		...
		end_loop:;
		  ...
		  temp = ISVREF(temp,(IFIX(ring_buffer_index) >>  -  - 
			  (SI_Long)10L) + (SI_Long)2L);
		  temp_2 = IFIX(ring_buffer_index) & (SI_Long)1023L;
		  ISVREF(temp,temp_2) = svref_new_value;
	      }
	  }
	  vector_1 = ISVREF(ring_buffer,(SI_Long)7L);
	  if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
    ...
    end_loop:
	  ...
	  if (FIXNUM_LE(ISVREF(temp_1,(SI_Long)1L),
	      ...
	      temp_1 = ISVREF(temp_1,(IFIX(index_to_copy_from) >>  -  - 
		      (SI_Long)10L) + (SI_Long)2L);
	      temp = IFIX(index_to_copy_from) & (SI_Long)1023L;
	      ISVREF(temp_1,temp) = svref_new_value;
	  }
      }
      vector_1 = ISVREF(ring_buffer,(SI_Long)7L);
      if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
	  ...
	  if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
		...
		end_loop:;
		  ...
		  temp_2 = ISVREF(temp_2,(IFIX(index_to_copy_to) >>  -  - 
			  (SI_Long)10L) + (SI_Long)2L);
		  temp_4 = IFIX(index_to_copy_to) & (SI_Long)1023L;
		  ISVREF(temp_2,temp_4) = svref_new_value;
	      }
	  }
	  vector_1 = ISVREF(ring_buffer,(SI_Long)7L);
	  if (SIMPLE_VECTOR_P(vector_1) && EQ(ISVREF(vector_1,(SI_Long)0L),
...
Object Previous_cascaded_ring_buffer_accessed = UNBOUND;

Object Previous_index_for_ring_buffer = UNBOUND;
    ...
    Object buffer, delta;
{
    ...
    Object amf_array, svref_new_value, amf_result, incff_1_arg, new_float;
    SI_Long temp_4, temp_6;
    char temp_5;
    double aref_new_value;
    XDeclare_area(1);
    XDeclare_frontier(1);
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	  next_loop_1:
	    ...
	    temp_5 = FIXNUM_EQ(element_index,newest_active_element_index);
	    if (temp_5);
	    else {
		temp_6 = IFIX(points_read) % (SI_Long)500L;
		temp_5 = temp_6 == (SI_Long)0L;
	    }
	    if (temp_5)
		goto end_loop_1;
	    goto next_loop_1;
...
Object Time_used_to_adjust_histories_qm = UNBOUND;
...
Object read_history_buffer_from_kb()
{
    ...
    reclaim_gensym_list_1(history_buffer_information);
    ...
    svref_new_value = gensym_cons_1(shell,Nil);
    ...
    Object slot_component_indicator_qm;
{
	...
	return gensym_list_3(Qslot,slot_name,defining_class_qm);
}
...
Object save_history_buffer_for_kb varargs_1(int, n)
{
    ...
    reclaim_gensym_list_1(location_information);
    ...
    Object block;
{
    ...
    Object incff_1_arg, new_float, history_buffer;
    Object history_location_information, frame, sub_vector_qm, function_qm;
	...
	if (! !(FIXNUM_LE(FIX((SI_Long)-128L),temp) && FIXNUM_LE(temp,
		...
		if (function_qm)
		    inline_funcall_3(function_qm,frame,history_buffer,
			    history_location_information);
		reclaim_gensym_list_1(history_location_information);
		break;
	      case 82:
		...
		break;
	      case 65:
		if (Noting_changes_to_kb_p)
		    note_change_to_block_1(block,Qmanaged_g2_array);
		SVREF(block,FIX((SI_Long)23L)) = first_1;
		break;
	      case 76:
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(squirreled_data);
...
void histories_INIT()
{
    ...
    Object Qgeneric_method_lambda_list, list_constant;
    Object Qhistory_location_information, Qhistory_buffer, Qhistories;
    Object Qtime_used_to_adjust_histories_qm, Qg2_initialize_parameter_aux;
    ...
    Object Qcascaded_ring_buffer_count;
    Object Qchain_of_available_cascaded_ring_buffers, string_constant_18;
    ...
    Object Qhistory_ring_buffer_structure_memory_usage;
    Object Qhistory_ring_buffer_count;
    Object Qchain_of_available_history_ring_buffers, string_constant_16;
    Object string_constant_15;
    ...
    string_constant_15 = 
	    STATIC_STRING("43Dy8m83iZy1o83iZy834Yy8n8k1l834Yy0000001m1m8x834Yy1m8y83-4Fyksk0k0");
    ...
    Qhistory_ring_buffer_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_16 = STATIC_STRING("1q83iZy8s83-XSy09k9l");
    ...
    string_constant_17 = 
	    STATIC_STRING("43Dy8m83fhy1n83fhy8n8k1l8n0000001m1m8y83-34y1m83=0y83-9Dykwk0k0");
    ...
    Qcascaded_ring_buffer_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_18 = STATIC_STRING("1q83fhy8s83-LUy09k9l");
    clear_optimized_constants();
    ...
    list_constant = STATIC_LIST((SI_Long)3L,Qblock,Qhistory_buffer,
	    Qhistory_location_information);
    Qgeneric_method_lambda_list = 
	    STATIC_SYMBOL("GENERIC-METHOD-LAMBDA-LIST",AB_package);
    mutate_global_property(Qrestore_history_buffer,list_constant,
	    Qgeneric_method_lambda_list);
