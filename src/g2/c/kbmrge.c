...
Object Class_name_conflicts = UNBOUND;

Object Deferred_class_definitions_alist = UNBOUND;

Object Record_class_name_conflicts_qm = UNBOUND;
    ...
    Object class_definition_1, class_definition_2;
{
    ...
    Object class_2, instance_qm, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp_1, temp_2, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
    Object junction_block_class_2, junction_block_class_1, change_command;
    Object junction_block_definition_2, x2, sub_class_bit_vector;
    Object inferior_class, ab_loop_list_, inferior_class_definition;
    Object inferior_class_definition_class, direct_superiors_of_defined_class;
    ...
    end_loop:;
	  ...
	  gensymed_symbol_1 = class_2;
	  gensymed_symbol_2 = SXHASH_SYMBOL_1(class_2) & 
	...
	end_12:;
	  ...
	  junction_block_class_1 = 
		  ISVREF(get_slot_description_of_class_description_function(Qjunction_block_class_for_class,
		  gensymed_symbol,Nil),(SI_Long)6L);
	  change_command = gensym_list_2(Qmerge_definitions,
		  junction_block_class_1);
	  ...
	  if (gensymed_symbol) {
		  ...
		  temp_3 = (SI_Long)0L < gensymed_symbol_2;
	      }
	      else
		  temp_3 = TRUEP(Nil);
	  }
    ...
    Object frame, new_class;
{
    ...
    Object next_qm, previous_qm, last_instance_qm;
  ...
  end_loop:;
	...
	if (next_qm) {
	    ...
	    mutate_kb_specific_property_value(old_class,next_qm,
		    Instances_specific_to_this_class_kbprop);
	    ISVREF(next_qm,(SI_Long)7L) = Nil;
	}
	else {
	    mutate_kb_specific_property_value(old_class,Nil,
		    Instances_specific_to_this_class_kbprop);
	    mutate_kb_specific_property_value(old_class,Nil,
	...
	mutate_kb_specific_property_value(old_class,previous_qm,
		Instances_specific_to_this_class_tail_pointer_kbprop);
	ISVREF(previous_qm,(SI_Long)6L) = Nil;
    }
    else {
	next_qm = ISVREF(frame,(SI_Long)6L);
	previous_qm = ISVREF(frame,(SI_Long)7L);
	...
	ISVREF(next_qm,(SI_Long)7L) = previous_qm;
    }
	...
	if ( !TRUEP(ISVREF(frame,(SI_Long)7L))) {
	    ...
	    if (next_qm) {
		ISVREF(frame,(SI_Long)6L) = Nil;
		mutate_kb_specific_property_value(new_class,next_qm,
			Instances_specific_to_this_class_kbprop);
		ISVREF(next_qm,(SI_Long)7L) = Nil;
	    }
	    else {
		mutate_kb_specific_property_value(new_class,Nil,
			Instances_specific_to_this_class_kbprop);
		mutate_kb_specific_property_value(new_class,Nil,
			Instances_specific_to_this_class_tail_pointer_kbprop);
	    }
	    ...
	    previous_qm = ISVREF(frame,(SI_Long)7L);
	    ISVREF(frame,(SI_Long)7L) = Nil;
	    mutate_kb_specific_property_value(new_class,previous_qm,
		    Instances_specific_to_this_class_tail_pointer_kbprop);
	    ISVREF(previous_qm,(SI_Long)6L) = Nil;
	}
	else {
    ...
    last_instance_qm = lookup_kb_specific_property_value(new_class,
	    Instances_specific_to_this_class_tail_pointer_kbprop);
    if (last_instance_qm) {
	ISVREF(last_instance_qm,(SI_Long)6L) = frame;
	ISVREF(frame,(SI_Long)7L) = last_instance_qm;
	ISVREF(frame,(SI_Long)6L) = Nil;
	mutate_kb_specific_property_value(new_class,frame,
		Instances_specific_to_this_class_tail_pointer_kbprop);
    }
    else {
	mutate_kb_specific_property_value(new_class,frame,
...
Object install_deferred_class_definitions()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_tree_1(Deferred_class_definitions_alist);
    ...
    Object name_for_class, class_definition_with_no_name_yet;
{
    ...
    pair = gensym_cons_1(name_for_class,class_definition_with_no_name_yet);
  ...
  next_loop:
	...
	cdr_new_value = gensym_cons_1(pair,CDR(l));
	return VALUES_1(M_CDR(l) = cdr_new_value);
    }
    l = M_CDR(l);
    goto next_loop;
  end_loop:
    Deferred_class_definitions_alist = gensym_cons_1(pair,
...
{
    Object class_definition, x, gensymed_symbol, gensymed_symbol_1;
	...
	if ( !((SI_Long)0L != (IFIX(ISVREF(class_definition,(SI_Long)5L)) 
		...
		gensymed_symbol = CDR(Symbol_properties_table);
		gensymed_symbol_1 = x;
		gensymed_symbol_2 = SXHASH_SYMBOL_1(x) & 
			IFIX(Most_positive_fixnum);
		gensymed_symbol_3 = (SI_Long)0L;
	      next_loop:
		if ( !TRUEP(gensymed_symbol))
	    ...
	    temp_2 = TRUEP(Nil);
	if (temp_2) {
	    gensymed_symbol = ISVREF(class_definition,(SI_Long)14L);
...
Object Current_frame_serial_number_before_reading = UNBOUND;

Object Reading_ghost_definitions_p = UNBOUND;
    ...
    Object class_inheritance_path_needs_refreshing_qm;
{
	...
	if (old_class_definition_is_frame_p) {
		...
		if (add_junction_block_class_to_slot_differences_qm)
		    current_differing_slots_qm = 
			    ...
			    gensym_cons_1(Qjunction_block_class_for_connection,
			    Nil));
	    }
	...
	if (new_name_qm) {
	  ...
	  next_loop:
		...
		ab_loop_list__1 = M_CDR(ab_loop_list__1);
		ab_loopvar__2 = gensym_cons_1(EQ(superior,name_for_class) ?
			 new_name_qm : superior,Nil);
		if (ab_loopvar__1)
		...
		next_loop_2:
		  ...
		  if (conflict_for_subclass_qm) {
			...
			next_loop_3:
			  ...
			  ab_loop_list_ = M_CDR(ab_loop_list_);
			  ab_loopvar__3 = gensym_cons_1(EQ(superior,
			...
			end_2:;
		      ...
		      if (THIRD(conflict_for_subclass_qm)) {
			  temp_2 = 
				  gensym_cons_1(Qdirect_superiors_of_defined_class,
				  FIFTH(conflict_for_subclass_qm));
			  M_FIFTH(conflict_for_subclass_qm) = temp_2;
		      }
		      Class_name_conflicts = 
			      delete_gensym_element_1(conflict_for_subclass_qm,
			      Class_name_conflicts);
		      list_of_conflicts_for_subclasses_qm = 
			      gensym_cons_1(conflict_for_subclass_qm,
			      list_of_conflicts_for_subclasses_qm);
		  }
		  goto next_loop_2;
		end_loop_2:;
...
Object Name_of_kb_being_read = UNBOUND;
...
Object preprocess_class_name_conflicts_with_move_attribute_facility()
{
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
      ...
      top_down_class_name_conflicts = 
	      nreverse(copy_list_using_gensym_conses_1(Class_name_conflicts));
      basis_class = Nil;
      new_class = Nil;
	...
	end_loop_3:;
      ...
      goto next_loop;
    end_loop:;
      result = reclaim_gensym_list_1(top_down_class_name_conflicts);
    POP_SPECIAL();
    return result;
}

Object Name_text_string_for_kb_being_read = UNBOUND;
    ...
    Object auto_merge_case_qm, new_algorithm_qm;
{
    ...
    Object ghost_definition_p, temp_1, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp_3, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
    Object sub_class_bit_vector, scope_conses, ab_loopvar_, subclass;
    Object ab_loop_it_, x;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;
    Declare_special(2);
    ...
    next_loop:
	  ...
	  gensymed_symbol = ISVREF(new_class_definition,(SI_Long)14L);
	  gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		  (SI_Long)5L) : Nil;
	  temp_2 = TRUEP(gensymed_symbol);
      }
	...
	end_2:;
	  if ( !TRUEP(gensymed_symbol)) {
	      ...
	      M_CDR(gensymed_symbol_1) = Nil;
	      inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
	      gensymed_symbol = set_balanced_binary_tree_entry(temp_3,Qeq,
	...
	end_4:;
	  ...
	  if (ghost_definition_p && new_name_qm) {
		  ...
		  gensymed_symbol = CDR(Symbol_properties_table);
		  gensymed_symbol_1 = new_name_qm;
		  gensymed_symbol_2 = SXHASH_SYMBOL_1(new_name_qm) & 
			  IFIX(Most_positive_fixnum);
		  gensymed_symbol_3 = (SI_Long)0L;
		next_loop_18:
		  if ( !TRUEP(gensymed_symbol))
	  ...
	  if (temp_2)
		...
		end_37:;
		  ...
		  gensymed_symbol = ISVREF(old_class_definition_qm,
			  (SI_Long)14L);
		  gensymed_symbol = gensymed_symbol ? 
			  ISVREF(gensymed_symbol,(SI_Long)5L) : Nil;
		  temp_2 =  !TRUEP(gensymed_symbol);
		  ...
		  if (temp_2);
		      ...
		      if (CAR(temp_1)) {
			  gensymed_symbol = ISVREF(new_class_definition,
				  (SI_Long)14L);
			  gensymed_symbol = gensymed_symbol ? 
				  ISVREF(gensymed_symbol,(SI_Long)5L) : Nil;
			  temp_2 =  !TRUEP(gensymed_symbol);
		  ...
		  if (temp_2) {
			  ...
			  deferred_class_name_conflicts = 
				  gensym_cons_1(copy_tree_using_gensym_conses_1(class_name_conflict),
				  deferred_class_name_conflicts);
		      else {
			  number_of_conflicts = 
    ...
    end_loop:
	  ...
	  reclaim_gensym_tree_1(workspace_coordinate_information);
      ...
      reclaim_gensym_tree_1(Class_name_conflicts);
...
Object Current_backup_definition_workspace_qm = UNBOUND;

Object Current_backup_definition_workspace_serial_number_qm = UNBOUND;

Object Do_not_show_conflicts_during_kb_load_qm = UNBOUND;
    ...
    Object new_algorithm_qm;
{
    ...
    PUSH_SPECIAL(Index_of_top_of_backtrace_stack,index_of_top_of_backtrace_stack,
	  ...
	  workspace_coordinate_information = 
		  gensym_cons_1(gensym_list_3(workspace,top_edge,
    ...
    Object conflicts;
{
	...
	return reclaim_gensym_cons_1(conflicts);
    }
    else
	return VALUES_1(Nil);
}

Object Record_of_class_name_conflicts_qm = UNBOUND;
    ...
    Object class_name_conflicts;
{
    ...
    PUSH_SPECIAL(Class_name_conflicts,class_name_conflicts,0);
      ...
      Record_of_class_name_conflicts_qm = gensym_cons_1(temp,
	      Class_name_conflicts);
...
Object record_class_name_conflict varargs_1(int, n)
{
    ...
    Class_name_conflicts = gensym_cons_1(gensymed_symbol,Class_name_conflicts);
    ...
    Object interim_class_definition, current_definition;
{
    ...
    Object slot_group_qm, current_default_overrides_qm, stubs_qm, temp_2;
    Object temp_3, new_cons, global_properties, kb_properties;
  ...
  next_loop:
	...
	if (member_eql(pretty_slot_name,list_constant_1));
		...
		if (EQ(next_queue_element,queue))
		    goto end_loop_1;
		subblock = ISVREF(next_queue_element,(SI_Long)2L);
		...
		if (slot_group_qm)
		    SVREF(slot_group_qm,FIX((SI_Long)5L)) = gensymed_symbol_5;
		else if ( !EQ(gensymed_symbol_5,Qnil)) {
		    if (Noting_changes_to_kb_p)
		    ...
		    SVREF(temp_1,FIX((SI_Long)5L)) = gensymed_symbol_5;
		}
		goto next_loop_1;
	      end_loop_1:;
	    }
		...
		temp_1 = current_attribute_displays_spec_qm || stubs_qm ? 
			...
			gensym_cons_1(gensym_list_2(Qattribute_displays_for_class,
			current_attribute_displays_spec_qm),Nil) : Nil,
			stubs_qm ? 
			gensym_cons_1(gensym_list_2(Qstubs_for_class,
		...
		gensymed_symbol_4 = CDR(Symbol_properties_table);
		gensymed_symbol_3 = current_definition_class;
		gensymed_symbol = 
			SXHASH_SYMBOL_1(current_definition_class) & 
			IFIX(Most_positive_fixnum);
		...
		if (gensymed_symbol < gensymed_symbol_1)
		    gensymed_symbol_4 = ISVREF(gensymed_symbol_4,(SI_Long)1L);
		else if (gensymed_symbol > gensymed_symbol_1)
		    gensymed_symbol_4 = ISVREF(gensymed_symbol_4,(SI_Long)2L);
		else {
		    gensymed_symbol_4 = ISVREF(gensymed_symbol_4,(SI_Long)3L);
		    gensymed_symbol_5 = Nil;
		  next_loop_3:
		    if ( !TRUEP(gensymed_symbol_4))
			goto end_loop_3;
			...
			gensymed_symbol_4 = M_CDR(M_CAR(gensymed_symbol_4));
			goto end_1;
		    }
		...
		gensymed_symbol_4 = Qnil;
	      end_2:;
		if ( !TRUEP(gensymed_symbol_4)) {
		    gensymed_symbol_4 = current_definition_class;
		    temp_2 = Symbol_properties_table;
		    temp_3 = FIX(SXHASH_SYMBOL_1(gensymed_symbol_4) & 
			    IFIX(Most_positive_fixnum));
		    new_cons = Available_gensym_conses;
		    if (new_cons) {
			Available_gensym_conses = M_CDR(new_cons);
		    ...
		    M_CAR(gensymed_symbol_3) = Qsymbol_properties_hash_table;
		    ...
		    gensymed_symbol_4 = 
			    ...
			    T,gensymed_symbol_4,temp_3,gensymed_symbol_3);
		}
		global_properties = gensymed_symbol_4;
		gensymed_symbol_4 = CDR(global_properties);
		gensymed_symbol_3 = 
			Current_kb_specific_property_list_property_name;
		gensymed_symbol = 
			SXHASH_SYMBOL_1(Current_kb_specific_property_list_property_name) 
		...
		if (gensymed_symbol < gensymed_symbol_1)
		  ...
		  next_loop_5:
		    ...
		    gensymed_symbol_5 = M_CAR(M_CAR(gensymed_symbol_4));
		    if (EQ(gensymed_symbol_3,gensymed_symbol_5)) {
			kb_properties = M_CDR(M_CAR(gensymed_symbol_4));
			goto end_3;
		    }
		    gensymed_symbol_4 = M_CDR(gensymed_symbol_4);
		    goto next_loop_5;
		...
		if (kb_properties);
		    ...
		    kb_properties = Nil;
		if (kb_properties) {
		    gensymed_symbol_4 = CDR(kb_properties);
		    gensymed_symbol_3 = Class_description_gkbprop;
		    gensymed_symbol = 
			    SXHASH_SYMBOL_1(Class_description_gkbprop) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_1 = (SI_Long)0L;
		...
		if ( !EQ(kb_specific_value,No_specific_property_value))
		  ...
		  next_loop_8:
			...
			gensymed_symbol_5 = M_CAR(M_CAR(gensymed_symbol_4));
			if (EQ(gensymed_symbol_3,gensymed_symbol_5)) {
			    resulting_value = M_CDR(M_CAR(gensymed_symbol_4));
			    goto end_7;
			}
			gensymed_symbol_4 = M_CDR(gensymed_symbol_4);
			goto next_loop_9;
		...
		gensymed_symbol_4 = resulting_value;
		...
		if (temp) {
			...
			temp_3 = cross_section_pattern_qm ? 
				gensym_cons_1(gensym_list_2(Qcross_section_pattern_for_class,
				cross_section_pattern_qm),Nil) : Nil;
			temp_1 = nconc2(current_default_overrides_qm,
				nconc2(temp_3,nconc2(stub_length_qm ? 
				gensym_cons_1(gensym_list_2(Qstub_length_for_class,
				stub_length_qm),Nil) : Nil,
				junction_block_qm ? 
				gensym_cons_1(gensym_list_2(Qjunction_block_class_for_class,
		    ...
		    temp_1 = default_message_properties_qm ? 
			    nconc2(current_default_overrides_qm,
			    gensym_cons_1(gensym_list_2(Qdefault_message_properties_for_class,
    ...
    Object conflicts;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, next, follower;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp;
  ...
  end_loop_7:;
	...
	return gensym_cons_1(temp_1,nreverse(result_1));
    }
    else {
...
Object resolve_class_name_conflicts()
{
	...
	if (reordered_class_name_conflicts) {
	    reclaim_gensym_list_1(Record_of_class_name_conflicts_qm);
	...
	PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	  ...
	  class_name_conflicts = Nil;
	  PUSH_SPECIAL(Class_name_conflicts,class_name_conflicts,1);
	    ...
	    PUSH_SPECIAL(Currently_automatically_resolving_class_name_conflicts_qm,currently_automatically_resolving_class_name_conflicts_qm,
		    0);
	      class_name_conflict = Nil;
	      ab_loop_list_ = Class_name_conflicts;
	      class_1 = Nil;
	    ...
	    next_loop:
		  ...
		  if ( 
		      ...
		      create_class_definition_conflict_workspace(5,class_1,
			      ...
			      new_class_definition,
			      slots_that_still_have_differences);
		      reclaim_gensym_list_1(slots_that_still_have_differences);
		  }
	      }
	      goto next_loop;
	    end_loop:
    ...
    Object old_class_definition, new_class_definition;
{
  ...
  end_1:;
	...
	temp_1 = TRUEP(Nil);
    if (temp_1) {
	ab_loopvar__2 = gensym_cons_1(CAR(new_attribute_description),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
	...
	if (old_slot_description_qm) {
		...
		next_loop_2:
		  ...
		  if ( !EQ(current_slot_value,new_slot_init_form) && 
		      ...
		      gensymed_symbol = ISVREF(instance,(SI_Long)14L);
		      gensymed_symbol = gensymed_symbol ? 
		    ...
		    next_loop_3:
		      ...
		      ab_next_queue_element_ = 
			      ISVREF(ab_next_queue_element_,(SI_Long)0L);
		...
		value_to_return_qm = nconc2(temp,
			gensym_cons_1(nconc2(gensym_list_2(ISVREF(new_slot_description,
			(SI_Long)2L),
			defining_class_for_slot_description_to_set_qm),
			gensym_cons_1(instances_and_slot_values_list_qm,
			Nil)),Nil));
	    }
	}
    }
    ...
    Object preserved_non_default_values;
{
    ...
    Object list_of_instances_and_values, gensym_pop_store, cons_1, next_cons;
    Object cdr_new_value, instance_and_values, instance, slot_value;
  ...
  next_loop:
    ...
    attribute_information = gensym_pop_store;
    gensym_pop_store = Nil;
    ...
    pretty_slot_name = gensym_pop_store;
    gensym_pop_store = Nil;
    cons_1 = attribute_information;
    if (cons_1) {
	gensym_pop_store = M_CAR(cons_1);
	...
	next_cons = Nil;
    attribute_information = next_cons;
    defining_class = gensym_pop_store;
    gensym_pop_store = Nil;
    cons_1 = attribute_information;
    if (cons_1) {
	gensym_pop_store = M_CAR(cons_1);
	...
	next_cons = Nil;
    attribute_information = next_cons;
    list_of_instances_and_values = gensym_pop_store;
  ...
  next_loop_1:
    ...
    instance_and_values = gensym_pop_store;
    gensym_pop_store = Nil;
	...
	next_cons = Nil;
    instance_and_values = next_cons;
    attribute_display_qm = gensym_pop_store;
	...
	if (sub_class_vector_index < 
	    ...
	    temp = TRUEP(Nil);
	ab_loop_it_ = (temp ? TRUEP(attribute_display_p(subblock)) : 
    ...
    Object old_class_definition, new_class_definition;
{
    ...
    Object old_definition_class_name, new_definition_class_name;
    ...
    Object kb_specific_value, resulting_value, old_definition_defines_class_qm;
	...
	gensymed_symbol_4 = old_definition_class_name;
	gensymed_symbol = SXHASH_SYMBOL_1(old_definition_class_name) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_1 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol_3))
	...
	gensymed_symbol_3 = CDR(Symbol_properties_table);
	gensymed_symbol_4 = new_definition_class_name;
	gensymed_symbol = SXHASH_SYMBOL_1(new_definition_class_name) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_1 = (SI_Long)0L;
      next_loop_8:
	if ( !TRUEP(gensymed_symbol_3))
...
Object Record_of_definitional_name_conflicts_qm = UNBOUND;

Object Record_definitional_name_conflicts_qm = UNBOUND;

Object Kb_load_case_qm = UNBOUND;
...
Object note_definitional_name_conflict varargs_1(int, n)
{
    ...
    common_arglist_length_in_method_case_qm = 
	    OPTIONAL_ARG_P_nonrelocating() ? OPTIONAL_ARG_nonrelocating() :
	     Nil;
    END_ARGS_nonrelocating();
    temp = nconc2(gensym_list_3(base_kb_instance_with_same_name,
	    merge_kb_instance_with_same_name,name_in_common),
	    class_in_common_in_method_case_qm ? 
	    gensym_list_2(class_in_common_in_method_case_qm,
	    common_arglist_length_in_method_case_qm) : Nil);
    Record_of_definitional_name_conflicts_qm = gensym_cons_1(temp,
...
Object resolve_definitional_name_conflicts()
{
	...
	PUSH_SPECIAL(Resolving_definitional_name_conflicts_qm,resolving_definitional_name_conflicts_qm,
		0);
	...
	end_loop_1:;
	  ...
	  reclaim_gensym_tree_1(Record_of_definitional_name_conflicts_qm);
...
Object Number_of_kb_characters_so_far_qm = UNBOUND;
...
Object Total_items_in_file = UNBOUND;

Object Write_xml_object_items_collected = UNBOUND;
...
Object Kb_file_progress = UNBOUND;

Object Number_of_kb_lines_so_far = UNBOUND;

Object Do_not_update_file_progress_display_qm = UNBOUND;

Object Do_not_restore_image_planes_qm = UNBOUND;

Object Do_not_notify_user_during_kb_load_qm = UNBOUND;

Object Do_not_allow_user_interactions_during_kb_load_qm = UNBOUND;

Object Selected_file_progress_attributes_to_show_subsets_plist = UNBOUND;
...
static Object Qnumber_of_kb_characters_so_far_qm;  /* number-of-kb-characters-so-far? */
...
Object put_up_file_progress_display varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Number_of_kb_characters_so_far_qm,number_of_kb_characters_so_far_qm,
		1);
...
Object Suppress_notification_for_kb_save_qm = UNBOUND;
...
Object First_kb_in_group_read_in_yet_qm = UNBOUND;

Object Level_of_group_kb_read = UNBOUND;

Object Modules_loaded_in_this_group = UNBOUND;

Object Kb_serial_number_before_loading_this_group = UNBOUND;

Object Current_system_rpc_icp_socket_qm = UNBOUND;
    ...
    Object what_to_do_after_loading_kb_qm, update_before_loading_qm;
{
    ...
    PUSH_SPECIAL(Kb_serial_number_before_loading_this_group,kb_serial_number_before_loading_this_group,
	    4);
      PUSH_SPECIAL(Modules_loaded_in_this_group,modules_loaded_in_this_group,
	      3);
	PUSH_SPECIAL(First_kb_in_group_read_in_yet_qm,first_kb_in_group_read_in_yet_qm,
		2);
	  PUSH_SPECIAL(Level_of_group_kb_read,level_of_group_kb_read,1);
	    if (PUSH_UNWIND_PROTECT(0)) {
...
Object Doing_g2_init_file_p = UNBOUND;

Object Doing_g2_init_kb_p = UNBOUND;
    ...
    Object update_before_loading_qm;
{
    ...
    PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,5);
	...
	end_2:;
	  if (temp_1) {
		...
		POP_SPECIAL();
	      ...
	      if (warmboot_case_qm) {
		  temp = FIRST(module_loading_schedule);
		  temp = gensym_list_2(SECOND(temp),
	      ...
	      temp = post_module_schedule_dialog(Qloading,
		      ...
		      warmboot_case_qm ? Nil : 
		      gensym_cons_1(copy_of_module_loading_schedule,Nil));
	  }
...
Object Some_module_is_clear_text_p = UNBOUND;

Object Kb_file_progress_is_currently_for_modules_p = UNBOUND;

Object Current_kb_file_progress_for_modules_qm = UNBOUND;

Object Post_loading_functions_will_be_executed_again_later_qm = UNBOUND;

Object Launch_recompile_for_compilations_removed_in_this_kb_qm = UNBOUND;
    ...
    Object what_to_do_after_loading_kb_qm;
{
    ...
    defer_notifications_qm = clear_kb_qm;
    PUSH_SPECIAL(Defer_notifications_qm,defer_notifications_qm,3);
      current_kb_file_progress_for_modules_qm = Nil;
      PUSH_SPECIAL(Current_kb_file_progress_for_modules_qm,current_kb_file_progress_for_modules_qm,
	      2);
	kb_file_progress_is_currently_for_modules_p = T;
	PUSH_SPECIAL(Kb_file_progress_is_currently_for_modules_p,kb_file_progress_is_currently_for_modules_p,
		1);
	  ...
	  PUSH_SPECIAL(Post_loading_functions_will_be_executed_again_later_qm,post_loading_functions_will_be_executed_again_later_qm,
		  0);
	    ab_loop_iter_flag_ = T;
	  next_loop:
...
Object Selected_module_load_request_attributes_to_show_subsets_plist = UNBOUND;
    ...
    Object cancel_function_arglist_qm;
{
    ...
    PUSH_SPECIAL(Simple_dialog_title_qm,simple_dialog_title_qm,2);
      simple_dialog_fill_text_p = Nil;
      PUSH_SPECIAL(Simple_dialog_fill_text_p,simple_dialog_fill_text_p,1);
	...
	PUSH_SPECIAL(Simple_dialog_plist_qm,simple_dialog_plist_qm,0);
...
Object File_system_directory_search_cache_active_p = UNBOUND;

Object File_system_directory_search_cache = UNBOUND;

Object File_system_directory_search_cache_wildcard_string = UNBOUND;
    ...
    Object convertable_thing;
{
	...
	PUSH_SPECIAL(File_system_directory_search_cache_wildcard_string,file_system_directory_search_cache_wildcard_string,
		2);
	  PUSH_SPECIAL(File_system_directory_search_cache_active_p,file_system_directory_search_cache_active_p,
		  1);
	    PUSH_SPECIAL(File_system_directory_search_cache,file_system_directory_search_cache,
		    0);
...
Object gensym_directory_using_cache varargs_1(int, n)
{
	...
	if (include_subdirectories_qm) {
		...
		if (directory_qm) {
		    ab_loopvar__2 = gensym_cons_1(directory_qm,Nil);
		    if (ab_loopvar__1)
			M_CDR(ab_loopvar__1) = ab_loopvar__2;
		    else
			ab_loopvar_ = ab_loopvar__2;
		...
		if ( !EQ(path_list,Qunbound_in_protected_let))
		    reclaim_gensym_list_1(path_list);
	    }
	    if (directory_pathname) {
		if ( !EQ(directory_pathname,Qunbound_in_protected_let))
		    reclaim_gensym_pathname(directory_pathname);
	...
	if (PUSH_UNWIND_PROTECT(0)) {
		...
		if (member(4,d1_qm,result_1,Ktest,
		    ...
		    result_1 = gensym_cons_1(d1_qm,result_1);
		l = M_CDR(l);
		goto next_loop_1;
	      end_loop_1:
	  ...
	  next_loop_2:
	    ...
	    if (temp_2) {
		ab_loopvar__2 = 
			gensym_cons_1(copy_gensym_pathname(candidate_gensym_pathname),
			Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
	...
	if (subdirectory_directory_if_needed_1) {
	    if ( !EQ(subdirectory_directory_if_needed_1,
		    Qunbound_in_protected_let))
		reclaim_gensym_list_1(subdirectory_directory_if_needed_1);
	}
	if (wildcarded_namestring) {
	    if ( !EQ(wildcarded_namestring,Qunbound_in_protected_let))
		reclaim_text_string(wildcarded_namestring);
...
Object Default_g2_module_map_pathname = UNBOUND;
...
Object Pathname_for_disabling_g2_module_map_command_line = UNBOUND;
...
Object Saved_directories_for_module_truename_search = UNBOUND;
    ...
    Object saved_directories;
{
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:;
    reclaim_gensym_list_1(directory_1);
    ...
    Object module, overriding_pathname_qm, current_kb_directory;
{
    ...
    PUSH_SPECIAL(Saved_directories_for_module_truename_search,saved_directories_for_module_truename_search,
	    0);
      if (PUSH_UNWIND_PROTECT(0)) {
...
Object Current_attribute_file_pathname_qm = UNBOUND;

Object Current_statistics_file_pathname_qm = UNBOUND;

Object Current_foreign_image_pathname_qm = UNBOUND;
...
Object Modules_scheduled_so_far_by_save_all_modules_of_kb = UNBOUND;

Object Kb_module_currently_to_save_qm = UNBOUND;

Object Inhibit_modularity_consistency_checking_qm = UNBOUND;

Object Current_module_directory_binding_alist = UNBOUND;

Object Current_module_pathname_override_binding_alist = UNBOUND;

Object Modules_scheduled_so_far = UNBOUND;
    ...
    Object override_pathname_qm, use_clear_text_qm, only_changed_modules_qm;
{
    ...
    PUSH_SPECIAL(Modules_scheduled_so_far,modules_scheduled_so_far,2);
      PUSH_SPECIAL(Current_module_directory_binding_alist,current_module_directory_binding_alist,
	      1);
	PUSH_SPECIAL(Current_module_pathname_override_binding_alist,current_module_pathname_override_binding_alist,
		0);
    ...
    Object changed_modules;
{
    ...
    Object next_cons, cdr_new_value, module_saving_schedule;
...
Object Modules_considered_in_loading_schedule_so_far = UNBOUND;
		  ...
		  PUSH_SPECIAL(File_system_directory_search_cache_active_p,file_system_directory_search_cache_active_p,
		    ...
		    PUSH_SPECIAL(File_system_directory_search_cache,file_system_directory_search_cache,
		      ...
		      modules_considered_in_loading_schedule_so_far = 
			      Qunbound_in_protected_let;
		      PUSH_SPECIAL(Modules_considered_in_loading_schedule_so_far,modules_considered_in_loading_schedule_so_far,
			      3);
			PUSH_SPECIAL(Saved_directories_for_module_truename_search,saved_directories_for_module_truename_search,
				2);
			  if (PUSH_UNWIND_PROTECT(0)) {
			      ...
			      current_module_directory_binding_alist = Nil;
			      modules_scheduled_so_far = Nil;
			      PUSH_SPECIAL(Modules_scheduled_so_far,modules_scheduled_so_far,
				      1);
				PUSH_SPECIAL(Current_module_directory_binding_alist,current_module_directory_binding_alist,
					0);
    ...
    Object update_before_loading_qm, clear_kb_qm;
{
    ...
    Object next_cons, cdr_new_value;
    Object result;
...
Object Pathname_with_default_type_if_required_for_module_pathnames_qm = UNBOUND;
...
Object Modules_listed_so_far = UNBOUND;
    ...
    Object module;
{
    ...
    PUSH_SPECIAL(Modules_listed_so_far,modules_listed_so_far,0);
...
Object Enable_loading_compiled_kbs_p = UNBOUND;
...
Object Enable_saving_compiled_kbs_p = UNBOUND;

Object Delete_compiled_kb_source_p = UNBOUND;

Object Loading_compiled_kb_p = UNBOUND;
...
Object save_module_of_kb varargs_1(int, n)
{
	...
	if ( !TRUEP(module_saving_schedule))
	    ...
	    SAVE_VALUES(post_module_schedule_dialog(Qsaving,temp,temp_1,
		    ...
		    gensym_list_3(module_saving_schedule,emit_c_code_qm,
		    commit_after_saving_qm),
		    Qreclaim_module_loading_schedule_and_representations_thereof,
		    gensym_cons_1(module_saving_schedule,Nil)));
	}
	else
...
static Object Qcurrent_workstation_event;  /* current-workstation-event */
...
Object save_one_module_of_kb varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Inhibit_modularity_consistency_checking_qm,inhibit_modularity_consistency_checking_qm,
	    1);
      PUSH_SPECIAL(Kb_module_currently_to_save_qm,kb_module_currently_to_save_qm,
	      0);
    ...
    Object relation_and_related_items;
{
	...
	results = gensym_cons_1(header,Nil);
	relation_frame = Nil;
	...
	ab_loop_list__2 = M_CDR(ab_loop_list__2);
	results = gensym_cons_1(related_item,results);
	goto next_loop_2;
      end_loop_2:;
	goto next_loop_1;
      end_loop_1:;
	results = gensym_cons_1(relation_frame,results);
	goto next_loop;
      end_loop:
...
Object A_list_of_relations_with_related_items_in_modules_that_do_not_require_them = UNBOUND;

Object A_list_of_classes_with_instances_in_modules_that_do_not_require_them = UNBOUND;

Object Classes_whose_superiors_are_not_defined_in_required_modules = UNBOUND;

Object Classes_not_defined_in_any_module = UNBOUND;

static Object Qfatal;              /* fatal */

static Object list_constant_13;    /* # */

static Object Qclasses_not_defined_in_any_module;  /* classes-not-defined-in-any-module */

static Object Qclasses_whose_superiors_are_not_defined_in_required_modules;  /* classes-whose-superiors-are-not-defined-in-required-modules */
...
Object check_savability_of_kb_in_terms_of_modularity varargs_1(int, n)
{
	...
	PUSH_SPECIAL(Current_modularity_problems,current_modularity_problems,
		6);
	  inspect_command_for_modularity_problems_qm = inspect_command_qm;
	  PUSH_SPECIAL(Inspect_command_for_modularity_problems_qm,inspect_command_for_modularity_problems_qm,
		  5);
	    current_modularity_problems_fatal_qm = Nil;
	    PUSH_SPECIAL(Current_modularity_problems_fatal_qm,current_modularity_problems_fatal_qm,
		    4);
	      ...
	      PUSH_SPECIAL(A_list_of_relations_with_related_items_in_modules_that_do_not_require_them,a_list_of_relations_with_related_items_in_modules_that_do_not_require_them,
		      3);
		PUSH_SPECIAL(A_list_of_classes_with_instances_in_modules_that_do_not_require_them,a_list_of_classes_with_instances_in_modules_that_do_not_require_them,
			2);
		  PUSH_SPECIAL(Classes_whose_superiors_are_not_defined_in_required_modules,classes_whose_superiors_are_not_defined_in_required_modules,
			  1);
		    PUSH_SPECIAL(Classes_not_defined_in_any_module,classes_not_defined_in_any_module,
			    0);
		...
		if (temp) {
		    ...
		    gensymed_symbol_4 = ISVREF(gensymed_symbol_3,(SI_Long)1L);
		    sub_class_bit_vector = ISVREF(gensymed_symbol_4,
			    (SI_Long)19L);
		    superior_class_bit_number = 
			...
			gensymed_symbol_4 = Nil;
			gensymed_symbol_5 = Nil;
			ab_loop_list_ = ISVREF(gensymed_symbol_3,(SI_Long)19L);
		      next_loop_2:
			if ( !TRUEP(ab_loop_list_))
			    goto end_loop_2;
			...
			ab_loop_list__1 = M_CDR(ab_loop_list__1);
			if (gensymed_symbol_3 && CONSP(gensymed_symbol_3)) {
			    represented_frame = 
				    get_slot_represented_by_text_cell_if_any(gensymed_symbol_3);
			    if (represented_frame &&  
				    !EQ(gensymed_symbol_4,represented_frame)) {
		...
		goto next_loop;
	      end_loop_1:;
	      POP_SPECIAL();
	      temp_1 = Current_modularity_problems_fatal_qm;
...
{
    Object do_not_note_permanent_changes_p, class_description_qm;
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp_1;
    Object temp_2, new_cons, global_properties, kb_properties;
    Object kb_specific_value, resulting_value, default_workspace_margin;
    Object class_specific_workspace_margin, workspace_margin, kb_workspace;
    Object module_to_use_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, svref_new_value;
    char temp;
    Declare_special(1);

    x_note_fn_call(131,113);
    do_not_note_permanent_changes_p = T;
    PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	    0);
	  ...
	  if (class_description_qm &&  !TRUEP(ISVREF(class_description_qm,
		  (SI_Long)20L))) {
	      gensymed_symbol = CDR(Symbol_properties_table);
	      gensymed_symbol_1 = Qkb_workspace;
	      gensymed_symbol_2 = SXHASH_SYMBOL_1(Qkb_workspace) & 
		      IFIX(Most_positive_fixnum);
	      gensymed_symbol_3 = (SI_Long)0L;
	    next_loop:
	      if ( !TRUEP(gensymed_symbol))
	...
	if (temp ?  !TRUEP(following_junction_class_definition_qm) : 
		...
		end_loop:
		  ...
		  if (memq_function(Qconnection,
			  ...
			  gensymed_symbol_3 = CDR(Symbol_properties_table);
			  gensymed_symbol_4 = x;
			  gensymed_symbol = SXHASH_SYMBOL_1(x) & 
				  IFIX(Most_positive_fixnum);
			  gensymed_symbol_1 = (SI_Long)0L;
			next_loop_3:
			  if ( !TRUEP(gensymed_symbol_3))
			...
			end_4:;
			  if ( !TRUEP(gensymed_symbol_3)) {
			      ...
			      gensymed_symbol_3 = 
				      ...
				      Qeq,Nil,T,gensymed_symbol_3,temp_1,
				      gensymed_symbol_4);
			  }
			  global_properties = gensymed_symbol_3;
			  gensymed_symbol_3 = CDR(global_properties);
		  ...
		  if (temp) {
		      ...
		      gensymed_symbol_3 = CDR(Symbol_properties_table);
		      gensymed_symbol_4 = symbol;
		      gensymed_symbol = SXHASH_SYMBOL_1(symbol) & 
			      IFIX(Most_positive_fixnum);
		      gensymed_symbol_1 = (SI_Long)0L;
		    next_loop_11:
		      if ( !TRUEP(gensymed_symbol_3))
		    ...
		    end_14:;
		      ...
		      if (kb_properties) {
			  gensymed_symbol_3 = CDR(kb_properties);
			  gensymed_symbol_4 = property_name;
			  gensymed_symbol = SXHASH_SYMBOL_1(property_name) 
				  & IFIX(Most_positive_fixnum);
			  gensymed_symbol_1 = (SI_Long)0L;
			next_loop_15:
			  if ( !TRUEP(gensymed_symbol_3))
...
Object Required_definitions = UNBOUND;
    ...
    Object module_being_saved;
{
    ...
    x_note_fn_call(131,116);
    noting_changes_to_kb_p = Nil;
    PUSH_SPECIAL(Noting_changes_to_kb_p,noting_changes_to_kb_p,1);
      ...
      required_definitions = collect_ghost_definitions(module_being_saved,
	      required_modules);
      PUSH_SPECIAL(Required_definitions,required_definitions,0);
	definition = Nil;
...
Object write_section_mark_for_kb(char_1)
    Object char_1;
{
    x_note_fn_call(131,117);
    start_new_kb_line();
    write_char_for_kb(CHR('*'));
    return write_char_for_kb(char_1);
}

Object Definitions_not_required = UNBOUND;

Object Connections_in_modules_a_list = UNBOUND;
    ...
    Object module_being_saved, required_modules;
{
    ...
    x_note_fn_call(131,118);
    required_definitions = Nil;
    PUSH_SPECIAL(Required_definitions,required_definitions,3);
      definitions_not_required = Nil;
      PUSH_SPECIAL(Definitions_not_required,definitions_not_required,2);
	connections_in_modules_a_list = get_connections_in_modules_a_list();
	PUSH_SPECIAL(Connections_in_modules_a_list,connections_in_modules_a_list,
		1);
	  scope_conses = Scope_conses;
	  ab_loopvar_ = Nil;
	  ab_loopvar_ = Qblock;
...
Object get_connections_in_modules_a_list()
{
	...
	end_loop_1:
      ...
      ab_node_stack_ = Nil;
      ab_current_node_ = Nil;
      gensymed_symbol = ISVREF(b,(SI_Long)14L);
      gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	      (SI_Long)6L) : Nil;
    ...
    Object class_1, module;
{
    ...
    Object resulting_value, sub_class_bit_vector, ab_loopvar_, instance;
    Object ab_loop_it_;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, superior_class_bit_number;
    SI_Long sub_class_vector_index, gensymed_symbol_5;
    char temp_2;

    x_note_fn_call(131,122);
    gensymed_symbol = CDR(Symbol_properties_table);
    gensymed_symbol_1 = class_1;
...
Object Current_linearized_kb_required_modules = UNBOUND;
	...
	PUSH_SPECIAL(A_list_of_classes_with_instances_in_modules_that_do_not_require_them,a_list_of_classes_with_instances_in_modules_that_do_not_require_them,
	  ...
	  PUSH_SPECIAL(Connections_in_modules_a_list,connections_in_modules_a_list,
	    ...
	    PUSH_SPECIAL(A_list_of_relations_with_related_items_in_modules_that_do_not_require_them,a_list_of_relations_with_related_items_in_modules_that_do_not_require_them,
	      ...
	      PUSH_SPECIAL(Module_required_by_relationships,module_required_by_relationships,
		      0);
...
Object collect_bad_definitions()
{
    ...
    Object gensymed_symbol_3, gensymed_symbol_4, hashed_relationship;
    Object relationship, temp_4;
    SI_Long gensymed_symbol, gensymed_symbol_1, temp_3;
    char temp_1;
    Declare_special(1);
    Object result;

    x_note_fn_call(131,126);
    scope_conses = Scope_conses;
    ab_loopvar_ = Nil;
    ab_loopvar_ = Qblock;
    class_1 = Nil;
	  ...
	  if ( !TRUEP(module_for_definition_qm)) {
	    ...
	    next_loop_4:
		  ...
		  if ((SI_Long)0L != (IFIX(ISVREF(instance,(SI_Long)4L)) & 
			  ...
			  gensymed_symbol_3 = key;
			  gensymed_symbol_1 = (SI_Long)0L;
			next_loop_5:
			  if ( !TRUEP(gensymed_symbol_2))
			      goto end_loop_5;
			  gensymed_symbol_1 = 
				  IFIX(ISVREF(gensymed_symbol_2,(SI_Long)0L));
			  if (gensymed_symbol < gensymed_symbol_1)
			      gensymed_symbol_2 = ISVREF(gensymed_symbol_2,
				      (SI_Long)1L);
			  else if (gensymed_symbol > gensymed_symbol_1)
			      gensymed_symbol_2 = ISVREF(gensymed_symbol_2,
				      (SI_Long)2L);
			    ...
			    next_loop_6:
				  ...
				  goto end_loop_6;
			      gensymed_symbol_4 = 
				      M_CAR(M_CAR(gensymed_symbol_2));
			      if (module_relationship_key_equal(gensymed_symbol_3,
				      gensymed_symbol_4)) {
				  hashed_relationship = 
					  M_CDR(M_CAR(gensymed_symbol_2));
				  goto end_3;
			      }
			      gensymed_symbol_2 = M_CDR(gensymed_symbol_2);
			      goto next_loop_6;
			    end_loop_6:
			      hashed_relationship = Qnil;
			    end_3:;
			      goto end_4;
			  }
			  goto next_loop_5;
			...
			end_4:;
			  ...
			  if (relationship);
			      ...
			      temp = 
				      Fp_mutate_module_required_by_relationships_tree_for_hash_tree_entry;
			      relationship = 
...
{
    Object module_for_instance_qm, key, temp_1, gensymed_symbol_1;
    Object gensymed_symbol_2, gensymed_symbol_4, hashed_relationship;
    Object relationship, temp_3, a1, a2, gensym_push_modify_macro_arg, car_1;
    Object cdr_1, cdr_new_value;
    SI_Long gensymed_symbol, temp_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(131,128);
	...
	if (gensymed_symbol < gensymed_symbol_3)
	  ...
	  next_loop_1:
	    ...
	    if (module_relationship_key_equal(gensymed_symbol_2,
		    gensymed_symbol_4)) {
		hashed_relationship = M_CDR(M_CAR(gensymed_symbol_1));
		goto end_1;
	    }
	    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
	    goto next_loop_1;
	...
	if (relationship);
	    ...
	    temp_1 = 
		    Fp_mutate_module_required_by_relationships_tree_for_hash_tree_entry;
	    relationship = set_balanced_binary_tree_entry(temp_3,
...
void kb_merge_INIT()
{
    ...
    Object Qreclaim_if_gensym_pathname, list_constant_23, Qkb_merge;
    Object Qpathname_with_default_type_if_required_for_module_pathnames_qm;
    Object Kfuncall, G2_DEFSTRUCT_STRUCTURE_NAME_package, list_constant_22;
    Object Qpathnames, Qpathname_for_disabling_g2_module_map_command_line;
    Object Qinitializer_for_pathname_for_disabling_g2_module_map_command_line;
    Object Kabsolute, list_constant_21, Qdefault_g2_module_map_pathname;
    ...
    Object string_constant_97, Qkb_load1;
    Object Qselected_module_load_request_attributes_to_show_subsets_plist;
    Object string_constant_96, list_constant_20, string_constant_95;
    Object string_constant_94, string_constant_74, string_constant_93;
    ...
    Object string_constant_83, string_constant_82;
    Object Qselected_file_progress_attributes_to_show_subsets_plist;
    ...
    Object Qreclaim_slot_value, Qrecord_of_definitional_name_conflicts_qm;
    Object list_constant_17, Qall_definitional_classes, Qtext_conversion_style;
    Object Qtokenizer, Qframe_style_definition, Qimage_definition;
    Object Qlanguage_translation, Quser_menu_choice, Qgeneric_formula;
    Object Qgeneric_simulation_formula, Qrule, Qremote_procedure_declaration;
    Object Qforeign_function_declaration, Qexternal_simulation_definition;
    Object Qunits_of_measure_declaration, Qrelation, Qtabular_function;
    Object Qtabular_function_of_1_arg, Qfunction_definition, Qprocedure;
    Object list_constant_16, list_constant_15, Qitem_or_datum, Qab_or;
    Object Qno_item, Qframe_flags_2, Qinclude_in_menus_qm, Qinstantiate_qm;
    Object Qinstance_configuration, Qobject_configuration, Qsubworkspaces;
    ...
    Object Qreclaim_class_name_conflicts, Qrecord_of_class_name_conflicts_qm;
    Object string_constant_73, string_constant_72;
    Object Qreclaim_frame_serial_number;
    Object Qcurrent_backup_definition_workspace_serial_number_qm;
    Object Qcurrent_backup_definition_workspace_qm, Qdefault_junction;

    x_note_fn_call(131,129);
    SET_PACKAGE("AB");
    ...
    string_constant_75 = 
	    STATIC_STRING("1u4z8r83W+y83W+y838Ly838Ly00001p1m8p8313y1l8l1l8o1l83Fy1l83Hy000004z8r83WKy83WKy838Ly838Ly00001q1m8p83dXy1l8l1l8o1l83Fy1l83Hy1l8");
    string_constant_76 = 
	    STATIC_STRING("3-3y000004z8r83YOy83YOy838Ly838Ly0k001p1m8p83YOy1l8l1l8o1l83Fy1l83Hy000004z8r83Tty83Tty838Ly838Ly00001p1m8p01l8l1l8o1l83Fy1l83Hy");
    string_constant_77 = 
	    STATIC_STRING("000004z8r83Lay83Lay838Ly838Ly0k001p1l8l1l8o1l83Fy1l83Hy1l83-3y000004z8r83Jvy83Jvy838Ly838Ly00001n1m8p83Juy1l8l1l8o000004z8r83b-y");
    string_constant_78 = 
	    STATIC_STRING("83b-y838Ly838Ly00001n1m8p83b+y1l8l1l8o000004z8r83Wny83Wny838Ly838Ly00001m1l8l1l8o000004z8r83cIy83cIy838Ly838Ly00001m1l8l1l8o0000");
    string_constant_79 = 
	    STATIC_STRING("04z8r83dVy83dVy838Ly838Ly00001m1l8l1l8o00000");
    string_constant_80 = 
	    STATIC_STRING("1w8q1m838Ly1l83-+y1r83W+y01m8p8313y8l8o83Fy83Hy1s83WKy01m8p83dXy8l8o83Fy83Hy83-3y1r83YOyk1m8p83YOy8l8o83Fy83Hy1r83Tty01m8p08l8o8");
    string_constant_81 = 
	    STATIC_STRING("3Fy83Hy1r83Layk8l8o83Fy83Hy83-3y1p83Jvy01m8p83Juy8l8o1p83b-y01m8p83b+y8l8o1o83Wny08l8o1o83cIy08l8o1o83dVy08l8o");
    ...
    check_if_superior_classes_are_defined(Qmodule_load_request,
	    list_constant_20);
    string_constant_94 = 
	    STATIC_STRING("1m4z8r83W*y83W*y83Vxy83Vxy00001p1m8p8313y1l8l1l8o1l83Fy1l83Hy000004z8r83W3y83W3y83Vxy83Vxy00001p1m8p835ey1l8l1l8o1l83Fy1l83Hy000");
    string_constant_95 = STATIC_STRING("00");
    string_constant_96 = 
	    STATIC_STRING("1o8q1m83Vxy1l838Ly1r83W*y01m8p8313y8l8o83Fy83Hy1r83W3y01m8p835ey8l8o83Fy83Hy");
    temp = regenerate_optimized_constant(string_constant_74);
