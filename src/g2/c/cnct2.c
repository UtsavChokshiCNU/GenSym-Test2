...
Object make_stubs varargs_1(int, n)
{
    ...
    Object transient_qm, new_cons, gensymed_symbol, connection_item_table;
    Object connection_name_or_names, connection_type, direction_qm, side;
    Object position_1, style_qm, pattern_qm, connection_arrows_qm;
    Object ab_loop_list_, new_stub_qm, ab_loop_desetq_, temp, connection_item;
    Object names, gensymed_symbol_1, slot_group_qm, temp_1;
  ...
  next_loop:
	...
	names = connection_name_or_names ? 
		...
		copy_list_using_gensym_conses_1(connection_name_or_names) :
		 gensym_cons_1(connection_name_or_names,Nil)) : Nil;
...
Object add_stub varargs_1(int, n)
{
    ...
    Object gensymed_symbol_1, slot_group_qm, new_cons, temp, connection_item;
    Object names, temp_1, this_block, superblock_qm, sub_class_bit_vector;
    Object workspace_qm;
	...
	if ( !TRUEP(superblock_qm)) {
		...
		temp_2 = TRUEP(Nil);
	    workspace_qm = temp_2 ? this_block : Nil;
	    goto end_1;
	}
...
Object Stub_length_to_use_qm = UNBOUND;

Object Default_stub_length = UNBOUND;
...
Object make_stub_new varargs_1(int, n)
{
    ...
    Object position_1;
    Object transient_qm, connection_style_qm, line_pattern_qm;
    Object connection_arrows_qm, x2, gensymed_symbol, gensymed_symbol_1;
    ...
    Object noting_changes_to_kb_p, temp_4, stub_length, stub_loose_end;
    ...
    SI_Long sub_class_vector_index, gensymed_symbol_5, temp_3, bv16_length;
	...
	PUSH_SPECIAL(Noting_changes_to_kb_p,noting_changes_to_kb_p,0);
	  if ( !TRUEP(make_transient_qm)) {
	      temp_3 = IFIX(ISVREF(connection,(SI_Long)7L)) | (SI_Long)2L;
	      ISVREF(connection,(SI_Long)7L) = FIX(temp_3);
	  }
	  temp_4 = 
		  copy_frame_serial_number(increment_current_frame_serial_number());
	  SVREF(connection,FIX((SI_Long)10L)) = temp_4;
	  ...
	  if (EQ(side,Qright)) {
	      ...
	      stub_x_position = FIX(gensymed_symbol_2 + gensymed_symbol_3 
		      + gensymed_symbol_5);
	  }
	      ...
	      gensymed_symbol_2 = IFIX(gensymed_symbol);
	      gensymed_symbol_3 = IFIX(stub_length);
	      stub_x_position = FIX(gensymed_symbol_2 - gensymed_symbol_3);
	  }
	  else {
	      gensymed_symbol = ISVREF(block,(SI_Long)14L);
	      gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		      (SI_Long)0L) : FIX((SI_Long)0L);
	      gensymed_symbol_2 = IFIX(gensymed_symbol);
	      gensymed_symbol_3 = IFIX(position_1);
	      stub_x_position = FIX(gensymed_symbol_2 + gensymed_symbol_3);
	  }
	  if (EQ(side,Qtop)) {
	      gensymed_symbol = ISVREF(block,(SI_Long)14L);
	      ...
	      gensymed_symbol_2 = IFIX(gensymed_symbol);
	      gensymed_symbol_3 = IFIX(stub_length);
	      stub_y_position = FIX(gensymed_symbol_2 - gensymed_symbol_3);
	  }
	  ...
	  if (make_transient_qm) {
	      temp_3 = IFIX(ISVREF(stub_loose_end,(SI_Long)5L)) | 
		      (SI_Long)262144L;
	      ISVREF(stub_loose_end,(SI_Long)5L) = FIX(temp_3);
	  }
	  ...
	  gensymed_symbol_4 = ISVREF(stub_loose_end,(SI_Long)14L);
	  gensymed_symbol_4 = gensymed_symbol_4 ? ISVREF(gensymed_symbol_4,
		  (SI_Long)0L) : FIX((SI_Long)0L);
	  gensymed_symbol_2 = IFIX(gensymed_symbol_4);
	  gensymed_symbol_2 =  - gensymed_symbol_2;
	  gensymed_symbol_3 = IFIX(stub_x_position);
	  gensymed_symbol_2 = gensymed_symbol_2 + gensymed_symbol_3;
	  gensymed_symbol_4 = ISVREF(stub_loose_end,(SI_Long)14L);
	  gensymed_symbol_4 = gensymed_symbol_4 ? ISVREF(gensymed_symbol_4,
		  (SI_Long)1L) : FIX((SI_Long)0L);
	  gensymed_symbol_3 = IFIX(gensymed_symbol_4);
	  ...
	  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
		  FIX(gensymed_symbol_2),FIX(gensymed_symbol_3));
	  if (directed_qm) {
	      ...
	      temp_3 = IFIX(ISVREF(connection,(SI_Long)7L)) &  ~(SI_Long)1L;
	      ISVREF(connection,(SI_Long)7L) = FIX(temp_3);
	  }
	  else {
	      temp = TRUEP(Noting_changes_to_kb_p);
	  ...
	  if (EQ(direction,Qinput)) {
	      temp_4 = gensym_cons_1(Qstub_connection,Nil);
	      SVREF(connection_item,FIX((SI_Long)1L)) = temp_4;
	  }
	  else {
	      temp_4 = gensym_cons_1(Qstub_connection,Nil);
	      SVREF(connection_item,FIX((SI_Long)2L)) = temp_4;
	  }
	  ...
	  if (EQ(direction,Qinput)) {
	      ...
	      gensymed_symbol_3 = EQ(side,Qleft) || EQ(side,Qright) ? 
		      IFIX(position_1) : IFIX(position_1);
	      gensymed_symbol_5 = (SI_Long)2L;
	      gensymed_symbol_3 = gensymed_symbol_3 << gensymed_symbol_5;
	      temp_3 = gensymed_symbol_2 + gensymed_symbol_3;
	      ISVREF(connection,(SI_Long)4L) = FIX(temp_3);
	      temp = TRUEP(Noting_changes_to_kb_p);
	      if (temp);
	      else {
		  gensymed_symbol_2 = IFIX(ISVREF(connection,(SI_Long)7L)) 
	      ...
	      gensymed_symbol_3 = (SI_Long)0L;
	      temp_3 = gensymed_symbol_2 + gensymed_symbol_3;
	      ISVREF(connection,(SI_Long)5L) = FIX(temp_3);
	  }
	  else {
	      temp = TRUEP(Noting_changes_to_kb_p);
	      if (temp);
	  ...
	  if (make_transient_qm) {
	      temp_3 = IFIX(ISVREF(connection,(SI_Long)7L)) | (SI_Long)64L;
	      ISVREF(connection,(SI_Long)7L) = FIX(temp_3);
	  }
	  if (SIMPLE_VECTOR_P(connection_frame_or_class) && 
		  IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(connection_frame_or_class)) 
    ...
    Object block, connection_to_be_replaced, new_connection;
{
    ...
    Object input_port_connection, old_single_item;
    ...
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)6L) : Nil;
    gensymed_symbol = CDR(gensymed_symbol);
    gensymed_symbol_1 = connection_to_be_replaced;
    gensymed_symbol_2 = SXHASH_SYMBOL_1(connection_to_be_replaced) & 
	    IFIX(Most_positive_fixnum);
    gensymed_symbol_3 = (SI_Long)0L;
  next_loop:
    if ( !TRUEP(gensymed_symbol))
  ...
  end_loop:
    temp = Qnil;
  end_2:;
    connection_to_be_replaced_duplicated_qm = ISVREF(temp,(SI_Long)3L);
    side = Nil;
    position_1 = Nil;
	...
	if (input_names || output_names) {
	  ...
	  next_loop_4:
		...
		if (EQ(side,CAR(temp))) {
		    temp = CDDDDR(spec);
		    temp_1 = FIXNUM_EQ(position_on_side,CAR(temp));
		}
		else
		    temp_1 = TRUEP(Nil);
		if (temp_1) {
		    svref_new_value = 
			    copy_list_using_gensym_conses_1(input_names);
		...
		if (temp_1) {
		    svref_new_value = 
			    copy_list_using_gensym_conses_1(output_names);
		    SVREF(new_connection_item,FIX((SI_Long)2L)) = 
			    svref_new_value;
		}
	    }
	...
	if (temp_1) {
	  ...
	  end_8:;
	    ...
	    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		    (SI_Long)6L) : Nil;
	    gensymed_symbol = CDR(gensymed_symbol);
	    gensymed_symbol_1 = new_connection;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(new_connection) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_9:
	    if ( !TRUEP(gensymed_symbol))
		...
		gensymed_symbol_4 = M_CAR(M_CAR(gensymed_symbol));
		if (EQ(gensymed_symbol_1,gensymed_symbol_4)) {
		    old_single_item = M_CDR(M_CAR(gensymed_symbol));
		    goto end_9;
		}
		gensymed_symbol = M_CDR(gensymed_symbol);
		goto next_loop_10;
	      end_loop_10:
		old_single_item = Qnil;
	      end_9:;
		goto end_10;
	    }
	    goto next_loop_9;
	  ...
	  end_10:;
	    ...
	    delete_balanced_binary_tree_entry(SYMBOL_FUNCTION(Qeq),
		    connection_to_be_replaced,temp,
...
Object get_port_name_given_block_and_connection varargs_1(int, n)
{
    ...
    Object input_or_output, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, connection_item, names;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    Declare_varargs_nonrelocating;
...
{
    Object connection, gensymed_symbol, connections, gensymed_symbol_1;
    Object gensymed_symbol_4, connection_item, temp_1, temp_2, slot_group_qm;
    Object new_cons, connection_table, temp_3, workspace_qm;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;
	...
	gensymed_symbol_2 = SXHASH_SYMBOL_1(connection_to_be_added) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop_2:
	if ( !TRUEP(gensymed_symbol))
...
{
    Object gensymed_symbol, connection_item_table, gensymed_symbol_1;
    Object gensymed_symbol_4, connection_item;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
	...
	gensymed_symbol = CDR(connection_item_table);
	gensymed_symbol_1 = connection_to_be_deleted;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(connection_to_be_deleted) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
    ...
    Object connection_color_change_pattern;
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,3);
      ...
      new_color_pattern = copy_tree_using_gensym_conses_1(old_color_pattern);
      cross_section_pattern = ISVREF(connection_frame_1,(SI_Long)20L);
      temp = CAAR(cross_section_pattern);
      cross_section_stripes = copy_tree_using_gensym_conses_1(CONSP(temp) ?
	...
	if ( !TRUEP(any_changes_noticed_qm)) {
	    ...
	    reclaim_gensym_tree_1(cross_section_stripes);
	}
	else {
		...
		change_slot_value(3,connection_frame_1,
			...
			gensym_cons_1(new_color_pattern,
    ...
    Object connection_frame_1, note_as_kb_state_change_qm, new_color;
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,3);
      ...
      new_cross_section_regions = 
	      copy_tree_using_gensym_conses_1(CONSP(temp) ? 
    ...
    end_loop_1:;
      ...
      PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	      2);
	if ( !TRUEP(any_changes_noticed_qm)) {
	    reclaim_gensym_tree_1(new_cross_section_regions);
	    result = reclaim_gensym_tree_1(new_cross_section_stripes);
	}
	else {
	    if (EQ(Current_drawing_transfer_mode,Kpaint_infered_from_xor) 
		    && EQ(Current_drawing_priority,
		...
		change_slot_value(3,connection_frame_1,
			...
			gensym_cons_1(new_cross_section_regions,
			new_cross_section_stripes) : 
			new_cross_section_stripes);
		if (workspace_qm) {
...
Object Chain_of_available_connection_subrectangle_structures = UNBOUND;

Object Connection_subrectangle_structure_count = UNBOUND;
    ...
    Object connection_subrectangle_structure;
{
    ...
    svref_new_value = Chain_of_available_connection_subrectangle_structures;
    SVREF(connection_subrectangle_structure,FIX((SI_Long)0L)) = 
	    svref_new_value;
    Chain_of_available_connection_subrectangle_structures = 
	    connection_subrectangle_structure;
    return VALUES_1(Nil);
}
...
Object make_permanent_connection_subrectangle_structure_structure_internal()
{
    ...
    Object connection_subrectangle_structure_count_new_value;
    ...
    connection_subrectangle_structure_count_new_value = 
	    FIXNUM_ADD1(Connection_subrectangle_structure_count);
...
Object Minimum_distance_between_fins = UNBOUND;

Object Desired_distance_between_fins = UNBOUND;

Object Desired_distance_between_fins_on_link = UNBOUND;

Object Default_fin_length = UNBOUND;
...
Object connection_fin_length varargs_1(int, n)
{
    ...
    Object cross_section_pattern, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, temp_1, temp_2, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value;
    Object cross_section_stripe, width, ab_loop_list_, ab_loopvar_;
    Object ab_loop_desetq_;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, fin_length, temp_3;
    char temp;
    Declare_varargs_nonrelocating;
    ...
    Object connection;
{
    ...
    Object kb_specific_value, resulting_value, cross_section_stripes, color;
    Object width, ab_loop_list_, ab_loopvar_, ab_loop_desetq_;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;
...
Object Orientation_horizontal_p = UNBOUND;

Object Init_orientation_horizontal_p = UNBOUND;

Object Current_delta = UNBOUND;

Object Cumulative_x_scaled_connection_stripe_width = UNBOUND;

Object Cumulative_y_scaled_connection_stripe_width = UNBOUND;

Object Cumulative_x_scaled_connection_stripe_half_width = UNBOUND;

Object Cumulative_y_scaled_connection_stripe_half_width = UNBOUND;
    ...
    Object cross_section_pattern;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    ab_loopvar__2 = 
	    gensym_cons_1(make_connection_subrectangle_structure_1(width),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  next_loop_1:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    reversed_list = gensym_cons_1(subrectangle_structure,reversed_list);
    goto next_loop_1;
  end_loop_1:
    ...
    reverse_list = Qnil;
  end_2:;
    return gensym_cons_1(forward_list,reverse_list);
}
    ...
    Object connection_subrectangle_structures;
{
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(forward_list);
	reclaim_gensym_list_1(CDR(connection_subrectangle_structures));
	return reclaim_gensym_cons_1(connection_subrectangle_structures);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object initial_orientation_horizontal_p;
{
    ...
    PUSH_SPECIAL(Current_delta,current_delta,1);
	  ...
	  if (initial_orientation_horizontal_p) {
	      ...
	      PUSH_SPECIAL(Orientation_horizontal_p,orientation_horizontal_p,
		      0);
...
Object Global_draw_diagonally_qm = UNBOUND;
    ...
    Object connection, change_to_this_color_or_color_pattern_qm;
{
    ...
    Object ab_loop_desetq_, temp_1, svref_arg_1, gensym_push_modify_macro_arg;
    Object car_1, cdr_1, svref_new_value, current_drawing_transfer_mode;
    char temp, already_in_synch;
    Declare_special(1);

    x_note_fn_call(99,67);
    connection_frame_or_class = ISVREF(connection,(SI_Long)1L);
    if (SIMPLE_VECTOR_P(connection_frame_or_class) && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(connection_frame_or_class)) > 
	    (SI_Long)2L &&  !EQ(ISVREF(connection_frame_or_class,
	...
	if (temp) {
		...
		if (Currently_working_on_drawing_workspace) {
		  ...
		  end_1:;
			...
			gensym_push_modify_macro_arg = 
				gensym_list_4(SYMBOL_FUNCTION(Qdraw_connection_frame_in_xor),
				connection,
		...
		if ( !temp) {
		    svref_arg_1 = Current_image_plane;
		    gensym_push_modify_macro_arg = 
			    gensym_list_4(SYMBOL_FUNCTION(Qdraw_connection_structure_in_xor),
			    connection,
			    copy_frame_serial_number(ISVREF(connection,
			    (SI_Long)10L)),
			    change_to_this_color_or_color_pattern_qm);
...
Object Buggy_polyline_p = UNBOUND;
    ...
    Object connection, change_to_this_color_or_color_pattern_qm;
{
    ...
    PUSH_SPECIAL(Cumulative_x_scaled_connection_stripe_width,cumulative_x_scaled_connection_stripe_width,
	    7);
      cumulative_y_scaled_connection_stripe_width = Nil;
      PUSH_SPECIAL(Cumulative_y_scaled_connection_stripe_width,cumulative_y_scaled_connection_stripe_width,
	      6);
	cumulative_x_scaled_connection_stripe_half_width = Nil;
	PUSH_SPECIAL(Cumulative_x_scaled_connection_stripe_half_width,cumulative_x_scaled_connection_stripe_half_width,
		5);
	  cumulative_y_scaled_connection_stripe_half_width = Nil;
	  PUSH_SPECIAL(Cumulative_y_scaled_connection_stripe_half_width,cumulative_y_scaled_connection_stripe_half_width,
		  4);
	    init_orientation_horizontal_p = initial_orientation_horizontal_p;
	    PUSH_SPECIAL(Init_orientation_horizontal_p,init_orientation_horizontal_p,
		    3);
	      stable_axis_position = Nil;
	      variable_axis_begin_position = Nil;
	      variable_axis_end_position = Nil;
    ...
    Object connection, change_to_this_color_or_color_pattern_qm;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp_1;
    Object temp_2, new_cons, global_properties, kb_properties;
    Object kb_specific_value, resulting_value, cross_section_regions;
    Object cross_section_stripes, vertices, total_width, scale, line_pattern;
    Object stripes, nstripes, scaled_line_pattern, connection_has_fins_p;
    ...
    Object connection_overall_width, fin_length;
{
    ...
    x_note_fn_call(99,84);
    SAVE_STACK();
    PUSH_SPECIAL(Orientation_horizontal_p,orientation_horizontal_p,2);
      PUSH_SPECIAL(Current_delta,current_delta,1);
    ...
    Object connection;
{
    ...
    Object ab_loop_list_, ab_loopvar_, ab_loop_desetq_, size, arrows, arrow;
    Object ab_loopvar__1, ab_loop_maxmin_fl_;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp;

    x_note_fn_call(99,101);
    connection_frame_or_class = ISVREF(connection,(SI_Long)1L);
    if (SIMPLE_VECTOR_P(connection_frame_or_class) && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(connection_frame_or_class)) > 
	    (SI_Long)2L &&  !EQ(ISVREF(connection_frame_or_class,
  ...
  end_17:;
    ...
    arrows = connection_arrows_of_connection(connection);
    gensymed_symbol_2 = IFIX(width);
    if (EQ(arrows,Qnone))
	gensymed_symbol_3 = IFIX(width);
    else if ( !TRUEP(arrows) &&  !((SI_Long)0L != (IFIX(ISVREF(connection,
	    (SI_Long)7L)) & (SI_Long)1L)))
	gensymed_symbol_3 = IFIX(width) + IFIX(size) * (SI_Long)2L;
    else if (ATOM(arrows))
	gensymed_symbol_3 = IFIX(size);
    else {
	arrow = Nil;
	ab_loop_list_ = arrows;
	ab_loopvar_ = FIX((SI_Long)0L);
    ...
    return VALUES_1(FIX(MAX(gensymed_symbol_2,gensymed_symbol_3)));
}
	  ...
	  if (NUMBERP(delta_or_deltas_qm)) {
		...
		if ( !TRUEP(ab_loop_iter_flag_))
		    Orientation_horizontal_p =  
			    !TRUEP(Orientation_horizontal_p) ? T : Nil;
		ab_loopvar__1 = 
			gensym_cons_1(adjust_delta_according_to_new_orientation(delta,
		...
		goto next_loop_3;
	      end_loop_3:
		reclaim_gensym_list_1(delta_or_deltas_qm);
		temp_1 = TRUEP(Noting_changes_to_kb_p);
		if (temp_1);
		else {
...
void connect2_INIT()
{
    ...
    Object Qglobal_draw_diagonally_qm;
    ...
    Object Qdefault_fin_length, Qdesired_distance_between_fins_on_link;
    Object Qdesired_distance_between_fins, Qminimum_distance_between_fins;
    ...
    Object Qutilities2, Qconnection_subrectangle_structure_count;
    Object Qchain_of_available_connection_subrectangle_structures;
    ...
    Object Qcleanup, Qcleanup_for_connection, Qdefault_stub_length;
    Object Qstub_length_to_use_qm;

    x_note_fn_call(99,131);
    SET_PACKAGE("AB");
    ...
    string_constant_2 = 
	    STATIC_STRING("43Dy8m83gJy1n83gJy8n8k1l8n0000001l1n8y83-3Oy1l83-E=yktk0k0");
    ...
    Qconnection_subrectangle_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_3 = STATIC_STRING("1q83gJy8s83-O2y09k9l");
