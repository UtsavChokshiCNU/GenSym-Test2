    ...
    Object ws;
{
  ...
  next_loop:
	...
	goto end_loop;
    item = ISVREF(ab_next_queue_element_,(SI_Long)2L);
    ...
    Object class_name, icp_socket;
{
	...
	svref_new_value = gensym_list_4(Qsocket,icp_socket,Qsession_id,
    ...
    Object text;
{
  ...
  next_loop:
	...
	text_lines = gensym_cons_1(temp,text_lines);
    }
    goto next_loop;
  end_loop:
...
static Object Qcurrent_g2_time;    /* current-g2-time */
    ...
    Object trend_chart;
{
    ...
    initial_info = gensym_cons_1(gensymed_symbol,Qab_structure);
    if (active_p) {
    ...
    Object slider;
{
    ...
    gensymed_symbol = ISVREF(slider,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
    ab_queue_form_ = gensymed_symbol;
    ab_next_queue_element_ = Nil;
  ...
  end_loop:
	...
	additional_properties = 
		gensym_cons_1(gensym_cons_1(gensymed_symbol,Qab_structure),
		additional_properties);
    }
    ...
    Object button;
{
    ...
    Object pruned_interest_list, gensym_cons, temp, sub_class_bit_vector;
    Object temp_2, value_1, amf_available_array_cons_qm, amf_array;
	...
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,2);
	  ...
	  if (gensymed_symbol_1) {
	    ...
	    end_loop:
		  ...
		  gensym_cons = gensymed_symbol_1;
		next_loop_1:
		  inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		  if (EQ(gensym_cons,gensymed_symbol_2))
		      goto end_1;
	  ...
	  if (gensymed_symbol_2) {
		  ...
		  temp_1 = (SI_Long)0L < gensymed_symbol_5;
	      }
	      else
		  temp_1 = TRUEP(Nil);
	  }
	  ...
	  if (temp_1) {
		  ...
		  if (FIXNUMP(value_1))
			  ...
			  (SI_Long)1L)
		      temp_2 = copy_managed_float(value_1);
		  else if (FLOATP(value_1)) {
		      amf_available_array_cons_qm = 
			  ...
			  IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(value_1)) == 
			  (SI_Long)1L)
		      temp_2 = copy_managed_long(value_1);
		  else if (INLINE_LONG_P(value_1) != (SI_Long)0L)
		      temp_2 = make_evaluation_long(value_1);
		  else if (text_string_p(value_1))
		      temp_2 = copy_as_wide_string(value_1);
		  else if (CONSP(value_1) && EQ(M_CDR(value_1),Qtruth_value)) {
			  ...
			  temp_2 = gensym_cons_1(gensymed_symbol_1,
				  Qtruth_value);
		  }
		  else
    ...
    Object slider;
{
    ...
    Object variables_that_did_not_have_values, current_computation_frame;
    Object gensymed_symbol_2, gensymed_symbol_3, gensymed_symbol_4;
    Object pruned_interest_list, gensym_cons, temp_1;
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		end_loop:
		  ...
		  M_CDR(gensymed_symbol_2) = temp_1;
		  Available_gensym_conses = gensymed_symbol_1;
	      }
	      CONTINUE_UNWINDING(0);
	      if (expiration_qm && EQ(type,Qtext))
		  ...
		  if (FIXNUM_EQ(gensymed_symbol_1,Truth))
		      ...
		      temp = gensym_cons_1(gensymed_symbol_1,Qtruth_value);
	      }
	      else
    ...
    Object item;
{
	...
	reclaim_gensym_tree_1(color_pattern);
    ...
    Object item, new_color_pattern_structure;
{
    ...
    PUSH_SPECIAL(Note_as_kb_state_change_qm,note_as_kb_state_change_qm,0);
	  ...
	  temp = reclaim_gensym_tree_1(new_color_pattern_or_error);
      else {
    ...
    Object connection;
{
	...
	temp = gensym_cons_1(FIX(gensymed_symbol),Qtruth_value);
    return VALUES_1(temp);
}
...
Object get_workspace_representation_type_for_chart(chart)
    Object chart;
{
    x_note_fn_call(229,98);
    return VALUES_1(Qchart);
}
    ...
    Object thing, representation_type_name;
{
	...
	additional_properties = gensym_cons_1(gensymed_symbol,Qab_structure);
    }
    ...
    Object connection;
{
  ...
  next_loop:
    ...
    y = CDR(temp);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    tmplist = gensym_cons_1(x,tmplist);
    tmplist = gensym_cons_1(FIXNUM_NEGATE(y),tmplist);
    goto next_loop;
  end_loop:
    ...
    Object color_pattern;
{
  ...
  next_loop:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    if (color) {
	color_pattern_list = gensym_cons_1(region,color_pattern_list);
	color_pattern_list = gensym_cons_1(color,color_pattern_list);
    }
    goto next_loop;
  end_loop:
    ...
    Object color_pattern_structure;
{
  ...
  next_loop:
	...
	color_pattern = gensym_cons_1(gensym_cons_1(region,color),
		color_pattern);
    else
...
{
    x_note_fn_call(229,124);
    reclaim_gensym_list_1(workspaces);
    return VALUES_1(Nil);
}
    ...
    Object interface_1, client_session;
{
    ...
    x_note_fn_call(229,125);
    if ( !((SI_Long)0L != (IFIX(ISVREF(interface_1,(SI_Long)5L)) & 
	    (SI_Long)512L))) {
	temp = delete_gensym_element_1(client_session,ISVREF(interface_1,
		(SI_Long)26L));
    ...
    Object start_date, end_date, desired_license_level;
{
    ...
    PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
      ...
      return_from_system_defined_rpc(rpc_instance,
	      gensym_cons_1(authorized_qm ? Evaluation_true_value : 
	      error_symbol_qm,Nil));
    POP_SPECIAL();
    return VALUES_1(Nil);
}
    ...
    Object workspace_showing_callback_qm;
{
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    result = gensym_cons_1(gensymed_symbol_1,Qab_structure);
	    MVS_2(result,gensymed_symbol_1,gensymed_symbol_2);
	    return_list = gensym_cons_1(gensymed_symbol_1,Nil);
	    result = return_from_system_defined_rpc(gensymed_symbol,
		    return_list);
    ...
    Object os_type, time_of_connection;
{
	...
	gensym_modify_macro_using_test_arg_1 = session;
	car_1 = gensym_modify_macro_using_test_arg_1;
...
{
    Object already_there_qm, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object svref_new_value;

    x_note_fn_call(229,154);
    ...
    Object ui_client_session, workspace;
{
    ...
    x_note_fn_call(229,155);
    if (find(2,workspace,ISVREF(ui_client_session,(SI_Long)27L))) {
	svref_new_value = delete_gensym_element_1(workspace,
    ...
    Object client_item;
{
	...
	if (FIXNUM_EQ(gensymed_symbol,Truth))
	    ...
	    temp_1 = gensym_cons_1(gensymed_symbol,Qtruth_value);
    }
    else {
	sub_class_bit_vector = ISVREF(gensymed_symbol,(SI_Long)19L);
	superior_class_bit_number = 
...
Object Local_ui_client_test_mode_p = UNBOUND;
...
Object update_ui_client_for_show varargs_1(int, n)
{
    ...
    Object svref_new_value, structure, temp_2, amf_available_array_cons_qm;
    Object amf_array, amf_result, incff_1_arg, new_float, argument_list;
    Object address, socket_1;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    SI_Long svref_arg_2;
    char temp;
  ...
  next_loop_1:
	...
	structure = gensym_cons_1(gensymed_symbol_5,Qab_structure);
	if (symbolic_x_scale_qm) {
	    if (FIXNUMP(symbolic_x_scale_qm))
		temp_2 = symbolic_x_scale_qm;
		...
		temp_2 = symbolic_x_scale_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_x_scale_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_x_scale_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_x_scale_qm);
	    else if (INLINE_LONG_P(symbolic_x_scale_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_x_scale_qm);
	    else if (text_string_p(symbolic_x_scale_qm))
		temp_2 = copy_as_wide_string(symbolic_x_scale_qm);
		...
		if (FIXNUM_EQ(gensymed_symbol_5,Truth))
		    ...
		    temp_2 = gensym_cons_1(gensymed_symbol_5,Qtruth_value);
	    }
	    else
		temp_2 = error((SI_Long)2L,
			"Bad type ~a for make-evaluation-value-based-on-type.",
			type_of(symbolic_x_scale_qm));
	    set_evaluation_structure_slot(structure,Qsymbolic_x_scale,temp_2);
	}
	if (symbolic_y_scale_qm) {
	    if (FIXNUMP(symbolic_y_scale_qm))
		temp_2 = symbolic_y_scale_qm;
		...
		temp_2 = symbolic_y_scale_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_y_scale_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_y_scale_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_y_scale_qm);
	    else if (INLINE_LONG_P(symbolic_y_scale_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_y_scale_qm);
	    else if (text_string_p(symbolic_y_scale_qm))
		temp_2 = copy_as_wide_string(symbolic_y_scale_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qsymbolic_y_scale,temp_2);
	}
	if (symbolic_x_in_workspace_qm) {
	    if (FIXNUMP(symbolic_x_in_workspace_qm))
		temp_2 = symbolic_x_in_workspace_qm;
		...
		temp_2 = symbolic_x_in_workspace_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_x_in_workspace_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_x_in_workspace_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_x_in_workspace_qm);
	    else if (INLINE_LONG_P(symbolic_x_in_workspace_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_x_in_workspace_qm);
	    else if (text_string_p(symbolic_x_in_workspace_qm))
		temp_2 = copy_as_wide_string(symbolic_x_in_workspace_qm);
	...
	if (symbolic_y_in_workspace_qm) {
		...
		temp_2 = symbolic_y_in_workspace_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_y_in_workspace_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_y_in_workspace_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_y_in_workspace_qm);
	    else if (INLINE_LONG_P(symbolic_y_in_workspace_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_y_in_workspace_qm);
	    else if (text_string_p(symbolic_y_in_workspace_qm))
		temp_2 = copy_as_wide_string(symbolic_y_in_workspace_qm);
	    ...
	    set_evaluation_structure_slot(structure,
		    Qsymbolic_y_in_workspace,temp_2);
	}
	if (symbolic_x_in_window_qm) {
	    if (FIXNUMP(symbolic_x_in_window_qm))
		temp_2 = symbolic_x_in_window_qm;
		...
		temp_2 = symbolic_x_in_window_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_x_in_window_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_x_in_window_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_x_in_window_qm);
	    else if (INLINE_LONG_P(symbolic_x_in_window_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_x_in_window_qm);
	    else if (text_string_p(symbolic_x_in_window_qm))
		temp_2 = copy_as_wide_string(symbolic_x_in_window_qm);
	...
	if (symbolic_y_in_window_qm) {
		...
		temp_2 = symbolic_y_in_window_qm;
		...
		temp_2 = symbolic_y_in_window_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_y_in_window_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_y_in_window_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_y_in_window_qm);
	    else if (INLINE_LONG_P(symbolic_y_in_window_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_y_in_window_qm);
	    else if (text_string_p(symbolic_y_in_window_qm))
		temp_2 = copy_as_wide_string(symbolic_y_in_window_qm);
	...
	if (x_offset_units_qm) {
		...
		temp_2 = x_offset_units_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(x_offset_units_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(x_offset_units_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(x_offset_units_qm);
	    else if (INLINE_LONG_P(x_offset_units_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(x_offset_units_qm);
	    else if (text_string_p(x_offset_units_qm))
		temp_2 = copy_as_wide_string(x_offset_units_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qx_offset_units,temp_2);
	}
	if (y_offset_units_qm) {
	    if (FIXNUMP(y_offset_units_qm))
		temp_2 = y_offset_units_qm;
		...
		temp_2 = y_offset_units_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(y_offset_units_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(y_offset_units_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(y_offset_units_qm);
	    else if (INLINE_LONG_P(y_offset_units_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(y_offset_units_qm);
	    else if (text_string_p(y_offset_units_qm))
		temp_2 = copy_as_wide_string(y_offset_units_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qy_offset_units,temp_2);
	}
	if (symbolic_x_offset_direction_qm) {
	    if (FIXNUMP(symbolic_x_offset_direction_qm))
		temp_2 = symbolic_x_offset_direction_qm;
		...
		temp_2 = symbolic_x_offset_direction_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_x_offset_direction_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_x_offset_direction_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_x_offset_direction_qm);
	    else if (INLINE_LONG_P(symbolic_x_offset_direction_qm) != 
		    (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_x_offset_direction_qm);
	    else if (text_string_p(symbolic_x_offset_direction_qm))
		temp_2 = copy_as_wide_string(symbolic_x_offset_direction_qm);
	...
	if (symbolic_y_offset_direction_qm) {
		...
		temp_2 = symbolic_y_offset_direction_qm;
		    ...
		    == (SI_Long)1L)
		temp_2 = copy_managed_float(symbolic_y_offset_direction_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(symbolic_y_offset_direction_qm)) 
		    == (SI_Long)1L)
		temp_2 = copy_managed_long(symbolic_y_offset_direction_qm);
	    else if (INLINE_LONG_P(symbolic_y_offset_direction_qm) != 
		    (SI_Long)0L)
		temp_2 = make_evaluation_long(symbolic_y_offset_direction_qm);
	    else if (text_string_p(symbolic_y_offset_direction_qm))
		temp_2 = copy_as_wide_string(symbolic_y_offset_direction_qm);
	    ...
	    set_evaluation_structure_slot(structure,
		    Qsymbolic_y_offset_direction,temp_2);
	}
	if (x_magnification_qm) {
	    if (FIXNUMP(x_magnification_qm))
		temp_2 = x_magnification_qm;
		...
		temp_2 = x_magnification_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(x_magnification_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(x_magnification_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(x_magnification_qm);
	    else if (INLINE_LONG_P(x_magnification_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(x_magnification_qm);
	    else if (text_string_p(x_magnification_qm))
		temp_2 = copy_as_wide_string(x_magnification_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qx_magnification,temp_2);
	}
	if (y_magnification_qm) {
	    if (FIXNUMP(y_magnification_qm))
		temp_2 = y_magnification_qm;
		...
		temp_2 = y_magnification_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(y_magnification_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(y_magnification_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(y_magnification_qm);
	    else if (INLINE_LONG_P(y_magnification_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(y_magnification_qm);
	    else if (text_string_p(y_magnification_qm))
		temp_2 = copy_as_wide_string(y_magnification_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qy_magnification,temp_2);
	}
	if (x_in_workspace_qm) {
	    if (FIXNUMP(x_in_workspace_qm))
		temp_2 = x_in_workspace_qm;
		...
		temp_2 = x_in_workspace_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(x_in_workspace_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(x_in_workspace_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(x_in_workspace_qm);
	    else if (INLINE_LONG_P(x_in_workspace_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(x_in_workspace_qm);
	    else if (text_string_p(x_in_workspace_qm))
		temp_2 = copy_as_wide_string(x_in_workspace_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qx_in_workspace,temp_2);
	}
	if (y_in_workspace_qm) {
	    if (FIXNUMP(y_in_workspace_qm))
		temp_2 = y_in_workspace_qm;
		...
		temp_2 = y_in_workspace_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(y_in_workspace_qm);
		...
		temp_2 = new_float;
		    ...
		    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(y_in_workspace_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(y_in_workspace_qm);
	    else if (INLINE_LONG_P(y_in_workspace_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(y_in_workspace_qm);
	    else if (text_string_p(y_in_workspace_qm))
		temp_2 = copy_as_wide_string(y_in_workspace_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qy_in_workspace,temp_2);
	}
	if (x_in_window_qm) {
	    if (FIXNUMP(x_in_window_qm))
		temp_2 = x_in_window_qm;
		...
		temp_2 = x_in_window_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(x_in_window_qm);
		...
		temp_2 = new_float;
		    ...
		    && IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(x_in_window_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(x_in_window_qm);
	    else if (INLINE_LONG_P(x_in_window_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(x_in_window_qm);
	    else if (text_string_p(x_in_window_qm))
		temp_2 = copy_as_wide_string(x_in_window_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qx_in_window,temp_2);
	}
	if (y_in_window_qm) {
	    if (FIXNUMP(y_in_window_qm))
		temp_2 = y_in_window_qm;
		...
		temp_2 = y_in_window_qm;
		    ...
		    (SI_Long)1L)
		temp_2 = copy_managed_float(y_in_window_qm);
		...
		temp_2 = new_float;
		    ...
		    && IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(y_in_window_qm)) == 
		    (SI_Long)1L)
		temp_2 = copy_managed_long(y_in_window_qm);
	    else if (INLINE_LONG_P(y_in_window_qm) != (SI_Long)0L)
		temp_2 = make_evaluation_long(y_in_window_qm);
	    else if (text_string_p(y_in_window_qm))
		temp_2 = copy_as_wide_string(y_in_window_qm);
	    ...
	    set_evaluation_structure_slot(structure,Qy_in_window,temp_2);
	}
    ...
    Object module_information_callback, module_information_callback_data;
{
	...
	next_loop:
	  ...
	  ab_loopvar__1 = ISVREF(ab_loopvar__1,(SI_Long)6L);
	  ab_loopvar__4 = 
		  gensym_cons_1(make_new_module_info_structure(module_info,
    ...
    result_1 = gensym_cons_1(gensymed_symbol,Qab_structure);
    return VALUES_1(result_1);
}
    ...
    Object module_name;
{
	...
	next_loop:
	  ...
	  if ( !TRUEP(ISVREF(workspace,(SI_Long)18L)) && EQ(module_name,
	      ...
	      ab_loopvar__3 = gensym_cons_1(workspace,Nil);
	      if (ab_loopvar__2)
    ...
    Object module_info, ui_client_interface;
{
    ...
    name_denotation_sequence = 
	    allocate_evaluation_sequence(gensym_cons_1(gensym_cons_1(gensymed_symbol,
	    Qab_structure),Nil));
    gensymed_symbol = allocate_managed_array(1,FIX((SI_Long)4L + (SI_Long)1L));
    gensymed_symbol_1 = (SI_Long)0L;
    if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
    ...
    PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
      ...
      if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
	      Maximum_in_place_array_size)) {
	  item_or_value = 
		  allocate_evaluation_sequence(gensym_list_2(name_subscription_handle,
		  required_modules_subscription_handle));
	  if (SIMPLE_VECTOR_P(item_or_value) && 
		  IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
		  (SI_Long)2L &&  !EQ(ISVREF(item_or_value,(SI_Long)1L),
	...
	next_loop:
	  ...
	  if ( !EQ(table_name,Qmodule_information)) {
	      ab_loopvar__2 = gensym_cons_1(SYMBOL_VALUE(table_name),Nil);
	      if (ab_loopvar__1)
		  M_CDR(ab_loopvar__1) = ab_loopvar__2;
	      else
		  ab_loopvar_ = ab_loopvar__2;
	...
	end_2:;
      ...
      module_structure = gensym_cons_1(gensymed_symbol,Qab_structure);
      name_representation = 
      ...
      gensym_modify_macro_using_test_arg_1 = name_representation;
      car_1 = gensym_modify_macro_using_test_arg_1;
    ...
    end_loop_2:
      temp_1 = TRUEP(Qnil);
    end_3:;
      temp = temp_1 ? cdr_1 : gensym_cons_1(car_1,cdr_1);
      ISVREF(ui_client_interface,(SI_Long)25L) = temp;
      gensym_modify_macro_using_test_arg_1 = required_modules_representation;
      car_1 = gensym_modify_macro_using_test_arg_1;
      cdr_1 = ISVREF(ui_client_interface,(SI_Long)25L);
      key_result = car_1;
      x_element = Nil;
    ...
    Object ui_client_interface;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(ISVREF(ui_client_interface,(SI_Long)25L));
    ...
    Object module_info, ui_client_interface;
{
    ...
    x_note_fn_call(229,199);
    callback_qm = ISVREF(ui_client_interface,(SI_Long)21L);
    if (callback_qm && 
	    get_lookup_slot_value_given_default(ui_client_interface,
	    Qgsi_interface_icp_socket,Nil)) {
	arg_list = gensym_list_2(Qcreate,
    ...
    Object module_info;
{
	...
	end_loop_3:;
	  ...
	  if (callback_qm && 
		  get_lookup_slot_value_given_default(ui_client_interface,
		  Qgsi_interface_icp_socket,Nil)) {
	      arg_list = gensym_list_2(Qdelete,module_info);
	      temp_1 = 
		      get_lookup_slot_value_given_default(ui_client_interface,
		      Qgsi_interface_icp_socket,Nil);
...
Object inform_ui_client_interfaces_of_clear_kb()
{
	...
	end_loop:
	  ...
	  arg_list = gensym_list_2(Qclear_kb,Nil);
    ...
    Object update_type, data;
{
	...
	end_loop:
      ...
      if (callback_qm && icp_socket_qm && FIXNUM_NE(ISVREF(icp_socket_qm,
	      (SI_Long)15L),Icp_connection_closed)) {
	  arg_list = gensym_list_2(update_type,data);
	  start_remote_representation_callback(icp_socket_qm,callback_qm,
		  arg_list);
      }
      goto next_loop;
    ...
    Object progress_frame;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_list_2(temp,FIXNUMP(thing) || thing && 
...
Object note_update_to_file_progress varargs_1(int, n)
{
	...
	end_loop:
	  ...
	  start_remote_representation_callback(temp_1,temp_2,
		  gensym_list_2(temp_3,EQ(change,Qdelete) ? 
		  Evaluation_true_value : Evaluation_false_value));
      }
      goto next_loop;
    end_loop_1:
...
Object Current_t2_dialog_sequence_number = UNBOUND;
...
Object T2_dialog_result_alist = UNBOUND;
...
Object enter_dialog_for_t2 varargs_1(int, n)
{
  ...
  end_1:;
    ...
    reclaim_gensym_list_1(dialog_as_eval_list);
    ...
    Object sequence_number;
{
	...
	if (EQ(type,Qcheck_box)) {
	    ab_loopvar__1 = gensym_cons_1(gensym_cons_1(name,CONSP(value) 
		    && EQ(M_CDR(value),Qtruth_value) ? (EQ(M_CAR(value),
		    Truth) ? T : Nil) : Qnil),Nil);
	    if (ab_loopvar_)
		M_CDR(ab_loopvar_) = ab_loopvar__1;
	    else
...
{
    Object callback_qm, icp_socket_qm, gensym_push_modify_macro_arg, car_1;
    Object cdr_1, temp, gensymed_symbol, gensymed_symbol_1;

    x_note_fn_call(229,215);
	...
	if (icp_socket_qm && FIXNUM_NE(ISVREF(icp_socket_qm,(SI_Long)15L),
		Icp_connection_closed)) {
	    gensym_push_modify_macro_arg = gensym_list_3(sequence_number,
		    dialog_name,CONSP(continuation) ? 
		    copy_list_using_gensym_conses_1(continuation) : 
		    continuation);
	    car_1 = gensym_push_modify_macro_arg;
    ...
    Object update_type;
{
	...
	if (dialog_info) {
		...
		if (FIXNUM_LE(ISVREF(gensymed_symbol_2,(SI_Long)1L),
			Maximum_in_place_array_size)) {
		    item_or_value = 
			    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(new_info_list));
		    if (SIMPLE_VECTOR_P(item_or_value) && 
			    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) 
			    > (SI_Long)2L &&  !EQ(ISVREF(item_or_value,
			    (SI_Long)1L),Qavailable_frame_vector)) {
		...
		temp = 
			allocate_evaluation_sequence(gensym_cons_1(gensym_cons_1(gensymed_symbol_2,
			Qab_structure),Nil));
		M_CAR(gensymed_symbol_1) = temp;
    ...
    Object ui_client_interface, client_item_qm, sequence_number;
{
    ...
    x_note_fn_call(229,220);
    callback_qm = ISVREF(ui_client_interface,(SI_Long)29L);
    if (callback_qm) {
	a = assoc_eql(sequence_number,ISVREF(ui_client_interface,
		(SI_Long)31L));
	if (a) {
	    svref_new_value = delete_gensym_element_1(a,
    ...
    Object dialog_sequence_number, ui_client_interface;
{
    ...
    x_note_fn_call(229,221);
    dialog_info = assoc_eql(dialog_sequence_number,
	    ISVREF(ui_client_interface,(SI_Long)31L));
    continuation = CADDR(dialog_info);
    svref_new_value = delete_gensym_element_1(dialog_info,
	    ISVREF(ui_client_interface,(SI_Long)31L));
    ISVREF(ui_client_interface,(SI_Long)31L) = svref_new_value;
    reclaim_gensym_list_1(dialog_info);
    temp = CONSP(continuation) ? reclaim_gensym_list_1(continuation) : Nil;
    return VALUES_1(temp);
}
    ...
    Object gensymed_symbol, filestring;
{
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    gensymed_symbol_7 = make_gensym_list_1(FIX((SI_Long)6L));
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    MVS_3(result,gensymed_symbol_1,gensymed_symbol_2,
		    gensymed_symbol_3);
	    return_list = gensym_list_2(gensymed_symbol_1,gensymed_symbol_2);
	    result = return_from_system_defined_rpc(gensymed_symbol,
		    return_list);
	  POP_SPECIAL();
	POP_SPECIAL();
    ...
    Object log_message_for_commit_after_saving;
{
	...
	PUSH_SPECIAL(Current_system_rpc_icp_socket_qm,current_system_rpc_icp_socket_qm,
	  ...
	  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,0);
	    ...
	    options = gensym_cons_1(gensymed_symbol_1,Qab_structure);
    ...
    Object symbol_tree;
{
  ...
  next_loop:
	...
	if ( !EQ(branch,old_leaf)) {
	    old_leaf = branch;
	    flattened_tree = gensym_cons_1(branch,flattened_tree);
	}
    }
...
void view_g2_INIT()
{
    ...
    string_constant_39 = 
	    STATIC_STRING("1z4z8r8347y8347y83d=y83d=y01l1n83Ry1l83-Gy1l83=hy001o1l8l1l8z1m8p832uy1l83Cy000004z8r8354y8354y83d=y83d=y01l1m83Ry1l836fy001p1l8");
    string_constant_40 = 
	    STATIC_STRING("l1l8z1m8p832uy1l83Cy1l83Ny000004z8r833ty833ty83d=y83d=y08k001p1l8l1l8z1l83Ny1m8p83Ky1l83Cy000004z8r83dBy83dBy83d=y83d=y0833ey001");
    string_constant_41 = 
	    STATIC_STRING("m1l8o1l8l000004z8r83d1y83d1y83d=y83d=y00001m1l8o1l8l000004z8r83d0y83d0y83d=y83d=y00001m1l8o1l8l000004z8r83d6y83d6y83d=y83d=y0000");
    string_constant_42 = 
	    STATIC_STRING("1m1l8o1l8l000004z8r83d5y83d5y83d=y83d=y00001m1l8o1l8l000004z8r83d7y83d7y83d=y83d=y00001m1l8o1l8l000004z8r83dAy83dAy83d=y83d=y000");
    string_constant_43 = 
	    STATIC_STRING("01m1l8o1l8l000004z8r83d9y83d9y83d=y83d=y00001m1l8o1l8l000004z8r83d8y83d8y83d=y83d=y00001m1l8o1l8l000004z8r83d3y83d3y83d=y83d=y00");
    string_constant_44 = 
	    STATIC_STRING("001m1l8o1l8l000004z8r83d2y83d2y83d=y83d=y00001m1l8o1l8l000004z8r83d4y83d4y83d=y83d=y00001m1l8o1l8l00000");
    string_constant_45 = 
	    STATIC_STRING("13Dy8q1o83d=y1l83=8y83Iy8t1q8347y1l1n83Ry1l83-Gy1l83=hy1l8l8z1m8p832uy1l83Cy1q8354y1l1m83Ry1l836fy1l8l8z1m8p832uy1l83Cy1r833ty8k");
    string_constant_46 = 
	    STATIC_STRING("1l8l8z83Ny1m8p83Ky1l83Cy1o83dBy833ey8o8l1o83d1y08o8l1o83d0y08o8l1o83d6y08o8l1o83d5y08o8l1o83d7y08o8l1o83dAy08o8l1o83d9y08o8l1o83");
    string_constant_47 = 
	    STATIC_STRING("d8y08o8l1o83d3y08o8l1o83d2y08o8l1o83d4y08o8l");
    ...
    string_constant_49 = 
	    STATIC_STRING("1l4z8r83a4y83a4y83a3y83a3y08k001m1l8l1l8o00000");
    string_constant_50 = STATIC_STRING("1n8q1n83a3y1l830Xy8t1n83a4y8k8o");
    ...
    string_constant_55 = 
	    STATIC_STRING("1m4z8r83N2y83N2y838Ty838Ty00001m1l8l1l83Cy000004z8r83Tjy83Tjy838Ty838Ty00001n1l8l1l83Cy1l83Uy00000");
    string_constant_56 = 
	    STATIC_STRING("1o8q1p838Ty1l835Iy1m8v838Ty83Ly8t1o83N2y08l83Cy1p83Tjy08l83Cy83Uy");
    ...
    string_constant_59 = 
	    STATIC_STRING("1m8q1q83Mwy1l83Ry1m8v83Ry83Ly83-8y83Iy");
    ...
    check_if_superior_classes_are_defined(Qg2_foreign_serializable,
	    list_constant_199);
    string_constant_60 = 
	    STATIC_STRING("1m8q1q83xZy1l83Mwy1m8v83Ry83Ly83-8y83Iy");
    temp_1 = regenerate_optimized_constant(string_constant_57);
    temp_2 = regenerate_optimized_constant(string_constant_58);
