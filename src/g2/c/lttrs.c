...
Object Chain_of_available_unicode_blocks = UNBOUND;

Object Unicode_block_count = UNBOUND;
    ...
    Object unicode_block;
{
    ...
    svref_new_value = Chain_of_available_unicode_blocks;
    SVREF(unicode_block,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_unicode_blocks = unicode_block;
    return VALUES_1(Nil);
}
...
Object make_permanent_unicode_block_structure_internal()
{
    ...
    unicode_block_count_new_value = FIXNUM_ADD1(Unicode_block_count);
    Unicode_block_count = unicode_block_count_new_value;
...
Object All_unicode_block_names = UNBOUND;
...
void letters_INIT()
{
    ...
    Object Qunicode_block_count, Qchain_of_available_unicode_blocks;
    ...
    string_constant = 
	    STATIC_STRING("43Dy8m83oCy1n83oCy8n8k1l8n0000001l1m8y83-6Gykpk0k0");
    ...
    string_constant_1 = STATIC_STRING("1q83oCy8s83-t5y09k9l");
