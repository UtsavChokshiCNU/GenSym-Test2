...
Object Chain_of_available_compiled_resources = UNBOUND;

Object Compiled_resource_count = UNBOUND;
    ...
    Object compiled_resource;
{
    ...
    svref_new_value = Chain_of_available_compiled_resources;
    SVREF(compiled_resource,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_compiled_resources = compiled_resource;
    return VALUES_1(Nil);
}
...
Object make_permanent_compiled_resource_structure_internal()
{
    ...
    Object compiled_resource_count_new_value;
    ...
    compiled_resource_count_new_value = FIXNUM_ADD1(Compiled_resource_count);
    Compiled_resource_count = compiled_resource_count_new_value;
...
Object decode_resource_from_list(list_1)
    Object list_1;
{
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, temp, temp_1;
    Object temp_2, compiled_resource;
	...
	next_cons = Nil;
    list_1 = next_cons;
    compiled_resource = make_compiled_resource_1(temp,temp_1,temp_2,
	    gensym_pop_store);
    gensym_pop_store = Nil;
    cons_1 = list_1;
    if (cons_1) {
    ...
    Object compiled_resource;
{
    ...
    Object new_float, gensymed_symbol_2, svref_new_value, new_structure;
    Object memory_options_qm, option, ab_loop_list_, ab_loopvar_;
    Object ab_loopvar__1, temp_3, name, value_1;
	...
	if (FIXNUMP(value))
		...
		item_or_value = gensym_cons_1(gensymed_symbol_2,Qtruth_value);
	}
	else
    ...
    new_structure = gensym_cons_1(gensymed_symbol,Qab_structure);
	...
	ab_loopvar__1 = gensym_cons_1(option,Nil);
	if (ab_loopvar_)
	...
	temp_3 = Qnil;
      end_1:;
	set_evaluation_structure_slot(new_structure,Qmemory_options,temp_3);
    }
    name = Nil;
    value_1 = Nil;
    ...
    Object structure, type, name, value;
{
    ...
    Object gensymed_symbol, attr_structure, attr_name, attr_value;
    Object ab_loop_list_, temp_2, control, ab_loopvar_, ab_loopvar__1;
    Object gensymed_symbol_2, native_p, control_type, id, properties;
    Object item_or_value, x2, control_structure, prop_name, prop_value;
	...
	attr_structure = gensym_cons_1(gensymed_symbol,Qab_structure);
	attr_name = Nil;
	attr_value = Nil;
	ab_loop_list_ = value;
	if ( !TRUEP(ab_loop_list_))
	...
	if (EQ(attr_value,Qtrue))
	    ...
	    temp_2 = 
		    allocate_evaluation_sequence(copy_list_using_gensym_conses_1(attr_value));
	else
	    temp_2 = FIXNUMP(attr_value) || attr_value && 
		    SYMBOLP(attr_value) || SIMPLE_VECTOR_P(attr_value) ? 
		    attr_value : copy_if_evaluation_value_1(attr_value);
	set_evaluation_structure_slot(attr_structure,temp,temp_2);
	ab_loop_list_ = CDDR(ab_loop_list_);
	if ( !TRUEP(ab_loop_list_))
	    goto end_loop;
	goto next_loop;
	...
	control_structure = gensym_cons_1(gensymed_symbol_2,Qab_structure);
	prop_name = Nil;
	prop_value = Nil;
	...
	goto next_loop_2;
      end_loop_2:;
	ab_loopvar__1 = gensym_cons_1(control_structure,Nil);
	if (ab_loopvar_)
	    M_CDR(ab_loopvar_) = ab_loopvar__1;
	else
	    gensymed_symbol = ab_loopvar__1;
...
void resources_INIT()
{
    ...
    Object Qcompiled_resource_count, Qchain_of_available_compiled_resources;
    ...
    string_constant = 
	    STATIC_STRING("43Dy8m83g7y1n83g7y8n8k1l8n0000001l1n8y83-3Hy1o83sVy83sWy83sTy83sUyksk0k0");
    ...
    Qcompiled_resource_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_1 = STATIC_STRING("1q83g7y8s83-NPy09k9l");
