    ...
    Object x_in_window, y_in_window;
{
    ...
    establish_next_workstation_context_continuation(Nil,
	    ...
	    gensym_list_2(new_module_information,
...
Object put_up_table_of_network_info()
{
    ...
    Object temp_3, workspace, new_wide_string, temp_4, aref_arg_2_1;
    Object gensym_list_of_wide_strings, string_1, new_cons, gensymed_symbol;
    Object short_string;
    ...
    temp =  !TRUEP(New_g2_classic_ui_p) ? gensym_cons_1(gensym_list_2(Nil,
	    make_text_cell(2,gensym_cons_1(copy_text_string(host_name),
	    Nil),Qclass_format)),Nil) : Nil;
    type_of_network = Nil;
    address = Nil;
    secure_p = Nil;
  ...
  next_loop:
    ...
    secure_p = CAR(temp_1);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp_2 = make_text_cell(2,gensym_cons_1(tformat_text_string(2,
	...
	POP_SPECIAL();
      POP_SPECIAL();
    POP_SPECIAL();
    ab_loopvar__2 = gensym_cons_1(gensym_list_2(temp_2,make_text_cell(2,
	    gensym_cons_1(temp_1,Nil),Qdefault_text_cell_format)),Nil);
    if (ab_loopvar__1)
	M_CDR(ab_loopvar__1) = ab_loopvar__2;
    else
	ab_loopvar_ = ab_loopvar__2;
  ...
  end_1:;
	...
	temp_3 = make_text_cell(2,
		gensym_cons_1(copy_constant_wide_string_given_length(array_constant_16,
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  POP_SPECIAL();
	POP_SPECIAL();
	temp_1 = gensym_cons_1(gensym_list_2(temp_3,make_text_cell(2,
		gensym_cons_1(temp_1,Nil),Qdefault_text_cell_format)),Nil);
    }
    else
	temp_1 = Nil;
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  aref_new_value = (SI_Long)57344L | IFIX(aref_arg_2_1) >> 
			   -  - (SI_Long)16L;
		  UBYTE_16_ISASET_1(temp_4,aref_arg_2,aref_new_value);
		  UBYTE_16_ISASET_1(temp_4,IFIX(aref_arg_2_1),(SI_Long)0L);
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	  POP_SPECIAL();
...
Object compute_module_deletion_choices()
{
  ...
  next_loop:
    ...
    if ( ! !TRUEP(get_slot_value_function(module_information_table,
	    Qtop_level_kb_module_qm,Nil))) {
	ab_loopvar__2 = 
		gensym_cons_1(get_slot_value_function(module_information_table,
...
Object delete_workspace_for_user varargs_1(int, n)
{
	...
	gensymed_symbol_3 = ISVREF(workspace,(SI_Long)14L);
...
Object item_deletion_causes_workspace_deletion_p(item)
    Object item;
{
    Object temp, sub_class_bit_vector, class_name_qm, gensymed_symbol_3;
	...
	if (temp_1) {
		...
		if ( !TRUEP(gensymed_symbol_3)) {
		    ...
		    gensymed_symbol_3 = 
			    ...
			    T,gensymed_symbol_3,temp,gensymed_symbol_4);
		}
    ...
    Object block;
{
    ...
    Object workspace_deletion_qm, class_name_qm, gensymed_symbol_4;
    Object gensymed_symbol_5, temp_1, temp_2, new_cons, global_properties;
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  if (SYMBOLP(class_name_qm)) {
		      ...
		      gensymed_symbol_4 = class_name_qm;
		      gensymed_symbol_1 = SXHASH_SYMBOL_1(class_name_qm) & 
			      IFIX(Most_positive_fixnum);
    ...
    Object block;
{
    ...
    Object ab_loop_it_, gensymed_symbol_4, gensymed_symbol_5, temp_1, temp_2;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, class_name_qm, scope_conses, ab_loopvar_;
    Object ab_loopvar__1, connection_definition;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
    SI_Long gensymed_symbol_1, gensymed_symbol_2;
    char temp;
    Declare_special(1);
	...
	if (temp) {
		...
		if ( !TRUEP(gensymed_symbol_3)) {
		    ...
		    gensymed_symbol_3 = 
			    ...
			    T,gensymed_symbol_3,temp_2,gensymed_symbol_4);
		}
		global_properties = gensymed_symbol_3;
		gensymed_symbol_3 = CDR(global_properties);
		gensymed_symbol_4 = 
...
Object enter_text_editor_on_text_cell varargs_1(int, n)
{
	...
	if ( !edit_in_place_qm) {
	    temp = defining_class_qm ? gensym_cons_1(Qclass_qualified_name,
		    gensym_cons_1(defining_class_qm,
		    gensym_cons_1(slot_name_qm,Nil))) : slot_name_qm;
    ...
    Object entity, workspace_class_qm;
{
    ...
    Object kb_workspace_class, gensymed_symbol, gensymed_symbol_1;
	...
	if (ISVREF(entity,(SI_Long)18L)) {
	    ...
	    PUSH_SPECIAL(Inhibit_updating_module_related_frame_notes_for_all_workspaces_qm,inhibit_updating_module_related_frame_notes_for_all_workspaces_qm,
	      ...
	      gensymed_symbol = CDR(Symbol_properties_table);
	      gensymed_symbol_1 = kb_workspace_class;
	      gensymed_symbol_2 = SXHASH_SYMBOL_1(kb_workspace_class) & 
		      IFIX(Most_positive_fixnum);
...
Object make_command_frame varargs_1(int, n)
{
    ...
    temp = No_value;
    svref_new_value = gensym_cons_1(temp,initial_text_line_qm ? 
    ...
    Object command_class, initial_text_line_qm;
{
    ...
    return enter_editing_context(3,command_frame,Qbox_translation_and_text,
	    initial_text_line_qm ? gensym_cons_1(initial_text_line_qm,Nil) 
	    : make_empty_text());
}
    ...
    Object class_1, image_plane, x_in_window, y_in_window;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, text_box;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;
    char temp_2;
...
Object Chain_of_available_meter_or_dial_spots = UNBOUND;

Object Meter_or_dial_spot_count = UNBOUND;
    ...
    Object meter_or_dial_spot;
{
    ...
    svref_new_value = Chain_of_available_meter_or_dial_spots;
    SVREF(meter_or_dial_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_meter_or_dial_spots = meter_or_dial_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_meter_or_dial_spot_structure_internal()
{
    ...
    Object meter_or_dial_spot_count_new_value;
    Object defstruct_g2_meter_or_dial_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(120,58);
    def_structure_meter_or_dial_spot_variable = Nil;
    meter_or_dial_spot_count_new_value = FIXNUM_ADD1(Meter_or_dial_spot_count);
    Meter_or_dial_spot_count = meter_or_dial_spot_count_new_value;
...
Object Chain_of_available_dial_spots = UNBOUND;

Object Dial_spot_count = UNBOUND;
    ...
    Object dial_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_dial_spots;
    SVREF(dial_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_dial_spots = dial_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_dial_spot_variable, dial_spot_count_new_value;
    Object defstruct_g2_dial_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(120,64);
    def_structure_dial_spot_variable = Nil;
    dial_spot_count_new_value = FIXNUM_ADD1(Dial_spot_count);
    Dial_spot_count = dial_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_dial_spot_variable;

    x_note_fn_call(120,65);
    def_structure_dial_spot_variable = Chain_of_available_dial_spots;
...
Object Chain_of_available_meter_spots = UNBOUND;

Object Meter_spot_count = UNBOUND;
    ...
    Object meter_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_meter_spots;
    SVREF(meter_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_meter_spots = meter_spot;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_meter_spot_variable, meter_spot_count_new_value;
    Object defstruct_g2_meter_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(120,70);
    def_structure_meter_spot_variable = Nil;
    meter_spot_count_new_value = FIXNUM_ADD1(Meter_spot_count);
    Meter_spot_count = meter_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_meter_spot_variable;

    x_note_fn_call(120,71);
    def_structure_meter_spot_variable = Chain_of_available_meter_spots;
...
Object Color_parameters = UNBOUND;
    ...
    Object color_parameters, value;
{
    ...
    x_note_fn_call(120,72);
    PUSH_SPECIAL(Color_parameters,color_parameters,0);
      if (Noting_changes_to_kb_p)
    ...
    Object color;
{
	...
	temp = Qnil;
    return gensym_list_4(Qbackground_color,color,Qline_color,temp);
}

Object The_type_description_of_bounding_box_spot = UNBOUND;

Object Chain_of_available_bounding_box_spots = UNBOUND;

Object Bounding_box_spot_count = UNBOUND;
    ...
    Object bounding_box_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_bounding_box_spots;
    SVREF(bounding_box_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_bounding_box_spots = bounding_box_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_bounding_box_spot_structure_internal()
{
    ...
    Object bounding_box_spot_count_new_value;
    Object defstruct_g2_bounding_box_spot_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(120,84);
    def_structure_bounding_box_spot_variable = Nil;
    bounding_box_spot_count_new_value = FIXNUM_ADD1(Bounding_box_spot_count);
    Bounding_box_spot_count = bounding_box_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_bounding_states = UNBOUND;

Object Bounding_state_count = UNBOUND;
    ...
    Object bounding_state;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_bounding_states;
    SVREF(bounding_state,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_bounding_states = bounding_state;
    return VALUES_1(Nil);
}
...
Object make_permanent_bounding_state_structure_internal()
{
    ...
    Object bounding_state_count_new_value;
    Object defstruct_g2_bounding_state_variable, the_array;
    SI_Long gensymed_symbol, i, ab_loop_bind_;
    XDeclare_area(1);

    x_note_fn_call(120,93);
    def_structure_bounding_state_variable = Nil;
    bounding_state_count_new_value = FIXNUM_ADD1(Bounding_state_count);
    Bounding_state_count = bounding_state_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
{
    Object def_structure_bounding_state_variable, svref_new_value;

    x_note_fn_call(120,94);
    def_structure_bounding_state_variable = Chain_of_available_bounding_states;
    ...
    SVREF(def_structure_bounding_state_variable,FIX((SI_Long)2L)) = 
	    svref_new_value;
    return VALUES_1(def_structure_bounding_state_variable);
}
    ...
    Object kb_workspace, left_edge, top_edge, right_edge, bottom_edge, mode;
{
	...
	PUSH_SPECIAL(Extreme_top_edge_so_far,extreme_top_edge_so_far,1);
	  PUSH_SPECIAL(Extreme_left_edge_so_far,extreme_left_edge_so_far,0);
    ...
    Object action_button, left_edge, top_edge, right_edge, bottom_edge, mode;
{
    ...
    gensymed_symbol = ISVREF(action_button,(SI_Long)14L);
    gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
	    (SI_Long)4L) : Nil;
    ab_queue_form_ = gensymed_symbol;
    ab_next_queue_element_ = Nil;
...
Object Width_for_change_size_qm = UNBOUND;

Object Height_for_change_size_qm = UNBOUND;
...
Object Force_change_to_minimum_size_p = UNBOUND;
...
{
    x_note_fn_call(120,133);
    right_edge = heuristic_maximum_edge(left_edge,right_edge,
	    Default_chart_width);
    bottom_edge = heuristic_maximum_edge(left_edge,bottom_edge,
	    Default_chart_height);
    return change_size_of_chart(chart,left_edge,top_edge,right_edge,
	    bottom_edge);
}
...
{
    Object bounding_state, gensymed_symbol, ab_queue_form_;
...
Object select_edge_or_corner_of_bounding_box varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Bottom_edge_of_draw_area,bottom_edge_of_draw_area,32);
      PUSH_SPECIAL(Right_edge_of_draw_area,right_edge_of_draw_area,31);
	PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,30);
	  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,29);
	    ...
	    PUSH_SPECIAL(Current_y_origin_of_drawing,current_y_origin_of_drawing,
	      ...
	      PUSH_SPECIAL(Current_x_origin_of_drawing,current_x_origin_of_drawing,
		      27);
		PUSH_SPECIAL(Current_image_y_scale,current_image_y_scale,26);
		  PUSH_SPECIAL(Current_image_x_scale,current_image_x_scale,25);
								  ...
								  PUSH_SPECIAL(Loose_left_edge_of_visible_workspace_area,loose_left_edge_of_visible_workspace_area,
									...
									PUSH_SPECIAL(Current_background_color_value,current_background_color_value,
									  ...
									  if (edge_or_corner_qm) 
									      ...
									      result = VALUES_3(edge_or_corner_qm,
										      temp,
										      temp_2);
									  }
									  else
    ...
    Object blocks;
{
    ...
    return enter_dialog(7,temp,Nil,Nil,
	    ...
	    gensym_cons_1(blocks,Nil),Qreclaim_dragging_list_function,
	    gensym_cons_1(blocks,Nil));
}
...
Object Workspace_invalidation_handling_procedure_qm = UNBOUND;

Object Workspace_invalidation_handling_procedure_fsn_qm = UNBOUND;

Object Workspace_invalidation_handling_workspace_queue = UNBOUND;

Object Workspace_invalidation_handling_fsn_queue = UNBOUND;

Object Workspace_invalidation_handling_window_queue = UNBOUND;

Object Workspace_invalidation_handling_event_type_queue = UNBOUND;
...
{
    Object gensym_pop_store, cons_1, next_cons, cdr_new_value, frame, fsn;
    Object gensymed_symbol, xa, ya, temp_1;
    char temp;

    x_note_fn_call(120,150);
	...
	temp = TRUEP(Nil);
    if (temp ? (SI_Long)0L != (IFIX(ISVREF(frame,(SI_Long)5L)) & 
	    (SI_Long)1L) : TRUEP(Nil)) {
	...
	reclaim_frame_serial_number(fsn);
	temp_1 = make_evaluation_truth_value_function(Falsity);
    }
    gensym_pop_store = Nil;
...
Object Simple_dialog_title_qm = UNBOUND;

Object Simple_dialog_fill_text_p = UNBOUND;

Object Simple_dialog_plist_qm = UNBOUND;
...
void facilities_INIT()
{
    ...
    Object Qworkspace_invalidation_handling_event_type_queue;
    Object Qworkspace_invalidation_handling_window_queue;
    Object Qreclaim_slot_value_fsn_queue;
    Object Qworkspace_invalidation_handling_fsn_queue;
    Object Qworkspace_invalidation_handling_workspace_queue;
    Object Qreclaim_frame_serial_number;
    Object Qworkspace_invalidation_handling_procedure_fsn_qm;
    Object Qworkspace_invalidation_handling_procedure_qm, list_constant_16;
    Object Qmouse_down_on_close_box_widget_in_bounding_state;
    ...
    Object Qchange_size_per_bounding_rectangle, Qchart;
    ...
    Object Qbounding_state_count, Qchain_of_available_bounding_states;
    ...
    Object Qbounding_box_spot_structure_memory_usage, Qbounding_box_spot_count;
    Object Qchain_of_available_bounding_box_spots, string_constant_51;
    ...
    Object Qcolor_parameters, string_constant_40, string_constant_39;
    Object list_constant_34, string_constant_38, string_constant_37;
    Object string_constant_36, string_constant_35, Qmeter, Qmeter_spot;
    Object Qoutstanding_meter_spot_count, Qmeter_spot_structure_memory_usage;
    Object Qmeter_spot_count, Qchain_of_available_meter_spots;
    ...
    Object Qdial_spot_count, Qchain_of_available_dial_spots;
    Object string_constant_32, string_constant_31, Qmeter_or_dial_spot;
    Object Qoutstanding_meter_or_dial_spot_count;
    Object Qmeter_or_dial_spot_structure_memory_usage;
    Object Qmeter_or_dial_spot_count, Qchain_of_available_meter_or_dial_spots;
    Object string_constant_30, string_constant_29, Qmenu_string;
    Object array_constant_52, Qkb_configuration, Qclass_choice_action;
    Object Qact_on_choice_of_a_trend_chart, Qact_on_choice_of_a_text_box;
    Object Qact_on_choice_of_a_freeform_table, Qfreeform_table;
    Object Qact_on_choice_of_a_chart, Qact_on_choice_of_a_graph;
    Object Qact_on_choice_of_a_button, Qbutton, Qact_on_choice_of_a_meter;
    Object Qact_on_choice_of_a_dial, Qact_on_choice_of_a_readout_table;
    Object Qreadout_table, Qact_on_choice_of_a_message, Qmessage;
    Object Qact_on_choice_of_a_entity, list_constant_33, Qexecute_command;
    Object Qcommand, string_constant_28, string_constant_27;
    Object string_constant_26, array_constant_51, Qup_down_reflection;
    Object array_constant_50, Qleft_right_reflection;
    ...
    Qmeter_or_dial_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_30 = STATIC_STRING("1q837By8s83-ddy09k9l");
    ...
    string_constant_31 = 
	    STATIC_STRING("43Dy8m83gjy1p83gjy837By83Qy8n8k1l837By0000001l1m8x837Bykqk0k0");
    ...
    string_constant_32 = STATIC_STRING("1q83gjy8s83-R4y09k9l");
    clear_optimized_constants();
    ...
    string_constant_33 = 
	    STATIC_STRING("43Dy8m83koy1p83koy837By83Qy8n8k1l837By0000001l1m8x837Bykqk0k0");
    ...
    string_constant_34 = STATIC_STRING("1q83koy8s83-dey09k9l");
    clear_optimized_constants();
    ...
    string_constant_37 = 
	    STATIC_STRING("83ICy83ICy0830*y001n1l8o1l8l1m8p83BJy000004z8r83Wgy83Wgy83ICy83ICy0l001n1l8o1l8l1m8p83E3y000004z8r83Why83Why83ICy83ICy0n001n1l8o");
    string_constant_38 = 
	    STATIC_STRING("1l8l1m8p83E3y000004z8r83K=y83K=y83ICy83ICy08k001n1l8o1l8l1m8p83Ky00000");
    string_constant_39 = 
	    STATIC_STRING("1s8q1n83ICy1l83-sy83ey1p83BIy83Ciy8o8l1m8p83BIy1p83IDy83FBy8o8l1m8p83BJy1p83IEy830*y8o8l1m8p83BJy1p83Wgyl8o8l1m8p83E3y1p83Whyn8o");
    ...
    mutate_global_property(Qdo_not_dismiss_color_menu_after_choosing_qm,
	    ...
	    Qabsent_slot_putter);
    string_constant_41 = 
	    STATIC_STRING("1n1m83BIy1m9k83-ZVy1m83BIy1m9k83-Jdy1m83BIy1m9k83Ciy");
    clear_optimized_constants();
    ...
    mutate_global_property(Qcolor_menu_ordering,
	    ...
	    Qslot_value_writer);
    string_constant_42 = 
	    STATIC_STRING("1n1m83BJy1m9k830*y1n83BJy1m1m9k837Ry1m9k9l83FBy1m83BJy83-bwy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_45 = 
	    STATIC_STRING("13Hy83*by83byl83ayl83Wyl83cyl83ny1l83-ry83ty3Dy83syx83uyk83wy83-dy83iy3-Wy");
    ...
    Qcolor_menu_table_format = STATIC_SYMBOL("COLOR-MENU-TABLE-FORMAT",
	    AB_package);
    string_constant_46 = 
	    STATIC_STRING("13Fy83*oy83=wy83fy832Py83fy837Ty83fy8308ym830Aym8309ym8307ym83=Dyl83=Nyl");
    ...
    string_constant_50 = 
	    STATIC_STRING("43Dy8m83fUy1o83fUy83Qy8n8k1l83Qy0000001l1m8x83Qykqk0k0");
    ...
    Qbounding_box_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_51 = STATIC_STRING("1q83fUy8s83-L+y09k9l");
    clear_optimized_constants();
    ...
    string_constant_52 = 
	    STATIC_STRING("43Dy8m83fWy1o83fWy83-Sy8n8k1l83-Sy0000001m1n8y83-3+y1w83r1y83r3y83r5y83r4y83vVy83-HCy83-HIy83-D2y83-D3y83r2y83qiy83-H=y1m8x83-Sy");
    ...
    string_constant_54 = STATIC_STRING("1q83fWy8s83-L*y09k9l");
    clear_optimized_constants();
