...
Object Current_g2_rdf_module = UNBOUND;
    ...
    Object xml_object;
{
    ...
    kb_load_case_qm = Nil;
    PUSH_SPECIAL(Kb_load_case_qm,kb_load_case_qm,0);
...
Object Write_diffs_after_saving_clear_text_p = UNBOUND;

Object Write_checksums_in_xml_file_p = UNBOUND;
...
Object write_clear_text_kb()
{
    ...
    reclaim_gensym_tree_1(ISVREF(Current_kb_save,(SI_Long)39L));
    svref_arg_1 = Current_kb_save;
...
Object Xml_output_stream = UNBOUND;

Object Length_of_xml_output_line = UNBOUND;

Object Xml_output_buffer = UNBOUND;

Object Xml_output_position = UNBOUND;
    ...
    Object xml_object, pathname_1;
{
    ...
    PUSH_SPECIAL(Xml_output_stream,xml_output_stream,3);
      xml_output_buffer = obtain_simple_gensym_string(Write_kb_buffer_length);
      PUSH_SPECIAL(Xml_output_buffer,xml_output_buffer,2);
	xml_output_position = FIX((SI_Long)0L);
	PUSH_SPECIAL(Xml_output_position,xml_output_position,1);
	  length_of_xml_output_line = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Length_of_xml_output_line,length_of_xml_output_line,0);
...
Object Show_deletions_in_xml_changes_p = UNBOUND;
...
Object Write_xml_attribute_change_old_value_p = UNBOUND;
...
Object Traversing_xml_object_p = UNBOUND;
...
Object make_xml_object varargs_1(int, n)
{
	...
	temp = object || include_value_slot ? gensym_list_2(Qvalue,object) 
		: Nil;
	temp_1 = gensym_list_2(Qtype,type);
	temp_2 = unit_qm ? gensym_list_2(Qunit,unit_qm) : Nil;
	if (EQ(user_attribute_count,Qnone))
	    temp_3 = Nil;
	else if (user_attribute_count)
	    temp_3 = gensym_list_2(Quser_attribute_count,user_attribute_count);
	else {
	    if (EQ(type,Qitem)) {
		name = Nil;
		value = Nil;
		...
		if (EQ(user_p,current_user_p))
		    ...
		    user = gensym_cons_1(current,user);
		...
		if (EQ(CAR(user_list),FIX((SI_Long)2L)) && EQ(CAR(fixups),
		    ...
		    reclaim_gensym_list_1(user_list);
		}
		else
		...
		temp_4 = Qnil;
	      end_2:;
		temp_3 = gensym_list_2(Quser_attribute_count,temp_4);
	    }
	    else
		temp_3 = Qnil;
	}
	if (fixups) {
		...
		temp_4 = CDR(ab_loop_list_);
		value = CAR(temp_4);
		ab_loopvar__2 = gensym_cons_1(value,Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
		    ab_loopvar_ = ab_loopvar__2;
		...
		temp_4 = Qnil;
	      end_3:;
		reclaim_gensym_list_1(fixups);
		temp_4 = gensym_list_2(Qelements,
		...
		if (CONSP(name)) {
		    temp_4 = CDR(name) ? 
			    ...
			    CAR(name)) : CAR(name);
		    reclaim_gensym_cons_1(name);
		    name_symbol = temp_4;
		}
		else
		    name_symbol = name;
		ab_loopvar__2 = gensym_list_2(name_symbol,value);
		if (ab_loopvar__2) {
		    if (ab_loopvar__1)
			M_CDR(ab_loopvar__1) = ab_loopvar__2;
		    else
		...
		temp_4 = Qnil;
	      end_4:;
		reclaim_gensym_list_1(fixups);
		temp_4 = gensym_list_2(Qattributes,
    ...
    Object contents, type;
{
  ...
  next_loop:
    ...
    ab_loopvar__1 = include_value_slot ? (sequencep_1 ? 
	    gensym_cons_1(kept_value,Nil) : gensym_list_2(name,
	    kept_value)) : Nil;
    if (ab_loopvar__1) {
	if (ab_loopvar_)
    ...
    ab_loopvar__1 = gensym_list_2(name,value);
    if (ab_loopvar__1) {
	if (ab_loopvar__2)
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(contents);
    if (include_value_slot) {
	if (EQ(type,Qsequence))
...
Object G2binary_file_stream = UNBOUND;
    ...
    Object object_and_fixups, copy_annotations_p;
{
	...
	if (fixups) {
	  ...
	  next_loop:
		...
		goto end_loop;
	    value = evaluation_sequence_aref(fixups,FIX(name));
	    fixups_reversed = gensym_cons_1(FIX(name),fixups_reversed);
	    temp = copy_xml_object(value,copy_annotations_p);
	    fixups_reversed = gensym_cons_1(temp,fixups_reversed);
	    name = name + (SI_Long)1L;
	    goto next_loop;
	  end_loop:;
	}
	...
	if (fixups) {
	  ...
	  next_loop_1:
	    ...
	    next_index = next_index + (SI_Long)2L;
	    fixups_reversed = gensym_cons_1(name_1,fixups_reversed);
	    temp = copy_xml_object(value,copy_annotations_p);
	    fixups_reversed = gensym_cons_1(temp,fixups_reversed);
	    goto next_loop_1;
	  end_loop_1:;
    ...
    Object object_and_fixups;
{
    ...
    x_note_fn_call(137,39);
    temp = get_xml_fixups(object_and_fixups,Qid,Nil);
    return VALUES_1(temp);
}

Object Attr_not_found = UNBOUND;

Object Xml_object_changes = UNBOUND;

Object Compare_xml_collect_diffs_p = UNBOUND;
    ...
    Object object_and_fixups_1, object_and_fixups_2, collect_diffs_p;
{
    ...
    x_note_fn_call(137,41);
    xml_object_changes = Nil;
    compare_xml_collect_diffs_p = collect_diffs_p;
    PUSH_SPECIAL(Compare_xml_collect_diffs_p,compare_xml_collect_diffs_p,1);
      PUSH_SPECIAL(Xml_object_changes,xml_object_changes,0);
...
Object Attribute_name_xml_checksum = UNBOUND;

Object Uuid_xml_checksum = UNBOUND;

Object Value_xml_checksum = UNBOUND;

Object Text_xml_checksum = UNBOUND;

Object Binary_xml_checksum = UNBOUND;

Object Xml_checksums_enabled_p = UNBOUND;

Object Process_checksum_for_image_data_p = UNBOUND;
...
Object initialize_all_xml_checksums()
{
	...
	reclaim_gensym_list_1(FOURTH(index_plus_result_plus_debug));
...
{
    Object gensym_push_modify_macro_arg, car_1, cdr_1, third_new_value;
    SI_Long temp;

    x_note_fn_call(137,50);
...
{
    x_note_fn_call(137,54);
    return copy_list_using_gensym_conses_1(recent_p ? 
...
Object get_xml_checksum_information()
{
	...
	ab_loopvar__2 = gensym_list_2(name,checksum);
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
    ...
    Object xml_object, module_qm;
{
    ...
    x_note_fn_call(137,66);
    xml_checksums_enabled_p = T;
    process_checksum_for_image_data_p = T;
    PUSH_SPECIAL(Process_checksum_for_image_data_p,process_checksum_for_image_data_p,
	    3);
      PUSH_SPECIAL(Xml_checksums_enabled_p,xml_checksums_enabled_p,2);
	xml_checksums_enabled_p = T;
	process_checksum_for_image_data_p = T;
	PUSH_SPECIAL(Process_checksum_for_image_data_p,process_checksum_for_image_data_p,
		1);
	  PUSH_SPECIAL(Xml_checksums_enabled_p,xml_checksums_enabled_p,0);
...
Object G2binary_file_name = UNBOUND;

Object G2binary_file_position = UNBOUND;

Object Current_g2binary_file_symbol_index = UNBOUND;

Object G2binary_file_symbol_list = UNBOUND;

Object G2binary_file_symbol_index_space = UNBOUND;

Object G2binary_file_symbol_index_prop = UNBOUND;

Object Using_temporary_g2binary_file_symbol_indices_p = UNBOUND;

Object Temporary_g2binary_file_symbol_indices = UNBOUND;
...
Object Remaining_bytes_in_g2binary_data = UNBOUND;
    ...
    Object code, stream;
{
	...
	switch (INTEGER_TO_CHAR(code)) {
	  ...
	  case 3:
		...
		return gensym_cons_1(FIX(gensymed_symbol),Qtruth_value);
	  case 4:
	  ...
	  next_loop_1:
	    ...
	    if (error_string_qm)
		return VALUES_2(Nil,error_string_qm);
	    ab_loopvar__2 = gensym_list_2(attr,value);
	    if (ab_loopvar__2) {
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
    ...
    Object value, stream;
{
    ...
    PUSH_SPECIAL(Temporary_g2binary_file_symbol_indices,temporary_g2binary_file_symbol_indices,
	    1);
      PUSH_SPECIAL(Using_temporary_g2binary_file_symbol_indices_p,using_temporary_g2binary_file_symbol_indices_p,
	      0);
    ...
    Object stream;
{
    ...
    PUSH_SPECIAL(Remaining_bytes_in_g2binary_data,remaining_bytes_in_g2binary_data,
	    0);
      result = read_g2binary_data_from_stream(stream);
      MVS_2(result,value,error_string_qm);
      if (error_string_qm) {
...
Object Clear_text_primitive_value_style = UNBOUND;

Object Call_check_node_attribute_value_p = UNBOUND;

Object Current_module_being_saved = UNBOUND;

Object Writing_xml_p = UNBOUND;

Object Writing_xml_cdata_p = UNBOUND;

Object Kb_format_write_integer_buffer = UNBOUND;
...
Object Writing_g2_rdf_file_p = UNBOUND;
    ...
    Object file_name;
{
    ...
    x_note_fn_call(137,108);
    stream = g2_stream_open_for_output(file_name);
    writing_g2_rdf_file_p = T;
    PUSH_SPECIAL(Writing_g2_rdf_file_p,writing_g2_rdf_file_p,1);
      if (stream) {
	...
	end_loop_1:;
	  ...
	  next_loop_2:
		...
		ab_loopvar__3 = gensym_cons_1(class_1,Nil);
		if (ab_loopvar__2)
	...
	next_loop_5:
	  ...
	  if ( !TRUEP(memq_function(attribute_name,attribute_names))) {
	      attribute_names = gensym_cons_1(attribute_name,attribute_names);
	      any_p = T;
	...
	end_loop_3:
	  tformat_to_stream(2,stream,string_constant_13);
	  reclaim_gensym_list_1(sorted_class_names);
	  reclaim_gensym_list_1(attribute_names);
    ...
    Object node, node_type, attribute;
{
	...
	if (qualifier || (Traversing_xml_object_p ? CONSP(attribute) : 
	    ...
	    temp = gensym_cons_1(name,qualifier);
...
Object Run_traverse_kb_xml_object_type = UNBOUND;
...
{
    Object writing_xml_p, header, name, value, gensym_pop_store, cons_1;
    Object next_cons, cdr_new_value, temp;
    Declare_special(1);

    x_note_fn_call(137,120);
    writing_xml_p = T;
    PUSH_SPECIAL(Writing_xml_p,writing_xml_p,0);
...
static Object Qcurrent_kb_save;    /* current-kb-save */
    ...
    Object traversal, node, node_type, nesting;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, x2, temp_3;
    Object refid_text_string_qm, temp_4;
    SI_Long temp, gensymed_symbol_2, gensymed_symbol_3;
    char temp_1;

    x_note_fn_call(137,123);
    category = refid_category_of_node(node,node_type);
    ...
    temp_3 = EQ(Qitem,category) ? gensym_list_2(Qab_class,
	    refid_type_of_node(node,node_type)) : Nil;
    refid_text_string_qm = rdf_text_string_for_refid_for_node(node,
	    node_type,T);
    temp_4 = refid_text_string_qm ? gensym_list_2(Qid,
	    refid_text_string_qm) : Nil;
    ...
    Object value;
{
	...
	PUSH_SPECIAL(Write_floats_accurately_p,write_floats_accurately_p,0);
    ...
    Object type;
{
    ...
    PUSH_SPECIAL(Writing_xml_cdata_p,writing_xml_cdata_p,0);
    ...
    Object type;
{
    ...
    GENSYM_RETURN_ONE(gensym_list_2(temp,temp_1));
    return VALUES_1(Nil);
}
    ...
    Object type;
{
    ...
    x_note_fn_call(137,130);
    temp = attribute_name_for_make_xml_object(node,node_type,attribute);
    nesting = FIXNUMP(attribute) ? nesting : add1(nesting);
    category = refid_category_of_node(value,type);
    resource_string = rdf_text_string_for_refid_for_node(value,type,Nil);
    temp_1 = EQ(category,Qitem) ? gensym_list_2(Qab_class,
	    refid_type_of_node(value,type)) : Nil;
    GENSYM_RETURN_ONE(gensym_list_2(temp,make_xml_object(4,value,category,
	    nconc2(temp_1,gensym_list_2(QRDF_COL_RESOURCE,
	    resource_string)),T)));
    return VALUES_1(Nil);
}
    ...
    Object type;
{
    ...
    x_note_fn_call(137,132);
    temp = attribute_name_for_make_xml_object(node,node_type,attribute);
    nesting = FIXNUMP(attribute) ? nesting : add1(nesting);
    GENSYM_RETURN_ONE(gensym_list_2(temp,traverse_kb_node(traversal,value,
	    type,nesting)));
    return VALUES_1(Nil);
}
    ...
    Object binary_file, xml_object;
{
    ...
    PUSH_SPECIAL(G2binary_file_name,g2binary_file_name,7);
      g2binary_file_stream = G2binary_file_name;
      PUSH_SPECIAL(G2binary_file_stream,g2binary_file_stream,6);
	g2binary_file_position = FIX((SI_Long)0L);
	PUSH_SPECIAL(G2binary_file_position,g2binary_file_position,5);
	  current_g2binary_file_symbol_index = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Current_g2binary_file_symbol_index,current_g2binary_file_symbol_index,
		  4);
	    g2binary_file_symbol_list = Nil;
	    PUSH_SPECIAL(G2binary_file_symbol_list,g2binary_file_symbol_list,
		    3);
	      g2binary_file_symbol_index_space = Nil;
	      PUSH_SPECIAL(G2binary_file_symbol_index_space,g2binary_file_symbol_index_space,
		      2);
		...
		PUSH_SPECIAL(Clear_text_primitive_value_style,clear_text_primitive_value_style,
			1);
		  PUSH_SPECIAL(Traversing_xml_object_p,traversing_xml_object_p,
			  0);
    ...
    Object binary_file, module;
{
	...
	g2binary_file_name = Nil;
    PUSH_SPECIAL(G2binary_file_name,g2binary_file_name,5);
      g2binary_file_stream = G2binary_file_name;
      PUSH_SPECIAL(G2binary_file_stream,g2binary_file_stream,4);
	g2binary_file_position = FIX((SI_Long)0L);
	PUSH_SPECIAL(G2binary_file_position,g2binary_file_position,3);
	  current_g2binary_file_symbol_index = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Current_g2binary_file_symbol_index,current_g2binary_file_symbol_index,
		  2);
	    g2binary_file_symbol_list = Nil;
    ...
    Object value, xml_object_p, type;
{
    ...
    PUSH_SPECIAL(Write_xml_object_items_collected,write_xml_object_items_collected,
	    4);
      PUSH_SPECIAL(Current_module_being_saved,current_module_being_saved,3);
	PUSH_SPECIAL(In_write_module_as_clear_text_p,in_write_module_as_clear_text_p,
		2);
	  ...
	  PUSH_SPECIAL(Clear_text_primitive_value_style,clear_text_primitive_value_style,
		  1);
	    PUSH_SPECIAL(Call_check_node_attribute_value_p,call_check_node_attribute_value_p,
		    0);
...
Object In_find_stripped_text_slot_p = UNBOUND;
    ...
    Object module;
{
    ...
    x_note_fn_call(137,151);
    if (PUSH_CATCH(Qstripped_text_slot_search,0)) {
	in_find_stripped_text_slot_p = T;
	PUSH_SPECIAL(In_find_stripped_text_slot_p,in_find_stripped_text_slot_p,
		0);
...
Object Traverse_kb_queued_nodes = UNBOUND;

Object Traverse_kb_queued_nodes_tail = UNBOUND;
    ...
    Object node_plus_type;
{
    ...
    x_note_fn_call(137,153);
    new_1 = gensym_cons_1(node_plus_type,Nil);
    ...
    Object workspace;
{
    ...
    x_note_fn_call(137,155);
    enqueue_kb_node(gensym_cons_1(workspace,Qitem_or_evaluation_value));
  ...
  next_loop:
	...
	subworkspace = Nil;
    enqueue_kb_node(gensym_cons_1(sub_item,Qitem_or_evaluation_value));
    if (subworkspace)
    ...
    Object traversal, value, type;
{
    ...
    x_note_fn_call(137,156);
    SAVE_STACK();
    traverse_kb_queued_nodes = Nil;
    traverse_kb_queued_nodes_tail = Nil;
    PUSH_SPECIAL(Traverse_kb_queued_nodes_tail,traverse_kb_queued_nodes_tail,
	    1);
      PUSH_SPECIAL(Traverse_kb_queued_nodes,traverse_kb_queued_nodes,0);
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(Traverse_kb_queued_nodes);
...
Object Item_color_pattern_returns_overrides_only_p = UNBOUND;

Object Array_initialization_evaluation_values_use_designations_p = UNBOUND;
    ...
    Object traversal, value, type;
{
	...
	if (EQ(type_1,Qprimitive_value) || EQ(type_1,Qtext))
		...
		if (EQ(FIX(attribute),QModule) && EQ(type,Qmodule)) {
		    module_seen_p = T;
		    enqueue_kb_node(gensym_cons_1(value_1,Qmodule));
		}
		else if (module_seen_p)
		    enqueue_kb_node(gensym_cons_1(value_1,
	...
	PUSH_SPECIAL(Current_computation_flags,current_computation_flags,2);
	  PUSH_SPECIAL(Item_color_pattern_returns_overrides_only_p,item_color_pattern_returns_overrides_only_p,
		  1);
	    PUSH_SPECIAL(Array_initialization_evaluation_values_use_designations_p,array_initialization_evaluation_values_use_designations_p,
		    0);
	      ...
	      enqueue_kb_node(gensym_cons_1(value,type));
    ...
    Object traversal, module, type;
{
	...
	reclaim_gensym_cons_1(node_plus_type);
	temp = EQ(node_type,Qmodule) ? QModule : Nil;
	ab_loopvar__2 = gensym_list_2(temp,traverse_kb_node(traversal,node,
...
Object Traversing_kb_attribute = UNBOUND;
    ...
    Object traversal, node, node_type, attribute, nesting;
{
	...
	if (module_attribute) {
	    ...
	    PUSH_SPECIAL(Traversing_kb_attribute,traversing_kb_attribute,0);
	      traversal_function = fn;
    ...
    Object node, node_type;
{
	...
	if (superior_qm) {
	  ...
	  next_loop:
	    ...
	    goto next_loop;
	  end_loop:
	    reclaim_gensym_list_1(inferiors_of_superior);
...
{
    x_note_fn_call(137,175);
    return gensym_cons_1(type,gensym_cons_1(name,superior_refid));
}
    ...
    Object refid;
{
	...
	goto next_loop;
      end_loop:;
	return reclaim_gensym_list_1(refid);
    }
    else
	return VALUES_1(Qnil);
}
		...
		if (fixups) {
		  ...
		  next_loop:
			...
			if (user_p) {
				...
				temp = gensym_cons_1(FIX(attribute),Nil);
			}
			else
			    temp = FIX(attribute);
			attribute_list = gensym_cons_1(temp,attribute_list);
		    }
		    attribute = attribute + (SI_Long)1L;
		    goto next_loop;
		  end_loop:;
		...
		if (fixups) {
		  ...
		  next_loop_1:
			...
			if (user_p) {
				...
				temp = gensym_cons_1(attribute_1,Nil);
			}
			else
			    temp = attribute_1;
			attribute_list = gensym_cons_1(temp,attribute_list);
    ...
    Object node, node_type, attributes;
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(attributes);
	return VALUES_1(Qnil);
    }
    else if (EQ(node_type,Qitem_or_evaluation_value)) {
	if (CONSP(node) && EQ(M_CDR(node),Qab_structure))
	    return reclaim_gensym_list_1(attributes);
	else
	    return VALUES_1(Nil);
    }
    else
...
Object All_classes_for_cached_class_description_node_attributes = UNBOUND;

Object All_classes_for_cached_class_description_node_attributes_for_external_definition = UNBOUND;
...
Object decache_all_cached_class_node_attributes()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(All_classes_for_cached_class_description_node_attributes);
  ...
  next_loop_1:
    ...
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(All_classes_for_cached_class_description_node_attributes_for_external_definition);
    All_classes_for_cached_class_description_node_attributes_for_external_definition 
	    = Nil;
    return VALUES_1(Qnil);
}

Object Exclude_secondary_attributes = UNBOUND;
    ...
    Object class_description;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(non_local_attr,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
  ...
  next_loop_1:
	...
	ab_loopvar__2 = gensym_cons_1(get_property_value_function(3,
    ...
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(all_virtual_attr_name_list);
    return VALUES_1(ab_loopvar_);
    return VALUES_1(Qnil);
}
...
Object node_attribute_value(node,node_type,attribute)
    Object node, node_type, attribute;
{
    Object category_type, gensymed_symbol, temp, item_or_value, x2;
    Object svref_new_value, temp_2, name_list, name, ab_loop_list_, cdef;
    Object ab_loopvar_, ab_loopvar__1, ab_loopvar__2, x, gensymed_symbol_2;
    Object gensymed_symbol_4, temp_3, new_cons, global_properties;
    Object kb_properties, kb_specific_value, resulting_value, workspace;
    Object write_proprietary_package_while_saving_xml_kb;
    SI_Long gensymed_symbol_1, svref_arg_2, gensymed_symbol_3;
    char temp_1;
    Declare_special(1);
    Object result;

    x_note_fn_call(137,192);
    category_type = Nil;
    if (Traversing_xml_object_p) {
	if (CONSP(attribute))
	...
	if (EQ(attribute,Qversion)) {
	    ...
	    if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		    Maximum_in_place_array_size)) {
		if ( !TRUEP(T))
		    temp_2 = array_constant_8;
		else
		    switch (INTEGER_TO_CHAR(Release_quality_of_current_gensym_product_line)) 
				{
		      case 0:
			temp_2 = array_constant_10;
			break;
		      case 1:
			temp_2 = array_constant_11;
			break;
		      case 2:
			temp_2 = array_constant_12;
			break;
		      case 3:
			temp_2 = array_constant_8;
			break;
		...
		item_or_value = copy_wide_string(temp_2);
		if (SIMPLE_VECTOR_P(item_or_value) && 
			IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(item_or_value)) > 
			(SI_Long)2L &&  !EQ(ISVREF(item_or_value,
			(SI_Long)1L),Qavailable_frame_vector)) {
	  ...
	  next_loop:
		...
		if (SYMBOLP(x)) {
		    ...
		    gensymed_symbol_2 = x;
		    gensymed_symbol_1 = SXHASH_SYMBOL_1(x) & 
			    IFIX(Most_positive_fixnum);
		    gensymed_symbol_3 = (SI_Long)0L;
		  next_loop_1:
		  ...
		  end_2:;
			...
			inline_note_allocate_cons(gensymed_symbol_2,
				Qab_gensym);
			gensymed_symbol = 
				set_balanced_binary_tree_entry(temp_3,Qeq,
				Nil,T,gensymed_symbol,temp_2,
				gensymed_symbol_2);
		    }
		  ...
		  end_4:;
			...
			gensymed_symbol_2 = Class_description_gkbprop;
			gensymed_symbol_1 = 
		...
		temp_1 = TRUEP(Nil);
	    if (temp_1) {
		gensymed_symbol = ISVREF(cdef,(SI_Long)14L);
		...
		temp_1 = TRUEP(Nil);
	    if (temp_1) {
		temp_2 = ISVREF(cdef,(SI_Long)21L);
		temp_1 = EQUAL(temp_2,list_constant_7);
	    }
	    else
		temp_1 = TRUEP(Nil);
	    if ( !temp_1) {
		ab_loopvar__2 = gensym_cons_1(cdef,Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
		    ab_loopvar_ = ab_loopvar__2;
	    ...
	    goto next_loop;
	  end_loop:
	    reclaim_gensym_list_1(name_list);
	    temp_2 = ab_loopvar_;
	    goto end_9;
	    temp_2 = Qnil;
	  end_9:;
	    return allocate_evaluation_sequence(temp_2);
	}
	  ...
	  next_loop_9:
		...
		ab_loopvar__2 = gensym_cons_1(workspace,Nil);
		if (ab_loopvar__1)
		    M_CDR(ab_loopvar__1) = ab_loopvar__2;
		else
		    ab_loopvar_ = ab_loopvar__2;
	  ...
	  end_loop_9:
	    ...
	    temp_2 = Qnil;
	  end_10:;
	    return allocate_evaluation_sequence(sort_items_in_definition_order(temp_2));
	}
	else if (EQ(attribute,Qformats))
	    return allocate_evaluation_sequence(sort_items_in_definition_order(copy_list_using_gensym_conses_1(get_formats_for_current_module())));
	else if (EQ(attribute,Qpanes))
	...
	if (temp_1) {
		...
		temp_2 = ISVREF(node,(SI_Long)18L);
		return VALUES_1(CAR(temp_2));
	    }
		...
		if (category_type) {
			...
			PUSH_SPECIAL(Write_proprietary_package_while_saving_xml_kb,write_proprietary_package_while_saving_xml_kb,
				0);
...
Object Kb_restrictions_names = UNBOUND;
...
Object get_kb_restrictions_names()
{
    ...
    x_note_fn_call(137,204);
    temp = Kb_restrictions_names;
    if (temp);
    else
	temp = 
		allocate_evaluation_sequence(gensym_list_2(Qkb_configuration,
		Qkb_restrictions));
    return VALUES_1(temp);
}
    ...
    Object node, node_type, attribute, value, type;
{
	...
	if (temp) {
		...
		if (EQ(temp_1,Qrelationships))
			...
			gensymed_symbol = ISVREF(node,(SI_Long)14L);
...
static Object Qserver_parameters;  /* server-parameters */
    ...
    Object node;
{
  ...
  next_loop_2:
	...
	temp = TRUEP(Nil);
    if (temp) {
	frames = delete_gensym_element_1(table,frames);
	frame = table;
	goto end_2;
    }
    goto next_loop_2;
    ...
    Object workspace;
{
  ...
  next_loop:
    ...
    if ( !temp) {
	result_1 = gensym_cons_1(block_or_connection_frame,result_1);
	scope_conses = Scope_conses;
	ab_node_stack_ = Nil;
    ...
    Object item;
{
    ...
    x_note_fn_call(137,213);
    ws_qm = get_workspace_if_any_for_block(item);
    last_1 = Nil;
    if (ws_qm) {
	gensymed_symbol = ISVREF(ws_qm,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)4L) : Nil;
	ab_queue_form_ = gensymed_symbol;
	ab_next_queue_element_ = Nil;
    ...
    Object block, new_value;
{
    ...
    x_note_fn_call(137,216);
    if (new_value) {
	disable_stack_error = T;
	permit_transfer_of_permanent_items_p = T;
	PUSH_SPECIAL(Permit_transfer_of_permanent_items_p,permit_transfer_of_permanent_items_p,
		1);
    ...
    Object block;
{
	...
	gensymed_symbol_3 = make_gensym_list_1(FIX((SI_Long)6L));
	...
	gensymed_symbol_4 = M_CDR(gensymed_symbol_4);
	gensymed_symbol_5 = ISVREF(block,(SI_Long)14L);
    ...
    Object item, new_value;
{
	...
	disable_stack_error = T;
	PUSH_SPECIAL(Disable_stack_error,disable_stack_error,1);
	  permit_transfer_of_permanent_items_p = T;
	  PUSH_SPECIAL(Permit_transfer_of_permanent_items_p,permit_transfer_of_permanent_items_p,
		  0);
    ...
    Object block;
{
	...
	if ((SI_Long)0L < IFIX(width) && (SI_Long)0L < IFIX(height)) {
	    ...
	    temp_1 = allocate_evaluation_structure(gensym_list_4(Qwidth,
    ...
    Object item, new_value;
{
	...
	if (workspace_qm) {
		...
		PUSH_SPECIAL(Width_for_change_size_qm,width_for_change_size_qm,
			2);
		  height_for_change_size_qm = height;
		  PUSH_SPECIAL(Height_for_change_size_qm,height_for_change_size_qm,
			  1);
		    force_change_to_minimum_size_p = T;
		    PUSH_SPECIAL(Force_change_to_minimum_size_p,force_change_to_minimum_size_p,
			    0);
    ...
    Object connection, direction;
{
	...
	return allocate_evaluation_structure(nconc2(gensymed_symbol,
		port_name ? gensym_list_2(Qport_name,port_name) : Nil));
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object workspace;
{
    ...
    x_note_fn_call(137,249);
    info_qm = getf(ISVREF(workspace,(SI_Long)19L),Qdetail_pane,_);
    if (info_qm) {
	temp = gensym_list_4(Qx,FIRST(info_qm),Qy,SECOND(info_qm));
	if ( !(IFIX(THIRD(info_qm)) == (SI_Long)4096L && 
	    ...
	    temp_1 = gensym_list_4(Qx_scale,temp_1,Qy_scale,
    ...
    Object workspace, value;
{
    ...
    Object amf_result, incff_1_arg, new_float, temp_2;

    x_note_fn_call(137,250);
    if (value) {
...
Object Classes_sorted_so_far = UNBOUND;

Object Classes_remaining_to_sort = UNBOUND;
    ...
    Object class_list;
{
    ...
    x_note_fn_call(137,251);
    classes_sorted_so_far = Nil;
    classes_remaining_to_sort = nreverse(class_list);
    PUSH_SPECIAL(Classes_remaining_to_sort,classes_remaining_to_sort,1);
      PUSH_SPECIAL(Classes_sorted_so_far,classes_sorted_so_far,0);
	...
	Classes_sorted_so_far = gensym_cons_1(class_with_no_predecessors,
		Classes_sorted_so_far);
	Classes_remaining_to_sort = 
		delete_gensym_element_1(class_with_no_predecessors,
		Classes_remaining_to_sort);
	goto next_loop;
      end_loop:;
...
Object All_classes_for_indirectly_referenced_class = UNBOUND;
...
Object note_indirectly_referenced_class(class_1)
    Object class_1;
{
    x_note_fn_call(137,253);
    mutate_global_property(class_1,T,Qindirectly_referenced_class_p);
    All_classes_for_indirectly_referenced_class = gensym_cons_1(class_1,
...
Object decache_all_indirectly_referenced_classes()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(All_classes_for_indirectly_referenced_class);
    ...
    Object module;
{
    ...
    next_loop:
      ...
      if (temp_1) {
	  ab_loopvar__3 = 
		  gensym_cons_1(note_indirectly_referenced_class(subclass),
		  Nil);
	  if (ab_loopvar__2)
	      M_CDR(ab_loopvar__2) = ab_loopvar__3;
	  else
    ...
    Object needed_class;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = 
		gensym_cons_1(note_indirectly_referenced_class(needed_class),
		Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
    ...
    Object module;
{
    ...
    x_note_fn_call(137,257);
    decache_all_indirectly_referenced_classes();
    reclaim_gensym_list_1(mark_all_classes_defined_in_module(module));
    needed_class = Nil;
    ab_loop_list_ = All_classes_for_cached_class_description_node_attributes;
    ab_loopvar_ = Nil;
    ab_loopvar__1 = Nil;
...
Object All_formats_in_module = UNBOUND;
...
Object Reading_initial_plist_for_clear_text_kb = UNBOUND;
...
Object read_initial_plist_for_clear_text_kb()
{
    ...
    x_note_fn_call(137,262);
    reading_initial_plist_for_clear_text_kb = T;
    PUSH_SPECIAL(Reading_initial_plist_for_clear_text_kb,reading_initial_plist_for_clear_text_kb,
	    0);
...
Object Read_xml_line = UNBOUND;

Object Read_kb_next_character = UNBOUND;
...
Object update_read_xml_progress()
{
    ...
    x_note_fn_call(137,266);
    if (Kb_file_progress) {
	suppress_updating_of_slot_value_representations_qm = Nil;
	PUSH_SPECIAL(Suppress_updating_of_slot_value_representations_qm,suppress_updating_of_slot_value_representations_qm,
		0);
    ...
    Object pathname_qm, ignore_errors_p;
{
	...
	g2binary_file_name = Nil;
    PUSH_SPECIAL(G2binary_file_name,g2binary_file_name,6);
      g2binary_file_stream = G2binary_file_name;
      PUSH_SPECIAL(G2binary_file_stream,g2binary_file_stream,5);
	g2binary_file_position = FIX((SI_Long)0L);
	PUSH_SPECIAL(G2binary_file_position,g2binary_file_position,4);
	  current_g2binary_file_symbol_index = FIX((SI_Long)0L);
	  PUSH_SPECIAL(Current_g2binary_file_symbol_index,current_g2binary_file_symbol_index,
		  3);
	    g2binary_file_symbol_list = Nil;
		...
		PUSH_SPECIAL(Read_xml_line,read_xml_line,0);
    ...
    Object attribute_list, contents, skip_value;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    reclaim_gensym_list_1(attribute_list);
	...
	goto next_loop_1;
      end_loop_1:;
	return reclaim_gensym_list_1(contents);
    }
    else
	return VALUES_1(Qnil);
}
...
Object reclaim_two_eval_conses(list_1)
    Object list_1;
{
    x_note_fn_call(137,271);
    reclaim_gensym_cons_1(CDR(list_1));
    reclaim_gensym_cons_1(list_1);
    return VALUES_1(Nil);
}
    ...
    Object ch, xml_read_context;
{
	...
	if (empty_p)
	  ...
	  next_loop_1:
	    ...
	    if (text_p)
		contents_rev = gensym_cons_1(ch,contents_rev);
	    goto next_loop_1;
	  end_loop:
	    temp = TRUEP(Qnil);
	  end_1:;
    ...
    Object ch, xml_read_context;
{
	...
	xml_read_context_1 = gensym_cons_1(identification,xml_read_context_1);
    ...
    Object contents_rev, text_p, object_and_fixups, error_or_plist;
{
    ...
    Object gensym_pop_store, cons_1, next_cons, temp_1, thing, contents;
    Object current_wide_string_list, wide_string_bv16, current_wide_string;
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object ch, thing_1, schar_arg_2, schar_new_value;
    SI_Long bv16_length, aref_arg_2, aref_new_value, length_1;
    Declare_special(5);

    x_note_fn_call(137,276);
	...
	reclaim_gensym_list_1(contents_rev);
    ...
    Object valuep;
{
    ...
    x_note_fn_call(137,277);
    if ( !TRUEP(text_p)) {
	if (object_and_fixups || valuep) {
	    temp = read_xml_make_attribute_name(content_name,content_kind);
	    contents_rev = gensym_cons_1(temp,contents_rev);
	    contents_rev = gensym_cons_1(EQ(object_and_fixups,Xml_nil) ? 
		    Nil : object_and_fixups,contents_rev);
	}
    }
	...
	contents_rev = gensym_cons_1(object_and_fixups,contents_rev);
    else {
	reclaim_gensym_list_1(contents_rev);
	text_p = Nil;
	temp = EQ(object_and_fixups,Xml_nil) ? Nil : object_and_fixups;
	contents_rev = gensym_list_2(temp,
    ...
    Object object_and_fixups, error_or_plist;
{
	...
	if (EQ(pn,Qkb_name))
		...
		next_index = next_index + (SI_Long)1L;
		m = validated_elt;
		ab_loopvar__4 = gensym_cons_1(m,Nil);
		if (ab_loopvar__3)
	    ...
	    value = Qnil;
	ab_loopvar__2 = value ? gensym_list_2(pn,value) : Nil;
	if (ab_loopvar__2) {
	    if (ab_loopvar__1)
		M_CDR(ab_loopvar__1) = ab_loopvar__2;
	    else
	...
	reclaim_two_eval_conses(xml_read_context);
	temp = gensym_list_2(Qab_class,symbol);
    ...
    Object xml_read_context;
{
    ...
    Object amf_array, temp_1, svref_new_value, amf_result, incff_1_arg;
    Object new_float, temp_2, gensymed_symbol, value, error_string;
	...
	switch ((char)temp) {
	  case 82:
		...
		PUSH_SPECIAL(Read_kb_buffer,read_kb_buffer,2);
		  read_kb_buffer_index = FIX((SI_Long)0L);
		  PUSH_SPECIAL(Read_kb_buffer_index,read_kb_buffer_index,1);
		    read_kb_buffer_length = length(Read_kb_buffer);
		    PUSH_SPECIAL(Read_kb_buffer_length,read_kb_buffer_length,
			    0);
	  ...
	  case 70:
		...
		if (value_qm) {
			...
			new_float = amf_result;
			temp_2 = lfloat(read_float_from_string(value_qm,
		...
		switch ((char)temp) {
		  case 121:
			...
			if (temp_2);
			    ...
			    temp_2 = copy_text_string(array_constant_8);
			result_1 = intern_text_string(1,temp_2);
			if (result_1);
			else
			    result_1 = Knil;
		    }
		  ...
		  case 101:
			...
			temp_2 = collect_xml_list(contents,Qsequence);
			contents = Nil;
			result_1 = temp_2;
		    }
		    else
		  ...
		  case 116:
			...
			temp_2 = collect_xml_list(contents,Qab_structure);
			contents = Nil;
			result_1 = temp_2;
		    }
		    else
		...
		switch ((char)temp) {
		  ...
		  case 114:
			...
			if (value_qm) {
				...
				result_1 = gensym_cons_1(gensymed_symbol,
					Qtruth_value);
			}
			else
			    result_1 = Nil;
	  ...
	  case 66:
		...
		MVS_2(result,value,error_string);
		if (error_string) {
		    temp_2 = read_xml_error_string(2,xml_read_context,
			    error_string);
		    return VALUES_2(Nil,temp_2);
		}
		attribute_list = Nil;
		contents = Nil;
		result_1 = value;
    ...
    reclaim_xml_attribute_list_and_contents(attribute_list,contents,Nil);
    if ( !TRUEP(result_1)) {
	temp_2 = read_xml_error_string(2,xml_read_context,string_constant_145);
	return VALUES_2(Nil,temp_2);
    }
    if (unit_qm)
...
/* START-WITH-W */
Object start_with_w(str1,str2,start,len1,len2)
    Object str1, str2, start, len1, len2;
{
    SI_Long index_1, ab_loop_bind_;

    x_note_fn_call(137,280);
    if (FIXNUM_LT(FIXNUM_MINUS(len1,start),len2))
	return VALUES_1(Nil);
    else {
	index_1 = IFIX(start);
	ab_loop_bind_ = IFIX(FIXNUM_ADD(start,len2));
      next_loop:
	if (index_1 >= ab_loop_bind_)
	    goto end_loop;
	if ( !(UBYTE_16_ISAREF_1(str1,index_1) == UBYTE_16_ISAREF_1(str2,
		index_1 - IFIX(start))))
	    return VALUES_1(Nil);
	index_1 = index_1 + (SI_Long)1L;
	goto next_loop;
...
/* BIND-SYMBOL-TO-RDF-SYMBOL-NAME */
Object bind_symbol_to_rdf_symbol_name(rdf_symbol,name)
    Object rdf_symbol, name;
{
    Object index_1, len, dot_seen, type, current_wide_string_list;
    Object wide_string_bv16, current_wide_string;
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object ch, qmp, simple_or_wide_character, thing, temp_1, schar_arg_2;
    Object schar_new_value, temp_2, first_part, second_part;
    SI_Long temp, bv16_length, aref_new_value, length_1, incff_1_arg;
    Declare_special(5);

    x_note_fn_call(137,281);
    index_1 = FIX((SI_Long)0L);
    len = lengthw(name);
    dot_seen = Nil;
    type = Nil;
    if (start_with_w(name,array_constant_24,FIX((SI_Long)0L),len,
	    FIX((SI_Long)3L))) {
	temp = IFIX(index_1) + (SI_Long)3L;
	index_1 = FIX(temp);
    }
    else if (start_with_w(name,array_constant_25,FIX((SI_Long)0L),len,
	    FIX((SI_Long)4L))) {
	temp = IFIX(index_1) + (SI_Long)4L;
	index_1 = FIX(temp);
    }
    if (start_with_w(name,array_constant_26,index_1,len,FIX((SI_Long)2L))) {
	type = Qab_class;
	temp = IFIX(index_1) + (SI_Long)2L;
	index_1 = FIX(temp);
    }
    else if (start_with_w(name,array_constant_27,index_1,len,
		FIX((SI_Long)2L))) {
	type = Qattribute;
	temp = IFIX(index_1) + (SI_Long)2L;
	index_1 = FIX(temp);
    }
    else if (start_with_w(name,array_constant_28,index_1,len,
		FIX((SI_Long)3L))) {
	type = Quser_attribute;
	temp = IFIX(index_1) + (SI_Long)3L;
	index_1 = FIX(temp);
    }
    else if (start_with_w(name,array_constant_29,index_1,len,
		FIX((SI_Long)3L))) {
	type = Qqualified_attribute;
	temp = IFIX(index_1) + (SI_Long)3L;
	index_1 = FIX(temp);
    }
    else if (start_with_w(name,array_constant_30,index_1,len,
		FIX((SI_Long)3L))) {
	type = Qstructure_attribute;
	temp = IFIX(index_1) + (SI_Long)3L;
	index_1 = FIX(temp);
    }
    current_wide_string_list = Qdo_not_use;
	...
	PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
	    ...
	    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
	      ...
	      qmp = Nil;
	    next_loop:
	      if ( !(FIXNUM_LT(index_1,len) &&  !TRUEP(dot_seen)))
		  goto end_loop;
	      ch = FIX(UBYTE_16_ISAREF_1(name,IFIX(index_1)));
	      qmp = IFIX(ch) == (SI_Long)95L && IFIX(index_1) + 
		      (SI_Long)2L < IFIX(len) && UBYTE_16_ISAREF_1(name,
		      IFIX(FIXNUM_ADD1(index_1))) == (SI_Long)113L ? 
		      (UBYTE_16_ISAREF_1(name,IFIX(index_1) + (SI_Long)2L) 
		      == (SI_Long)109L ? T : Nil) : Qnil;
	      if (EQ(type,Qqualified_attribute) && IFIX(ch) == (SI_Long)46L) {
		  dot_seen = T;
		  index_1 = FIXNUM_ADD1(index_1);
	      }
	      else {
		  simple_or_wide_character = qmp ? FIX((SI_Long)63L) : ch;
		  if (EQ(Current_twriting_output_type,Qwide_string)) {
    ...
    if (EQ(type,Qqualified_attribute) && dot_seen) {
	current_wide_string_list = Qdo_not_use;
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		  (SI_Long)3L));
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  qmp = Nil;
		next_loop_1:
		  if ( !FIXNUM_LT(index_1,len))
		      goto end_loop_1;
		  ch = FIX(UBYTE_16_ISAREF_1(name,IFIX(index_1)));
		  qmp = IFIX(ch) == (SI_Long)95L && IFIX(index_1) + 
			  (SI_Long)2L < IFIX(len) && 
			  UBYTE_16_ISAREF_1(name,
			  IFIX(FIXNUM_ADD1(index_1))) == (SI_Long)113L ? 
			  (UBYTE_16_ISAREF_1(name,IFIX(index_1) + 
			  (SI_Long)2L) == (SI_Long)109L ? T : Nil) : Qnil;
		  simple_or_wide_character = qmp ? FIX((SI_Long)63L) : ch;
		  if (EQ(Current_twriting_output_type,Qwide_string)) {
		      thing = simple_or_wide_character;
		      twrite_wide_character(CHARACTERP(thing) ? 
	...
	second_part = Nil;
    return mutate_global_property(rdf_symbol,gensym_cons_1(EQ(type,
	    Qqualified_attribute) && dot_seen ? gensym_cons_1(second_part,
	    first_part) : first_part,type),Qsymbol_from_rdf_symbol_name);
}
    ...
    Object symbol;
{
    ...
    x_note_fn_call(137,282);
    s_plus_p = get(symbol,Qsymbol_from_rdf_symbol_name,_);
    s = CAR(s_plus_p);
    if (CONSP(s)) {
	temp = gensym_cons_1(CAR(s),CDR(s));
...
Object read_xml_name(first_char)
    Object first_char;
{
    Object ch, ch_list, index_1, next_char, using_string_buffer_p;
    Object current_gensym_string, fill_pointer_for_current_gensym_string;
    Object total_length_of_current_gensym_string, current_twriting_output_type;
    Object next_char_1, temp, code, temp_2, temp_3, wide_character_code;
    Object code_1, extended_code, unicode, gensym_character_code_qm;
    ...
    Object symbol, current_wide_string_list, wide_string_bv16;
    Object current_wide_string, fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, ch_1, ab_loop_list_, name;
    SI_Long row, gensym_full_row, gensymed_symbol, gensymed_symbol_1, octet_2;
    SI_Long octet_3, thing_1, simple_or_wide_character_1, bv16_length;
    SI_Long aref_arg_2, aref_new_value, length_1;
    char temp_1;
    Declare_special(9);
    Object result;

    x_note_fn_call(137,283);
    ch = Nil;
    ch_list = Nil;
    index_1 = FIX((SI_Long)0L);
    next_char = Nil;
    ...
    PUSH_SPECIAL(Current_gensym_string,current_gensym_string,8);
      fill_pointer_for_current_gensym_string = FIX((SI_Long)0L);
      PUSH_SPECIAL(Fill_pointer_for_current_gensym_string,fill_pointer_for_current_gensym_string,
	      7);
	total_length_of_current_gensym_string = FIX((SI_Long)2048L);
	PUSH_SPECIAL(Total_length_of_current_gensym_string,total_length_of_current_gensym_string,
	  ...
	  PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  5);
	    next_char_1 = first_char;
	    if (next_char_1);
	    else
		next_char_1 = read_next_xml_char();
	    ch_list = gensym_cons_1(next_char_1,ch_list);
	    temp = next_char_1;
	    if (temp);
	    else {
	  ...
	  next_loop:
		...
		temp_1 = TRUEP(complex_char_pw(ch));
	    if (temp_1);
	    else
	    ...
	    if ( !temp_1)
		goto end_loop;
	    ch_list = gensym_cons_1(ch,ch_list);
	    next_char = ch;
	    if (using_string_buffer_p && FIXNUM_LT(index_1,
		    Intern_string_buffer_length)) {
		code = next_char;
		...
		PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		  ...
		  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		    ...
		    PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			    0);
		      ch_1 = Nil;
		      ab_loop_list_ = nreverse(ch_list);
		    next_loop_1:
		      if ( !TRUEP(ab_loop_list_))
			  goto end_loop_1;
		      ch_1 = M_CAR(ab_loop_list_);
		      ab_loop_list_ = M_CDR(ab_loop_list_);
		      if (EQ(Current_twriting_output_type,Qwide_string)) {
			  thing = ch_1;
			  twrite_wide_character(CHARACTERP(thing) ? 
		      ...
		      goto next_loop_1;
		    end_loop_1:;
		      name = copy_out_current_wide_string();
		    POP_SPECIAL();
		  POP_SPECIAL();
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    bind_symbol_to_rdf_symbol_name(symbol,name);
	    reclaim_text_string(name);
	    reclaim_gensym_list_1(ch_list);
	    temp = symbol;
	  POP_SPECIAL();
	POP_SPECIAL();
      POP_SPECIAL();
...
/* COMPLEX-CHAR-PW */
Object complex_char_pw(ch)
    Object ch;
{
    Object code;

    x_note_fn_call(137,286);
    code = ch;
    if (IFIX(code) > (SI_Long)255L)
	return VALUES_1( !TRUEP(xml_whitespace_p(ch)) ? T : Nil);
    else
	return VALUES_1(Nil);
}

static Object string_constant_146;  /* "Expected >" */

static Object string_constant_147;  /* "Expected =" */

static Object string_constant_148;  /* "Expected an attribute, /, or >" */
    ...
    Object next_char, xml_read_context;
{
  ...
  next_loop:
	...
	if ( !((SI_Long)62L == IFIX(read_next_xml_char()))) {
	    reclaim_gensym_list_1(result_1);
	    temp = read_xml_error_string(2,xml_read_context,
		    string_constant_146);
	    return VALUES_2(Nil,temp);
	}
	...
	if (temp_1) {
	    ...
	    attvalue = gensym_list_2(name,attvalue);
	}
	else {
	    reclaim_gensym_list_1(result_1);
	    temp = read_xml_error_string(2,xml_read_context,
...
static Object string_constant_149;  /* "Unrecognized character reference \"&~a;\"" */

static Object string_constant_150;  /* "Expected \";\"" */
    ...
    Object xml_read_context;
{
	...
	if (EQ(name,QAMP))
	    ...
	    return read_xml_error_string(3,xml_read_context,
		    string_constant_149,name);
    }
    else
	return read_xml_error_string(2,xml_read_context,string_constant_150);
}

static Object string_constant_151;  /* "Expected \" or '" */
    ...
    Object quote, xml_read_context;
{
    ...
    x_note_fn_call(137,289);
    if ( !(IFIX(quote) == (SI_Long)34L || IFIX(quote) == (SI_Long)39L)) {
	result = VALUES_2(Nil,string_constant_151);
...
Object read_xml_make_attribute_name(name,kind)
    Object name, kind;
{
    x_note_fn_call(137,291);
    if ((EQ(kind,Quser_attribute) || EQ(kind,Qqualified_attribute)) && 
	    ATOM(name))
	return gensym_cons_1(name,Nil);
    else
	return VALUES_1(name);
}

Object Most_recent_xml_checksum_differences = UNBOUND;

static Object Qname_text_string_for_kb_being_read;  /* name-text-string-for-kb-being-read */

static Object string_constant_152;  /* "Checksum Error in ~A: ~(~L,A~)" */

static Object string_constant_153;  /* "Checksum Error: ~(~L,A~)" */
...
Object Current_module_data = UNBOUND;

Object Initialize_items_count = UNBOUND;

Object Delayed_item_array_initializations = UNBOUND;

Object Delay_item_array_initializations_p = UNBOUND;

Object Externaldefinitions_fixups = UNBOUND;

Object Systemtables_fixups = UNBOUND;

Object Systemtables_are_initialized_p = UNBOUND;

Object Kb_window_for_initializing_definitions = UNBOUND;

Object Clear_text_item_layering_info = UNBOUND;

Object Disable_update_button = UNBOUND;

Object Disable_subworkspace_connection_posts = UNBOUND;

Object Change_the_text_of_attributes_without_category_evaluator_interfaces_p = UNBOUND;

Object Changing_validity_interval_invalidates_current_value_p = UNBOUND;

Object Suppress_consistency_analysis_warnings_notes_qm = UNBOUND;
    ...
    Object data, auto_merge_case_qm;
{
    ...
    PUSH_SPECIAL(Do_not_note_permanent_changes_p,do_not_note_permanent_changes_p,
	    26);
      PUSH_SPECIAL(Clear_text_item_layering_info,clear_text_item_layering_info,
	      25);
	PUSH_SPECIAL(Kb_window_for_initializing_definitions,kb_window_for_initializing_definitions,
		24);
	  PUSH_SPECIAL(Systemtables_are_initialized_p,systemtables_are_initialized_p,
		  23);
	    PUSH_SPECIAL(Systemtables_fixups,systemtables_fixups,22);
	      PUSH_SPECIAL(Externaldefinitions_fixups,externaldefinitions_fixups,
		      21);
		PUSH_SPECIAL(Initialize_items_count,initialize_items_count,20);
		  PUSH_SPECIAL(Total_items_in_file,total_items_in_file,19);
		    PUSH_SPECIAL(Disable_update_button,disable_update_button,
			    18);
		      PUSH_SPECIAL(Disable_subworkspace_connection_posts,disable_subworkspace_connection_posts,
			      17);
			PUSH_SPECIAL(Delay_item_array_initializations_p,delay_item_array_initializations_p,
				16);
			  PUSH_SPECIAL(Delayed_item_array_initializations,delayed_item_array_initializations,
				  15);
			    PUSH_SPECIAL(Disable_tracing_and_breakpoints_warning,disable_tracing_and_breakpoints_warning,
				    14);
			      PUSH_SPECIAL(Allow_name_box_creation,allow_name_box_creation,
				      13);
				PUSH_SPECIAL(Keep_edit_workspace_hidden_no_matter_what_qm,keep_edit_workspace_hidden_no_matter_what_qm,
					12);
				  PUSH_SPECIAL(Change_the_text_of_attributes_without_category_evaluator_interfaces_p,change_the_text_of_attributes_without_category_evaluator_interfaces_p,
					  11);
				    PUSH_SPECIAL(Changing_validity_interval_invalidates_current_value_p,changing_validity_interval_invalidates_current_value_p,
					    10);
					...
					PUSH_SPECIAL(Suppress_consistency_analysis_warnings_notes_qm,suppress_consistency_analysis_warnings_notes_qm,
						8);
					  PUSH_SPECIAL(Called_within_clear_text_loading,called_within_clear_text_loading,
						  7);
					    PUSH_SPECIAL(Initializing_clear_text_p,initializing_clear_text_p,
						    6);
					      PUSH_SPECIAL(Loading_kb_p,loading_kb_p,
						      5);
						PUSH_SPECIAL(Reading_kb_p,reading_kb_p,
							4);
						  PUSH_SPECIAL(Suppress_updating_of_slot_value_representations_qm,suppress_updating_of_slot_value_representations_qm,
							  3);
						    PUSH_SPECIAL(Ignore_kb_state_changes_p,ignore_kb_state_changes_p,
							    2);
						      PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
							      1);
							PUSH_SPECIAL(Current_module_data,current_module_data,
								0);
							  Current_computation_flags 
								  = 
							  ...
							  gensymed_symbol 
								  = 
								  ISVREF(Kb_window_for_initializing_definitions,
								  (SI_Long)14L);
							  gensymed_symbol 
								  = 
								  gensymed_symbol 
    ...
    Object data;
{
    ...
    Plist_from_end_element_qm = 
	    nconc2(gensym_list_2(Qdetail_pane_description,temp),
	    Plist_from_end_element_qm);
...
Object Definitions_in_module = UNBOUND;

Object Definitions_in_module_to_go = UNBOUND;

Object In_external_definitions_for_module_p = UNBOUND;
    ...
    Object object_and_fixups;
{
	...
	if (class_1 && class_name && direct_superior_classes &&  
	    ...
	    Definitions_in_module = gensym_cons_1(gensymed_symbol,
...
Object create_all_definitions_in_module()
{
    ...
    gensymed_symbol_1 = M_CDR(gensymed_symbol_1);
    M_CAR(gensymed_symbol_1) = Nil;
    definitions_in_module_to_go = gensym_cons_1(gensymed_symbol,
	    copy_list_using_gensym_conses_1(Definitions_in_module));
    PUSH_SPECIAL(Definitions_in_module_to_go,definitions_in_module_to_go,0);
    next_loop:
    ...
    end_loop:
      ...
      reclaim_gensym_list_1(gensym_pop_store);
    POP_SPECIAL();
  next_loop_1:
    ...
    Object name_plus_nname_plus_object_and_fixups_plus_ghostp_plus_class;
{
    ...
    x_note_fn_call(137,298);
    if (memq_function(name_plus_nname_plus_object_and_fixups_plus_ghostp_plus_class,
	    Definitions_in_module_to_go)) {
	Definitions_in_module_to_go = 
		delete_gensym_element_1(name_plus_nname_plus_object_and_fixups_plus_ghostp_plus_class,
		Definitions_in_module_to_go);
	object_and_fixups = 
	...
	PUSH_SPECIAL(Reading_ghost_definitions_p,reading_ghost_definitions_p,
		0);
	  class_1 = 
    ...
    Object data;
{
    ...
    x_note_fn_call(137,299);
    definitions_in_module = Nil;
    PUSH_SPECIAL(Definitions_in_module,definitions_in_module,1);
      in_external_definitions_for_module_p = T;
      PUSH_SPECIAL(In_external_definitions_for_module_p,in_external_definitions_for_module_p,
	      0);
...
Object May_create_simulation_subtable_from_module_data_p = UNBOUND;
    ...
    Object class_description, object_and_fixups, do_loose_ends_p;
{
    ...
    x_note_fn_call(137,307);
    disable_stack_error = T;
    PUSH_SPECIAL(Disable_stack_error,disable_stack_error,3);
	...
	PUSH_SPECIAL(Uuid_for_next_frame_qm,uuid_for_next_frame_qm,1);
	  class_description_for_next_frame_qm = class_description;
	  PUSH_SPECIAL(Class_description_for_next_frame_qm,class_description_for_next_frame_qm,
		  0);
    ...
    Object object_and_fixups, resolve_references_p;
{
    ...
    Object gensymed_symbol_4, gensymed_symbol_5, held_vector, name_1;
    Object attribute_value, svref_new_value;
    SI_Long name, ab_loop_bind_, gensymed_symbol_1, svref_arg_2;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, next_index, length_1;
    char temp_1;
    Declare_special(1);

    x_note_fn_call(137,309);
    object_and_fixups_1 = object_and_fixups;
    object_and_fixups_vector = CONSP(object_and_fixups_1) && 
	    EQ(M_CDR(object_and_fixups_1),Qab_structure) ? 
	    M_CAR(object_and_fixups_1) : Nil;
	...
	if (temp)
		...
		PUSH_SPECIAL(May_create_simulation_subtable_from_module_data_p,may_create_simulation_subtable_from_module_data_p,
			0);
		  actual_value = 
			  create_all_instances_from_module_data(value,
			  resolve_references_p);
		  gensymed_symbol_4 = actual_value;
		  temp_1 = FIXNUMP(gensymed_symbol_4);
		  if (temp_1);
		  else
		      temp_1 = 
			      INLINE_DOUBLE_FLOAT_VECTOR_P(gensymed_symbol_4) 
			      != (SI_Long)0L ? 
		  ...
		  if (temp_1);
		      ...
		      temp_1 = gensymed_symbol_4 ? 
			      SYMBOLP(gensymed_symbol_4) : TRUEP(Qnil);
		  if (temp_1);
		  else
		      temp_1 = 
		  ...
		  if (temp_1);
			  ...
			  gensymed_symbol_1 = 
				  SXHASH_SYMBOL_1(gensymed_symbol_4) & 
				  IFIX(Most_positive_fixnum);
    ...
    Object object_and_fixups;
{
    ...
    Object gensymed_symbol, gensymed_symbol_1, temp_1;
    Object stack_of_slot_value_changes, gensymed_symbol_2, gensymed_symbol_3;
    Object svref_new_value, item_or_value_1, value, actual_value, temp_3;
    Object temp_4, frame_and_slot_or_atom, ab_loop_list_, ab_loop_it_;
    Object gensym_pop_store, cons_1, next_cons, held_vector, name_1;
    Object attribute_value;
    SI_Long temp_2, gensymed_symbol_4, item_or_value, name, ab_loop_bind_;
    SI_Long next_index, length_1;
    char temp;
    Declare_special(1);

    x_note_fn_call(137,310);
    object_and_fixups_1 = object_and_fixups;
    object_and_fixups_vector = CONSP(object_and_fixups_1) && 
	    EQ(M_CDR(object_and_fixups_1),Qab_structure) ? 
	    M_CAR(object_and_fixups_1) : Nil;
	...
	if (temp) {
	    ...
	    if (Nil)
		gensymed_symbol_1 = nconc2(gensym_list_2(object,
	    ...
	    PUSH_SPECIAL(Stack_of_slot_value_changes,stack_of_slot_value_changes,
		  ...
		  inline_funcall_3(gensymed_symbol,gensymed_symbol_1,
			  gensymed_symbol_2,gensymed_symbol_3);
		  temp_2 = IFIX(ISVREF(object,(SI_Long)5L)) | 
			  (SI_Long)16777216L;
		  ISVREF(object,(SI_Long)5L) = FIX(temp_2);
	      }
		  ...
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
		      ...
		      temp_1 = ISVREF(gensymed_symbol,(gensymed_symbol_4 
			      >>  -  - (SI_Long)10L) + (SI_Long)2L);
		      temp_2 = gensymed_symbol_4 & (SI_Long)1023L;
		      ISVREF(temp_1,temp_2) = FIX((SI_Long)1L);
		  }
		  if (FIXNUM_LE(ISVREF(gensymed_symbol,(SI_Long)1L),
			  Maximum_in_place_array_size))
		  ...
		  value = gensym_cons_1(gensymed_symbol,Qab_structure);
		...
		next_loop:
		  ...
		  if ( !TRUEP(memq_function(FIX(name),list_constant_18))) {
		      temp_3 = FIX(name);
		      temp_4 = xml_object_text_of_p(value);
		      initialize_attribute_from_module_data(5,object,
			      temp_3,actual_value,temp_4,
			      xml_object_unit(value));
		  }
		  name = name + (SI_Long)1L;
		  goto next_loop;
		...
		next_loop_1:
		  ...
		  if (temp);
		      ...
		      temp = CONSP(temp_3) ? EQ(slot_description,
    ...
    Object kb_workspace, info;
{
    ...
    Object ab_loopvar__2, gensym_pop_store, cons_1, next_cons, cdr_new_value;
    Object ab_loop_list_, ab_loop_desetq_, possible_top_item, higher_item;
    Object top_item, item, next_item, items_from_top_to_bottom;

    x_note_fn_call(137,319);
    e = Nil;
    after = Nil;
    before = Nil;
    collectp = Nil;
	...
	if (EQ(type,Qprimitive_value) || EQ(type,Qtext))
		...
		if (position_in_workspace) {
			...
			desired_position_in_workspace = 
				gensym_cons_1(gensymed_symbol_3,Qab_structure);
			initialize_attribute_from_module_data(3,object,
...
static Object string_constant_154;  /* "Illegal simulation-details" */

static Object string_constant_155;  /* "Illegal text value" */
	...
	PUSH_SPECIAL(Current_computation_frame,current_computation_frame,0);
	  ...
	  if (temp) {
		  ...
		  change_slot_description_value_function(item,
			  ...
			  gensym_list_2(FIXNUMP(value) || value && 
			  SYMBOLP(value) ? value : 
		  ...
		  if (initialize_p &&  !EQ(value,
			  ...
			  update_attribute_tables(1,
				  get_lookup_slot_value_given_default(value,
				  Qparent_frame,Nil));
			  gensymed_symbol = ISVREF(value,(SI_Long)14L);
			  gensymed_symbol = gensymed_symbol ? 
				  ISVREF(gensymed_symbol,(SI_Long)5L) : Nil;
			  if (gensymed_symbol) {
			      ...
			      gensymed_symbol = ISVREF(value,(SI_Long)14L);
			      gensymed_symbol = gensymed_symbol ? 
				      ISVREF(gensymed_symbol,(SI_Long)5L) :
				       Nil;
		  ...
		  if (initialize_p)
		      Delayed_item_array_initializations = 
			      gensym_cons_1(gensym_cons_1(item,value),
			      Delayed_item_array_initializations);
		  problem_description_qm = Nil;
	      }
	      else if (initialize_p)
...
static Object string_constant_156;  /* "Save" */

static Object string_constant_157;  /* "Load" */

static Object string_constant_158;  /* "~A problem: ~A" */

static Object string_constant_159;  /* "~A problem when making ~NF be the ~S of ~NF: ~A" */

static Object string_constant_160;  /* "~A problem when making ~NV be the ~S of ~NF: ~A" */
    ...
    Object save_or_load, item, attribute, value, problem_description_qm;
{
    ...
    skip_prefix = match_prefix(array_constant_31,problem_description_qm);
    if (skip_prefix);
    else
	skip_prefix = match_prefix(array_constant_32,problem_description_qm);
    if (EQ(save_or_load,Qsave))
	operation_string = string_constant_156;
    else if (EQ(save_or_load,Qload))
	operation_string = string_constant_157;
    else
	operation_string = Qnil;
    if (skip_prefix)
	control_string = string_constant_158;
    else {
	if (SIMPLE_VECTOR_P(value) && 
		IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(value)) > (SI_Long)2L &&  
	    ...
	    temp = TRUEP(Nil);
	control_string = temp ? string_constant_159 : string_constant_160;
    }
...
Object do_delayed_array_initializations()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(Delayed_item_array_initializations);
    return VALUES_1(Qnil);
}
...
Object Allow_comparison_of_slot_value_to_parse_result = UNBOUND;

static Object Qslot_value_compiler;  /* slot-value-compiler */

static Object string_constant_161;  /* "Slot value does not match compiled result.~
				     *                               ~%  ~A ~A~%  ~A~%  ~A"
				     */
	...
	PUSH_SPECIAL(Current_edit_state,current_edit_state,0);
	  ...
	  if (EQ(parse_result_or_bad_phrase,Bad_phrase))
		  ...
		  if (Allow_comparison_of_slot_value_to_parse_result) {
			  ...
			  notify_user_at_console(5,string_constant_161,
...
void kb_save4_INIT()
{
    ...
    Object Qrdf_col_Seq, Qxml_nil, Qset_default_window_position_and_scale;
    ...
    Object Qfreeform_table, Qreadout_table, Qgraph, Qtrend_chart, Qchart;
    Object Qentity, Qset_following_item_in_workspace_layering;
    ...
    Object Qauthors, Qbinary_xml_checksum, Qtext_xml_checksum;
    Object Qvalue_xml_checksum, Quuid_xml_checksum;
    Object Qattribute_name_xml_checksum, Qattr_not_found, Qwrite_clear_text_kb;
    Object Qg2_compare_xml_objects;
    ...
    array_constant_24 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)0L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)1L,(SI_Long)50L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)2L,(SI_Long)58L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)7L,(SI_Long)57344L);
    array_constant_25 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)0L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)1L,(SI_Long)50L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)2L,(SI_Long)109L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)3L,(SI_Long)58L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)6L,(SI_Long)4L);
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)7L,(SI_Long)57344L);
    array_constant_26 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)0L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)1L,(SI_Long)46L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)6L,(SI_Long)2L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)7L,(SI_Long)57344L);
    array_constant_27 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)0L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)1L,(SI_Long)46L);
    ...
    array_constant_28 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)0L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)1L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)2L,(SI_Long)46L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)7L,(SI_Long)57344L);
    Quser_attribute = STATIC_SYMBOL("USER-ATTRIBUTE",AB_package);
    array_constant_29 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)0L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)1L,(SI_Long)113L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)2L,(SI_Long)46L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)6L,(SI_Long)3L);
    ...
    string_constant_146 = STATIC_STRING("Expected >");
    string_constant_147 = STATIC_STRING("Expected =");
    string_constant_148 = STATIC_STRING("Expected an attribute, /, or >");
    ...
    string_constant_150 = STATIC_STRING("Expected \";\"");
    string_constant_151 = STATIC_STRING("Expected \" or \'");
    ...
    SET_SYMBOL_VALUE_LOCATION(Qname_text_string_for_kb_being_read,
	    Name_text_string_for_kb_being_read);
    string_constant_152 = STATIC_STRING("Checksum Error in ~A: ~(~L,A~)");
    string_constant_153 = STATIC_STRING("Checksum Error: ~(~L,A~)");
    ...
    string_constant_154 = STATIC_STRING("Illegal simulation-details");
    string_constant_155 = STATIC_STRING("Illegal text value");
    ...
    array_constant_31 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)48L));
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)0L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)1L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)2L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)3L,(SI_Long)98L);
    ...
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)7L,(SI_Long)116L);
    ...
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)12L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)13L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)14L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)15L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)16L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)17L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)18L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)19L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)20L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)21L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)22L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)23L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)24L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)25L,(SI_Long)118L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)26L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)27L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)28L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)29L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)30L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)31L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)32L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)33L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)34L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)35L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)36L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)37L,(SI_Long)104L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)38L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)46L,(SI_Long)39L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)47L,(SI_Long)57344L);
    array_constant_32 = STATIC_ARRAY(list_constant_29,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)0L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)1L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)2L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)3L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)4L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)5L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)6L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)7L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)8L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)9L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)10L,(SI_Long)108L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)11L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)12L,(SI_Long)100L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)13L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)14L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)15L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)22L,(SI_Long)16L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)23L,(SI_Long)57344L);
    string_constant_156 = STATIC_STRING("Save");
    string_constant_157 = STATIC_STRING("Load");
    string_constant_158 = STATIC_STRING("~A problem: ~A");
    string_constant_159 = 
