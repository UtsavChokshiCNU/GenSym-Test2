...
Object Chain_of_available_gfi_queue_items = UNBOUND;

Object Gfi_queue_item_count = UNBOUND;
    ...
    Object gfi_queue_item;
{
    ...
    svref_new_value = 
	    ...
	    (SI_Long)1L));
    SVREF(gfi_queue_item,FIX((SI_Long)1L)) = svref_new_value;
    SVREF(gfi_queue_item,FIX((SI_Long)1L)) = Nil;
    svref_new_value = 
	    reclaim_managed_number_or_value_function(ISVREF(gfi_queue_item,
	    (SI_Long)2L));
    SVREF(gfi_queue_item,FIX((SI_Long)2L)) = svref_new_value;
    SVREF(gfi_queue_item,FIX((SI_Long)2L)) = Nil;
    reclaim_gensym_tree_1(ISVREF(gfi_queue_item,(SI_Long)4L));
    ...
    reclaim_gensym_tree_1(ISVREF(gfi_queue_item,(SI_Long)8L));
    SVREF(gfi_queue_item,FIX((SI_Long)8L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_gfi_queue_items;
    SVREF(gfi_queue_item,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gfi_queue_items = gfi_queue_item;
    return VALUES_1(Nil);
}
...
Object make_permanent_gfi_queue_item_structure_internal()
{
    ...
    Object gfi_queue_item_count_new_value;
    ...
    gfi_queue_item_count_new_value = FIXNUM_ADD1(Gfi_queue_item_count);
    Gfi_queue_item_count = gfi_queue_item_count_new_value;
...
Object Available_gfi_spreadsheet_field_index_hash_vector_131_vectors = UNBOUND;

Object Count_of_gfi_spreadsheet_field_index_hash_vector_131_vectors = UNBOUND;
...
{
    Object count_of_gfi_spreadsheet_field_index_hash_vector_131_vectors_new_value;
    Object temp;
    XDeclare_area(1);

    x_note_fn_call(218,8);
    count_of_gfi_spreadsheet_field_index_hash_vector_131_vectors_new_value 
	    = 
	    FIXNUM_ADD1(Count_of_gfi_spreadsheet_field_index_hash_vector_131_vectors);
...
Object make_gfi_spreadsheet_field_index_hash_vector()
{
    ...
    if (Available_gfi_spreadsheet_field_index_hash_vector_131_vectors) {
	temp = 
		M_CAR(Available_gfi_spreadsheet_field_index_hash_vector_131_vectors);
	temp_1 = 
		M_CDR(Available_gfi_spreadsheet_field_index_hash_vector_131_vectors);
	inline_note_reclaim_cons(Available_gfi_spreadsheet_field_index_hash_vector_131_vectors,
		Qab_gensym);
	cdr_arg = 
	...
	Available_gensym_conses = 
		Available_gfi_spreadsheet_field_index_hash_vector_131_vectors;
	Available_gfi_spreadsheet_field_index_hash_vector_131_vectors = temp_1;
    }
    else
	temp = 
...
Object reclaim_gfi_spreadsheet_field_index_tree_for_hash_leaves(gfi_spreadsheet_field_index_tree_for_hash_binary_tree)
    Object gfi_spreadsheet_field_index_tree_for_hash_binary_tree;
{
    ...
    alist = Nil;
  next_loop:
    if ( !TRUEP(gfi_spreadsheet_field_index_tree_for_hash_binary_tree))
	goto end_loop;
    less_than_branch_qm = 
	    ISVREF(gfi_spreadsheet_field_index_tree_for_hash_binary_tree,
	    (SI_Long)1L);
    greater_than_branch_qm = 
	    ISVREF(gfi_spreadsheet_field_index_tree_for_hash_binary_tree,
	    (SI_Long)2L);
    alist = ISVREF(gfi_spreadsheet_field_index_tree_for_hash_binary_tree,
	    (SI_Long)3L);
    reclaim_binary_tree_element_1(gfi_spreadsheet_field_index_tree_for_hash_binary_tree);
    alist_entry = Nil;
    ab_loop_list_ = alist;
  next_loop_1:
  ...
  end_loop_1:;
	...
	reclaim_gfi_spreadsheet_field_index_tree_for_hash_leaves(less_than_branch_qm);
	gfi_spreadsheet_field_index_tree_for_hash_binary_tree = 
		greater_than_branch_qm;
    }
    else {
	...
	gfi_spreadsheet_field_index_tree_for_hash_binary_tree = temp;
    }
    goto next_loop;
  end_loop:;
...
Object clear_gfi_spreadsheet_field_index_tree(gfi_spreadsheet_field_index_tree_for_hash_binary_tree)
    Object gfi_spreadsheet_field_index_tree_for_hash_binary_tree;
{
    Object element_qm;

    x_note_fn_call(218,12);
    element_qm = CDR(gfi_spreadsheet_field_index_tree_for_hash_binary_tree);
    if (element_qm) {
	reclaim_gfi_spreadsheet_field_index_tree_for_hash_leaves(element_qm);
	M_CDR(gfi_spreadsheet_field_index_tree_for_hash_binary_tree) = Nil;
    }
    return VALUES_1(gfi_spreadsheet_field_index_tree_for_hash_binary_tree);
}
...
Object reclaim_gfi_spreadsheet_field_index(gfi_spreadsheet_field_index_hash_table)
    Object gfi_spreadsheet_field_index_hash_table;
{
    Object gfi_spreadsheet_field_index_tree_for_hash_binary_tree, element_qm;
  ...
  next_loop:
    ...
    element_qm = M_CDR(gfi_spreadsheet_field_index_tree_for_hash_binary_tree);
    if (element_qm)
	reclaim_gfi_spreadsheet_field_index_tree_for_hash_leaves(element_qm);
    inline_note_reclaim_cons(gfi_spreadsheet_field_index_tree_for_hash_binary_tree,
	    Qab_gensym);
    cdr_new_value = Available_gensym_conses;
    M_CDR(gfi_spreadsheet_field_index_tree_for_hash_binary_tree) = 
	    cdr_new_value;
    Available_gensym_conses = 
	    gfi_spreadsheet_field_index_tree_for_hash_binary_tree;
...
Object Queue_of_active_gfi_output_interface_objects = UNBOUND;

Object Queue_of_active_gfi_input_interface_objects = UNBOUND;

Object Queue_of_active_uninterruptable_gfi_output_interface_objects = UNBOUND;

Object Queue_of_active_uninterruptable_gfi_input_interface_objects = UNBOUND;

Object Time_slice_expired_p = UNBOUND;
    ...
    Object key, queue_pair;
{
	...
	inline_note_reclaim_cons(delete_cons,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(delete_cons) = temp;
	Available_gensym_conses = delete_cons;
    }
...
Object reclaim_gfi_queue_of_new_output_values_contents(queue_pair)
    Object queue_pair;
{
    Object queue_list, item_, rest_of_list_, last_1, next_qm, cdr_new_value;
	...
	if (queue_list) {
	  ...
	  end_loop_1:
	    ...
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(last_1) = cdr_new_value;
	    Available_gensym_conses = queue_list;
	}
    ...
    Object frame, new_value, gensymed_symbol;
{
	...
	reclaim_gensym_list_1(get_lookup_slot_value_given_default(gfi_output_frame,
		Qgfi_output_not_unique_designation_p_results,Nil));
  ...
  next_loop:
    ...
    gensymed_symbol_2 = gensym_cons_1(gensymed_symbol_3 ? T : Nil,Nil);
    ...
    Object slot_value, frame;
{
	...
	goto next_loop;
      end_loop:;
	reclaim_gensym_list_1(slot_value);
    }
    return VALUES_1(Nil);
}
    ...
    Object value_qm, frame;
{
    ...
    set_non_savable_lookup_slot_value(frame,
	    Qgfi_output_not_unique_designation_p_results,Nil);
    if (value_qm)
	reclaim_gensym_list_1(value_qm);
    return VALUES_1(Nil);
}
    ...
    Object gfi_output_frame, e_designations, not_unique_designation_results;
{
    ...
    designation_position_pair = gensym_cons_1(Nil,Nil);
    designation = Nil;
  ...
  next_loop:
	...
	if (temp) {
		...
		set_balanced_binary_tree_entry(SVREF(temp_1,FIX(temp_2)),
			Qeq,Nil,T,designation_value,FIX(gensymed_symbol),
			position_1);
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_cons_1(designation_position_pair);
    ...
    Object gfi_output_frame;
{
    ...
    Object list_of_output_designations, designations, queue_of_values;
    Object error_text;
	...
	if (pathname_qm && 
	    ...
	    list_of_output_designations = 
		    install_gfi_true_value_update(gfi_output_frame,temp_1,
	    ...
	    temp_1 = get_lookup_slot_value_given_default(gfi_output_frame,
		    Qgfi_output_values,Nil);
	    designations = CAR(temp_1);
	    if (designations) {
		set_non_savable_lookup_slot_value(gfi_output_frame,
			Qgfi_queue_of_new_output_values,gensym_cons_1(Nil,
			Nil));
		if (EQ(get_lookup_slot_value(gfi_output_frame,
		  ...
		  next_loop:
		    ...
		    queue_of_values = gensym_cons_1(Nil,queue_of_values);
		    goto next_loop;
		  end_loop:
		    set_non_savable_lookup_slot_value(gfi_output_frame,
    ...
    Object old_value, class_if_specific_qm;
{
    ...
    Object queue_pair, temp_2, last_queue_item_qm, new_cons, gensymed_symbol_4;
    Object new_cons_, queue_pair_, temp_3, gensymed_symbol_5;
    Object gensymed_symbol_6, pruned_interest_list, gensym_cons;
		...
		PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
		  ...
		  if (PUSH_UNWIND_PROTECT(0)) {
			...
			if (PUSH_LOCAL_ALLOCATION(Local_area,1,1)) {
				...
				if (position_qm) {
					...
					temp_1 = 
						copy_tree_using_gensym_conses_1(CAR(designation_position_pair));
				...
				M_CAR(gensymed_symbol_4) = queue_item;
				M_CDR(gensymed_symbol_4) = Nil;
				inline_note_allocate_cons(gensymed_symbol_4,
					Qab_gensym);
				new_cons_ = gensymed_symbol_4;
				queue_pair_ = queue_pair;
				if (M_CAR(queue_pair_)) {
				    temp_1 = M_CDR(queue_pair_);
				    M_CDR(temp_1) = new_cons_;
				}
				else
				    M_CAR(queue_pair_) = new_cons_;
				M_CDR(queue_pair_) = new_cons_;
				set_non_savable_lookup_slot_value(gfi_output_frame,
		  ...
		  if (gensymed_symbol_3) {
			...
			end_1:;
		      ...
		      Available_gensym_conses = gensymed_symbol_3;
		  }
		  CONTINUE_UNWINDING(0);
...
Object prepare_gfi_output_interface_to_open(gfi_output_interface)
    Object gfi_output_interface;
{
    Object code, temp, new_cons, gensymed_symbol, new_cons_, queue_pair_;
    Object cdr_arg, queue_list;
	...
	if ( ! !TRUEP(CAR(temp)))
		...
		if (Queue_of_active_uninterruptable_gfi_output_interface_objects) 
		    ...
		    if ( !TRUEP(gensymed_symbol))
			gensymed_symbol = replenish_gensym_cons_pool();
		    M_CAR(gensymed_symbol) = gfi_output_interface;
		    M_CDR(gensymed_symbol) = Nil;
		    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
		    new_cons_ = gensymed_symbol;
		    queue_pair_ = 
			    Queue_of_active_uninterruptable_gfi_output_interface_objects;
		    if (M_CAR(queue_pair_)) {
			cdr_arg = M_CDR(queue_pair_);
			M_CDR(cdr_arg) = new_cons_;
		    }
		    else
			M_CAR(queue_pair_) = new_cons_;
		    M_CDR(queue_pair_) = new_cons_;
		    ...
		    queue_list = gensym_cons_1(gfi_output_interface,Nil);
		    Queue_of_active_uninterruptable_gfi_output_interface_objects 
			    = gensym_cons_1(queue_list,queue_list);
		}
	    }
		...
		inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
		new_cons_ = gensymed_symbol;
		queue_pair_ = Queue_of_active_gfi_output_interface_objects;
		if (M_CAR(queue_pair_)) {
		    cdr_arg = M_CDR(queue_pair_);
		    M_CDR(cdr_arg) = new_cons_;
		}
...
Object schedule_gfi_output_tasks(gfi_output_frame)
    Object gfi_output_frame;
{
    Object value, temp, file_format, current_task_schedule_modify_arg_2;
	...
	if (temp_1) {
		...
		current_task_schedule_modify_arg_11 = gfi_output_frame;
		schedule_task_qm = 
			get_lookup_slot_value_given_default(gfi_output_frame,
			Qgfi_output_scheduled_task,Nil);
		if (schedule_task_qm) {
    ...
    Object gfi_output_frame, do_not_override_time_slice_p;
{
    ...
    Object pruned_interest_list, gensym_cons;
    ...
    Object execution_time, future_task_schedule_modify_arg_2;
    ...
    char temp_1, g2_p, svref_new_value;
    double aref_new_value, temp_3, future_task_schedule_modify_arg_3;
    Declare_stack_pointer;
    Declare_catch(1);
    Declare_special(5);
    XDeclare_area(1);
	...
	PUSH_SPECIAL(Time_slice_expired_p,time_slice_expired_p_1,4);
	  if (output_stream) {
			...
			PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
			  ...
			  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
				...
				if (gensymed_symbol_3 &&  !((SI_Long)0L == 
				    ...
				    gensym_cons = gensymed_symbol_3;
				  next_loop_2:
				    inline_note_reclaim_cons(gensym_cons,
					    Qab_gensym);
				    if (EQ(gensym_cons,gensymed_symbol_4))
					goto end_1;
				    else if ( !TRUEP(gensym_cons))
				...
				M_CDR(gensymed_symbol_4) = temp_2;
				Available_gensym_conses = gensymed_symbol_3;
			    }
			    CONTINUE_UNWINDING(0);
			  POP_SPECIAL();
		...
		end_loop:
		  ...
		  if (do_not_override_time_slice_p && Time_slice_expired_p 
			  ...
			  v = ctask ? Current_task_queue_vector : 
				  Deferred_task_queue_vector;
			  q = ISVREF(v,IFIX(p));
			  gensymed_symbol_3 = ISVREF(q,(SI_Long)1L);
			  def_structure_queue_element_variable = 
				  Chain_of_available_queue_elements;
			  if (def_structure_queue_element_variable)
			      Chain_of_available_queue_elements = 
			  ...
			  SVREF(def_structure_queue_element_variable,
				  FIX((SI_Long)0L)) = q;
			  SVREF(def_structure_queue_element_variable,
				  FIX((SI_Long)1L)) = gensymed_symbol_3;
			  SVREF(def_structure_queue_element_variable,
				  FIX((SI_Long)2L)) = task;
			  gensymed_symbol_4 = 
				  def_structure_queue_element_variable;
			  SVREF(gensymed_symbol_3,FIX((SI_Long)0L)) = 
				  gensymed_symbol_4;
			  ...
			  future_task_schedule_modify_arg_3 = temp_3 + 
				  (double)temp_4;
    ...
    Object gfi_output_frame, do_not_override_time_slice_p;
{
    ...
    Object gensymed_symbol_6, pruned_interest_list, gensym_cons, x2;
    Object current_task_schedule_modify_arg_2;
    Object current_task_schedule_modify_arg_8;
    Object current_task_schedule_modify_arg_11, schedule_task_qm;
    Object old_structure_being_reclaimed, def_structure_schedule_task_variable;
    ...
    char temp_1, g2_p, svref_new_value;
    double aref_new_value, temp_4, future_task_schedule_modify_arg_3;
    Declare_stack_pointer;
    Declare_catch(1);
    Declare_special(5);
    XDeclare_area(1);
	  ...
	  if (output_stream) {
	    ...
	    next_loop:
		  ...
		  if (eval_list_of_designation_values) {
		    ...
		    next_loop_1:
			  ...
			  designation_qm = 
				  copy_tree_using_gensym_conses_1(designation);
			  ...
			  if (temp_1) {
				...
				PUSH_SPECIAL(Current_computation_instance,current_computation_instance,
				  ...
				  PUSH_SPECIAL(Current_computation_flags,current_computation_flags,
					...
					M_CDR(gensymed_symbol_4) = temp_3;
					Available_gensym_conses = 
						gensymed_symbol_3;
				    }
				    CONTINUE_UNWINDING(0);
		      ...
		      if (unique_designation_p_1)
			  reclaim_gensym_tree_1(designation_qm);
		      goto next_loop_1;
		    end_loop_1:
		      reclaim_gensym_tree_1(eval_list_of_designation_values);
		  }
		  else
		      warning_message_for_wrong_reference_for_gfi_designation(gfi_output_frame,
			      designation,Nil);
	    ...
	    end_loop:
		  ...
		  if (temp_1) {
		      ...
		      future_task_schedule_modify_arg_3 = temp_4 + 
			      (double)temp_5;
		      future_task_schedule_modify_arg_8 = 
			      SYMBOL_FUNCTION(Qgfi_output_event_log_values_periodically_task);
		      future_task_schedule_modify_arg_11 = gfi_output_frame;
		      schedule_task_qm = 
			      get_lookup_slot_value_given_default(gfi_output_frame,
			      Qgfi_output_scheduled_task,Nil);
		      if (schedule_task_qm) {
    ...
    Object gfi_output_frame, flush_queues_to_file_qm;
{
	...
	temp = Nil;
	set_non_savable_lookup_slot_value(gfi_output_frame,
		Qgfi_output_scheduled_task,temp);
	set_non_savable_lookup_slot_value(gfi_output_frame,
		Qgfi_output_scheduled_task,Nil);
    }
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_list_1(value_list);
    }
    set_non_savable_lookup_slot_value(gfi_output_frame,
	    Qgfi_list_of_new_spreadsheet_output_values,Nil);
	...
	inline_note_reclaim_cons(queue_pair_,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(queue_pair_) = temp;
	Available_gensym_conses = queue_pair_;
    }
    set_non_savable_lookup_slot_value(gfi_output_frame,
	    Qgfi_queue_of_new_output_values,Nil);
    set_non_savable_lookup_slot_value(gfi_output_frame,
...
Object prepare_gfi_input_interface_to_open(gfi_input_interface)
    Object gfi_input_interface;
{
    Object code, update_mode_qm, file_format, temp, result_qm, new_cons;
    Object gensymed_symbol, new_cons_, queue_pair_, cdr_arg, queue_list;
	...
	if ( ! !TRUEP(CAR(temp)))
		...
		if (Queue_of_active_uninterruptable_gfi_input_interface_objects) 
		    ...
		    if ( !TRUEP(gensymed_symbol))
			gensymed_symbol = replenish_gensym_cons_pool();
		    M_CAR(gensymed_symbol) = gfi_input_interface;
		    M_CDR(gensymed_symbol) = Nil;
		    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
		    new_cons_ = gensymed_symbol;
		    queue_pair_ = 
		    ...
		    queue_list = gensym_cons_1(gfi_input_interface,Nil);
		    Queue_of_active_uninterruptable_gfi_input_interface_objects 
			    = gensym_cons_1(queue_list,queue_list);
		}
	    }
		...
		inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
		new_cons_ = gensymed_symbol;
		queue_pair_ = Queue_of_active_gfi_input_interface_objects;
		if (M_CAR(queue_pair_)) {
		    cdr_arg = M_CDR(queue_pair_);
		    M_CDR(cdr_arg) = new_cons_;
		}
    ...
    Object gfi_input_frame;
{
    ...
    list_of_designations = gensym_cons_1(Nil,Nil);
  ...
  next_loop:
	...
	if (CAR(tail)) {
	    cdr_new_value = gensym_cons_1(designation,Nil);
  ...
  end_loop:
	...
	reclaim_gensym_cons_1(list_of_designations);
	return VALUES_1(Nil);
    }
    return VALUES_1(Qnil);
}
    ...
    Object designation, gfi_input_frame, no_data_service_required_qm;
{
	...
	if (temp) {
	    ...
	    PUSH_SPECIAL(Current_index,current_index,2);
	      data_type = 
    ...
    Object gfi_input_frame;
{
    ...
    Object gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3, temp_2;
    Object variable, ab_loop_list_, input_stream, current_computation_frame;
    Object thing, managed_float, amf_available_array_cons_qm, amf_array;
    Object svref_new_value_1, amf_result, incff_1_arg, new_float;
	...
	if (CAR(queue)) {
		...
		set_non_savable_lookup_slot_value(gfi_input_frame,
			Qgfi_input_file_synchronized_qm,T);
		time_slice_expired_p_1 = Nil;
		PUSH_SPECIAL(Time_slice_expired_p,time_slice_expired_p_1,0);
		  gensymed_symbol = 
			  get_lookup_slot_value_given_default(gfi_input_frame,
			  Qgfi_queue_of_variables_that_need_values,Nil);
		...
		next_loop:
		  ...
		  if ( !temp_1)
		      goto end_loop;
		  gensymed_symbol_2 = CAR(gensymed_symbol);
		  gensymed_symbol_3 = Nil;
		  if (gensymed_symbol_2) {
		      temp = CAR(gensymed_symbol_2);
		      gensymed_symbol_3 = CDR(gensymed_symbol_2);
		      M_CAR(gensymed_symbol) = gensymed_symbol_3;
		      if ( !TRUEP(gensymed_symbol_3))
			  M_CDR(gensymed_symbol) = Nil;
		      inline_note_reclaim_cons(gensymed_symbol_2,Qab_gensym);
		      temp_2 = Available_gensym_conses;
		      M_CDR(gensymed_symbol_2) = temp_2;
	    ...
	    reclaim_gensym_list_1(CAR(queue));
	}
	reclaim_gensym_cons_1(queue);
    }
    set_non_savable_lookup_slot_value(gfi_input_frame,
	    Qgfi_queue_of_variables_that_need_values,Nil);
    set_non_savable_lookup_slot_value(gfi_input_frame,
	...
	if (amf_available_array_cons_qm) {
	    ...
	    svref_new_value_1 = M_CDR(amf_available_array_cons_qm);
	    SVREF(temp_2,FIX((SI_Long)1L)) = svref_new_value_1;
    ...
    Object variable;
{
    ...
    Object current_computation_instance, temp_1, temp_2, temp_3, new_cons;
    Object new_cons_, queue_pair_;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    SI_Long svref_new_value;
    char temp;
	...
	if (ISVREF(lookup_kb_specific_property_value(Qgfi_data_server,
		...
		if (temp) {
			...
			if ( !TRUEP(gensymed_symbol))
			    gensymed_symbol = replenish_gensym_cons_pool();
			M_CAR(gensymed_symbol) = variable;
			M_CDR(gensymed_symbol) = Nil;
			inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
			new_cons_ = gensymed_symbol;
			queue_pair_ = 
				...
				Qgfi_queue_of_variables_that_need_values,Nil);
			if (M_CAR(queue_pair_)) {
			    temp_3 = M_CDR(queue_pair_);
			    M_CDR(temp_3) = new_cons_;
			}
			else
			    M_CAR(queue_pair_) = new_cons_;
			M_CDR(queue_pair_) = new_cons_;
			svref_new_value = IFIX(ISVREF(variable,
				(SI_Long)5L)) | (SI_Long)4096L;
			ISVREF(variable,(SI_Long)5L) = FIX(svref_new_value);
		    }
		    else if ( !((SI_Long)0L != 
    ...
    Object variable, interval;
{
    ...
    Object def_structure_schedule_task_variable, task, ctask, p, v, q;
    Object def_structure_queue_element_variable, gensymed_symbol_4;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_3;
    char temp, g2_p;
	...
	if (temp) {
	    ...
	    if (ctask && FIXNUM_LT(p,Priority_of_next_task))
		Priority_of_next_task = p;
	    result = VALUES_1(ISVREF(variable,(SI_Long)40L) = task);
	}
	else {
	    Suppress_warning_message_header_qm = T;
	    if ((SI_Long)2L <= IFIX(Warning_message_level))
    ...
    Object variable;
{
    ...
    svref_new_value = Nil;
    return VALUES_1(ISVREF(variable,(SI_Long)40L) = svref_new_value);
}
    ...
    Object gfi_output_frame, forcibly_flush;
{
    ...
    Object position_qm, gensymed_symbol, gensymed_symbol_1, temp_2;
    Object gensymed_symbol_4, designation_or_substitute_string, rest_of_list;
    Object managed_number_or_value, head_of_queue, designation_qm;
    SI_Long gensymed_symbol_2, temp_3, gensymed_symbol_3;
    char temp_1;
    double arg, arg_1;
    XDeclare_area(1);
    XDeclare_frontier(1);
	...
	if (line_limit && 
	  ...
	  next_loop_1:
	    ...
	    if ( !temp_1)
		goto end_loop_1;
	    gensymed_symbol = CAR(queue);
	    gensymed_symbol_1 = Nil;
	    if (gensymed_symbol) {
		temp = CAR(gensymed_symbol);
		gensymed_symbol_1 = CDR(gensymed_symbol);
		M_CAR(queue) = gensymed_symbol_1;
		...
		gensymed_symbol_1 = ISVREF(item,(SI_Long)6L);
		gensymed_symbol_2 = 
			IFIX(frame_hash_function(gensymed_symbol_1));
		temp = 
			get_lookup_slot_value_given_default(gfi_output_frame,
			Qgfi_output_spreadsheet_field_index_hash,Nil);
		temp_3 = gensymed_symbol_2 % (SI_Long)131L;
...
Object accept_data_from_gfi_data_service()
{
    ...
    Object initial_number_of_frames, gensymed_symbol, gensymed_symbol_1, temp;
    Object temp_1, gfi_output_frame, new_cons, new_cons_, queue_pair_;
	...
	next_loop:
	  ...
	  if (gensymed_symbol) {
	      ...
	      temp_1 = 
		      Queue_of_active_uninterruptable_gfi_input_interface_objects;
	      M_CAR(temp_1) = gensymed_symbol_1;
	      if ( !TRUEP(gensymed_symbol_1)) {
		  temp_1 = 
			  Queue_of_active_uninterruptable_gfi_input_interface_objects;
		  M_CDR(temp_1) = Nil;
	  ...
	  if (gfi_input_frame) {
		  ...
		  if (EQ(get_lookup_slot_value(gfi_input_frame,
			  Qgfi_input_file_format),Qnupec_snapshot)) {
		      temp = gfi_input_frame;
		      if (gfi_input_nupec_snapshot_values_periodically(temp,
			      Nil,Nil,
			      get_lookup_slot_value_given_default(gfi_input_frame,
		      ...
		      temp = gfi_input_frame;
		      if (synchronize_gfi_input_file(temp,Nil,
			      get_lookup_slot_value_given_default(gfi_input_frame,
			      Qgfi_input_ignore_data_server_qm,Nil))) {
			  if (get_lookup_slot_value_given_default(gfi_input_frame,
				  Qgfi_inputting_qm,Nil)) {
	...
	next_loop_1:
	  ...
	  if (gfi_output_frame) {
		  ...
		  temp = get_lookup_slot_value(gfi_output_frame,
			  Qgfi_output_file_format);
		  if (EQ(temp,Qnupec_snapshot) || EQ(temp,
			  Qnupec_snapshot_with_restart_time)) {
			  ...
			  Suppress_warning_message_header_qm = T;
			  if ((SI_Long)2L <= IFIX(Warning_message_level)) {
			      temp = gfi_output_frame;
			      give_warning_1(4,FIX((SI_Long)2L),
				      string_constant_59,temp,
				      get_lookup_slot_value_given_default(gfi_output_frame,
	...
	next_loop_2:
	  gensymed_symbol = CAR(Queue_of_active_gfi_input_interface_objects);
	  gensymed_symbol_1 = Nil;
	  if (gensymed_symbol) {
	      temp = CAR(gensymed_symbol);
	      gensymed_symbol_1 = CDR(gensymed_symbol);
	      temp_1 = Queue_of_active_gfi_input_interface_objects;
	      M_CAR(temp_1) = gensymed_symbol_1;
	      if ( !TRUEP(gensymed_symbol_1)) {
		  temp_1 = Queue_of_active_gfi_input_interface_objects;
		  M_CDR(temp_1) = Nil;
	  ...
	  if (gfi_input_frame) {
	      ...
	      if ( !TRUEP(gensymed_symbol))
		  gensymed_symbol = replenish_gensym_cons_pool();
	      M_CAR(gensymed_symbol) = gfi_input_frame;
	      M_CDR(gensymed_symbol) = Nil;
	      inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
	      new_cons_ = gensymed_symbol;
	      queue_pair_ = Queue_of_active_gfi_input_interface_objects;
		  ...
		  if (EQ(get_lookup_slot_value(gfi_input_frame,
		      ...
		      temp = gfi_input_frame;
		      if (synchronize_gfi_input_file(temp,T,
			      get_lookup_slot_value_given_default(gfi_input_frame,
			      Qgfi_input_ignore_data_server_qm,Nil))) {
			  if (get_lookup_slot_value_given_default(gfi_input_frame,
				  Qgfi_inputting_qm,Nil)) {
			...
			next_loop_3:
			  if (CAR(gensymed_symbol)) {
			      temp = CAR(gensymed_symbol);
			      temp_2 =  !EQ(gensymed_symbol_1,CAR(temp));
			  }
			  else
			      temp_2 = TRUEP(Nil);
			  if ( !temp_2)
			  ...
			  if (gensymed_symbol_2) {
			      ...
			      if ( !TRUEP(gensymed_symbol_3))
				  M_CDR(gensymed_symbol) = Nil;
			      inline_note_reclaim_cons(gensymed_symbol_2,
				      Qab_gensym);
			      temp_1 = Available_gensym_conses;
	...
	next_loop_4:
	  gensymed_symbol = CAR(Queue_of_active_gfi_output_interface_objects);
	  gensymed_symbol_1 = Nil;
	  if (gensymed_symbol) {
	      temp = CAR(gensymed_symbol);
	      gensymed_symbol_1 = CDR(gensymed_symbol);
	      temp_1 = Queue_of_active_gfi_output_interface_objects;
	      M_CAR(temp_1) = gensymed_symbol_1;
	      if ( !TRUEP(gensymed_symbol_1)) {
		  temp_1 = Queue_of_active_gfi_output_interface_objects;
		  M_CDR(temp_1) = Nil;
	  ...
	  if (gfi_output_frame) {
	      ...
	      if ( !TRUEP(gensymed_symbol))
		  gensymed_symbol = replenish_gensym_cons_pool();
	      M_CAR(gensymed_symbol) = gfi_output_frame;
	      M_CDR(gensymed_symbol) = Nil;
	      inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
	      new_cons_ = gensymed_symbol;
	      queue_pair_ = Queue_of_active_gfi_output_interface_objects;
    ...
    Object gfi_output_frame, do_not_override_time_slice_p;
{
	...
	if (number_of_designations_already_handled);
	    ...
	    number_of_designations_already_handled = FIX((SI_Long)0L);
	PUSH_SPECIAL(Time_slice_expired_p,time_slice_expired_p_1,1);
	  PUSH_SPECIAL(Current_computation_frame,current_computation_frame,0);
	    if (output_stream) {
		temp = number_of_designations_already_handled;
		temp_1 = 
    ...
    Object variable, gfi_output_frame;
{
	...
	goto next_loop;
      end_loop:
	reclaim_gensym_cons_1(oldest_index_qm);
	reclaim_gensym_cons_1(newest_index_qm);
	return VALUES_1(Qnil);
    }
    else
	return VALUES_1(Nil);
    ...
    Object no_data_service_required_qm;
{
    ...
    current_computation_frame = gfi_input_frame;
    PUSH_SPECIAL(Current_computation_frame,current_computation_frame,7);
      if (reset_time_qm) {
	  if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
	      base_time = 
		      get_lookup_slot_value_given_default(gfi_input_frame,
    ...
    Object gfi_input_frame, designation, variable_or_parameter, history_length;
{
    ...
    Object amf_array, temp_2, amf_result, incff_1_arg, new_float;
    ...
    Object new_managed_array, element_index, svref_new_value, index_2;
	...
	if (PUSH_CATCH(tag_temp,0)) {
	    temp_1 = gensym_cons_1(ring_buffer,Nil);
			...
			if (ISVREF(ring_buffer,(SI_Long)3L)) {
				...
				if (FIXNUM_LE(ISVREF(temp_1,(SI_Long)1L),
				    ...
				    temp_1 = ISVREF(temp_1,(IFIX(index_1) 
					    ...
					    (SI_Long)2L);
				    temp_3 = IFIX(index_1) & (SI_Long)1023L;
				    ISVREF(temp_1,temp_3) = svref_new_value;
				}
			    }
...
void gfi_INIT()
{
    ...
    Object list_constant_8, Qdata_server_map, Qdata_server_spec;
    Object list_constant_7, list_constant_6, list_constant_5, list_constant_4;
    Object Qserver, Qdata, Qgfi, Qslot_value_reclaimer;
    ...
    Object Qput_gfi_output_file_pathname, Qtime_slice_expired_p;
    Object Qqueue_of_active_uninterruptable_gfi_input_interface_objects;
    Object Qqueue_of_active_uninterruptable_gfi_output_interface_objects;
    Object Qqueue_of_active_gfi_input_interface_objects;
    Object Qqueue_of_active_gfi_output_interface_objects;
    ...
    Object string_constant_78, Qutilities2;
    Object Qcount_of_gfi_spreadsheet_field_index_hash_vector_131_vectors;
    Object Qavailable_gfi_spreadsheet_field_index_hash_vector_131_vectors;
    Object Qgfi_queue_item, Qreclaim_structure;
    Object Qoutstanding_gfi_queue_item_count;
    Object Qgfi_queue_item_structure_memory_usage, Qgfi_queue_item_count;
    Object Qchain_of_available_gfi_queue_items, string_constant_77;
    Object Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_76, Qunique_structure_type_of_ab_name_qm;
    Object Qab_name_of_unique_structure_type, list_constant_3;
    ...
    string_constant_76 = 
	    STATIC_STRING("43Dy8m83i5y1n83i5y8n8k1l8n0000000kuk0k0");
    ...
    string_constant_77 = STATIC_STRING("1q83i5y8s83-W=y09k9l");
    ...
    Qgfi_spreadsheet_field_index_hash_vector_131_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_78 = STATIC_STRING("1q83-W0y83*By83-Ooy09k9l");
    clear_optimized_constants();
    ...
    list_constant_4 = STATIC_LIST((SI_Long)2L,Qquote,Qgfi);
    Qdata = STATIC_SYMBOL("DATA",AB_package);
    list_constant_5 = STATIC_LIST((SI_Long)2L,Qquote,Qdata);
    Qserver = STATIC_SYMBOL("SERVER",AB_package);
    list_constant_6 = STATIC_LIST((SI_Long)2L,Qquote,Qserver);
    list_constant_7 = STATIC_LIST((SI_Long)3L,list_constant_4,
	    list_constant_5,list_constant_6);
    list_constant_8 = STATIC_LIST((SI_Long)2L,list_constant_7,
	    Qgfi_data_server);
    list_constant_9 = STATIC_CONS(Qdata_server_spec,list_constant_8);
    Qdata_server_map = STATIC_SYMBOL("DATA-SERVER-MAP",AB_package);
    list_constant_10 = STATIC_CONS(Qdata_server_map,list_constant_8);
