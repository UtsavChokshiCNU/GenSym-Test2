...
Object Directory_of_built_in_menu_choices = UNBOUND;
    ...
    Object menu_choice_arglist, gensymed_symbol;
{
    ...
    reclaim_gensym_list_1(menu_choice_arglist);
    return VALUES_1(Nil);
}
    ...
    Object block_qm, menu_1;
{
	...
	set_non_savable_lookup_slot_value(block_qm,Qmenus_for_this,
		delete_gensym_element_1(menu_1,
...
Object Menu_parameters = UNBOUND;

static Object Qmenu_parameters;    /* menu-parameters */
    ...
    Object menu_parameters;
{
    ...
    PUSH_SPECIAL(Menu_parameters,menu_parameters,0);
...
Object All_menu_heading_format_names = UNBOUND;
...
Object Chain_of_available_entire_menu_spots = UNBOUND;

Object Entire_menu_spot_count = UNBOUND;
    ...
    Object entire_menu_spot;
{
    ...
    svref_new_value = Chain_of_available_entire_menu_spots;
    SVREF(entire_menu_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_entire_menu_spots = entire_menu_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_entire_menu_spot_structure_internal()
{
    ...
    Object entire_menu_spot_count_new_value;
    ...
    entire_menu_spot_count_new_value = FIXNUM_ADD1(Entire_menu_spot_count);
    Entire_menu_spot_count = entire_menu_spot_count_new_value;
...
Object Chain_of_available_entire_focus_menu_spots = UNBOUND;

Object Entire_focus_menu_spot_count = UNBOUND;
    ...
    Object entire_focus_menu_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_entire_focus_menu_spots;
    SVREF(entire_focus_menu_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_entire_focus_menu_spots = entire_focus_menu_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_entire_focus_menu_spot_structure_internal()
{
    ...
    Object entire_focus_menu_spot_count_new_value;
    ...
    entire_focus_menu_spot_count_new_value = 
	    FIXNUM_ADD1(Entire_focus_menu_spot_count);
    Entire_focus_menu_spot_count = entire_focus_menu_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object post_menu_workspace varargs_1(int, n)
{
    ...
    PUSH_SPECIAL(Current_draw_paper_p,current_draw_paper_p,5);
...
Object make_table_spanning_row varargs_1(int, n)
{
	...
	temp = FIX((SI_Long)1L);
    list_1 = make_gensym_list_1(temp);
    sublist = list_1;
  next_loop:
    if ( !TRUEP(sublist))
	goto end_loop;
...
Object make_table_spacer_cells varargs_1(int, n)
{
  ...
  next_loop:
    ...
    ab_loop_repeat_ = ab_loop_repeat_ - (SI_Long)1L;
    temp_1 = 
	    gensym_cons_1(copy_constant_wide_string_given_length(array_constant_1,
	    FIX((SI_Long)0L)),Nil);
    temp = get_instance_with_name_if_any(Qformat_frame,Qmenu_spacer_format);
    if (temp);
    else
	temp = make_format_frame(Qmenu_spacer_format);
    ab_loopvar__2 = gensym_cons_1(make_table_spanning_row(2,
    ...
    Object menu_or_menu_workspace;
{
    ...
    gensymed_symbol = ISVREF(menu_or_menu_workspace,(SI_Long)14L);
...
Object pick_cell_from_table varargs_1(int, n)
{
  ...
  next_loop:
	...
	if (FIXNUM_GE(x_in_window,left_edge_of_cell_in_window) && 
		...
		temp_2 = TRUEP(Nil);
	    if (temp_2)
		return pick_cell_from_table(5,cell,image_plane,x_in_window,
			y_in_window,only_if_in_text_qm);
		    ...
		    left_edge_of_cell,top_edge_of_cell,Nil,x_in_workspace,
		    y_in_workspace,Nil,Nil,Nil,only_if_in_text_qm) && ( 
		    !TRUEP(consider_cell_visibility_qm) || 
		    text_cell_text_visible_in_image_plane_p(cell,image_plane)))
		return VALUES_8(cell,table,FIX(row_index),column_index,
			left_edge_of_cell,top_edge_of_cell,
			right_edge_of_cell,bottom_edge_of_cell);
	    else
		return VALUES_1(Nil);
	}
	if (find_nearest_cell_qm) {
		...
		if (FIXNUM_LT(y_in_workspace,top_edge)) {
		    ...
		    distance_if_in_range_qm = FIXNUM_MINUS(x_in_workspace,
			    right_edge);
	    }
	    ...
	    distance_if_reasonable_qm = (distance_if_in_range_qm ? 
		    FIXNUM_LT(distance_if_in_range_qm,reasonable_distance) 
  ...
  end_loop:
    if (nearest_cell_so_far_qm)
	return VALUES_8(nearest_cell_so_far_qm,table,
		row_index_of_nearest_cell,column_row_index_of_nearest_cell,
...
Object Chain_of_available_menu_item_spots = UNBOUND;

Object Menu_item_spot_count = UNBOUND;
    ...
    Object menu_item_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_menu_item_spots;
    SVREF(menu_item_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_menu_item_spots = menu_item_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_menu_item_spot_structure_internal()
{
    ...
    Object menu_item_spot_count_new_value;
    ...
    menu_item_spot_count_new_value = FIXNUM_ADD1(Menu_item_spot_count);
    Menu_item_spot_count = menu_item_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_menu_title_spots = UNBOUND;

Object Menu_title_spot_count = UNBOUND;
    ...
    Object menu_title_spot;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_menu_title_spots;
    SVREF(menu_title_spot,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_menu_title_spots = menu_title_spot;
    return VALUES_1(Nil);
}
...
Object make_permanent_menu_title_spot_structure_internal()
{
    ...
    Object menu_title_spot_count_new_value;
    ...
    menu_title_spot_count_new_value = FIXNUM_ADD1(Menu_title_spot_count);
    Menu_title_spot_count = menu_title_spot_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object initialize_user_menu_choice_action(user_menu_choice)
    Object user_menu_choice;
{
    Object embedded_rule_qm, gensymed_symbol, new_cons, gensymed_symbol_1;
    Object temp, thing;
    ...
    Object user_menu_choice, class_1;
{
    ...
    gensym_modify_macro_using_test_arg_1 = user_menu_choice;
    ...
    Object user_menu_choice, class_1, label_qm;
{
    ...
    temp = delete_gensym_element_1(user_menu_choice,
...
Object Inside_breakpoint_p = UNBOUND;
...
Object get_user_menu_choice_or_choice_symbols varargs_1(int, n)
{
	...
	if (temp) {
		...
		resulting_user_menu_choices_so_far = 
			gensym_cons_1(user_menu_choice,
			resulting_user_menu_choices_so_far);
	}
	goto next_loop_1;
      end_loop_1:;
	...
	if ( !TRUEP(choice_symbol_qm) && resulting_user_menu_choices_so_far) {
	  ...
	  next_loop_3:
	    ...
	    if (runnable_p_function(user_menu_choice) && 
		    ...
		    frame)) {
		ab_loopvar__1 = gensym_cons_1(ISVREF(user_menu_choice,
			(SI_Long)20L),Nil);
		if (ab_loopvar_)
		    M_CDR(ab_loopvar_) = ab_loopvar__1;
		else
	    ...
	    goto next_loop_3;
	  end_loop_3:
	    reclaim_gensym_list_1(resulting_user_menu_choices_so_far);
...
Object Window_instigating_this_rule_instance_qm = UNBOUND;
    ...
    Object user_menu_choice, frame, window_or_ui_client;
{
	...
	PUSH_SPECIAL(Window_instigating_this_rule_instance_qm,window_instigating_this_rule_instance_qm,
		0);
...
void menus_INIT()
{
    ...
    Object Qnew_rules, Qwindow_instigating_this_rule_instance_qm, AB_package;
    Object Qslot_value_writer, Qwrite_symbol_from_slot;
    ...
    Object Qmenu_title_spot_count, Qchain_of_available_menu_title_spots;
    ...
    Object Qmenu_item_spot_structure_memory_usage, Qmenu_item_spot_count;
    Object Qchain_of_available_menu_item_spots, string_constant_28;
    ...
    Object Qentire_focus_menu_spot_structure_memory_usage;
    Object Qentire_focus_menu_spot_count;
    Object Qchain_of_available_entire_focus_menu_spots, string_constant_25;
    Object string_constant_24, Qoutstanding_entire_menu_spot_count;
    Object Qentire_menu_spot_structure_memory_usage, Qentire_menu_spot_count;
    Object Qchain_of_available_entire_menu_spots, string_constant_23;
    ...
    Object string_constant_6, Qmenu_string, Qmenus, Qshort_menus_qm;
    ...
    string_constant_7 = 
	    STATIC_STRING("1u4z8r83VFy83VFy9k9k00001m1l8o1l8l000004z8r8325y8325y9k9k00001m1l8o1l8l000004z8r83VEy83VEy9k9k00001m1l8o1l8l000004z8r83eky83eky9");
    string_constant_8 = 
	    STATIC_STRING("k9k00001m1l8o1l8l000004z8r83esy83esy9k9k00001m1l8o1l8l000004z8r83HZy83HZy9k9k00001m1l8o1l8l000004z8r83VDy83VDy9k9k00001m1l8o1l8l");
    string_constant_9 = 
	    STATIC_STRING("000004z8r836Uy836Uy9k9k00001m1l83Ey1l8l000004z8r83VIy83VIy9k9k00001m1l83Ey1l8l000004z8r83Ygy83Ygy9k9k00001m1l83Ey1l8l00000");
    string_constant_10 = 
	    STATIC_STRING("1w8q1n9k1l83*Jy8t1o83VFy08o8l1o8325y08o8l1o83VEy08o8l1o83eky08o8l1o83esy08o8l1o83HZy08o8l1o83VDy08o8l1o836Uy083Ey8l1o83VIy083Ey8");
    string_constant_11 = STATIC_STRING("l1o83Ygy083Ey8l");
    ...
    string_constant_13 = 
	    STATIC_STRING("1o4z8r83GXy83GXy83VKy83VKy083*hy001n1l8l1l8o1m8p83Ady000004z8r83Fvy83Fvy83VKy83VKy08329y001n1l8l1l8o1m8p83Fvy000004z8r83e7y83e7y");
    string_constant_14 = 
	    STATIC_STRING("83VKy83VKy08k001n1l8l1l83Ey1m8p83Ky000004z8r83Asy83Asy83VKy83VKy01m830Py1n831iy834Wy836iy001n1l8l1l83Ey1m8p83Asy00000");
    string_constant_15 = 
	    STATIC_STRING("1q8q1n83VKy1l83-sy83ey1p83GXy83*hy8l8o1m8p83Ady1p83Fvy8329y8l8o1m8p83Fvy1p83e7y8k8l83Ey1m8p83Ky1p83Asy1m830Py1n831iy834Wy836iy8l");
    ...
    mutate_global_property(Qinitialize_after_reading,temp_2,
	    Qclasses_which_define);
    string_constant_17 = 
	    STATIC_STRING("1n1m83Fvy1m9k8329y1m83Fvy1m9k83f9y1n83Fvy1n1m9k83=Iy1m9k83-RBy1m9k83-moy83-Y9y");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    add_grammar_rules_function(regenerate_optimized_constant(string_constant_17));
    string_constant_18 = 
	    STATIC_STRING("1n1m83Ady1m9k83*hy1m83Ady1m9k83-dy1m83Ady1m9k83-cy");
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    ...
    string_constant_20 = 
	    STATIC_STRING("1m4z8r83VMy83VMy83VLy83VLy00001m1l8o1l8l000004z8r836Hy836Hy83VLy83VLy08k001n1l8l1m8p83Ky1l83Ny00000");
    string_constant_21 = 
	    STATIC_STRING("1o8q1m83VLy1l8318y1o83VMy08o8l1m836Hy8k");
    ...
    Qentire_menu_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_23 = STATIC_STRING("1q838Fy8s83-Shy09k9l");
    clear_optimized_constants();
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8m83Kdy1p83Kdy838Fy83Qy8n8k1l838Fy0000001l1m8x838Fykqk0k0");
    ...
    Qentire_focus_menu_spot_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_25 = STATIC_STRING("1q83Kdy8s83-Sfy09k9l");
    clear_optimized_constants();
    ...
    string_constant_28 = STATIC_STRING("1q83Ddy8s83-dLy09k9l");
    clear_optimized_constants();
    ...
    string_constant_30 = STATIC_STRING("1q83Dfy8s83-dQy09k9l");
    clear_optimized_constants();
    ...
    string_constant_31 = 
	    STATIC_STRING("13Dy83*oy83=wy83*2y832Py83fy8308ym830Aym8309ym8307ym83=Dyl83=Nyk");
    ...
    Qmenu_table_format_for_new_g2_classic_ui = 
	    ...
	    AB_package);
    string_constant_32 = 
	    STATIC_STRING("13Dy83*oy83=wy0832Py83fy8308yk830Ayk8309yk8307yk83=Dyk83=Nyk");
    ...
    mutate_global_property(Qfat_left_aligned_menu_item_format,
	    ...
	    Qformat_description);
    string_constant_44 = STATIC_STRING("1p83*by83wy83-dy83Wy3Gy");
    mutate_global_property(Qfat_center_aligned_menu_item_format,
	    regenerate_optimized_constant(string_constant_44),
	    Qformat_description);
    string_constant_45 = STATIC_STRING("1p83*by83wy83-cy83Wy3Gy");
    ...
    mutate_global_property(Qleft_aligned_cascade_menu_item_format,
	    ...
	    Qformat_description);
    string_constant_47 = STATIC_STRING("1p83*by83wy83-dy83Wy3Hy");
    mutate_global_property(Qcenter_aligned_cascade_menu_item_format,
	    regenerate_optimized_constant(string_constant_47),
	    Qformat_description);
    string_constant_48 = STATIC_STRING("1p83*by83wy83-cy83Wy3Hy");
    ...
    mutate_global_property(Qleft_aligned_menu_heading_format,
	    ...
	    Qformat_description);
    string_constant_50 = STATIC_STRING("1r83*by83wy83-dy83*Ky83fy83-Ny83*2y");
    mutate_global_property(Qcenter_aligned_menu_heading_format,
	    regenerate_optimized_constant(string_constant_50),
	    Qformat_description);
    string_constant_51 = STATIC_STRING("1r83*by83wy83-cy83*Ky83fy83-Ny83*2y");
    ...
    mutate_global_property(Qfat_left_aligned_menu_heading_format,
	    ...
	    Qformat_description);
    string_constant_53 = 
	    STATIC_STRING("1t83*by83Wy3Hy83wy83-dy83*Ky83fy83-Ny83*2y");
    ...
    string_constant_61 = STATIC_STRING("1n1m8v834oy1m83*ey1m1l839Fy83*ty1l8t");
    ...
    string_constant_67 = 
	    STATIC_STRING("Y class definition000004z8r83dky83dky834oy834oy00001o1m8p834oy1l8l1l8o1l83Cy000004z8r83B9y83B9y834oy834oy00001p1m8p83AOy1l8l1l8z");
    string_constant_68 = 
    ...
    string_constant_69 = 
	    STATIC_STRING("z8r83GRy83GRy834oy834oy00001p1n8p8333y83Gy1l8o1l8l1l83-5y1m83Dy53Fyexport action parse000004z8r83KTy83KTy834oy834oy00001o1l8o1l8");
    string_constant_70 = 
	    STATIC_STRING("l1l83Cy1m83Dy53Eyexport the uuid\?\?\?000004z8r83Fky83Fky834oy834oy0m001q1m8p83-Zy1l83Ey1l8l1l8z1l83Cy1m83Dy53Jyexport positive-int");
    string_constant_71 = STATIC_STRING("eger00000");
    string_constant_72 = 
	    STATIC_STRING("1v8q1p834oy1m83Ry83-+y1m8v834oy1m83*ey1m1l839Fy83*ty8t1o83--y01m8p83-*y1m83Dy53*syWill allow 0 or more author entries. each auth");
    string_constant_73 = 
    ...
    string_constant_75 = 
	    STATIC_STRING("y1n83Oy1mk3Qy1m3ay3Qy1n83Oy1mk3ay1m3ay3ay1n83Oy1mk3ky1m3ay3ky1q83dky01m8p834oy8l8o83Cy1r83B9y01m8p83AOy8l8z8o83Cy1t83BMy01n8p83A");
    string_constant_76 = 
	    STATIC_STRING("Py83Gy8l8z8o83Cy83-5y1m83Dy53Pyexport a menu condition parse1r83GRy01n8p8333y83Gy8o8l83-5y1m83Dy53Fyexport action parse1q83KTy08");
    string_constant_77 = 
	    STATIC_STRING("o8l83Cy1m83Dy53Eyexport the uuid\?\?\?1s83Fkym1m8p83-Zy83Ey8l8z83Cy1m83Dy53Jyexport positive-integer");
    ...
    mutate_global_property(Qembedded_rule_in_user_menu_choice_qm,
	    ...
	    Qslot_value_reclaimer);
    string_constant_79 = STATIC_STRING("1m1m83-SOy8333y1m834oy83-6y");
