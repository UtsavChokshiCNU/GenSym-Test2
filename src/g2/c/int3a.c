...
Object read_icp_wide_string()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    end_loop_2:;
		  ...
		  notify_user(3,string_constant_4,
...
Object read_icp_gensym_string()
{
    ...
    Object last_character_p, skip_this_character_p, icp_byte, even_qm, temp_2;
    Object gensym_string_1, length_limit_exceeded_p;
    Object beginning_of_truncated_string, result_of_read;
    Object resumable_icp_state_1, icp_suspend_1, top, value;
    Object string_is_simple_p_1;
    SI_Long string_length, temp, length_1, character_code, temp_1;
    SI_Long last_char_index, character_index, gensymed_symbol;
    char character_1;
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	      ...
	      length_1 = MIN(string_length,temp);
	      gensym_string = length_1 > 
		      IFIX(Maximum_suggested_length_for_simple_gensym_strings) 
		      ? 
		      obtain_long_enough_adjustable_gensym_string(FIX(length_1)) 
		      : obtain_simple_gensym_string(FIX(length_1));
	    ...
	    next_loop:
	      ...
	      if ( !(skip_this_character_p || string_length_exceeded_p)) {
		  ...
		  if (bad_state_p);
		  else if ( !((SI_Long)32L <= character_code && 
			  character_code <= (SI_Long)126L))
			  ...
			  switch (ICHAR_CODE(escape_character_qm)) {
			    ...
			    case '\\':
			      if ( 
				      !TRUEP(first_character_code_following_bs_qm))
				  first_character_code_following_bs_qm = 
					  FIX(character_code);
			      else if ( 
				      !TRUEP(second_character_code_following_bs_qm)) 
					  {
	    ...
	    end_loop:
		  ...
		  gensym_string = temp_2;
	      }
	      result = VALUES_2(gensym_string,string_length_exceeded_p);
	      MVS_2(result,gensym_string_1,length_limit_exceeded_p);
	      if (length_limit_exceeded_p) {
		  beginning_of_truncated_string = 
			  gensym_string_substring(gensym_string_1,
			  FIX((SI_Long)0L),FIX((SI_Long)20L));
		  notify_user(3,string_constant_5,
			  Maximum_length_for_user_gensym_strings,
			  beginning_of_truncated_string);
		  reclaim_gensym_string(beginning_of_truncated_string);
	      }
	      result_of_read = gensym_string_1;
	      if (tracep)
		  emit_icp_read_trace(Nil,byte_count_before,
			  instantaneous_icp_reader_byte_count(),
	  ...
	  next_loop_1:
		...
		if (bad_state_p);
			...
			|| CHAR_EQ(CHAR_TO_CHARACTER(character_1),
			CHR('~')) || 
			CHAR_EQ(CHAR_TO_CHARACTER(character_1),CHR('\\')))
		    escape_character_qm = CHAR_TO_CHARACTER(character_1);
	    }
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	      ...
	      string_is_simple_p_1 = (resumable_icp_state_1 ? 
		      TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() :  
		      !ARRAY_HAS_FILL_POINTER_P(gensym_string) ? T : Nil;
	      bad_state_p = (resumable_icp_state_1 ? 
		      TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	      escape_character_qm = (resumable_icp_state_1 ? 
		      TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	      first_character_code_following_bs_qm = 
	      ...
	      third_character_code_following_bs_qm = 
		      ...
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	      kanji_character_code_qm = (resumable_icp_state_1 ? 
		      TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	      if ((resumable_icp_state_1 ? TRUEP(Resumable_icp_state) : 
	      ...
	      last_character_p = (resumable_icp_state_1 ? 
		      ...
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	      skip_this_character_p = (resumable_icp_state_1 ? 
		      TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		      !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		      resumable_icp_pop() : Nil;
	    ...
	    resume:
		  ...
		  value = read_icp_byte();
		  if (EQ(icp_suspend_1,value)) {
		      resumable_icp_push(even_qm);
		      resumable_icp_push(icp_byte);
		      resumable_icp_push(skip_this_character_p);
		      resumable_icp_push(last_character_p);
		      resumable_icp_push(FIX(character_index));
		      resumable_icp_push(FIX(last_char_index));
		      resumable_icp_push(kanji_character_code_qm);
		      resumable_icp_push(third_character_code_following_bs_qm);
		      resumable_icp_push(second_character_code_following_bs_qm);
		      resumable_icp_push(first_character_code_following_bs_qm);
		      resumable_icp_push(escape_character_qm);
		      resumable_icp_push(bad_state_p);
		      resumable_icp_push(string_is_simple_p_1);
	    ...
	    end_loop_2:
	      ...
	      result = VALUES_2(gensym_string,string_length_exceeded_p);
	      MVS_2(result,gensym_string_1,length_limit_exceeded_p);
	      if (EQ(icp_suspend_1,gensym_string_1)) {
		  resumable_icp_push(Qread_icp_gensym_string);
		  result = VALUES_1(Icp_suspend);
		  POP_SPECIAL();
		  goto end_read_icp_gensym_string;
	    ...
	    escape_character_qm = (resumable_icp_state_1 ? 
		    ...
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : Nil;
	    first_character_code_following_bs_qm = (resumable_icp_state_1 ?
		     TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : Nil;
	    second_character_code_following_bs_qm = (resumable_icp_state_1 
		    ? TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : Nil;
	    third_character_code_following_bs_qm = (resumable_icp_state_1 ?
		     TRUEP(Resumable_icp_state) : TRUEP(Nil)) &&  
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : Nil;
	    kanji_character_code_qm = (resumable_icp_state_1 ? 
	    ...
	    icp_byte = (resumable_icp_state_1 ? TRUEP(Resumable_icp_state) 
		    ...
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : Nil;
	    even_qm = (resumable_icp_state_1 ? TRUEP(Resumable_icp_state) :
		     TRUEP(Nil)) &&  
		    !TRUEP(resumable_icp_pop_list_if_end_marker()) ? 
		    resumable_icp_pop() : T;
	    if (resumable_icp_state_1 ? TRUEP(Resumable_icp_state) : 
	...
	if (Icp_write_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_write_trace_level,current_icp_write_trace_level,
		  ...
		  beginning_of_truncated_string = 
			  ...
			  FIX((SI_Long)0L),FIX((SI_Long)20L));
		  notify_user(3,string_constant_6,FIX(maximum_length),
			  beginning_of_truncated_string);
		  reclaim_text_string(beginning_of_truncated_string);
	...
	if (Icp_write_trace_cutoff_level_qm) {
	    ...
	    PUSH_SPECIAL(Current_icp_write_trace_level,current_icp_write_trace_level,
		  ...
		  beginning_of_truncated_string = 
			  gensym_string_substring(raw_gensym_string,
			  FIX((SI_Long)0L),FIX((SI_Long)20L));
		  notify_user(3,string_constant_7,
			  Maximum_length_for_user_gensym_strings,
			  beginning_of_truncated_string);
		  reclaim_gensym_string(beginning_of_truncated_string);
    ...
    Object send_enlarge_message_p;
{
	...
	index_1 = frame_serial_number_function(icp_object);
    else {
    ...
    Object task, priority;
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, temp_1, buffer_of_resumable_p;
    Object index_of_resumable_p_in_icp_buffer, temp_2, gensymed_symbol_3;
    Object gensymed_symbol_4, gensymed_symbol_5, gensymed_symbol_6;
    Object gensymed_symbol_7, gensymed_symbol_8, gensymed_symbol_9;
    Object gensymed_symbol_10, gensymed_symbol_11, gensymed_symbol_12;
    Object gensymed_symbol_13, array, completion_function;
    Object completion_argument_list;
    SI_Long icp_position, position_1, value, temp_3, gensymed_symbol_14;
    double gensymed_symbol_1, gensymed_symbol_2, gensymed_symbol_15;
    double gensymed_symbol_16, gensymed_symbol_17, aref_new_value;
    Declare_special(18);
    Object result;

    x_note_fn_call(52,138);
    function = ISVREF(task,(SI_Long)2L);
					  ...
					  PUSH_SPECIAL(Buffer_of_resumable_p,buffer_of_resumable_p,
						...
						switch (INTEGER_TO_CHAR(temp_2)) 
						  ...
						  case 2:
						    ...
						    temp_2 = 
							    inline_funcall_2(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5);
						    break;
						  case 3:
						    ...
						    gensymed_symbol_6 = 
							    THIRD(argument_list);
						    temp_2 = 
							    inline_funcall_3(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6);
						    break;
						  case 4:
						    ...
						    temp_2 = 
							    inline_funcall_4(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7);
						  ...
						  case 5:
						    ...
						    gensymed_symbol_8 = 
							    FIFTH(argument_list);
						    temp_2 = 
							    inline_funcall_5(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
						  ...
						  case 6:
						    ...
						    gensymed_symbol_9 = 
							    SIXTH(argument_list);
						    temp_2 = 
							    inline_funcall_6(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
						  ...
						  case 7:
						    ...
						    temp_2 = 
							    inline_funcall_7(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
						  ...
						  case 8:
						    ...
						    temp_2 = 
							    inline_funcall_8(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
						  ...
						  case 9:
						    ...
						    gensymed_symbol_12 = 
							    NINTH(argument_list);
						    temp_2 = 
							    inline_funcall_9(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
						  ...
						  case 10:
						    ...
						    gensymed_symbol_13 = 
							    TENTH(argument_list);
						    temp_2 = 
							    inline_funcall_10(gensymed_symbol_3,
							    gensymed_symbol_4,
							    gensymed_symbol_5,
							    gensymed_symbol_6,
							    gensymed_symbol_7,
					    ...
					    suspendp = EQ(temp,temp_2) ? T 
						    : Nil;
					    if (suspendp) {
						temp_1 = Resumable_icp_state;
						SVREF(task,
							FIX((SI_Long)5L)) 
							= temp_1;
						SVREF(task,
			...
			switch (INTEGER_TO_CHAR(temp)) {
			  ...
			  case 10:
			    ...
			    inline_funcall_10(gensymed_symbol,
				    ...
				    gensymed_symbol_7,gensymed_symbol_8,
				    gensymed_symbol_9,gensymed_symbol_10,
				    gensymed_symbol_11,gensymed_symbol_12);
			    break;
			  default:
			    break;
			}
    ...
    Object completion_function, completion_argument_list;
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, aref_arg_1, buffer_of_resumable_p;
    Object index_of_resumable_p_in_icp_buffer, temp_2, gensymed_symbol_3;
    Object gensymed_symbol_4, gensymed_symbol_5, gensymed_symbol_6;
    Object gensymed_symbol_7, gensymed_symbol_8, gensymed_symbol_9;
    Object gensymed_symbol_10, gensymed_symbol_11, gensymed_symbol_12;
    Object gensymed_symbol_13, array;
    SI_Long icp_position, position_1, value, temp_3, gensymed_symbol_14;
...
void int3a_INIT()
{
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83ncy1n83ncy8n8k1l8n0000001l1n8y83-62y0kmk0k0");
    ...
    string_constant_15 = STATIC_STRING("1q83ncy8s83-q2y09k9l");
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83jBy1n83jBy8n8k1l8n0000001l1n8y83-4gy1l83-=nykok0k0");
    ...
    string_constant_17 = STATIC_STRING("1q83jBy8s83-Zby09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83ipy1n83ipy8n8k1l8n0000001l1n8y83-4Ty1l83-=5ykrk0k0");
    ...
    string_constant_19 = STATIC_STRING("1q83ipy8s83-Y2y09k9l");
    clear_optimized_constants();
    ...
    string_constant_20 = 
	    STATIC_STRING("43Dy8m83iry1n83iry8n8k1l8n0000001l1n8y83-4Vy1r83-=Ay83-=By83-=7y83-=Dy83-=Cy83-=9y83-=8yksk0k0");
    ...
    string_constant_21 = STATIC_STRING("1q83iry8s83-Y4y09k9l");
    clear_optimized_constants();
