    ...
    Object book, page;
{
    ...
    svref_new_value = delete_gensym_element_1(page,ISVREF(book,(SI_Long)20L));
    ISVREF(book,(SI_Long)20L) = svref_new_value;
    return VALUES_1(Nil);
}

Object Logbook_parameters = UNBOUND;
...
Object Message_board_parameters = UNBOUND;
    ...
    Object logbook_parameters;
{
    ...
    PUSH_SPECIAL(Logbook_parameters,logbook_parameters,0);
    ...
    Object message_board_parameters;
{
    ...
    PUSH_SPECIAL(Message_board_parameters,message_board_parameters,0);
...
static Object Qoperator_logbook_enabled;  /* operator-logbook-enabled */

/* IS-OPERATOR-LOGBOOK-ENABLED */
Object is_operator_logbook_enabled(workstation)
    Object workstation;
{
    Object gensym_window, icp_socket, temp;

    x_note_fn_call(117,22);
    gensym_window = ISVREF(workstation,(SI_Long)1L);
    icp_socket = icp_socket_for_gensym_window_qm(gensym_window);
    temp =  !TRUEP(icp_socket) ? T : Nil;
    if (temp)
	return VALUES_1(temp);
    else
	return VALUES_1(EQ(get_remote_icp_version_info_value(icp_socket,
		Qoperator_logbook_enabled,FIX((SI_Long)1L)),
		FIX((SI_Long)1L)) ? T : Nil);
}

static Object Qmessage_board_enabled;  /* message-board-enabled */

/* IS-MESSAGE-BOARD-ENABLED */
Object is_message_board_enabled(workstation)
    Object workstation;
{
    Object gensym_window, icp_socket, temp;
	...
	return VALUES_1(EQ(get_remote_icp_version_info_value(icp_socket,
		Qmessage_board_enabled,FIX((SI_Long)1L)),FIX((SI_Long)1L)) 
		? T : Nil);
}
    ...
    Object block, book;
{
	...
	svref_new_value = gensym_cons_1(page,ISVREF(book,(SI_Long)20L));
	ISVREF(book,(SI_Long)20L) = svref_new_value;
	svref_new_value = add1(ISVREF(book,(SI_Long)21L));
	ISVREF(book,(SI_Long)21L) = svref_new_value;
	ISVREF(page,(SI_Long)29L) = svref_new_value;
			  ...
			  PUSH_SPECIAL(Specific_structure_for_current_workstation_context,specific_structure_for_current_workstation_context,
				...
				PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
				  ...
				  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
					  0);
				    add_page_to_display_of_book(page,book,
					    Current_workstation_detail_pane);
				  POP_SPECIAL();
				POP_SPECIAL();
			      POP_SPECIAL();
    ...
    Object book, page;
{
    ...
    set_slot_value_function(down_arrow,Qbutton_action_data_qm,
	    gensym_list_2(down_arrow,T),Nil);
    ...
    set_slot_value_function(up_arrow,Qbutton_action_data_qm,
	    gensym_list_2(up_arrow,Nil),Nil);
...
Object Current_image_plane_for_button = UNBOUND;
    ...
    Object page, book, pane;
{
    ...
    if (g2_window_qm &&  
	    ...
	    !TRUEP(is_operator_logbook_enabled(workstation)))
	return VALUES_1(Nil);
...
Object Current_logbook_qm = UNBOUND;
...
Object Current_message_board_qm = UNBOUND;

Object Frame_serial_number_of_current_message_board = UNBOUND;
...
Object provide_current_message_board()
{
  ...
  next_loop:
    ...
    if (EQ(ISVREF(workstation,(SI_Long)28L),Qlogged_in) && 
	    is_message_board_enabled(workstation) && 
    ...
    Object gensym_window;
{
	...
	message_board = Current_message_board_qm;
	if (detail_pane_1 && is_message_board_enabled(workstation)) {
	    image_plane = Nil;
			...
			PUSH_SPECIAL(Type_of_current_workstation_context,type_of_current_workstation_context,
			  ...
			  PUSH_SPECIAL(Specific_structure_for_current_workstation_context,specific_structure_for_current_workstation_context,
				...
				PUSH_SPECIAL(New_g2_classic_ui_p,new_g2_classic_ui_p,
				  ...
				  PUSH_SPECIAL(Servicing_workstation_qm,servicing_workstation_qm,
					  0);
				    result = put_workspace_on_pane_function(message_board,
					    detail_pane_1,Qleft,Qtop,Nil,
...
Object Next_serial_number_to_be_generated = UNBOUND;

Object Current_message_unix_time_qm = UNBOUND;

/* INCREMENT-MESSAGE-SERIAL-NUMBER */
Object increment_message_serial_number()
{
    Object temp, next_serial_number_to_be_generated_new_value;

    x_note_fn_call(117,40);
    temp = Next_serial_number_to_be_generated;
    next_serial_number_to_be_generated_new_value = 
	    add1(Next_serial_number_to_be_generated);
...
Object Log_file_parameters = UNBOUND;
    ...
    Object log_file_parameters, value;
{
    ...
    PUSH_SPECIAL(Log_file_parameters,log_file_parameters,0);
    ...
    Object message_count, interval_in_seconds;
{
    ...
    return gensym_list_2(message_count,gensym_cons_1(interval_in_seconds,
	    Qseconds));
}

Object Log_file_outputting_qm = UNBOUND;

Object Log_file_writing_message_qm = UNBOUND;

Object Log_file_string = UNBOUND;

Object Log_file_stream = UNBOUND;

Object Log_file_default_pathname_qm = UNBOUND;

Object Log_file_count = UNBOUND;

Object Log_file_message_count = UNBOUND;

Object Log_file_message_count_at_last_update = UNBOUND;

Object Log_file_time_at_last_update = UNBOUND;

Object Log_file_time_at_open = UNBOUND;

Object Log_file_pathnames = UNBOUND;

Object Log_file_name_extension = UNBOUND;

Object Maximum_log_file_name_prefix_length_qm = UNBOUND;
...
Object Current_logbook_serial_number_qm = UNBOUND;

Object Allow_user_defined_logbook_handlers_p = UNBOUND;

Object Currently_posting_message_on_logbook_p = UNBOUND;
...
Object G2_save_module_list = UNBOUND;
    ...
    Object text_line, from_message_board_p;
{
    ...
    PUSH_SPECIAL(Current_message_unix_time_qm,current_message_unix_time_qm,5);
      current_wide_string_list = Qdo_not_use;
      PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	wide_string_bv16 = allocate_byte_vector_16(FIX((SI_Long)2048L + 
		(SI_Long)3L));
	...
	POP_SPECIAL();
      ...
      PUSH_SPECIAL(Currently_posting_message_on_logbook_p,currently_posting_message_on_logbook_p,
	      0);
    ...
    Object message_1;
{
  ...
  end_1:;
	...
	if (snapshot_of_block_valid_p(snapshot)) {
	    ab_loopvar__2 = gensym_cons_1(snapshot,Nil);
	    if (ab_loopvar__1)
	...
	reclaim_gensym_list_1(snapshots);
    }
...
Object Chain_of_available_inform_message_informations = UNBOUND;

Object Inform_message_information_count = UNBOUND;
    ...
    Object inform_message_information;
{
    ...
    svref_new_value = Chain_of_available_inform_message_informations;
    SVREF(inform_message_information,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_inform_message_informations = 
	    inform_message_information;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_inform_message_information_variable;
    Object inform_message_information_count_new_value, the_array;
    ...
    inform_message_information_count_new_value = 
	    FIXNUM_ADD1(Inform_message_information_count);
...
Object reclaim_task_to_remove_inform_message(task_qm)
    Object task_qm;
{
    Object svref_arg_1, schedule_task_qm, old_structure_being_reclaimed;
    Object svref_new_value;

    x_note_fn_call(117,78);
    if (task_qm) {
	svref_arg_1 = Structure_being_reclaimed;
	schedule_task_qm = ISVREF(svref_arg_1,(SI_Long)0L);
	if (schedule_task_qm) {
	...
	svref_new_value = Nil;
	return VALUES_1(SVREF(svref_arg_1,FIX((SI_Long)0L)) = svref_new_value);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object task_qm;
{
    ...
    if (task_qm) {
	svref_arg_1 = Structure_being_reclaimed;
	schedule_task_qm = ISVREF(svref_arg_1,(SI_Long)1L);
	if (schedule_task_qm) {
	    if (EQ(schedule_task_qm,Current_schedule_task))
		Current_schedule_task = Nil;
	    if (ISVREF(schedule_task_qm,(SI_Long)6L))
	...
	svref_new_value = Nil;
	return VALUES_1(SVREF(svref_arg_1,FIX((SI_Long)1L)) = svref_new_value);
    }
    else
	return VALUES_1(Nil);
}
...
Object change_text_of_message varargs_1(int, n)
{
	...
	result = change_slot_value(3,message_1,Qbox_translation_and_text,
		gensym_cons_1(temp,convert_text_string_to_text(text_string)));
      POP_SPECIAL();
    POP_SPECIAL();
    return result;
}
    ...
    Object class_1, subclass;
{
    ...
    PUSH_SPECIAL(Message_class_description,message_class_description,0);
    next_loop:
...
Object post_on_message_board varargs_1(int, n)
{
    ...
    Object message_timestamp, svref_arg_1, future_task_schedule_modify_arg_8;
    Object future_task_schedule_modify_arg_10;
    Object future_task_schedule_modify_arg_11;
    Object future_task_schedule_modify_arg_12, schedule_task_qm;
    Object old_structure_being_reclaimed, temp_2;
    Object def_structure_schedule_task_variable, task, x2;
    Object real_time_duration_qm, future_task_schedule_modify_arg_6;
    SI_Long superior_class_bit_number, sub_class_vector_index, gensymed_symbol;
	...
	PUSH_SPECIAL(Current_message_serial_number,current_message_serial_number,
		7);
	  current_message_unix_time_qm = compute_current_message_time();
	  PUSH_SPECIAL(Current_message_unix_time_qm,current_message_unix_time_qm,
		  6);
	    gensym_time = Gensym_time;
	    PUSH_SPECIAL(Gensym_time,gensym_time,5);
	      if (workspace_qm) {
		  ...
		  if (target_block_qm) {
		      gensymed_symbol_3 = ISVREF(target_block_qm,(SI_Long)14L);
	    ...
	    next_loop:
	      ...
	      count_1 = FIX((SI_Long)0L);
	      gensymed_symbol_3 = ISVREF(message_board,(SI_Long)14L);
	      gensymed_symbol_3 = gensymed_symbol_3 ? 
	    ...
	    end_loop_1:
	      if (ISVREF(Message_board_parameters,(SI_Long)26L)) {
		  svref_arg_1 = ISVREF(message_1,(SI_Long)19L);
		  future_task_schedule_modify_arg_3 = 
			  DFLOAT_ISAREF_1(Current_real_time,(SI_Long)0L) + 1.0;
		  future_task_schedule_modify_arg_8 = 
			  SYMBOL_FUNCTION(Qunhighlight_recent_message);
		  future_task_schedule_modify_arg_10 = gensym_list_2(Nil,
			  Qreclaim_frame_serial_number);
		  future_task_schedule_modify_arg_11 = message_1;
		  future_task_schedule_modify_arg_12 = 
			  copy_frame_serial_number(ISVREF(message_1,
			  (SI_Long)3L));
		  schedule_task_qm = ISVREF(svref_arg_1,(SI_Long)1L);
		  if (schedule_task_qm) {
		      if (EQ(schedule_task_qm,Current_schedule_task))
		  ...
		  SVREF(task,FIX((SI_Long)9L)) = 
			  future_task_schedule_modify_arg_10;
		  ...
		  SVREF(svref_arg_1,FIX((SI_Long)1L)) = task;
	      }
	      if (target_block_qm) {
		  gensymed_symbol_3 = ISVREF(target_block_qm,(SI_Long)14L);
		  gensymed_symbol_3 = gensymed_symbol_3 ? 
		  ...
		  svref_arg_1 = ISVREF(message_1,(SI_Long)19L);
		  future_task_schedule_modify_arg_3 = 
			  real_time_duration_qm ? 
			  DFLOAT_ISAREF_1(Current_real_time,(SI_Long)0L) + 
			  (double)IFIX(duration_qm) : 
			  DFLOAT_ISAREF_1(Current_g2_time,(SI_Long)0L) + 
			  (double)IFIX(duration_qm);
		  future_task_schedule_modify_arg_6 = real_time_duration_qm;
		  future_task_schedule_modify_arg_8 = 
			  SYMBOL_FUNCTION(Qexecute_message_removal_task);
		  future_task_schedule_modify_arg_10 = gensym_list_2(Nil,
			  Qreclaim_frame_serial_number);
		  future_task_schedule_modify_arg_11 = message_1;
		  future_task_schedule_modify_arg_12 = 
		  ...
		  aref_new_value_1 = -1.0;
		  DFLOAT_ISASET_1(temp_2,(SI_Long)1L,aref_new_value_1);
		  svref_new_value =  !TRUEP(future_task_schedule_modify_arg_6);
		  SVREF(task,FIX((SI_Long)3L)) = svref_new_value ? T : Nil;
		  ISVREF(task,(SI_Long)4L) = FIX((SI_Long)2L);
		  SVREF(task,FIX((SI_Long)5L)) = Nil;
		  SVREF(task,FIX((SI_Long)9L)) = 
		  ...
		  SVREF(task,FIX((SI_Long)12L)) = 
			  future_task_schedule_modify_arg_12;
		  future_task_schedule_2(task);
		  SVREF(svref_arg_1,FIX((SI_Long)0L)) = task;
	      }
...
{
    Object gensymed_symbol, xa, ya, svref_arg_1, schedule_task_qm;
    Object old_structure_being_reclaimed, svref_new_value;
    char temp;
...
{
    x_note_fn_call(117,92);
    if (Servicing_workstation_qm && 
	    is_operator_logbook_enabled(current_workstation())) {
	provide_current_logbook();
...
Object Long_operation_notification_has_been_put_up_qm = UNBOUND;

Object Fixnum_time_at_start_of_current_long_notification = UNBOUND;

Object Current_long_operation_notification_workspace = UNBOUND;

Object Doing_long_operation_with_notification_qm = UNBOUND;
...
Object User_defined_logbook_handling_procedure_qm = UNBOUND;

Object User_defined_logbook_handling_procedure_fsn = UNBOUND;
...
Object User_defined_message_board_handling_procedure_qm = UNBOUND;

Object User_defined_message_board_handling_procedure_fsn = UNBOUND;
...
Object get_current_logbook_sequence()
{
	...
	if (sub_class_vector_index < 
	    ...
	    temp = TRUEP(Nil);
	if (temp)
	    list_1 = gensym_cons_1(subblock,list_1);
	goto next_loop_1;
      end_loop_1:;
	goto next_loop;
      end_loop:
...
Object get_current_message_board_sequence()
{
    ...
    x_note_fn_call(117,118);
    if (current_message_board_qm()) {
	list_1 = Qnil;
	gensymed_symbol = ISVREF(Current_message_board_qm,(SI_Long)14L);
	gensymed_symbol = gensymed_symbol ? ISVREF(gensymed_symbol,
		(SI_Long)4L) : Nil;
	ab_queue_form_ = gensymed_symbol;
	ab_next_queue_element_ = Nil;
...
void books_INIT()
{
    ...
    Object Quser_defined_message_board_handling_procedure_fsn;
    Object Quser_defined_message_board_handling_procedure_qm;
    Object Qg2_get_logbook_message_handler;
    Object Qg2_deregister_logbook_message_handler;
    Object Qg2_register_logbook_message_handler;
    Object Quser_defined_logbook_handling_procedure_fsn;
    Object Quser_defined_logbook_handling_procedure_qm, Qclasses_which_define;
    ...
    Object Qinform_message_information_count;
    Object Qchain_of_available_inform_message_informations, string_constant_80;
    ...
    Object Qcurrent_logbook_qm, Qcurrent_logbook_serial_number_qm;
    Object Qclose_log_file, Qdeinstall_system_table, Qlog_file_parameters;
    ...
    Object Qmaximum_log_file_name_prefix_length_qm, Kfuncall, array_constant_3;
    Object Qlog_file_name_extension, Qlog_file_pathnames;
    Object Qlog_file_time_at_open, Qlog_file_time_at_last_update;
    Object Qlog_file_message_count_at_last_update, Qlog_file_message_count;
    Object Qlog_file_count, Qreclaim_pathname_or_string;
    Object Qlog_file_default_pathname_qm, Qlog_file_stream, Qlog_file_string;
    Object Qlog_file_writing_message_qm, Qlog_file_outputting_qm;
    ...
    Object Qcurrent_message_unix_time_qm, Qcurrent_message_serial_number;
    Object Qnext_serial_number_to_be_generated, Qcurrent_message_board_qm;
    Object Kno_initial_value, Qframe_serial_number_of_current_message_board;
    Object Qmessage_board_parameters;
    Object Qinstall_system_table_for_message_board_parameters;
    Object Qlogbook_parameters, Qdeinstall_system_table_for_logbook_parameters;
    ...
    string_constant_16 = 
	    STATIC_STRING("1t4z8r83auy83auy837oy837oy00001m1l8o1l8l000004z8r83Tgy83Tgy837oy837oy0k001o1m8p83Sy1l83Hy1l8o1l8l000004z8r835py835py837oy837oy00");
    string_constant_17 = 
	    STATIC_STRING("001n1m8p839My1l8o1l8l000004z8r83cDy83cDy837oy837oy00001n1m8p9k1l8o1l8l000004z8r83HFy83HFy837oy837oy00001o1m8p838Py1l83Cy1l8o1l8l");
    string_constant_18 = 
	    STATIC_STRING("000004z8r83eny83eny837oy837oy0f001n1l83Ey1l8l1m8p83Sy000004z8r83evy83evy837oy837oy03Oz001n1l83Ey1l8l1m8p83Sy000004z8r83eoy83eoy8");
    string_constant_19 = 
	    STATIC_STRING("37oy837oy0u001n1l83Ey1l8l1m8p83Sy000004z8r83ewy83ewy837oy837oy0a001n1l83Ey1l8l1m8p83Sy00000");
    string_constant_20 = 
	    STATIC_STRING("1v8q1m837oy1l83-+y1o83auy08o8l1q83Tgyk1m8p83Sy83Hy8o8l1p835py01m8p839My8o8l1p83cDy01m8p9k8o8l1q83HFy01m8p838Py83Cy8o8l1p83enyf83");
    string_constant_21 = 
	    STATIC_STRING("Ey8l1m8p83Sy1p83evy3Oz83Ey8l1m8p83Sy1p83eoyu83Ey8l1m8p83Sy1p83ewya83Ey8l1m8p83Sy");
    ...
    string_constant_22 = 
	    STATIC_STRING("1l4z8r835py835py83UQy83UQy01l9k001n1l8o1l8l1m8p839My00000");
    string_constant_23 = STATIC_STRING("1n8q1m83UQy1l837oy1o835py1l9k8o8l");
    temp = regenerate_optimized_constant(string_constant_15);
    clear_optimized_constants();
    ...
    string_constant_27 = 
	    STATIC_STRING("1l4z8r83J7y83J7y83URy83URy00001n1l8o1l8l1m83Dy73*cy3-1y3-qy3-iy3-hy3-ky3-my3sy3Sy3-my3-ry3-iy3-Xy3Sy3ay3-gy3-hy3-gy3-Xy3Sy3-hy3-");
    string_constant_28 = 
    ...
    string_constant_33 = 
	    STATIC_STRING("1n8q1n83URy1m83Ry839dy83ey1p83J7y08o8l1m83Dy73*cy3-1y3-qy3-iy3-hy3-ky3-my3sy3Sy3-my3-ry3-iy3-Xy3Sy3ay3-gy3-hy3-gy3-Xy3Sy3-hy3-ky");
    string_constant_34 = 
    ...
    string_constant_39 = 
	    STATIC_STRING("13Gy4z8r83eVy83eVy83USy83USy031Ly001n1l8o1l8l1m8p83-Vy000004z8r83RNy83RNy83USy83USy032Cy001n1l8o1l8l1m8p83-Vy000004z8r83Uly83Uly");
    string_constant_40 = 
	    STATIC_STRING("83USy83USy0p001n1l8o1l8l1m8p83-Vy000004z8r83emy83emy83USy83USy0f001n1l8o1l8l1m8p83Sy000004z8r83euy83euy83USy83USy03Oz001n1l8o1l8");
    string_constant_41 = 
	    STATIC_STRING("l1m8p83Sy000004z8r83ely83ely83USy83USy0u001n1l8o1l8l1m8p83Sy000004z8r83ety83ety83USy83USy0a001n1l8o1l8l1m8p83Sy000004z8r83eqy83e");
    string_constant_42 = 
	    STATIC_STRING("qy83USy83USy03-++y001m1l8o1l8l000004z8r83f+y83f+y83USy83USy03-++y001m1l8o1l8l000004z8r83epy83epy83USy83USy03-++y001m1l8o1l8l0000");
    string_constant_43 = 
	    STATIC_STRING("04z8r83exy83exy83USy83USy03-++y001m1l8o1l8l000004z8r83V*y83V*y83USy83USy0n001n1l8o1l8l1m8p83-Vy000004z8r83Wty83Wty83USy83USy0l00");
    string_constant_44 = 
	    STATIC_STRING("1n1l8o1l8l1m8p83*7y000004z8r83afy83afy83USy83USy0u001n1l8o1l8l1m8p83-Vy000004z8r83UPy83UPy83USy83USy00001n1l8o1l8l1m8p83Ky000004");
    string_constant_45 = 
	    STATIC_STRING("z8r83V-y83V-y83USy83USy03=4y001n1l8o1l8l1m8p83*7y000004z8r83Twy83Twy83USy83USy08k001n1l8o1l8l1m8p83Ky000004z8r83Y3y83Y3y83USy83U");
    string_constant_46 = 
	    STATIC_STRING("Sy08k001o1m8p83Ky1l8o1l8l1l83Cy000004z8r83S4y83S4y83USy83USy00001n1l8o1l8l1m8p83Ky000004z8r83JEy83JEy83USy83USy083-cy001o1m8p83B");
    string_constant_47 = STATIC_STRING("ry1l8o1l8l1l83Cy00000");
    string_constant_48 = 
	    STATIC_STRING("13Iy8q1n83USy1l83-sy83ey1p83eVy31Ly8o8l1m8p83-Vy1p83RNy32Cy8o8l1m8p83-Vy1p83Ulyp8o8l1m8p83-Vy1p83emyf8o8l1m8p83Sy1p83euy3Oz8o8l1");
    string_constant_49 = 
	    STATIC_STRING("m8p83Sy1p83elyu8o8l1m8p83Sy1p83etya8o8l1m8p83Sy1o83eqy3-++y8o8l1o83f+y3-++y8o8l1o83epy3-++y8o8l1o83exy3-++y8o8l1p83V*yn8o8l1m8p8");
    string_constant_50 = 
	    STATIC_STRING("3-Vy1p83Wtyl8o8l1m8p83*7y1p83afyu8o8l1m8p83-Vy1p83UPy08o8l1m8p83Ky1p83V-y3=4y8o8l1m8p83*7y1p83Twy8k8o8l1m8p83Ky1q83Y3y8k1m8p83Ky");
    string_constant_51 = 
	    STATIC_STRING("8o8l83Cy1p83S4y08o8l1m8p83Ky1q83JEy83-cy1m8p83Bry8o8l83Cy");
    temp = regenerate_optimized_constant(string_constant_26);
    ...
    record_system_variable(Qlogbook_parameters,Qbooks,Ksystem_frame,Qnil,
	    Qnil,Qnil,Qt);
    string_constant_52 = 
	    STATIC_STRING("1o1m83Bry1m9k83hy1m83Bry1m9k83gy1m83Bry1m9k83*hy1m83Bry1m9k83-cy");
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qmessage_board_parameters,
	    list_constant_5);
    string_constant_53 = 
	    STATIC_STRING("1s4z8r83SHy83SHy83VQy83VQy031Ly001n1l8o1l8l1m8p83-Vy000004z8r83SCy83SCy83VQy83VQy032Cy001n1l8o1l8l1m8p83-Vy000004z8r83agy83agy83");
    string_constant_54 = 
	    STATIC_STRING("VQy83VQy0u001n1l8o1l8l1m8p83-Vy000004z8r83Uxy83Uxy83VQy83VQy0u001n1l8o1l8l1m8p83-Vy000004z8r83RWy83RWy83VQy83VQy08k001n1l8o1l8l1");
    string_constant_55 = 
	    STATIC_STRING("m8p83Ky000004z8r83Vay83Vay83VQy83VQy0832by001n1l8o1l8l1m8p834by000004z8r83Y5y83Y5y83VQy83VQy08k001o1m8p83Ky1l8o1l8l1l83Cy000004z");
    string_constant_56 = 
	    STATIC_STRING("8r83S5y83S5y83VQy83VQy00001n1l8o1l8l1m8p83Ky00000");
    string_constant_57 = 
	    STATIC_STRING("1u8q1n83VQy1l83-sy83ey1p83SHy31Ly8o8l1m8p83-Vy1p83SCy32Cy8o8l1m8p83-Vy1p83agyu8o8l1m8p83-Vy1p83Uxyu8o8l1m8p83-Vy1p83RWy8k8o8l1m8");
    string_constant_58 = 
	    STATIC_STRING("p83Ky1p83Vay832by8o8l1m8p834by1q83Y5y8k1m8p83Ky8o8l83Cy1p83S5y08o8l1m8p83Ky");
    temp = regenerate_optimized_constant(string_constant_26);
    ...
    Qoperator_logbook_enabled = STATIC_SYMBOL("OPERATOR-LOGBOOK-ENABLED",
	    AB_package);
    Qmessage_board_enabled = STATIC_SYMBOL("MESSAGE-BOARD-ENABLED",AB_package);
    ...
    string_constant_59 = 
	    STATIC_STRING("1r4z8r83UNy83UNy83UOy83UOy00001n1l8o1l8l1m8p83Ky000004z8r83K+y83K+y83UOy83UOy00001n1l8o1l8l1m8p83DUy000004z8r83ZHy83ZHy83UOy83UO");
    string_constant_60 = 
	    STATIC_STRING("y0+3Cy3-Zy3ky3fy3-ey3-hy3-Zy3fykkkkkkkr3A++y001n1l8o1l8l1m8p83DWy000004z8r83J+y83J+y83UOy83UOy00001p1l8o1l8l1l83Fy1m8p8365y1l83H");
    string_constant_61 = 
	    STATIC_STRING("y000004z8r83eTy83eTy83UOy83UOy01m3-Wy2l3H2+y832Ky001n1l8o1l8l1m8p9k000004z8r83eSy83eSy83UOy83UOy00001n1l8o1l8l1m8p83Aty000004z8r");
    string_constant_62 = 
	    STATIC_STRING("83Uwy83Uwy83UOy83UOy0u001n1l8o1l8l1m8p83DVy00000");
    string_constant_63 = 
	    STATIC_STRING("1t8q1n83UOy1l83-sy83ey1p83UNy08o8l1m8p83Ky1p83K+y08o8l1m8p83DUy1p83ZHy5rg2-log-8o8l1m8p83DWy1r83J+y08o8l83Fy1m8p8365y83Hy1p83eTy");
    string_constant_64 = 
	    STATIC_STRING("1m3-Wy2l3H2+y832Ky8o8l1m8p9k1p83eSy08o8l1m8p83Aty1p83Uwyu8o8l1m8p83DVy");
    temp = regenerate_optimized_constant(string_constant_26);
    clear_optimized_constants();
    ...
    string_constant_69 = 
	    STATIC_STRING("1u4z8r83ry83ry9k9k00001o1l8l1n8p83-ey83Gy1l8o1l83-3y000004z8r83xy83xy9k9k0835ly001o1l8l1l8z1m83Dy5qExport1l83Ey000004z8r83=ky83=");
    string_constant_70 = 
    ...
    string_constant_73 = 
	    STATIC_STRING("1l83Ey1l8l1l8z1l83Ny1m83Dy5rNew api000004z8r83S8y83S8y9k9k00001n1l8o1l8l1m83Dy5sExport: 000004z8r83Bay83Bay9k9k00001u1l83Ey1l8l1");
    string_constant_74 = 
	    STATIC_STRING("m8p833Sy1l830Yy1l83Hy1l83Fy1l83-4y1l83Ny1l8z1m83Dy5sExport: 000004z8r83aZy83aZy9k9k00001n1l83Ey1l8l1l83Hy000004z8r83VUy83VUy9k9k");
    string_constant_75 = 
	    STATIC_STRING("00001o1l8o1l8l1l83Ny1l83Hy000004z8r83VRy83VRy9k9k00001o1l8o1l8l1l83Ny1l83Hy00000");
    string_constant_76 = 
    ...
    string_constant_77 = 
	    STATIC_STRING("p83-ey83Gy1o83xy835ly8z1m83Dy5qExport1n83=ky08z1r8327yk1m8p83Sy83Ey8l8z83Ny1r8326yk1m8p83Sy83Ey8l8z83Ny1p83S8y08o8l1m83Dy5sExpor");
    string_constant_78 = 
	    STATIC_STRING("t: 1w83Bay083Ey8l1m8p833Sy830Yy83Hy83Fy83-4y83Ny8z1m83Dy5sExport: 1p83aZy083Ey8l83Hy1q83VUy08o8l83Ny83Hy1q83VRy08o8l83Ny83Hy");
    clear_optimized_constants();
    ...
    string_constant_79 = 
	    STATIC_STRING("43Dy8m83j4y1m83j4y8k1l8k0000001m1m83*gy9k1n8y83-4fy1q83-Fxy83-8Hy83x0y83v3y83vUy83-F5yksk0k0");
    ...
    Qinform_message_information_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_80 = STATIC_STRING("1q83j4y8s83-Z4y09k9l");
    clear_optimized_constants();
    ...
    check_if_superior_classes_are_defined(Qmessage_board_format,
	    list_constant_8);
    string_constant_81 = 
	    STATIC_STRING("1n4z8r83ahy83ahy83Dhy83Dhy0u001m1l8o1l8l000004z8r83SEy83SEy83Dhy83Dhy032Cy001l1l8l000004z8r83SDy83SDy83Dhy83Dhy032Cy001l1l8l0000");
    string_constant_82 = 
	    STATIC_STRING("1p8q1m83Dhy1l831Fy1o83ahyu8o8l1m83SEy32Cy1m83SDy32Cy");
    temp = regenerate_optimized_constant(string_constant_15);
    ...
    string_constant_84 = 
	    STATIC_STRING("1l4z8r83*Ly83*Ly83VPy83VPy0p001n1l8l1l8o1m8p83*7y00000");
    string_constant_85 = STATIC_STRING("1n8q1n83VPy1m83Ry832Ay83ey1m83*Lyp");
    temp = regenerate_optimized_constant(string_constant_26);
    ...
    string_constant_87 = 
	    STATIC_STRING("1m4z8r83ry83ry83Zfy83Zfy00001o1l8l1n8p083Gy1l8o1l83-3y000004z8r83xy83xy83Zfy83Zfy0836Dy001n1l8l1l83Ey1m83Dy53CyExport, writable0");
    string_constant_88 = STATIC_STRING("0000");
    string_constant_89 = 
	    STATIC_STRING("1o8q1m83Zfy1l83-ly1n83ry01n8p083Gy1m83xy836Dy");
    temp = regenerate_optimized_constant(string_constant_15);
