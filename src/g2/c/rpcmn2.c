...
Object Chain_of_available_resumable_object_mixins = UNBOUND;

Object Resumable_object_mixin_count = UNBOUND;
    ...
    Object resumable_object_mixin;
{
    ...
    x_note_fn_call(159,5);
    inline_note_reclaim_cons(resumable_object_mixin,Nil);
    svref_new_value = Chain_of_available_resumable_object_mixins;
    SVREF(resumable_object_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_object_mixins = resumable_object_mixin;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_object_mixin_structure_internal()
{
    ...
    x_note_fn_call(159,7);
    def_structure_resumable_object_mixin_variable = Nil;
    resumable_object_mixin_count_new_value = 
	    FIXNUM_ADD1(Resumable_object_mixin_count);
    Resumable_object_mixin_count = resumable_object_mixin_count_new_value;
...
Object Chain_of_available_resumable_icp_object_mixins = UNBOUND;

Object Resumable_icp_object_mixin_count = UNBOUND;
    ...
    Object resumable_icp_object_mixin;
{
    ...
    svref_new_value = Chain_of_available_resumable_icp_object_mixins;
...
Object make_permanent_resumable_icp_object_mixin_structure_internal()
{
    ...
    x_note_fn_call(159,13);
    def_structure_resumable_icp_object_mixin_variable = Nil;
    temp = FIXNUM_ADD1(Resumable_icp_object_mixin_count);
    Resumable_icp_object_mixin_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_resumable_icp_object_mixins;
	SVREF(def_structure_resumable_icp_object_mixin_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_resumable_icp_object_mixins = 
		def_structure_resumable_icp_object_mixin_variable;
...
Object Chain_of_available_resumable_node_mixins = UNBOUND;

Object Resumable_node_mixin_count = UNBOUND;
    ...
    Object resumable_node_mixin;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_node_mixins;
    SVREF(resumable_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_node_mixins = resumable_node_mixin;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_node_mixin_structure_internal()
{
    ...
    x_note_fn_call(159,19);
    def_structure_resumable_node_mixin_variable = Nil;
    resumable_node_mixin_count_new_value = 
	    FIXNUM_ADD1(Resumable_node_mixin_count);
    Resumable_node_mixin_count = resumable_node_mixin_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_resumable_icp_node_mixins = UNBOUND;

Object Resumable_icp_node_mixin_count = UNBOUND;
    ...
    Object resumable_icp_node_mixin;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_resumable_icp_node_mixins;
    SVREF(resumable_icp_node_mixin,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_resumable_icp_node_mixins = resumable_icp_node_mixin;
    return VALUES_1(Nil);
}
...
Object make_permanent_resumable_icp_node_mixin_structure_internal()
{
    ...
    x_note_fn_call(159,25);
    def_structure_resumable_icp_node_mixin_variable = Nil;
    resumable_icp_node_mixin_count_new_value = 
	    FIXNUM_ADD1(Resumable_icp_node_mixin_count);
    Resumable_icp_node_mixin_count = resumable_icp_node_mixin_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Current_receiving_resumable_object = UNBOUND;

Object The_type_description_of_receiving_resumable_object = UNBOUND;

Object Chain_of_available_receiving_resumable_objects = UNBOUND;

Object Receiving_resumable_object_count = UNBOUND;
    ...
    Object receiving_resumable_object;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_receiving_resumable_objects;
...
Object make_permanent_receiving_resumable_object_structure_internal()
{
    ...
    x_note_fn_call(159,31);
    def_structure_receiving_resumable_object_variable = Nil;
    temp = FIXNUM_ADD1(Receiving_resumable_object_count);
    Receiving_resumable_object_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_receiving_resumable_objects;
	SVREF(def_structure_receiving_resumable_object_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_receiving_resumable_objects = 
		def_structure_receiving_resumable_object_variable;
...
Object Chain_of_available_object_building_problems = UNBOUND;

Object Object_building_problem_count = UNBOUND;
    ...
    Object object_building_problem;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_object_building_problems;
    SVREF(object_building_problem,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_object_building_problems = object_building_problem;
    return VALUES_1(Nil);
}
...
Object make_permanent_object_building_problem_structure_internal()
{
    ...
    x_note_fn_call(159,38);
    def_structure_object_building_problem_variable = Nil;
    object_building_problem_count_new_value = 
	    FIXNUM_ADD1(Object_building_problem_count);
    Object_building_problem_count = object_building_problem_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_receiving_rpc_arglist_structures = UNBOUND;

Object Receiving_rpc_arglist_structure_count = UNBOUND;
    ...
    Object receiving_rpc_arglist_structure;
{
    ...
    reclaim_gensym_list_1(ISVREF(receiving_rpc_arglist_structure,(SI_Long)6L));
    SVREF(receiving_rpc_arglist_structure,FIX((SI_Long)6L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_receiving_rpc_arglist_structures;
    ...
    Object rpc_arglist_structures;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(rpc_arglist_structures);
}
    ...
    Object icp_list;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(icp_list);
}
    ...
    Object receiving_resumable_object;
{
	...
	svref_new_value = 
		delete_gensym_element_1(receiving_resumable_object,
	...
	PUSH_SPECIAL(Current_icp_read_trace_level,current_icp_read_trace_level,
	  ...
	  if (IFIX(length_1) <= (SI_Long)0L)
	    ...
	    next_loop:
	      ...
	      argument_cons = gensym_cons_1(argument,Nil);
...
{
    x_note_fn_call(159,74);
    return VALUES_1(rpc_arguments);
}

Object Rpc_throw_tag = UNBOUND;
...
Object read_icp_list_of_attributes()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    next_loop:
	      ...
	      tag = read_icp_byte();
	      ab_loopvar__2 = 
		      gensym_cons_1(g2_read_icp_attribute_for_list_of_attributes(tag),
		      Nil);
	      if (ab_loopvar__1)
...
Object read_icp_list_of_boolean()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    next_loop:
	      if (count_1 > ab_loop_bind_)
		  goto end_loop;
	      ab_loopvar__2 = gensym_cons_1(read_icp_boolean(),Nil);
	      if (ab_loopvar__1)
		  M_CDR(ab_loopvar__1) = ab_loopvar__2;
	      else
		  ab_loopvar_ = ab_loopvar__2;
...
Object read_icp_list_of_lists_of_attributes()
{
	...
	if (Icp_read_trace_cutoff_level_qm) {
	    ...
	    next_loop:
	      if (count_1 > ab_loop_bind_)
		  goto end_loop;
	      ab_loopvar__2 = gensym_cons_1(read_icp_list_of_attributes(),Nil);
	      if (ab_loopvar__1)
		  M_CDR(ab_loopvar__1) = ab_loopvar__2;
	      else
		  ab_loopvar_ = ab_loopvar__2;
...
Object read_icp_resumable_node_indices()
{
	...
	next_loop:
	  if (count_1 > ab_loop_bind_)
	      goto end_loop;
	  ab_loopvar__2 = gensym_cons_1(read_icp_fixnum(),Nil);
	  if (ab_loopvar__1)
	      M_CDR(ab_loopvar__1) = ab_loopvar__2;
	  else
	      ab_loopvar_ = ab_loopvar__2;
    ...
    Object output_port_p;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:;
    return reclaim_gensym_list_1(resumable_instance_node_indices);
}
    ...
    Object resumable_object_portion;
{
	...
	PUSH_SPECIAL(Do_not_initialize_g2_array_elements_p,do_not_initialize_g2_array_elements_p,
		3);
	  PUSH_SPECIAL(Current_receiving_resumable_object,current_receiving_resumable_object,
		  2);
	    ...
	    rpc_throw_tag = Nil;
	    PUSH_SPECIAL(Rpc_throw_tag,rpc_throw_tag,1);
	    next_loop:
	      gsi_reclaim_list_level = Qrpc_arg_list;
	      icp_tag = read_icp_byte();
	      PUSH_SPECIAL(Gsi_reclaim_list_level,gsi_reclaim_list_level,0);
    ...
    Object remote_procedure_name, rpc_argument_list;
{
	...
	PUSH_SPECIAL(Rpc_argument_list_error,rpc_argument_list_error,0);
	  argument = Nil;
	  ab_loop_list_ = rpc_argument_list;
	next_loop:
	  if ( !TRUEP(ab_loop_list_))
	...
	end_1:;
	  if (object_argument_qm) {
	      ...
	      receive_start_or_call_remote_procedure(temp,
		      remote_procedure_name_symbol,gensym_cons_1(temp_1,
		      gensym_cons_1(Nil,rpc_argument_list)),Nil);
	  }
	POP_SPECIAL();
    }
    return VALUES_1(Nil);
    ...
    Object rpc_argument_list;
{
    ...
    Object gensym_push_modify_macro_arg, car_1, cdr_1, svref_new_value, temp;
    Object temp_1;
    Declare_special(1);

    x_note_fn_call(159,175);
	...
	end_1:;
	  if (object_argument_qm) {
		...
		end_loop_1:;
	      ...
	      receive_start_or_call_remote_procedure(temp,
		      remote_procedure_name_symbol,gensym_cons_1(temp_1,
		      gensym_cons_1(Nil,rpc_argument_list)),
		      remote_procedure_identifier);
	  }
	POP_SPECIAL();
    }
  ...
  end_1:;
	...
	PUSH_SPECIAL(Rpc_argument_list_error,rpc_argument_list_error,0);
	  ...
	  receive_remote_procedure_values(remote_procedure_identifier,
		  gensym_cons_1(temp,gensym_cons_1(Nil,return_values_list)));
	POP_SPECIAL();
    }
    return VALUES_1(Nil);
}
...
void rpc_common2_INIT()
{
    ...
    Object Qutilities2, Qreceiving_rpc_arglist_structure_count;
    Object Qchain_of_available_receiving_rpc_arglist_structures;
    ...
    Object Qobject_building_problem_structure_memory_usage;
    Object Qobject_building_problem_count;
    Object Qchain_of_available_object_building_problems, string_constant_19;
    ...
    Object Qreceiving_resumable_object_count;
    Object Qchain_of_available_receiving_resumable_objects, string_constant_17;
    Object string_constant_16, Qresumable_icp_node_mixin;
    Object Qoutstanding_resumable_icp_node_mixin_count;
    Object Qresumable_icp_node_mixin_structure_memory_usage;
    Object Qresumable_icp_node_mixin_count;
    Object Qchain_of_available_resumable_icp_node_mixins, string_constant_15;
    Object string_constant_14, Qresumable_node_mixin;
    Object Qoutstanding_resumable_node_mixin_count;
    Object Qresumable_node_mixin_structure_memory_usage;
    Object Qresumable_node_mixin_count;
    Object Qchain_of_available_resumable_node_mixins, string_constant_13;
    ...
    Object Qresumable_icp_object_mixin_count;
    Object Qchain_of_available_resumable_icp_object_mixins, string_constant_11;
    Object string_constant_10, Qresumable_object_mixin;
    Object Qoutstanding_resumable_object_mixin_count;
    Object Qresumable_object_mixin_structure_memory_usage;
    Object Qresumable_object_mixin_count;
    Object Qchain_of_available_resumable_object_mixins, string_constant_9;
    Object string_constant_8;

    x_note_fn_call(159,186);
    SET_PACKAGE("AB");
    ...
    Qresumable_object_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_9 = STATIC_STRING("1q834Xy8s83-lVy09k9l");
    ...
    Qresumable_icp_object_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_11 = STATIC_STRING("1q83Emy8s83-lPy09k9l");
    clear_optimized_constants();
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8m83*Ay1n83*Ay8n8k1l8n0000000knk0k0");
    ...
    Qresumable_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83*Ay8s83-lTy09k9l");
    clear_optimized_constants();
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8m83*cy1o83*cy83*Ay8n8k1l83*Ay0000001l1m8x83*Aykok0k0");
    ...
    Qresumable_icp_node_mixin_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_15 = STATIC_STRING("1q83*cy8s83-lOy09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8m83m6y1o83m6y834Xy8n8k1l834Xy0000001n1m8x834Xy1n8y83-5Ky01m83My83-Atykzk0k0");
    ...
    Qreceiving_resumable_object_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_17 = STATIC_STRING("1q83m6y8s83-k2y09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8m83lFy1n83lFy8n8k1l8n0000001l1n8y83-51y1q83-7wy83-7ry83-7sy83-7uy83-7vy83-7tykrk0k0");
    ...
    Qobject_building_problem_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_19 = STATIC_STRING("1q83lFy8s83-gJy09k9l");
    clear_optimized_constants();
    ...
    string_constant_20 = 
	    STATIC_STRING("43Dy8m83m7y1n83m7y8n8k1l8n0000000ktk0k0");
    ...
    Qreceiving_rpc_arglist_structure_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_21 = STATIC_STRING("1q83m7y8s83-k3y09k9l");
    clear_optimized_constants();
