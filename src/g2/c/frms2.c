...
Object Last_system_class_bit_number = UNBOUND;

Object Next_class_bit_number = UNBOUND;
...
Object Classes_visited_byte_vector = UNBOUND;
...
{
    Object gensym_pop_store, cons_1, next_cons, temp, temp_1;
	...
	temp = FIXNUM_ADD1(Next_class_bit_number);
	Next_class_bit_number = temp;
...
Object assign_class_bit_numbers_and_vectors_to_system_classes()
{
    ...
    Object ab_loopvar__2, ab_loopvar__3, class_1, gensymed_symbol;
    ...
    Object sublist, class_to_add, superior, ab_loop_list_, ab_loop_it_, temp_3;
    ...
    if (Class_bit_numbers_pool) {
	reclaim_gensym_list_1(Class_bit_numbers_pool);
    ...
    PUSH_SPECIAL(Scope_conses,scope_conses,0);
	  ...
	  gensymed_symbol_2 = SXHASH_SYMBOL_1(ab_loopvar_) & 
    ...
    end_loop_9:;
      class_1 = temp_1;
      temp_3 = lookup_global_or_kb_specific_property_value(class_1,
	      Class_description_gkbprop);
      SVREF(temp_3,FIX((SI_Long)18L)) = current_class_bit_number;
    ...
    end_loop_21:;
      ...
      class_description = 
	      ...
	      Class_description_gkbprop);
      temp_3 = make_class_bit_vector(ISVREF(class_description,
	      (SI_Long)18L),ISVREF(class_description,(SI_Long)2L));
      SVREF(class_description,FIX((SI_Long)19L)) = temp_3;
      goto next_loop_20;
    end_loop_20:
    ...
    Object superclasses_path_argument;
{
    ...
    Object resulting_value, aref_arg_1, classes, classes_tail_pointer;
    ...
    SI_Long gensymed_symbol_2, gensymed_symbol_3, index_1, temp_3;
    SI_Long ab_loop_bind_, class_byte_vector_index, class_visited_byte;
    SI_Long class_byte_mask, byte_vector_index, visited_byte, byte_mask;
	...
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = superclasses_path_argument;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(superclasses_path_argument) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
    ...
    if (temp_2) {
	index_1 = (SI_Long)0L;
	temp_3 = (IFIX(Next_class_bit_number) + ((SI_Long)8L - 
		(SI_Long)1L)) / (SI_Long)8L;
	ab_loop_bind_ = temp_3;
      next_loop_8:
	if (index_1 >= ab_loop_bind_)
	    goto end_loop_8;
	aref_arg_1 = Classes_visited_byte_vector;
	...
	goto next_loop_8;
      end_loop_8:;
	classes = gensym_cons_1(superclasses_path_argument,Nil);
	classes_tail_pointer = classes;
	...
	if ( !EQ(superclasses_path_argument,inferior)) {
	    ...
	    gensymed_symbol_3 = IFIX(class_bit_number) & (SI_Long)7L;
	    class_byte_mask = gensymed_symbol_2 << gensymed_symbol_3;
	    ab_loop_it_ = (class_visited_byte & class_byte_mask) == 
		    (SI_Long)0L ? T : Nil;
	}
	else
	...
	if ( !temp_2) {
	    ...
	    gensymed_symbol_2 = (SI_Long)1L;
	    gensymed_symbol_3 = IFIX(class_bit_number) & (SI_Long)7L;
	    byte_mask = gensymed_symbol_2 << gensymed_symbol_3;
	    if ((visited_byte & byte_mask) == (SI_Long)0L) {
		aref_arg_1 = Classes_visited_byte_vector;
		aref_new_value = visited_byte | byte_mask;
		UBYTE_8_ISASET_1(aref_arg_1,byte_vector_index,aref_new_value);
    ...
    Object direct_superior_classes, user_defined_class_qm;
{
    ...
    Object slot_hash_binary_tree, element_qm, temp_2, superior, ab_loop_list_;
	...
	if (memq_function(superior_class,direct_superior_classes) &&  
	    ...
	    upgraded_superiors_list = gensym_cons_1(superior_class,
	    ...
	    M_CDR(slot_hash_binary_tree) = temp_2;
	...
	if (user_defined_class_qm) {
		...
		end_10:;
		  if ( !TRUEP(gensymed_symbol)) {
		      ...
		      inline_note_allocate_cons(gensymed_symbol_1,Qab_gensym);
		      gensymed_symbol = 
			      set_balanced_binary_tree_entry(temp,Qeq,Nil,
			      T,gensymed_symbol,temp_1,gensymed_symbol_1);
		  }
		  global_properties = gensymed_symbol;
		  gensymed_symbol = CDR(global_properties);
	...
	goto next_loop_9;
      end_loop_9:;
	reclaim_gensym_list_1(upgraded_superiors_list);
	temp_1 = make_sparse_slot_descriptions_hash_table(class_1,
		class_slot_descriptions,class_inheritance_path);
    ...
    Object class_being_defined, direct_superior_classes;
{
  ...
  end_3:;
    ...
    goto next_loop_2;
  end_loop_2:
    reclaim_gensym_list_1(list_of_common_ancestors);
    path = Nil;
    path = merging_path;
    merging_path = Nil;
    goto next_loop;
    ...
    Object symbol_1, symbol_2;
{
    Object gensymed_symbol, gensymed_symbol_1, gensymed_symbol_4, temp, temp_1;
    Object new_cons, global_properties, kb_properties, kb_specific_value;
    Object resulting_value, symbol_1_subclasses, scope_conses, ab_loopvar_;
    Object symbol_2_subclass, ab_loopvar__1, class_1, ab_loopvar__2;
    ...
    if (SYMBOLP(symbol_1)) {
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = symbol_1;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(symbol_1) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop:
	if ( !TRUEP(gensymed_symbol))
	...
	if (SYMBOLP(symbol_2)) {
	    gensymed_symbol = CDR(Symbol_properties_table);
	    gensymed_symbol_1 = symbol_2;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(symbol_2) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop_8:
	    if ( !TRUEP(gensymed_symbol))
	...
	next_loop_16:
	  ...
	  next_loop_17:
	    ...
	    ab_loopvar__1 = M_CDR(ab_loopvar__1);
	    class_1 = temp_1;
	    ab_loopvar__4 = gensym_cons_1(class_1,Nil);
	    if (ab_loopvar__3)
	  ...
	  if (memq_function(symbol_2_subclass,symbol_1_subclasses)) {
	      reclaim_gensym_list_1(symbol_1_subclasses);
	      result = VALUES_1(T);
	      goto end_18;
	  }
	  goto next_loop_16;
...
Object Current_block_of_dependent_frame = UNBOUND;
...
Object most_refined_foundation_class_of_direct_superiors varargs_1(int, n)
{
    ...
    Object foundation_class_slot_description_qm, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
  ...
  next_loop:
    ...
    if (unaliased_slot_name) {
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = superior_foundation_class;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(superior_foundation_class) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop_9:
	if ( !TRUEP(gensymed_symbol))
...
Object System_class_method_tables_processed_qm = UNBOUND;

Object Decache_attribute_description_lists_of_interned_lists_function = UNBOUND;

Object Class_change_timestamp = UNBOUND;

/* DECACHE-CACHED-CLASS-DATA */
Object decache_cached_class_data(class_1)
    Object class_1;
{
    x_note_fn_call(82,14);
...
Object update_change_timestamps(class_1)
    Object class_1;
{
    Object class_description_qm, class_change_timestamp_new_value;
    Object new_timestamp, superclass_class_description;
    ...
    x_note_fn_call(82,15);
    class_description_qm = 
	    lookup_global_or_kb_specific_property_value(class_1,
	    Class_description_gkbprop);
    if (class_description_qm) {
	class_change_timestamp_new_value = FIXNUM_ADD1(Class_change_timestamp);
	Class_change_timestamp = class_change_timestamp_new_value;
	new_timestamp = Class_change_timestamp;
    ...
    Object defining_class, slot_descriptions;
{
  ...
  next_loop:
	...
	ab_loopvar__2 = gensym_cons_1(slot_description,Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
	    ab_loopvar_ = ab_loopvar__2;
...
Object List_of_user_overridable_system_slots = UNBOUND;

Object User_overridable_variable_slots = UNBOUND;

Object User_overridable_parameter_slots = UNBOUND;

Object User_overridable_g2_array_slots = UNBOUND;

Object User_overridable_g2_list_slots = UNBOUND;

Object User_overridable_object_slots = UNBOUND;

Object User_overridable_message_slots = UNBOUND;

Object User_overridable_connection_slots = UNBOUND;
    ...
    Object class_inheritance_path;
{
  ...
  next_loop_1:
	...
	if ( !TRUEP(memq_function(slot_name,slots_to_mask_qm)))
	    list_to_return = gensym_cons_1(slot_name,list_to_return);
	goto next_loop_2;
      end_loop_2:;
    }
    goto next_loop_1;
    ...
    Object slot_descriptions_for_overridden_slots_qm;
{
    ...
    Object slot_descriptions_cons_after_which_to_insert, temp_2, symbol;
    Object property_name, temp_3, user_vector_slot_index_qm;
    Object superior_class_description, superior_slot_description_qm;
    Object working_list_slot_description;
    SI_Long gensymed_symbol_2, gensymed_symbol_3;

    x_note_fn_call(82,25);
  ...
  end_3:;
	...
	if (ISVREF(slot_description,(SI_Long)8L)) {
		...
		if (overriding_class_slot_description);
		    ...
		    gensymed_symbol = CDR(Symbol_properties_table);
		    gensymed_symbol_1 = most_specific_overriding_class;
		    gensymed_symbol_2 = 
	...
	reclaim_gensym_list_1(superior_classes_below_merging_point_in_reverse_order_qm);
    }
    user_slot_descriptions_to_add = Nil;
    slot_description = Nil;
  ...
  next_loop_16:
	...
	system_slots_overridden_by_most_refined_version = 
		gensym_cons_1(unique_slot_name,
		system_slots_overridden_by_most_refined_version);
  ...
  end_loop_25:;
	...
	goto next_loop_26;
      end_loop_26:
	reclaim_gensym_list_1(user_superior_classes_below_merging_point_qm);
    }
    if (system_slots_overridden_by_most_refined_version)
	reclaim_gensym_list_1(system_slots_overridden_by_most_refined_version);
    ...
    Object class_1, direct_superior_classes;
{
  ...
  next_loop:
	...
	gensymed_symbol = CDR(Symbol_properties_table);
	gensymed_symbol_1 = direct_superior;
	gensymed_symbol_2 = SXHASH_SYMBOL_1(direct_superior) & 
		IFIX(Most_positive_fixnum);
	gensymed_symbol_3 = (SI_Long)0L;
      next_loop_1:
	if ( !TRUEP(gensymed_symbol))
...
Object Table_to_map_generic_method_id_to_generic_method_name = UNBOUND;
    ...
    Object method_table, class_inheritance_path, user_defined_class_qm;
{
  ...
  end_loop_2:
	...
	ab_loopvar__2 = gensym_cons_1(gensym_list_2(class_1,
		class_specific_method_qm),Nil);
	if (ab_loopvar__1)
	    M_CDR(ab_loopvar__1) = ab_loopvar__2;
	else
  ...
  end_1:;
	...
	goto next_loop_3;
      end_loop_3:
	reclaim_gensym_tree_1(class_specific_methods_with_name_on_path_qm);
    ...
    Object node;
{
    ...
    Object subclass_inheritance_path, subclass_method_table, gensymed_symbol;
    Object gensymed_symbol_1, gensymed_symbol_4, temp, temp_1, new_cons;
    Object global_properties, kb_properties, kb_specific_value;
    Object resulting_value, ab_loopvar__4, current_classes_variable_set;
...
Object Do_not_note_permanent_changes_p = UNBOUND;
...
Object reclaim_slot_value_tree_function(tree)
    Object tree;
{
    x_note_fn_call(82,68);
    return reclaim_gensym_tree_1(tree);
}
...
{
    x_note_fn_call(82,69);
    if (default_value_case_qm)
	return gensym_cons_1(number_or_string,gensym_cons_1(unit_qm,
		Qdefault_slot_constant));
    else
	return gensym_list_2(number_or_string,unit_qm);
}
...
Object reclaim_slot_constant(the_constant)
    Object the_constant;
{
    x_note_fn_call(82,70);
    return reclaim_gensym_list_star_1(the_constant);
}
...
{
    x_note_fn_call(82,74);
    return VALUES_1(Nil);
}

Object Dependent_frame_class_description = UNBOUND;
...
Object reclaim_initial_slot_value(slot_value)
    Object slot_value;
{
    Object slot_value_cdr, gensymed_symbol, gensymed_symbol_1;
    Object gensymed_symbol_4, slot_cons, car_value, next_cdr, gensym_cons;
    Object cdr_new_value, temp_1, x2, sub_class_bit_vector;
    SI_Long gensymed_symbol_2, gensymed_symbol_3, index_1, ab_loop_bind_;
    SI_Long superior_class_bit_number, sub_class_vector_index;
    SI_Long gensymed_symbol_5;
    char temp;

    x_note_fn_call(82,75);
	...
	if (SYMBOLP(slot_value_cdr)) {
	    ...
	    gensymed_symbol_1 = slot_value_cdr;
	    gensymed_symbol_2 = SXHASH_SYMBOL_1(slot_value_cdr) & 
		    IFIX(Most_positive_fixnum);
	    gensymed_symbol_3 = (SI_Long)0L;
	  next_loop:
	    if ( !TRUEP(gensymed_symbol))
	...
	if (temp) {
	  ...
	  end_loop_2:
		...
		gensym_cons = slot_value;
	      next_loop_3:
		inline_note_reclaim_cons(gensym_cons,Qab_gensym);
		if (EQ(gensym_cons,slot_cons))
		    goto end_3;
	    ...
	    M_CDR(slot_cons) = cdr_new_value;
	    Available_gensym_conses = slot_value;
	    return VALUES_1(Qnil);
	}
    }
    ...
    Object slot_value;
{
    ...
    Object car_1, gensymed_symbol_4, gensymed_symbol_5, thing, cdr_of_next_cdr;
    Object slot_cons, car_value, next_cdr, gensym_cons, cdr_new_value;
    ...
    x_note_fn_call(82,76);
    if (FIXNUMP(slot_value) ||  !TRUEP(slot_value) || EQ(slot_value,
	    No_value) || SYMBOLP(slot_value));
    else if (SIMPLE_VECTOR_P(slot_value) && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(slot_value)) == (SI_Long)3L && 
	    EQ(ISVREF(slot_value,(SI_Long)2L),Constant_queue_marker));
    else if (INLINE_DOUBLE_FLOAT_VECTOR_P(slot_value) != (SI_Long)0L && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(slot_value)) == (SI_Long)1L)
	reclaim_managed_simple_float_array_of_length_1(slot_value);
    else if (text_string_p(slot_value))
	...
	if (temp)
		...
		if (SYMBOLP(slot_value_cdr)) {
		    gensymed_symbol = CDR(Defined_evaluation_value_types);
		    gensymed_symbol_4 = slot_value_cdr;
		    gensymed_symbol_1 = SXHASH_SYMBOL_1(slot_value_cdr) & 
			    IFIX(Most_positive_fixnum);
...
Object Item_class_description = UNBOUND;

Object System_item_class_description = UNBOUND;

Object Kb_frame_class_description = UNBOUND;

Object Temporary_workspace_class_description = UNBOUND;

Object Invisible_entity_class_description = UNBOUND;

Object Message_definition_class_description = UNBOUND;

Object Format_frame_class_description = UNBOUND;

Object Menu_class_description = UNBOUND;

Object Language_translation_class_description = UNBOUND;

Object User_menu_choice_class_description = UNBOUND;

Object Generic_formula_class_description = UNBOUND;

Object Logical_variable_class_description = UNBOUND;

Object Float_variable_class_description = UNBOUND;

Object Integer_variable_class_description = UNBOUND;

Object Symbolic_variable_class_description = UNBOUND;

Object Text_variable_class_description = UNBOUND;

Object Logical_parameter_class_description = UNBOUND;

Object Quantitative_parameter_class_description = UNBOUND;

Object Integer_parameter_class_description = UNBOUND;

Object Float_parameter_class_description = UNBOUND;

Object Symbolic_parameter_class_description = UNBOUND;

Object Text_parameter_class_description = UNBOUND;

Object Forward_chaining_link_class_description = UNBOUND;

Object True_value_update_recipient_class_description = UNBOUND;

Object Backward_chaining_link_class_description = UNBOUND;

Object Function_definition_class_description = UNBOUND;

Object Units_of_measure_declaration_class_description = UNBOUND;

Object Tabular_function_of_1_arg_class_description = UNBOUND;

Object G2_cell_array_class_description = UNBOUND;

Object G2_cell_array_cell_class_description = UNBOUND;

Object G2_query_cell_class_description = UNBOUND;

Object G2_designation_cell_class_description = UNBOUND;

Object G2_expression_cell_class_description = UNBOUND;

Object Remote_procedure_declaration_class_description = UNBOUND;

Object Dial_class_description = UNBOUND;

Object Meter_class_description = UNBOUND;

Object Digital_clock_class_description = UNBOUND;

Object Graph_grid_class_description = UNBOUND;

Object Plot_class_description = UNBOUND;

Object Model_definition_class_description = UNBOUND;

Object Foreign_function_declaration_class_description = UNBOUND;

Object External_simulation_definition_class_description = UNBOUND;

Object Authorized_user_class_description = UNBOUND;

Object Statement_class_description = UNBOUND;

Object Edit_box_class_description = UNBOUND;

Object Procedure_invocation_class_description = UNBOUND;

Object Logbook_page_class_description = UNBOUND;

Object Page_class_description = UNBOUND;

Object Menu_workspace_class_description = UNBOUND;

Object Category_instance_menu_workspace_class_description = UNBOUND;

Object Inspect_command_class_description = UNBOUND;

Object Icon_cell_class_description = UNBOUND;

Object Explanation_table_class_description = UNBOUND;

Object Text_box_class_description = UNBOUND;

Object G2_login_class_description = UNBOUND;

Object Name_box_class_description = UNBOUND;

Object Category_menu_class_description = UNBOUND;

Object Scrap_class_description = UNBOUND;

Object Text_region_class_description = UNBOUND;

Object Kfep_conversion_choice_menu_class_description = UNBOUND;

Object Subordinate_text_box_class_description = UNBOUND;

Object Dialog_button_class_description = UNBOUND;

Object Connection_definition_class_description = UNBOUND;

Object Workspace_name_box_class_description = UNBOUND;

Object Class_definition_class_description = UNBOUND;

Object Non_kb_workspace_class_description = UNBOUND;

Object Connection_post_class_description = UNBOUND;

Object Message_board_class_description = UNBOUND;

Object Action_button_class_description = UNBOUND;

Object Chart_class_description = UNBOUND;

Object Default_junction_class_description = UNBOUND;

Object Ruling_for_dial_class_description = UNBOUND;

Object Pointer_for_dial_class_description = UNBOUND;

Object Ruling_for_meter_class_description = UNBOUND;

Object Marker_for_meter_class_description = UNBOUND;

Object Readout_table_class_description = UNBOUND;

Object Graph_class_description = UNBOUND;

Object Ok_class_description = UNBOUND;

Object Generic_simulation_formula_class_description = UNBOUND;

Object Object_class_description = UNBOUND;

Object Method_declaration_class_description = UNBOUND;

Object Method_class_description = UNBOUND;

Object Procedure_class_description = UNBOUND;

Object Variable_or_parameter_class_description = UNBOUND;

Object Relation_class_description = UNBOUND;

Object Simulation_subtable_class_description = UNBOUND;

Object Kb_workspace_class_description = UNBOUND;

Object Table_class_description = UNBOUND;

Object Message_class_description = UNBOUND;

Object Loose_end_class_description = UNBOUND;

Object Parameter_class_description = UNBOUND;

Object Variable_class_description = UNBOUND;

Object Quantitative_variable_class_description = UNBOUND;

Object Slider_minimum_value_label_class_description = UNBOUND;

Object Rule_class_description = UNBOUND;

Object Question_mark_box_class_description = UNBOUND;

Object Slider_readout_class_description = UNBOUND;

Object Button_label_class_description = UNBOUND;

Object Slider_needle_class_description = UNBOUND;

Object Type_in_text_box_class_description = UNBOUND;

Object Button_class_description = UNBOUND;

Object Generic_action_button_class_description = UNBOUND;

Object Type_in_box_class_description = UNBOUND;

Object Arrow_button_class_description = UNBOUND;

Object G2_window_class_description = UNBOUND;

Object Connection_class_description = UNBOUND;

Object Entity_class_description = UNBOUND;

Object Workspace_class_description = UNBOUND;

Object Icon_editor_workspace_class_description = UNBOUND;

Object Object_definition_class_description = UNBOUND;

Object Icon_editor_table_info_frame_class_description = UNBOUND;

Object Bounding_box_class_description = UNBOUND;

Object Tabular_function_class_description = UNBOUND;

Object G2_list_class_description = UNBOUND;

Object Item_list_class_description = UNBOUND;

Object Value_list_class_description = UNBOUND;

Object Integer_list_class_description = UNBOUND;

Object Float_list_class_description = UNBOUND;

Object Quantity_list_class_description = UNBOUND;

Object Symbol_list_class_description = UNBOUND;

Object Text_list_class_description = UNBOUND;

Object Truth_value_list_class_description = UNBOUND;

Object G2_array_class_description = UNBOUND;

Object Item_array_class_description = UNBOUND;

Object Value_array_class_description = UNBOUND;

Object Integer_array_class_description = UNBOUND;

Object Float_array_class_description = UNBOUND;

Object Quantity_array_class_description = UNBOUND;

Object Symbol_array_class_description = UNBOUND;

Object Text_array_class_description = UNBOUND;

Object Truth_value_array_class_description = UNBOUND;

Object Definition_class_description = UNBOUND;

Object Long_variable_class_description = UNBOUND;
...
void frames2_INIT()
{
    ...
    Object list_constant_180, Qframes2, Quser_overridable_connection_slots;
    Object list_constant_179, Qjunction_block_class, Qstub_length;
    Object Qcross_section_pattern, list_constant_178;
    Object Quser_overridable_message_slots, list_constant_177;
    Object Qminimum_height_of_text_box, Qminimum_width_of_text_box;
    Object Qtext_cell_plist_for_text_box, Qdefault_text_box_format_name;
    Object list_constant_176, Quser_overridable_object_slots;
    Object list_constant_166, list_constant_175;
    Object Quser_overridable_g2_list_slots, list_constant_174;
    Object Qinsert_duplicate_elements_qm, Qlist_type, list_constant_173;
    Object Quser_overridable_g2_array_slots, list_constant_172;
    Object Qg2_array_initial_values, Qg2_array_length, Qg2_array_element_type;
    Object list_constant_171, Quser_overridable_parameter_slots;
    Object list_constant_170, list_constant_169;
    ...
    Object Quser_overridable_variable_slots, list_constant_167;
    ...
    Object Qlist_of_user_overridable_system_slots, list_constant_164;
    ...
    Object list_constant_142, list_constant_141, list_constant_140;
    ...
    Object list_constant_106, Qsimulation_subtable;
    ...
    Object Qchart, Qannotations, Qdata_series, Qchart_style, list_constant_67;
    Object list_constant_66, Qgraph, list_constant_61, Qbackground_colors;
    Object Qextra_grid_lines_qm, Qinterval_between_horizontal_grid_lines_qm;
    Object Qshow_grid_lines_qm, Qpercentage_extra_space_to_leave;
    Object Qscroll_continuously_qm, Qdesired_range_for_vertical_axis_qm;
    ...
    Object Qcurrent_block_of_dependent_frame, Qnoting_changes_to_kb_p;
    Object Qreclaim_byte_vector, list_constant_4, Qclasses_visited_byte_vector;
    Object Qinitialize_classes_visited_byte_vector, Kfuncall;

    x_note_fn_call(82,79);
    SET_PACKAGE("AB");
