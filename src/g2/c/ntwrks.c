...
Object Fixnum_time_units_of_sleep_this_clock_tick = UNBOUND;

Object Record_fixnum_time_units_of_sleep_this_clock_tick_qm = UNBOUND;

void networks_INIT()
{
    Object Qnetworks, Qfixnum_time_units_of_sleep_this_clock_tick, AB_package;
