...
Object make_frame_like_category_default varargs_1(int, n)
{
    ...
    Object gensym_push_modify_macro_arg, car_1, cdr_1, gensymed_symbol;
  ...
  end_loop:
	...
	if (memq_function(key,CDDR(result_1))) {
	    ...
	    if (EQ(pool,Qab_slot_value)) {
		gensym_push_modify_macro_arg = EQ(pool,Qab_slot_value) ? 
	    ...
	    if (EQ(pool,Qab_slot_value)) {
		gensym_push_modify_macro_arg = key;
		car_1 = gensym_push_modify_macro_arg;
		cdr_1 = CDDR(result_1);
		temp_1 = gensym_cons_1(car_1,cdr_1);
		M_CDDR(result_1) = temp_1;
...
Object Calling_float_function_cleverly_p = UNBOUND;

Object Outstanding_float_function_floats = UNBOUND;
...
Object cleanup_float_function_floats()
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    reclaim_gensym_list_1(Outstanding_float_function_floats);
...
Object Chain_of_available_extremum_caches = UNBOUND;

Object Extremum_cache_count = UNBOUND;
    ...
    Object extremum_cache;
{
    ...
    svref_new_value = Chain_of_available_extremum_caches;
    SVREF(extremum_cache,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_extremum_caches = extremum_cache;
    return VALUES_1(Nil);
}
...
Object make_permanent_extremum_cache_structure_internal()
{
    ...
    Object extremum_cache_count_new_value;
    ...
    extremum_cache_count_new_value = FIXNUM_ADD1(Extremum_cache_count);
    Extremum_cache_count = extremum_cache_count_new_value;
...
Object Trace_validate_p = UNBOUND;

static Object Qcurrent_block_of_dependent_frame;  /* current-block-of-dependent-frame */
...
Object new_constant_history(fix_or_float)
    Object fix_or_float;
{
    Object history, amf_available_array_cons_qm, amf_array, temp;
...
Object new_cascaded_history varargs_1(int, n)
{
	...
	if (Noting_changes_to_kb_p)
	    note_change_to_dependent_frame_1();
	svref_new_value = gensym_list_4(Nil,Nil,expiration_interval_qm,
		granularity);
    ...
    Object frame, cell_index, use_simulator_p;
{
    ...
    if (Noting_changes_to_kb_p)
	note_change_to_dependent_frame_1();
    svref_new_value = gensym_list_3(frame,cell_index,use_simulator_p);
    ...
    Object extremum_cache, history;
{
  ...
  next_loop:
    if (i >= ab_loop_bind_)
	goto end_loop;
    reclaim_gensym_list_1(FIXNUM_LE(ISVREF(zone_vector,(SI_Long)1L),
  ...
  next_loop_1:
    if (i >= ab_loop_bind_)
	goto end_loop_1;
    reclaim_gensym_tree_1(FIXNUM_LE(ISVREF(zone_index,(SI_Long)1L),
    ...
    goto next_loop_1;
  end_loop_1:;
    reclaim_gensym_list_1(ISVREF(extremum_cache,(SI_Long)8L));
    ...
    Object extremum_cache, start_index, value_index;
{
	...
	if ( !(FIXNUM_LE(ISVREF(zone_vector,(SI_Long)1L),
		...
		svref_new_value = gensym_list_3(Nil,Nil,Nil);
...
{
    Object svref_arg_1, temp, gensym_push_modify_macro_arg, car_1, cdr_1;
    Object svref_new_value;
    SI_Long svref_arg_2;
    ...
    temp = chestnut_modf_function(start_index,ISVREF(extremum_cache,
	    (SI_Long)6L));
    gensym_push_modify_macro_arg = gensym_cons_1(start_index,vector_index);
    car_1 = gensym_push_modify_macro_arg;
    ...
    Object extremum_cache, start, end_1, value_index;
{
	...
	svref_new_value = gensym_list_3(start,end_1,value_index);
...
void graph_util_INIT()
{
    ...
    Object Qextremum_cache_count, Qchain_of_available_extremum_caches;
    ...
    Object Qoutstanding_float_function_floats;
    Object Qcalling_float_function_cleverly_p;
    ...
    string_constant_4 = 
	    STATIC_STRING("43Dy8m83hKy1n83hKy8n8k1l8n0000000kzk0k0");
    ...
    string_constant_5 = STATIC_STRING("1q83hKy8s83-TTy09k9l");
    ...
    string_constant_7 = 
	    STATIC_STRING("1r4z8r83Q*y83Q*y83Pwy83Pwy00001m1l8o1l8l000004z8r83Q=y83Q=y83Pwy83Pwy00001m1l8o1l8l000004z8r83Q1y83Q1y83Pwy83Pwy00001n1l8o1l8l1l");
    string_constant_8 = 
	    STATIC_STRING("83Cy000004z8r83Pxy83Pxy83Pwy83Pwy00001m1l8o1l8l000004z8r83Q-y83Q-y83Pwy83Pwy00001n1l8o1l8l1l83Cy000004z8r83Q+y83Q+y83Pwy83Pwy000");
    string_constant_9 = 
	    STATIC_STRING("01m1l8o1l8l000004z8r83Q0y83Q0y83Pwy83Pwy00001n1l8o1l8l1l83Cy00000");
    string_constant_10 = 
	    STATIC_STRING("1t8q1n83Pwy1l83=fy8t1o83Q*y08o8l1o83Q=y08o8l1p83Q1y08o8l83Cy1o83Pxy08o8l1p83Q-y08o8l83Cy1o83Q+y08o8l1p83Q0y08o8l83Cy");
