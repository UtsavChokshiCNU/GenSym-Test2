...
Object G2int_jis_x_0208_to_unicode_map = UNBOUND;

Object G2int_unicode_to_jis_x_0208_map = UNBOUND;

void jismap_INIT()
{
    Object temp, temp_1, temp_2, temp_3, cjk_code, contiguous_code_qm;
    SI_Long row, column;
    ...
    Object Qg2int_jis_x_0208_to_unicode_map, string_constant_199;
    ...
    Qg2int_jis_x_0208_to_unicode_map = 
	    STATIC_SYMBOL("JIS-X-0208-TO-UNICODE-MAP",AB_package);
    SET_SYMBOL_VALUE_LOCATION(Qg2int_jis_x_0208_to_unicode_map,
	    G2int_jis_x_0208_to_unicode_map);
    string_constant_200 = 
    ...
    SET_SYMBOL_VALUE(Qg2int_jis_x_0208_to_unicode_map,
	    g2int_regenerate_optimized_constant(nconc2(temp,nconc2(temp_1,
    ...
    if (G2int_unicode_to_jis_x_0208_map == UNBOUND)
	G2int_unicode_to_jis_x_0208_map = g2int_make_cjk_code_mapping_vector();
    row = (SI_Long)33L;
  next_loop:
    if (row > (SI_Long)116L)
	goto end_loop;
  ...
  next_loop_1:
    if (column > (SI_Long)126L)
	goto end_loop_1;
    cjk_code = FIX((row << (SI_Long)8L) + column);
    contiguous_code_qm = g2int_gensym_jis_code_to_contiguous(cjk_code);
    if (contiguous_code_qm)
	g2int_set_cjk_code_mapping(FIX(UBYTE_16_ISAREF_1(G2int_jis_x_0208_to_unicode_map,
		IFIX(contiguous_code_qm))),G2int_unicode_to_jis_x_0208_map,
		cjk_code);
  ...
  end_loop_1:;
    ...
    goto next_loop;
  end_loop:;
    g2int_set_cjk_code_mapping(FIX((SI_Long)12316L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8513L));
    g2int_set_cjk_code_mapping(FIX((SI_Long)8214L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8514L));
    g2int_set_cjk_code_mapping(FIX((SI_Long)8722L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8541L));
    g2int_set_cjk_code_mapping(FIX((SI_Long)162L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8561L));
    g2int_set_cjk_code_mapping(FIX((SI_Long)163L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8562L));
    g2int_set_cjk_code_mapping(FIX((SI_Long)172L),
	    G2int_unicode_to_jis_x_0208_map,FIX((SI_Long)8780L));
}
