...
Object G2int_unicode_to_gb_2312_map = UNBOUND;
...
void gbmapr_INIT()
{
    ...
    if (G2int_unicode_to_gb_2312_map == UNBOUND) {
	...
	G2int_unicode_to_gb_2312_map = 
		g2int_regenerate_optimized_constant(nconc2(temp,
