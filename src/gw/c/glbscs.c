...
void glbasics_INIT()
{
	...
	G2int_optimized_constant_op_codes = Nil;
    string_constant_2 = 
	    STATIC_STRING("322y5vCOMMON-LISP5lTk53NyG2-DEFSTRUCT-STRUCTURE-NAME53MyTYPE-DESCRIPTION-G2-STRUCTk5mAB53IyNAMED-GENSYM-STRUCTUREk5rKEYWORD5vCON");
    string_constant_3 = 
    ...
    string_constant_5 = 
	    STATIC_STRING("-8859-ABSTRACT5uTRANSCODER53Cy8859-PART-NUMBER53JyREGULAR-EXPRESSION-NODE5qTHREAD53DyASIAN-DOUBLE-BYTEk5rKEYWORD53FyCREATIONS-AT");
    string_constant_6 = 
	    STATIC_STRING("-A-TIMEk5mAB53XyMULTIPLY-WILD-REGULAR-EXPRESSION-NODEk5rKEYWORD5oTYPEk5mAB53UyREMOTE-PROCEDURE-ITEM-PASSING-INFO53IyRESUMABLE-OB");
    string_constant_7 = 
	    STATIC_STRING("JECT-MIXIN5qSOCKET5xTEXT-SEQUENCE5yWEBLINK-SOCKET5zLISTENER-SOCKET53-=yREMOTE-PROCEDURE-ITEM-PASSING-INFO-INTERNED-VARARGSP+ITEM");
    string_constant_8 = 
	    STATIC_STRING("-INFO-LIST53GyRESUMABLE-NODE-MIXIN5uRPC-THREAD53LyTEXT-SEQUENCE-STRING-TYPE53CyUTF-G-TRANSCODER5mAE5rANSI3.45pASCII5qAacute5vAci");
    string_constant_9 = 
	    STATIC_STRING("rcumflex5uAdiaeresis5tAdieresis5qAgrave5pAring5qAtilde5yBALANCE-FACTOR53GyBINARY-ELEMENT-ALIST53MyBINARY-ELEMENT-HASH-NUMBER53Fy");
    string_constant_10 = 
	    STATIC_STRING("BINARY-TREE-ELEMENT53LyBRIDGE-CONFIGURATION-INFO5xCLIENT-SOCKET53QyCOMPILED-REGULAR-SUBEXPRESSION5xCONSTANT-TYPE53JyCONSTANT-VAL");
    string_constant_11 = 
	    STATIC_STRING("UE-INTERNAL53TyCONTINUATION-OF-PENDING-ACTIVITY\?5sCcedillak5rKEYWORD53IyELIMINATE-FOR-PRODUCTSk5mAB5xEQ-HASH-TABLE5uERROR-CODE53");
    string_constant_12 = 
	    STATIC_STRING("FyERROR-FORMAT-STRING5yERROR-SEVERITY5qEacute5vEcircumflex5uEdiaeresis5tEdieresis5qEgrave53CyFETCH-STYLE-INFO5wFETCH-THREAD53NyF");
    string_constant_13 = 
	    STATIC_STRING("ILENAME-PARSER-INFORMATION53FyFOREIGN-STRUCT-INFO53KyFUTURE-TASK-QUEUE-HOLDER53CyG2-STREAM-HANDLE53FyG2-STREAM-STRUCTURE5mGB5rGB");
    string_constant_14 = 
	    STATIC_STRING("-23125qGB231253IyGENSYM-PATHNAME-DEVICE53LyGENSYM-PATHNAME-DIRECTORY53GyGENSYM-PATHNAME-HOST53GyGENSYM-PATHNAME-NAME53GyGENSYM-P");
    string_constant_15 = 
	    STATIC_STRING("ATHNAME-TYPE53JyGENSYM-PATHNAME-VERSION5xGENSYM-STRING53GyGENSYM-STRING-STREAM53NyGENSYM-STRING-TEXT-SEQUENCE53FyGREATER-THAN-BR");
    string_constant_16 = 
	    STATIC_STRING("ANCHk5rKEYWORD5nGSIk5mAB5zGSI-APPLICATION53NyGSI-APPLICATION-NAME-SYMBOL5tGSI-ARRAY5yGSI-ARRAY-TYPE53DyGSI-ARRAY-WRAPPER5xGSI-AT");
    string_constant_17 = 
	    STATIC_STRING("TRIBUTE53IyGSI-ATTRIBUTE-INSTANCE53FyGSI-ATTRIBUTE-OWNER53EyGSI-ATTRIBUTE-SPEC53EyGSI-EXTENSION-DATA5vGSI-HISTORY53FyGSI-HISTORY");
    string_constant_18 = 
	    STATIC_STRING("-COUNTER53EyGSI-HISTORY-LENGTH53IyGSI-HISTORY-TIMESTAMPS53EyGSI-HISTORY-VALUES5wGSI-INSTANCE53IyGSI-INSTANCE-EXTENSION53EyGSI-LO");
    string_constant_19 = 
	    STATIC_STRING("CAL-FUNCTION53GyGSI-REMOTE-PROCEDURE53HyGSI-TRANSFER-INSTANCE53EyGSI-TRANSFER-OWNER53OyGSI-TRANSFER-SENSOR-OR-INDEX53FyGSI-TRANS");
    string_constant_20 = 
	    STATIC_STRING("FER-STATUS53OyGSI-TRANSFER-UPDATE-INTERVAL53GyGSI-TRANSFER-WRAPPER53EyHTTP-CLIENT-THREAD5uICP-BUFFER53DyICP-BUFFER-VECTOR53HyICP");
    string_constant_21 = 
	    STATIC_STRING("-CONNECTION-HANDLE53FyICP-CONNECTION-NAME53GyICP-CONNECTION-STATE5sICP-PORT53EyICP-PORT-DIRECTION5xICP-READ-TASK53eyICP-READ-TAS");
    string_constant_22 = 
	    STATIC_STRING("K-CORRESPONDING-ICP-OBJECT-INDEX5uICP-SOCKET53OyICP-SOCKET-LOCAL-SYSTEM-NAME5yICP-WRITE-TASK53OyICP-WRITE-TASK-ARGUMENT-LIST53Zy");
    string_constant_23 = 
	    STATIC_STRING("ICP-WRITE-TASK-COMPLETION-ARGUMENT-LIST53UyICP-WRITE-TASK-COMPLETION-FUNCTION53fyICP-WRITE-TASK-CORRESPONDING-ICP-OBJECT-INDEX53");
    string_constant_24 = 
	    STATIC_STRING("JyICP-WRITE-TASK-FUNCTION53UyICP-WRITE-TASK-RESUMABLE-ICP-STATE53HyICP-WRITE-TASK-STARTP53NyIGNORE-CACHE-OF-FETCH-STYLE5vINDEX-S");
    string_constant_25 = 
	    STATIC_STRING("PACE53CyINDEX-SPACE-NAME53PyINDEX-SPACE-OBJECT-RECLAIMER\?5xINTERNED-LIST53FyINTERNED-LIST--LIST53dyINTERNED-REMOTE-PROCEDURE-ITE");
    string_constant_26 = 
	    STATIC_STRING("M-PASSING-INFO53FyISO-2022-TRANSCODER5rISO-6465vISO-646-IRV5uISO-8859-15vISO-8859-105uISO-8859-25uISO-8859-35uISO-8859-45uISO-88");
    string_constant_27 = 
	    STATIC_STRING("59-55uISO-8859-65uISO-8859-75uISO-8859-85uISO-8859-953QyISO-8859-GRAPHIC-CHARACTER-SET53GyISO-8859-PART-NUMBER53FyISO-8859-TRANS");
    string_constant_28 = 
	    STATIC_STRING("CODER5qIacute5vIcircumflex5uIdiaeresis5tIdieresis5qIgrave5nJIS5uJIS-X-02085mKS5tKS-C-56015nKSC5rLATIN-15rLATIN-25rLATIN-35rLATIN");
    string_constant_29 = 
	    STATIC_STRING("-45rLATIN-55rLATIN-65wLATIN-ARABIC5yLATIN-CYRILLIC5vLATIN-GREEK5wLATIN-HEBREW53CyLESS-THAN-BRANCH53KyMAKE-BINARY-TREE-ELEMENT53S");
    string_constant_30 = 
	    STATIC_STRING("yMAKE-BRIDGE-CONFIGURATION-INFO-153EyMAKE-CLIENT-SOCKET53NyMAKE-EQ-HASH-TABLE-INTERNAL5zMAKE-ERROR-CODE53HyMAKE-FETCH-STYLE-INFO");
    string_constant_31 = 
	    STATIC_STRING("53DyMAKE-FETCH-THREAD53SyMAKE-FILENAME-PARSER-INFORMATION53RyMAKE-FUTURE-TASK-QUEUE-HOLDER-153TyMAKE-G2-STREAM-STRUCTURE-INTERNA");
    string_constant_32 = 
	    STATIC_STRING("L53WyMAKE-GENSYM-PATHNAME-STRUCTURE-MACRO53UyMAKE-GENSYM-STRING-STREAM-INTERNAL53GyMAKE-GSI-APPLICATION53IyMAKE-GSI-ARRAY-WRAPPE");
    string_constant_33 = 
	    STATIC_STRING("R53GyMAKE-GSI-ATTRIBUTE-153EyMAKE-GSI-HISTORY-153FyMAKE-GSI-INSTANCE-153NyMAKE-GSI-INSTANCE-EXTENSION53NyMAKE-GSI-TRANSFER-WRAPP");
    string_constant_34 = 
	    STATIC_STRING("ER-153LyMAKE-HTTP-CLIENT-THREAD-153KyMAKE-ICP-BUFFER-INTERNAL53JyMAKE-ICP-PORT-STRUCTURE53EyMAKE-ICP-READ-TASK53LyMAKE-ICP-SOCKE");
    string_constant_35 = 
	    STATIC_STRING("T-STRUCTURE53FyMAKE-ICP-WRITE-TASK53CyMAKE-INDEX-SPACE53EyMAKE-INTERNED-LIST53kyMAKE-INTERNED-REMOTE-PROCEDURE-ITEM-PASSING-INFO");
    string_constant_36 = 
	    STATIC_STRING("-153KyMAKE-ISO-8859-TRANSCODER53GyMAKE-LISTENER-SOCKET53OyMAKE-OBJECT-BUILDING-PROBLEM53HyMAKE-PENDING-ACTIVITY53JyMAKE-PROXY-FE");
    string_constant_37 = 
	    STATIC_STRING("TCH-THREAD53EyMAKE-QUEUE-ELEMENT53FyMAKE-QUEUE-INTERNAL53RyMAKE-RECEIVING-RESUMABLE-OBJECT53kyMAKE-REGULAR-EXPRESSION-NODE-FOR-S");
    string_constant_38 = 
	    STATIC_STRING("ET-OF-CHARACTERS53jyMAKE-REGULAR-EXPRESSION-NODE-FOR-SINGLE-CHARACTER53oyMAKE-REGULAR-EXPRESSION-NODE-FOR-SINGLE-WILD-CHARACTER5");
    string_constant_39 = 
	    STATIC_STRING("3gyMAKE-REGULAR-EXPRESSION-NODE-FOR-SUBEXPRESSION53iyMAKE-REGULAR-EXPRESSION-NODE-FOR-WILD-CHARACTERS53SyMAKE-REMOTE-PROCEDURE-I");
    string_constant_40 = 
	    STATIC_STRING("DENTIFIER53byMAKE-REMOTE-PROCEDURE-ITEM-PASSING-INFO-153MyMAKE-REMOTE-PROCEDURE-NAME5zMAKE-RPC-THREAD53EyMAKE-SCHEDULE-TASK53EyM");
    string_constant_41 = 
	    STATIC_STRING("AKE-SERVER-THREAD53IyMAKE-SKIP-LIST-ELEMENT53CyMAKE-SYMBOL-TREE53LyMAKE-TEMPORARY-CONSTANT-153NyMAKE-TEXT-SEQUENCE-INTERNAL5xMAK");
    string_constant_42 = 
	    STATIC_STRING("E-THREAD-153EyMAKE-UNICODE-BLOCK53LyMAXIMUM-SIZE-FOR-RESOURCE53FyNAME-OF-FETCH-STYLE53KyNAME-OF-PENDING-ACTIVITY5yNAME-OF-THREAD");
    string_constant_43 = 
	    STATIC_STRING("53OyNOTE-PROGRESS-WHILE-FETCHING5qNtilde53JyOBJECT-BUILDING-PROBLEM53UyOBJECT-BUILDING-PROBLEM-ATTRIBUTE\?53VyOBJECT-BUILDING-PRO");
    string_constant_44 = 
	    STATIC_STRING("BLEM-CLASS-NAME\?53UyOBJECT-BUILDING-PROBLEM-EXTRA-INFO53jyOBJECT-BUILDING-PROBLEM-EXTRA-INFO-FORMAT-STRING\?53fyOBJECT-BUILDING-P");
    string_constant_45 = 
	    STATIC_STRING("ROBLEM-EXTRA-INFO-RECLAIMER\?53OyOBJECT-BUILDING-PROBLEM-NAME5mOE5qOacute5vOcircumflex5tOdieresis5qOgrave5qOslash5qOtilde53DyPARE");
    string_constant_46 = 
	    STATIC_STRING("NT-ICP-SOCKET53NyPARENT-OF-PENDING-ACTIVITY\?53CyPARENT-OF-THREAD53CyPENDING-ACTIVITY53JyPORT-NUMBER-OF-LISTENERk5rKEYWORD5yPRINT");
    string_constant_47 = 
	    STATIC_STRING("-FUNCTIONk5mAB5vPRINT-QUEUE53EyPROXY-FETCH-THREAD5pQUEUE5vQUEUE-DATUM5xQUEUE-ELEMENT53FyQUEUE-HEAD-INTERNAL53EyQUEUE-NEXT-ELEMEN");
    string_constant_48 = 
	    STATIC_STRING("T53IyQUEUE-PREVIOUS-ELEMENT53FyQUEUE-TAIL-INTERNAL5sR-BUFFER5vRB-FRAGMENT5rRB-MARK53PyRECEIVE-OR-TRANSMIT-DIRECTLY\?53MyRECEIVING");
    string_constant_49 = 
	    STATIC_STRING("-RESUMABLE-OBJECT53RyRECEIVING-RPC-ARGLIST-STRUCTURE53QyRECLAIM-EQ-HASH-TABLE-INTERNAL53eyRECLAIM-FILENAME-PARSER-INFORMATION-IN");
    string_constant_50 = 
	    STATIC_STRING("TERNAL53UyRECLAIM-FUTURE-TASK-QUEUE-HOLDER-153ZyRECLAIM-GENSYM-PATHNAME-STRUCTURE-MACRO53JyRECLAIM-GSI-ATTRIBUTE-153VyRECLAIM-GS");
    string_constant_51 = 
	    STATIC_STRING("I-EXTENSION-DATA-INTERNAL53HyRECLAIM-GSI-HISTORY-153IyRECLAIM-GSI-INSTANCE-153SyRECLAIM-GSI-INSTANCE-EXTENSION-153XyRECLAIM-GSI-");
    string_constant_52 = 
	    STATIC_STRING("REMOTE-PROCEDURE-INTERNAL53QyRECLAIM-GSI-TRANSFER-WRAPPER-153NyRECLAIM-ICP-BUFFER-INTERNAL53LyRECLAIM-ICP-PORT-INTERNAL53NyRECLA");
    string_constant_53 = 
	    STATIC_STRING("IM-ICP-SOCKET-INTERNAL53IyRECLAIM-QUEUE-INTERNAL53dyRECLAIM-RECEIVING-RESUMABLE-OBJECT-INTERNAL53nyRECLAIM-REGULAR-EXPRESSION-NO");
    string_constant_54 = 
	    STATIC_STRING("DE-FOR-SET-OF-CHARACTERS53myRECLAIM-REGULAR-EXPRESSION-NODE-FOR-SINGLE-CHARACTER53ryRECLAIM-REGULAR-EXPRESSION-NODE-FOR-SINGLE-W");
    string_constant_55 = 
	    STATIC_STRING("ILD-CHARACTER53jyRECLAIM-REGULAR-EXPRESSION-NODE-FOR-SUBEXPRESSION53lyRECLAIM-REGULAR-EXPRESSION-NODE-FOR-WILD-CHARACTERS53eyREC");
    string_constant_56 = 
	    STATIC_STRING("LAIM-REMOTE-PROCEDURE-ITEM-PASSING-INFO-153YyRECLAIM-REMOTE-PROCEDURE-NAME-INTERNAL53UyRECLAIM-SKIP-LIST-ELEMENT-INTERNAL53QyREC");
    string_constant_57 = 
	    STATIC_STRING("LAIM-TEXT-SEQUENCE-INTERNAL53fyREGULAR-EXPRESSION-NODE-FOR-SET-OF-CHARACTERS53eyREGULAR-EXPRESSION-NODE-FOR-SINGLE-CHARACTER53jy");
    string_constant_58 = 
	    STATIC_STRING("REGULAR-EXPRESSION-NODE-FOR-SINGLE-WILD-CHARACTER53byREGULAR-EXPRESSION-NODE-FOR-SUBEXPRESSION53dyREGULAR-EXPRESSION-NODE-FOR-WI");
    string_constant_59 = 
	    STATIC_STRING("LD-CHARACTERS53NyREMOTE-PROCEDURE-IDENTIFIER53RyREMOTE-PROCEDURE-IDENTIFIER-TAG53HyREMOTE-PROCEDURE-NAME53OyREMOTE-PROCEDURE-NAM");
    string_constant_60 = 
	    STATIC_STRING("E-SYMBOL53KyRESUMABLE-ICP-NODE-MIXIN53MyRESUMABLE-ICP-OBJECT-MIXIN53WyRETURN-CACHE-FILENAME-OF-FETCH-STYLE53QyRETURN-RESOURCE-OF");
    string_constant_61 = 
	    STATIC_STRING("-FETCH-STYLE53VyRETURN-SERVER-PREFIX-OF-FETCH-STYLE5xSCHEDULE-TASK53FySCHEDULE-TASK-ARG-153KySCHEDULE-TASK-ARG-OFFSET53aySCHEDUL");
    string_constant_62 = 
	    STATIC_STRING("E-TASK-RECLAIMABLE-BY-SCHEDULER-P5xSERVER-THREAD53GySHIFT-JIS-TRANSCODER53YySINGLE-CHARACTER-IN-REGULAR-EXPRESSION53DySKIP-LIST-");
    string_constant_63 = 
	    STATIC_STRING("ELEMENT53JySKIP-LIST-ELEMENT-ENTRY53PySKIP-LIST-ELEMENT-HASH-NUMBER53HySKIP-LIST-ELEMENT-KEY53NySKIP-LIST-ELEMENT-TOP-LEVELk5rKE");
    string_constant_64 = 
	    STATIC_STRING("YWORD5vSLOT-OFFSETk5mAB53GySOCKET-OUTPUT-BUFFER5vSYMBOL-TREE5uTCP-SOCKET53EyTEMPORARY-CONSTANT53RyTRANSCODE-TEXT-CONVERSION-STYL");
    string_constant_65 = 
	    STATIC_STRING("E53IyTYPE-OF-ICP-CONNECTION5xUNICODE-BLOCK53RyUNICODE-BYTE-SWAPPED-TRANSCODER53EyUNICODE-TRANSCODER53KyUNICODE-UCS-2-TRANSCODER5");
    string_constant_66 = 
	    STATIC_STRING("3HyUNUSED-NODE-RECLAIMER5sUS-ASCII53CyUTF-7-TRANSCODER53CyUTF-8-TRANSCODER53cyUTF-G-ASCII-AS-MUCH-AS-POSSIBLE-TRANSCODER5qUacute");
    string_constant_67 = 
	    STATIC_STRING("5vUcircumflex5uUdiaeresis5tUdieresis5qUgrave53KyVERB-OF-FETCH-STYLE-INFO5vWIDE-STRING53LyWIDE-STRING-TEXT-SEQUENCE5qaacute5vacir");
    string_constant_68 = 
	    STATIC_STRING("cumflex5uadiaeresis5tadieresis5mae5qagrave5paring5uasciitilde5mat5qatilde5tbackslash5qbullet5sccedilla5ocent5tcopyright5qeacute5");
    string_constant_69 = 
	    STATIC_STRING("vecircumflex5uediaeresis5tedieresis5qegrave5uexclamdown5qflorin5ugermandbls5xguillemotleft5yguillemotright5qiacute5vicircumflex5");
    string_constant_70 = 
	    STATIC_STRING("uidiaeresis5tidieresis5qigrave5qntilde5qoacute5vocircumflex5todieresis5moe5qograve5qoslash5qotilde5wquestiondown5uregistered5sst");
    string_constant_71 = 
	    STATIC_STRING("erling5ttrademark5quacute5vucircumflex5uudiaeresis5tudieresis5qugrave5nyenkk");
    G2int_standard_symbols_for_optimized_constantqm = 
	    ...
	    string_constant_50,string_constant_51),list(20,
