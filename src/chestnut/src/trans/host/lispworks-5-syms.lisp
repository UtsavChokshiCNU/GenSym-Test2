;;; -*- Mode: Lisp -*-
;;;
;;; lispworks-3-1-syms.lisp -- HOST package database for LispWorks 3.1
;;;
...
(himpl:note-rcs-revision
 "$Source: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/chestnut/src/trans/host/lispworks-5-syms.lisp,v $"
 "$Revision: 1.2 $"
 "$Date: 2009-04-05 22:37:00 $")
...
;; binghe: the external symbol 'hcl:augment-environment on LW 5.0+ is NOT defined!
("AUGMENT-ENVIRONMENT"
    (:symbol
        :package "HOSTX"
	:import-from nil
