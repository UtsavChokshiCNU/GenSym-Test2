;;; -*- Mode: Lisp -*-
;;;
;;; ccl-1-4-syms.lisp -- HOST package database for Clozure CL 1.4
;;;
;;; based on mac-2-0-syms.lisp
;;;
...
This file is for Clozure CL version 1.4.")

(in-package "HOST-IMPLEMENTATION")

(himpl:note-rcs-revision
 "$Source: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/chestnut/src/trans/host/ccl-1-4-syms.lisp,v $"
 "$Revision: 1.2 $"
