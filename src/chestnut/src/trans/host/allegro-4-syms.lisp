...
;;;
;;; allegro-4-syms.lisp -- HOST package database
;;;
...
(himpl:note-rcs-revision
 "$Source: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/chestnut/src/trans/host/allegro-4-syms.lisp,v $"
 "$Revision: 1.1 $"
...
("DEFINE-SETF-EXPANDER"
    (:SYMBOL
        :PACKAGE "HOST"
        :IMPORT-FROM #-allegro-v4.1 NIL #+allegro-v4.1 "COMMON-LISP"
        )
    )
...
("DEFINE-SETF-METHOD"
    (:SYMBOL
        :PACKAGE "HOSTX"
        :IMPORT-FROM #-allegro-v4.1 "COMMON-LISP" #+allegro-v4.1 "CLTL1"
        )
    )
