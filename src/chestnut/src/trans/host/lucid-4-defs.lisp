...
;;;
;;; lucid-4-defs.lisp -- host compatibility functions 
;;; for Lucid 4.0 and Lucid 4.1
;;;
...
(himpl:note-rcs-revision
 "$Source: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/chestnut/src/trans/host/lucid-4-defs.lisp,v $"
 "$Revision: 1.1 $"
 "$Date: 2006-02-28 21:58:59 $")

#-LCL4.0
#.(error "Attempting to use incorrect host database.
This file is for Lucid Common Lisp version 4.0 and 4.1.")
