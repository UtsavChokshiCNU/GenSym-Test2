;;; -*- Mode: Lisp -*-
;;;
;;; sbcl-1-0-52-syms.lisp -- HOST package database for SBCL 1.0.52
;;;
...
;; FILE-NAMESTRING is broken on SBCL 1.0.52 (Windows), which has the same effect
;; as NAMESTRING, which has directories attached. We have to define our own version.
;; -- Chun Tian (binghe), 2011/12/12
("FILE-NAMESTRING"
    (:SYMBOL
        :PACKAGE "HOST"
        :IMPORT-FROM nil
