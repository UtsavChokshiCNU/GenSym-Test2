<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Default2" %>
 ...
 <div id="input" runat="server">
   ...
   <table class="style5">
      ...
      <asp:Label ID="Label6" runat="server" Text="To (MM/DD/YYYY)  : "></asp:Label>
                    ...
                    <td class="style14">
      <asp:TextBox ID="todate_pick" runat="server" CssClass="control_width" ReadOnly="True" ></asp:TextBox></td>
                    <td>
