<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductAdmin.aspx.cs" Inherits="Default2" %>
...
<div id="container" class="style8">
  ...
  <div id="navcontainer">
    <ul id="navlist">
      <li id="active"><a href="bundleAdmin.aspx">Bundle</a></li>
      <li><a href="ProductAdmin.aspx">Product</a></li>     
    </ul>
  </div>  
  <div id="content">
 ...
 <div id="input" runat="server">
   ...
   <table class="style5">
                <tr>
                    ...
                    <td>
                        ...
                        <div><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ControlToValidate="email_txt" ErrorMessage="Enter Email ID" 
          ...
          <asp:TextBox ID="machinename_txt" runat="server" CssClass="control_width" ></asp:TextBox></td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                            ControlToValidate="machine_id_cmbbox" 
                            ErrorMessage="Machine Id is mandatory" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style15">
      ...
      <asp:TextBox ID="machine_id_cmbbox" runat="server" CssClass="control_width" ></asp:TextBox></td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ControlToValidate="machine_id_cmbbox" ErrorMessage="Enter Machine Name" 
      ...
      <asp:Label ID="Label5" runat="server" Text="From (MM/DD/YYYY)  : "></asp:Label>
                    ...
                    <td class="style14">
      <asp:TextBox ID="startdate_pick" runat="server" CssClass="control_width" ></asp:TextBox></td>
                    <td>
                        <asp:CheckBox ID="nodate_chkBox" CssClass="control_width" runat="server" AutoPostBack="True" 
                            ...
                            Text="No Expiration Dates" />
                        <asp:RegularExpressionValidator ID="validatefromdate" runat="server" 
                            ControlToValidate="startdate_pick" ErrorMessage="Enter Valid Date" 
                            ValidationExpression="\d{1,2}/\d{1,2}/\d{4}" SetFocusOnError="True"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style15">
      <asp:Label ID="Label6" runat="server" Text="To (MM/DD/YYYY)  : "></asp:Label>
                    ...
                    <td class="style14">
      <asp:TextBox ID="todate_pick" runat="server" CssClass="control_width" ></asp:TextBox></td>
                    <td>
                        <asp:RegularExpressionValidator ID="validatetodate" runat="server" 
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator6" 
                                    ...
                                    ToolTip="Number" ValidationExpression="[0-9][0-9]{0,2}" 
                                    SetFocusOnError="True"></asp:RegularExpressionValidator>
                                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator7" 
                                    ...
                                    ToolTip="Number" ValidationExpression="[0-9]{1,3}" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                </span>
                            </td>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <asp:DropDownList ID="license_level_cmb" runat="server" Height="22px" 
                                    ...
                                    <asp:ListItem Value="none" Text="" Selected=True></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <asp:DropDownList ID="licensemode_drpbox" runat="server" Height="22px" 
                                    ...
                                    <asp:ListItem Value="Restricted-use"></asp:ListItem>
