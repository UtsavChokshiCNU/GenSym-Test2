<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bundleAdmin.aspx.cs" Inherits="bundle" %>
...
<body onload="page_laod(); return false;">
  ...
  <div id="navcontainer">
    <ul id="navlist">
      <li id="avtive"><a href="bundleAdmin.aspx">Bundle</a></li>
          ...
          <tr>
              ...
              <td class="style18">
                  <asp:CheckBox ID="nodate_chkBox" runat="server" 
                      ...
                      Text="No Expiration Dates" AutoPostBack="True" />
