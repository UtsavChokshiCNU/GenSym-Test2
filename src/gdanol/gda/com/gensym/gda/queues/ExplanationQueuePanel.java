...
public class ExplanationQueuePanel extends MDIToolBarPanel
{	
    ...
    private static final Symbol XQ_NAME_ = Symbol.intern ("EXPLANATION-QUEUE");
    
    public ExplanationQueuePanel (UiApplication app, TwAccess cxn, MessageBrowser msgBrowser) 
    {
        super ();
        browser = msgBrowser;  
