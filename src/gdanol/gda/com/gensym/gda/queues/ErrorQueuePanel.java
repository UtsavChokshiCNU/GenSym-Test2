...
public class ErrorQueuePanel extends MDIToolBarPanel
{	
    ...
    private static final Symbol EQ_NAME_ = Symbol.intern ("ERROR-QUEUE");
    
    public ErrorQueuePanel (UiApplication app, TwAccess cxn, MessageBrowser msgBrowser) 
    {
        super ();
        browser = msgBrowser;  
