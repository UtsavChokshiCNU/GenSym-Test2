...
public class gdaPanel extends JPanel {
	...
	*/
	...
	protected void addPanel(JPanel panel, String labelString, int gridy) {
		JLabel label=null;
		if (labelString!=null) {
  ...
  protected void setDefaultConstraints() {
	...
	private static final Insets checkBoxGroupInsets = new Insets(0, 4, 0, 0);
	...
	protected static Resource i18n = Resource.getBundle("com.gensym.gda.dialogs.blocks.Messages");
