 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Tue Jun 13 11:45:44 EDT 2000
 *
 */
...
public interface GqmEntry extends com.gensym.classes.Object {

  public static final Symbol GQM_ENTRY_ = Symbol.intern ("GQM-ENTRY");
  static final Symbol g2ClassName = GQM_ENTRY_;
  static final Symbol[] classInheritancePath = new Symbol[] {GQM_ENTRY_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for GQM-COMMENTS is : 
   * (Class TEXT-ARRAY)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GQM-MESSAGE-TEXT is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GQM-CREATION-TIME is : 
   * Float
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GQM-PRIORITY is : 
   * Integer
   *
   */
