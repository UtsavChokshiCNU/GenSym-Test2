 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Jul 07 08:10:13 EDT 2000
 *
 */
...
public interface GdlPermanentItemArray extends com.gensym.classes.ItemArray {

  public static final Symbol GDL_PERMANENT_ITEM_ARRAY_ = Symbol.intern ("GDL-PERMANENT-ITEM-ARRAY");
  static final Symbol g2ClassName = GDL_PERMANENT_ITEM_ARRAY_;
  static final Symbol[] classInheritancePath = new Symbol[] {GDL_PERMANENT_ITEM_ARRAY_, ITEM_ARRAY_, G2_ARRAY_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
  ...
  /**
   * Generated Property Getter for attribute -- MEMBER-IDS
   * @return the value of the MEMBER-IDS attribute of this item
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for MEMBER-IDS is : 
   * (Class TEXT-ARRAY)
   *
   */
  public com.gensym.classes.TextArray getMemberIds() throws G2AccessException;

  /**
   * Generated Property Setter for attribute -- MEMBER-IDS
   * @param memberIds new value to conclude for MEMBER-IDS
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  public void setMemberIds(com.gensym.classes.TextArray memberIds) throws G2AccessException;
