 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Jun 26 18:45:42 EDT 2000
 *
 */
...
public interface GdlObjectWithSseId extends com.gensym.classes.Object {

  public static final Symbol GDL_OBJECT_WITH_SSE_ID_ = Symbol.intern ("GDL-OBJECT-WITH-SSE-ID");
  static final Symbol g2ClassName = GDL_OBJECT_WITH_SSE_ID_;
  static final Symbol[] classInheritancePath = new Symbol[] {GDL_OBJECT_WITH_SSE_ID_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for SSE-ID is : 
   * Integer
   *
   */
