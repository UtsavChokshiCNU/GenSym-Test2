 ...
 *
 * GSI benchmark modified for GSI 3.2 release.
 * (As indicated by PAF.)  - cpm, 7/14/95
 */
...
long gsi_get_decnet_object_name(object_name)
    char *object_name;
{
    printf ("gsi_decnet_object_name\n");
    strcpy(object_name,DECNET_OBJECT_NAME);
    return(GSI_SUCCESS);
}
...
int gsibench_noop (arg_list,count,call_index)
TEMP_PARAM       *arg_list[];
...
gsi_int           call_index;
{
 ...
 gsi_rpc_return_values(ret_arg, 1,call_index,current_context);
 return(GSI_SUCCESS);
}
...
int gsibench_noop_return (arg_list,count,call_index)
TEMP_PARAM        *arg_list[];
unsigned short     count;
gsi_int           call_index;
{
 ...
 gsi_rpc_return_values(ret_arg, 2,call_index,current_context);
 return(GSI_SUCCESS);
}
...
int gsibench_noop_arg (arg_list,count,call_index)
TEMP_PARAM       *arg_list[];
unsigned short    count;
gsi_int           call_index;
{
...
int gsibench_noop_arg_return (arg_list, count,call_index)
TEMP_PARAM       *arg_list[];
unsigned short    count;
gsi_int           call_index;
{
...
gsibench_continue_rpc_call_ins(args, count,call_index)
TEMP_PARAM       *args[];
unsigned short    count;
gsi_int           call_index;
{
...
gsibench_finished_with_rpc(arg_list, count,call_index)
TEMP_PARAM        *arg_list[];
unsigned short     count;
gsi_int           call_index;
{
...
gsibench_ready_for_noop (arg_list, count,call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
gsibench_ready_for_noop_return (arg_list, count,call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
gsibench_ready_for_noop_arg (arg_list, count,call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
r_noop_arg_return (arg_list, count,call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
gsibench_finished_with_rpc_thru(arg_list, count,call_index)
TEMP_PARAM        *arg_list[];
unsigned short     count;
gsi_int           call_index;
{
...
gsibench_ready_for_noop_thru (arg_list, count,call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
r_noop_return_thru (arg_list, count, call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
r_noop_arg_thru (arg_list, count, call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
...
r_noop_arg_return_thru (arg_list, count, call_index)
TEMP_PARAM *arg_list[];
unsigned short count;
gsi_int           call_index;
{
