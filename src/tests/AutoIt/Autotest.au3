...
Send("{HOME}");
Sleep(1000);
ControlSend("Telewindows Client from SBCL!","Text Editor for the module-search-path of SERVER-PARAMETERS","Scintilla1",'"c:\g2\src\kbs\sources"');
Sleep(500);
Send("^+{ENTER}");
Sleep(1000);
Send("{ESC}");
...
Sleep(1000);
ControlSetText("Load KB","","Edit1","C:\G2\src\tests\g2-delete-symbol-test.kb");
Sleep(1000);
WinActivate("Load KB");
ControlClick("Load KB","","Button2");
;--After load KB:g2-delete-symbol-test.kb
WinActivate("Telewindows Client from SBCL!");
WinWaitActive("Telewindows Client from SBCL!");
$testws=WinExists("Telewindows Client from SBCL!","TEST-WS");
While $testws==0
	sleep(1000);
	$testws=WinExists("Telewindows Client from SBCL!","TEST-WS");
WEnd
...
Sleep(1000);
Send("s");
$testfinish=WinExists("Telewindows Client from SBCL!","DRIVER-STATS-AT-END-OF-TEST");
While $testfinish==0
	sleep(1000);
	$testfinish=WinExists("Telewindows Client from SBCL!","DRIVER-STATS-AT-END-OF-TEST");
WEnd
