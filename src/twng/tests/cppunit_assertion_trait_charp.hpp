...
namespace CppUnit {
    ...
    */
    ...
    template<> struct assertion_traits<wchar_t const*> {
        static bool equal(wchar_t const* const& x, wchar_t const* const& y) {
            return wcscmp(x,y) == 0;
        }
        
        static std::string toString(wchar_t const* const& wcs) {
