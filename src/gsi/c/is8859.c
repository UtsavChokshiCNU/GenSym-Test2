...
Object G2int_8859_2_unicode_map = UNBOUND;

Object G2int_8859_3_unicode_map = UNBOUND;

Object G2int_8859_4_unicode_map = UNBOUND;

Object G2int_8859_6_unicode_map = UNBOUND;

Object G2int_8859_7_unicode_map = UNBOUND;

Object G2int_8859_8_unicode_map = UNBOUND;
...
Object g2int_make_reverse_8859_unicode_map(n_8859_graphic_character_set_name)
    Object n_8859_graphic_character_set_name;
{
    ...
    graphic_character_set = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(n_8859_graphic_character_set_name),
	    Qg2int_graphic_character_set);
    reverse_map = g2int_make_8859_reverse_unicode_map();
    i = (SI_Long)0L;
  next_loop:
    if (i >= IFIX(G2int_8859_part_size))
	goto end_loop;
    ...
    gensymed_symbol_2 = IFIX(g2int_sxhashw(gensymed_symbol));
    temp = gensymed_symbol_2 % (SI_Long)43L;
    g2int_set_balanced_binary_tree_entry(SVREF(reverse_map,FIX(temp)),Qeq,
	    Nil,T,gensymed_symbol,FIX(gensymed_symbol_2),FIX(i));
    i = i + (SI_Long)1L;
    goto next_loop;
  end_loop:;
...
Object g2int_map_code_to_unicode_for_iso_8859_1(iso_8859_1,code)
...
Object g2int_map_unicode_to_code_if_any_for_iso_8859_1(iso_8859_1,
    ...
    Object iso_8859_1, unicode_wide_character;
{
	...
	return VALUES_1(FIXNUM_LOGAND(unicode_wide_character,
		G2int_8859_code_mask));
    else
	return VALUES_1(Nil);
}

/* MAP-CODE-TO-UNICODE-FOR-ISO-8859-5 */
Object g2int_map_code_to_unicode_for_iso_8859_5(iso_8859_5,code)
...
Object g2int_map_unicode_to_code_if_any_for_iso_8859_5(iso_8859_5,
	    unicode_wide_character)
...
Object g2int_map_code_to_unicode_for_iso_8859_9(iso_8859_9,code)
...
void iso8859_INIT()
{
    Object map_code_to_unicode_for_iso_8859_1;
    Object map_unicode_to_code_if_any_for_iso_8859_1, svref_arg_1;
    Object svref_new_value, map_code_to_unicode_for_iso_8859_5;
    Object map_unicode_to_code_if_any_for_iso_8859_5;
    Object map_code_to_unicode_for_iso_8859_9;
    Object Qg2int_iso_8859_10, AB_package, Qg2int_iso_8859_9;
    Object Qg2int_map_code_to_unicode, Qg2int_iso_8859_8, Qg2int_iso_8859_7;
    Object Qg2int_iso_8859_6, Qg2int_iso_8859_5;
    Object Qg2int_map_unicode_to_code_if_any, Qg2int_iso_8859_4;
    ...
    Object string_constant_21, string_constant, string_constant_20;
    ...
    G2int_8859_2_unicode_map = 
	    g2int_regenerate_optimized_constant(LIST_5(string_constant,
    ...
    map_code_to_unicode_for_iso_8859_1 = 
	    STATIC_FUNCTION(g2int_map_code_to_unicode_for_iso_8859_1,NIL,
	    FALSE,2,2);
    g2int_record_direct_structure_method(Qg2int_map_code_to_unicode,
	    Qg2int_iso_8859_1,map_code_to_unicode_for_iso_8859_1);
    ...
    map_unicode_to_code_if_any_for_iso_8859_1 = 
	    STATIC_FUNCTION(g2int_map_unicode_to_code_if_any_for_iso_8859_1,
	    NIL,FALSE,2,2);
    g2int_record_direct_structure_method(Qg2int_map_unicode_to_code_if_any,
	    Qg2int_iso_8859_1,map_unicode_to_code_if_any_for_iso_8859_1);
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_2_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_2),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_2);
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_3_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_3),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_3);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_4_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_4),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_4);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    Qg2int_iso_8859_5 = STATIC_SYMBOL("ISO-8859-5",AB_package);
    map_code_to_unicode_for_iso_8859_5 = 
	    STATIC_FUNCTION(g2int_map_code_to_unicode_for_iso_8859_5,NIL,
	    FALSE,2,2);
    g2int_record_direct_structure_method(Qg2int_map_code_to_unicode,
	    Qg2int_iso_8859_5,map_code_to_unicode_for_iso_8859_5);
    map_unicode_to_code_if_any_for_iso_8859_5 = 
	    STATIC_FUNCTION(g2int_map_unicode_to_code_if_any_for_iso_8859_5,
	    NIL,FALSE,2,2);
    g2int_record_direct_structure_method(Qg2int_map_unicode_to_code_if_any,
	    Qg2int_iso_8859_5,map_unicode_to_code_if_any_for_iso_8859_5);
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_6_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_6),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_6);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_7_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_7),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_7);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    ...
    svref_arg_1 = 
	    ...
	    Qg2int_graphic_character_set);
    svref_new_value = G2int_8859_8_unicode_map;
    SVREF(svref_arg_1,FIX((SI_Long)8L)) = svref_new_value;
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_8),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_8);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    Qg2int_iso_8859_9 = STATIC_SYMBOL("ISO-8859-9",AB_package);
    map_code_to_unicode_for_iso_8859_9 = 
	    STATIC_FUNCTION(g2int_map_code_to_unicode_for_iso_8859_9,NIL,
	    FALSE,2,2);
    g2int_record_direct_structure_method(Qg2int_map_code_to_unicode,
	    Qg2int_iso_8859_9,map_code_to_unicode_for_iso_8859_9);
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_9),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_9);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
    ...
    svref_arg_1 = 
	    g2int_getfq_function_no_default(INLINE_SYMBOL_PLIST(Qg2int_iso_8859_10),
	    Qg2int_graphic_character_set);
    svref_new_value = g2int_make_reverse_8859_unicode_map(Qg2int_iso_8859_10);
    SVREF(svref_arg_1,FIX((SI_Long)9L)) = svref_new_value;
}
