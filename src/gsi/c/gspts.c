...
Object g2int_g2_stream_write_char(char_1,stream)
    Object char_1, stream;
{
    x_note_fn_call(5,25);
    return VALUES_1(Nil);
}
...
Object g2int_g2_stream_write_string(string_1,stream)
    Object string_1, stream;
{
    x_note_fn_call(5,26);
    return VALUES_1(Nil);
}
...
/* G2-STREAM-CLOSE */
Object g2int_g2_stream_close(g2_stream)
    Object g2_stream;
{
    x_note_fn_call(5,58);
    return VALUES_1(Nil);
...
{
    x_note_fn_call(5,116);
    return VALUES_1(Nil);
}

void gsi_patches_INIT()
{
    x_note_fn_call(5,117);
    SET_PACKAGE("AB");
    ...
    if (G2int_g2_stream_all_open_streams == UNBOUND)
