...
gsi_char *gsirtl_strcpy(dst, src)
  gsi_char *dst;
  char *src;
{
  gsi_char *dstptr = dst;
...
char *gsirtl_strcpy_gsi_char_to_char (dst, src)
  char *dst;
  gsi_char *src;
{
  char *dstptr = dst;
...
char *gsirtl_strdup_gsi_char_to_char (str)
  gsi_char *str;
{
...
void gsirtl_copy_item_or_value(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_sequence(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_structure(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_item(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_array(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_list(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_item_or_value_1(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_sequence_1(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_structure_1(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_elements(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_attributes(arg, duplicate)
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_item_1(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_array_1(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
...
void gsirtl_copy_list_1(arg_type, arg, duplicate)
  gsi_int arg_type;
  gsi_item arg;
  gsi_item duplicate;
{
