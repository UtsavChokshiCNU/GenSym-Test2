...
Object g2int_chestnut_floorf_function(fixnum_init,divisor_fixnum_init)
...
Object g2int_chestnut_modf_function(fixnum_init,divisor_fixnum_init)
    Object fixnum_init, divisor_fixnum_init;
{
...
Object G2int_kfep_capabilityqm = UNBOUND;

Object G2int_hfep_capabilityqm = UNBOUND;

void basics_INIT()
{
    x_note_fn_call(9,2);
    SET_PACKAGE("AB");
    if (G2int_kfep_capabilityqm == UNBOUND)
	G2int_kfep_capabilityqm = Nil;
    if (G2int_hfep_capabilityqm == UNBOUND)
	G2int_hfep_capabilityqm = Nil;
}
