...
Object G2int_ks_c_5601_to_unicode_map = UNBOUND;

Object G2int_unicode_to_ks_c_5601_map = UNBOUND;

void ksmap2_INIT()
{
    Object temp, temp_1, temp_2, temp_3, temp_4, cjk_code, contiguous_code_qm;
    SI_Long row, column;
    ...
    Object string_constant_250, Qg2int_ks_c_5601_to_unicode_map;
    ...
    Qg2int_ks_c_5601_to_unicode_map = 
	    STATIC_SYMBOL("KS-C-5601-TO-UNICODE-MAP",AB_package);
    SET_SYMBOL_VALUE_LOCATION(Qg2int_ks_c_5601_to_unicode_map,
	    G2int_ks_c_5601_to_unicode_map);
    string_constant_250 = 
    ...
    SET_SYMBOL_VALUE(Qg2int_ks_c_5601_to_unicode_map,
    ...
    if (G2int_unicode_to_ks_c_5601_map == UNBOUND)
	G2int_unicode_to_ks_c_5601_map = g2int_make_cjk_code_mapping_vector();
    row = (SI_Long)33L;
  next_loop:
    if (row > (SI_Long)127L)
	goto end_loop;
  ...
  next_loop_1:
    if (column > (SI_Long)220L)
	goto end_loop_1;
    cjk_code = FIX((row << (SI_Long)8L) + column);
    contiguous_code_qm = g2int_gensym_ksc_code_to_contiguous(cjk_code);
    if (contiguous_code_qm)
	g2int_set_cjk_code_mapping(FIX(UBYTE_16_ISAREF_1(G2int_ks_c_5601_to_unicode_map,
		IFIX(contiguous_code_qm))),G2int_unicode_to_ks_c_5601_map,
		cjk_code);
