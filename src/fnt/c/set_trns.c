...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/set_trns.c,v 1.3 2005-05-23 22:36:10 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.2  1996/08/05 00:01:11  jra
*     Project: Warnings Cleanup
*
*     On advice of developers from Bitstream, we resolved a compiler warning by
*     changing an overflowing constant assignment into a short into an assignment of
*     the most positive value.
*
*     Revision 1.1  1995/11/13 22:32:36  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:26  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:04:01  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:15:08  mhd
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/set_trns.c,v 1.3 2005-05-23 22:36:10 jv Exp $";
#endif
