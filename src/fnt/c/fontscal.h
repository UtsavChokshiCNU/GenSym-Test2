...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/fontscal.h,v 1.2 1998-04-08 21:33:14 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:31:55  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:35:50  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.3  1994/04/25 21:12:19  mpc
...
*
 * Revision 1.2  1993/08/10  19:24:53  mpc
 * Project: PC TW port
 * Modified Files:	fontscal.h fontrip.c load_pcl.c
 *
 * Minor changes necessary for compiling these files on the PC with the
 * Watcom compiler.
 *
 * fontscal.h:  The redefinition of 'pascal' was def'd out for MSDOS. Watcom
 * 		defines 'pascal', '_pascal', and '__pascal'. The redef
 * 		causes an error. The definition affected nothing prior to
 * 		change.
 * fontrip.c:   A function was used before its declaration. This caused Watcom
 * 		to implicitly define parameters, which conflicted with
 * 		actuals. Now declare the function for MSDOS before its use.
 * load_pcl.c:   A function was used before its declaration. This caused Watcom
 * 		to implicitly define parameters, which conflicted with
 * 		actuals. Now declare the function for MSDOS before its use.
 *
 * Revision 1.1  1993/05/19  22:02:32  mhd
 * Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
 * all are compiles -- some are demos, or test modules.
 *
 * Revision 1.1  1993/05/04  20:13:36  mhd
