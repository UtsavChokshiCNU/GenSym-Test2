...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/tt_specs.c,v 1.2 2005-05-23 22:36:11 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:32:56  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:52  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:04:45  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:15:44  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.3  1993/04/23  22:39:18  mhd
 * Removed comments embedded in changelog comments, which mixed up
 * the compiler.
 *
 * Revision 1.2  1993/04/23  22:30:57  mhd
 *  Removed this line of code, per Bob Eggers.  It complained of multiple
 *  definitions.  See also truetype.c -mhd@gensym, 4/25/93
 *    SPEEDO_GLOBALS  sp_globals;
 *    
 *
 * Revision 1.1.1.1  1993/04/15  20:14:42  mhd
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/tt_specs.c,v 1.2 2005-05-23 22:36:11 jv Exp $";
#endif
