...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/set_spcs.c,v 1.2 2005-05-23 22:36:10 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:32:35  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:25  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:03:56  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:15:06  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.4  1993/04/23  22:55:49  mhd
 * fixed comment
 *
 * Revision 1.3  1993/04/23  22:43:40  mhd
 * Fixed problem in the changelog comment itself.
 *
 * Revision 1.2  1993/04/23  22:35:47  mhd
 * removed #define SET_SPCS (per Bob Eggers)
 *
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/set_spcs.c,v 1.2 2005-05-23 22:36:10 jv Exp $";
#endif
 ...
 *                                                                           *
 ****************************************************************************/
/* removed #define SET_SPCS --mhd@gensym, 4/22/93 */
