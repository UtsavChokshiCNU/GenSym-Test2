...
--- COMMENTED OUT
--- This is being declared now in ufe.h.
--- mhd@gensym, 8/10/93
*/
...
boolean success = FALSE;
	outValue = 0;
	success = bsBSearch ( (fix15 STACKFAR*)&outValue, MSLCompare,
...
void BuildSortedMSLIDList(PARAMS1) /* Added PARAMS1 here, and GDECL below,
				      and fixed caller in frontend.c.
				    -- mhd@gensym, 8/3/93*/
     GDECL
{
#if PROC_PCL
