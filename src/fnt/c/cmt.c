...
/*************************************************************************************
*	GlyphCompare ()
*		Comparison function called by bsBSearch() when binary searching GlyphTable
...
/*************************************************************************************
*	bsBSearch() -- JED 8.27.93 changed name to avoid link collisions with stdlib 
*                                  bsearch
...
#if PROTOS_AVAIL
#if REENTRANT_ALLOC
FUNCTION boolean  bsBSearch (SPEEDO_GLOBALS *sp_global_ptr, fix15 STACKFAR*indexPtr,
					fix15 (*ComparisonTo)(SPEEDO_GLOBALS *,fix31, void STACKFAR *),
					void STACKFAR *theValue, fix31 nElements)
#else
FUNCTION boolean  bsBSearch (fix15 STACKFAR*indexPtr,
					fix15 (*ComparisonTo)(fix31, void STACKFAR *),
					void STACKFAR *theValue, fix31 nElements)
#endif
#else
FUNCTION boolean  bsBSearch (PARAMS2 indexPtr, ComparisonTo, theValue, nElements)
GDECL
...
ufix16   keyField;
{
   ...
   aGlyphType = keyField;
#if REENTRANT_ALLOC
   result = bsBSearch ((SPEEDO_GLOBALS *)0, indexPtr, GlyphCompare, theValue, (fix31)GlyphNumElements() );
#else
   result = bsBSearch (indexPtr, GlyphCompare, theValue, (fix31)GlyphNumElements() );
#endif
   return (result);
