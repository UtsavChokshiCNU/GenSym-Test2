...
*  Revision 1.1  1995/10/03 00:35:00  jra
*  Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*  Revision 1.2  1995/03/13 23:10:56  mhd
*  Fixed numerous bugs, inefficiencies, and brokenness.  Now knows when it needs
*  to reset font rasterizer, i.e., not for every character, and can handle
*  truetype properly (except for some character encoding issues to resolve).
*
*  Demo files (used actually with the offline version of this in /bt/.../fonts)
*  were made to work and cleaned up slightly.
*
*  Take this change with the new version of FONTS simultaneously committed.
*
...
{
#if 0 /* 1 */ /* Gensym's replacement code: */  
