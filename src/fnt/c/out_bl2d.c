...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/out_bl2d.c,v 1.3 2005-05-23 22:36:09 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.2  2004/05/06 18:40:55  yduj
*     Project:Intel compiler
*     Witness:alatto
*     Authorization:dkuznick
*     Bug ID and Label:HQ-4765877 Intel compiler generates lots of new warnings
*     Files modified and/or added:rtl/c/type_of.c rtl/c/evalrun.c fnt/c/out_bl2d.c
*     Description of changes:
*       In three functions there were goto tags defined which were never went to.
*       Comment these out, to make the intel compiler happy.
*       Don't just delete them, in case someone wants to make changes for debugging
*       purposes.  (Other commented out goto tags exist.)
*     Difficulty of change:trivial
*     Number of edit sites:3
*     Number of lines changed:3
*     When and how bug was introduced:Original
*     Fanin and fanout of change:Should be none
*     How this has been tested:Compiled under both intel and MS compiler, and on
*       sparcsol.
*
*     Revision 1.1  1995/11/13 22:32:18  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:36:57  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:03:13  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:14:30  mhd
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/out_bl2d.c,v 1.3 2005-05-23 22:36:09 jv Exp $";
#endif
