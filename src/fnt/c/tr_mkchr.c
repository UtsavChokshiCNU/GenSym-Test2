...
* static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/tr_mkchr.c,v 1.1 1995-11-13 22:32:48 mes Exp $";
 *
 * $Log: not supported by cvs2svn $
 * Revision 1.1  1995/10/03 00:37:45  jra
 * Adding ext files from 4.0 Rev. 1 as initial commit for AB.
 *
 * Revision 1.3  1994/04/25 21:12:26  mpc
 ...
 *
 * Revision 1.2  1993/08/19  04:52:18  mhd
 ...
 * minor bug fixes.
 *
 * Revision 1.3  1993/07/27  23:19:50  mhd
 * Fixed lossage caused by including a c comment in a in the cvs log.
 *
 * Revision 1.2  1993/07/27  22:48:17  mhd
 * 	/\* void            do_hstem(PARAMS2); *\/
 * 	/\* -- rewrote this as the following: -mhd@gensym, 7/26/93 *\/
 * 	void            do_hstem();	/\* Execute hstem hint *\/
 * -- to fix this problem when I turned on dynamic_alloc.
 *
 * Revision 1.1  1993/05/04  20:15:29  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.4  1993/04/23  22:50:45  mhd
 * fixed comments
 *
 * Revision 1.3  1993/04/23  22:45:44  mhd
 * Fixed comments with embedded in changelog.
 *
 * Revision 1.2  1993/04/23  22:33:30  mhd
 * Altered this section per Bob Eggers' instructions:
 *    extern CHARACTERNAME  *charname_tbl[];
 *    #if NAME_STRUCT
 *    extern CHARACTERNAME   charname_structs[];
 *    #endif
 *
 * Revision 1.1.1.1  1993/04/15  20:14:32  mhd
...
/* Altered this section per Bob Eggers' instructions. -mhd@gensym, 4/25/93
   */
extern CHARACTERNAME  *charname_tbl[];
#if NAME_STRUCT
extern CHARACTERNAME   charname_structs[];
...
ufix8 STACKFAR*font_ptr;
{
	...
	/* Added the cast (font_data STACKFAR*) in front of the rhs of the
	   assignment that follows.  The SGI (strict ANSI) compiler otherwise
	   objected. -mhd@gensym, 4/22/93
	   */
