...
*                                                                         
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/spdo_prv.h,v 1.1 1995-11-13 22:32:42 mes Exp $
*                                                                                    
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/10/03 00:37:33  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:04:18  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:15:17  mhd
...
// RFP-44559 (GENSYM-2955): G2 build fails with DEBUG preprocessor definition
// Disable DEBUG even project setting defines it. -- Glority, Aug 2011
#ifdef DEBUG
#undef DEBUG
#endif
