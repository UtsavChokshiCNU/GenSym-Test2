...
*                                                                         
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/speedo.h,v 1.2 1998-04-08 21:33:16 jv Exp $                                                                       *
*                                                                                    
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:32:43  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:34  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.3  1994/11/15 23:26:50  mpc
...
*
 * Revision 1.2  1993/08/19  04:52:16  mhd
 ...
 * minor bug fixes.
 *
 * Revision 1.2  1993/07/29  16:28:35  mhd
 * Resolved bug causing failure of 4demo (speedo processor) with Kanji font.
 * Comments in code explain in detail the problem/solution.
 *
 * Revision 1.1  1993/05/04  20:15:19  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.1.1.1  1993/04/15  20:14:22  mhd
...
#if 1				/* Fix by MHD@gensym, 7/29/93 */
...
/* line of code above added to define sp_intercepts -- fix from timc@bitstream,
 -mhd@gensym, 8/9/93
 */
...
/* reset.c functions */
void spd_reset PROTO((PROTO_DECL1));
#if INCL_KEYS
