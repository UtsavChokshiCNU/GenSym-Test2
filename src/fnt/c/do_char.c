...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/do_char.c,v 1.2 2005-05-23 22:36:08 jv Exp $ *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:31:23  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:35:20  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.2  1993/08/19 04:51:55  mhd
...
*     minor bug fixes.
*
 * Revision 1.2  1993/07/23  21:18:30  mhd
 * New version of do_char.c, received from Bitstream, fixing a few problems,
 * especially in the area of getting the bounding box.
 *
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/do_char.c,v 1.2 2005-05-23 22:36:08 jv Exp $";
#endif
...
if ((fix15) pchar_data->no_bytes < no_bytes)  /* Correct number of bytes loaded? */
    return NULL;
