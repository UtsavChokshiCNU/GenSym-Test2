...
#if REENTRANT_ALLOC
boolean  bsBSearch PROTO((PROTO_DECL2 fix15 STACKFAR*indexPtr, fix15 (*ComparisonTo)(SPEEDO_GLOBALS *,fix31, void STACKFAR *), \
					void STACKFAR *theValue, fix31 nElements));
#else
boolean  bsBSearch PROTO((fix15 STACKFAR*indexPtr, fix15 (*ComparisonTo)(fix31, void STACKFAR *), \
					void STACKFAR *theValue, fix31 nElements));
#endif
#if RESTRICTED_ENVIRON
