...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/out_scrn.c,v 1.2 2005-05-23 22:36:10 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:32:21  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:00  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.2  1994/04/25 21:12:23  mpc
...
*
 * Revision 1.1  1993/05/19  22:03:19  mhd
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/out_scrn.c,v 1.2 2005-05-23 22:36:10 jv Exp $";
#endif
...
if ((X3 >> 16) == (X0 >> 16))
    {
    sp_vert_line_screen(PARAMS2 X3, (fix15)(Y0>>16),(fix15)(Y3>>16));
	return;
    }
