...
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/reset.c,v 1.2 2005-05-23 22:36:10 jv Exp $                                                                       *
*                                                                                    *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/11/13 22:32:30  mes
*     Project:  Bitstream Font Transition
*
*       Committing all Bitstream fonts files from the ext/c module.  This is the new
*     home for libfnt.a.
*
*     Revision 1.1  1995/10/03 00:37:15  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.2  1994/11/15 23:26:52  mpc
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/reset.c,v 1.2 2005-05-23 22:36:10 jv Exp $";
#endif
...

FUNCTION void spd_reset(PARAMS1)
GDECL
/*
...
if ((ufix16) (private_off + FH_CUSNR) > font_buff.no_bytes)
	{
