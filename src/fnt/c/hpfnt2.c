 ...
 *                                                                           *
*                                                                                    *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fnt/c/hpfnt2.c,v 1.1 1995-11-13 22:32:07 mes Exp $ *
*     $Log: not supported by cvs2svn $
*     Revision 1.1  1995/10/03 00:36:25  jra
*     Adding ext files from 4.0 Rev. 1 as initial commit for AB.
*
*     Revision 1.1  1993/05/19 22:02:51  mhd
*     Added Bitstream fontrip (Font Raster Image Processor) c & h files.  Not
*     all are compiles -- some are demos, or test modules.
*
 * Revision 1.1  1993/05/04  20:13:56  mhd
