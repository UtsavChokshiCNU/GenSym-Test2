...
Object reclaim_window_for_workstation(gensym_window)
    Object gensym_window;
{
    Object current_window, delete_corresponding_object_qm, workstation_qm;
    Declare_special(2);

    x_note_fn_call(50,40);
    current_window = gensym_window;
    ...
    PUSH_SPECIAL(Delete_corresponding_object_qm,delete_corresponding_object_qm,
	    1);
      PUSH_SPECIAL(Current_window,current_window,0);
...
Object sync_graphics_on_native_window(native_window_qm)
    Object native_window_qm;
{
    x_note_fn_call(50,62);
    if (native_window_qm)
	sync_graphics_on_native_window_1(native_window_qm);
    return VALUES_1(Nil);
}
...
Object synchronize_icp_on_window_with_drawing(current_window,
	    left_edge_of_draw_area,top_edge_of_draw_area,
	    right_edge_of_draw_area,bottom_edge_of_draw_area)
    Object current_window, left_edge_of_draw_area, top_edge_of_draw_area;
    ...
    Object gensym_window;
{
    ...
    SI_Long gensymed_symbol, gensymed_symbol_1;
    double gensymed_symbol_3;
    Declare_special(12);

    x_note_fn_call(50,125);
    ...
    Object gensym_window;
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, gensymed_symbol_2, car_new_value, module_name;
    Object ab_loop_list_, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    Object ab_loop_desetq_, code, info;
...
Object update_window varargs_1(int, n)
{
    ...
    Object current_window, drawing_on_window, current_drawing_transfer_mode;
			...
			PUSH_SPECIAL(Top_edge_of_draw_area,top_edge_of_draw_area,
			  ...
			  PUSH_SPECIAL(Left_edge_of_draw_area,left_edge_of_draw_area,
			    ...
			    if (FIXNUM_LT(Left_edge_of_draw_area,
				    ...
				    Bottom_edge_of_draw_area)) {
				current_window = gensym_window;
				PUSH_SPECIAL(Current_window,current_window,21);
...
void windows1_INIT()
{
    ...
    Object Qcurrent_drawing_transfer_mode, Qtelewindows;
    ...
    string_constant_10 = 
	    STATIC_STRING("43Dy8l83sy1n83sy8m8k1l8m0000001m1m8q833Iy1n8n831ry1l832hyk3-2yk0k0");
    ...
    string_constant_11 = STATIC_STRING("1q83sy8o8365y09k9l");
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8l83-0y1o83-0y83Py8m8k1l83Py0000001n1m8p83Py1m8q833Ny1n8n832-y1q830Uy830wy83Zy83Xy83Wy83*Ayktk0k0");
    ...
    Qidentified_drawing_activity_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_13 = STATIC_STRING("1q83-0y8o836Hy09k9l");
    clear_optimized_constants();
    ...
    string_constant_14 = 
	    STATIC_STRING("43Dy8l83iy1n83iy8m8k1l8m0000001l1n8n831jy1p83*fy83*iy83*jy83*gy83*hyksk0k0");
    ...
    string_constant_15 = STATIC_STRING("1q83iy8o835dy09k9l");
    clear_optimized_constants();
    ...
    string_constant_16 = 
	    STATIC_STRING("43Dy8l83-my1n83-my8m8k1l8m0000001l1m8q833fykqk0k0");
    ...
    string_constant_17 = STATIC_STRING("1q83-my8o837Ry09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8l83-Sy1n83-Sy8m8k1l8m0000001m1n8n8329y1o8331y833=y833*y8330y1m8q833Tykpk0k0");
    ...
    string_constant_19 = STATIC_STRING("1q83-Sy8o837+y09k9l");
    clear_optimized_constants();
