...
Object Current_system_being_loaded = UNBOUND;

Object Override_eliminate_for_gsi_p = UNBOUND;

Object Override_eliminate_for_gsi_no_utf_g_p = UNBOUND;

Object Macroexpanding_for_instruction_expander = UNBOUND;
...
Object Most_recent_defun_warned_for_catch_qm = UNBOUND;

Object Most_recent_defun_warned_for_unwind_protect_qm = UNBOUND;
...
Object Current_module_qm = UNBOUND;
...
Object Current_directory_of_source_truenames_qm = UNBOUND;

Object Current_directory_of_binary_truenames = UNBOUND;

Object Pathname_for_distribution_binaries_qm = UNBOUND;

Object Use_directory_lists_for_bootstrapping_qm = UNBOUND;

Object Last_bootstrap_mode_qm = UNBOUND;
...
Object Ab_package_1 = UNBOUND;

Object All_systems = UNBOUND;
...
Object Filename_of_module_being_loaded_qm = UNBOUND;

Object Current_module_source_filename = UNBOUND;

Object Current_module_lisp_binary_filename = UNBOUND;
    ...
    Object pathname_for_non_distribution_binaries_qm;
{
    ...
    x_note_fn_call(1,43);
    PUSH_SPECIAL(Pathname_for_distribution_binaries_qm,pathname_for_distribution_binaries_qm,
	    0);
...
Object G2_operating_system = UNBOUND;

Object G2_machine_type = UNBOUND;

Object Machine_model_var = UNBOUND;
...
Object Do_not_load_modules_p = UNBOUND;

Object Making_distribution_system_qm = UNBOUND;
