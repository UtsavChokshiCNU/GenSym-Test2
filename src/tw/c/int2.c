...
Object Icp_socket_index = UNBOUND;

Object Shutdown_interval_for_disallowed_icp_connection_in_seconds = UNBOUND;

Object Shutdown_interval_for_disallowed_icp_connection = UNBOUND;

Object Negative_shutdown_interval_for_disallowed_icp_connection = UNBOUND;

Object Refused_icp_listener_connections = UNBOUND;
...
Object get_forbidden_listener_clients_if_any()
{
	...
	if ( !TRUEP(network_access_allowed_p(2,Qg2,Qconnect)))
	    forbidden_listener_clients_qm = gensym_cons_1(Qg2,
		    forbidden_listener_clients_qm);
	if ( !TRUEP(network_access_allowed_p(2,Qtelewindows,Qconnect)))
	    forbidden_listener_clients_qm = gensym_cons_1(Qtelewindows,
		    forbidden_listener_clients_qm);
...
Object Inhibit_icp_message_processing_enabled = UNBOUND;

Object Inhibit_icp_message_processing = UNBOUND;
...
Object Handle_ui_client_interface_messages_immediately_p = UNBOUND;

Object Abort_for_icp_catcher_qm = UNBOUND;
    ...
    Object icp_socket, force_schedule_p;
{
	...
	future_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qhandle_queued_icp_messages_task);
    ...
    Object icp_output_port, flush_partial_buffers;
{
    ...
    localnetp = EQ(type_of_icp_connection,Qlocalnet);
...
Object Priority_of_icp_message_service = UNBOUND;

Object Priority_of_rpc_service = UNBOUND;

Object Priority_of_icp_control_messages = UNBOUND;

Object Resumable_priority_of_gsi_data_service = UNBOUND;

Object Resumable_priority_of_gsi_rpc_service = UNBOUND;

Object Current_icp_buffer = UNBOUND;

Object Current_read_icp_byte_position = UNBOUND;

Object Current_write_icp_byte_position = UNBOUND;

Object Writing_resumable_icp_messages_p = UNBOUND;

Object Icp_error_suspend_p = UNBOUND;

Object Current_resumable_icp_read_task = UNBOUND;

Object Resumable_icp_read_ignore_p = UNBOUND;

Object Number_of_icp_bytes_left_in_current_buffer = UNBOUND;
...
Object read_icp_skip_to_message_group_end()
{
    ...
    x_note_fn_call(46,21);
    current_resumable_icp_read_task = Nil;
    PUSH_SPECIAL(Current_resumable_icp_read_task,current_resumable_icp_read_task,
	    0);
    next_loop:
...
Object ensure_next_icp_message_series()
{
	...
	PUSH_SPECIAL(Number_of_icp_bytes_left_in_current_buffer,number_of_icp_bytes_left_in_current_buffer,
		0);
...
Object At_end_of_icp_message_group_qm = UNBOUND;
    ...
    Object icp_input_port;
{
	...
	PUSH_SPECIAL(Current_system_name,current_system_name,9);
	  if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		  ...
		  current_icp_port = icp_input_port;
		  PUSH_SPECIAL(Current_icp_port,current_icp_port,8);
		    current_icp_socket = ISVREF(Current_icp_port,(SI_Long)2L);
		    PUSH_SPECIAL(Current_icp_socket,current_icp_socket,7);
		      current_standard_icp_object_index_space = 
			      ISVREF(Current_icp_port,(SI_Long)8L);
		      PUSH_SPECIAL(Current_standard_icp_object_index_space,current_standard_icp_object_index_space,
			      6);
			current_temporary_icp_object_index_space = 
				ISVREF(Current_icp_port,(SI_Long)19L);
			PUSH_SPECIAL(Current_temporary_icp_object_index_space,current_temporary_icp_object_index_space,
				5);
			  number_of_icp_bytes_left_in_message_series = 
				  FIX((SI_Long)0L);
			  PUSH_SPECIAL(Number_of_icp_bytes_left_in_message_series,number_of_icp_bytes_left_in_message_series,
				  4);
			    ...
			    PUSH_SPECIAL(Current_icp_buffer,current_icp_buffer,
			      ...
			      number_of_icp_bytes_ready_to_read = 
				      FIX((SI_Long)0L);
			      PUSH_SPECIAL(Number_of_icp_bytes_ready_to_read,number_of_icp_bytes_ready_to_read,
				      2);
				at_end_of_icp_message_group_qm = Nil;
				PUSH_SPECIAL(At_end_of_icp_message_group_qm,at_end_of_icp_message_group_qm,
					1);
				  current_read_icp_byte_position = Nil;
				  PUSH_SPECIAL(Current_read_icp_byte_position,current_read_icp_byte_position,
					  0);
				    if ((SI_Long)0L < 
...
Object Icp_socket_transacting_message_group = UNBOUND;

Object At_end_of_icp_message_block_qm = UNBOUND;

Object Icp_message_trace_stream_qm = UNBOUND;

Object Handling_solitary_i_am_alive_qm = UNBOUND;
    ...
    Object exit_at_end_of_message_block_qm;
{
    ...
    x_note_fn_call(46,36);
    current_resumable_icp_read_task = Nil;
    PUSH_SPECIAL(Current_resumable_icp_read_task,current_resumable_icp_read_task,
	    5);
      resumable_icp_read_ignore_p = Nil;
      PUSH_SPECIAL(Resumable_icp_read_ignore_p,resumable_icp_read_ignore_p,4);
	parent_icp_socket = ISVREF(Current_icp_port,(SI_Long)2L);
	at_end_of_icp_message_block_qm = Nil;
	PUSH_SPECIAL(At_end_of_icp_message_block_qm,at_end_of_icp_message_block_qm,
		3);
	  ...
	  next_loop:
		...
		end_loop_1:
		  ...
		  PUSH_SPECIAL(Handling_solitary_i_am_alive_qm,handling_solitary_i_am_alive_qm,
			  0);
...
Object Debug_out_of_synch = UNBOUND;
    ...
    Object number_of_icp_bytes_ready_to_read, icp_socket;
{
    ...
    x_note_fn_call(46,37);
    PUSH_SPECIAL(Number_of_icp_bytes_ready_to_read,number_of_icp_bytes_ready_to_read,
	    1);
      PUSH_SPECIAL(Current_icp_buffer,current_icp_buffer,0);
    ...
    Object error_type, error_string_or_out_of_synch_case, arg1, arg2, arg3;
{
    ...
    x_note_fn_call(46,40);
    resumable_icp_state = Nil;
    PUSH_SPECIAL(Resumable_icp_state,resumable_icp_state,0);
      direction = ISVREF(Current_icp_port,(SI_Long)3L);
      resumable_output_p = EQ(direction,Qoutput) && 
	      Writing_resumable_icp_messages_p ? ( !TRUEP(T) ? T : Nil) : Qnil;
      ...
      string2 = icp_error_message_string(error_type,
	      error_string_or_out_of_synch_case,arg1,arg2,arg3);
      notify_user_at_console(1,string2);
...
Object Icp_buffers_for_message_group = UNBOUND;

Object Icp_byte_position_of_start_of_message_series_qm = UNBOUND;

Object Icp_buffer_of_start_of_message_series_qm = UNBOUND;

Object Number_of_icp_bytes_in_message_group = UNBOUND;
...
Object Writing_icp_message_group = UNBOUND;

/* NEXT-ICP-MESSAGE-GROUP */
Object next_icp_message_group()
{
    x_note_fn_call(46,48);
...
Object Do_icp_flow_control_qm = UNBOUND;
    ...
    Object i_am_alive_info;
{
    ...
    gensymed_symbol = gensym_cons_1(FIX(id_for_last_message_group_written),
	    FIX(message_group_final_byte_count));
    gensymed_symbol = gensym_cons_1(gensymed_symbol,Nil);
    if (ISVREF(i_am_alive_info,(SI_Long)12L)) {
	if ( !TRUEP(ISVREF(i_am_alive_info,(SI_Long)13L))) {
	    temp = last(ISVREF(i_am_alive_info,(SI_Long)12L),_);
	    SVREF(i_am_alive_info,FIX((SI_Long)13L)) = temp;
	}
	temp = ISVREF(i_am_alive_info,(SI_Long)13L);
	M_CDR(temp) = gensymed_symbol;
    }
    else
	SVREF(i_am_alive_info,FIX((SI_Long)12L)) = gensymed_symbol;
    SVREF(i_am_alive_info,FIX((SI_Long)13L)) = gensymed_symbol;
...
{
    Object was_clogged_p, fn, new_clogged_p;
    Object current_task_schedule_modify_arg_8;
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qhandle_unclogged_connection_if_necessary);
	current_task_schedule_modify_arg_11 = i_am_alive_info;
	...
	if (ctask && FIXNUM_LT(p,Priority_of_next_task))
	    Priority_of_next_task = p;
	return VALUES_1(SVREF(i_am_alive_info,FIX((SI_Long)17L)) = task);
    }
    else
	return VALUES_1(Nil);
}
    ...
    Object icp_message_type_code;
{
	...
	if (Icp_write_trace_cutoff_level_qm && 
	    ...
	    emit_icp_write_trace(T,Nil,Nil,string_constant_10,Nil,
...
static Object string_constant_11;  /* "ICP message series too long -- please call Gensym customer support" */

static Object string_constant_12;  /* "wrote \"end-of-message-group\" message series" */

static Object string_constant_13;  /* "[finished writing message series]" */
...
Object end_icp_message_series_if_any()
{
    ...
    x_note_fn_call(46,55);
    if (Icp_buffers_for_message_group) {
	message_series_byte_count = 
		FIXNUM_MINUS(Number_of_icp_bytes_for_message_series,
		Number_of_icp_bytes_to_fill_buffer);
	if (IFIX(message_series_byte_count) > (SI_Long)63000L)
	    icp_error_internal(Qerror,string_constant_11,Nil,Nil,Nil);
	if (Icp_write_trace_cutoff_level_qm && 
		(EQ(Icp_write_trace_cutoff_level_qm,T) || 
		IFIX(Icp_write_trace_cutoff_level_qm) >= (SI_Long)1L))
	    emit_icp_write_trace(Nil,FIX((SI_Long)0L),
		    ...
		    string_constant_12 : string_constant_13,Nil,
		    Qmessage_series,Nil,Nil,T,Nil);
...
void int2_INIT()
{
    Object AB_package, Qint2, Qdo_icp_flow_control_qm;
    Object Qabort_for_icp_catcher_qm, Qicp_message_trace_stream_qm;
    Object Qat_end_of_icp_message_group_qm, Qcurrent_write_icp_byte_position;
    Object Qcurrent_read_icp_byte_position, Qnumber_of_icp_bytes_ready_to_read;
    Object Qcurrent_icp_buffer, Qnumber_of_icp_bytes_left_in_message_series;
    Object G2_DEFSTRUCT_STRUCTURE_NAME_package;
    Object Qrefused_icp_listener_connections, Qicp_socket_index;

    x_note_fn_call(46,56);
    SET_PACKAGE("AB");
    ...
    Icp_message_too_long_warning = string_constant_11;
    string_constant_12 = 
	    STATIC_STRING("wrote \"end-of-message-group\" message series");
    string_constant_13 = STATIC_STRING("[finished writing message series]");
}
