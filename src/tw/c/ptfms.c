...
Object Last_workstation_serviced = UNBOUND;

Object Last_session_id_for_g2 = UNBOUND;

Object Standard_gensym_color_alist = UNBOUND;
...
Object Color_hierarchy = UNBOUND;

Object Standard_gensym_color_subset = UNBOUND;

Object Native_window_notices_enter_and_leave_events_p = UNBOUND;
...
Object X11_preinitialized_p = UNBOUND;
...
Object print_display_error()
{
    ...
    format((SI_Long)2L,T,"TW ");
    return format((SI_Long)2L,T,"startup.~%");
}

Object Cached_local_gensym_x11_display = UNBOUND;
...
Object x11_preinitialize_if_necessary()
{
	...
	preinitialization_option = (SI_Long)0L;
...
/* C-X11-INITIALIZE */
Object c_x11_initialize(display_spec,window_name,icon_name,window_width,
	    window_height,x_offset,y_offset,backing_store_p,
	    private_colormap_p,frame_type)
    Object display_spec, window_name, icon_name, window_width, window_height;
    Object x_offset, y_offset, backing_store_p, private_colormap_p, frame_type;
{
    ...
    temp = LONG_TO_FIXNUM(g2ext_x11_initialize(temp_1,temp_2,ISTRING(temp),
	    IFIX(window_width),IFIX(window_height),IFIX(x_offset),
...
Object Do_not_error_in_x11_create_pixmap_on_failed_allocation = UNBOUND;

static Object string_constant_6;   /* "Unable to allocate a ~dx~d pixmap!" */
    ...
    Object gensym_window, width, height;
{
    ...
    return notify_user_at_console_and_on_logbook(3,string_constant_6,width,
	    height);
}
...
Object Chain_of_available_workstations = UNBOUND;

Object Workstation_count = UNBOUND;
    ...
    Object workstation;
{
    ...
    reclaim_workstation_context_stack_if_g2(ISVREF(workstation,(SI_Long)17L));
    ...
    reclaim_block_near_mouse_cache_function(ISVREF(workstation,(SI_Long)42L));
    SVREF(workstation,FIX((SI_Long)42L)) = Nil;
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_workstations;
    SVREF(workstation,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_workstations = workstation;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_workstation_variable, workstation_count_new_value;
    ...
    workstation_count_new_value = FIXNUM_ADD1(Workstation_count);
    Workstation_count = workstation_count_new_value;
...
{
    Object def_structure_workstation_variable, temp;
...
Object Delete_corresponding_object_qm = UNBOUND;
...
Object Chain_of_available_local_events = UNBOUND;

Object Local_event_count = UNBOUND;
    ...
    Object local_event;
{
    ...
    Structure_being_reclaimed = old_structure_being_reclaimed;
    svref_new_value = Chain_of_available_local_events;
    SVREF(local_event,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_local_events = local_event;
    return VALUES_1(Nil);
}
...
{
    Object def_structure_local_event_variable, local_event_count_new_value;
    ...
    local_event_count_new_value = FIXNUM_ADD1(Local_event_count);
    Local_event_count = local_event_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Fixnum_time_of_last_xsync = UNBOUND;
...
Object Current_workstation = UNBOUND;

Object Current_workstation_window = UNBOUND;
...
Object Current_workstation_native_window_qm = UNBOUND;
...
Object Specific_structure_for_current_workstation_context = UNBOUND;

Object Type_of_current_workstation_context = UNBOUND;

Object Current_workstation_context = UNBOUND;

Object Type_of_current_workstation_window = UNBOUND;
...
static Object string_constant_7;   /* "#000000" */

static Object string_constant_8;   /* "#ffffff" */
    ...
    Object x11_window;
{
	...
	temp = get_pixel_value(x11_window,string_constant_7,Nil);
	return make_monochrome_color_description_plist(temp,
		get_pixel_value(x11_window,string_constant_8,Nil));
    }
}
...
static Object Qcharting_library_version_qm;  /* charting-library-version? */
...
Object Node_id_for_uuid = UNBOUND;

Object Node_id_for_uuid_uses_ethernet_address_p = UNBOUND;
...
{
    Object string_1, temp, buffer, start, end;
    Object result;
	...
	MVS_3(result,buffer,start,end);
	if (buffer) {
	    temp = extract_ethernet_address_from_string(buffer,start,end,
		    uuid_machine_id);
...
static Object string_constant_9;   /* "lanscan -a" */

static Object Qskip_two_characters;  /* skip-two-characters */

static Object Qalphaosf;           /* alphaosf */

static Object string_constant_10;  /* "netstat -i -I ln0 | grep '<Link>'" */

static Object Qextract_ethernet;   /* extract-ethernet */

static Object Qsgi;                /* sgi */

static Object string_constant_11;  /* "netstat -ia" */

static Object Qsparcsol;           /* sparcsol */

static Object string_constant_12;  /* "ndd /dev/arp arp_cache_report | grep PUBLISH" */
...
Object get_ethernet_address_if_possible_for_unix()
{
	...
	result = VALUES_2(string_constant_9,Qskip_two_characters);
	...
	result = VALUES_2(string_constant_12,Qextract_ethernet);
	...
	command = tformat_gensym_string(3,string_constant_13,command,
...
Object extract_ethernet_address_from_string(buffer,start,end,result_1)
    Object buffer, start, end, result_1;
{
    Object all_zeros_p, result_index_1, current_bit_count, char_1, digit;
    Object ab_loop_iter_flag_, incff_1_arg;
    SI_Long result_index, index_1, ab_loop_bind_, temp;

    x_note_fn_call(34,92);
    result_index = (SI_Long)0L;
  next_loop:
    if (result_index >= (SI_Long)3L)
	goto end_loop;
    UBYTE_16_ISASET_1(result_1,result_index,(SI_Long)0L);
    result_index = result_index + (SI_Long)1L;
    goto next_loop;
  end_loop:;
    all_zeros_p = T;
    result_index_1 = FIX((SI_Long)0L);
  ...
  next_loop_1:
    if ( !(IFIX(result_index_1) < (SI_Long)3L))
	goto end_loop_1;
	...
	temp = UBYTE_16_ISAREF_1(result_1,IFIX(result_index_1)) + 
		IFIX(incff_1_arg);
	UBYTE_16_ISASET_1(result_1,IFIX(result_index_1),temp);
	temp = IFIX(current_bit_count) + (SI_Long)4L;
	current_bit_count = FIX(temp);
	if (IFIX(current_bit_count) == (SI_Long)16L) {
	    current_bit_count = FIX((SI_Long)0L);
	    result_index_1 = FIXNUM_ADD1(result_index_1);
	}
    ...
    goto next_loop_1;
  end_loop_1:
    if ((SI_Long)3L == IFIX(result_index_1) &&  !TRUEP(all_zeros_p))
	return VALUES_1(result_1);
    else
	return VALUES_1(Nil);
    return VALUES_1(Qnil);
...
Object Time_of_last_uuid = UNBOUND;

Object Always_use_current_time_for_uuid = UNBOUND;

Object Use_current_time_for_next_uuid = UNBOUND;

Object Clock_sequence_for_uuid = UNBOUND;
...
Object Uuid_time_b0 = UNBOUND;

Object Uuid_time_b1 = UNBOUND;

Object Uuid_time_b2 = UNBOUND;

Object Uuid_time_b3 = UNBOUND;
...
Object get_time_for_uuid()
{
	...
	temp_1 = TRUEP(Always_use_current_time_for_uuid);
    if (temp_1);
    else
	temp_1 = TRUEP(Use_current_time_for_next_uuid);
    if (temp_1);
	...
	temp_1 = FIXNUM_EQ(FIXNUM_LOGAND(Uuid_offset_mask,Uuid_time_b0),
		Uuid_offset_mask);
    if (temp_1) {
	arg = 0.0;
...
Object User_notified_of_uuid_uniqueness_problem_p = UNBOUND;

static Object string_constant_14;  /* "Unrecognized error code: " */

static Object string_constant_15;  /* "~a~a" */

static Object string_constant_16;  /* "" */

static Object string_constant_17;  /* "This computer's operating system cannot generate a universal unique ID (UUID).~
				    *               ~%~a"
				    */
    ...
    Object uuid_string;
{
	...
	if ( !TRUEP(User_notified_of_uuid_uniqueness_problem_p)) {
	    ...
	    message_string = tformat_text_string(3,string_constant_15,temp,
		    message_string_qm ? string_constant_16 : code);
	    notify_user_at_console_and_on_logbook(2,string_constant_17,
		    message_string);
...
static Object string_constant_18;  /* "000" */

static Object string_constant_19;  /* "00" */

static Object string_constant_20;  /* "0" */
	...
	PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
	  ...
	  PUSH_SPECIAL(Fill_pointer_for_current_wide_string,fill_pointer_for_current_wide_string,
		...
		twrite_general_string(IFIX(character_code) <= (SI_Long)15L 
			? string_constant_18 : IFIX(character_code) <= 
			(SI_Long)255L ? string_constant_19 : 
			IFIX(character_code) <= (SI_Long)4095L ? 
			string_constant_20 : string_constant_16);
...
{
    Object temp;
    SI_Long start, end, hash, index_1, ab_loop_bind_, char_code_1;
...
void platforms_INIT()
{
    ...
    Object AB_package, Qplatforms, Quser_notified_of_uuid_uniqueness_problem_p;
    Object Quuid_time_b3, Quuid_time_b2, Quuid_time_b1, Quuid_time_b0;
    Object Qclock_sequence_for_uuid, Quse_current_time_for_next_uuid;
    Object Qtime_of_last_uuid, Qalphavms, Qvax, string_constant_49;
    ...
    Object Qnamed_dynamic_extent_description, Qfor_workstation_polling;
    Object Qunwind_qm, Qfor_workstation_context, Qtelestubs;
    Object Qnative_window_polling_interval;
    ...
    Object Qutilities2, Qlocal_event_count, Qchain_of_available_local_events;
    Object string_constant_48, Qtype_description_of_type;
    Object Qtype_description_of_unique_type_name_of_gensym_structure;
    Object string_constant_47, Qunique_structure_type_of_ab_name_qm;
    ...
    Object Qworkstation_count, Qchain_of_available_workstations;
    Object string_constant_46, string_constant_45;
    Object Qmaximum_polygon_coordinates, list_constant_7, list_constant_6;
    Object list_constant_5, string_constant_44, string_constant_43;
    Object string_constant_38, string_constant_42, string_constant_41;
    Object string_constant_40, string_constant_39, string_constant_37;
    ...
    Object Qblue, Qgreen, Qyellow, Qorange, Qred, string_constant_33;
    ...
    Object Qlast_session_id_for_g2, Qlast_workstation_serviced;
    Object Qworkstations_in_service, Qservice_workstations;
    ...
    string_constant_21 = 
	    STATIC_STRING("13xy1o83*9y3-xy3=xy3=Gy1o83*Pykkk1o83*Qykk3=xy1o83*Vy3*Xy3cy3cy1o83*Xy3-Ry3*Qy3*Sy1o83*oy3=xy3-xy3-Cy1o83*syk3=xy3=xy1q8302y3*+y");
    string_constant_22 = 
	    STATIC_STRING("3*+y3*+y835qy8k1o8303y3-4y3vy3*7y1p8304y3-by3-by3-by835ry1o830Fy3Uy3*7y3Uy1o830Vy3=xy3=Jyk1o830Wy3=My3*Xy3Sy1p830Yy3*by3*by3*by8");
    string_constant_23 = 
	    STATIC_STRING("368y1o830ayk3=xyk1o830by3*fy3=xy3hy1o831-y3=9y3-Oy3-Oy1o8319y3=iy3=Yy3*8y1o831Py3*fy3=Ky3=Yy1p831Ty3=Fy3=Fy3=Fy836fy1o831Xy3ky3=");
    string_constant_24 = 
	    STATIC_STRING("9y3ky1o831dy3=xyk3=xy1o832Vy3*+ykk1o832Wy3-Yy3=9y3*cy1o832Xykk3=9y1o832Yy3=cy3=cy3*fy1o832Zy3*sy3-Hy3=Fy1o832ny3=xy3*Xyk1o832vy3");
    string_constant_25 = 
	    STATIC_STRING("*Ky3=ty3*Ky1o833-y3=xy3=+y3=7y1o8332y3=Py3*Sy3=Py1q8337y3*+yk3*+y08k1o833iy3=xykk1o833ly3=sy3*+y3-ky1o833ty3*Sy3-Ey3fy1o834-y3*3");
    string_constant_26 = 
	    STATIC_STRING("y3=Ay3=dy1o834*y3-cy3-My3=9y1o9k3=Ey3*my3*8y1o8345y3=Ky3*xy3=Ky1o834Cy3-+y3=Sy3=Cy1o834Ry3=gy3**y3=gy1o834Sy3=8y3ky3*Ly1o834Ty3=");
    string_constant_27 = 
	    STATIC_STRING("ny3=Qy3*ly1o834Uy3=xy3=xy3=xy1o834gy3=xy3=xyk1r8340y3=ny3=ny3=ny837fy08k1r830Ey3=xy3=sy3=iy008k1r831ay3=sy3=iy3=Yy008k1r83*8y3=s");
    string_constant_28 = 
	    STATIC_STRING("y3=dy3=Jy008k1r8312y3=xy3=xy3=iy008k1r83*Dy3=iy3=xy3=xy008k1r831Ny3=Yy3=Yy3=sy008k1r831Vy3*iy3=0y3=Qy008k1r8333y3*iy3=Sy3=Yy008k");
    string_constant_29 = 
	    STATIC_STRING("1r832wy3*hy3=gy3=gy008k1r831Qy3=Sy3=xy3=xy008k1r832uy3=gy3=ay3*cy008k1r831Sy3=sy3=sy3=Ey008k1r831Wy3=xy3=xy3=Sy008k1r831Ry3=gy3=");
    string_constant_30 = 
	    STATIC_STRING("Py3**y008k1r83*My3=ny3=ny3=Oy008k1r831Uy3=xy3*oy3=-y008k1r8308y3=Xy3=Xy3=Xy835uy08k");
  ...
  end_loop:
    ...
    string_constant_31 = 
	    STATIC_STRING("1n8378y1n83*Py1n833iy1n832ny1o830Vy8319y833ty9k83*oy1n83*Vy1o831dy8345y834Sy833-y1n832Vy833ly831-y1o83*Qy1o8337y1n831Py832Xy834-");
    string_constant_32 = 
	    STATIC_STRING("y1n83*Xy834*y8303y1n834Ry832Zy8332y830Yy1m8302y8304y13Fy834Uy1n834gy1p830Wy834Ty831Sy831Wy831Ry832Yy1n830ay1o832vy831Xy830by83*s");
    string_constant_33 = 
	    STATIC_STRING("y1o830Fy832Wy83*9y834Cy831Ty8308y8340y830Ey831ay83*8y8312y83*Dy831Ny831Vy8333y832wy831Qy832uy83*My831Uy");
    ...
    string_constant_36 = STATIC_STRING("x-res");
    string_constant_37 = STATIC_STRING("x-resolution");
    string_constant_2 = STATIC_STRING("res");
    string_constant_38 = STATIC_STRING("resolution");
    string_constant_39 = STATIC_STRING("x-mag");
    string_constant_40 = STATIC_STRING("x-magnification");
    string_constant_34 = STATIC_STRING("mag");
    string_constant_35 = STATIC_STRING("magnification");
    list_constant_5 = STATIC_LIST((SI_Long)2L,string_constant_34,
	    string_constant_35);
    list_constant_6 = STATIC_LIST_STAR((SI_Long)7L,string_constant_36,
	    string_constant_37,string_constant_2,string_constant_38,
	    string_constant_39,string_constant_40,list_constant_5);
    string_constant_41 = STATIC_STRING("y-res");
    string_constant_42 = STATIC_STRING("y-resolution");
    string_constant_43 = STATIC_STRING("y-mag");
    string_constant_44 = STATIC_STRING("y-magnification");
    list_constant_7 = STATIC_LIST_STAR((SI_Long)7L,string_constant_41,
	    string_constant_42,string_constant_2,string_constant_38,
	    string_constant_43,string_constant_44,list_constant_5);
    ...
    string_constant_6 = STATIC_STRING("Unable to allocate a ~dx~d pixmap!");
    ...
    string_constant_45 = 
	    STATIC_STRING("43Dy8l83Ty1n83Ty8m8k1l8m0000001n1m8q833hy1m83Ly8336y1n8n832Uy1l83dyk3qyk0k0");
    ...
    string_constant_46 = STATIC_STRING("1q83Ty8o837iy09k9l");
    clear_optimized_constants();
    ...
    string_constant_47 = 
	    STATIC_STRING("43Dy8l83-My1n83-My8m8k1l8m0000001m1m8q833Ry1m83Ly8334yksk0k0");
    ...
    string_constant_48 = STATIC_STRING("1q83-My8o836gy09k9l");
    clear_optimized_constants();
    ...
    string_constant_7 = STATIC_STRING("#000000");
    string_constant_8 = STATIC_STRING("#ffffff");
    ...
    Extract_ethernet_script = string_constant_49;
    ...
    string_constant_14 = STATIC_STRING("Unrecognized error code: ");
    ...
    string_constant_18 = STATIC_STRING("000");
    string_constant_19 = STATIC_STRING("00");
