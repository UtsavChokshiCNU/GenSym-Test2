...
Object Key_index_to_key_symbol_array = UNBOUND;

Object Key_index_to_lisp_character_array = UNBOUND;

Object Lisp_int_character_to_key_index_array = UNBOUND;

Object Lisp_character_to_key_index_alist = UNBOUND;

Object Bindable_keysyms = UNBOUND;

Object Pseudo_keysyms = UNBOUND;
...
/* DEFINE-KEY-SYMBOL-1 */
Object define_key_symbol_1(key_symbol,key_index,pretty_key_symbol,
	    character_object,character_index,bindable_p,pseudo_p)
    Object key_symbol, key_index, pretty_key_symbol, character_object;
    Object character_index, bindable_p, pseudo_p;
{
    ...
    mutate_global_property(key_symbol,key_index,Qkey_code_for_key_symbol);
    if (bindable_p)
	Bindable_keysyms = nconc2(Bindable_keysyms,LIST_1(key_symbol));
    if (pseudo_p)
	Pseudo_keysyms = nconc2(Pseudo_keysyms,LIST_1(key_symbol));
    if (character_object) {
