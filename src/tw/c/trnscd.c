...
Object Chain_of_available_transcode_text_conversion_styles = UNBOUND;

Object Transcode_text_conversion_style_count = UNBOUND;
    ...
    Object transcode_text_conversion_style;
{
    ...
    svref_new_value = Chain_of_available_transcode_text_conversion_styles;
...
Object make_permanent_transcode_text_conversion_style_structure_internal()
{
    ...
    transcode_text_conversion_style_count_new_value = 
	    FIXNUM_ADD1(Transcode_text_conversion_style_count);
...
Object Default_text_conversion_style = UNBOUND;

Object Utf_g_ascii_as_much_as_possible_conversion_style = UNBOUND;
...
Object Chain_of_available_text_sequences = UNBOUND;

Object Text_sequence_count = UNBOUND;
    ...
    Object text_sequence;
{
    ...
    svref_new_value = Chain_of_available_text_sequences;
    SVREF(text_sequence,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_text_sequences = text_sequence;
    return VALUES_1(Nil);
}
...
Object make_permanent_text_sequence_structure_internal()
{
    ...
    text_sequence_count_new_value = FIXNUM_ADD1(Text_sequence_count);
    Text_sequence_count = text_sequence_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_gensym_string_text_sequences = UNBOUND;

Object Gensym_string_text_sequence_count = UNBOUND;
    ...
    Object gensym_string_text_sequence;
{
    ...
    svref_new_value = Chain_of_available_gensym_string_text_sequences;
...
Object make_permanent_gensym_string_text_sequence_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Gensym_string_text_sequence_count);
    Gensym_string_text_sequence_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_gensym_string_text_sequences;
	SVREF(def_structure_gensym_string_text_sequence_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_gensym_string_text_sequences = 
		def_structure_gensym_string_text_sequence_variable;
...
Object Chain_of_available_wide_string_text_sequences = UNBOUND;

Object Wide_string_text_sequence_count = UNBOUND;
    ...
    Object wide_string_text_sequence;
{
    ...
    svref_new_value = Chain_of_available_wide_string_text_sequences;
    SVREF(wide_string_text_sequence,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_wide_string_text_sequences = wide_string_text_sequence;
    return VALUES_1(Nil);
}
...
Object make_permanent_wide_string_text_sequence_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Wide_string_text_sequence_count);
    Wide_string_text_sequence_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_wide_string_text_sequences;
	SVREF(def_structure_wide_string_text_sequence_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_wide_string_text_sequences = 
		def_structure_wide_string_text_sequence_variable;
...
Object Chain_of_available_transcoders = UNBOUND;

Object Transcoder_count = UNBOUND;
    ...
    Object transcoder;
{
    ...
    svref_new_value = Chain_of_available_transcoders;
    SVREF(transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_transcoders = transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_transcoder_structure_internal()
{
    ...
    transcoder_count_new_value = FIXNUM_ADD1(Transcoder_count);
    Transcoder_count = transcoder_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_graphic_character_sets = UNBOUND;

Object Graphic_character_set_count = UNBOUND;
    ...
    Object graphic_character_set;
{
    ...
    svref_new_value = Chain_of_available_graphic_character_sets;
    SVREF(graphic_character_set,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_graphic_character_sets = graphic_character_set;
    return VALUES_1(Nil);
}
...
Object make_permanent_graphic_character_set_structure_internal()
{
    ...
    graphic_character_set_count_new_value = 
	    FIXNUM_ADD1(Graphic_character_set_count);
    Graphic_character_set_count = graphic_character_set_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_646s = UNBOUND;

Object Iso_646_count = UNBOUND;
    ...
    Object iso_646;
{
    ...
    svref_new_value = Chain_of_available_iso_646s;
    SVREF(iso_646,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_646s = iso_646;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_646_structure_internal()
{
    ...
    iso_646_count_new_value = FIXNUM_ADD1(Iso_646_count);
    Iso_646_count = iso_646_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_abstracts = UNBOUND;

Object Iso_8859_abstract_count = UNBOUND;
    ...
    Object iso_8859_abstract;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_abstracts;
    SVREF(iso_8859_abstract,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_abstracts = iso_8859_abstract;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_abstract_structure_internal()
{
    ...
    iso_8859_abstract_count_new_value = FIXNUM_ADD1(Iso_8859_abstract_count);
    Iso_8859_abstract_count = iso_8859_abstract_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Available_8859_reverse_unicode_map_hash_vector_43_vectors = UNBOUND;

Object Count_of_8859_reverse_unicode_map_hash_vector_43_vectors = UNBOUND;
...
Object make_permanent_8859_reverse_unicode_map_hash_vector_43_vector_internal()
{
    ...
    count_of_8859_reverse_unicode_map_hash_vector_43_vectors_new_value = 
	    FIXNUM_ADD1(Count_of_8859_reverse_unicode_map_hash_vector_43_vectors);
...
Object make_8859_reverse_unicode_map_hash_vector()
{
    ...
    if (Available_8859_reverse_unicode_map_hash_vector_43_vectors) {
	temp = 
		M_CAR(Available_8859_reverse_unicode_map_hash_vector_43_vectors);
	temp_1 = 
		M_CDR(Available_8859_reverse_unicode_map_hash_vector_43_vectors);
	inline_note_reclaim_cons(Available_8859_reverse_unicode_map_hash_vector_43_vectors,
		Qab_gensym);
	cdr_arg = Available_8859_reverse_unicode_map_hash_vector_43_vectors;
	...
	Available_8859_reverse_unicode_map_hash_vector_43_vectors = temp_1;
    }
    else
	temp = 
    ...
    Object n_8859_reverse_unicode_map_hash_vector_43_vector;
{
    ...
    cdr_new_value = Available_8859_reverse_unicode_map_hash_vector_43_vectors;
...
Object Chain_of_available_iso_8859_1s = UNBOUND;

Object Iso_8859_1_count = UNBOUND;
    ...
    Object iso_8859_1;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_1s;
    SVREF(iso_8859_1,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_1s = iso_8859_1;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_1_structure_internal()
{
    ...
    iso_8859_1_count_new_value = FIXNUM_ADD1(Iso_8859_1_count);
    Iso_8859_1_count = iso_8859_1_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_2s = UNBOUND;

Object Iso_8859_2_count = UNBOUND;
    ...
    Object iso_8859_2;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_2s;
    SVREF(iso_8859_2,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_2s = iso_8859_2;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_2_structure_internal()
{
    ...
    iso_8859_2_count_new_value = FIXNUM_ADD1(Iso_8859_2_count);
    Iso_8859_2_count = iso_8859_2_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_3s = UNBOUND;

Object Iso_8859_3_count = UNBOUND;
    ...
    Object iso_8859_3;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_3s;
    SVREF(iso_8859_3,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_3s = iso_8859_3;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_3_structure_internal()
{
    ...
    iso_8859_3_count_new_value = FIXNUM_ADD1(Iso_8859_3_count);
    Iso_8859_3_count = iso_8859_3_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_4s = UNBOUND;

Object Iso_8859_4_count = UNBOUND;
    ...
    Object iso_8859_4;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_4s;
    SVREF(iso_8859_4,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_4s = iso_8859_4;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_4_structure_internal()
{
    ...
    iso_8859_4_count_new_value = FIXNUM_ADD1(Iso_8859_4_count);
    Iso_8859_4_count = iso_8859_4_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_5s = UNBOUND;

Object Iso_8859_5_count = UNBOUND;
    ...
    Object iso_8859_5;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_5s;
    SVREF(iso_8859_5,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_5s = iso_8859_5;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_5_structure_internal()
{
    ...
    iso_8859_5_count_new_value = FIXNUM_ADD1(Iso_8859_5_count);
    Iso_8859_5_count = iso_8859_5_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_6s = UNBOUND;

Object Iso_8859_6_count = UNBOUND;
    ...
    Object iso_8859_6;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_6s;
    SVREF(iso_8859_6,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_6s = iso_8859_6;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_6_structure_internal()
{
    ...
    iso_8859_6_count_new_value = FIXNUM_ADD1(Iso_8859_6_count);
    Iso_8859_6_count = iso_8859_6_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_7s = UNBOUND;

Object Iso_8859_7_count = UNBOUND;
    ...
    Object iso_8859_7;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_7s;
    SVREF(iso_8859_7,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_7s = iso_8859_7;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_7_structure_internal()
{
    ...
    iso_8859_7_count_new_value = FIXNUM_ADD1(Iso_8859_7_count);
    Iso_8859_7_count = iso_8859_7_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_8s = UNBOUND;

Object Iso_8859_8_count = UNBOUND;
    ...
    Object iso_8859_8;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_8s;
    SVREF(iso_8859_8,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_8s = iso_8859_8;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_8_structure_internal()
{
    ...
    iso_8859_8_count_new_value = FIXNUM_ADD1(Iso_8859_8_count);
    Iso_8859_8_count = iso_8859_8_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_9s = UNBOUND;

Object Iso_8859_9_count = UNBOUND;
    ...
    Object iso_8859_9;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_9s;
    SVREF(iso_8859_9,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_9s = iso_8859_9;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_9_structure_internal()
{
    ...
    iso_8859_9_count_new_value = FIXNUM_ADD1(Iso_8859_9_count);
    Iso_8859_9_count = iso_8859_9_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_10s = UNBOUND;

Object Iso_8859_10_count = UNBOUND;
    ...
    Object iso_8859_10;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_10s;
    SVREF(iso_8859_10,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_10s = iso_8859_10;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_10_structure_internal()
{
    ...
    iso_8859_10_count_new_value = FIXNUM_ADD1(Iso_8859_10_count);
    Iso_8859_10_count = iso_8859_10_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_asian_double_bytes = UNBOUND;

Object Asian_double_byte_count = UNBOUND;
    ...
    Object asian_double_byte;
{
    ...
    svref_new_value = Chain_of_available_asian_double_bytes;
    SVREF(asian_double_byte,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_asian_double_bytes = asian_double_byte;
    return VALUES_1(Nil);
}
...
Object make_permanent_asian_double_byte_structure_internal()
{
    ...
    asian_double_byte_count_new_value = FIXNUM_ADD1(Asian_double_byte_count);
    Asian_double_byte_count = asian_double_byte_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_jis_x_0208s = UNBOUND;

Object Jis_x_0208_count = UNBOUND;
    ...
    Object jis_x_0208;
{
    ...
    svref_new_value = Chain_of_available_jis_x_0208s;
    SVREF(jis_x_0208,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_jis_x_0208s = jis_x_0208;
    return VALUES_1(Nil);
}
...
Object make_permanent_jis_x_0208_structure_internal()
{
    ...
    jis_x_0208_count_new_value = FIXNUM_ADD1(Jis_x_0208_count);
    Jis_x_0208_count = jis_x_0208_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_ks_c_5601s = UNBOUND;

Object Ks_c_5601_count = UNBOUND;
    ...
    Object ks_c_5601;
{
    ...
    svref_new_value = Chain_of_available_ks_c_5601s;
    SVREF(ks_c_5601,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_ks_c_5601s = ks_c_5601;
    return VALUES_1(Nil);
}
...
Object make_permanent_ks_c_5601_structure_internal()
{
    ...
    ks_c_5601_count_new_value = FIXNUM_ADD1(Ks_c_5601_count);
    Ks_c_5601_count = ks_c_5601_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_gb_2312s = UNBOUND;

Object Gb_2312_count = UNBOUND;
    ...
    Object gb_2312;
{
    ...
    svref_new_value = Chain_of_available_gb_2312s;
    SVREF(gb_2312,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gb_2312s = gb_2312;
    return VALUES_1(Nil);
}
...
Object make_permanent_gb_2312_structure_internal()
{
    ...
    gb_2312_count_new_value = FIXNUM_ADD1(Gb_2312_count);
    Gb_2312_count = gb_2312_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Chain_of_available_iso_8859_transcoders = UNBOUND;

Object Iso_8859_transcoder_count = UNBOUND;
    ...
    Object iso_8859_transcoder;
{
    ...
    svref_new_value = Chain_of_available_iso_8859_transcoders;
    SVREF(iso_8859_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_8859_transcoders = iso_8859_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_8859_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Iso_8859_transcoder_count);
    Iso_8859_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_iso_8859_transcoders;
...
Object Chain_of_available_iso_2022_transcoders = UNBOUND;

Object Iso_2022_transcoder_count = UNBOUND;
    ...
    Object iso_2022_transcoder;
{
    ...
    svref_new_value = Chain_of_available_iso_2022_transcoders;
    SVREF(iso_2022_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_iso_2022_transcoders = iso_2022_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_iso_2022_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Iso_2022_transcoder_count);
    Iso_2022_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_iso_2022_transcoders;
...
Object Text_conversion_style_for_transcoder_being_created = UNBOUND;
...
Object Chain_of_available_shift_jis_transcoders = UNBOUND;

Object Shift_jis_transcoder_count = UNBOUND;
    ...
    Object shift_jis_transcoder;
{
    ...
    svref_new_value = Chain_of_available_shift_jis_transcoders;
    SVREF(shift_jis_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_shift_jis_transcoders = shift_jis_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_shift_jis_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Shift_jis_transcoder_count);
    Shift_jis_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_shift_jis_transcoders;
	SVREF(def_structure_shift_jis_transcoder_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_shift_jis_transcoders = 
		def_structure_shift_jis_transcoder_variable;
...
Object Chain_of_available_utf_g_transcoders = UNBOUND;

Object Utf_g_transcoder_count = UNBOUND;
    ...
    Object utf_g_transcoder;
{
    ...
    svref_new_value = Chain_of_available_utf_g_transcoders;
    SVREF(utf_g_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_utf_g_transcoders = utf_g_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_utf_g_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Utf_g_transcoder_count);
    Utf_g_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_utf_g_transcoders;
    ...
    Object utf_g_transcoder;
{
	...
	if (IFIX(ISVREF(transcoder,(SI_Long)7L)) == (SI_Long)65535L)
		...
		PUSH_SPECIAL(Current_extended_utf_g_low_half_character_qm,current_extended_utf_g_low_half_character_qm,
			0);
		...
		row = IFIX(gensym_character_code) >>  -  - (SI_Long)8L;
		unicode_full_row = 
			UBYTE_8_ISAREF_1(Gensym_to_unicode_full_row_map,row);
...
Object Chain_of_available_utf_g_ascii_as_much_as_possible_transcoders = UNBOUND;

Object Utf_g_ascii_as_much_as_possible_transcoder_count = UNBOUND;
...
Object make_permanent_utf_g_ascii_as_much_as_possible_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Utf_g_ascii_as_much_as_possible_transcoder_count);
    Utf_g_ascii_as_much_as_possible_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_utf_g_ascii_as_much_as_possible_transcoders;
	SVREF(def_structure_utf_g_ascii_as_much_as_possible_transcoder_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_utf_g_ascii_as_much_as_possible_transcoders = 
		def_structure_utf_g_ascii_as_much_as_possible_transcoder_variable;
...
Object Chain_of_available_unicode_ucs_2_transcoders = UNBOUND;

Object Unicode_ucs_2_transcoder_count = UNBOUND;
    ...
    Object unicode_ucs_2_transcoder;
{
    ...
    svref_new_value = Chain_of_available_unicode_ucs_2_transcoders;
    SVREF(unicode_ucs_2_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_unicode_ucs_2_transcoders = unicode_ucs_2_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_unicode_ucs_2_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Unicode_ucs_2_transcoder_count);
    Unicode_ucs_2_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_unicode_ucs_2_transcoders;
	SVREF(def_structure_unicode_ucs_2_transcoder_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_unicode_ucs_2_transcoders = 
		def_structure_unicode_ucs_2_transcoder_variable;
...
Object Chain_of_available_unicode_transcoders = UNBOUND;

Object Unicode_transcoder_count = UNBOUND;
    ...
    Object unicode_transcoder;
{
    ...
    svref_new_value = Chain_of_available_unicode_transcoders;
    SVREF(unicode_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_unicode_transcoders = unicode_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_unicode_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Unicode_transcoder_count);
    Unicode_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_unicode_transcoders;
...
Object Chain_of_available_unicode_byte_swapped_transcoders = UNBOUND;

Object Unicode_byte_swapped_transcoder_count = UNBOUND;
    ...
    Object unicode_byte_swapped_transcoder;
{
    ...
    svref_new_value = Chain_of_available_unicode_byte_swapped_transcoders;
...
Object make_permanent_unicode_byte_swapped_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Unicode_byte_swapped_transcoder_count);
    Unicode_byte_swapped_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_unicode_byte_swapped_transcoders;
	SVREF(def_structure_unicode_byte_swapped_transcoder_variable,
		FIX((SI_Long)0L)) = temp;
	Chain_of_available_unicode_byte_swapped_transcoders = 
		def_structure_unicode_byte_swapped_transcoder_variable;
    ...
    Object text_conversion_style, text_sequence;
{
    ...
    PUSH_SPECIAL(Text_conversion_style_for_transcoder_being_created,text_conversion_style_for_transcoder_being_created,
	    0);
...
Object Chain_of_available_utf_7_transcoders = UNBOUND;

Object Utf_7_transcoder_count = UNBOUND;
    ...
    Object utf_7_transcoder;
{
    ...
    svref_new_value = Chain_of_available_utf_7_transcoders;
    SVREF(utf_7_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_utf_7_transcoders = utf_7_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_utf_7_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Utf_7_transcoder_count);
    Utf_7_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_utf_7_transcoders;
...
Object Ucs_4_to_utf_8_1st_octet_table = UNBOUND;
...
Object Chain_of_available_utf_8_transcoders = UNBOUND;

Object Utf_8_transcoder_count = UNBOUND;
    ...
    Object utf_8_transcoder;
{
    ...
    svref_new_value = Chain_of_available_utf_8_transcoders;
    SVREF(utf_8_transcoder,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_utf_8_transcoders = utf_8_transcoder;
    return VALUES_1(Nil);
}
...
Object make_permanent_utf_8_transcoder_structure_internal()
{
    ...
    temp = FIXNUM_ADD1(Utf_8_transcoder_count);
    Utf_8_transcoder_count = temp;
    if (PUSH_AREA(Dynamic_area,0)) {
	gensymed_symbol = (SI_Long)1L;
      next_loop:
	...
	if (gensymed_symbol >= (SI_Long)1L)
	    goto end_loop_1;
	temp = Chain_of_available_utf_8_transcoders;
    ...
    Object text_string;
{
  ...
  next_loop:
	...
	gensym_full_row = UBYTE_8_ISAREF_1(Unicode_to_gensym_full_row_map,row);
...
Object Intern_string_buffer = UNBOUND;
    ...
    Object wide_string, start_init, end_init, package_qm;
{
    ...
    s = obtain_simple_gensym_string(FIX(end - start));
    i = start;
    ab_loop_bind_ = end;
    j = (SI_Long)0L;
...
Object Standard_8_bit_non_graphic_characters_skip_spec = UNBOUND;
...
void transcode_INIT()
{
    ...
    Object Qutf_8_transcoder_count, Qchain_of_available_utf_8_transcoders;
    Object string_constant_70, Qtype_description_of_type, string_constant_69;
    ...
    Object Qutf_7_transcoder_structure_memory_usage, Qutf_7_transcoder_count;
    Object Qchain_of_available_utf_7_transcoders, string_constant_68;
    ...
    Object Qunicode_byte_swapped_transcoder_count;
    Object Qchain_of_available_unicode_byte_swapped_transcoders;
    Object string_constant_65, string_constant_64, Qunicode_transcoder;
    Object Qoutstanding_unicode_transcoder_count;
    Object Qunicode_transcoder_structure_memory_usage;
    Object Qunicode_transcoder_count, Qchain_of_available_unicode_transcoders;
    Object string_constant_63, string_constant_62, Qunicode_ucs_2_transcoder;
    Object Qoutstanding_unicode_ucs_2_transcoder_count;
    Object Qunicode_ucs_2_transcoder_structure_memory_usage;
    Object Qunicode_ucs_2_transcoder_count;
    Object Qchain_of_available_unicode_ucs_2_transcoders, string_constant_61;
    Object string_constant_60, Qutf_g_ascii_as_much_as_possible_transcoder;
    ...
    Object Qutf_g_ascii_as_much_as_possible_transcoder_count;
    Object Qchain_of_available_utf_g_ascii_as_much_as_possible_transcoders;
    Object string_constant_59, string_constant_58, Qutf_g_transcoder;
    Object Qoutstanding_utf_g_transcoder_count;
    Object Qutf_g_transcoder_structure_memory_usage, Qutf_g_transcoder_count;
    Object Qchain_of_available_utf_g_transcoders, string_constant_57;
    Object string_constant_56, Qshift_jis_transcoder;
    Object Qoutstanding_shift_jis_transcoder_count;
    Object Qshift_jis_transcoder_structure_memory_usage;
    Object Qshift_jis_transcoder_count;
    Object Qchain_of_available_shift_jis_transcoders, string_constant_55;
    Object string_constant_54, Qiso_2022_transcoder, list_constant_29;
    ...
    Object Qiso_2022_transcoder_structure_memory_usage;
    Object Qiso_2022_transcoder_count;
    Object Qchain_of_available_iso_2022_transcoders, string_constant_53;
    Object string_constant_52, Qiso_8859_transcoder;
    Object Qoutstanding_iso_8859_transcoder_count;
    Object Qiso_8859_transcoder_structure_memory_usage;
    Object Qiso_8859_transcoder_count;
    Object Qchain_of_available_iso_8859_transcoders, string_constant_51;
    Object string_constant_50, Qmap_unicode_to_code_if_any;
    Object Qmap_code_to_unicode, Qgb2312, Qgb, Qoutstanding_gb_2312_count;
    Object Qgb_2312_structure_memory_usage, Qgb_2312_count;
    Object Qchain_of_available_gb_2312s, string_constant_49;
    Object string_constant_48, string_constant_47, Qksc, Qks;
    Object Qoutstanding_ks_c_5601_count, Qks_c_5601_structure_memory_usage;
    Object Qks_c_5601_count, Qchain_of_available_ks_c_5601s;
    Object string_constant_46, string_constant_45, string_constant_44, Qjis;
    Object Qoutstanding_jis_x_0208_count, Qjis_x_0208_structure_memory_usage;
    Object Qjis_x_0208_count, Qchain_of_available_jis_x_0208s;
    Object string_constant_43, string_constant_42, string_constant_41;
    Object Qoutstanding_asian_double_byte_count;
    Object Qasian_double_byte_structure_memory_usage, Qasian_double_byte_count;
    Object Qchain_of_available_asian_double_bytes, string_constant_40;
    Object string_constant_39, Qlatin_6, Qoutstanding_iso_8859_10_count;
    Object Qiso_8859_10_structure_memory_usage, Qiso_8859_10_count;
    Object Qchain_of_available_iso_8859_10s, string_constant_38;
    Object string_constant_19, string_constant_37, Qlatin_5;
    Object Qoutstanding_iso_8859_9_count, Qiso_8859_9_structure_memory_usage;
    Object Qiso_8859_9_count, Qchain_of_available_iso_8859_9s;
    Object string_constant_36, string_constant_35, Qlatin_hebrew;
    Object Qoutstanding_iso_8859_8_count, Qiso_8859_8_structure_memory_usage;
    Object Qiso_8859_8_count, Qchain_of_available_iso_8859_8s;
    Object string_constant_34, string_constant_33, Qlatin_greek;
    Object Qoutstanding_iso_8859_7_count, Qiso_8859_7_structure_memory_usage;
    Object Qiso_8859_7_count, Qchain_of_available_iso_8859_7s;
    Object string_constant_32, string_constant_31, Qlatin_arabic;
    Object Qoutstanding_iso_8859_6_count, Qiso_8859_6_structure_memory_usage;
    Object Qiso_8859_6_count, Qchain_of_available_iso_8859_6s;
    Object string_constant_30, string_constant_29, Qlatin_cyrillic;
    Object Qoutstanding_iso_8859_5_count, Qiso_8859_5_structure_memory_usage;
    Object Qiso_8859_5_count, Qchain_of_available_iso_8859_5s;
    Object string_constant_28, string_constant_27, Qlatin_4;
    Object Qoutstanding_iso_8859_4_count, Qiso_8859_4_structure_memory_usage;
    Object Qiso_8859_4_count, Qchain_of_available_iso_8859_4s;
    Object string_constant_26, string_constant_25, Qlatin_3;
    Object Qoutstanding_iso_8859_3_count, Qiso_8859_3_structure_memory_usage;
    Object Qiso_8859_3_count, Qchain_of_available_iso_8859_3s;
    Object string_constant_24, string_constant_23, Qlatin_2;
    Object Qoutstanding_iso_8859_2_count, Qiso_8859_2_structure_memory_usage;
    Object Qiso_8859_2_count, Qchain_of_available_iso_8859_2s;
    ...
    Object Qiso_8859_1_count, Qchain_of_available_iso_8859_1s;
    Object string_constant_20, string_constant_18;
    ...
    Object string_constant_17;
    Object Qcount_of_8859_reverse_unicode_map_hash_vector_43_vectors;
    Object Qavailable_8859_reverse_unicode_map_hash_vector_43_vectors;
    Object Qoutstanding_iso_8859_abstract_count;
    Object Qiso_8859_abstract_structure_memory_usage, Qiso_8859_abstract_count;
    Object Qchain_of_available_iso_8859_abstracts, string_constant_16;
    Object string_constant_15, Qoutstanding_iso_646_count;
    Object Qiso_646_structure_memory_usage, Qiso_646_count;
    Object Qchain_of_available_iso_646s, string_constant_14;
    Object string_constant_13, string_constant_12;
    Object Qoutstanding_graphic_character_set_count;
    Object Qgraphic_character_set_structure_memory_usage;
    Object Qgraphic_character_set_count;
    Object Qchain_of_available_graphic_character_sets, string_constant_11;
    ...
    Object Qtranscoder_structure_memory_usage, Qtranscoder_count;
    Object Qchain_of_available_transcoders, string_constant_9;
    ...
    Object Qwide_string_text_sequence_count;
    Object Qchain_of_available_wide_string_text_sequences, string_constant_7;
    Object string_constant_6, Qoutstanding_gensym_string_text_sequence_count;
    Object Qgensym_string_text_sequence_structure_memory_usage;
    Object Qgensym_string_text_sequence_count;
    Object Qchain_of_available_gensym_string_text_sequences, string_constant_5;
    Object string_constant_4, Qoutstanding_text_sequence_count;
    Object Qtext_sequence_structure_memory_usage, Qtext_sequence_count;
    Object Qchain_of_available_text_sequences, string_constant_3;
    ...
    Object Qtranscode_text_conversion_style_count;
    Object Qchain_of_available_transcode_text_conversion_styles;
    ...
    string_constant = STATIC_STRING("43Dy8l83cy1n83cy8m8k1l8m0000000krk0k0");
    ...
    Qtranscode_text_conversion_style_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_1 = STATIC_STRING("1q83cy8o834By09k9l");
    ...
    string_constant_2 = 
	    STATIC_STRING("43Dy8l83Ny1n83Ny8m8k1l8m0000001m1n8n832Py01m8q833eyksk0k0");
    ...
    string_constant_3 = STATIC_STRING("1q83Ny8o837Py09k9l");
    clear_optimized_constants();
    ...
    string_constant_4 = 
	    STATIC_STRING("43Dy8l83ry1o83ry83Ny8m8k1l83Ny0000001l1n8p83Ny1m83by1m9k830Ryksk0k0");
    ...
    Qgensym_string_text_sequence_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_5 = STATIC_STRING("1q83ry8o8364y09k9l");
    clear_optimized_constants();
    ...
    string_constant_6 = 
	    STATIC_STRING("43Dy8l83-xy1o83-xy83Ny8m8k1l83Ny0000001l1n8p83Ny1m83by1m9k834Vyksk0k0");
    ...
    Qwide_string_text_sequence_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_7 = STATIC_STRING("1q83-xy8o837gy09k9l");
    clear_optimized_constants();
    ...
    string_constant_8 = STATIC_STRING("43Dy8l8y1n8y8m8k1l8m0000000kqk0k0");
    ...
    string_constant_9 = STATIC_STRING("1q8y8o837Ty09k9l");
    clear_optimized_constants();
    ...
    string_constant_10 = STATIC_STRING("43Dy8l8r1n8r8m8k1l8m0000000krk0k0");
    ...
    Qgraphic_character_set_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_11 = STATIC_STRING("1q8r8o8367y09k9l");
    clear_optimized_constants();
    ...
    string_constant_12 = 
	    STATIC_STRING("43Dy8l83-7y1o83-7y8r8m8k1l8r0000001l1r8p8r1m8u1m9k83-7y1m8w1m9k1o831=y83*Cy834Fy83*7y1m8t1m9kl1m8s1m9k3-Qy1m8v1m9k+s3-*ykkkkkl3A");
    string_constant_13 = STATIC_STRING("++ykrk0k0");
    ...
    string_constant_14 = STATIC_STRING("1q83-7y8o836Oy09k9l");
    clear_optimized_constants();
  ...
  end_loop:;
    ...
    string_constant_15 = 
	    STATIC_STRING("43Dy8l8x1o8x8r8m8k1l8r0000001l1r8p8r1m8u1m9k8x1m8w1m9k01m8t1m9kl1m8s1m9k3-Sy1m8v1m9k0kuk0k0");
    ...
    Qiso_8859_abstract_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_16 = STATIC_STRING("1q8x8o836Zy09k9l");
    clear_optimized_constants();
  ...
  end_loop_1:;
    ...
    Q8859_reverse_unicode_map_hash_vector_43_vector_memory_usage = 
	    ...
	    AB_package);
    string_constant_17 = STATIC_STRING("1q835Ry83Ky835ey09k9l");
    clear_optimized_constants();
    ...
    string_constant_18 = 
	    STATIC_STRING("43Dy8l83-8y1p83-8y8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-8y1m8w1m9k1l831Dy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3--ykkkkkl3A++y1m8zlkuk0k");
    ...
    string_constant_20 = STATIC_STRING("1q83-8y8o836Py09k9l");
    clear_optimized_constants();
  ...
  end_loop_2:;
    ...
    string_constant_21 = 
	    STATIC_STRING("43Dy8l83-Ay1p83-Ay8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Ay1m8w1m9k1l831Ey1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-*ykkkkkl3A++y1m8zmkuk0k");
    ...
    string_constant_22 = STATIC_STRING("1q83-Ay8o836Ry09k9l");
    clear_optimized_constants();
  ...
  end_loop_3:;
    ...
    string_constant_23 = 
	    STATIC_STRING("43Dy8l83-By1p83-By8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-By1m8w1m9k1l831Fy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-=ykkkkkl3A++y1m8znkuk0k");
    ...
    string_constant_24 = STATIC_STRING("1q83-By8o836Sy09k9l");
    clear_optimized_constants();
  ...
  end_loop_4:;
    ...
    string_constant_25 = 
	    STATIC_STRING("43Dy8l83-Cy1p83-Cy8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Cy1m8w1m9k1l831Gy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-0ykkkkkl3A++y1m8zokuk0k");
    ...
    string_constant_26 = STATIC_STRING("1q83-Cy8o836Ty09k9l");
    clear_optimized_constants();
  ...
  end_loop_5:;
    ...
    string_constant_27 = 
	    STATIC_STRING("43Dy8l83-Dy1p83-Dy8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Dy1m8w1m9k1l831Ky1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-8ykkkkkl3A++y1m8zpkuk0k");
    ...
    string_constant_28 = STATIC_STRING("1q83-Dy8o836Uy09k9l");
    clear_optimized_constants();
  ...
  end_loop_6:;
    ...
    string_constant_29 = 
	    STATIC_STRING("43Dy8l83-Ey1p83-Ey8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Ey1m8w1m9k1l831Jy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-3ykkkkkl3A++y1m8zqkuk0k");
    ...
    string_constant_30 = STATIC_STRING("1q83-Ey8o836Vy09k9l");
    clear_optimized_constants();
  ...
  end_loop_7:;
    ...
    string_constant_31 = 
	    STATIC_STRING("43Dy8l83-Fy1p83-Fy8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Fy1m8w1m9k1l831Ly1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-2ykkkkkl3A++y1m8zrkuk0k");
    temp = The_type_description_of_iso_8859_7;
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    The_type_description_of_iso_8859_7 = 
	    load_and_initialize_type_description(temp,
	    regenerate_optimized_constant(LIST_2(string_constant_31,
	    string_constant_19)));
    mutate_global_property(Qg2_defstruct_structure_name_iso_8859_7_g2_struct,
	    The_type_description_of_iso_8859_7,
	    Qtype_description_of_unique_type_name_of_gensym_structure);
    ...
    string_constant_32 = STATIC_STRING("1q83-Fy8o836Wy09k9l");
    clear_optimized_constants();
  ...
  end_loop_8:;
    ...
    string_constant_33 = 
	    STATIC_STRING("43Dy8l83-Gy1p83-Gy8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Gy1m8w1m9k1l831My1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-4ykkkkkl3A++y1m8zskuk0k");
    ...
    string_constant_34 = STATIC_STRING("1q83-Gy8o836Xy09k9l");
    clear_optimized_constants();
  ...
  end_loop_9:;
    ...
    string_constant_35 = 
	    STATIC_STRING("43Dy8l83-Hy1p83-Hy8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-Hy1m8w1m9k1l831Hy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-9ykkkkkl3A++y1m8ztkuk0k");
    temp = The_type_description_of_iso_8859_9;
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    The_type_description_of_iso_8859_9 = 
	    load_and_initialize_type_description(temp,
	    regenerate_optimized_constant(LIST_2(string_constant_35,
	    string_constant_19)));
    mutate_global_property(Qg2_defstruct_structure_name_iso_8859_9_g2_struct,
	    The_type_description_of_iso_8859_9,
	    Qtype_description_of_unique_type_name_of_gensym_structure);
    ...
    string_constant_36 = STATIC_STRING("1q83-Hy8o836Yy09k9l");
    clear_optimized_constants();
  ...
  end_loop_10:;
    ...
    string_constant_37 = 
	    STATIC_STRING("43Dy8l83-9y1p83-9y8x8r8m8k1l8x0000001l1s8p8x1m8u1m9k83-9y1m8w1m9k1l831Iy1m8t1m9kl1m8s1m9k3-Sy1m8v1m9k+s3-0ykkkkkl3A++y1m8zukuk0k");
    ...
    string_constant_38 = STATIC_STRING("1q83-9y8o836Qy09k9l");
    clear_optimized_constants();
  ...
  end_loop_11:;
    ...
    string_constant_39 = 
	    STATIC_STRING("43Dy8l83Iy1o83Iy8r8m8k1l8r0000001l1r8p8r1m8u1m9k83Iy1m8w1m9k01m8t1m9km1m8s1m9k3-Qy1m8v1m9k0ksk0k0");
    ...
    Qasian_double_byte_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_40 = STATIC_STRING("1q83Iy8o835Wy09k9l");
    clear_optimized_constants();
  ...
  end_loop_12:;
    ...
    string_constant_41 = 
	    STATIC_STRING("43Dy8l83-Jy1p83-Jy83Iy8r8m8k1l83Iy0000001l1r8p83Iy1m8u1m9k83-Jy1m8w1m9k1l8318y1m8t1m9km1m8s1m9k3-Qy1m8v1m9k+s3-*ykkkkkl3A++yksk0");
    string_constant_42 = STATIC_STRING("k0");
    temp = The_type_description_of_jis_x_0208;
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    The_type_description_of_jis_x_0208 = 
	    load_and_initialize_type_description(temp,
	    regenerate_optimized_constant(LIST_2(string_constant_41,
	    string_constant_42)));
    mutate_global_property(Qg2_defstruct_structure_name_jis_x_0208_g2_struct,
	    The_type_description_of_jis_x_0208,
	    Qtype_description_of_unique_type_name_of_gensym_structure);
    ...
    string_constant_43 = STATIC_STRING("1q83-Jy8o836by09k9l");
    clear_optimized_constants();
  ...
  end_loop_13:;
    ...
    string_constant_44 = 
	    STATIC_STRING("43Dy8l83-Ky1p83-Ky83Iy8r8m8k1l83Iy0000001l1r8p83Iy1m8u1m9k83-Ky1m8w1m9k1m831Ay831By1m8t1m9km1m8s1m9k3-Qy1m8v1m9k+s3-=ykkkkkl3A++");
    string_constant_45 = STATIC_STRING("yksk0k0");
    temp = The_type_description_of_ks_c_5601;
    clear_optimized_constants();
    push_optimized_constant(Qquote);
    The_type_description_of_ks_c_5601 = 
	    load_and_initialize_type_description(temp,
	    regenerate_optimized_constant(LIST_2(string_constant_44,
	    string_constant_45)));
    mutate_global_property(Qg2_defstruct_structure_name_ks_c_5601_g2_struct,
	    The_type_description_of_ks_c_5601,
	    Qtype_description_of_unique_type_name_of_gensym_structure);
    ...
    string_constant_46 = STATIC_STRING("1q83-Ky8o836dy09k9l");
    clear_optimized_constants();
  ...
  end_loop_14:;
    ...
    string_constant_47 = 
	    STATIC_STRING("43Dy8l83py1p83py83Iy8r8m8k1l83Iy0000001l1r8p83Iy1m8u1m9k83py1m8w1m9k1m830Iy830Jy1m8t1m9km1m8s1m9k3-Qy1m8v1m9k+s3-=ykkkkkl3A++yks");
    string_constant_48 = STATIC_STRING("k0k0");
    ...
    string_constant_49 = STATIC_STRING("1q83py8o836*y09k9l");
    clear_optimized_constants();
  ...
  end_loop_15:;
    ...
    string_constant_50 = 
	    STATIC_STRING("43Dy8l83-Iy1o83-Iy8y8m8k1l8y0000001m1m8p8y1n8n8323y1m8311y8310yksk0k0");
    ...
    Qiso_8859_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_51 = STATIC_STRING("1q83-Iy8o836ay09k9l");
    clear_optimized_constants();
    ...
    string_constant_52 = 
	    STATIC_STRING("43Dy8l83-6y1o83-6y8y8m8k1l8y0000001l1m8p8ykyk0k0");
    ...
    Qiso_2022_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_53 = STATIC_STRING("1q83-6y8o836Ny09k9l");
    clear_optimized_constants();
  ...
  end_loop_24:;
    ...
    string_constant_54 = 
	    STATIC_STRING("43Dy8l83-ey1o83-ey8y8m8k1l8y0000001l1m8p8ykrk0k0");
    ...
    Qshift_jis_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_55 = STATIC_STRING("1q83-ey8o837Dy09k9l");
    clear_optimized_constants();
    ...
    string_constant_56 = 
	    STATIC_STRING("43Dy8l83Sy1o83Sy8y8m8k1l8y0000001l1m8p8yksk0k0");
    ...
    Qutf_g_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_57 = STATIC_STRING("1q83Sy8o837dy09k9l");
    clear_optimized_constants();
	...
	The_type_description_of_utf_g_ascii_as_much_as_possible_transcoder 
		= Nil;
    string_constant_58 = 
	    STATIC_STRING("43Dy8l83-wy1p83-wy83Sy8y8m8k1l83Sy0000001l1m8p83Syksk0k0");
    ...
    Qutf_g_ascii_as_much_as_possible_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_59 = STATIC_STRING("1q83-wy8o837cy09k9l");
    clear_optimized_constants();
    ...
    string_constant_60 = 
	    STATIC_STRING("43Dy8l83-sy1o83-sy8y8m8k1l8y0000001l1m8p8yksk0k0");
    ...
    Qunicode_ucs_2_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_61 = STATIC_STRING("1q83-sy8o837Yy09k9l");
    clear_optimized_constants();
    ...
    string_constant_62 = 
	    STATIC_STRING("43Dy8l83-ry1o83-ry8y8m8k1l8y0000001l1m8p8ykqk0k0");
    ...
    Qunicode_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_63 = STATIC_STRING("1q83-ry8o837Xy09k9l");
    clear_optimized_constants();
    ...
    string_constant_64 = 
	    STATIC_STRING("43Dy8l83-qy1o83-qy8y8m8k1l8y0000001l1m8p8ykqk0k0");
    ...
    Qunicode_byte_swapped_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_65 = STATIC_STRING("1q83-qy8o837Wy09k9l");
    clear_optimized_constants();
  ...
  end_loop_40:;
    ...
    Utf_7_modified_base64_characters = stringw(string_constant_66);
    ...
    string_constant_67 = 
	    STATIC_STRING("43Dy8l83-uy1o83-uy8y8m8k1l8y0000001l1m8p8ykqk0k0");
    ...
    Qutf_7_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_68 = STATIC_STRING("1q83-uy8o837ay09k9l");
    clear_optimized_constants();
  ...
  end_loop_41:;
    ...
    string_constant_69 = 
	    STATIC_STRING("43Dy8l83-vy1o83-vy8y8m8k1l8y0000001l1m8p8ykqk0k0");
    ...
    Qutf_8_transcoder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_70 = STATIC_STRING("1q83-vy8o837by09k9l");
    clear_optimized_constants();
