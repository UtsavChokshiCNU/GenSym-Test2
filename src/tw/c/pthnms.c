    ...
    Object file_error_string, arguments_list;
{
	...
	notify_user_at_console(2,string_constant_1,report_string);
...
void pathnames_INIT()
{
    ...
    string_constant_9 = 
	    STATIC_STRING("43Dy8l9k1n9k8m8k1l8m0000001m1n8n831py1q830Ny830Ly830My830Oy830Py830Qy1m8q833Hykvk0k0");
    ...
    string_constant_10 = STATIC_STRING("1q9k8o8362y09l9m");
    clear_optimized_constants();
    push_optimized_constant(Qgensym_pathname);
