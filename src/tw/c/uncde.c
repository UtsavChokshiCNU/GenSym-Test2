...
Object Print_wide_string_max_length = UNBOUND;

Object Abbreviate_wide_strings_for_legibility = UNBOUND;
...
Object print_valid_wide_string_1(wide_string,stream,start,end,print_ellipsis_p)
...
Object Lisp_highest_printable_character_code = UNBOUND;
...
Object Stringw_should_not_cons_p = UNBOUND;
...
Object Current_wide_string = UNBOUND;

Object Fill_pointer_for_current_wide_string = UNBOUND;

Object Total_length_of_current_wide_string = UNBOUND;

Object Current_wide_string_list = UNBOUND;
    ...
    Object string_1, start_qm, end_qm;
{
	...
	end = STRINGP(string_1) ? gensym_string_length(string_1) : 
		text_string_length(string_1);
    temp = copy_text_string_portion(string_1,start,end);
    return VALUES_1(temp);
}

/* COPY-TEXT-STRING-PORTION */
Object copy_text_string_portion(string_1,start,end)
    Object string_1, start, end;
{
    ...
    copy_portion_of_string_into_text_string(string_1,start,end,
...
Object Count_of_interned_text_strings = UNBOUND;

Object Memory_used_for_interned_text_strings = UNBOUND;
...
Object Chain_of_available_gensym_string_streams = UNBOUND;

Object Gensym_string_stream_count = UNBOUND;
    ...
    Object gensym_string_stream;
{
    ...
    svref_new_value = Chain_of_available_gensym_string_streams;
    SVREF(gensym_string_stream,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_gensym_string_streams = gensym_string_stream;
    return VALUES_1(Nil);
}
...
Object make_permanent_gensym_string_stream_structure_internal()
{
    ...
    gensym_string_stream_count_new_value = 
	    FIXNUM_ADD1(Gensym_string_stream_count);
    Gensym_string_stream_count = gensym_string_stream_count_new_value;
...
Object Base_36_digits_string = UNBOUND;
...
Object position_of_text_character_not_in_bag_function(string_1,bag,start,end)
...
Object position_of_text_character_in_bag_function(string_1,bag,start,end)
    Object string_1, bag, start, end;
{
    Object temp;
    SI_Long i, ab_loop_bind_;
...
{
    Object character_1;
    SI_Long start, ab_loop_bind_, end;
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    end = IFIX(lengthw(string_1));
    ab_loop_bind_ = start;
    character_1 = Nil;
  next_loop_1:
    if (end <= ab_loop_bind_)
	goto end_loop_1;
    character_1 = FIX(UBYTE_16_ISAREF_1(string_1,end - (SI_Long)1L));
    if ( !TRUEP(find_text_character_in_sequence(character_1,character_bag)))
	goto end_loop_1;
    end = end - (SI_Long)1L;
    goto next_loop_1;
  end_loop_1:
    return text_string_substring(string_1,FIX(start),FIX(end));
    return VALUES_1(Qnil);
    return VALUES_1(Qnil);
}
    ...
    Object character_bag, string_1;
{
  ...
  next_loop:
    ...
    goto next_loop;
  end_loop:
    return text_string_substring(string_1,Nil,FIX(end));
    return VALUES_1(Qnil);
}

/* PARSE-TEXT-LINE-GIVEN-GROUPING-BAG */
Object parse_text_line_given_grouping_bag(text_line,delimiter_bag,trim_bag,
	    start,end,grouping_bag)
    Object text_line, delimiter_bag, trim_bag, start, end, grouping_bag;
{
    ...
    SI_Long start_1, end_1, grouping_start_char, grouping_end_char, i2;
    ...
    Object text_line, delimiter_bag, trim_bag, start, end, grouping_bag;
{
	...
	return parse_text_line_given_grouping_bag(text_line,delimiter_bag,
		trim_bag,start,end,grouping_bag);
    else {
	temp = start;
	if (temp);
	else
...
Object parse_module_map_line_into_list_of_text_strings_function(text_line,
	    delimiter_bag,trim_bag,start,end)
    Object text_line, delimiter_bag, trim_bag, start, end;
{
    Object temp, substart, i, j, k, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    SI_Long start_1, end_1;
    ...
    Object string_1, start_qm, end_qm;
{
	...
	end = lengthw(string_1);
    if (UBYTE_16_ISAREF_1(string_1,IFIX(start)) == (SI_Long)34L && 
	    UBYTE_16_ISAREF_1(string_1,IFIX(FIXNUM_SUB1(end))) == 
		(SI_Long)34L) {
...
{
    Object end, start, initial_index, previous_number_parsing_state_qm;
    ...
    initial_index = disallow_leading_whitespace_qm ? start : 
	    skip_whitespace_in_string(string_1,start,end);
    ...
    next_character = Nil;
  next_loop:
    next_character = i == IFIX(end) ? FIX((SI_Long)32L) : 
...
Object Message_illegal_symbol_text_string_empty = UNBOUND;

Object Message_illegal_symbol_text_string_contains_a_newline = UNBOUND;

Object Message_illegal_symbol_text_string_contains_ffff = UNBOUND;

Object Message_illegal_symbol_text_string_contains_fffe = UNBOUND;

Object Message_illegal_symbol_text_string_too_long = UNBOUND;
...
Object Current_character_syntax_table = UNBOUND;
    ...
    Object wide_string, start_qm, end_qm;
{
    ...
    i = start;
    if ( !(IFIX(Fill_pointer_for_current_wide_string) + (end - start) + 
  ...
  next_loop_1:
	...
	if ( !(IFIX(Fill_pointer_for_current_wide_string) + (end - j) + 
		(SI_Long)2L < IFIX(Total_length_of_current_wide_string)))
	    extend_current_wide_string(FIX(IFIX(Fill_pointer_for_current_wide_string) 
		    + (end - j) + (SI_Long)2L));
	temp_1 = Current_wide_string;
  ...
  end_loop_1:
	...
	if (i == end)
	    ...
	    temp_2 = i < IFIX(Fill_pointer_for_current_wide_string) ? 
		    IFIX(Fill_pointer_for_current_wide_string) < end : 
		    TRUEP(Qnil);
	    if (temp_2);
	    else {
		arg = IFIX(Fill_pointer_for_current_wide_string);
		arg_1 = i;
		arg_2 = IFIX(Fill_pointer_for_current_wide_string) + (end - i);
		temp_2 = arg < arg_1 ? arg_1 < arg_2 : TRUEP(Qnil);
	    }
	    if (temp_2) {
		copy_byte_vector_16_portion_carefully(wide_string,FIX(i),
			Current_wide_string,
			Fill_pointer_for_current_wide_string,FIX(end - i));
		temp_2 = TRUEP(T);
	    }
	    else
		temp_2 = TRUEP(Qnil);
    ...
    Object wide_string, start_qm, end_qm;
{
    ...
    if ( !FIXNUM_LT(FIXNUM_ADD(Fill_pointer_for_current_wide_string,
	    FIXNUM_MINUS(end,start)),Total_length_of_current_wide_string))
	...
	if (FIXNUM_EQ(start,end))
	    ...
	    temp = FIXNUM_LT(start,Fill_pointer_for_current_wide_string) ? 
		    FIXNUM_LT(Fill_pointer_for_current_wide_string,end) : 
		    TRUEP(Qnil);
	    if (temp);
	    else {
		arg = IFIX(Fill_pointer_for_current_wide_string);
...
Object Wide_twrite_fixnum_buffer = UNBOUND;

Object Most_negative_fixnum_as_string = UNBOUND;

Object Length_of_most_negative_fixnum_as_string = UNBOUND;
...
Object Twrite_fixnum_buffer = UNBOUND;
...
Object String_for_returning_floats = UNBOUND;

Object Null_char = UNBOUND;
...
Object Maximum_significant_decimal_digits_in_gensym_float = UNBOUND;

Object Write_floats_accurately_p = UNBOUND;
...
Object Default_float_to_text_format = UNBOUND;
...
Object write_floating_point_number_simple_c_format varargs_1(int, n)
{
    ...
    output_format = OPTIONAL_ARG_P_nonrelocating() ? 
	    OPTIONAL_ARG_nonrelocating() : Qdefault;
...
void unicode_INIT()
{
    ...
    Object Qwide_twrite_fixnum_buffer, Qmake_wide_string_function, Kfuncall;
    ...
    Object list_constant_35, list_constant_30, list_constant_32;
    Object list_constant_34, list_constant_33, list_constant_31;
    ...
    Object list_constant_8, list_constant_7, Qtl_tl, Qtl_bs, Qab_and, Qpct;
    Object Qdol, Qab_or_1, Qex, Qqm, Qsc, list_constant_6, Qcol, Qcol_col, Qcm;
    Object Qcbt, Qobt, Qcp, Qop, Qct, list_constant_5, Qplus_, list_constant_4;
    Object list_constant_3, list_constant_2, string_constant_37;
    Object string_constant_36, string_constant_35, string_constant_34;
    Object string_constant_33, string_constant_32, Qread_character_code;
    Object Qgensym_string_stream, Qreclaim_structure;
    Object Qoutstanding_gensym_string_stream_count;
    Object Qgensym_string_stream_structure_memory_usage, Qutilities2;
    Object Qgensym_string_stream_count;
    Object Qchain_of_available_gensym_string_streams, string_constant_31;
    ...
    Object Qmemory_used_for_interned_text_strings;
    Object Qcount_of_interned_text_strings, string_constant_29;
    Object string_constant_28, Qwide_string_list_maximum_length;
    Object Qnamed_dynamic_extent_description, Qoutputting_to_wide_string;
    Object Qutilities1, Qstringw_should_not_cons_p;
    ...
    Extend_current_text_string_error_message = string_constant_28;
    ...
    Maximum_text_string_length_exceeded_message = string_constant_29;
    Qlength_when_written_parsably = 
    ...
    string_constant_30 = 
	    STATIC_STRING("43Dy8l83qy1n83qy8m8k1l8m0000001l1n8n831qy0krk0k0");
    ...
    Qgensym_string_stream_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_31 = STATIC_STRING("1q83qy8o8363y09k9l");
    ...
    string_constant_32 = STATIC_STRING("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ");
    if (Base_36_digits_string == UNBOUND)
	Base_36_digits_string = stringw(string_constant_32);
    ...
    string_constant_33 = STATIC_STRING("It is empty.");
    if (Message_illegal_symbol_text_string_empty == UNBOUND)
	Message_illegal_symbol_text_string_empty = stringw(string_constant_33);
    string_constant_34 = STATIC_STRING("It contains a newline character.");
    if (Message_illegal_symbol_text_string_contains_a_newline == UNBOUND)
	Message_illegal_symbol_text_string_contains_a_newline = 
		stringw(string_constant_34);
    string_constant_35 = 
