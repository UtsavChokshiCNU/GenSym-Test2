...
static Object Qmqtt_poll_watcher;  /* mqtt-poll-watcher */
...
Object dequeue_and_execute_next_task()
{
  ...
  end_loop:;
	...
	temp_1 = TRUEP(g2_event_ready_p());
	if (temp_1);
	else {
	    Time_to_check_network_events = Nil;
	    temp_1 = TRUEP(Time_to_check_network_events);
	}
    }
    else
	temp_1 = TRUEP(Nil);
	...
	FUNCALL_SYMBOL_0(Qmqtt_poll_watcher);
    dequeue_next_task();
    ...
    Object current_task;
{
	...
	if (arg > arg_1 &&  !inline_nanp_for_comparison(arg) &&  
	    ...
	    current_time = g2_running_qm ? DFLOAT_ISAREF_1(Current_g2_time,
		    (SI_Long)0L) : DFLOAT_ISAREF_1(Current_real_time,
		    (SI_Long)0L);
    ...
    Object current_only_p;
{
    ...
    Object fill_pointer_for_current_wide_string;
    Object total_length_of_current_wide_string, current_twriting_output_type;
    Object car_new_value, temp_1, temp_2, temp_3, temp_4, temp_5, ab_loopvar_;
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  tformat(3,string_constant_11,Qreal_time,Nil);
		  car_new_value = copy_out_current_wide_string();
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
		  ...
		  write_floating_point_number(10,
			  ...
			  + 
			  (DFLOAT_ISAREF_1(Gensym_base_time_as_managed_float,
			  (SI_Long)0L) - temp)),FIX((SI_Long)9L),
	...
	PUSH_SPECIAL(Current_wide_string_list,current_wide_string_list,4);
	  ...
	  PUSH_SPECIAL(Current_wide_string,current_wide_string,3);
		...
		PUSH_SPECIAL(Current_twriting_output_type,current_twriting_output_type,
			0);
		  temp_1 = Priority_of_next_task;
		  tformat(3,string_constant_16,temp_1,
	...
	if ( !EQ(ISVREF(Immediate_task_queue,(SI_Long)0L),
		...
		POP_SPECIAL();
	      POP_SPECIAL();
	    POP_SPECIAL();
	    temp_2 = gensym_cons_1(temp_1,gensym_cons_1(temp_2,
	...
	if ( !TRUEP(current_only_p)) {
		...
		temp_1 = Qnil;
	      end_3:;
		temp_1 = gensym_cons_1(temp_6,gensym_cons_1(temp_7,
			gensym_cons_1(temp_8,temp_1)));
	    }
	    else
		temp_1 = Nil;
	    temp_1 = nconc2(temp_4,nconc2(temp_5,temp_1));
	}
	else
	    temp_1 = Nil;
	temp_1 = nconc2(gensymed_symbol,nconc2(temp_2,nconc2(temp_3,temp_1)));
    }
    POP_LOCAL_ALLOCATION(0,0);
...
void schedule_INIT()
{
    ...
    string_constant_22 = 
	    STATIC_STRING("43Dy8l83-dy1n83-dy8m8k1l8m0000001n1m83Gy3ky1n8n832Jy1l833ry1m834=y1m833py833qykzk0k0");
    ...
    string_constant_23 = STATIC_STRING("1q83-dy8o837Cy09k9l");
    ...
    string_constant_24 = 
	    STATIC_STRING("43Dy8l83ny1m83ny8k1l8k0000001o1m83Fy9k1m83Gy3ky1n8n831ny01m8q833Gykok0k0");
    ...
    Qfuture_task_queue_holder_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_25 = STATIC_STRING("1q83ny8o836+y09k9l");
    clear_optimized_constants();
    ...
    Qmqtt_poll_watcher = STATIC_SYMBOL("MQTT-POLL-WATCHER",AB_package);
