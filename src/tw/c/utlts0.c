...
void utilities0_INIT()
{
    ...
    string_constant_1 = STATIC_STRING("1q8360y9k836=y09l9m");
    ...
    SET_SYMBOL_FUNCTION(Qsvp_memory_usage,STATIC_FUNCTION(svp_memory_usage,
	    NIL,FALSE,0,0));
    string_constant_2 = STATIC_STRING("1q836ly83Ky835py09k9l");
    clear_optimized_constants();
    ...
    string_constant_3 = STATIC_STRING("1q835ay1m9k1m83-tys835Vy09l9m");
    clear_optimized_constants();
    ...
    string_constant_4 = STATIC_STRING("1q835Zy1m9k1m83-ty3Cy835Uy09l9m");
    clear_optimized_constants();
    push_optimized_constant(Qvector);
