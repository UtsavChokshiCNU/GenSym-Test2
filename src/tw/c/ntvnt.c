...
Object Network_octet_buffer_length = UNBOUND;

Object Last_event_socket_handle_holder = UNBOUND;

Object Last_event_socket_handle = UNBOUND;

Object Last_event_status_code_holder = UNBOUND;

Object Last_event_status_code = UNBOUND;

Object Last_event_status_code_0 = UNBOUND;

Object Last_event_status_code_1 = UNBOUND;

Object Handle_to_socket_mapping = UNBOUND;
    ...
    Object socket_1, socket_handle;
{
	...
	Handle_to_socket_mapping = 
		gensym_cons_1(gensym_cons_1(socket_handle,socket_1),
		Handle_to_socket_mapping);
    return VALUES_1(Nil);
}

Object Icp_sockets_waiting_for_icp_message_processing = UNBOUND;
    ...
    Object icp_socket;
{
	...
	svref_new_value = Icp_connection_closed;
...
Object Icp_sockets_to_be_reclaimed = UNBOUND;

Object Icp_socket_for_handle_icp_messages = UNBOUND;
    ...
    Object icp_socket;
{
    ...
    Active_icp_sockets = delete_gensym_element_1(icp_socket,
	    Active_icp_sockets);
	...
	if (icp_socket_notifies_user_on_error_p(icp_socket))
	    notify_user_at_console(2,string_constant,reason_for_shutdown_qm);
	reclaim_text_string(reason_for_shutdown_qm);
	SVREF(icp_socket,FIX((SI_Long)9L)) = Qshutdown;
    }
    Icp_sockets_to_be_reclaimed = gensym_cons_1(icp_socket,
	    Icp_sockets_to_be_reclaimed);
    return VALUES_1(Nil);
}

Object Inhibit_icp_socket_reclamation = UNBOUND;
...
Object Scheduler_enabled_qm = UNBOUND;
...
Object run_scheduler_for_current_system()
{
	...
	PUSH_SPECIAL(Scheduler_enabled_qm,scheduler_enabled_qm,0);
	  SAVE_VALUES(run_one_tw_scheduler_cycle());
	POP_SPECIAL();
    }
...
Object get_pending_network_events()
{
    ...
    SAVE_STACK();
    g2ext_set_handle_network_events((SI_Long)1L);
    ...
    RESTORE_STACK();
    return VALUES_1(FIX(g2ext_set_handle_network_events((SI_Long)0L)));
}
...
static Object string_constant_2;   /* "Error event! ~% socket-handle is ~s, event-status is ~s.~%" */
    ...
    Object event_code, event_socket_handle, event_status_code;
{
    ...
    PUSH_SPECIAL(Inside_handle_event,inside_handle_event,0);
      ...
      if ( !(FIXNUM_LE(FIX((SI_Long)-128L),temp) && FIXNUM_LE(temp,
	      FIX((SI_Long)127L))))
	  notify_user_at_console(2,string_constant_1,event_code);
      else
	  switch (INTEGER_TO_CHAR(temp)) {
	    ...
	    case 7:
	      ...
	      break;
	    case -1:
	      notify_user_at_console(3,string_constant_2,
    ...
    Object icp_socket, network_error_code;
{
	...
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qhandle_read_event_function);
    ...
    Object icp_socket, network_error_code;
{
    ...
    if ( !(schedule_task_qm && (ISVREF(schedule_task_qm,(SI_Long)6L) || 
	    EQ(schedule_task_qm,Current_schedule_task)))) {
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qhandle_write_event_function);
	current_task_schedule_modify_arg_11 = icp_socket;
	current_task_schedule_modify_arg_12 = network_error_code;
	schedule_task_qm = ISVREF(icp_socket,(SI_Long)44L);
	if (schedule_task_qm) {
    ...
    Object icp_socket, network_error_code;
{
    ...
    if ( !(schedule_task_qm && (ISVREF(schedule_task_qm,(SI_Long)6L) || 
	    EQ(schedule_task_qm,Current_schedule_task)))) {
	current_task_schedule_modify_arg_8 = 
		SYMBOL_FUNCTION(Qhandle_close_event);
	current_task_schedule_modify_arg_11 = icp_socket;
	current_task_schedule_modify_arg_12 = network_error_code;
	schedule_task_qm = ISVREF(icp_socket,(SI_Long)45L);
	if (schedule_task_qm) {
...
Object During_ffi_call_qm = UNBOUND;
...
Object Default_accept_timeout = UNBOUND;
...
void netevent_INIT()
{
    ...
    Object array_constant_3, array_constant_2, string_constant_19;
    ...
    string_constant_3 = STATIC_STRING("Operation was successful.");
    ...
    ISASET_1(array_constant_2,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_2,(SI_Long)1L,string_constant_3);
    ...
    ISASET_1(array_constant_3,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_3,(SI_Long)1L,string_constant_4);
    ...
    ISASET_1(array_constant_4,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_4,(SI_Long)1L,string_constant_5);
    ...
    ISASET_1(array_constant_5,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_5,(SI_Long)1L,string_constant_6);
    ...
    ISASET_1(array_constant_6,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_6,(SI_Long)1L,string_constant_7);
    ...
    ISASET_1(array_constant_7,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_7,(SI_Long)1L,string_constant_8);
    ...
    ISASET_1(array_constant_8,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_8,(SI_Long)1L,string_constant_9);
    ...
    ISASET_1(array_constant_9,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_9,(SI_Long)1L,string_constant_10);
    ...
    ISASET_1(array_constant_10,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_10,(SI_Long)1L,string_constant_11);
    ...
    ISASET_1(array_constant_11,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_11,(SI_Long)1L,string_constant_12);
    ...
    ISASET_1(array_constant_12,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_12,(SI_Long)1L,string_constant_13);
    ...
    ISASET_1(array_constant_13,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_13,(SI_Long)1L,string_constant_14);
    ...
    ISASET_1(array_constant_14,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_14,(SI_Long)1L,string_constant_15);
    ...
    ISASET_1(array_constant_15,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_15,(SI_Long)1L,string_constant_16);
    ...
    ISASET_1(array_constant_16,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_16,(SI_Long)1L,string_constant_17);
    ...
    ISASET_1(array_constant_17,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_17,(SI_Long)1L,string_constant_18);
    ...
    ISASET_1(array_constant_18,(SI_Long)0L,
	    Qg2_defstruct_structure_name_error_code_g2_struct);
    ISASET_1(array_constant_18,(SI_Long)1L,string_constant_19);
