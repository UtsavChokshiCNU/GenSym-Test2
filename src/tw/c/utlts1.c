...
Object Short_simple_gensym_strings = UNBOUND;

Object Long_simple_gensym_strings = UNBOUND;

Object Adjustable_gensym_strings = UNBOUND;

Object Short_simple_gensym_string_counts = UNBOUND;

Object Long_simple_gensym_string_counts = UNBOUND;

Object Adjustable_gensym_string_counts = UNBOUND;

Object Simple_gensym_string_counter = UNBOUND;

Object Simple_gensym_string_byte_use_counter = UNBOUND;
...
Object String_pool_number_to_malloc = UNBOUND;

Object Largest_non_malloced_string_pool_index = UNBOUND;
    ...
    Object length_1;
{
	...
	if (pool_qm) {
	    ...
	    inline_note_reclaim_cons(pool_qm,Qab_gensym);
	    temp_1 = Available_gensym_conses;
	    M_CDR(pool_qm) = temp_1;
	    Available_gensym_conses = pool_qm;
	    string_1 = temp;
	}
	else
	...
	if (FIXNUM_EQ(length_1,SIMPLE_ARRAY_ANY_1_LENGTH(M_CAR(pool_cons)))) {
	    ...
	    inline_note_reclaim_cons(pool_cons,Qab_gensym);
	    temp_1 = Available_gensym_conses;
	    M_CDR(pool_cons) = temp_1;
	    Available_gensym_conses = pool_cons;
	    string_1 = temp;
	    goto end;
	}
	...
	if (IFIX(String_pool_number_to_malloc) == (SI_Long)-1L || 
	    ...
	    temp_2 = IFIX(Largest_non_malloced_string_pool_index);
	    Largest_non_malloced_string_pool_index = FIX(MAX(temp_2,
		    pool_index));
...
Object Log_simple_string_data = UNBOUND;

Object Log_simple_string_reclaims = UNBOUND;

Object Min_string_length_to_report = UNBOUND;

Object String_report_frequency = UNBOUND;

Object String_allocations_until_next_report = UNBOUND;

Object String_reclaims_until_next_report = UNBOUND;

Object String_chars_to_print = UNBOUND;
...
Object free_malloced_strings()
{
	...
	temp = FIXNUM_SUB1(Simple_gensym_string_counter);
	Simple_gensym_string_counter = temp;
	decff_1_arg = bytes_per_simple_string(length(array));
	temp = FIXNUM_MINUS(Simple_gensym_string_byte_use_counter,decff_1_arg);
	Simple_gensym_string_byte_use_counter = temp;
	g2rtl_free_malloced_array_internal(array);
	goto next_loop_1;
      end_loop_1:;
	reclaim_gensym_list_1(array_list);
	temp = Long_simple_gensym_strings;
	ISVREF(temp,pool_index) = Nil;
	temp = Long_simple_gensym_string_counts;
    ...
    Object length_1, malloc_p;
{
    ...
    temp = FIXNUM_ADD1(Simple_gensym_string_counter);
    Simple_gensym_string_counter = temp;
    incff_1_arg = bytes_per_simple_string(length_1);
    temp = FIXNUM_ADD(Simple_gensym_string_byte_use_counter,incff_1_arg);
    Simple_gensym_string_byte_use_counter = temp;
    if (FIXNUM_LE(length_1,
		Maximum_suggested_length_for_simple_gensym_strings)) {
	temp = Short_simple_gensym_string_counts;
	temp_1 = FIXNUM_ADD1(ISVREF(temp,IFIX(length_1)));
	SVREF(temp,length_1) = temp_1;
    }
    else {
	temp = Long_simple_gensym_string_counts;
	temp_1 = partial_buffer_pool_index_given_length(length_1,
		String_allocation_schemes);
...
Object Current_custom_reclamation_stamp_qm = UNBOUND;
    ...
    Object simple_gensym_string;
{
	...
	temp_1 = FIXNUM_SUB1(Simple_gensym_string_counter);
	Simple_gensym_string_counter = temp_1;
	decff_1_arg = bytes_per_simple_string(length(simple_gensym_string));
	temp_1 = FIXNUM_MINUS(Simple_gensym_string_byte_use_counter,
		decff_1_arg);
	Simple_gensym_string_byte_use_counter = temp_1;
...
Object Adjustable_gensym_string_counter = UNBOUND;

Object Adjustable_gensym_string_byte_use_counter = UNBOUND;
    ...
    Object length_1;
{
    ...
    temp = FIXNUM_ADD1(Adjustable_gensym_string_counter);
    Adjustable_gensym_string_counter = temp;
    temp_1 = IFIX(length_1) / IFIX(Bytes_per_rtl_ptr);
    incff_1_arg = (SI_Long)36L + IFIX(FIXNUM_TIMES(FIX(temp_1),
	    Bytes_per_rtl_ptr));
    adjustable_gensym_string_byte_use_counter_new_value = 
	    IFIX(Adjustable_gensym_string_byte_use_counter) + incff_1_arg;
    Adjustable_gensym_string_byte_use_counter = 
	    FIX(adjustable_gensym_string_byte_use_counter_new_value);
    temp = Adjustable_gensym_string_counts;
    svref_arg_2 = partial_buffer_pool_index_given_length(length_1,
	    String_allocation_schemes);
    ...
    Object adjustable_gensym_string;
{
    ...
    cdr_new_value = ISVREF(Adjustable_gensym_strings,pool_index);
    ...
    Object string_1, start_qm, end_qm;
{
    ...
    new_string = obtain_simple_gensym_string(FIXNUM_MINUS(end,start));
    temp = start_qm;
    if (temp);
    else
	temp = FIX((SI_Long)0L);
...
Object Current_gensym_string = UNBOUND;

Object Fill_pointer_for_current_gensym_string = UNBOUND;

Object Total_length_of_current_gensym_string = UNBOUND;

Object Current_twriting_output_type = UNBOUND;
...
Object copy_gensym_string_portion(string_1,start,end)
...
Object Write_symbols_parsably_qm = UNBOUND;
...
Object position_of_ascii_character_not_in_bag_function(string_1,bag,start,end)
    Object string_1, bag, start, end;
{
    Object temp;
    SI_Long i, ab_loop_bind_;
    char string_is_simple_qm;
...
Object position_of_ascii_character_in_bag_function(string_1,bag,start,end)
    Object string_1, bag, start, end;
{
    Object temp;
    SI_Long i, ab_loop_bind_;
...
Object parse_ascii_text_line_given_grouping_bag(ascii_text_line,
	    delimiter_bag,trim_bag,start,end,grouping_bag)
    Object ascii_text_line, delimiter_bag, trim_bag, start, end, grouping_bag;
{
    ...
    SI_Long start_1, end_1, i2, ab_loop_bind_;
...
Object Calling_tformat_for_give_warning_qm = UNBOUND;

Object Write_symbols_in_lower_case_qm = UNBOUND;

Object Write_strings_parsably_qm = UNBOUND;
    ...
    Object x;
{
    ...
    PUSH_SPECIAL(Write_strings_parsably_qm,write_strings_parsably_qm,1);
...
Object Note_blocks_in_tformat = UNBOUND;

Object Tformat_fresh_line_is_newline_p = UNBOUND;

Object In_text_for_item_or_value_p = UNBOUND;
			  ...
			  switch (INTEGER_TO_CHAR(temp_2)) {
			    ...
			    case 110:
				  ...
				  switch ((char)temp) {
				    ...
				    case 65:
				    case 97:
				      write_block_or_evaluation_value(arg);
				      break;
				    case 78:
				    case 110:
...
Object The_g2_defstruct_package = UNBOUND;
...
Object The_type_description_of_t = UNBOUND;

Object Maximum_number_of_structure_methods = UNBOUND;

Object Table_to_map_structure_id_to_method_name = UNBOUND;
...
void utilities1_INIT()
{
    ...
    Object Qnamed_dynamic_extent_description, Qoutputting_to_gensym_string;
    Object Qutilities1, string_constant_17;
    Object Qcompute_memory_used_by_adjustable_gensym_strings;
    Object Qoutstanding_adjustable_gensym_strings;
    Object Qadjustable_gensym_string_byte_use_counter;
    Object Qadjustable_gensym_string_counter, string_constant_16;
    Object Qcompute_memory_used_by_simple_gensym_strings;
    Object Qoutstanding_simple_gensym_strings;
    Object Qsimple_gensym_string_byte_use_counter;
    Object Qsimple_gensym_string_counter, list_constant_9;
    Object Qadjustable_gensym_string_counts, Qlong_simple_gensym_string_counts;
    Object list_constant_8, Qnew_partial_buffer_gensym_string_vector, Kfuncall;
    Object list_constant_7, Qshort_simple_gensym_string_counts;
    Object Qnew_short_simple_gensym_string_vector, list_constant_6;
    Object Qadjustable_gensym_strings, Qlong_simple_gensym_strings;
    Object list_constant_5, list_constant_4, Qshort_simple_gensym_strings;
    ...
    if (Maximum_gensym_string_length == UNBOUND)
    ...
    SET_SYMBOL_FUNCTION(Qcompute_memory_used_by_simple_gensym_strings,
	    ...
	    NIL,FALSE,0,0));
    string_constant_16 = STATIC_STRING("1q837Gy837Hy837Fy09k9l");
    ...
    SET_SYMBOL_FUNCTION(Qcompute_memory_used_by_adjustable_gensym_strings,
	    ...
	    NIL,FALSE,0,0));
    string_constant_17 = STATIC_STRING("1q835Ty9k835Sy09l9m");
    clear_optimized_constants();
    ...
    Extend_current_gensym_string_error_message = string_constant_18;
    ...
    string_constant_19 = STATIC_STRING("G2-DEFSTRUCT-STRUCTURE-NAME");
    if (The_g2_defstruct_package == UNBOUND)
	The_g2_defstruct_package = find_package(string_constant_19);
    string_constant_20 = STATIC_STRING("TYPE-DESCRIPTION-G2-STRUCT");
    intern(string_constant_20,The_g2_defstruct_package);
    Qtype_description_of_unique_type_name_of_gensym_structure = 
    ...
    string_constant_21 = STATIC_STRING("43Dy8l8k00000004ukkkkkkkkkk0kkk0k0");
    ...
    Undefined_structure_method_message = string_constant_22;
    Qundefined_structure_method_function = 
