    ...
    Object icp_socket, connect_p;
{
	...
	PUSH_SPECIAL(Name_for_local_home,name_for_local_home,13);
    ...
    Object icp_socket, i_am_alive_info;
{
    ...
    Object sending_i_am_alive_qm, current_icp_port, current_icp_socket, temp;
	...
	SVREF(i_am_alive_info,FIX((SI_Long)3L)) = svref_new_value;
	ISVREF(i_am_alive_info,(SI_Long)5L) = FIX((SI_Long)0L);
	ISVREF(i_am_alive_info,(SI_Long)6L) = FIX((SI_Long)0L);
    }
...
Object handle_icp_connection_denied__body()
{
    ...
    notify_user_at_console(2,string_constant_8,ISVREF(Current_icp_socket,
	    (SI_Long)2L));
    return VALUES_1(Nil);
}
...
Object handle_icp_no_license__body()
{
    ...
    notify_user_at_console(2,string_constant_9,ISVREF(Current_icp_socket,
	    (SI_Long)2L));
    return VALUES_1(Nil);
}
    ...
    Object time_until_shutdown;
{
    ...
    notify_user_at_console(3,string_constant_10,ISVREF(Current_icp_socket,
...
Object warn_disallowed_icp_listener_connections varargs_1(int, n)
{
    ...
    Object current_write_icp_byte_position;
    Object number_of_icp_bytes_in_message_group, writing_icp_message_group;
    Object gensymed_symbol, svref_new_value;
    double gensymed_symbol_1;
    Declare_varargs_nonrelocating;
    Declare_special(12);

    x_note_fn_call(48,128);
  ...
  next_loop_1:
	...
	POP_SPECIAL();
	svref_new_value = c_native_clock_ticks_or_cache(Nil,Nil);
	SVREF(icp_socket,FIX((SI_Long)27L)) = svref_new_value;
