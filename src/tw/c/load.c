...
Object ab_Dummy_var = UNBOUND;

Object User_package_in_this_lisp = UNBOUND;

Object List_for_import = UNBOUND;

Object Bootstrap_information = UNBOUND;

Object Ab_system_pathname = UNBOUND;
...
Object Lisp_memory_expanded_qm = UNBOUND;
...
void load_INIT()
{
    ...
    Object string_constant_2, Qab_system_pathname, Kvanilla, Kno_macros;
    Object string_constant_5, string_constant_4, string_constant_1;
    Object string_constant_3, list_constant_18, list_constant_17;
    ...
    Object list_constant_2, list_constant_1, list_constant, string_constant;

    x_note_fn_call(0,1);
    SET_PACKAGE("TCL-USER");
    if (ab_Dummy_var == UNBOUND)
	ab_Dummy_var = adjust_area_target_sizes(FIX((SI_Long)800L),
		FIX((SI_Long)1400L),"TELEWINDOWS");
