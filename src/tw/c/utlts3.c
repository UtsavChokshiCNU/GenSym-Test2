...
Object Write_console_p = UNBOUND;
...
Object Vector_of_simple_float_array_pools = UNBOUND;

Object Vector_of_oversized_simple_float_array_pools = UNBOUND;

Object Created_simple_float_array_pool_arrays = UNBOUND;

Object Created_oversized_simple_float_array_pool_arrays = UNBOUND;
...
Object Simple_float_array_pool_memory_usage = UNBOUND;

Object Oversized_simple_float_array_pool_memory_usage = UNBOUND;
    ...
    Object requested_length_init;
{
	...
	inline_note_reclaim_cons(available_array_cons_qm,Qab_gensym);
	temp = Available_gensym_conses;
	M_CDR(available_array_cons_qm) = temp;
	Available_gensym_conses = available_array_cons_qm;
	result_1 = array;
    }
    else if (length_1 <= IFIX(Replenished_simple_float_array_size_limit) 
	    && length_1 <= IFIX(Maximum_managed_simple_float_array_size)) {
	new_vector_list = 
		make_gensym_list_1(FIXNUM_SUB1(Replenished_simple_vectors_to_make_at_a_time));
	...
	incff_1_arg = Replenished_simple_float_arrays_to_make_at_a_time;
	temp = FIXNUM_ADD(Created_simple_float_array_pool_arrays,incff_1_arg);
	...
	Created_simple_float_array_pool_arrays = temp;
	incff_1_arg = bytes_per_double_float_simple_array(FIX(length_1));
	temp = FIXNUM_ADD(Simple_float_array_pool_memory_usage,incff_1_arg);
	Simple_float_array_pool_memory_usage = temp;
	result_1 = generate_float_vector(FIX(length_1));
    }
    else {
	temp = FIXNUM_ADD1(Created_oversized_simple_float_array_pool_arrays);
	Created_oversized_simple_float_array_pool_arrays = temp;
	incff_1_arg = bytes_per_double_float_simple_array(FIX(length_1));
	temp = FIXNUM_ADD(Oversized_simple_float_array_pool_memory_usage,
		incff_1_arg);
	Oversized_simple_float_array_pool_memory_usage = temp;
	result_1 = generate_float_vector(FIX(length_1));
    }
...
Object allocate_managed_simple_float_array_of_length_1()
{
	...
	new_vector_list = make_gensym_list_1(FIX((SI_Long)9L));
	new_vector_cons = new_vector_list;
      next_loop:
	if ( !TRUEP(new_vector_cons))
	    goto end_loop;
	...
	temp_1 = IFIX(Created_simple_float_array_pool_arrays) + (SI_Long)10L;
	Created_simple_float_array_pool_arrays = FIX(temp_1);
	incff_1_arg = (SI_Long)10L * 
		IFIX(bytes_per_double_float_simple_array(FIX((SI_Long)1L)));
	temp_1 = IFIX(Simple_float_array_pool_memory_usage) + incff_1_arg;
	Simple_float_array_pool_memory_usage = FIX(temp_1);
    ...
    Object managed_simple_float_array;
{
	...
	gensymed_symbol = replenish_gensym_cons_pool();
    M_CAR(gensymed_symbol) = managed_simple_float_array;
    cdr_new_value = ISVREF(Vector_of_simple_float_array_pools,(SI_Long)1L);
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
...
{
    x_note_fn_call(30,28);
    return VALUES_1(DOUBLE_TO_DOUBLE_FLOAT(DFLOAT_ISAREF_1(managed_float,
	    (SI_Long)0L)));
}

Object Bytes_per_double_float_simple_array_cached = UNBOUND;
...
Object Vector_of_simple_long_array_pools = UNBOUND;

Object Created_simple_long_array_pool_arrays = UNBOUND;
...
Object allocate_managed_simple_long_array_of_length_1()
{
	...
	temp = Vector_of_simple_long_array_pools;
	SVREF(temp,FIX((SI_Long)1L)) = new_vector_list;
	temp_1 = IFIX(Created_simple_long_array_pool_arrays) + (SI_Long)10L;
	Created_simple_long_array_pool_arrays = FIX(temp_1);
	incff_1_arg = (SI_Long)10L * 
		IFIX(bytes_per_long_simple_array(FIX((SI_Long)1L)));
	temp_1 = IFIX(Simple_long_array_pool_memory_usage) + incff_1_arg;
	Simple_long_array_pool_memory_usage = FIX(temp_1);
    ...
    Object managed_simple_long_array;
{
    ...
    cdr_new_value = ISVREF(Vector_of_simple_long_array_pools,(SI_Long)1L);
    M_CDR(gensymed_symbol) = cdr_new_value;
    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
    SVREF(svref_arg_1,FIX((SI_Long)1L)) = gensymed_symbol;
    return VALUES_1(Nil);
...
Object managed_long_value_function(managed_long)
    Object managed_long;
{
    x_note_fn_call(30,38);
    return aref1(managed_long,FIX((SI_Long)0L));
}

Object Bytes_per_long_simple_array_cached = UNBOUND;
...
Object allocate_managed_long_box()
{
	...
	temp = FIXNUM_ADD1(Created_simple_long_array_pool_arrays);
	Created_simple_long_array_pool_arrays = temp;
	incff_1_arg = Bytes_per_long_simple_array_cached;
	temp = FIXNUM_ADD(Simple_long_array_pool_memory_usage,incff_1_arg);
	Simple_long_array_pool_memory_usage = temp;
    ...
    Object old_value, new_number;
{
    ...
    Object svref_new_value, amf_result, incff_1_arg, new_float, new_long;
    SI_int64 aref_new_value_1;
    double aref_new_value;

    x_note_fn_call(30,45);
...
Object make_partition_float_or_long_union()
{
    ...
    x_note_fn_call(30,51);
    temp = make_array(3,FIX((SI_Long)4L),Kelement_type,list_constant_1);
    return VALUES_1(temp);
}

Object Partition_float_union = UNBOUND;

Object Partition_long_union = UNBOUND;
...
Object Managed_bignum_pool = UNBOUND;
...
Object Chain_of_available_temporary_constants = UNBOUND;

Object Temporary_constant_count = UNBOUND;
    ...
    Object temporary_constant;
{
    ...
    svref_new_value = Chain_of_available_temporary_constants;
    SVREF(temporary_constant,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_temporary_constants = temporary_constant;
    return VALUES_1(Nil);
}
...
Object make_permanent_temporary_constant_structure_internal()
{
    ...
    x_note_fn_call(30,64);
    def_structure_temporary_constant_variable = Nil;
    temporary_constant_count_new_value = FIXNUM_ADD1(Temporary_constant_count);
    Temporary_constant_count = temporary_constant_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object value, type;
{
	...
	new_float = amf_result;
	temp_1 = coerce_bignum_to_gensym_float(value);
	aref_new_value = DOUBLE_FLOAT_TO_DOUBLE(temp_1);
	DFLOAT_ISASET_1(new_float,(SI_Long)0L,aref_new_value);
    }
    else
    ...
    Object managed_value, type;
{
	...
	svref_new_value = copy_managed_float(managed_value);
    else if (INLINE_LONG_VECTOR_P(managed_value) != (SI_Long)0L && 
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(managed_value)) == (SI_Long)1L)
	svref_new_value = copy_managed_long(managed_value);
    else if (text_string_p(managed_value))
	svref_new_value = copy_text_string(managed_value);
    else
    ...
    Object temporary_constant;
{
    ...
    if (INLINE_DOUBLE_FLOAT_VECTOR_P(managed_number_or_value) != 
	    ...
	    IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(managed_number_or_value)) == 
	    (SI_Long)1L)
	svref_new_value = copy_managed_float(managed_number_or_value);
    else if (INLINE_LONG_VECTOR_P(managed_number_or_value) != (SI_Long)0L 
	    && IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(managed_number_or_value)) == 
	    (SI_Long)1L)
	svref_new_value = copy_managed_long(managed_number_or_value);
    else if (text_string_p(managed_number_or_value))
	svref_new_value = copy_text_string(managed_number_or_value);
    else
...
Object Recycled_resumption_conses = UNBOUND;
...
Object Count_of_interned_gensym_strings = UNBOUND;

Object Memory_used_for_interned_gensym_strings = UNBOUND;
...
Object intern_gensym_string varargs_1(int, n)
{
	...
	count_of_interned_gensym_strings_new_value = 
		FIXNUM_ADD1(Count_of_interned_gensym_strings);
	...
	memory_used_for_interned_gensym_strings_new_value = 
		IFIX(Memory_used_for_interned_gensym_strings) + incff_1_arg;
    ...
    Object string_buffer, length_1, package_qm;
{
    ...
    MVS_2(result,symbol,pre_existing_symbol_p);
    if ( !TRUEP(pre_existing_symbol_p)) {
	temp = FIXNUM_ADD1(Count_of_interned_gensym_strings);
	Count_of_interned_gensym_strings = temp;
	incff_1_arg = length_1;
	temp = FIXNUM_ADD(Memory_used_for_interned_gensym_strings,incff_1_arg);
	Memory_used_for_interned_gensym_strings = temp;
    }
...
Object read_number_from_string(string_1,start_index,end_index)
    Object string_1, start_index, end_index;
{
    Object managed_value_qm, number_exists_p, whole_number, exponent_qm;
    Object end_index_of_mantissa, whole_number_for_exponent;
    Object exponent_for_exponent, end_index_of_exponent;
    Object store_managed_number_or_value_arg;
    SI_Long current_index, start_index_for_exponent;
    XDeclare_area(1);
    XDeclare_frontier(1);
    Object result;

    x_note_fn_call(30,90);
    current_index = (SI_Long)0L;
	...
	if (FIXNUM_LE(end_index_of_mantissa,start_index))
	    ...
	    current_index = IFIX(end_index_of_mantissa);
		...
		if (IFIX(end_index_of_exponent) == start_index_for_exponent);
		    ...
		    current_index = IFIX(end_index_of_exponent);
		...
		store_managed_number_or_value_arg = 
			lfloat(read_float_from_string(string_1,start_index,
			end_index),float_constant);
		managed_value_qm = 
			store_managed_number_or_value_function(managed_value_qm,
			store_managed_number_or_value_arg);
	    }
    ...
    POP_LOCAL_ALLOCATION(0,0);
    if (managed_value_qm)
	return VALUES_3(managed_value_qm,FIX(current_index),Nil);
    else
	return VALUES_3(Nil,start_index,number_exists_p ? 
    ...
    Object string_1, start_index, end_index;
{
	  ...
	  PUSH_SPECIAL(Total_length_of_current_wide_string,total_length_of_current_wide_string,
		...
		next_loop_1:
		  ...
		  if (simple_symbol_character_p(character_1)) {
		      ...
		      string_length_so_far = FIXNUM_ADD1(string_length_so_far);
		      current_index = FIXNUM_ADD1(current_index);
		  }
		  else
		      goto end_1;
	...
	return VALUES_3(Nil,current_index,string_constant_3);
    }
    else if (FIXNUM_EQ(current_index,start_index)) {
	reclaim_text_string(string_to_intern);
	return VALUES_3(Nil,current_index,Nil);
    }
    else {
	managed_symbol = Nil;
	...
	managed_symbol = 
		...
		store_managed_number_or_value_arg);
	return VALUES_3(managed_symbol,current_index,Nil);
    }
}
    ...
    Object string_1, start_index, end_index;
{
	...
	if (PUSH_LOCAL_ALLOCATION(Local_area,0,0)) {
		...
		if (INLINE_DOUBLE_FLOAT_VECTOR_P(certainty_qm) != 
		    ...
		    temp = 
			    ...
			    (SI_Long)0L));
		else if (INLINE_LONG_VECTOR_P(certainty_qm) != (SI_Long)0L 
			&& IFIX(SIMPLE_ARRAY_ANY_1_LENGTH(certainty_qm)) 
			== (SI_Long)1L)
		...
		if (IFIX(FIXNUM_MINUS(end_index,current_index)) < (SI_Long)4L)
		    current_index = start_index;
	...
	POP_LOCAL_ALLOCATION(0,0);
	return VALUES_3(managed_certainty,current_index,error_message);
    }
}
    ...
    Object string_1, start_index, end_index;
{
	...
	if (string_is_ok_p) {
	    ...
	    return VALUES_3(managed_string,current_index,Nil);
	}
	else {
	    reclaim_text_string(string_in_string);
	    return VALUES_3(Nil,start_index,Nil);
    ...
    Object string_1, start_index, end_index;
{
  ...
  next_loop:
	...
	if (day) {
		...
		if (year && IFIX(end_index_of_year) == IFIX(current_index) 
			+ (SI_Long)4L)
		    return VALUES_5(day,month,year,end_index_of_year,Nil);
	    }
	}
    }
    return VALUES_5(Nil,Nil,Nil,start_index,Nil);
    goto next_loop;
  end_loop:
    return VALUES_1(Qnil);
}
  ...
  next_loop:
	...
	if (hours && IFIX(hours) <= (SI_Long)24L && 
	    ...
	    if (minutes && IFIX(minutes) <= (SI_Long)59L && 
		    IFIX(FIXNUM_MINUS(end_index_of_minutes,current_index)) 
		...
		if (seconds) {
			...
			valid_seconds_qm = IFIX(seconds) <= (SI_Long)59L ? 
				...
				current_index)) == (SI_Long)2L ? T : Nil) :
				 Qnil;
		...
		if (valid_seconds_qm) {
		    ...
		    if (IFIX(FIXNUM_MINUS(end_index,current_index)) < 
			    (SI_Long)4L)
			return VALUES_5(hours,minutes,seconds,
...
Object Random_state_array = UNBOUND;

Object Random_state_array_current_pointer = UNBOUND;

Object Random_state_array_24_pointer = UNBOUND;

Object Random_variation = UNBOUND;

Object Random_variation_2 = UNBOUND;

Object User_random_seed_qm = UNBOUND;
    ...
    Object a_intervals, b_intervals;
{
    ...
    Object b_intervals_old_value, new_cons, gensymed_symbol, max_qm;

    x_note_fn_call(30,112);
    result_1 = Nil;
    a0 = Nil;
    a1 = Nil;
    b0 = Nil;
  ...
  next_loop:
	...
	if (FIXNUM_LT(a1,b0))
		...
		if (EQ(CDDR(result_1),b0))
		    ...
		    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
		    result_1 = gensym_cons_1(gensymed_symbol,result_1);
		}
	    }
	    goto adv_b;
	}
    ...
    Object a_intervals, b_intervals;
{
    ...
    Object gensymed_symbol, left_min, tail, temp_1, temp_2;

    x_note_fn_call(30,113);
    if ( !TRUEP(b_intervals)) {
	if (a_intervals) {
	    left = Nil;
	    right = Nil;
	  ...
	  next_loop:
	    ...
	    ab_loopvar__1 = gensym_cons_1(gensym_cons_1(left,right),Nil);
	    if (ab_loopvar_)
    ...
    Object a_intervals, b_intervals;
{
    ...
    Object new_cons, gensymed_symbol, gensymed_symbol_1, temp_1, temp_2;
    Object a_intervals_old_value, b_intervals_old_value;

    x_note_fn_call(30,114);
  ...
  next_loop:
    ...
    a_intervals_old_value = a_intervals;
    temp_1 = FIRST(a_intervals_old_value);
    a_intervals = REST(a_intervals_old_value);
    a1 = M_CDR(temp_1);
  next_loop_2:
	...
	M_CDR(gensymed_symbol) = a1;
	inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
	union_intervals_1 = gensym_cons_1(gensymed_symbol,union_intervals_1);
	goto end_1;
    }
    else {
	b_intervals_old_value = b_intervals;
	temp_1 = FIRST(b_intervals_old_value);
	b_intervals = REST(b_intervals_old_value);
	b1 = M_CDR(temp_1);
	if (FIXNUM_LE(b1,a1));
	else {
...
Object reclaim_region(region_qm)
    Object region_qm;
{
    Object box, interval, cdr_new_value, strip, ab_loop_list_, intervals;
    Object interval_1, ab_loop_list__1, gensym_list, last_1, next_qm;

    x_note_fn_call(30,120);
    if (region_qm) {
	box = M_CDR(region_qm);
	interval = M_CAR(box);
	inline_note_reclaim_cons(interval,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(interval) = cdr_new_value;
	Available_gensym_conses = interval;
	interval = M_CDR(box);
	inline_note_reclaim_cons(interval,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(interval) = cdr_new_value;
	Available_gensym_conses = interval;
	reclaim_gensym_cons_1(box);
	strip = Nil;
	ab_loop_list_ = M_CAR(region_qm);
      next_loop:
	if ( !TRUEP(ab_loop_list_))
	    goto end_loop;
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	if (strip) {
	    intervals = M_CDR(strip);
	    interval_1 = Nil;
	    ab_loop_list__1 = intervals;
	  next_loop_1:
	    if ( !TRUEP(ab_loop_list__1))
		goto end_loop_1;
	    interval_1 = M_CAR(ab_loop_list__1);
	    ab_loop_list__1 = M_CDR(ab_loop_list__1);
	    inline_note_reclaim_cons(interval_1,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(interval_1) = cdr_new_value;
	    Available_gensym_conses = interval_1;
	    goto next_loop_1;
	  end_loop_1:
	    reclaim_gensym_list_1(intervals);
	    inline_note_reclaim_cons(strip,Qab_gensym);
	    cdr_new_value = Available_gensym_conses;
	    M_CDR(strip) = cdr_new_value;
	    Available_gensym_conses = strip;
	}
	goto next_loop;
      end_loop:;
	gensym_list = M_CAR(region_qm);
	if (gensym_list) {
	    last_1 = gensym_list;
	    next_qm = Nil;
	  next_loop_2:
	...
	inline_note_reclaim_cons(region_qm,Qab_gensym);
	cdr_new_value = Available_gensym_conses;
	M_CDR(region_qm) = cdr_new_value;
	Available_gensym_conses = region_qm;
	return VALUES_1(Nil);
    }
    else
	return VALUES_1(Nil);
    ...
    Object region;
{
    ...
    Object ab_loopvar__2, new_cons, gensymed_symbol, region_strip_top, left;
    Object right, ab_loop_list__1, ab_loopvar__3, ab_loopvar__4;
    Object ab_loop_desetq_, gensymed_symbol_1, gensymed_symbol_2;
    Object region_strip_intervals, region_strips, box, interval, interval_left;
    Object interval_right, region_bounding_box_x_interval;
    Object region_bounding_box_y_interval, region_bounding_box;

    x_note_fn_call(30,121);
    strips = M_CAR(region);
    strip = Nil;
  ...
  next_loop:
	...
	if ( !TRUEP(gensymed_symbol_2))
	    gensymed_symbol_2 = replenish_gensym_cons_pool();
	M_CAR(gensymed_symbol_2) = left;
	M_CDR(gensymed_symbol_2) = right;
	inline_note_allocate_cons(gensymed_symbol_2,Qab_gensym);
...
{
    Object region_strips, new_cons, gensymed_symbol;
    Object region_bounding_box_x_interval, region_bounding_box_y_interval;
    Object region_bounding_box;

    x_note_fn_call(30,122);
    region_strips = Nil;
    new_cons = Available_gensym_conses;
    if (new_cons) {
	Available_gensym_conses = M_CDR(new_cons);
...
{
    Object gensymed_symbol, gensymed_symbol_1, temp, region_strip_top;
    Object new_cons, gensymed_symbol_2, gensymed_symbol_3;
    Object region_strip_intervals, region_strips;
    Object region_bounding_box_x_interval, region_bounding_box_y_interval;
    Object region_bounding_box;

    x_note_fn_call(30,125);
    if (FIXNUM_LE(left,right) && FIXNUM_LE(top,bottom)) {
	gensymed_symbol = Nil;
      next_loop:
	gensymed_symbol = CDR(Available_gensym_conses);
	if (gensymed_symbol)
	    goto end_loop;
	...
	temp = Available_gensym_conses;
	Available_gensym_conses = CDR(gensymed_symbol);
	M_CDR(gensymed_symbol) = Nil;
...
Object Scratch_rectangle_region = UNBOUND;
    ...
    Object region1, region2;
{
    ...
    Object ab_loop_list_, new_cons, gensymed_symbol, temp_2, strip;
    Object ab_loopvar_, ab_loopvar__1, ab_loopvar__2, region_strip_top, left;
    Object right, ab_loop_list__1, ab_loopvar__3, ab_loopvar__4;
    Object ab_loop_desetq_, gensymed_symbol_1, gensymed_symbol_2;
    Object region_strip_intervals, region_strips, region_bounding_box;

    x_note_fn_call(30,134);
  ...
  next_loop:
	...
	if (EQUAL(strip_intervals,temp)) {
	  ...
	  next_loop_1:
	    ...
	    inline_note_reclaim_cons(interval,Qab_gensym);
	    temp_1 = Available_gensym_conses;
	    M_CDR(interval) = temp_1;
	    Available_gensym_conses = interval;
	    goto next_loop_1;
	  end_loop_1:
	    reclaim_gensym_list_1(strip_intervals);
	}
	else {
	    new_cons = Available_gensym_conses;
	    if (new_cons) {
	    ...
	    inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
	    strips_union = gensym_cons_1(gensymed_symbol,strips_union);
	}
    }
    temp = M_CDR(strips1);
    ...
    Object region_a, region_b;
{
    ...
    Object right_qm, interval, ab_loop_list_, cdr_new_value, new_cons;
    Object gensymed_symbol, region_strips, region_bounding_box_x_interval;
    Object region_bounding_box_y_interval, region_bounding_box;
    Object result;

    x_note_fn_call(30,137);
  ...
  loop_body:
	...
	if (FIXNUM_LT(a1,b0))
		...
		if (cantidate_intervals_qm) {
			...
			goto next_loop;
		      end_loop:
			reclaim_gensym_list_1(cantidate_intervals_qm);
		    }
		    else {
			if (last_bottom_qm) {
			...
			inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
			result_strips = gensym_cons_1(gensymed_symbol,
				result_strips);
  ...
  finished_b:
	...
	M_CDR(gensymed_symbol) = Nil;
	inline_note_allocate_cons(gensymed_symbol,Qab_gensym);
	result_strips = gensym_cons_1(gensymed_symbol,result_strips);
    ...
    Object region_a, region_b;
{
    ...
    Object interval, cdr_new_value, new_cons, gensymed_symbol, left_qm;
    Object right_qm, region_strips, region_bounding_box_x_interval;
    Object region_bounding_box_y_interval, region_bounding_box;
    Object result;

    x_note_fn_call(30,138);
    if ( !TRUEP(intersect_region_p_1(region_a,region_b)))
...
{
    Object string_1, end, i, j, ab_loopvar_, ab_loopvar__1, ab_loopvar__2;
    Object character_1, start, temp, substring;
    SI_Long i_1, ab_loop_bind_;

    x_note_fn_call(30,142);
...
Object Chain_of_available_pending_activitys = UNBOUND;

Object Pending_activity_count = UNBOUND;
    ...
    Object pending_activity;
{
    ...
    x_note_fn_call(30,145);
    inline_note_reclaim_cons(pending_activity,Nil);
    svref_new_value = Chain_of_available_pending_activitys;
    SVREF(pending_activity,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_pending_activitys = pending_activity;
    return VALUES_1(Nil);
}
...
Object make_permanent_pending_activity_structure_internal()
{
    ...
    x_note_fn_call(30,147);
    def_structure_pending_activity_variable = Nil;
    pending_activity_count_new_value = FIXNUM_ADD1(Pending_activity_count);
    Pending_activity_count = pending_activity_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object list_of_pending_activities;
{
  ...
  next_loop_1:
    ...
    ab_loop_list_ = M_CDR(ab_loop_list_);
    cancel_pending_activity(parent);
    goto next_loop_1;
  end_loop_1:
    reclaim_gensym_list_1(list_of_pending_activities);
    reclaim_gensym_list_1(parents);
    return VALUES_1(Qnil);
}
...
Object text_string_parse_integer_function(string_1,start,end,junk_allowed)
...
Object text_string_parse_symbol_function(text_string,start,end)
    Object text_string, start, end;
{
...
Object Cached_gensym_user_home_directory = UNBOUND;

Object All_command_line_keyword_arguments = UNBOUND;
...
Object All_known_command_line_plist_elements = UNBOUND;

Object Used_positional_command_line_argument_default = UNBOUND;
...
Object get_command_line_arguments()
{
    ...
    x_note_fn_call(30,172);
    used_positional_command_line_argument_default = Nil;
    PUSH_SPECIAL(Used_positional_command_line_argument_default,used_positional_command_line_argument_default,
	    0);
      indicator = Nil;
...
Object get_command_line_plist_element_for_no_backing_store()
{
    ...
    x_note_fn_call(30,205);
    arg_qm = get_command_line_flag_argument(2,array_constant_20,T);
    temp = 
...
Object get_command_line_plist_element_for_private_colormap()
{
    ...
    x_note_fn_call(30,207);
    arg_qm = get_command_line_flag_argument(2,array_constant_21,T);
    temp = 
...
Object get_command_line_plist_element_for_background()
{
    ...
    x_note_fn_call(30,221);
    arg_qm = get_command_line_keyword_argument(1,array_constant_24);
...
Object get_command_line_plist_element_for_ui()
{
    ...
    x_note_fn_call(30,223);
    value_qm = get_command_line_keyword_argument(1,array_constant_25);
...
Object exit_on_abort_p()
{
    ...
    x_note_fn_call(30,234);
    temp = get_command_line_flag_argument(1,array_constant_28);
    return VALUES_1(temp);
}
...
{
    x_note_fn_call(30,236);
    return VALUES_1(Nil);
}

Object Use_jit_p = UNBOUND;
...
{
    x_note_fn_call(30,239);
    return get_command_line_flag_argument(1,array_constant_30);
}
...
Object secure_icp_string varargs_1(int, n)
{
    ...
    if (secure_p && ( !TRUEP(network_type) || 
	    string_prefix_eq_w(array_constant_31,network_type)) && 
...
Object get_command_line_plist_element_for_icp_log_intensity()
{
    ...
    x_note_fn_call(30,249);
    value_qm = get_command_line_keyword_argument(1,array_constant_32);
    temp = 
...
Object Chain_of_available_foreign_struct_infos = UNBOUND;

Object Foreign_struct_info_count = UNBOUND;
    ...
    Object foreign_struct_info;
{
    ...
    x_note_fn_call(30,252);
    inline_note_reclaim_cons(foreign_struct_info,Nil);
    svref_new_value = Chain_of_available_foreign_struct_infos;
    SVREF(foreign_struct_info,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_foreign_struct_infos = foreign_struct_info;
    return VALUES_1(Nil);
}
...
Object make_permanent_foreign_struct_info_structure_internal()
{
    ...
    x_note_fn_call(30,254);
    def_structure_foreign_struct_info_variable = Nil;
    foreign_struct_info_count_new_value = 
	    FIXNUM_ADD1(Foreign_struct_info_count);
    Foreign_struct_info_count = foreign_struct_info_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
...
Object Next_eq_hash_value = UNBOUND;

Object The_type_description_of_eq_hash_table = UNBOUND;

Object Chain_of_available_eq_hash_tables = UNBOUND;

Object Eq_hash_table_count = UNBOUND;
    ...
    Object eq_hash_table;
{
    ...
    x_note_fn_call(30,258);
    inline_note_reclaim_cons(eq_hash_table,Nil);
    svref_new_value = Chain_of_available_eq_hash_tables;
    SVREF(eq_hash_table,FIX((SI_Long)0L)) = svref_new_value;
    Chain_of_available_eq_hash_tables = eq_hash_table;
    return VALUES_1(Nil);
}
...
Object make_permanent_eq_hash_table_structure_internal()
{
    ...
    x_note_fn_call(30,260);
    def_structure_eq_hash_table_variable = Nil;
    eq_hash_table_count_new_value = FIXNUM_ADD1(Eq_hash_table_count);
    Eq_hash_table_count = eq_hash_table_count_new_value;
    if (PUSH_AREA(Dynamic_area,0)) {
    ...
    Object table;
{
  ...
  next_loop:
	...
	ab_loop_list_ = M_CDR(ab_loop_list_);
	key = CAR(pair);
	result_1 = gensym_cons_1(key,result_1);
	goto next_loop_1;
      end_loop_1:;
    }
    i = i + (SI_Long)1L;
...
Object twrite_system_version_in_g2_title varargs_1(int, n)
{
    ...
    suppress_brief_description_of_system_version_qm = 
	    OPTIONAL_ARG_P_nonrelocating() ? OPTIONAL_ARG_nonrelocating() :
	     Nil;
    END_ARGS_nonrelocating();
    tformat(2,string_constant_31,g2_enterprise_p() ? string_constant_32 : 
	    string_constant_33);
    tformat(2,string_constant_34,External_version);
    if (IFIX(Revision_number_of_current_gensym_product_line) < (SI_Long)10L)
	twrite_beginning_of_wide_string(array_constant_33,FIX((SI_Long)1L));
    tformat(2,string_constant_28,
	    Revision_number_of_current_gensym_product_line);
    if ( !TRUEP(suppress_brief_description_of_system_version_qm)) {
	brief_description_qm = getf(CDDR(system_version),Qbrief_description,_);
	if (brief_description_qm)
	    return tformat(2,string_constant_35,brief_description_qm);
	else
	    return VALUES_1(Nil);
    }
    else
...
static Object string_constant_36;  /* "Host: ~a" */

static Object string_constant_37;  /* "; ~a: ~a~a" */

static Object string_constant_38;  /* "~%Expiration Day:~a~%" */
    ...
    Object write_machine_id_p;
{
    ...
    x_note_fn_call(30,271);
    result = get_raw_network_info();
    MVS_2(result,host_name,port_list);
    tformat(2,string_constant_36,host_name);
    network_type = Nil;
    address = Nil;
    secure_p = Nil;
...
Object get_raw_network_info()
{
  ...
  next_loop:
    ...
    secure_p = CAR(temp);
    ab_loop_list_ = M_CDR(ab_loop_list_);
    temp_2 = copy_text_string(equalw(type_of_network,array_constant_34) ? 
	    array_constant_35 : array_constant_36);
    temp = tformat_text_string(2,string_constant_41,address);
...
void utilities3_INIT()
{
    ...
    Object Qeq_hash_table_count, Qchain_of_available_eq_hash_tables;
    Object string_constant_59, Qtype_description_of_type, string_constant_58;
    ...
    Object Qforeign_struct_info_structure_memory_usage;
    Object Qforeign_struct_info_count;
    Object Qchain_of_available_foreign_struct_infos, string_constant_57;
    Object string_constant_56, list_constant_43;
    Object Qget_command_line_plist_element_for_icp_log_intensity;
    Object Qcommand_line_process_icp_log_intensity, list_constant_42, Qcert;
    Object Qget_command_line_plist_element_for_cert;
    Object Qcommand_line_process_cert, list_constant_41;
    Object Qget_command_line_plist_element_for_secure;
    Object Qcommand_line_process_secure, list_constant_40, Quse_jit;
    Object Qget_command_line_plist_element_for_use_jit;
    Object Qcommand_line_process_use_jit, list_constant_39, Qexit_on_abort;
    Object Qget_command_line_plist_element_for_exit_on_abort;
    Object Qcommand_line_process_exit_on_abort, list_constant_38;
    Object Qget_command_line_plist_element_for_silent;
    Object Qcommand_line_process_silent, list_constant_37;
    Object Qget_command_line_plist_element_for_verbose;
    Object Qcommand_line_process_verbose, list_constant_36, Qnetinfo;
    Object Qget_command_line_plist_element_for_netinfo;
    Object Qcommand_line_process_netinfo, list_constant_35;
    Object Qget_command_line_plist_element_for_ui, Qcommand_line_process_ui;
    Object list_constant_34, Qknown_ui_styles, Qclassic, list_constant_33;
    Object Qget_command_line_plist_element_for_background;
    Object Qcommand_line_process_background, list_constant_32;
    Object Qget_command_line_plist_element_for_xclip;
    Object Qcommand_line_process_xclip, list_constant_31;
    Object Qdebug_frame_reference_balance;
    ...
    Object list_constant_30, Qcopy_logbook_on_console;
    Object Qget_command_line_plist_element_for_copy_logbook_on_console;
    Object Qcommand_line_process_copy_logbook_on_console, list_constant_29;
    Object Qcopy_messages_on_logbook;
    Object Qget_command_line_plist_element_for_copy_messages_on_logbook;
    Object Qcommand_line_process_copy_messages_on_logbook, list_constant_28;
    Object Qget_command_line_plist_element_for_use_os_emulation;
    Object Qcommand_line_process_use_os_emulation, list_constant_27;
    Object Qfile_operation_timeout;
    Object Qget_command_line_plist_element_for_file_operation_timeout;
    Object Qcommand_line_process_file_operation_timeout, list_constant_26;
    Object Qget_command_line_plist_element_for_private_colormap;
    Object Qcommand_line_process_private_colormap, list_constant_25;
    Object Qget_command_line_plist_element_for_no_backing_store;
    Object Qcommand_line_process_no_backing_store, list_constant_24;
    Object Qg2passwdexe, Qget_command_line_plist_element_for_g2passwdexe;
    Object Qcommand_line_process_g2passwdexe, list_constant_23;
    Object Qget_command_line_plist_element_for_no_native_clipboard;
    Object Qcommand_line_process_no_native_clipboard, list_constant_22;
    Object Qget_command_line_plist_element_for_native_fonts;
    Object Qcommand_line_process_native_fonts, list_constant_21;
    ...
    Object list_constant_20, Qget_command_line_plist_element_for_window_style;
    Object Qcommand_line_process_window_style, list_constant_19;
    Object Qget_command_line_plist_element_for_windowhandle;
    Object Qcommand_line_process_windowhandle, list_constant_18;
    Object Qget_command_line_plist_element_for_user_name;
    Object Qcommand_line_process_user_name, list_constant_17;
    Object Qget_command_line_plist_element_for_window;
    Object Qcommand_line_process_window, list_constant_16;
    Object Qget_command_line_plist_element_for_user_mode;
    Object Qcommand_line_process_user_mode, list_constant_15;
    Object Qget_command_line_plist_element_for_discard_user_settings;
    Object Qcommand_line_process_discard_user_settings, list_constant_14;
    Object Qget_command_line_plist_element_for_init_string;
    Object Qcommand_line_process_init_string, list_constant_13;
    Object Qget_command_line_plist_element_for_cjk_language;
    Object Qcommand_line_process_cjk_language, Qchinese_traditional;
    Object Qchinese_simplified, Qkorean, Qjapanese, Qchinese, list_constant_12;
    Object Qget_command_line_plist_element_for_language;
    Object Qcommand_line_process_language, list_constant_11;
    Object Qget_command_line_plist_element_for_password;
    Object Qcommand_line_process_password, list_constant_10, Qutilities3;
    Object Qcommand_line_arguments, Qget_initial_command_line_arguments;
    Object Kfuncall, Qall_command_line_keyword_arguments, Qpending_activity;
    Object Qoutstanding_pending_activity_count;
    Object Qpending_activity_structure_memory_usage, Qpending_activity_count;
    Object Qchain_of_available_pending_activitys, string_constant_55;
    Object string_constant_54, list_constant_9, Qscratch_rectangle_region;
    Object Qmake_region_from_rectangle, string_constant_53, string_constant_52;
    Object string_constant_51, string_constant_50, list_constant_8;
    Object list_constant_7, Qrandom_seed_3, Qrandom_seed_2, Qrandom_seed_1;
    Object Qrandom_seed_0, Qlarge_shift, Qlarge_mask, array_constant_48;
    Object array_constant_47, array_constant_46, array_constant_45;
    Object array_constant_44, array_constant_43, array_constant_42;
    Object array_constant_41, array_constant_40, array_constant_39;
    Object array_constant_38, array_constant_37;
    ...
    Object Qmemory_used_for_interned_gensym_strings;
    Object Qcount_of_interned_gensym_strings, Qschedule;
    Object Qrecycled_resumption_conses, Qoutstanding_temporary_constant_count;
    Object Qtemporary_constant_structure_memory_usage;
    Object Qtemporary_constant_count, Qchain_of_available_temporary_constants;
    Object string_constant_47, string_constant_46, list_constant_6;
    Object Qmanaged_bignum_pool, Qallocate_managed_array;
    Object Qmask_for_ieee_exponent, string_constant_45;
    Object Qsimple_long_array_pool_memory_usage;
    Object Qoutstanding_simple_long_array_pool_arrays, Qutilities0;
    Object Qcreated_simple_long_array_pool_arrays, list_constant_5;
    Object Qvector_of_simple_long_array_pools;
    ...
    Object Qoversized_simple_float_array_pool_memory_usage;
    Object Qsimple_float_array_pool_memory_usage;
    Object Qcreated_oversized_simple_float_array_pool_arrays;
    Object Qcreated_simple_float_array_pool_arrays;
    Object Qvector_of_oversized_simple_float_array_pools;
    Object Qvector_of_simple_float_array_pools;
    Object Qallocate_initial_vector_of_simple_float_array_pools;
    Object Qmaximum_oversized_managed_simple_float_array_size;
    Object Qmaximum_managed_simple_float_array_size, string_constant_42;
    Object Qno_arg;

    x_note_fn_call(30,276);
    SET_PACKAGE("AB");
    ...
    Qiso_8859_1_gensym_string = STATIC_SYMBOL("ISO-8859-1-GENSYM-STRING",
	    AB_package);
    string_constant_42 = STATIC_STRING("the ~(~A~) ");
    if (Actual_arg == UNBOUND)
	Actual_arg = string_constant_42;
    ...
    record_system_variable(Qvector_of_oversized_simple_float_array_pools,
	    Qutilities0,list_constant_5,Qnil,Qt,Qnil,Qnil);
    ...
    string_constant_43 = STATIC_STRING("1q836jy1m83ay830Ky83*ry09k9l");
    ...
    string_constant_44 = STATIC_STRING("1q836iy1m83ay830Ky835oy09k9l");
    clear_optimized_constants();
    ...
    SET_SYMBOL_FUNCTION(Qoutstanding_simple_long_array_pool_arrays,
	    ...
	    FALSE,0,0));
    string_constant_45 = STATIC_STRING("1q836ky1m83ay8361y83*ry09k9l");
    clear_optimized_constants();
    ...
    list_constant_6 = STATIC_LIST((SI_Long)3L,Kfuncall,
    ...
    string_constant_46 = 
	    STATIC_STRING("43Dy8l83-ky1n83-ky8m8k1l8m0000001l1n8n832Oy1m83*ny83*myknk0k0");
    ...
    Qtemporary_constant_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_47 = STATIC_STRING("1q83-ky8o837Oy09k9l");
    clear_optimized_constants();
    ...
    string_constant_48 = STATIC_STRING("NIL");
    if (Nil_interned == UNBOUND)
	Nil_interned = intern(string_constant_48,_);
    Qget_memory_used_for_interned_text_strings = 
	    STATIC_SYMBOL("GET-MEMORY-USED-FOR-INTERNED-TEXT-STRINGS",
	    AB_package);
    string_constant_49 = STATIC_STRING("1q837Zy837Ly835gy835gy09k");
    clear_optimized_constants();
    ...
    array_constant_37 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)0L,(SI_Long)74L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)1L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_37,(SI_Long)2L,(SI_Long)110L);
    ...
    array_constant_38 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)0L,(SI_Long)70L);
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)1L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_38,(SI_Long)2L,(SI_Long)98L);
    ...
    array_constant_39 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)0L,(SI_Long)77L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)1L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_39,(SI_Long)2L,(SI_Long)114L);
    ...
    array_constant_40 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)0L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)1L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)2L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_40,(SI_Long)7L,(SI_Long)57344L);
    array_constant_41 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)0L,(SI_Long)77L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)1L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_41,(SI_Long)2L,(SI_Long)121L);
    ...
    array_constant_42 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)0L,(SI_Long)74L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)1L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)2L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_42,(SI_Long)7L,(SI_Long)57344L);
    array_constant_43 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)0L,(SI_Long)74L);
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)1L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_43,(SI_Long)2L,(SI_Long)108L);
    ...
    array_constant_44 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)0L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)1L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)2L,(SI_Long)103L);
    UBYTE_16_ISASET_1(array_constant_44,(SI_Long)6L,(SI_Long)3L);
    ...
    UBYTE_16_ISASET_1(array_constant_45,(SI_Long)1L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_45,(SI_Long)2L,(SI_Long)112L);
    UBYTE_16_ISASET_1(array_constant_45,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_45,(SI_Long)7L,(SI_Long)57344L);
    array_constant_46 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_46,(SI_Long)0L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_46,(SI_Long)1L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_46,(SI_Long)2L,(SI_Long)116L);
    ...
    array_constant_47 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_47,(SI_Long)0L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_47,(SI_Long)1L,(SI_Long)111L);
    ...
    array_constant_48 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_48,(SI_Long)0L,(SI_Long)68L);
    UBYTE_16_ISASET_1(array_constant_48,(SI_Long)1L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_48,(SI_Long)2L,(SI_Long)99L);
    UBYTE_16_ISASET_1(array_constant_48,(SI_Long)6L,(SI_Long)3L);
    UBYTE_16_ISASET_1(array_constant_48,(SI_Long)7L,(SI_Long)57344L);
    list_constant_2 = STATIC_LIST((SI_Long)12L,array_constant_37,
	    array_constant_38,array_constant_39,array_constant_40,
	    array_constant_41,array_constant_42,array_constant_43,
	    array_constant_44,array_constant_45,array_constant_46,
	    array_constant_47,array_constant_48);
    ...
    list_constant_7 = STATIC_LIST((SI_Long)2L,Qsatisfies,Qsymbolp);
    mutate_global_property(Qsymbol,list_constant_7,Qsimple_type_specification);
    list_constant_8 = STATIC_LIST((SI_Long)2L,Qsatisfies,Qconsp);
    mutate_global_property(Qcons,list_constant_8,Qsimple_type_specification);
    ...
    string_constant_50 = STATIC_STRING("neither true nor false");
    mutate_global_property(Qboolean,string_constant_50,Qtype_error_printer);
    string_constant_51 = STATIC_STRING("not a symbol");
    mutate_global_property(Qsymbol,string_constant_51,Qtype_error_printer);
    string_constant_52 = STATIC_STRING("not a simple integer");
    mutate_global_property(Qfixnum,string_constant_52,Qtype_error_printer);
    string_constant_53 = STATIC_STRING("not a number");
    mutate_global_property(Qgensym_float,string_constant_53,
	    Qtype_error_printer);
    mutate_global_property(Qmanaged_number,string_constant_53,
	    Qtype_error_printer);
    mutate_global_property(Qtemporary_constant,string_constant_53,
	    Qtype_error_printer);
    ...
    list_constant_9 = STATIC_LIST((SI_Long)6L,Kfuncall,
    ...
    string_constant_54 = 
	    STATIC_STRING("43Dy8l83Py1n83Py8m8k1l8m0000001l1n8n8328y1n83Zy83Xy83Wykqk0k0");
    ...
    Qpending_activity_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_55 = STATIC_STRING("1q83Py8o836xy09k9l");
    clear_optimized_constants();
    ...
    mutate_global_property(Qpassword,
	    Qget_command_line_plist_element_for_password,
	    Qcommand_line_plist_element_getter);
    list_constant_11 = STATIC_CONS(Qpassword,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
	    list_constant_11,All_known_command_line_plist_elements);
    All_known_command_line_plist_elements = 
    ...
    mutate_global_property(Qlanguage,
	    Qget_command_line_plist_element_for_language,
	    Qcommand_line_plist_element_getter);
    list_constant_12 = STATIC_CONS(Qlanguage,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
	    list_constant_12,All_known_command_line_plist_elements);
    All_known_command_line_plist_elements = 
	    all_known_command_line_plist_elements_new_value;
    ...
    mutate_global_property(Qcjk_language,
	    Qget_command_line_plist_element_for_cjk_language,
	    Qcommand_line_plist_element_getter);
    list_constant_13 = STATIC_CONS(Qcjk_language,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
	    list_constant_13,All_known_command_line_plist_elements);
    All_known_command_line_plist_elements = 
	    all_known_command_line_plist_elements_new_value;
    ...
    mutate_global_property(Qinit_string,
	    Qget_command_line_plist_element_for_init_string,
	    Qcommand_line_plist_element_getter);
    list_constant_14 = STATIC_CONS(Qinit_string,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qdiscard_user_settings,
	    Qget_command_line_plist_element_for_discard_user_settings,
	    Qcommand_line_plist_element_getter);
    list_constant_15 = STATIC_CONS(Qdiscard_user_settings,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Quser_mode,
	    Qget_command_line_plist_element_for_user_mode,
	    Qcommand_line_plist_element_getter);
    list_constant_16 = STATIC_CONS(Quser_mode,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qwindow,
	    Qget_command_line_plist_element_for_window,
	    Qcommand_line_plist_element_getter);
    list_constant_17 = STATIC_CONS(Qwindow,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Quser_name,
	    Qget_command_line_plist_element_for_user_name,
	    Qcommand_line_plist_element_getter);
    list_constant_18 = STATIC_CONS(Quser_name,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qwindowhandle,
	    Qget_command_line_plist_element_for_windowhandle,
	    Qcommand_line_plist_element_getter);
    list_constant_19 = STATIC_CONS(Qwindowhandle,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qwindow_style,
	    Qget_command_line_plist_element_for_window_style,
	    Qcommand_line_plist_element_getter);
    list_constant_20 = STATIC_CONS(Qwindow_style,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qno_native_fonts,
	    Qget_command_line_plist_element_for_no_native_fonts,
	    Qcommand_line_plist_element_getter);
    list_constant_21 = STATIC_CONS(Qno_native_fonts,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qnative_fonts,
	    Qget_command_line_plist_element_for_native_fonts,
	    Qcommand_line_plist_element_getter);
    list_constant_22 = STATIC_CONS(Qnative_fonts,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qno_native_clipboard,
	    Qget_command_line_plist_element_for_no_native_clipboard,
	    Qcommand_line_plist_element_getter);
    list_constant_23 = STATIC_CONS(Qno_native_clipboard,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qg2passwdexe,
	    Qget_command_line_plist_element_for_g2passwdexe,
	    Qcommand_line_plist_element_getter);
    list_constant_24 = STATIC_CONS(Qg2passwdexe,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_20 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)0L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)1L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)2L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)3L,(SI_Long)66L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)4L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)5L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)6L,(SI_Long)75L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)7L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)8L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)9L,(SI_Long)71L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)10L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)11L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)12L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)13L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)14L,(SI_Long)82L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)15L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_20,(SI_Long)22L,(SI_Long)16L);
    ...
    mutate_global_property(Qno_backing_store,
	    Qget_command_line_plist_element_for_no_backing_store,
	    Qcommand_line_plist_element_getter);
    list_constant_25 = STATIC_CONS(Qno_backing_store,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_21 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)0L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)1L,(SI_Long)82L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)2L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)3L,(SI_Long)86L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)4L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)5L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)6L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)7L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)8L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)9L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)10L,(SI_Long)76L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)11L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)12L,(SI_Long)82L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)13L,(SI_Long)77L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)14L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_21,(SI_Long)15L,(SI_Long)80L);
    ...
    mutate_global_property(Qprivate_colormap,
	    Qget_command_line_plist_element_for_private_colormap,
	    Qcommand_line_plist_element_getter);
    list_constant_26 = STATIC_CONS(Qprivate_colormap,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qfile_operation_timeout,
	    Qget_command_line_plist_element_for_file_operation_timeout,
	    Qcommand_line_plist_element_getter);
    list_constant_27 = STATIC_CONS(Qfile_operation_timeout,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_22 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)0L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)1L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)2L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)3L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)4L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)5L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)6L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)7L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)8L,(SI_Long)77L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)9L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)10L,(SI_Long)76L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)11L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)12L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)13L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)14L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_22,(SI_Long)15L,(SI_Long)78L);
    ...
    mutate_global_property(Quse_os_emulation,
	    Qget_command_line_plist_element_for_use_os_emulation,
	    Qcommand_line_plist_element_getter);
    list_constant_28 = STATIC_CONS(Quse_os_emulation,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qcopy_messages_on_logbook,
	    Qget_command_line_plist_element_for_copy_messages_on_logbook,
	    Qcommand_line_plist_element_getter);
    list_constant_29 = STATIC_CONS(Qcopy_messages_on_logbook,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qcopy_logbook_on_console,
	    Qget_command_line_plist_element_for_copy_logbook_on_console,
	    Qcommand_line_plist_element_getter);
    list_constant_30 = STATIC_CONS(Qcopy_logbook_on_console,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qdebug_frame_reference_balance,
	    Qget_command_line_plist_element_for_debug_frame_reference_balance,
	    Qcommand_line_plist_element_getter);
    list_constant_31 = STATIC_CONS(Qdebug_frame_reference_balance,
	    FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_23 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)0L,(SI_Long)88L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)1L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)2L,(SI_Long)76L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)3L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_23,(SI_Long)4L,(SI_Long)80L);
    ...
    mutate_global_property(Qxclip,
	    Qget_command_line_plist_element_for_xclip,
	    Qcommand_line_plist_element_getter);
    list_constant_32 = STATIC_CONS(Qxclip,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_24 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)0L,(SI_Long)66L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)1L,(SI_Long)65L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)2L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)3L,(SI_Long)75L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)4L,(SI_Long)71L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)5L,(SI_Long)82L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)6L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)7L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)8L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)9L,(SI_Long)68L);
    UBYTE_16_ISASET_1(array_constant_24,(SI_Long)14L,(SI_Long)10L);
    ...
    mutate_global_property(Qbackground,
	    Qget_command_line_plist_element_for_background,
	    Qcommand_line_plist_element_getter);
    list_constant_33 = STATIC_CONS(Qbackground,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    list_constant_34 = STATIC_LIST((SI_Long)2L,Qclassic,Qab_standard);
    SET_SYMBOL_VALUE(Qknown_ui_styles,list_constant_34);
    string_constant_22 = 
    ...
    UBYTE_16_ISASET_1(array_constant_25,(SI_Long)1L,(SI_Long)73L);
    ...
    mutate_global_property(Qui,Qget_command_line_plist_element_for_ui,
	    Qcommand_line_plist_element_getter);
    list_constant_35 = STATIC_CONS(Qui,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qnetinfo,
	    Qget_command_line_plist_element_for_netinfo,
	    Qcommand_line_plist_element_getter);
    list_constant_36 = STATIC_CONS(Qnetinfo,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_26 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)0L,(SI_Long)86L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)1L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)2L,(SI_Long)82L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)3L,(SI_Long)66L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)4L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)5L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)6L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_26,(SI_Long)14L,(SI_Long)7L);
    ...
    mutate_global_property(Qverbose,
	    Qget_command_line_plist_element_for_verbose,
	    Qcommand_line_plist_element_getter);
    list_constant_37 = STATIC_CONS(Qverbose,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
	    list_constant_37,All_known_command_line_plist_elements);
    All_known_command_line_plist_elements = 
	    all_known_command_line_plist_elements_new_value;
    ...
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)1L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)2L,(SI_Long)76L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)3L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)4L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)5L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_27,(SI_Long)14L,(SI_Long)6L);
    ...
    mutate_global_property(Qsilent,
	    Qget_command_line_plist_element_for_silent,
	    Qcommand_line_plist_element_getter);
    list_constant_38 = STATIC_CONS(Qsilent,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    mutate_global_property(Qexit_on_abort,
	    Qget_command_line_plist_element_for_exit_on_abort,
	    Qcommand_line_plist_element_getter);
    list_constant_39 = STATIC_CONS(Qexit_on_abort,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_28 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)0L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)1L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)2L,(SI_Long)120L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)3L,(SI_Long)105L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)4L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)5L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)6L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)7L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)8L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)9L,(SI_Long)97L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)10L,(SI_Long)98L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)11L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)12L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)13L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_28,(SI_Long)22L,(SI_Long)14L);
    ...
    mutate_global_property(Quse_jit,
	    Qget_command_line_plist_element_for_use_jit,
	    Qcommand_line_plist_element_getter);
    list_constant_40 = STATIC_CONS(Quse_jit,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_29 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)0L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)1L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)2L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)3L,(SI_Long)85L);
    UBYTE_16_ISASET_1(array_constant_29,(SI_Long)4L,(SI_Long)82L);
    ...
    mutate_global_property(Qsecure,
	    Qget_command_line_plist_element_for_secure,
	    Qcommand_line_plist_element_getter);
    list_constant_41 = STATIC_CONS(Qsecure,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    UBYTE_16_ISASET_1(array_constant_30,(SI_Long)4L,(SI_Long)114L);
    ...
    mutate_global_property(Qcert,Qget_command_line_plist_element_for_cert,
	    Qcommand_line_plist_element_getter);
    list_constant_42 = STATIC_CONS(Qcert,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    array_constant_31 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)8L));
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)0L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)1L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)2L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_31,(SI_Long)6L,(SI_Long)3L);
    ...
    array_constant_32 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)0L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)1L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)2L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)3L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)4L,(SI_Long)76L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)5L,(SI_Long)79L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)6L,(SI_Long)71L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)7L,(SI_Long)45L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)8L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)9L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)10L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)11L,(SI_Long)69L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)12L,(SI_Long)78L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)13L,(SI_Long)83L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)14L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)15L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_32,(SI_Long)16L,(SI_Long)89L);
    ...
    mutate_global_property(Qicp_log_intensity,
	    Qget_command_line_plist_element_for_icp_log_intensity,
	    Qcommand_line_plist_element_getter);
    list_constant_43 = STATIC_CONS(Qicp_log_intensity,FIX((SI_Long)0L));
    all_known_command_line_plist_elements_new_value = adjoin(2,
    ...
    string_constant_56 = 
	    STATIC_STRING("43Dy8l83my1n83my8m8k1l8m0000000krk0k0");
    ...
    Qforeign_struct_info_structure_memory_usage = 
	    ...
	    AB_package);
    string_constant_57 = STATIC_STRING("1q83my8o835wy09k9l");
    clear_optimized_constants();
    ...
    string_constant_58 = 
	    STATIC_STRING("43Dy8l83jy1n83jy8m8k1l8m0000001m1m8n831ky1m8q833Eykqk0k0");
    ...
    string_constant_59 = STATIC_STRING("1q83jy8o835sy09k9l");
    clear_optimized_constants();
    ...
    string_constant_36 = STATIC_STRING("Host: ~a");
    string_constant_37 = STATIC_STRING("; ~a: ~a~a");
    string_constant_38 = STATIC_STRING("~%Expiration Day:~a~%");
    string_constant_39 = STATIC_STRING("~%");
    string_constant_40 = STATIC_STRING("(Unknown Host)");
    array_constant_34 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)0L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)1L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)2L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)3L,(SI_Long)95L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)4L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_34,(SI_Long)5L,(SI_Long)80L);
    ...
    array_constant_35 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)16L));
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)0L,(SI_Long)84L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)1L,(SI_Long)67L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)2L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)3L,(SI_Long)47L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)4L,(SI_Long)73L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)5L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)6L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)7L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)8L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)9L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)10L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)14L,(SI_Long)11L);
    UBYTE_16_ISASET_1(array_constant_35,(SI_Long)15L,(SI_Long)57344L);
    array_constant_36 = STATIC_ARRAY(list_constant_1,(SI_Long)1L,
	    FIX((SI_Long)24L));
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)0L,(SI_Long)117L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)1L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)2L,(SI_Long)107L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)3L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)4L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)5L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)6L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)7L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)8L,(SI_Long)110L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)9L,(SI_Long)101L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)10L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)11L,(SI_Long)119L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)12L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)13L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)14L,(SI_Long)107L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)15L,(SI_Long)32L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)16L,(SI_Long)80L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)17L,(SI_Long)111L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)18L,(SI_Long)114L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)19L,(SI_Long)116L);
    UBYTE_16_ISASET_1(array_constant_36,(SI_Long)22L,(SI_Long)20L);
