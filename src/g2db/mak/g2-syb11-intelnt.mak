# ==========================================================================
#
#              make file to create g2-sybase.exe for Windows
#
...
#
#           nmake /f %SRCBOX%\g2db\mak\g2-syb11-intel.mak
#
...
#
#        nmake gsiab=t /f %SRCBOX%\g2db\mak\g2-syb11-intel.mak
#                  
# ==========================================================================
# Defines
# -------
...
XDBDIR = k:\gensym\bridges\intelnt\dbs\sybase\1110
...
!IF "$(GSIDIR)" == ""
!IF DEFINED(gsiab)
GSIDIR = k:\bt\ab\dst\$(PLATFM)\gsi\tape
!ELSE
GSIDIR = $(SRCBOX)\dst\$(PLATFM)\gsi\tape
!ENDIF
!ENDIF

# Executable:
# -----------
g2-syb11.exe:               settings                            \
                            gdb_main.obj                        \
                            gdb_g2_server.obj                   \
                            gdb_common.obj                      \
                            gdb_utils.obj                       \
                            ...
                            gdb_client_syb.obj                  \
                            g2-syb11.res                        
	@link -out:g2-syb11.exe -nologo  -incremental:no -machine:I386 -nodefaultlib:libc.lib        \
        ...
        gdb_client_inter_syb.obj gdb_client_syb.obj g2-syb11.res                                     \
...
gdb_client_inter_syb.obj:   $(GDBDIR)\gdb_client_inter_syb.c    \
                            ...
                            $(GDBDIR)\gdb_utils.h               \
                            $(GDBDIR)\gdb_common.h
	@cl -c  -nologo -ML -W3 -GX -O2 -I$(GDBDIR) -I$(GSIDIR) -I$(XDBDIR)/include -D$(DBNAME) -DWIN32 $(GDBDIR)/gdb_client_inter_syb.c
...
gdb_client_syb.obj:         gdb_client_syb.c                    \
                            ...
                            $(GDBDIR)\gdb_common.h              \
                            $(GDBDIR)\gdb_g2_client.h
	@cl -c -nologo -ML -W3 -GX -O2 -DWIN32 -D iDBVER=$(DB_GRP) -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/include -D$(DBNAME) gdb_client_syb.c
...
# Resources
# ---------
g2-syb11.res:               $(GDBDIR)\g2-syb11.rc               \
                            $(GDBDIR)\sybase_res.h              \
                            $(GDBDIR)\sybase.ico
	@rc.exe /l 0x409 /d "NDEBUG" /fog2-syb11.res $(GDBDIR)\g2-syb11.rc
	@dir /b g2-syb11.res
...
settings:
	@echo "+=====================================================================
	@echo "|  BUILDING G2-SYB11.exe ($(BLDCOD)) on $(PLATFM) ($(OSCODE))
	@echo "+=====================================================================
	@echo "|
	@echo "| ENVIRONMENT
