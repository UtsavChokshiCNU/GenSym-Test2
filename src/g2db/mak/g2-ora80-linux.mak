...
DB_GRP = 8
DBNAME = ORACLE
XDBDIR = /gensym/spare/bridges/linux/dbs/oracle/806
...
g2-ora80:                   settings                            \
                            ...
                            gdb_client_ora.o
	@cc -o g2-ora80 -L$(XDBDIR)/lib -L${GSIDIR}                           \
            gdb_main.o gdb_g2_server.o gdb_common.o gdb_utils.o gsi_brg.o     \
            ${SPECFC}/nsleep.o gdb_client_inter_ora.o gdb_client_ora.o        \
            -lgsi -ltcp -lnogsec -lrtl -lclient $(XDBDIR)/lib/libsql.a        \
            $(XDBDIR)/lib/scorept.o $(XDBDIR)/lib/sscoreed.o                  \
            $(XDBDIR)/rdbms/lib/kpudfo.o $(XDBDIR)/lib/nautab.o               \
            $(XDBDIR)/lib/naeet.o $(XDBDIR)/lib/naect.o $(XDBDIR)/lib/naedhs.o\
            `cat $(XDBDIR)/lib/naldflgs` -lnetv2 -lnttcp -lnetwork -lncr      \
            ...
            -lgeneric -lplsf -lplsb -lepc -lnlsrtl3 -lcore4 -lnlsrtl3 -lcore4 \
            -lnlsrtl3 -lclient -lvsn -lcommon -lgeneric -lnlsrtl3  -lcore4    \
            -lnlsrtl3 -lcore4 -lnlsrtl3 `cat $(XDBDIR)/lib/sysliblist` -ldl   \
            -lm $(XDBDIR)/rdbms/lib/xaondy.o
	@chmod +x g2-ora80
	@ls -l g2-ora80
...
gdb_main.o:                 $(GDBDIR)/gdb_main.c                \
	...
	@cc -c -I$(GDBDIR) -I$(GSIDIR) -D$(DBNAME) -D$(PLATFM) -DDB_VER=\"$(DB_VER)\"      \
            -DGSI_VER=\"$(GSIVER)\" -DGDB_VER=\"$(GDBVER)\" -DBUILD_CODE=\"$(BLDCOD)\" \
            $(GDBDIR)/gdb_main.c
	@ls -l gdb_main.o
...
gdb_g2_server.o:            $(GDBDIR)/gdb_g2_server.c           \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_genda.h
	@gcc -c -I$(GDBDIR) -I$(GSIDIR) -DKB_VER=$(KB_VER) -D$(DBNAME) $(GDBDIR)/gdb_g2_server.c
...
gdb_client_ora.o:           gdb_client_ora.c                        \
                            ...
                            $(GDBDIR)/gdb_common.h                  \
                            $(GDBDIR)/gdb_g2_client.h
	@gcc -ansi -c -I$(GDBDIR) -I$(GDBDIR) -I$(GSIDIR) -I$(XDBDIR)/precomp/public \
        -DMAXOPENCURSORS=44 -DHOLD_CURSOR="yes" -DRELEASE_CURSOR="no" -D$(DBNAME) -D iDBVER=$(DB_GRP) gdb_client_ora.c
