...
DB_VER = 8.0
DBNAME = ORACLE
XDBDIR = /gensym/spare/bridges/hp9000s700/dbs/oracle/806
...
g2-ora80:                   settings                            \
                            ...
                            ${SPECFC}/nsleep.o                  \
                            gdb_client_ora.o
	@gcc -L$(XDBDIR)/lib -L${GSIDIR} -O -lm -lclntsh -o g2-ora80\
         gdb_main.o gdb_g2_server.o gdb_common.o gdb_utils.o    \
         gdb_client_inter_ora.o gdb_client_ora.o gsi_brg.o      \
         ${SPECFC}/nsleep.o -lgsi -ltcp -lnogsec -lrtl
	@chmod +x g2-ora80
	@chatr +s enable g2-ora80
	@ls -l g2-ora80
...
gdb_main.o:                 $(GDBDIR)/gdb_main.c                \
                            ...
                            $(GDBDIR)/gdb_utils.h
	@gcc -ansi -c -I$(GDBDIR) -I$(GSIDIR) -D$(DBNAME) -D$(PLATFM) \
             -D DB_VER=\"$(DB_VER)\" -D GSI_VER=\"$(GSIVER)\"     \
