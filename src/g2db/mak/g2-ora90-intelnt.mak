# ==========================================================================
#
#               make file to create g2-ora90.exe for Windows
#
...
#
#              nmake /f %SRCBOX%\g2db\mak\g2-ora90-intel.mak
#
...
XDBDIR = k:\gensym\spare\bridges\intelnt\dbs\oracle\901
...
g2-ora90.exe:               settings                            \
                            ...
                            gdb_client_ora.obj                  \
                            g2-ora90.res
	@link -out:g2-ora90.exe -nologo  -incremental:no -machine:I386 -nodefaultlib:libcmt                    \
        ...
        gdb_client_inter_ora.obj  gdb_client_ora.obj g2-ora90.res                                        \
...
# Resources
# ---------
g2-ora90.res:               $(GDBDIR)\g2-ora90.rc               \
                            $(GDBDIR)\oracle_res.h              \
                            $(GDBDIR)\oracle.ico
	@rc.exe /l 0x409 /d "NDEBUG" /fog2-ora90.res $(GDBDIR)\g2-ora90.rc
	@echo g2-ora90.res
...
settings:
	@echo "+================================================
	@echo "|  BUILDING G2-ORA90 on $(PLATFM)
	@echo "+================================================
	@echo "|                                                
	@echo "| ENVIRONMENT                                    
