...
g2-ora7:                    settings                            \
                            ...
                            gdb_client_ora.o
	@cc -L$(XDBDIR)/lib -L${GSIDIR} -lbsd -lm -lclntsh -o g2-ora7   \
...
gdb_g2_server.o:            $(GDBDIR)/gdb_g2_server.c	        \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_genda.h
	@cc -c -I$(GDBDIR) -I$(GSIDIR) -D$(DBNAME) -DKB_VER=$(KB_VER) $(GDBDIR)/gdb_g2_server.c
...
gdb_client_ora.c:           $(GDBDIR)/gdb_client_ora.pc         \
	...
	@$(XDBDIR)/bin/proc iname=$(GDBDIR)/gdb_client_ora.pc oname=gdb_client_ora.c \
       include=$(GDBDIR) include=$(GDBDIR) include=$(GSIDIR) include=$(XDBDIR)/precomp/public \
