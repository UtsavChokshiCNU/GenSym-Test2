...
DB_GRP = 12
DBNAME = SYBASE
XDBDIR = /gensym/bridges/rs6000/dbs/sybase/1250
...
g2-syb125:                  settings                            \
                            ...
                            gdb_client_syb.o
	@cc -L$(XDBDIR)/OCS-12_5/lib -L${GSIDIR} -O -Drs6000 -o g2-syb125          \
...
gdb_client_syb.o:           gdb_client_syb.c                    \
	...
	@cc -c -I$(GDBDIR) -I$(GDBDIR) -I $(XDBDIR)/OCS-12_5/include -I $(GSIDIR) -D$(DBNAME) gdb_client_syb.c
