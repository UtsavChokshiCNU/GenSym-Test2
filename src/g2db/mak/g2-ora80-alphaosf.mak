...
DB_GRP = 8
DBNAME = ORACLE
XDBDIR = /gensym/spare/bridges/alphaosf/dbs/oracle/806
...
g2-ora80:                   settings                            \
                            ...
                            gdb_client_ora.o
	@cc  -L$(XDBDIR)/lib -L${GSIDIR} -lbsd -lm -lclntsh -o g2-ora80 gdb_main.o     \
             gdb_g2_server.o gdb_common.o gdb_utils.o gdb_client_inter_ora.o gsi_brg.o \
             gdb_client_ora.o ${SPECFC}/nsleep.o -lgsi -ltcp -lnogsec -lrtl /usr/lib/libdb.a
	@chmod +x g2-ora80
	@ls -l g2-ora80
