...
DB_VER = 11
DBNAME = SYBASE
XDBDIR = /gensym/bridges/sparcsol/dbs/sybase/1110
...
g2-syb11:                   settings                            \
                            ...
                            gdb_client_syb.o
	@gcc -ansi -L$(XDBDIR)/lib -L$(GSIDIR) -O -Dsparcsol -o g2-syb11   \
            ...
            -ltli -lgsi -lrtl -ltcp -lnogsec  -ldl -lsocket -lnsl -lm -ldl
	@chmod +x g2-syb11
	@ls -l g2-syb11
...
gdb_client_syb.o:           gdb_client_syb.c                    \
	...
	@gcc -ansi -c -I$(GDBDIR) -I$(GDBDIR) -I $(XDBDIR)/include -I $(GSIDIR) -D$(DBNAME) gdb_client_syb.c
