# ==========================================================================
#
#               make file to create g2-ora10.exe for Windows
#
...
#
#              nmake /f %SRCBOX%\g2db\mak\g2-ora100-intel.mak
#
...
XDBDIR = k:\gensym\bridges\intelnt\dbs\oracle\1020
...
g2-ora10.exe:               settings                            \
                            ...
                            gdb_client_ora.obj                  \
                            g2-ora10.res
        @link -out:g2-ora10.exe -nologo  -incremental:no -machine:I386 -nodefaultlib:libcmt              \
        ...
        gdb_client_inter_ora.obj  gdb_client_ora.obj g2-ora10.res                                        \
        librtl.lib libgsi.lib libtcp.lib libnogsec.lib advapi32.lib gdi32.lib kernel32.lib netapi32.lib               \
        shell32.lib user32.lib uuid.lib winspool.lib wsock32.lib orasql10.lib spromeps.lib rpcrt4.lib
        @echo g2-ora10.exe
...
# Resources
# ---------
g2-ora10.res:               $(GDBDIR)\g2-ora10.rc               \
                            $(GDBDIR)\oracle_res.h              \
                            $(GDBDIR)\oracle.ico
        @rc.exe /l 0x409 /d "NDEBUG" /fog2-ora10.res $(GDBDIR)\g2-ora10.rc
        @echo g2-ora10.res
...
settings:
	@echo "+================================================
	@echo "|  BUILDING G2-ORA10 on $(PLATFM)
	@echo "+================================================
	@echo "|                                                
	@echo "| ENVIRONMENT                                    
