...
DB_GRP = 11
DBNAME = ORACLE
XDBDIR = ${SRCBOX}/g2db/dbs/$(PLATFM)/oracle/instantclient_11_2
...
g2-ora11:                   settings                            \
                            ...
                            gdb_client_ora11.o
	@cd $(EXEDIR)
	@$(GCC) -L$(XDBDIR) -L${GSIDIR} -L${EXTDIR} -L${RTLDIR} -o g2-ora11 \
		-Wl,--wrap=memcpy ${EXTDIR}/nsleep.o \
		gdb_main.o gdb_g2_server.o gdb_common.o \
	        gdb_utils.o gsi_brg.o gdb_client_inter_ora.o gdb_client_ora11.o \
...
gdb_client_ora11.o:         gdb_client_ora11.c                  \
                            $(GDBDIR)/gdb_globals.h             \
                            $(GDBDIR)/gdb_client_ora.h          \
                            $(GDBDIR)/gdb_globals.h             \
                            $(GDBDIR)/gdb_messages.h            \
	...
	@$(CC) -c -D $(PLATFM) -D iDBVER=$(DB_GRP) -I$(GDBDIR) -I$(GSICDIR) -I$(GDBDIR) -I$(XDBDIR)/sdk/include \
        -DORA09 -DHYBRID -DMAXOPENCURSORS=44 -DHOLD_CURSOR="yes" -DRELEASE_CURSOR="no" -D$(DBNAME) gdb_client_ora11.c
	@ls -l gdb_client_ora11.o

# Precompiler
# -----------
gdb_client_ora11.c:         $(GDBDIR)/gdb_client_ora.pc         \
                            $(GDBDIR)/gdb_client_ora.h          \
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_context.h             \
                            $(GDBDIR)/gdb_g2_client.h           \
	...
	@$(XDBDIR)/sdk/proc iname=$(GDBDIR)/gdb_client_ora.pc oname=gdb_client_ora11.c \
...
clean :
	@- rm *.o 2> /dev/null
	@- rm tp* 2> /dev/null
	@- rm gdb_client_ora11.c 2> /dev/null

# Report:
# -------
settings:
	@echo "+================================================"
	@echo "|  BUILDING G2-ORA11 (${BLDCOD}) on $(PLATFM)    "
	@echo "+================================================"
	@echo "|                                                "
	@echo "| ENVIRONMENT                                    "
