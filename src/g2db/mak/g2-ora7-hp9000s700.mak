...
g2-ora7:                            settings                    \
                                    ...
                                    gdb_client_ora.o
	@gcc -L$(XDBDIR)/lib -L${GSIDIR} -o g2-ora7                 \
             gdb_main.o gdb_g2_server.o gdb_common.o gdb_utils.o\
             gdb_client_inter_ora.o gdb_client_ora.o gsi_brg.o  \
             ${SPECFC}/nsleep.o -lgsi -ltcp -lnogsec -lrtl -lsql -lsqlnet\
             -lncr -lsqlnet -lclient -lcommon -lgeneric -lsqlnet\
             -lncr -lsqlnet -lclient -lcommon -lgeneric -lepc   \
             -lnlsrtl3 -lc3v6 -lcore3 -lnlsrtl3 -lcore3         \
             -lnlsrtl3 `cat $(XDBDIR)/rdbms/lib/sysliblist` -lm \
             -l:libcma.sl
	@chmod +x g2-ora7
	@chatr +s enable g2-ora7
	@ls -l g2-ora7
...
gdb_client_ora.o:           gdb_client_ora.c                    \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_g2_client.h
	@gcc -ansi -c -D$(PLATFM) -DiDBVER=$(DB_VER) -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/precomp/public \
