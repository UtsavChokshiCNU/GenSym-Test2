...
DB_VER = 5.1
DBNAME = SYBASE
XDBDIR = /gensym/bridges/hp9000s700/dbs/sybase/1110
...
g2-syb11:                   settings                            \
                            ...
                            gdb_client_syb.o
	@gcc -ansi -L$(XDBDIR)/lib -L${GSIDIR} -O -Wl,+s,+vallcompatwarnings -static -Dhp9000s700   \
        -o g2-syb11 gdb_main.o gdb_g2_server.o gdb_utils.o gdb_common.o gdb_client_inter_syb.o      \
        gdb_client_syb.o gsi_brg.o ${SPECFC}/nsleep.o -lct -lcs -ltcl -lcomn -lintl -Wl,-a,default  \
        -linsck -lgsi -lrtl -ltcp -lnogsec -lcl -lm -lBSD
	@chmod +x g2-syb11
	@chatr +s enable g2-syb11
	@ls -l g2-syb11
...
gdb_client_inter_syb.o:     $(GDBDIR)/gdb_globals.h             \
	...
	@gcc -ansi -c  -I$(GDBDIR) -I$(GSIDIR) -I$(XDBDIR)/include -D$(DBNAME) $(GDBDIR)/gdb_client_inter_syb.c
...
gdb_client_syb.o:           $(GDBDIR)/gdb_globals.h             \
                            ...
                            gdb_client_syb.c
	@gcc -ansi -c -D $(PLATFM) -D iDBVER=$(DB_VER) -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/include \
...
gdb_client_syb.c:           $(GDBDIR)/gdb_client_syb.cp 
	@$(XDBDIR)/bin/cpre -CKR_C -I $(GDBDIR) -I $(XDBDIR)/include -O gdb_client_syb.c $(GDBDIR)/gdb_client_syb.cp
