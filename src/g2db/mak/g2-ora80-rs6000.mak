...
DB_VER = 8.0
DBNAME = ORACLE
XDBDIR = /gensym/spare/bridges/rs6000/dbs/oracle/806
...
gdb_client_ora.o:           gdb_client_ora.c                    \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_g2_client.h
	@cc -c -D $(PLATFM) -D iDBVER=$(DB_VER) -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/precomp/public \
