...
DB_VER = 9
DBNAME = ORACLE
XDBDIR = /gensym/bridges/hp9000s700/dbs/oracle/901
LLBDIR = $(XDBDIR)/lib32
...
g2-ora90:                   settings                            \
                            ...
                            gdb_client_ora.o
	@gcc -o g2-ora90 -L$(LLBDIR) -L${GSIDIR} \
        gdb_main.o gdb_g2_server.o gdb_common.o gdb_utils.o gdb_client_inter_ora.o \
        gdb_client_ora.o gsi_brg.o ${SPECFC}/nsleep.o -lgsi -ltcp -lnogsec -lrtl -lclntst9  \
        `cat $(LLBDIR)/ldflags` `cat $(LLBDIR)/sysliblist` -lm  -lpthread -lpthread\
        -lclntst9 `cat $(LLBDIR)/ldflags` `cat $(LLBDIR)/sysliblist` -lm  -lpthread -lpthread
	@chmod +x g2-ora90
	@chatr +s enable g2-ora90
	@ls -l g2-ora90
