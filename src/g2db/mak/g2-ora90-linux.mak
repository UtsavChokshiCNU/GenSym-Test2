...
DB_GRP = 9
DBNAME = ORACLE
XDBDIR = /gensym/bridges/linux/dbs/oracle/901
...
g2-ora90:                   settings                            \
                            ...
                            gdb_client_ora.o
	@cd $(EXEDIR)
	@cc  -L$(XDBDIR)/lib -L${GSIDIR} -o g2-ora90 gdb_main.o gdb_g2_server.o gdb_common.o  \
        gdb_utils.o gsi_brg.o ${SPECFC}/nsleep.o gdb_client_inter_ora.o gdb_client_ora.o  \
        -lgsi -ltcp -lnogsec -lrtl -lclntst9 `cat $(XDBDIR)/lib/ldflags`                  \
...
gdb_common.o:               $(GDBDIR)/gdb_common.c              \
	...
	@cc -c -I$(GDBDIR) -I$(GSIDIR) -D$(DBNAME) -DORA90LNX $(GDBDIR)/gdb_common.c
	@ls -l gdb_common.o
...
gdb_client_ora.o:           gdb_client_ora.c                    \
	...
	@cc -c -D $(PLATFM) -D iDBVER=$(DB_GRP) -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/precomp/public \
        -DORA09 -DMAXOPENCURSORS=44 -DHOLD_CURSOR="yes" -DRELEASE_CURSOR="no" -D$(DBNAME) gdb_client_ora.c
...
gdb_client_ora.c:           $(GDBDIR)/gdb_client_ora.pc         \
	...
	@$(XDBDIR)/bin/proc iname=$(GDBDIR)/gdb_client_ora.pc oname=gdb_client_ora.c \
        include=$(GDBDIR)  include=$(GSIDIR) include=$(XDBDIR)/precomp/public \
