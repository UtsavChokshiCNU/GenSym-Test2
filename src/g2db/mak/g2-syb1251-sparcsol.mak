...
DB_VER = 12.5.1
DBNAME = SYBASE
XDBDIR = /gensym/bridges/sparcsol/dbs/sybase/1251
...
g2-syb1251:                 settings                            \
                            ...
                            gdb_client_syb.o
	@gcc -ansi -L$(XDBDIR)/$(SYBASE_OCS)/lib -L$(GSIDIR) -O -Dsparcsol -o g2-syb1251 \
...
gdb_client_syb.c: 		$(GDBDIR)/gdb_client_syb.cp
	@$(XDBDIR)/$(SYBASE_OCS)/bin/cpre -Cansi_c -I $(GDBDIR) -I $(XDBDIR)/$(SYBASE_OCS)/include \
...
settings:
	@echo "+===============================================================
	@echo "|  BUILDING G2-SYB1251 (${BLDCOD}) on $(PLATFM)
	@echo "+===============================================================
	@echo "|
	@echo "| ENVIRONMENT
