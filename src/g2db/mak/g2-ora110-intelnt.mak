# ==========================================================================
#
#               make file to create g2-ora11.exe for Windows
#
#    - make sure that SRCBOX and DSTBOX are defined
#    - cd to destination directory (typically %DSTBOX%\g2oracle\opt)
#    - Supervisor will build the bridge with:
#
#              nmake /f %SRCBOX%\g2db\mak\g2-ora110-intel.mak
#
...
XDBDIR = C:\app\Administrator\product\11.2.0\client_2
...
g2-ora11.exe:               settings                            \
                            ...
                            gdb_client_ora.obj                  \
                            g2-ora11.res
        @link -out:g2-ora11.exe -nologo  -incremental:no -machine:I386 -nodefaultlib:libcmt              \
        ...
        gdb_client_inter_ora.obj  gdb_client_ora.obj g2-ora11.res                                        \
        librtl.lib libgsi.lib libtcp.lib libnogsec.lib advapi32.lib gdi32.lib kernel32.lib netapi32.lib               \
        shell32.lib user32.lib uuid.lib winspool.lib wsock32.lib orasql11.lib spromeps.lib rpcrt4.lib
        @echo g2-ora11.exe
...
gdb_main.obj:               $(GDBDIR)\gdb_main.c                \
        ...
        -I$(GDBDIR) -I$(GSISRC) -D$(DBNAME) -D$(OSCODE) -DDB_VER=\"$(DB_VER)\" \
...
gdb_g2_server.obj:          $(GDBDIR)\gdb_g2_server.c           \
                            ...
                            $(GDBDIR)\gdb_common.h              \
                            $(GDBDIR)\gdb_genda.h
        @cl -c -nologo -ML -W3 -GX -O2 -I$(GDBDIR) -I$(GSISRC) -DKB_VER=$(KB_VER) -D$(DBNAME) $(GDBDIR)\gdb_g2_server.c
...
gdb_common.obj:             $(GDBDIR)\gdb_common.c              \
        ...
        @cl -c -nologo -ML -W3 -GX -O2 -I$(GDBDIR) -I$(GSISRC) $(GDBDIR)\gdb_common.c

gdb_utils.obj:              $(GDBDIR)\gdb_utils.c               \
                            $(GDBDIR)\gdb_globals.h
        @cl -c -nologo -ML -W3 -GX -O2 -I$(GDBDIR) -I$(GSISRC) $(GDBDIR)\gdb_utils.c
...
gdb_client_inter_ora.obj:   $(GDBDIR)\gdb_client_inter_ora.c    \
                            ...
                            $(GDBDIR)\gdb_utils.h               \
                            $(GDBDIR)\gdb_common.h
        @cl -c  -nologo -ML -W3 -GX -O2 -I$(GDBDIR) -I$(GSISRC) -I$(XDBDIR)\precomp\public -DWIN32 $(GDBDIR)\gdb_client_inter_ora.c
...
gdb_client_ora.obj:         gdb_client_ora.c                    \
        ...
        -I$(GDBDIR) -I$(GSISRC) -I$(GDBDIR) -I$(XDBDIR)\precomp\public gdb_client_ora.c
...
# Resources
# ---------
g2-ora11.res:               $(GDBDIR)\g2-ora11.rc               \
                            $(GDBDIR)\oracle_res.h              \
                            $(GDBDIR)\oracle.ico
        @rc.exe /l 0x409 /d "NDEBUG" /fog2-ora11.res $(GDBDIR)\g2-ora11.rc
        @echo g2-ora11.res
...
settings:
        @echo "+================================================
        @echo "|  BUILDING G2-ORA11 on $(PLATFM)
        @echo "+================================================
        @echo "|                                                
        @echo "| ENVIRONMENT                                    
