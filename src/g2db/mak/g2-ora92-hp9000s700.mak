...
DB_VER = 9
DBNAME = ORACLE
XDBDIR = /gensym/spare/bridges/hp9000s700/dbs/oracle/920
LLBDIR = $(XDBDIR)/lib32
...
g2-ora92:                   settings                            \
                            ...
                            gdb_client_ora.o
	@gcc -o g2-ora92 -L$(LLBDIR) -L${GSIDIR} \
        gdb_main.o gdb_g2_server.o gdb_common.o gdb_utils.o gdb_client_inter_ora.o \
        gdb_client_ora.o gsi_brg.o ${SPECFC}/nsleep.o -lgsi -ltcp -lnogsec -lrtl -lclntsh  \
        `cat $(LLBDIR)/ldflags` `cat $(LLBDIR)/sysliblist` -lm  -lpthread -lpthread\
        -lclntsh `cat $(LLBDIR)/ldflags` `cat $(LLBDIR)/sysliblist` -lm  -lpthread -lpthread
	@chmod +x g2-ora92
	@chatr +s enable g2-ora92
	@ls -l g2-ora92
...
gdb_client_ora.o:           gdb_client_ora.c                    \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_g2_client.h
	@gcc -ansi -c -D $(PLATFM) -D iDBVER=$(DB_VER) -DORA09 -I$(GDBDIR) -I$(GSIDIR) -I$(GDBDIR) -I$(XDBDIR)/precomp/public \
...
settings:
	@echo "+================================================
	@echo "|  BUILDING G2-ORA92 (${BLDCOD}) on $(PLATFM)
	@echo "+================================================
	@echo "|
	@echo "| ENVIRONMENT
