...
DB_GRP = 12
DBNAME = SYBASE
XDBDIR = /gensym/bridges/rs6000/dbs/sybase/1200
...
g2-syb12:                   settings                            \
                            ...
                            gdb_client_syb.o
	@cc -L$(XDBDIR)/OCS-12_0/lib -L${GSIDIR} -O -Drs6000 -o g2-syb12           \
...
gdb_client_inter_syb.o:     $(GDBDIR)/gdb_client_inter_syb.c    \
                            ...
                            $(GDBDIR)/gdb_utils.h               \
                            $(GDBDIR)/gdb_common.h          
	@cc -c  -I$(GDBDIR) -I$(GSIDIR) -I$(XDBDIR)/OCS-12_0/include -D$(DBNAME) $(GDBDIR)/gdb_client_inter_syb.c
...
gdb_client_syb.o:           gdb_client_syb.c                    \
	...
	@cc -c -I$(GDBDIR) -I$(GDBDIR) -I $(XDBDIR)/OCS-12_0/include -I $(GSIDIR) -D$(DBNAME) gdb_client_syb.c
	@ls -l gdb_client_syb.o

# Precompiler
# -----------
gdb_client_syb.c:           $(GDBDIR)/gdb_client_syb.cp
	@$(XDBDIR)/OCS-12_0/bin/cpre -CKR_C -I $(GDBDIR) -I $(XDBDIR)/OCS-12_0/include \
      -O gdb_client_syb.c $(GDBDIR)/gdb_client_syb.cp
	@sed -e /^"# line"/d gdb_client_syb.c > lineless.c
	@mv lineless.c gdb_client_syb.c
...
settings:
	@echo "+=======================================================================
	@echo "|  BUILDING G2-SYB12 (${BLDCOD}) on $(PLATFM) ($(OSCODE))
	@echo "+=======================================================================
	@echo "|
	@echo "| ENVIRONMENT
