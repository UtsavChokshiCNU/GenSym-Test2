...
g2-ora7:                    settings                            \
                            ...
                            gdb_client_ora.o
	@gcc -ansi -O2 -L$(XDBDIR)/lib -L${GSIDIR} -O -Dsparcsol    \
             -lsocket -lnsl -lm  -o g2-ora7  gdb_main.o         \
             gdb_g2_server.o gdb_utils.o gdb_common.o           \
             gdb_client_inter_ora.o gdb_client_ora.o gsi_brg.o  \
             ${SPECFC}/nsleep.o -lgsi -lrtl -ltcp -lnogsec -lclntsh\
             -lsocket -lnsl -lm -ldl
	@chmod +x g2-ora7
	@ls -l g2-ora7
...
gdb_client_ora.o:           gdb_client_ora.c                    \
                            ...
                            $(GDBDIR)/gdb_common.h              \
                            $(GDBDIR)/gdb_g2_client.h
	@gcc -ansi -c -I$(GDBDIR) -I$(GDBDIR) -I$(GSIDIR) -I$(XDBDIR)/precomp/public -DiDBVER=$(DB_VER)\
