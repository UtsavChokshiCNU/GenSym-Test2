...
# Entering /build/s630/buildtools/mkfile/prefix.mk

# Entering /build/s630/buildtools/mkfile/defs.mk
...
# Exiting /build/s630/buildtools/mkfile/defs.mk
# Entering /build/s630/buildtools/mkfile/platform.mk
...
LINK32=$(PURECMDS) gcc $(LDFLAGS32) $(COMPSOBJS)
...
ROFLAGS=-c
SPFLAGS=-DLINUX -DORAX86_64 -D_GNU_SOURCE -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -DSLTS_ENABLE -DSLMXMX_ENABLE -D_REENTRANT -DNS_THREADS -DLONG_IS_64 -fno-strict-aliasing -DSS_64BIT_SERVER
SPFLAGS32=-DLINUX -D_GNU_SOURCE -D_LARGEFILE64_SOURCE=1 -D_LARGEFILE_SOURCE=1 -DSLTS_ENABLE -DSLMXMX_ENABLE -D_REENTRANT -DNS_THREADS -fno-strict-aliasing
ifeq ($(BUILD32),T)
SPFLAGS=$(SPFLAGS32)
endif
...
ifdef BUILD_CC
	...
	CC=$(COMPDIR)/bin/icc
	CPP=$(CC) -E
	CFLAGS += $(OPTIMIZE) -ip -fp -mp1 -fp_port $(PROFILE) -no-global-hoist
else
	CC=/usr/bin/gcc
	CPP=/lib/cpp
...
CCC=$(COMPDIR)/bin/icpc
CCFLAGSCC=-DOCCI_NO_WSTRING=1 -cxxlib-gcc $(KPIC_OPTION)
...
SHLIB_LD=gcc -o $(_FULL_LIBNAME) -shared -L$(BOOTSTRAPLIB) -L$(LIBHOME) -L$(PRODLIBHOME) -L$(LIBHOME)stubs/
...
# Exiting /build/s630/buildtools/mkfile/platform.mk
# Entering /build/s630/buildtools/mkfile/rules.mk
 
# Exiting /build/s630/buildtools/mkfile/rules.mk
# Exiting /build/s630/buildtools/mkfile/prefix.mk
# Entering /build/s630/ldap/exports.mk
...
# Entering /build/s630/ldap/s_exports.mk


# Exiting /build/s630/ldap/s_exports.mk
# Exiting /build/s630/ldap/exports.mk
# Entering /build/s630/encryption/exports.mk
...
# Entering /build/s630/encryption/s_exports.mk

# Exiting /build/s630/encryption/s_exports.mk
# Exiting /build/s630/encryption/exports.mk
# Entering /build/s630/network/exports.mk
...
# Entering /build/s630/network/adapters.mk

# Entering /build/s630/network/s_adapters.mk

# Exiting /build/s630/network/s_adapters.mk

# Entering /build/s630/network/libnames.mk
...
# Exiting /build/s630/network/libnames.mk

# Exiting /build/s630/network/adapters.mk
...
# Entering /build/s630/network/s_exports.mk
...
# Exiting /build/s630/network/s_exports.mk
# Exiting /build/s630/network/exports.mk
# Entering /build/s630/oracore/exports.mk
...
# Entering /build/s630/oracore/s_exports.mk
 
# Exiting /build/s630/oracore/s_exports.mk
# Exiting /build/s630/oracore/exports.mk
# Entering /build/s630/nlsrtl/exports.mk
...
# Entering /build/s630/nlsrtl/s_exports.mk
...
# Exiting /build/s630/nlsrtl/s_exports.mk
# Exiting /build/s630/nlsrtl/exports.mk
# Entering /build/s630/rdbms/exports.mk
...
# Entering /build/s630/rdbms/s_exports.mk
...
# Exiting /build/s630/rdbms/s_exports.mk
# Exiting /build/s630/rdbms/exports.mk
# Entering /build/s630/plsql/exports.mk
...
# Entering /build/s630/plsql/s_exports.mk
 
# Exiting /build/s630/plsql/s_exports.mk
# Exiting /build/s630/plsql/exports.mk
# Entering /build/s630/slax/exports.mk
...
# Entering /build/s630/slax/s_exports.mk

# Exiting /build/s630/slax/s_exports.mk
# Exiting /build/s630/slax/exports.mk
# Entering /build/s630/xdk/exports.mk
...
# Entering /build/s630/xdk/s_exports.mk
 
# Exiting /build/s630/xdk/s_exports.mk



# Exiting /build/s630/xdk/exports.mk
# Entering /build/s630/javavm/exports.mk
LIBJAVAVM=$(LIBHOME)$(LIB_PREFIX)aurora.$(LIB_EXT)
LLIBJAVAVM=$(LDLIBFLAG)aurora

# Entering /build/s630/javavm/s_exports.mk

# Exiting /build/s630/javavm/s_exports.mk
# Exiting /build/s630/javavm/exports.mk

# Entering /build/s630/dbjava/exports.mk
...
# Exiting /build/s630/dbjava/exports.mk

# Entering /build/s630/ctx/exports.mk
...
# Entering /build/s630/ctx/s_exports.mk
# Exiting /build/s630/ctx/s_exports.mk
# Exiting /build/s630/ctx/exports.mk
# Entering /build/s630/javavm/exports.mk
LIBJAVAVM=$(LIBHOME)$(LIB_PREFIX)aurora.$(LIB_EXT)
LLIBJAVAVM=$(LDLIBFLAG)aurora
...
# Exiting /build/s630/javavm/s_exports.mk
# Exiting /build/s630/javavm/exports.mk
# Entering /build/s630/sqlplus/exports.mk
...
# Entering /build/s630/sqlplus/s_exports.mk
...
# Exiting /build/s630/sqlplus/s_exports.mk
# Exiting /build/s630/sqlplus/exports.mk
 
# Entering /build/s630/precomp/exports.mk
...
# Entering /build/s630/precomp/s_exports.mk
 
# Exiting /build/s630/precomp/s_exports.mk
# Exiting /build/s630/precomp/exports.mk
...
# Entering /build/s630/precomp/s_precomp.mk
...
SYS_INCLUDE='sys_include=($(ORACLE_HOME)/precomp/public,/usr/include,/opt/gcc33/lib64/gcc-lib/x86_64-suse-linux/3.3/include,/usr/lib/gcc-lib/x86_64-redhat-linux/3.2.3/include,/usr/lib64/gcc-lib/x86_64-suse-linux/3.3.3/include)'

C2O_32=$(CC) $(AMD32FLAGS) $(CFLAGS32) -c $*.c

CPLUSPLUS=g++
CPLUS_SYS_INCLUDE='sys_include=($(ORACLE_HOME)/precomp/public,/usr/include,/opt/gcc33/lib64/gcc-lib/x86_64-suse-linux/3.3/include,/opt/gcc33/include/g++,/opt/gcc33/include/g++/backward,/opt/gcc33/include/g++/x86_64-suse-linux,/usr/lib/gcc-lib/x86_64-redhat-linux/3.2.3/include,/usr/include/c++/3.2.3/backward,/usr/include/g++-3,/usr/lib64/gcc-lib/x86_64-suse-linux/3.3.3/include)'
...
JAVACLASSPATH=.$(CLASS_SEP)$(JAVACLASSDIR)$(CLASS_SEP)$(JDBCCLASSES12)$(CLASS_SEP)$(ORACLE_HOME)/sqlj/lib/runtime12.jar:$(ORACLE_HOME)/jlib/orai18n.jar:$(ORACLE_HOME)/sqlj/lib/translator.jar:$(ORACLE_HOME)/javavm/lib/aurora.zip:$(ORACLE_HOME)/precomp/lib/ottclasses.zip
...
SHIPHOME_JDK_SQLJCLASSFILE=$$ORACLE_HOME/sqlj/lib/runtime12.jar:$$ORACLE_HOME/sqlj/lib/translator.jar
...
$(PCSCFG) loc_$(PCSCFG):
	$(MAKE) -f $(ORACLE_HOME)/precomp/lib/ins_precomp.mk CONFIG=$(PCSCFG) config
	$(SILENT)$(ECHO) $(SYS_INCLUDE) >> $(PCSCFG)
	$(SILENT)$(ECHO) "ltype=short" >> $(PCSCFG)
	$(SILENT)$(ECHO) "define=__x86_64__" >> $(PCSCFG)

# Exiting /build/s630/precomp/s_precomp.mk
# Exiting precomp.mk
# Entering /build/s630/buildtools/mkfile/libclntsh.mk
...
# Exiting /build/s630/buildtools/mkfile/libclntsh.mk
