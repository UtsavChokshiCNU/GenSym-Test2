--  
--  $Header: sqaqss.ada,v 1.2 1993/11/05 14:00:05 nikeda Exp $ 
--  
-- Copyright (c) 1989,1990 by Oracle Corporation
 
-- Name		
--   sqasss.ada
-- Function	
--   package SQL_STANDARD, using SMALLINT for INDICATOR_TYPE;
-- Notes
--    VAX/VMS-specific.
-- MODIFIED
-- Copyright (c) 1991,1990,1989 by Oracle Corporation 
--   NAME
--     sqaqss.ada - <one-line expansion of the name>
--   DESCRIPTION
--     package SQL_STANDARD, using SMALLINT for INDICATOR_TYPE;
--   RETURNS
--
...
--     VAX/VMS-specific.
--   MODIFIED   (MM/DD/YY)
--    nikeda	 11/05/93 -  Merge back as sqaqss.ada
--    jmuller    03/19/93 -  Creation 
--  Muller     09/25/90 - Creation
--  Muller     08/11/89 - Creation
--  Muller     08/02/89 - Creation
