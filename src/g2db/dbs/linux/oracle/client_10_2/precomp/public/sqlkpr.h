/*
 * $Header: sqlkpr.h 08-may-2002.12:13:42 apopat Exp $ 
 */
...
void sqlldat( /*_ dvoid *sqluga, Lda_Def *lda _*/ );
...
void sqlld2( /*_ Lda_Def *lda, text *hname, sb4 *hnamel _*/ );
...
void sqlld2t( /*_ dvoid *sqluga, Lda_Def *lda, text *hname, sb4 *hnamel _*/ );
