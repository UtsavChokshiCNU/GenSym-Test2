 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:44:52 EEST 2009
 *
 */
...
public interface DbQueryObject extends com.gensym.classes.GsiDataService, com.gensym.classes.SymbolicVariable {

  public static final Symbol DB_QUERY_OBJECT_ = Symbol.intern ("DB-QUERY-OBJECT");
  static final Symbol g2ClassName = DB_QUERY_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_QUERY_OBJECT_, GSI_DATA_SERVICE_, SYMBOLIC_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for DB-ROWS-PROCESSED is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
