...
public interface DbDebugObject extends com.gensym.classes.LogicalParameter {

  public static final Symbol DB_DEBUG_OBJECT_ = Symbol.intern ("DB-DEBUG-OBJECT");
  static final Symbol g2ClassName = DB_DEBUG_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_DEBUG_OBJECT_, LOGICAL_PARAMETER_, PARAMETER_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for LEVEL is : 
   * Integer
   *
   */
