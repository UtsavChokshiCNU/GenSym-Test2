...
public class DbQueryItemImpl extends com.gensym.classes.SymbolicVariableImpl implements DbQueryItem {
  ...
  public DbQueryItemImpl() {
    super();
  }

  public DbQueryItemImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public DbQueryItemImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
