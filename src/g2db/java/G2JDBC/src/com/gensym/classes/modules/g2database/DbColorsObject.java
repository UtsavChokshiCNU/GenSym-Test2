 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:48:31 EEST 2009
 *
 */
...
public interface DbColorsObject extends com.gensym.classes.LogicalParameter {

  public static final Symbol DB_COLORS_OBJECT_ = Symbol.intern ("DB-COLORS-OBJECT");
  static final Symbol g2ClassName = DB_COLORS_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_COLORS_OBJECT_, LOGICAL_PARAMETER_, PARAMETER_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for DEFAULT-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for NOT-CONNECTED-BODY-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for NOT-CONNECTED-TOP-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for CONNECTED-BODY-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for CONNECTED-TOP-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for ERROR-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for WARNING-COLOR is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for SUCCESS-COLOR is : 
   * Symbol
   *
   */
