 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:49:37 EEST 2009
 *
 */
...
public class DbDebugObjectImpl extends com.gensym.classes.LogicalParameterImpl implements DbDebugObject {


  static final long serialVersionUID = 2L;
  private static final Symbol LEVEL_ = Symbol.intern ("LEVEL");

  /* Generated constructors */

  public DbDebugObjectImpl() {
    super();
  }

  public DbDebugObjectImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public DbDebugObjectImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
    super (context, handle, handleVersion, wrap, attributes);
  }


  /**
   * Generated Property Setter for attribute -- LEVEL
   * @param level new value to conclude for LEVEL
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setLevel(int level) throws G2AccessException {
    setAttributeValue (LEVEL_, level);
  }

  /**
   * Generated Property Getter for attribute -- LEVEL
   * @return the value of the LEVEL attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public int getLevel() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (LEVEL_);
