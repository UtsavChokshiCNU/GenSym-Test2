 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:46:22 EEST 2009
 *
 */
...
public interface DbQueryItemArray extends com.gensym.classes.modules.g2database.DbQueryItem {

  public static final Symbol DB_QUERY_ITEM_ARRAY_ = Symbol.intern ("DB-QUERY-ITEM-ARRAY");
  static final Symbol g2ClassName = DB_QUERY_ITEM_ARRAY_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_QUERY_ITEM_ARRAY_, DB_QUERY_ITEM_, SYMBOLIC_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * DB-QUERY-ITEM-ARRAY::DB-COPY
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS DB-QUERY-ITEM-ARRAY,arg1:CLASS ITEM) = ()
   */
  public  void dbCopy(com.gensym.classes.Item arg1) throws G2AccessException;
  
  /**
   * Auto Generated method for G2 Method
   * DB-QUERY-ITEM-ARRAY::DB-DELETE
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS DB-QUERY-ITEM-ARRAY) = ()
   */
  @Override
