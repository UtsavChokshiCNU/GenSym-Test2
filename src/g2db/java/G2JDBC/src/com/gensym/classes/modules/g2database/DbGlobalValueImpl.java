 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:48:54 EEST 2009
 *
 */
...
public class DbGlobalValueImpl extends com.gensym.classes.LogicalParameterImpl implements DbGlobalValue {
  ...
  public DbGlobalValueImpl() {
    super();
  }

  public DbGlobalValueImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public DbGlobalValueImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setState(boolean state) throws G2AccessException {
    setAttributeValue (STATE_, new Boolean (state));
  }
