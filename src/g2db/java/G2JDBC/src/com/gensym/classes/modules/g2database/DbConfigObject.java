...
public interface DbConfigObject extends com.gensym.classes.GsiDataService, com.gensym.classes.SymbolicVariable {

  public static final Symbol DB_CONFIG_OBJECT_ = Symbol.intern ("DB-CONFIG-OBJECT");
  static final Symbol g2ClassName = DB_CONFIG_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_CONFIG_OBJECT_, GSI_DATA_SERVICE_, SYMBOLIC_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for OBJECT-HANDLE is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for DB-STATUS is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for DB-CODE is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for DB-MESSAGE is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
  ...
  /**
   * Generated Property Getter for attribute -- SQL-STMT
   * @return the value of the SQL-STMT attribute of this item
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for SQL-STMT is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
  public java.lang.Object getSqlStmt() throws G2AccessException;

  /**
   * Generated Property Setter for attribute -- SQL-STMT
   * @param sqlStmt new value to conclude for SQL-STMT
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  public void setSqlStmt(java.lang.Object sqlStmt) throws G2AccessException;

  /**
   * Generated Property Getter for attribute -- BIND-VARS
   * @return the value of the BIND-VARS attribute of this item
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for BIND-VARS is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
  public java.lang.Object getBindVars() throws G2AccessException;

  /**
   * Generated Property Setter for attribute -- BIND-VARS
   * @param bindVars new value to conclude for BIND-VARS
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  public void setBindVars(java.lang.Object bindVars) throws G2AccessException;
