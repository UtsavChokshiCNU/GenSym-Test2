 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:46:23 EEST 2009
 *
 */
...
public class DbQueryItemArrayImpl extends com.gensym.classes.modules.g2database.DbQueryItemImpl implements DbQueryItemArray {
  ...
  public DbQueryItemArrayImpl() {
    super();
  }

  public DbQueryItemArrayImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public DbQueryItemArrayImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
