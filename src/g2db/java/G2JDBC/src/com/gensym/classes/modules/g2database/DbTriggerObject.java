 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:48:04 EEST 2009
 *
 */
...
public interface DbTriggerObject extends com.gensym.classes.GsiDataService, com.gensym.classes.TextVariable {

  public static final Symbol DB_TRIGGER_OBJECT_ = Symbol.intern ("DB-TRIGGER-OBJECT");
  static final Symbol g2ClassName = DB_TRIGGER_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_TRIGGER_OBJECT_, GSI_DATA_SERVICE_, TEXT_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   */
  public int getObjectHandle() throws G2AccessException;
   ...
   */
  public void setObjectHandle(int objectHandle) throws G2AccessException;

  /**
   * Generated Property Getter for attribute -- TIME-STAMP
   * @return the value of the TIME-STAMP attribute of this item
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for TIME-STAMP is : 
   * Text
   *
   */
  public java.lang.String getTimeStamp() throws G2AccessException;

  /**
   * Generated Property Setter for attribute -- TIME-STAMP
   * @param timeStamp new value to conclude for TIME-STAMP
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  public void setTimeStamp(java.lang.String timeStamp) throws G2AccessException;
