 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Jun 18 17:46:21 EEST 2009
 *
 */
...
public interface DbQueryItem extends com.gensym.classes.SymbolicVariable {

  public static final Symbol DB_QUERY_ITEM_ = Symbol.intern ("DB-QUERY-ITEM");
  static final Symbol g2ClassName = DB_QUERY_ITEM_;
  static final Symbol[] classInheritancePath = new Symbol[] {DB_QUERY_ITEM_, SYMBOLIC_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * DB-QUERY-ITEM::DB-DELETE
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS DB-QUERY-ITEM) = ()
   */
