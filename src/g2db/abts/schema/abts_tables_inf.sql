host clear
host echo "====================================================================="
host echo "   ABTS DATABASE TABLES AND TEST DATA FOR ORACLE"
host echo "====================================================================="
...
host echo "Creating table ABTS_EMP"
DROP TABLE ABTS_EMP;
...
host echo "Inserting sample data into table ABTS_EMP"    
...
host echo "Creating table ABTS_EMP2"
...
host echo "Inserting sample data into table ABTS_EMP2"    
...
INSERT INTO ABTS_EMP2 VALUES -
    (9788,'BRIDGEBOY','VICE-PRESIDENT',9566,to_date('01-JAN-1983','DD-MON-YYYY'),33000,NULL,10);
INSERT INTO ABTS_EMP2 VALUES -
...
INSERT INTO ABTS_EMP2 VALUES -
    (9902,'BUTCHY','VICE-PRESIDENT',9566,to_date('23-JUL-1971','DD-MON-YYYY'),23000,NULL,30);
INSERT INTO ABTS_EMP2 VALUES -
...
host echo "Creating table ABTS_MANY_COLUMNS"
...
host echo "Create table ABTS_DATATYPES"
...
host echo "Inserting sample data into table ABTS_DATATYPES"    
...
host echo "Create table ABTS_TOOBIG_DATA"
DROP TABLE ABTS_TOOBIG_DATA;
CREATE TABLE ABTS_TOOBIG_DATA
  (TBI             NUMBER(38),
   TBF             NUMBER );

host echo "Inserting sample data into table ABTS_TOOBIG_DATA"    
...
host echo "Create table ABTS_FUNCTION_DATA"
...
host echo "Inserting sample data into table ABTS_FUNCTION_DATA"
...
host echo "Create table ABTS_EMPTY_TABLE"
...
host echo "Create table ABTS_PERSONNEL"
...
host echo "Inserting sample data into table ABTS_PERSONNEL"    
...
host echo "Creating table ABTS_UNSUP_DTYPES"
...
host echo "Creating table ABTS_TEXT"
...
host echo "Inserting sample data into table ABTS_TEXT"    
...
host echo "Creating table ABTS_FLOAT"
...
host echo "Inserting sample data into table ABTS_FLOAT"
...
host echo "Creating table ABTS_INT"
DROP TABLE ABTS_INT;
...
host echo "Inserting sample data into table ABTS_INT"
...
host echo "Creating table ABTS_EMP_X2"
...
host echo "Inserting sample data into table ABTS_EMP_X2"
...
host echo "Creating table ABTS_ROWS10K"
...
host echo "Creating table ABTS_SCRATCH"
...
host echo "Creating table ABTS_TRIGGER_TABLE"
