/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 +      directory, and renamed it to include tw.  We will presumably have
 +      different callbacks for different systems.
 +
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
...
long g2int_network_event_handler(long event_code, long event_socket_handle, long event_status_code)
{
  ...
  if (g2int_network_event_handler_call_handle) {
    return_value = (*g2int_network_event_handler_call_handle)(event_code, event_socket_handle, event_status_code);
  } else {
