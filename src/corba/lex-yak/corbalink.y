...
%union 
	...
	double			val;
        long long               llng_val ;
        unsigned long long      ullng_val ;
	}

%type	<tok_val>	unary_operator switch_body aux_11 aux_3 aux_4 aux_5 aux_8 aux_9 aux_10

%type	<str_lit>	signed_short_int signed_int signed_long_int signed_long_long_int
%type   <str_lit>	unsigned_short_int unsigned_int unsigned_long_int unsigned_long_long_int
...
signed_int:             signed_long_long_int	{	if( compiler_debug_state == DEBUG_ON )printf( "signed_int:signed_long_long_int\n" );   $$=$1;  }
					|   signed_long_int		    {	if( compiler_debug_state == DEBUG_ON )printf( "signed_int:signed_long_int\n" );	$$=$1;	}
					|	signed_short_int	    {	if( compiler_debug_state == DEBUG_ON )printf( "signed_int:signed_short_int\n" );	$$=$1;	}
;

signed_long_long_int:   xLONG xLONG         {	char	*long_long;
...
unsigned_int:			unsigned_long_long_int  {   if( compiler_debug_state == DEBUG_ON )printf( "unsigned_int:unsigned_long_long_int\n" );   $$=$1;  }
				    |   unsigned_long_int	    {	if( compiler_debug_state == DEBUG_ON )printf( "unsigned_int:unsigned_long_int\n" );	 $$=$1;	}
					|	unsigned_short_int	    {	if( compiler_debug_state == DEBUG_ON )printf( "unsigned_int:unsigned_short_int\n" ); $$=$1;	}
;

unsigned_long_long_int: xUNSIGNED xLONG xLONG   {   char	*u_long_long;
												    u_long_long = (char *) malloc( 19 );
    											    strcpy( u_long_long, $1 ) ;
	   											    strcat( u_long_long, " " ); 
	   											    strcat( u_long_long, $2 ) ; 
	   											    strcat( u_long_long, " " ); 
	   											    strcat( u_long_long, $3 ) ; 
												    $$ = u_long_long;
