...
%type	<tok_val>	primary_expr scoped_name literal boolean_literal definition const_dcl
%type	<tok_val>	except_dcl interface module interface_dcl forward_dcl inheritance_spec
%type	<tok_val>	interface_body export aux_1 
...
%type	<str_lit>	param_type_spec switch_type_spec simple_declarator aux_6 op_type_spec param_attribute enumerator

%type	<interface_header>	interface_header	

%type	<sAttributeNode_ptr>	attr_dcl
...
interface_dcl:			interface_header '{' interface_body '}'		
							...
							buildInterface( $1, export_array, export_count );
...
export:					type_dcl ';'				{	export_dcl_type_node	*ptr;
					...
					|	attr_dcl ';'				{	export_dcl_type_node	*ptr;
														printf( "export: case 4: attr_dcl:\n" ); 
														ptr = (export_dcl_type_node *) malloc( sizeof(export_dcl_type_node) );
														ptr->dcl_type = ATTR_DCL;
														ptr->nodePtr.sAttributeNode_ptr = $1;
													   	export_array[export_count] = ptr;
														export_count++;		
													}							 
...
/********
attr_dcl:				xATTRIBUTE param_type_spec simple_declarator					{ printf( "attr_dcl: case 1:$1= %s, $2= %s, $3= %s\n", $1, $2, $3 ); loadattr_dcl_array($3); }
					|	xATTRIBUTE param_type_spec simple_declarator aux_6				{ printf( "attr_dcl: case 2:$1= %s, $2= %s, $3= %s, $4= %s\n", $1, $2, $3, $4 ); loadattr_dcl_array($3); loadattr_dcl_array($4); }
...
aux_6:					',' simple_declarator				{ printf( "aux_6: case 1:$2= %s\n", $2 ); $$=$2; loadArray($2); }
					|	aux_6 ',' simple_declarator			{ printf( "aux_6: case 2:$1= %s, $3= %s\n", $1, $3); $$=$1; loadArray($1); loadArray($3); }
;
...
attr_dcl:				xATTRIBUTE param_type_spec aux_6			
							...
							$$ = buildAttribute( NO_READONLY, $1, $2, attr_dcl_array, attr_dcl_count );
