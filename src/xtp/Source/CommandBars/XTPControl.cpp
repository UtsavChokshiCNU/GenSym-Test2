...
CXTPControl::CXTPControl()
{
	...
	m_nUserData = 0;		// Gensym addition -fmw, 9/4/04
...
HRESULT CXTPControl::GetAccessibleState(VARIANT varChild, VARIANT* pvarState)
{
	...
	// GENSYMCID-1817: TWNG crashes when executing 1000408 - Telewindows NG - Disable / Enable (TC11)
	// TWNG crashes here, maybe because "m_pParent" is NULL. -- Chun Tian (binghe), June 29, 2016.
