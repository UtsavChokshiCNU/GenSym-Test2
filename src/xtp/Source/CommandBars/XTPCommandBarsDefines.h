...
const UINT WM_XTP_RELEASE_POPUP = (WM_XTP_COMMANDBARS_BASE + 51);
//End of adding
...
//--------------------------------------------------------------------------------
// Begin Gensym additions -fmw, 6/21/04
//--------------------------------------------------------------------------------
#define WM_XTP_INITMENUBAR (WM_XTP_COMMANDBARS_BASE + 40)
#define WM_XTP_MODALLOOP (WM_XTP_COMMANDBARS_BASE + 41)

// WM_XTP_INITMENUBAR now returns a value. If that value is
// GENSYM_XTP_ABORT_MENU, then the activation of the menu bar is aborted. This
// was added for HQ-4944384 "Selecting workspace menu and menu bar in TWNG
// hangs/crashes". Keep in sync with ext/c/

#define GENSYM_XTP_ABORT_MENU 666
//--------------------------------------------------------------------------------
// End Gensym Additions
//--------------------------------------------------------------------------------
