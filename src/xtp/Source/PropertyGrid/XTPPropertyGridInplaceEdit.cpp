...
{
	// GENSYMCID-1218: Pressing CTRL+A within a cell in the property grid does not select the contents of the cell
	if(pMsg->message == WM_KEYDOWN && (GetKeyState(VK_CONTROL) < 0) && (pMsg->wParam == 'A'))
	{
		UpdateData();
