/*
 * snrscnn.c -  Chestnut Run-Time Library entry for function SI_intersection_n
 *
...
extern Object intersection(Object list1, Object list2, Object test, Object test_not, Object key);
...
/*VARARGS*/
Object SI_intersection_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return intersection(r1, r2, k1, k2, k3);
}
