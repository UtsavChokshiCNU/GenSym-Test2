/*
 * sngcplzn.c -  Chestnut Run-Time Library entry for function SI_string_capitalize_n
 *
...
/*VARARGS*/
Object SI_string_capitalize_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object k1;
    ...
    END_ARGS();
    return string_capitalize(r1, k1, k2);
}
