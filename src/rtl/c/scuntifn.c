/*
 * scuntifn.c -  Chestnut Run-Time Library entry for function SI_count_if_n
 *
...
extern Object count_if(Object test, Object seq, Object from_end, Object lstart, Object lend, Object key);
...
/*VARARGS*/
Object SI_count_if_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return count_if(r1, r2, k1, k2, k3, k4);
}
