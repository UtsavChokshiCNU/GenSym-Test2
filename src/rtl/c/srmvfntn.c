/*
 * srmvfntn.c -  Chestnut Run-Time Library entry for function SI_remove_if_not_n
 *
...
extern Object remove_if_not(Object test, Object sequence, Object from_end, Object start, Object end, Object count, Object key);
...
/*VARARGS*/
Object SI_remove_if_not_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return remove_if_not(r1, r2, k1, k2, k3, k4, k5);
}
