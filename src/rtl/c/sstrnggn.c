/*
 * sstrnggn.c -  Chestnut Run-Time Library entry for function SI_string_ge_n
 *
...
extern Object string_ge(Object string1, Object string2, Object start1, Object end1, Object start2, Object end2);
...
/*VARARGS*/
Object SI_string_ge_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return string_ge(r1, r2, k1, k2, k3, k4);
}
