/*
 * nntrsctn.c -  Chestnut Run-Time Library entry for function nintersection
 *
...
Object nintersection (list1, list2, test, test_not, key)
    Object list1, list2, test, test_not, key;
{
    Declare_local_temp;
    Object result, last_cell, item1, temp1, elem;
    Declare_stack_pointer;

    SAVE_STACK();
    PROTECT_5(list1,list2,test,test_not,key);
    PROTECTI_5(result,last_cell,item1,temp1,elem);
