/*
 * ssearchn.c -  Chestnut Run-Time Library entry for function SI_search_n
 *
...
extern Object search(Object seq1, Object seq2, Object from_end, Object test, Object test_not, Object key, Object lstart1, Object lstart2, Object lend1, Object lend2);
...
/*VARARGS*/
Object SI_search_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return search(r1, r2, k1, k2, k3, k4, k5, k6, k7, k8);
}
