/*
 * nsbstttf.c -  Chestnut Run-Time Library entry for function nsubstitute_if
 *
...
Object nsubstitute_if (newitem, test, seq, from_end, lstart, lend,lcount, key)
    Object newitem, test, seq, from_end, lstart, lend, lcount, key;
{
	...
	result = nreverse(nsubstitute_if(newitem, test, nreverse(seq), NIL,
