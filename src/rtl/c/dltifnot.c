/*
 * dltifnot.c -  Chestnut Run-Time Library entry for function delete_if_not
 *
...
Object delete_if_not (test, seq, from_end, start, end, count, key)
    Object test, seq, from_end, start, end, count, key;
{
    return SI_delete_if(test, seq, from_end, start, end, count, key, T);
}
