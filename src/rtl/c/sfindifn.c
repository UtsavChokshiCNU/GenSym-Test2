/*
 * sfindifn.c -  Chestnut Run-Time Library entry for function SI_find_if_n
 *
...
extern Object find_if(Object test, Object seq, Object from_end, Object lstart, Object lend, Object key);
...
/*VARARGS*/
Object SI_find_if_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return find_if(r1, r2, k1, k2, k3, k4);
}
