/*
 * snsbsfn.c -  Chestnut Run-Time Library entry for function SI_nsubstitute_if_n
 *
...
/*VARARGS*/
Object SI_nsubstitute_if_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return nsubstitute_if(r1, r2, r3, k1, k2, k3, k4, k5);
}
