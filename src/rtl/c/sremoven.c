/*
 * sremoven.c -  Chestnut Run-Time Library entry for function SI_remove_n
 *
...
extern Object lremove(Object item, Object seq, Object from_end, Object test, Object test_not, Object lstart, Object lend, Object lcount, Object key);
...
/*VARARGS*/
Object SI_remove_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return lremove(r1, r2, k1, k2, k3, k4, k5, k6, k7);
}
