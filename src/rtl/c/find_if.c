/*
 * find_if.c -  Chestnut Run-Time Library entry for function find_if
 *
...
Object find_if (test, seq, from_end, lstart, lend, key)
    Object test, seq, from_end, lstart, lend, key;
{
	...
	result = find_if(test, nreverse(copy_seq(seq)), NIL,
