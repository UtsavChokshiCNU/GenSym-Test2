/*
 * scpvbgnm.c -  Chestnut Run-Time Library entry for function STATIC_POSITIVE_BIGNUM
 *
...
Object STATIC_POSITIVE_BIGNUM (length)
    SI_Dimension length;
{
    Object result;
    Declare_area(a);
    ...
    BIGNUM_SET_HEADER(result, length, FALSE);
