/*
 * snsubstn.c -  Chestnut Run-Time Library entry for function SI_nsubst_n
 *
...
extern Object nsubst(Object new, Object old, Object tree, Object test, Object test_not, Object key);
...
/*VARARGS*/
Object SI_nsubst_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return nsubst(r1, r2, r3, k1, k2, k3);
}
