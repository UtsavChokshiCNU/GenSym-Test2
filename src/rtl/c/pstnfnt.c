/*
 * pstnfnt.c -  Chestnut Run-Time Library entry for function position_if_not
 *
...
Object position_if_not (test, seq, from_end, lstart, lend, key)
    Object test, seq, from_end, lstart, lend, key;
{
    Declare_local_temp;
    Object rest, result, elem;
    long i, start, end, len;
    Declare_stack_pointer;

    SAVE_STACK();
    PROTECT_3(test,seq,key);
    PROTECTI_3(rest,result,elem);
	...
	result = position_if_not(test, nreverse(copy_seq(seq)), NIL,
