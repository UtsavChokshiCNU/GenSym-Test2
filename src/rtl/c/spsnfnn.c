/*
 * spsnfnn.c -  Chestnut Run-Time Library entry for function SI_position_if_not_n
 *
...
extern Object position_if_not(Object test, Object seq, Object from_end, Object lstart, Object lend, Object key);
...
/*VARARGS*/
Object SI_position_if_not_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return position_if_not(r1, r2, k1, k2, k3, k4);
}
