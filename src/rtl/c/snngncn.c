/*
 * snngncn.c -  Chestnut Run-Time Library entry for function SI_nstring_downcase_n
 *
...
/*VARARGS*/
Object SI_nstring_downcase_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object k1;
    ...
    END_ARGS();
    return nstring_downcase(r1, k1, k2);
}
