/*
 * ssbstttn.c -  Chestnut Run-Time Library entry for function SI_substitute_n
 *
...
extern Object substitute(Object newitem, Object olditem, Object seq, Object from_end, Object test, Object test_not, Object lstart, Object lend, Object lcount, Object key);
...
/*VARARGS*/
Object SI_substitute_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return substitute(r1, r2, r3, k1, k2, k3, k4, k5, k6, k7);
}
