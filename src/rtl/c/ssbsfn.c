/*
 * ssbsfn.c -  Chestnut Run-Time Library entry for function SI_substitute_if_n
 *
...
extern Object substitute_if(Object newitem, Object test, Object seq, Object from_end, Object start, Object end, Object count, Object key);
...
/*VARARGS*/
Object SI_substitute_if_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return substitute_if(r1, r2, r3, k1, k2, k3, k4, k5);
}
