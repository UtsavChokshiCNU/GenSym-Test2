/*
 * ssrngqln.c -  Chestnut Run-Time Library entry for function SI_string_equal_n
 *
...
/*VARARGS*/
Object SI_string_equal_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return string_equal(r1, r2, k1, k2, k3, k4);
}
