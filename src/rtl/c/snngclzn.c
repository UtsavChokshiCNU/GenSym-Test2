/*
 * snngclzn.c -  Chestnut Run-Time Library entry for function SI_nstring_capitalize_n
 *
...
/*VARARGS*/
Object SI_nstring_capitalize_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object k1;
    ...
    END_ARGS();
    return nstring_capitalize(r1, k1, k2);
}
