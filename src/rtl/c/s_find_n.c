/*
 * s_find_n.c -  Chestnut Run-Time Library entry for function SI_find_n
 *
...
extern Object find(Object item, Object seq, Object from_end, Object test, Object test_not, Object lstart, Object lend, Object key);
...
/*VARARGS*/
Object SI_find_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return find(r1, r2, k1, k2, k3, k4, k5, k6);
}
