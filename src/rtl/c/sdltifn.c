/*
 * sdltifn.c -  Chestnut Run-Time Library entry for function SI_delete_if_n
 *
...
extern Object delete_if(Object test, Object seq, Object from_end, Object start, Object end, Object count, Object key);
...
/*VARARGS*/
Object SI_delete_if_n varargs_1(int, n)
{
    XDeclare_varargs;
    Object r1;
    Object r2;
    ...
    END_ARGS();
    return delete_if(r1, r2, k1, k2, k3, k4, k5);
}
