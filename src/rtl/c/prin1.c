/*
 * prin1.c -  Chestnut Run-Time Library entry for function prin1
 *
...
Object prin1 (object, output_stream)
    Object object, output_stream;
{
    return(lwrite(object, output_stream, T,
		  Print_radix, Print_base, Print_circle, Print_pretty,
		  Print_level, Print_length, Print_case, Print_gensym,
		  Print_array));
}
