...
public class NolSingleChoiceDialog extends JDialog {
	...
	public NolSingleChoiceDialog(JFrame dw, String title, String choiceString, 
    ...
    class MainAction extends AbstractAction implements MouseListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (event.getSource().equals(okButton)) {
				isOk = okFired();
				NolSingleChoiceDialog.this.setVisible(false);
