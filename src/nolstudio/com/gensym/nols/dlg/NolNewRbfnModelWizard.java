...
public class NolNewRbfnModelWizard  extends NolWizardDialog
	...
	private static final String GENERAL_LABEL = "NewRbfnModelWizard_GeneralLabel";
	private static final String COMMENT_LABEL = "CommentLabel";
	private static final String NAMEEDITLABEL = "NewRbfnModelWizard_NameEditLabel";
	private static final String PREPROCESSOR_LABEL = "NewRbfnModelWizard_PreprocessorLabel";
	private static final String PREPROCESSOR = "NewRbfnModelWizard_Preprocessor";
	private static final String DATASOURCE_LABEL = "NewRbfnModelWizard_OutputDataSourceLabel";
	private static final String DATASERIES = "NewRbfnModelWizard_DataSeries";
	private static final String VARIABLE = "NewRbfnModelWizard_Variable";
	private static final String SAMPLE = "NewRbfnModelWizard_Sample";
	private static final String CLASSIFICATION_LABEL = "NewRbfnModelWizard_ClassificationLabel";
	private static final String NODELAY_LABEL = "NewRbfnModelWizard_NoDelayLabel";
	private static final String DELAY_LABEL = "NewRbfnModelWizard_DelayLabel";
	private static final String HOUR = "NewRbfnModelWizard_Hour";
	private static final String MINUTE = "NewRbfnModelWizard_Minute";
	private static final String SECOND = "NewRbfnModelWizard_Second";
	private static final String DELAYS = "NewRbfnModelWizard_Delays";
	private static final String SETTING_LABEL = "NewRbfnModelWizard_SettingLabel";
	private static final String SETTING_BORDER = "NewRbfnModelWizard_SettingBorder";
	private static final String THRESHOLD = "NewRbfnModelWizard_Threshold";
	private static final String CALCULATERATINGS = "NewRbfnModelWizard_CalculateRatings";
	private static final String STRUCTURE_LABEL = "NewRbfnModelWizard_StructureLabel";
	private static final String OUTPUT = "NewRbfnModelWizard_Output";
	private static final String INPUT = "NewRbfnModelWizard_Input";
	private static final String UNUSED = "NewRbfnModelWizard_Unused";
	private static final String MINDELAY = "NewRbfnModelWizard_MinDelay";
	private static final String MAXDELAY = "NewRbfnModelWizard_MaxDelay";
	private static final String INTERVAL = "NewRbfnModelWizard_Interval";
	private static final String DELAY = "NewRbfnModelWizard_Delay";
	private static final String RATING = "NewRbfnModelWizard_Rating";
	private static final String USED = "NewRbfnModelWizard_Used";
	private static final String NOOUTPUTISSPECIFIED = "NewRbfnModelWizard_NoOutputIsSpecified";
	private static final String NOINPUTISSPECIFIED = "NewRbfnModelWizard_NoInputIsSpecified";
	private static final String NOLFINITEDATA = "NewRbfnModelWizard_NoFiniteData";
	private static final String THRESHOLDTOOLTIP = "NewRbfnModelWizard_ThresholdToolTip";
	private static final String LOADFROMEXISTMODEL = "NewRbfnModelWizard_LoadFromModel";
	private static final String LOADFROMDISK = "NewRbfnModelWizard_LoadFromDisk";
	private static final String PREDICTIVEMODEL = "NewRbfnModelWizard_PredictiveModel";
	private static final String NOMODELSELECTED = "NewRbfnModelWizard_NoModelSelected";
	private static final String NONAMEFORTHISMODEL = "NewRbfnModelWizard_NoNameForThisModel";
	private static final String LAYERNUMBER = "NewRbfnModelWizard_LayerNumber";
	...
	public NolNewRbfnModelWizard (NolMainFrame dw) {
//		super((JFrame)dw, "Create New Predictive Model", true, 7); //if DEBUG.more = true
		super((JFrame)dw, "Create New Back Propagation Model", true, 7);
	...
	private JPanel getGeneralPanel(){
		...
		URL url = this.getClass().getResource("largerbfn.gif");
...
//		autoPane.setBorder(BorderFactory.createTitledBorder("Automatically Select Variables & Calculate Delays:"));
	...
	public void setVisible(boolean v){
		...
		currentStep = 0;
		modifyStep(true);
		String title = "Create New Radial Basis Function Net - "+setTitleForStep(currentStep);
		title = title + " - General";
		setTitle(title);
		super.setVisible(v);
	}
	...
	protected void modifyStep(boolean isNext){
		...
		String title = "Create New Radial Basis Function Model - "+setTitleForStep(currentStep);
		if(currentStep == 1){
			title = title + " - General";
...
//System.out.println("shape=	"+ shape);
		...
		model = new NolRbfnModel(net,modelName.getText(),outs ,
	...
	public boolean verifyControlActionCalculateRatings() {
		return !calculateDelay.isEnabled();
	}
	
	public int verifyDelayTimeSettingFlag() {
		return delayTimeSettingFlag;
	}
}
