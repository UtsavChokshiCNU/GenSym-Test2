...
public class NolRbfnTrainDialog extends JDialog{
	...
	public NolRbfnTrainDialog(JFrame dw, String title) {
		super(dw, title, true);
	...
	public NolRbfnTrainDialog(JFrame dw, String title,  NolRbfnModel model) {
		this(dw,title);
		this.model = model;
		setTitle("Train a Model: "+model.getName());
	}

	public void setRbfnModel(NolRbfnModel model) {
		this.model = model;
		setTitle("Train a Model: "+model.getName());
	}
	...
	private void initializeLayout(){ 
		...
		methodPane.setBorder(new TitledBorder("Clustering Method:"));               
		ButtonGroup group = new ButtonGroup();
		but1 = new JRadioButton("Regular k-means clustering");
		but2 = new JRadioButton("class-separate k-means clustering");
