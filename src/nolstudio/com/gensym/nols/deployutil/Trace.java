...
public class Trace extends Message {
  ...
  public static MessageKey registerMessageKey(final String key, final Class classKey) {
    try {
      Class messageClass = classKey;
      if (messageClass == null)
	messageClass = Class.forName("java.lang.Object");
      return Message.registerMessageKey(key, messageClass);
    } catch (Exception ex) {
      ex.printStackTrace();
    }
  ...
  public static void exception (Throwable t, String message) {
	...
	System.err.println(message);
      ...
      catchBackTrace = DebugUtil.getStackTrace ();
