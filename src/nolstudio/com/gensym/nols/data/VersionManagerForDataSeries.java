...
public class VersionManagerForDataSeries implements Cloneable, Serializable {
	...
	private transient DataSeries data;
...
/**Save the project to a file.*/
	...
	public Object clone() throws CloneNotSupportedException {
		VersionManagerForDataSeries cloned = (VersionManagerForDataSeries) super.clone();
...
// change
	...
	public void setDataSeries(DataSeries data){
		this.data = data;
	}
}
