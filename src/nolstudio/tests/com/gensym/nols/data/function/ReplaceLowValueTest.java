...
public class ReplaceLowValueTest
{
	private ReplaceLowValue testObj;

	@Before
	public void initObject()
	{
		testObj = new ReplaceLowValue();
	}
	/**
	...
	{
		assertEquals("ReplaceLowValue", testObj.getName());
	}
	...
	{
		final String description = "D = ReplaceLowValue(A,B,C). If A < B, then D = C, otherwise D = A.";
