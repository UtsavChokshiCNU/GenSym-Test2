...
#define GENSYM_INVALID_ROW_TAG  (-1)		  // Gensym addition
...
public:
	...
	void SetNumericHeader(BOOL bNumeric = FALSE)  { m_bNumericHead = bNumeric;        }  // Gensym addition
	BOOL IsNumericHeader()                        { return m_bNumericHead;            }  // Gensym addition
///////////////////////////////////////////////////////////////////////////////////
...
public:				      // Gensym addition
  int GetRowTag(int nRow);	      // Gensym addition
  void SetRowTag(int nRow, int tag);  // Gensym addition
  int FindRow(int tag);		      // Gensym addition
  void InvalidateFindRowCache();      // Gensym addition
protected:			      // Gensym addition
  CArray<int,int> m_arRowTags;	      // Gensym addition
  int m_cacheTag;		      // Gensym addition. FindRow() cache
  int m_cacheRow;		      // Gensym addition
  BOOL m_bNumericHead;		      // Gensym addition
  bool m_AllowSelectRowInFixedCol;    // GENSYMCID-1045
};
