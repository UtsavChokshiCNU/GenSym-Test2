...
public:
  ...
  void SetColorCombo(BOOL bColor) { m_colorCombo = bColor; }
  BOOL IsColorCombo() { return m_colorCombo; }
...
private:
  ...
  DWORD        m_dwStyle;
  BOOL m_colorCombo;			// TRUE to assume contents are color names.
};
...
public:
    ...
    void EndEdit(BOOL sendEvent);

protected:
    BOOL IsColorCombo() { return (GetStyle() & CBS_OWNERDRAWFIXED) != 0; }
