...
$       then
$		vmi$callback message i info "Gensym GSI 5.1 for VAX VMS/OpenVMS"
$	else
$		vmi$callback message i info "Gensym GSI 5.1 for Alpha AXP OpenVMS"
$	endif
$
...
$	product_startup_line	= "$      @sys$startup:gsi50-startup"
$
$	gsi_update_files	= 0
$       new_top_level_dir	= 0
$!
...
$	get_directories:
$
$	vmi$callback ask gsi_directory "GSI directory" "''gsi_device'[gsi51]" D
...
$
$	open/read  gsikitstartup  vmi$kwd:gsi50-startup.com
$	open/write gsistartup     vmi$root:[sys$startup]gsi50-startup.com
$
$	l6:
...
$	then
$	    purge 'gsi_root_tree'
$	    purge vmi$root:[sys$startup]gsi50-startup.com
$	endif
$	!
$	set file/protection=(s:rwed,o:rwed,g:rwe,w:re) 'gsi_root_tree'*.*
$	set file/protection=(s:rwed,o:rwed,g:rwe,w:re)  vmi$root:[sys$startup]gsi50-startup.com
$	return
$!
$!
$!
