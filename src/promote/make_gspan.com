...
$	else
$       	cc/standard=vaxc/extern=common/share/obj=gsi$objs gsi$srcs:gsi_main.c
$	endif
$!
...
$	else
$       	cc/standard=vaxc/extern=common/share/obj=gsi$objs gsi$srcs:'p1
$	endif
$!
...
$! Link Object Modules
$!
$	write sys$output "Linking object modules..."
$	!
$	link/exe=gsi$exes:'main.exe -
		gsi$objs:gsi_main, -
		gsi$objs:'p1, -
		gsi$libgspan/lib, -
		gsi$options/opt
