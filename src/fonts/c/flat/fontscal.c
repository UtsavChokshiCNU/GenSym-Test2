...
*                                                                            *
*     $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fonts/c/flat/fontscal.c,v 1.1 1995-10-03 00:58:37 jra Exp $                                                 *
*                                                                            *
*     $Log: not supported by cvs2svn $
*     Revision 1.3  1995/03/14 00:30:18  mhd
...
*     development.
*
 * Revision 1.2  1993/09/17  18:38:38  mhd
 * Changes to eliminate all compiler warnings in the fontrip/4-in-1 c files.
 *
 * Revision 1.1  1993/05/04  20:13:34  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.2  1993/04/22  20:12:36  mhd
 * Added cast (int8 *) to the rhs of the assignment
 * 	int8* workSpacePtr		= (int8 *)key->memoryBases[WORK_SPACE_BASE];
 * The SGI (strict ansi) compiler would object otherwise.
 *
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fonts/c/flat/fontscal.c,v 1.1 1995-10-03 00:58:37 jra Exp $";
#endif
...
/* PRIVATE PROTOTYPES */
/* added static to the line below, since it is declared that way at
   the actual function definition site. -mhd@gensym, 9/15/93
   */
static int32 fs__Contour PROTO((fs_GlyphInputType *, fs_GlyphInfoType *, boolean ));
...
#else
		uint16 glyphIndex =
			key->mappingF( key, inputPtr->param.newglyph.characterCode );
#endif
