 ...
 * $Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fonts/c/flat/tr_trans.c,v 1.1 1995-10-03 01:02:49 jra Exp $
 *
 * $Log: not supported by cvs2svn $
 * Revision 1.3  1995/03/14 00:31:44  mhd
 ...
 * development.
 *
 * Revision 1.2  1993/09/17  18:38:45  mhd
 * Changes to eliminate all compiler warnings in the fontrip/4-in-1 c files.
 *
 * Revision 1.1  1993/05/04  20:15:33  mhd
 * The flat-directory version of the Bitstream 4-in-1 software.
 *
 * Revision 1.3  1993/04/27  21:06:41  mhd
 * A few more too-long-lines problems corrected.  And recorded before/after
 * in problems.text.
 *
 * Revision 1.2  1993/04/27  20:03:52  mhd
 * Shortened some of the extremely long lines because they could not be handled
 * by the VAX/VMS compiler (on Bolton).
 *
 * Revision 1.1.1.1  1993/04/15  20:14:33  mhd
...
static char     rcsid[] = "$Header: /media/gensym/home/versata1/cvs_repo_copyDec06/ab-repos/fonts/c/flat/tr_trans.c,v 1.1 1995-10-03 01:02:49 jra Exp $";
...
/* Removed "static" -- this is declared in type1.h -mhd@gensym, 9/17/93 */
FUNCTION void
set_mode_flags(PARAMS2 font_bbox)
	GDECL
	fbbox_t        STACKFAR*font_bbox;
 ...
 */
{
	...
	if (sp_globals.processor.type1.no_x_breaks == 0) {
		...
		sp_globals.processor.type1.Xoffset[i]
		  = sp_globals.processor.type1.Xpix[sp_globals.processor.type1.no_x_breaks - 1]
		    - (sp_globals.processor.type1.Xorus[sp_globals.processor.type1.no_x_breaks - 1]
		       * sp_globals.processor.type1.x_pix_per_oru_i
		       + ((sp_globals.processor.type1.Xorus[sp_globals.processor.type1.no_x_breaks - 1] >> 4)
			  * sp_globals.processor.type1.fudge_x));
	}
 ...
 */
{
	...
	if (sp_globals.processor.type1.no_y_breaks == 0) {
		...
		sp_globals.processor.type1.Yoffset[i]
		  = sp_globals.processor.type1.Ypix[sp_globals.processor.type1.no_y_breaks - 1]
		    - (sp_globals.processor.type1.Yorus[sp_globals.processor.type1.no_y_breaks - 1]
		       * sp_globals.processor.type1.y_pix_per_oru_i
		       + ((sp_globals.processor.type1.Yorus[sp_globals.processor.type1.no_y_breaks - 1] >> 4)
			  * sp_globals.processor.type1.fudge_y));
	}
