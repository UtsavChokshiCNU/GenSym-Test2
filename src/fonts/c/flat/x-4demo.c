...
*  Revision 1.1  1993/07/27 23:02:17  mhd
*  Save x-4demo.c, which is the 4demo.c that we had finally ported.  The
*  current version is based on an update from Bob Eggers -- his current
*  working version as of 7/26/93.
*
 * Revision 1.1  1993/05/04  20:07:34  mhd
