...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym Optegrity 4.1r0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym Optegrity 4.1r0")
;; MODIFY
...
(def-part-version :41r0 :major 4 :minor 1 :revision 0 :suffix "-B03J30" :letter "r")
...
(defvar optegrity-common
  '(javalink optegrity-documentation g2i-core-modules doc-pdf doc-html doc-chm
...
(def-part optegrity-doc
    ...
    :source-filename ("GEDPUsersGuide.pdf" "OptegrityUsersGuide.pdf" "OptegrityFurnaceTutorial.pdf" "SymCureUsersGuide.pdf" "IntelligentObjectsUsersGuide.pdf" "OptegrityReleaseNotes.pdf")
    :destination-directory "doc/optegrity"
    :indep t
    :shortcuts (opt-users-guide opt-release-notes
;;; leaving opt-rel-notes out of the Alpha release.
;;;                opt-rel-notes
                opt-demo-guide gedp-users-guide opt-io-users-guide ))
(def-shortcut opt-release-notes
...
;;;    :subfolder-name "Documentation"
;;;    :subsubfolder-name "Optegrity"
    :application-display-name "Optegrity 4.1r0 Bundle Release Notes"
    :application-directory "doc/optegrity"
...
(def-part g2i-examples
  ...
  :source-filename ("gedp-demo.kb" "gdpm-demo.kb")
