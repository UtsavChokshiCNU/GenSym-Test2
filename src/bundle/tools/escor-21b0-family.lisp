...
;;; The current shipping version of e-SCOR is 2.1 Beta Rev. 0 ("21b0").  The
;;; symbol :21b0 should be used generally for e-SCOR elements below.

(require "g2-family")			; G2 5.1r7
(provide "escor-21b0-family")

(def-family escor-21b0
    :index 3
    :file-syntax-version 10
    :print-name "escor"			; was "e-SCOR"! (MHD 5/1/01)
    :bundles (escor)
    :directory "escor"
    :guid "243D4BB8-9EE7-11D4-8111-00A02431D004" ; "2.1b0"
...
(def-part escor-readme
    :version :21b0-DD19 :source-ship-type :internal
