...
(require "g2-81r0-family")
(provide "tw2-13r2-family")

(def-family tw2-13r2
    :index 56			; per tools/datafiles/families/family-id.dat
    :file-syntax-version 10
    :bundles (tw2-client)
    :print-name "Telewindows2 Toolkit"    
    :directory "g2-8.1r0"
    ;; per tools/datafiles/families/guid.dat:
    :guid "c1961219-0a12-4e81-9d60-83bb744d6eee"
    :compatible-previous-versions (("1.3r1" "a68433b0-351c-4ce8-b557-bbddd297ddd9")
