...
;;; The current shipping version of NOL is 5.0 Beta Rev. 0 ("50r0").  

(defvar g2-shortcut-folder-name "Gensym G2 NOL 5.0r0")
(defvar nol-shortcut-folder-name "Gensym G2 NOL 5.0r0")

(require "g2-82r2-family")        ; g2-82r2-family       
(provide 'nol-50r0-family)	; NOL 5.0r0
...
(def-family nol-50r0
    ...
    :print-name "NOL"
    :directory "nol-5.0r0"
    :guid "b598691f-ea2a-4e0d-8946-561b9aa0287d" ; 5.0r0
...
(def-g2-ok-components (neuron-line-premium-development :obfuscate t) nol "NeurOnline Premium Development"
			  ...
			  (1 "-aug25-2006") (1 "-sep25-2006") (1 "-oct25-2006")
