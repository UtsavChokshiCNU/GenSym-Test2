...
(def-family G2-52b1
    ...
    :print-name "G2"
    :directory "g2classic"
    :guid "243D4BB9-9EE7-11D4-8111-00A02431D004"
    :previous-versions (("5.1r7" "243D4BB1-9EE7-11D4-8111-00A02431D004")
...
(def-component telewindows2 :parts (tw2 tw2-intelnt)
...
(def-component javalink
  :parts (jvl jvl-intelnt jvl-com-gensym-properties-intelnt)
  :non-platforms ("linux" "alphaosf")
...
(def-component documentation
  :parts (g2stkdoc g2doc g2utldoc jvldoc tw2doc axldoc corbalinkdoc
		;   g2stkpdf ;yduj, 4/25: the current stkdoc contains PDF files,
			     ;and thus we should leave out the excess copy of PDF files
		;   g2ps 
		   g2utlps
...
(def-component opclink :parts (opclink gsi-opclink-ok gsi-opclink-blank-ok) :platforms ("nt")
	       :print-name "OPCLink"
	       :optional true)
(def-component Oraclebridge :parts (Oraclebridge Oraclebridge-old gsi-Oracle-ok gsi-Oracle-blank-ok)
	       :non-platforms ("linux")
...
(def-part g2-exe-intelnt
    :version :60b1-dd17 :source-ship-type :internal
...
(def-part fonts
    ...
    :make-not-read-only t)
(def-part tw2
    :version :11r1-DD25 :source-ship-type :internal
...
(def-shortcut g2-reference-manual-1
    :folder-name "Gensym G2 Classic"
    :subfolder-name "Documentation"
    :application-display-name "G2 Reference Manual Vol. 1"
    :application-directory "doc\\g2\\g2"
    :target-name "g2refman1.pdf")

(def-shortcut g2-reference-manual-2
    :folder-name "Gensym G2 Classic"
    :subfolder-name "Documentation"
    :application-display-name "G2 Reference Manual Vol. 2"
    :application-directory "doc\\g2\\g2"
    :target-name "g2refman2.pdf")
...
(def-shortcut g2-protools-users-guide
    ...
    :application-directory "protools\\kbs-5\\doc"
    :target-name "titlepag.htm")
...
(def-shortcut g2-database-bridge-guide
    ...
    :application-display-name "G2 Database Bridge Guide"
    ...
    ;; -601 tag. (MHD 4/26/01)
    :application-directory "doc\\bridges"
    :target-name "g2-database.pdf")
...
(def-shortcut telewindows-users-guide
    ...
    :application-directory "doc\\g2\\starterkit"
    :target-name "twug.pdf")
...
(def-part gda :version :41b1-D17 :source-ship-type :internal :destination-directory gda :indep t)
...
(def-part g2stkdoc :version :60b1 :destination-directory doc/g2/starterkit :indep t
	  :shortcuts
	  (
	   ...
	   g2-reference-manual-1	   g2-reference-manual-2
	    ;;g2-release-notes-update;;not included in 6.0b1
	    g2-system-procedures-reference-manual
	    ;; g2-class-reference-manual	    ;;not included in 6.0b1
...
(def-part g2stkpdf :version :51r8 :destination-directory doc/g2/starterkit :indep t)
;; utilities
...
(def-part g2doc
    :version :60b1
    :destination-directory doc/g2/g2
    :indep t)
...
(def-part opclinkdoc :version :10r0 :destination-directory doc/bridges/opclink :indep t) ; check for 5.2r0 final!
(def-part g2odbcdoc :version :60r4 :destination-directory doc/bridges/odbc :indep t)
(def-part g2dbdoc
    :version :60r4			; see note at shortcut for g2-database-bridge-guide
    :destination-directory doc/bridges/db
    :indep t)

(def-part protools-5 :version :51r8-C28
	  :source protools
	  :destination-directory protools/kbs-5
	  :source-ship-type :internal
	  :indep t)
(def-part protools-6 :version :60b1-C27
	  :source protools
...
(def-part Oraclebridge
    ...
    :non-platforms ("linux" "hpux" "alphaosf"))

(def-part Oraclebridge-old
    :version :60r4a
    :source-ship-type :internal
    :source g2oracle
    :destination-directory Oracle
    :platforms ("hpux" "alphaosf"))
