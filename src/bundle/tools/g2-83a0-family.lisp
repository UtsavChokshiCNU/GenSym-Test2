...
(def-family G2-83a0
    :index 64			; per tools/datafiles/families/family-id.dat
    ...
    :guid "119575e2-3b3e-4158-9e34-fe3a31320d41"
    :compatible-previous-versions (("8.2r3" "7e98adb1-7abc-4415-a822-cb6e676eeb67")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.3a0")
...
(defvar core-g2-components
  '(g2 telewindows gateway gda gda-45r1 g2i-core-modules weblink javalink
    activexlink
...
(def-component doc-pdf
  :parts (g2doc-g2tutorials-pdf g2doc-g2refman-pdf g2doc-g2gateway-pdf
	   ...
	   g2idoc-gevm-pdf g2idoc-grlb-pdf g2idoc-grtl-pdf 
...
(def-component doc-html
  :parts (;g2classicrn-html
	  ...
	  g2idoc-gevm-html g2idoc-grlb-html g2idoc-grtl-html
...
(def-shortcut g2idoc-gdsm
    ...
    :application-display-name "G2 Data Source Management User's Guide (GDSM)"
...
(def-shortcut g2idoc-gdu
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 Developers' Utilities"
    :application-display-name "G2 Dialog Utilities User's Guide (GDU)"
...
(def-shortcut g2idoc-gerr
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 Developers' Utilities"
    :application-display-name "G2 Error Handling User's Guide (GERR)"
...
(def-shortcut g2idoc-gevm
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 Developers' Utilities"
    :application-display-name "G2 Event Management User's Guide (GEVM)"
...
(def-shortcut g2idoc-grlb
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 Developers' Utilities"
    :application-display-name "G2 Relations Browser User's Guide (GRLB)"
...
(def-shortcut g2idoc-grtl
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 Developers' Utilities"
    :application-display-name "G2 Runtime Library User's Guide (GRTL)"
...
(def-part gda-45r1
    :source gda
    :version :45r1
    :destination-directory gda-4.5r1
    :indep t
    )
...
(def-part doc-chm
    :version :83a0
    :source-filename ("G2BundleReleaseNotesHelp.chm"
