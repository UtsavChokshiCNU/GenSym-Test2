...
(def-family G2-80r1
    :index 37			; per tools/datafiles/families/family-id.dat
    ...
    :guid "9bce1969-7fbf-45a4-91cc-f54d294a7531" ;8.0r1
    :compatible-previous-versions (("8.0r0" "c5192361-2347-4ec2-827c-a9af41ddc6c9")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.0r1")
...
(def-part twng
    ...
    :destination-directory "g2"
    :postinstall-code "VerifyDLLVersion(\"comctl32.dll\",4,71,\"\",\"Telewindows\");VerifyDLLVersion(\"shell32.dll\",4,71,\"shfolder.dll\",\"Telewindows\");"
    :platforms ("nt")
...
(def-component socket-manager
    ...
    :parts (socket-manager-bin-intel socket-manager-bin-unix socket-manager-classes
	    socket-manager-kbs socket-manager-examples socket-manager-doc jre-most basic-jvl-parts)
    :optional true
    :include-in-contents (socket-manager-bin-unix socket-manager-bin-intel))

(def-part socket-manager-bin-intel
    :source sockman
    :version :41r1
    :platforms ("nt")
    :source-subdirectory bin
    :source-filename ("StartSockManBridge.bat")
...
(def-part socket-manager-bin-unix
    :source sockman
    :version :41r1
    :platforms ("sparcsol")
    :source-subdirectory bin
    :source-filename ("SocketManager.sh")
    :destination-directory "sockman/bin")
...
(def-component jmail-component
  :print-name "JMail"
  :parts (jmail-part jmail-doc jre-most basic-jvl-parts)
...
(def-component jms-component
  :print-name "JMS"
  :parts (jms-part jms-g2i-modules jms-doc jre-most basic-jvl-parts)
  :optional true
...
(def-part axlkbs
    ...
    :source axl
    :source-subdirectory kbs
    :destination-directory activexlink/kbs
    :source-filename ("g2com.kb")
    :platforms ("nt"))
...
(def-shortcut axldemo
    ...
    :application-directory "g2"
    :target-name "StartServer.bat"
    :parameters "-kb ..\\activexlink\\kbs\\axldemo.kb")
...
(def-part run-g2-sybase11-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2-sybase11.bat"
    :destination-directory sybase/bin
    :postinstall-code "replace_rootdir(\"sybase\"^\"bin\", \"run-g2-sybase11.bat\");"
...
(def-shortcut sybase11-shortcut
    ...
    :target-name "run-g2-sybase11.bat")

(def-part run-g2-sybase125-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2-sybase125.bat"
    :destination-directory sybase/bin
    :postinstall-code "replace_rootdir(\"sybase\"^\"bin\", \"run-g2-sybase125.bat\");"
...
(def-shortcut sybase125-shortcut
    ...
    :application-directory "sybase\\bin"
    :target-name "run-g2-sybase125.bat")
...
(def-part run-g2-odbc-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-odbc.bat"
    :destination-directory odbc/bin
    :postinstall-code "replace_rootdir(\"odbc\"^\"bin\", \"run-g2v8-odbc.bat\");"
...
(def-part run-g2-ora7-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-ora7.bat"
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2v8-ora7.bat\");"
    :shortcuts (ora7-shortcut))

(def-part run-g2-ora80-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-ora80.bat"
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2v8-ora80.bat\");"
    :shortcuts (ora80-shortcut))

(def-part run-g2-ora81-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-ora81.bat"
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2v8-ora81.bat\");"
    :shortcuts (ora81-shortcut))

(def-part run-g2-ora90-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-ora90.bat"
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2v8-ora90.bat\");"
    :shortcuts (ora90-shortcut))

(def-part run-g2-ora92-template-batfile
    :platforms ("nt") 
    :source "/home/development/installers/release-files"
    :source-filename "run-g2v8-ora92.bat"
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2v8-ora92.bat\");"
...
(def-shortcut ora80-shortcut
    ...
    :application-directory "oracle\\bin"
    :target-name "run-g2v8-ora80.bat")
...
(def-shortcut ora81-shortcut
    ...
    :application-directory "oracle\\bin"
    :target-name "run-g2v8-ora81.bat")
...
(def-shortcut ora90-shortcut
    ...
    :application-directory "oracle\\bin"
    :target-name "run-g2v8-ora90.bat")
...
(def-shortcut ora92-shortcut
    ...
    :application-directory "oracle\\bin"
    :target-name "run-g2v8-ora92.bat")
