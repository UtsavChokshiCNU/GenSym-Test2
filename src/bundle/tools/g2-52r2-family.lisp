...
(def-family G2-52r2
    ...
    :print-name "G2"
    :directory "g2classic"
    :guid "243D4BC0-9EE7-11D4-8111-00A02431D004" ; 5.2r1
    :previous-versions (("5.2r0" "243D4BBC-9EE7-11D4-8111-00A02431D004")
...
(def-part g2classicrn
    :version :52r1
    :source-filename "g2classicrelnotes.pdf"
    :indep t
...
(def-environment-variable sequoia-classpath :variable "CLASSPATH" :append-or-merge merge
			  :value "%SEQUOIA_HOME%\\\\classes;%SEQUOIA_HOME%\\\\classes\\\\coreui.jar;%SEQUOIA_HOME%\\\\classes\\\\sequoia.jar;%SEQUOIA_HOME%\\\\classes\\\\antlr.jar;%SEQUOIA_HOME%\\\\classes\\\\ax2jbeans.jar")
