...
;;; The current shipping version of NOL is 5.0 Beta Rev. 0 ("50b0").  

(defvar g2-shortcut-folder-name "Gensym G2 NOL 5.0b0")
(defvar nol-shortcut-folder-name "Gensym G2 NOL 5.0b0")

(require "g2-82r2-family")        ; g2-82r2-family       
(provide 'nol-50b0-family)	; NOL 5.0b0
...
(def-family nol-50b0
    ...
    :print-name "NOL"
    :directory "nol-5.0b0"
    :guid "9145e84f-7ea6-46aa-9892-a652dd60a4f9" ; 5.0b0
...
(def-part nol-classic-kb
    ...
    :source-filename ("nol.kb" "nolapps.kb" "gnneapps.kb" "noldemo.kb" "nolexten.kb" "nolx.kb" 
				"nolxapps.kb" "nolui.kb" "java-module.kb"  "nolspack.kb" "nolstudio.kb" "jlintf.kb"))
