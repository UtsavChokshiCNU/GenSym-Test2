...
(require "g2-80r1-family")
(provide "tw2-13r1-family")

(def-family tw2-13r1
    :index 48			; per tools/datafiles/families/family-id.dat
    :file-syntax-version 10
    :bundles (tw2-client)
    :print-name "Telewindows2 Toolkit"    
    :directory "g2-8.0r1"
    ;; per tools/datafiles/families/guid.dat:
    :guid "a68433b0-351c-4ce8-b557-bbddd297ddd9"
    :compatible-previous-versions (("1.2r9" "d5d1af9e-9a2d-4b5e-bcfd-95bdd8c3063a")
...
(def-part tw2-unix
    :source tw2
    :version :13r1-GI08 :source-ship-type :internal
