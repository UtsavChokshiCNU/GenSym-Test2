...
(def-family G2-83a1
    :index 75			; per tools/datafiles/families/family-id.dat
    ...
    :guid "7e2afbe3-f71a-4c50-90a6-269814d09516"
    :compatible-previous-versions (("8.3a0" "119575e2-3b3e-4158-9e34-fe3a31320d41")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.3a1")
...
(def-part g2-megabundle-ok-file
    ...
    :source-filename "g2-83a1-megabundle.obf"
...
(defvar additional-g2-components '(jmail-component jms-component socket-manager jsnmp-bridge))
...
(def-bundle g2-deployment
    :components (core-g2-components
		  ...
		  rethink escor nol integrity optegrity)
    :version :83a1
...
(def-component doc-pdf
  :parts (g2doc-g2tutorials-pdf g2doc-g2refman-pdf g2doc-g2gateway-pdf
	   ...
	   g2idoc-gedp-pdf g2idoc-grpe-pdf g2idoc-gweb-pdf g2idoc-brms-pdf
	   g2idoc-geuc-pdf
...
(def-component doc-html
  :parts (;g2classicrn-html
	  ...
	  g2idoc-gedp-html g2idoc-grpe-html g2idoc-gweb-html g2idoc-brms-html
	  g2idoc-geuc-html
...
(def-component g2i-core-modules
  ...
  :parts (g2i-core-modules g2i-examples g2i-data))
...
(def-part g2i-core-modules
  ...
  :source-filename ("gens.kb" "gerr.kb" "grtl.kb"  "glf.kb" "gqs.kb" "gqsui.kb" "gqsviews.kb" "resources-english.txt" "config.txt" "gevm.kb" "gdsm.kb" "grlb.kb" "gdu.kb" "gduc.kb" "gdue.kb" "gdpm.kb" "geuc.kb" "gedp.kb" "grpe.kb" "gweb.kb" "brms.kb")
  :make-not-read-only t
...
(def-part g2i-examples
  ...
  :source-filename ("gqsdemo.kb" "gevm-demo.kb" "gdu-demo.kb" "g2i-ui-demo.kb"
		    ...
		    "gedp-demo.kb" "grpe-demo.kb" "brms-demo.kb")
  :shortcuts (g2i-gqsdemo-shortcut g2i-gevm-demo-shortcut g2i-gdu-demo-shortcut g2i-ui-demo-shortcut g2i-gedp-demo-shortcut g2i-gdpm-demo-shortcut g2i-brms-demo-shortcut g2i-grpe-demo-shortcut)
  :destination-directory "g2i/examples")

(def-shortcut g2i-gqsdemo-shortcut
    :parent startserver-shortcut
    :subfolder-name "Examples"
    :subsubfolder-name "G2 Developer's Utilities"
...
(def-shortcut g2i-gevm-demo-shortcut
    ...
    :subfolder-name "Examples"
    :subsubfolder-name "G2 Developer's Utilities"
    :application-display-name "G2 Event Management (GEVM) Example"
...
(def-shortcut g2i-gdu-demo-shortcut
    ...
    :subfolder-name "Examples"
    :subsubfolder-name "G2 Developer's Utilities"
    :application-display-name "G2 Dialog Utilities (GDU) Example"
...
(def-shortcut rethink-online-server-shortcut
    ...
    :application-display-name "Start G2 ReThink Online Server"
    :application-directory "g2"
    :target-name "StartServer.bat"
...
(def-component integrity
  ...
  :optional true
  :parts (integrity-doc ping-manager   cdg-readme integrity-g2i-modules integrity-mib-parser remote-OS-agent integrity-readme integrity-reasoner-kbs)
...
;;    :postinstall-code "replace_rootdir(\"integrity\"^\"bin\", \"StartServer.bat\");"
    :shortcuts (integrity-shortcut reasoner-sym-users-guide 
                 mpe-demo-shortcut opac-demo-shortcut opx-demo-shortcut)
    :indep t) 
...
(def-component optegrity
  ...
  :optional true
  :parts (optegrity-win-doc optegrity-release-notes optegrity-doc opt-io-modules opt-io-data opt-io-resources opt-io-examples  optegrity-readme opt-bin  opt-kbs opt-resources opt-g2i-modules
...
(def-part optegrity-doc
    ...
    :version :50r0
;;;    :source-ship-type :internal
    :source-filename ("OptegrityUsersGuide.pdf" "SymCureUsersGuide.pdf" "OptegrityHeaterTutorial.pdf")
