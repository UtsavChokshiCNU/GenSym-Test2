...
;; yduj and wmorris
(defvar g2-shortcut-folder-name "Integrity")
(defvar integrity-shortcut-folder-name "Integrity")
(defvar optegrity-shortcut-folder-name "Optegrity")

(require "g2-61r0-family")			; G2 6.1r0
;;(require "g2-52r1-family")			; G2 6.0r1
;;; Use this for 3.4r0 version of Integrity (require "g2-family")			; G2 5.1r7
(provide "integrity-35r1-family")
...
(defvar integrity-common
  '(javalink integrity-client ping-manager remote-OS-agent
    ...
    socket-manager documentation protools activexlink weblink telewindows2
...
(defvar opt-g2-bridges-common
  '(opt-corbalink opt-opclink opt-Oraclebridge opt-Sybasebridge opt-ODBCbridge))
...
(def-shortcut int-rel-notes
    :folder-name integrity-shortcut-folder-name
    :subfolder-name "Documentation"
    :application-display-name "Integrity 3.5r1 Release Notes"
    :application-directory "doc"
...
(def-part integrity-readme
    ...
    :source-filename "integrity-readme-first-35r1.txt"  ;;change this for each release!
...
(def-shortcut opt-rel-notes
    :folder-name "Optegrity\\Documentation"
    :application-display-name "Optegrity 3.5r1 Release Notes"
    :application-directory "optdoc"
...
(def-component opt-documentation
  :parts (opt-g2pdf opt-g2utlpdf opt-jvldoc opt-tw2doc opt-axldoc opt-corbalinkdoc
		 opt-g2classicrn
...
(def-component opt-Oraclebridge
             :parts (opt-Oraclebridge gsi-Oracle-ok opt-run-g2-ora7-template-batfile 
                     opt-run-g2-ora80-template-batfile opt-run-g2-ora81-template-batfile gsi-Oracle-blank-ok)
...
(def-part opt-corbalinkdoc :version :10r1-DF18 :source corbalinkdoc :destination-directory doc/bridges/corbalink :indep t)
(def-part opt-g2oradoc :version :60r4-DE18 :source g2oradoc :destination-directory doc/bridges/oracle :indep t)
(def-part opt-g2sybdoc :version :60r4-DE18 :source g2sybdoc :destination-directory doc/bridges/sybase :indep t)
(def-part opt-opclinkdoc :version :10r0-DD24 :source opclinkdoc :destination-directory doc/bridges/opclink :indep t) ; check for 5.2r0 final!
(def-part opt-g2odbcdoc :version :60r4-DE18 :source g2odbcdoc :destination-directory doc/bridges/odbc :indep t)
