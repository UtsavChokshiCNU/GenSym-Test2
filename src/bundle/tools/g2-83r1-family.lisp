...
(def-family G2-83r1
    :index 82			; per tools/datafiles/families/family-id.dat
    ...
    :guid "3973967d-6c2a-4703-a287-be1a50ab5a02"
    :compatible-previous-versions (("8.3r0" "db696946-2d97-44c2-b5f5-7971488fcab4")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.3r1")
...
(setq prevailing-ok-version-suffix "-v83")
...
(def-g2-ok-components (g2-development :obfuscate :from-sandbox)
    ...
    (1 2 3 (1 2)
       ...
       (1 "-apr25-2008") (1 "-may25-2008") (1 "-jun25-2008")))
...
(def-component g2-megabundle-ok-file
  :print-name "G2 83r0 Megabundle OK file (internal use only)"
...
(def-part g2-megabundle-ok-file
    ...
    :source-filename "g2-83r0-megabundle.obf"
...
(defvar core-g2-components
  '(g2 telewindows gateway gda g2i-core-modules weblink javalink gateway-redhat4
    activexlink
    corbalink opcclient opclink pibridge Oraclebridge Sybasebridge ODBCbridge gservice
    g2-readme protools))
...
(def-component g2
  ...
  (g2-intelnt g2-unix
	      ...
	      jmskbs odbckbs oraclekbs sybasekbs pikbs opcclientkbs socket-manager-kbs 
...
(def-component gateway-redhat4
  :parts (gsi-redhat4)
  :print-name "G2 Gateway (GSI) for Red Hat Enterprise Linux 4"
  :optional true
  :platforms ("linux"))
...
(def-component opcclient :parts (opcclient gsi-opcclient-ok gsi-opcclient-blank-ok) :platforms ("nt")
...
(def-part gsi-redhat4
    :version 83r1-REDHAT4
    :source gsi
    :destination-directory gsi-rhel4
    :platforms ("linux"))
...
(def-part g2i-core-modules
  ...
  :source-filename ("gens.kb" "gerr.kb" "grtl.kb" "grtl-icons.kb" "grtl-utils.kb" "glf.kb" "gqs.kb" "gqsui.kb" "gqsviews.kb" "resources-english.txt" "gdpm-resources-english.txt" "config.txt" "gevm.kb" "grlb.kb" "gdu.kb" "gduc.kb" "gdue.kb" "gdpm.kb" "geuc.kb" "gedp.kb" "grpe.kb" "gweb.kb" "brms.kb" "bpms.kb"
...
(def-part jms-doc
  ...
  :platforms ("nt" "hpux" "hpia64" "linux")
  :indep t
...
(def-component NOL
  ...
  :parts (nolstudio-data nolstudio-math-library   nolstudio-window-classic-dll nolstudio-deploy-library
	  nolstudio-gui nolstudio-batch nolstudio-online-batch 
nolstudio-examples nolstudio-deploy-misc nol-classic-kb nol-classic-nt gnne-demo gnne-demo-config nol-total-demo nol-bakery-demo nol-bleach-demo nol-classic-gnne nol-g2i-modules  nol-classic-documentation nol-readme nolstudio-window-misc nolstudio-ActiveX-control)
...
(def-component integrity
  ...
  :platforms ("nt" "hpux" "sparcsol" "hpia64")
...
(def-component optegrity
  ...
  :optional true
  :parts (optegrity-win-doc  optegrity-doc opt-io-modules opt-io-data    optegrity-readme opt-bin  opt-kbs  opt-g2i-modules 
