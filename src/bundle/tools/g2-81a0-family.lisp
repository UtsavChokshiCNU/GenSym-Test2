...
(def-family G2-81a0
    :index 49			; per tools/datafiles/families/family-id.dat
    ...
    :guid "3a6d5b1d-08e5-42fa-973e-518ccd5c2b9e" ;
    :compatible-previous-versions (("8.0r1" "9bce1969-7fbf-45a4-91cc-f54d294a7531")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.1a0")
...
(def-part tw-intelnt
    ...
    :source tw
    :source-filename ("tw.exe" "nptwplug.dll")
    :destination-directory "g2"
    :platforms ("nt")
...
(def-registry-entry tw-registry-entry
    :path  "HKEY_LOCAL_MACHINE\\SOFTWARE\\Gensym\\Telewindows\\8.1 Alpha Rev. 0" 
    :key-name "installDir"
    :value "%ROOTDIR%\\g2")
...
(def-part workspace-view
    :version :81a0
    :destination-directory "g2"
    :source-filename ("WSView.frm" "WSView.frx" "WorkspaceViewDemo.exe" "WorkspaceView.ocx" "WorkspaceViewDemo.vbp" "WorkspaceViewDemo.vbw" "registerWSV.bat" "unregisterWSV.bat" "wsvdemo.kb" "wsview.html")
    :platforms ("nt")
...
(def-part g2i-core-modules
  ...
  :source-filename ("gens.kb" "gerr.kb" "grtl.kb"  "glf.kb" "gqs.kb" "gqsui.kb" "gqsviews.kb" "resources-english.txt" "config.txt" "gevm.kb" "gdsm.kb" "grlb.kb")
...
(def-part g2i-examples
  ...
  :indep t
  :source-subdirectory examples
  :source-filename ("gqsdemo.kb" "gevm-demo.kb")
  :shortcuts (g2i-gqsdemo-shortcut g2i-gevm-demo-shortcut)
...
(def-component socket-manager
    ...
    :parts (socket-manager-intel socket-manager-unix jre-most basic-jvl-parts)
    :optional true
