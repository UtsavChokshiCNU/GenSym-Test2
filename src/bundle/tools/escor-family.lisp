...
;;; The current shipping version of e-SCOR is 2.1 Rev. 0 ("21b0").  The symbol
;;; :21b0 should be used generally for e-SCOR elements below.

(def-part-version :21b0 :major 2 :minor 1 :revision 0 :suffix "" :letter "b")
