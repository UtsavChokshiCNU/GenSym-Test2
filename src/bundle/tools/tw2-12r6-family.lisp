...
(def-family tw2-12r6
    ...
    :guid "BF1B2B68-73E4-4691-BCB9-F780C5CAE906"
...
(def-component telewindows2 :parts (tw2 tw2-intelnt-with-shortcuts tw2-javadoc-with-shortcuts )
	       :print-name "Telewindows2 Toolkit")

(def-component telewindows2-no-shortcuts :parts (tw2 tw2-intelnt tw2-javadoc)
	       :print-name "Telewindows2 Toolkit")

(def-component telewindows2-jars :parts (tw2-jars-only-unix tw2-jars-only-intelnt)
...
(def-part tw2-jars-only-intelnt
    :version :12r6
    :source tw2
