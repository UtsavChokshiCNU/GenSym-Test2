...
;;; The current shipping version of NOL is 4.3 Rev. 0 ("43r0").  

(defvar g2-shortcut-folder-name "Gensym NOL 4.3r0")
(defvar nol-shortcut-folder-name "Gensym NOL 4.3r0")

(require "g2-71r0-family")			; G2 7.1r0
(provide 'nol-43r0-family)
...
(def-family nol-43r0
    ...
    :print-name "NOL"
    :directory "nol-4.3r0"
    :guid "6ebdaab3-894f-4a65-82ce-e8296fee7d76" ; 4.3r0
    :previous-versions (
...
(def-component nol-classic
  :parts (nol-classic nol-classic-nt nol-classic-unix nol-total-demo nol-bakery-demo nol-bleach-demo)
  :print-name "NOL Classic")

(def-component nol-classic-g2i
  :parts (nol-classic-gnne nol-g2i-modules g2i-core-modules odbc-bridge opclink-bridge jmail-part jmail-doc jms-part jms-doc jre basic-jvl-parts gdsm-fix-kb)
...
(def-part gdsm-fix-kb
    :version :43r0-HP
    :source gda
    :source-filename ("gdsm.kb")
    :destination-directory g2i/kbs
	:destination-filename gdsm.kb
    :indep t)
