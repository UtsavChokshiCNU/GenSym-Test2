...
(def-family G2-80a1
    :index 33			; per tools/datafiles/families/family-id.dat
    ...
    :guid "162d35e4-346d-426a-b840-b3495f4c51a4" ; 8.0a1
    :compatible-previous-versions (("8.0a0" "49D6E4C9-C17A-41f4-AAD1-CC92F9575A15")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.0a1")
...
;    :path  "HKEY_LOCAL_MACHINE\\SOFTWARE\\Gensym\\Telewindows\\8.0 Alpha Rev. 1" 
;    :key-name "installDir"
;    :value "%ROOTDIR%") ;; or something???
...
(def-component socket-manager
    ...
    :parts (socket-manager-bin socket-manager-classes socket-manager-kbs socket-manager-doc jre basic-jvl-parts)
    :optional true
