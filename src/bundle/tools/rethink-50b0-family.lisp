...
(defvar g2-shortcut-folder-name "Gensym G2 ReThink 5.0b0")
(defvar rethink-shortcut-folder-name "Gensym G2 ReThink 5.0b0")
(defvar rethink-example-subsub-folder-name "ReThink")

(require "g2-82r1-family")
(provide "rethink-50b0-family")

(def-family rethink-50b0
    :index 53
    :file-syntax-version 10
    :print-name "G2 ReThink"
    :bundles (rethink-offline rethink-online rethink-client-only)
    :directory "rethink-5.0b0"
