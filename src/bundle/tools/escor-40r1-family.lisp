...
;;; The current shipping version of e-SCOR is 4.0 Rev. 1 ("40r1").  The
;;; symbol :40r1 should be used generally for e-SCOR / ReThink elements below.

(defvar g2-shortcut-folder-name "Gensym e-SCOR & ReThink")
(defvar escor-shortcut-folder-name "Gensym e-SCOR & ReThink")

(require "g2-61r0-family")			; G2 6.1r0
(provide "escor-40r1-family")

(def-family escor-40r1
    :index 10
...
(def-bundle escor-online
    :components (core-runtime-client rethink-client escor-client escor-online-client jre
			...
			g2 telewindows telewindows2 javalink gateway protools 
