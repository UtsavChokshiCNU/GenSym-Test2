...
(def-family G2-71r3
    :index 36			; per tools/datafiles/families/family-id.dat
    ...
    :guid "cba808f0-ce0d-47d3-b0c6-3be1d5671e63" ; 7.1r3
    
    :compatible-previous-versions (("7.1r2" "89e84532-b802-465f-8a5d-d3f0719db337")
				   ("7.1r1" "a58bf6ff-20f6-41b9-bc4a-63b6f942c98d")
...
(defvar g2-shortcut-folder-name "Gensym G2 7.1r3")
...
(def-component socket-manager
    ...
    :parts (socket-manager-bin-intel socket-manager-bin-unix socket-manager-classes socket-manager-kbs socket-manager-examples socket-manager-doc jre basic-jvl-parts)
    :optional true
...
(def-shortcut sockman-demo-shortcut
    ...
    :parameters "..\\sockman\\examples\\gsockdemo.kb"
)
