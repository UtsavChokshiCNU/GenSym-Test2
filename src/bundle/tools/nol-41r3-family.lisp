...
;;; The current shipping version of NOL is 4.1 Rev. 3 ("41r3").  The
;;; symbol :41r3 should be used generally for NOL elements below.

(defvar g2-shortcut-folder-name "Gensym NOL 4.1r3")
(defvar nol-shortcut-folder-name "Gensym NOL 4.1r3")

(require "g2-62r2-family")			; G2 6.2r2
(provide 'nol-41r3-family)
...
(def-family nol-41r3
    ...
    :guid "9C4D66F9-B71E-4EB9-BB91-FA9BE1954B57" ; 4.1r3
    :previous-versions (
...
(def-bundle nol-studio-deployment
    :version :41r3
    :components (nolstudio-core-development nols-basic-components nolstudio-window-deployment)
    :platforms ("nt")
...
(def-component nol-classic
  :parts (nol-classic nol-classic-nt nol-classic-unix)
...
(def-shortcut noldemo-shortcut
    ...
    :parameters "-kb ..\\nol\\noldemo.kb -module-search-path \"'..\\g2\\kbs\\utils' '..\\nol' '..\\gda' '..\\protools\\kbs' '..\\activexlink' '..\\gsi' '..\\gw\\kbs' '..\\tw2\\kbs'\" -ok ..\\g2\\g2.ok -start")
