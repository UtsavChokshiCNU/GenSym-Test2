...
(defvar g2-shortcut-folder-name "Gensym G2 e-SCOR 5.1a0")
(defvar escor-shortcut-folder-name "Gensym G2 e-SCOR 5.1a0")

(require "rethink-50r1-family")
(require "g2-82r3-family")
(provide "escor-51a0-family")

(def-family escor-51a0
    :index 72
    :file-syntax-version 10
    :print-name "G2 e-SCOR"
    :bundles (escor-offline escor-online)
    :directory "escor-5.1a0"
    :guid "86658842-a2a5-4863-84d5-11221955978f"
    :compatible-previous-versions (("5.0r0" "6c10f73d-11d6-4fb0-b814-ab96c5063440")
...
(def-g2-ok-components (escor-offline :obfuscate :from-sandbox) escor-offline "e-SCOR Offline"
  (1
...
;;;			escor-documentation rethink-documentation)
;;;    :print-name "G2 e-SCOR Online Client Only"
;;;    :directory "escor"
;;;    :version :51a0)
