...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym Optegrity 4.2b0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym Optegrity 4.2b0")
;; MODIFY
...
(def-component optegrity-documentation
    ...
    :parts (optegrity-doc optegrity-release-notes))
