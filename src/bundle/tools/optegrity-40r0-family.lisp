...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym Optegrity 4.0r0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym Optegrity 4.0r0")
;; MODIFY
;; Defining the module search path for Optegrity.  This needs to be modified if the support
;;   KBs path changes.
(defvar optegrity-search-path-and-ok-file "-module-search-path ..\\g2i\\kbs kbs\\utils ..\\optegrity\\kbs ..\\optegrity\\demos ..\\pi ..\\odbc ..\\opclink\\kbs ..\\protools\\kbs ..\\gw ..\\corbalink\\kbs ..\\javalink\\kbs ..\\gda ..\\activexlink ..\\oracle ..\\sybase -ok ..\\g2\\g2.ok")
...
(def-part-version :40r0-B03I17 :major 4 :minor 0 :revision 0 :suffix "-B03I17" :letter "r")
...
(def-g2-ok-components (optegrity-reasoner-development :obfuscate t) optegrity "Optegrity Development"
			...
			(1 "-apr25-2004") (1 "-may25-2004") (1 "-jun25-2004")
			(1 "-jul25-2004") (1 "-aug25-2004") (1 "-sep25-2004")
			(1 "-oct25-2003")	(1 "-nov25-2003") (1 "-dec25-2003")
                  (1 "-aug25-2003") (1 "-sep25-2003")
))
...
(defvar optegrity-common
  '(javalink optegrity-documentation socket-manager g2i-core-modules doc-pdf doc-html doc-chm
    protools activexlink weblink telewindows g2 gateway g2-readme gda jre cdg-import-export 
    optegrity-readme gservice io-modules ))
...
(def-shortcut g2-shortcut
    ...
    :target-name "g2.exe"
    :parameters "-module-search-path ..\\g2i\\kbs kbs\\utils ..\\optegrity\\kbs ..\\optegrity\\demos ..\\pi ..\\odbc ..\\opclink\\kbs ..\\protools\\kbs ..\\gw ..\\corbalink\\kbs ..\\javalink\\kbs ..\\gda ..\\activexlink ..\\oracle ..\\sybase -ok ..\\g2\\g2.ok")
...
;;;    :subfolder-name "Documentation"
;;;    :subsubfolder-name "Optegrity"
    :application-display-name "Optegrity 4.0r0 Bundle Release Notes"
    :application-directory "doc/optegrity"
...
(def-component io-modules
  ...
  :parts (opt-io-modules opt-io-data opt-io-examples opt-io-resources)
  :optional true
...
(def-part opt-io-data
    ...
    :source-filename ("io-external-datapoints-configuration.csv" "io-replay-to-external-datapoint.csv")
...
;;;=== ODBC Bridge delivered with G2 7.0r1
...
(def-part opt-bin
    ...
    :version :40r0
    :source-subdirectory bin
    :source-filename ("InstallServerAsNTService.bat" "Optegrity.ico" "StartServer.bat" "UninstallServerAsNTService.bat")
    :destination-directory "optegrity/bin"
    :postinstall-code "replace_rootdir(\"optegrity\"^\"bin\", \"StartServer.bat\");replace_rootdir(\"optegrity\"^\"bin\", \"InstallServerAsNTService.bat\");replace_rootdir(\"optegrity\"^\"bin\", \"UninstallServerAsNTService.bat\");"
    :shortcuts (optegrity-shortcut optegrity-sym-users-guide furnace-demo-shortcut symcure-demo-shortcut)
    :indep t
)
...
(def-shortcut optegrity-shortcut
    :folder-name optegrity-shortcut-folder-name
    :application-display-name "Start Optegrity"
    :application-directory "optegrity\\bin"
...
(def-shortcut symcure-demo-shortcut
    ...
    :application-directory "optegrity\\bin"
    :target-name "StartServer.bat"
    :parameters "..\\..\\g2i\\kbs\\cdg-modguide.kb")
...
(def-part opt-g2i-modules
  ...
  :destination-directory "g2i/kbs"
  :source-subdirectory kbs
  :source-filename ("cdg.kb" "cdggrlb.kb" "gdpm.kb" "grlb.kb" "gdsm.kb" "gedp.kb" "guif.kb" "guif-resources.txt" "cdg-modguide.kb")
  :indep t)
;;;
