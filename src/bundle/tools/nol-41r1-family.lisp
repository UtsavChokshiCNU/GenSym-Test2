...
;;; The current shipping version of NOL is 4.1 Rev. 1 ("41r1").  The
;;; symbol :41r1 should be used generally for NOL elements below.

(defvar g2-shortcut-folder-name "Gensym NOL")
(defvar nol-shortcut-folder-name "Gensym NOL")

(require "g2-61r0-family")			; G2 6.1r0
(provide 'nol-41r1-family)
...
(def-family nol-41r1
    ...
    :guid "39C4AC65-75FF-4EA5-A105-A001BF1BD5E7" ; 4.1r1
    :previous-versions (
...
(def-part nolstudio-batch
	...
	:shortcuts (nolstudio-batch-file nolstudio-users-guide nolstudio-readme))
...
(def-part nol-classic-nt
    ...
    :shortcuts (nol-users-guide noldemo-shortcut nolapp-shortcut))
