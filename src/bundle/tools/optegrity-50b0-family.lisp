...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym G2 Optegrity 5.0b0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym G2 Optegrity 5.0b0")
;; MODIFY
...
(require "g2-82r1-family")                ; Optegrity 5.0b0
...
(def-g2-ok-components (optegrity-reasoner-development :obfuscate t) optegrity "G2 Optegrity Development"
...
(def-g2-ok-components (optegrity-reasoner-deployment :obfuscate t) optegrity "G2 Optegrity Deployment"
		      (4 8 16 20 24 28 32
			(1 "-jan25-2006") (1 "-feb25-2006")
			(1 "-mar25-2006") (1 "-apr25-2006") (1 "-may25-2006")
			(1 "-jun25-2006") (1 "-jul25-2006") (1 "-aug25-2006")
...
(def-part optegrity-doc
    ...
    :version :50b0
;;;    :source-ship-type :internal
    :source-filename ("GEDPUsersGuide.pdf" "OptegrityUsersGuide.pdf" "SymCureUsersGuide.pdf" "OptegrityIntelligentFurnaceTutorial.pdf")
...
(def-component optegrity-kbs
  :print-name "G2 Optegrity KBs"
  :parts (opt-archive opt-bin opt-kbs opt-g2i-modules opt-logs opt-resources odbckbs opclinkkbs pikbs opt-jms jms-g2i-modules opt-project opt-g2i-examples opt-g2i-datafiles)
...
;;;  :source-ship-type :internal
  ...
  :postinstall-code "replace_rootdir(\"g2i\"^\"kbs\", \"config.txt\");"
  :source-subdirectory kbs
  :source-filename ("cdg.kb" "cdggrlb.kb" "gdpm.kb" "gedp.kb" "guif.kb" "guif-resources.txt" "geuc.kb" "symcure.kb" "grtl.kb" "gevm.kb" "gqs.kb" "gqsui.kb" "gqsviews.kb" "grlb.kb" "gdsm.kb" "gdu.kb" "gduc.kb" "gdue.kb" "gens.kb" "gerr.kb" "glf.kb" "config.txt" "resources-english.txt")
  :indep t)
;;;
