...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym Optegrity 4.2r0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym Optegrity 4.2r0")
;; MODIFY
...
(def-g2-ok-components (optegrity-reasoner-development :obfuscate t) optegrity "Optegrity Development"
			...
			(1 "-oct25-2004") (1 "-nov25-2004") (1 "-dec25-2004")
))
...
(defvar optegrity-common
  '(javalink optegrity-documentation g2i-core-modules doc-pdf doc-html doc-chm
    ...
    optegrity-readme gservice io-modules gda-43r1-component))
...
;;; Updated GDA version
;;;
(def-component gda-43r1-component :parts (gda-43r1 gda-jvl-43r1 gda-g2i-43r1) :print-name "G2 Diagnostic Assistant (GDA)")
