...
;;; The current shipping version of e-SCOR is 4.0 Rev. 2("40r2").  The
;;; symbol :40r2 should be used generally for e-SCOR / ReThink elements below.

(defvar g2-shortcut-folder-name "Gensym e-SCOR & ReThink 4.0r2")
(defvar escor-shortcut-folder-name "Gensym e-SCOR & ReThink 4.0r2")

(require "g2-62r0-family")
(provide "escor-40r2-family")

(def-family escor-40r2
    :index 16
    ...
    :guid "CCD24411-CF01-4661-BAA0-90E52E487142"
    :previous-versions (("4.0r1" "3BFDD0B2-F895-489B-A51C-9C44F6BB4405")
...
(def-bundle escor-online
    :components (core-runtime-client rethink-client escor-client escor-online-client jre
			...
			weblink escor-activexlink corbalink opclink Oraclebridge Sybasebridge ODBCbridge
