...
(def-family G2-80a0
    :index 29			; per tools/datafiles/families/family-id.dat
    ...
    :guid "49D6E4C9-C17A-41f4-AAD1-CC92F9575A15" ; 8.0a0
    :compatible-previous-versions (("7.1r0" "55F37F88-60D2-466e-BA95-517719158B18") ; 7.1r0
				   ("7.0r1" "23961651-4FCF-4fec-BC84-2DE2E5679818") ; 7.0r1
...
(defvar g2-shortcut-folder-name "Gensym G2 8.0a0")
...
(def-part workspace-view
    :version :10a0
    :destination-directory "g2"
    :source-filename ("WSView.frm" "WSView.frx" "WorkspaceView.ocx" "WorkspaceViewDemo.vbp" "WorkspaceViewDemo.vbw" "g2com.kb" "registerWSV.bat" "unregisterWSV.bat" "workspace-views.kb" "wsvdemo.kb" "wsview.html")
    :platforms ("nt"))
