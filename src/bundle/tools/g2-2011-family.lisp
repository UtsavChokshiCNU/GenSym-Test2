...
;; Copyright (c) 2012-2013 DevFactory, Inc.
...
(def-family G2-2011
    :index 219			; per tools/datafiles/families/family-id.dat
    ...
    :guid "f5c990cb-f7cb-48b6-9cee-3e7db4afb021"
    :compatible-previous-versions (("8.3r1" "3973967d-6c2a-4703-a287-be1a50ab5a02")
...
(defvar g2-shortcut-folder-name "Gensym G2 2011")
...
(setq prevailing-ok-version-suffix "-v11")
...
(def-g2-ok-components (g2-development :obfuscate :from-sandbox)
    ...
    (1 2 3 (1 2)
       ...
       (1 "-dec25-2013")
       (1 "-jan25-2014") (1 "-feb25-2014") (1 "-mar25-2014")
       (1 "-apr25-2014") (1 "-may25-2014") (1 "-jun25-2014")
       (1 "-jul25-2014") (1 "-aug25-2014") (1 "-sep25-2014")))
...
(defvar additional-g2-development-components '(jre doc-pdf doc-chm))
...
(def-component g2
  ...
  (g2-intelnt g2-unix
	      ...
	      jmskbs odbckbs odbckbsunicode jdbckbs mssqlkbs
...
(def-component telewindows
  :parts (tw-intelnt
	   tw-unix twng twng-style tw-win2000
...
(def-component activexlink
  ...
  :parts (axl-g2com-dll axl-msvcr100-dll axl)
  :platforms ("nt")
...
(def-component doc-pdf
  :parts (g2doc-g2tutorials-pdf g2doc-g2ldap-pdf g2doc-g2refman-pdf g2doc-g2gateway-pdf
...
(def-component doc-html
  :parts (#|
	  ...
	  jvldoc-javalink-html #+nil jvldoc-di-html #+nil jvldoc-bb-html axldoc-html corbalinkdoc-html 
	  g2oradoc-html g2sybdoc-html opcclientdoc-html g2pidoc-html g2odbcdoc-html
	  g2dbdoc-html protoolsdoc-html weblinkdoc-html gdadoc-api-html gdadoc-ug-html
	  snmpdoc-html |#)
  :print-name "G2 Full Documentation (HTML/Gold)"
  :include-in-contents (#+nil g2doc-g2refman-html)
  :typical false)
...
(def-component opcclient :parts (opcclient) :platforms ("nt")
	       :print-name "G2 OPC Client Bridge"
	       :optional true)

(def-component opclink :parts (opclink) :platforms ("nt")
	       :print-name "G2 OPCLink Bridge"
	       :optional true)

(def-component pibridge :parts (g2pi
				run-g2-pi-template-batfile) :platforms ("nt")
	       :print-name "G2 PI Bridge"
	       :optional true)

(def-component g2-oracle
    :parts (oraclebridge oraclebin
	    run-g2-ora7-template-batfile run-g2-ora80-template-batfile
	    run-g2-ora81-template-batfile run-g2-ora90-template-batfile
	    run-g2-ora92-template-batfile run-g2-ora10-template-batfile
...
(def-component Sybasebridge
    :parts (Sybasebridge run-g2-sybase11-template-batfile run-g2-sybase125-template-batfile run-g2-sybase150-template-batfile)
    :print-name "G2 Sybase Bridge"
    :non-platforms ("linux" "linux64")
    :optional true)

(def-component ODBCbridge
    :parts (ODBCbridge run-g2-odbc-template-batfile run-g2-odbc-sh-file)
    :print-name "G2 ODBC Bridge"
    :optional true)

(def-component ODBCUnicodebridge
    :parts (odbcunicodebridge run-g2-odbc-unicode-template-batfile)
    :platforms ("nt")
    :print-name "G2 ODBC UNICODE Bridge"
    :optional true)

(def-component MSSQLbridge
    :parts (mssqlbridge run-g2-mssql-template-batfile)
    :platforms ("nt")
    :print-name "G2 MS SQL Bridge"
    :optional true)
...
(def-part g2-intelnt
    ...
    :source g2
    :source-filename ("g2.exe" "g2passwd.exe" "machine-id.exe" "hostlookup.exe")
    :destination-directory "g2"
    :platforms ("nt")
...
(def-part g2-unix
    ...
    :source g2
    :source-filename ("g2" "g2passwd" "hostlookup" "machine-id")
    :destination-directory "g2"
    :non-platforms ("nt"))
...
(def-part twng
    ...
    :source tw
    :source-filename ("twng.exe" "mfc100u.dll" "msvcr100.dll")
    :destination-directory "g2"
...
(def-part twng-style
    :version :2011-NG
    :print-name "TW Next Generation Styles"
    :source tw
    :source-subdirectory "Styles"
    :destination-directory "g2/Styles"
    :source-filename ("GensymTWNG.cjstyles")
    :platforms ("nt"))
...
(def-shortcut g2-ldap-authentication-usage-manual
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Documentation"
    :subsubfolder-name "G2"
    :application-display-name "LDAP authentication usage in G2"
    :application-directory "doc\\g2\\g2ldap"
    :target-name "g2ldap.pdf")
...
(def-part mssqlkbs
    ...
    :source-filename ("g2-database.kb")
    :platforms ("nt")
    :destination-directory mssql/kbs)
...
(def-part axl-msvcr100-dll
    :source axl
    :version :2011
    :source-subdirectory bin
    :source-filename "msvcr100.dll"
    :destination-directory activexlink/bin
    :platforms ("nt"))
...
(def-part g2doc-g2refman-pdf
    ...
    ;;documentation within them then there used to be, so it is less strange.
		...
		g2-reference-manual
		 ...
		 g2-tutorial
		 g2-ldap-authentication-usage-manual
...
(def-part g2doc-g2ldap-pdf
    :source g2doc
    :source-subdirectory "g2ldap"
    :version :2011
    :destination-directory doc/g2/g2ldap
    :indep t
    :platforms ("nt")
    :source-filename ("g2ldap.pdf"))
...
(def-shortcut doc-chm-shortcut
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Documentation"
    :application-display-name "G2 Help"
    :application-directory "doc-chm"
...
#+nil
(def-part opcclientdoc-html
    :source opclinkdoc
    :version :83r0-JG18
    :destination-directory doc/bridges/opcclient/html
    :indep t
    :source-subdirectory opcclient/html)
...
(def-part run-g2-sybase150-template-batfile
    ...
    :destination-directory sybase/bin
    :postinstall-code "replace_rootdir(\"sybase\"^\"bin\", \"run-g2-syb150.bat\");replace_rootdir(\"sybase\"^\"bin\"^\"x64\", \"run-g2-syb150.bat\");"
...
(def-part run-g2-odbc-template-batfile
    ...
    :postinstall-code "replace_rootdir(\"odbc\"^\"bin\", \"run-g2-odbc.bat\"); replace_rootdir(\"odbc\"^\"bin\"^\"x64\", \"run-g2-odbc.bat\");"
...
(def-part run-g2-ora10-template-batfile
    ...
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2-ora10.bat\"); replace_rootdir(\"oracle\"^\"bin\"^\"x64\", \"run-g2-ora10.bat\");"
...
(def-part run-g2-ora11-template-batfile
    ...
    :destination-directory oracle/bin
    :postinstall-code "replace_rootdir(\"oracle\"^\"bin\", \"run-g2-ora11.bat\"); replace_rootdir(\"oracle\"^\"bin\"^\"x64\", \"run-g2-ora11.bat\");"
...
(def-part run-g2-odbc-unicode-template-batfile
    ...
    :platforms ("nt")
    :postinstall-code "replace_rootdir(\"odbc_unicode\"^\"bin\", \"run-g2-odbc-unicode.bat\"); replace_rootdir(\"odbc_unicode\"^\"bin\"^\"x64\", \"run-g2-odbc-unicode.bat\");"
...
(def-part mssqlbridge
    :version :2011
    :source g2mssql
    :destination-directory mssql
    :platforms ("nt"))

(def-part run-g2-mssql-template-batfile
    :platforms ("nt") 
    :source g2mssql
    :source-subdirectory bin
    :version :2011
    :source-filename "run-g2-mssql.bat"
    :destination-directory mssql/bin
    :platforms ("nt")
    :postinstall-code "replace_rootdir(\"mssql\"^\"bin\", \"run-g2-mssql.bat\"); replace_rootdir(\"mssql\"^\"bin\"^\"x64\", \"run-g2-mssql.bat\");"
    :shortcuts (mssql-shortcut))

(def-shortcut mssql-shortcut
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Bridges"
    :application-display-name "G2 MS-SQL Bridge"
    :application-directory "mssql\\bin"
    :target-name "run-g2-mssql.bat")
...
(def-shortcut rethink-documentation-winhelp
    ...
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 ReThink"
    :application-display-name "ReThink Help"
...
(def-part escor-documentation
    ...
    :source escordoc
    :indep t
    :shortcuts (escor-documentation-quick escor-documentation-user escor-tutorial escor-winhelp))
...
;;;Note: Tasha plans to move the diretory for this.  Wait for her.
(def-shortcut escor-winhelp
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 e-SCOR"
    :application-display-name "e-SCOR Help"
    :application-directory "doc/escor/WinHelp"
    :target-name "Master.chm")
...
nolstudio-examples nolstudio-deploy-misc nol-classic-kb nol-classic-nt nol-classic-linux gnne-demo gnne-demo-config nol-total-demo nol-bakery-demo nol-bleach-demo nol-classic-gnne nol-g2i-modules  nol-classic-documentation nol-readme nolstudio-window-misc nolstudio-ActiveX-control)
  :optional true
...
(def-part nol-classic-linux
    ...
    :destination-directory "nol/bin"
    :platforms ("linux" "linux64")
    :source-filename ("startnolapps" "startbakery-demo" "startbleach-demo" "starttotal-demo")
...
(def-part nol-classic-documentation
    ...
    :shortcuts (nol-users-guide nol-reference-guide gnne-users-guide nolstudio-users-guide #|nol-html-doc|# nol-win-doc))

(def-shortcut nol-win-doc
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 NeurOn-Line"
    :application-display-name "NOL Help"
...
(def-component optegrity
  ...
  :optional true
  :parts (optegrity-win-doc optegrity-doc
...
(def-part symcure-doc
    ...
    :indep t
    :platforms ("nt")
    :shortcuts (symcure-users-guide symcure-winhelp))
...
(def-shortcut symcure-winhelp
    :folder-name g2-shortcut-folder-name
    :subfolder-name "Documentation"
    :subsubfolder-name "G2 SymCure"
    :application-display-name "SymCure Help"
    :application-directory "doc/optegrity/WinHelp"
    :target-name "SymCure.chm")
