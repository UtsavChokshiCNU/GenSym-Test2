...
(def-shortcut int-rel-notes
    :folder-name integrity-shortcut-folder-name
    :subfolder-name "Documentation"
    :application-display-name "Integrity 3.6r0 Release Notes"
    :application-directory "doc"
...
(def-part integrity-readme
    ...
    :source-filename "integrity-readme-first-36r0.txt"  ;;change this for each release!
...
(def-shortcut opt-rel-notes
    :folder-name "Optegrity\\Documentation"
    :application-display-name "Optegrity 3.6r0 Release Notes"
    :application-directory "optdoc"
