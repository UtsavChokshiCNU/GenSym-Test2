...
(defvar g2-shortcut-folder-name "Gensym e-SCOR & ReThink 4.0r4")
(defvar escor-shortcut-folder-name "Gensym e-SCOR & ReThink 4.0r4")

(require "g2-62r3-family")
(provide "escor-40r4-family")

(def-family escor-40r4
    :index 22
    ...
    :directory "escor_rethink-4.0r4"
    :guid "045E9660-BBF8-445c-9D54-4F677C054F23"
...
(def-g2-ok-components (rethink-offline :obfuscate t) rethink-offline "ReThink Offline"
  (1
     (1 "-feb25-2005") (1 "-mar25-2005")
     (1 "-apr25-2005") (1 "-may25-2005") (1 "-jun25-2005")
