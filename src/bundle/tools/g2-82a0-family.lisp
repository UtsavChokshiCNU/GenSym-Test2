...
(def-family G2-82a0
    :index 57			; per tools/datafiles/families/family-id.dat
    ...
    :guid "845b6aad-861d-44b5-a36e-2eab7524f82f"
    :compatible-previous-versions (("8.1r1" "e1417885-cf39-4385-8c10-3e843e35c1ec")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.2a0")
...
(defvar basic-jvl-parts
  '(jvl-unix jvl-intelnt jvl-3tier jvl-javadoc))
...
(def-part jvl-intelnt
  ...
  :source jvl
  :destination-directory javalink
  :postinstall-code "replace_rootdir(\"javalink\"^\"bin\", \"envvars.bat\");FixupPropertiesFile(TARGETDIR^\"javalink\"^\"bin\", \".com.gensym.properties\", TARGETDIR^\"javalink\", \"classes\", \".com.gensym.properties\");"
  :platforms ("nt")
...
(def-part axl
    ...
    :platforms ("nt")
    :shortcuts (axldemo axlhtmldemo axlvbdemo axlvbdemoproj axlc++demo axlc++proj axlexceldemo
			))
