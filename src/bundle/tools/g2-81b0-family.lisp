...
(def-family G2-81b0
    :index 50			; per tools/datafiles/families/family-id.dat
    ...
    :guid "c4664f9c-db38-4afe-b5d6-992a046c7d99" ;
    :compatible-previous-versions (("8.1a0" "3a6d5b1d-08e5-42fa-973e-518ccd5c2b9e")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.1b0")
...
(def-part twng
    ...
    :destination-directory "g2"
    :postinstall-code "VerifyDLLVersion(\"comctl32.dll\",4,71,\"\",\"Telewindows\");VerifyDLLVersion(\"shell32.dll\",4,71,\"shfolder.dll\",\"Telewindows\");LaunchAppAndWait(TARGETDIR ^ \"g2\"^\"twng.exe\", \"/regserver /s\", WAIT);"
    :platforms ("nt")
...
(def-part g2i-examples
  ...
  :shortcuts (g2i-gqsdemo-shortcut g2i-gevm-demo-shortcut g2i-gdu-demo-shortcut)
...
(def-part g2gldoc
    :source g2classicrn
    :version :81b0
    :source-filename "g2gl.pdf"
    :indep t
    :shortcuts (g2gldoc)
    :destination-directory doc/g2/g2gl)

(def-shortcut g2gldoc
    :folder-name g2-shortcut-folder-name
    :application-display-name "G2 Graphical Language User's Guide"
    :subfolder-name "Documentation"
    :subsubfolder-name "G2"
    :application-directory "doc\\g2\\g2gl"
    :target-name "g2gl.pdf")
