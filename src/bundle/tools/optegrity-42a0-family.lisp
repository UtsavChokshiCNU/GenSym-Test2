...
;;   of this bundle.
(defvar g2-shortcut-folder-name "Gensym Optegrity 4.2a0")
;; MODIFY
;; Setting the shortcut for the Optegrity bundle
(defvar optegrity-shortcut-folder-name "Gensym Optegrity 4.2a0")
;; MODIFY
...
(def-part-version :42a0 :major 4 :minor 2 :revision 0 :suffix "-B04E17" :letter "a")
...
;;;    :subfolder-name "Documentation"
;;;    :subsubfolder-name "Optegrity"
    :application-display-name "Optegrity 4.2r0 Bundle Release Notes"
    :application-directory "doc/optegrity"
...
(def-part g2i-examples
  ...
  :source-filename ("gedp-demo.kb" "gdpm-demo.kb" "geuc-demo.kb" "cdg-modguide.kb")
  :destination-directory "g2i/examples"
  :shortcuts (gedp-demo-shortcut gdpm-demo-shortcut geuc-demo-shortcut) )
