...
(def-family G2-83b1
    :index 80			; per tools/datafiles/families/family-id.dat
    ...
    :guid "9d76a758-e820-4223-b011-9472a0a5ee2b"
    :compatible-previous-versions (("8.3b0" "93f4944a-2607-4b88-a977-44ef51b0cff9")
...
(defvar g2-shortcut-folder-name "Gensym G2 8.3b1")
...
(def-part g2-megabundle-ok-file
    ...
    :source-filename "g2-83b1-megabundle.obf"
...
(defvar core-g2-components
  '(g2 telewindows gateway gateway-itanium gda g2i-core-modules weblink javalink
    activexlink
    corbalink opcclient pibridge Oraclebridge Sybasebridge ODBCbridge gservice
    g2-readme protools))
...
(def-component corbalink :parts (corbalink)
	       ...
	       :optional true)
(def-component opcclient :parts (opcclient gsi-opclink-ok gsi-opclink-blank-ok) :platforms ("nt")
...
(def-part nol-classic-documentation
    ...
    :shortcuts (nol-users-guide nol-reference-guide gnne-users-guide nolstudio-users-guide nol-html-doc))
...
(def-shortcut nol-html-doc
    ...
    :subfolder-name "Documentation (HTML)"
    :subsubfolder-name "G2 NeurOn-Line"
    :application-display-name "G2 NeurOn-Line Users' Guide and Reference Manual"
