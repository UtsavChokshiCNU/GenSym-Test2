...
(def-family G2-70r1
    :index 20			; per tools/datafiles/families/family-id.dat
    ...
    :guid "23961651-4FCF-4fec-BC84-2DE2E5679818" ; 7.0r1
    :compatible-previous-versions (("7.0r0" "487E5A3E-E452-4048-802B-3FCF81C4E4AF")
...
(defvar g2-shortcut-folder-name "Gensym G2 7.0r1")
...
(def-part axl
    :version :10r6
    :source axl
    :source-filename ("gsi.dll" "ReadMe.htm" "g2com.kb" "runme.bat" "regsvr32.exe")
