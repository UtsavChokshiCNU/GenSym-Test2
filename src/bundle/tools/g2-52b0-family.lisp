...
(def-component telewindows2 :parts (tw2 tw2-intelnt) :print-name "Telewindows2 Toolkit")
...
(def-part fonts
    ...
    :make-not-read-only t)
(def-part tw2
    :version :11r1-DD20 :source-ship-type :internal
...
(def-part g2stkdoc :version :51r8 :destination-directory doc/g2/starterkit/html :indep t
	  :shortcuts
	  (
...
(def-part g2doc
    :version :60b1-dd23
    :source-ship-type :internal
    :destination-directory doc/g2/g2/html
    :indep t)
