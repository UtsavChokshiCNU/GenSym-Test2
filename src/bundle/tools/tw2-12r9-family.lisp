...
(require "g2-71r3-family")
(provide "tw2-12r9-family")

(def-family tw2-12r9
    :index 47			; per tools/datafiles/families/family-id.dat
    :file-syntax-version 10
    :bundles (tw2-client)
    :print-name "Telewindows2 Toolkit"    
    :directory "g2-7.1r3"
    ;; per tools/datafiles/families/guid.dat:
    :guid "d5d1af9e-9a2d-4b5e-bcfd-95bdd8c3063a"
    :compatible-previous-versions (("1.2r7" "45735011-ac08-4399-8fed-3e8624792542")
