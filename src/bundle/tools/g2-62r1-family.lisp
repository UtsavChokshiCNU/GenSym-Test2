...
(def-family G2-62r1
    ...
    :guid "C88050F2-F316-4099-816C-A37D11D62831" ; 6.2r0 and 6.2r1 (both!)
    :previous-versions (("6.1r0" "5127F127-9E61-4E5C-B7F6-F34B20EC8F34")
...
(defvar g2-shortcut-folder-name "Gensym G2 6.2")
...
(def-component opclink :parts (opclink gsi-opclink-ok run-G2Opc-template-batfile gsi-opclink-blank-ok) :platforms ("nt")
	       ...
	       :optional true)
(def-component Oraclebridge :parts (Oraclebridge gsi-Oracle-ok run-g2-ora7-template-batfile run-g2-ora80-template-batfile run-g2-ora81-template-batfile gsi-Oracle-blank-ok)
