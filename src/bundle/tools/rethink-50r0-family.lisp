...
(defvar g2-shortcut-folder-name "Gensym G2 ReThink 5.0r0")
(defvar rethink-shortcut-folder-name "Gensym G2 ReThink 5.0r0")
(defvar rethink-example-subsub-folder-name "ReThink")

(require "g2-82r1-family")
(provide "rethink-50r0-family")

(def-family rethink-50r0
    :index 53
    :file-syntax-version 10
    :print-name "G2 ReThink"
    :bundles (rethink-offline rethink-online rethink-client-only)
    :directory "rethink-5.0r0"
...
(def-g2-ok-components (rethink-offline :obfuscate t) rethink-offline "ReThink Offline"
  (1
     ...
     (1 "-apr25-2007") (1 "-may25-2006") (1 "-jun25-2006")
...
;;;    :application-directory "g2"
;;;    :target-name "StartServer.bat"
;;;    :parameters "-kb ..\\g2i\\examples\\gqsdemo.kb -nowindow")
...
;;;    :application-directory "g2"
;;;    :target-name "StartServer.bat"
;;;    :parameters "-kb ..\\g2i\\examples\\gevm-demo.kb -nowindow")
...
;;;    :application-directory "g2"
;;;    :target-name "StartServer.bat"
;;;    :parameters "-kb ..\\g2i\\examples\\gdu-demo.kb -nowindow")
