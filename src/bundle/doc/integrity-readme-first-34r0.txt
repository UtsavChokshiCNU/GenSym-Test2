...
(1) Package Products  
    ...
    Integrity Core, Integrity Discover, Integrity Reasoner, Integrity Premium, and Optegrity. 
...
The knowledge base (.kb file) that loads the products included in Integrity Core is 
	opexpkg1.kb


-------------------------------------------
Integrity Discover includes Integrity Core plus network discovery, modeling and analysis
   software. Through model-based reasoning and proactive network probes, Integrity Discover
   enables you to isolate the source of a network outage. Integrity Discover includes:

	
o All Integrity Core products
o AutoDiscovery - automatic discovery and mapping of network domain maps
o IPRA - IP Reachability Analysis
o DXI3 - Domain map importer
o DSM - Domain Synchronization Manager synchronizes updating of the 
        domain map between applications
o ORA-TWO - Object Reachability Analysis
O ODG (OpEx-Denali Gateway) - allows domain element synchronization between AutoDiscovery and Integrity network models  

-------------------------------------------
Integrity Reasoner includes Integrity Core plus a model-based reasoning tool for problem diagnosis. Integrity Reasoner includes:

o All Integrity Core products
o SymCure - Model-based tool for fault modeling, and root cause failure analysis
 
-------------------------------------------
Integrity Premium is the complete Integrity solution, which combines the functionality and services of all other Integrity packages. Integrity Premium includes:

o All Integrity Core products
o All Integrity Discover products
o All Integrity Reasoner products

-------------------------------------------
Optegrity includes Integrity Core, a model-based reasoning tool (SymCure) for problem diagnosis, and the G2 Classic platform. Optegrity includes:
...
b. Load the appropriate knowledgbase for the package you purchased.  Below is a table of the available packages:
	Integrity Core		opexpkg1.kb
	Integrity Discover	opexpkg2.kb
	Integrity Premium	opexpkg3.kb
...
Integrity with AutoDiscovery User Guide
