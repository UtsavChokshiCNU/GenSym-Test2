...
-----------------------
  ...
  operating systems in C:\Program Files\Gensym\g2classic\, and on UNIX
  operating systems in /usr/gensym/g2classic/.
...
--------------------------------
  ...
  The G2 Classic deployment package replaces the previous restricted
...
------------
  ...
  The G2 Classic 5.2 Rev. 1 package ships with the G2 component, 6.0
  Rev. 1.

  The G2 Reference Manual 6.0 Rev. 0 states that the -v5ok
  command-line option (or the equivalent G2V5_OK environment variable)
  specifies a custom location for an authorization file that is
  specific to G2 Version 5.0. For G2 6.0, the manual should state that
  the -v6ok command-line option (or equivalent G2V6_OK environment
  variable) specifies a custom location for an authorization file that
  is specific to G2 Version 6.0.


TELEWINDOWS COMPONENT
---------------------

  The Telewindows User's Guide 6.0 Rev. 0 states that the -v5ok
  command-line option (or the equivalent TWV5_OK environment variable)
  specifies a custom location for an authorization file that is
  specific to Telewindows Version 5.0. For Telewindows 6.0, the manual
  should state that the -v6ok command-line option (or equivalent
  TWV6_OK environment variable) specifies a custom location for an
  authorization file that is specific to Telewindows Version 6.0.


NEURON-LINE STUDIO USERS
------------------------

  If you want to use the G2 Classic components with NeurOn-Line
  Studio, obtain the NeurOn-Line Studio Premium Package instead of
  using this G2 Classic Package.


G2 PROTOOLS USERS
-----------------

  The G2 Protools KBs have been updated for the 5.2 release of the G2
  Classic Package. The G2 Protools directory on the CD contains one
  subdirectory for the G2 6.0 KBs (kbs) and a separate sub-directory
  for the G2 5.1 KBs (kbs-5). The documentation for both sets of KBs
  is the same and is located in the kbs\doc directory.
...
INSTALLING G2 CLASSIC ON THE WINDOWS OPERATING SYSTEM
-----------------------------------------------------
 ...
 REMOVING PREVIOUS G2 CLASSIC INSTALLATIONS
  ...
  To uninstall a previous G2 Classic installation:
...
INSTALLING G2 CLASSIC ON UNIX OPERATING SYSTEMS
-----------------------------------------------
 ...
 BEFORE INSTALLING
  ...
  Classic on your machine, make a backup copy of the g2.ok (OK) file
 ...
 SYSTEM REQUIREMENTS
  ...
  - 128 Mbytes memory.
  - 200 Mbytes disk space without online documentation (500 Mbytes for
    full installation).
...
INSTALLING G2 CLASSIC ON WINDOWS OPERATING SYSTEMS
--------------------------------------------------

  These instructions provide information for installing G2 Classic on
  machines running the Windows 98/Me/NT/2000/XP operating systems.


 BEFORE INSTALLING

  1. If you have a previous installation of G2 Classic on your
  ...
  2. Uninstall any previous installation of G2 Classic and reboot your
     ...
     Removing Previous G2 Classic Installations in this
 ...
 WINDOWS OPERATING SYSTEMS CONSIDERATIONS
  ...
  The G2 Classic installation differs depending on the Windows
  operating system:
