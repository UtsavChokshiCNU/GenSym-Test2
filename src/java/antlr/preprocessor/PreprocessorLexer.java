...
public PreprocessorLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("catch", this), 23);
	literals.put(new ANTLRHashString("exception", this), 22);
	literals.put(new ANTLRHashString("class", this), 6);
	literals.put(new ANTLRHashString("public", this), 17);
	literals.put(new ANTLRHashString("tokens", this), 11);
	literals.put(new ANTLRHashString("returns", this), 20);
	literals.put(new ANTLRHashString("private", this), 16);
	literals.put(new ANTLRHashString("protected", this), 15);
	literals.put(new ANTLRHashString("extends", this), 8);
