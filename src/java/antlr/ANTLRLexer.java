...
public ANTLRLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("Parser", this), 28);
	literals.put(new ANTLRHashString("catch", this), 37);
	literals.put(new ANTLRHashString("Lexer", this), 11);
	literals.put(new ANTLRHashString("exception", this), 36);
	literals.put(new ANTLRHashString("class", this), 9);
	literals.put(new ANTLRHashString("lexclass", this), 8);
	literals.put(new ANTLRHashString("public", this), 30);
	literals.put(new ANTLRHashString("header", this), 5);
	literals.put(new ANTLRHashString("options", this), 47);
	literals.put(new ANTLRHashString("charVocabulary", this), 17);
	literals.put(new ANTLRHashString("tokens", this), 4);
	literals.put(new ANTLRHashString("returns", this), 34);
	literals.put(new ANTLRHashString("TreeParser", this), 12);
	literals.put(new ANTLRHashString("private", this), 31);
	literals.put(new ANTLRHashString("protected", this), 29);
	literals.put(new ANTLRHashString("extends", this), 10);
