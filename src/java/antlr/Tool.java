...
public class Tool {
	...
	protected static volatile String outputDir = ".";

	// Grammar input
	String grammarFile;
	transient Reader f = new InputStreamReader(System.in, Charset.defaultCharset());
...
// This example is provided WITHOUT WARRANTY either expressed or implied.
	   ...
	   throws IOException
  {
	...
	Reader source = null; // SAS: changed for proper text io
	...
	if (!parentdir.canWrite())
	  ...
	  source = new InputStreamReader(new FileInputStream(source_file), charset);
	  destination = new OutputStreamWriter(new FileOutputStream(destination_file), charset);
	...
	protected void doEverything(String[] args) {
		...
		try {
			if (grammarFile != null) {
				InputStream stream = new FileInputStream(grammarFile);
				f  = new InputStreamReader(stream, Charset.defaultCharset());
			}
		}
		catch (IOException e) {
...
private static void help() {
	...
	public static PrintWriter openOutputFile(String f) throws IOException {
		OutputStream stream = new FileOutputStream(outputDir+System.getProperty("file.separator")+f);
		Writer streamWriter  = new OutputStreamWriter(stream, Charset.defaultCharset());
...
private void processArguments(String[] args) {
	 ...
	 */
	public static String stripBack(final String s, final char c) {
		String str = s;
	 ...
	 * @return The resulting string
	 */
	public static String stripBack(final String s, final String remove) {
		boolean changed;
		String str = s;
		do {
			changed = false;
	 ...
	 * @return The resulting string
	 */
	public static String stripFront(final String s, final char c) {
		String str = s;
	 ...
	 * @return The resulting string
	 */
	public static String stripFront(final String s, final String remove) {
		boolean changed;
		String str = s;
		do {
			changed = false;
