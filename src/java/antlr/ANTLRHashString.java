...
public class ANTLRHashString {
	...
	public boolean equals(Object o) {
		if (o == null || !(getClass().equals(o.getClass()) || isString(o))) {
			return false;
		}
		
		ANTLRHashString antlrString;
		if (isString(o)) {
			antlrString = new ANTLRHashString((String)o,lexer);
		}
		else {
			antlrString = (ANTLRHashString)o;
		}	
		int l = length();
		if (antlrString.length() != l) {
			return false;
		}
		if (lexer.getCaseSensitiveLiterals()) {
			for (int i = 0; i < l; i++) {
				if (charAt(i) != antlrString.charAt(i)) {
					return false;
				}
			}
		} else {
			for (int i = 0; i < l; i++) {
				if (lexer.toLower(charAt(i)) != lexer.toLower(antlrString.charAt(i))) {
					return false;
				}
			}
		}
