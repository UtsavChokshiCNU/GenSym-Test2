 ...
 * @version 1.0
 */
public class LocalClassFriendAccess implements com.gensym.jgi.download.ClassFriendAccessor {

  /*
   * Standard Tracing Requirements
   */
  private static MessageKey traceKey =
  Trace.registerMessageKey("com.gensym.g2export.access",
			   LocalClassFriendAccess.class);
  ...
  public static final String CLASS_INH_FIELD_NAME = "classInheritancePath";
  ...
  public final boolean register (Symbol className_, Class clazz) {
	...
	return true;
      ...
      fieldName = CLASS_INH_FIELD_NAME;
      ...
      register (className_, inheritancePath, new Symbol[0]);
