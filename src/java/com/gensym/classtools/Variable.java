...
public class Variable extends Expression {
	...
	*/
	public Variable(int argumentNumber, String type) 
		...
		if (argumentNumber == 0) 
		  {
			...
			if(tpe.isReferenceType()) {
				switch(argumentNumber) {
					case 1:   
						ins = Instruction.makeInstruction(opc_aload_1); 
						break;
					case 2:   
						ins = Instruction.makeInstruction(opc_aload_2); 
						break;
					case 3:   
						ins = Instruction.makeInstruction(opc_aload_3); 
						break;
					default:  
						ins = Instruction.makeInstruction(opc_aload,argumentNumber); 
						break;
				}
				state.pushStack();
			}
			...
			if(tpe.isIntegerType() || tpe.isShortType() || tpe.isByteType() ||
				...
				switch(argumentNumber) {
					case 1:   
						ins = Instruction.makeInstruction(opc_iload_1); 
						break;
					case 2:   
						ins = Instruction.makeInstruction(opc_iload_2); 
						break;
					case 3:   
						ins = Instruction.makeInstruction(opc_iload_3); 
						break;
					default:  
						ins = Instruction.makeInstruction(opc_iload,argumentNumber); 
						break;
				}
				state.pushStack();
			}						 
		    ...
		    if(tpe.isDoubleType())  {
				switch(argumentNumber) {
					case 1:   
						ins = Instruction.makeInstruction(opc_dload_1); 
						break;
					case 2:   
						ins = Instruction.makeInstruction(opc_dload_2); 
						break;
					case 3:   
						ins = Instruction.makeInstruction(opc_dload_3); 
						break;
					default:  
						ins = Instruction.makeInstruction(opc_dload,argumentNumber); 
						break;
			   }
				state.pushStack(2);
			}
			...
			if(tpe.isLongType())  {
				switch(argumentNumber) {
					case 1:   
						ins = Instruction.makeInstruction(opc_lload_1); 
						break;
					case 2:   
						ins = Instruction.makeInstruction(opc_lload_2);
						break;
					case 3:   
						ins = Instruction.makeInstruction(opc_lload_3); 
						break;
					default:  
						ins = Instruction.makeInstruction(opc_lload,argumentNumber); 
						break;
			   }
				state.pushStack(2);
			}
		    ...
		    if(tpe.isFloatType()) {
				switch(argumentNumber) {
					case 1:   
						ins = Instruction.makeInstruction(opc_fload_1); 
						break;
					case 2:   
						ins = Instruction.makeInstruction(opc_fload_2); 
						break;
					case 3:   
						ins = Instruction.makeInstruction(opc_fload_3); 
						break;
					default:  
						ins = Instruction.makeInstruction(opc_fload,argumentNumber); 
						break;
				} 
				state.pushStack();
			}
