...
public class intern_keyword implements ICPMessage {
    public static short messageCode = 86;
    private ICPStream stream = null;

    int corresponding_icp_object_index = 0;
    String text_string = null;

    public intern_keyword () {}
    public intern_keyword (int corresponding_icp_object_index, String text_string) {
