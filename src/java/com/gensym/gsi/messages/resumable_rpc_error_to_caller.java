...
public class resumable_rpc_error_to_caller implements ICPMessage {
    public static short messageCode = 354;
    private ICPStream stream = null;

    int remote_caller_index = 0;
    Integer signaller = null;
    Symbol error_name = null;
    int error_level = 0;
    String error_description = null;
    Object[] error_argument_list = null;

    public resumable_rpc_error_to_caller () {}
    public resumable_rpc_error_to_caller (int remote_caller_index, Integer signaller, Symbol error_name, int error_level, String error_description, Object[] error_argument_list) {
        this.remote_caller_index = remote_caller_index;
    ...
    public void read (ICPInputStream inputStream)
        throws IOException {
        remote_caller_index = UNSIGNED_INTEGER.read(inputStream);
        signaller = UNSIGNED_INTEGER_OR_NIL.read(inputStream);
    ...
    public void write (ICPOutputStream outputStream)
        ...
        UNSIGNED_INTEGER.write(remote_caller_index,outputStream);
        UNSIGNED_INTEGER_OR_NIL.write(signaller,outputStream);
