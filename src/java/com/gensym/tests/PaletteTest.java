 ...
 *  a) a class called APPLE and a class called ORANGE
 *  b) a workspace that is a GFR palette named EXAMPLE-GFR-PALETTE
 */
...
public class PaletteTest extends TW2Application implements G2ClassSymbols{
  ...
  public PaletteTest(String[] cmdLineArgs){
    super(cmdLineArgs);

    frame = new MDIFrame("Palette Test");
  ...
  public static void main(String[] args){
    PaletteTest demo = new PaletteTest(args);
  }
}
