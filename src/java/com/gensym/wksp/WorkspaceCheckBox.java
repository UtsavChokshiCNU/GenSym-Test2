...
/**
 * A <code>WorkspaceButton</code> intended for use with buttons of class <code>CheckBox</code>.
 */
public interface WorkspaceCheckBox extends WorkspaceButton {
  ...
  /**
   * Invoked when the check box's status has changed.
   ...
   * <code>WorkspaceElement.ATTRIBUTE_NAME_</code> will be <code>BUTTON_STATUS_</code> and whose
   * attribute named by <code>WorkspaceElement.NEW_VALUE_</code> will be either
   * <code>ON_</code>, <code>OFF_</code>, or <code>null</code>.
   */
