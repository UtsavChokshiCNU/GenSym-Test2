 ...
 * StandardJDialogClient listener that is notified of the
 ...
 *
 */
abstract class StandardJDialog extends JDialog implements CommandConstants {

  private StandardJDialogClient dlgClient;
   ...
   * of a StandardJDialog. The component passed in is placed in the
   ...
   * @param client a StandardJDialogClient that will be notified of all
   ...
   */
  protected StandardJDialog (Frame parent,
			    String title,
			    boolean isModal,
			    String[] btnLabels,
			    int[] cmdCodes,
			    Component x,
			    StandardJDialogClient client) {
   ...
   */
  private void setClient (StandardJDialogClient client) {
    dlgClient = client;
  }
  ...
  */
   ...
   * <code>Component</code> within the <code>StandardJDialog</code>
   ...
   * In the notification callback, StandardJDialogClients can
...
class CommandPanel extends Panel {
  ...
  private Button defaultBtn, cancelBtn;
  ...
  CommandPanel (String[] cmdNames, int[] cmdCodes, ActionListener listnr, int alignment) {
    ...
    for (int i=0; i<numButtons; i++) {
      CommandButton cb = new CommandButton (cmdNames[i], cmdCodes[i]);
...
class CommandButton extends Button {
  ...
  private int code;
  CommandButton (String label, int code) {
    super (label);
    this.code = code;
  }
