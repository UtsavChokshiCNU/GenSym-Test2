...
public abstract class QuickSorter
{
  ...
  {
    quickSortInPlace(a, null);
  }

  public void quickSortInPlace(Object[] a, Object[] auxArray)
  {
    quickSortInPlace(a, auxArray, 0, a.length - 1);
  }
  ...
  {
    quickSortInPlace (a, null, lo0, hi0);
  }

  private void quickSortInPlace(Object[] a, Object[] auxArray, int lo0, int hi0)
  {
    int lo = lo0;
    int hi = hi0;
    Object mid;
	 ...
	 */
	if( lo0 < hi )
	  quickSortInPlace( a, auxArray, lo0, hi );
	
	/* If the left index has not reached the right side of array
	 * must now sort the right partition.
	 */
	if( lo < hi0 )
	  quickSortInPlace( a, auxArray, lo, hi0 );
