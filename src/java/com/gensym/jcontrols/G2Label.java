...
*/
public class G2Label extends JLabel implements
ObjectUpdateListener, SwingConstants
{
  /*
...
//   public static final int RIGHT = 2;
  ...
  {
    setText("Label");
    setAlignment (new Enum(new String[]{"Left", "Center", "Right"}, 
...
//   }
  ...
  public void setHorizontalAlignment(int alignment) {
    this.alignment = new Enum(new String[]{"Left", "Center", "Right"}, 
       new int[]{LEFT, CENTER, RIGHT}, alignment);
  }
  
  public void setAlignment(Enum alignment){
    this.alignment = alignment;
    super.setHorizontalAlignment(alignment.value);
    repaint();
  }
...
//   }
  ...
  */
   ...
   * property.
   */
  public void setTextKey(String labelKey)  
  {
   ...
   * @see com.gensym.controls.G2Button#getTextKey
   */
  public void setResourceName(String resourceName)
  {
    ...
    try
    {
      ...
      if (bundle != null && labelKey != null)
        setText(bundle.getString(labelKey));
    }
    catch (Exception ex) // fix this: MissingResourceException
    {
      Trace.exception (ex, null);
    }
  }
