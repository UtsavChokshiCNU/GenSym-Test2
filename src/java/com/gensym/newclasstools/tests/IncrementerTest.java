...
public class IncrementerTest implements RuntimeConstants 
{
  public static void main (String[] args) {
    try {			

      Type classType = Type.makeType("com.gensym.newclasstools.tests.TestIncrementer");
	...
	= new MethodCall("println",
     ...
     FileOutputStream fileOutStream = new FileOutputStream("TestIncrementer.class");
     ...
     Class cl = Class.forName("com.gensym.newclasstools.tests.TestIncrementer");
