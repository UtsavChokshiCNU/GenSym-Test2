...
public class ContinueTest3 implements RuntimeConstants 
{
  public static void main (String[] args) {
    try {			

      Type classType = Type.makeType("com.gensym.newclasstools.tests.TestContinue3");
	...
	= new MethodCall("println",
     ...
     FileOutputStream fileOutStream = new FileOutputStream("TestContinue3.class");
     ...
     Class cl = Class.forName("com.gensym.newclasstools.tests.TestContinue3");
