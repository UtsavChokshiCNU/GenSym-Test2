...
public class NewArrayTest implements RuntimeConstants 
{
  public static void main (String[] args) {
    try {			

      Type classType = Type.makeType("com.gensym.newclasstools.tests.TestNewArray");
      ...
      Type stringArray = Type.makeType(Type.STRING_TYPE, 1);

      FieldInfo fi = new FieldInfo(new Access(ACC_PUBLIC), "x", stringArray, null, false);

      ci.add(fi);

      FieldRef xRef =  new FieldRef(classType, "x", stringArray);

      Block b = new Block();

      NewArray na = 
	new NewArray(Type.STRING_TYPE,
		     (int)1, 
	...
	= new MethodCall("println",
     ...
     FileOutputStream fileOutStream = new FileOutputStream("TestNewArray.class");
     ...
     Class cl = Class.forName("com.gensym.newclasstools.tests.TestNewArray");
