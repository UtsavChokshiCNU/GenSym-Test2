...
public class Shell extends MDIApplication implements ClientApplication {

  // bind the message resource for Shell
  //  private static Resource shortBundle 
  //    = Resource.getBundle("com.gensym.cbu.adminShell.Messages");
  ...
  public Shell (String[] cmdLineArgs) {
     ...
     *
     * 1. let Shell handle these
     * command line arguments:
     *
     *  -host, -port (port of bootstrapping name server)
     *
  ...
  static void subscribeComponentsToModuleSet(Shell application)
  {
