...
/**
 * A class to allow command-line access to a class-info file
 * containing a serialized structure.
 *
 * Author : vkp
 * Version: 1.0 09/16/97
 */
public class ClassInfoReader 
  ...
  public static void main (String[] args) {
    if (args.length != 1) {
      System.err.println ("Usage: java com.gensym.devtools.ClassInfoReader <filename>");
      System.exit (2);
    }
