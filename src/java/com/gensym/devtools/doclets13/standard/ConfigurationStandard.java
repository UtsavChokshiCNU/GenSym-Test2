...
public class ConfigurationStandard extends Configuration {
  ...
  /**
   * Argument for the command line option "-rootpath". rootPath is required when
   * using moduleInfo to exclude documentation.
   */
  public static String rootPath = null;

  /**
   * True if command line option "-noundocumented" is used. Default value is
   * false.  When noundocumented is true, classes/methods with the @undocumented
   * tag will be omitted.
   */
  public static boolean noundocumented = false;

  /**
   * True when a list of classes has been provided as the classes to be published.  When true,
   * any class not in this list will not be documented.
   */
  public static boolean restrictToClassList = false;

  /**
   * If restrictToClassList is true, this will hold the list of classes to be published.
   */
  public static HashSet classList;
   ...
   * {@link com.gensym.devtools.doclets13.MessageRetriever}.
   */
  ...
  static void populateClassList(String fileName) {
    try {
  ...
  public void setSpecificDocletOptions(RootDoc root) {
    ...
    for (int oi = 0; oi < options.length; ++oi) {
      ...
      if (opt.equals("-rootpath")) { //pickup the rootPath command line & value
	rootPath = os[1];
      } else  if (opt.equals("-noundocumented")) { //pick up noundocumented flag
	noundocumented = true;
      } else  if (opt.equals("-documented-classes-file")) { //the documented classes file
	restrictToClassList = true;
	populateClassList(os[1]);
   ...
   * {@link com.gensym.devtools.doclets13.Configuration#optionLength(String)}. This 
  ...
  public int specificDocletOptionLength(String option) {
	...
	option.equals("-nooverview")) {
      ...
      return -1; // so run will end
	       ...
	       option.equals("-documented-classes-file") ||
   ...
   * exactly like
   * {@link com.gensym.devtools.doclets13.Configuration#validOptions(String[][],
