...
import com.gensym.devtools.doclets13.ClassTree;
import com.gensym.devtools.doclets13.DocletAbortException;
import java.util.*;
...
public class ClassUseMapper {
  ...
  public static void generate(RootDoc root, 
    ...
    for (int i = 0; i < classes.length; i++) {
      if(Standard.excludeDoc(classes[i]))
	 continue;
