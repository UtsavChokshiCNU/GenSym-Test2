...
public class ConfigurationStandard extends Configuration {
    ...
    /**
     * Argument for the required command line option "-rootpath".
     */
     ...
     * {@link com.gensym.devtools.doclets.MessageRetriever}.
     */
    public ConfigurationStandard() {
        if (standardmessage == null) {
            standardmessage = 
               new MessageRetriever("com.gensym.devtools.doclets.standard.standard");
        }
    }
     ...
     * {@link com.gensym.devtools.doclets.Configuration#optionLength(String)}. This 
     ...
     * exactly like
     * {@link com.gensym.devtools.doclets.Configuration#validOptions(String[][],
    ...
    public boolean specificDocletValidOptions(String options[][],
        ...
        /* -rootpath is a required, print an error and
           return false if it is missing */
        if (rootPath == null) {
          reporter.printError("The required parameter -rootpath is missing."); 
          return false;
        }
