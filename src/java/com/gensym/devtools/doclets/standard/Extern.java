...
public class Extern {
    ...
    public static boolean url(String url, String pkglisturl,
      ...
      // The original doclet code reports an error here if the
      // packageMap is not null (i.e., if the -link option
      // has been used before. This check is not necessary.
      // The real check could be if a package in the list
      // is already in the packageMap, which could be checked for
      // in composeExternPackageList.
