 ...
 */ public class QuestionDialog extends IconDialog {
  ...
  private QuestionDialog (String  title,
			  boolean isModal,
			  String  message,
   ...
   *   commands generated by buttons on the dialog
   */
   protected QuestionDialog (Frame frame, String title, boolean isModal,
			    String[] buttonLabels, int[] buttonCodes,
			    String message, Image img, 
			    StandardDialogClient client) {
    super (frame, title, isModal, buttonLabels, buttonCodes, 
	   message, (img != null ? img : QuestionDialog.img),
	   message.indexOf ("\n") >= 0, client);
  }

  private QuestionDialog (Frame frame, String title, boolean isModal,
			    String message, Image img,
			    StandardDialogClient client) {
  ...
  */
  ...
  public static void main (String[] args) {
	...
	new QuestionDialog ("From Menu", true, "Message From Menu", sd).show ();
      }
    });
    mb.add (fileMenu);
    f.setMenuBar (mb);
    ...
    QuestionDialog d =new QuestionDialog ("Helloooooo...",
				    true,
				    "No message!",
				    sd);
    d.show ();
...
class QuestionDialogLauncher implements Runnable {
  ...
  public void run () {
    ...
    QuestionDialog d = new QuestionDialog (null,
					   "Blah...",
					   true,
					   "No Real message!",
					   sd);
