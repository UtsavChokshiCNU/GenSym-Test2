 ...
 * menu for items in a WorkspaceView to display custom
 * menu choices contained in EditCommandsImpl.
 */
public class WorkspaceFrame2 extends Frame {
  ...
  public static void main (String[] args) {
    ...
    Frame f = new WorkspaceFrame2 ("Workspace Demo 2");
    // Resize the frame
  ...
  WorkspaceFrame2 (String title) {
    ...
    SelectionCommandGenerator.setSelectionCommandsFactory
      (new CustomSelectionCommandsFactory2());
