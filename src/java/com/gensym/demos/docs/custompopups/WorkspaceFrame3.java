...
/**
 * This class demonstates how to customize the popup
 * menu for items in a WorkspaceView to invoke
 * a user menu choice locally in the client.
 */
public class WorkspaceFrame3 extends Frame {
  ...
  public static void main (String[] args) {
    ...
    Frame f = new WorkspaceFrame3 ("Workspace Demo 2");
    // Resize the frame
  ...
  WorkspaceFrame3 (String title) {
    ...
    //Set the SelectionCommandsFactory for generating 
    //popup menus for selected items.
    SelectionCommandGenerator.setSelectionCommandsFactory (new CustomSelectionCommandsFactory3());
  ...
  private void displayWorkspace (String host, String port, Symbol wkspName_) {
    ...
    try {
      ...
      //Get UserMenuChoice
      UserMenuChoice userMenuChoice = cxn.getUserMenuChoice(EDIT_DEMO_, DEMO_CLASS_);
      ...
      UserMenuChoiceCommands.setLocalMenuChoiceHandler(userMenuChoice, handler); 
