...
public class JavaCallingG2Procedure {
  ...
  public static void main(String args[]) {
	...
	JavaCallingG2Procedure G2procCall = new JavaCallingG2Procedure(g2_connection);
	...
	try {
	  for (int i=0; i<100; i++) {
	    ...
	    double g2Time = G2procCall.aG2Procedure(i, 
						    "Hi there from Java, this is a unicode string", 
						    randomGen.nextDouble()*1000, 
						    Symbol.intern("JAVALINK"));
	    System.out.println(i + ".Called a G2 Procedure successfully...current real time from G2 is " + g2Time);
	  }
