 ...
 *
 */
package com.gensym.demos.itemaccessdemo;
...
/** Demo class to illustrate the following:
   ...
   */
public class ItemAccessDemo implements Demo, StandardDialogClient{
  private String host;
  private String port;
  ...
  public void runDemo(Frame frame){
	...
	g2Connection.login();
      ...
      planet =  (Planet)g2Connection.getUniqueNamedItem(PLANET_, planetName_);
      ...
      new InputDialog(frame, planetName_.getPrintValue(), false, textFieldLabels, initialValues, (StandardDialogClient)this).setVisible (true);
  ...
  public void dialogDismissed (StandardDialog d, int code) {
    ...
    try{
      ...
      planet.setNumberOfMoons(numberOfMoons);
       ...
       ErrorDialog errDlg = new ErrorDialog(e, (Frame)demoShell, null, "Error", "Lost connection.  Restart G2 SEQUOIA_REQUIRED_G2_VERSION or later with SQ-DEMOS.KB on port "+port);
       g2Connection = null;
    }
  }
