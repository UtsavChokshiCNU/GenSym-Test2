 ...
 *
 *          Date: Tue Dec 01 18:08:50 EST 1998
 *
 */
...
public interface DiscovererInformation extends com.gensym.classes.Object {

  public static final Symbol DISCOVERER_INFORMATION_ = Symbol.intern ("DISCOVERER-INFORMATION");
  static final Symbol g2ClassName = DISCOVERER_INFORMATION_;
  static final Symbol[] classInheritancePath = new Symbol[] {DISCOVERER_INFORMATION_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for FIRST-NAME is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for LAST-NAME is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for DATE-OF-DISCOVERY is : 
   * (Structure)
   *
   */
