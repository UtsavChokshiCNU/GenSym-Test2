 ...
 *  All Rights Reserved.
 *
 *      DiscovererInformationImpl.java
 *
 ...
 *
 *          Date: Tue Dec 01 18:08:54 EST 1998
 *
 */
...
public class DiscovererInformationImpl extends com.gensym.classes.ObjectImpl implements DiscovererInformation {


  static final long serialVersionUID = 2L;
  private static final Symbol FIRST_NAME_ = Symbol.intern ("FIRST-NAME");
  private static final Symbol LAST_NAME_ = Symbol.intern ("LAST-NAME");
  private static final Symbol DATE_OF_DISCOVERY_ = Symbol.intern ("DATE-OF-DISCOVERY");

  /* Generated constructors */

  public DiscovererInformationImpl() {
    super();
  }

  public DiscovererInformationImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  /**
   * Generated Property Setter for attribute -- FIRST-NAME
   * @param firstName new value to conclude for FIRST-NAME
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setFirstName(java.lang.String firstName) throws G2AccessException {
    setAttributeValue (FIRST_NAME_, firstName);
  }

  /**
   * Generated Property Getter for attribute -- FIRST-NAME
   * @return the value of the FIRST-NAME attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public java.lang.String getFirstName() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (FIRST_NAME_);
    return (java.lang.String)retnValue;
  }

  /**
   * Generated Property Setter for attribute -- LAST-NAME
   * @param lastName new value to conclude for LAST-NAME
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setLastName(java.lang.String lastName) throws G2AccessException {
    setAttributeValue (LAST_NAME_, lastName);
  }

  /**
   * Generated Property Getter for attribute -- LAST-NAME
   * @return the value of the LAST-NAME attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public java.lang.String getLastName() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (LAST_NAME_);
    return (java.lang.String)retnValue;
  }

  /**
   * Generated Property Setter for attribute -- DATE-OF-DISCOVERY
   * @param dateOfDiscovery new value to conclude for DATE-OF-DISCOVERY
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setDateOfDiscovery(com.gensym.util.Structure dateOfDiscovery) throws G2AccessException {
    setAttributeValue (DATE_OF_DISCOVERY_, dateOfDiscovery);
  }

  /**
   * Generated Property Getter for attribute -- DATE-OF-DISCOVERY
   * @return the value of the DATE-OF-DISCOVERY attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Structure getDateOfDiscovery() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (DATE_OF_DISCOVERY_);
