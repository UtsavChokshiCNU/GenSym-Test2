 ...
 *
 *          Date: Tue Dec 01 18:09:02 EST 1998
 *
 */
...
public class AlarmImpl extends com.gensym.classes.ObjectImpl implements Alarm {


  static final long serialVersionUID = 2L;
  private static final Symbol ALARM_TYPE_ = Symbol.intern ("ALARM-TYPE");
  ...
  public AlarmImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  /**
   * Generated Property Setter for attribute -- ALARM-TYPE
   * @param alarmType new value to conclude for ALARM-TYPE
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setAlarmType(java.lang.String alarmType) throws G2AccessException {
    setAttributeValue (ALARM_TYPE_, alarmType);
  }

  /**
   * Generated Property Getter for attribute -- ALARM-TYPE
   * @return the value of the ALARM-TYPE attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public java.lang.String getAlarmType() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (ALARM_TYPE_);
  ...
  private static final Symbol MethodName_ANIMATE_ = Symbol.intern ("ANIMATE");
   ...
   * ALARM::ANIMATE
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS ALARM,arg1:CLASS PLANET) = ()
   */
  @Override
  public  void animate(com.gensym.demos.democlasses.Planet arg1) throws G2AccessException
{
    if (isByHandle()) {
      java.lang.Object result;
      java.lang.Object[] args = new java.lang.Object[] {this,arg1};
      result = (java.lang.Object)callRPC(MethodName_ANIMATE_, args);
    }
    else {
