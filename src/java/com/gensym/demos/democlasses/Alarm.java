 ...
 *
 *          Date: Tue Dec 01 18:08:52 EST 1998
 *
 */
...
public interface Alarm extends com.gensym.classes.Object {

  public static final Symbol ALARM_ = Symbol.intern ("ALARM");
  static final Symbol g2ClassName = ALARM_;
  static final Symbol[] classInheritancePath = new Symbol[] {ALARM_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for ALARM-TYPE is : 
   * Text
   *
   */
