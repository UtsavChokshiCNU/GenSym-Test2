...
public class TwCommandImpl implements Command, PropertyChangeListener {
  ...
  public TwCommandImpl (BrowserApplication browserApp) {
  ...
  public void propertyChange (PropertyChangeEvent pce) {
    System.out.println ("TwCommandImpl..propertyChange (" + pce + ")");
...
class WorkspaceDownloaderThread extends Thread {
  ...
  public void run () {
    try {
      ...
      new WarningDialog (null, TwCommandImpl.i18nui.getString ("getWkspError"), true, gae.toString (), null).setVisible (true);
    }
  }
}
