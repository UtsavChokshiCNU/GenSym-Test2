 ...
 *
 *          Date: Fri Sep 21 13:01:25 EDT 2007
 *
 */
...
public class MessageBoardImpl extends com.gensym.classes.ItemImpl implements MessageBoard {
  ...
  public MessageBoardImpl() {
    super();
  }

  public MessageBoardImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public MessageBoardImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setPreferBufferedDrawing(boolean preferBufferedDrawing) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.PREFER_BUFFERED_DRAWING_, preferBufferedDrawing);
  }
