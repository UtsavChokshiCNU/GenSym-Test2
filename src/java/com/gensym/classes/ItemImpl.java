 ...
 *
 *          Date: Fri Sep 21 13:26:01 EDT 2007
 *
 */
...
public class ItemImpl extends com.gensym.classes.SystemItemImpl implements Item {
  ...
  public ItemImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ItemImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
