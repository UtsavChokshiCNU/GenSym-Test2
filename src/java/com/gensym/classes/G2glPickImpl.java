 ...
 *
 *          Date: Fri Sep 21 12:53:27 EDT 2007
 *
 */
...
public class G2glPickImpl extends com.gensym.classes.G2glActivityImpl implements G2glPick {
  ...
  public G2glPickImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public G2glPickImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
