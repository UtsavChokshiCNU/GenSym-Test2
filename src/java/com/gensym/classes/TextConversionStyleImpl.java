 ...
 *
 *          Date: Fri Sep 21 13:11:05 EDT 2007
 *
 */
...
public class TextConversionStyleImpl extends com.gensym.classes.ItemImpl implements TextConversionStyle {
  ...
  public TextConversionStyleImpl() {
    super();
  }

  public TextConversionStyleImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TextConversionStyleImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
