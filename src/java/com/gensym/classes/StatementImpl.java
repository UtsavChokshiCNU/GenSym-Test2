 ...
 *
 *          Date: Fri Sep 21 13:14:00 EDT 2007
 *
 */
...
public class StatementImpl extends com.gensym.classes.ItemImpl implements Statement {
  ...
  public StatementImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public StatementImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
