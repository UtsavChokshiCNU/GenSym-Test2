 ...
 *
 *          Date: Fri Sep 21 13:05:35 EDT 2007
 *
 */
...
public class RadioButtonImpl extends com.gensym.classes.ItemImpl implements RadioButton {
  ...
  public RadioButtonImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public RadioButtonImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
