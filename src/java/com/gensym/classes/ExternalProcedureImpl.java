 ...
 *
 *          Date: Fri Sep 21 12:41:09 EDT 2007
 *
 */
...
public class ExternalProcedureImpl extends com.gensym.classes.EntityImpl implements ExternalProcedure {
  ...
  public ExternalProcedureImpl() {
    super();
  }

  public ExternalProcedureImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ExternalProcedureImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
