 ...
 *
 *          Date: Fri Sep 21 12:40:51 EDT 2007
 *
 */
...
public class ExplanationImpl extends com.gensym.classes.ItemImpl implements Explanation {
  ...
  public ExplanationImpl() {
    super();
  }

  public ExplanationImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ExplanationImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
