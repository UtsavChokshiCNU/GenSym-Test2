 ...
 *
 *          Date: Fri Sep 21 12:58:10 EDT 2007
 *
 */
...
public class ItemListImpl extends com.gensym.classes.G2ListImpl implements ItemList {
  ...
  public ItemListImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ItemListImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
