 ...
 *
 *          Date: Fri Sep 21 13:10:46 EDT 2007
 *
 */
...
public class TabularFunctionImpl extends com.gensym.classes.ItemImpl implements TabularFunction {
  ...
  public TabularFunctionImpl() {
    super();
  }

  public TabularFunctionImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TabularFunctionImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
