 ...
 *  All Rights Reserved.
 *
 *      ExternalSimulationDefinitionImpl.java
 *
 ...
 *
 *          Date: Fri Sep 21 12:41:14 EDT 2007
 *
 */
...
public class ExternalSimulationDefinitionImpl extends com.gensym.classes.ItemImpl implements ExternalSimulationDefinition {
  ...
  public ExternalSimulationDefinitionImpl() {
    super();
  }

  public ExternalSimulationDefinitionImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ExternalSimulationDefinitionImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setClassOfObjectComputedByThis(com.gensym.util.Symbol classOfObjectComputedByThis) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.CLASS_OF_OBJECT_COMPUTED_BY_THIS_, classOfObjectComputedByThis);
  }
  ...
  public com.gensym.util.Symbol getClassOfObjectComputedByThis() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.CLASS_OF_OBJECT_COMPUTED_BY_THIS_);
