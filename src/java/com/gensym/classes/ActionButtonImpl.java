 ...
 *
 *          Date: Fri Sep 21 12:38:00 EDT 2007
 *
 */
...
public class ActionButtonImpl extends com.gensym.classes.ItemImpl implements ActionButton {


  static final long serialVersionUID = 2L;

  /* Overriden Field */
  private static final Symbol G2_FIRE_ACTION_BUTTON_ = Symbol.intern ("G2-FIRE-ACTION-BUTTON");
  /* Overriden Field */
  ...
  public ActionButtonImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ActionButtonImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
