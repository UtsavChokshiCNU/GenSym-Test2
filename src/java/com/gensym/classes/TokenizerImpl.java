 ...
 *
 *          Date: Fri Sep 21 13:11:42 EDT 2007
 *
 */
...
public class TokenizerImpl extends com.gensym.classes.ItemImpl implements Tokenizer {
  ...
  public TokenizerImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TokenizerImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  /**
   * Generated Property Setter for attribute -- PATTERNS-DEFINITION
   * @param patternsDefinition new value to conclude for PATTERNS-DEFINITION
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setPatternsDefinition(com.gensym.util.Sequence patternsDefinition) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.PATTERNS_DEFINITION_, patternsDefinition);
  }

  /**
   * Generated Property Getter for attribute -- PATTERNS-DEFINITION
   * @return the value of the PATTERNS-DEFINITION attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Sequence getPatternsDefinition() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.PATTERNS_DEFINITION_);
    return (com.gensym.util.Sequence)retnValue;
  }

  /**
   * Generated Property Setter for attribute -- TOKENS-DEFINITION
   * @param tokensDefinition new value to conclude for TOKENS-DEFINITION
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setTokensDefinition(com.gensym.util.Sequence tokensDefinition) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.TOKENS_DEFINITION_, tokensDefinition);
  }

  /**
   * Generated Property Getter for attribute -- TOKENS-DEFINITION
   * @return the value of the TOKENS-DEFINITION attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Sequence getTokensDefinition() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.TOKENS_DEFINITION_);
    return (com.gensym.util.Sequence)retnValue;
  }
