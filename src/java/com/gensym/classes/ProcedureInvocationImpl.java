 ...
 *
 *          Date: Fri Sep 21 13:05:03 EDT 2007
 *
 */
...
public class ProcedureInvocationImpl extends com.gensym.classes.ItemImpl implements ProcedureInvocation {
  ...
  public ProcedureInvocationImpl() {
    super();
  }

  public ProcedureInvocationImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ProcedureInvocationImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
