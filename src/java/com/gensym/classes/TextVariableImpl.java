 ...
 *
 *          Date: Fri Sep 21 13:11:36 EDT 2007
 *
 */
...
public class TextVariableImpl extends com.gensym.classes.G2VariableImpl implements TextVariable {
  ...
  public TextVariableImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TextVariableImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
