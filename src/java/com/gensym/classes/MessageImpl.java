 ...
 *
 *          Date: Fri Sep 21 13:01:22 EDT 2007
 *
 */
...
public class MessageImpl extends com.gensym.classes.ItemImpl implements Message {


  static final long serialVersionUID = 2L;

  /* Overriden Field */
  private static final Symbol G2_GET_REFERENCED_ITEMS_ = Symbol.intern ("G2-GET-REFERENCED-ITEMS");
  ...
  public MessageImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public MessageImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public com.gensym.util.Structure getDefaultMessagePropertiesForClass() throws G2AccessException {
    java.lang.Object retnValue = getStaticAttributeValue (SystemAttributeSymbols.DEFAULT_MESSAGE_PROPERTIES_);
    return (com.gensym.util.Structure)retnValue;
  }
