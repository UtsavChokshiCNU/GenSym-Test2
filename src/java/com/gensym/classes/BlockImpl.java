 ...
 *
 *          Date: Fri Sep 21 13:25:57 EDT 2007
 *
 */
...
public class BlockImpl extends com.gensym.classes.KbFrameImpl implements Block {
  ...
  public BlockImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public BlockImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
