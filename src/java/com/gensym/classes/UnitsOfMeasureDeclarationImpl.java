 ...
 *  All Rights Reserved.
 *
 *      UnitsOfMeasureDeclarationImpl.java
 *
 ...
 *
 *          Date: Fri Sep 21 13:14:02 EDT 2007
 *
 */
...
public class UnitsOfMeasureDeclarationImpl extends com.gensym.classes.StatementImpl implements UnitsOfMeasureDeclaration {
  ...
  public UnitsOfMeasureDeclarationImpl() {
    super();
  }

  public UnitsOfMeasureDeclarationImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public UnitsOfMeasureDeclarationImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
