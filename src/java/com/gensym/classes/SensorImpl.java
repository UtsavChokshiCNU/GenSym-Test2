 ...
 *
 *          Date: Fri Sep 21 13:08:09 EDT 2007
 *
 */
...
public class SensorImpl extends com.gensym.classes.VariableImpl implements Sensor {
  ...
  public SensorImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public SensorImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
