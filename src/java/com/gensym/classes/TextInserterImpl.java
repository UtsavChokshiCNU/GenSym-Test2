 ...
 *
 *          Date: Fri Sep 21 13:14:30 EDT 2007
 *
 */
...
public class TextInserterImpl extends com.gensym.classes.ItemImpl implements TextInserter {
  ...
  public TextInserterImpl() {
    super();
  }

  public TextInserterImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TextInserterImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
