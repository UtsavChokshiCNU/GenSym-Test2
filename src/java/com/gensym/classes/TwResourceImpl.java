 ...
 *
 *          Date: Fri Sep 21 13:13:32 EDT 2007
 *
 */
...
public class TwResourceImpl extends com.gensym.classes.ItemImpl implements TwResource {
  ...
  public TwResourceImpl() {
    super();
  }

  public TwResourceImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TwResourceImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
