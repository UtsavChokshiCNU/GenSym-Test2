 ...
 *
 *          Date: Fri Sep 21 13:08:44 EDT 2007
 *
 */
...
public class SymbolicParameterImpl extends com.gensym.classes.ParameterImpl implements SymbolicParameter {
  ...
  public SymbolicParameterImpl() {
    super();
  }

  public SymbolicParameterImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public SymbolicParameterImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
