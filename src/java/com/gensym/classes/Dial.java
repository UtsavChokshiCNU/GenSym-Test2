 ...
 *
 *          Date: Fri Sep 21 12:37:50 EDT 2007
 *
 */
...
public interface Dial extends com.gensym.classes.Item, com.gensym.classes.Entity {

  public static final Symbol DIAL_ = com.gensym.util.symbol.G2ClassSymbols.DIAL_;
  static final Symbol g2ClassName = DIAL_;
  static final Symbol[] classInheritancePath = new Symbol[] {DIAL_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for LOW-VALUE-FOR-DIAL-RULING is : 
   * Quantity
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for INCREMENT-PER-DIAL-RULING is : 
   * Quantity
   *
   */
