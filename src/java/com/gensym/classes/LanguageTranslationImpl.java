 ...
 *
 *          Date: Fri Sep 21 13:00:38 EDT 2007
 *
 */
...
public class LanguageTranslationImpl extends com.gensym.classes.StatementImpl implements LanguageTranslation {
  ...
  public LanguageTranslationImpl() {
    super();
  }

  public LanguageTranslationImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public LanguageTranslationImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
