 ...
 *
 *          Date: Fri Sep 21 13:05:16 EDT 2007
 *
 */
...
public class QuantitativeVariableImpl extends com.gensym.classes.G2VariableImpl implements QuantitativeVariable {
  ...
  public QuantitativeVariableImpl() {
    super();
  }

  public QuantitativeVariableImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public QuantitativeVariableImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
