 ...
 *
 *          Date: Fri Sep 21 13:26:04 EDT 2007
 *
 */
...
public class SystemTableImpl extends com.gensym.classes.ItemImpl implements SystemTable {
  ...
  public SystemTableImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public SystemTableImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
