 ...
 *
 *          Date: Fri Sep 21 12:58:08 EDT 2007
 *
 */
...
public class ItemArrayImpl extends com.gensym.classes.G2ArrayImpl implements ItemArray {
  ...
  public ItemArrayImpl() {
    super();
  }

  public ItemArrayImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ItemArrayImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
