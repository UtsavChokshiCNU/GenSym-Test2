 ...
 *
 *          Date: Fri Sep 21 13:14:04 EDT 2007
 *
 */
...
public class UserMenuChoiceImpl extends com.gensym.classes.ItemImpl implements UserMenuChoice {


  static final long serialVersionUID = 2L;

  /* Overriden Field */
  private static final Symbol G2_FIRE_USER_MENU_CHOICE_ = Symbol.intern ("G2-FIRE-USER-MENU-CHOICE");
  /* Overriden Field */
  ...
  public UserMenuChoiceImpl() {
    super();
  }

  public UserMenuChoiceImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public UserMenuChoiceImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setApplicableClass(com.gensym.util.Symbol applicableClass) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.APPLICABLE_CLASS_, applicableClass);
  }
  ...
  public com.gensym.util.Symbol getApplicableClass() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.APPLICABLE_CLASS_);
    return (com.gensym.util.Symbol)retnValue;
  }
  ...
  public void setCondition(java.lang.String condition) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.CONDITION_, condition);
  }
  ...
  public java.lang.String getCondition() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.CONDITION_);
