 ...
 *
 *          Date: Fri Sep 21 13:10:41 EDT 2007
 *
 */
...
public class TableItemImpl extends com.gensym.classes.ExportedSystemItemImpl implements TableItem {
  ...
  public TableItemImpl() {
    super();
  }

  public TableItemImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public TableItemImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public com.gensym.util.Structure getTableLayout() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.TABLE_LAYOUT_);
  ...
  public com.gensym.util.Symbol getTableFontSize() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.TABLE_FONT_SIZE_);
