 ...
 *
 *          Date: Fri Sep 21 12:38:04 EDT 2007
 *
 */
...
public class BorderlessFreeTextImpl extends com.gensym.classes.ItemImpl implements BorderlessFreeText {
  ...
  public BorderlessFreeTextImpl() {
    super();
  }

  public BorderlessFreeTextImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public BorderlessFreeTextImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
