 ...
 *
 *          Date: Fri Sep 21 12:42:12 EDT 2007
 *
 */
...
public class FrameStyleDefinitionImpl extends com.gensym.classes.ItemImpl implements FrameStyleDefinition {
  ...
  public FrameStyleDefinitionImpl() {
    super();
  }

  public FrameStyleDefinitionImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public FrameStyleDefinitionImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  /**
   * Generated Property Setter for attribute -- DESCRIPTION-OF-FRAME
   * @param descriptionOfFrame new value to conclude for DESCRIPTION-OF-FRAME
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setDescriptionOfFrame(com.gensym.util.Sequence descriptionOfFrame) throws G2AccessException {
    setAttributeValue (SystemAttributeSymbols.DESCRIPTION_OF_FRAME_, descriptionOfFrame);
  }

  /**
   * Generated Property Getter for attribute -- DESCRIPTION-OF-FRAME
   * @return the value of the DESCRIPTION-OF-FRAME attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Sequence getDescriptionOfFrame() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SystemAttributeSymbols.DESCRIPTION_OF_FRAME_);
    return (com.gensym.util.Sequence)retnValue;
  }
