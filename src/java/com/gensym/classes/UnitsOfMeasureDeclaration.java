 ...
 *  All Rights Reserved.
 *
 *      UnitsOfMeasureDeclaration.java
 *
 ...
 *
 *          Date: Fri Sep 21 13:13:56 EDT 2007
 *
 */
...
public interface UnitsOfMeasureDeclaration extends com.gensym.classes.Statement {

  public static final Symbol UNITS_OF_MEASURE_DECLARATION_ = com.gensym.util.symbol.G2ClassSymbols.UNITS_OF_MEASURE_DECLARATION_;
  static final Symbol g2ClassName = UNITS_OF_MEASURE_DECLARATION_;
  static final Symbol[] classInheritancePath = new Symbol[] {UNITS_OF_MEASURE_DECLARATION_, STATEMENT_, ITEM_, STATEMENT_OR_PROCEDURE_STEP_, TEXT_BOX_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
