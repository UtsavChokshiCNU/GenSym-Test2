 ...
 *
 *          Date: Fri Sep 21 12:44:13 EDT 2007
 *
 */
...
public class FunctionDefinitionImpl extends com.gensym.classes.StatementImpl implements FunctionDefinition {
  ...
  public FunctionDefinitionImpl() {
    super();
  }

  public FunctionDefinitionImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public FunctionDefinitionImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
