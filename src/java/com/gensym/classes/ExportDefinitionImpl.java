 ...
 *
 *          Date: Fri Sep 21 12:41:01 EDT 2007
 *
 */
...
public class ExportDefinitionImpl extends com.gensym.classes.ItemImpl implements ExportDefinition {
  ...
  public ExportDefinitionImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public ExportDefinitionImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
