 ...
 *  All Rights Reserved.
 *
 *      UilCheckButtonConfigurationClassImpl.java
 *
 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:07:31 EDT 2007
 *
 */
...
public class UilCheckButtonConfigurationClassImpl extends com.gensym.classes.modules.uilroot.UilConfigurationClassImpl implements UilCheckButtonConfigurationClass {
  ...
  public UilCheckButtonConfigurationClassImpl() {
    super();
  }

  public UilCheckButtonConfigurationClassImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public UilCheckButtonConfigurationClassImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
