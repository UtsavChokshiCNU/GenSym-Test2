 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:06:10 EDT 2007
 *
 */
...
public interface UilIconPushbutton extends com.gensym.classes.modules.uilroot.UilIconButton {

  public static final Symbol UIL_ICON_PUSHBUTTON_ = Symbol.intern ("UIL-ICON-PUSHBUTTON");
  static final Symbol g2ClassName = UIL_ICON_PUSHBUTTON_;
  static final Symbol[] classInheritancePath = new Symbol[] {UIL_ICON_PUSHBUTTON_, UIL_ICON_BUTTON_, UIL_BUTTON_, UIL_GROBJ_, UIL_OBJECT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for UIL-UDPATE-VALUE is : 
   * (OR ItemOrValue
      NoItem)
   *
   */
