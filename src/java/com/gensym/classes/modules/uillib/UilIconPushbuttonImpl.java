 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:06:12 EDT 2007
 *
 */
...
public class UilIconPushbuttonImpl extends com.gensym.classes.modules.uilroot.UilIconButtonImpl implements UilIconPushbutton {
  ...
  private static final Symbol UIL_UDPATE_VALUE_ = Symbol.intern ("UIL-UDPATE-VALUE");

  /* Generated constructors */

  public UilIconPushbuttonImpl() {
    super();
  }

  public UilIconPushbuttonImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public UilIconPushbuttonImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  /**
   * Generated Property Setter for attribute -- UIL-UDPATE-VALUE
   * @param uilUdpateValue new value to conclude for UIL-UDPATE-VALUE
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setUilUdpateValue(java.lang.Object uilUdpateValue) throws G2AccessException {
    setAttributeValue (UIL_UDPATE_VALUE_, uilUdpateValue);
  }

  /**
   * Generated Property Getter for attribute -- UIL-UDPATE-VALUE
   * @return the value of the UIL-UDPATE-VALUE attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public java.lang.Object getUilUdpateValue() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (UIL_UDPATE_VALUE_);
    return (java.lang.Object)retnValue;
  }
