 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:06:00 EDT 2007
 *
 */
...
public class UilIconToggleButtonImpl extends com.gensym.classes.modules.uilroot.UilIconButtonImpl implements UilIconToggleButton {
  ...
  public UilIconToggleButtonImpl() {
    super();
  }

  public UilIconToggleButtonImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public UilIconToggleButtonImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
