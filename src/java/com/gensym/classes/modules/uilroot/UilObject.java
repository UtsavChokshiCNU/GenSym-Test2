 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:14:19 EDT 2007
 *
 */
...
public interface UilObject extends com.gensym.classes.Object {

  public static final Symbol UIL_OBJECT_ = Symbol.intern ("UIL-OBJECT");
  static final Symbol g2ClassName = UIL_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {UIL_OBJECT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * UIL-OBJECT::GOLD-MAP-ITEM-TO-CONTEXT
   * @return the return from calling GOLD-MAP-ITEM-TO-CONTEXT
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS UIL-OBJECT,arg1:CLASS UI-CLIENT-ITEM) = (ITEM-OR-VALUE)
   */
