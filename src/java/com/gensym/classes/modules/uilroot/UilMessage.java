 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:06:55 EDT 2007
 *
 */
...
public interface UilMessage extends com.gensym.classes.Message {

  public static final Symbol UIL_MESSAGE_ = Symbol.intern ("UIL-MESSAGE");
  static final Symbol g2ClassName = UIL_MESSAGE_;
  static final Symbol[] classInheritancePath = new Symbol[] {UIL_MESSAGE_, MESSAGE_, ITEM_, TEXT_BOX_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   * UIL-MESSAGE::GOLD-MAP-ITEM-TO-CONTEXT
   * @return the return from calling GOLD-MAP-ITEM-TO-CONTEXT
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS UIL-MESSAGE,arg1:CLASS UI-CLIENT-ITEM) = (ITEM-OR-VALUE)
   */
