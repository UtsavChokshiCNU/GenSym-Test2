...
public interface G2EventObject extends com.gensym.classes.Object,com.gensym.classes.G2_EventObject {

  public static final Symbol G2_EVENT_OBJECT_ = Symbol.intern ("G2-EVENT-OBJECT");
  static final Symbol g2ClassName = G2_EVENT_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2_EVENT_OBJECT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for SOURCE is : 
   * (Sequence)
   *
   */
