 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Sep 27 12:31:36 EDT 2007
 *
 */
...
public interface G2EventListenerSupport extends com.gensym.classes.Object {

  public static final Symbol G2_EVENT_LISTENER_SUPPORT_ = Symbol.intern ("G2-EVENT-LISTENER-SUPPORT");
  static final Symbol g2ClassName = G2_EVENT_LISTENER_SUPPORT_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2_EVENT_LISTENER_SUPPORT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for _EVENT-LISTENERS is : 
   * (Class _G2LISSUP-LISTENER-LIST)
   *
   */
