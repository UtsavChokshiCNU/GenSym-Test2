 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Sep 27 12:31:49 EDT 2007
 *
 */
...
public class G2EventObjectImpl extends com.gensym.classes.ObjectImpl implements G2EventObject {
  ...
  public G2EventObjectImpl() {
    super();
  }

  public G2EventObjectImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public G2EventObjectImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
    super (context, handle, handleVersion, wrap, attributes);
  }


  /**
   * Generated Property Setter for attribute -- SOURCE
   * @param source new value to conclude for SOURCE
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setSource(com.gensym.util.Sequence source) throws G2AccessException {
    setAttributeValue (SOURCE_, source);
  }

  /**
   * Generated Property Getter for attribute -- SOURCE
   * @return the value of the SOURCE attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Sequence getSource() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (SOURCE_);
  ...
  public Class getExternalEventClass() {
    return com.gensym.classes.modules.g2evliss.G2_G2EventObject.class;
  }
