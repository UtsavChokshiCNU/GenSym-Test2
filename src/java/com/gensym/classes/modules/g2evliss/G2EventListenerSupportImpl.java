 ...
 *  All Rights Reserved.
 *
 *      G2EventListenerSupportImpl.java
 *
 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Sep 27 12:32:01 EDT 2007
 *
 */
...
public class G2EventListenerSupportImpl extends com.gensym.classes.ObjectImpl implements G2EventListenerSupport {
  ...
  public G2EventListenerSupportImpl() {
    super();
  }

  public G2EventListenerSupportImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public G2EventListenerSupportImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  private static final Symbol MethodName_ADD_G2_EVENT_LISTENER_ = Symbol.intern ("ADD-G2-EVENT-LISTENER");
  private static final Symbol MethodName_REMOVE_G2_EVENT_LISTENER_ = Symbol.intern ("REMOVE-G2-EVENT-LISTENER");
  private static final Symbol MethodName_GET_EVENT_LISTENER_LIST_ = Symbol.intern ("GET-EVENT-LISTENER-LIST");
  ...
  public  void addG2EventListener(com.gensym.classes.modules.g2evliss.G2EventListener arg1) throws G2AccessException
{
    if (isByHandle()) {
      ...
      result = (java.lang.Object)callRPC(MethodName_ADD_G2_EVENT_LISTENER_, args);
    }
    else {
  ...
  public  void removeG2EventListener(com.gensym.classes.modules.g2evliss.G2EventListener arg1) throws G2AccessException
{
    if (isByHandle()) {
      java.lang.Object result;
      java.lang.Object[] args = new java.lang.Object[] {this,arg1};
      result = (java.lang.Object)callRPC(MethodName_REMOVE_G2_EVENT_LISTENER_, args);
    }
    else {
      // No MethodBody for by-copy exported
      throw new RuntimeException(NoBodyExceptionString);
  ...
  public  com.gensym.classes.ItemList getEventListenerList() throws G2AccessException
{
    if (isByHandle()) {
      ...
      result = (java.lang.Object)callRPC(MethodName_GET_EVENT_LISTENER_LIST_, args);
