 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Sep 27 12:31:53 EDT 2007
 *
 */
...
public class G2EventListenerImpl extends com.gensym.classes.ObjectImpl implements G2EventListener {
  ...
  public G2EventListenerImpl() {
    super();
  }

  public G2EventListenerImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public G2EventListenerImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
