 ...
 *
 *          Date: Wed Aug 12 00:44:45 EDT 1998
 *
 */
...
public interface G2ForeignObject extends com.gensym.classes.Object {

  public static final Symbol G2_FOREIGN_OBJECT_ = Symbol.intern ("G2-FOREIGN-OBJECT");
  static final Symbol g2ClassName = G2_FOREIGN_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2_FOREIGN_OBJECT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for _G2-ACTIVE-STUBS is : 
     (Sequence)
   *
   */
