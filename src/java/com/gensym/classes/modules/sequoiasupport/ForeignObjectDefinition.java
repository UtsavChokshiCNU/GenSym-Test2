 ...
 *
 *          Date: Wed Aug 12 00:36:27 EDT 1998
 *
 */
...
public interface ForeignObjectDefinition extends com.gensym.classes.ClassDefinition {

  public static final Symbol FOREIGN_OBJECT_DEFINITION_ = Symbol.intern ("FOREIGN-OBJECT-DEFINITION");
  static final Symbol g2ClassName = FOREIGN_OBJECT_DEFINITION_;
  static final Symbol[] classInheritancePath = new Symbol[] {FOREIGN_OBJECT_DEFINITION_, CLASS_DEFINITION_, DEFINITION_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for EXTERNAL-CLASS-NAME is : 
     Text
   *
   */
