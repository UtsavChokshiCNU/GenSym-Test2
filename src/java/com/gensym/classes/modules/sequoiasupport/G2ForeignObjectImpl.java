 ...
 *
 *          Date: Wed Aug 12 00:45:55 EDT 1998
 *
 */
...
public class G2ForeignObjectImpl extends ItemImpl implements G2ForeignObject {


  static final long serialVersionUID = 2L;
  private static final Symbol _G2_ACTIVE_STUBS_ = Symbol.intern ("_G2-ACTIVE-STUBS");
  ...
  public G2ForeignObjectImpl() {
    ...
    try { 
      setAttributeValue(CLASS_,G2ForeignObject.g2ClassName);
    }
    catch (G2AccessException e) {}
  }

  public G2ForeignObjectImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes, G2ForeignObject.g2ClassName);
  }
  ...
  /**
   * Generated Property Setter for attribute -- _G2-ACTIVE-STUBS
   * @param _g2ActiveStubs new value to conclude for _G2-ACTIVE-STUBS
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void set_g2ActiveStubs(com.gensym.util.Sequence _g2ActiveStubs) throws G2AccessException {
    setAttributeValue (_G2_ACTIVE_STUBS_, _g2ActiveStubs);
  }

  /**
   * Generated Property Getter for attribute -- _G2-ACTIVE-STUBS
   * @return the value of the _G2-ACTIVE-STUBS attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public com.gensym.util.Sequence get_g2ActiveStubs() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (_G2_ACTIVE_STUBS_);
  ...
  private static final Symbol MethodName__DISPATCH_REMOTE_METHODS_ = Symbol.intern ("_DISPATCH-REMOTE-METHODS");
   ...
   * G2-FOREIGN-OBJECT::_DISPATCH-REMOTE-METHODS
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS G2-FOREIGN-OBJECT,arg1:TEXT,arg2:SEQUENCE) = ()
   */
  @Override
  public  void _dispatchRemoteMethods(java.lang.String arg1,com.gensym.util.Sequence arg2) throws G2AccessException
{
    if (isByHandle()) {
      java.lang.Object result;
      java.lang.Object[] args = new java.lang.Object[] {this,arg1,arg2};
      result = (java.lang.Object)callRPC(MethodName__DISPATCH_REMOTE_METHODS_, args);
    }
    else {
   ...
   * G2-FOREIGN-OBJECT::_DISPATCH-REMOTE-METHODS
   * @exception G2AccessException if there are any communication problems
   * (this:CLASS G2-FOREIGN-OBJECT,arg1:TEXT,arg2:SEQUENCE,arg3:SEQUENCE) = ()
   */
  @Override
  public  void _dispatchRemoteMethods(java.lang.String arg1,com.gensym.util.Sequence arg2,com.gensym.util.Sequence arg3) throws G2AccessException
{
    if (isByHandle()) {
      java.lang.Object result;
