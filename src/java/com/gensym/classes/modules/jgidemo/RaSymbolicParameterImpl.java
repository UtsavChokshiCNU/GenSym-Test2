 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:50:05 EDT 2007
 *
 */
...
public class RaSymbolicParameterImpl extends com.gensym.classes.SymbolicParameterImpl implements RaSymbolicParameter {
  ...
  public RaSymbolicParameterImpl() {
    super();
  }

  public RaSymbolicParameterImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public RaSymbolicParameterImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setAttributeName(com.gensym.util.Symbol attributeName) throws G2AccessException {
    setAttributeValue (ATTRIBUTE_NAME_, attributeName);
  }
  ...
  public com.gensym.util.Symbol getAttributeName() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (ATTRIBUTE_NAME_);
