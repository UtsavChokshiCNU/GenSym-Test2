 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:52:45 EDT 2007
 *
 */
...
public class GsiQuantityClassImpl extends com.gensym.classes.GsiDataServiceImpl implements GsiQuantityClass {


  static final long serialVersionUID = 2L;
  private static final Symbol UPDATE_RATE_ = Symbol.intern ("UPDATE-RATE");
  private static final Symbol EXTERNAL_UNIT_NO_ = Symbol.intern ("EXTERNAL-UNIT-NO");

  /* Generated constructors */

  public GsiQuantityClassImpl() {
    super();
  }

  public GsiQuantityClassImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public GsiQuantityClassImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
  ...
  public void setUpdateRate(int updateRate) throws G2AccessException {
    setAttributeValue (UPDATE_RATE_, updateRate);
  }
  ...
  public int getUpdateRate() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (UPDATE_RATE_);
  ...
  public void setExternalUnitNo(java.lang.String externalUnitNo) throws G2AccessException {
    setAttributeValue (EXTERNAL_UNIT_NO_, externalUnitNo);
  }
  ...
  public java.lang.String getExternalUnitNo() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (EXTERNAL_UNIT_NO_);
