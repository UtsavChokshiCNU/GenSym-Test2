 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:52:36 EDT 2007
 *
 */
...
public class GsiIntegerClassImpl extends com.gensym.classes.GsiDataServiceImpl implements GsiIntegerClass {
  ...
  public GsiIntegerClassImpl() {
    super();
  }

  public GsiIntegerClassImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public GsiIntegerClassImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
