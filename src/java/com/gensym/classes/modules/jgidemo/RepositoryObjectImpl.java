 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:50:12 EDT 2007
 *
 */
...
public class RepositoryObjectImpl extends com.gensym.classes.ObjectImpl implements RepositoryObject {


  static final long serialVersionUID = 2L;
  private static final Symbol REPOSITORY_TAG_ = Symbol.intern ("REPOSITORY-TAG");

  /* Generated constructors */

  public RepositoryObjectImpl() {
    super();
  }

  public RepositoryObjectImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public RepositoryObjectImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
    super (context, handle, handleVersion, wrap, attributes);
  }


  /**
   * Generated Property Setter for attribute -- REPOSITORY-TAG
   * @param repositoryTag new value to conclude for REPOSITORY-TAG
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  @Override
  public void setRepositoryTag(int repositoryTag) throws G2AccessException {
    setAttributeValue (REPOSITORY_TAG_, repositoryTag);
  }

  /**
   * Generated Property Getter for attribute -- REPOSITORY-TAG
   * @return the value of the REPOSITORY-TAG attribute of this item
   * @exception G2AccessException if there are any communication problems
   */
  @Override
  public int getRepositoryTag() throws G2AccessException {
    java.lang.Object retnValue = getAttributeValue (REPOSITORY_TAG_);
