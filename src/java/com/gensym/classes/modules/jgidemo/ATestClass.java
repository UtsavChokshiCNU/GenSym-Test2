 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:49:18 EDT 2007
 *
 */
...
public interface ATestClass extends com.gensym.classes.Object {

  public static final Symbol A_TEST_CLASS_ = Symbol.intern ("A-TEST-CLASS");
  static final Symbol g2ClassName = A_TEST_CLASS_;
  static final Symbol[] classInheritancePath = new Symbol[] {A_TEST_CLASS_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for A-INT is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for A-FLOAT is : 
   * Float
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for A-TEXT is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for A-SYMBOL is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for A-THRUTH-VALUE is : 
   * BooleanTruthValue
   *
   */
