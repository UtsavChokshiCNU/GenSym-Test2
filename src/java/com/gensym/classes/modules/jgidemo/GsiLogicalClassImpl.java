 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:52:40 EDT 2007
 *
 */
...
public class GsiLogicalClassImpl extends com.gensym.classes.GsiDataServiceImpl implements GsiLogicalClass {
  ...
  public GsiLogicalClassImpl() {
    super();
  }

  public GsiLogicalClassImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public GsiLogicalClassImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
