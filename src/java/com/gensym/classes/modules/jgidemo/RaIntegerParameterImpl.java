 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:50:03 EDT 2007
 *
 */
...
public class RaIntegerParameterImpl extends com.gensym.classes.IntegerParameterImpl implements RaIntegerParameter {
  ...
  public RaIntegerParameterImpl() {
    super();
  }

  public RaIntegerParameterImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public RaIntegerParameterImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
