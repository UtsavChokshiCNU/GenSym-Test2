 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:49:24 EDT 2007
 *
 */
...
public interface RepositoryObject extends com.gensym.classes.Object {

  public static final Symbol REPOSITORY_OBJECT_ = Symbol.intern ("REPOSITORY-OBJECT");
  static final Symbol g2ClassName = REPOSITORY_OBJECT_;
  static final Symbol[] classInheritancePath = new Symbol[] {REPOSITORY_OBJECT_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for REPOSITORY-TAG is : 
   * Integer
   *
   */
