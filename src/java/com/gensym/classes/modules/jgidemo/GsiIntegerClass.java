 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:52:34 EDT 2007
 *
 */
...
public interface GsiIntegerClass extends com.gensym.classes.GsiMessageService, com.gensym.classes.GsiDataService, com.gensym.classes.IntegerVariable, com.gensym.classes.modules.jgidemo.IdentAttsClass {

  public static final Symbol GSI_INTEGER_CLASS_ = Symbol.intern ("GSI-INTEGER-CLASS");
  static final Symbol g2ClassName = GSI_INTEGER_CLASS_;
  static final Symbol[] classInheritancePath = new Symbol[] {GSI_INTEGER_CLASS_, GSI_MESSAGE_SERVICE_, GSI_DATA_SERVICE_, INTEGER_VARIABLE_, QUANTITATIVE_VARIABLE_, G2_VARIABLE_, VARIABLE_, VARIABLE_OR_PARAMETER_, IDENT_ATTS_CLASS_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
