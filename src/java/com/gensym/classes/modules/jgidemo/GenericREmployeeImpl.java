 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:50:15 EDT 2007
 *
 */
...
public class GenericREmployeeImpl extends com.gensym.classes.modules.jgidemo.REmployeeImpl implements GenericREmployee {
  ...
  public GenericREmployeeImpl() {
    super();
  }

  public GenericREmployeeImpl(G2Access context, int handle, Structure attributes) {
    super (context, handle, attributes);
  }


  public GenericREmployeeImpl(G2Access context, int handle, int handleVersion, G2__BaseImpl wrap, Structure attributes) {
