 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Sep 21 13:49:29 EDT 2007
 *
 */
...
public interface RaIntegerParameter extends com.gensym.classes.IntegerParameter {

  public static final Symbol RA_INTEGER_PARAMETER_ = Symbol.intern ("RA-INTEGER-PARAMETER");
  static final Symbol g2ClassName = RA_INTEGER_PARAMETER_;
  static final Symbol[] classInheritancePath = new Symbol[] {RA_INTEGER_PARAMETER_, INTEGER_PARAMETER_, QUANTITATIVE_PARAMETER_, PARAMETER_, VARIABLE_OR_PARAMETER_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
  ...
  /**
   * Generated Property Getter for attribute -- ATTRIBUTE-NAME
   * @return the value of the ATTRIBUTE-NAME attribute of this item
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for ATTRIBUTE-NAME is : 
   * Symbol
   *
   */
  public com.gensym.util.Symbol getAttributeName() throws G2AccessException;

  /**
   * Generated Property Setter for attribute -- ATTRIBUTE-NAME
   * @param attributeName new value to conclude for ATTRIBUTE-NAME
   * @exception G2AccessException if there are any communication problems
   *              or the value does not match with the type specification
   */
  public void setAttributeName(com.gensym.util.Symbol attributeName) throws G2AccessException;
