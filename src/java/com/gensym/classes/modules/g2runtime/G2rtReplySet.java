 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Fri Jul 23 05:27:19 EDT 1999
 *
 */
...
public interface G2rtReplySet extends com.gensym.classes.Object {

  public static final Symbol G2RT_REPLY_SET_ = Symbol.intern ("G2RT-REPLY-SET");
  static final Symbol g2ClassName = G2RT_REPLY_SET_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2RT_REPLY_SET_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for _REPLIES is : 
   * (Class G2-LIST)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _UNAVAILABLE-REPLIES is : 
   * (Class G2-LIST)
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _CURRENT-REPLY-INDEX is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _NUMBER-OF-REPLIES-RECEIVED is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _NUMBER-OF-AVAIL-REPLIES-RECEIVED is : 
   * Integer
   *
   */
