 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Thu Aug 05 16:23:03 EDT 1999
 *
 */
...
public interface G2rtMessage extends com.gensym.classes.Object {

  public static final Symbol G2RT_MESSAGE_ = Symbol.intern ("G2RT-MESSAGE");
  static final Symbol g2ClassName = G2RT_MESSAGE_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2RT_MESSAGE_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for CATEGORY is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for TIMESTAMP is : 
   * Float
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _REPLY-EXCEPTION-NAME is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _REPLY-EXCEPTION-TEXT is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for CONTENT-TYPE is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for CONTENT is : 
   * ItemOrValue
   *
   */
