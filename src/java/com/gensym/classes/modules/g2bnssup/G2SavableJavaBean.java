 ...
 *
 *          Date: Tue Dec 01 14:35:21 EST 1998
 *
 */
...
public interface G2SavableJavaBean extends com.gensym.classes.G2JavaBean, com.gensym.classes.G2ForeignSerializable {

  public static final Symbol G2_SAVABLE_JAVA_BEAN_ = Symbol.intern ("G2-SAVABLE-JAVA-BEAN");
  static final Symbol g2ClassName = G2_SAVABLE_JAVA_BEAN_;
  static final Symbol[] classInheritancePath = new Symbol[] {G2_SAVABLE_JAVA_BEAN_, G2_JAVA_BEAN_, G2_FOREIGN_OBJECT_, OBJECT_, G2_FOREIGN_SERIALIZABLE_, G2_FOREIGN_SAVABLE_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
