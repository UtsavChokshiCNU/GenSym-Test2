 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:08:49 EDT 2007
 *
 */
...
public interface GfrTextResourceGroup extends com.gensym.classes.Object {

  public static final Symbol GFR_TEXT_RESOURCE_GROUP_ = Symbol.intern ("GFR-TEXT-RESOURCE-GROUP");
  static final Symbol g2ClassName = GFR_TEXT_RESOURCE_GROUP_;
  static final Symbol[] classInheritancePath = new Symbol[] {GFR_TEXT_RESOURCE_GROUP_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for GFR-VERSION is : 
   * Text
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GFR-DEFAULT-LANGUAGE is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GFR-USE-DEFAULT-LANGUAGE is : 
   * BooleanTruthValue
   *
   */
