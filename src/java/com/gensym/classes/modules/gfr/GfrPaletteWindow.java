 ...
 *       Version: 5.1 Rev. 1
 *
 *          Date: Mon Oct 22 11:08:43 EDT 2007
 *
 */
...
public interface GfrPaletteWindow extends com.gensym.classes.Object {

  public static final Symbol GFR_PALETTE_WINDOW_ = Symbol.intern ("GFR-PALETTE-WINDOW");
  static final Symbol g2ClassName = GFR_PALETTE_WINDOW_;
  static final Symbol[] classInheritancePath = new Symbol[] {GFR_PALETTE_WINDOW_, OBJECT_, ITEM_, ENTITY_, BLOCK_, KB_FRAME_, SYSTEM_ITEM_, ROOT_};
   ...
   *
   * Type Specification for GFR-HELP-MESSAGE-NAME is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for GFR-HELP-TEXT-RESOURCE is : 
   * Symbol
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-X-OFFSET is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-Y-OFFSET is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-TRACKING-IS-ACTIVE is : 
   * BooleanTruthValue
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-MOUSE-X-POSITION is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-MOUSE-Y-POSITION is : 
   * Integer
   *
   */
   ...
   * @exception G2AccessException if there are any communication problems
   *
   * Type Specification for _GFR-CLASS-OF-ASSOCIATED-ITEM is : 
   * Symbol
   *
   */
