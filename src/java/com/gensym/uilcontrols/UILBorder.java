...
public class UILBorder extends Border implements UilClientGrobj{

  static final long serialVersionUID = 6555881697406507276L;

  private UilClientBorder uilHelper;
  
  public UILBorder(UilBoxBorder uilBoxBorder, Class staticClass) throws G2AccessException{
    uilHelper = new UilClientBorderImpl(uilBoxBorder, this, staticClass);
  }

  //UilClientBorder Interface
  //properties
  @Override
  public String getId(){
