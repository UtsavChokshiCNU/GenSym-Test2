...
public class dispVBProjectsEvents extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e190, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public dispVBProjectsEvents (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #24
    ...
    Type info name is: _dispVBProjectsEvents
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
...
public String toString() {
    return "<dispVBProjectsEvents, super = " + super.toString() + ">";
}
