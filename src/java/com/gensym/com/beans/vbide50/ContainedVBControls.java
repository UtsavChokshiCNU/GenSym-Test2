...
public class ContainedVBControls extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e11e, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ContainedVBControls (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #76
    ...
    Type info name is: _ContainedVBControls
    Doc string is: Represents a collection of  VBControl objects.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public VBControl Add (String param1, VBControl param2, boolean param3)
    throws ActiveXException {
    // memid = 0x2a
  ...
  public void Remove (VBControl param1)
    throws ActiveXException {
    // memid = 0x2b

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x2b, AX_INVOKE, true, args);
  }
...
public String toString() {
    return "<ContainedVBControls, super = " + super.toString() + ">";
}
