...
public class ControlTemplates extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x79b1f924, 0xec2c, 0x101a,
             (short) 0xb1, (short) 0xf9, (short) 0x8, (short) 0x0,
             (short) 0x2b, (short) 0x2b, (short) 0x8c, (short) 0xda);

  public ControlTemplates (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #75
    ...
    Type info name is: ControlTemplates
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
    Type Info contains 13 functions.
 ...
 */
  ...
  public ControlTemplate Item (Variant param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public ControlTemplate Item (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0x0
  ...
  public FormTemplate getAxParent ()
    throws ActiveXException {
    // memid = 0x2
  ...
  public ControlTemplate Add (String param1)
    throws ActiveXException {
    // memid = 0x2a

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0x2a, AX_INVOKE, false, args);
    ControlTemplate result = new ControlTemplate(vResult.getActiveXDispatchableValue());
    return result;
  }

  public ControlTemplate Add (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0x2a
...
public String toString() {
    return "<ControlTemplates, super = " + super.toString() + ">";
}
