...
public class References extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e179, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public References (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Reference Item (Variant param1)
    throws ActiveXException {
    // memid = 0x0
    ...
    Reference result = new Reference(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public Reference AddFromGuid (String param1, int param2, int param3)
    throws ActiveXException {
    // memid = 0x60020005
    ...
    args.addElement(new Variant(param2));
    args.addElement(new Variant(param3));
    Variant vResult = axInvoke(0x60020005, AX_INVOKE, false, args);
    Reference result = new Reference(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Reference AddFromFile (String param1)
    throws ActiveXException {
    // memid = 0x60020006

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0x60020006, AX_INVOKE, false, args);
    Reference result = new Reference(vResult.getActiveXDispatchableValue());
    return result;
  }

  public void Remove (Reference param1)
    throws ActiveXException {
    // memid = 0x60020007

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60020007, AX_INVOKE, true, args);
  }

@Override
public String toString() {
    return "<References, super = " + super.toString() + ">";
}
