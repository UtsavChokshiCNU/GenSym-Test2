...
/* Type info #18
    ...
    Type info name is: _Windows
    Doc string is: Represents the collection of Visual Basic IDE windows.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public Window CreateToolWindow (AddIn param1, String param2, String param3, String param4, Variant param5)
    throws ActiveXException {
    // memid = 0x12c
    ...
    args.addElement(new Variant(param4));
    args.addElement(param5);
    Variant vResult = axInvoke(0x12c, AX_INVOKE, false, args);
    Window result = new Window(vResult.getActiveXDispatchableValue());
    return result;
  }
