...
/* Type info #106
    An enumeration type.
    Type info name is: vbext_Scope
    Doc string is: Specifies the scope of the member.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 */

  public static final int VBEXT_PRIVATE = 1;

  public static final int VBEXT_PUBLIC = 2;

  public static final int VBEXT_FRIEND = 3;
