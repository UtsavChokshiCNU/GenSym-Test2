...
public class MenuLine extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xef404e18, 0xeda6, 0x101a,
             (short) 0x8d, (short) 0xaf, (short) 0x0, (short) 0xdd,
             (short) 0x1, (short) 0xf, (short) 0x7e, (short) 0xbb);

  public MenuLine (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public MenuItems getAxParent ()
    throws ActiveXException {
    // memid = 0x2

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x2, AX_PROPERTYGET, false, args);
    MenuItems result = new MenuItems(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public int ConnectEvents (ActiveXDispatchable param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0x68, AX_INVOKE, false, args);
    int result = vResult.getIntValue();
    return result;
  }
...
public String toString() {
    return "<MenuLine, super = " + super.toString() + ">";
}
