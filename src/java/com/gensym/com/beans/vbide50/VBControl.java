...
public class VBControl extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e11d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public VBControl (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #71
    ...
    Type info name is: VBControl
    Doc string is: Represents a VBControl object.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public ActiveXDispatchable getAxContainer ()
    ...
    // Currently unimplemented reference put: 0x29
  ...
  public boolean getAxInSelection ()
    throws ActiveXException {
    // memid = 0x2c
  ...
  public void setAxInSelection (boolean param1)
    throws ActiveXException {
    // memid = 0x2c
  ...
  public ActiveXDispatchable getAxControlObject ()
    throws ActiveXException {
    // memid = 0x2d
    ...
    // Enumeration type = vbextControlType
  public int getAxControlType ()
    throws ActiveXException {
    // memid = 0x2e

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x2e, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public VBControl ZOrder (int param1)
    throws ActiveXException {
    // memid = 0x2f

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0x2f, AX_INVOKE, false, args);
...
public String toString() {
    return "<VBControl, super = " + super.toString() + ">";
}
