...
public class AddIns extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e109, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public AddIns (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #84
    ...
    Type info name is: _AddIns
    Doc string is: Returns the collection of all add-ins that are accessible in the development environment.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public AddIn Item (Variant param1)
    throws ActiveXException {
    // memid = 0x0
    ...
    AddIn result = new AddIn(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public void Update ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x29, AX_INVOKE, true, args);
  }

@Override
public String toString() {
    return "<AddIns, super = " + super.toString() + ">";
}
