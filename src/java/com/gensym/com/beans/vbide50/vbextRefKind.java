...
/* Type info #99
    An enumeration type.
    Type info name is: vbext_RefKind
    Doc string is: Represents a reference to a type of library or a project.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 */

  public static final int VBEXT_RK_TYPE_LIB = 0;

  public static final int VBEXT_RK_PROJECT = 1;
