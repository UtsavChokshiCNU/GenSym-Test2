...
public class Components extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2f3304a0, 0x1602, 0x11ce,
             (short) 0xbf, (short) 0xdc, (short) 0x8, (short) 0x0,
             (short) 0x2b, (short) 0x2b, (short) 0x8c, (short) 0xda);

  public Components (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
public String toString() {
    return "<Components, super = " + super.toString() + ">";
}
