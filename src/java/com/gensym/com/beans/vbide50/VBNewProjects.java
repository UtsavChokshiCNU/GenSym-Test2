...
public class VBNewProjects extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2e133, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public VBNewProjects (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #53
    ...
    Type info name is: VBNewProjects
    Doc string is: Represents all the projects added as a result of a particular operation.
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
...
public String toString() {
    return "<VBNewProjects, super = " + super.toString() + ">";
}
