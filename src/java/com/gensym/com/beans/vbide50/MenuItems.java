...
public class MenuItems extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xef404e12, 0xeda6, 0x101a,
 ...
 */
  ...
  public ActiveXDispatchable Item (String param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public MenuLine Add (String param1)
    throws ActiveXException {
    // memid = 0x64
    ...
    MenuLine result = new MenuLine(vResult.getActiveXDispatchableValue());
    return result;
  }

  public SubMenu AddMenu (String param1)
    throws ActiveXException {
    // memid = 0x65
    ...
    SubMenu result = new SubMenu(vResult.getActiveXDispatchableValue());
    return result;
  }

  public int Remove (ActiveXDispatchable param1)
    throws ActiveXException {
    // memid = 0x66
