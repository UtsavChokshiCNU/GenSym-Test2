...
public class ControlTemplate extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x79b1f922, 0xec2c, 0x101a,
             (short) 0xb1, (short) 0xf9, (short) 0x8, (short) 0x0,
             (short) 0x2b, (short) 0x2b, (short) 0x8c, (short) 0xda);

  public ControlTemplate (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #69
    ...
    Type info name is: ControlTemplate
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public ControlTemplates getAxParent ()
    throws ActiveXException {
    // memid = 0x2
  ...
  public ControlTemplate ZOrder (int param1)
    throws ActiveXException {
    // memid = 0x2b
...
public String toString() {
    return "<ControlTemplate, super = " + super.toString() + ">";
}
