...
public class SelectedComponents extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xef404e1c, 0xeda6, 0x101a,
             (short) 0x8d, (short) 0xaf, (short) 0x0, (short) 0xdd,
             (short) 0x1, (short) 0xf, (short) 0x7e, (short) 0xbb);

  public SelectedComponents (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #56
    ...
    Type info name is: SelectedComponents
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public Variant Item (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<SelectedComponents, super = " + super.toString() + ">";
}
