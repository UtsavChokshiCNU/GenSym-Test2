...
public class Application extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xef404e01, 0xeda6, 0x101a,
 ...
 */
  ...
  public ProjectTemplate getAxActiveProject ()
    throws ActiveXException {
    // memid = 0x65
  ...
  public FileControl getAxFileControl ()
    throws ActiveXException {
    // memid = 0x67

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x67, AX_PROPERTYGET, false, args);
    FileControl result = new FileControl(vResult.getActiveXDispatchableValue());
    return result;
  }

  public SubMenu getAxAddInMenu ()
    throws ActiveXException {
    // memid = 0x68
  ...
  public ProjectTemplate LoadProject (String param1, boolean param2)
    throws ActiveXException {
    // memid = 0x69
    ...
    args.addElement(new Variant(param1));
    args.addElement(new Variant(param2));
    Variant vResult = axInvoke(0x69, AX_INVOKE, false, args);
    ProjectTemplate result = new ProjectTemplate(vResult.getActiveXDispatchableValue());
    return result;
  }
