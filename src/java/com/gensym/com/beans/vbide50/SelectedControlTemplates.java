...
public class SelectedControlTemplates extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x79b1f926, 0xec2c, 0x101a,
             (short) 0xb1, (short) 0xf9, (short) 0x8, (short) 0x0,
             (short) 0x2b, (short) 0x2b, (short) 0x8c, (short) 0xda);

  public SelectedControlTemplates (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #80
    ...
    Type info name is: SelectedControlTemplates
    Help file is: C:\Program Files\DevStudio\VB\VB5EXT.HLP
 ...
 */
  ...
  public ControlTemplate Item (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<SelectedControlTemplates, super = " + super.toString() + ">";
}
