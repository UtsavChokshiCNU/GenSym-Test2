...
public class Interior extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20870, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Interior (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Variant getAxInvertIfNegative ()
    throws ActiveXException {
    // memid = 0x84
  ...
  public void setAxInvertIfNegative (Variant param1)
    throws ActiveXException {
    // memid = 0x84
  ...
  public void setAxPattern (Variant param1)
    throws ActiveXException {
    // memid = 0x5f

    Vector args = new Vector(1);
    args.addElement(param1);
    axInvoke(0x5f, AX_PROPERTYSET, true, args);
  }

  public Variant getAxPatternColor ()
    throws ActiveXException {
    // memid = 0x64
  ...
  public void setAxPatternColor (Variant param1)
    throws ActiveXException {
    // memid = 0x64
  ...
  public Variant getAxPatternColorIndex ()
    throws ActiveXException {
    // memid = 0x62

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x62, AX_PROPERTYGET, false, args);
    return vResult;
  }

  public void setAxPatternColorIndex (Variant param1)
    throws ActiveXException {
    // memid = 0x62

    Vector args = new Vector(1);
    args.addElement(param1);
    axInvoke(0x62, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<Interior, super = " + super.toString() + ">";
}
