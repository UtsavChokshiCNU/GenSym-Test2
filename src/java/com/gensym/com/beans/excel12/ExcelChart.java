...
public class ExcelChart extends com.gensym.com.ActiveXDefaultComponentImpl
{
  private boolean hasBeenAdded = false;


  private static Guid classID =
    new Guid(0x20821, 0x0, 0x0,
  ...
  public ExcelChart (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
public String toString() {
    return "<ExcelChart, super = " + super.toString() + ">";
}
