...
public class Comments extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24426, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Comments (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Comment Item (int param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public Comment getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Comments, super = " + super.toString() + ">";
}
