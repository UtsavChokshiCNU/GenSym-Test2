...
public class HPageBreaks extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24404, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public HPageBreaks (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public HPageBreak getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    HPageBreak result = new HPageBreak(vResult.getActiveXDispatchableValue());
    return result;
  }

  public HPageBreak getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public HPageBreak Add (ActiveXDispatchable param1)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<HPageBreaks, super = " + super.toString() + ">";
}
