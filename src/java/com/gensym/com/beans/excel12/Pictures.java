...
public class Pictures extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208a7, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Pictures (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Picture Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    Picture result = new Picture(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public Picture Insert (String param1)
    throws ActiveXException {
    // memid = 0xfc

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0xfc, AX_INVOKE, false, args);
    Picture result = new Picture(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Picture Insert (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0xfc
  ...
  public Picture Paste ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0xd3, AX_INVOKE, false, args);
    Picture result = new Picture(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Picture Paste (Variant param1)
    throws ActiveXException {
    // memid = 0xd3
...
public String toString() {
    return "<Pictures, super = " + super.toString() + ">";
}
