...
public class ExcelSheet extends com.gensym.com.ActiveXDefaultComponentImpl
{
  private boolean hasBeenAdded = false;


  private static Guid classID =
    new Guid(0x20820, 0x0, 0x0,
  ...
  public synchronized void addNotify () {
    ...
    if ((hWnd == null) || (hWnd.handleToPeer == Hwnd.NO_HWND)) {
      message(AX_ERROR, "Failed to obtain HWND for " + this);
    } else if (classID.isNullGuid()) {
      message(AX_ERROR, "Failed to obtain CLSID for " + this);
    } else {
      message(AX_PROGRESS, "HWND for " + this + " = " + hWnd);
      if (axProxy == null) {
        try {
          axProxy = new ActiveXProxy(hWnd, new ActiveXModes(classID),
                                     this);
          axDispatch = new ActiveXDispatchableImpl(AX_NO_DISPATCH, axProxy);
        } catch(ActiveXException e) {
           message(AX_ERROR, "Failed to create Proxy" + e);
           }
        message(AX_DATA_DUMPS, "made new ActiveXProxy! = " + axProxy);
        message(AX_PROGRESS, "AddNotify: Inserted object  " + axProxy);
      }
    }
  }


  public ExcelSheet (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #522
    ...
    Type info name is: Worksheet
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains zero functions.
 ...
 */
  ...
  public void SelectionChange (Range param1)
    throws ActiveXException {
    // memid = 0x607

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x607, AX_INVOKE, true, args);
  }

  public void BeforeDoubleClick (Range param1, Variant param2)
    throws ActiveXException {
    // memid = 0x601
  ...
  public void BeforeRightClick (Range param1, Variant param2)
    throws ActiveXException {
    // memid = 0x5fe
  ...
  public void Change (Range param1)
    throws ActiveXException {
    // memid = 0x609

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x609, AX_INVOKE, true, args);
  }

@Override
public String toString() {
    return "<ExcelSheet, super = " + super.toString() + ">";
}
