...
public class Menu extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20866, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Menu (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public MenuItems getAxMenuItems ()
    throws ActiveXException {
    // memid = 0x251

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x251, AX_PROPERTYGET, false, args);
...
public String toString() {
    return "<Menu, super = " + super.toString() + ">";
}
