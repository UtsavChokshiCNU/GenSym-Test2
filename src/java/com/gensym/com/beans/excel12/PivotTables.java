...
public class PivotTables extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20873, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PivotTables (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public PivotTable Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
...
public String toString() {
    return "<PivotTables, super = " + super.toString() + ">";
}
