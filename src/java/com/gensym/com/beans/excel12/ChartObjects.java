...
public class ChartObjects extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208d0, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ChartObjects (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #448
    ...
    Type info name is: ChartObjects
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public ChartObject Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    ChartObject result = new ChartObject(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<ChartObjects, super = " + super.toString() + ">";
}
