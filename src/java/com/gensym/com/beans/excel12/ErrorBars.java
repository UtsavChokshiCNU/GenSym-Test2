...
public class ErrorBars extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208ce, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ErrorBars (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public void ClearFormats ()
    ...
    // Enumeration type = XlEndStyleCap
  public int getAxEndStyle ()
    throws ActiveXException {
    // memid = 0x464

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x464, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxEndStyle (int param1)
    throws ActiveXException {
    // memid = 0x464

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x464, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<ErrorBars, super = " + super.toString() + ">";
}
