...
public class ControlFormat extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24440, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ControlFormat (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #515
    ...
    Type info name is: ControlFormat
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 44 functions.
 ...
 */
  ...
  public int getAxListCount ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x351, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxListCount (int param1)
    throws ActiveXException {
    // memid = 0x351

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x351, AX_PROPERTYSET, true, args);
  }
  ...
  public void setAxMultiSelect (int param1)
    throws ActiveXException {
    // memid = 0x20
...
public String toString() {
    return "<ControlFormat, super = " + super.toString() + ">";
}
