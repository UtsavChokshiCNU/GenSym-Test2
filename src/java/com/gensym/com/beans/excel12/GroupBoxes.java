...
public class GroupBoxes extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2088a, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public GroupBoxes (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #406
    ...
    Type info name is: GroupBoxes
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 63 functions.
 ...
 */
  ...
  public GroupBox Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<GroupBoxes, super = " + super.toString() + ">";
}
