...
public class ListBoxes extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20888, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ListBoxes (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #404
    ...
    Type info name is: ListBoxes
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 70 functions.
 ...
 */
  ...
  public ListBox Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    ListBox result = new ListBox(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<ListBoxes, super = " + super.toString() + ">";
}
