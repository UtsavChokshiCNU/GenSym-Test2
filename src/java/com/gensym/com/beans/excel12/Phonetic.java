...
public class Phonetic extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24438, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Phonetic (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public int getAxCharacterType ()
    throws ActiveXException {
    // memid = 0x68a

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x68a, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxCharacterType (int param1)
    throws ActiveXException {
    // memid = 0x68a

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x68a, AX_PROPERTYSET, true, args);
  }
  ...
  public int getAxAlignment ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x1c5, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
  ...
  public void setAxAlignment (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x1c5, AX_PROPERTYSET, true, args);
  }
...
public String toString() {
    return "<Phonetic, super = " + super.toString() + ">";
}
