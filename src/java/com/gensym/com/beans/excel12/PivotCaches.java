...
public class PivotCaches extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2441d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PivotCaches (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public PivotCache Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public PivotCache getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<PivotCaches, super = " + super.toString() + ">";
}
