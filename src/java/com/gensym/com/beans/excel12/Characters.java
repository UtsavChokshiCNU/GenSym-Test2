...
public class Characters extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20878, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Characters (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public String getAxPhoneticCharacters ()
    throws ActiveXException {
    // memid = 0x5f2

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x5f2, AX_PROPERTYGET, false, args);
    String result = vResult.getStringValue();
    return result;
  }

  public void setAxPhoneticCharacters (String param1)
    throws ActiveXException {
    // memid = 0x5f2

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x5f2, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<Characters, super = " + super.toString() + ">";
}
