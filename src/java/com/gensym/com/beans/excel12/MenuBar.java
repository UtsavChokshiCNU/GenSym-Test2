...
public class MenuBar extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20864, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public MenuBar (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Menus getAxMenus ()
    throws ActiveXException {
    // memid = 0x24f

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x24f, AX_PROPERTYGET, false, args);
    Menus result = new Menus(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<MenuBar, super = " + super.toString() + ">";
}
