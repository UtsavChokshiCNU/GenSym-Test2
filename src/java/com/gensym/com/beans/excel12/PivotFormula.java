...
public class PivotFormula extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2441e, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PivotFormula (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #379
    ...
    Type info name is: PivotFormula
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public void setAxIndex (int param1)
    throws ActiveXException {
    // memid = 0x1e6

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x1e6, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<PivotFormula, super = " + super.toString() + ">";
}
