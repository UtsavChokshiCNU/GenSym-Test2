...
public class AutoFilter extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24432, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public AutoFilter (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Filters getAxFilters ()
    throws ActiveXException {
    // memid = 0x651

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x651, AX_PROPERTYGET, false, args);
    Filters result = new Filters(vResult.getActiveXDispatchableValue());
    return result;
  }

@Override
public String toString() {
    return "<AutoFilter, super = " + super.toString() + ">";
}
