...
public class CustomView extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24423, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CustomView (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public boolean getAxPrintSettings ()
    throws ActiveXException {
    // memid = 0x629

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x629, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }

  public boolean getAxRowColSettings ()
    throws ActiveXException {
    // memid = 0x62a

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x62a, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }
...
public String toString() {
    return "<CustomView, super = " + super.toString() + ">";
}
