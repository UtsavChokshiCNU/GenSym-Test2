...
public class MenuBars extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20863, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public MenuBars (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public MenuBar Add (Variant param1)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public MenuBar getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public MenuBar getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
...
public String toString() {
    return "<MenuBars, super = " + super.toString() + ">";
}
