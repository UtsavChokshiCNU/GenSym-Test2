...
public class Buttons extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2087e, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Buttons (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #394
    ...
    Type info name is: Buttons
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 86 functions.
 ...
 */
  ...
  public Button Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    Button result = new Button(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<Buttons, super = " + super.toString() + ">";
}
