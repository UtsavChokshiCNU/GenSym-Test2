...
public class OptionButtons extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20882, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public OptionButtons (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #398
    ...
    Type info name is: OptionButtons
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public GroupBox getAxGroupBox ()
    throws ActiveXException {
    // memid = 0x341

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x341, AX_PROPERTYGET, false, args);
    GroupBox result = new GroupBox(vResult.getActiveXDispatchableValue());
    return result;
  }

  public OptionButton Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    OptionButton result = new OptionButton(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<OptionButtons, super = " + super.toString() + ">";
}
