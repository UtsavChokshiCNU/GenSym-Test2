...
public class Borders extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20855, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Borders (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Border getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public void setAxLineStyle (Variant param1)
    throws ActiveXException {
    // memid = 0x77

    Vector args = new Vector(1);
    args.addElement(param1);
    axInvoke(0x77, AX_PROPERTYSET, true, args);
  }
  ...
  public void setAxWeight (Variant param1)
    throws ActiveXException {
    // memid = 0x78

    Vector args = new Vector(1);
    args.addElement(param1);
    axInvoke(0x78, AX_PROPERTYSET, true, args);
  }

  public Border getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Borders, super = " + super.toString() + ">";
}
