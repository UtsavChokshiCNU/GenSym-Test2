...
public class SoundNote extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2087b, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public SoundNote (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public void Import (String param1)
    throws ActiveXException {
    // memid = 0x395

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x395, AX_INVOKE, true, args);
  }
  ...
  public void Play ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x396, AX_INVOKE, true, args);
  }
  ...
  public void Record ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x397, AX_INVOKE, true, args);
  }

@Override
public String toString() {
    return "<SoundNote, super = " + super.toString() + ">";
}
