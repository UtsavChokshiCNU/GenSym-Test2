...
public class QueryTables extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24429, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public QueryTables (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Variant Add (Variant param1, Range param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Variant Add (Variant param1, Range param2, Variant param3)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<QueryTables, super = " + super.toString() + ">";
}
