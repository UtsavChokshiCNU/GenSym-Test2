...
public class CustomViews extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24422, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CustomViews (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public CustomView Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    CustomView result = new CustomView(vResult.getActiveXDispatchableValue());
    return result;
  }

  public CustomView Add (String param1)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public CustomView Add (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public CustomView Add (String param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public CustomView getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<CustomViews, super = " + super.toString() + ">";
}
