...
public class ExcelApplication extends com.gensym.com.ActiveXDefaultComponentImpl
{
  private boolean hasBeenAdded = false;


  private static Guid classID =
    new Guid(0x24500, 0x0, 0x0,
  ...
  public synchronized void addNotify () {
    ...
    if ((hWnd == null) || (hWnd.handleToPeer == Hwnd.NO_HWND)) {
      ...
      if (axProxy == null) {
        try {
          axProxy = new ActiveXProxy(hWnd, new ActiveXModes(classID, AX_NOT_INSERTABLE),
                                     this);
  ...
  public ExcelApplication (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
public String toString() {
    return "<ExcelApplication, super = " + super.toString() + ">";
}
