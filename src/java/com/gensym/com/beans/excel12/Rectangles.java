...
public class Rectangles extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2089d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Rectangles (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #423
    ...
    Type info name is: Rectangles
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 80 functions.
 ...
 */
  ...
  public Rectangle Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    Rectangle result = new Rectangle(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<Rectangles, super = " + super.toString() + ">";
}
