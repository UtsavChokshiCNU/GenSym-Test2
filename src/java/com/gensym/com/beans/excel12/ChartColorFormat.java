...
public class ChartColorFormat extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24436, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ChartColorFormat (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #473
    ...
    Type info name is: ChartColorFormat
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public int getAxSchemeColor ()
    throws ActiveXException {
    // memid = 0x66e

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x66e, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxSchemeColor (int param1)
    throws ActiveXException {
    // memid = 0x66e

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x66e, AX_PROPERTYSET, true, args);
  }
  ...
  public int getAxRGB ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x41f, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
...
public String toString() {
    return "<ChartColorFormat, super = " + super.toString() + ">";
}
