...
public class Filters extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24433, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Filters (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Filter getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
    ...
    Filter result = new Filter(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Filter getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
...
public String toString() {
    return "<Filters, super = " + super.toString() + ">";
}
