...
public class Toolbars extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2085d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Toolbars (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Toolbar Add ()
    ...
    Toolbar result = new Toolbar(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Toolbar Add (Variant param1)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Toolbar getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public Toolbar getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
...
public String toString() {
    return "<Toolbars, super = " + super.toString() + ">";
}
