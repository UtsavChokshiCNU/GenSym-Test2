...
public class Windows extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20892, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Windows (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public void Arrange (int param1)
    throws ActiveXException {
    // memid = 0x27e

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x27e, AX_INVOKE, true, args);
  }

  public void Arrange (int param1, Variant param2)
    throws ActiveXException {
    // memid = 0x27e
  ...
  public void Arrange (int param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0x27e
  ...
  public void Arrange (int param1, Variant param2, Variant param3, Variant param4)
    throws ActiveXException {
    // memid = 0x27e
  ...
  public Window getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public Window getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Windows, super = " + super.toString() + ">";
}
