...
public class VPageBreaks extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24405, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public VPageBreaks (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public VPageBreak getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    VPageBreak result = new VPageBreak(vResult.getActiveXDispatchableValue());
    return result;
  }

  public VPageBreak getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public VPageBreak Add (ActiveXDispatchable param1)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<VPageBreaks, super = " + super.toString() + ">";
}
