...
public class Modules extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208ae, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Modules (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Module Add ()
    ...
    Module result = new Module(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Module Add (Variant param1)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Module Add (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Module Add (Variant param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<Modules, super = " + super.toString() + ">";
}
