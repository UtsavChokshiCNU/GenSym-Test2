...
public class PivotFormulas extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2441f, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PivotFormulas (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #380
    ...
    Type info name is: PivotFormulas
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public PivotFormula Add (String param1)
    throws ActiveXException {
    // memid = 0xb5
    ...
    PivotFormula result = new PivotFormula(vResult.getActiveXDispatchableValue());
    return result;
  }

  public PivotFormula Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public PivotFormula getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<PivotFormulas, super = " + super.toString() + ">";
}
