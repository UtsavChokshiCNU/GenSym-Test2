...
public class Styles extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20853, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Styles (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Style Add (String param1)
    throws ActiveXException {
    // memid = 0xb5
    ...
    Style result = new Style(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Style Add (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Style getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public Style getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Styles, super = " + super.toString() + ">";
}
