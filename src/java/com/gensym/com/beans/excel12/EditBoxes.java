...
public class EditBoxes extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20884, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public EditBoxes (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public boolean getAxPasswordEdit ()
    throws ActiveXException {
    // memid = 0x48a

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x48a, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }

  public void setAxPasswordEdit (boolean param1)
    throws ActiveXException {
    // memid = 0x48a

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x48a, AX_PROPERTYSET, true, args);
  }

  public EditBox Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    EditBox result = new EditBox(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<EditBoxes, super = " + super.toString() + ">";
}
