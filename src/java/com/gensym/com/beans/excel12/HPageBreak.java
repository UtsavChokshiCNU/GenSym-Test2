...
public class HPageBreak extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24401, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public HPageBreak (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public void DragOff (int param1, int param2)
    throws ActiveXException {
    // memid = 0x58c
    ...
    args.addElement(new Variant(param1));
    args.addElement(new Variant(param2));
    axInvoke(0x58c, AX_INVOKE, true, args);
  }

    // Enumeration type = XlPageBreak
  ...
  public void setAxType (int param1)
    ...
    // Enumeration type = XlPageBreakExtent
  public int getAxExtent ()
    throws ActiveXException {
    // memid = 0x58e

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x58e, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public Range getAxLocation ()
    throws ActiveXException {
    // memid = 0x575

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x575, AX_PROPERTYGET, false, args);
    Range result = new Range(vResult.getActiveXDispatchableValue());
    return result;
  }

    // Currently unimplemented reference put: 0x575

@Override
public String toString() {
    return "<HPageBreak, super = " + super.toString() + ">";
}
