...
public class Areas extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20860, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Areas (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Range getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public Range getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Areas, super = " + super.toString() + ">";
}
