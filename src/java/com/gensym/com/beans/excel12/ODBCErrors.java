...
public class ODBCErrors extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2442d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ODBCErrors (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public ODBCError Item (int param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    ODBCError result = new ODBCError(vResult.getActiveXDispatchableValue());
    return result;
  }

  public ODBCError getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<ODBCErrors, super = " + super.toString() + ">";
}
