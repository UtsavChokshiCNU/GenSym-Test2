...
public class Label extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20890, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Label (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
public String toString() {
    return "<Label, super = " + super.toString() + ">";
}
