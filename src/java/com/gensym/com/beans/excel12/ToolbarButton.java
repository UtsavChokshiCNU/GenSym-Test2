...
public class ToolbarButton extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2085e, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ToolbarButton (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #365
    ...
    Type info name is: ToolbarButton
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public boolean getAxBuiltInFace ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x22a, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }
  ...
  public void setAxBuiltInFace (boolean param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x22a, AX_PROPERTYSET, true, args);
  }

  public void Copy (Toolbar param1, int param2)
    throws ActiveXException {
    // memid = 0x227
  ...
  public void CopyFace ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x3c6, AX_INVOKE, true, args);
  }
  ...
  public void Edit ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x232, AX_INVOKE, true, args);
  }
  ...
  public int getAxId ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x23a, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public boolean getAxIsGap ()
    throws ActiveXException {
    // memid = 0x231

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x231, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }

  public void Move (Toolbar param1, int param2)
    throws ActiveXException {
    // memid = 0x27d
  ...
  public void PasteFace ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x3c7, AX_INVOKE, true, args);
  }

  public boolean getAxPushed ()
    throws ActiveXException {
    // memid = 0x230

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x230, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }

  public void setAxPushed (boolean param1)
    throws ActiveXException {
    // memid = 0x230

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x230, AX_PROPERTYSET, true, args);
  }
...
public String toString() {
    return "<ToolbarButton, super = " + super.toString() + ">";
}
