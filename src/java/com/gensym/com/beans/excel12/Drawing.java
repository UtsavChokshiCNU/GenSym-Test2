...
public class Drawing extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208a8, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Drawing (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #435
    ...
    Type info name is: Drawing
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 77 functions.
 ...
 */
  ...
  public void AddVertex (double param1, double param2)
    throws ActiveXException {
    // memid = 0x259
    ...
    args.addElement(new Variant(param1));
    args.addElement(new Variant(param2));
    axInvoke(0x259, AX_INVOKE, true, args);
  }
  ...
  public Variant getAxVertices (Variant param1)
    throws ActiveXException {
    // memid = 0x26d
  ...
  public Variant getAxVertices (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0x26d
...
public String toString() {
    return "<Drawing, super = " + super.toString() + ">";
}
