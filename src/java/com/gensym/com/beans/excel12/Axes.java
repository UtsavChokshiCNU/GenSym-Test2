...
public class Axes extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2085b, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Axes (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Axis Item (int param1, int param2)
    throws ActiveXException {
    // memid = 0xaa
    ...
    Axis result = new Axis(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<Axes, super = " + super.toString() + ">";
}
