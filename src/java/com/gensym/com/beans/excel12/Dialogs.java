...
public class Dialogs extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20879, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Dialogs (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Dialog getAxItem (int param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    Dialog result = new Dialog(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Dialog getAx_Default (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Dialogs, super = " + super.toString() + ">";
}
