...
public class Menus extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20865, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Menus (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Menu Add (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Menu Add (String param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Menu getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public Menu getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
...
public String toString() {
    return "<Menus, super = " + super.toString() + ">";
}
