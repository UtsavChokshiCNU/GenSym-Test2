...
public class EditBox extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20883, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public EditBox (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #399
    ...
    Type info name is: EditBox
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 62 functions.
 ...
 */
  ...
  public String getAxLinkedObject ()
    throws ActiveXException {
    // memid = 0x35e

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x35e, AX_PROPERTYGET, false, args);
    String result = vResult.getStringValue();
    return result;
  }
...
public String toString() {
    return "<EditBox, super = " + super.toString() + ">";
}
