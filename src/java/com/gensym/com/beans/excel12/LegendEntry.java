...
public class LegendEntry extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208ba, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public LegendEntry (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public LegendKey getAxLegendKey ()
    throws ActiveXException {
    // memid = 0xae

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0xae, AX_PROPERTYGET, false, args);
    LegendKey result = new LegendKey(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<LegendEntry, super = " + super.toString() + ">";
}
