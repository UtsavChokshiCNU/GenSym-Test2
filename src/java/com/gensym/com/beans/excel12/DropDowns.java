...
public class DropDowns extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2088c, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public DropDowns (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #408
    ...
    Type info name is: DropDowns
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
    Type Info contains 76 functions.
 ...
 */
  ...
  public DropDown Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    DropDown result = new DropDown(vResult.getActiveXDispatchableValue());
    return result;
  }

  public DropDown Add (double param1, double param2, double param3, double param4, Variant param5)
    throws ActiveXException {
    // memid = 0xb5
...
public String toString() {
    return "<DropDowns, super = " + super.toString() + ">";
}
