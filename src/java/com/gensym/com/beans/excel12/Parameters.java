...
public class Parameters extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2442b, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Parameters (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Parameter Add (String param1)
    throws ActiveXException {
    // memid = 0xb5
    ...
    Parameter result = new Parameter(vResult.getActiveXDispatchableValue());
    return result;
  }

  public Parameter Add (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public Parameter Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
  ...
  public Parameter getAx_Default (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Parameters, super = " + super.toString() + ">";
}
