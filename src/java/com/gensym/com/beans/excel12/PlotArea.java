...
public class PlotArea extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208cb, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PlotArea (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public double getAxInsideLeft ()
    throws ActiveXException {
    // memid = 0x683

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x683, AX_PROPERTYGET, false, args);
    double result = vResult.getDoubleValue();
    return result;
  }

  public double getAxInsideTop ()
    throws ActiveXException {
    // memid = 0x684

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x684, AX_PROPERTYGET, false, args);
    double result = vResult.getDoubleValue();
    return result;
  }

  public double getAxInsideWidth ()
    throws ActiveXException {
    // memid = 0x685

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x685, AX_PROPERTYGET, false, args);
    double result = vResult.getDoubleValue();
    return result;
  }

  public double getAxInsideHeight ()
    throws ActiveXException {
    // memid = 0x686

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x686, AX_PROPERTYGET, false, args);
    double result = vResult.getDoubleValue();
    return result;
  }
...
public String toString() {
    return "<PlotArea, super = " + super.toString() + ">";
}
