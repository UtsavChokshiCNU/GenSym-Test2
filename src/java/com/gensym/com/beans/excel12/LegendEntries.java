...
public class LegendEntries extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208bb, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public LegendEntries (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #487
    ...
    Type info name is: LegendEntries
    Help file is: C:\Program Files\Microsoft Office\Office\VBAXL8.HLP
 ...
 */
  ...
  public LegendEntry Item (Variant param1)
    throws ActiveXException {
    // memid = 0xaa
    ...
    LegendEntry result = new LegendEntry(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<LegendEntries, super = " + super.toString() + ">";
}
