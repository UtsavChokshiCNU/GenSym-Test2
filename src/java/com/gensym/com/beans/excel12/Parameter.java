...
public class Parameter extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x2442a, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Parameter (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public ActiveXDispatchable getAxParent ()
    ...
    // Enumeration type = XlParameterDataType
  ...
  public void setAxDataType (int param1)
    throws ActiveXException {
    // memid = 0x2d2

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x2d2, AX_PROPERTYSET, true, args);
  }

    // Enumeration type = XlParameterType
  ...
  public String getAxPromptString ()
    throws ActiveXException {
    // memid = 0x63f

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x63f, AX_PROPERTYGET, false, args);
  ...
  public Range getAxSourceRange ()
    throws ActiveXException {
    // memid = 0x640

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x640, AX_PROPERTYGET, false, args);
  ...
  public void SetParam (int param1, Variant param2)
    throws ActiveXException {
    // memid = 0x641
    ...
    args.addElement(new Variant(param1));
    args.addElement(param2);
    axInvoke(0x641, AX_INVOKE, true, args);
  }

@Override
public String toString() {
    return "<Parameter, super = " + super.toString() + ">";
}
