...
public class CheckBoxes extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20880, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CheckBoxes (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public CheckBox Add (double param1, double param2, double param3, double param4)
    throws ActiveXException {
    // memid = 0xb5
    ...
    CheckBox result = new CheckBox(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<CheckBoxes, super = " + super.toString() + ">";
}
