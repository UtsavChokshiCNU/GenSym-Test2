...
public class Worksheets extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x208b1, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Worksheets (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public ActiveXDispatchable Add ()
    throws ActiveXException {
    // memid = 0xb5
  ...
  public ActiveXDispatchable Add (Variant param1)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public ActiveXDispatchable Add (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public ActiveXDispatchable Add (Variant param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public ActiveXDispatchable Add (Variant param1, Variant param2, Variant param3, Variant param4)
    throws ActiveXException {
    // memid = 0xb5
  ...
  public void FillAcrossSheets (Range param1, int param2)
    throws ActiveXException {
    // memid = 0x1d5
    ...
    args.addElement(new Variant(param1));
    args.addElement(new Variant(param2));
    axInvoke(0x1d5, AX_INVOKE, true, args);
  }
...
public String toString() {
    return "<Worksheets, super = " + super.toString() + ">";
}
