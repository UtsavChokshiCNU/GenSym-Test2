...
public class Points extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x20869, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Points (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public Point Item (int param1)
    ...
    Point result = new Point(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<Points, super = " + super.toString() + ">";
}
