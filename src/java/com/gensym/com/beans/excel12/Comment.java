...
public class Comment extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24427, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Comment (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public String Text ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x8a, AX_INVOKE, false, args);
    String result = vResult.getStringValue();
    return result;
  }

  public String Text (Variant param1)
    throws ActiveXException {
    // memid = 0x8a
  ...
  public String Text (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0x8a
  ...
  public String Text (Variant param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0x8a
  ...
  public Comment Next ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x1f6, AX_INVOKE, false, args);
  ...
  public Comment Previous ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x1f7, AX_INVOKE, false, args);
    Comment result = new Comment(vResult.getActiveXDispatchableValue());
    return result;
  }
...
public String toString() {
    return "<Comment, super = " + super.toString() + ">";
}
