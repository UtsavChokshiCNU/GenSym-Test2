...
public class LinkFormat extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0x24442, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public LinkFormat (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public boolean getAxAutoUpdate ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x418, AX_PROPERTYGET, false, args);
  ...
  public void setAxAutoUpdate (boolean param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x418, AX_PROPERTYSET, true, args);
  }
...
public String toString() {
    return "<LinkFormat, super = " + super.toString() + ">";
}
