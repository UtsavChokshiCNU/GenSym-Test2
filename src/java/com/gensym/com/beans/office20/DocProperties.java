...
/* Type info #67
    An enumeration type.
    Type info name is: DocProperties
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int OFF_PROPERTY_TYPE_NUMBER = 1;

  public static final int OFF_PROPERTY_TYPE_BOOLEAN = 2;

  public static final int OFF_PROPERTY_TYPE_DATE = 3;

  public static final int OFF_PROPERTY_TYPE_STRING = 4;

  public static final int OFF_PROPERTY_TYPE_FLOAT = 5;
