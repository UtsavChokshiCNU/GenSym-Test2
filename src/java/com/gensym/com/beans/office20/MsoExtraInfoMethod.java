...
public interface MsoExtraInfoMethod
{
...
/* Type info #57
    An enumeration type.
    Type info name is: MsoExtraInfoMethod
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_METHOD_GET = 0;

  public static final int MSO_METHOD_POST = 1;
