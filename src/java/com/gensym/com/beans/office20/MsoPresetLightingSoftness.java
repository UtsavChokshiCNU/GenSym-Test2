...
/* Type info #17
    An enumeration type.
    Type info name is: MsoPresetLightingSoftness
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_PRESET_LIGHTING_SOFTNESS_MIXED = -2;

  public static final int MSO_LIGHTING_DIM = 1;

  public static final int MSO_LIGHTING_NORMAL = 2;

  public static final int MSO_LIGHTING_BRIGHT = 3;
