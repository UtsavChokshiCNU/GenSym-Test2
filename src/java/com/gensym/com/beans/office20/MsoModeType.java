...
/* Type info #62
    An enumeration type.
    Type info name is: MsoModeType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_MODE_MODAL = 0;

  public static final int MSO_MODE_AUTO_DOWN = 1;

  public static final int MSO_MODE_MODELESS = 2;
