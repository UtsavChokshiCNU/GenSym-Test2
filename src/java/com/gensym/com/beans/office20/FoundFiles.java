...
public class FoundFiles extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc0331, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public FoundFiles (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public String getAxItem (int param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<FoundFiles, super = " + super.toString() + ">";
}
