...
public interface MsoButtonState
{
...
/* Type info #49
    An enumeration type.
    Type info name is: MsoButtonState
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_BUTTON_UP = 0;

  public static final int MSO_BUTTON_DOWN = -1;

  public static final int MSO_BUTTON_MIXED = 2;
