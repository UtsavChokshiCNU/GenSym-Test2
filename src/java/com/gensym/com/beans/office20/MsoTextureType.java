...
public interface MsoTextureType
{
...
/* Type info #8
    An enumeration type.
    Type info name is: MsoTextureType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_TEXTURE_TYPE_MIXED = -2;

  public static final int MSO_TEXTURE_PRESET = 1;

  public static final int MSO_TEXTURE_USER_DEFINED = 2;
