...
public class CommandBarControls extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc0306, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CommandBarControls (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #74
    ...
    Type info name is: CommandBarControls
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 ...
 */
  ...
  public CommandBarControl Add ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60030000, AX_INVOKE, false, args);
    CommandBarControl result = new CommandBarControl(vResult.getActiveXDispatchableValue());
    return result;
  }

  public CommandBarControl Add (Variant param1)
    throws ActiveXException {
    // memid = 0x60030000
  ...
  public CommandBarControl Add (Variant param1, Variant param2)
    throws ActiveXException {
    // memid = 0x60030000
  ...
  public CommandBarControl Add (Variant param1, Variant param2, Variant param3)
    throws ActiveXException {
    // memid = 0x60030000
  ...
  public CommandBarControl Add (Variant param1, Variant param2, Variant param3, Variant param4)
    throws ActiveXException {
    // memid = 0x60030000
  ...
  public CommandBarControl Add (Variant param1, Variant param2, Variant param3, Variant param4, Variant param5)
    throws ActiveXException {
    // memid = 0x60030000
  ...
  public CommandBarControl getAxItem (Variant param1)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<CommandBarControls, super = " + super.toString() + ">";
}
