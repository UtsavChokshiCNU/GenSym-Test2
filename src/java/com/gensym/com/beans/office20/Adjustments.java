...
public class Adjustments extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc0310, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public Adjustments (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
 ...
 */
  ...
  public float getAxItem (int param1)
    throws ActiveXException {
    // memid = 0x0
  ...
  public void setAxItem (int param1, float param2)
    throws ActiveXException {
    // memid = 0x0
...
public String toString() {
    return "<Adjustments, super = " + super.toString() + ">";
}
