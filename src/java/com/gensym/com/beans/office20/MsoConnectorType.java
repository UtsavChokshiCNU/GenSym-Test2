...
/* Type info #24
    An enumeration type.
    Type info name is: MsoConnectorType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_CONNECTOR_TYPE_MIXED = -2;

  public static final int MSO_CONNECTOR_STRAIGHT = 1;

  public static final int MSO_CONNECTOR_ELBOW = 2;

  public static final int MSO_CONNECTOR_CURVE = 3;
