...
/* Type info #7
    An enumeration type.
    Type info name is: MsoGradientColorType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_GRADIENT_COLOR_MIXED = -2;

  public static final int MSO_GRADIENT_ONE_COLOR = 1;

  public static final int MSO_GRADIENT_TWO_COLORS = 2;

  public static final int MSO_GRADIENT_PRESET_COLORS = 3;
