...
/* Type info #51
    An enumeration type.
    Type info name is: MsoButtonStyle
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_BUTTON_AUTOMATIC = 0;

  public static final int MSO_BUTTON_ICON = 1;

  public static final int MSO_BUTTON_CAPTION = 2;

  public static final int MSO_BUTTON_ICON_AND_CAPTION = 3;
