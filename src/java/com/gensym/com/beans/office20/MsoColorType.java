...
/* Type info #35
    An enumeration type.
    Type info name is: MsoColorType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_COLOR_TYPE_MIXED = -2;

  public static final int MSO_COLOR_TYPERGB = 1;

  public static final int MSO_COLOR_TYPE_SCHEME = 2;
