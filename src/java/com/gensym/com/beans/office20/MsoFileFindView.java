...
public interface MsoFileFindView
{
...
/* Type info #106
    An enumeration type.
    Type info name is: MsoFileFindView
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_VIEW_FILE_INFO = 1;

  public static final int MSO_VIEW_PREVIEW = 2;

  public static final int MSO_VIEW_SUMMARY_INFO = 3;
