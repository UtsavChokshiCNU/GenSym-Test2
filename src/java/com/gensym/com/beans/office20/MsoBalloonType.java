...
public interface MsoBalloonType
{
...
/* Type info #61
    An enumeration type.
    Type info name is: MsoBalloonType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_BALLOON_TYPE_BUTTONS = 0;

  public static final int MSO_BALLOON_TYPE_BULLETS = 1;

  public static final int MSO_BALLOON_TYPE_NUMBERS = 2;
