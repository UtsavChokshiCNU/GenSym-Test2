...
/* Type info #38
    An enumeration type.
    Type info name is: MsoCalloutDropType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_CALLOUT_DROP_MIXED = -2;

  public static final int MSO_CALLOUT_DROP_CUSTOM = 1;

  public static final int MSO_CALLOUT_DROP_TOP = 2;

  public static final int MSO_CALLOUT_DROP_CENTER = 3;

  public static final int MSO_CALLOUT_DROP_BOTTOM = 4;
