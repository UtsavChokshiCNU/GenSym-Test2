...
/* Type info #47
    An enumeration type.
    Type info name is: MsoBarType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_BAR_TYPE_NORMAL = 0;

  public static final int MSO_BAR_TYPE_MENU_BAR = 1;

  public static final int MSO_BAR_TYPE_POPUP = 2;
