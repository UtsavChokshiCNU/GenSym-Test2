...
public interface MsoOrientation
{
...
/* Type info #27
    An enumeration type.
    Type info name is: MsoOrientation
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_ORIENTATION_MIXED = -2;

  public static final int MSO_ORIENTATION_HORIZONTAL = 1;

  public static final int MSO_ORIENTATION_VERTICAL = 2;
