...
public interface MsoWiardActType
{
...
/* Type info #64
    An enumeration type.
    Type info name is: MsoWizardActType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_WIZARD_ACT_INACTIVE = 0;

  public static final int MSO_WIZARD_ACT_ACTIVE = 1;

  public static final int MSO_WIZARD_ACT_SUSPEND = 2;

  public static final int MSO_WIZARD_ACT_RESUME = 3;
