...
/* Type info #34
    An enumeration type.
    Type info name is: MsoTriState
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_TRUE = -1;

  public static final int MSO_FALSE = 0;

  public static final int MSO_C_TRUE = 1;

  public static final int MSO_TRI_STATE_TOGGLE = -3;

  public static final int MSO_TRI_STATE_MIXED = -2;
