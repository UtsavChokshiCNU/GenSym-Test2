...
public interface MsoExtrusionColorType
{
...
/* Type info #21
    An enumeration type.
    Type info name is: MsoExtrusionColorType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_EXTRUSION_COLOR_TYPE_MIXED = -2;

  public static final int MSO_EXTRUSION_COLOR_AUTOMATIC = 1;

  public static final int MSO_EXTRUSION_COLOR_CUSTOM = 2;
