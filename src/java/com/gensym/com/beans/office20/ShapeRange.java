...
public class ShapeRange extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc031d, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public ShapeRange (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #92
    ...
    Type info name is: ShapeRange
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
    Type Info contains 71 functions.
 ...
 */
  ...
  public void Align (int param1, int param2)
    throws ActiveXException {
    // memid = 0xa
  ...
  public void Distribute (int param1, int param2)
    throws ActiveXException {
    // memid = 0xd
  ...
  public void ScaleHeight (float param1, int param2, int param3)
    ...
    args.addElement(new Variant(param2));
    args.addElement(new Variant(param3));
    axInvoke(0x17, AX_INVOKE, true, args);
  }
  ...
  public void Select ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x19, AX_INVOKE, true, args);
  }
  ...
  public void SetShapesDefaultProperties ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x1a, AX_INVOKE, true, args);
  }
  ...
  public ShapeRange Ungroup ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x1b, AX_INVOKE, false, args);
    ShapeRange result = new ShapeRange(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public void ZOrder (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x1c, AX_INVOKE, true, args);
  }
...
public String toString() {
    return "<ShapeRange, super = " + super.toString() + ">";
}
