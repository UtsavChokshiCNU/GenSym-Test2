...
/* Type info #4
    An enumeration type.
    Type info name is: MsoArrowheadLength
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_ARROWHEAD_LENGTH_MIXED = -2;

  public static final int MSO_ARROWHEAD_SHORT = 1;

  public static final int MSO_ARROWHEAD_LENGTH_MEDIUM = 2;

  public static final int MSO_ARROWHEAD_LONG = 3;
