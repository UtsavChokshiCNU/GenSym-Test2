...
public interface MsoEditingType
{
...
/* Type info #30
    An enumeration type.
    Type info name is: MsoEditingType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_EDITING_AUTO = 0;

  public static final int MSO_EDITING_CORNER = 1;

  public static final int MSO_EDITING_SMOOTH = 2;

  public static final int MSO_EDITING_SYMMETRIC = 3;
