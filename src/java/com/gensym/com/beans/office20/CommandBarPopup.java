...
public class CommandBarPopup extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc030a, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CommandBarPopup (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #77
    ...
    Type info name is: CommandBarPopup
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
    Type Info contains 87 functions.
 ...
 */
  ...
  public CommandBar getAxCommandBar ()
    throws ActiveXException {
    // memid = 0x60050000
  ...
  public CommandBarControls getAxControls ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050001, AX_PROPERTYGET, false, args);
    CommandBarControls result = new CommandBarControls(vResult.getActiveXDispatchableValue());
    return result;
  }

    // Enumeration type = MsoOLEMenuGroup
  public int getAxOLEMenuGroup ()
    throws ActiveXException {
    // memid = 0x60050002
  ...
  public void setAxOLEMenuGroup (int param1)
    throws ActiveXException {
    // memid = 0x60050002
...
public String toString() {
    return "<CommandBarPopup, super = " + super.toString() + ">";
}
