...
/* Type info #112
    An enumeration type.
    Type info name is: MsoSortBy
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_SORT_BY_FILE_NAME = 1;

  public static final int MSO_SORT_BY_SIZE = 2;

  public static final int MSO_SORT_BY_FILE_TYPE = 3;

  public static final int MSO_SORT_BY_LAST_MODIFIED = 4;
