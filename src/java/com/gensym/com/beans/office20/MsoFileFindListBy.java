...
public interface MsoFileFindListBy
{
...
/* Type info #108
    An enumeration type.
    Type info name is: MsoFileFindListBy
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_LISTBY_NAME = 1;

  public static final int MSO_LISTBY_TITLE = 2;
