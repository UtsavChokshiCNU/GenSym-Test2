...
/* Type info #43
    An enumeration type.
    Type info name is: MsoScaleFrom
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_SCALE_FROM_TOP_LEFT = 0;

  public static final int MSO_SCALE_FROM_MIDDLE = 1;

  public static final int MSO_SCALE_FROM_BOTTOM_RIGHT = 2;
