...
public interface MsoHyperlinkType
{
...
/* Type info #56
    An enumeration type.
    Type info name is: MsoHyperlinkType
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_HYPERLINK_RANGE = 0;

  public static final int MSO_HYPERLINK_SHAPE = 1;

  public static final int MSO_HYPERLINK_INLINE_SHAPE = 2;
