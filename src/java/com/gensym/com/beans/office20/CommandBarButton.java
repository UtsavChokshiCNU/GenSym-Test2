...
public class CommandBarButton extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc030e, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CommandBarButton (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #76
    ...
    Type info name is: CommandBarButton
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
    Type Info contains 95 functions.
 ...
 */
  ...
  public boolean getAxBuiltInFace ()
    throws ActiveXException {
    // memid = 0x60050000

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050000, AX_PROPERTYGET, false, args);
    boolean result = vResult.getBooleanValue();
    return result;
  }

  public void setAxBuiltInFace (boolean param1)
    throws ActiveXException {
    // memid = 0x60050000

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050000, AX_PROPERTYSET, true, args);
  }
  ...
  public void CopyFace ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x60050002, AX_INVOKE, true, args);
  }

  public int getAxFaceId ()
    throws ActiveXException {
    // memid = 0x60050003

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050003, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxFaceId (int param1)
    throws ActiveXException {
    // memid = 0x60050003

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050003, AX_PROPERTYSET, true, args);
  }
  ...
  public void PasteFace ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x60050005, AX_INVOKE, true, args);
  }

  public String getAxShortcutText ()
    throws ActiveXException {
    // memid = 0x60050006
  ...
  public void setAxShortcutText (String param1)
    throws ActiveXException {
    // memid = 0x60050006
    ...
    // Enumeration type = MsoButtonState
  public int getAxState ()
    throws ActiveXException {
    // memid = 0x60050008
  ...
  public void setAxState (int param1)
    throws ActiveXException {
    // memid = 0x60050008

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050008, AX_PROPERTYSET, true, args);
  }

    // Enumeration type = MsoButtonStyle
  public int getAxStyle ()
    throws ActiveXException {
    // memid = 0x6005000a

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x6005000a, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
  ...
  public void setAxStyle (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x6005000a, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<CommandBarButton, super = " + super.toString() + ">";
}
