...
public class PropertyTests extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc0334, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public PropertyTests (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #119
    ...
    Type info name is: PropertyTests
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 ...
 */
  ...
  public PropertyTest getAxItem (int param1)
    throws ActiveXException {
    // memid = 0x0
    ...
    PropertyTest result = new PropertyTest(vResult.getActiveXDispatchableValue());
    return result;
  }
  ...
  public void Add (String param1, int param2, Variant param3, Variant param4, int param5)
    throws ActiveXException {
    // memid = 0x5
...
public String toString() {
    return "<PropertyTests, super = " + super.toString() + ">";
}
