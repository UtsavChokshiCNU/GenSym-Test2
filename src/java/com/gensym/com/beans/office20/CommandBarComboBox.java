...
public class CommandBarComboBox extends com.gensym.com.ActiveXDispatchableImpl
{
  private static Guid classID =
    new Guid(0xc030c, 0x0, 0x0,
             (short) 0xc0, (short) 0x0, (short) 0x0, (short) 0x0,
             (short) 0x0, (short) 0x0, (short) 0x0, (short) 0x46);

  public CommandBarComboBox (ActiveXDispatchable axDispatch) throws ActiveXCastException
  {
       super(axDispatch);
...
/* Type info #78
    ...
    Type info name is: CommandBarComboBox
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
    Type Info contains 101 functions.
 ...
 */
  ...
  public void AddItem (String param1)
    throws ActiveXException {
    // memid = 0x60050000

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050000, AX_INVOKE, true, args);
  }

  public void AddItem (String param1, Variant param2)
    throws ActiveXException {
    // memid = 0x60050000
  ...
  public void Clear ()
    ...
    Vector args = new Vector(0);
    axInvoke(0x60050001, AX_INVOKE, true, args);
  }
  ...
  public int getAxDropDownLines ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050002, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
  ...
  public void setAxDropDownLines (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050002, AX_PROPERTYSET, true, args);
  }

  public int getAxDropDownWidth ()
    throws ActiveXException {
    // memid = 0x60050004

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050004, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxDropDownWidth (int param1)
    throws ActiveXException {
    // memid = 0x60050004

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050004, AX_PROPERTYSET, true, args);
  }

  public String getAxList (int param1)
    throws ActiveXException {
    // memid = 0x60050006

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    Variant vResult = axInvoke(0x60050006, AX_PROPERTYGET, false, args);
    String result = vResult.getStringValue();
    return result;
  }

  public void setAxList (int param1, String param2)
    throws ActiveXException {
    // memid = 0x60050006
    ...
    args.addElement(new Variant(param1));
    args.addElement(new Variant(param2));
    axInvoke(0x60050006, AX_PROPERTYSET, true, args);
  }

  public int getAxListCount ()
    throws ActiveXException {
    // memid = 0x60050008

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050008, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public int getAxListHeaderCount ()
    throws ActiveXException {
    // memid = 0x60050009

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050009, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }

  public void setAxListHeaderCount (int param1)
    throws ActiveXException {
    // memid = 0x60050009

    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050009, AX_PROPERTYSET, true, args);
  }
  ...
  public int getAxListIndex ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x6005000b, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
  ...
  public void setAxListIndex (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x6005000b, AX_PROPERTYSET, true, args);
  }
  ...
  public void RemoveItem (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x6005000d, AX_INVOKE, true, args);
  }

    // Enumeration type = MsoComboStyle
  public int getAxStyle ()
    throws ActiveXException {
    // memid = 0x6005000e

    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x6005000e, AX_PROPERTYGET, false, args);
    int result = vResult.getIntValue();
    return result;
  }
  ...
  public void setAxStyle (int param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x6005000e, AX_PROPERTYSET, true, args);
  }
  ...
  public String getAxText ()
    ...
    Vector args = new Vector(0);
    Variant vResult = axInvoke(0x60050010, AX_PROPERTYGET, false, args);
    String result = vResult.getStringValue();
    return result;
  }
  ...
  public void setAxText (String param1)
    ...
    Vector args = new Vector(1);
    args.addElement(new Variant(param1));
    axInvoke(0x60050010, AX_PROPERTYSET, true, args);
  }

@Override
public String toString() {
    return "<CommandBarComboBox, super = " + super.toString() + ">";
}
