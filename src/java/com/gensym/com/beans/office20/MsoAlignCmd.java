...
/* Type info #22
    An enumeration type.
    Type info name is: MsoAlignCmd
    Help file is: C:\Program Files\Microsoft Office\Office\vbaoff8.hlp
 */

  public static final int MSO_ALIGN_LEFTS = 0;

  public static final int MSO_ALIGN_CENTERS = 1;

  public static final int MSO_ALIGN_RIGHTS = 2;

  public static final int MSO_ALIGN_TOPS = 3;

  public static final int MSO_ALIGN_MIDDLES = 4;

  public static final int MSO_ALIGN_BOTTOMS = 5;
