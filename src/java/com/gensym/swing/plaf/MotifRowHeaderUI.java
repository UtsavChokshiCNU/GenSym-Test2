...
public class MotifRowHeaderUI extends RowHeaderUI {
  ...
  public void paint (Graphics g, JComponent c) {
	...
	System.out.println ("Dbl Buffer Image = " + rowWidth + "x" + rowHeight);
      ...
      bufG.setColor (new Color (174, 178,195));
      ...
      bufG.setColor (new Color (84, 86, 95));
	...
	break;
      ...
      g.drawString (model.getRowName (rowNumber), invArea.x + 5, y + (rowHeight + fontHeight)/2 - 3 /*fudge*/);
    }
  }
