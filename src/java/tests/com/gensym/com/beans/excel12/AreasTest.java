...
public class AreasTest extends ActiveXDispatchableTestBase {

    private Areas component;

    @Before
    public void setUp() throws ActiveXCastException {
        component = new Areas(axProxy);
    }

    @Test
    public void test_QueryInterface_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60000000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(361), new Variant(229))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.QueryInterface(new Variant(361), new Variant(229));
                    }
                });
    }
    ...
    public void test_GetIDsOfNames_FiveArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010002).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(247), new Variant(857), new
                Variant(42L), new Variant(42L), new Variant(766))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetIDsOfNames(new Variant(247), new Variant(857), 42L, 42L, new Variant(766));
                    }
                });
    }
    ...
    public void test_Invoke_EightArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010003).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(650), new
                Variant(42L), new Variant(42), new Variant(799), new Variant(243), new Variant(121), new Variant(491))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Invoke(42, new Variant(650), 42L, 42, new Variant(799), new Variant(243), new
                                Variant(121), new Variant(491));
                    }
                });
    }
