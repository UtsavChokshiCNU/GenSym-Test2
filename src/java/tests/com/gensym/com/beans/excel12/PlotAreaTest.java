...
public class PlotAreaTest extends ActiveXDispatchableTestBase {

    private PlotArea component;

    @Before
    public void setUp() throws ActiveXCastException {
        component = new PlotArea(axProxy);
    }

    @Test
    public void test_QueryInterface_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60000000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(430), new Variant(882))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.QueryInterface(new Variant(430), new Variant(882));
                    }
                });
    }
    ...
    public void test_GetTypeInfoCount_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x60010000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(873))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetTypeInfoCount(new Variant(873));
                    }
                });
    }
    ...
    public void test_GetTypeInfo_ThreeArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010001).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42L), new Variant(42L), new
                ...
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetTypeInfo(42L, 42L, new Variant(656));
                    }
                });
    }
    ...
    public void test_GetIDsOfNames_FiveArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010002).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(668), new Variant(701), new
                Variant(42L), new Variant(42L), new Variant(513))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetIDsOfNames(new Variant(668), new Variant(701), 42L, 42L, new Variant(513));
                    }
                });
    }
    ...
    public void test_Invoke_EightArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010003).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(241), new
                Variant(42L), new Variant(42), new Variant(549), new Variant(322), new Variant(580), new Variant(257))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Invoke(42, new Variant(241), 42L, 42, new Variant(549), new Variant(322), new
                                Variant(580), new Variant(257));
                    }
                });
    }
    ...
    @Test
    public void test_getAxInsideLeft_ZeroArgs_ShouldRedirectToProxy() throws Exception {
        on(0x683).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET)
                .verifyReturnsDouble(new Returns<Double>() {
                    @Override
                    public Double invoke() throws ActiveXException {
                        return component.getAxInsideLeft();
                    }
                });
    }

    @Test
    public void test_getAxInsideTop_ZeroArgs_ShouldRedirectToProxy() throws Exception {
        on(0x684).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET)
                .verifyReturnsDouble(new Returns<Double>() {
                    @Override
                    public Double invoke() throws ActiveXException {
                        return component.getAxInsideTop();
                    }
                });
    }

    @Test
    public void test_getAxInsideWidth_ZeroArgs_ShouldRedirectToProxy() throws Exception {
        on(0x685).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET)
                .verifyReturnsDouble(new Returns<Double>() {
                    @Override
                    public Double invoke() throws ActiveXException {
                        return component.getAxInsideWidth();
                    }
                });
    }

    @Test
    public void test_getAxInsideHeight_ZeroArgs_ShouldRedirectToProxy() throws Exception {
        on(0x686).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET)
                .verifyReturnsDouble(new Returns<Double>() {
                    @Override
                    public Double invoke() throws ActiveXException {
                        return component.getAxInsideHeight();
                    }
                });
    }
