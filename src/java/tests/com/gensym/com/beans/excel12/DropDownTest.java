...
public class DropDownTest extends ActiveXDispatchableTestBase {

    private DropDown component;

    @Before
    public void setUp() throws ActiveXCastException {
        component = new DropDown(axProxy);
    }

    @Test
    public void test_QueryInterface_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60000000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(701), new Variant(547))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.QueryInterface(new Variant(701), new Variant(547));
                    }
                });
    }
    ...
    public void test_GetTypeInfoCount_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x60010000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(332))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetTypeInfoCount(new Variant(332));
                    }
                });
    }
    ...
    public void test_GetTypeInfo_ThreeArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010001).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42L), new Variant(42L), new
                ...
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetTypeInfo(42L, 42L, new Variant(123));
                    }
                });
    }
    ...
    public void test_GetIDsOfNames_FiveArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010002).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(880), new Variant(992), new
                Variant(42L), new Variant(42L), new Variant(481))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetIDsOfNames(new Variant(880), new Variant(992), 42L, 42L, new Variant(481));
                    }
                });
    }
    ...
    public void test_Invoke_EightArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010003).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(693), new
                Variant(42L), new Variant(42), new Variant(520), new Variant(953), new Variant(885), new Variant(297))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Invoke(42, new Variant(693), 42L, 42, new Variant(520), new Variant(953), new
                                Variant(885), new Variant(297));
                    }
                });
    }
    ...
    public void test_setAxName_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x6e).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("DWLYaJmAMe"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxName("DWLYaJmAMe");
                    }
                });
    }
    ...
    public void test_setAxOnAction_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x254).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("qoQCGlpUgH"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxOnAction("qoQCGlpUgH");
                    }
                });
    }
    ...
    public void test_setAxPlacement_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x269).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant(912))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxPlacement(new Variant(912));
                    }
                });
    }
    ...
    public void test_Select_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0xeb).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(704))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Select(new Variant(704));
                    }
                });
    }
    ...
    public void test_AddItem_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x353).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(955))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.AddItem(new Variant(955));
                    }
                });
    }
    ...
    public void test_AddItem_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x353).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(937), new Variant(840))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.AddItem(new Variant(937), new Variant(840));
                    }
                });
    }
    ...
    public void test_setAxLinkedCell_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x422).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("MGYOISVXGz"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxLinkedCell("MGYOISVXGz");
                    }
                });
    }
    ...
    public void test_List_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x35d).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(808))
                .verifyReturnsVariant(new Returns<Variant>() {
                    @Override
                    public Variant invoke() throws ActiveXException {
                        return component.List(new Variant(808));
                    }
                });
    }
    ...
    public void test_setAxListFillRange_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x34f).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("fYIRisameM"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxListFillRange("fYIRisameM");
                    }
                });
    }
    ...
    public void test_RemoveItem_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x354).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(370))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.RemoveItem(42, new Variant(370));
                    }
                });
    }
    ...
    public void test_Selected_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x463).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(416))
                .verifyReturnsVariant(new Returns<Variant>() {
                    @Override
                    public Variant invoke() throws ActiveXException {
                        return component.Selected(new Variant(416));
                    }
                });
    }
    ...
    public void test_setAxCaption_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x8b).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("CkygtGSOxD"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxCaption("CkygtGSOxD");
                    }
                });
    }
    ...
    public void test_getAxCharacters_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x25b).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET).args(new Variant(777))
                .verifyReturnsDispatchable(new Returns<Characters>() {
                    @Override
                    public Characters invoke() throws ActiveXException {
                        return component.getAxCharacters(new Variant(777));
                    }
                });
    }
    ...
    public void test_getAxCharacters_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x25b).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYGET).args(new Variant(705), new Variant(585))
                .verifyReturnsDispatchable(new Returns<Characters>() {
                    @Override
                    public Characters invoke() throws ActiveXException {
                        return component.getAxCharacters(new Variant(705), new Variant(585));
                    }
                });
    }
    ...
    public void test_setAxText_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x8a).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("aChSvArvgg"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxText("aChSvArvgg");
                    }
                });
    }
