...
public class ListBoxTest extends ActiveXDispatchableTestBase {

    private ListBox component;

    @Before
    public void setUp() throws ActiveXCastException {
        component = new ListBox(axProxy);
    }

    @Test
    public void test_QueryInterface_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60000000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(452), new Variant(859))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.QueryInterface(new Variant(452), new Variant(859));
                    }
                });
    }
    ...
    public void test_GetTypeInfoCount_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x60010000).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(72))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetTypeInfoCount(new Variant(72));
                    }
                });
    }
    ...
    public void test_GetIDsOfNames_FiveArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010002).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(844), new Variant(503), new
                Variant(42L), new Variant(42L), new Variant(340))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.GetIDsOfNames(new Variant(844), new Variant(503), 42L, 42L, new Variant(340));
                    }
                });
    }
    ...
    public void test_Invoke_EightArgs_ShouldRedirectToProxy() throws Exception {
        on(0x60010003).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(888), new
                Variant(42L), new Variant(42), new Variant(938), new Variant(472), new Variant(649), new Variant(320))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Invoke(42, new Variant(888), 42L, 42, new Variant(938), new Variant(472), new
                                Variant(649), new Variant(320));
                    }
                });
    }
    ...
    public void test_setAxName_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x6e).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("ASVXUgJjES"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxName("ASVXUgJjES");
                    }
                });
    }
    ...
    public void test_setAxOnAction_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x254).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("IKQNMXHVEk"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxOnAction("IKQNMXHVEk");
                    }
                });
    }
    ...
    public void test_setAxPlacement_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x269).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant(567))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxPlacement(new Variant(567));
                    }
                });
    }
    ...
    public void test_Select_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0xeb).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(404))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.Select(new Variant(404));
                    }
                });
    }
    ...
    public void test_AddItem_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x353).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(373))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.AddItem(new Variant(373));
                    }
                });
    }
    ...
    public void test_AddItem_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x353).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(70), new Variant(883))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.AddItem(new Variant(70), new Variant(883));
                    }
                });
    }
    ...
    public void test_setAxLinkedCell_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x422).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("RLSATiwbGl"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxLinkedCell("RLSATiwbGl");
                    }
                });
    }
    ...
    public void test_List_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x35d).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(693))
                .verifyReturnsVariant(new Returns<Variant>() {
                    @Override
                    public Variant invoke() throws ActiveXException {
                        return component.List(new Variant(693));
                    }
                });
    }
    ...
    public void test_setAxListFillRange_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x34f).dispatchType(ActiveXRuntimeConstants.AX_PROPERTYSET).args(new Variant("qTbpqrdcdX"))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.setAxListFillRange("qTbpqrdcdX");
                    }
                });
    }
    ...
    public void test_RemoveItem_TwoArgs_ShouldRedirectToProxy() throws Exception {
        on(0x354).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(42), new Variant(14))
                .verifyNoReturn(new Void() {
                    @Override
                    public void invoke() throws ActiveXException {
                        component.RemoveItem(42, new Variant(14));
                    }
                });
    }
    ...
    public void test_Selected_OneArg_ShouldRedirectToProxy() throws Exception {
        on(0x463).dispatchType(ActiveXRuntimeConstants.AX_INVOKE).args(new Variant(680))
                .verifyReturnsVariant(new Returns<Variant>() {
                    @Override
                    public Variant invoke() throws ActiveXException {
                        return component.Selected(new Variant(680));
                    }
                });
    }
