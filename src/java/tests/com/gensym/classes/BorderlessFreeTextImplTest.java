...
public class BorderlessFreeTextImplTest extends G2TestBase<BorderlessFreeTextImpl> {

    @Override
    protected Class<BorderlessFreeTextImpl> forClass() {
        return BorderlessFreeTextImpl.class;
    }
