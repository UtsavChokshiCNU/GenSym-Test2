...
public class ProcedureImplTest extends G2TestBase<ProcedureImpl> {

    @Override
    protected Class<ProcedureImpl> forClass() {
    ...
    @Test
    public void test_setClassOfProcedureInvocation_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setClassOfProcedureInvocation(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CLASS_OF_PROCEDURE_INVOCATION_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getClassOfProcedureInvocation_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CLASS_OF_PROCEDURE_INVOCATION_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getClassOfProcedureInvocation()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setDefaultProcedurePriority_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDefaultProcedurePriority(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DEFAULT_PROCEDURE_PRIORITY_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getDefaultProcedurePriority_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DEFAULT_PROCEDURE_PRIORITY_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getDefaultProcedurePriority()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setUninterruptedProcedureExecutionLimit_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setUninterruptedProcedureExecutionLimit("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.UNINTERRUPTED_PROCEDURE_EXECUTION_LIMIT_)).isEqualTo("ABC");
    }
    @Test
    public void test_getUninterruptedProcedureExecutionLimit_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.UNINTERRUPTED_PROCEDURE_EXECUTION_LIMIT_, "ABC");

        assertThat(instance.getUninterruptedProcedureExecutionLimit()).isEqualTo("ABC");
    }
    ...
    @Test
    public void test_setDynamicBreakpoints_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDynamicBreakpoints(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DYNAMIC_BREAKPOINTS_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getDynamicBreakpoints_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DYNAMIC_BREAKPOINTS_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getDynamicBreakpoints()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getInlinedCalls_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INLINED_CALLS_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getInlinedCalls()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
