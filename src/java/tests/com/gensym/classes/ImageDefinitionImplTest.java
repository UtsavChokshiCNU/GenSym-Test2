...
public class ImageDefinitionImplTest extends G2TestBase<ImageDefinitionImpl> {

    @Override
    protected Class<ImageDefinitionImpl> forClass() {
        return ImageDefinitionImpl.class;
    }
    ...
    @Test
    public void test_setFileNameOfImage_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setFileNameOfImage("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.FILE_NAME_OF_IMAGE_)).isEqualTo("ABC");
    }
    @Test
    public void test_getFileNameOfImage_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.FILE_NAME_OF_IMAGE_, "ABC");

        assertThat(instance.getFileNameOfImage()).isEqualTo("ABC");
    }


    @Test
    public void test_setSaveImageDataWithKb_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSaveImageDataWithKb(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SAVE_IMAGE_DATA_WITH_KB_)).isEqualTo(false);
    }
    @Test
    public void test_getSaveImageDataWithKb_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SAVE_IMAGE_DATA_WITH_KB_, false);

        assertThat(instance.getSaveImageDataWithKb()).isEqualTo(false);
    }


    @Test
    public void test_getWidthOfImage_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.WIDTH_OF_IMAGE_, 42);

        assertThat(instance.getWidthOfImage()).isEqualTo(42);
    }


    @Test
    public void test_getHeightOfImage_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.HEIGHT_OF_IMAGE_, 42);

        assertThat(instance.getHeightOfImage()).isEqualTo(42);
    }


    @Test
    public void test_getDepthOfImage_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DEPTH_OF_IMAGE_, 42);

        assertThat(instance.getDepthOfImage()).isEqualTo(42);
    }


    @Test
    public void test_getCachedMediaBin_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CACHED_MEDIA_BIN_, getStub(com.gensym.classes.MediaBin.class));

        assertThat(instance.getCachedMediaBin()).isEqualTo(getStub(com.gensym.classes.MediaBin.class));
    }


    @Test
    public void test_setImageData_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setImageData(getStub(com.gensym.util.Structure.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.IMAGE_DATA_)).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
    @Test
    public void test_getImageData_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.IMAGE_DATA_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getImageData()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
