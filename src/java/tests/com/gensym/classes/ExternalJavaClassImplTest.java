...
public class ExternalJavaClassImplTest extends G2TestBase<ExternalJavaClassImpl> {

    @Override
    protected Class<ExternalJavaClassImpl> forClass() {
        return ExternalJavaClassImpl.class;
    }

    @Test
    public void test_setDeriveNamesAutomatically_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDeriveNamesAutomatically(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DERIVE_NAMES_AUTOMATICALLYQ_)).isEqualTo(false);
    }
    @Test
    public void test_getDeriveNamesAutomatically_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DERIVE_NAMES_AUTOMATICALLYQ_, false);

        assertThat(instance.getDeriveNamesAutomatically()).isEqualTo(false);
    }


    @Test
    public void test_getJavaClassAndInterfaceNames_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.JAVA_CLASS_AND_INTERFACE_NAMES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getJavaClassAndInterfaceNames()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getJavaSyntaxVersion_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.JAVA_SYNTAX_VERSION_, "ABC");

        assertThat(instance.getJavaSyntaxVersion()).isEqualTo("ABC");
    }


    @Test
    public void test_getPackageDeclaration_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.PACKAGE_DECLARATION_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getPackageDeclaration()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getImportDeclarations_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.IMPORT_DECLARATIONS_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getImportDeclarations()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
