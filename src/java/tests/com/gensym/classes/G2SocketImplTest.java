...
public class G2SocketImplTest extends G2TestBase<G2SocketImpl> {

    @Override
    protected Class<G2SocketImpl> forClass() {
        return G2SocketImpl.class;
    }

    @Test
    public void test_getG2SocketPort_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.G2_SOCKET_PORT_, "ABC");

        assertThat(instance.getG2SocketPort()).isEqualTo("ABC");
    }


    @Test
    public void test_getG2SocketStatus_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.G2_SOCKET_STATUS_, "ABC");

        assertThat(instance.getG2SocketStatus()).isEqualTo("ABC");
    }


    @Test
    public void test_getG2SocketRemoteHost_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.G2_SOCKET_REMOTE_HOST_, "ABC");

        assertThat(instance.getG2SocketRemoteHost()).isEqualTo("ABC");
    }
