...
public class SliderImplTest extends G2TestBase<SliderImpl> {

    @Override
    protected Class<SliderImpl> forClass() {
        return SliderImpl.class;
    }

    @Test
    public void test_setMinimumValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setMinimumValue(42);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.MINIMUM_VALUE_)).isEqualTo(42);
    }
    @Test
    public void test_getMinimumValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.MINIMUM_VALUE_, 42);

        assertThat(instance.getMinimumValue()).isEqualTo(42);
    }


    @Test
    public void test_setMaximumValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setMaximumValue(42);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.MAXIMUM_VALUE_)).isEqualTo(42);
    }
    @Test
    public void test_getMaximumValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.MAXIMUM_VALUE_, 42);

        assertThat(instance.getMaximumValue()).isEqualTo(42);
    }


    @Test
    public void test_setSetValueWhileSliding_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSetValueWhileSliding(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SET_VALUE_WHILE_SLIDINGQ_)).isEqualTo(false);
    }
    @Test
    public void test_getSetValueWhileSliding_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SET_VALUE_WHILE_SLIDINGQ_, false);

        assertThat(instance.getSetValueWhileSliding()).isEqualTo(false);
    }


    @Test
    public void test_setWhenToShowValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setWhenToShowValue(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.WHEN_TO_SHOW_VALUE_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getWhenToShowValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.WHEN_TO_SHOW_VALUE_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getWhenToShowValue()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setSliderValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSliderValue(42);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SLIDER_VALUE_)).isEqualTo(42);
    }
    @Test
    public void test_getSliderValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SLIDER_VALUE_, 42);

        assertThat(instance.getSliderValue()).isEqualTo(42);
    }
