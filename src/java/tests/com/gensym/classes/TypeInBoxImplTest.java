...
public class TypeInBoxImplTest extends G2TestBase<TypeInBoxImpl> {

    @Override
    protected Class<TypeInBoxImpl> forClass() {
        return TypeInBoxImpl.class;
    }

    @Test
    public void test_setFormatForTypeInBox_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setFormatForTypeInBox("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.FORMAT_FOR_TYPE_IN_BOX_)).isEqualTo("ABC");
    }
    @Test
    public void test_getFormatForTypeInBox_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.FORMAT_FOR_TYPE_IN_BOX_, "ABC");

        assertThat(instance.getFormatForTypeInBox()).isEqualTo("ABC");
    }


    @Test
    public void test_setBlankForTypeIn_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setBlankForTypeIn(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.BLANK_FOR_TYPE_INQ_)).isEqualTo(false);
    }
    @Test
    public void test_getBlankForTypeIn_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.BLANK_FOR_TYPE_INQ_, false);

        assertThat(instance.getBlankForTypeIn()).isEqualTo(false);
    }


    @Test
    public void test_setHaveEditOptionButtonsForTypeIn_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setHaveEditOptionButtonsForTypeIn(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.HAVE_EDIT_OPTION_BUTTONS_FOR_TYPE_INQ_)).isEqualTo(false);
    }
    @Test
    public void test_getHaveEditOptionButtonsForTypeIn_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.HAVE_EDIT_OPTION_BUTTONS_FOR_TYPE_INQ_, false);

        assertThat(instance.getHaveEditOptionButtonsForTypeIn()).isEqualTo(false);
    }


    @Test
    public void test_setShowPromptsForTypeIn_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setShowPromptsForTypeIn(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SHOW_PROMPTS_FOR_TYPE_IN_)).isEqualTo(false);
    }
    @Test
    public void test_getShowPromptsForTypeIn_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SHOW_PROMPTS_FOR_TYPE_IN_, false);

        assertThat(instance.getShowPromptsForTypeIn()).isEqualTo(false);
    }


    @Test
    public void test_getTypeInBoxVariableOrParameter_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TYPE_IN_BOX_VARIABLE_OR_PARAMETER_, "ABC");

        assertThat(instance.getTypeInBoxVariableOrParameter()).isEqualTo("ABC");
    }


    @Test
    public void test_setTypeInBoxValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setTypeInBoxValue("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.TYPE_IN_BOX_VALUE_)).isEqualTo("ABC");
    }
    @Test
    public void test_getTypeInBoxValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TYPE_IN_BOX_VALUE_, "ABC");

        assertThat(instance.getTypeInBoxValue()).isEqualTo("ABC");
    }
