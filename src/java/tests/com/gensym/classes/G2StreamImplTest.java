...
public class G2StreamImplTest extends G2TestBase<G2StreamImpl> {

    @Override
    protected Class<G2StreamImpl> forClass() {
        return G2StreamImpl.class;
    }

    @Test
    public void test_getNameOfFile_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NAME_OF_FILE_, "ABC");

        assertThat(instance.getNameOfFile()).isEqualTo("ABC");
    }
    ...
    @Test
    public void test_getAccessDirection_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ACCESS_DIRECTION_, "ABC");

        assertThat(instance.getAccessDirection()).isEqualTo("ABC");
    }


    @Test
    public void test_getPositionInFile_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.POSITION_IN_FILE_, "ABC");

        assertThat(instance.getPositionInFile()).isEqualTo("ABC");
    }


    @Test
    public void test_getG2StreamStatus_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.G2_STREAM_STATUS_, "ABC");

        assertThat(instance.getG2StreamStatus()).isEqualTo("ABC");
    }
