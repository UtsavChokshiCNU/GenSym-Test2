...
public class MessageImplTest extends G2TestBase<MessageImpl> {

    @Override
    protected Class<MessageImpl> forClass() {
    ...
    @Test
    public void test_getDefaultMessagePropertiesForClass_ReturnsExpected() throws Exception {
        com.gensym.util.Structure expected = mockClassAttributeValue(SystemAttributeSymbols.DEFAULT_MESSAGE_PROPERTIES_, com.gensym.util.Structure.class);

        assertThat(instance.getDefaultMessagePropertiesForClass()).isEqualTo(expected);
    }
