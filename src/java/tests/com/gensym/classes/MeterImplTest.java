...
public class MeterImplTest extends G2TestBase<MeterImpl> {

    @Override
    protected Class<MeterImpl> forClass() {
    ...
    @Test
    public void test_setLowValueForMeterRuling_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setLowValueForMeterRuling(42);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.LOW_VALUE_FOR_METER_RULING_)).isEqualTo(42);
    }
    @Test
    public void test_getLowValueForMeterRuling_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.LOW_VALUE_FOR_METER_RULING_, 42);

        assertThat(instance.getLowValueForMeterRuling()).isEqualTo(42);
    }


    @Test
    public void test_setIncrementPerMeterRuling_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setIncrementPerMeterRuling(42);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.INCREMENT_PER_METER_RULING_)).isEqualTo(42);
    }
    @Test
    public void test_getIncrementPerMeterRuling_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INCREMENT_PER_METER_RULING_, 42);

        assertThat(instance.getIncrementPerMeterRuling()).isEqualTo(42);
    }
