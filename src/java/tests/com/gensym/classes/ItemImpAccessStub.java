...
public class ItemImpAccessStub implements ImplAccess, Item {
    @Override
    public G2Access getContext() {
        return null;
    }
    ...
    @Override
    public void addStubInvalidationListener(StubInvalidationListener listener) {

    }

    @Override
    public void removeStubInvalidationListener(StubInvalidationListener listener) {
