...
public class ItemG2ProxyStubOldStyle extends G2__BaseImpl implements ItemG2Proxy {
    private Symbol internalG2ClassName;

    public ItemG2ProxyStubOldStyle(G2Access access, int handle, Structure attributes) {
    }
