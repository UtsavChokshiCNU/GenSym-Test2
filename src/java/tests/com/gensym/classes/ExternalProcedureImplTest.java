...
public class ExternalProcedureImplTest extends G2TestBase<ExternalProcedureImpl> {

    @Override
    protected Class<ExternalProcedureImpl> forClass() {
        return ExternalProcedureImpl.class;
    }
