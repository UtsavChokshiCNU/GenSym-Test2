...
public class ModelDefinitionImplTest extends G2TestBase<ModelDefinitionImpl> {

    @Override
    protected Class<ModelDefinitionImpl> forClass() {
        return ModelDefinitionImpl.class;
    }
    ...
    @Test
    public void test_setItemsBelongingToThisModel_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setItemsBelongingToThisModel("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.ITEMS_BELONGING_TO_THIS_MODEL_)).isEqualTo("ABC");
    }
    @Test
    public void test_getItemsBelongingToThisModel_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ITEMS_BELONGING_TO_THIS_MODEL_, "ABC");

        assertThat(instance.getItemsBelongingToThisModel()).isEqualTo("ABC");
    }
    ...
    public void test_setSendAllValuesAtBeginningOfCycle_GivenValue_SetsAsAttributeValue() throws Exception {
        ...
        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SEND_ALL_VALUES_AT_BEGINNING_OF_CYCLE_)).isEqualTo(false);
    }
    @Test
    public void test_getSendAllValuesAtBeginningOfCycle_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SEND_ALL_VALUES_AT_BEGINNING_OF_CYCLE_, false);
    ...
    @Test
    public void test_getModelSimulationStatus_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.MODEL_SIMULATION_STATUS_, "ABC");

        assertThat(instance.getModelSimulationStatus()).isEqualTo("ABC");
    }


    @Test
    public void test_setSimulationControlSpecifications_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSimulationControlSpecifications(getStub(com.gensym.util.Structure.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SIMULATION_CONTROL_SPECIFICATIONS_)).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
    @Test
    public void test_getSimulationControlSpecifications_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SIMULATION_CONTROL_SPECIFICATIONS_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getSimulationControlSpecifications()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
