...
public class ExportDefinitionImplTest extends G2TestBase<ExportDefinitionImpl> {

    @Override
    protected Class<ExportDefinitionImpl> forClass() {
        return ExportDefinitionImpl.class;
    }
