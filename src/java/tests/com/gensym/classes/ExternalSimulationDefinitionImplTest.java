...
public class ExternalSimulationDefinitionImplTest extends G2TestBase<ExternalSimulationDefinitionImpl> {

    @Override
    protected Class<ExternalSimulationDefinitionImpl> forClass() {
        return ExternalSimulationDefinitionImpl.class;
    }
    ...
    @Test
    public void test_setClassOfObjectComputedByThis_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setClassOfObjectComputedByThis(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CLASS_OF_OBJECT_COMPUTED_BY_THIS_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getClassOfObjectComputedByThis_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CLASS_OF_OBJECT_COMPUTED_BY_THIS_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getClassOfObjectComputedByThis()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
