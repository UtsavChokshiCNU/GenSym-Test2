...
public class ProcedureInvocationImplTest extends G2TestBase<ProcedureInvocationImpl> {

    @Override
    protected Class<ProcedureInvocationImpl> forClass() {
        return ProcedureInvocationImpl.class;
    }
