...
public class GsiQuantityClassImplTest extends G2TestBase<GsiQuantityClassImpl> {

    @Override
    protected Class<GsiQuantityClassImpl> forClass() {
        return GsiQuantityClassImpl.class;
    }
