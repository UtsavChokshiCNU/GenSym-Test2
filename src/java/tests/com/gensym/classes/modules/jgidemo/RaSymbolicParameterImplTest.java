...
public class RaSymbolicParameterImplTest extends G2TestBase<RaSymbolicParameterImpl> {

    @Override
    protected Class<RaSymbolicParameterImpl> forClass() {
        return RaSymbolicParameterImpl.class;
    }

    @Test
    public void test_setAttributeName_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setAttributeName(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(Symbol.intern("ATTRIBUTE-NAME"))).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getAttributeName_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("ATTRIBUTE-NAME"), getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getAttributeName()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
