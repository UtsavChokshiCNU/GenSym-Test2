...
public class GsiLogicalClassImplTest extends G2TestBase<GsiLogicalClassImpl> {

    @Override
    protected Class<GsiLogicalClassImpl> forClass() {
        return GsiLogicalClassImpl.class;
    }
