...
public class GenericREmployeeImplTest extends G2TestBase<GenericREmployeeImpl> {

    @Override
    protected Class<GenericREmployeeImpl> forClass() {
        return GenericREmployeeImpl.class;
    }

    @Test
    public void test_setASequence_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setASequence("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("A-SEQUENCE"))).isEqualTo("ABC");
    }
    @Test
    public void test_getASequence_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("A-SEQUENCE"), "ABC");

        assertThat(instance.getASequence()).isEqualTo("ABC");
    }


    @Test
    public void test_setAStructure_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setAStructure("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("A-STRUCTURE"))).isEqualTo("ABC");
    }
    @Test
    public void test_getAStructure_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("A-STRUCTURE"), "ABC");

        assertThat(instance.getAStructure()).isEqualTo("ABC");
    }
