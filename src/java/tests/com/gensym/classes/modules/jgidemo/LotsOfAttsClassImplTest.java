...
public class LotsOfAttsClassImplTest extends G2TestBase<LotsOfAttsClassImpl> {

    @Override
    protected Class<LotsOfAttsClassImpl> forClass() {
        return LotsOfAttsClassImpl.class;
    }

    @Test
    public void test_setSym91_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym91("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-91"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym91_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-91"), "ABC");

        assertThat(instance.getSym91()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym92_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym92("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-92"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym92_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-92"), "ABC");

        assertThat(instance.getSym92()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym918_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym918("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-918"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym918_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-918"), "ABC");

        assertThat(instance.getSym918()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym93_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym93("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-93"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym93_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-93"), "ABC");

        assertThat(instance.getSym93()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym919_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym919("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-919"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym919_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-919"), "ABC");

        assertThat(instance.getSym919()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym94_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym94("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-94"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym94_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-94"), "ABC");

        assertThat(instance.getSym94()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9111_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9111("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9111"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9111_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9111"), "ABC");

        assertThat(instance.getSym9111()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym95_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym95("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-95"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym95_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-95"), "ABC");

        assertThat(instance.getSym95()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9122_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9122("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9122"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9122_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9122"), "ABC");

        assertThat(instance.getSym9122()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym96_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym96("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-96"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym96_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-96"), "ABC");

        assertThat(instance.getSym96()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9133_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9133("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9133"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9133_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9133"), "ABC");

        assertThat(instance.getSym9133()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym97_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym97("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-97"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym97_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-97"), "ABC");

        assertThat(instance.getSym97()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9144_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9144("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9144"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9144_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9144"), "ABC");

        assertThat(instance.getSym9144()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym98_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym98("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-98"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym98_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-98"), "ABC");

        assertThat(instance.getSym98()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9155_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9155("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9155"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9155_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9155"), "ABC");

        assertThat(instance.getSym9155()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym99_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym99("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-99"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym99_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-99"), "ABC");

        assertThat(instance.getSym99()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9166_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9166("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9166"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9166_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9166"), "ABC");

        assertThat(instance.getSym9166()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym910_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym910("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-910"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym910_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-910"), "ABC");

        assertThat(instance.getSym910()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9177_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9177("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9177"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9177_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9177"), "ABC");

        assertThat(instance.getSym9177()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym911_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym911("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-911"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym911_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-911"), "ABC");

        assertThat(instance.getSym911()).isEqualTo("ABC");
    }


    @Test
    public void test_setSym9188_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSym9188("ABC");

        assertThat(attributes.getAttributeValue(Symbol.intern("SYM-9188"))).isEqualTo("ABC");
    }
    @Test
    public void test_getSym9188_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("SYM-9188"), "ABC");

        assertThat(instance.getSym9188()).isEqualTo("ABC");
    }
