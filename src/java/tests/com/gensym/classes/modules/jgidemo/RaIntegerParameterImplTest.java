...
public class RaIntegerParameterImplTest extends G2TestBase<RaIntegerParameterImpl> {

    @Override
    protected Class<RaIntegerParameterImpl> forClass() {
        return RaIntegerParameterImpl.class;
    }
