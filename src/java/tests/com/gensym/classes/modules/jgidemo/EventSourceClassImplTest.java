...
public class EventSourceClassImplTest extends G2TestBase<EventSourceClassImpl> {

    @Override
    protected Class<EventSourceClassImpl> forClass() {
        return EventSourceClassImpl.class;
    }
