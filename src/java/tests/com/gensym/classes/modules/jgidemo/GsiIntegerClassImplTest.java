...
public class GsiIntegerClassImplTest extends G2TestBase<GsiIntegerClassImpl> {

    @Override
    protected Class<GsiIntegerClassImpl> forClass() {
        return GsiIntegerClassImpl.class;
    }
