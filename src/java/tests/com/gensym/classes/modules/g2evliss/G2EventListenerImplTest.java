...
public class G2EventListenerImplTest extends G2TestBase<G2EventListenerImpl> {

    @Override
    protected Class<G2EventListenerImpl> forClass() {
        return G2EventListenerImpl.class;
    }
