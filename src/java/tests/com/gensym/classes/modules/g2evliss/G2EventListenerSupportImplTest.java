...
public class G2EventListenerSupportImplTest extends G2TestBase<G2EventListenerSupportImpl> {

    @Override
    protected Class<G2EventListenerSupportImpl> forClass() {
        return G2EventListenerSupportImpl.class;
    }

    @Test
    public void test_set_eventListeners_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.set_eventListeners(getStub(com.gensym.classes.modules.g2evliss._g2lissupListenerList.class));

        assertThat(attributes.getAttributeValue(Symbol.intern("_EVENT-LISTENERS"))).isEqualTo(getStub(com.gensym.classes.modules.g2evliss._g2lissupListenerList.class));
    }
    @Test
    public void test_get_eventListeners_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(Symbol.intern("_EVENT-LISTENERS"), getStub(com.gensym.classes.modules.g2evliss._g2lissupListenerList.class));

        assertThat(instance.get_eventListeners()).isEqualTo(getStub(com.gensym.classes.modules.g2evliss._g2lissupListenerList.class));
    }
