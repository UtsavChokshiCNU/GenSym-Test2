...
public class RelationImplTest extends G2TestBase<RelationImpl> {

    @Override
    protected Class<RelationImpl> forClass() {
        return RelationImpl.class;
    }
    ...
    @Test
    public void test_setFirstClass_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setFirstClass(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.FIRST_CLASS_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getFirstClass_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.FIRST_CLASS_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getFirstClass()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setSecondClass_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setSecondClass(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.SECOND_CLASS_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getSecondClass_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.SECOND_CLASS_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getSecondClass()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setRelationName_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setRelationName(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.RELATION_NAME_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getRelationName_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.RELATION_NAME_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getRelationName()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setInverseOfRelation_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setInverseOfRelation(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.INVERSE_OF_RELATION_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getInverseOfRelation_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INVERSE_OF_RELATION_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getInverseOfRelation()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setTypeOfRelation_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setTypeOfRelation(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.TYPE_OF_RELATION_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getTypeOfRelation_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TYPE_OF_RELATION_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getTypeOfRelation()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setRelationIsSymmetric_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setRelationIsSymmetric(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.RELATION_IS_SYMMETRIC_)).isEqualTo(false);
    }
    @Test
    public void test_getRelationIsSymmetric_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.RELATION_IS_SYMMETRIC_, false);

        assertThat(instance.getRelationIsSymmetric()).isEqualTo(false);
    }


    @Test
    public void test_setRelationIsPermanent_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setRelationIsPermanent(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.RELATION_IS_PERMANENT_)).isEqualTo(false);
    }
    @Test
    public void test_getRelationIsPermanent_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.RELATION_IS_PERMANENT_, false);

        assertThat(instance.getRelationIsPermanent()).isEqualTo(false);
    }


    @Test
    public void test_getItemsInThisRelation_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ITEMS_IN_THIS_RELATION_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getItemsInThisRelation()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
