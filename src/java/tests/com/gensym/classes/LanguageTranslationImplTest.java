...
public class LanguageTranslationImplTest extends G2TestBase<LanguageTranslationImpl> {

    @Override
    protected Class<LanguageTranslationImpl> forClass() {
        return LanguageTranslationImpl.class;
    }
