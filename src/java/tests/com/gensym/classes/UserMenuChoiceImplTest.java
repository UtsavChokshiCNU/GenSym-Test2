...
public class UserMenuChoiceImplTest extends G2TestBase<UserMenuChoiceImpl> {

    @Override
    protected Class<UserMenuChoiceImpl> forClass() {
        return UserMenuChoiceImpl.class;
    }
    ...
    public void test_setLabel_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setLabel(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.LABEL_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getLabel_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.LABEL_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getLabel()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setApplicableClass_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setApplicableClass(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.APPLICABLE_CLASS_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getApplicableClass_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.APPLICABLE_CLASS_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getApplicableClass()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setCondition_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setCondition("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CONDITION_)).isEqualTo("ABC");
    }
    @Test
    public void test_getCondition_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONDITION_, "ABC");

        assertThat(instance.getCondition()).isEqualTo("ABC");
    }
