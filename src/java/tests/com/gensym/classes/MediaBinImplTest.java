...
public class MediaBinImplTest extends G2TestBase<MediaBinImpl> {

    @Override
    protected Class<MediaBinImpl> forClass() {
        return MediaBinImpl.class;
    }

    @Test
    public void test_setMediaBinData_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setMediaBinData("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.MEDIA_BIN_DATA_)).isEqualTo("ABC");
    }
    @Test
    public void test_getMediaBinData_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.MEDIA_BIN_DATA_, "ABC");

        assertThat(instance.getMediaBinData()).isEqualTo("ABC");
    }
