...
public class FrameStyleDefinitionImplTest extends G2TestBase<FrameStyleDefinitionImpl> {

    @Override
    protected Class<FrameStyleDefinitionImpl> forClass() {
        return FrameStyleDefinitionImpl.class;
    }
    ...
    @Test
    public void test_setDescriptionOfFrame_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDescriptionOfFrame(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DESCRIPTION_OF_FRAME_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getDescriptionOfFrame_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DESCRIPTION_OF_FRAME_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getDescriptionOfFrame()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
