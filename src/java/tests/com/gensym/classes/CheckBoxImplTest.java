...
public class CheckBoxImplTest extends G2TestBase<CheckBoxImpl> {

    @Override
    protected Class<CheckBoxImpl> forClass() {
        return CheckBoxImpl.class;
    }

    @Test
    public void test_setOnValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setOnValue("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.ON_VALUE_)).isEqualTo("ABC");
    }
    @Test
    public void test_getOnValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ON_VALUE_, "ABC");

        assertThat(instance.getOnValue()).isEqualTo("ABC");
    }


    @Test
    public void test_setOffValue_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setOffValue("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.OFF_VALUE_)).isEqualTo("ABC");
    }
    @Test
    public void test_getOffValue_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.OFF_VALUE_, "ABC");

        assertThat(instance.getOffValue()).isEqualTo("ABC");
    }


    @Test
    public void test_setButtonStatus_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setButtonStatus(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.BUTTON_STATUS_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getButtonStatus_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.BUTTON_STATUS_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getButtonStatus()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
