...
public class UnitsOfMeasureDeclarationImplTest extends G2TestBase<UnitsOfMeasureDeclarationImpl> {

    @Override
    protected Class<UnitsOfMeasureDeclarationImpl> forClass() {
        return UnitsOfMeasureDeclarationImpl.class;
    }
