...
public class TableItemImplTest extends G2TestBase<TableItemImpl> {

    @Override
    protected Class<TableItemImpl> forClass() {
        return TableItemImpl.class;
    }

    @Test
    public void test_getTableLayout_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TABLE_LAYOUT_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getTableLayout()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }


    @Test
    public void test_getTableFontSize_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TABLE_FONT_SIZE_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getTableFontSize()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_getRepresentedItem_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.REPRESENTED_ITEM_, "ABC");

        assertThat(instance.getRepresentedItem()).isEqualTo("ABC");
    }
