...
public class G2NativeWindowImplTest extends G2TestBase<G2NativeWindowImpl> {

    @Override
    protected Class<G2NativeWindowImpl> forClass() {
        return G2NativeWindowImpl.class;
    }

    @Test
    public void test_getNativeWindowLeft_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NATIVE_WINDOW_LEFT_, 42);

        assertThat(instance.getNativeWindowLeft()).isEqualTo(42);
    }


    @Test
    public void test_getNativeWindowTop_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NATIVE_WINDOW_TOP_, 42);

        assertThat(instance.getNativeWindowTop()).isEqualTo(42);
    }


    @Test
    public void test_getNativeWindowWidth_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NATIVE_WINDOW_WIDTH_, 42);

        assertThat(instance.getNativeWindowWidth()).isEqualTo(42);
    }


    @Test
    public void test_getNativeWindowHeight_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NATIVE_WINDOW_HEIGHT_, 42);

        assertThat(instance.getNativeWindowHeight()).isEqualTo(42);
    }


    @Test
    public void test_getNativeWindowState_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.NATIVE_WINDOW_STATE_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getNativeWindowState()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_getG2WindowOfView_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.G2_WINDOW_OF_VIEW_, getStub(com.gensym.classes.G2Window.class));

        assertThat(instance.getG2WindowOfView()).isEqualTo(getStub(com.gensym.classes.G2Window.class));
    }
