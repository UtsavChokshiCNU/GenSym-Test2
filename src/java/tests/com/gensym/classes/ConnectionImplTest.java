...
public class ConnectionImplTest extends G2TestBase<ConnectionImpl> {

    @Override
    protected Class<ConnectionImpl> forClass() {
        return ConnectionImpl.class;
    }

    @Test
    public void test_setConnectionArrows_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setConnectionArrows("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CONNECTION_ARROWS_)).isEqualTo("ABC");
    }
    @Test
    public void test_getConnectionArrows_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_ARROWS_, "ABC");

        assertThat(instance.getConnectionArrows()).isEqualTo("ABC");
    }


    @Test
    public void test_setLinePattern_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setLinePattern("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.LINE_PATTERN_)).isEqualTo("ABC");
    }
    @Test
    public void test_getLinePattern_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.LINE_PATTERN_, "ABC");

        assertThat(instance.getLinePattern()).isEqualTo("ABC");
    }


    @Test
    public void test_getConnectionPositionSequence_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_POSITION_SEQUENCE_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getConnectionPositionSequence()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getConnectionIsDirected_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_IS_DIRECTED_, false);

        assertThat(instance.getConnectionIsDirected()).isEqualTo(false);
    }


    @Test
    public void test_getConnectionVertices_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_VERTICES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getConnectionVertices()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getConnectionStyle_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_STYLE_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getConnectionStyle()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_getConnectionOutput_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_OUTPUT_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getConnectionOutput()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }


    @Test
    public void test_getConnectionInput_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CONNECTION_INPUT_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getConnectionInput()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
    ...
    @Test
    public void test_getCrossSectionPatternForClass_ReturnsExpected() throws Exception {
        com.gensym.util.Structure expected = mockClassAttributeValue(SystemAttributeSymbols.CROSS_SECTION_PATTERN_, com.gensym.util.Structure.class);

        assertThat(instance.getCrossSectionPatternForClass()).isEqualTo(expected);
    }


    @Test
    public void test_getStubLengthForClass_ReturnsExpected() throws Exception {
        java.lang.Object expected = mockClassAttributeValue(SystemAttributeSymbols.STUB_LENGTH_, java.lang.Object.class);

        assertThat(instance.getStubLengthForClass()).isEqualTo(expected);
    }


    @Test
    public void test_getJunctionBlockClassForClass_ReturnsExpected() throws Exception {
        com.gensym.util.Symbol expected = mockClassAttributeValue(SystemAttributeSymbols.JUNCTION_BLOCK_CLASS_, com.gensym.util.Symbol.class);

        assertThat(instance.getJunctionBlockClassForClass()).isEqualTo(expected);
    }
