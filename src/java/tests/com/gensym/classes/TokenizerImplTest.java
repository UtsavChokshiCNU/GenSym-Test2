...
public class TokenizerImplTest extends G2TestBase<TokenizerImpl> {

    @Override
    protected Class<TokenizerImpl> forClass() {
        return TokenizerImpl.class;
    }
    ...
    @Test
    public void test_setPatternsDefinition_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setPatternsDefinition(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.PATTERNS_DEFINITION_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getPatternsDefinition_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.PATTERNS_DEFINITION_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getPatternsDefinition()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setTokensDefinition_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setTokensDefinition(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.TOKENS_DEFINITION_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getTokensDefinition_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.TOKENS_DEFINITION_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getTokensDefinition()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
