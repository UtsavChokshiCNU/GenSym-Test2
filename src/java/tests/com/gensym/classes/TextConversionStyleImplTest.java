...
public class TextConversionStyleImplTest extends G2TestBase<TextConversionStyleImpl> {

    @Override
    protected Class<TextConversionStyleImpl> forClass() {
        return TextConversionStyleImpl.class;
    }
