...
public class DefinitionImplTest extends G2TestBase<DefinitionImpl> {

    @Override
    protected Class<DefinitionImpl> forClass() {
        return DefinitionImpl.class;
    }
    ...
    @Test
    public void test_setClassName_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setClassName(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CLASS_NAME_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getClassName_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CLASS_NAME_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getClassName()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setDirectSuperiorClasses_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDirectSuperiorClasses(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DIRECT_SUPERIOR_CLASSES_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getDirectSuperiorClasses_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DIRECT_SUPERIOR_CLASSES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getDirectSuperiorClasses()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setClassSpecificAttributes_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setClassSpecificAttributes(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CLASS_SPECIFIC_ATTRIBUTES_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getClassSpecificAttributes_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CLASS_SPECIFIC_ATTRIBUTES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getClassSpecificAttributes()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setInstanceConfiguration_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setInstanceConfiguration(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.INSTANCE_CONFIGURATION_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getInstanceConfiguration_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INSTANCE_CONFIGURATION_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getInstanceConfiguration()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setInstantiate_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setInstantiate(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.INSTANTIATE_)).isEqualTo(false);
    }
    @Test
    public void test_getInstantiate_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INSTANTIATE_, false);

        assertThat(instance.getInstantiate()).isEqualTo(false);
    }


    @Test
    public void test_setIncludeInMenus_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setIncludeInMenus(false);

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.INCLUDE_IN_MENUS_)).isEqualTo(false);
    }
    @Test
    public void test_getIncludeInMenus_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INCLUDE_IN_MENUS_, false);

        assertThat(instance.getIncludeInMenus()).isEqualTo(false);
    }


    @Test
    public void test_getClassInheritancePath_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CLASS_INHERITANCE_PATH_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getClassInheritancePath()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getInheritedAttributes_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INHERITED_ATTRIBUTES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getInheritedAttributes()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getInitializableSystemAttributes_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.INITIALIZABLE_SYSTEM_ATTRIBUTES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getInitializableSystemAttributes()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setAttributeInitializations_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setAttributeInitializations(getStub(com.gensym.util.Sequence.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.ATTRIBUTE_INITIALIZATIONS_)).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }
    @Test
    public void test_getAttributeInitializations_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ATTRIBUTE_INITIALIZATIONS_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getAttributeInitializations()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_setIconDescription_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setIconDescription(getStub(com.gensym.util.Structure.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.ICON_DESCRIPTION_)).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
    @Test
    public void test_getIconDescription_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ICON_DESCRIPTION_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getIconDescription()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
