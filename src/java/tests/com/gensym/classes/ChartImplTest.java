...
public class ChartImplTest extends G2TestBase<ChartImpl> {

    @Override
    protected Class<ChartImpl> forClass() {
        return ChartImpl.class;
    }

    @Test
    public void test_setChartStyle_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setChartStyle(getStub(com.gensym.util.Symbol.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.CHART_STYLE_)).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }
    @Test
    public void test_getChartStyle_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CHART_STYLE_, getStub(com.gensym.util.Symbol.class));

        assertThat(instance.getChartStyle()).isEqualTo(getStub(com.gensym.util.Symbol.class));
    }


    @Test
    public void test_setDataSeries_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setDataSeries("ABC");

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.DATA_SERIES_)).isEqualTo("ABC");
    }
    @Test
    public void test_getDataSeries_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.DATA_SERIES_, "ABC");

        assertThat(instance.getDataSeries()).isEqualTo("ABC");
    }


    @Test
    public void test_setAnnotations_GivenValue_SetsAsAttributeValue() throws Exception {
        instance.setAnnotations(getStub(com.gensym.util.Structure.class));

        assertThat(attributes.getAttributeValue(SystemAttributeSymbols.ANNOTATIONS_)).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
    @Test
    public void test_getAnnotations_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.ANNOTATIONS_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getAnnotations()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }


    @Test
    public void test_getChartDataSeries_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CHART_DATA_SERIES_, getStub(com.gensym.util.Sequence.class));

        assertThat(instance.getChartDataSeries()).isEqualTo(getStub(com.gensym.util.Sequence.class));
    }


    @Test
    public void test_getChartAxisComputedDetails_HadPreviouslySetAttributeValue_ReturnsExpected() throws Exception {
        attributes.setAttributeValue(SystemAttributeSymbols.CHART_AXIS_COMPUTED_DETAILS_, getStub(com.gensym.util.Structure.class));

        assertThat(instance.getChartAxisComputedDetails()).isEqualTo(getStub(com.gensym.util.Structure.class));
    }
