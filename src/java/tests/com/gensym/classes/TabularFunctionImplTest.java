...
public class TabularFunctionImplTest extends G2TestBase<TabularFunctionImpl> {

    @Override
    protected Class<TabularFunctionImpl> forClass() {
        return TabularFunctionImpl.class;
    }
