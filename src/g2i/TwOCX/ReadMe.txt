========================================================================
		ActiveX Control DLL : WEBSCORAX
========================================================================

ControlWizard has created this project for your WEBSCORAX ActiveX Control
...
that make up your WEBSCORAX ActiveX Control DLL.
...
WebSCORaxCtl.h
	This file contains the declaration of the CWebSCORaxCtrl C++ class.

WebSCORaxCtl.cpp
	This file contains the implementation of the CWebSCORaxCtrl C++ class.

WebSCORaxPpg.h
	This file contains the declaration of the CWebSCORaxPropPage C++ class.

WebSCORaxPpg.cpp
	This file contains the implementation of the CWebSCORaxPropPage C++ class.

WebSCORaxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CWebSCORaxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file WebSCORax.rc.
