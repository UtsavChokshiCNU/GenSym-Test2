...
echo Optegrity Client

rem
rem	This batch file launches the Optegrity Client.
...
set TITLE_="Optegrity 4.2 Rev 1 Client"
set TCP_EXACT=
set HM=%SITE_%
set TW_PATH=%HM%\g2
...
start %TITLE_% /b "%TW_PATH%\tw" %HOSTNAME% %PORTNUM% -background gray -log "%HM%\optegrity\logs\clientlog.txt" -icon %TITLE_% -name %TITLE_%
