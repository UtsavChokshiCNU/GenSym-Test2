#ifndef G2FederateAmbassador_h
#define G2FederateAmbassador_h
...
//
//-----------------------------------------------------------------
class G2FederateAmbassador : public RTI::FederateAmbassador
{
public:

G2FederateAmbassador();
virtual ~G2FederateAmbassador();
