#ifndef G2DemoFederateAmb_h
#define G2DemoFederateAmb_h
...
//
//-----------------------------------------------------------------
class G2DemoFederateAmb : public RTI::FederateAmbassador
{
public:

G2DemoFederateAmb();
virtual ~G2DemoFederateAmb() throw(RTI::FederateInternalError);
