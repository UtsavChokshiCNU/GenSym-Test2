...
$G2EXEC $* -kb $SRCBOX/gdanol/common/build/tools/release-gdanol.kb -copy-logbook-on-console
#${G2EXEC} $* -resourcefile ${SRCBOX}/g2i/kbs/resources-\*.txt -configfile ${SRCBOX}/g2i/kbs/config.txt
